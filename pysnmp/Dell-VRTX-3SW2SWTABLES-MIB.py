...
Unsigned32, iso, Counter32, MibIdentifier, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, NotificationType, ObjectIdentity, TimeTicks, Gauge32, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Counter32", "MibIdentifier", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "NotificationType", "ObjectIdentity", "TimeTicks", "Gauge32", "IpAddress", "Bits")
...
mibBuilder.exportSymbols("Dell-VRTX-3SW2SWTABLES-MIB", PYSNMP_MODULE_ID=rl3sw2swTables, rl3sw2swTables=rl3sw2swTables, rl3sw2swTablesPollingInterval=rl3sw2swTablesPollingInterval)
