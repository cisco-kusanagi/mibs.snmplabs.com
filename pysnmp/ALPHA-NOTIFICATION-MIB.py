...
# Produced by pysmi-0.3.4 at Mon Apr 29 17:05:04 2019
...
Unsigned32, IpAddress, Gauge32, NotificationType, iso, ObjectIdentity, MibIdentifier, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, Counter32, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Gauge32", "NotificationType", "iso", "ObjectIdentity", "MibIdentifier", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "Counter32", "Integer32", "ModuleIdentity")
...
mibBuilder.exportSymbols("ALPHA-NOTIFICATION-MIB", alarmPriority=alarmPriority, alarmSeverity=alarmSeverity, alphaAlarmNotificationsExtension=alphaAlarmNotificationsExtension, PYSNMP_MODULE_ID=alphaAlarmNotifications, alarmCustomDescription=alarmCustomDescription, alphaParameterGroup=alphaParameterGroup, alphaAlarmNotificationConformance=alphaAlarmNotificationConformance, alphaAlarmActiveState=alphaAlarmActiveState, alphaAlarmNotificationCompliances=alphaAlarmNotificationCompliances, alphaNotificationsGroup=alphaNotificationsGroup, alphaAlarmNotificationCompliance=alphaAlarmNotificationCompliance, alphaAlarmNotifications=alphaAlarmNotifications, alphaAlarmClearState=alphaAlarmClearState, alphaAlarmNotificationGroups=alphaAlarmNotificationGroups)
