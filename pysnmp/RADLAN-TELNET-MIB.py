...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/RADLAN-TELNET-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 20:41:26 2019
...
ObjectIdentity, Unsigned32, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, Bits, NotificationType, MibIdentifier, Gauge32, TimeTicks, iso, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "Bits", "NotificationType", "MibIdentifier", "Gauge32", "TimeTicks", "iso", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("RADLAN-TELNET-MIB", rlTelnetUsersEntry=rlTelnetUsersEntry, rlTelnetEnable=rlTelnetEnable, rlTelnet=rlTelnet, rlTelnetSecondLoginBanner=rlTelnetSecondLoginBanner, rlTelnetTimeout=rlTelnetTimeout, rlTelnetSessionStatus=rlTelnetSessionStatus, rlTelnetPassword=rlTelnetPassword, rlTelnetSessionClientAddressType=rlTelnetSessionClientAddressType, rlTelnetSessionClientAddress=rlTelnetSessionClientAddress, rlTelnetMibVersion=rlTelnetMibVersion, rlTelnetSessionLoginTime=rlTelnetSessionLoginTime, rlTelnetLoginBanner=rlTelnetLoginBanner, rlTelnetSessionId=rlTelnetSessionId, PYSNMP_MODULE_ID=rlTelnet, rlTelnetUsersTable=rlTelnetUsersTable)
