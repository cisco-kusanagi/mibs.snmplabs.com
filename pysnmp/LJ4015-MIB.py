...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ4015-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:14 2019
...
Gauge32, Unsigned32, TimeTicks, ObjectIdentity, IpAddress, Integer32, Counter64, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Counter32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Unsigned32", "TimeTicks", "ObjectIdentity", "IpAddress", "Integer32", "Counter64", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Counter32", "iso")
...
mibBuilder.exportSymbols("LJ4015-MIB", error2_date_time=error2_date_time, held_job_quantity=held_job_quantity, error28_date_time=error28_date_time, error45_code=error45_code, error5_code=error5_code, error20_date_time=error20_date_time, upgradable_devices_version=upgradable_devices_version, media19_short_name=media19_short_name, error13_code=error13_code, printed_media_simplex_count=printed_media_simplex_count, processing_subsystem=processing_subsystem, error26_time_stamp=error26_time_stamp, firmware_download_version=firmware_download_version, settings_spooler=settings_spooler, error3=error3, error18=error18, error48_date_time=error48_date_time, media_size_count=media_size_count, error21_time_stamp=error21_time_stamp, direct_connect_ports_enable=direct_connect_ports_enable, job_info_accounting_color_usage_log=job_info_accounting_color_usage_log, error18_code=error18_code, display=display, error15=error15, media14=media14, usage_instructions_line1=usage_instructions_line1, error14_code=error14_code, media6_page_count=media6_page_count, operating_system=operating_system, media5=media5, device_configure=device_configure, consumable_status_partnumber=consumable_status_partnumber, simm4_bank1_type=simm4_bank1_type, background_status_msg_line1_part1=background_status_msg_line1_part1, settings_io=settings_io, status_rpc=status_rpc, non_assured_oht_page_count=non_assured_oht_page_count, error17_time_stamp=error17_time_stamp, error29_date_time=error29_date_time, error24_code=error24_code, os_execute_file=os_execute_file, media14_engine_media_mode=media14_engine_media_mode, perm_store_init_occurred=perm_store_init_occurred, netPMLmgmt=netPMLmgmt, error31_time_stamp=error31_time_stamp, web_server=web_server, consumables=consumables, imaging=imaging, default_vmi=default_vmi, error46=error46, media11_page_count=media11_page_count, error39_time_stamp=error39_time_stamp, default_ret=default_ret, tray1_phd=tray1_phd, printer_accounting=printer_accounting, error10=error10, error19_date_time=error19_date_time, pdl_postscript=pdl_postscript, phd1_type=phd1_type, error45=error45, usb_device_kind=usb_device_kind, settings_web_server=settings_web_server, error43_date_time=error43_date_time, printer_average=printer_average, remote_procedure_call=remote_procedure_call, error31_date_time=error31_date_time, usb_interface=usb_interface, error49_time_stamp=error49_time_stamp, intray5=intray5, custom_paper_feed_dim=custom_paper_feed_dim, media9_short_name=media9_short_name, simm4_bank1=simm4_bank1, job_being_parsed=job_being_parsed, job_info_attr_5=job_info_attr_5, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, error1_time_stamp=error1_time_stamp, consumable_maintenance_pages_remaining=consumable_maintenance_pages_remaining, error45_time_stamp=error45_time_stamp, job_info_attr_15=job_info_attr_15, error10_date_time=error10_date_time, simm5_capacity=simm5_capacity, job_info_size=job_info_size, error24=error24, file_system_wipe_disk=file_system_wipe_disk, error47_time_stamp=error47_time_stamp, media11_short_name=media11_short_name, error1=error1, simm2=simm2, tray6_phd=tray6_phd, settings_system=settings_system, media17_engine_media_mode=media17_engine_media_mode, error6_date_time=error6_date_time, error42_code=error42_code, simm1_bank1_type=simm1_bank1_type, media4_page_count=media4_page_count, error36=error36, simm5_bank2_capacity=simm5_bank2_capacity, held_job_info=held_job_info, error23_date_time=error23_date_time, source_tray_usage_total=source_tray_usage_total, job_info=job_info, media2_page_count=media2_page_count, phd2=phd2, phd2_model=phd2_model, error41_date_time=error41_date_time, media13_short_name=media13_short_name, simm3_bank1_capacity=simm3_bank1_capacity, error1_date_time=error1_date_time, simm4_bank2=simm4_bank2, held_job=held_job, error45_date_time=error45_date_time, ews_request_control_panel_supplies_status=ews_request_control_panel_supplies_status, media3_page_count=media3_page_count, error38_time_stamp=error38_time_stamp, job_info_attr_8=job_info_attr_8, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, date_and_time=date_and_time, ports=ports, printed_media_dimplex_count=printed_media_dimplex_count, settings_print_media=settings_print_media, error19=error19, simm3_type=simm3_type, error46_code=error46_code, ph_devices=ph_devices, error34=error34, error1_code=error1_code, error25_time_stamp=error25_time_stamp, error17=error17, intray6=intray6, print_meter=print_meter, media8_name=media8_name, media14_short_name=media14_short_name, error38_code=error38_code, destination_subsystem=destination_subsystem, error_log_clear=error_log_clear, marking_agent_density_setting=marking_agent_density_setting, error50_code=error50_code, north_edge_offset=north_edge_offset, usb_host_supported=usb_host_supported, media4_name=media4_name, simm5_bank1_capacity=simm5_bank1_capacity, file_system2_initialize_volume=file_system2_initialize_volume, media3_engine_media_mode=media3_engine_media_mode, file_system2=file_system2, web_server_security=web_server_security, held_job_enable=held_job_enable, media19_name=media19_name, error33=error33, custom_paper_xfeed_dim=custom_paper_xfeed_dim, error33_time_stamp=error33_time_stamp, error6_code=error6_code, display_status=display_status, port1_parallel_speed=port1_parallel_speed, settings_file_system=settings_file_system, media1_page_count=media1_page_count, error12_date_time=error12_date_time, job_info_printed_originals=job_info_printed_originals, error6_time_stamp=error6_time_stamp, printer_average_marking_agent_coverage_sum=printer_average_marking_agent_coverage_sum, simm4_bank2_type=simm4_bank2_type, consumable_maintenance_interval=consumable_maintenance_interval, error36_code=error36_code, mopy_mode=mopy_mode, supply_out_action_support=supply_out_action_support, consumables_life=consumables_life, simm1_bank1_capacity=simm1_bank1_capacity, outbins=outbins, override_media_size=override_media_size, localization_languages_supported=localization_languages_supported, simm1_type=simm1_type, consumable_string_information=consumable_string_information, held_job_security=held_job_security, phd2_capacity=phd2_capacity, error34_code=error34_code, print_density=print_density, media_info=media_info, held_job_control=held_job_control, media8_page_count=media8_page_count, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, simm2_type=simm2_type, background_message1=background_message1, media3=media3, error11=error11, error20=error20, media18_engine_media_mode=media18_engine_media_mode, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, file_system3_initialize_volume=file_system3_initialize_volume, error23_code=error23_code, job_info_outbins_used=job_info_outbins_used, default_vertical_black_resolution=default_vertical_black_resolution, settings_rpc=settings_rpc, error14_date_time=error14_date_time, media18_page_count=media18_page_count, media17_short_name=media17_short_name, simm1_bank2_type=simm1_bank2_type, file_system_delete_files=file_system_delete_files, media12_engine_media_mode=media12_engine_media_mode, asset_number=asset_number, printed_media_simplex_charge=printed_media_simplex_charge, media7_engine_media_mode=media7_engine_media_mode, consumable_status=consumable_status, default_page_protect=default_page_protect, settings_ph=settings_ph, pcl_total_page_count=pcl_total_page_count, media10_engine_media_mode=media10_engine_media_mode, media11_name=media11_name, cartridge_out_override_control=cartridge_out_override_control, error8=error8, tray3_media_size_loaded=tray3_media_size_loaded, error7_time_stamp=error7_time_stamp, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, media4_engine_media_mode=media4_engine_media_mode, media3_short_name=media3_short_name, job_input_auto_continue_timeout=job_input_auto_continue_timeout, job_info_name1=job_info_name1, media15_page_count=media15_page_count, port1_parallel_bidirectionality=port1_parallel_bidirectionality, media16=media16, outbin1=outbin1, mio4_type=mio4_type, finisher_image_rotation=finisher_image_rotation, media16_engine_media_mode=media16_engine_media_mode, error46_time_stamp=error46_time_stamp, error42_date_time=error42_date_time, autocleaning_page_size=autocleaning_page_size, error17_date_time=error17_date_time, error9_date_time=error9_date_time, background_message=background_message, error27_time_stamp=error27_time_stamp, error14=error14, job_info_state=job_info_state, error35_date_time=error35_date_time, source_subsystem=source_subsystem, simm4_bank=simm4_bank, held_job_print=held_job_print, form_feed_needed=form_feed_needed, input_tray_auto_select=input_tray_auto_select, error33_date_time=error33_date_time, simm1_bank=simm1_bank, job_info_pages_processed=job_info_pages_processed, consumable_life_usage_units=consumable_life_usage_units, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, media13_name=media13_name, settings_prt_eng=settings_prt_eng, usage_instructions_line3=usage_instructions_line3, collated_originals_support=collated_originals_support, tray_disable_use_instead=tray_disable_use_instead, marking_agent_density=marking_agent_density, firmware_download=firmware_download, media_names_enabled=media_names_enabled, error47_code=error47_code, simm1=simm1, held_job_set_queue_size=held_job_set_queue_size, duplex_blank_pages=duplex_blank_pages)
mibBuilder.exportSymbols("LJ4015-MIB", media_names_available=media_names_available, media17_name=media17_name, outbin2_maximum_binding=outbin2_maximum_binding, printer_average_marking_agent_coverage_sum_squared=printer_average_marking_agent_coverage_sum_squared, simm2_bank1=simm2_bank1, error10_time_stamp=error10_time_stamp, upgradable_devices_name=upgradable_devices_name, job_info_pages_printed=job_info_pages_printed, tray4_media_size_loaded=tray4_media_size_loaded, media16_name=media16_name, error2_time_stamp=error2_time_stamp, error9_code=error9_code, media9_engine_media_mode=media9_engine_media_mode, mio4_ip_address=mio4_ip_address, error44_time_stamp=error44_time_stamp, media19_engine_media_mode=media19_engine_media_mode, usb_vendor_id=usb_vendor_id, job_info_requested_originals=job_info_requested_originals, usb_manufacturer_name=usb_manufacturer_name, error44_date_time=error44_date_time, media10_page_count=media10_page_count, media15_name=media15_name, default_bits_per_pixel=default_bits_per_pixel, error48_code=error48_code, error30_time_stamp=error30_time_stamp, simm2_bank1_type=simm2_bank1_type, autocleaning_page_frequency=autocleaning_page_frequency, simm4=simm4, duplex_page_count=duplex_page_count, upgradable_devices_current_state=upgradable_devices_current_state, error7_date_time=error7_date_time, model_number=model_number, error50=error50, time_display=time_display, printed_media_total_charge=printed_media_total_charge, media3_name=media3_name, error15_date_time=error15_date_time, printed_modes_total_count=printed_modes_total_count, job_info_page_count_current_original=job_info_page_count_current_original, error27_date_time=error27_date_time, error48_time_stamp=error48_time_stamp, default_custom_paper_dim_unit=default_custom_paper_dim_unit, simm=simm, media10=media10, media_types=media_types, simm1_bank1=simm1_bank1, intray2=intray2, dfa_data_in_nvram=dfa_data_in_nvram, media_modes=media_modes, cancel_job=cancel_job, firmware_download_write_status_supported=firmware_download_write_status_supported, job_info_attr_12=job_info_attr_12, active_print_jobs=active_print_jobs, media1=media1, error35_code=error35_code, io_switch=io_switch, tray3_phd=tray3_phd, error46_date_time=error46_date_time, job_info_attr_10=job_info_attr_10, status_system=status_system, control_panel_display=control_panel_display, device_configure_printer_parameters=device_configure_printer_parameters, host_application_available_memory=host_application_available_memory, error32_time_stamp=error32_time_stamp, error3_code=error3_code, job_info_accounting_media_type=job_info_accounting_media_type, error24_time_stamp=error24_time_stamp, default_media_size=default_media_size, postscript_total_page_count=postscript_total_page_count, default_copies=default_copies, settings_intray=settings_intray, simm5_bank2_type=simm5_bank2_type, media_number_of_type_supported=media_number_of_type_supported, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, job=job, error13_time_stamp=error13_time_stamp, consumables_1=consumables_1, simm1_bank2_capacity=simm1_bank2_capacity, media7_short_name=media7_short_name, simm3_capacity=simm3_capacity, job_info_attribute=job_info_attribute, job_info_attr_16=job_info_attr_16, settings_job=settings_job, mass_storage_block_driver=mass_storage_block_driver, media9=media9, webserver_proc_sub=webserver_proc_sub, error16_code=error16_code, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, error47=error47, file_system_external_access_capabilities=file_system_external_access_capabilities, error42_time_stamp=error42_time_stamp, error47_date_time=error47_date_time, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, destination_bin_accounting=destination_bin_accounting, mio1=mio1, clearable_warning=clearable_warning, postscript_print_errors=postscript_print_errors, media11_engine_media_mode=media11_engine_media_mode, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, usb_product_description=usb_product_description, pdl=pdl, error21=error21, pdf_print_errors=pdf_print_errors, file_systems=file_systems, default_lines_per_page=default_lines_per_page, media5_page_count=media5_page_count, media14_name=media14_name, simm3_bank2_type=simm3_bank2_type, consumable_notification_status=consumable_notification_status, firmware_download_write_time=firmware_download_write_time, outbin2_phd=outbin2_phd, media6_name=media6_name, media5_short_name=media5_short_name, error39=error39, phd2_device_specific_command=phd2_device_specific_command, error41_time_stamp=error41_time_stamp, media18_short_name=media18_short_name, media19_page_count=media19_page_count, error4_time_stamp=error4_time_stamp, error20_code=error20_code, media1_name=media1_name, hp=hp, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, job_info_attr_14=job_info_attr_14, tray7_phd=tray7_phd, job_info_attr_4=job_info_attr_4, phd1=phd1, mass_storage_resources=mass_storage_resources, status_mass_storage_bd=status_mass_storage_bd, error19_code=error19_code, intray=intray, current_job_parsing_id=current_job_parsing_id, media2_engine_media_mode=media2_engine_media_mode, media8=media8, simm4_bank2_capacity=simm4_bank2_capacity, error13_date_time=error13_date_time, pysmi_continue=pysmi_continue, media12_short_name=media12_short_name, error2=error2, energy_star=energy_star, simm5_bank1_type=simm5_bank1_type, simm3_bank2_capacity=simm3_bank2_capacity, usb_product_id=usb_product_id, printed_modes_accounting=printed_modes_accounting, printed_modes_usage=printed_modes_usage, error26=error26, error3_date_time=error3_date_time, error22_time_stamp=error22_time_stamp, error34_time_stamp=error34_time_stamp, mio=mio, media8_short_name=media8_short_name, install_date=install_date, media8_engine_media_mode=media8_engine_media_mode, supplies_replace_action_at_setting=supplies_replace_action_at_setting, error49=error49, consumable_string=consumable_string, media6=media6, print_engine=print_engine, error43=error43, error18_time_stamp=error18_time_stamp, error21_code=error21_code, error35_time_stamp=error35_time_stamp, media9_page_count=media9_page_count, media15_engine_media_mode=media15_engine_media_mode, default_horizontal_black_resolution=default_horizontal_black_resolution, error9=error9, error6=error6, error26_date_time=error26_date_time, consumables_status=consumables_status, status_pdl=status_pdl, error20_time_stamp=error20_time_stamp, media17_page_count=media17_page_count, error32_code=error32_code, error34_date_time=error34_date_time, port1=port1, printed_media_usage=printed_media_usage, error16=error16, error28=error28, print_media=print_media, io_timeout=io_timeout, error22_code=error22_code, ram_disk_size=ram_disk_size, error25_date_time=error25_date_time, job_info_io_source=job_info_io_source, media12_page_count=media12_page_count, device_name=device_name, device_system=device_system, maximum_ram_disk_memory=maximum_ram_disk_memory, ph2=ph2, error12_code=error12_code, media12=media12, tray7_media_size_loaded=tray7_media_size_loaded, media9_name=media9_name, error49_date_time=error49_date_time, media13_page_count=media13_page_count, ph=ph, default_media_name=default_media_name, error41=error41, destination_bin_usage_total=destination_bin_usage_total, tray5_media_size_loaded=tray5_media_size_loaded, error43_code=error43_code, source_tray_usage_count=source_tray_usage_count, simm4_capacity=simm4_capacity, outbin1_override_mode=outbin1_override_mode, usage_instructions_line4=usage_instructions_line4, control_panel_display_graphical_contents=control_panel_display_graphical_contents, error14_time_stamp=error14_time_stamp, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, upgradable_devices=upgradable_devices, form_feed=form_feed, error37=error37, interface=interface, phd2_manufacturing_info=phd2_manufacturing_info, error13=error13, media18_name=media18_name, job_info_change_id=job_info_change_id, fw_rom_revision=fw_rom_revision, job_info_attr_11=job_info_attr_11, overflow_bin=overflow_bin, simm3_bank=simm3_bank, settings_outbin=settings_outbin, sleep_mode=sleep_mode, io=io, autocleaning_page_enable=autocleaning_page_enable, job_info_accounting_job_type=job_info_accounting_job_type, simm3_bank1_type=simm3_bank1_type, on_off_line=on_off_line, error37_time_stamp=error37_time_stamp, error28_code=error28_code, error12_time_stamp=error12_time_stamp, mio4=mio4, auto_continue=auto_continue, simm5=simm5, job_input_auto_continue_mode=job_input_auto_continue_mode, error36_date_time=error36_date_time, formatter_serial_number=formatter_serial_number, media_counts=media_counts, hold_job_timeout=hold_job_timeout, simm2_bank=simm2_bank, media2_name=media2_name, file_system_erase_mode=file_system_erase_mode, simm4_type=simm4_type, job_info_attr_13=job_info_attr_13, media1_engine_media_mode=media1_engine_media_mode, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, error27_code=error27_code, media14_page_count=media14_page_count, job_info_attr_9=job_info_attr_9, error4_date_time=error4_date_time, error23=error23, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, printed_media_duplex_charge=printed_media_duplex_charge, error40_code=error40_code, phd1_model=phd1_model)
mibBuilder.exportSymbols("LJ4015-MIB", error25=error25, pdl_pdf=pdl_pdf, destination_bin_usage_count=destination_bin_usage_count, error10_code=error10_code, mio4_manufacturing_info=mio4_manufacturing_info, mass_storage_resource_change_counter=mass_storage_resource_change_counter, simm5_bank1=simm5_bank1, serial_number=serial_number, job_info_attr_1=job_info_attr_1, error23_time_stamp=error23_time_stamp, media2_short_name=media2_short_name, simm1_capacity=simm1_capacity, settings_pdl=settings_pdl, error29_time_stamp=error29_time_stamp, error30_code=error30_code, job_info_attr_6=job_info_attr_6, usage_average_toner_coverage=usage_average_toner_coverage, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, error11_code=error11_code, media15=media15, consumable_reorder_url=consumable_reorder_url, print_engine_revision=print_engine_revision, error8_date_time=error8_date_time, simm1_bank2=simm1_bank2, consumable_status_web_service_access_control=consumable_status_web_service_access_control, printed_media_duplex_count=printed_media_duplex_count, device_location=device_location, source_tray_accounting=source_tray_accounting, simm5_bank2=simm5_bank2, tray2_phd=tray2_phd, tray5_phd=tray5_phd, fw_rom_datecode=fw_rom_datecode, outbin2_error_info=outbin2_error_info, file_system4_initialize_volume=file_system4_initialize_volume, error8_time_stamp=error8_time_stamp, job_info_stage=job_info_stage, tray_prompt=tray_prompt, consumable_string_information_reset=consumable_string_information_reset, simm4_bank1_capacity=simm4_bank1_capacity, tray6_media_size_loaded=tray6_media_size_loaded, DisplayString=DisplayString, media7_page_count=media7_page_count, simm2_bank2_type=simm2_bank2_type, error38_date_time=error38_date_time, simm2_bank2=simm2_bank2, background_message2=background_message2, job_info_attr_2=job_info_attr_2, media1_short_name=media1_short_name, simm2_capacity=simm2_capacity, media_size=media_size, error25_code=error25_code, web_server_url=web_server_url, mio1_type=mio1_type, phd1_manufacturing_info=phd1_manufacturing_info, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, mass_storage_resource_changed=mass_storage_resource_changed, status_prt_eng=status_prt_eng, media10_name=media10_name, held_job_job_name=held_job_job_name, error49_code=error49_code, pdl_pcl=pdl_pcl, media13_engine_media_mode=media13_engine_media_mode, date_display=date_display, intrays=intrays, media4_short_name=media4_short_name, error4=error4, media12_name=media12_name, error16_date_time=error16_date_time, error44=error44, file_system_max_open_files=file_system_max_open_files, cold_reset_media_size=cold_reset_media_size, rpc_bind_protocol_address=rpc_bind_protocol_address, error39_code=error39_code, usage_printer_total_charge=usage_printer_total_charge, settings_mass_storage_bd=settings_mass_storage_bd, remote_upgrade_enable=remote_upgrade_enable, job_info_attr_7=job_info_attr_7, background_status_msg_line2_part1=background_status_msg_line2_part1, error8_code=error8_code, settings_webserver=settings_webserver, error16_time_stamp=error16_time_stamp, media10_short_name=media10_short_name, usb=usb, supply_after_out_state=supply_after_out_state, held_job_user_name=held_job_user_name, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, error42=error42, error18_date_time=error18_date_time, error12=error12, error41_code=error41_code, error9_time_stamp=error9_time_stamp, media13=media13, job_info_accounting_finishing_options=job_info_accounting_finishing_options, media7_name=media7_name, media11=media11, engine_media_modes_supported1=engine_media_modes_supported1, error5=error5, consumable_current_state=consumable_current_state, error28_time_stamp=error28_time_stamp, printed_media_combined_total=printed_media_combined_total, media16_page_count=media16_page_count, firmware_download_name=firmware_download_name, simm5_bank=simm5_bank, ram_disk_mode=ram_disk_mode, configurable_low_threshold_setting=configurable_low_threshold_setting, media6_short_name=media6_short_name, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, intray7=intray7, error15_code=error15_code, phd2_type=phd2_type, held_job_retention=held_job_retention, usb_driver_name=usb_driver_name, simm3_bank1=simm3_bank1, error4_code=error4_code, media2=media2, error44_code=error44_code, destination_bin_usage=destination_bin_usage, error36_time_stamp=error36_time_stamp, job_info_accounting=job_info_accounting, mio4_model_name=mio4_model_name, simm2_bank1_capacity=simm2_bank1_capacity, file_system4=file_system4, mio1_manufacturing_info=mio1_manufacturing_info, media18=media18, outbin2=outbin2, file_system_wipe_disk_status=file_system_wipe_disk_status, error27=error27, outbin=outbin, error5_date_time=error5_date_time, tray1_media_size_loaded=tray1_media_size_loaded, consumable_life_low_threshold=consumable_life_low_threshold, supply_out_device_state=supply_out_device_state, error50_time_stamp=error50_time_stamp, mio1_ip_address=mio1_ip_address, usage_instructions_line2=usage_instructions_line2, media6_engine_media_mode=media6_engine_media_mode, intray4=intray4, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, error5_time_stamp=error5_time_stamp, media4=media4, error40=error40, simm3_bank2=simm3_bank2, source_tray_usage=source_tray_usage, simm5_type=simm5_type, firmware_download_current_state=firmware_download_current_state, service_id=service_id, media5_engine_media_mode=media5_engine_media_mode, error26_code=error26_code, intray3=intray3, tray2_media_size_loaded=tray2_media_size_loaded, error21_date_time=error21_date_time, error32_date_time=error32_date_time, error31_code=error31_code, consumable_status_web_service_access_data=consumable_status_web_service_access_data, media16_short_name=media16_short_name, job_info_outcome=job_info_outcome, pcl_default_font_source=pcl_default_font_source, spooler=spooler, error11_date_time=error11_date_time, error31=error31, show_address=show_address, control_panel_supplies_status_message=control_panel_supplies_status_message, intray1=intray1, error7_code=error7_code, consumable_status_tls_max_value=consumable_status_tls_max_value, error48=error48, error17_code=error17_code, phd1_capacity=phd1_capacity, held_job_pin=held_job_pin, simm2_bank2_capacity=simm2_bank2_capacity, media19=media19, simm3=simm3, error11_time_stamp=error11_time_stamp, phd=phd, pcl_default_font_height=pcl_default_font_height, error33_code=error33_code, error3_time_stamp=error3_time_stamp, error38=error38, pcl_default_font_number=pcl_default_font_number, rpc_bound_protocol_address=rpc_bound_protocol_address, usage_staple_count=usage_staple_count, localization_countries_supported=localization_countries_supported, job_info_physical_outbins_used=job_info_physical_outbins_used, job_info_attr_3=job_info_attr_3, file_system=file_system, control_panel_button_press=control_panel_button_press, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, error24_date_time=error24_date_time, job_info_pages_in_original=job_info_pages_in_original, error7=error7, error22_date_time=error22_date_time, accounting=accounting, upgradable_devices_write_time=upgradable_devices_write_time, consumable_pages_printed_with_supply=consumable_pages_printed_with_supply, error15_time_stamp=error15_time_stamp, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, tray4_phd=tray4_phd, mio1_model_name=mio1_model_name, media7=media7, media17=media17, job_info_accounting_black_dots=job_info_accounting_black_dots, media15_short_name=media15_short_name, error37_date_time=error37_date_time, error30=error30, outbin2_override_mode=outbin2_override_mode, consumable_status_printer_design_compatibility=consumable_status_printer_design_compatibility, error19_time_stamp=error19_time_stamp, error43_time_stamp=error43_time_stamp, default_custom_paper_feed_dim=default_custom_paper_feed_dim, error32=error32, printed_modes_usage_total=printed_modes_usage_total, error40_time_stamp=error40_time_stamp, model_name=model_name, held_job_delete=held_job_delete, error37_code=error37_code, file_system3=file_system3, pcl_default_font_width=pcl_default_font_width, media5_name=media5_name, error35=error35, error2_code=error2_code, error39_date_time=error39_date_time, device=device, job_output_auto_continue_timeout=job_output_auto_continue_timeout, error22=error22, error29_code=error29_code, error29=error29, control_panel_display_contents_crc=control_panel_display_contents_crc, resource_manager=resource_manager, job_info_name2=job_info_name2, error40_date_time=error40_date_time, reprint=reprint, usb_serial_number=usb_serial_number, errorlog=errorlog, override_media_name=override_media_name, id=id, error30_date_time=error30_date_time, error50_date_time=error50_date_time, consumable_status_page_count_b5_executive=consumable_status_page_count_b5_executive, job_info_accounting_media_size=job_info_accounting_media_size)
