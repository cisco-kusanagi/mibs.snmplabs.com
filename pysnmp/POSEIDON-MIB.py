...
# Produced by pysmi-0.3.4 at Mon Apr 29 20:32:37 2019
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, enterprises, IpAddress, NotificationType, TimeTicks, Integer32, ModuleIdentity, MibIdentifier, Unsigned32, Bits, Gauge32, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "enterprises", "IpAddress", "NotificationType", "TimeTicks", "Integer32", "ModuleIdentity", "MibIdentifier", "Unsigned32", "Bits", "Gauge32", "iso", "Counter64")
...
mibBuilder.exportSymbols("POSEIDON-MIB", sensID=sensID, tsAlarmEntry=tsAlarmEntry, sensSetupTable=sensSetupTable, outName=outName, inpValue=inpValue, sensValueRaw=sensValueRaw, sensFlags=sensFlags, tsTrapAlarmStart=tsTrapAlarmStart, outValue=outValue, sensHysteresis=sensHysteresis, outType=outType, SensorUnitString=SensorUnitString, outMode=outMode, sensAlarmStateChanged=sensAlarmStateChanged, SensorName=SensorName, tsAlarm=tsAlarm, OnOff=OnOff, IOName=IOName, inpName=inpName, sensTable=sensTable, tsAlarmSensName=tsAlarmSensName, sensSetup=sensSetup, sensUnit=sensUnit, tsAlarmId=tsAlarmId, sensValue=sensValue, infoAddressMAC=infoAddressMAC, unitType=unitType, SensorID=SensorID, InputAlarmSetup=InputAlarmSetup, PositiveInteger=PositiveInteger, info=info, setup=setup, outEntry=outEntry, tsAlarmTime=tsAlarmTime, sensString=sensString, sensLimitMax=sensLimitMax, poseidon=poseidon, OutputType=OutputType, tsAlarmDescr=tsAlarmDescr, SensorString=SensorString, sensName=sensName, sensSetupName=sensSetupName, charonII=charonII, outIndex=outIndex, SensorFlags=SensorFlags, sensSetupIndex=sensSetupIndex, inpAlarmSetup=inpAlarmSetup, tsAlarmTable=tsAlarmTable, UnitType=UnitType, outTable=outTable, tsTrapAlarmEnd=tsTrapAlarmEnd, OutputMode=OutputMode, tsAlarmIdx=tsAlarmIdx, hwgroup=hwgroup, inpEntry=inpEntry, tsAlarmsPresent=tsAlarmsPresent, SensorValue=SensorValue, TimeStamp=TimeStamp, inpAlarmStateChanged=inpAlarmStateChanged, sensLimitMin=sensLimitMin, inpAlarmState=inpAlarmState, sensUnitString=sensUnitString, sensIndex=sensIndex, inpIndex=inpIndex, sensEntry=sensEntry, SensorState=SensorState, inpTable=inpTable, InputAlarmState=InputAlarmState, sensSetupEntry=sensSetupEntry, sensState=sensState)
