...
# Produced by pysmi-0.3.4 at Mon Apr 29 21:03:19 2019
...
Bits, Counter32, Counter64, ObjectIdentity, Unsigned32, MibIdentifier, TimeTicks, IpAddress, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, Integer32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter32", "Counter64", "ObjectIdentity", "Unsigned32", "MibIdentifier", "TimeTicks", "IpAddress", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "Integer32", "iso")
...
mibBuilder.exportSymbols("STE2-MIB", sensSN=sensSN, sensTable=sensTable, SensorString=SensorString, IOName=IOName, infoAddressMAC=infoAddressMAC, sensName=sensName, SensorState=SensorState, info=info, inpValue=inpValue, SensorValue=SensorValue, inpAlarmState=inpAlarmState, SensorSN=SensorSN, inpName=inpName, SensorName=SensorName, inpIndex=inpIndex, hwgroup=hwgroup, sensID=sensID, PositiveInteger=PositiveInteger, OnOff=OnOff, inpEntry=inpEntry, x390=x390, sensValue=sensValue, UnitType=UnitType, sensUnit=sensUnit, ste2=ste2, inpTable=inpTable, sensState=sensState, InputAlarmState=InputAlarmState, sensString=sensString, sensIndex=sensIndex, SensorID=SensorID, sensEntry=sensEntry)
