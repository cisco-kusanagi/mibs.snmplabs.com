...
# Produced by pysmi-0.3.4 at Mon Apr 29 17:20:09 2019
...
Counter32, IpAddress, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Integer32, Gauge32, Bits, TimeTicks, Unsigned32, iso, MibIdentifier, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Integer32", "Gauge32", "Bits", "TimeTicks", "Unsigned32", "iso", "MibIdentifier", "ObjectIdentity", "ModuleIdentity")
...
mibBuilder.exportSymbols("BEGEMOT-MIB2-MIB", begemotIfForcePoll=begemotIfForcePoll, PYSNMP_MODULE_ID=begemotMib2, begemotIfMaxspeed=begemotIfMaxspeed, begemotMib2=begemotMib2, begemotIfPoll=begemotIfPoll)
