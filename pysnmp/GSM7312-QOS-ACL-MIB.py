...
iso, Gauge32, Bits, Integer32, Counter64, MibIdentifier, NotificationType, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Bits", "Integer32", "Counter64", "MibIdentifier", "NotificationType", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("GSM7312-QOS-ACL-MIB", aclIfDirection=aclIfDirection, aclRuleStatus=aclRuleStatus, aclIfTable=aclIfTable, aclRuleIPDSCP=aclRuleIPDSCP, aclRuleIndex=aclRuleIndex, aclRuleProtocol=aclRuleProtocol, aclRuleIpPrecedence=aclRuleIpPrecedence, aclRuleEntry=aclRuleEntry, aclRuleSrcL4Port=aclRuleSrcL4Port, aclRuleSrcL4PortRangeStart=aclRuleSrcL4PortRangeStart, aclRuleIpTosMask=aclRuleIpTosMask, aclRuleTable=aclRuleTable, aclRuleDestL4PortRangeStart=aclRuleDestL4PortRangeStart, aclRuleSrcIpAddress=aclRuleSrcIpAddress, aclTable=aclTable, aclRuleIpTosBits=aclRuleIpTosBits, aclIfIndex=aclIfIndex, aclEntry=aclEntry, aclRuleDestIpMask=aclRuleDestIpMask, PYSNMP_MODULE_ID=gsm7312QOSACL, gsm7312QOSACL=gsm7312QOSACL, aclStatus=aclStatus, aclRuleAction=aclRuleAction, aclRuleDestL4Port=aclRuleDestL4Port, aclRuleDestIpAddress=aclRuleDestIpAddress, aclIfEntry=aclIfEntry, aclRuleSrcIpMask=aclRuleSrcIpMask, aclIfStatus=aclIfStatus, aclRuleDestL4PortRangeEnd=aclRuleDestL4PortRangeEnd, aclRuleSrcL4PortRangeEnd=aclRuleSrcL4PortRangeEnd, aclIndex=aclIndex)
