...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:06:45 2019
...
ipAddressEntry, ipv6InterfaceEntry, ipv6RouterAdvertEntry, ipNetToPhysicalEntry = mibBuilder.importSymbols("IP-MIB", "ipAddressEntry", "ipv6InterfaceEntry", "ipv6RouterAdvertEntry", "ipNetToPhysicalEntry")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
ModuleIdentity, Bits, ObjectIdentity, Unsigned32, mib_2, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, iso, MibIdentifier, Integer32, zeroDotZero, Gauge32, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "ObjectIdentity", "Unsigned32", "mib-2", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "iso", "MibIdentifier", "Integer32", "zeroDotZero", "Gauge32", "NotificationType", "IpAddress")
...
mibBuilder.exportSymbols("CISCOSB-IPv6", rlIpv6RouterAdvertPrefixAdvPreferredLifetime=rlIpv6RouterAdvertPrefixAdvPreferredLifetime, rlIpv6PathMtuEntryAge=rlIpv6PathMtuEntryAge, rlipv6EnabledByDefaultRemovedIfindex=rlipv6EnabledByDefaultRemovedIfindex, rlInetStaticRouteOwner=rlInetStaticRouteOwner, rlInternInetStaticRouteNextHop=rlInternInetStaticRouteNextHop, PYSNMP_MODULE_ID=rlIPv6, rlInternInetCidrRouteInfo=rlInternInetCidrRouteInfo, rlipv6LLDefaultZone=rlipv6LLDefaultZone, rlipNetToPhysicalReachableConfirmed=rlipNetToPhysicalReachableConfirmed, rlIpv6PathMtuEntryInetDestAddrType=rlIpv6PathMtuEntryInetDestAddrType, rlInetStaticRouteDest=rlInetStaticRouteDest, rlIpv6GeneralPrefixTable=rlIpv6GeneralPrefixTable, rlInetRoutingDistanceStatic=rlInetRoutingDistanceStatic, rlInternInetCidrRouteIfIndex=rlInternInetCidrRouteIfIndex, rlInternInetStaticRoutePfxLen=rlInternInetStaticRoutePfxLen, rlinetCidrRouteLifetime=rlinetCidrRouteLifetime, rlIpv6PathMtuTable=rlIpv6PathMtuTable, rlIpv6RouterAdvertEntry=rlIpv6RouterAdvertEntry, rlIpv6GeneralPrefixInetAddrPrefixLength=rlIpv6GeneralPrefixInetAddrPrefixLength, rlIpv6RouterAdvertPrefixAdvertise=rlIpv6RouterAdvertPrefixAdvertise, rlIpNetToPhysicalTableClearScope=rlIpNetToPhysicalTableClearScope, rlIpv6RouterAdvertPrefixInetAddr=rlIpv6RouterAdvertPrefixInetAddr, rlipv6InterfaceIcmpUnreachSendEnable=rlipv6InterfaceIcmpUnreachSendEnable, rlInetStaticRoutePathCost=rlInetStaticRoutePathCost, rlipv6InterfaceAutoconfigEnable=rlipv6InterfaceAutoconfigEnable, rlIpAddressTable=rlIpAddressTable, rlipv6InterfaceMLDVersion=rlipv6InterfaceMLDVersion, rlInetStaticRouteNextHopType=rlInetStaticRouteNextHopType, rlIpv6RouterAdvertAdvIntervalOption=rlIpv6RouterAdvertAdvIntervalOption, rlIpv6HostForwardingType=rlIpv6HostForwardingType, rlIpv6RouterAdvertPrefixAdvValidLifetime=rlIpv6RouterAdvertPrefixAdvValidLifetime, rlInetStaticRouteRowStatus=rlInetStaticRouteRowStatus, rlInetStaticRouteTable=rlInetStaticRouteTable, rlInternInetCidrRouteMetric3=rlInternInetCidrRouteMetric3, rlipNetToPhysicalTable=rlipNetToPhysicalTable, rlInetStaticRoutePfxLen=rlInetStaticRoutePfxLen, rlipv6InterfaceRetransmitTime=rlipv6InterfaceRetransmitTime, rlIpv6GeneralPrefixEntry=rlIpv6GeneralPrefixEntry, rlIpAddressPrefixLength=rlIpAddressPrefixLength, rlInetStaticRouteNextHop=rlInetStaticRouteNextHop, rlInternInetCidrRouteAge=rlInternInetCidrRouteAge, rlInetRoutingDistanceOspfInternal=rlInetRoutingDistanceOspfInternal, rlInternInetCidrRouteType=rlInternInetCidrRouteType, rlInternInetStaticRouteNextHopType=rlInternInetStaticRouteNextHopType, rlIpv6HostForwardingDestType=rlIpv6HostForwardingDestType, rlIpv6GeneralPrefixName=rlIpv6GeneralPrefixName, rlIpv6RouterAdvertPrefixOnLinkStatus=rlIpv6RouterAdvertPrefixOnLinkStatus, rlInetRoutingDistanceConnected=rlInetRoutingDistanceConnected, rlIpv6GeneralPrefixInetAddr=rlIpv6GeneralPrefixInetAddr, rlInternInetStaticRouteRowStatus=rlInternInetStaticRouteRowStatus, rlInternInetStaticRouteIfIndex=rlInternInetStaticRouteIfIndex, rlIpAddressType=rlIpAddressType, rlInternInetCidrRouteDestType=rlInternInetCidrRouteDestType, rlIpv6HostForwardingIfIndex=rlIpv6HostForwardingIfIndex, rlInternInetCidrRouteMetric5=rlInternInetCidrRouteMetric5, rlInternInetCidrRouteNextHopType=rlInternInetCidrRouteNextHopType, rlIpv6HostForwardingDest=rlIpv6HostForwardingDest, rlInetRoutingDistanceEntry=rlInetRoutingDistanceEntry, rlipv6InterfaceTable=rlipv6InterfaceTable, rlipv6InterfaceIcmpRedirectSendEnable=rlipv6InterfaceIcmpRedirectSendEnable, rlIpAddressEntry=rlIpAddressEntry, rlInternInetCidrRouteMetric4=rlInternInetCidrRouteMetric4, rlIpv6RouterAdvertPrefixAutonomousFlag=rlIpv6RouterAdvertPrefixAutonomousFlag, rlInternInetStaticRouteEntry=rlInternInetStaticRouteEntry, rlIpv6RouterAdvertPrefixEntry=rlIpv6RouterAdvertPrefixEntry, rlIpv6RouterAdvertRouterPreference=rlIpv6RouterAdvertRouterPreference, rlIPv6=rlIPv6, rlInternInetStaticRouteTable=rlInternInetStaticRouteTable, rlIpNetToPhysicalTableClearTable=rlIpNetToPhysicalTableClearTable, rlInternInetCidrRoutePolicy=rlInternInetCidrRoutePolicy, rlIpv6RouterAdvertIsCurHopLimitUserConfigured=rlIpv6RouterAdvertIsCurHopLimitUserConfigured, rlIpv6GeneralPrefixInetAddrType=rlIpv6GeneralPrefixInetAddrType, rlipNetToPhysicalIsRouter=rlipNetToPhysicalIsRouter, rlInternInetStaticRouteType=rlInternInetStaticRouteType, rlInternInetCidrRouteMetric2=rlInternInetCidrRouteMetric2, rlIpv6RouterAdvertTable=rlIpv6RouterAdvertTable, rlipv6InetCidrTableClear=rlipv6InetCidrTableClear, rlInternInetCidrRouteDest=rlInternInetCidrRouteDest, rlinetCidrRouteTable=rlinetCidrRouteTable, rlIpv6RouterAdvertPrefixInetAddrType=rlIpv6RouterAdvertPrefixInetAddrType, rlipv6MaximumHopsNumber=rlipv6MaximumHopsNumber, rlInternInetCidrRouteNextHop=rlInternInetCidrRouteNextHop, rlIpv6RouterAdvertPrefixInetAddrPrefixLength=rlIpv6RouterAdvertPrefixInetAddrPrefixLength, rlIpv6RouterAdvertPrefixRowStatus=rlIpv6RouterAdvertPrefixRowStatus, rlIpv6GeneralPrefixRowStatus=rlIpv6GeneralPrefixRowStatus, rlIpv6RouterAdvertPrefixIsDefault=rlIpv6RouterAdvertPrefixIsDefault, rlInetStaticRouteType=rlInetStaticRouteType, rlInternInetCidrRouteLifetime=rlInternInetCidrRouteLifetime, rlInetStaticRouteIfIndex=rlInetStaticRouteIfIndex, rlInternInetCidrRouteStatus=rlInternInetCidrRouteStatus, rlInternInetStaticRouteOwner=rlInternInetStaticRouteOwner, rlipv6InterfaceLinkMTU=rlipv6InterfaceLinkMTU, rlInetStaticRouteDestType=rlInetStaticRouteDestType, rlIpv6HostForwardingPathCost=rlIpv6HostForwardingPathCost, rlInternInetCidrRoutePfxLen=rlInternInetCidrRoutePfxLen, rlInternInetCidrRouteNextHopAS=rlInternInetCidrRouteNextHopAS, rlIpNetToPhysicalTableClearEntry=rlIpNetToPhysicalTableClearEntry, rlIpv6HostForwardingEntry=rlIpv6HostForwardingEntry, rlInetStaticRouteEntry=rlInetStaticRouteEntry, rlIpv6RouterAdvertPrefixAdminStatus=rlIpv6RouterAdvertPrefixAdminStatus, rlIpv6HostForwardingNextHop=rlIpv6HostForwardingNextHop, rlIpv6HostForwardingPfxLen=rlIpv6HostForwardingPfxLen, rlIpv6RouterAdvertPrefixIfIndex=rlIpv6RouterAdvertPrefixIfIndex, rlipv6InterfaceNdDadAttemps=rlipv6InterfaceNdDadAttemps, rlInternInetCidrRouteProto=rlInternInetCidrRouteProto, rlInternInetCidrRouteEntry=rlInternInetCidrRouteEntry, rlipv6IcmpErrorRatelimitBucketSize=rlipv6IcmpErrorRatelimitBucketSize, rlIpv6PathMtuEntryInetDestAddr=rlIpv6PathMtuEntryInetDestAddr, rlIpv6GeneralPrefixInterfaceId=rlIpv6GeneralPrefixInterfaceId, rlInternInetStaticRouteDest=rlInternInetStaticRouteDest, rlInetRoutingDistanceTable=rlInetRoutingDistanceTable, rlIpv6HostForwardingNextHopType=rlIpv6HostForwardingNextHopType, rlInetRoutingDistanceType=rlInetRoutingDistanceType, rlInternInetStaticRoutePathCost=rlInternInetStaticRoutePathCost, rlManagementIpv6Action=rlManagementIpv6Action, rlInetRoutingDistanceRip=rlInetRoutingDistanceRip, rlInetRoutingDistanceOspfExternal=rlInetRoutingDistanceOspfExternal, rlIpv6PathMtuEntry=rlIpv6PathMtuEntry, rlManagementIpv6=rlManagementIpv6, rlIpv6PathMtuEntryMtu=rlIpv6PathMtuEntryMtu, rlInternInetCidrRouteTable=rlInternInetCidrRouteTable, rlIpv6HostForwardingTable=rlIpv6HostForwardingTable, rlIpNetToPhysicalTableClearIfIndex=rlIpNetToPhysicalTableClearIfIndex, rlipNetToPhysicalEntry=rlipNetToPhysicalEntry, rlinetCidrRouteEntry=rlinetCidrRouteEntry, rlInternInetStaticRouteDestType=rlInternInetStaticRouteDestType, rlipv6InterfaceEntry=rlipv6InterfaceEntry, rlIpv6RouterAdvertPrefixTable=rlIpv6RouterAdvertPrefixTable, rlinetCidrRouteInfo=rlinetCidrRouteInfo, rlInternInetCidrRouteMetric1=rlInternInetCidrRouteMetric1, rlipv6IcmpErrorRatelimitInterval=rlipv6IcmpErrorRatelimitInterval)
