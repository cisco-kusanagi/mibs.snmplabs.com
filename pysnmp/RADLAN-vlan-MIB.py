...
VlanList4, VlanList3, VlanList1, VlanList2 = mibBuilder.importSymbols("RADLAN-BRIDGEMIBOBJECTS-MIB", "VlanList4", "VlanList3", "VlanList1", "VlanList2")
...
mibBuilder.exportSymbols("RADLAN-vlan-MIB", vlanSubnetPortEntry=vlanSubnetPortEntry, vlanVoiceRowStatus=vlanVoiceRowStatus, vlanInetTriplePlayTable=vlanInetTriplePlayTable, vlanPortModeContextTable=vlanPortModeContextTable, vlanSpecialTagCurrentEntry=vlanSpecialTagCurrentEntry, vlanSpecialTagStatus=vlanSpecialTagStatus, vlanVoicePortEntry=vlanVoicePortEntry, vlanSubnetRangeGroupId=vlanSubnetRangeGroupId, vlanTrunkModeList1025to2048=vlanTrunkModeList1025to2048, vlanPortModeExtStatus=vlanPortModeExtStatus, vlanPrivateMapSecondaryOperPorts=vlanPrivateMapSecondaryOperPorts, rlPortVlanTriplePlayMulticastTvEntry=rlPortVlanTriplePlayMulticastTvEntry, rldot1qPortVlanStaticUntaggedEgressList2049to3072=rldot1qPortVlanStaticUntaggedEgressList2049to3072, vlanDynamicVlanStatus=vlanDynamicVlanStatus, vlanPrivateEdgeGroupIfIndexDomainID=vlanPrivateEdgeGroupIfIndexDomainID, vlanInetTriplePlayMulticastTvTable=vlanInetTriplePlayMulticastTvTable, rldot1qPortVlanStaticTable=rldot1qPortVlanStaticTable, vlanMulticastTvStatus=vlanMulticastTvStatus, vlanCustomerPortModeMtvList3073to4094=vlanCustomerPortModeMtvList3073to4094, vlanPrivateEdgeVersion=vlanPrivateEdgeVersion, vlanRsvlMapEntry=vlanRsvlMapEntry, rldot1qPortVlanStaticForbiddenList1to1024=rldot1qPortVlanStaticForbiddenList1to1024, vlanTrunkModeList2049to3072=vlanTrunkModeList2049to3072, vlanTriplePlayInnerVID=vlanTriplePlayInnerVID, vlanPrivateEntryOld=vlanPrivateEntryOld, vlanMulticastTvEntry=vlanMulticastTvEntry, rlPortVlanTriplePlayMulticastTvList1to1024=rlPortVlanTriplePlayMulticastTvList1to1024, vlanCustomerPortModeVlanId=vlanCustomerPortModeVlanId, vlanDefaultExtManagment=vlanDefaultExtManagment, vlanSubnetRangeMask=vlanSubnetRangeMask, rldot1qVlanMembershipTypeEntry=rldot1qVlanMembershipTypeEntry, vlanPrivateSupported=vlanPrivateSupported, vlanPrivateMapStatus=vlanPrivateMapStatus, vlanTriplePlayEntry=vlanTriplePlayEntry, vlanCustomerPortModeMtvList2049to3072=vlanCustomerPortModeMtvList2049to3072, vlanMacBaseVlanGroupId=vlanMacBaseVlanGroupId, vlanTriplePlayMulticastTvMulticastTvVID=vlanTriplePlayMulticastTvMulticastTvVID, vlanSubnetPortGroupVid=vlanSubnetPortGroupVid, vlanInetTriplePlayMulticatTvEntry=vlanInetTriplePlayMulticatTvEntry, rldot1qVlanStaticList2049to3072=rldot1qVlanStaticList2049to3072, vlanSwitchPortModeEntry=vlanSwitchPortModeEntry, vlanPortModeContextEntry=vlanPortModeContextEntry, vlanDynamicVlanTable=vlanDynamicVlanTable, vlanPrivateOldIsolatedVlanTag=vlanPrivateOldIsolatedVlanTag, vlanInetTriplePlayMulticastTvMulticastTvPortList=vlanInetTriplePlayMulticastTvMulticastTvPortList, vlanMacBaseVlanPortGroupId=vlanMacBaseVlanPortGroupId, vlanPrivateEdgeGroupUplink=vlanPrivateEdgeGroupUplink, rldot1qPortVlanStaticForbiddenList2049to3072=rldot1qPortVlanStaticForbiddenList2049to3072, rlPortVlanTriplePlayMulticastTvList3073to4094=rlPortVlanTriplePlayMulticastTvList3073to4094, vlanTriplePlayMulticastTvMulticastTvPortList=vlanTriplePlayMulticastTvMulticastTvPortList, vlanTriplePlayTable=vlanTriplePlayTable, vlanPrivateCommunityEntry=vlanPrivateCommunityEntry, vlanVoicePortCurrentMembership=vlanVoicePortCurrentMembership, rldot1qPortVlanStaticEntry=rldot1qPortVlanStaticEntry, rldot1qPortVlanStaticUntaggedEgressList3073to4094=rldot1qPortVlanStaticUntaggedEgressList3073to4094, vlanSwitchPortModeCategory=vlanSwitchPortModeCategory, rlPortVlanTriplePlayMulticastTvList1025to2048=rlPortVlanTriplePlayMulticastTvList1025to2048, vlanPrivateEdgeUplink=vlanPrivateEdgeUplink, vlanPortModeExtTable=vlanPortModeExtTable, vlanVoicePriority=vlanVoicePriority, vlanVoiceOUIDescription=vlanVoiceOUIDescription, rldot1qVlanStaticListEntry=rldot1qVlanStaticListEntry, vlanSpecialTagVID=vlanSpecialTagVID, vlanVoicePortVlanIndex=vlanVoicePortVlanIndex, vlanSubnetRangeRowStatus=vlanSubnetRangeRowStatus, vlanSubnetRangeTable=vlanSubnetRangeTable, vlanInetTriplePlayMulticastTvMulticastTvVID=vlanInetTriplePlayMulticastTvMulticastTvVID, vlan=vlan, vlanPrivateVid=vlanPrivateVid, vlanPortModeContextValue=vlanPortModeContextValue, vlanTrunkPortModeTable=vlanTrunkPortModeTable, vlanPrivateMapTable=vlanPrivateMapTable, vlanDynamicVlanMacAddress=vlanDynamicVlanMacAddress, vlanMacBaseVlanMacMask=vlanMacBaseVlanMacMask, rldot1qVlanStaticListTable=rldot1qVlanStaticListTable, vlanInetTriplePlayRowStatus=vlanInetTriplePlayRowStatus, rldot1qPortVlanStaticUntaggedEgressList1025to2048=rldot1qPortVlanStaticUntaggedEgressList1025to2048, vlanMulticastTvTable=vlanMulticastTvTable, vlanVoice=vlanVoice, vlanSubnetPortTable=vlanSubnetPortTable, vlanInetTriplePlayMulticastTvVID=vlanInetTriplePlayMulticastTvVID, vlanVoicePortSecure=vlanVoicePortSecure, vlanDot1vSupported=vlanDot1vSupported, vlanVoiceOUIPrefix=vlanVoiceOUIPrefix, rldot1qPortVlanStaticEgressList3073to4094=rldot1qPortVlanStaticEgressList3073to4094, vlanVoicePortEnable=vlanVoicePortEnable, vlanPrivateMapSecondaryVid=vlanPrivateMapSecondaryVid, vlanVoiceTable=vlanVoiceTable, rlPortVlanTriplePlayMulticastTvList2049to3072=rlPortVlanTriplePlayMulticastTvList2049to3072, vlanPrivateEdgeStatus=vlanPrivateEdgeStatus, vlanPrivatePrimaryVid=vlanPrivatePrimaryVid, vlanInetTriplePlayInetAddressType=vlanInetTriplePlayInetAddressType, vlanPrivateTableOld=vlanPrivateTableOld, vlanPrivateEntry=vlanPrivateEntry, vlanAccessPortModeEntry=vlanAccessPortModeEntry, vlanRsvlMapPrimaryVid=vlanRsvlMapPrimaryVid, vlanMacBaseVlanPortGroupVid=vlanMacBaseVlanPortGroupVid, vlanVoicePortQosMode=vlanVoicePortQosMode, rldot1qVlanMembershipTypeBitmap=rldot1qVlanMembershipTypeBitmap, vlanRsvlMapSecondaryVid=vlanRsvlMapSecondaryVid, vlanAccessPortModeTable=vlanAccessPortModeTable, vlanPrivateEdgeGroupStatus=vlanPrivateEdgeGroupStatus, PYSNMP_MODULE_ID=vlan, vlanPrivateMapSecondaryPorts=vlanPrivateMapSecondaryPorts, rldot1qVlanMembershipTypeTable=rldot1qVlanMembershipTypeTable, vlanPrivateEdgeGroupSource=vlanPrivateEdgeGroupSource, vlanNameTag=vlanNameTag, vlanSwitchPortModeTable=vlanSwitchPortModeTable, vlanDefaultEnabled=vlanDefaultEnabled, vlanDefaultTaggedPorts=vlanDefaultTaggedPorts, vlanPrivateEdgeGroupTable=vlanPrivateEdgeGroupTable, vlanMacBaseVlanGroupEntry=vlanMacBaseVlanGroupEntry, rldot1qVlanStaticListIndex=rldot1qVlanStaticListIndex, vlanPrivateEdgeTable=vlanPrivateEdgeTable, vlanTriplePlayMulticatTvEntry=vlanTriplePlayMulticatTvEntry, vlanTriplePlayMulticastTvVID=vlanTriplePlayMulticastTvVID, vlanSpecialTagCurrentVID=vlanSpecialTagCurrentVID, vlanSubnetPortGroupId=vlanSubnetPortGroupId, vlanCustomerPortModeEntry=vlanCustomerPortModeEntry, rldot1qPortVlanStaticEgressList1025to2048=rldot1qPortVlanStaticEgressList1025to2048, vlanMacBaseVlanPortRowStatus=vlanMacBaseVlanPortRowStatus, vlanPrivateEdgeGroupEntry=vlanPrivateEdgeGroupEntry, vlanPrivateMapPrimaryVid=vlanPrivateMapPrimaryVid, vlanPrivateType=vlanPrivateType, vlanDynamicVlanSupported=vlanDynamicVlanSupported, vlanPrivateCommunityStatus=vlanPrivateCommunityStatus, vlanVoicePortTable=vlanVoicePortTable, rldot1qPortVlanStaticUntaggedEgressList1to1024=rldot1qPortVlanStaticUntaggedEgressList1to1024, rldot1qPortVlanStaticEgressList2049to3072=rldot1qPortVlanStaticEgressList2049to3072, vlanRsvlMapTable=vlanRsvlMapTable, vlanAsymmetricEnabled=vlanAsymmetricEnabled, rldot1qPortVlanStaticEgressList1to1024=rldot1qPortVlanStaticEgressList1to1024, vlanNameName=vlanNameName, vlanCustomerPortModeMtvList1025to2048=vlanCustomerPortModeMtvList1025to2048, vlanSpecialTagTable=vlanSpecialTagTable, vlanDynamicVlanTag=vlanDynamicVlanTag, vlanMibVersion=vlanMibVersion, vlanMacBaseVlanMacAddress=vlanMacBaseVlanMacAddress, vlanPortModeEntry=vlanPortModeEntry, vlanPrivateOldStatus=vlanPrivateOldStatus, rldot1qVlanStaticList1025to2048=rldot1qVlanStaticList1025to2048, vlanMacBaseVlanGroupTable=vlanMacBaseVlanGroupTable, vlanMulticastTvVID=vlanMulticastTvVID, vlanVoiceAgingTimeout=vlanVoiceAgingTimeout, vlanSubnetPortRowStatus=vlanSubnetPortRowStatus, vlanVoiceOUISetToDefault=vlanVoiceOUISetToDefault, vlanCustomerPortModeMtvList1to1024=vlanCustomerPortModeMtvList1to1024, vlanPrivateStatus=vlanPrivateStatus, rldot1qVlanStaticNameEntry=rldot1qVlanStaticNameEntry, vlanPortModeState=vlanPortModeState, vlanSubnetRangeEntry=vlanSubnetRangeEntry, rldot1qVlanStaticNameTable=rldot1qVlanStaticNameTable, vlanPortModeTable=vlanPortModeTable, rldot1qVlanStaticList3073to4094=rldot1qVlanStaticList3073to4094, vlanTrunkPortModeEntry=vlanTrunkPortModeEntry, vlanPrivateTable=vlanPrivateTable, vlanMacBaseVlanPortEntry=vlanMacBaseVlanPortEntry, vlanInetTriplePlayInnerVID=vlanInetTriplePlayInnerVID, vlanDynamicVlanEntry=vlanDynamicVlanEntry, vlanAccessPortModeMcstTvVlanId=vlanAccessPortModeMcstTvVlanId, vlanSubnetRangeAddr=vlanSubnetRangeAddr, vlanSendUnknownToAllPorts=vlanSendUnknownToAllPorts, vlanVoicePriorityRemark=vlanVoicePriorityRemark, vlanNameTable=vlanNameTable, vlanSpecialTagCurrentTable=vlanSpecialTagCurrentTable, vlanPrivateCommunityTable=vlanPrivateCommunityTable, vlanMaxTableNumber=vlanMaxTableNumber, vlanPrivateEdgeEntry=vlanPrivateEdgeEntry, vlanPrivateEdgeGroupIfIndexEntry=vlanPrivateEdgeGroupIfIndexEntry, vlanPrivateMapPrimaryPorts=vlanPrivateMapPrimaryPorts, vlanDefault=vlanDefault, vlanPrivateEdgeGroupIfIndexTable=vlanPrivateEdgeGroupIfIndexTable, vlanNameEntry=vlanNameEntry, vlanCustomerPortModeTable=vlanCustomerPortModeTable, vlanDefaultSupported=vlanDefaultSupported, vlanMacBaseVlanGroupRowStatus=vlanMacBaseVlanGroupRowStatus, vlanTriplePlayMulticastTvTable=vlanTriplePlayMulticastTvTable, vlanSpecialTagEntry=vlanSpecialTagEntry, vlanSpecialTagCurrentReserved=vlanSpecialTagCurrentReserved, vlanPrivateMapEntry=vlanPrivateMapEntry, rldot1qPortVlanStaticForbiddenList1025to2048=rldot1qPortVlanStaticForbiddenList1025to2048, vlanPrivateEdgeSupported=vlanPrivateEdgeSupported, rldot1qVlanStaticList1to1024=rldot1qVlanStaticList1to1024, vlanPortModeExtState=vlanPortModeExtState, vlanPortModeExtEntry=vlanPortModeExtEntry, vlanInetTriplePlayEntry=vlanInetTriplePlayEntry, vlanMacBaseVlanPortTable=vlanMacBaseVlanPortTable, vlanRsvlMapStatus=vlanRsvlMapStatus, vlanSpecialTagCurrentActive=vlanSpecialTagCurrentActive, rldot1qPortVlanStaticForbiddenList3073to4094=rldot1qPortVlanStaticForbiddenList3073to4094, vlanVoiceOUIEntry=vlanVoiceOUIEntry, vlanPrivateCommunityVlanTag=vlanPrivateCommunityVlanTag, vlanTrunkPortModeNativeVlanId=vlanTrunkPortModeNativeVlanId, vlanTrunkModeList3073to4094=vlanTrunkModeList3073to4094, vlanVoiceEntry=vlanVoiceEntry, rlPortVlanTriplePlayMulticastTvTable=rlPortVlanTriplePlayMulticastTvTable, vlanDefaultEnabledPorts=vlanDefaultEnabledPorts, vlanRsvlEnable=vlanRsvlEnable, vlanVoiceOUIEntryRowStatus=vlanVoiceOUIEntryRowStatus, vlanTriplePlayRowStatus=vlanTriplePlayRowStatus, vlanTrunkModeList1to1024=vlanTrunkModeList1to1024, rldot1qVlanStaticName=rldot1qVlanStaticName, vlanPrivateEdgeGroupIfIndexID=vlanPrivateEdgeGroupIfIndexID, vlanAccessPortModeVlanId=vlanAccessPortModeVlanId, vlanVoiceOUITable=vlanVoiceOUITable, vlanPrivateMapPrimaryOperPorts=vlanPrivateMapPrimaryOperPorts, vlanNameIfIndex=vlanNameIfIndex)
