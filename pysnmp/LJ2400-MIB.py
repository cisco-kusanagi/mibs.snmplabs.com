...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ2400-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:04 2019
...
Counter64, TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, NotificationType, ModuleIdentity, iso, MibIdentifier, ObjectIdentity, Bits, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "NotificationType", "ModuleIdentity", "iso", "MibIdentifier", "ObjectIdentity", "Bits", "Gauge32", "Counter32")
...
mibBuilder.exportSymbols("LJ2400-MIB", channel=channel, default_bits_per_pixel=default_bits_per_pixel, service_id=service_id, channelinformation=channelinformation, held_job_quantity=held_job_quantity, error14_code=error14_code, media1_page_count=media1_page_count, error9_code=error9_code, error23_code=error23_code, media19_name=media19_name, media16=media16, error47_time_stamp=error47_time_stamp, cancel_job=cancel_job, file_system2=file_system2, error47_code=error47_code, tray1_media_size_loaded=tray1_media_size_loaded, error4_time_stamp=error4_time_stamp, intray2=intray2, error16=error16, job_info_pages_in_original=job_info_pages_in_original, background_message=background_message, destination_subsystem=destination_subsystem, tables=tables, error43_code=error43_code, media11_short_name=media11_short_name, time_display=time_display, source_tray_accounting=source_tray_accounting, media10_short_name=media10_short_name, held_job_info=held_job_info, job_info_accounting_finishing_options=job_info_accounting_finishing_options, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, intray3=intray3, simm3_bank1=simm3_bank1, job_info_attr_12=job_info_attr_12, destination_bin_usage_total=destination_bin_usage_total, media15_page_count=media15_page_count, media7_name=media7_name, default_horizontal_black_resolution=default_horizontal_black_resolution, held_job_set_queue_size=held_job_set_queue_size, simm1=simm1, channel_bytes_received=channel_bytes_received, port1_parallel_bidirectionality=port1_parallel_bidirectionality, source_tray_usage_count=source_tray_usage_count, error20_code=error20_code, simm3_capacity=simm3_capacity, simm5=simm5, localization_countries_supported=localization_countries_supported, error3_time_stamp=error3_time_stamp, media8_engine_media_mode=media8_engine_media_mode, test=test, job_info_attr_2=job_info_attr_2, upgradable_devices_version=upgradable_devices_version, channelnumberofchannels=channelnumberofchannels, device_system=device_system, error16_code=error16_code, job_info_attr_1=job_info_attr_1, asset_number=asset_number, usage_instructions_line4=usage_instructions_line4, media19=media19, media18_engine_media_mode=media18_engine_media_mode, control_panel_display_graphical_contents=control_panel_display_graphical_contents, consumable_string_information=consumable_string_information, media5_page_count=media5_page_count, simm5_type=simm5_type, processing_subsystem=processing_subsystem, job_info_pages_printed=job_info_pages_printed, tray1_phd=tray1_phd, pdl=pdl, channel_bytes_sent=channel_bytes_sent, error50=error50, fw_rom_datecode=fw_rom_datecode, media14_name=media14_name, errorlog=errorlog, consumable_current_state=consumable_current_state, north_edge_offset=north_edge_offset, consumable_status=consumable_status, error26_code=error26_code, media_info=media_info, consumables=consumables, error35_time_stamp=error35_time_stamp, media2_page_count=media2_page_count, printed_modes_accounting=printed_modes_accounting, mio1=mio1, held_job_pin=held_job_pin, firmware_download_version=firmware_download_version, media17_page_count=media17_page_count, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, mio3_type=mio3_type, error14=error14, tray2_phd=tray2_phd, consumable_status_manufacturer_name=consumable_status_manufacturer_name, consumable_life_low_threshold=consumable_life_low_threshold, media10_page_count=media10_page_count, file_system_max_open_files=file_system_max_open_files, error49=error49, default_page_protect=default_page_protect, upgradable_devices_write_time=upgradable_devices_write_time, error30_time_stamp=error30_time_stamp, control_panel_button_press=control_panel_button_press, error35_code=error35_code, settings_system=settings_system, upgradable_devices_write_count=upgradable_devices_write_count, error41=error41, simm1_bank2_type=simm1_bank2_type, hold_job_timeout=hold_job_timeout, media9_engine_media_mode=media9_engine_media_mode, consumable_status_drum_life_units=consumable_status_drum_life_units, usage_instructions_line2=usage_instructions_line2, job_info_change_id=job_info_change_id, error48_code=error48_code, upgradable_devices_current_state=upgradable_devices_current_state, print_media=print_media, error13_time_stamp=error13_time_stamp, error38=error38, media2_engine_media_mode=media2_engine_media_mode, port1_parallel_speed=port1_parallel_speed, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, job_info_name2=job_info_name2, background_status_msg_line2_part1=background_status_msg_line2_part1, media11_name=media11_name, media18_page_count=media18_page_count, error44_time_stamp=error44_time_stamp, error32_code=error32_code, channelifindex=channelifindex, error42=error42, media17_short_name=media17_short_name, media_number_of_type_supported=media_number_of_type_supported, error44=error44, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, error35=error35, simm4_bank=simm4_bank, error10_time_stamp=error10_time_stamp, error31_time_stamp=error31_time_stamp, mio2_type=mio2_type, consumable_status_capacity_units=consumable_status_capacity_units, file_system_wipe_disk=file_system_wipe_disk, error17_code=error17_code, error9=error9, simm5_bank2_capacity=simm5_bank2_capacity, media12_engine_media_mode=media12_engine_media_mode, background_status_msg_line1_part1=background_status_msg_line1_part1, error6_code=error6_code, error36=error36, error44_code=error44_code, error18=error18, job_info_physical_outbins_used=job_info_physical_outbins_used, file_system=file_system, out_marking_agent_processing=out_marking_agent_processing, error49_code=error49_code, settings_rpc=settings_rpc, simm2_bank1=simm2_bank1, mio2=mio2, printed_modes_usage_total=printed_modes_usage_total, default_custom_paper_dim_unit=default_custom_paper_dim_unit, media_size_count=media_size_count, webserver_proc_sub=webserver_proc_sub, error7_time_stamp=error7_time_stamp, media12_short_name=media12_short_name, error13=error13, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, error39=error39, printed_media_combined_total=printed_media_combined_total, error33_time_stamp=error33_time_stamp, channel_jobs_received=channel_jobs_received, simm2_bank=simm2_bank, outbin1=outbin1, consumables_life=consumables_life, held_job_print=held_job_print, error47=error47, error30_code=error30_code, marker_density_calibration=marker_density_calibration, media13_engine_media_mode=media13_engine_media_mode, pjl=pjl, mass_storage_block_driver=mass_storage_block_driver, mio1_type=mio1_type, simm4_bank2_capacity=simm4_bank2_capacity, file_system3_initialize_volume=file_system3_initialize_volume, accounting=accounting, sleep_mode=sleep_mode, usage_average_toner_coverage=usage_average_toner_coverage, consumable_status_manufacturing_date=consumable_status_manufacturing_date, error22_code=error22_code, non_assured_oht_page_count=non_assured_oht_page_count, error22_time_stamp=error22_time_stamp, error31=error31, override_media_size=override_media_size, upgradable_devices_name=upgradable_devices_name, pdl_pcl=pdl_pcl, media_types=media_types, media14_page_count=media14_page_count, job_info_printed_originals=job_info_printed_originals, upgradable_devices=upgradable_devices, settings_file_system=settings_file_system, rpc_bind_protocol_address=rpc_bind_protocol_address, error28=error28, web_server_security=web_server_security, media17=media17, job_info_attr_4=job_info_attr_4, model_name=model_name, status_mass_storage_bd=status_mass_storage_bd, media16_engine_media_mode=media16_engine_media_mode, status_pdl=status_pdl, active_print_jobs=active_print_jobs, job_info_io_source=job_info_io_source, default_vmi=default_vmi, rpc_bound_protocol_address=rpc_bound_protocol_address, firmware_download_current_state=firmware_download_current_state, error36_time_stamp=error36_time_stamp, job_info_attr_16=job_info_attr_16, media17_name=media17_name, job_info_attr_11=job_info_attr_11, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, job_info_accounting_black_dots=job_info_accounting_black_dots, media7_page_count=media7_page_count, simm4_capacity=simm4_capacity, error6_time_stamp=error6_time_stamp, outbins=outbins, error8=error8, error37_code=error37_code, job_info_pages_processed=job_info_pages_processed, job_info_outbins_used=job_info_outbins_used, channel_io_errors=channel_io_errors, mio1_model_name=mio1_model_name, mio2_manufacturing_info=mio2_manufacturing_info, error46_time_stamp=error46_time_stamp, control_panel_display_contents_crc=control_panel_display_contents_crc, media9_name=media9_name, job_info_attr_5=job_info_attr_5, consumable_status_page_count_b5_executive=consumable_status_page_count_b5_executive, error3_code=error3_code, job_info_accounting_media_type=job_info_accounting_media_type, media8_short_name=media8_short_name, error48=error48, job_info_stage=job_info_stage, date_and_time=date_and_time, error42_time_stamp=error42_time_stamp, media6_name=media6_name, firmware_download_maximum_write_count=firmware_download_maximum_write_count, consumable_status_page_count_a4_letter=consumable_status_page_count_a4_letter, error7=error7, show_address=show_address, held_job_control=held_job_control, io=io, device_configure_printer_parameters=device_configure_printer_parameters, socket_ping=socket_ping, consumable_status_page_count_xy_other=consumable_status_page_count_xy_other, error46_code=error46_code, duplex_page_count=duplex_page_count, printer_average_marking_agent_coverage_sum=printer_average_marking_agent_coverage_sum, error22=error22, media10=media10, socket_ping_job_events_version=socket_ping_job_events_version, media10_name=media10_name)
mibBuilder.exportSymbols("LJ2400-MIB", channelTable=channelTable, media1=media1, simm5_bank1_type=simm5_bank1_type, job_input_auto_continue_mode=job_input_auto_continue_mode, device=device, error24=error24, intray1=intray1, settings_spooler=settings_spooler, media13_page_count=media13_page_count, error14_time_stamp=error14_time_stamp, job_info_state=job_info_state, mio3_manufacturing_info=mio3_manufacturing_info, job_info_attr_6=job_info_attr_6, error12_code=error12_code, marking_agent_density_setting=marking_agent_density_setting, printed_media_total_charge=printed_media_total_charge, error18_code=error18_code, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, page_frame_memory_available=page_frame_memory_available, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, simm4_bank2=simm4_bank2, settings_job=settings_job, settings_print_media=settings_print_media, maximum_ram_disk_memory=maximum_ram_disk_memory, media4_name=media4_name, engine_media_modes_supported1=engine_media_modes_supported1, error38_code=error38_code, media14=media14, simm1_bank1_type=simm1_bank1_type, error13_code=error13_code, job_info_accounting=job_info_accounting, simm1_bank=simm1_bank, consumable_status_info=consumable_status_info, media8_name=media8_name, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, error12=error12, error39_time_stamp=error39_time_stamp, simm2_type=simm2_type, pcl_default_font_width=pcl_default_font_width, input_tray_auto_select=input_tray_auto_select, os_execute_file=os_execute_file, error45=error45, error1_time_stamp=error1_time_stamp, held_job_user_name=held_job_user_name, error28_code=error28_code, error50_code=error50_code, pcl_default_font_number=pcl_default_font_number, error26=error26, consumables_1=consumables_1, DisplayString=DisplayString, model_number=model_number, usage_instructions_line1=usage_instructions_line1, media2_name=media2_name, PYSNMP_MODULE_ID=hp, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, media15_name=media15_name, destination_bin_accounting=destination_bin_accounting, printed_media_simplex_charge=printed_media_simplex_charge, job_info_requested_originals=job_info_requested_originals, media3_name=media3_name, job_info_attr_3=job_info_attr_3, error11_code=error11_code, job_info_accounting_job_type=job_info_accounting_job_type, file_system_external_access_capabilities=file_system_external_access_capabilities, install_date=install_date, form_feed=form_feed, job_info_attr_9=job_info_attr_9, consumable_reorder_url=consumable_reorder_url, media11=media11, consumable_string_information_reset=consumable_string_information_reset, media13_name=media13_name, error32=error32, simm2_bank2=simm2_bank2, error24_time_stamp=error24_time_stamp, media5_engine_media_mode=media5_engine_media_mode, media14_short_name=media14_short_name, consumable_status_first_install_date=consumable_status_first_install_date, media12=media12, error37_time_stamp=error37_time_stamp, job_info_outcome=job_info_outcome, media8_page_count=media8_page_count, error19_code=error19_code, hp=hp, mass_storage_resource_changed=mass_storage_resource_changed, error41_code=error41_code, simm1_type=simm1_type, media13=media13, job=job, printed_media_dimplex_count=printed_media_dimplex_count, simm3_bank=simm3_bank, error31_code=error31_code, error25_code=error25_code, error34_code=error34_code, printer_average=printer_average, media_names_available=media_names_available, error21_code=error21_code, error23=error23, media14_engine_media_mode=media14_engine_media_mode, channelprinteralert=channelprinteralert, error15_time_stamp=error15_time_stamp, error17=error17, error1_code=error1_code, intray=intray, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, error9_time_stamp=error9_time_stamp, outbin1_override_mode=outbin1_override_mode, mass_storage_resource_change_counter=mass_storage_resource_change_counter, remote_upgrade_enable=remote_upgrade_enable, settings_io=settings_io, error5_time_stamp=error5_time_stamp, error29_time_stamp=error29_time_stamp, print_meter=print_meter, error23_time_stamp=error23_time_stamp, default_custom_paper_feed_dim=default_custom_paper_feed_dim, consumable_status_engine_usage_units=consumable_status_engine_usage_units, simm1_bank1=simm1_bank1, error48_time_stamp=error48_time_stamp, consumable_status_oem_name=consumable_status_oem_name, error6=error6, media1_short_name=media1_short_name, file_system4=file_system4, netPMLmgmt=netPMLmgmt, media_modes=media_modes, simm5_bank1_capacity=simm5_bank1_capacity, error10_code=error10_code, held_job=held_job, spooler=spooler, error11=error11, simm1_bank2=simm1_bank2, error42_code=error42_code, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, error3=error3, error38_time_stamp=error38_time_stamp, job_info_attr_7=job_info_attr_7, marking_agent_density=marking_agent_density, simm2_bank2_capacity=simm2_bank2_capacity, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, default_lines_per_page=default_lines_per_page, engine_self_diagnostic=engine_self_diagnostic, background_message1=background_message1, pcl_default_font_height=pcl_default_font_height, collated_originals_support=collated_originals_support, media5_name=media5_name, error25_time_stamp=error25_time_stamp, error7_code=error7_code, error36_code=error36_code, error45_time_stamp=error45_time_stamp, simm3_type=simm3_type, simm2=simm2, media2_short_name=media2_short_name, file_system_delete_files=file_system_delete_files, operating_system=operating_system, error10=error10, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, mass_storage_resources=mass_storage_resources, usage_staple_count=usage_staple_count, channelstatus=channelstatus, intrays=intrays, error40_code=error40_code, error20_time_stamp=error20_time_stamp, simm5_bank=simm5_bank, simm4=simm4, error27_time_stamp=error27_time_stamp, default_copies=default_copies, pcl_default_font_source=pcl_default_font_source, date_display=date_display, error11_time_stamp=error11_time_stamp, mio2_model_name=mio2_model_name, channelprotocolversion=channelprotocolversion, error43=error43, error39_code=error39_code, error17_time_stamp=error17_time_stamp, media18_name=media18_name, media19_page_count=media19_page_count, energy_star=energy_star, background_message2=background_message2, channelstate=channelstate, cold_reset_media_size=cold_reset_media_size, printer_average_marking_agent_coverage_sum_squared=printer_average_marking_agent_coverage_sum_squared, status_system=status_system, interface=interface, marking_agent=marking_agent, printed_media_usage=printed_media_usage, pcl_total_page_count=pcl_total_page_count, print_engine_revision=print_engine_revision, on_off_line=on_off_line, error19=error19, media6_short_name=media6_short_name, channeltype=channeltype, tray3_phd=tray3_phd, file_system2_initialize_volume=file_system2_initialize_volume, simm4_bank1=simm4_bank1, file_system4_initialize_volume=file_system4_initialize_volume, error21_time_stamp=error21_time_stamp, media2=media2, media4=media4, upgradable_devices_max_write_count=upgradable_devices_max_write_count, simm1_bank2_capacity=simm1_bank2_capacity, error2_time_stamp=error2_time_stamp, media4_engine_media_mode=media4_engine_media_mode, firmware_download_name=firmware_download_name, media10_engine_media_mode=media10_engine_media_mode, simm4_type=simm4_type, simm5_capacity=simm5_capacity, auto_continue=auto_continue, file_systems=file_systems, simm1_capacity=simm1_capacity, error8_time_stamp=error8_time_stamp, simm4_bank2_type=simm4_bank2_type, held_job_job_name=held_job_job_name, consumable_status_usage_units=consumable_status_usage_units, consumable_status_job_count=consumable_status_job_count, error49_time_stamp=error49_time_stamp, override_media_name=override_media_name, display=display, media5_short_name=media5_short_name, media4_page_count=media4_page_count, media_counts=media_counts, printed_modes_usage=printed_modes_usage, media9_short_name=media9_short_name, status_prt_eng=status_prt_eng, localization_languages_supported=localization_languages_supported, pdl_postscript=pdl_postscript, error50_time_stamp=error50_time_stamp, error29_code=error29_code, settings_prt_eng=settings_prt_eng, job_input_auto_continue_timeout=job_input_auto_continue_timeout, error33_code=error33_code, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, control_panel_display=control_panel_display, error20=error20, media7_engine_media_mode=media7_engine_media_mode, error8_code=error8_code, outbin=outbin, serial_number=serial_number, consumable_status_authentication=consumable_status_authentication, firmware_download_write_count=firmware_download_write_count, error19_time_stamp=error19_time_stamp, held_job_retention=held_job_retention, device_name=device_name, pysmi_continue=pysmi_continue, firmware_download_write_time=firmware_download_write_time, settings_marking_agent=settings_marking_agent, settings_outbin=settings_outbin, settings_intray=settings_intray, error45_code=error45_code, media18_short_name=media18_short_name, consumable_status_page_count_legal=consumable_status_page_count_legal, ram_disk_size=ram_disk_size, error24_code=error24_code, error34_time_stamp=error34_time_stamp, io_timeout=io_timeout, tray_prompt=tray_prompt)
mibBuilder.exportSymbols("LJ2400-MIB", firmware_download=firmware_download, media3_engine_media_mode=media3_engine_media_mode, media6_engine_media_mode=media6_engine_media_mode, simm3_bank2_type=simm3_bank2_type, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, error43_time_stamp=error43_time_stamp, perm_store_init_occurred=perm_store_init_occurred, file_system_wipe_disk_status=file_system_wipe_disk_status, settings_pdl=settings_pdl, simm2_capacity=simm2_capacity, media1_name=media1_name, consumable_status_usage_count=consumable_status_usage_count, display_status=display_status, printed_modes_total_count=printed_modes_total_count, consumables_status=consumables_status, file_system3=file_system3, printed_media_duplex_charge=printed_media_duplex_charge, consumable_status_total_capacity=consumable_status_total_capacity, error28_time_stamp=error28_time_stamp, media15=media15, simm5_bank1=simm5_bank1, current_job_parsing_id=current_job_parsing_id, destination_bin_usage=destination_bin_usage, held_job_security=held_job_security, error30=error30, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, mopy_mode=mopy_mode, media15_short_name=media15_short_name, printer_accounting=printer_accounting, media3_short_name=media3_short_name, media13_short_name=media13_short_name, self_test=self_test, error32_time_stamp=error32_time_stamp, error18_time_stamp=error18_time_stamp, media12_page_count=media12_page_count, job_info_attr_15=job_info_attr_15, mio=mio, mio3_model_name=mio3_model_name, id=id, printed_media_simplex_count=printed_media_simplex_count, overflow_bin=overflow_bin, error25=error25, ram_disk_mode=ram_disk_mode, error4=error4, manually_feed_prompt_test=manually_feed_prompt_test, media17_engine_media_mode=media17_engine_media_mode, simm3_bank1_type=simm3_bank1_type, default_vertical_black_resolution=default_vertical_black_resolution, usage_instructions_line3=usage_instructions_line3, resource_manager=resource_manager, error27_code=error27_code, error34=error34, simm2_bank2_type=simm2_bank2_type, media3=media3, consumable_status_drum_life=consumable_status_drum_life, file_system_erase_mode=file_system_erase_mode, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, media11_engine_media_mode=media11_engine_media_mode, consumable_string=consumable_string, held_job_enable=held_job_enable, media4_short_name=media4_short_name, usage_printer_total_charge=usage_printer_total_charge, media_size=media_size, error16_time_stamp=error16_time_stamp, device_configure=device_configure, status_rpc=status_rpc, job_info_accounting_media_size=job_info_accounting_media_size, media5=media5, media19_short_name=media19_short_name, firmware_download_write_status_supported=firmware_download_write_status_supported, error29=error29, error2=error2, job_info=job_info, channelEntry=channelEntry, job_info_attr_13=job_info_attr_13, settings_webserver=settings_webserver, fw_rom_revision=fw_rom_revision, mio1_manufacturing_info=mio1_manufacturing_info, ports=ports, media3_page_count=media3_page_count, media15_engine_media_mode=media15_engine_media_mode, media12_name=media12_name, media16_name=media16_name, job_info_attr_10=job_info_attr_10, clearable_warning=clearable_warning, error15=error15, media7=media7, job_output_auto_continue_timeout=job_output_auto_continue_timeout, media1_engine_media_mode=media1_engine_media_mode, job_info_size=job_info_size, postscript_print_errors=postscript_print_errors, job_info_attr_14=job_info_attr_14, held_job_delete=held_job_delete, host_application_available_memory=host_application_available_memory, job_being_parsed=job_being_parsed, default_media_name=default_media_name, settings_mass_storage_bd=settings_mass_storage_bd, media16_short_name=media16_short_name, error5_code=error5_code, simm5_bank2=simm5_bank2, error21=error21, error40_time_stamp=error40_time_stamp, source_subsystem=source_subsystem, media7_short_name=media7_short_name, default_media_size=default_media_size, error1=error1, source_tray_usage=source_tray_usage, channel_mio=channel_mio, consumable_life_usage_units=consumable_life_usage_units, low_marking_agent_processing=low_marking_agent_processing, form_feed_needed=form_feed_needed, print_internal_page=print_internal_page, simm2_bank1_capacity=simm2_bank1_capacity, job_info_page_count_current_original=job_info_page_count_current_original, error15_code=error15_code, media6_page_count=media6_page_count, deviceChannelEntry=deviceChannelEntry, error2_code=error2_code, device_location=device_location, simm=simm, error26_time_stamp=error26_time_stamp, error40=error40, simm4_bank1_capacity=simm4_bank1_capacity, mio3=mio3, simm2_bank1_type=simm2_bank1_type, error41_time_stamp=error41_time_stamp, error37=error37, source_tray_usage_total=source_tray_usage_total, job_info_attribute=job_info_attribute, port1=port1, file_system_security_access_password=file_system_security_access_password, error_log_clear=error_log_clear, consumable_status_last_use_date=consumable_status_last_use_date, simm4_bank1_type=simm4_bank1_type, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, error12_time_stamp=error12_time_stamp, media18=media18, remote_procedure_call=remote_procedure_call, media6=media6, media11_page_count=media11_page_count, tray3_media_size_loaded=tray3_media_size_loaded, media9_page_count=media9_page_count, timestamp=timestamp, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, postscript_total_page_count=postscript_total_page_count, media8=media8, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, io_switch=io_switch, simm3_bank2_capacity=simm3_bank2_capacity, error46=error46, simm1_bank1_capacity=simm1_bank1_capacity, error33=error33, media16_page_count=media16_page_count, media9=media9, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, error5=error5, error27=error27, tray2_media_size_loaded=tray2_media_size_loaded, printed_media_duplex_count=printed_media_duplex_count, print_engine=print_engine, simm5_bank2_type=simm5_bank2_type, simm3_bank2=simm3_bank2, simm3_bank1_capacity=simm3_bank1_capacity, job_info_attr_8=job_info_attr_8, consumable_status_cartridge_model=consumable_status_cartridge_model, consumable_status_serial_number=consumable_status_serial_number, simm3=simm3, destination_bin_usage_count=destination_bin_usage_count, consumable_status_engine_usage_count=consumable_status_engine_usage_count, reprint=reprint, job_info_name1=job_info_name1, error4_code=error4_code, deviceChannelTable=deviceChannelTable)
