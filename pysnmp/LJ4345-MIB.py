...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ4345-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:20 2019
...
ModuleIdentity, Unsigned32, Counter64, iso, Integer32, IpAddress, TimeTicks, Gauge32, Bits, NotificationType, Counter32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "Counter64", "iso", "Integer32", "IpAddress", "TimeTicks", "Gauge32", "Bits", "NotificationType", "Counter32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("LJ4345-MIB", background_status_msg_line3_part1=background_status_msg_line3_part1, usb_interface=usb_interface, simm2_bank2_capacity=simm2_bank2_capacity, error21_date_time=error21_date_time, error26_code=error26_code, media9_short_name=media9_short_name, media9=media9, media19_engine_media_mode=media19_engine_media_mode, printed_media_duplex_charge=printed_media_duplex_charge, mass_storage_resource_changed=mass_storage_resource_changed, simm1_bank1_type=simm1_bank1_type, default_copier_contrast=default_copier_contrast, source_tray_usage=source_tray_usage, error49_time_stamp=error49_time_stamp, media18_page_count=media18_page_count, default_scan_job_mode=default_scan_job_mode, media15_page_count=media15_page_count, job_info_size=job_info_size, media26_page_count=media26_page_count, default_copy_output_bin=default_copy_output_bin, media25_short_name=media25_short_name, phd2_type=phd2_type, job_info_accounting_scanned_media_duplex_count=job_info_accounting_scanned_media_duplex_count, media14_engine_media_mode=media14_engine_media_mode, error11_time_stamp=error11_time_stamp, source_tray_usage_total=source_tray_usage_total, media4_short_name=media4_short_name, job_info_pages_processed=job_info_pages_processed, settings_webserver=settings_webserver, error50_code=error50_code, default_page_protect=default_page_protect, media_modes=media_modes, ram_disk_mode=ram_disk_mode, media2_engine_media_mode=media2_engine_media_mode, error9=error9, supply_after_out_state=supply_after_out_state, background_status_msg_higher_priority=background_status_msg_higher_priority, non_assured_oht_page_count=non_assured_oht_page_count, media17_page_count=media17_page_count, error36_time_stamp=error36_time_stamp, error39_code=error39_code, printer_cal_dhalf_utc=printer_cal_dhalf_utc, media2_page_count=media2_page_count, media22_page_count=media22_page_count, phd2=phd2, file_system3=file_system3, scanned_media_usage=scanned_media_usage, error2_date_time=error2_date_time, media17=media17, override_media_size=override_media_size, media1_engine_media_mode=media1_engine_media_mode, media5_name=media5_name, supply_out_device_state=supply_out_device_state, scanner_accessory_digital_send_status=scanner_accessory_digital_send_status, finisher_image_rotation=finisher_image_rotation, media3_engine_media_mode=media3_engine_media_mode, printer_calibration_cpr=printer_calibration_cpr, printed_media_usage=printed_media_usage, media14_page_count=media14_page_count, simm1_capacity=simm1_capacity, total_color_page_count=total_color_page_count, auto_continue=auto_continue, error48_time_stamp=error48_time_stamp, media7_short_name=media7_short_name, media18_engine_media_mode=media18_engine_media_mode, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, file_system4_initialize_volume=file_system4_initialize_volume, error44_time_stamp=error44_time_stamp, marker_density_calibration=marker_density_calibration, media4_name=media4_name, active_print_jobs=active_print_jobs, error46_code=error46_code, overflow_bin=overflow_bin, error16_code=error16_code, error32=error32, media9_name=media9_name, error15_code=error15_code, default_copier_pages_per_sheet=default_copier_pages_per_sheet, background_message4=background_message4, job_info_attr_1=job_info_attr_1, error46=error46, device=device, printer_cal_dhalf_data=printer_cal_dhalf_data, print_engine=print_engine, media15_name=media15_name, source_tray_usage_count=source_tray_usage_count, default_copier_media_size=default_copier_media_size, mio1_model_name=mio1_model_name, clearable_warning=clearable_warning, pcl_default_font_width=pcl_default_font_width, file_system2=file_system2, copier=copier, simm2_bank2=simm2_bank2, media3_short_name=media3_short_name, simm1_bank1=simm1_bank1, media10_short_name=media10_short_name, media11_short_name=media11_short_name, printer_accounting=printer_accounting, tray7_media_size_loaded=tray7_media_size_loaded, copier_media_type=copier_media_type, serial_number=serial_number, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, media12=media12, error14_date_time=error14_date_time, error18_date_time=error18_date_time, error22_code=error22_code, ports=ports, error19_time_stamp=error19_time_stamp, install_date=install_date, media14_short_name=media14_short_name, error4_date_time=error4_date_time, error25_time_stamp=error25_time_stamp, simm1_bank2_capacity=simm1_bank2_capacity, error31=error31, upgradable_devices_write_time=upgradable_devices_write_time, error27=error27, printed_modes_accounting=printed_modes_accounting, job_info=job_info, media3=media3, default_scan_content_orientation=default_scan_content_orientation, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, error35_code=error35_code, media23_name=media23_name, job=job, consumable_maintenance_interval=consumable_maintenance_interval, job_info_accounting=job_info_accounting, engine_media_modes_supported1=engine_media_modes_supported1, io_switch=io_switch, media18=media18, service_id=service_id, settings_marking_agent=settings_marking_agent, printed_modes_usage_total=printed_modes_usage_total, control_panel_button_press=control_panel_button_press, error33_code=error33_code, cold_reset_media_size=cold_reset_media_size, job_info_accounting_media_size=job_info_accounting_media_size, source_tray_accounting=source_tray_accounting, background_status_msg_line2_part1=background_status_msg_line2_part1, fw_rom_revision=fw_rom_revision, error37=error37, intrays=intrays, intray3=intray3, printer_average=printer_average, io_timeout=io_timeout, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, error13_date_time=error13_date_time, tray6_media_size_loaded=tray6_media_size_loaded, error18=error18, error13=error13, marking_agent_shadows_density_setting=marking_agent_shadows_density_setting, error3=error3, control_panel_display_contents_crc=control_panel_display_contents_crc, control_panel_key_press=control_panel_key_press, outbins=outbins, printer_cal_cpr_data=printer_cal_cpr_data, media5=media5, mio1_type=mio1_type, job_info_attribute=job_info_attribute, usb=usb, error2_time_stamp=error2_time_stamp, error5=error5, job_info_attr_13=job_info_attr_13, error30_time_stamp=error30_time_stamp, usage_average_toner_coverage=usage_average_toner_coverage, media12_name=media12_name, media21_page_count=media21_page_count, error45_time_stamp=error45_time_stamp, job_info_accounting_job_type=job_info_accounting_job_type, pcl_default_font_height=pcl_default_font_height, error22_date_time=error22_date_time, error11_date_time=error11_date_time, error29=error29, media17_name=media17_name, media25_page_count=media25_page_count, DisplayString=DisplayString, scanner_accessory_digital_send_config_ldap_gateway=scanner_accessory_digital_send_config_ldap_gateway, error34=error34, media8_short_name=media8_short_name, error10=error10, imaging=imaging, job_info_physical_outbins_used=job_info_physical_outbins_used, fw_rom_datecode=fw_rom_datecode, held_job_delete=held_job_delete, error1_date_time=error1_date_time, mass_storage_resource_change_counter=mass_storage_resource_change_counter, media14=media14, error29_code=error29_code, media10_engine_media_mode=media10_engine_media_mode, media19_name=media19_name, error44_code=error44_code, job_info_outbins_used=job_info_outbins_used, id=id, consumables=consumables, error3_date_time=error3_date_time, pdl_pcl=pdl_pcl, error26_date_time=error26_date_time, media8=media8, media17_short_name=media17_short_name, device_location=device_location, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, consumables_life=consumables_life, media23_engine_media_mode=media23_engine_media_mode, model_number=model_number, media25_name=media25_name, error7=error7, printer_cal_cpr_page_count=printer_cal_cpr_page_count, settings_prt_eng=settings_prt_eng, io=io, error20_time_stamp=error20_time_stamp, error45=error45, firmware_download_write_time=firmware_download_write_time, job_info_io_source=job_info_io_source, media8_page_count=media8_page_count, error33_time_stamp=error33_time_stamp, error29_date_time=error29_date_time, error48=error48, media7_page_count=media7_page_count, media24_engine_media_mode=media24_engine_media_mode, media_counts=media_counts, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, simm1=simm1, media21_name=media21_name, error46_time_stamp=error46_time_stamp, media8_name=media8_name, media_types=media_types, error15=error15, print_engine_revision=print_engine_revision, error41=error41, scanned_media_duplex_count=scanned_media_duplex_count, printer_calibration_dhalf=printer_calibration_dhalf, localization_countries_supported=localization_countries_supported, error29_time_stamp=error29_time_stamp, media_size=media_size, consumable_life_low_threshold=consumable_life_low_threshold, phd=phd, settings_system=settings_system, port1_parallel_speed=port1_parallel_speed, intray=intray, media4_page_count=media4_page_count, simm1_bank1_capacity=simm1_bank1_capacity, settings_copier=settings_copier, phd2_capacity=phd2_capacity, media24_name=media24_name, error39_time_stamp=error39_time_stamp, simm2_bank1=simm2_bank1, error43=error43, held_job=held_job, intray7=intray7, job_info_attr_2=job_info_attr_2, error42_date_time=error42_date_time, usb_product_description=usb_product_description, error49_date_time=error49_date_time, error9_date_time=error9_date_time, consumable_life_usage_units=consumable_life_usage_units)
mibBuilder.exportSymbols("LJ4345-MIB", scanner_accessory_adf_sheet_count=scanner_accessory_adf_sheet_count, error39_date_time=error39_date_time, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, error13_code=error13_code, media6_short_name=media6_short_name, scanner=scanner, web_server_security=web_server_security, input_tray_auto_select=input_tray_auto_select, duplex_blank_pages=duplex_blank_pages, media1_short_name=media1_short_name, held_job_set_queue_size=held_job_set_queue_size, color_copy_enabled=color_copy_enabled, media20_name=media20_name, media5_page_count=media5_page_count, host_application_available_memory=host_application_available_memory, error24_date_time=error24_date_time, error40_code=error40_code, media10_name=media10_name, usage_scanner_total_charge=usage_scanner_total_charge, media12_engine_media_mode=media12_engine_media_mode, upgradable_devices_current_state=upgradable_devices_current_state, media_number_of_type_supported=media_number_of_type_supported, default_audible_feedback=default_audible_feedback, media2_short_name=media2_short_name, error39=error39, consumable_maintenance_pages_remaining=consumable_maintenance_pages_remaining, error16_date_time=error16_date_time, error27_time_stamp=error27_time_stamp, copy_job_hold_time=copy_job_hold_time, job_info_attr_11=job_info_attr_11, outbin2_error_info=outbin2_error_info, printer_cal_cpr_utc=printer_cal_cpr_utc, not_ready_source_scanner=not_ready_source_scanner, remote_upgrade_enable=remote_upgrade_enable, error34_date_time=error34_date_time, job_info_printed_originals=job_info_printed_originals, default_copier_edge_to_edge=default_copier_edge_to_edge, error26_time_stamp=error26_time_stamp, settings_spooler=settings_spooler, configurable_low_threshold_setting=configurable_low_threshold_setting, consumable_notification_status=consumable_notification_status, firmware_download_version=firmware_download_version, marking_agent_highlights_density_setting=marking_agent_highlights_density_setting, error20_date_time=error20_date_time, error34_code=error34_code, upgradable_devices_name=upgradable_devices_name, postscript_print_errors=postscript_print_errors, media6_name=media6_name, error33=error33, mio1=mio1, outbin1=outbin1, scan_to_folder_count=scan_to_folder_count, tray6_phd=tray6_phd, media11_name=media11_name, job_info_change_id=job_info_change_id, tray7_phd=tray7_phd, job_output_auto_continue_timeout=job_output_auto_continue_timeout, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, default_copier_image_type=default_copier_image_type, media18_name=media18_name, error7_date_time=error7_date_time, background_message2=background_message2, pjl=pjl, maximum_ram_disk_memory=maximum_ram_disk_memory, media11_page_count=media11_page_count, override_media_name=override_media_name, error22=error22, print_meter=print_meter, error47=error47, settings_intray=settings_intray, error43_date_time=error43_date_time, media9_engine_media_mode=media9_engine_media_mode, tray1_media_size_loaded=tray1_media_size_loaded, error37_code=error37_code, postscript_defer_media=postscript_defer_media, background_message3=background_message3, device_configure=device_configure, status_prt_eng=status_prt_eng, firmware_download=firmware_download, scanner_accessory_digital_send_module_url=scanner_accessory_digital_send_module_url, auto_send_reset=auto_send_reset, error37_date_time=error37_date_time, error12_code=error12_code, error8=error8, error38_date_time=error38_date_time, consumable_string=consumable_string, media20_engine_media_mode=media20_engine_media_mode, printed_media_dimplex_count=printed_media_dimplex_count, job_info_accounting_scanned_media_simplex_count=job_info_accounting_scanned_media_simplex_count, error44_date_time=error44_date_time, default_vmi=default_vmi, file_system4=file_system4, form_feed_needed=form_feed_needed, media9_page_count=media9_page_count, media4=media4, usage_instructions_line2=usage_instructions_line2, postscript_total_page_count=postscript_total_page_count, mopy_mode=mopy_mode, printed_media_combined_total=printed_media_combined_total, simm2_bank2_type=simm2_bank2_type, error18_code=error18_code, scanner_accessory_adf_two_sided_sheet_count=scanner_accessory_adf_two_sided_sheet_count, error30_date_time=error30_date_time, default_lines_per_page=default_lines_per_page, error45_code=error45_code, job_info_outcome=job_info_outcome, formatter_serial_number=formatter_serial_number, mio4=mio4, error5_code=error5_code, error31_date_time=error31_date_time, display_status=display_status, tray1_phd=tray1_phd, scanner_accessory_digital_send_log_event_counter=scanner_accessory_digital_send_log_event_counter, held_job_security=held_job_security, printed_modes_total_count=printed_modes_total_count, media3_page_count=media3_page_count, media20_short_name=media20_short_name, usb_vendor_id=usb_vendor_id, held_job_job_name=held_job_job_name, dm=dm, intray2=intray2, job_info_stage=job_info_stage, printed_media_total_charge=printed_media_total_charge, source_subsystem=source_subsystem, rpc_bind_protocol_address=rpc_bind_protocol_address, error32_date_time=error32_date_time, error20=error20, error45_date_time=error45_date_time, mio4_model_name=mio4_model_name, settings_print_media=settings_print_media, tray_prompt=tray_prompt, media16_short_name=media16_short_name, error7_time_stamp=error7_time_stamp, error1_code=error1_code, error21_time_stamp=error21_time_stamp, media5_short_name=media5_short_name, error8_date_time=error8_date_time, usb_driver_name=usb_driver_name, job_info_attr_9=job_info_attr_9, media21_short_name=media21_short_name, mio4_type=mio4_type, scanned_media_duplex_charge=scanned_media_duplex_charge, mio=mio, fax_job_scan_count=fax_job_scan_count, media1_name=media1_name, mio1_manufacturing_info=mio1_manufacturing_info, control_panel_display=control_panel_display, port1=port1, error28_time_stamp=error28_time_stamp, outbin2=outbin2, settings_job=settings_job, date_display=date_display, settings_file_system=settings_file_system, job_info_name2=job_info_name2, processing_subsystem=processing_subsystem, job_info_attr_5=job_info_attr_5, job_info_requested_originals=job_info_requested_originals, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, remote_procedure_call=remote_procedure_call, scanner_accessory_total_copy_pages_printed=scanner_accessory_total_copy_pages_printed, error43_time_stamp=error43_time_stamp, error3_time_stamp=error3_time_stamp, error12=error12, printed_media_simplex_charge=printed_media_simplex_charge, error41_date_time=error41_date_time, default_copy_reset_timeout=default_copy_reset_timeout, settings_ph=settings_ph, time_display=time_display, background_message1=background_message1, asset_number=asset_number, error13_time_stamp=error13_time_stamp, default_copier_page_borders=default_copier_page_borders, tray2_media_size_loaded=tray2_media_size_loaded, error37_time_stamp=error37_time_stamp, device_system=device_system, media16_page_count=media16_page_count, error43_code=error43_code, error5_date_time=error5_date_time, media20_page_count=media20_page_count, scanned_media_total_charge=scanned_media_total_charge, web_server=web_server, media_names_available=media_names_available, cancel_job=cancel_job, pcl_default_font_source=pcl_default_font_source, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, error12_date_time=error12_date_time, error20_code=error20_code, supplies_replace_action_at_setting=supplies_replace_action_at_setting, web_server_url=web_server_url, default_mfp_color_space=default_mfp_color_space, error1_time_stamp=error1_time_stamp, job_info_attr_3=job_info_attr_3, error30_code=error30_code, rpc_bound_protocol_address=rpc_bound_protocol_address, error44=error44, device_configure_printer_parameters=device_configure_printer_parameters, job_info_attr_10=job_info_attr_10, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, ram_disk_size=ram_disk_size, error34_time_stamp=error34_time_stamp, pcl_total_page_count=pcl_total_page_count, status_mass_storage_bd=status_mass_storage_bd, webserver_proc_sub=webserver_proc_sub, scan_sharpening_coefficient=scan_sharpening_coefficient, usb_product_id=usb_product_id, settings_web_server=settings_web_server, media16=media16, default_copy_job_chromaticity=default_copy_job_chromaticity, error14_time_stamp=error14_time_stamp, usage_instructions_line1=usage_instructions_line1, marking_agent=marking_agent, media13_name=media13_name, mass_storage_block_driver=mass_storage_block_driver, pysmi_continue=pysmi_continue, default_scan_background_removal=default_scan_background_removal, file_system=file_system, default_scan_image_quality=default_scan_image_quality, error23_time_stamp=error23_time_stamp, mio4_manufacturing_info=mio4_manufacturing_info, tray3_media_size_loaded=tray3_media_size_loaded, perm_store_init_occurred=perm_store_init_occurred, media11=media11, operating_system=operating_system, printed_media_simplex_count=printed_media_simplex_count, simm2_capacity=simm2_capacity, error9_code=error9_code, status_system=status_system, default_staple_mode=default_staple_mode, show_address=show_address, simm1_bank2=simm1_bank2, scanner_accessory_adf_one_sided_sheet_count=scanner_accessory_adf_one_sided_sheet_count, printer_cal_dhalf_page_count=printer_cal_dhalf_page_count, default_custom_paper_dim_unit=default_custom_paper_dim_unit, error4_time_stamp=error4_time_stamp, firmware_download_write_status_supported=firmware_download_write_status_supported, scanner_accounting=scanner_accounting, media10_page_count=media10_page_count, destination_bin_usage_total=destination_bin_usage_total, scanned_media_simplex_count=scanned_media_simplex_count, default_horizontal_black_resolution=default_horizontal_black_resolution, socket_ping=socket_ping, settings_rpc=settings_rpc, cartridge_out_override_control=cartridge_out_override_control, error6_time_stamp=error6_time_stamp, localization_languages_supported=localization_languages_supported, error28_date_time=error28_date_time, outbin=outbin, usage_printer_total_charge=usage_printer_total_charge, error38_code=error38_code, media14_name=media14_name, status_pdl=status_pdl, error35_time_stamp=error35_time_stamp, error19_date_time=error19_date_time, destination_bin_accounting=destination_bin_accounting)
mibBuilder.exportSymbols("LJ4345-MIB", background_status_msg_line1_part1=background_status_msg_line1_part1, default_copy_duplex_mode=default_copy_duplex_mode, media15_short_name=media15_short_name, duplex_page_count=duplex_page_count, upgradable_devices_version=upgradable_devices_version, error6_code=error6_code, error15_date_time=error15_date_time, error41_code=error41_code, ews_request_control_panel_supplies_status=ews_request_control_panel_supplies_status, default_authentication_timeout=default_authentication_timeout, hold_job_timeout=hold_job_timeout, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, job_info_attr_15=job_info_attr_15, phd2_manufacturing_info=phd2_manufacturing_info, scanner_accessory_digital_send_config_dsm_enabled_fax=scanner_accessory_digital_send_config_dsm_enabled_fax, scanner_accessory_send_job_scan_count=scanner_accessory_send_job_scan_count, consumables_status=consumables_status, media16_engine_media_mode=media16_engine_media_mode, error40_time_stamp=error40_time_stamp, mass_storage_resources=mass_storage_resources, error_log_clear=error_log_clear, media25_engine_media_mode=media25_engine_media_mode, error21_code=error21_code, hp=hp, error32_time_stamp=error32_time_stamp, scanner_accessory_flatbed_scan_count=scanner_accessory_flatbed_scan_count, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, pcl_default_font_number=pcl_default_font_number, job_info_attr_6=job_info_attr_6, direct_connect_ports_enable=direct_connect_ports_enable, background_message=background_message, copy_job_auto_interrupt=copy_job_auto_interrupt, error9_time_stamp=error9_time_stamp, error38_time_stamp=error38_time_stamp, error50=error50, media4_engine_media_mode=media4_engine_media_mode, error32_code=error32_code, held_job_enable=held_job_enable, simm2=simm2, north_edge_offset=north_edge_offset, error17_date_time=error17_date_time, consumable_reorder_url=consumable_reorder_url, on_off_line=on_off_line, scanner_accessory_digital_send_config_fax_embedded=scanner_accessory_digital_send_config_fax_embedded, simm2_bank1_type=simm2_bank1_type, job_info_page_count_current_original=job_info_page_count_current_original, error21=error21, default_copy_input_tray=default_copy_input_tray, error24_time_stamp=error24_time_stamp, error27_date_time=error27_date_time, media5_engine_media_mode=media5_engine_media_mode, media13=media13, media20=media20, error23_date_time=error23_date_time, settings_outbin=settings_outbin, error40_date_time=error40_date_time, media2_name=media2_name, file_system3_initialize_volume=file_system3_initialize_volume, media15=media15, error19=error19, current_job_parsing_id=current_job_parsing_id, error48_date_time=error48_date_time, media7_engine_media_mode=media7_engine_media_mode, media23_short_name=media23_short_name, intray6=intray6, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, intray1=intray1, consumable_string_information=consumable_string_information, default_reset_send_timeout=default_reset_send_timeout, error46_date_time=error46_date_time, error47_date_time=error47_date_time, media_size_count=media_size_count, default_copier_quantity=default_copier_quantity, error36=error36, error10_date_time=error10_date_time, media22_short_name=media22_short_name, default_scan_original_size=default_scan_original_size, job_info_accounting_media_type=job_info_accounting_media_type, error42=error42, error10_code=error10_code, error23_code=error23_code, simm1_type=simm1_type, error5_time_stamp=error5_time_stamp, media22=media22, job_info_pages_in_original=job_info_pages_in_original, default_copier_flip_pages_up=default_copier_flip_pages_up, firmware_download_name=firmware_download_name, error28_code=error28_code, error42_time_stamp=error42_time_stamp, error38=error38, media6_page_count=media6_page_count, media15_engine_media_mode=media15_engine_media_mode, media16_name=media16_name, media26_name=media26_name, upgradable_devices=upgradable_devices, tray_disable_use_instead=tray_disable_use_instead, job_input_auto_continue_mode=job_input_auto_continue_mode, error14_code=error14_code, job_info_accounting_finishing_options=job_info_accounting_finishing_options, error10_time_stamp=error10_time_stamp, media21=media21, outbin2_maximum_binding=outbin2_maximum_binding, error28=error28, printer_cal_dhalf_data2=printer_cal_dhalf_data2, held_job_pin=held_job_pin, usb_device_kind=usb_device_kind, media19=media19, printer_cal_dhalf_data1=printer_cal_dhalf_data1, destination_subsystem=destination_subsystem, scanner_accessory_copy_job_scan_count=scanner_accessory_copy_job_scan_count, error6=error6, consumable_current_state=consumable_current_state, error33_date_time=error33_date_time, error49_code=error49_code, settings_pdl=settings_pdl, resource_manager=resource_manager, simm2_bank1_capacity=simm2_bank1_capacity, media26_short_name=media26_short_name, file_systems=file_systems, error14=error14, destination_bin_usage=destination_bin_usage, held_job_control=held_job_control, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, first_copy_speed=first_copy_speed, scanned_media_simplex_charge=scanned_media_simplex_charge, media19_page_count=media19_page_count, reprint=reprint, simm2_bank=simm2_bank, media6_engine_media_mode=media6_engine_media_mode, spooler=spooler, printer_average_marking_agent_coverage_sum=printer_average_marking_agent_coverage_sum, error6_date_time=error6_date_time, error48_code=error48_code, error12_time_stamp=error12_time_stamp, error41_time_stamp=error41_time_stamp, outbin2_phd=outbin2_phd, error50_date_time=error50_date_time, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, media3_name=media3_name, control_panel_supplies_status_message=control_panel_supplies_status_message, device_name=device_name, media22_name=media22_name, media23_page_count=media23_page_count, error11_code=error11_code, error25=error25, usage_staple_count=usage_staple_count, tables=tables, collated_originals_support=collated_originals_support, job_info_attr_7=job_info_attr_7, error17=error17, tray3_phd=tray3_phd, default_ret=default_ret, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, date_and_time=date_and_time, usage_instructions_line3=usage_instructions_line3, settings_io=settings_io, usb_host_supported=usb_host_supported, default_scan_text_graphics_mix=default_scan_text_graphics_mix, media11_engine_media_mode=media11_engine_media_mode, intray5=intray5, error16=error16, job_info_attr_14=job_info_attr_14, supply_out_action_support=supply_out_action_support, simm1_bank=simm1_bank, media24_page_count=media24_page_count, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, error4_code=error4_code, pdl=pdl, error8_code=error8_code, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, usb_manufacturer_name=usb_manufacturer_name, media24_short_name=media24_short_name, default_bits_per_pixel=default_bits_per_pixel, accounting=accounting, job_info_name1=job_info_name1, media17_engine_media_mode=media17_engine_media_mode, media7_name=media7_name, error17_code=error17_code, media1_page_count=media1_page_count, error2_code=error2_code, media13_short_name=media13_short_name, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, default_vertical_black_resolution=default_vertical_black_resolution, usb_serial_number=usb_serial_number, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, media24=media24, media_info=media_info, printed_media_duplex_count=printed_media_duplex_count, held_job_info=held_job_info, error40=error40, media23=media23, job_input_auto_continue_timeout=job_input_auto_continue_timeout, error26=error26, error47_time_stamp=error47_time_stamp, error27_code=error27_code, error47_code=error47_code, port1_parallel_bidirectionality=port1_parallel_bidirectionality, error36_date_time=error36_date_time, tray2_phd=tray2_phd, marking_agent_density_setting=marking_agent_density_setting, background_status_msg_line4_part1=background_status_msg_line4_part1, error36_code=error36_code, settings_scanner=settings_scanner, outbin2_override_mode=outbin2_override_mode, error1=error1, held_job_retention=held_job_retention, error31_time_stamp=error31_time_stamp, held_job_print=held_job_print, tray5_phd=tray5_phd, job_info_attr_16=job_info_attr_16, interface=interface, media26=media26, default_scanner_speed=default_scanner_speed, os_execute_file=os_execute_file, mono_color_switching_mode=mono_color_switching_mode, error15_time_stamp=error15_time_stamp, copy_job_interrupt_copy_jobs=copy_job_interrupt_copy_jobs, media8_engine_media_mode=media8_engine_media_mode, error8_time_stamp=error8_time_stamp, job_being_parsed=job_being_parsed, job_info_pages_printed=job_info_pages_printed, media13_page_count=media13_page_count, media2=media2, scan_calibration_error=scan_calibration_error, copy_job_hold_off_print_jobs=copy_job_hold_off_print_jobs, media26_engine_media_mode=media26_engine_media_mode, media25=media25, simm1_bank2_type=simm1_bank2_type, scanner_accessory_digital_send_config_email_gateway=scanner_accessory_digital_send_config_email_gateway, media13_engine_media_mode=media13_engine_media_mode, error2=error2, pml=pml, destination_bin_usage_count=destination_bin_usage_count, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, copy_job_scan_ahead=copy_job_scan_ahead, consumable_string_information_reset=consumable_string_information_reset, error3_code=error3_code, default_copier_collate=default_copier_collate, job_info_attr_4=job_info_attr_4, error49=error49, job_info_attr_12=job_info_attr_12, error17_time_stamp=error17_time_stamp, phd2_model=phd2_model, model_name=model_name, file_system2_initialize_volume=file_system2_initialize_volume, status_scanner=status_scanner, custom_paper_xfeed_dim=custom_paper_xfeed_dim, media12_page_count=media12_page_count, scan_calibration_download=scan_calibration_download, job_info_state=job_info_state, error31_code=error31_code, sleep_mode=sleep_mode, custom_paper_feed_dim=custom_paper_feed_dim, error16_time_stamp=error16_time_stamp)
mibBuilder.exportSymbols("LJ4345-MIB", firmware_download_current_state=firmware_download_current_state, held_job_user_name=held_job_user_name, usage_instructions_line4=usage_instructions_line4, job_info_attr_8=job_info_attr_8, media12_short_name=media12_short_name, error18_time_stamp=error18_time_stamp, error42_code=error42_code, error25_date_time=error25_date_time, error7_code=error7_code, scanner_accessory_digital_send_home_screen_status=scanner_accessory_digital_send_home_screen_status, media6=media6, error24=error24, printer_average_marking_agent_coverage_sum_squared=printer_average_marking_agent_coverage_sum_squared, control_panel_display_graphical_contents=control_panel_display_graphical_contents, error35=error35, error50_time_stamp=error50_time_stamp, default_custom_paper_feed_dim=default_custom_paper_feed_dim, job_info_accounting_black_dots=job_info_accounting_black_dots, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, error4=error4, outbin1_override_mode=outbin1_override_mode, menus=menus, errorlog=errorlog, error25_code=error25_code, default_copies=default_copies, print_media=print_media, media18_short_name=media18_short_name, printed_modes_usage=printed_modes_usage, held_job_quantity=held_job_quantity, media21_engine_media_mode=media21_engine_media_mode, media10=media10, error23=error23, error24_code=error24_code, file_system_max_open_files=file_system_max_open_files, marking_agent_midtones_density_setting=marking_agent_midtones_density_setting, marking_agent_density=marking_agent_density, tray5_media_size_loaded=tray5_media_size_loaded, ph=ph, media19_short_name=media19_short_name, simm2_type=simm2_type, default_media_name=default_media_name, settings_mass_storage_bd=settings_mass_storage_bd, energy_star=energy_star, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, media1=media1, media7=media7, display=display, file_system_delete_files=file_system_delete_files, media22_engine_media_mode=media22_engine_media_mode, error11=error11, error19_code=error19_code, default_media_size=default_media_size, simm=simm, error30=error30, error22_time_stamp=error22_time_stamp, form_feed=form_feed, error35_date_time=error35_date_time, pdl_postscript=pdl_postscript, status_rpc=status_rpc, socket_ping_job_events_version=socket_ping_job_events_version)
