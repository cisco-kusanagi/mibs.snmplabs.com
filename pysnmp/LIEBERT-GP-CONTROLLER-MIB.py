...
# Produced by pysmi-0.3.4 at Mon Apr 29 19:56:08 2019
...
Integer32, Unsigned32, ObjectIdentity, Gauge32, IpAddress, MibIdentifier, Bits, iso, Counter32, TimeTicks, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "ObjectIdentity", "Gauge32", "IpAddress", "MibIdentifier", "Bits", "iso", "Counter32", "TimeTicks", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType")
