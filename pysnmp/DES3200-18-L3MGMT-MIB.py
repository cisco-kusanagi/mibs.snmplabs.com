...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:25:00 2019
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, IpAddress, iso, Gauge32, NotificationType, Counter32, Integer32, Counter64, ObjectIdentity, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "IpAddress", "iso", "Gauge32", "NotificationType", "Counter32", "Integer32", "Counter64", "ObjectIdentity", "Unsigned32", "MibIdentifier")
MacAddress, PhysAddress, DisplayString, TimeStamp, TextualConvention, TruthValue, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "PhysAddress", "DisplayString", "TimeStamp", "TextualConvention", "TruthValue", "RowStatus")
...
mibBuilder.exportSymbols("DES3200-18-L3MGMT-MIB", swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3IpMgmt=swL3IpMgmt, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3IpCtrlTable=swL3IpCtrlTable, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3DevMgmt=swL3DevMgmt, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3MgmtMIB=swL3MgmtMIB, Ipv6Address=Ipv6Address, swL3Ipv6Address=swL3Ipv6Address, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress)
