...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:34:35 2019
...
ModuleIdentity, Gauge32, Counter32, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ObjectIdentity, Unsigned32, iso, IpAddress, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Counter32", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ObjectIdentity", "Unsigned32", "iso", "IpAddress", "Bits", "MibIdentifier")
...
mibBuilder.exportSymbols("DLINK-3100-rlInterfaces", rlIfNumOfLoopbackPorts=rlIfNumOfLoopbackPorts, rlIfClearPortMacAddresses=rlIfClearPortMacAddresses, swIfSingleHostViolationOperAction=swIfSingleHostViolationOperAction, swIfDefaultPriority=swIfDefaultPriority, swIfAdminLockAction=swIfAdminLockAction, swIfSingleHostViolationAdminAction=swIfSingleHostViolationAdminAction, swIfExtSFPSpeed=swIfExtSFPSpeed, swIfOperFlowControlMode=swIfOperFlowControlMode, rlIfClearStackPortsCounters=rlIfClearStackPortsCounters, swIfFlowControlMode=swIfFlowControlMode, swIfLockMacAddressesCount=swIfLockMacAddressesCount, swIfPortLockTrapSupport=swIfPortLockTrapSupport, swIfAdminMdix=swIfAdminMdix, rlIfNumOfPhPorts=rlIfNumOfPhPorts, swIfOperSpeedDuplexAutoNegotiationLocalCapabilities=swIfOperSpeedDuplexAutoNegotiationLocalCapabilities, swIfType=swIfType, swIfLockMaxMacAddresses=swIfLockMaxMacAddresses, swIfEntry=swIfEntry, swIfSpeedDuplexAutoNegotiation=swIfSpeedDuplexAutoNegotiation, swIfHostMode=swIfHostMode, swIfPhysAddressType=swIfPhysAddressType, swIfSpeedDuplexNegotiationRemoteCapabilities=swIfSpeedDuplexNegotiationRemoteCapabilities, swIfPortLockIfRangeIndex=swIfPortLockIfRangeIndex, rlIfClearPortMibCounters=rlIfClearPortMibCounters, rlIfBaseMACAddressPerIfIndex=rlIfBaseMACAddressPerIfIndex, swIfSingleHostViolationOperTrapCount=swIfSingleHostViolationOperTrapCount, swIfSingleHostViolationAdminTrapFrequency=swIfSingleHostViolationAdminTrapFrequency, swIfOperComboMode=swIfOperComboMode, swIfExtEntry=swIfExtEntry, swIfTaggedMode=swIfTaggedMode, swIfLockAdminStatus=swIfLockAdminStatus, rlFlowControlRxPerSystem=rlFlowControlRxPerSystem, swIfSpeedAdminMode=swIfSpeedAdminMode, swIfDuplexOperMode=swIfDuplexOperMode, rlIfNumOfUserDefinedPorts=rlIfNumOfUserDefinedPorts, swIfPortLockIfRangeTable=swIfPortLockIfRangeTable, swIfDuplexAdminMode=swIfDuplexAdminMode, rlFlowControlCascadeType=rlFlowControlCascadeType, swIfPortLockIfRangeLockStatus=swIfPortLockIfRangeLockStatus, swIfAdminSpeedDuplexAutoNegotiationLocalCapabilities=swIfAdminSpeedDuplexAutoNegotiationLocalCapabilities, swIfPortLockIfRangeTrapFreq=swIfPortLockIfRangeTrapFreq, swIfExtTable=swIfExtTable, swIfPortLockActionSupport=swIfPortLockActionSupport, swIfDefaultTag=swIfDefaultTag, swIfOperSuspendedStatus=swIfOperSuspendedStatus, swIfSingleHostViolationAdminTrapEnable=swIfSingleHostViolationAdminTrapEnable, swIfLockOperTrapCount=swIfLockOperTrapCount, swIfOperLockAction=swIfOperLockAction, swIfAdminLockTrapEnable=swIfAdminLockTrapEnable, AutoNegCapabilitiesBits=AutoNegCapabilitiesBits, swIfOperMdix=swIfOperMdix, swIfLockOperStatus=swIfLockOperStatus, swIfReActivate=swIfReActivate, swIfPortLockIfRangeAction=swIfPortLockIfRangeAction, swIfPortLockIfRangeEntry=swIfPortLockIfRangeEntry, swIfOperLockTrapEnable=swIfOperLockTrapEnable, rlManagementIfIndex=rlManagementIfIndex, swIfOperSpeedDuplexAutoNegotiation=swIfOperSpeedDuplexAutoNegotiation, swIfLockAdminTrapFrequency=swIfLockAdminTrapFrequency, swIfPortLockIfRange=swIfPortLockIfRange, rlIfMibVersion=rlIfMibVersion, swIfAdminComboMode=swIfAdminComboMode, rlIfMapOfOnPhPorts=rlIfMapOfOnPhPorts, swIfTransceiverType=swIfTransceiverType, rlIfFirstOutOfBandIfIndex=rlIfFirstOutOfBandIfIndex, swIfPortLockIfRangeTrapEn=swIfPortLockIfRangeTrapEn, swIfOperBackPressureMode=swIfOperBackPressureMode, rlCascadePortProtectionAction=rlCascadePortProtectionAction, rlFlowControlCascadeMode=rlFlowControlCascadeMode, swIfIndex=swIfIndex, swIfPortLockSupport=swIfPortLockSupport, swIfStatus=swIfStatus, rlIfFirstLoopbackIfIndex=rlIfFirstLoopbackIfIndex, rlIfExistingPortList=rlIfExistingPortList, swIfSingleHostViolationOperTrapEnable=swIfSingleHostViolationOperTrapEnable, swIfTable=swIfTable, swIfBackPressureMode=swIfBackPressureMode, swIfMibVersion=swIfMibVersion, swIfLockLimitationMode=swIfLockLimitationMode)
