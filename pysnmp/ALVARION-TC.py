...
IpAddress, Unsigned32, ObjectIdentity, TimeTicks, MibIdentifier, Integer32, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, Counter32, Counter64, iso = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "ObjectIdentity", "TimeTicks", "MibIdentifier", "Integer32", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "Counter32", "Counter64", "iso")
...
mibBuilder.exportSymbols("ALVARION-TC", AlvarionRadioType=AlvarionRadioType, AlvarionPriorityQueue=AlvarionPriorityQueue, AlvarionProfileIndexOrZero=AlvarionProfileIndexOrZero, AlvarionServerIndex=AlvarionServerIndex, AlvarionSSID=AlvarionSSID, alvarionTextualConventions=alvarionTextualConventions, AlvarionNotificationEnable=AlvarionNotificationEnable, AlvarionSSIDOrNone=AlvarionSSIDOrNone, AlvarionAuthenticationMode=AlvarionAuthenticationMode, PYSNMP_MODULE_ID=alvarionTextualConventions, AlvarionProfileIndex=AlvarionProfileIndex, AlvarionDataRate=AlvarionDataRate, AlvarionUsersAuthenticationType=AlvarionUsersAuthenticationType, AlvarionServerIndexOrZero=AlvarionServerIndexOrZero, AlvarionUsersAuthenticationMode=AlvarionUsersAuthenticationMode, AlvarionSecurity=AlvarionSecurity)
