...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ9065-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:33 2019
...
Integer32, IpAddress, ModuleIdentity, ObjectIdentity, TimeTicks, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, MibIdentifier, iso, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "IpAddress", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "MibIdentifier", "iso", "NotificationType", "Counter32")
...
mibBuilder.exportSymbols("LJ9065-MIB", firmware_download_maximum_write_count=firmware_download_maximum_write_count, error48_code=error48_code, hold_job_timeout=hold_job_timeout, channelprotocolversion=channelprotocolversion, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, error18_code=error18_code, error20_code=error20_code, intray1=intray1, print_density=print_density, intray5=intray5, error3_time_stamp=error3_time_stamp, media5_page_count=media5_page_count, simm4_bank=simm4_bank, media9=media9, error27_time_stamp=error27_time_stamp, error13_code=error13_code, copier=copier, media3_short_name=media3_short_name, media12_page_count=media12_page_count, replaceable_part_custom_information_part_number=replaceable_part_custom_information_part_number, error8=error8, error15_code=error15_code, mass_storage_block_driver=mass_storage_block_driver, error50=error50, duplex_two_to_two_mono_page_count=duplex_two_to_two_mono_page_count, error41_time_stamp=error41_time_stamp, phd2_options_description=phd2_options_description, replaceable_part_life_information=replaceable_part_life_information, error18=error18, upgradable_devices_write_count=upgradable_devices_write_count, error17_time_stamp=error17_time_stamp, error32=error32, error14_code=error14_code, error41=error41, channel=channel, mio=mio, default_custom_paper_feed_dim=default_custom_paper_feed_dim, media14_page_count=media14_page_count, netPMLmgmt=netPMLmgmt, simm1_bank1=simm1_bank1, simm2=simm2, error23_time_stamp=error23_time_stamp, copied_media_usage=copied_media_usage, error27_code=error27_code, file_system4=file_system4, pdl_postscript=pdl_postscript, device=device, error25_code=error25_code, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, media13_short_name=media13_short_name, media16=media16, show_address=show_address, error1_time_stamp=error1_time_stamp, error20=error20, error25_time_stamp=error25_time_stamp, deviceChannelEntry=deviceChannelEntry, error39_time_stamp=error39_time_stamp, job_info_accounting_media_type=job_info_accounting_media_type, error42_code=error42_code, media3_engine_media_mode=media3_engine_media_mode, upgradable_devices_name=upgradable_devices_name, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, print_engine=print_engine, channelnumberofchannels=channelnumberofchannels, error44=error44, job_info_outcome=job_info_outcome, error28_code=error28_code, error9_code=error9_code, tray2_phd=tray2_phd, simm3_bank1_capacity=simm3_bank1_capacity, spooler=spooler, default_bits_per_pixel=default_bits_per_pixel, mass_storage_resource_change_counter=mass_storage_resource_change_counter, error33_time_stamp=error33_time_stamp, tray1_media_size_loaded=tray1_media_size_loaded, service_call_information_count=service_call_information_count, error11_time_stamp=error11_time_stamp, job_info_stage=job_info_stage, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, error35_time_stamp=error35_time_stamp, duplex_one_to_two_mono_page_count=duplex_one_to_two_mono_page_count, default_page_protect=default_page_protect, error33=error33, fw_rom_revision=fw_rom_revision, media6_name=media6_name, phd3_manufacturing_info=phd3_manufacturing_info, copied_media_count=copied_media_count, settings_marking_agent=settings_marking_agent, marking_agent_density=marking_agent_density, job_info_attr_10=job_info_attr_10, jam_count_by_location=jam_count_by_location, media15_engine_media_mode=media15_engine_media_mode, error13_time_stamp=error13_time_stamp, error50_code=error50_code, rpc_bind_protocol_address=rpc_bind_protocol_address, media1=media1, held_job_delete=held_job_delete, error16_time_stamp=error16_time_stamp, media14_engine_media_mode=media14_engine_media_mode, status_copier=status_copier, upgradable_devices=upgradable_devices, media1_short_name=media1_short_name, settings_pdl=settings_pdl, simm2_bank=simm2_bank, error21=error21, phd2_options_model=phd2_options_model, id=id, job_info_accounting_black_dots=job_info_accounting_black_dots, file_system3=file_system3, configuration_dip_switches_switch=configuration_dip_switches_switch, file_system=file_system, media5_name=media5_name, media10_short_name=media10_short_name, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, error7=error7, media12_name=media12_name, media6_short_name=media6_short_name, error13=error13, status_pdl=status_pdl, media4_name=media4_name, firmware_download_name=firmware_download_name, error38_time_stamp=error38_time_stamp, intrays=intrays, mass_storage_resource_changed=mass_storage_resource_changed, tables=tables, channel_bytes_received=channel_bytes_received, firmware_download=firmware_download, error44_time_stamp=error44_time_stamp, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, simm4_bank1=simm4_bank1, error23_code=error23_code, simm3_bank2_type=simm3_bank2_type, simm4_bank2_capacity=simm4_bank2_capacity, ram_disk_size=ram_disk_size, error14_time_stamp=error14_time_stamp, media_types=media_types, error4_time_stamp=error4_time_stamp, error26=error26, media1_name=media1_name, consumables=consumables, error47_code=error47_code, firmware_download_write_time=firmware_download_write_time, file_system4_initialize_volume=file_system4_initialize_volume, error29_code=error29_code, error49=error49, channeltype=channeltype, replaceable_part_life_information_part_number=replaceable_part_life_information_part_number, simm4=simm4, jam_history_time_stamp=jam_history_time_stamp, simm2_bank1=simm2_bank1, error2_code=error2_code, error46=error46, error22_time_stamp=error22_time_stamp, timestamp=timestamp, rpc_bound_protocol_address=rpc_bound_protocol_address, pjl=pjl, simm4_bank1_type=simm4_bank1_type, error29=error29, simm=simm, error8_code=error8_code, error2_time_stamp=error2_time_stamp, simplex_two_to_one_mono_page_count=simplex_two_to_one_mono_page_count, job=job, phd2=phd2, jam_history_magnification=jam_history_magnification, media12=media12, media_size=media_size, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, error17=error17, media6_page_count=media6_page_count, media11_short_name=media11_short_name, simm2_bank1_type=simm2_bank1_type, replaceable_part_custom_information_limit=replaceable_part_custom_information_limit, settings_system=settings_system, settings_job=settings_job, error32_time_stamp=error32_time_stamp, job_info_pages_printed=job_info_pages_printed, channelinformation=channelinformation, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, settings_print_media=settings_print_media, simm2_bank2=simm2_bank2, error16=error16, job_info=job_info, mopy_mode=mopy_mode, simm3_capacity=simm3_capacity, settings_prt_eng=settings_prt_eng, status_prt_eng=status_prt_eng, settings_mass_storage_bd=settings_mass_storage_bd, source_subsystem=source_subsystem, non_assured_oht_page_count=non_assured_oht_page_count, interface=interface, media7=media7, job_info_requested_originals=job_info_requested_originals, error46_time_stamp=error46_time_stamp, model_number=model_number, error30=error30, replaceable_part_life_information_count=replaceable_part_life_information_count, phd2_options_firmware_version=phd2_options_firmware_version, error32_code=error32_code, media16_engine_media_mode=media16_engine_media_mode, media3_name=media3_name, time_regionalization=time_regionalization, destination_subsystem=destination_subsystem, localization_languages_supported=localization_languages_supported, DisplayString=DisplayString, mio3_type=mio3_type, tray2_media_size_loaded=tray2_media_size_loaded, media11_engine_media_mode=media11_engine_media_mode, replaceable_part_custom_life_information=replaceable_part_custom_life_information, default_media_size=default_media_size, error5_time_stamp=error5_time_stamp, firmware_download_current_state=firmware_download_current_state, background_status_msg_line1_part1=background_status_msg_line1_part1, job_being_parsed=job_being_parsed, status_mass_storage_bd=status_mass_storage_bd, channelTable=channelTable, simm4_bank1_capacity=simm4_bank1_capacity, job_info_pages_in_original=job_info_pages_in_original, settings_intray=settings_intray, simm2_capacity=simm2_capacity, host_application_available_memory=host_application_available_memory, media13_engine_media_mode=media13_engine_media_mode, error16_code=error16_code, sleep_mode=sleep_mode, device_system=device_system, media12_short_name=media12_short_name, jam_history_jam_code=jam_history_jam_code, job_info_name2=job_info_name2, form_feed=form_feed, tray1_phd=tray1_phd, channelprinteralert=channelprinteralert, simm3_bank=simm3_bank, job_info_attr_5=job_info_attr_5, job_info_accounting_media_size=job_info_accounting_media_size, error19=error19, intray=intray, file_system_delete_files=file_system_delete_files, simm1_bank2_capacity=simm1_bank2_capacity, operating_system=operating_system, held_job_job_name=held_job_job_name, media7_short_name=media7_short_name, error47_time_stamp=error47_time_stamp, default_copies=default_copies, media4_engine_media_mode=media4_engine_media_mode, printer_accounting=printer_accounting, on_off_line=on_off_line, error3=error3, media2_name=media2_name, job_info_state=job_info_state, perm_store_init_occurred=perm_store_init_occurred, service_call_information=service_call_information, status_system=status_system, low_marking_agent_processing=low_marking_agent_processing)
mibBuilder.exportSymbols("LJ9065-MIB", device_detail=device_detail, media14=media14, media15_page_count=media15_page_count, accounting=accounting, phd3_number_of_options=phd3_number_of_options, error35_code=error35_code, mio1=mio1, media8_short_name=media8_short_name, job_info_size=job_info_size, channel_mio=channel_mio, simm1_bank1_capacity=simm1_bank1_capacity, error41_code=error41_code, media16_name=media16_name, error10=error10, simm3_bank1_type=simm3_bank1_type, print_media=print_media, configuration_dip_switches=configuration_dip_switches, asset_number=asset_number, job_info_attr_14=job_info_attr_14, printed_media_count=printed_media_count, mio3_model_name=mio3_model_name, consumable_life_usage_units=consumable_life_usage_units, tray5_phd=tray5_phd, simm3_bank2=simm3_bank2, copy_controller_disk_storage=copy_controller_disk_storage, error25=error25, settings_rpc=settings_rpc, imaging_mode_page_count_description=imaging_mode_page_count_description, port1_parallel_bidirectionality=port1_parallel_bidirectionality, error30_time_stamp=error30_time_stamp, settings_file_system=settings_file_system, status_rpc=status_rpc, media4=media4, media8_engine_media_mode=media8_engine_media_mode, error39=error39, error17_code=error17_code, consumable_string_information=consumable_string_information, postscript_print_errors=postscript_print_errors, port1=port1, service_call_information_description=service_call_information_description, error9=error9, media_counts=media_counts, localization_countries_supported=localization_countries_supported, printed_media_usage=printed_media_usage, copy_controller_memory_installed=copy_controller_memory_installed, job_info_attribute=job_info_attribute, mio3=mio3, error14=error14, phd2_number_of_options=phd2_number_of_options, phd2_manufacturing_info=phd2_manufacturing_info, media4_short_name=media4_short_name, error11=error11, error50_time_stamp=error50_time_stamp, channel_bytes_sent=channel_bytes_sent, consumables_status=consumables_status, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, consumable_life_low_threshold=consumable_life_low_threshold, pysmi_continue=pysmi_continue, control_panel_button_press=control_panel_button_press, maximum_ram_disk_memory=maximum_ram_disk_memory, error42_time_stamp=error42_time_stamp, job_info_attr_13=job_info_attr_13, default_media_name=default_media_name, simm3_bank2_capacity=simm3_bank2_capacity, out_marking_agent_processing=out_marking_agent_processing, printed_media_charge=printed_media_charge, error7_code=error7_code, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, media10_page_count=media10_page_count, jam_history=jam_history, background_message1=background_message1, mio2=mio2, PYSNMP_MODULE_ID=hp, media13_page_count=media13_page_count, error10_code=error10_code, pdl=pdl, media_modes=media_modes, mio3_manufacturing_info=mio3_manufacturing_info, job_info_attr_7=job_info_attr_7, error36_time_stamp=error36_time_stamp, collated_originals_support=collated_originals_support, media8_page_count=media8_page_count, media2_page_count=media2_page_count, jam_history_media_size=jam_history_media_size, display_status=display_status, file_system3_initialize_volume=file_system3_initialize_volume, jam_count_by_location_description=jam_count_by_location_description, error40_code=error40_code, firmware_download_write_status_supported=firmware_download_write_status_supported, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, background_status_msg_line2_part1=background_status_msg_line2_part1, phd2_model=phd2_model, form_feed_needed=form_feed_needed, error43=error43, pcl_default_font_number=pcl_default_font_number, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, job_info_attr_9=job_info_attr_9, phd3_model=phd3_model, channelEntry=channelEntry, pcl_total_page_count=pcl_total_page_count, media2_short_name=media2_short_name, error46_code=error46_code, error9_time_stamp=error9_time_stamp, consumable_current_state=consumable_current_state, error8_time_stamp=error8_time_stamp, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, error19_time_stamp=error19_time_stamp, channelstatus=channelstatus, printed_media_total_charge=printed_media_total_charge, error47=error47, media9_page_count=media9_page_count, job_info_attr_16=job_info_attr_16, phd3=phd3, media5=media5, usage_instructions_line4=usage_instructions_line4, error1=error1, job_info_attr_4=job_info_attr_4, cold_reset_media_size=cold_reset_media_size, simm2_type=simm2_type, job_info_change_id=job_info_change_id, error5_code=error5_code, self_test=self_test, default_horizontal_black_resolution=default_horizontal_black_resolution, error24=error24, mio2_type=mio2_type, media11=media11, media10_engine_media_mode=media10_engine_media_mode, media2_engine_media_mode=media2_engine_media_mode, error20_time_stamp=error20_time_stamp, firmware_download_version=firmware_download_version, media8_name=media8_name, simm1_bank=simm1_bank, held_job_print=held_job_print, resource_manager=resource_manager, error45=error45, simm3_bank1=simm3_bank1, media16_short_name=media16_short_name, error1_code=error1_code, job_info_attr_1=job_info_attr_1, serial_number=serial_number, error27=error27, error35=error35, mass_storage_resources=mass_storage_resources, job_info_attr_2=job_info_attr_2, error21_code=error21_code, usage_instructions_line2=usage_instructions_line2, copier_accounting=copier_accounting, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, media10_name=media10_name, media14_short_name=media14_short_name, ram_disk_mode=ram_disk_mode, port1_parallel_speed=port1_parallel_speed, simm3=simm3, media_info=media_info, job_info_pages_processed=job_info_pages_processed, job_info_accounting_job_type=job_info_accounting_job_type, phd=phd, error37_code=error37_code, error31_code=error31_code, reprint=reprint, intray2=intray2, error22_code=error22_code, media_size_count=media_size_count, error15=error15, file_system2=file_system2, error24_time_stamp=error24_time_stamp, error34=error34, auto_continue=auto_continue, error37_time_stamp=error37_time_stamp, pdl_pcl=pdl_pcl, error49_code=error49_code, error12=error12, simm4_type=simm4_type, mio1_model_name=mio1_model_name, job_info_accounting=job_info_accounting, marking_agent=marking_agent, os_execute_file=os_execute_file, channelstate=channelstate, job_info_outbins_used=job_info_outbins_used, error45_code=error45_code, media15_name=media15_name, media5_engine_media_mode=media5_engine_media_mode, marking_agent_density_setting=marking_agent_density_setting, mio2_model_name=mio2_model_name, error_log_clear=error_log_clear, media13=media13, job_info_printed_originals=job_info_printed_originals, held_job_retention=held_job_retention, default_vertical_black_resolution=default_vertical_black_resolution, job_info_physical_outbins_used=job_info_physical_outbins_used, error40_time_stamp=error40_time_stamp, phd2_type=phd2_type, jam_history_source_tray=jam_history_source_tray, error36=error36, error38=error38, phd3_type=phd3_type, webserver_proc_sub=webserver_proc_sub, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, upgradable_devices_current_state=upgradable_devices_current_state, error28_time_stamp=error28_time_stamp, duplex_page_count=duplex_page_count, simm1_bank2=simm1_bank2, intray6=intray6, media9_engine_media_mode=media9_engine_media_mode, error7_time_stamp=error7_time_stamp, held_job_enable=held_job_enable, media12_engine_media_mode=media12_engine_media_mode, page_frame_memory_available=page_frame_memory_available, intray3=intray3, media_names_available=media_names_available, media16_page_count=media16_page_count, cancel_job=cancel_job, settings_io=settings_io, held_job_info=held_job_info, error12_time_stamp=error12_time_stamp, mio1_manufacturing_info=mio1_manufacturing_info, media13_name=media13_name, simm1_type=simm1_type, settings_webserver=settings_webserver, settings_spooler=settings_spooler, error31_time_stamp=error31_time_stamp, engine_media_modes_supported1=engine_media_modes_supported1, media2=media2, errorlog=errorlog, upgradable_devices_version=upgradable_devices_version, file_system2_initialize_volume=file_system2_initialize_volume, engine_data_access=engine_data_access, error12_code=error12_code, error34_time_stamp=error34_time_stamp, io=io, current_job_parsing_id=current_job_parsing_id, device_name=device_name, job_info_accounting_finishing_options=job_info_accounting_finishing_options, jam_count_by_location_count=jam_count_by_location_count, model_name=model_name, job_info_attr_11=job_info_attr_11, print_internal_page=print_internal_page, job_info_name1=job_info_name1, media4_page_count=media4_page_count, error6_code=error6_code, job_info_attr_12=job_info_attr_12, io_timeout=io_timeout, error42=error42, control_panel_key_press=control_panel_key_press, processing_subsystem=processing_subsystem, media1_engine_media_mode=media1_engine_media_mode, job_info_page_count_current_original=job_info_page_count_current_original, background_message2=background_message2, error21_time_stamp=error21_time_stamp, engine_data_access_location=engine_data_access_location, media8=media8, error48=error48, error36_code=error36_code, fw_rom_datecode=fw_rom_datecode)
mibBuilder.exportSymbols("LJ9065-MIB", default_vmi=default_vmi, upgradable_devices_max_write_count=upgradable_devices_max_write_count, printer_average=printer_average, media7_engine_media_mode=media7_engine_media_mode, ports=ports, print_engine_revision=print_engine_revision, held_job=held_job, service_id=service_id, remote_upgrade_enable=remote_upgrade_enable, media10=media10, held_job_pin=held_job_pin, simm3_type=simm3_type, tray3_phd=tray3_phd, error11_code=error11_code, simm1_bank2_type=simm1_bank2_type, hp=hp, job_info_io_source=job_info_io_source, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, clearable_warning=clearable_warning, file_systems=file_systems, channelifindex=channelifindex, pcl_default_font_height=pcl_default_font_height, tray6_media_size_loaded=tray6_media_size_loaded, tray5_media_size_loaded=tray5_media_size_loaded, job_info_attr_8=job_info_attr_8, io_switch=io_switch, media1_page_count=media1_page_count, active_print_jobs=active_print_jobs, error19_code=error19_code, error44_code=error44_code, error26_code=error26_code, device_location=device_location, media_number_of_type_supported=media_number_of_type_supported, media11_page_count=media11_page_count, replaceable_part_life_information_part_name=replaceable_part_life_information_part_name, mio2_manufacturing_info=mio2_manufacturing_info, consumables_life=consumables_life, error43_time_stamp=error43_time_stamp, job_info_attr_6=job_info_attr_6, imaging_mode=imaging_mode, simm1_capacity=simm1_capacity, job_info_attr_3=job_info_attr_3, simplex_one_to_one_mono_page_count=simplex_one_to_one_mono_page_count, held_job_security=held_job_security, error28=error28, error49_time_stamp=error49_time_stamp, imaging_mode_page_count=imaging_mode_page_count, error18_time_stamp=error18_time_stamp, display=display, socket_ping_job_events_version=socket_ping_job_events_version, web_server_security=web_server_security, error6_time_stamp=error6_time_stamp, channel_jobs_received=channel_jobs_received, held_job_control=held_job_control, error31=error31, energy_star=energy_star, error30_code=error30_code, error29_time_stamp=error29_time_stamp, media7_name=media7_name, phd3_capacity=phd3_capacity, channel_io_errors=channel_io_errors, error34_code=error34_code, error40=error40, pcl_default_font_source=pcl_default_font_source, media9_short_name=media9_short_name, held_job_set_queue_size=held_job_set_queue_size, default_lines_per_page=default_lines_per_page, jam_history_jam_count=jam_history_jam_count, tray3_media_size_loaded=tray3_media_size_loaded, held_job_user_name=held_job_user_name, mio1_type=mio1_type, phd2_capacity=phd2_capacity, test=test, socket_ping=socket_ping, media11_name=media11_name, error2=error2, usage_instructions_line1=usage_instructions_line1, media7_page_count=media7_page_count, media5_short_name=media5_short_name, error45_time_stamp=error45_time_stamp, consumable_string_information_reset=consumable_string_information_reset, consumable_string=consumable_string, deviceChannelTable=deviceChannelTable, simm4_capacity=simm4_capacity, error22=error22, simm2_bank1_capacity=simm2_bank1_capacity, error39_code=error39_code, simm1=simm1, error37=error37, error4_code=error4_code, media3=media3, error26_time_stamp=error26_time_stamp, error43_code=error43_code, error15_time_stamp=error15_time_stamp, error5=error5, replaceable_part_custom_information_part_name=replaceable_part_custom_information_part_name, tray6_phd=tray6_phd, consumable_reorder_url=consumable_reorder_url, simm4_bank2=simm4_bank2, file_system_max_open_files=file_system_max_open_files, error38_code=error38_code, usage_instructions_line3=usage_instructions_line3, default_custom_paper_dim_unit=default_custom_paper_dim_unit, held_job_quantity=held_job_quantity, simm2_bank2_capacity=simm2_bank2_capacity, error6=error6, media6=media6, simm1_bank1_type=simm1_bank1_type, postscript_total_page_count=postscript_total_page_count, error4=error4, remote_procedure_call=remote_procedure_call, media6_engine_media_mode=media6_engine_media_mode, error3_code=error3_code, media9_name=media9_name, error24_code=error24_code, simm4_bank2_type=simm4_bank2_type, firmware_download_write_count=firmware_download_write_count, error48_time_stamp=error48_time_stamp, pcl_default_font_width=pcl_default_font_width, media15=media15, simm2_bank2_type=simm2_bank2_type, replaceable_part_custom_information_count=replaceable_part_custom_information_count, media14_name=media14_name, job_info_attr_15=job_info_attr_15, install_date=install_date, error33_code=error33_code, background_message=background_message, print_meter=print_meter, media3_page_count=media3_page_count, media15_short_name=media15_short_name, error23=error23, upgradable_devices_write_time=upgradable_devices_write_time, error10_time_stamp=error10_time_stamp)
