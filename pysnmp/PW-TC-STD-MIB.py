...
Gauge32, Counter64, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, iso, ModuleIdentity, mib_2, TimeTicks, Counter32, NotificationType, Bits, ObjectIdentity, MibIdentifier, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "iso", "ModuleIdentity", "mib-2", "TimeTicks", "Counter32", "NotificationType", "Bits", "ObjectIdentity", "MibIdentifier", "Integer32")
...
mibBuilder.exportSymbols("PW-TC-STD-MIB", PwIDType=PwIDType, PwOperStatusTC=PwOperStatusTC, PwAttachmentIdentifierType=PwAttachmentIdentifierType, PwGenIdType=PwGenIdType, PwIndexType=PwIndexType, PYSNMP_MODULE_ID=pwTcStdMIB, PwIndexOrZeroType=PwIndexOrZeroType, PwGroupID=PwGroupID, PwFragSize=PwFragSize, pwTcStdMIB=pwTcStdMIB, PwStatus=PwStatus, PwFragStatus=PwFragStatus, PwCwStatusTC=PwCwStatusTC, PwCfgIndexOrzero=PwCfgIndexOrzero)
