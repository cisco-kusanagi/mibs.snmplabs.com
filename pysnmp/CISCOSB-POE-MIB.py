...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:07:02 2019
...
NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, IpAddress, iso, Integer32, Unsigned32, Bits, ModuleIdentity, MibIdentifier, Counter64, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "IpAddress", "iso", "Integer32", "Unsigned32", "Bits", "ModuleIdentity", "MibIdentifier", "Counter64", "TimeTicks")
...
mibBuilder.exportSymbols("CISCOSB-POE-MIB", rlPethPsePortEntry=rlPethPsePortEntry, rlPethPsePortOutputVoltage=rlPethPsePortOutputVoltage, rlPethPsePortStatusDescription=rlPethPsePortStatusDescription, rlPethPsePortOutputPower=rlPethPsePortOutputPower, rlPethPsePortTimeRangeName=rlPethPsePortTimeRangeName, rlPethPowerPseRpsPower=rlPethPowerPseRpsPower, rlPethPsePortOutputCurrent=rlPethPsePortOutputCurrent, rlPethPowerPseTable=rlPethPowerPseTable, rlPethPsePortOperStatus=rlPethPsePortOperStatus, rlPethPsePortIndex=rlPethPsePortIndex, rlPethMainPseEntry=rlPethMainPseEntry, rlPethPowerPsedisconnectMethod=rlPethPowerPsedisconnectMethod, rlPethMainPseTable=rlPethMainPseTable, rlPethPowerPseInrushTestEnabled=rlPethPowerPseInrushTestEnabled, rlPethMainPseSwVersion=rlPethMainPseSwVersion, rlPoe=rlPoe, rlPethMainPseHwVersion=rlPethMainPseHwVersion, rlPethMainPsePowerGuardBand=rlPethMainPsePowerGuardBand, rlPethPowerPsePower=rlPethPowerPsePower, rlPethMainPseGroupIndex=rlPethMainPseGroupIndex, rlPethPsePortOperPowerLimit=rlPethPsePortOperPowerLimit, rlPethPsePortSupportPoePlus=rlPethPsePortSupportPoePlus, PYSNMP_MODULE_ID=rlPoe, rlPethPowerPseEntry=rlPethPowerPseEntry, rlPethPsePortTable=rlPethPsePortTable, rlPethPowerPsePowerManagementMode=rlPethPowerPsePowerManagementMode, rlPethPsePortPowerLimit=rlPethPsePortPowerLimit, rlPethPsePortSupportPoe=rlPethPsePortSupportPoe, rlPethMainPseHwType=rlPethMainPseHwType, rlPethPsePortGroupIndex=rlPethPsePortGroupIndex, rlPethPsePortMaxPowerAllocAllowed=rlPethPsePortMaxPowerAllocAllowed, rlPethPowerPseGroupIndex=rlPethPowerPseGroupIndex, rlPethPsePortStatus=rlPethPsePortStatus, rlPethPowerPseTemperatureSensor=rlPethPowerPseTemperatureSensor)
