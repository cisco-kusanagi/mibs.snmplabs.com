#
# PySNMP MIB module LJ4650-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ4650-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:22 2019
...
job_info_job_settings = MibIdentifier((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 21)).setLabel("job-info-job-settings")
...
control_panel_key_press = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 2, 66), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 2147483648))).setLabel("control-panel-key-press").setMaxAccess("readwrite")
...
job_info_settings_vertical_resolution = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 21, 2), Integer32()).setLabel("job-info-settings-vertical-resolution").setMaxAccess("readonly")
if mibBuilder.loadTexts: job_info_settings_vertical_resolution.setStatus('optional')
job_info_settings_horizontal_resolution = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 21, 3), Integer32()).setLabel("job-info-settings-horizontal-resolution").setMaxAccess("readonly")
if mibBuilder.loadTexts: job_info_settings_horizontal_resolution.setStatus('optional')
job_info_settings_orientation = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 21, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))).clone(namedValues=NamedValues(("ePortrait", 1), ("eLandscape", 2), ("eReversePostrait", 3), ("eReverseLandscape", 4)))).setLabel("job-info-settings-orientation").setMaxAccess("readonly")
if mibBuilder.loadTexts: job_info_settings_orientation.setStatus('optional')
job_info_settings_economode = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 21, 11), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("eOff", 1), ("eOn", 2)))).setLabel("job-info-settings-economode").setMaxAccess("readonly")
if mibBuilder.loadTexts: job_info_settings_economode.setStatus('optional')
...
job_info_accounting_language = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 28, 30), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7, 8, 9))).clone(namedValues=NamedValues(("ePJL", 1), ("ePostscript", 2), ("eMixed", 3), ("ePCL5", 4), ("ePCL6", 5), ("ePDF", 6), ("eIPDS", 7), ("eXHTML", 8), ("eOther", 9)))).setLabel("job-info-accounting-language").setMaxAccess("readonly")
if mibBuilder.loadTexts: job_info_accounting_language.setStatus('optional')
job_info_accounting_source_trays_used = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 6, 5, 28, 31), OctetString()).setLabel("job-info-accounting-source-trays-used").setMaxAccess("readonly")
if mibBuilder.loadTexts: job_info_accounting_source_trays_used.setStatus('optional')
...
channelEntry = MibTableRow((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 6, 3, 1), ).setIndexNames((0, "LJ4650-MIB", "channelindex"))
...
deviceChannelEntry = MibTableRow((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 7, 2, 1), ).setIndexNames((0, "LJ4650-MIB", "channel-index"))
...
pml_engine_nvram_shadow_copy = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 5, 9), OctetString()).setLabel("pml-engine-nvram-shadow-copy").setMaxAccess("readwrite")
if mibBuilder.loadTexts: pml_engine_nvram_shadow_copy.setStatus('optional')
pml_engine_nvram = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 1, 5, 10), OctetString()).setLabel("pml-engine-nvram").setMaxAccess("readwrite")
if mibBuilder.loadTexts: pml_engine_nvram.setStatus('optional')
...
mibBuilder.exportSymbols("LJ4650-MIB", error46_code=error46_code, error5=error5, mass_storage_resource_changed=mass_storage_resource_changed, self_test=self_test, held_job_delete=held_job_delete, device_location=device_location, error49=error49, consumable_status_drum_life_units=consumable_status_drum_life_units, port1_parallel_speed=port1_parallel_speed, consumable_status_engine_usage_units=consumable_status_engine_usage_units, media18_page_count=media18_page_count, media16_short_name=media16_short_name, consumable_status_job_count=consumable_status_job_count, simm1_bank2=simm1_bank2, error48=error48, accounting=accounting, file_system_security_access_password=file_system_security_access_password, printer_color_accounting=printer_color_accounting, form_feed_needed=form_feed_needed, error27_code=error27_code, consumable_status_total_capacity=consumable_status_total_capacity, simm3_capacity=simm3_capacity, error39_time_stamp=error39_time_stamp, media6_name=media6_name, job_being_parsed=job_being_parsed, current_job_parsing_id=current_job_parsing_id, channelstate=channelstate, pdf_enabled=pdf_enabled, simm1_bank1_type=simm1_bank1_type, control_panel_display=control_panel_display, io_switch=io_switch, port1_parallel_bidirectionality=port1_parallel_bidirectionality, media14_short_name=media14_short_name, media2_engine_media_mode=media2_engine_media_mode, media23_page_count=media23_page_count, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, source_tray_usage=source_tray_usage, printed_media_total_charge=printed_media_total_charge, error13=error13, error38=error38, printer_cal_cpr_utc=printer_cal_cpr_utc, error17_time_stamp=error17_time_stamp, simm3_bank1_capacity=simm3_bank1_capacity, media12_engine_media_mode=media12_engine_media_mode, file_system2_initialize_volume=file_system2_initialize_volume, printed_media_color_dimplex_count=printed_media_color_dimplex_count, mass_storage_resource_change_counter=mass_storage_resource_change_counter, override_media_name=override_media_name, media20_short_name=media20_short_name, media19_short_name=media19_short_name, control_panel_display_graphical_contents=control_panel_display_graphical_contents, file_system3_initialize_volume=file_system3_initialize_volume, media6_page_count=media6_page_count, media20_page_count=media20_page_count, media10=media10, mio3=mio3, settings_rpc=settings_rpc, simm2_bank2_type=simm2_bank2_type, error19_code=error19_code, pdl_postscript=pdl_postscript, manually_feed_prompt_test=manually_feed_prompt_test, device_configure_printer_parameters=device_configure_printer_parameters, media17_short_name=media17_short_name, media21_short_name=media21_short_name, file_system4=file_system4, simm4=simm4, error31_code=error31_code, held_job_print=held_job_print, media19_page_count=media19_page_count, media_size=media_size, default_vmi=default_vmi, color_supply_out_action=color_supply_out_action, media20_engine_media_mode=media20_engine_media_mode, simm5_type=simm5_type, job_info_settings_economode=job_info_settings_economode, media1_short_name=media1_short_name, media1=media1, mio1_model_name=mio1_model_name, simm3=simm3, consumable_current_state=consumable_current_state, media3_name=media3_name, simm2_bank1_type=simm2_bank1_type, media5_engine_media_mode=media5_engine_media_mode, media18_name=media18_name, media23_engine_media_mode=media23_engine_media_mode, printed_media_dimplex_count=printed_media_dimplex_count, error39=error39, error42_code=error42_code, error1=error1, error11=error11, error44=error44, media21=media21, held_job_set_queue_size=held_job_set_queue_size, firmware_download_write_count=firmware_download_write_count, media_number_of_type_supported=media_number_of_type_supported, error50=error50, mio1_type=mio1_type, tray3_phd=tray3_phd, display_status=display_status, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, error47_time_stamp=error47_time_stamp, printer_calibration_dhalf=printer_calibration_dhalf, source_tray_usage_count=source_tray_usage_count, error17_code=error17_code, firmware_download_version=firmware_download_version, media26_page_count=media26_page_count, error10_code=error10_code, pcl_default_font_number=pcl_default_font_number, media15_page_count=media15_page_count, error46_time_stamp=error46_time_stamp, printed_media_usage=printed_media_usage, channel=channel, fw_rom_datecode=fw_rom_datecode, error40_time_stamp=error40_time_stamp, media5_name=media5_name, error10_time_stamp=error10_time_stamp, simm5_bank=simm5_bank, file_systems=file_systems, media13_engine_media_mode=media13_engine_media_mode, error28_time_stamp=error28_time_stamp, media17=media17, error50_code=error50_code, consumables=consumables, printed_media_duplex_charge=printed_media_duplex_charge, tray2_media_size_loaded=tray2_media_size_loaded, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, error25_code=error25_code, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, media23_name=media23_name, error29=error29, media24_engine_media_mode=media24_engine_media_mode, hold_job_timeout=hold_job_timeout, media7_engine_media_mode=media7_engine_media_mode, error27=error27, held_job=held_job, job_info_accounting_finishing_options=job_info_accounting_finishing_options, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, job_info_attr_10=job_info_attr_10, error45_time_stamp=error45_time_stamp, error7_code=error7_code, marking_agent_density=marking_agent_density, channel_jobs_received=channel_jobs_received, settings_print_media=settings_print_media, error36_code=error36_code, job=job, media_names_available=media_names_available, status_prt_eng=status_prt_eng, held_job_info=held_job_info, consumable_status_page_count_quarter_speed=consumable_status_page_count_quarter_speed, simm5_bank2=simm5_bank2, device_configure=device_configure, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, tables=tables, error26_time_stamp=error26_time_stamp, printer_accounting=printer_accounting, printer_cal_dhalf_page_count=printer_cal_dhalf_page_count, simm4_bank1=simm4_bank1, media26_short_name=media26_short_name, error48_code=error48_code, error12=error12, error17=error17, display=display, on_off_line=on_off_line, printed_media_color_total_count=printed_media_color_total_count, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, print_engine=print_engine, marker_density_calibration=marker_density_calibration, print_internal_page=print_internal_page, socket_ping_job_events_version=socket_ping_job_events_version, error33_code=error33_code, error15=error15, print_media=print_media, error8_code=error8_code, error18_time_stamp=error18_time_stamp, media14_page_count=media14_page_count, error29_time_stamp=error29_time_stamp, timestamp=timestamp, job_info_stage=job_info_stage, overflow_bin=overflow_bin, media6=media6, job_info_attr_8=job_info_attr_8, printed_media_simplex_count=printed_media_simplex_count, error32_time_stamp=error32_time_stamp, simm2_bank1_capacity=simm2_bank1_capacity, error36_time_stamp=error36_time_stamp, job_info_outbins_used=job_info_outbins_used, resource_manager=resource_manager, error34_code=error34_code, tray5_media_size_loaded=tray5_media_size_loaded, settings_mass_storage_bd=settings_mass_storage_bd, error16=error16, pml_engine_nvram_shadow_copy=pml_engine_nvram_shadow_copy, simm2=simm2, channelifindex=channelifindex, media6_engine_media_mode=media6_engine_media_mode, error7=error7, low_marking_agent_processing=low_marking_agent_processing, media13_page_count=media13_page_count, consumable_status_usage_count=consumable_status_usage_count, default_bits_per_pixel=default_bits_per_pixel, engine_parameter=engine_parameter, error11_code=error11_code, media9_engine_media_mode=media9_engine_media_mode, printed_media_simplex_charge=printed_media_simplex_charge, job_info_outcome=job_info_outcome, media16_page_count=media16_page_count, form_feed=form_feed, print_engine_revision=print_engine_revision, error49_time_stamp=error49_time_stamp, simm1=simm1, upgradable_devices_write_count=upgradable_devices_write_count, model_number=model_number, error12_time_stamp=error12_time_stamp, media9_short_name=media9_short_name, file_system2=file_system2, media8_name=media8_name, error47=error47, sleep_mode=sleep_mode, errorlog=errorlog, error35=error35, default_custom_paper_dim_unit=default_custom_paper_dim_unit, error42=error42, rpc_bind_protocol_address=rpc_bind_protocol_address, job_input_auto_continue_timeout=job_input_auto_continue_timeout, web_server_password=web_server_password, media21_page_count=media21_page_count, pml=pml, error13_code=error13_code, media4_name=media4_name, io=io, service_id=service_id, file_system4_initialize_volume=file_system4_initialize_volume, default_media_name=default_media_name, webserver_proc_sub=webserver_proc_sub, DisplayString=DisplayString, firmware_download_current_state=firmware_download_current_state, error22_code=error22_code, cancel_job=cancel_job, job_info_attr_16=job_info_attr_16, consumable_status_total_page_count=consumable_status_total_page_count, postscript_print_errors=postscript_print_errors, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, error21_code=error21_code, error29_code=error29_code, job_info_settings_vertical_resolution=job_info_settings_vertical_resolution, non_assured_oht_page_count=non_assured_oht_page_count, job_info_page_count_current_original=job_info_page_count_current_original, mio1_manufacturing_info=mio1_manufacturing_info, simm4_bank2_type=simm4_bank2_type, error18_code=error18_code, marking_agent_shadows_density_setting=marking_agent_shadows_density_setting, media9_name=media9_name, error38_code=error38_code)
mibBuilder.exportSymbols("LJ4650-MIB", printed_media_combined_total=printed_media_combined_total, menus=menus, error1_time_stamp=error1_time_stamp, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, printer_cal_dhalf_utc=printer_cal_dhalf_utc, printed_modes_total_count=printed_modes_total_count, error19_time_stamp=error19_time_stamp, mass_storage_resources=mass_storage_resources, job_info_attr_13=job_info_attr_13, destination_bin_usage_total=destination_bin_usage_total, media_counts=media_counts, consumable_status_engine_usage_count=consumable_status_engine_usage_count, media25=media25, error35_time_stamp=error35_time_stamp, io_timeout=io_timeout, mio=mio, media11_short_name=media11_short_name, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, mono_color_switching_mode=mono_color_switching_mode, media_modes=media_modes, simm2_bank2=simm2_bank2, firmware_download_name=firmware_download_name, intray=intray, error38_time_stamp=error38_time_stamp, file_system=file_system, settings_job=settings_job, error3_code=error3_code, outbin=outbin, job_info_pages_printed=job_info_pages_printed, simm1_bank1_capacity=simm1_bank1_capacity, serial_number=serial_number, ram_disk_size=ram_disk_size, active_print_jobs=active_print_jobs, consumable_status_developer_life_units=consumable_status_developer_life_units, media20=media20, media7=media7, error48_time_stamp=error48_time_stamp, media17_engine_media_mode=media17_engine_media_mode, error24_code=error24_code, consumable_status_drum_life=consumable_status_drum_life, default_lines_per_page=default_lines_per_page, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, settings_marking_agent=settings_marking_agent, usage_instructions_line4=usage_instructions_line4, pcl_default_font_width=pcl_default_font_width, background_status_msg_line2_part1=background_status_msg_line2_part1, settings_intray=settings_intray, error_log_clear=error_log_clear, error22_time_stamp=error22_time_stamp, error10=error10, job_output_auto_continue_timeout=job_output_auto_continue_timeout, held_job_enable=held_job_enable, consumable_status_last_use_date=consumable_status_last_use_date, input_tray_auto_select=input_tray_auto_select, consumable_life_low_threshold=consumable_life_low_threshold, simm3_bank=simm3_bank, PYSNMP_MODULE_ID=hp, error6=error6, background_message2=background_message2, media19_engine_media_mode=media19_engine_media_mode, firmware_download_write_time=firmware_download_write_time, error6_time_stamp=error6_time_stamp, consumable_status_manufacturer_name=consumable_status_manufacturer_name, device=device, default_media_size=default_media_size, error44_code=error44_code, media5=media5, error21=error21, media26_engine_media_mode=media26_engine_media_mode, status_rpc=status_rpc, printer_average_marking_agent_coverage_sum=printer_average_marking_agent_coverage_sum, printed_modes_mono_count=printed_modes_mono_count, media_size_count=media_size_count, channel_bytes_received=channel_bytes_received, id=id, job_info_attr_1=job_info_attr_1, job_info_attr_12=job_info_attr_12, error44_time_stamp=error44_time_stamp, job_info_attribute=job_info_attribute, marking_agent=marking_agent, consumable_status_formatter_color_page_count=consumable_status_formatter_color_page_count, settings_system=settings_system, channelnumberofchannels=channelnumberofchannels, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, mio1=mio1, printed_modes_usage_total=printed_modes_usage_total, consumable_status_duplex_sheet_count=consumable_status_duplex_sheet_count, printer_average=printer_average, usage_staple_count=usage_staple_count, media16_name=media16_name, media14_name=media14_name, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, settings_spooler=settings_spooler, consumable_status_mono_page_count=consumable_status_mono_page_count, outbins=outbins, error9_code=error9_code, job_info_attr_4=job_info_attr_4, consumable_status_first_install_date=consumable_status_first_install_date, clearable_warning=clearable_warning, outbin1_override_mode=outbin1_override_mode, override_media_size=override_media_size, media1_name=media1_name, held_job_pin=held_job_pin, error47_code=error47_code, error19=error19, error4_time_stamp=error4_time_stamp, job_info_settings_horizontal_resolution=job_info_settings_horizontal_resolution, held_job_quantity=held_job_quantity, show_address=show_address, firmware_download_maximum_write_count=firmware_download_maximum_write_count, media2_page_count=media2_page_count, error49_code=error49_code, mass_storage_block_driver=mass_storage_block_driver, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, media15=media15, error24_time_stamp=error24_time_stamp, auto_continue=auto_continue, error43=error43, error2=error2, background_status_msg_line1_part1=background_status_msg_line1_part1, media4_engine_media_mode=media4_engine_media_mode, held_job_retention=held_job_retention, mopy_mode=mopy_mode, consumable_status_total_equiv_page_count=consumable_status_total_equiv_page_count, consumables_life=consumables_life, consumable_status_serial_number=consumable_status_serial_number, file_system_delete_files=file_system_delete_files, error30=error30, consumable_status_page_count_half_speed=consumable_status_page_count_half_speed, printer_calibration_cpr=printer_calibration_cpr, media3_engine_media_mode=media3_engine_media_mode, media24=media24, simm1_bank=simm1_bank, maximum_ram_disk_memory=maximum_ram_disk_memory, control_panel_button_press=control_panel_button_press, error42_time_stamp=error42_time_stamp, media12_short_name=media12_short_name, error25=error25, default_page_protect=default_page_protect, perm_store_init_occurred=perm_store_init_occurred, job_info_accounting=job_info_accounting, simm1_bank2_capacity=simm1_bank2_capacity, media23=media23, job_info_attr_15=job_info_attr_15, usage_printer_color_total_charge=usage_printer_color_total_charge, error4=error4, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, job_info_pages_in_original=job_info_pages_in_original, pdl_pdf=pdl_pdf, job_info_size=job_info_size, simm3_bank2_capacity=simm3_bank2_capacity, media13=media13, settings_webserver=settings_webserver, source_tray_usage_total=source_tray_usage_total, localization_languages_supported=localization_languages_supported, media16_engine_media_mode=media16_engine_media_mode, file_system_external_access_capabilities=file_system_external_access_capabilities, error16_time_stamp=error16_time_stamp, north_edge_offset=north_edge_offset, media25_engine_media_mode=media25_engine_media_mode, media26=media26, simm2_bank2_capacity=simm2_bank2_capacity, source_subsystem=source_subsystem, error39_code=error39_code, deviceChannelEntry=deviceChannelEntry, job_info_accounting_media_type=job_info_accounting_media_type, error5_code=error5_code, media11=media11, job_info_settings_orientation=job_info_settings_orientation, media12_page_count=media12_page_count, printed_media_color_usage=printed_media_color_usage, consumables_status=consumables_status, usage_instructions_line3=usage_instructions_line3, remote_procedure_call=remote_procedure_call, error33=error33, marking_agent_highlights_density_setting=marking_agent_highlights_density_setting, media11_page_count=media11_page_count, media18=media18, media8_page_count=media8_page_count, simm4_bank1_type=simm4_bank1_type, duplex_page_count=duplex_page_count, error9=error9, media7_page_count=media7_page_count, background_message1=background_message1, error11_time_stamp=error11_time_stamp, error34=error34, consumable_status_input_option_sheet_count=consumable_status_input_option_sheet_count, media_info=media_info, consumable_status_page_count_xy_other=consumable_status_page_count_xy_other, error46=error46, destination_bin_usage_count=destination_bin_usage_count, consumable_status_page_count_third_speed=consumable_status_page_count_third_speed, settings_file_system=settings_file_system, simm2_capacity=simm2_capacity, consumable_status_info=consumable_status_info, printer_average_marking_agent_coverage_sum_squared=printer_average_marking_agent_coverage_sum_squared, intray3=intray3, error31_time_stamp=error31_time_stamp, media26_name=media26_name, error45=error45, settings_prt_eng=settings_prt_eng, channelTable=channelTable, media11_name=media11_name, port1=port1, processing_subsystem=processing_subsystem, total_color_page_count=total_color_page_count, error7_time_stamp=error7_time_stamp, tray1_media_size_loaded=tray1_media_size_loaded, settings_io=settings_io, web_server_security=web_server_security, channelEntry=channelEntry, error6_code=error6_code, media6_short_name=media6_short_name, media10_short_name=media10_short_name, job_info_attr_3=job_info_attr_3, media24_short_name=media24_short_name, error20=error20, usage_instructions_line2=usage_instructions_line2, printed_modes_color_count=printed_modes_color_count, media2=media2, remote_upgrade_enable=remote_upgrade_enable, simm4_type=simm4_type, printer_cal_cpr_page_count=printer_cal_cpr_page_count, consumable_status_oem_name=consumable_status_oem_name, channel_io_errors=channel_io_errors, destination_subsystem=destination_subsystem, consumable_status_manufacturing_date=consumable_status_manufacturing_date, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, error14_time_stamp=error14_time_stamp, error15_code=error15_code, consumable_status_authentication=consumable_status_authentication, mio3_model_name=mio3_model_name, consumable_status_capacity_units=consumable_status_capacity_units, test=test, error20_time_stamp=error20_time_stamp, marking_agent_midtones_density_setting=marking_agent_midtones_density_setting, consumable_status_developer_life=consumable_status_developer_life, pdl=pdl, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, error12_code=error12_code, print_meter=print_meter, engine_media_modes_supported1=engine_media_modes_supported1, control_panel_display_contents_crc=control_panel_display_contents_crc, localization_countries_supported=localization_countries_supported, simm1_bank1=simm1_bank1, interface=interface, reprint=reprint, mio3_manufacturing_info=mio3_manufacturing_info, usage_printer_mono_total_charge=usage_printer_mono_total_charge, consumable_status_usage_units=consumable_status_usage_units, error40=error40, error15_time_stamp=error15_time_stamp, error23_code=error23_code, media19_name=media19_name)
mibBuilder.exportSymbols("LJ4650-MIB", simm3_bank2_type=simm3_bank2_type, media14_engine_media_mode=media14_engine_media_mode, pdf_version=pdf_version, error8_time_stamp=error8_time_stamp, media18_engine_media_mode=media18_engine_media_mode, upgradable_devices_write_time=upgradable_devices_write_time, simm2_type=simm2_type, error24=error24, media9_page_count=media9_page_count, out_marking_agent_processing=out_marking_agent_processing, media15_engine_media_mode=media15_engine_media_mode, pjl=pjl, simm=simm, simm1_bank2_type=simm1_bank2_type, error30_time_stamp=error30_time_stamp, default_horizontal_black_resolution=default_horizontal_black_resolution, error23=error23, printed_media_color_duplex_count=printed_media_color_duplex_count, error32_code=error32_code, error37=error37, firmware_download=firmware_download, error2_time_stamp=error2_time_stamp, consumable_life_usage_units=consumable_life_usage_units, error3=error3, status_mass_storage_bd=status_mass_storage_bd, error22=error22, device_name=device_name, simm1_capacity=simm1_capacity, usage_average_toner_coverage=usage_average_toner_coverage, printed_media_duplex_count=printed_media_duplex_count, ram_disk_mode=ram_disk_mode, job_info_accounting_source_trays_used=job_info_accounting_source_trays_used, job_info_name1=job_info_name1, asset_number=asset_number, error33_time_stamp=error33_time_stamp, simm2_bank1=simm2_bank1, consumable_status_color_page_count=consumable_status_color_page_count, error2_code=error2_code, media1_page_count=media1_page_count, control_panel_key_press=control_panel_key_press, media22=media22, postscript_total_page_count=postscript_total_page_count, simm5_bank1_capacity=simm5_bank1_capacity, job_info_requested_originals=job_info_requested_originals, background_message=background_message, media4_short_name=media4_short_name, simm4_bank2_capacity=simm4_bank2_capacity, media10_name=media10_name, media21_engine_media_mode=media21_engine_media_mode, media_types=media_types, media25_short_name=media25_short_name, error18=error18, source_tray_accounting=source_tray_accounting, intray2=intray2, media4=media4, pcl_default_font_height=pcl_default_font_height, media18_short_name=media18_short_name, file_system_max_open_files=file_system_max_open_files, page_frame_memory_available=page_frame_memory_available, media5_short_name=media5_short_name, error43_time_stamp=error43_time_stamp, usage_instructions_line1=usage_instructions_line1, channelprinteralert=channelprinteralert, job_info_name2=job_info_name2, channelinformation=channelinformation, simm3_bank1_type=simm3_bank1_type, upgradable_devices_version=upgradable_devices_version, error25_time_stamp=error25_time_stamp, error41_code=error41_code, printed_media_color_simplex_count=printed_media_color_simplex_count, file_system3=file_system3, media22_short_name=media22_short_name, error40_code=error40_code, error14_code=error14_code, tray1_phd=tray1_phd, printed_modes_usage=printed_modes_usage, firmware_download_write_status_supported=firmware_download_write_status_supported, default_vertical_black_resolution=default_vertical_black_resolution, consumable_status_page_count_legal=consumable_status_page_count_legal, os_execute_file=os_execute_file, held_job_control=held_job_control, error41_time_stamp=error41_time_stamp, host_application_available_memory=host_application_available_memory, deviceChannelTable=deviceChannelTable, media7_name=media7_name, error43_code=error43_code, channelprotocolversion=channelprotocolversion, media3_page_count=media3_page_count, media17_name=media17_name, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, error28_code=error28_code, media24_page_count=media24_page_count, simm1_type=simm1_type, install_date=install_date, channel_bytes_sent=channel_bytes_sent, media7_short_name=media7_short_name, media10_engine_media_mode=media10_engine_media_mode, media12=media12, job_info_attr_5=job_info_attr_5, error20_code=error20_code, collated_originals_support=collated_originals_support, rpc_bound_protocol_address=rpc_bound_protocol_address, error23_time_stamp=error23_time_stamp, simm2_bank=simm2_bank, consumable_status=consumable_status, error35_code=error35_code, job_info_attr_9=job_info_attr_9, consumable_reorder_url=consumable_reorder_url, simm5=simm5, job_info_physical_outbins_used=job_info_physical_outbins_used, consumable_status_engine_job_count=consumable_status_engine_job_count, intray5=intray5, device_system=device_system, consumable_status_cartridge_model=consumable_status_cartridge_model, job_info_attr_11=job_info_attr_11, simm3_bank2=simm3_bank2, status_system=status_system, job_info_pages_processed=job_info_pages_processed, media9=media9, upgradable_devices_current_state=upgradable_devices_current_state, media11_engine_media_mode=media11_engine_media_mode, simm5_bank2_capacity=simm5_bank2_capacity, error50_time_stamp=error50_time_stamp, job_info_change_id=job_info_change_id, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, media13_short_name=media13_short_name, operating_system=operating_system, simm5_bank1_type=simm5_bank1_type, error26=error26, error14=error14, job_info_attr_6=job_info_attr_6, printed_modes_accounting=printed_modes_accounting, pcl_total_page_count=pcl_total_page_count, mio3_type=mio3_type, pml_engine_nvram=pml_engine_nvram, media8_engine_media_mode=media8_engine_media_mode, engine_self_diagnostic=engine_self_diagnostic, upgradable_devices_max_write_count=upgradable_devices_max_write_count, intrays=intrays, error1_code=error1_code, error36=error36, job_info_state=job_info_state, ports=ports, media2_short_name=media2_short_name, media19=media19, spooler=spooler, mio2_model_name=mio2_model_name, simm4_bank2=simm4_bank2, job_info_accounting_language=job_info_accounting_language, channeltype=channeltype, media24_name=media24_name, media25_page_count=media25_page_count, simm5_bank1=simm5_bank1, error13_time_stamp=error13_time_stamp, error31=error31, simm3_bank1=simm3_bank1, error27_time_stamp=error27_time_stamp, error37_code=error37_code, media22_engine_media_mode=media22_engine_media_mode, tray3_media_size_loaded=tray3_media_size_loaded, fw_rom_revision=fw_rom_revision, upgradable_devices=upgradable_devices, job_input_auto_continue_mode=job_input_auto_continue_mode, error3_time_stamp=error3_time_stamp, pdf_print_errors=pdf_print_errors, outbin1=outbin1, intray1=intray1, channel_mio=channel_mio, media4_page_count=media4_page_count, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, pdl_pcl=pdl_pcl, error41=error41, energy_star=energy_star, media3=media3, job_info_attr_7=job_info_attr_7, media3_short_name=media3_short_name, upgradable_devices_name=upgradable_devices_name, destination_bin_accounting=destination_bin_accounting, media25_name=media25_name, error28=error28, media15_short_name=media15_short_name, hp=hp, default_copies=default_copies, mio2_manufacturing_info=mio2_manufacturing_info, simm5_capacity=simm5_capacity, job_info_attr_14=job_info_attr_14, model_name=model_name, media15_name=media15_name, error9_time_stamp=error9_time_stamp, media21_name=media21_name, tray5_phd=tray5_phd, usage_printer_total_charge=usage_printer_total_charge, media13_name=media13_name, media10_page_count=media10_page_count, pysmi_continue=pysmi_continue, status_pdl=status_pdl, job_info_attr_2=job_info_attr_2, consumables_1=consumables_1, error34_time_stamp=error34_time_stamp, settings_outbin=settings_outbin, error16_code=error16_code, destination_bin_usage=destination_bin_usage, consumable_status_page_count_a4_letter=consumable_status_page_count_a4_letter, job_info_printed_originals=job_info_printed_originals, held_job_user_name=held_job_user_name, mio2=mio2, simm4_bank1_capacity=simm4_bank1_capacity, job_info_job_settings=job_info_job_settings, job_info_io_source=job_info_io_source, settings_pdl=settings_pdl, socket_ping=socket_ping, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, error26_code=error26_code, media8=media8, pdf_total_page_count=pdf_total_page_count, error5_time_stamp=error5_time_stamp, pcl_default_font_source=pcl_default_font_source, media5_page_count=media5_page_count, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, held_job_security=held_job_security, media23_short_name=media23_short_name, simm4_capacity=simm4_capacity, error45_code=error45_code, media22_name=media22_name, error32=error32, default_custom_paper_feed_dim=default_custom_paper_feed_dim, media8_short_name=media8_short_name, media17_page_count=media17_page_count, media22_page_count=media22_page_count, job_info_accounting_job_type=job_info_accounting_job_type, simm4_bank=simm4_bank, netPMLmgmt=netPMLmgmt, simm5_bank2_type=simm5_bank2_type, job_info_accounting_media_size=job_info_accounting_media_size, error8=error8, mio2_type=mio2_type, media12_name=media12_name, cold_reset_media_size=cold_reset_media_size, error4_code=error4_code, held_job_job_name=held_job_job_name, media20_name=media20_name, media14=media14, error21_time_stamp=error21_time_stamp, error30_code=error30_code, job_info=job_info, error37_time_stamp=error37_time_stamp, channelstatus=channelstatus, tray2_phd=tray2_phd, media1_engine_media_mode=media1_engine_media_mode, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, media2_name=media2_name, job_info_accounting_black_dots=job_info_accounting_black_dots, simm3_type=simm3_type, media16=media16)
mibBuilder.exportSymbols("LJ4650-MIB", )
