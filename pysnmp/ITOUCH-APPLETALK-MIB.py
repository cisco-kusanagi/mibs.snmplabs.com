...
NotificationType, Gauge32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, MibIdentifier, iso, Integer32, ModuleIdentity, Unsigned32, IpAddress, Bits, TimeTicks, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "MibIdentifier", "iso", "Integer32", "ModuleIdentity", "Unsigned32", "IpAddress", "Bits", "TimeTicks", "Counter32")
...
mibBuilder.exportSymbols("ITOUCH-APPLETALK-MIB", applePortZoneStatus=applePortZoneStatus, applePortRouterType=applePortRouterType, applePortBringBackTime=applePortBringBackTime, appleTrafficIntf=appleTrafficIntf, appleTrafficMonitoring=appleTrafficMonitoring, applePortIndex=applePortIndex, applePortImportStatus=applePortImportStatus, appleTrafficEntry=appleTrafficEntry, arapDefaultZoneName=arapDefaultZoneName, applePortPacketsOut=applePortPacketsOut, appleNbpNode=appleNbpNode, appleTrafficSort=appleTrafficSort, arapPortGuestLoginsOk=arapPortGuestLoginsOk, arapPortZoneAccess=arapPortZoneAccess, applePortNetEnd=applePortNetEnd, applePortExportZone=applePortExportZone, appleNbpSocket=appleNbpSocket, arapPortTable=arapPortTable, appleTrafficPercent=appleTrafficPercent, applePortChecksum=applePortChecksum, applePortImportIndex=applePortImportIndex, applePortTable=applePortTable, appleTrafficTable=appleTrafficTable, applePortLastErrorTime=applePortLastErrorTime, xApple=xApple, arapPassword=arapPassword, appleStatusIf=appleStatusIf, appleNbpZone=appleNbpZone, applePortLastErrorData=applePortLastErrorData, applePortZoneName=applePortZoneName, applePortForwardsIn=applePortForwardsIn, xApplePolicy=xApplePolicy, xAppleTraffic=xAppleTraffic, applePortForwardsOut=applePortForwardsOut, arapPortTimeConnected=arapPortTimeConnected, applePortNetStart=applePortNetStart, arapPortEntry=arapPortEntry, appleStatus=appleStatus, applePortPacketsIn=applePortPacketsIn, appleNbpTable=appleNbpTable, arapPortZoneName=arapPortZoneName, applePortProtocolPriority=applePortProtocolPriority, applePortImportZone=applePortImportZone, appleTrafficSrc=appleTrafficSrc, appleNbpType=appleNbpType, xAppleSystem=xAppleSystem, xAppleNbp=xAppleNbp, applePortEntry=applePortEntry, applePortUseNeighborNotify=applePortUseNeighborNotify, applePortArpRetransmitCount=applePortArpRetransmitCount, applePortExportAction=applePortExportAction, appleTrafficDst=appleTrafficDst, applePortZoneIndex=applePortZoneIndex, arapPortMaxConnectTime=arapPortMaxConnectTime, applePortImportAction=applePortImportAction, applePortImportType=applePortImportType, applePortExportType=applePortExportType, appleState=appleState, appleTrafficIndex=appleTrafficIndex, arapPortTimeRemaining=arapPortTimeRemaining, applePortArpInterval=applePortArpInterval, applePortZoneEntry=applePortZoneEntry, arapPortEnabled=arapPortEnabled, xApplePort=xApplePort, applePortExportStatus=applePortExportStatus, applePortNetAddress=applePortNetAddress, applePortLastError=applePortLastError, xAppleRemoteAccess=xAppleRemoteAccess, applePortExportIndex=applePortExportIndex, appleNbpEntry=appleNbpEntry, applePortImportName=applePortImportName, applePortExportName=applePortExportName, applePortExportEntry=applePortExportEntry, applePortImportTable=applePortImportTable, appleNbpName=appleNbpName, applePortErrors=applePortErrors, applePortZoneTable=applePortZoneTable, applePortExportTable=applePortExportTable, applePortImportEntry=applePortImportEntry)
