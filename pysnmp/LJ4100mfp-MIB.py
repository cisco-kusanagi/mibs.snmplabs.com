#
# PySNMP MIB module LJ4100mfp-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ4100mfp-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:15 2019
...
NotificationType, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Bits, MibIdentifier, Integer32, ObjectIdentity, Unsigned32, IpAddress, ModuleIdentity, Counter64, Gauge32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Bits", "MibIdentifier", "Integer32", "ObjectIdentity", "Unsigned32", "IpAddress", "ModuleIdentity", "Counter64", "Gauge32", "iso")
...
prtgeneralcurrentlocalization = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 2, 5, 1, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 10))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: prtgeneralcurrentlocalization.setStatus('optional')
prtconsolelocalization = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 2, 5, 1, 1, 10), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 10))).setMaxAccess("readwrite")
...
default_media_size = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 3, 3, 1, 13), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 17, 18, 25, 26, 45, 65, 80, 81, 90, 91, 100, 101))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eROC16K", 17), ("eJISExecutive", 18), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eJISB5", 45), ("eISOB5", 65), ("eMonarch", 80), ("eCommercial10", 81), ("eInternationalDL", 90), ("eInternationalC5", 91), ("eInternationalB5", 100), ("eCustom", 101)))).setLabel("default-media-size").setMaxAccess("readwrite")
...
default_scan_original_size = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 2, 2, 1, 66), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 25, 26, 45))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eJISB5", 45)))).setLabel("default-scan-original-size").setMaxAccess("readwrite")
...
scanner_accessory_digital_send_log_event_counter = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 2, 2, 1, 79), Integer32()).setLabel("scanner-accessory-digital-send-log-event-counter").setMaxAccess("readonly")
if mibBuilder.loadTexts: scanner_accessory_digital_send_log_event_counter.setStatus('optional')
scanner_accessory_digital_send_config_email_gateway = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 2, 2, 1, 80), DisplayString()).setLabel("scanner-accessory-digital-send-config-email-gateway").setMaxAccess("readonly")
if mibBuilder.loadTexts: scanner_accessory_digital_send_config_email_gateway.setStatus('optional')
scanner_accessory_digital_send_config_ldap_gateway = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 2, 2, 1, 81), DisplayString()).setLabel("scanner-accessory-digital-send-config-ldap-gateway").setMaxAccess("readonly")
if mibBuilder.loadTexts: scanner_accessory_digital_send_config_ldap_gateway.setStatus('optional')
scanner_accessory_digital_send_config_dsm_enabled_fax = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 2, 2, 1, 82), Integer32()).setLabel("scanner-accessory-digital-send-config-dsm-enabled-fax").setMaxAccess("readonly")
if mibBuilder.loadTexts: scanner_accessory_digital_send_config_dsm_enabled_fax.setStatus('optional')
scanner_accessory_digital_send_config_fax_embedded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 2, 2, 1, 83), Integer32()).setLabel("scanner-accessory-digital-send-config-fax-embedded").setMaxAccess("readwrite")
...
scan_calibration_error = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 2, 2, 2, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6))).clone(namedValues=NamedValues(("eNoError", 1), ("eUnknownCalibrationError", 2), ("eScannerFeederEmpty", 3), ("eLowMemory", 4), ("eWriteFailed", 5), ("eScannerBusy", 6)))).setLabel("scan-calibration-error").setMaxAccess("readonly")
...
default_copier_media_size = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 1, 9), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 25, 26, 45))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eJISB5", 45)))).setLabel("default-copier-media-size").setMaxAccess("readwrite")
...
default_copy_output_bin = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 5, 1, 30), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1))).clone(namedValues=NamedValues(("eOutFaceDown", 1)))).setLabel("default-copy-output-bin").setMaxAccess("readwrite")
...
tray1_media_size_loaded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 3, 3, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 17, 18, 26, 25, 45, 65, 80, 81, 90, 91, 100, 101, 32764, 32767))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eRock16K", 17), ("eJISExecutive", 18), ("eISOandJISA4", 26), ("eISOandJISA5", 25), ("eJISB5", 45), ("eISOB5", 65), ("eMonarch", 80), ("eCommercial10", 81), ("eInternationalDL", 90), ("eInternationalC5", 91), ("eInternationalB5", 100), ("eCustom", 101), ("eAnyCustomSize", 32764), ("eUnknownMediaSize", 32767)))).setLabel("tray1-media-size-loaded").setMaxAccess("readwrite")
...
tray2_media_size_loaded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 3, 3, 2, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 17, 18, 25, 26, 65, 80, 81, 90, 91, 100, 101, 32764, 32767))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eRock16K", 17), ("eJISExecutive", 18), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eISOB5", 65), ("eMonarch", 80), ("eCommercial10", 81), ("eInternationalDL", 90), ("eInternationalC5", 91), ("eInternationalB5", 100), ("eCustom", 101), ("eAnyCustomSize", 32764), ("eUnknownMediaSize", 32767)))).setLabel("tray2-media-size-loaded").setMaxAccess("readonly")
...
tray3_media_size_loaded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 3, 3, 3, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 17, 18, 25, 26, 65, 80, 81, 90, 91, 100, 101, 32764, 32767))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eRock16K", 17), ("eJISExecutive", 18), ("eISOandJISA5", 25), ("eISOandJISA4", 26), ("eISOB5", 65), ("eMonarch", 80), ("eCommercial10", 81), ("eInternationalDL", 90), ("eInternationalC5", 91), ("eInternationalB5", 100), ("eCustom", 101), ("eAnyCustomSize", 32764), ("eUnknownMediaSize", 32767)))).setLabel("tray3-media-size-loaded").setMaxAccess("readonly")
...
tray5_media_size_loaded = MibScalar((1, 3, 6, 1, 4, 1, 11, 2, 3, 9, 4, 2, 1, 4, 1, 3, 3, 5, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 45, 26, 101, 32764, 32767))).clone(namedValues=NamedValues(("eUSExecutive", 1), ("eUSLetter", 2), ("eUSLegal", 3), ("eJISB5", 45), ("eISOandJISA4", 26), ("eCustom", 101), ("eAnyCustomSize", 32764), ("eUnknownMediaSize", 32767)))).setLabel("tray5-media-size-loaded").setMaxAccess("readonly")
...
mibBuilder.exportSymbols("LJ4100mfp-MIB", phd6=phd6, prtinputsecurity=prtinputsecurity, scanned_media_simplex_charge=scanned_media_simplex_charge, media14=media14, file_system=file_system, control_panel_button_press=control_panel_button_press, error3=error3, error43_code=error43_code, job_info_attr_7=job_info_attr_7, job_info_attr_9=job_info_attr_9, prtinputdescription=prtinputdescription, channelstate=channelstate, prtMarkerSupplies=prtMarkerSupplies, held_job=held_job, error41=error41, postscript_total_page_count=postscript_total_page_count, prtinputnextindex=prtinputnextindex, error19_code=error19_code, job_info_stage=job_info_stage, prtoutputoffsetstacking=prtoutputoffsetstacking, mio1=mio1, error12_code=error12_code, media3_engine_media_mode=media3_engine_media_mode, media17_short_name=media17_short_name, error6=error6, prtoutputdescription=prtoutputdescription, scanned_media_duplex_charge=scanned_media_duplex_charge, channelprinteralert=channelprinteralert, hrDiskStorageEntry=hrDiskStorageEntry, scanned_media_total_charge=scanned_media_total_charge, default_copier_page_borders=default_copier_page_borders, copy_job_hold_off_print_jobs=copy_job_hold_off_print_jobs, mio1_model_name=mio1_model_name, ph3=ph3, scanner=scanner, prtoutputdimunit=prtoutputdimunit, prtAlert=prtAlert, prtalertgroup=prtalertgroup, prtInputEntry=prtInputEntry, job_info_attr_11=job_info_attr_11, prtinterpreterlangversion=prtinterpreterlangversion, error18=error18, error23_code=error23_code, rpc_bound_protocol_address=rpc_bound_protocol_address, usage_average_toner_coverage=usage_average_toner_coverage, job_info_accounting=job_info_accounting, prtmediapathdefaultindex=prtmediapathdefaultindex, tray7_media_size_loaded=tray7_media_size_loaded, mio2_manufacturing_info=mio2_manufacturing_info, duplex_page_count=duplex_page_count, default_horizontal_black_resolution=default_horizontal_black_resolution, outbin5_maximum_binding=outbin5_maximum_binding, phd3_capacity=phd3_capacity, source_subsystem=source_subsystem, fw_rom_revision=fw_rom_revision, held_job_user_name=held_job_user_name, printed_media_simplex_charge=printed_media_simplex_charge, error42_code=error42_code, phd2_model=phd2_model, prtgeneralserviceperson=prtgeneralserviceperson, prtLocalizationEntry=prtLocalizationEntry, file_systems=file_systems, job_info_accounting_job_type=job_info_accounting_job_type, channelTable=channelTable, held_job_control=held_job_control, cancel_job=cancel_job, hrfsremotemountpoint=hrfsremotemountpoint, prtinputmodel=prtinputmodel, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, hrdevicedescr=hrdevicedescr, pcl_default_font_source=pcl_default_font_source, hrdiskstorageaccess=hrdiskstorageaccess, error36_code=error36_code, settings_job=settings_job, error7_time_stamp=error7_time_stamp, tray3_phd=tray3_phd, prtoutputmodel=prtoutputmodel, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, default_copier_collate=default_copier_collate, simm=simm, outbin9=outbin9, outbin3_phd=outbin3_phd, media11_short_name=media11_short_name, simm1_bank=simm1_bank, status_mass_storage_bd=status_mass_storage_bd, prtMarker=prtMarker, outbin10_phd=outbin10_phd, prtinputmediadimxfeeddirdeclared=prtinputmediadimxfeeddirdeclared, consumables_test=consumables_test, device_name=device_name, channel_io_errors=channel_io_errors, prtmarkereastmargin=prtmarkereastmargin, override_media_name=override_media_name, simm1_bank2=simm1_bank2, prtconsolelocalization=prtconsolelocalization, error30_time_stamp=error30_time_stamp, error10=error10, scan_calibration_download=scan_calibration_download, channel=channel, rpc_bind_protocol_address=rpc_bind_protocol_address, hrDeviceEntry=hrDeviceEntry, prtinterpreterfeedaddressability=prtinterpreterfeedaddressability, prtMarkerSuppliesTable=prtMarkerSuppliesTable, hrprinterstatus=hrprinterstatus, held_job_job_name=held_job_job_name, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, media2=media2, consumable_status_cartridge_model=consumable_status_cartridge_model, resource_manager=resource_manager, error4_time_stamp=error4_time_stamp, prtinputmedialoadtimeout=prtinputmedialoadtimeout, settings_file_system=settings_file_system, error4_code=error4_code, error25_code=error25_code, error7_code=error7_code, status_prt_eng=status_prt_eng, control_panel_display_contents_crc=control_panel_display_contents_crc, outbin10_error_info=outbin10_error_info, default_page_protect=default_page_protect, error33=error33, control_panel_display_graphical_contents=control_panel_display_graphical_contents, tray5_media_size_loaded=tray5_media_size_loaded, intray2=intray2, tray1_media_size_loaded=tray1_media_size_loaded, prtcoverdescription=prtcoverdescription, prtoutputdefaultindex=prtoutputdefaultindex, phd4=phd4, error5_time_stamp=error5_time_stamp, marking_agent_density=marking_agent_density, outbin9_phd=outbin9_phd, consumable_status_manufacturing_date=consumable_status_manufacturing_date, error20=error20, prtinputdimunit=prtinputdimunit, media19_short_name=media19_short_name, background_message2=background_message2, outbin5=outbin5, error33_time_stamp=error33_time_stamp, outbin8=outbin8, default_copier_edge_to_edge=default_copier_edge_to_edge, media4_page_count=media4_page_count, error49_code=error49_code, prtmarkeraddressabilityxfeeddir=prtmarkeraddressabilityxfeeddir, error2=error2, background_message1=background_message1, outbins=outbins, prtGeneralEntry=prtGeneralEntry, hrPrinterTable=hrPrinterTable, error36_time_stamp=error36_time_stamp, ph_devices=ph_devices, error48=error48, prtinputvendorname=prtinputvendorname, current_job_parsing_id=current_job_parsing_id, localization_countries_supported=localization_countries_supported, hrdiskstorageremoveble=hrdiskstorageremoveble, media11=media11, out_marking_agent_processing=out_marking_agent_processing, prtoutputversion=prtoutputversion, consumable_reorder_url=consumable_reorder_url, media7_name=media7_name, simm2_type=simm2_type, destination_subsystem=destination_subsystem, media9=media9, scanner_accessory_digital_send_config_email_gateway=scanner_accessory_digital_send_config_email_gateway, error17_code=error17_code, error35=error35, error22=error22, hrstorageallocationunits=hrstorageallocationunits, error17=error17, scanned_media_simplex_count=scanned_media_simplex_count, hold_job_timeout=hold_job_timeout, outbin8_maximum_binding=outbin8_maximum_binding, web_server_password=web_server_password, hrPrinterEntry=hrPrinterEntry, prtConsoleLights=prtConsoleLights, phd2_device_specific_command=phd2_device_specific_command, default_media_size=default_media_size, media18_name=media18_name, media18=media18, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, mio3_model_name=mio3_model_name, media15_engine_media_mode=media15_engine_media_mode, hrFSTable=hrFSTable, consumable_status_total_capacity=consumable_status_total_capacity, default_copier_contrast=default_copier_contrast, mio2=mio2, prtmarkerpoweroncount=prtmarkerpoweroncount, hrfslastfullbackupdate=hrfslastfullbackupdate, phd1_manufacturing_info=phd1_manufacturing_info, scanner_accessory_copy_job_scan_count=scanner_accessory_copy_job_scan_count, scan_calibration_error=scan_calibration_error, prtgeneralstartuppage=prtgeneralstartuppage, prtalertdescription=prtalertdescription, host_application_available_memory=host_application_available_memory, test=test, channelnumberofchannels=channelnumberofchannels, prtoutputstackingorder=prtoutputstackingorder, prtAlertTable=prtAlertTable, prtmarkersuppliesdescription=prtmarkersuppliesdescription, error15=error15, intray=intray, outbin7_override_mode=outbin7_override_mode, outbin8_error_info=outbin8_error_info, settings_marking_agent=settings_marking_agent, background_status_msg_line3_part1=background_status_msg_line3_part1, consumable_status_info=consumable_status_info, consumable_status_page_count_legal=consumable_status_page_count_legal, settings_webserver=settings_webserver, os_execute_file=os_execute_file, device=device, postscript_print_errors=postscript_print_errors, job_info_change_id=job_info_change_id, error31_code=error31_code, prtoutputname=prtoutputname, ram_disk_size=ram_disk_size, phd2_capacity=phd2_capacity, prtoutputdecollating=prtoutputdecollating, prtmarkermarktech=prtmarkermarktech, default_authentication_timeout=default_authentication_timeout, engine_media_modes_supported1=engine_media_modes_supported1, prtoutputpagedeliveryorientation=prtoutputpagedeliveryorientation, ph6=ph6, simm4_bank1_capacity=simm4_bank1_capacity, default_copier_flip_pages_up=default_copier_flip_pages_up, prtlocalizationlanguage=prtlocalizationlanguage, job_info_attr_1=job_info_attr_1, simm2_bank=simm2_bank, self_test=self_test, job_info_pages_printed=job_info_pages_printed, media16_short_name=media16_short_name, pysmi_continue=pysmi_continue, imaging=imaging, remote_procedure_call=remote_procedure_call, error8=error8, io_timeout=io_timeout, prtmarkercolorantrole=prtmarkercolorantrole, media13_engine_media_mode=media13_engine_media_mode, autocleaning_page_enable=autocleaning_page_enable, simm3_bank2_capacity=simm3_bank2_capacity, simm4=simm4, error9_code=error9_code, hrDevice=hrDevice, mio3_manufacturing_info=mio3_manufacturing_info, job_info_attr_15=job_info_attr_15, simm4_capacity=simm4_capacity, printed_media_duplex_charge=printed_media_duplex_charge, error10_time_stamp=error10_time_stamp, job_info_accounting_black_dots=job_info_accounting_black_dots, phd6_device_specific_command=phd6_device_specific_command, prtinputname=prtinputname, prtinputversion=prtinputversion, prtmarkersuppliesmaxcapacity=prtmarkersuppliesmaxcapacity, job_info_size=job_info_size, prtcoverstatus=prtcoverstatus)
mibBuilder.exportSymbols("LJ4100mfp-MIB", file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, error44_time_stamp=error44_time_stamp, error50=error50, simm3_bank2_type=simm3_bank2_type, prtgeneralcurrentoperator=prtgeneralcurrentoperator, simm4_bank1_type=simm4_bank1_type, copy_job_scan_ahead=copy_job_scan_ahead, job_info_attr_10=job_info_attr_10, mass_storage_resource_changed=mass_storage_resource_changed, job_info_attr_14=job_info_attr_14, prtconsolecolor=prtconsolecolor, outbin9_override_mode=outbin9_override_mode, error7=error7, default_bits_per_pixel=default_bits_per_pixel, scanner_accessory_flatbed_scan_count=scanner_accessory_flatbed_scan_count, error22_time_stamp=error22_time_stamp, prtmediapathminmediafeeddir=prtmediapathminmediafeeddir, phd1=phd1, file_system3=file_system3, copy_job_hold_time=copy_job_hold_time, mopy_mode=mopy_mode, hrdevicetype=hrdevicetype, prtmarkerstatus=prtmarkerstatus, error14_time_stamp=error14_time_stamp, error6_code=error6_code, error30_code=error30_code, media15=media15, prtOutputTable=prtOutputTable, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, intray7=intray7, error20_code=error20_code, hrstorageallocationfailures=hrstorageallocationfailures, default_copy_duplex_mode=default_copy_duplex_mode, prtinterpreterlangfamily=prtinterpreterlangfamily, mio2_model_name=mio2_model_name, error27_code=error27_code, upgradable_devices=upgradable_devices, error38=error38, web_server_security=web_server_security, media7_page_count=media7_page_count, outbin7_error_info=outbin7_error_info, prtInput=prtInput, media6_engine_media_mode=media6_engine_media_mode, media_size=media_size, DisplayString=DisplayString, default_lines_per_page=default_lines_per_page, error47_code=error47_code, error46=error46, error32_code=error32_code, job_info_pages_processed=job_info_pages_processed, pjl_password=pjl_password, media17_page_count=media17_page_count, error36=error36, hrdeviceid=hrdeviceid, error19_time_stamp=error19_time_stamp, default_scan_image_quality=default_scan_image_quality, prtoutputmaxdimfeeddir=prtoutputmaxdimfeeddir, simm2_bank1_type=simm2_bank1_type, prtoutputmaxdimxfeeddir=prtoutputmaxdimxfeeddir, error47=error47, printed_media_simplex_count=printed_media_simplex_count, media9_name=media9_name, default_print_quality=default_print_quality, hrpartitionid=hrpartitionid, prtalertseveritylevel=prtalertseveritylevel, mio3=mio3, prtinterpreterdescription=prtinterpreterdescription, collated_originals_support=collated_originals_support, job_input_auto_continue_mode=job_input_auto_continue_mode, media10_name=media10_name, prtinterpreterversion=prtinterpreterversion, hrm=hrm, job_info_attr_8=job_info_attr_8, port1_parallel_bidirectionality=port1_parallel_bidirectionality, error24_code=error24_code, prtmarkercolorantvalue=prtmarkercolorantvalue, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, scanner_accessory_digital_send_module_url=scanner_accessory_digital_send_module_url, media1_short_name=media1_short_name, consumable_maintenance_interval=consumable_maintenance_interval, prtlocalizationcharacterset=prtlocalizationcharacterset, error45_code=error45_code, error15_time_stamp=error15_time_stamp, channelifindex=channelifindex, outbin8_phd=outbin8_phd, job_info=job_info, channel_table=channel_table, hrStorageTable=hrStorageTable, outbin4_override_mode=outbin4_override_mode, error26_code=error26_code, file_system_max_open_files=file_system_max_open_files, hrfsaccess=hrfsaccess, mass_storage_resource_change_counter=mass_storage_resource_change_counter, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, pdl_pcl=pdl_pcl, pcl_default_font_number=pcl_default_font_number, phd2_manufacturing_info=phd2_manufacturing_info, phd5_model=phd5_model, media_size_count=media_size_count, hrdeviceindex=hrdeviceindex, mio=mio, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, settings_outbin=settings_outbin, system=system, job_info_state=job_info_state, default_copy_input_tray=default_copy_input_tray, consumable_status_page_count_b5_executive=consumable_status_page_count_b5_executive, prtconsoleofftime=prtconsoleofftime, outbin7_phd=outbin7_phd, error22_code=error22_code, maximum_ram_disk_memory=maximum_ram_disk_memory, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, perm_store_init_occurred=perm_store_init_occurred, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, prtoutputcapacityunit=prtoutputcapacityunit, outbin11_error_info=outbin11_error_info, error45_time_stamp=error45_time_stamp, prtMediaPathTable=prtMediaPathTable, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, file_system2=file_system2, media10_engine_media_mode=media10_engine_media_mode, phd1_type=phd1_type, printed_media_total_charge=printed_media_total_charge, job_info_outcome=job_info_outcome, hrfstype=hrfstype, hrfsbootable=hrfsbootable, active_print_jobs=active_print_jobs, phd5_type=phd5_type, outbin10=outbin10, simm2_capacity=simm2_capacity, channel_bytes_sent=channel_bytes_sent, error19=error19, prtmediapathminmediaxfeeddir=prtmediapathminmediaxfeeddir, overflow_bin=overflow_bin, prtStorageRefEntry=prtStorageRefEntry, error11_time_stamp=error11_time_stamp, phd4_model=phd4_model, ph2=ph2, upgradable_devices_write_time=upgradable_devices_write_time, media17_name=media17_name, tables=tables, error34=error34, phd5=phd5, phd3=phd3, mio2_type=mio2_type, tray4_media_size_loaded=tray4_media_size_loaded, prtinputdefaultindex=prtinputdefaultindex, phd4_device_specific_command=phd4_device_specific_command, error3_time_stamp=error3_time_stamp, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, tray7_phd=tray7_phd, error17_time_stamp=error17_time_stamp, simm4_bank2_capacity=simm4_bank2_capacity, not_ready_source_scanner=not_ready_source_scanner, simm4_type=simm4_type, consumable_status_capacity_units=consumable_status_capacity_units, prtgeneralreset=prtgeneralreset, prtOutputEntry=prtOutputEntry, control_panel_key_press=control_panel_key_press, media11_page_count=media11_page_count, job_input_auto_continue_timeout=job_input_auto_continue_timeout, consumable_status_job_count=consumable_status_job_count, outbin3_error_info=outbin3_error_info, intray3=intray3, prtinterpretertwoway=prtinterpretertwoway, outbin7_maximum_binding=outbin7_maximum_binding, prtconsolenumberofdisplaychars=prtconsolenumberofdisplaychars, hrPartitionTable=hrPartitionTable, outbin=outbin, error28_code=error28_code, error14_code=error14_code, fw_rom_datecode=fw_rom_datecode, prtConsoleLightEntry=prtConsoleLightEntry, error16_time_stamp=error16_time_stamp, settings_prt_eng=settings_prt_eng, settings_rpc=settings_rpc, channelEntry=channelEntry, media13=media13, media11_engine_media_mode=media11_engine_media_mode, consumable_status_reseller_id=consumable_status_reseller_id, prtmarkeraddressabilityfeeddir=prtmarkeraddressabilityfeeddir, upgradable_devices_max_write_count=upgradable_devices_max_write_count, serial_number=serial_number, media9_short_name=media9_short_name, error1_time_stamp=error1_time_stamp, scanner_accessory_dimm2_type=scanner_accessory_dimm2_type, outbin5_phd=outbin5_phd, error27_time_stamp=error27_time_stamp, media16=media16, job_info_name2=job_info_name2, error29=error29, error4=error4, simm1=simm1, media2_name=media2_name, phd6_manufacturing_info=phd6_manufacturing_info, media4_short_name=media4_short_name, file_system2_initialize_volume=file_system2_initialize_volume, prtalertgroupindex=prtalertgroupindex, prtConsoleLightTable=prtConsoleLightTable, settings_copier=settings_copier, error21_code=error21_code, consumable_test_password=consumable_test_password, prtoutputremainingcapacity=prtoutputremainingcapacity, on_off_line=on_off_line, error25_time_stamp=error25_time_stamp, outbin8_override_mode=outbin8_override_mode, default_copies=default_copies, media8_name=media8_name, firmware_download_current_state=firmware_download_current_state, settings_intray=settings_intray, prtoutputmindimxfeeddir=prtoutputmindimxfeeddir, io=io, hrstorageindex=hrstorageindex, media3_name=media3_name, error44_code=error44_code, simm1_type=simm1_type, simm3_bank=simm3_bank, prtconsoledisable=prtconsoledisable, scanner_accessory_digital_send_config_fax_embedded=scanner_accessory_digital_send_config_fax_embedded, simm3_bank1=simm3_bank1, mio1_type=mio1_type, simm4_bank2_type=simm4_bank2_type, consumable_status_last_use_date=consumable_status_last_use_date, prtmediapathmaxmediaxfeeddir=prtmediapathmaxmediaxfeeddir, outbin3=outbin3, simm2_bank2_capacity=simm2_bank2_capacity, error50_code=error50_code, prtchanneltype=prtchanneltype, error18_time_stamp=error18_time_stamp, tray6_media_size_loaded=tray6_media_size_loaded, default_copier_pages_per_sheet=default_copier_pages_per_sheet, outbin3_maximum_binding=outbin3_maximum_binding, status_rpc=status_rpc, default_copy_reset_timeout=default_copy_reset_timeout, error41_code=error41_code, hrpartitionsize=hrpartitionsize, hrpartitionindex=hrpartitionindex, outbin9_error_info=outbin9_error_info, consumables_status=consumables_status, media8_engine_media_mode=media8_engine_media_mode, error12_time_stamp=error12_time_stamp, media3_page_count=media3_page_count, media16_engine_media_mode=media16_engine_media_mode, prtinterpreterxfeedaddressability=prtinterpreterxfeedaddressability, prtCoverTable=prtCoverTable, media1_name=media1_name, prtalertcriticalevents=prtalertcriticalevents, io_switch=io_switch, id=id, prtoutputpagecollated=prtoutputpagecollated, usage_printer_total_charge=usage_printer_total_charge, background_status_msg_line1_part1=background_status_msg_line1_part1, copier=copier, phd2=phd2)
mibBuilder.exportSymbols("LJ4100mfp-MIB", hrdeviceerrors=hrdeviceerrors, phd5_device_specific_command=phd5_device_specific_command, error42=error42, job_info_accounting_media_size=job_info_accounting_media_size, prtchanneldefaultpagedesclangindex=prtchanneldefaultpagedesclangindex, default_scan_heavy_media_mode=default_scan_heavy_media_mode, prtChannel=prtChannel, hrfsmountpoint=hrfsmountpoint, autocleaning_page_frequency=autocleaning_page_frequency, media6_page_count=media6_page_count, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, channel_jobs_received=channel_jobs_received, settings_spooler=settings_spooler, simm1_bank1_type=simm1_bank1_type, firmware_download_version=firmware_download_version, outbin11_override_mode=outbin11_override_mode, error39_code=error39_code, channelinformation=channelinformation, error40_time_stamp=error40_time_stamp, outbin5_error_info=outbin5_error_info, error24=error24, prtgeneralconfigchanges=prtgeneralconfigchanges, prtlocalizationcountry=prtlocalizationcountry, mass_storage_resources=mass_storage_resources, media5=media5, autocleaning_page_size=autocleaning_page_size, scanner_accessory_send_job_scan_count=scanner_accessory_send_job_scan_count, background_status_msg_line2_part1=background_status_msg_line2_part1, media9_engine_media_mode=media9_engine_media_mode, prtinputstatus=prtinputstatus, prtmarkerlifecount=prtmarkerlifecount, job_info_attr_5=job_info_attr_5, media4_name=media4_name, prtmarkersuppliescolorantindex=prtmarkersuppliescolorantindex, error5=error5, default_audible_feedback=default_audible_feedback, status_pdl=status_pdl, pdl=pdl, phd3_model=phd3_model, prtOutput=prtOutput, settings_pdl=settings_pdl, job_info_accounting_finishing_options=job_info_accounting_finishing_options, prtoutputbursting=prtoutputbursting, hrPartitionEntry=hrPartitionEntry, media5_short_name=media5_short_name, tray2_phd=tray2_phd, prtgeneralserialnumber=prtgeneralserialnumber, settings_system=settings_system, printer_average=printer_average, scanner_accessory_dimm2_capacity=scanner_accessory_dimm2_capacity, prtmarkersuppliestype=prtmarkersuppliestype, prtInterpreterEntry=prtInterpreterEntry, pcl_total_page_count=pcl_total_page_count, error13_code=error13_code, media15_short_name=media15_short_name, prtinputtype=prtinputtype, background_status_msg_line4_part1=background_status_msg_line4_part1, scan_sharpening_coefficient=scan_sharpening_coefficient, error43_time_stamp=error43_time_stamp, media_names_available=media_names_available, media18_page_count=media18_page_count, held_job_set_queue_size=held_job_set_queue_size, form_feed_needed=form_feed_needed, settings_io=settings_io, prtconsoleontime=prtconsoleontime, error48_code=error48_code, default_scan_text_graphics_mix=default_scan_text_graphics_mix, socket_ping=socket_ping, media_modes=media_modes, error35_time_stamp=error35_time_stamp, port1_parallel_speed=port1_parallel_speed, error13_time_stamp=error13_time_stamp, prtmediapathmaxspeedprintunit=prtmediapathmaxspeedprintunit, prtmarkernorthmargin=prtmarkernorthmargin, upgradable_devices_version=upgradable_devices_version, ph4=ph4, prtchannelprotocolversion=prtchannelprotocolversion, channeltype=channeltype, prtDeviceRefEntry=prtDeviceRefEntry, hrfsindex=hrfsindex, error16=error16, prtgeneralprintername=prtgeneralprintername, prtLocalization=prtLocalization, media18_short_name=media18_short_name, outbin11_maximum_binding=outbin11_maximum_binding, job_output_auto_continue_timeout=job_output_auto_continue_timeout, error_log_clear=error_log_clear, prtchannelifindex=prtchannelifindex, outbin11=outbin11, prtmediapathstatus=prtmediapathstatus, error49=error49, media5_name=media5_name, usage_instructions_line2=usage_instructions_line2, prtmarkercoloranttonality=prtmarkercoloranttonality, consumable_status_manufacturer_name=consumable_status_manufacturer_name, prtChannelEntry=prtChannelEntry, error2_code=error2_code, held_job_info=held_job_info, error34_time_stamp=error34_time_stamp, media18_engine_media_mode=media18_engine_media_mode, media15_name=media15_name, print_density=print_density, auto_continue=auto_continue, error9=error9, held_job_pin=held_job_pin, file_system_delete_files=file_system_delete_files, error31_time_stamp=error31_time_stamp, media17=media17, prtmarkersuppliesmarkerindex=prtmarkersuppliesmarkerindex, prtGeneral=prtGeneral, prtinputmedianame=prtinputmedianame, error29_time_stamp=error29_time_stamp, default_scan_job_mode=default_scan_job_mode, hrDeviceTable=hrDeviceTable, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, outbin1=outbin1, consumable_status_page_count_a4_letter=consumable_status_page_count_a4_letter, hrStorage=hrStorage, scanner_accessory_digital_send_config_dsm_enabled_fax=scanner_accessory_digital_send_config_dsm_enabled_fax, consumable_status_page_count_envelope=consumable_status_page_count_envelope, consumable_status=consumable_status, hrdiskstoragecapacity=hrdiskstoragecapacity, web_server_url=web_server_url, tray6_phd=tray6_phd, job_info_requested_originals=job_info_requested_originals, media9_page_count=media9_page_count, hrfsstorageindex=hrfsstorageindex, mio3_type=mio3_type, north_edge_offset=north_edge_offset, prtmediapathdescription=prtmediapathdescription, prtchannelcurrentjobcntllangindex=prtchannelcurrentjobcntllangindex, prtmarkercolorantmarkerindex=prtmarkercolorantmarkerindex, reprint=reprint, prtinterpreterdefaultcharsetin=prtinterpreterdefaultcharsetin, job_info_attr_16=job_info_attr_16, error27=error27, prtalertcode=prtalertcode, prtoutputmaxcapacity=prtoutputmaxcapacity, held_job_security=held_job_security, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, consumable_maintenance_pages_remaining=consumable_maintenance_pages_remaining, hrfslastpartialbackupdate=hrfslastpartialbackupdate, error28=error28, printed_media_duplex_count=printed_media_duplex_count, prtalerttime=prtalerttime, upgradable_devices_current_state=upgradable_devices_current_state, simm2_bank1=simm2_bank1, outbin4_phd=outbin4_phd, prtMarkerColorantTable=prtMarkerColorantTable, prtinputmediadimfeeddirchosen=prtinputmediadimfeeddirchosen, hrDiskStorageTable=hrDiskStorageTable, error2_time_stamp=error2_time_stamp, prtdevicerefindex=prtdevicerefindex, ph5=ph5, prtmediapathmaxspeed=prtmediapathmaxspeed, error34_code=error34_code, hrdevicestatus=hrdevicestatus, held_job_enable=held_job_enable, error42_time_stamp=error42_time_stamp, phd6_capacity=phd6_capacity, error16_code=error16_code, copy_job_interrupt_copy_jobs=copy_job_interrupt_copy_jobs, media4_engine_media_mode=media4_engine_media_mode, media16_name=media16_name, cold_reset_media_size=cold_reset_media_size, simm1_bank2_type=simm1_bank2_type, job_info_attr_4=job_info_attr_4, error29_code=error29_code, phd6_type=phd6_type, media17_engine_media_mode=media17_engine_media_mode, usage_instructions_line4=usage_instructions_line4, prtinputcurrentlevel=prtinputcurrentlevel, prtinterpreterdefaultcharsetout=prtinterpreterdefaultcharsetout, default_scan_content_orientation=default_scan_content_orientation, job_info_attr_12=job_info_attr_12, hrpartitionlabel=hrpartitionlabel, media8=media8, copy_job_auto_interrupt=copy_job_auto_interrupt, firmware_download_write_status_supported=firmware_download_write_status_supported, simm4_bank2=simm4_bank2, simm2_bank1_capacity=simm2_bank1_capacity, outbin10_maximum_binding=outbin10_maximum_binding, prtmarkerdefaultindex=prtmarkerdefaultindex, simm3_capacity=simm3_capacity, error1_code=error1_code, processing_subsystem=processing_subsystem, override_media_size=override_media_size, media5_page_count=media5_page_count, simm4_bank=simm4_bank, simm2=simm2, intray5=intray5, prtgeneralbannerpage=prtgeneralbannerpage, error46_code=error46_code, device_location=device_location, prtinterpreterlanglevel=prtinterpreterlanglevel, job_info_attr_2=job_info_attr_2, prtchannelstate=prtchannelstate, prtmarkerspotcolorants=prtmarkerspotcolorants, channel_entry=channel_entry, energy_star=energy_star, error9_time_stamp=error9_time_stamp, job_info_name1=job_info_name1, media1_page_count=media1_page_count, error10_code=error10_code, prtmarkersuppliessupplyunit=prtmarkersuppliessupplyunit, job_being_parsed=job_being_parsed, phd3_manufacturing_info=phd3_manufacturing_info, error39=error39, default_custom_paper_feed_dim=default_custom_paper_feed_dim, default_copier_media_size=default_copier_media_size, pdl_postscript=pdl_postscript, prtoutputserialnumber=prtoutputserialnumber, media7=media7, usage_instructions_line1=usage_instructions_line1, fax_print_page_count=fax_print_page_count, media19_page_count=media19_page_count, consumable_status_first_install_date=consumable_status_first_install_date, consumable_status_oem_name=consumable_status_oem_name, errorlog=errorlog, error20_time_stamp=error20_time_stamp, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, error13=error13, status_scanner=status_scanner, channelstatus=channelstatus, usage_instructions_line3=usage_instructions_line3, prtInputTable=prtInputTable, prtmediapathtype=prtmediapathtype, error26_time_stamp=error26_time_stamp, remote_upgrade_enable=remote_upgrade_enable, default_reset_send_timeout=default_reset_send_timeout, ram_disk_mode=ram_disk_mode, outbin3_override_mode=outbin3_override_mode, error44=error44, outbin6_override_mode=outbin6_override_mode, default_custom_paper_dim_unit=default_custom_paper_dim_unit, operating_system=operating_system, media2_short_name=media2_short_name, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, consumable_status_usage_count=consumable_status_usage_count, held_job_print=held_job_print, localization_languages_supported=localization_languages_supported, error40=error40, simm2_bank2_type=simm2_bank2_type, ph=ph, default_vmi=default_vmi, settings_fax_proc_sub=settings_fax_proc_sub, upgradable_devices_write_count=upgradable_devices_write_count, intray1=intray1, consumables=consumables, hrprinterdetectederrorstate=hrprinterdetectederrorstate, job_info_attr_6=job_info_attr_6, prtinputmaxcapacity=prtinputmaxcapacity, phd4_manufacturing_info=phd4_manufacturing_info, socket_ping_job_events_version=socket_ping_job_events_version)
mibBuilder.exportSymbols("LJ4100mfp-MIB", error38_code=error38_code, tray1_phd=tray1_phd, outbin6=outbin6, prtmarkerwestmargin=prtmarkerwestmargin, error24_time_stamp=error24_time_stamp, error5_code=error5_code, simm2_bank2=simm2_bank2, port1=port1, media6=media6, job_info_accounting_scanned_media_duplex_count=job_info_accounting_scanned_media_duplex_count, default_media_name=default_media_name, consumables_1=consumables_1, prtoutputtype=prtoutputtype, channelprotocolversion=channelprotocolversion, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, media5_engine_media_mode=media5_engine_media_mode, media_info=media_info, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, outbin6_maximum_binding=outbin6_maximum_binding, control_panel_display=control_panel_display, intrays=intrays, error41_time_stamp=error41_time_stamp, job_info_attribute=job_info_attribute, marking_agent=marking_agent, error50_time_stamp=error50_time_stamp, firmware_download_write_time=firmware_download_write_time, firmware_download_write_count=firmware_download_write_count, prtmarkercounterunit=prtmarkercounterunit, error21_time_stamp=error21_time_stamp, outbin4_error_info=outbin4_error_info, error30=error30, printer_accounting=printer_accounting, error1=error1, clearable_warning=clearable_warning, low_marking_agent_processing=low_marking_agent_processing, media3_short_name=media3_short_name, usage_scanner_total_charge=usage_scanner_total_charge, default_copy_output_bin=default_copy_output_bin, tray4_phd=tray4_phd, media14_engine_media_mode=media14_engine_media_mode, error35_code=error35_code, error38_time_stamp=error38_time_stamp, media15_page_count=media15_page_count, hrFSEntry=hrFSEntry, prtoutputvendorname=prtoutputvendorname, scanner_accounting=scanner_accounting, firmware_download_maximum_write_count=firmware_download_maximum_write_count, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, prtmarkersupplieslevel=prtmarkersupplieslevel, file_system3_initialize_volume=file_system3_initialize_volume, firmware_download=firmware_download, error49_time_stamp=error49_time_stamp, media19_engine_media_mode=media19_engine_media_mode, engine_self_diagnostic=engine_self_diagnostic, error31=error31, prtMediaPathEntry=prtMediaPathEntry, error8_code=error8_code, prtChannelTable=prtChannelTable, asset_number=asset_number, media8_page_count=media8_page_count, media19=media19, job_info_accounting_media_type=job_info_accounting_media_type, print_internal_page=print_internal_page, phd=phd, status_system=status_system, simm3_bank2=simm3_bank2, media10_short_name=media10_short_name, error47_time_stamp=error47_time_stamp, held_job_retention=held_job_retention, intray4=intray4, media10=media10, scanner_accessory_adf_two_sided_sheet_count=scanner_accessory_adf_two_sided_sheet_count, consumable_life_usage_units=consumable_life_usage_units, mp_tray=mp_tray, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, scanner_accessory_dimm1_type=scanner_accessory_dimm1_type, phd6_model=phd6_model, media6_short_name=media6_short_name, media2_engine_media_mode=media2_engine_media_mode, error23=error23, job_info_io_source=job_info_io_source, job_info_pages_in_original=job_info_pages_in_original, hrstoragedescr=hrstoragedescr, media1_engine_media_mode=media1_engine_media_mode, error11=error11, prtconsoledisplaybuffertext=prtconsoledisplaybuffertext, settings_mass_storage_bd=settings_mass_storage_bd, prtalertallevents=prtalertallevents, default_scan_background_removal=default_scan_background_removal, job_info_printed_originals=job_info_printed_originals, prtmarkersouthmargin=prtmarkersouthmargin, fax_proc_sub=fax_proc_sub, prtalertlocation=prtalertlocation, mass_storage_block_driver=mass_storage_block_driver, error45=error45, prtinputmediadimxfeeddirchosen=prtinputmediadimxfeeddirchosen, media16_page_count=media16_page_count, simm1_bank1_capacity=simm1_bank1_capacity, settings_scanner=settings_scanner, prtCover=prtCover, prtMediaPath=prtMediaPath, print_meter=print_meter, error39_time_stamp=error39_time_stamp, prtMarkerColorant=prtMarkerColorant, scanner_accessory_digital_send_config_ldap_gateway=scanner_accessory_digital_send_config_ldap_gateway, job_info_page_count_current_original=job_info_page_count_current_original, simm3=simm3, prtInterpreterTable=prtInterpreterTable, simm1_bank2_capacity=simm1_bank2_capacity, intray6=intray6, error8_time_stamp=error8_time_stamp, prtmarkerprocesscolorants=prtmarkerprocesscolorants, phd2_type=phd2_type, phd5_capacity=phd5_capacity, prtmediapathmediasizeunit=prtmediapathmediasizeunit, channel_bytes_received=channel_bytes_received, scanner_accessory_total_copy_pages_printed=scanner_accessory_total_copy_pages_printed, error40_code=error40_code, media4=media4, prtoutputmindimfeeddir=prtoutputmindimfeeddir, prtGeneralTable=prtGeneralTable, pcl_default_font_height=pcl_default_font_height, error18_code=error18_code, job_info_outbins_used=job_info_outbins_used, error25=error25, hrstoragesize=hrstoragesize, error46_time_stamp=error46_time_stamp, default_copier_quantity=default_copier_quantity, simm1_capacity=simm1_capacity, consumables_life=consumables_life, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, prtmediapathmaxmediafeeddir=prtmediapathmaxmediafeeddir, default_ret=default_ret, print_media=print_media, model_name=model_name, phd3_type=phd3_type, outbin7=outbin7, outbin6_phd=outbin6_phd, error32_time_stamp=error32_time_stamp, outbin4_maximum_binding=outbin4_maximum_binding, outbin1_override_mode=outbin1_override_mode, scanner_accessory_adf_sheet_count=scanner_accessory_adf_sheet_count, held_job_delete=held_job_delete, printer_average_marking_agent_coverage_sum=printer_average_marking_agent_coverage_sum, prtMarkerEntry=prtMarkerEntry, simm3_bank1_type=simm3_bank1_type, media3=media3, model_number=model_number, prtalerttraininglevel=prtalerttraininglevel, prtAlertEntry=prtAlertEntry, error37_time_stamp=error37_time_stamp, outbin9_maximum_binding=outbin9_maximum_binding, job_info_attr_13=job_info_attr_13, media19_name=media19_name, dm=dm, background_message3=background_message3, interface=interface, prtconsolenumberofdisplaylines=prtconsolenumberofdisplaylines, marking_agent_density_setting=marking_agent_density_setting, outbin10_override_mode=outbin10_override_mode, prtinputcapacityunit=prtinputcapacityunit, prtoutputstatus=prtoutputstatus, default_copier_image_type=default_copier_image_type, prtInterpreter=prtInterpreter, file_system4=file_system4, consumable_status_page_count_a3_ledger=consumable_status_page_count_a3_ledger, hrStorageEntry=hrStorageEntry, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, outbin5_override_mode=outbin5_override_mode, sleep_mode=sleep_mode, error33_code=error33_code, error21=error21, auto_send_reset=auto_send_reset, hrdiskstoragemedia=hrdiskstoragemedia, prtCoverEntry=prtCoverEntry, media6_name=media6_name, hp=hp, media8_short_name=media8_short_name, error23_time_stamp=error23_time_stamp, error14=error14, error26=error26, simm4_bank1=simm4_bank1, phd3_device_specific_command=phd3_device_specific_command, job_info_physical_outbins_used=job_info_physical_outbins_used, job_info_accounting_scanned_media_simplex_count=job_info_accounting_scanned_media_simplex_count, simm3_type=simm3_type, prtinputmediadimfeeddirdeclared=prtinputmediadimfeeddirdeclared, outbin4=outbin4, simm1_bank1=simm1_bank1, prtinputserialnumber=prtinputserialnumber, consumable_status_serial_number=consumable_status_serial_number, print_engine=print_engine, prtLocalizationTable=prtLocalizationTable, upgradable_devices_name=upgradable_devices_name, form_feed=form_feed, error12=error12, background_message=background_message, error11_code=error11_code, phd1_model=phd1_model, hrstorageused=hrstorageused, prtchannelstatus=prtchannelstatus, prtMarkerTable=prtMarkerTable, settings_print_media=settings_print_media, prtchannelinformation=prtchannelinformation, prtDeviceRefTable=prtDeviceRefTable, tray3_media_size_loaded=tray3_media_size_loaded, prtmarkersuppliesclass=prtmarkersuppliesclass, error28_time_stamp=error28_time_stamp, job_info_attr_3=job_info_attr_3, default_scan_original_size=default_scan_original_size, media10_page_count=media10_page_count, prtmarkeraddressabilityunit=prtmarkeraddressabilityunit, firmware_download_name=firmware_download_name, error37=error37, error43=error43, scanner_accessory_dimm1_capacity=scanner_accessory_dimm1_capacity, scanned_media_duplex_count=scanned_media_duplex_count, scanned_media_usage=scanned_media_usage, phd4_type=phd4_type, phd4_capacity=phd4_capacity, prtStorageRefTable=prtStorageRefTable, prtconsoledescription=prtconsoledescription, hrmemorysize=hrmemorysize, prtoutputsecurity=prtoutputsecurity, pjl=pjl, channel_mio=channel_mio, outbin11_phd=outbin11_phd, printer_average_marking_agent_coverage_sum_squared=printer_average_marking_agent_coverage_sum_squared, printmib=printmib, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, job=job, media7_engine_media_mode=media7_engine_media_mode, scanner_accessory_digital_send_log_event_counter=scanner_accessory_digital_send_log_event_counter, media11_name=media11_name, error32=error32, default_vertical_black_resolution=default_vertical_black_resolution, spooler=spooler, error3_code=error3_code, ports=ports, mio1_manufacturing_info=mio1_manufacturing_info, prtstoragerefindex=prtstoragerefindex, simm3_bank1_capacity=simm3_bank1_capacity, phd1_capacity=phd1_capacity, media1=media1, error15_code=error15_code, held_job_quantity=held_job_quantity, phd5_manufacturing_info=phd5_manufacturing_info, media7_short_name=media7_short_name, prtgeneralcurrentlocalization=prtgeneralcurrentlocalization, prtMarkerColorantEntry=prtMarkerColorantEntry, error48_time_stamp=error48_time_stamp, prtinterpreterdefaultorientation=prtinterpreterdefaultorientation, consumable_status_page_count_xy_other=consumable_status_page_count_xy_other, tray2_media_size_loaded=tray2_media_size_loaded)
mibBuilder.exportSymbols("LJ4100mfp-MIB", pcl_default_font_width=pcl_default_font_width, hrstoragetype=hrstoragetype, tray5_phd=tray5_phd, scanner_accessory_adf_one_sided_sheet_count=scanner_accessory_adf_one_sided_sheet_count, webserver_proc_sub=webserver_proc_sub, outbin6_error_info=outbin6_error_info, error37_code=error37_code, accounting=accounting, printed_media_usage=printed_media_usage, media2_page_count=media2_page_count, print_engine_revision=print_engine_revision, file_system4_initialize_volume=file_system4_initialize_volume, hrpartitionfsindex=hrpartitionfsindex, background_message4=background_message4, consumable_status_usage_units=consumable_status_usage_units, error6_time_stamp=error6_time_stamp, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, scanner_accessory_digital_send_status=scanner_accessory_digital_send_status)
