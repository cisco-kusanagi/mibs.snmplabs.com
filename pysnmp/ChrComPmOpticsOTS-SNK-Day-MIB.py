...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:20:19 2019
...
Counter32, ModuleIdentity, TimeTicks, Gauge32, ObjectIdentity, Counter64, Integer32, Bits, NotificationType, MibIdentifier, Unsigned32, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ModuleIdentity", "TimeTicks", "Gauge32", "ObjectIdentity", "Counter64", "Integer32", "Bits", "NotificationType", "MibIdentifier", "Unsigned32", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("ChrComPmOpticsOTS-SNK-Day-MIB", chrComPmOpticsSuppressedIntrvls=chrComPmOpticsSuppressedIntrvls, chrComPmOpticsElapsedTime=chrComPmOpticsElapsedTime, chrComPmOpticsThresholdProfIndex=chrComPmOpticsThresholdProfIndex, chrComPmOpticsOTS_SNK_DayEntry=chrComPmOpticsOTS_SNK_DayEntry, chrComPmOpticsMean=chrComPmOpticsMean, chrComPmOpticsResetCountersAction=chrComPmOpticsResetCountersAction, chrComPmOpticsSES=chrComPmOpticsSES, chrComPmOpticsORS=chrComPmOpticsORS, chrComPmOpticsSuspectedIntrvl=chrComPmOpticsSuspectedIntrvl, chrComPmOpticsDayNumber=chrComPmOpticsDayNumber, chrComPmOpticsUAS=chrComPmOpticsUAS, chrComPmOpticsOTS_SNK_DayTable=chrComPmOpticsOTS_SNK_DayTable, chrComPmOpticsSD=chrComPmOpticsSD, chrComPmOpticsMin=chrComPmOpticsMin, chrComPmOpticsMax=chrComPmOpticsMax)
