...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:26:03 2019
...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, Integer32, Unsigned32, Counter64, ObjectIdentity, MibIdentifier, TimeTicks, iso, Bits, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "Integer32", "Unsigned32", "Counter64", "ObjectIdentity", "MibIdentifier", "TimeTicks", "iso", "Bits", "ModuleIdentity", "NotificationType")
...
mibBuilder.exportSymbols("DES3810-52-L2MGMT-MIB", swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2DhcpLocalRelayVLANState=swL2DhcpLocalRelayVLANState, swL2PortCtrlMDIXState=swL2PortCtrlMDIXState, MacAddress=MacAddress, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, Ipv6Address=Ipv6Address, swL2Notify=swL2Notify, swL2DevCtrlCFMPortState=swL2DevCtrlCFMPortState, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2PortErrPortState=swL2PortErrPortState, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2PortCtrlTable=swL2PortCtrlTable, swL2DevCtrlCFMPortEntry=swL2DevCtrlCFMPortEntry, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2PortErrEntry=swL2PortErrEntry, swL2TrunkVLANEntry=swL2TrunkVLANEntry, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swDevInfoFrontPanelLedStatus=swDevInfoFrontPanelLedStatus, swL2DevCtrlSnmpTrapState=swL2DevCtrlSnmpTrapState, swL2MulticastFilterModeVlanEntry=swL2MulticastFilterModeVlanEntry, swL2DevCtrlCFM=swL2DevCtrlCFM, swL2PortInfoEntry=swL2PortInfoEntry, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2PortCounterCtrlTable=swL2PortCounterCtrlTable, swL2PortCounterCtrlPortIndex=swL2PortCounterCtrlPortIndex, swL2MulticastFilterMode=swL2MulticastFilterMode, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2TrunkVLANTable=swL2TrunkVLANTable, swL2PVIDAutoAssignmentState=swL2PVIDAutoAssignmentState, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2TrunkVLANState=swL2TrunkVLANState, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swL2DevInfo=swL2DevInfo, swL2VlanPortInfoPortRole=swL2VlanPortInfoPortRole, swL2MirrorMgmt=swL2MirrorMgmt, swL2TrafficSegTable=swL2TrafficSegTable, swL2VLANMgmt=swL2VLANMgmt, PortList=PortList, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2TrunkIndex=swL2TrunkIndex, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2DevCtrlCFMPortIndex=swL2DevCtrlCFMPortIndex, swL2DevCtrlCFMPortTable=swL2DevCtrlCFMPortTable, swL2TrafficSegPort=swL2TrafficSegPort, swL2PortErrPortReason=swL2PortErrPortReason, swL2PortErrTable=swL2PortErrTable, swL2MulticastFilterModeVlanTable=swL2MulticastFilterModeVlanTable, swL2TrunkState=swL2TrunkState, swL2VlanPortInfoVid=swL2VlanPortInfoVid, swL2PortInfoMediumType=swL2PortInfoMediumType, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2DhcpLocalRelayMgmt=swL2DhcpLocalRelayMgmt, swL2PortCtrlMediumType=swL2PortCtrlMediumType, swL2DevCtrl=swL2DevCtrl, swL2MirrorPortState=swL2MirrorPortState, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2MulticastFilterVlanMode=swL2MulticastFilterVlanMode, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2PortInfoErrorDisabled=swL2PortInfoErrorDisabled, swL2macNotification=swL2macNotification, swL2PortInfoTable=swL2PortInfoTable, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2NniGvrpBpduAddress=swL2NniGvrpBpduAddress, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2DevCtrlVLANTrunkState=swL2DevCtrlVLANTrunkState, swL2TrafficSegEntry=swL2TrafficSegEntry, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2DhcpLocalRelayVLANTable=swL2DhcpLocalRelayVLANTable, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2PortErrPortConnStatus=swL2PortErrPortConnStatus, swL2DevMgmt=swL2DevMgmt, swL2DhcpLocalRelayVLANEntry=swL2DhcpLocalRelayVLANEntry, swL2PortInfoType=swL2PortInfoType, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2VlanIndex=swL2VlanIndex, swL2NotifFirmware=swL2NotifFirmware, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2DevAlarm=swL2DevAlarm, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2TrunkMgmt=swL2TrunkMgmt, swL2PortErrPortIndex=swL2PortErrPortIndex, swL2VLANAdvertisement=swL2VLANAdvertisement, swL2macNotifyInfo=swL2macNotifyInfo, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2PortCtrlJumboFrameMaxSize=swL2PortCtrlJumboFrameMaxSize, swL2DhcpRelayMgmt=swL2DhcpRelayMgmt, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2VlanStaticEntry=swL2VlanStaticEntry, swL2NotifyPrefix=swL2NotifyPrefix, swL2MACNotifyState=swL2MACNotifyState, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2DhcpLocalRelayVLANID=swL2DhcpLocalRelayVLANID, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swL2DhcpLocalRelayState=swL2DhcpLocalRelayState, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2MulticastFilterVid=swL2MulticastFilterVid, swL2VlanPortInfoEntry=swL2VlanPortInfoEntry, swL2VlanPortInfoPortIndex=swL2VlanPortInfoPortIndex, swL2PortCtrlLearningState=swL2PortCtrlLearningState, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2VlanPortInfoTable=swL2VlanPortInfoTable, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2DevCtrlCFMState=swL2DevCtrlCFMState, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2MgmtMIB=swL2MgmtMIB, swL2PortInfoUnitID=swL2PortInfoUnitID, VlanId=VlanId, swL2TrunkMember=swL2TrunkMember, swl2NotificationBidings=swl2NotificationBidings, swL2NotifyMgmt=swL2NotifyMgmt, swL2VlanStaticTable=swL2VlanStaticTable, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2TrunkType=swL2TrunkType, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2PortCounterCtrlEntry=swL2PortCounterCtrlEntry, swL2DevCtrlIpAutoconfig=swL2DevCtrlIpAutoconfig, swL2TrunkVLANPort=swL2TrunkVLANPort, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2PortMgmt=swL2PortMgmt, swL2PortCounterClearCtrl=swL2PortCounterClearCtrl, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex)
