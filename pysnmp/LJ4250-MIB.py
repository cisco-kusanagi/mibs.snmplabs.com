...
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:17 2019
...
NotificationType, Bits, Counter32, Counter64, ModuleIdentity, Gauge32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, IpAddress, iso, Integer32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Bits", "Counter32", "Counter64", "ModuleIdentity", "Gauge32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "IpAddress", "iso", "Integer32", "Unsigned32")
...
mibBuilder.exportSymbols("LJ4250-MIB", error25_time_stamp=error25_time_stamp, media9=media9, simm5_bank1=simm5_bank1, error42=error42, error28_time_stamp=error28_time_stamp, tray6_phd=tray6_phd, error36_code=error36_code, error50_code=error50_code, media14_page_count=media14_page_count, cancel_job=cancel_job, error20_code=error20_code, error44_code=error44_code, media2_page_count=media2_page_count, mass_storage_resource_change_counter=mass_storage_resource_change_counter, mio3_model_name=mio3_model_name, consumable_status_page_count_envelope=consumable_status_page_count_envelope, consumable_status_page_count_a4_letter=consumable_status_page_count_a4_letter, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, mass_storage_block_driver=mass_storage_block_driver, simm2_bank1_type=simm2_bank1_type, error27=error27, error14=error14, usage_average_toner_coverage=usage_average_toner_coverage, job_info_attr_7=job_info_attr_7, pdl_postscript=pdl_postscript, media4_name=media4_name, error36=error36, localization_languages_supported=localization_languages_supported, job_info_accounting_media_size=job_info_accounting_media_size, phd=phd, print_meter=print_meter, consumable_status=consumable_status, consumables_status=consumables_status, intray5=intray5, webserver_proc_sub=webserver_proc_sub, held_job_control=held_job_control, form_feed=form_feed, simm1_type=simm1_type, job_info_accounting_black_dots=job_info_accounting_black_dots, source_tray_usage_total=source_tray_usage_total, north_edge_offset=north_edge_offset, error1_code=error1_code, error16_time_stamp=error16_time_stamp, simm2_bank1=simm2_bank1, media9_page_count=media9_page_count, service_channel=service_channel, id=id, marking_agent_density=marking_agent_density, error28=error28, file_system3_initialize_volume=file_system3_initialize_volume, error31_time_stamp=error31_time_stamp, printed_modes_usage_total=printed_modes_usage_total, error35=error35, error42_time_stamp=error42_time_stamp, error45_code=error45_code, media14_name=media14_name, media14_short_name=media14_short_name, held_job_set_queue_size=held_job_set_queue_size, consumable_string=consumable_string, upgradable_devices_current_state=upgradable_devices_current_state, upgradable_devices_version=upgradable_devices_version, simm3_bank2_type=simm3_bank2_type, held_job_print=held_job_print, media5_short_name=media5_short_name, simm2_capacity=simm2_capacity, simm3_type=simm3_type, error34_time_stamp=error34_time_stamp, error48_code=error48_code, asset_number=asset_number, collated_originals_support=collated_originals_support, channelEntry=channelEntry, media5_name=media5_name, simm3_bank2_capacity=simm3_bank2_capacity, file_system_delete_files=file_system_delete_files, simm1_bank1_capacity=simm1_bank1_capacity, non_assured_oht_page_count=non_assured_oht_page_count, job_info_attr_10=job_info_attr_10, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, socket_ping=socket_ping, settings_job=settings_job, media14=media14, job_info_attr_9=job_info_attr_9, consumables_1=consumables_1, media7_name=media7_name, channelstatus=channelstatus, error25_code=error25_code, deviceChannelTable=deviceChannelTable, source_tray_accounting=source_tray_accounting, pcl_total_page_count=pcl_total_page_count, media19_name=media19_name, simm5_bank2=simm5_bank2, error10_time_stamp=error10_time_stamp, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, consumable_life_low_threshold=consumable_life_low_threshold, upgradable_devices_name=upgradable_devices_name, host_application_available_memory=host_application_available_memory, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, time_display=time_display, serial_number=serial_number, marker_density_calibration=marker_density_calibration, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, channel_jobs_received=channel_jobs_received, job_input_auto_continue_timeout=job_input_auto_continue_timeout, interface=interface, channelprotocolversion=channelprotocolversion, media1=media1, perm_store_init_occurred=perm_store_init_occurred, ram_disk_size=ram_disk_size, error41_code=error41_code, media19_page_count=media19_page_count, printer_accounting=printer_accounting, background_message2=background_message2, consumable_status_page_count_b5_executive=consumable_status_page_count_b5_executive, error41_time_stamp=error41_time_stamp, media7_engine_media_mode=media7_engine_media_mode, error48=error48, default_media_name=default_media_name, upgradable_devices_write_count=upgradable_devices_write_count, media16_engine_media_mode=media16_engine_media_mode, marking_agent=marking_agent, settings_rpc=settings_rpc, error19_code=error19_code, remote_upgrade_enable=remote_upgrade_enable, media6_name=media6_name, mio3=mio3, error8_time_stamp=error8_time_stamp, error29_time_stamp=error29_time_stamp, ph2=ph2, phd2_type=phd2_type, channelTable=channelTable, media16_short_name=media16_short_name, error45=error45, media7=media7, tray2_phd=tray2_phd, settings_print_media=settings_print_media, error12_time_stamp=error12_time_stamp, printed_modes_total_count=printed_modes_total_count, mio2=mio2, error17_code=error17_code, job_info_requested_originals=job_info_requested_originals, held_job_pin=held_job_pin, simm2_bank2_type=simm2_bank2_type, media7_short_name=media7_short_name, simm4_bank2=simm4_bank2, engine_self_diagnostic=engine_self_diagnostic, error6_time_stamp=error6_time_stamp, pjl=pjl, ports=ports, simm5_bank2_type=simm5_bank2_type, fw_rom_datecode=fw_rom_datecode, job_info_attr_13=job_info_attr_13, held_job_security=held_job_security, mopy_mode=mopy_mode, job_info_pages_printed=job_info_pages_printed, port1_parallel_bidirectionality=port1_parallel_bidirectionality, default_custom_paper_dim_unit=default_custom_paper_dim_unit, simm2_bank=simm2_bank, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, media4_page_count=media4_page_count, simm5_bank1_capacity=simm5_bank1_capacity, simm4_bank1_capacity=simm4_bank1_capacity, simm5_capacity=simm5_capacity, job_info_state=job_info_state, job_input_auto_continue_mode=job_input_auto_continue_mode, media11_name=media11_name, job_info_attribute=job_info_attribute, media_modes=media_modes, job_info_accounting_media_type=job_info_accounting_media_type, print_engine_revision=print_engine_revision, media15_name=media15_name, settings_system=settings_system, media16=media16, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, error39_time_stamp=error39_time_stamp, error41=error41, firmware_download=firmware_download, tray6_media_size_loaded=tray6_media_size_loaded, media5=media5, model_name=model_name, printed_media_simplex_count=printed_media_simplex_count, settings_mass_storage_bd=settings_mass_storage_bd, job_info_pages_processed=job_info_pages_processed, job_info_name1=job_info_name1, default_custom_paper_feed_dim=default_custom_paper_feed_dim, pcl_default_font_source=pcl_default_font_source, override_media_name=override_media_name, job_info=job_info, error17_time_stamp=error17_time_stamp, os_execute_file=os_execute_file, media6_short_name=media6_short_name, outbin1_override_mode=outbin1_override_mode, media5_engine_media_mode=media5_engine_media_mode, error33=error33, tray1_phd=tray1_phd, destination_bin_usage_total=destination_bin_usage_total, error19_time_stamp=error19_time_stamp, usage_instructions_line2=usage_instructions_line2, phd2_device_specific_command=phd2_device_specific_command, print_internal_page=print_internal_page, default_horizontal_black_resolution=default_horizontal_black_resolution, simm4_type=simm4_type, outbins=outbins, error29_code=error29_code, channelprinteralert=channelprinteralert, simm1_bank2_type=simm1_bank2_type, media13_name=media13_name, print_engine=print_engine, error23_time_stamp=error23_time_stamp, job_info_accounting_job_type=job_info_accounting_job_type, job_info_attr_12=job_info_attr_12, error7_time_stamp=error7_time_stamp, consumable_reorder_url=consumable_reorder_url, error10_code=error10_code, model_number=model_number, media11_engine_media_mode=media11_engine_media_mode, settings_marking_agent=settings_marking_agent, media11=media11, media4=media4, simm4_bank1=simm4_bank1, printer_average_marking_agent_coverage_sum_squared=printer_average_marking_agent_coverage_sum_squared, media2=media2, media3_engine_media_mode=media3_engine_media_mode, media17_short_name=media17_short_name, job_being_parsed=job_being_parsed, background_status_msg_line1_part1=background_status_msg_line1_part1, error12_code=error12_code, error3_code=error3_code, media3=media3, default_page_protect=default_page_protect, error26_time_stamp=error26_time_stamp, device=device, mass_storage_resource_changed=mass_storage_resource_changed, error48_time_stamp=error48_time_stamp, tray1_media_size_loaded=tray1_media_size_loaded, file_systems=file_systems, media6=media6, simm1_bank2_capacity=simm1_bank2_capacity, job_info_size=job_info_size, error6_code=error6_code, simm2_bank2=simm2_bank2, media18_engine_media_mode=media18_engine_media_mode, error16=error16, error47=error47, media6_page_count=media6_page_count, default_copies=default_copies, media3_name=media3_name, error50=error50, pdl_pcl=pdl_pcl, simm5_type=simm5_type, source_tray_usage=source_tray_usage, error45_time_stamp=error45_time_stamp, hold_job_timeout=hold_job_timeout, error40=error40, channelnumberofchannels=channelnumberofchannels)
mibBuilder.exportSymbols("LJ4250-MIB", error1=error1, firmware_download_current_state=firmware_download_current_state, media_size_count=media_size_count, printed_media_combined_total=printed_media_combined_total, settings_io=settings_io, firmware_download_maximum_write_count=firmware_download_maximum_write_count, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, error50_time_stamp=error50_time_stamp, error11_time_stamp=error11_time_stamp, mio1_type=mio1_type, job_info_change_id=job_info_change_id, consumable_current_state=consumable_current_state, background_message=background_message, simm4_capacity=simm4_capacity, error35_code=error35_code, channelifindex=channelifindex, consumable_status_manufacturer_name=consumable_status_manufacturer_name, device_location=device_location, processing_subsystem=processing_subsystem, maximum_ram_disk_memory=maximum_ram_disk_memory, error43_time_stamp=error43_time_stamp, device_system=device_system, printed_media_duplex_count=printed_media_duplex_count, marking_agent_density_setting=marking_agent_density_setting, media6_engine_media_mode=media6_engine_media_mode, simm1_capacity=simm1_capacity, media15_short_name=media15_short_name, error15_time_stamp=error15_time_stamp, media18_page_count=media18_page_count, source_subsystem=source_subsystem, held_job_delete=held_job_delete, accounting=accounting, phd2=phd2, phd2_model=phd2_model, media2_engine_media_mode=media2_engine_media_mode, error18_code=error18_code, settings_spooler=settings_spooler, auto_continue=auto_continue, consumable_status_page_count_xy_other=consumable_status_page_count_xy_other, error21_time_stamp=error21_time_stamp, file_system_max_open_files=file_system_max_open_files, service_id=service_id, error11_code=error11_code, job_info_page_count_current_original=job_info_page_count_current_original, upgradable_devices_max_write_count=upgradable_devices_max_write_count, destination_subsystem=destination_subsystem, tray4_phd=tray4_phd, error49_code=error49_code, media3_page_count=media3_page_count, firmware_download_write_time=firmware_download_write_time, outbin1=outbin1, error8_code=error8_code, error47_code=error47_code, mio2_manufacturing_info=mio2_manufacturing_info, file_system_wipe_disk_status=file_system_wipe_disk_status, media8_engine_media_mode=media8_engine_media_mode, media15_engine_media_mode=media15_engine_media_mode, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, mio3_type=mio3_type, postscript_print_errors=postscript_print_errors, pcl_default_font_width=pcl_default_font_width, simm1_bank1=simm1_bank1, error32=error32, error33_time_stamp=error33_time_stamp, cold_reset_media_size=cold_reset_media_size, job_info_attr_5=job_info_attr_5, media12_short_name=media12_short_name, settings_intray=settings_intray, on_off_line=on_off_line, intray2=intray2, error24_code=error24_code, error35_time_stamp=error35_time_stamp, simm5=simm5, simm3_bank1_type=simm3_bank1_type, io_switch=io_switch, media10=media10, port1_parallel_speed=port1_parallel_speed, firmware_download_version=firmware_download_version, DisplayString=DisplayString, error34_code=error34_code, consumable_status_usage_count=consumable_status_usage_count, consumable_status_info=consumable_status_info, file_system2=file_system2, job_info_name2=job_info_name2, held_job_user_name=held_job_user_name, mio2_type=mio2_type, firmware_download_write_count=firmware_download_write_count, media3_short_name=media3_short_name, media_types=media_types, error39_code=error39_code, channel_mio=channel_mio, media19_short_name=media19_short_name, error9=error9, consumable_status_oem_name=consumable_status_oem_name, simm=simm, job_info_attr_8=job_info_attr_8, job_info_attr_3=job_info_attr_3, error31_code=error31_code, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, consumable_status_engine_usage_units=consumable_status_engine_usage_units, simm4=simm4, status_rpc=status_rpc, job=job, error38_time_stamp=error38_time_stamp, default_vertical_black_resolution=default_vertical_black_resolution, media10_short_name=media10_short_name, manually_feed_prompt_test=manually_feed_prompt_test, consumable_maintenance_pages_remaining=consumable_maintenance_pages_remaining, simm4_bank=simm4_bank, control_panel_display=control_panel_display, postscript_total_page_count=postscript_total_page_count, simm5_bank2_capacity=simm5_bank2_capacity, held_job_info=held_job_info, channel_bytes_received=channel_bytes_received, consumable_string_information_reset=consumable_string_information_reset, mass_storage_resources=mass_storage_resources, destination_bin_accounting=destination_bin_accounting, error40_code=error40_code, phd2_manufacturing_info=phd2_manufacturing_info, error_log_clear=error_log_clear, media18=media18, job_info_attr_14=job_info_attr_14, input_tray_auto_select=input_tray_auto_select, error9_time_stamp=error9_time_stamp, device_configure=device_configure, tray2_media_size_loaded=tray2_media_size_loaded, error16_code=error16_code, error22_time_stamp=error22_time_stamp, channel_bytes_sent=channel_bytes_sent, consumable_status_total_capacity=consumable_status_total_capacity, error23=error23, job_info_attr_1=job_info_attr_1, media_counts=media_counts, error22_code=error22_code, media12_page_count=media12_page_count, error25=error25, error24_time_stamp=error24_time_stamp, self_test=self_test, consumable_status_manufacturing_date=consumable_status_manufacturing_date, media8_name=media8_name, remote_procedure_call=remote_procedure_call, consumable_maintenance_interval=consumable_maintenance_interval, media1_short_name=media1_short_name, io=io, control_panel_button_press=control_panel_button_press, consumable_status_cartridge_model=consumable_status_cartridge_model, rpc_bound_protocol_address=rpc_bound_protocol_address, channel_io_errors=channel_io_errors, error30=error30, error4_time_stamp=error4_time_stamp, localization_countries_supported=localization_countries_supported, error42_code=error42_code, error5_code=error5_code, spooler=spooler, ph=ph, mio1=mio1, consumable_status_usage_units=consumable_status_usage_units, pdl=pdl, error26=error26, file_system_external_access_capabilities=file_system_external_access_capabilities, media11_short_name=media11_short_name, engine_media_modes_supported1=engine_media_modes_supported1, consumable_status_capacity_units=consumable_status_capacity_units, simm5_bank1_type=simm5_bank1_type, printed_media_total_charge=printed_media_total_charge, tables=tables, intray1=intray1, control_panel_display_graphical_contents=control_panel_display_graphical_contents, error4=error4, control_panel_display_contents_crc=control_panel_display_contents_crc, error6=error6, simm4_bank2_type=simm4_bank2_type, error46_code=error46_code, error33_code=error33_code, install_date=install_date, hp=hp, consumable_status_drum_life=consumable_status_drum_life, mio2_model_name=mio2_model_name, printed_media_simplex_charge=printed_media_simplex_charge, error37=error37, intray=intray, settings_pdl=settings_pdl, media2_short_name=media2_short_name, job_info_attr_6=job_info_attr_6, low_marking_agent_processing=low_marking_agent_processing, media12=media12, error32_time_stamp=error32_time_stamp, file_system3=file_system3, error17=error17, date_and_time=date_and_time, display=display, file_system_wipe_disk=file_system_wipe_disk, usage_instructions_line4=usage_instructions_line4, error49_time_stamp=error49_time_stamp, consumable_status_first_install_date=consumable_status_first_install_date, error29=error29, media17=media17, error40_time_stamp=error40_time_stamp, show_address=show_address, error39=error39, job_info_outbins_used=job_info_outbins_used, media2_name=media2_name, pysmi_continue=pysmi_continue, job_info_physical_outbins_used=job_info_physical_outbins_used, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, default_vmi=default_vmi, media17_engine_media_mode=media17_engine_media_mode, error46=error46, background_message1=background_message1, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, active_print_jobs=active_print_jobs, error22=error22, error32_code=error32_code, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, test=test, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, error15=error15, error36_time_stamp=error36_time_stamp, tray3_phd=tray3_phd, simm1=simm1, settings_outbin=settings_outbin, consumables_life=consumables_life, media5_page_count=media5_page_count, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, media17_page_count=media17_page_count, consumable_string_information=consumable_string_information, consumable_life_usage_units=consumable_life_usage_units, error23_code=error23_code, media12_name=media12_name, error15_code=error15_code, settings_webserver=settings_webserver, printed_modes_usage=printed_modes_usage, simm2_type=simm2_type, display_status=display_status, sleep_mode=sleep_mode, file_system4=file_system4, error7=error7, phd2_capacity=phd2_capacity, simm1_bank2=simm1_bank2, status_prt_eng=status_prt_eng, held_job_retention=held_job_retention, intray6=intray6, error10=error10, firmware_download_write_status_supported=firmware_download_write_status_supported, error13=error13, media9_short_name=media9_short_name, media_size=media_size, media4_engine_media_mode=media4_engine_media_mode, simm4_bank1_type=simm4_bank1_type, consumable_status_job_count=consumable_status_job_count, consumable_status_authentication=consumable_status_authentication, mio3_manufacturing_info=mio3_manufacturing_info, error49=error49, error5=error5)
mibBuilder.exportSymbols("LJ4250-MIB", error38_code=error38_code, media1_engine_media_mode=media1_engine_media_mode, resource_manager=resource_manager, netPMLmgmt=netPMLmgmt, media13_page_count=media13_page_count, error20_time_stamp=error20_time_stamp, usage_instructions_line3=usage_instructions_line3, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, media17_name=media17_name, print_media=print_media, error37_time_stamp=error37_time_stamp, upgradable_devices_write_time=upgradable_devices_write_time, errorlog=errorlog, error13_time_stamp=error13_time_stamp, upgradable_devices=upgradable_devices, error1_time_stamp=error1_time_stamp, tray_prompt=tray_prompt, socket_ping_job_events_version=socket_ping_job_events_version, file_system_security_access_password=file_system_security_access_password, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, service_channel_printing_status=service_channel_printing_status, printer_average_marking_agent_coverage_sum=printer_average_marking_agent_coverage_sum, media8_short_name=media8_short_name, error43=error43, tray3_media_size_loaded=tray3_media_size_loaded, error44_time_stamp=error44_time_stamp, error43_code=error43_code, media4_short_name=media4_short_name, usage_printer_total_charge=usage_printer_total_charge, media1_name=media1_name, file_system4_initialize_volume=file_system4_initialize_volume, usage_staple_count=usage_staple_count, media9_name=media9_name, job_output_auto_continue_timeout=job_output_auto_continue_timeout, error18_time_stamp=error18_time_stamp, simm1_bank=simm1_bank, job_info_pages_in_original=job_info_pages_in_original, simm1_bank1_type=simm1_bank1_type, intrays=intrays, error12=error12, error31=error31, settings_file_system=settings_file_system, settings_prt_eng=settings_prt_eng, held_job_job_name=held_job_job_name, media18_name=media18_name, error14_time_stamp=error14_time_stamp, media13_engine_media_mode=media13_engine_media_mode, error9_code=error9_code, error11=error11, simm3_bank1=simm3_bank1, error2_code=error2_code, error27_code=error27_code, fw_rom_revision=fw_rom_revision, energy_star=energy_star, job_info_attr_2=job_info_attr_2, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, firmware_download_name=firmware_download_name, simm2=simm2, job_info_io_source=job_info_io_source, error2=error2, error37_code=error37_code, held_job_enable=held_job_enable, job_info_attr_16=job_info_attr_16, outbin=outbin, consumable_status_engine_usage_count=consumable_status_engine_usage_count, intray3=intray3, error38=error38, media16_name=media16_name, job_info_printed_originals=job_info_printed_originals, operating_system=operating_system, status_mass_storage_bd=status_mass_storage_bd, error27_time_stamp=error27_time_stamp, error7_code=error7_code, job_info_attr_15=job_info_attr_15, channeltype=channeltype, simm4_bank2_capacity=simm4_bank2_capacity, error19=error19, media_info=media_info, media13=media13, timestamp=timestamp, media16_page_count=media16_page_count, job_info_stage=job_info_stage, status_system=status_system, channelinformation=channelinformation, PYSNMP_MODULE_ID=hp, error3=error3, simm3_capacity=simm3_capacity, overflow_bin=overflow_bin, consumable_status_last_use_date=consumable_status_last_use_date, error3_time_stamp=error3_time_stamp, media13_short_name=media13_short_name, media15=media15, error20=error20, printed_media_dimplex_count=printed_media_dimplex_count, error26_code=error26_code, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, printed_media_usage=printed_media_usage, ram_disk_mode=ram_disk_mode, tray4_media_size_loaded=tray4_media_size_loaded, job_info_attr_4=job_info_attr_4, consumable_status_serial_number=consumable_status_serial_number, intray4=intray4, simm3_bank2=simm3_bank2, media12_engine_media_mode=media12_engine_media_mode, io_timeout=io_timeout, consumable_status_drum_life_units=consumable_status_drum_life_units, media8=media8, mio1_model_name=mio1_model_name, source_tray_usage_count=source_tray_usage_count, consumable_status_page_count_legal=consumable_status_page_count_legal, usage_instructions_line1=usage_instructions_line1, override_media_size=override_media_size, consumables=consumables, printed_media_duplex_charge=printed_media_duplex_charge, error21=error21, date_display=date_display, media_names_available=media_names_available, out_marking_agent_processing=out_marking_agent_processing, background_status_msg_line2_part1=background_status_msg_line2_part1, channel=channel, rpc_bind_protocol_address=rpc_bind_protocol_address, held_job_quantity=held_job_quantity, error13_code=error13_code, job_info_accounting_finishing_options=job_info_accounting_finishing_options, error30_time_stamp=error30_time_stamp, media10_name=media10_name, mio=mio, job_info_outcome=job_info_outcome, pcl_default_font_height=pcl_default_font_height, media15_page_count=media15_page_count, file_system=file_system, default_lines_per_page=default_lines_per_page, file_system_erase_mode=file_system_erase_mode, pcl_default_font_number=pcl_default_font_number, job_info_accounting=job_info_accounting, held_job=held_job, destination_bin_usage=destination_bin_usage, error28_code=error28_code, simm3_bank1_capacity=simm3_bank1_capacity, error47_time_stamp=error47_time_stamp, default_bits_per_pixel=default_bits_per_pixel, mio1_manufacturing_info=mio1_manufacturing_info, simm3=simm3, destination_bin_usage_count=destination_bin_usage_count, media9_engine_media_mode=media9_engine_media_mode, device_name=device_name, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, simm3_bank=simm3_bank, tray5_media_size_loaded=tray5_media_size_loaded, media_number_of_type_supported=media_number_of_type_supported, tray5_phd=tray5_phd, channelstate=channelstate, printed_modes_accounting=printed_modes_accounting, error18=error18, media19=media19, media10_page_count=media10_page_count, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, printer_average=printer_average, error14_code=error14_code, web_server_security=web_server_security, media1_page_count=media1_page_count, error5_time_stamp=error5_time_stamp, job_info_attr_11=job_info_attr_11, error8=error8, form_feed_needed=form_feed_needed, deviceChannelEntry=deviceChannelEntry, media7_page_count=media7_page_count, device_configure_printer_parameters=device_configure_printer_parameters, media10_engine_media_mode=media10_engine_media_mode, error21_code=error21_code, media11_page_count=media11_page_count, error4_code=error4_code, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, file_system2_initialize_volume=file_system2_initialize_volume, status_pdl=status_pdl, simm2_bank1_capacity=simm2_bank1_capacity, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, duplex_page_count=duplex_page_count, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, clearable_warning=clearable_warning, media8_page_count=media8_page_count, ph_devices=ph_devices, error24=error24, reprint=reprint, media18_short_name=media18_short_name, port1=port1, error46_time_stamp=error46_time_stamp, error2_time_stamp=error2_time_stamp, current_job_parsing_id=current_job_parsing_id, error44=error44, error30_code=error30_code, simm5_bank=simm5_bank, simm2_bank2_capacity=simm2_bank2_capacity, media14_engine_media_mode=media14_engine_media_mode, error34=error34, default_media_size=default_media_size)
