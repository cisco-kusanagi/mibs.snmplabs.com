...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:14:05 2019
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, iso, Bits, Integer32, Unsigned32, MibIdentifier, Counter32, Gauge32, IpAddress, Counter64, NotificationType, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "iso", "Bits", "Integer32", "Unsigned32", "MibIdentifier", "Counter32", "Gauge32", "IpAddress", "Counter64", "NotificationType", "ModuleIdentity")
