...
# Produced by pysmi-0.3.4 at Mon Apr 29 20:28:27 2019
...
ObjectIdentity, Counter32, NotificationType, Gauge32, Counter64, Integer32, ModuleIdentity, Bits, iso, TimeTicks, IpAddress, Unsigned32, MibIdentifier, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "NotificationType", "Gauge32", "Counter64", "Integer32", "ModuleIdentity", "Bits", "iso", "TimeTicks", "IpAddress", "Unsigned32", "MibIdentifier", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("PANDATEL-GMSF-MODEM-MIB", mdmClockSystem=mdmClockSystem, mdmClockSource=mdmClockSource, mdmCRC6Test=mdmCRC6Test, mdmPosition=mdmPosition, mdmScrambler=mdmScrambler, gmsfTableEntry=gmsfTableEntry, mdmDataRate=mdmDataRate, gmsf_modem=gmsf_modem, mdmHDSLUnit=mdmHDSLUnit, mdmModemProperty=mdmModemProperty, mdmTimeslot16=mdmTimeslot16, mdmCRC6Status=mdmCRC6Status, mdmCRC4Generation=mdmCRC4Generation, mdmStartTimeslot=mdmStartTimeslot, mdmFramingMode=mdmFramingMode, mdmCRC6Error=mdmCRC6Error, mdmRemoteAccessMode=mdmRemoteAccessMode, mdmInterfaceEmulationMode=mdmInterfaceEmulationMode, mdmRack=mdmRack, mdmModemName=mdmModemName, gmsfModemTable=gmsfModemTable, mdmModem=mdmModem, gmsf=gmsf, mdmTimeslotSize=mdmTimeslotSize)
