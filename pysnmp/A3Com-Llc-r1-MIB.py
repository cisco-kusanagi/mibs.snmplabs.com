...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/A3Com-Llc-r1-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 16:54:25 2019
...
TimeTicks, Counter32, ObjectIdentity, Unsigned32, Integer32, ModuleIdentity, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, NotificationType, iso, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Counter32", "ObjectIdentity", "Unsigned32", "Integer32", "ModuleIdentity", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "NotificationType", "iso", "Counter64", "Gauge32")
...
ccsLlcTunnelDefaultDestEntry = MibTableRow((1, 3, 6, 1, 4, 1, 43, 2, 26, 4, 3, 1), ).setIndexNames((0, "A3Com-Llc-r1-MIB", "pysmiFakeCol1000"))
...
mibBuilder.exportSymbols("A3Com-Llc-r1-MIB", ccsLlcRouterTunnelTransport=ccsLlcRouterTunnelTransport, llcSapNumber=llcSapNumber, llcSapOperStatus=llcSapOperStatus, llcPortAdminMaxUnackedIPDUsSend=llcPortAdminMaxUnackedIPDUsSend, ccsLlcLocalAddress=ccsLlcLocalAddress, llcCcOperDelayAckCount=llcCcOperDelayAckCount, llcSapOperNumCcs=llcSapOperNumCcs, llcSapStatsConnectFail=llcSapStatsConnectFail, ccsLlcRemoteMacAddress=ccsLlcRemoteMacAddress, llcSapStatsIOctetsIn=llcSapStatsIOctetsIn, llcSapStatsXIDResponsesIn=llcSapStatsXIDResponsesIn, llcCcRSap=llcCcRSap, llcCcOperAckTimer=llcCcOperAckTimer, llcPortAdminMaxUnackedIPDUsRcv=llcPortAdminMaxUnackedIPDUsRcv, llcSapStatsIFramesIn=llcSapStatsIFramesIn, llcSapOperTable=llcSapOperTable, ccsLlcTunnelInfo=ccsLlcTunnelInfo, brouterMIB=brouterMIB, llcCcOperLastFailTime=llcCcOperLastFailTime, llcCcLMac=llcCcLMac, llcSapStatsConnectOk=llcSapStatsConnectOk, llcCcOperLastFailCause=llcCcOperLastFailCause, llcCcOperCreateTime=llcCcOperCreateTime, llcCcOperMaxIPDUOctetsRcv=llcCcOperMaxIPDUOctetsRcv, llcCcRMac=llcCcRMac, llcCcOperDelayAckTimer=llcCcOperDelayAckTimer, ccsLlcTunnelDefaultDestEntry=ccsLlcTunnelDefaultDestEntry, llcCcOperWw=llcCcOperWw, llcCcLSap=llcCcLSap, llcCcStatsSFramesOut=llcCcStatsSFramesOut, llcSapStatsTable=llcSapStatsTable, llcCcOperInactTimer=llcCcOperInactTimer, llcCcOperMaxRetransmits=llcCcOperMaxRetransmits, llcCcStatsLocalBusies=llcCcStatsLocalBusies, llcPortAdminMaxRetransmits=llcPortAdminMaxRetransmits, llcSapStatsSFramesIn=llcSapStatsSFramesIn, ccsLlcTunnelRouterTable=ccsLlcTunnelRouterTable, llcPortAdminAckTimer=llcPortAdminAckTimer, llcCcOperMaxUnackedIPDUsRcv=llcCcOperMaxUnackedIPDUsRcv, ccsLlcTunnelMode=ccsLlcTunnelMode, llcCcStatsSFramesIn=llcCcStatsSFramesIn, ccsLlcRemoteSapHighRange=ccsLlcRemoteSapHighRange, llcPortAdminRejTimer=llcPortAdminRejTimer, llcSapStatsXIDResponsesOut=llcSapStatsXIDResponsesOut, a3com=a3com, llcPortOperTable=llcPortOperTable, ccsLlcRemoteSapLowRange=ccsLlcRemoteSapLowRange, llcPortOperNumSaps=llcPortOperNumSaps, ccsLlcTunnelDefaultDestTable=ccsLlcTunnelDefaultDestTable, llcCcOperRejTimer=llcCcOperRejTimer, llcSapStatsTESTCommandsIn=llcSapStatsTESTCommandsIn, llcCcAdminTable=llcCcAdminTable, llcCcOperLastFailFRMRInfo=llcCcOperLastFailFRMRInfo, ccsLlcRouterMode=ccsLlcRouterMode, MacAddress=MacAddress, llcCcOperEntry=llcCcOperEntry, llcCcOperPbitTimer=llcCcOperPbitTimer, llcCcStatsRetransmitsOut=llcCcStatsRetransmitsOut, llcPortAdminName=llcPortAdminName, llcSapStatsIFramesOut=llcSapStatsIFramesOut, ccsLlcRouterPeerString=ccsLlcRouterPeerString, llcSapStatsSFramesOut=llcSapStatsSFramesOut, llcSapStatsUIFramesOut=llcSapStatsUIFramesOut, llcPortAdminInactTimer=llcPortAdminInactTimer, llcPortGroup=llcPortGroup, llcSapStatsDisconnectFRMRRcv=llcSapStatsDisconnectFRMRRcv, llcSapAdminTable=llcSapAdminTable, llcSapStatsDisconnectFRMRSend=llcSapStatsDisconnectFRMRSend, llcSapStatsIOctetsOut=llcSapStatsIOctetsOut, llcCcOperBusyTimer=llcCcOperBusyTimer, llcSapOperEntry=llcSapOperEntry, llcCcStatsWwCount=llcCcStatsWwCount, llcCcStatsTable=llcCcStatsTable, llcCcStatsEntry=llcCcStatsEntry, llcCcOperMaxIPDUOctetsSend=llcCcOperMaxIPDUOctetsSend, llcPortAdminMaxCcs=llcPortAdminMaxCcs, ccsLlcTunnelSNAPriority=ccsLlcTunnelSNAPriority, llcSapStatsLocalBusies=llcSapStatsLocalBusies, llcCcStatsRemoteBusies=llcCcStatsRemoteBusies, llcPortAdminMaxPDUOctets=llcPortAdminMaxPDUOctets, ccsLlcTunnelRouterEntry=ccsLlcTunnelRouterEntry, ccsLlcDestTunnelId=ccsLlcDestTunnelId, llcPortAdminPbitTimer=llcPortAdminPbitTimer, llcSapOperLlc2Support=llcSapOperLlc2Support, llcSapStatsTESTCommandsOut=llcSapStatsTESTCommandsOut, ccsLlcPeerAddress=ccsLlcPeerAddress, llcCcOperLastWwCause=llcCcOperLastWwCause, ccsLlcTunnelId=ccsLlcTunnelId, llc=llc, llcSapStatsWwCount=llcSapStatsWwCount, llcPortOperSimRim=llcPortOperSimRim, llcSapStatsTESTResponsesOut=llcSapStatsTESTResponsesOut, llcCcGroup=llcCcGroup, llcCcStatsREJsIn=llcCcStatsREJsIn, llcSapStatsUIOctetsIn=llcSapStatsUIOctetsIn, llcSapGroup=llcSapGroup, llcTunnelGroup=llcTunnelGroup, llcCcStatsIFramesOut=llcCcStatsIFramesOut, llcCcOperMaxUnackedIPDUsSend=llcCcOperMaxUnackedIPDUsSend, llcSapStatsRetransmitsOut=llcSapStatsRetransmitsOut, llcPortOperEntry=llcPortOperEntry, llcPortAdminTable=llcPortAdminTable, llcCcOperTable=llcCcOperTable, llcSapStatsREJsIn=llcSapStatsREJsIn, llcSapStatsUIFramesIn=llcSapStatsUIFramesIn, llcCcAdminEntry=llcCcAdminEntry, llcSapStatsRemoteBusies=llcSapStatsRemoteBusies, llcPortAdminNw=llcPortAdminNw, llcCcStatsIOctetsOut=llcCcStatsIOctetsOut, llcPortAdminBusyTimer=llcPortAdminBusyTimer, ccsLlcRemoteSap=ccsLlcRemoteSap, llcSapStatsReset=llcSapStatsReset, llcCcStatsREJsOut=llcCcStatsREJsOut, llcSapStatsUIOctetsOut=llcSapStatsUIOctetsOut, llcCcOperNw=llcCcOperNw, ccsLlcRouterEnable=ccsLlcRouterEnable, llcSapStatsTESTResponsesIn=llcSapStatsTESTResponsesIn, llcPortAdminDelayAckTimer=llcPortAdminDelayAckTimer, llcCcStatsIFramesIn=llcCcStatsIFramesIn, pysmiFakeCol1000=pysmiFakeCol1000, ccsLlcTunnelVirtualRing=ccsLlcTunnelVirtualRing, llcCcStatsIOctetsIn=llcCcStatsIOctetsIn, llcSapStatsDisconnect=llcSapStatsDisconnect, llcPortOperLastModifyTime=llcPortOperLastModifyTime, llcSapStatsREJsOut=llcSapStatsREJsOut, ccsLlcRouterTunnelPort=ccsLlcRouterTunnelPort, llcSapAdminEntry=llcSapAdminEntry, llcSapStatsXIDCommandsIn=llcSapStatsXIDCommandsIn, llcSapStatsDisconnectTimer=llcSapStatsDisconnectTimer, llcPortAdminMaxSaps=llcPortAdminMaxSaps, llcSapStatsEntry=llcSapStatsEntry, llcCcOperState=llcCcOperState, llcCcOperLastModifyTime=llcCcOperLastModifyTime, llcSapStatsXIDCommandsOut=llcSapStatsXIDCommandsOut, llcPortAdminEntry=llcPortAdminEntry, llcPortAdminDelayAckCount=llcPortAdminDelayAckCount)
