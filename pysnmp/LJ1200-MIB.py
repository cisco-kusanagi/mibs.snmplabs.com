...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ1200-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:00 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, NotificationType, ObjectIdentity, ModuleIdentity, IpAddress, Unsigned32, iso, TimeTicks, MibIdentifier, Bits, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Unsigned32", "iso", "TimeTicks", "MibIdentifier", "Bits", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("LJ1200-MIB", job_info_outcome=job_info_outcome, prtmarkercounterunit=prtmarkercounterunit, prtmediapathdefaultindex=prtmediapathdefaultindex, status_system=status_system, source_subsystem=source_subsystem, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, prtcoverstatus=prtcoverstatus, pcl_resource_saving_memory_size=pcl_resource_saving_memory_size, prtconsolenumberofdisplaychars=prtconsolenumberofdisplaychars, hrdeviceid=hrdeviceid, current_job_parsing_id=current_job_parsing_id, simm2_type=simm2_type, prtmarkermarktech=prtmarkermarktech, prtConsoleLightTable=prtConsoleLightTable, default_media_size=default_media_size, prtchannelstate=prtchannelstate, hrstorageused=hrstorageused, default_copies=default_copies, hrstoragetype=hrstoragetype, prtDeviceRefEntry=prtDeviceRefEntry, total_engine_page_count=total_engine_page_count, prtinputname=prtinputname, system=system, prtinputmediadimxfeeddirchosen=prtinputmediadimxfeeddirchosen, hrstorageallocationfailures=hrstorageallocationfailures, prtmediapathmaxmediafeeddir=prtmediapathmaxmediafeeddir, job_info_io_source=job_info_io_source, prtinterpreterxfeedaddressability=prtinterpreterxfeedaddressability, job_info_change_id=job_info_change_id, hrm=hrm, energy_star=energy_star, pcl_default_font_number=pcl_default_font_number, prtInput=prtInput, prtDeviceRefTable=prtDeviceRefTable, simm1_type=simm1_type, dm=dm, error10_code=error10_code, sleep_mode=sleep_mode, prtMarkerSupplies=prtMarkerSupplies, hrStorageTable=hrStorageTable, prtinputsecurity=prtinputsecurity, error3=error3, hrstoragedescr=hrstoragedescr, channel_entry=channel_entry, simm2=simm2, prtmarkersuppliessupplyunit=prtmarkersuppliessupplyunit, pcl_default_font_width=pcl_default_font_width, job_info_pages_printed=job_info_pages_printed, default_print_quality=default_print_quality, prtmediapathminmediaxfeeddir=prtmediapathminmediaxfeeddir, reprint=reprint, simm2_capacity=simm2_capacity, prtmarkersupplieslevel=prtmarkersupplieslevel, prtinterpreterversion=prtinterpreterversion, job_info_name1=job_info_name1, prtgeneralcurrentoperator=prtgeneralcurrentoperator, error5_time_stamp=error5_time_stamp, prtLocalizationEntry=prtLocalizationEntry, serial_number=serial_number, error9_time_stamp=error9_time_stamp, job_info_attr_16=job_info_attr_16, error6_code=error6_code, postscript_print_errors=postscript_print_errors, prtinputtype=prtinputtype, prtinputcurrentlevel=prtinputcurrentlevel, on_off_line=on_off_line, error2_time_stamp=error2_time_stamp, print_engine_jam_count=print_engine_jam_count, prtoutputtype=prtoutputtype, job_input_auto_continue_timeout=job_input_auto_continue_timeout, prtalertgroup=prtalertgroup, job_info_attr_13=job_info_attr_13, prtinputversion=prtinputversion, prtmarkerpoweroncount=prtmarkerpoweroncount, job_info_attr_14=job_info_attr_14, prtlocalizationcountry=prtlocalizationcountry, prtmediapathtype=prtmediapathtype, intray1=intray1, error8_time_stamp=error8_time_stamp, custom_paper_xfeed_dim=custom_paper_xfeed_dim, processing_subsystem=processing_subsystem, job_info_attribute=job_info_attribute, status_prt_eng=status_prt_eng, prtoutputcapacityunit=prtoutputcapacityunit, prtinputmediadimxfeeddirdeclared=prtinputmediadimxfeeddirdeclared, print_density=print_density, prtinterpreterdescription=prtinterpreterdescription, default_lines_per_page=default_lines_per_page, hrstorageindex=hrstorageindex, prtChannelTable=prtChannelTable, prtmarkeraddressabilityxfeeddir=prtmarkeraddressabilityxfeeddir, errorlog=errorlog, prtmediapathdescription=prtmediapathdescription, settings_intray=settings_intray, job_info_attr_1=job_info_attr_1, settings_job=settings_job, prtmarkersuppliesclass=prtmarkersuppliesclass, hrdevicestatus=hrdevicestatus, prtmediapathminmediafeeddir=prtmediapathminmediafeeddir, prtalerttraininglevel=prtalerttraininglevel, prtInterpreter=prtInterpreter, pcl_default_font_source=pcl_default_font_source, settings_system=settings_system, prtmarkeraddressabilityfeeddir=prtmarkeraddressabilityfeeddir, prtmarkerprocesscolorants=prtmarkerprocesscolorants, prtmarkersuppliestype=prtmarkersuppliestype, prtMarkerSuppliesTable=prtMarkerSuppliesTable, prtmediapathstatus=prtmediapathstatus, print_internal_page=print_internal_page, prtconsoledisplaybuffertext=prtconsoledisplaybuffertext, error3_time_stamp=error3_time_stamp, prtmarkersuppliesmaxcapacity=prtmarkersuppliesmaxcapacity, hrStorageEntry=hrStorageEntry, prtinputdescription=prtinputdescription, prtchanneldefaultpagedesclangindex=prtchanneldefaultpagedesclangindex, prtinterpreterdefaultcharsetin=prtinterpreterdefaultcharsetin, prtinputcapacityunit=prtinputcapacityunit, mio=mio, custom_paper_feed_dim=custom_paper_feed_dim, auto_continue=auto_continue, prtmarkerwestmargin=prtmarkerwestmargin, prtStorageRefEntry=prtStorageRefEntry, prtGeneral=prtGeneral, default_horizontal_black_resolution=default_horizontal_black_resolution, prtalerttime=prtalerttime, io_timeout=io_timeout, simm1_capacity=simm1_capacity, hp=hp, error7_time_stamp=error7_time_stamp, print_engine=print_engine, prtmarkereastmargin=prtmarkereastmargin, error2_code=error2_code, prtmediapathmaxspeed=prtmediapathmaxspeed, prtLocalizationTable=prtLocalizationTable, job_info_attr_8=job_info_attr_8, prtoutputstatus=prtoutputstatus, channel_jobs_received=channel_jobs_received, prtinputmediadimfeeddirdeclared=prtinputmediadimfeeddirdeclared, prtMediaPathTable=prtMediaPathTable, prtMarker=prtMarker, hrdevicedescr=hrdevicedescr, error10_time_stamp=error10_time_stamp, prtmarkersuppliescolorantindex=prtmarkersuppliescolorantindex, device=device, job_info_attr_10=job_info_attr_10, channelprinteralert=channelprinteralert, error8_code=error8_code, prtinterpretertwoway=prtinterpretertwoway, tray1_media_size_loaded=tray1_media_size_loaded, hrstoragesize=hrstoragesize, job=job, error8=error8, hrdeviceindex=hrdeviceindex, job_info_attr_9=job_info_attr_9, prtmediapathmaxmediaxfeeddir=prtmediapathmaxmediaxfeeddir, tables=tables, transfer_setting=transfer_setting, channel_bytes_received=channel_bytes_received, simm1=simm1, error10=error10, prtMarkerEntry=prtMarkerEntry, prtChannel=prtChannel, job_info_attr_7=job_info_attr_7, error4_code=error4_code, prtgeneralcurrentlocalization=prtgeneralcurrentlocalization, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, interface=interface, device_location=device_location, error_log_clear=error_log_clear, prtconsoledescription=prtconsoledescription, prtoutputmaxcapacity=prtoutputmaxcapacity, prtchannelprotocolversion=prtchannelprotocolversion, error1=error1, channel_table=channel_table, channel_bytes_sent=channel_bytes_sent, prtmarkeraddressabilityunit=prtmarkeraddressabilityunit, prtGeneralEntry=prtGeneralEntry, intray=intray, prtOutputTable=prtOutputTable, prtchannelifindex=prtchannelifindex, prtmediapathmaxspeedprintunit=prtmediapathmaxspeedprintunit, io=io, install_date=install_date, prtmarkersuppliesmarkerindex=prtmarkersuppliesmarkerindex, channelnumberofchannels=channelnumberofchannels, prtInterpreterTable=prtInterpreterTable, prtinterpreterdefaultcharsetout=prtinterpreterdefaultcharsetout, prtconsoleofftime=prtconsoleofftime, prtInputTable=prtInputTable, prtCoverEntry=prtCoverEntry, DisplayString=DisplayString, pysmi_continue=pysmi_continue, pjl_password=pjl_password, job_info_attr_15=job_info_attr_15, prtmarkersouthmargin=prtmarkersouthmargin, pdl_pcl=pdl_pcl, prtCoverTable=prtCoverTable, prtalertallevents=prtalertallevents, prtconsolecolor=prtconsolecolor, resource_saving=resource_saving, error5_code=error5_code, prtchannelstatus=prtchannelstatus, job_info_stage=job_info_stage, status_pdl=status_pdl, asset_number=asset_number, hrprinterstatus=hrprinterstatus, hrPrinterEntry=hrPrinterEntry, service_password=service_password, prtMediaPath=prtMediaPath, hrprinterdetectederrorstate=hrprinterdetectederrorstate, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, prtalertlocation=prtalertlocation, printmib=printmib, prtinputdimunit=prtinputdimunit, prtChannelEntry=prtChannelEntry, job_info_physical_outbins_used=job_info_physical_outbins_used, error4=error4, job_info_attr_12=job_info_attr_12, prtlocalizationlanguage=prtlocalizationlanguage, dark_courier=dark_courier, error9=error9, wide_a4=wide_a4, prtalertcode=prtalertcode, settings_prt_eng=settings_prt_eng, prtconsoleontime=prtconsoleontime, job_info=job_info, fw_rom_datecode=fw_rom_datecode, device_name=device_name, job_info_attr_3=job_info_attr_3, settings_io=settings_io, test=test, destination_subsystem=destination_subsystem, prtalertcriticalevents=prtalertcriticalevents, active_print_jobs=active_print_jobs, job_info_attr_6=job_info_attr_6, default_page_protect=default_page_protect, prtinputdefaultindex=prtinputdefaultindex, prtinputvendorname=prtinputvendorname, job_info_attr_2=job_info_attr_2, hrPrinterTable=hrPrinterTable, job_being_parsed=job_being_parsed, error1_time_stamp=error1_time_stamp, prtgeneralreset=prtgeneralreset, prtgeneralserviceperson=prtgeneralserviceperson, prtoutputremainingcapacity=prtoutputremainingcapacity, hrDeviceEntry=hrDeviceEntry, mio1_type=mio1_type, job_input_auto_continue_mode=job_input_auto_continue_mode, default_vertical_black_resolution=default_vertical_black_resolution, pjl=pjl, prtMediaPathEntry=prtMediaPathEntry, maximum_resource_saving_memory=maximum_resource_saving_memory, form_feed=form_feed, prtinterpreterlanglevel=prtinterpreterlanglevel)
mibBuilder.exportSymbols("LJ1200-MIB", prtmarkerstatus=prtmarkerstatus, imaging=imaging, prtconsolenumberofdisplaylines=prtconsolenumberofdisplaylines, error1_code=error1_code, prtmarkernorthmargin=prtmarkernorthmargin, prtmediapathmediasizeunit=prtmediapathmediasizeunit, cold_reset_media_size=cold_reset_media_size, prtalertseveritylevel=prtalertseveritylevel, error9_code=error9_code, hrStorage=hrStorage, job_info_size=job_info_size, job_info_state=job_info_state, prtinputserialnumber=prtinputserialnumber, settings_pdl=settings_pdl, error5=error5, prtinputmedianame=prtinputmedianame, prtalertgroupindex=prtalertgroupindex, error7=error7, error2=error2, tray1_fuser_temperature=tray1_fuser_temperature, prtmarkersuppliesdescription=prtmarkersuppliesdescription, pcl_default_font_height=pcl_default_font_height, error3_code=error3_code, error7_code=error7_code, prtMarkerTable=prtMarkerTable, intrays=intrays, prtCover=prtCover, postscript_resource_saving_memory_size=postscript_resource_saving_memory_size, pdl=pdl, prtAlertEntry=prtAlertEntry, prtlocalizationcharacterset=prtlocalizationcharacterset, prtconsolelocalization=prtconsolelocalization, job_info_outbins_used=job_info_outbins_used, prtConsoleLightEntry=prtConsoleLightEntry, prtgeneralconfigchanges=prtgeneralconfigchanges, prtchannelcurrentjobcntllangindex=prtchannelcurrentjobcntllangindex, prtLocalization=prtLocalization, prtgeneralprintername=prtgeneralprintername, error6_time_stamp=error6_time_stamp, channel=channel, error6=error6, prtInterpreterEntry=prtInterpreterEntry, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, pdl_postscript=pdl_postscript, job_info_name2=job_info_name2, custom_paper_dim_unit=custom_paper_dim_unit, job_info_pages_processed=job_info_pages_processed, prtinputstatus=prtinputstatus, prtconsoledisable=prtconsoledisable, prtchannelinformation=prtchannelinformation, prtalertdescription=prtalertdescription, job_info_attr_11=job_info_attr_11, separation_setting=separation_setting, default_vmi=default_vmi, hrstorageallocationunits=hrstorageallocationunits, prtGeneralTable=prtGeneralTable, job_info_attr_5=job_info_attr_5, prtchanneltype=prtchanneltype, prtmarkerdefaultindex=prtmarkerdefaultindex, channel_io_errors=channel_io_errors, error4_time_stamp=error4_time_stamp, prtcoverdescription=prtcoverdescription, prtoutputdefaultindex=prtoutputdefaultindex, prtmarkerlifecount=prtmarkerlifecount, simm=simm, form_feed_needed=form_feed_needed, hrDeviceTable=hrDeviceTable, prtinputmaxcapacity=prtinputmaxcapacity, prtOutputEntry=prtOutputEntry, prtinputmodel=prtinputmodel, prtgeneralserialnumber=prtgeneralserialnumber, prtinterpreterdefaultorientation=prtinterpreterdefaultorientation, prtStorageRefTable=prtStorageRefTable, prtmarkerspotcolorants=prtmarkerspotcolorants, mio1=mio1, prtInputEntry=prtInputEntry, prtinputmediadimfeeddirchosen=prtinputmediadimfeeddirchosen, model_name=model_name, hrdevicetype=hrdevicetype, prtstoragerefindex=prtstoragerefindex, prtAlertTable=prtAlertTable, hrdeviceerrors=hrdeviceerrors, hrDevice=hrDevice, id=id, prtinterpreterfeedaddressability=prtinterpreterfeedaddressability, default_bits_per_pixel=default_bits_per_pixel, print_engine_mispick_count=print_engine_mispick_count, default_ret=default_ret, self_test=self_test, prtOutput=prtOutput, prtinterpreterlangversion=prtinterpreterlangversion, prtConsoleLights=prtConsoleLights, job_info_attr_4=job_info_attr_4, prtinterpreterlangfamily=prtinterpreterlangfamily, prtdevicerefindex=prtdevicerefindex, io_switch=io_switch, device_config_token=device_config_token, prtAlert=prtAlert, hrmemorysize=hrmemorysize)
