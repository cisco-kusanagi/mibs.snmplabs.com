...
# Produced by pysmi-0.3.4 at Mon Apr 29 17:10:17 2019
...
Unsigned32, Counter32, Integer32, ObjectIdentity, Bits, Counter64, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, ModuleIdentity, Gauge32, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "Integer32", "ObjectIdentity", "Bits", "Counter64", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Gauge32", "IpAddress", "iso")
...
mibBuilder.exportSymbols("ASCEND-MIBANSPLAN-MIB", answerPlanProfile_AnswerNumber=answerPlanProfile_AnswerNumber, answerPlanProfile_DestChanGroup=answerPlanProfile_DestChanGroup, answerPlanProfile_Action_o=answerPlanProfile_Action_o, answerPlanProfile_Name=answerPlanProfile_Name, answerPlanProfile_DialPlanNumber=answerPlanProfile_DialPlanNumber, mibanswerPlanProfile=mibanswerPlanProfile, mibanswerPlanProfileTable=mibanswerPlanProfileTable, answerPlanProfile_AnswerCallType=answerPlanProfile_AnswerCallType, DisplayString=DisplayString, mibanswerPlanProfileEntry=mibanswerPlanProfileEntry)
