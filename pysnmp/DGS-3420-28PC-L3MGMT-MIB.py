...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:28:46 2019
...
AreaID, DesignatedRouterPriority, Metric, HelloRange, TOSType, UpToMaxAge, Status, PositiveInteger, RouterID = mibBuilder.importSymbols("OSPF-MIB", "AreaID", "DesignatedRouterPriority", "Metric", "HelloRange", "TOSType", "UpToMaxAge", "Status", "PositiveInteger", "RouterID")
ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup")
Counter32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, IpAddress, Unsigned32, Gauge32, ObjectIdentity, NotificationType, Integer32, MibIdentifier, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "IpAddress", "Unsigned32", "Gauge32", "ObjectIdentity", "NotificationType", "Integer32", "MibIdentifier", "iso", "Bits")
MacAddress, PhysAddress, TimeStamp, RowStatus, TextualConvention, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "PhysAddress", "TimeStamp", "RowStatus", "TextualConvention", "TruthValue", "DisplayString")
...
mibBuilder.exportSymbols("DGS-3420-28PC-L3MGMT-MIB", swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3ospfIfDemand=swL3ospfIfDemand, swL3IpCtrlState=swL3IpCtrlState, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3OspfHostEntry=swL3OspfHostEntry, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3Route6RedistriDstProtocol=swL3Route6RedistriDstProtocol, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3IpCtrlIpv6AdminState=swL3IpCtrlIpv6AdminState, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3DevMgmt=swL3DevMgmt, swL3LoopBackIpv6CtrlIpv6Address=swL3LoopBackIpv6CtrlIpv6Address, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3IpCtrlDhcpv6ClientPDState=swL3IpCtrlDhcpv6ClientPDState, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3Md5RowStatus=swL3Md5RowStatus, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3RIPInboundRouteFilterEntry=swL3RIPInboundRouteFilterEntry, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3OspfHostTable=swL3OspfHostTable, swL3LoopBackIpv6CtrlTable=swL3LoopBackIpv6CtrlTable, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3Ipv6CtrlOptimisticDadState=swL3Ipv6CtrlOptimisticDadState, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3Ipv6Address=swL3Ipv6Address, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3IpCtrlDhcpv6ClientPDPrefix=swL3IpCtrlDhcpv6ClientPDPrefix, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3ospfAreaId=swL3ospfAreaId, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3IpMgmt=swL3IpMgmt, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3Md5Table=swL3Md5Table, swL3RoutePreference=swL3RoutePreference, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3VrrpOperTable=swL3VrrpOperTable, swL3RouteRedistriType=swL3RouteRedistriType, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3Route6RedistriRowStatus=swL3Route6RedistriRowStatus, swL3OspfHostStatus=swL3OspfHostStatus, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3ospfIfDistributeListInType=swL3ospfIfDistributeListInType, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3ospfIfDistributeListInName=swL3ospfIfDistributeListInName, swL3RIPTimerMgmt=swL3RIPTimerMgmt, swL3Ipv6DHCPv6CPDAddrCtrlTable=swL3Ipv6DHCPv6CPDAddrCtrlTable, swL3Ipv6CtrlDadRetransNum=swL3Ipv6CtrlDadRetransNum, swL3Route6RedistriTable=swL3Route6RedistriTable, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3DevCtrl=swL3DevCtrl, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3RIPInboundRouteFilterName=swL3RIPInboundRouteFilterName, swL3IpStaticRouteTunnelEntry=swL3IpStaticRouteTunnelEntry, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3IpCtrlLocalProxyArp=swL3IpCtrlLocalProxyArp, swL3ospfIfEvents=swL3ospfIfEvents, swL3Md5KeyId=swL3Md5KeyId, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, VrId=VrId, swL3IpCtrlDhcpv6ClientPDPrefixLen=swL3IpCtrlDhcpv6ClientPDPrefixLen, swL3LoopBackIpCtrlAdminState=swL3LoopBackIpCtrlAdminState, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3RelayMgmt=swL3RelayMgmt, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3LoopBackIpv6CtrlIpv6PrefixLen=swL3LoopBackIpv6CtrlIpv6PrefixLen, swL3Md5Entry=swL3Md5Entry, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3ospfAreaType=swL3ospfAreaType, swL3OspfECMPState=swL3OspfECMPState, swL3VrrpOperState=swL3VrrpOperState, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3ospfIfTable=swL3ospfIfTable, swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3IpStaticRouteTunnelTable=swL3IpStaticRouteTunnelTable, swL3RIPTimeOutTime=swL3RIPTimeOutTime, swL3RIPInboundRouteFilterIfIpAddress=swL3RIPInboundRouteFilterIfIpAddress, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3OspfDefInfoOrigMetricType=swL3OspfDefInfoOrigMetricType, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3LoopBackIpCtrlIfIndex=swL3LoopBackIpCtrlIfIndex, swL3ospfIfEntry=swL3ospfIfEntry, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3OspfDefInfoOriginate=swL3OspfDefInfoOriginate, swL3IpStaticRouteTunnelRowStatus=swL3IpStaticRouteTunnelRowStatus, swL3RIPInboundRouteFilterType=swL3RIPInboundRouteFilterType, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3OspfHostMetric=swL3OspfHostMetric, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3LoopBackIpCtrlInterfaceName=swL3LoopBackIpCtrlInterfaceName, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3LoopBackIpv6CtrlEntry=swL3LoopBackIpv6CtrlEntry, swL3Route6RedistriMetric=swL3Route6RedistriMetric, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName, swL3RelayDnsState=swL3RelayDnsState, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3LoopBackIpv6CtrlInterfaceName=swL3LoopBackIpv6CtrlInterfaceName, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3Route6RedistriSrcProtocol=swL3Route6RedistriSrcProtocol, swL3LoopBackIpCtrlIpSubnetMask=swL3LoopBackIpCtrlIpSubnetMask, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3Route6RedistriType=swL3Route6RedistriType, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3ospfIfMetric=swL3ospfIfMetric, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3OspfDefInfoOrigMetric=swL3OspfDefInfoOrigMetric, swL3Ipv6DHCPv6CPDAddrCtrlEntry=swL3Ipv6DHCPv6CPDAddrCtrlEntry, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3OspfDefInfoOrigMgmt=swL3OspfDefInfoOrigMgmt, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3ospfIfState=swL3ospfIfState, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3RIPGarbageCollectionTime=swL3RIPGarbageCollectionTime, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3IpCtrlDhcpv6ClientRapidCommit=swL3IpCtrlDhcpv6ClientRapidCommit, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3Ipv6DHCPv6CPDAddrCtrlState=swL3Ipv6DHCPv6CPDAddrCtrlState, swL3LoopBackIpCtrlRowStatus=swL3LoopBackIpCtrlRowStatus, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3IpCtrlIpv4AdminState=swL3IpCtrlIpv4AdminState, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3IpCtrlDhcpv6ClientPdRapidCommit=swL3IpCtrlDhcpv6ClientPdRapidCommit, swL3LoopBackIpCtrlIpAddr=swL3LoopBackIpCtrlIpAddr, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3LoopBackIpCtrlEntry=swL3LoopBackIpCtrlEntry, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=swL3Ipv6DHCPv6CPDAddrCtrlPrefixName, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3Ipv6AddressCtrlAddressType=swL3Ipv6AddressCtrlAddressType, NetAddress=NetAddress, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3OspfHostTOS=swL3OspfHostTOS, swL3RIPUpdateTime=swL3RIPUpdateTime, swL3Md5Key=swL3Md5Key, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3IpCtrlIpDirectedBroadcastState=swL3IpCtrlIpDirectedBroadcastState, swL3LoopBackIpCtrlTable=swL3LoopBackIpCtrlTable, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3LoopBackIpv6CtrlRowStatus=swL3LoopBackIpv6CtrlRowStatus, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable)
mibBuilder.exportSymbols("DGS-3420-28PC-L3MGMT-MIB", swL3ospfIfType=swL3ospfIfType, swL3IpCtrlIpv6AutoConfigState=swL3IpCtrlIpv6AutoConfigState, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3MgmtMIB=swL3MgmtMIB, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3RoutePreferenceDefault=swL3RoutePreferenceDefault, swL3IpCtrlTable=swL3IpCtrlTable, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3ospfAreaTable=swL3ospfAreaTable, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3Route6RedistriEntry=swL3Route6RedistriEntry, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3RouteRedistriRouteMapName=swL3RouteRedistriRouteMapName, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, NodeAddress=NodeAddress, swL3IpStaticRouteTunnelInterfaceName=swL3IpStaticRouteTunnelInterfaceName, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3IpCtrlDhcpv6ClientPDPrefixName=swL3IpCtrlDhcpv6ClientPDPrefixName, swL3IpCtrlIpv6AutoConfigDefault=swL3IpCtrlIpv6AutoConfigDefault, swL3RIPInboundRouteFilterTable=swL3RIPInboundRouteFilterTable, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3IpCtrlMode=swL3IpCtrlMode)
