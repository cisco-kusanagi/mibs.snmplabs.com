...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:32:20 2019
...
MibIdentifier, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, TimeTicks, enterprises, iso, Bits, Integer32, Unsigned32, IpAddress, Counter32, ModuleIdentity, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "TimeTicks", "enterprises", "iso", "Bits", "Integer32", "Unsigned32", "IpAddress", "Counter32", "ModuleIdentity", "ObjectIdentity")
...
mibBuilder.exportSymbols("DKSF-201-9-X-X-1", npGsmTrap=npGsmTrap, npIrStatus=npIrStatus, npRelay=npRelay, npGsmStrength=npGsmStrength, npThermoTrapHigh=npThermoTrapHigh, npThermoTrapMemo=npThermoTrapMemo, netPing2PWR220SMSv3=netPing2PWR220SMSv3, npIoTrapPrefix=npIoTrapPrefix, npThermoValue=npThermoValue, npThermoTrapStatus=npThermoTrapStatus, npGsmTrapPrefix=npGsmTrapPrefix, npThermoTrapPrefix=npThermoTrapPrefix, npPwrResetsCounter=npPwrResetsCounter, npGsm=npGsm, npPwrEntry=npPwrEntry, npPwrRelayState=npPwrRelayState, npIoTrapLevelIn=npIoTrapLevelIn, npPwrRepeatingResetsCounter=npPwrRepeatingResetsCounter, npIoTrap=npIoTrap, npIoTable=npIoTable, npIoPulseCounter=npIoPulseCounter, npRelHumSensorValueH=npRelHumSensorValueH, npRelHumSensor=npRelHumSensor, npGsmInfo=npGsmInfo, npThermoHigh=npThermoHigh, npRelHumTraps=npRelHumTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npReboot=npReboot, npThermoTraps=npThermoTraps, npPwrMemo=npPwrMemo, npPwrStartReset=npPwrStartReset, npThermoSensorN=npThermoSensorN, npRelHumSensorStatusH=npRelHumSensorStatusH, npTrapInfo=npTrapInfo, npRelayStartReset=npRelayStartReset, npIoEntry=npIoEntry, npIoLineN=npIoLineN, npRelHumSensorStatus=npRelHumSensorStatus, npRelayState=npRelayState, npIoLevelOut=npIoLevelOut, npIoLevelIn=npIoLevelIn, npIoTraps=npIoTraps, npRelayFlip=npRelayFlip, npRelayMemo=npRelayMemo, npPwrManualMode=npPwrManualMode, npRelHumSensorValueT=npRelHumSensorValueT, npTrapEmailTo=npTrapEmailTo, npThermoStatus=npThermoStatus, PYSNMP_MODULE_ID=netPing2PWR220SMSv3, npPwrChannelN=npPwrChannelN, npPwrRelayFlip=npPwrRelayFlip, npPwrTable=npPwrTable, npThermoTable=npThermoTable, npRelHumTrapPrefix=npRelHumTrapPrefix, npIr=npIr, npThermoTrapValue=npThermoTrapValue, npGsmFailed=npGsmFailed, npIoTrapLineN=npIoTrapLineN, npIrPlayCmd=npIrPlayCmd, npPwr=npPwr, npRelHumTrap=npRelHumTrap, npIoSinglePulseStart=npIoSinglePulseStart, npThermoTrapLow=npThermoTrapLow, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npThermoTrap=npThermoTrap, lightcom=lightcom, npRelHumidity=npRelHumidity, npRelayTable=npRelayTable, npIoMemo=npIoMemo, npIoSinglePulseDuration=npIoSinglePulseDuration, npIrReset=npIrReset, npIo=npIo, npResetStack=npResetStack, npIrCtrl=npIrCtrl, npForcedReboot=npForcedReboot, npSoftReboot=npSoftReboot, npRelayEntry=npRelayEntry, npThermoLow=npThermoLow, npIoTrapMemo=npIoTrapMemo, npRelayN=npRelayN, npThermoTrapSensorN=npThermoTrapSensorN, npThermo=npThermo, npRelayMode=npRelayMode, npGsmRegistration=npGsmRegistration, npThermoMemo=npThermoMemo, npGsmTraps=npGsmTraps, npThermoEntry=npThermoEntry, npRelHumSensorValueT100=npRelHumSensorValueT100)
