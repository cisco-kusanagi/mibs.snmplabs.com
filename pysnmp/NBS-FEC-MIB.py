...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/NBS-FEC-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 20:07:23 2019
...
ModuleIdentity, Integer32, NotificationType, Gauge32, MibIdentifier, Bits, TimeTicks, Counter64, IpAddress, Unsigned32, Counter32, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Integer32", "NotificationType", "Gauge32", "MibIdentifier", "Bits", "TimeTicks", "Counter64", "IpAddress", "Unsigned32", "Counter32", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
class NbsFecCode(TextualConvention, Integer32):
    ...
    namedValues = NamedValues(("notSupported", 0), ("noFec", 1), ("zero", 2), ("gfec", 3), ("ufec7", 4), ("ufec10", 5), ("ufec25", 6), ("hgfec7", 7), ("sdfec0", 8), ("sdfec1", 9), ("sdfec2", 10), ("sdfec3", 11), ("strong1dot4", 12), ("strong1dot7", 13))
...
mibBuilder.exportSymbols("NBS-FEC-MIB", nbsFecCfgIfIndex=nbsFecCfgIfIndex, nbsFecCfgTable=nbsFecCfgTable, nbsFecCfgCodeCaps=nbsFecCfgCodeCaps, nbsFecCfgCodeAdmin=nbsFecCfgCodeAdmin, nbsFecMib=nbsFecMib, PYSNMP_MODULE_ID=nbsFecMib, nbsFecCfgCodeOper=nbsFecCfgCodeOper, NbsFecCode=NbsFecCode, nbsFecCfgGrp=nbsFecCfgGrp, nbsFecCfgEntry=nbsFecCfgEntry)
