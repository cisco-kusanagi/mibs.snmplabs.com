...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:29:01 2019
...
ModuleIdentity, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, IpAddress, NotificationType, Gauge32, Integer32, TimeTicks, MibIdentifier, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "IpAddress", "NotificationType", "Gauge32", "Integer32", "TimeTicks", "MibIdentifier", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("DGS-3420-52P-L2MGMT-MIB", swL2PortCtrlMediumType=swL2PortCtrlMediumType, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2TrunkMgmt=swL2TrunkMgmt, swL2VlanPortInfoTable=swL2VlanPortInfoTable, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2DevCtrlIpAutoconfig=swL2DevCtrlIpAutoconfig, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2VlanPortInfoPortRole=swL2VlanPortInfoPortRole, swL2NotifyPrefix=swL2NotifyPrefix, swL2DevCtrlAsymVlanState=swL2DevCtrlAsymVlanState, swL2MulticastFilterMode=swL2MulticastFilterMode, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2PortJumboFrameCtrlEntry=swL2PortJumboFrameCtrlEntry, swL2VLANAdvertisement=swL2VLANAdvertisement, swL2DevCtrlCFMMaMode=swL2DevCtrlCFMMaMode, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2MirrorGroupID=swL2MirrorGroupID, swL2TrunkVLANState=swL2TrunkVLANState, swL2PortInfoTable=swL2PortInfoTable, swL2MACNotifyState=swL2MACNotifyState, swL2DevCtrlCFMPortState=swL2DevCtrlCFMPortState, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2DevCtrlVLANTrunkState=swL2DevCtrlVLANTrunkState, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2TrunkMember=swL2TrunkMember, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2VlanIndex=swL2VlanIndex, swL2DevAlarm=swL2DevAlarm, swL2DevInfo=swL2DevInfo, swL2TrafficSegTable=swL2TrafficSegTable, swL2PortJumboFrameCtrlPortState=swL2PortJumboFrameCtrlPortState, MacAddress=MacAddress, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2MirrorGroupTable=swL2MirrorGroupTable, swL2DevCtrlCFMMepMode=swL2DevCtrlCFMMepMode, swL2MulticastFilterModeVlanEntry=swL2MulticastFilterModeVlanEntry, swL2MirrorGroupEntry=swL2MirrorGroupEntry, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2MirrorGroupRowStatus=swL2MirrorGroupRowStatus, swL2PortJumboFrameCtrlTable=swL2PortJumboFrameCtrlTable, swL2MulticastFilterVlanMode=swL2MulticastFilterVlanMode, swL2DevCtrlCFMPortIndex=swL2DevCtrlCFMPortIndex, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2macNotifyInfo=swL2macNotifyInfo, swL2TrunkIndex=swL2TrunkIndex, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2NotifyMgmt=swL2NotifyMgmt, swL2PVIDAutoAssignmentState=swL2PVIDAutoAssignmentState, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2PortInfoMediumType=swL2PortInfoMediumType, swL2NotifFirmware=swL2NotifFirmware, swL2PortInfoType=swL2PortInfoType, IANAifMauAutoNegCapBits=IANAifMauAutoNegCapBits, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2VlanPortInfoPortIndex=swL2VlanPortInfoPortIndex, swL2PortSecurityViolationSeverity=swL2PortSecurityViolationSeverity, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2TrunkVLANTable=swL2TrunkVLANTable, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2PortJumboFrameCtrlPortIndex=swL2PortJumboFrameCtrlPortIndex, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2DevCtrl=swL2DevCtrl, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2DevCtrlCFMMaTable=swL2DevCtrlCFMMaTable, swL2VLANMgmt=swL2VLANMgmt, swL2TrunkVLANEntry=swL2TrunkVLANEntry, swL2DevCtrlCFMMepTable=swL2DevCtrlCFMMepTable, swL2DevCtrlSnmpTrapState=swL2DevCtrlSnmpTrapState, swL2MirrorGroupState=swL2MirrorGroupState, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2PortMgmt=swL2PortMgmt, swL2PortCounterCtrlTable=swL2PortCounterCtrlTable, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2MgmtMIB=swL2MgmtMIB, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2PortCtrlJumboFrameMaxSize=swL2PortCtrlJumboFrameMaxSize, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2PortCounterClearCtrl=swL2PortCounterClearCtrl, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2MirrorMgmt=swL2MirrorMgmt, swL2macNotification=swL2macNotification, swL2DevCtrlCFMPortEntry=swL2DevCtrlCFMPortEntry, swL2VlanPortInfoVid=swL2VlanPortInfoVid, swL2DevMgmt=swL2DevMgmt, swL2MirrorPortState=swL2MirrorPortState, swL2TrafficSegPort=swL2TrafficSegPort, swL2PortInfoEntry=swL2PortInfoEntry, swL2DevCtrlCFM=swL2DevCtrlCFM, swL2TrunkType=swL2TrunkType, swL2MirrorGroupPortSourceIngress=swL2MirrorGroupPortSourceIngress, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2PortCounterCtrlEntry=swL2PortCounterCtrlEntry, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2PortInfoErrorDisabled=swL2PortInfoErrorDisabled, swL2NniGvrpBpduAddress=swL2NniGvrpBpduAddress, swL2Notify=swL2Notify, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2PortCtrlLearningState=swL2PortCtrlLearningState, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, VlanId=VlanId, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2DevCtrlCFMMepEntry=swL2DevCtrlCFMMepEntry, swL2DevCtrlCFMPortTable=swL2DevCtrlCFMPortTable, swL2VlanStaticTable=swL2VlanStaticTable, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2PortCtrlMDIXState=swL2PortCtrlMDIXState, swL2TrunkVLANPort=swL2TrunkVLANPort, swL2MulticastFilterModeVlanTable=swL2MulticastFilterModeVlanTable, swL2MirrorGroupPortSourceEngress=swL2MirrorGroupPortSourceEngress, swL2MirrorGroupLogicTargetPort=swL2MirrorGroupLogicTargetPort, swL2DevCtrlCFMState=swL2DevCtrlCFMState, swl2NotificationBidings=swl2NotificationBidings, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swL2VlanStaticEntry=swL2VlanStaticEntry, swL2VlanPortInfoEntry=swL2VlanPortInfoEntry, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2PortCounterCtrlPortIndex=swL2PortCounterCtrlPortIndex, swL2PortInfoUnitID=swL2PortInfoUnitID, swL2TrunkState=swL2TrunkState, swL2macNotificationSeverity=swL2macNotificationSeverity, swL2PortCtrlTable=swL2PortCtrlTable, PortList=PortList, swL2DevCtrlCFMMaEntry=swL2DevCtrlCFMMaEntry, swL2MulticastFilterVid=swL2MulticastFilterVid, swL2DevCtrlWebState=swL2DevCtrlWebState)
