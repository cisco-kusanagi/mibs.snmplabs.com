...
mibBuilder.exportSymbols("RBN-TC", RbnPort=RbnPort, RbnUnsigned64=RbnUnsigned64, RbnCircuitHandle=RbnCircuitHandle, rbnTC=rbnTC, RbnVidOrUntagged=RbnVidOrUntagged, RbnPercentage=RbnPercentage, RbnKBytes=RbnKBytes, RbnPortMediumType=RbnPortMediumType, RbnSlot=RbnSlot, PYSNMP_MODULE_ID=rbnTC)
