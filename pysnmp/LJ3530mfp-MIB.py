...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ3530mfp-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:11 2019
...
Counter64, Bits, MibIdentifier, iso, NotificationType, TimeTicks, IpAddress, Integer32, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "MibIdentifier", "iso", "NotificationType", "TimeTicks", "IpAddress", "Integer32", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "ObjectIdentity")
...
mibBuilder.exportSymbols("LJ3530mfp-MIB", error44_date_time=error44_date_time, media3=media3, simm1_bank1=simm1_bank1, media21_engine_media_mode=media21_engine_media_mode, job_info_accounting_job_type=job_info_accounting_job_type, media9_page_count=media9_page_count, media3_short_name=media3_short_name, media12_page_count=media12_page_count, error39_date_time=error39_date_time, media_modes=media_modes, background_message=background_message, error41=error41, collated_originals_support=collated_originals_support, settings_ph=settings_ph, settings_io=settings_io, job_info_attr_3=job_info_attr_3, media24_engine_media_mode=media24_engine_media_mode, error11_code=error11_code, error50=error50, error25=error25, scanned_media_usage=scanned_media_usage, printed_modes_accounting=printed_modes_accounting, printer_cal_dhalf_data1=printer_cal_dhalf_data1, media8_page_count=media8_page_count, media_size=media_size, error12=error12, error38_date_time=error38_date_time, marking_agent_density=marking_agent_density, print_engine=print_engine, error43=error43, printed_media_duplex_charge=printed_media_duplex_charge, default_scan_job_mode=default_scan_job_mode, simm1=simm1, media6_name=media6_name, daylight_savings_end=daylight_savings_end, error26_code=error26_code, pcl_total_page_count=pcl_total_page_count, media16_name=media16_name, simm2_bank2_type=simm2_bank2_type, error14_code=error14_code, marking_agent=marking_agent, error26_time_stamp=error26_time_stamp, mio1_type=mio1_type, media16=media16, faxjob_tx_count=faxjob_tx_count, error28_time_stamp=error28_time_stamp, media11_short_name=media11_short_name, media1_short_name=media1_short_name, auto_continue=auto_continue, error33_time_stamp=error33_time_stamp, hp=hp, job_info_attr_1=job_info_attr_1, error35_time_stamp=error35_time_stamp, file_system3=file_system3, usage_scanner_total_charge=usage_scanner_total_charge, media28=media28, error40_date_time=error40_date_time, job_info_attr_5=job_info_attr_5, settings_pdl=settings_pdl, consumable_status=consumable_status, engine_media_modes_supported1=engine_media_modes_supported1, media12=media12, media22_engine_media_mode=media22_engine_media_mode, upgradable_devices_write_time=upgradable_devices_write_time, media23_name=media23_name, error24_code=error24_code, device_location=device_location, media2_short_name=media2_short_name, media6_short_name=media6_short_name, daylight_savings_reset=daylight_savings_reset, mopy_mode=mopy_mode, job_info_accounting_color_usage_log=job_info_accounting_color_usage_log, media22_page_count=media22_page_count, itb_tensioning_status=itb_tensioning_status, media6_page_count=media6_page_count, error19=error19, media24=media24, supply_after_out_state=supply_after_out_state, scan_calibration_error=scan_calibration_error, held_job_control=held_job_control, error42_date_time=error42_date_time, error48_date_time=error48_date_time, media27=media27, error9_date_time=error9_date_time, printed_modes_color_count=printed_modes_color_count, background_status_msg_line4_part1=background_status_msg_line4_part1, printed_modes_usage_total=printed_modes_usage_total, copy_job_hold_off_print_jobs=copy_job_hold_off_print_jobs, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, simm2=simm2, error31_code=error31_code, media5_engine_media_mode=media5_engine_media_mode, remote_upgrade_version_checking_enable=remote_upgrade_version_checking_enable, error16_code=error16_code, error1_date_time=error1_date_time, error26_date_time=error26_date_time, error41_code=error41_code, error43_code=error43_code, default_scan_original_size=default_scan_original_size, default_staple_mode=default_staple_mode, job_info_attr_15=job_info_attr_15, media13=media13, overflow_bin=overflow_bin, media10_engine_media_mode=media10_engine_media_mode, media13_short_name=media13_short_name, error30_code=error30_code, error32_code=error32_code, error21_date_time=error21_date_time, media7_short_name=media7_short_name, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, error2_code=error2_code, usb_serial_number=usb_serial_number, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, sleep_mode=sleep_mode, error37=error37, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, printer_cal_dhalf_utc=printer_cal_dhalf_utc, error26=error26, scanner_accessory_digital_send_home_screen_status=scanner_accessory_digital_send_home_screen_status, settings_mass_storage_bd=settings_mass_storage_bd, simm1_bank2_capacity=simm1_bank2_capacity, file_system4_initialize_volume=file_system4_initialize_volume, error9_time_stamp=error9_time_stamp, faxjob_rx_status=faxjob_rx_status, media26_name=media26_name, consumable_status_tls_max_value=consumable_status_tls_max_value, upgradable_devices_version=upgradable_devices_version, status_scanner=status_scanner, intray2=intray2, media5_short_name=media5_short_name, localization_countries_supported=localization_countries_supported, held_job_retention=held_job_retention, error10_date_time=error10_date_time, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, job_info_attr_2=job_info_attr_2, firmware_download_write_time=firmware_download_write_time, media10_name=media10_name, mio4=mio4, consumable_life_usage_units=consumable_life_usage_units, simm2_bank1=simm2_bank1, duplex_page_count=duplex_page_count, usb_device_kind=usb_device_kind, usb_manufacturer_name=usb_manufacturer_name, pcl_default_font_width=pcl_default_font_width, media25=media25, error4_code=error4_code, default_copier_edge_to_edge=default_copier_edge_to_edge, job_info_state=job_info_state, channel_jobs_received=channel_jobs_received, maximum_ram_disk_memory=maximum_ram_disk_memory, resource_manager=resource_manager, error46_date_time=error46_date_time, job_info_attr_10=job_info_attr_10, usb_vendor_id=usb_vendor_id, consumable_current_state=consumable_current_state, default_scan_content_orientation=default_scan_content_orientation, webserver_proc_sub=webserver_proc_sub, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, color_supply_out_action=color_supply_out_action, default_copies=default_copies, job_input_auto_continue_mode=job_input_auto_continue_mode, error31=error31, pysmi_continue=pysmi_continue, ph=ph, scanner_accessory_digital_send_log_event_counter=scanner_accessory_digital_send_log_event_counter, media20_short_name=media20_short_name, media8_short_name=media8_short_name, printed_modes_total_count=printed_modes_total_count, default_custom_paper_dim_unit=default_custom_paper_dim_unit, custom_paper_xfeed_dim=custom_paper_xfeed_dim, total_kilo_pixels_per_cartridge=total_kilo_pixels_per_cartridge, simm2_bank1_type=simm2_bank1_type, error34=error34, default_scan_background_removal=default_scan_background_removal, error3=error3, error39_time_stamp=error39_time_stamp, status_rpc=status_rpc, error1=error1, control_panel_display_graphical_contents=control_panel_display_graphical_contents, dm=dm, error22=error22, channel_mio=channel_mio, simm1_type=simm1_type, custom_paper_feed_dim=custom_paper_feed_dim, model_name=model_name, mio1_manufacturing_info=mio1_manufacturing_info, error6=error6, job_info_accounting_scanned_media_simplex_count=job_info_accounting_scanned_media_simplex_count, error42_code=error42_code, printer_calibration_dhalf=printer_calibration_dhalf, error6_time_stamp=error6_time_stamp, media9_name=media9_name, error6_code=error6_code, media15_engine_media_mode=media15_engine_media_mode, media_info=media_info, error39=error39, job_info_attr_12=job_info_attr_12, default_scan_text_graphics_mix=default_scan_text_graphics_mix, media20_page_count=media20_page_count, default_copy_duplex_mode=default_copy_duplex_mode, upgradable_devices_current_state=upgradable_devices_current_state, job_input_auto_continue_timeout=job_input_auto_continue_timeout, settings_file_system=settings_file_system, error4_date_time=error4_date_time, default_lines_per_page=default_lines_per_page, default_copier_pages_per_sheet=default_copier_pages_per_sheet, media25_page_count=media25_page_count, clearable_warning=clearable_warning, error35=error35, marking_agent_midtones_density_setting=marking_agent_midtones_density_setting, error45_code=error45_code, media9_engine_media_mode=media9_engine_media_mode, web_server=web_server, not_ready_source_scanner=not_ready_source_scanner, held_job_job_name=held_job_job_name, media16_page_count=media16_page_count, error5_code=error5_code, error11=error11, simm2_bank2_capacity=simm2_bank2_capacity, error22_time_stamp=error22_time_stamp, error14_time_stamp=error14_time_stamp, postscript_defer_media=postscript_defer_media, media7_page_count=media7_page_count, error36_date_time=error36_date_time, media10=media10, media4_engine_media_mode=media4_engine_media_mode, daylight_savings_start=daylight_savings_start, default_media_name=default_media_name, cancel_job=cancel_job, supply_out_action_support=supply_out_action_support, media7_engine_media_mode=media7_engine_media_mode, error15_time_stamp=error15_time_stamp, error50_date_time=error50_date_time, reprint=reprint, job_output_auto_continue_timeout=job_output_auto_continue_timeout, printer_cal_cpr_data=printer_cal_cpr_data, consumables_status=consumables_status, error16=error16, error8=error8, media7_name=media7_name, supplies_replace_action_at_setting=supplies_replace_action_at_setting, error44_code=error44_code, error29_date_time=error29_date_time, error45_time_stamp=error45_time_stamp, held_job_user_name=held_job_user_name, job_info_name1=job_info_name1, job_info_size=job_info_size, error49=error49, usb_product_description=usb_product_description, media11_engine_media_mode=media11_engine_media_mode, scanner_accessory_digital_send_status=scanner_accessory_digital_send_status, media13_engine_media_mode=media13_engine_media_mode, error25_date_time=error25_date_time, control_panel_display=control_panel_display)
mibBuilder.exportSymbols("LJ3530mfp-MIB", time_display=time_display, interface=interface, media15=media15, perm_store_init_occurred=perm_store_init_occurred, copier=copier, hold_job_timeout=hold_job_timeout, usb_driver_name=usb_driver_name, status_prt_eng=status_prt_eng, job_info_attr_11=job_info_attr_11, settings_print_media=settings_print_media, fax_number_confirmation=fax_number_confirmation, media5=media5, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, control_panel_key_press=control_panel_key_press, media3_engine_media_mode=media3_engine_media_mode, first_copy_speed=first_copy_speed, error27_time_stamp=error27_time_stamp, scanner_accessory_copy_job_scan_count=scanner_accessory_copy_job_scan_count, print_internal_page=print_internal_page, engine_self_diagnostic=engine_self_diagnostic, energy_star=energy_star, channel_io_errors=channel_io_errors, error30=error30, media24_page_count=media24_page_count, control_panel_supplies_status_message=control_panel_supplies_status_message, tray1_phd=tray1_phd, simm1_bank1_type=simm1_bank1_type, faxjob=faxjob, asset_number=asset_number, ram_disk_mode=ram_disk_mode, error18_time_stamp=error18_time_stamp, printed_media_simplex_charge=printed_media_simplex_charge, scanner_accessory_digital_send_config_email_gateway=scanner_accessory_digital_send_config_email_gateway, error16_time_stamp=error16_time_stamp, default_copy_reset_timeout=default_copy_reset_timeout, date_display=date_display, install_date=install_date, error38=error38, media25_engine_media_mode=media25_engine_media_mode, error44_time_stamp=error44_time_stamp, ports=ports, default_copy_input_tray=default_copy_input_tray, job_info_physical_outbins_used=job_info_physical_outbins_used, settings_intray=settings_intray, error32=error32, error21=error21, error36_code=error36_code, job_info_pages_in_original=job_info_pages_in_original, media12_short_name=media12_short_name, source_subsystem=source_subsystem, pcl_default_font_source=pcl_default_font_source, upgradable_devices_name=upgradable_devices_name, error1_time_stamp=error1_time_stamp, held_job_enable=held_job_enable, media8_name=media8_name, control_panel_display_contents_crc=control_panel_display_contents_crc, background_status_msg_line2_part1=background_status_msg_line2_part1, background_status_msg_line1_part1=background_status_msg_line1_part1, source_tray_accounting=source_tray_accounting, held_job_quantity=held_job_quantity, media26=media26, error8_time_stamp=error8_time_stamp, settings_webserver=settings_webserver, pjl=pjl, media_counts=media_counts, usage_staple_count=usage_staple_count, tray_prompt=tray_prompt, error47=error47, printed_modes_mono_count=printed_modes_mono_count, north_edge_offset=north_edge_offset, media2_page_count=media2_page_count, media10_short_name=media10_short_name, background_status_msg_line3_part1=background_status_msg_line3_part1, processing_subsystem=processing_subsystem, job_info=job_info, scanned_media_duplex_charge=scanned_media_duplex_charge, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, error14_date_time=error14_date_time, firmware_download_write_status_supported=firmware_download_write_status_supported, default_copier_collate=default_copier_collate, error20_date_time=error20_date_time, copy_job_auto_interrupt=copy_job_auto_interrupt, media9_short_name=media9_short_name, tray3_phd=tray3_phd, error1_code=error1_code, media15_name=media15_name, held_job_info=held_job_info, default_copier_contrast=default_copier_contrast, error15_date_time=error15_date_time, tray_disable_use_instead=tray_disable_use_instead, file_system3_initialize_volume=file_system3_initialize_volume, default_scan_image_quality=default_scan_image_quality, error34_date_time=error34_date_time, media21_page_count=media21_page_count, consumable_life_low_threshold=consumable_life_low_threshold, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, settings_rpc=settings_rpc, consumable_string_information=consumable_string_information, mass_storage_resources=mass_storage_resources, error39_code=error39_code, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, error28=error28, host_application_available_memory=host_application_available_memory, default_scanner_speed=default_scanner_speed, media4=media4, port1=port1, error23_date_time=error23_date_time, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, error24_date_time=error24_date_time, job_info_page_count_current_original=job_info_page_count_current_original, pdl_pcl=pdl_pcl, color_copy_enabled=color_copy_enabled, error10_code=error10_code, error12_code=error12_code, tray1_media_size_loaded=tray1_media_size_loaded, error9_code=error9_code, media3_name=media3_name, media27_name=media27_name, error10=error10, job_info_printed_originals=job_info_printed_originals, io_switch=io_switch, job_info_accounting_finishing_options=job_info_accounting_finishing_options, copy_job_hold_time=copy_job_hold_time, non_assured_oht_page_count=non_assured_oht_page_count, error48_time_stamp=error48_time_stamp, printer_cal_customiq_factory_default=printer_cal_customiq_factory_default, channelifindex=channelifindex, default_audible_feedback=default_audible_feedback, firmware_download_name=firmware_download_name, error40_time_stamp=error40_time_stamp, error31_date_time=error31_date_time, job_info_attr_7=job_info_attr_7, error17_code=error17_code, error7_time_stamp=error7_time_stamp, media13_name=media13_name, error28_code=error28_code, io_timeout=io_timeout, error30_date_time=error30_date_time, media17=media17, model_number=model_number, serial_number=serial_number, media26_engine_media_mode=media26_engine_media_mode, consumable_notification_status=consumable_notification_status, error17_date_time=error17_date_time, cold_reset_media_size=cold_reset_media_size, channel_bytes_received=channel_bytes_received, job_info_attr_13=job_info_attr_13, printed_media_duplex_count=printed_media_duplex_count, error35_date_time=error35_date_time, error19_date_time=error19_date_time, direct_connect_ports_enable=direct_connect_ports_enable, autocleaning_page_frequency=autocleaning_page_frequency, media5_page_count=media5_page_count, media28_name=media28_name, held_job_pin=held_job_pin, error29_time_stamp=error29_time_stamp, job_info_pages_processed=job_info_pages_processed, channelprotocolversion=channelprotocolversion, media1=media1, error17=error17, scanner_accessory_digital_send_config_dsm_enabled_fax=scanner_accessory_digital_send_config_dsm_enabled_fax, web_server_security=web_server_security, media17_page_count=media17_page_count, media19_engine_media_mode=media19_engine_media_mode, afax_send_page_count=afax_send_page_count, error22_code=error22_code, media1_name=media1_name, scanner_accounting=scanner_accounting, usb_host_supported=usb_host_supported, outbins=outbins, marking_agent_shadows_density_setting=marking_agent_shadows_density_setting, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, settings_marking_agent=settings_marking_agent, supply_override_activated_pagecount=supply_override_activated_pagecount, job_info_outbins_used=job_info_outbins_used, engine_parameter=engine_parameter, usb=usb, daylight_savings_offset=daylight_savings_offset, error32_date_time=error32_date_time, error32_time_stamp=error32_time_stamp, job_info_accounting=job_info_accounting, error5=error5, media14_name=media14_name, media27_engine_media_mode=media27_engine_media_mode, background_message1=background_message1, media18_page_count=media18_page_count, simm2_type=simm2_type, error34_code=error34_code, usage_instructions_line3=usage_instructions_line3, default_vmi=default_vmi, override_media_size=override_media_size, source_tray_usage=source_tray_usage, postscript_total_page_count=postscript_total_page_count, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, error_log_clear=error_log_clear, job_info_attr_4=job_info_attr_4, default_authentication_timeout=default_authentication_timeout, error18_date_time=error18_date_time, error46_code=error46_code, service_id=service_id, media4_page_count=media4_page_count, printer_accounting=printer_accounting, media17_engine_media_mode=media17_engine_media_mode, localization_languages_supported=localization_languages_supported, scanner_accessory_adf_two_sided_sheet_count=scanner_accessory_adf_two_sided_sheet_count, scan_calibration_download=scan_calibration_download, tray2_media_size_loaded=tray2_media_size_loaded, error43_time_stamp=error43_time_stamp, error44=error44, job_info_accounting_media_size=job_info_accounting_media_size, error2=error2, input_tray_auto_select=input_tray_auto_select, imaging=imaging, error18_code=error18_code, media26_page_count=media26_page_count, configurable_low_threshold_setting=configurable_low_threshold_setting, error8_code=error8_code, media23_page_count=media23_page_count, mio4_type=mio4_type, device_used_while_cartridge_out_override_active=device_used_while_cartridge_out_override_active, error40_code=error40_code, source_tray_usage_total=source_tray_usage_total, operating_system=operating_system, consumable_status_toner_low_sensing_level=consumable_status_toner_low_sensing_level, error7_code=error7_code, media20_name=media20_name, media25_short_name=media25_short_name, error45=error45, ram_disk_size=ram_disk_size, media20=media20, media2_name=media2_name, error15=error15, file_systems=file_systems, marker_density_calibration=marker_density_calibration, consumable_reorder_url=consumable_reorder_url, media9=media9, error13_date_time=error13_date_time, media16_short_name=media16_short_name, media10_page_count=media10_page_count, override_a4_with_letter=override_a4_with_letter, error2_date_time=error2_date_time, simm2_bank=simm2_bank, mass_storage_block_driver=mass_storage_block_driver, firmware_download=firmware_download, autocleaning_page_size=autocleaning_page_size, error41_date_time=error41_date_time, port1_parallel_bidirectionality=port1_parallel_bidirectionality, job_info_attr_8=job_info_attr_8, printed_media_color_total_count=printed_media_color_total_count, error12_date_time=error12_date_time, consumable_status_web_service_access_control=consumable_status_web_service_access_control, error23_time_stamp=error23_time_stamp, simm2_capacity=simm2_capacity, media_size_count=media_size_count)
mibBuilder.exportSymbols("LJ3530mfp-MIB", scan_to_folder_count=scan_to_folder_count, mio1_model_name=mio1_model_name, tray3_media_size_loaded=tray3_media_size_loaded, background_status_msg_higher_priority=background_status_msg_higher_priority, job_info_attr_9=job_info_attr_9, consumable_status_partnumber=consumable_status_partnumber, media26_short_name=media26_short_name, active_print_jobs=active_print_jobs, channelstate=channelstate, default_copy_job_chromaticity=default_copy_job_chromaticity, scanner_accessory_adf_one_sided_sheet_count=scanner_accessory_adf_one_sided_sheet_count, faxjob_rx_count=faxjob_rx_count, error18=error18, media17_name=media17_name, error27=error27, media19_short_name=media19_short_name, settings_fax_proc_sub=settings_fax_proc_sub, display=display, error14=error14, file_system2=file_system2, media2=media2, media6_engine_media_mode=media6_engine_media_mode, supply_out_user_configured_override_limit=supply_out_user_configured_override_limit, simm1_bank=simm1_bank, simm2_bank2=simm2_bank2, error23_code=error23_code, automatic_daylight_savings=automatic_daylight_savings, error50_time_stamp=error50_time_stamp, job_info_change_id=job_info_change_id, held_job_set_queue_size=held_job_set_queue_size, scanner_accessory_digital_send_config_ldap_gateway=scanner_accessory_digital_send_config_ldap_gateway, usage_instructions_line4=usage_instructions_line4, held_job_security=held_job_security, tray2_phd=tray2_phd, channeltype=channeltype, printed_media_color_duplex_count=printed_media_color_duplex_count, media4_short_name=media4_short_name, media14_engine_media_mode=media14_engine_media_mode, error49_code=error49_code, spooler=spooler, rpc_bound_protocol_address=rpc_bound_protocol_address, held_job=held_job, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, formatter_serial_number=formatter_serial_number, error43_date_time=error43_date_time, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, media19_name=media19_name, source_tray_usage_count=source_tray_usage_count, device_system=device_system, error7_date_time=error7_date_time, default_custom_paper_feed_dim=default_custom_paper_feed_dim, error7=error7, mio=mio, error35_code=error35_code, ews_request_control_panel_supplies_status=ews_request_control_panel_supplies_status, job_being_parsed=job_being_parsed, error8_date_time=error8_date_time, default_vertical_black_resolution=default_vertical_black_resolution, error4_time_stamp=error4_time_stamp, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, error46_time_stamp=error46_time_stamp, job_info_stage=job_info_stage, channelstatus=channelstatus, error30_time_stamp=error30_time_stamp, error25_time_stamp=error25_time_stamp, status_system=status_system, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, accounting=accounting, channelprinteralert=channelprinteralert, upgradeable_devices_generic_name=upgradeable_devices_generic_name, mass_storage_resource_change_counter=mass_storage_resource_change_counter, intray1=intray1, copy_job_scan_ahead=copy_job_scan_ahead, default_horizontal_black_resolution=default_horizontal_black_resolution, media_number_of_type_supported=media_number_of_type_supported, status_mass_storage_bd=status_mass_storage_bd, pdl_postscript=pdl_postscript, media16_engine_media_mode=media16_engine_media_mode, usb_interface=usb_interface, printed_modes_usage=printed_modes_usage, media6=media6, rtc_time_zone=rtc_time_zone, outbin1_override_mode=outbin1_override_mode, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, media11_name=media11_name, pdl=pdl, error28_date_time=error28_date_time, deviceChannelEntry=deviceChannelEntry, error20=error20, media21=media21, error38_code=error38_code, media17_short_name=media17_short_name, printed_media_color_usage=printed_media_color_usage, simm1_capacity=simm1_capacity, error41_time_stamp=error41_time_stamp, media13_page_count=media13_page_count, id=id, error11_date_time=error11_date_time, media28_engine_media_mode=media28_engine_media_mode, error2_time_stamp=error2_time_stamp, status_pdl=status_pdl, file_system_max_open_files=file_system_max_open_files, error29=error29, mono_color_switching_mode=mono_color_switching_mode, error23=error23, error38_time_stamp=error38_time_stamp, job_info_name2=job_info_name2, job_info_accounting_black_dots=job_info_accounting_black_dots, error9=error9, error42_time_stamp=error42_time_stamp, media3_page_count=media3_page_count, background_message2=background_message2, file_system=file_system, error10_time_stamp=error10_time_stamp, media20_engine_media_mode=media20_engine_media_mode, default_reset_send_timeout=default_reset_send_timeout, device_configure_printer_parameters=device_configure_printer_parameters, default_copier_image_type=default_copier_image_type, media1_engine_media_mode=media1_engine_media_mode, error5_date_time=error5_date_time, error36=error36, printer_color_accounting=printer_color_accounting, error21_time_stamp=error21_time_stamp, auto_send_reset=auto_send_reset, scanner=scanner, error45_date_time=error45_date_time, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, error37_date_time=error37_date_time, afax_recv_page_count=afax_recv_page_count, error3_code=error3_code, control_panel_button_press=control_panel_button_press, media24_short_name=media24_short_name, media1_page_count=media1_page_count, errorlog=errorlog, copier_media_type=copier_media_type, simm=simm, channel_bytes_sent=channel_bytes_sent, device=device, postscript_print_errors=postscript_print_errors, cartridge_adaptive_gain=cartridge_adaptive_gain, error33_code=error33_code, held_job_delete=held_job_delete, settings_spooler=settings_spooler, usage_printer_mono_total_charge=usage_printer_mono_total_charge, scanner_accessory_adf_sheet_count=scanner_accessory_adf_sheet_count, media8=media8, intray=intray, default_copier_quantity=default_copier_quantity, tables=tables, on_off_line=on_off_line, settings_scanner=settings_scanner, scanner_accessory_digital_send_module_url=scanner_accessory_digital_send_module_url, media21_short_name=media21_short_name, media5_name=media5_name, printer_average=printer_average, error27_code=error27_code, error49_date_time=error49_date_time, error15_code=error15_code, error36_time_stamp=error36_time_stamp, file_system_delete_files=file_system_delete_files, pcl_default_font_number=pcl_default_font_number, error47_date_time=error47_date_time, supply_override_activated_level=supply_override_activated_level, print_engine_revision=print_engine_revision, web_server_url=web_server_url, channelnumberofchannels=channelnumberofchannels, io=io, error11_time_stamp=error11_time_stamp, status_fax_proc_sub=status_fax_proc_sub, job_info_attr_16=job_info_attr_16, media11=media11, scanned_media_total_charge=scanned_media_total_charge, error19_code=error19_code, error5_time_stamp=error5_time_stamp, error49_time_stamp=error49_time_stamp, job_info_attribute=job_info_attribute, job=job, printed_media_color_dimplex_count=printed_media_color_dimplex_count, channelinformation=channelinformation, media18_engine_media_mode=media18_engine_media_mode, scanner_accessory_total_copy_pages_printed=scanner_accessory_total_copy_pages_printed, error24=error24, media19=media19, finisher_image_rotation=finisher_image_rotation, error46=error46, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, media11_page_count=media11_page_count, override_media_name=override_media_name, job_info_attr_14=job_info_attr_14, media28_short_name=media28_short_name, total_color_page_count=total_color_page_count, file_system2_initialize_volume=file_system2_initialize_volume, mass_storage_resource_changed=mass_storage_resource_changed, test=test, destination_bin_usage=destination_bin_usage, media23_short_name=media23_short_name, mio1=mio1, error13_code=error13_code, remote_upgrade_enable=remote_upgrade_enable, fax_proc_sub=fax_proc_sub, media12_name=media12_name, default_media_size=default_media_size, printer_cal_dhalf_data=printer_cal_dhalf_data, channel=channel, simm1_bank1_capacity=simm1_bank1_capacity, remote_procedure_call=remote_procedure_call, device_configure=device_configure, error27_date_time=error27_date_time, media25_name=media25_name, error22_date_time=error22_date_time, consumables=consumables, error13=error13, media8_engine_media_mode=media8_engine_media_mode, scanner_accessory_flatbed_scan_count=scanner_accessory_flatbed_scan_count, media18_short_name=media18_short_name, printer_cal_cpr_page_count=printer_cal_cpr_page_count, port1_parallel_speed=port1_parallel_speed, consumable_pages_printed_with_supply=consumable_pages_printed_with_supply, settings_web_server=settings_web_server, error47_time_stamp=error47_time_stamp, error29_code=error29_code, display_status=display_status, media14=media14, upgradable_devices=upgradable_devices, error37_time_stamp=error37_time_stamp, background_message4=background_message4, supply_override_activated_date=supply_override_activated_date, job_info_accounting_scanned_media_duplex_count=job_info_accounting_scanned_media_duplex_count, destination_bin_usage_count=destination_bin_usage_count, error34_time_stamp=error34_time_stamp, media_types=media_types, media23_engine_media_mode=media23_engine_media_mode, firmware_download_version=firmware_download_version, error33_date_time=error33_date_time, ship_cartridge_installed_in_printer=ship_cartridge_installed_in_printer, copy_job_interrupt_copy_jobs=copy_job_interrupt_copy_jobs, copy_job_alternative_letterhead_mode=copy_job_alternative_letterhead_mode, media15_page_count=media15_page_count, settings_copier=settings_copier, printed_media_dimplex_count=printed_media_dimplex_count, media14_short_name=media14_short_name, deviceChannelTable=deviceChannelTable, fax_job_scan_count=fax_job_scan_count, destination_subsystem=destination_subsystem, mio4_model_name=mio4_model_name, current_job_parsing_id=current_job_parsing_id, job_info_io_source=job_info_io_source, menus=menus, error21_code=error21_code, error12_time_stamp=error12_time_stamp, printer_cal_dhalf_page_count=printer_cal_dhalf_page_count, default_mfp_color_space=default_mfp_color_space, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, date_and_time=date_and_time)
mibBuilder.exportSymbols("LJ3530mfp-MIB", firmware_download_current_state=firmware_download_current_state, printer_cal_dhalf_data2=printer_cal_dhalf_data2, scanner_accessory_digital_send_config_fax_embedded=scanner_accessory_digital_send_config_fax_embedded, consumable_status_printer_design_compatibility=consumable_status_printer_design_compatibility, media28_page_count=media28_page_count, media2_engine_media_mode=media2_engine_media_mode, media21_name=media21_name, job_info_outcome=job_info_outcome, media_names_available=media_names_available, error25_code=error25_code, job_info_pages_printed=job_info_pages_printed, faxjob_tx_status=faxjob_tx_status, media18=media18, scanned_media_duplex_count=scanned_media_duplex_count, supply_out_user_configured_override2_limit=supply_out_user_configured_override2_limit, consumable_status_web_service_access_data=consumable_status_web_service_access_data, error37_code=error37_code, usage_printer_color_total_charge=usage_printer_color_total_charge, destination_bin_accounting=destination_bin_accounting, os_execute_file=os_execute_file, error16_date_time=error16_date_time, media22_name=media22_name, media24_name=media24_name, cartridge_out_override_control=cartridge_out_override_control, settings_prt_eng=settings_prt_eng, show_address=show_address, error6_date_time=error6_date_time, consumables_life=consumables_life, scanned_media_simplex_count=scanned_media_simplex_count, printed_media_simplex_count=printed_media_simplex_count, consumable_string=consumable_string, held_job_print=held_job_print, duplex_blank_pages=duplex_blank_pages, error3_date_time=error3_date_time, error48=error48, intray3=intray3, printed_media_combined_total=printed_media_combined_total, file_system4=file_system4, marking_agent_highlights_density_setting=marking_agent_highlights_density_setting, media15_short_name=media15_short_name, default_copier_page_borders=default_copier_page_borders, error47_code=error47_code, intrays=intrays, scanned_media_simplex_charge=scanned_media_simplex_charge, scanner_accessory_send_job_scan_count=scanner_accessory_send_job_scan_count, settings_job=settings_job, outbin1=outbin1, media19_page_count=media19_page_count, supply_out_device_state=supply_out_device_state, form_feed=form_feed, print_media=print_media, settings_outbin=settings_outbin, media22_short_name=media22_short_name, cartridge_adaptive_gain_reset=cartridge_adaptive_gain_reset, fw_rom_datecode=fw_rom_datecode, media23=media23, scan_sharpening_coefficient=scan_sharpening_coefficient, default_copier_media_size=default_copier_media_size, job_info_requested_originals=job_info_requested_originals, error48_code=error48_code, error33=error33, error17_time_stamp=error17_time_stamp, default_copy_output_bin=default_copy_output_bin, simm1_bank2_type=simm1_bank2_type, media27_short_name=media27_short_name, channelEntry=channelEntry, channelTable=channelTable, media7=media7, media12_engine_media_mode=media12_engine_media_mode, error4=error4, outbin=outbin, error3_time_stamp=error3_time_stamp, fax_job_control=fax_job_control, printer_calibration_cpr=printer_calibration_cpr, fw_rom_revision=fw_rom_revision, media22=media22, error42=error42, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, printed_media_usage=printed_media_usage, media18_name=media18_name, pcl_default_font_height=pcl_default_font_height, usage_instructions_line2=usage_instructions_line2, error20_time_stamp=error20_time_stamp, error19_time_stamp=error19_time_stamp, error20_code=error20_code, device_name=device_name, print_meter=print_meter, simm2_bank1_capacity=simm2_bank1_capacity, media27_page_count=media27_page_count, usb_product_id=usb_product_id, background_message3=background_message3, error24_time_stamp=error24_time_stamp, settings_system=settings_system, destination_bin_usage_total=destination_bin_usage_total, mio4_manufacturing_info=mio4_manufacturing_info, simm1_bank2=simm1_bank2, DisplayString=DisplayString, printed_media_total_charge=printed_media_total_charge, error13_time_stamp=error13_time_stamp, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, job_info_accounting_media_type=job_info_accounting_media_type, media14_page_count=media14_page_count, consumables_1=consumables_1, error31_time_stamp=error31_time_stamp, default_copier_flip_pages_up=default_copier_flip_pages_up, rpc_bind_protocol_address=rpc_bind_protocol_address, media4_name=media4_name, printer_cal_cpr_utc=printer_cal_cpr_utc, usage_printer_total_charge=usage_printer_total_charge, printed_media_color_simplex_count=printed_media_color_simplex_count, usage_instructions_line1=usage_instructions_line1, job_info_attr_6=job_info_attr_6, consumable_string_information_reset=consumable_string_information_reset, error40=error40, page_frame_memory_available=page_frame_memory_available, error50_code=error50_code, form_feed_needed=form_feed_needed)
