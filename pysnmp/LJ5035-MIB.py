...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ5035-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:24 2019
...
Counter32, MibIdentifier, Unsigned32, IpAddress, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, NotificationType, iso, Integer32, Gauge32, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "Unsigned32", "IpAddress", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "NotificationType", "iso", "Integer32", "Gauge32", "Counter64", "ModuleIdentity")
...
mibBuilder.exportSymbols("LJ5035-MIB", media12_page_count=media12_page_count, error3_time_stamp=error3_time_stamp, error12_time_stamp=error12_time_stamp, media26_short_name=media26_short_name, scanner_accessory_flatbed_scan_count=scanner_accessory_flatbed_scan_count, first_copy_speed=first_copy_speed, simm1=simm1, job_info_attr_3=job_info_attr_3, status_system=status_system, error33_date_time=error33_date_time, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, error25_time_stamp=error25_time_stamp, media4_short_name=media4_short_name, not_ready_source_scanner=not_ready_source_scanner, tray_prompt=tray_prompt, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, default_copy_reset_timeout=default_copy_reset_timeout, print_engine_revision=print_engine_revision, error45=error45, default_scan_image_quality=default_scan_image_quality, status_scanner=status_scanner, simm2_bank2_capacity=simm2_bank2_capacity, error47=error47, error24=error24, maximum_ram_disk_memory=maximum_ram_disk_memory, error48_code=error48_code, media8_short_name=media8_short_name, device_name=device_name, default_scan_text_graphics_mix=default_scan_text_graphics_mix, error26_date_time=error26_date_time, scan_calibration_error=scan_calibration_error, tray2_media_size_loaded=tray2_media_size_loaded, job_info_accounting_media_type=job_info_accounting_media_type, error31_code=error31_code, intrays=intrays, default_mfp_color_space=default_mfp_color_space, usage_instructions_line3=usage_instructions_line3, error44_date_time=error44_date_time, error9=error9, media26_name=media26_name, background_status_msg_line1_part1=background_status_msg_line1_part1, job=job, media6_short_name=media6_short_name, media22_name=media22_name, faxjob_rx_status=faxjob_rx_status, media23_engine_media_mode=media23_engine_media_mode, error47_time_stamp=error47_time_stamp, error43_date_time=error43_date_time, error7=error7, usage_instructions_line4=usage_instructions_line4, pdl_pcl=pdl_pcl, media10_page_count=media10_page_count, remote_upgrade_enable=remote_upgrade_enable, error36_time_stamp=error36_time_stamp, error4_code=error4_code, media4_page_count=media4_page_count, job_info_requested_originals=job_info_requested_originals, marking_agent_highlights_density_setting=marking_agent_highlights_density_setting, error2=error2, media12_engine_media_mode=media12_engine_media_mode, afax_recv_page_count=afax_recv_page_count, file_system4=file_system4, intray3=intray3, copy_job_interrupt_copy_jobs=copy_job_interrupt_copy_jobs, job_info_pages_in_original=job_info_pages_in_original, error32_time_stamp=error32_time_stamp, settings_prt_eng=settings_prt_eng, media_size_count=media_size_count, default_copy_input_tray=default_copy_input_tray, settings_io=settings_io, scanner=scanner, file_systems=file_systems, scanner_accessory_digital_send_module_url=scanner_accessory_digital_send_module_url, usb_manufacturer_name=usb_manufacturer_name, pdl_postscript=pdl_postscript, error6_date_time=error6_date_time, copy_job_alternative_letterhead_mode=copy_job_alternative_letterhead_mode, status_prt_eng=status_prt_eng, scan_sharpening_coefficient=scan_sharpening_coefficient, intray6=intray6, media8_engine_media_mode=media8_engine_media_mode, outbin2_error_info=outbin2_error_info, consumable_string_information_reset=consumable_string_information_reset, error18_date_time=error18_date_time, hp=hp, consumable_maintenance_interval=consumable_maintenance_interval, direct_connect_ports_enable=direct_connect_ports_enable, default_scan_content_orientation=default_scan_content_orientation, error23=error23, ram_disk_mode=ram_disk_mode, intray5=intray5, sleep_mode=sleep_mode, firmware_download_current_state=firmware_download_current_state, settings_scanner=settings_scanner, media23_page_count=media23_page_count, printed_media_usage=printed_media_usage, error37=error37, error22_code=error22_code, file_system2=file_system2, printed_modes_total_count=printed_modes_total_count, error34_time_stamp=error34_time_stamp, reprint=reprint, faxjob_tx_count=faxjob_tx_count, error45_code=error45_code, job_info_attr_7=job_info_attr_7, default_ret=default_ret, error24_time_stamp=error24_time_stamp, error12=error12, control_panel_display_graphical_contents=control_panel_display_graphical_contents, on_off_line=on_off_line, serial_number=serial_number, media21=media21, pcl_total_page_count=pcl_total_page_count, error2_time_stamp=error2_time_stamp, job_info_attr_6=job_info_attr_6, firmware_download_write_status_supported=firmware_download_write_status_supported, error21_code=error21_code, error45_time_stamp=error45_time_stamp, media_types=media_types, error38_code=error38_code, file_system4_initialize_volume=file_system4_initialize_volume, mio1_type=mio1_type, error33_code=error33_code, job_info_outbins_used=job_info_outbins_used, media20=media20, job_info_printed_originals=job_info_printed_originals, background_message3=background_message3, media4_name=media4_name, media_names_available=media_names_available, simm1_bank2=simm1_bank2, media19_page_count=media19_page_count, held_job_security=held_job_security, supplies_replace_action_at_setting=supplies_replace_action_at_setting, error23_code=error23_code, held_job_quantity=held_job_quantity, error11_date_time=error11_date_time, source_tray_usage_count=source_tray_usage_count, error32_date_time=error32_date_time, job_info_outcome=job_info_outcome, media15_engine_media_mode=media15_engine_media_mode, error14_code=error14_code, error41_time_stamp=error41_time_stamp, media17=media17, perm_store_init_occurred=perm_store_init_occurred, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, marking_agent_density_setting=marking_agent_density_setting, error46=error46, settings_rpc=settings_rpc, media6_page_count=media6_page_count, error44=error44, phd=phd, job_info_accounting_black_dots=job_info_accounting_black_dots, error1_time_stamp=error1_time_stamp, settings_pdl=settings_pdl, netPMLmgmt=netPMLmgmt, simm2_capacity=simm2_capacity, error41_code=error41_code, default_copier_flip_pages_up=default_copier_flip_pages_up, file_system3_initialize_volume=file_system3_initialize_volume, media15_short_name=media15_short_name, job_info=job_info, marking_agent_midtones_density_setting=marking_agent_midtones_density_setting, settings_outbin=settings_outbin, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, error31_date_time=error31_date_time, media5_page_count=media5_page_count, duplex_page_count=duplex_page_count, error42_date_time=error42_date_time, media12_short_name=media12_short_name, error12_date_time=error12_date_time, error10_time_stamp=error10_time_stamp, media18_page_count=media18_page_count, media7_page_count=media7_page_count, error27_date_time=error27_date_time, status_pdl=status_pdl, tray_disable_use_instead=tray_disable_use_instead, job_info_attr_15=job_info_attr_15, error4_date_time=error4_date_time, error28_date_time=error28_date_time, job_info_pages_printed=job_info_pages_printed, error32_code=error32_code, default_copier_collate=default_copier_collate, media21_page_count=media21_page_count, error5_date_time=error5_date_time, job_info_attribute=job_info_attribute, error17_date_time=error17_date_time, error3_code=error3_code, faxjob_tx_status=faxjob_tx_status, job_info_accounting_media_size=job_info_accounting_media_size, media23=media23, simm1_bank1_type=simm1_bank1_type, error17=error17, background_status_msg_line2_part1=background_status_msg_line2_part1, printer_accounting=printer_accounting, form_feed=form_feed, media18_engine_media_mode=media18_engine_media_mode, error8_code=error8_code, tray1_media_size_loaded=tray1_media_size_loaded, error17_code=error17_code, default_copy_output_bin=default_copy_output_bin, held_job_enable=held_job_enable, scanner_accessory_send_job_scan_count=scanner_accessory_send_job_scan_count, error25=error25, error7_time_stamp=error7_time_stamp, error39_date_time=error39_date_time, error41=error41, error16_code=error16_code, fax_proc_sub=fax_proc_sub, media_counts=media_counts, ram_disk_size=ram_disk_size, media16_engine_media_mode=media16_engine_media_mode, default_bits_per_pixel=default_bits_per_pixel, simm1_bank1_capacity=simm1_bank1_capacity, error29_date_time=error29_date_time, default_scan_original_size=default_scan_original_size, job_info_attr_13=job_info_attr_13, usage_printer_total_charge=usage_printer_total_charge, media25_short_name=media25_short_name, error14=error14, scanner_accessory_adf_two_sided_sheet_count=scanner_accessory_adf_two_sided_sheet_count, device_location=device_location, consumables=consumables, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, file_system_delete_files=file_system_delete_files, intray7=intray7, error37_time_stamp=error37_time_stamp, default_media_size=default_media_size, mopy_mode=mopy_mode, background_message=background_message, error35_time_stamp=error35_time_stamp, error39_code=error39_code, printed_media_combined_total=printed_media_combined_total, error46_code=error46_code, media11_name=media11_name, outbin2_phd=outbin2_phd, error49=error49, media25_name=media25_name, media13_name=media13_name, usb_host_supported=usb_host_supported, install_date=install_date, media18_name=media18_name, processing_subsystem=processing_subsystem, fax_job_scan_count=fax_job_scan_count, error33=error33, tray7_media_size_loaded=tray7_media_size_loaded, tray6_phd=tray6_phd, job_info_accounting_scanned_media_duplex_count=job_info_accounting_scanned_media_duplex_count, file_system=file_system, tray2_phd=tray2_phd, default_authentication_timeout=default_authentication_timeout, error18_time_stamp=error18_time_stamp, io_timeout=io_timeout, settings_job=settings_job, error6_code=error6_code)
mibBuilder.exportSymbols("LJ5035-MIB", media26_engine_media_mode=media26_engine_media_mode, media13_short_name=media13_short_name, error34=error34, error9_code=error9_code, media23_short_name=media23_short_name, error36=error36, settings_system=settings_system, pjl=pjl, port1=port1, marker_density_calibration=marker_density_calibration, device_system=device_system, job_info_attr_11=job_info_attr_11, printer_cal_cpr_data=printer_cal_cpr_data, usage_staple_count=usage_staple_count, error26_code=error26_code, control_panel_display=control_panel_display, job_info_accounting=job_info_accounting, media5_name=media5_name, media22_engine_media_mode=media22_engine_media_mode, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, usb_driver_name=usb_driver_name, settings_mass_storage_bd=settings_mass_storage_bd, job_info_attr_5=job_info_attr_5, fw_rom_revision=fw_rom_revision, default_page_protect=default_page_protect, simm1_type=simm1_type, postscript_total_page_count=postscript_total_page_count, media11_engine_media_mode=media11_engine_media_mode, error40_time_stamp=error40_time_stamp, media9_engine_media_mode=media9_engine_media_mode, media25_engine_media_mode=media25_engine_media_mode, error38=error38, error48_date_time=error48_date_time, cartridge_out_override_control=cartridge_out_override_control, port1_parallel_speed=port1_parallel_speed, default_copier_media_size=default_copier_media_size, simm2_bank1=simm2_bank1, outbin1=outbin1, upgradable_devices_name=upgradable_devices_name, simm=simm, phd2_model=phd2_model, scanned_media_total_charge=scanned_media_total_charge, error11=error11, postscript_defer_media=postscript_defer_media, outbin1_error_info=outbin1_error_info, job_info_attr_2=job_info_attr_2, default_vertical_black_resolution=default_vertical_black_resolution, cancel_job=cancel_job, error12_code=error12_code, error50_time_stamp=error50_time_stamp, phd2=phd2, background_message1=background_message1, usb=usb, media4_engine_media_mode=media4_engine_media_mode, printer_cal_dhalf_page_count=printer_cal_dhalf_page_count, outbins=outbins, simm2_type=simm2_type, job_info_attr_8=job_info_attr_8, file_system2_initialize_volume=file_system2_initialize_volume, supply_out_action_support=supply_out_action_support, printer_average_marking_agent_coverage_sum_squared=printer_average_marking_agent_coverage_sum_squared, media1_engine_media_mode=media1_engine_media_mode, default_scan_job_mode=default_scan_job_mode, usage_instructions_line1=usage_instructions_line1, error21_time_stamp=error21_time_stamp, settings_print_media=settings_print_media, mio4_model_name=mio4_model_name, model_number=model_number, destination_subsystem=destination_subsystem, scanned_media_duplex_count=scanned_media_duplex_count, media14_page_count=media14_page_count, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, error28=error28, rpc_bound_protocol_address=rpc_bound_protocol_address, media_modes=media_modes, media16_short_name=media16_short_name, job_info_stage=job_info_stage, engine_media_modes_supported1=engine_media_modes_supported1, date_display=date_display, settings_marking_agent=settings_marking_agent, override_media_name=override_media_name, cold_reset_media_size=cold_reset_media_size, device=device, outbin2=outbin2, model_name=model_name, copier_media_type=copier_media_type, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, tray5_media_size_loaded=tray5_media_size_loaded, error34_date_time=error34_date_time, fax_number_confirmation=fax_number_confirmation, media26_page_count=media26_page_count, time_display=time_display, error31=error31, media1_name=media1_name, error48=error48, job_info_attr_9=job_info_attr_9, default_copier_quantity=default_copier_quantity, operating_system=operating_system, scanner_accessory_copy_job_scan_count=scanner_accessory_copy_job_scan_count, simm2=simm2, error50_code=error50_code, media2_page_count=media2_page_count, error4_time_stamp=error4_time_stamp, error49_code=error49_code, consumable_current_state=consumable_current_state, error16_date_time=error16_date_time, file_system_max_open_files=file_system_max_open_files, consumable_life_usage_units=consumable_life_usage_units, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, error22_time_stamp=error22_time_stamp, device_used_while_cartridge_out_override_active=device_used_while_cartridge_out_override_active, background_message4=background_message4, error41_date_time=error41_date_time, media14=media14, error29_time_stamp=error29_time_stamp, default_copies=default_copies, host_application_available_memory=host_application_available_memory, clearable_warning=clearable_warning, job_info_io_source=job_info_io_source, media22=media22, custom_paper_feed_dim=custom_paper_feed_dim, mono_color_switching_mode=mono_color_switching_mode, usb_product_id=usb_product_id, upgradeable_devices_generic_name=upgradeable_devices_generic_name, error20_date_time=error20_date_time, media20_name=media20_name, media_number_of_type_supported=media_number_of_type_supported, error50_date_time=error50_date_time, scanner_accessory_digital_send_config_ldap_gateway=scanner_accessory_digital_send_config_ldap_gateway, pcl_default_font_number=pcl_default_font_number, non_assured_oht_page_count=non_assured_oht_page_count, media19=media19, copy_job_scan_ahead=copy_job_scan_ahead, simm1_capacity=simm1_capacity, firmware_download=firmware_download, job_info_accounting_finishing_options=job_info_accounting_finishing_options, tray5_phd=tray5_phd, simm1_bank2_type=simm1_bank2_type, error5_time_stamp=error5_time_stamp, scanner_accessory_total_copy_pages_printed=scanner_accessory_total_copy_pages_printed, tray7_phd=tray7_phd, media3_engine_media_mode=media3_engine_media_mode, media19_name=media19_name, menus=menus, error16=error16, supply_out_device_state=supply_out_device_state, consumables_status=consumables_status, device_configure_printer_parameters=device_configure_printer_parameters, consumable_reorder_url=consumable_reorder_url, marking_agent_density=marking_agent_density, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, error48_time_stamp=error48_time_stamp, held_job_user_name=held_job_user_name, device_configure=device_configure, supply_after_out_state=supply_after_out_state, afax_send_page_count=afax_send_page_count, media17_engine_media_mode=media17_engine_media_mode, settings_intray=settings_intray, asset_number=asset_number, printed_media_duplex_charge=printed_media_duplex_charge, error11_code=error11_code, error3=error3, error38_time_stamp=error38_time_stamp, scanner_accessory_adf_one_sided_sheet_count=scanner_accessory_adf_one_sided_sheet_count, error43=error43, pysmi_continue=pysmi_continue, held_job_control=held_job_control, printer_calibration_dhalf=printer_calibration_dhalf, error24_date_time=error24_date_time, mass_storage_block_driver=mass_storage_block_driver, media_size=media_size, error35_date_time=error35_date_time, remote_procedure_call=remote_procedure_call, media13_engine_media_mode=media13_engine_media_mode, error7_code=error7_code, printer_cal_dhalf_data=printer_cal_dhalf_data, form_feed_needed=form_feed_needed, printer_cal_dhalf_data2=printer_cal_dhalf_data2, media9=media9, firmware_download_name=firmware_download_name, tray3_phd=tray3_phd, media3_name=media3_name, printed_media_simplex_count=printed_media_simplex_count, error20_time_stamp=error20_time_stamp, localization_languages_supported=localization_languages_supported, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, source_tray_usage_total=source_tray_usage_total, media17_page_count=media17_page_count, phd2_type=phd2_type, media4=media4, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, scan_calibration_download=scan_calibration_download, default_copy_job_chromaticity=default_copy_job_chromaticity, phd2_manufacturing_info=phd2_manufacturing_info, error7_date_time=error7_date_time, error35=error35, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, held_job_set_queue_size=held_job_set_queue_size, held_job_retention=held_job_retention, error33_time_stamp=error33_time_stamp, job_info_pages_processed=job_info_pages_processed, default_scanner_speed=default_scanner_speed, printed_media_dimplex_count=printed_media_dimplex_count, error40_code=error40_code, job_info_physical_outbins_used=job_info_physical_outbins_used, job_info_attr_12=job_info_attr_12, error15_time_stamp=error15_time_stamp, overflow_bin=overflow_bin, media1_short_name=media1_short_name, job_info_size=job_info_size, held_job_job_name=held_job_job_name, error14_date_time=error14_date_time, settings_spooler=settings_spooler, error8=error8, error19_code=error19_code, consumable_maintenance_pages_remaining=consumable_maintenance_pages_remaining, media11_page_count=media11_page_count, default_copy_duplex_mode=default_copy_duplex_mode, default_lines_per_page=default_lines_per_page, firmware_download_version=firmware_download_version, printer_cal_cpr_page_count=printer_cal_cpr_page_count, printer_calibration_cpr=printer_calibration_cpr, error27=error27, ph=ph, outbin1_maximum_binding=outbin1_maximum_binding, media16_name=media16_name, printed_media_total_charge=printed_media_total_charge, error42_code=error42_code, error49_date_time=error49_date_time, outbin2_override_mode=outbin2_override_mode, fw_rom_datecode=fw_rom_datecode, firmware_download_write_time=firmware_download_write_time, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, duplex_blank_pages=duplex_blank_pages, usage_scanner_total_charge=usage_scanner_total_charge, pdl=pdl, error3_date_time=error3_date_time, error47_code=error47_code, tray6_media_size_loaded=tray6_media_size_loaded, outbin1_override_mode=outbin1_override_mode, localization_countries_supported=localization_countries_supported, default_copier_pages_per_sheet=default_copier_pages_per_sheet, scanner_accessory_adf_sheet_count=scanner_accessory_adf_sheet_count, source_subsystem=source_subsystem, media6_name=media6_name, postscript_print_errors=postscript_print_errors, media2_name=media2_name, error16_time_stamp=error16_time_stamp, error1=error1, default_custom_paper_feed_dim=default_custom_paper_feed_dim, error28_time_stamp=error28_time_stamp, consumable_string=consumable_string, mio4=mio4, usb_device_kind=usb_device_kind)
mibBuilder.exportSymbols("LJ5035-MIB", copier=copier, scanned_media_simplex_count=scanned_media_simplex_count, error19=error19, mio1_manufacturing_info=mio1_manufacturing_info, formatter_serial_number=formatter_serial_number, media24_short_name=media24_short_name, media25_page_count=media25_page_count, media22_page_count=media22_page_count, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, pcl_default_font_width=pcl_default_font_width, web_server_url=web_server_url, error50=error50, marking_agent=marking_agent, simm2_bank1_type=simm2_bank1_type, printer_average_marking_agent_coverage_sum=printer_average_marking_agent_coverage_sum, error43_code=error43_code, intray2=intray2, error30_code=error30_code, media9_page_count=media9_page_count, error32=error32, printed_modes_accounting=printed_modes_accounting, job_input_auto_continue_mode=job_input_auto_continue_mode, scanner_accessory_digital_send_status=scanner_accessory_digital_send_status, web_server_security=web_server_security, service_id=service_id, errorlog=errorlog, media14_engine_media_mode=media14_engine_media_mode, settings_ph=settings_ph, simm1_bank1=simm1_bank1, default_horizontal_black_resolution=default_horizontal_black_resolution, settings_web_server=settings_web_server, usb_vendor_id=usb_vendor_id, job_info_attr_10=job_info_attr_10, media5=media5, error29=error29, copy_job_hold_time=copy_job_hold_time, media18_short_name=media18_short_name, destination_bin_usage=destination_bin_usage, control_panel_supplies_status_message=control_panel_supplies_status_message, finisher_image_rotation=finisher_image_rotation, error31_time_stamp=error31_time_stamp, scanner_accessory_digital_send_home_screen_status=scanner_accessory_digital_send_home_screen_status, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, job_being_parsed=job_being_parsed, webserver_proc_sub=webserver_proc_sub, error10_date_time=error10_date_time, held_job_print=held_job_print, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, media1=media1, id=id, file_system3=file_system3, mass_storage_resources=mass_storage_resources, media24=media24, error40_date_time=error40_date_time, media10=media10, error42_time_stamp=error42_time_stamp, held_job_pin=held_job_pin, job_info_attr_14=job_info_attr_14, media11_short_name=media11_short_name, media21_engine_media_mode=media21_engine_media_mode, media3_page_count=media3_page_count, error45_date_time=error45_date_time, error10=error10, media6=media6, media8_page_count=media8_page_count, error21=error21, job_info_attr_1=job_info_attr_1, settings_fax_proc_sub=settings_fax_proc_sub, status_mass_storage_bd=status_mass_storage_bd, error26_time_stamp=error26_time_stamp, error36_code=error36_code, media14_name=media14_name, media21_name=media21_name, mio1=mio1, media20_engine_media_mode=media20_engine_media_mode, scanner_accounting=scanner_accounting, held_job_info=held_job_info, pcl_default_font_source=pcl_default_font_source, faxjob=faxjob, input_tray_auto_select=input_tray_auto_select, media_info=media_info, error13_time_stamp=error13_time_stamp, error25_code=error25_code, scanner_accessory_digital_send_config_fax_embedded=scanner_accessory_digital_send_config_fax_embedded, mass_storage_resource_changed=mass_storage_resource_changed, marking_agent_shadows_density_setting=marking_agent_shadows_density_setting, settings_copier=settings_copier, error5_code=error5_code, default_audible_feedback=default_audible_feedback, error23_time_stamp=error23_time_stamp, error30_date_time=error30_date_time, default_vmi=default_vmi, auto_continue=auto_continue, error22=error22, tray3_media_size_loaded=tray3_media_size_loaded, error13=error13, background_message2=background_message2, port1_parallel_bidirectionality=port1_parallel_bidirectionality, consumable_life_low_threshold=consumable_life_low_threshold, error27_code=error27_code, hold_job_timeout=hold_job_timeout, printer_cal_dhalf_data1=printer_cal_dhalf_data1, media24_name=media24_name, media19_short_name=media19_short_name, mio4_manufacturing_info=mio4_manufacturing_info, scanner_accessory_digital_send_log_event_counter=scanner_accessory_digital_send_log_event_counter, error11_time_stamp=error11_time_stamp, media18=media18, media26=media26, job_info_state=job_info_state, error6_time_stamp=error6_time_stamp, ports=ports, job_info_attr_16=job_info_attr_16, media25=media25, error36_date_time=error36_date_time, usb_interface=usb_interface, configurable_low_threshold_setting=configurable_low_threshold_setting, job_info_change_id=job_info_change_id, date_and_time=date_and_time, outbin2_maximum_binding=outbin2_maximum_binding, print_engine=print_engine, default_custom_paper_dim_unit=default_custom_paper_dim_unit, outbin1_phd=outbin1_phd, error34_code=error34_code, printed_media_simplex_charge=printed_media_simplex_charge, media5_engine_media_mode=media5_engine_media_mode, fax_job_control=fax_job_control, source_tray_accounting=source_tray_accounting, error22_date_time=error22_date_time, default_copier_contrast=default_copier_contrast, media3_short_name=media3_short_name, upgradable_devices=upgradable_devices, default_copier_page_borders=default_copier_page_borders, media21_short_name=media21_short_name, error14_time_stamp=error14_time_stamp, media15=media15, media12=media12, error18=error18, rpc_bind_protocol_address=rpc_bind_protocol_address, intray=intray, error40=error40, error43_time_stamp=error43_time_stamp, mio1_model_name=mio1_model_name, override_media_size=override_media_size, media19_engine_media_mode=media19_engine_media_mode, consumable_string_information=consumable_string_information, error1_code=error1_code, error30=error30, error6=error6, error44_code=error44_code, media13_page_count=media13_page_count, media9_name=media9_name, phd2_capacity=phd2_capacity, scanner_accessory_digital_send_config_dsm_enabled_fax=scanner_accessory_digital_send_config_dsm_enabled_fax, print_meter=print_meter, scanner_accessory_digital_send_config_email_gateway=scanner_accessory_digital_send_config_email_gateway, job_info_accounting_scanned_media_simplex_count=job_info_accounting_scanned_media_simplex_count, destination_bin_usage_count=destination_bin_usage_count, web_server=web_server, media8_name=media8_name, error39=error39, media9_short_name=media9_short_name, printer_cal_dhalf_utc=printer_cal_dhalf_utc, media16=media16, default_reset_send_timeout=default_reset_send_timeout, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, consumable_notification_status=consumable_notification_status, error13_code=error13_code, interface=interface, error39_time_stamp=error39_time_stamp, error8_time_stamp=error8_time_stamp, error24_code=error24_code, simm2_bank2=simm2_bank2, copy_job_auto_interrupt=copy_job_auto_interrupt, media20_page_count=media20_page_count, error19_time_stamp=error19_time_stamp, error28_code=error28_code, media6_engine_media_mode=media6_engine_media_mode, media5_short_name=media5_short_name, tables=tables, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, usage_instructions_line2=usage_instructions_line2, tray1_phd=tray1_phd, error15_date_time=error15_date_time, scanned_media_simplex_charge=scanned_media_simplex_charge, printer_average=printer_average, media7_engine_media_mode=media7_engine_media_mode, error15=error15, error1_date_time=error1_date_time, collated_originals_support=collated_originals_support, pml=pml, printed_media_duplex_count=printed_media_duplex_count, error2_date_time=error2_date_time, error8_date_time=error8_date_time, error38_date_time=error38_date_time, simm1_bank2_capacity=simm1_bank2_capacity, mass_storage_resource_change_counter=mass_storage_resource_change_counter, job_info_name2=job_info_name2, media10_engine_media_mode=media10_engine_media_mode, error18_code=error18_code, settings_file_system=settings_file_system, control_panel_button_press=control_panel_button_press, default_staple_mode=default_staple_mode, copy_job_hold_off_print_jobs=copy_job_hold_off_print_jobs, job_info_attr_4=job_info_attr_4, default_scan_background_removal=default_scan_background_removal, destination_bin_usage_total=destination_bin_usage_total, error30_time_stamp=error30_time_stamp, job_info_name1=job_info_name1, control_panel_display_contents_crc=control_panel_display_contents_crc, upgradable_devices_write_time=upgradable_devices_write_time, printer_cal_cpr_utc=printer_cal_cpr_utc, background_status_msg_higher_priority=background_status_msg_higher_priority, media24_engine_media_mode=media24_engine_media_mode, error9_date_time=error9_date_time, error37_date_time=error37_date_time, os_execute_file=os_execute_file, media10_name=media10_name, auto_send_reset=auto_send_reset, media1_page_count=media1_page_count, media23_name=media23_name, media3=media3, intray1=intray1, simm2_bank1_capacity=simm2_bank1_capacity, media2_short_name=media2_short_name, media10_short_name=media10_short_name, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, media14_short_name=media14_short_name, remote_upgrade_version_checking_enable=remote_upgrade_version_checking_enable, job_info_accounting_job_type=job_info_accounting_job_type, media7_name=media7_name, error21_date_time=error21_date_time, resource_manager=resource_manager, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, simm1_bank=simm1_bank, media11=media11, scanned_media_duplex_charge=scanned_media_duplex_charge, error4=error4, energy_star=energy_star, error35_code=error35_code, total_color_page_count=total_color_page_count, media22_short_name=media22_short_name, media13=media13, job_output_auto_continue_timeout=job_output_auto_continue_timeout, imaging=imaging, scan_to_folder_count=scan_to_folder_count, error17_time_stamp=error17_time_stamp, pcl_default_font_height=pcl_default_font_height, ews_request_control_panel_supplies_status=ews_request_control_panel_supplies_status, accounting=accounting, media12_name=media12_name, settings_webserver=settings_webserver, background_status_msg_line3_part1=background_status_msg_line3_part1)
mibBuilder.exportSymbols("LJ5035-MIB", error42=error42, error44_time_stamp=error44_time_stamp, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, spooler=spooler, error15_code=error15_code, media7_short_name=media7_short_name, media15_page_count=media15_page_count, outbin=outbin, scanned_media_usage=scanned_media_usage, error27_time_stamp=error27_time_stamp, default_media_name=default_media_name, error29_code=error29_code, error_log_clear=error_log_clear, error5=error5, error49_time_stamp=error49_time_stamp, media20_short_name=media20_short_name, default_copier_edge_to_edge=default_copier_edge_to_edge, media7=media7, upgradable_devices_version=upgradable_devices_version, printed_modes_usage=printed_modes_usage, error26=error26, media8=media8, upgradable_devices_current_state=upgradable_devices_current_state, error20=error20, job_input_auto_continue_timeout=job_input_auto_continue_timeout, media17_name=media17_name, printed_modes_usage_total=printed_modes_usage_total, usb_serial_number=usb_serial_number, faxjob_rx_count=faxjob_rx_count, held_job=held_job, source_tray_usage=source_tray_usage, control_panel_key_press=control_panel_key_press, status_rpc=status_rpc, error25_date_time=error25_date_time, media2_engine_media_mode=media2_engine_media_mode, error37_code=error37_code, usb_product_description=usb_product_description, background_status_msg_line4_part1=background_status_msg_line4_part1, consumables_life=consumables_life, error23_date_time=error23_date_time, error46_date_time=error46_date_time, custom_paper_xfeed_dim=custom_paper_xfeed_dim, io=io, default_copier_image_type=default_copier_image_type, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, status_fax_proc_sub=status_fax_proc_sub, active_print_jobs=active_print_jobs, destination_bin_accounting=destination_bin_accounting, simm2_bank2_type=simm2_bank2_type, error13_date_time=error13_date_time, error20_code=error20_code, media24_page_count=media24_page_count, media17_short_name=media17_short_name, simm2_bank=simm2_bank, media16_page_count=media16_page_count, error10_code=error10_code, io_switch=io_switch, error2_code=error2_code, north_edge_offset=north_edge_offset, media15_name=media15_name, held_job_delete=held_job_delete, error46_time_stamp=error46_time_stamp, error9_time_stamp=error9_time_stamp, mio=mio, print_media=print_media, usage_average_toner_coverage=usage_average_toner_coverage, job_info_page_count_current_original=job_info_page_count_current_original, error47_date_time=error47_date_time, mio4_type=mio4_type, current_job_parsing_id=current_job_parsing_id, error19_date_time=error19_date_time, DisplayString=DisplayString, media2=media2)
