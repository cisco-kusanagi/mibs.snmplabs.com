...
# Produced by pysmi-0.3.4 at Mon Apr 29 19:45:47 2019
...
ModuleIdentity, iso, Counter64, Gauge32, ObjectIdentity, MibIdentifier, mib_2, Counter32, NotificationType, Unsigned32, Integer32, Bits, experimental, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Counter64", "Gauge32", "ObjectIdentity", "MibIdentifier", "mib-2", "Counter32", "NotificationType", "Unsigned32", "Integer32", "Bits", "experimental", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks")
...
mibBuilder.exportSymbols("IPV6-UDP-MIB", ipv6UdpConformance=ipv6UdpConformance, PYSNMP_MODULE_ID=ipv6UdpMIB, ipv6UdpIfIndex=ipv6UdpIfIndex, ipv6UdpGroup=ipv6UdpGroup, ipv6UdpLocalPort=ipv6UdpLocalPort, ipv6UdpTable=ipv6UdpTable, ipv6UdpCompliance=ipv6UdpCompliance, ipv6UdpGroups=ipv6UdpGroups, ipv6UdpLocalAddress=ipv6UdpLocalAddress, ipv6UdpCompliances=ipv6UdpCompliances, ipv6UdpEntry=ipv6UdpEntry, ipv6UdpMIB=ipv6UdpMIB, udp=udp)
