...
# Produced by pysmi-0.3.4 at Mon Apr 29 16:51:24 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, Counter64, iso, Gauge32, Integer32, NotificationType, ObjectIdentity, ModuleIdentity, IpAddress, Bits, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "Counter64", "iso", "Gauge32", "Integer32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Bits", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("A3COM-HUAWEI-MLSR-SYSTEM-MIB", hwBuffer256Free=hwBuffer256Free, hwBuffer512FreeError3=hwBuffer512FreeError3, hwBuffer2048FreeError2=hwBuffer2048FreeError2, moduleSwVersion=moduleSwVersion, hwBuffer1024DropCounts=hwBuffer1024DropCounts, hwBuffer256DropCounts=hwBuffer256DropCounts, hwBuffer64Size=hwBuffer64Size, hwBuffer256Used=hwBuffer256Used, hwMemoryMallocFail=hwMemoryMallocFail, hwBuffer2048Size=hwBuffer2048Size, hwBuzzerStatus=hwBuzzerStatus, hwBuffer256KTotal=hwBuffer256KTotal, hwBuffer2048FreeError3=hwBuffer2048FreeError3, hwFlhCurStat=hwFlhCurStat, routerGeneral=routerGeneral, hwBuffer128Used=hwBuffer128Used, hwBuffer32CollectCounts=hwBuffer32CollectCounts, hwBuffer45KUsed=hwBuffer45KUsed, hwCpuCostRatePer5Minute=hwCpuCostRatePer5Minute, hwBuffer512FreeError2=hwBuffer512FreeError2, hwBuffer64DropCounts=hwBuffer64DropCounts, hwBuffer45KDropCounts=hwBuffer45KDropCounts, hwRAMSize=hwRAMSize, hwBuffer512Free=hwBuffer512Free, hwStartCfgChangedTime=hwStartCfgChangedTime, hwBuffer1024Total=hwBuffer1024Total, moduleFirstPort=moduleFirstPort, hwBuffer8192FreeError3=hwBuffer8192FreeError3, hwBuffer2048DropCounts=hwBuffer2048DropCounts, hwRunCfgSavedTime=hwRunCfgSavedTime, hwBuffer45KCollectCounts=hwBuffer45KCollectCounts, hwFansStatus=hwFansStatus, hwBuffer64Total=hwBuffer64Total, hwBuffer2048Free=hwBuffer2048Free, hwBuffer64FreeError3=hwBuffer64FreeError3, logfilterEntry=logfilterEntry, hwBuffer256KDropCounts=hwBuffer256KDropCounts, hwBuffer32Size=hwBuffer32Size, moduleTable=moduleTable, hwFlhEraseStat=hwFlhEraseStat, hwUsedMemory=hwUsedMemory, hwBuffer256Size=hwBuffer256Size, hwBuffer128Size=hwBuffer128Size, hwNetConfigName=hwNetConfigName, hwBuffer256KFree=hwBuffer256KFree, hwBuffer512Size=hwBuffer512Size, hwBuffer4096DropCounts=hwBuffer4096DropCounts, hwmHostName=hwmHostName, hwModuleId=hwModuleId, hwBuffer4096Total=hwBuffer4096Total, logcontroller=logcontroller, hwBuffer128Free=hwBuffer128Free, moduleHwVersion=moduleHwVersion, hwBuffer512Used=hwBuffer512Used, log=log, hwFlashMan=hwFlashMan, hwROMVersion=hwROMVersion, hwBuffer8192Total=hwBuffer8192Total, moduleIndex=moduleIndex, attr=attr, hwBuffer1024Used=hwBuffer1024Used, hwHostConfigName=hwHostConfigName, hwBuffer8192FreeError2=hwBuffer8192FreeError2, hwBuffer45KFree=hwBuffer45KFree, hwBuffer256KCollectCounts=hwBuffer256KCollectCounts, hwCpuCostRatePer5Sec=hwCpuCostRatePer5Sec, hwBuffer2048Used=hwBuffer2048Used, moduleSlotNum=moduleSlotNum, loghostfacility=loghostfacility, hwBuffer45KSize=hwBuffer45KSize, hwBuffer256KSize=hwBuffer256KSize, hwRunCfgChangedTime=hwRunCfgChangedTime, hwBuffer1024Free=hwBuffer1024Free, loghostport=loghostport, hwConfigReg=hwConfigReg, hwBuffer1024CollectCounts=hwBuffer1024CollectCounts, hwBuffer1024FreeError2=hwBuffer1024FreeError2, hwBuffer128FreeError2=hwBuffer128FreeError2, hwBuffer128FreeError3=hwBuffer128FreeError3, hwNVRAMSize=hwNVRAMSize, hwBuffer4096FreeError3=hwBuffer4096FreeError3, loghostIndex=loghostIndex, hwBuffer8192DropCounts=hwBuffer8192DropCounts, hwBuffer64Free=hwBuffer64Free, hwBuffer512CollectCounts=hwBuffer512CollectCounts, hwBuffer64CollectCounts=hwBuffer64CollectCounts, trap=trap, hwBuffer8192Free=hwBuffer8192Free, hwBuffer2048Total=hwBuffer2048Total, hwMemoryLargestFree=hwMemoryLargestFree, vrp=vrp, hwBuffer32Used=hwBuffer32Used, hwBuffer256CollectCounts=hwBuffer256CollectCounts, hwTFTPEnabled=hwTFTPEnabled, hwSecondPowerStatus=hwSecondPowerStatus, hwmRouterSerialNO=hwmRouterSerialNO, hwBuffer32Total=hwBuffer32Total, hwBuffer32Free=hwBuffer32Free, logdevfacility=logdevfacility, hwmWhyReboot=hwmWhyReboot, loghostaccess=loghostaccess, hwBuffer128Total=hwBuffer128Total, logfilterTable=logfilterTable, hwBuffer128CollectCounts=hwBuffer128CollectCounts, hwROMSysVersion=hwROMSysVersion, hwBuffer4096Free=hwBuffer4096Free, moduleNumberOfPorts=moduleNumberOfPorts, hwPowerStatus=hwPowerStatus, huaweiMixinfo=huaweiMixinfo, huaweiMemoryMan=huaweiMemoryMan, hwBuffer8192Size=hwBuffer8192Size, hwBuffer256KUsed=hwBuffer256KUsed, hwSysAirFlowTempIn=hwSysAirFlowTempIn, hwBuffer45KFreeError2=hwBuffer45KFreeError2, RowStatus=RowStatus, hwBuffer64Used=hwBuffer64Used, loghostaddress=loghostaddress, hwBuffer256FreeError2=hwBuffer256FreeError2, hwCurrentTime=hwCurrentTime, version=version, hwBuffer1024FreeError3=hwBuffer1024FreeError3, hwBuffer45KFreeError3=hwBuffer45KFreeError3, moduleEntry=moduleEntry, logfilterstatus=logfilterstatus, hwFreeMemory=hwFreeMemory, logfilterIndex=logfilterIndex, loghostTable=loghostTable, hwBuffer128DropCounts=hwBuffer128DropCounts, hwBuffer4096FreeError2=hwBuffer4096FreeError2, hwNVRAMUsed=hwNVRAMUsed, hwBuffer32FreeError3=hwBuffer32FreeError3, hwBuffer2048CollectCounts=hwBuffer2048CollectCounts, hwBuffer512DropCounts=hwBuffer512DropCounts, hwBuffer256KFreeError2=hwBuffer256KFreeError2, hwBuffer8192Used=hwBuffer8192Used, hwBuffer256FreeError3=hwBuffer256FreeError3, hwBuffer32FreeError2=hwBuffer32FreeError2, hwFlhTotalSize=hwFlhTotalSize, hwFlhUnusedSize=hwFlhUnusedSize, hwBuffer256Total=hwBuffer256Total, hwBuffer32DropCounts=hwBuffer32DropCounts, hwBuffer4096Used=hwBuffer4096Used, hwmSystem=hwmSystem, hwBuffer8192CollectCounts=hwBuffer8192CollectCounts, loghostlanguage=loghostlanguage, hwBuffer4096Size=hwBuffer4096Size, loghostseverity=loghostseverity, hwMemoryFree=hwMemoryFree, moduleType=moduleType, hwROMID=hwROMID, hwBuffer64FreeError2=hwBuffer64FreeError2, hwBuffer45KTotal=hwBuffer45KTotal, hwmHostHwVersion=hwmHostHwVersion, hwConfigRegNextReboot=hwConfigRegNextReboot, loghostEntry=loghostEntry, module=module, HwFlashEreaseStatus=HwFlashEreaseStatus, hwBuffer4096CollectCounts=hwBuffer4096CollectCounts, basis=basis, HwFlashStatus=HwFlashStatus, hwFlhEraseTime=hwFlhEraseTime, hwMemoryMallocNoMem=hwMemoryMallocNoMem, hwBuffer512Total=hwBuffer512Total, hwBuffer256KFreeError3=hwBuffer256KFreeError3, loghoststatus=loghoststatus, hwBuffer1024Size=hwBuffer1024Size, hwConfigFile=hwConfigFile, moduleVersion=moduleVersion)
