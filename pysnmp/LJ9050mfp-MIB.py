...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ9050mfp-MIB
...
Gauge32, ModuleIdentity, MibIdentifier, TimeTicks, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, Bits, IpAddress, NotificationType, Unsigned32, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "Bits", "IpAddress", "NotificationType", "Unsigned32", "iso", "Counter32")
...
mibBuilder.exportSymbols("LJ9050mfp-MIB", scanner_accounting=scanner_accounting, default_copies=default_copies, marking_agent_density_setting=marking_agent_density_setting, job_info_accounting_media_size=job_info_accounting_media_size, channelstatus=channelstatus, outbin=outbin, error6=error6, media_size=media_size, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, phd3_capacity=phd3_capacity, firmware_download_version=firmware_download_version, error21_time_stamp=error21_time_stamp, job_info_outbins_used=job_info_outbins_used, phd3_device_specific_command=phd3_device_specific_command, rpc_bound_protocol_address=rpc_bound_protocol_address, usage_instructions_line1=usage_instructions_line1, error20_time_stamp=error20_time_stamp, outbin12_maximum_binding=outbin12_maximum_binding, channelprotocolversion=channelprotocolversion, pjl=pjl, outbin10=outbin10, error14_time_stamp=error14_time_stamp, simm1_capacity=simm1_capacity, error16_time_stamp=error16_time_stamp, error11_time_stamp=error11_time_stamp, error44_time_stamp=error44_time_stamp, media6_name=media6_name, consumable_status_usage_count=consumable_status_usage_count, media8=media8, ram_disk_size=ram_disk_size, media10_short_name=media10_short_name, phd4_capacity=phd4_capacity, default_copy_output_bin=default_copy_output_bin, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, default_scan_image_quality=default_scan_image_quality, media19_name=media19_name, fax_print_page_count=fax_print_page_count, job_info_attr_15=job_info_attr_15, outbin9_phd=outbin9_phd, media16_short_name=media16_short_name, outbin7=outbin7, error34_time_stamp=error34_time_stamp, media18=media18, fw_rom_datecode=fw_rom_datecode, settings_mass_storage_bd=settings_mass_storage_bd, phd4=phd4, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, job_info_name1=job_info_name1, error33_code=error33_code, error17_code=error17_code, simm3_bank2_type=simm3_bank2_type, test=test, media3=media3, media19_engine_media_mode=media19_engine_media_mode, error4_time_stamp=error4_time_stamp, media11_name=media11_name, media3_name=media3_name, mass_storage_resource_changed=mass_storage_resource_changed, outbin8_override_mode=outbin8_override_mode, held_job_pin=held_job_pin, error21_code=error21_code, media4=media4, job_info_attr_13=job_info_attr_13, default_scan_text_graphics_mix=default_scan_text_graphics_mix, hold_job_timeout=hold_job_timeout, copy_job_interrupt_copy_jobs=copy_job_interrupt_copy_jobs, scanner=scanner, outbin9=outbin9, simm2=simm2, error27=error27, held_job_info=held_job_info, error31_code=error31_code, simm2_bank1_type=simm2_bank1_type, outbin4_override_mode=outbin4_override_mode, job_info_attribute=job_info_attribute, copy_job_auto_interrupt=copy_job_auto_interrupt, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, copy_job_scan_ahead=copy_job_scan_ahead, simm=simm, media16=media16, error4_code=error4_code, error46_code=error46_code, print_density=print_density, printer_average_marking_agent_coverage_sum=printer_average_marking_agent_coverage_sum, error37_code=error37_code, job_info_attr_16=job_info_attr_16, error15_code=error15_code, errorlog=errorlog, simm4_capacity=simm4_capacity, auto_continue=auto_continue, upgradable_devices_write_time=upgradable_devices_write_time, scanner_accessory_digital_send_config_fax_embedded=scanner_accessory_digital_send_config_fax_embedded, media19_short_name=media19_short_name, media9_engine_media_mode=media9_engine_media_mode, outbin8_error_info=outbin8_error_info, outbin11_phd=outbin11_phd, media5=media5, error29_time_stamp=error29_time_stamp, channelnumberofchannels=channelnumberofchannels, outbin11_maximum_binding=outbin11_maximum_binding, job_info_attr_11=job_info_attr_11, tray6_media_size_loaded=tray6_media_size_loaded, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, remote_procedure_call=remote_procedure_call, ph4=ph4, phd2_capacity=phd2_capacity, simm3_bank2_capacity=simm3_bank2_capacity, energy_star=energy_star, media1_page_count=media1_page_count, copier=copier, consumable_status_job_count=consumable_status_job_count, control_panel_display_graphical_contents=control_panel_display_graphical_contents, default_copy_reset_timeout=default_copy_reset_timeout, simm1_bank2=simm1_bank2, port1_parallel_speed=port1_parallel_speed, error13_code=error13_code, media15_page_count=media15_page_count, background_message1=background_message1, media2_short_name=media2_short_name, scanner_accessory_dimm1_capacity=scanner_accessory_dimm1_capacity, media11_page_count=media11_page_count, settings_spooler=settings_spooler, job_info_physical_outbins_used=job_info_physical_outbins_used, channelifindex=channelifindex, media17_name=media17_name, error49=error49, job_info_printed_originals=job_info_printed_originals, simm3_capacity=simm3_capacity, default_custom_paper_dim_unit=default_custom_paper_dim_unit, device=device, tray3_phd=tray3_phd, media5_short_name=media5_short_name, phd4_device_specific_command=phd4_device_specific_command, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, consumables_status=consumables_status, consumable_maintenance_interval=consumable_maintenance_interval, media18_name=media18_name, error43=error43, printed_media_total_charge=printed_media_total_charge, media2_engine_media_mode=media2_engine_media_mode, phd6=phd6, consumable_status=consumable_status, simm2_bank1=simm2_bank1, outbin10_maximum_binding=outbin10_maximum_binding, scanner_accessory_digital_send_status=scanner_accessory_digital_send_status, consumable_status_oem_name=consumable_status_oem_name, phd3=phd3, scanner_accessory_total_copy_pages_printed=scanner_accessory_total_copy_pages_printed, firmware_download_write_status_supported=firmware_download_write_status_supported, outbin3_phd=outbin3_phd, scan_sharpening_coefficient=scan_sharpening_coefficient, socket_ping_job_events_version=socket_ping_job_events_version, error37_time_stamp=error37_time_stamp, simm1_bank=simm1_bank, held_job_print=held_job_print, error50_time_stamp=error50_time_stamp, error32_code=error32_code, default_scan_job_mode=default_scan_job_mode, held_job_retention=held_job_retention, simm4_bank1_capacity=simm4_bank1_capacity, status_system=status_system, consumable_status_first_install_date=consumable_status_first_install_date, default_copier_quantity=default_copier_quantity, background_status_msg_line3_part1=background_status_msg_line3_part1, held_job_job_name=held_job_job_name, upgradable_devices_current_state=upgradable_devices_current_state, copy_job_hold_off_print_jobs=copy_job_hold_off_print_jobs, default_bits_per_pixel=default_bits_per_pixel, scanner_accessory_flatbed_scan_count=scanner_accessory_flatbed_scan_count, error48=error48, form_feed=form_feed, error36_time_stamp=error36_time_stamp, settings_rpc=settings_rpc, job_info_size=job_info_size, media5_name=media5_name, channelEntry=channelEntry, held_job_delete=held_job_delete, simm4_bank2_capacity=simm4_bank2_capacity, simm1_type=simm1_type, error7_time_stamp=error7_time_stamp, usage_average_toner_coverage=usage_average_toner_coverage, background_message2=background_message2, error42_code=error42_code, sleep_mode=sleep_mode, job_info_attr_1=job_info_attr_1, mio2_type=mio2_type, held_job_quantity=held_job_quantity, deviceChannelTable=deviceChannelTable, media_size_count=media_size_count, error16_code=error16_code, default_copy_input_tray=default_copy_input_tray, error22_code=error22_code, error32=error32, outbin6_override_mode=outbin6_override_mode, media6_short_name=media6_short_name, tray2_phd=tray2_phd, marking_agent=marking_agent, error8=error8, simm1_bank2_capacity=simm1_bank2_capacity, simm4_bank=simm4_bank, held_job=held_job, media16_engine_media_mode=media16_engine_media_mode, media7_short_name=media7_short_name, simm4_bank2_type=simm4_bank2_type, cancel_job=cancel_job, media1_engine_media_mode=media1_engine_media_mode, upgradable_devices_name=upgradable_devices_name, pysmi_continue=pysmi_continue, error50=error50, copier_media_type=copier_media_type, status_mass_storage_bd=status_mass_storage_bd, mio2_manufacturing_info=mio2_manufacturing_info, media16_name=media16_name, error39_code=error39_code, scanner_accessory_digital_send_log_event_counter=scanner_accessory_digital_send_log_event_counter, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, consumable_status_page_count_b5_executive=consumable_status_page_count_b5_executive, tray6_phd=tray6_phd, consumable_life_usage_units=consumable_life_usage_units, media2_name=media2_name, error16=error16, job_info_accounting_black_dots=job_info_accounting_black_dots, held_job_enable=held_job_enable, mio=mio, tray1_media_size_loaded=tray1_media_size_loaded, device_system=device_system, media9_short_name=media9_short_name, error2_code=error2_code, simm3_bank1_type=simm3_bank1_type, io_switch=io_switch, outbin1_override_mode=outbin1_override_mode, error19_time_stamp=error19_time_stamp, default_copier_collate=default_copier_collate, outbin3_override_mode=outbin3_override_mode, consumable_status_page_count_legal=consumable_status_page_count_legal, default_copier_flip_pages_up=default_copier_flip_pages_up, job_info_name2=job_info_name2, error7_code=error7_code, outbin4=outbin4, error34_code=error34_code, phd6_device_specific_command=phd6_device_specific_command, phd2=phd2, phd4_model=phd4_model, scanned_media_duplex_count=scanned_media_duplex_count, error7=error7, scanner_accessory_digital_send_config_dsm_enabled_fax=scanner_accessory_digital_send_config_dsm_enabled_fax, scanner_accessory_dimm1_type=scanner_accessory_dimm1_type, marking_agent_density=marking_agent_density, media7=media7, error8_time_stamp=error8_time_stamp, mass_storage_resource_change_counter=mass_storage_resource_change_counter, error26_code=error26_code, control_panel_button_press=control_panel_button_press)
mibBuilder.exportSymbols("LJ9050mfp-MIB", error29_code=error29_code, channel_io_errors=channel_io_errors, media18_short_name=media18_short_name, simm2_bank=simm2_bank, settings_pdl=settings_pdl, low_marking_agent_processing=low_marking_agent_processing, error40_code=error40_code, ram_disk_mode=ram_disk_mode, operating_system=operating_system, default_lines_per_page=default_lines_per_page, print_meter=print_meter, error10_code=error10_code, error49_code=error49_code, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, serial_number=serial_number, media16_page_count=media16_page_count, background_status_msg_line2_part1=background_status_msg_line2_part1, media17_engine_media_mode=media17_engine_media_mode, media9_page_count=media9_page_count, job_input_auto_continue_timeout=job_input_auto_continue_timeout, error50_code=error50_code, error15_time_stamp=error15_time_stamp, device_name=device_name, deviceChannelEntry=deviceChannelEntry, error20_code=error20_code, upgradable_devices=upgradable_devices, error44_code=error44_code, error45=error45, not_ready_source_scanner=not_ready_source_scanner, error9_code=error9_code, consumable_maintenance_pages_remaining=consumable_maintenance_pages_remaining, firmware_download_current_state=firmware_download_current_state, print_engine=print_engine, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, default_scan_original_size=default_scan_original_size, media19_page_count=media19_page_count, printed_media_duplex_charge=printed_media_duplex_charge, error27_code=error27_code, error33=error33, error36=error36, port1=port1, scanner_accessory_adf_one_sided_sheet_count=scanner_accessory_adf_one_sided_sheet_count, media_names_available=media_names_available, default_authentication_timeout=default_authentication_timeout, duplex_page_count=duplex_page_count, channelTable=channelTable, outbin3=outbin3, processing_subsystem=processing_subsystem, mio3_type=mio3_type, job_info_accounting_media_type=job_info_accounting_media_type, pdl_postscript=pdl_postscript, job=job, job_info_accounting=job_info_accounting, default_copier_contrast=default_copier_contrast, intray7=intray7, media1=media1, ph3=ph3, error36_code=error36_code, status_rpc=status_rpc, job_info_change_id=job_info_change_id, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, mass_storage_block_driver=mass_storage_block_driver, tray2_media_size_loaded=tray2_media_size_loaded, consumable_status_manufacturer_name=consumable_status_manufacturer_name, error38=error38, file_systems=file_systems, simm1_bank1=simm1_bank1, outbin5_override_mode=outbin5_override_mode, consumable_status_reseller_id=consumable_status_reseller_id, DisplayString=DisplayString, scanner_accessory_dimm2_capacity=scanner_accessory_dimm2_capacity, media5_page_count=media5_page_count, upgradable_devices_version=upgradable_devices_version, job_info_attr_9=job_info_attr_9, outbin5=outbin5, background_status_msg_line4_part1=background_status_msg_line4_part1, outbin9_error_info=outbin9_error_info, media4_short_name=media4_short_name, media10_page_count=media10_page_count, consumable_status_page_count_a4_letter=consumable_status_page_count_a4_letter, error19=error19, settings_outbin=settings_outbin, job_info_attr_12=job_info_attr_12, settings_marking_agent=settings_marking_agent, default_copier_media_size=default_copier_media_size, job_info_accounting_finishing_options=job_info_accounting_finishing_options, default_horizontal_black_resolution=default_horizontal_black_resolution, simm3_bank2=simm3_bank2, usage_staple_count=usage_staple_count, scanner_accessory_adf_sheet_count=scanner_accessory_adf_sheet_count, media11_short_name=media11_short_name, file_system2_initialize_volume=file_system2_initialize_volume, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, engine_self_diagnostic=engine_self_diagnostic, error45_code=error45_code, media15=media15, device_location=device_location, default_copier_image_type=default_copier_image_type, phd5_type=phd5_type, printer_average=printer_average, error12_code=error12_code, intray6=intray6, error18_code=error18_code, media6=media6, simm3_bank1_capacity=simm3_bank1_capacity, phd5_capacity=phd5_capacity, error32_time_stamp=error32_time_stamp, os_execute_file=os_execute_file, error10=error10, intray2=intray2, pdl_pcl=pdl_pcl, media4_engine_media_mode=media4_engine_media_mode, job_info=job_info, file_system3=file_system3, error38_time_stamp=error38_time_stamp, perm_store_init_occurred=perm_store_init_occurred, simm3_bank1=simm3_bank1, phd5=phd5, scanner_accessory_dimm2_type=scanner_accessory_dimm2_type, outbin9_override_mode=outbin9_override_mode, intray1=intray1, mio1_manufacturing_info=mio1_manufacturing_info, consumable_status_usage_units=consumable_status_usage_units, outbin6=outbin6, job_info_pages_processed=job_info_pages_processed, error29=error29, error42=error42, outbin10_error_info=outbin10_error_info, netPMLmgmt=netPMLmgmt, error25_code=error25_code, intrays=intrays, simm4_bank1_type=simm4_bank1_type, model_number=model_number, simm4=simm4, outbin4_error_info=outbin4_error_info, error37=error37, scanned_media_duplex_charge=scanned_media_duplex_charge, media10=media10, error12_time_stamp=error12_time_stamp, mp_tray=mp_tray, postscript_total_page_count=postscript_total_page_count, job_info_attr_5=job_info_attr_5, outbin5_maximum_binding=outbin5_maximum_binding, error27_time_stamp=error27_time_stamp, settings_fax_proc_sub=settings_fax_proc_sub, background_status_msg_line1_part1=background_status_msg_line1_part1, channel_mio=channel_mio, scanner_accessory_digital_send_module_url=scanner_accessory_digital_send_module_url, ports=ports, print_engine_revision=print_engine_revision, error11_code=error11_code, hp=hp, media19=media19, outbin4_phd=outbin4_phd, error43_time_stamp=error43_time_stamp, channeltype=channeltype, consumable_status_manufacturing_date=consumable_status_manufacturing_date, error14=error14, error41=error41, file_system2=file_system2, file_system4=file_system4, phd4_type=phd4_type, default_reset_send_timeout=default_reset_send_timeout, error3_time_stamp=error3_time_stamp, simm2_bank1_capacity=simm2_bank1_capacity, usage_printer_total_charge=usage_printer_total_charge, media4_page_count=media4_page_count, error35_time_stamp=error35_time_stamp, error48_time_stamp=error48_time_stamp, outbin11=outbin11, auto_send_reset=auto_send_reset, job_info_attr_4=job_info_attr_4, media10_name=media10_name, error24_code=error24_code, error21=error21, phd3_type=phd3_type, consumable_status_page_count_xy_other=consumable_status_page_count_xy_other, media1_short_name=media1_short_name, default_ret=default_ret, simm2_capacity=simm2_capacity, scanned_media_simplex_count=scanned_media_simplex_count, error17=error17, scanner_accessory_digital_send_config_ldap_gateway=scanner_accessory_digital_send_config_ldap_gateway, error9_time_stamp=error9_time_stamp, scanner_accessory_send_job_scan_count=scanner_accessory_send_job_scan_count, media15_name=media15_name, consumable_status_info=consumable_status_info, error46=error46, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, background_message3=background_message3, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, outbin6_maximum_binding=outbin6_maximum_binding, held_job_security=held_job_security, phd=phd, spooler=spooler, job_info_attr_2=job_info_attr_2, error1_code=error1_code, phd3_manufacturing_info=phd3_manufacturing_info, job_info_page_count_current_original=job_info_page_count_current_original, phd6_model=phd6_model, phd6_type=phd6_type, channelstate=channelstate, media_modes=media_modes, media6_engine_media_mode=media6_engine_media_mode, media8_name=media8_name, media2=media2, scanned_media_usage=scanned_media_usage, outbin9_maximum_binding=outbin9_maximum_binding, outbin12=outbin12, cold_reset_media_size=cold_reset_media_size, error2=error2, background_message=background_message, consumable_status_page_count_envelope=consumable_status_page_count_envelope, printed_media_simplex_charge=printed_media_simplex_charge, control_panel_display_contents_crc=control_panel_display_contents_crc, tray7_media_size_loaded=tray7_media_size_loaded, reprint=reprint, error5_time_stamp=error5_time_stamp, error49_time_stamp=error49_time_stamp, job_info_accounting_scanned_media_simplex_count=job_info_accounting_scanned_media_simplex_count, background_message4=background_message4, error47=error47, media6_page_count=media6_page_count, error34=error34, job_info_stage=job_info_stage, phd6_capacity=phd6_capacity, error3_code=error3_code, localization_languages_supported=localization_languages_supported, error8_code=error8_code, error26_time_stamp=error26_time_stamp, error44=error44, error41_code=error41_code, simm1_bank1_type=simm1_bank1_type, fw_rom_revision=fw_rom_revision, settings_print_media=settings_print_media, default_media_size=default_media_size, mio3_manufacturing_info=mio3_manufacturing_info, clearable_warning=clearable_warning, file_system_delete_files=file_system_delete_files, tables=tables, held_job_set_queue_size=held_job_set_queue_size, mio1_type=mio1_type, consumable_status_serial_number=consumable_status_serial_number, destination_subsystem=destination_subsystem, held_job_user_name=held_job_user_name, consumables_life=consumables_life, media_info=media_info, simm3=simm3, channel_jobs_received=channel_jobs_received, print_internal_page=print_internal_page, media3_engine_media_mode=media3_engine_media_mode, default_print_quality=default_print_quality, error17_time_stamp=error17_time_stamp, simm4_bank2=simm4_bank2)
mibBuilder.exportSymbols("LJ9050mfp-MIB", error23=error23, error22_time_stamp=error22_time_stamp, outbin3_maximum_binding=outbin3_maximum_binding, printed_media_duplex_count=printed_media_duplex_count, scanner_accessory_digital_send_config_email_gateway=scanner_accessory_digital_send_config_email_gateway, media3_short_name=media3_short_name, mopy_mode=mopy_mode, pcl_default_font_height=pcl_default_font_height, error12=error12, postscript_print_errors=postscript_print_errors, socket_ping=socket_ping, scanned_media_total_charge=scanned_media_total_charge, settings_io=settings_io, error5_code=error5_code, error28=error28, consumables_1=consumables_1, error46_time_stamp=error46_time_stamp, default_audible_feedback=default_audible_feedback, status_prt_eng=status_prt_eng, consumables=consumables, error47_code=error47_code, channelinformation=channelinformation, media7_name=media7_name, media17_page_count=media17_page_count, print_media=print_media, pcl_total_page_count=pcl_total_page_count, error5=error5, error24=error24, simm1_bank2_type=simm1_bank2_type, error48_code=error48_code, error19_code=error19_code, settings_system=settings_system, error13=error13, on_off_line=on_off_line, ph5=ph5, error30_time_stamp=error30_time_stamp, error1=error1, imaging=imaging, error6_time_stamp=error6_time_stamp, usage_instructions_line2=usage_instructions_line2, scanner_accessory_adf_two_sided_sheet_count=scanner_accessory_adf_two_sided_sheet_count, error24_time_stamp=error24_time_stamp, outbin11_override_mode=outbin11_override_mode, printed_media_simplex_count=printed_media_simplex_count, error2_time_stamp=error2_time_stamp, file_system_max_open_files=file_system_max_open_files, default_page_protect=default_page_protect, host_application_available_memory=host_application_available_memory, intray3=intray3, media7_page_count=media7_page_count, phd5_model=phd5_model, pcl_default_font_width=pcl_default_font_width, default_copier_pages_per_sheet=default_copier_pages_per_sheet, job_info_accounting_job_type=job_info_accounting_job_type, job_info_attr_7=job_info_attr_7, media7_engine_media_mode=media7_engine_media_mode, media18_page_count=media18_page_count, outbin4_maximum_binding=outbin4_maximum_binding, job_info_accounting_scanned_media_duplex_count=job_info_accounting_scanned_media_duplex_count, control_panel_key_press=control_panel_key_press, error25_time_stamp=error25_time_stamp, phd6_manufacturing_info=phd6_manufacturing_info, outbin7_error_info=outbin7_error_info, file_system3_initialize_volume=file_system3_initialize_volume, job_info_outcome=job_info_outcome, media9_name=media9_name, error40_time_stamp=error40_time_stamp, outbin12_phd=outbin12_phd, channelprinteralert=channelprinteralert, outbin8_phd=outbin8_phd, error39_time_stamp=error39_time_stamp, media9=media9, phd2_model=phd2_model, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, scanned_media_simplex_charge=scanned_media_simplex_charge, error11=error11, error6_code=error6_code, phd2_type=phd2_type, maximum_ram_disk_memory=maximum_ram_disk_memory, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, firmware_download=firmware_download, ph=ph, tray3_media_size_loaded=tray3_media_size_loaded, job_info_attr_6=job_info_attr_6, file_system=file_system, phd4_manufacturing_info=phd4_manufacturing_info, pcl_default_font_number=pcl_default_font_number, pcl_default_font_source=pcl_default_font_source, mio3_model_name=mio3_model_name, simm1_bank1_capacity=simm1_bank1_capacity, outbin6_error_info=outbin6_error_info, phd2_device_specific_command=phd2_device_specific_command, control_panel_display=control_panel_display, error30=error30, default_staple_mode=default_staple_mode, outbin11_error_info=outbin11_error_info, fax_proc_sub=fax_proc_sub, job_info_attr_14=job_info_attr_14, media8_engine_media_mode=media8_engine_media_mode, simm2_bank2_capacity=simm2_bank2_capacity, file_system4_initialize_volume=file_system4_initialize_volume, engine_media_modes_supported1=engine_media_modes_supported1, outbin1=outbin1, held_job_control=held_job_control, default_scan_heavy_media_mode=default_scan_heavy_media_mode, channel_bytes_received=channel_bytes_received, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, tray7_phd=tray7_phd, outbin7_maximum_binding=outbin7_maximum_binding, remote_upgrade_enable=remote_upgrade_enable, simm3_bank=simm3_bank, tray1_phd=tray1_phd, simm2_type=simm2_type, media5_engine_media_mode=media5_engine_media_mode, error40=error40, PYSNMP_MODULE_ID=hp, job_info_attr_8=job_info_attr_8, upgradable_devices_max_write_count=upgradable_devices_max_write_count, channel_bytes_sent=channel_bytes_sent, outbin10_phd=outbin10_phd, media11=media11, rpc_bind_protocol_address=rpc_bind_protocol_address, settings_scanner=settings_scanner, accounting=accounting, error4=error4, mio3=mio3, default_vmi=default_vmi, error22=error22, outbin5_error_info=outbin5_error_info, interface=interface, current_job_parsing_id=current_job_parsing_id, simm2_bank2_type=simm2_bank2_type, error1_time_stamp=error1_time_stamp, model_name=model_name, error20=error20, settings_intray=settings_intray, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, firmware_download_write_time=firmware_download_write_time, id=id, active_print_jobs=active_print_jobs, self_test=self_test, media15_engine_media_mode=media15_engine_media_mode, media17_short_name=media17_short_name, job_info_pages_in_original=job_info_pages_in_original, scanner_accessory_copy_job_scan_count=scanner_accessory_copy_job_scan_count, error33_time_stamp=error33_time_stamp, outbin12_override_mode=outbin12_override_mode, error31_time_stamp=error31_time_stamp, override_media_size=override_media_size, outbin8_maximum_binding=outbin8_maximum_binding, simm1=simm1, consumable_status_page_count_a3_ledger=consumable_status_page_count_a3_ledger, error13_time_stamp=error13_time_stamp, default_vertical_black_resolution=default_vertical_black_resolution, error39=error39, media4_name=media4_name, simm3_type=simm3_type, job_info_attr_10=job_info_attr_10, outbin7_phd=outbin7_phd, consumable_status_cartridge_model=consumable_status_cartridge_model, error31=error31, outbin8=outbin8, phd3_model=phd3_model, source_subsystem=source_subsystem, simm2_bank2=simm2_bank2, error15=error15, media17=media17, media3_page_count=media3_page_count, consumable_status_capacity_units=consumable_status_capacity_units, media18_engine_media_mode=media18_engine_media_mode, printer_accounting=printer_accounting, media10_engine_media_mode=media10_engine_media_mode, media8_short_name=media8_short_name, media8_page_count=media8_page_count, consumable_status_total_capacity=consumable_status_total_capacity, error41_time_stamp=error41_time_stamp, error42_time_stamp=error42_time_stamp, job_info_attr_3=job_info_attr_3, printed_media_usage=printed_media_usage, error23_code=error23_code, job_info_io_source=job_info_io_source, error47_time_stamp=error47_time_stamp, error9=error9, port1_parallel_bidirectionality=port1_parallel_bidirectionality, default_media_name=default_media_name, error18=error18, phd2_manufacturing_info=phd2_manufacturing_info, outbins=outbins, outbin10_override_mode=outbin10_override_mode, error28_time_stamp=error28_time_stamp, settings_copier=settings_copier, media15_short_name=media15_short_name, copy_job_hold_time=copy_job_hold_time, default_copy_duplex_mode=default_copy_duplex_mode, default_copier_edge_to_edge=default_copier_edge_to_edge, simm4_bank1=simm4_bank1, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, resource_manager=resource_manager, media11_engine_media_mode=media11_engine_media_mode, intray=intray, settings_job=settings_job, mio1=mio1, outbin6_phd=outbin6_phd, settings_prt_eng=settings_prt_eng, outbin12_error_info=outbin12_error_info, status_scanner=status_scanner, job_info_state=job_info_state, io_timeout=io_timeout, consumable_status_last_use_date=consumable_status_last_use_date, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, media1_name=media1_name, error35_code=error35_code, usage_instructions_line3=usage_instructions_line3, job_info_requested_originals=job_info_requested_originals, ph_devices=ph_devices, ph2=ph2, error3=error3, mio1_model_name=mio1_model_name, error_log_clear=error_log_clear, default_scan_content_orientation=default_scan_content_orientation, overflow_bin=overflow_bin, error18_time_stamp=error18_time_stamp, default_custom_paper_feed_dim=default_custom_paper_feed_dim, out_marking_agent_processing=out_marking_agent_processing, upgradable_devices_write_count=upgradable_devices_write_count, north_edge_offset=north_edge_offset, simm4_type=simm4_type, usage_scanner_total_charge=usage_scanner_total_charge, error35=error35, settings_file_system=settings_file_system, firmware_download_write_count=firmware_download_write_count, media2_page_count=media2_page_count, phd5_manufacturing_info=phd5_manufacturing_info, mass_storage_resources=mass_storage_resources, firmware_download_name=firmware_download_name, error30_code=error30_code, error10_time_stamp=error10_time_stamp, error25=error25, channel=channel, job_input_auto_continue_mode=job_input_auto_continue_mode, outbin5_phd=outbin5_phd, error14_code=error14_code, consumable_reorder_url=consumable_reorder_url, status_pdl=status_pdl, mio2=mio2, error23_time_stamp=error23_time_stamp, override_media_name=override_media_name, default_scan_background_removal=default_scan_background_removal, printer_average_marking_agent_coverage_sum_squared=printer_average_marking_agent_coverage_sum_squared, error28_code=error28_code, usage_instructions_line4=usage_instructions_line4, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, error43_code=error43_code, job_output_auto_continue_timeout=job_output_auto_continue_timeout)
mibBuilder.exportSymbols("LJ9050mfp-MIB", io=io, form_feed_needed=form_feed_needed, phd5_device_specific_command=phd5_device_specific_command, job_info_pages_printed=job_info_pages_printed, outbin7_override_mode=outbin7_override_mode, asset_number=asset_number, default_copier_page_borders=default_copier_page_borders, error26=error26, error38_code=error38_code, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, ph6=ph6, outbin3_error_info=outbin3_error_info, pdl=pdl, collated_originals_support=collated_originals_support, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, job_being_parsed=job_being_parsed, error45_time_stamp=error45_time_stamp, mio2_model_name=mio2_model_name, firmware_download_maximum_write_count=firmware_download_maximum_write_count, localization_countries_supported=localization_countries_supported)
