...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ6040mfp-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:29 2019
...
Counter32, IpAddress, Integer32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, Counter64, Gauge32, ModuleIdentity, NotificationType, TimeTicks, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "Integer32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "Counter64", "Gauge32", "ModuleIdentity", "NotificationType", "TimeTicks", "Bits", "iso")
...
mibBuilder.exportSymbols("LJ6040mfp-MIB", simm2_bank=simm2_bank, outbin2_maximum_binding=outbin2_maximum_binding, firmware_download_write_status_supported=firmware_download_write_status_supported, held_job_security=held_job_security, media7_name=media7_name, fax_job_control=fax_job_control, non_assured_oht_page_count=non_assured_oht_page_count, media1_engine_media_mode=media1_engine_media_mode, media15_engine_media_mode=media15_engine_media_mode, job_info_attribute=job_info_attribute, error12_time_stamp=error12_time_stamp, printer_cal_cpr_page_count=printer_cal_cpr_page_count, error33_date_time=error33_date_time, overflow_bin=overflow_bin, media14_page_count=media14_page_count, printed_modes_usage_total=printed_modes_usage_total, error44=error44, error25_code=error25_code, media26_name=media26_name, scanned_media_total_charge=scanned_media_total_charge, fw_rom_revision=fw_rom_revision, job_info_physical_outbins_used=job_info_physical_outbins_used, printed_media_color_duplex_count=printed_media_color_duplex_count, error1_code=error1_code, media7_short_name=media7_short_name, form_feed=form_feed, error16_date_time=error16_date_time, error24_time_stamp=error24_time_stamp, error45_date_time=error45_date_time, error48_date_time=error48_date_time, job_info_attr_11=job_info_attr_11, media_modes=media_modes, marking_agent_density=marking_agent_density, error1_time_stamp=error1_time_stamp, phd2_manufacturing_info=phd2_manufacturing_info, simm=simm, media21_name=media21_name, default_custom_paper_feed_dim=default_custom_paper_feed_dim, formatter_serial_number=formatter_serial_number, outbin1_override_mode=outbin1_override_mode, error29_date_time=error29_date_time, file_system_delete_files=file_system_delete_files, media8_engine_media_mode=media8_engine_media_mode, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, error32_time_stamp=error32_time_stamp, error41_date_time=error41_date_time, printer_average=printer_average, error26_code=error26_code, printer_cal_dhalf_page_count=printer_cal_dhalf_page_count, tray5_phd=tray5_phd, error36=error36, error7_time_stamp=error7_time_stamp, simm2=simm2, pdl=pdl, outbin1_maximum_binding=outbin1_maximum_binding, media24=media24, auto_send_reset=auto_send_reset, status_rpc=status_rpc, error6_time_stamp=error6_time_stamp, default_media_size=default_media_size, error48=error48, afax_recv_page_count=afax_recv_page_count, default_vertical_black_resolution=default_vertical_black_resolution, copy_job_auto_interrupt=copy_job_auto_interrupt, error32_date_time=error32_date_time, held_job_enable=held_job_enable, tray2_media_size_loaded=tray2_media_size_loaded, scan_calibration_error=scan_calibration_error, media25=media25, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, error7_code=error7_code, processing_subsystem=processing_subsystem, error35_code=error35_code, error47=error47, media14_short_name=media14_short_name, media15_short_name=media15_short_name, media_size=media_size, input_tray_auto_select=input_tray_auto_select, custom_paper_feed_dim=custom_paper_feed_dim, outbin1_phd=outbin1_phd, supply_override_activated_level=supply_override_activated_level, job_info_pages_printed=job_info_pages_printed, background_message3=background_message3, active_print_jobs=active_print_jobs, job_info_pages_in_original=job_info_pages_in_original, tray_disable_use_instead=tray_disable_use_instead, cartridge_out_override_control=cartridge_out_override_control, printed_media_color_dimplex_count=printed_media_color_dimplex_count, rpc_bound_protocol_address=rpc_bound_protocol_address, media_info=media_info, phd2_capacity=phd2_capacity, host_application_available_memory=host_application_available_memory, hp=hp, usb_host_supported=usb_host_supported, media2_name=media2_name, firmware_download_write_time=firmware_download_write_time, error17_code=error17_code, media18=media18, error35_time_stamp=error35_time_stamp, background_status_msg_line3_part1=background_status_msg_line3_part1, default_staple_mode=default_staple_mode, held_job_quantity=held_job_quantity, media12=media12, file_system2_initialize_volume=file_system2_initialize_volume, perm_store_init_occurred=perm_store_init_occurred, settings_file_system=settings_file_system, default_scan_background_removal=default_scan_background_removal, media26_short_name=media26_short_name, status_scanner=status_scanner, duplex_blank_pages=duplex_blank_pages, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, faxjob=faxjob, media26_engine_media_mode=media26_engine_media_mode, media10=media10, error39=error39, background_status_msg_line4_part1=background_status_msg_line4_part1, error8=error8, error28_time_stamp=error28_time_stamp, default_vmi=default_vmi, usb_device_kind=usb_device_kind, job_info_stage=job_info_stage, settings_copier=settings_copier, background_status_msg_higher_priority=background_status_msg_higher_priority, tray1_media_size_loaded=tray1_media_size_loaded, supply_out_user_configured_override2_limit=supply_out_user_configured_override2_limit, spooler=spooler, pdl_pcl=pdl_pcl, display=display, held_job_delete=held_job_delete, file_system=file_system, mass_storage_block_driver=mass_storage_block_driver, error46_code=error46_code, held_job_info=held_job_info, scanner_accounting=scanner_accounting, error20_code=error20_code, error27_time_stamp=error27_time_stamp, error45=error45, held_job_set_queue_size=held_job_set_queue_size, asset_number=asset_number, error6_date_time=error6_date_time, error19_time_stamp=error19_time_stamp, error14_date_time=error14_date_time, auto_continue=auto_continue, faxjob_tx_status=faxjob_tx_status, scan_calibration_download=scan_calibration_download, ports=ports, form_feed_needed=form_feed_needed, device_used_while_cartridge_out_override_active=device_used_while_cartridge_out_override_active, error14=error14, settings_outbin=settings_outbin, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, media18_short_name=media18_short_name, print_media=print_media, job_info_size=job_info_size, consumable_status_web_service_access_data=consumable_status_web_service_access_data, consumable_string_information=consumable_string_information, error2=error2, error21_code=error21_code, default_media_name=default_media_name, media8_page_count=media8_page_count, error7_date_time=error7_date_time, error44_time_stamp=error44_time_stamp, job_info_attr_1=job_info_attr_1, error48_code=error48_code, source_tray_usage=source_tray_usage, job_info_requested_originals=job_info_requested_originals, media7=media7, media6=media6, scanner_accessory_digital_send_log_event_counter=scanner_accessory_digital_send_log_event_counter, job_info_change_id=job_info_change_id, postscript_total_page_count=postscript_total_page_count, mass_storage_resource_changed=mass_storage_resource_changed, job_info_attr_13=job_info_attr_13, job_info_accounting_scanned_media_duplex_count=job_info_accounting_scanned_media_duplex_count, error40=error40, error4_date_time=error4_date_time, media15_page_count=media15_page_count, device_configure=device_configure, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, total_color_page_count=total_color_page_count, media13_page_count=media13_page_count, media9_name=media9_name, error49_time_stamp=error49_time_stamp, usage_average_toner_coverage=usage_average_toner_coverage, default_mfp_color_space=default_mfp_color_space, error2_code=error2_code, phd2_model=phd2_model, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, error22=error22, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, remote_upgrade_enable=remote_upgrade_enable, not_ready_source_scanner=not_ready_source_scanner, simm2_bank2_type=simm2_bank2_type, mio=mio, intray6=intray6, reprint=reprint, default_copies=default_copies, duplex_page_count=duplex_page_count, phd2=phd2, default_lines_per_page=default_lines_per_page, settings_scanner=settings_scanner, error22_date_time=error22_date_time, default_copy_job_chromaticity=default_copy_job_chromaticity, mass_storage_resource_change_counter=mass_storage_resource_change_counter, printed_modes_accounting=printed_modes_accounting, error_log_clear=error_log_clear, media_counts=media_counts, printed_media_usage=printed_media_usage, media26=media26, usage_staple_count=usage_staple_count, media3_short_name=media3_short_name, media13=media13, error32_code=error32_code, media25_name=media25_name, media1_page_count=media1_page_count, media1=media1, usage_printer_total_charge=usage_printer_total_charge, media13_short_name=media13_short_name, media13_engine_media_mode=media13_engine_media_mode, error24_date_time=error24_date_time, postscript_defer_media=postscript_defer_media, default_scan_text_graphics_mix=default_scan_text_graphics_mix, job_info_accounting_black_dots=job_info_accounting_black_dots, usb_manufacturer_name=usb_manufacturer_name, marking_agent_midtones_density_setting=marking_agent_midtones_density_setting, scanned_media_duplex_count=scanned_media_duplex_count, error28=error28, error36_code=error36_code, media2_engine_media_mode=media2_engine_media_mode, localization_languages_supported=localization_languages_supported, device_configure_printer_parameters=device_configure_printer_parameters, display_status=display_status, settings_pdl=settings_pdl, error49_date_time=error49_date_time, error29=error29, job_info_page_count_current_original=job_info_page_count_current_original, media2_page_count=media2_page_count, printed_media_color_total_count=printed_media_color_total_count, printer_calibration_cpr=printer_calibration_cpr, media9=media9, tray3_media_size_loaded=tray3_media_size_loaded, web_server_url=web_server_url, error11_date_time=error11_date_time, tray2_phd=tray2_phd, custom_paper_xfeed_dim=custom_paper_xfeed_dim, outbin=outbin, resource_manager=resource_manager, error37_time_stamp=error37_time_stamp, device=device, media16=media16, error38_code=error38_code, intray5=intray5, job_info_accounting_color_usage_log=job_info_accounting_color_usage_log)
mibBuilder.exportSymbols("LJ6040mfp-MIB", simm2_bank2_capacity=simm2_bank2_capacity, error36_time_stamp=error36_time_stamp, source_tray_usage_total=source_tray_usage_total, media25_short_name=media25_short_name, job_info_attr_15=job_info_attr_15, media8_short_name=media8_short_name, media12_name=media12_name, simm1_capacity=simm1_capacity, media4_name=media4_name, media6_name=media6_name, default_copy_reset_timeout=default_copy_reset_timeout, file_system4=file_system4, web_server=web_server, error40_date_time=error40_date_time, error30_time_stamp=error30_time_stamp, error5=error5, outbin2_phd=outbin2_phd, printed_media_total_charge=printed_media_total_charge, outbins=outbins, error3_time_stamp=error3_time_stamp, default_copier_flip_pages_up=default_copier_flip_pages_up, media23_page_count=media23_page_count, error12_code=error12_code, media11=media11, port1_parallel_speed=port1_parallel_speed, printer_cal_cpr_data=printer_cal_cpr_data, media3_engine_media_mode=media3_engine_media_mode, media9_short_name=media9_short_name, error34_time_stamp=error34_time_stamp, error13_time_stamp=error13_time_stamp, media11_engine_media_mode=media11_engine_media_mode, file_system3_initialize_volume=file_system3_initialize_volume, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, media24_name=media24_name, job_info_accounting_finishing_options=job_info_accounting_finishing_options, error16=error16, error30=error30, usage_instructions_line2=usage_instructions_line2, media21_page_count=media21_page_count, held_job_print=held_job_print, media22_name=media22_name, job_info=job_info, background_message1=background_message1, model_number=model_number, media17_name=media17_name, media9_engine_media_mode=media9_engine_media_mode, consumable_pages_printed_with_supply=consumable_pages_printed_with_supply, media23=media23, error31_time_stamp=error31_time_stamp, media13_name=media13_name, error4=error4, media18_page_count=media18_page_count, media20_engine_media_mode=media20_engine_media_mode, default_authentication_timeout=default_authentication_timeout, mio1_manufacturing_info=mio1_manufacturing_info, media10_engine_media_mode=media10_engine_media_mode, media19_name=media19_name, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, firmware_download_current_state=firmware_download_current_state, default_custom_paper_dim_unit=default_custom_paper_dim_unit, copy_job_interrupt_copy_jobs=copy_job_interrupt_copy_jobs, copier_media_type=copier_media_type, error47_date_time=error47_date_time, settings_job=settings_job, default_horizontal_black_resolution=default_horizontal_black_resolution, marking_agent_highlights_density_setting=marking_agent_highlights_density_setting, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, error11=error11, error21_time_stamp=error21_time_stamp, media3_page_count=media3_page_count, media24_page_count=media24_page_count, error42_time_stamp=error42_time_stamp, error24_code=error24_code, error50_code=error50_code, simm1=simm1, first_copy_speed=first_copy_speed, error6_code=error6_code, mio4=mio4, error3_date_time=error3_date_time, error21=error21, mio1=mio1, error10=error10, job_info_outbins_used=job_info_outbins_used, print_meter=print_meter, printer_calibration_dhalf=printer_calibration_dhalf, pcl_default_font_height=pcl_default_font_height, error44_date_time=error44_date_time, job_info_state=job_info_state, job_info_printed_originals=job_info_printed_originals, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, energy_star=energy_star, media_types=media_types, media10_name=media10_name, media17_engine_media_mode=media17_engine_media_mode, error43_code=error43_code, faxjob_tx_count=faxjob_tx_count, default_copy_input_tray=default_copy_input_tray, error42_date_time=error42_date_time, model_name=model_name, settings_rpc=settings_rpc, webserver_proc_sub=webserver_proc_sub, media5_name=media5_name, media12_engine_media_mode=media12_engine_media_mode, scanner_accessory_adf_sheet_count=scanner_accessory_adf_sheet_count, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, scan_sharpening_coefficient=scan_sharpening_coefficient, finisher_image_rotation=finisher_image_rotation, simm1_bank=simm1_bank, error2_time_stamp=error2_time_stamp, default_scan_job_mode=default_scan_job_mode, default_reset_send_timeout=default_reset_send_timeout, media6_short_name=media6_short_name, tray3_phd=tray3_phd, mass_storage_resources=mass_storage_resources, error19_date_time=error19_date_time, copy_job_hold_off_print_jobs=copy_job_hold_off_print_jobs, mio4_model_name=mio4_model_name, printed_modes_total_count=printed_modes_total_count, media20=media20, error41=error41, media_size_count=media_size_count, scanner_accessory_adf_one_sided_sheet_count=scanner_accessory_adf_one_sided_sheet_count, interface=interface, error26_date_time=error26_date_time, printed_media_color_usage=printed_media_color_usage, usage_instructions_line1=usage_instructions_line1, job_info_pages_processed=job_info_pages_processed, error33_time_stamp=error33_time_stamp, media11_name=media11_name, job_input_auto_continue_mode=job_input_auto_continue_mode, fax_proc_sub=fax_proc_sub, consumable_status=consumable_status, settings_system=settings_system, show_address=show_address, marking_agent_density_setting=marking_agent_density_setting, usage_scanner_total_charge=usage_scanner_total_charge, tray_prompt=tray_prompt, printed_modes_mono_count=printed_modes_mono_count, scanner_accessory_digital_send_home_screen_status=scanner_accessory_digital_send_home_screen_status, media22_engine_media_mode=media22_engine_media_mode, job_info_name2=job_info_name2, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, supply_out_action_support=supply_out_action_support, printed_media_simplex_charge=printed_media_simplex_charge, background_status_msg_line1_part1=background_status_msg_line1_part1, pysmi_continue=pysmi_continue, error50_date_time=error50_date_time, usb=usb, media19_engine_media_mode=media19_engine_media_mode, sleep_mode=sleep_mode, operating_system=operating_system, error38=error38, serial_number=serial_number, upgradable_devices_name=upgradable_devices_name, settings_spooler=settings_spooler, simm1_bank2_type=simm1_bank2_type, error5_time_stamp=error5_time_stamp, job=job, usb_product_id=usb_product_id, default_copier_media_size=default_copier_media_size, upgradable_devices=upgradable_devices, media17=media17, error42_code=error42_code, consumables=consumables, error6=error6, job_info_attr_5=job_info_attr_5, mio4_manufacturing_info=mio4_manufacturing_info, printed_media_color_simplex_count=printed_media_color_simplex_count, color_supply_out_action=color_supply_out_action, id=id, error3=error3, media22_short_name=media22_short_name, scanner_accessory_send_job_scan_count=scanner_accessory_send_job_scan_count, error18_date_time=error18_date_time, media_number_of_type_supported=media_number_of_type_supported, error31=error31, supply_out_device_state=supply_out_device_state, usage_printer_color_total_charge=usage_printer_color_total_charge, printed_media_combined_total=printed_media_combined_total, media23_short_name=media23_short_name, hold_job_timeout=hold_job_timeout, error26=error26, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, error34_code=error34_code, intray7=intray7, install_date=install_date, job_info_outcome=job_info_outcome, simm2_bank1_capacity=simm2_bank1_capacity, status_mass_storage_bd=status_mass_storage_bd, error9_date_time=error9_date_time, error28_code=error28_code, default_scanner_speed=default_scanner_speed, file_system_max_open_files=file_system_max_open_files, media12_short_name=media12_short_name, printer_average_marking_agent_coverage_sum=printer_average_marking_agent_coverage_sum, upgradable_devices_write_time=upgradable_devices_write_time, print_engine=print_engine, printed_modes_color_count=printed_modes_color_count, error27_date_time=error27_date_time, default_copier_edge_to_edge=default_copier_edge_to_edge, tray1_phd=tray1_phd, mono_color_switching_mode=mono_color_switching_mode, error10_date_time=error10_date_time, media12_page_count=media12_page_count, settings_prt_eng=settings_prt_eng, error23_date_time=error23_date_time, job_info_attr_2=job_info_attr_2, print_engine_revision=print_engine_revision, mio1_model_name=mio1_model_name, media5_engine_media_mode=media5_engine_media_mode, printer_cal_cpr_utc=printer_cal_cpr_utc, held_job_pin=held_job_pin, media8=media8, error22_code=error22_code, upgradable_devices_version=upgradable_devices_version, pcl_total_page_count=pcl_total_page_count, error49_code=error49_code, consumables_1=consumables_1, fw_rom_datecode=fw_rom_datecode, port1_parallel_bidirectionality=port1_parallel_bidirectionality, error4_code=error4_code, held_job_job_name=held_job_job_name, consumable_status_web_service_access_control=consumable_status_web_service_access_control, error29_code=error29_code, media3_name=media3_name, DisplayString=DisplayString, device_location=device_location, supply_out_user_configured_override_limit=supply_out_user_configured_override_limit, direct_connect_ports_enable=direct_connect_ports_enable, settings_intray=settings_intray, error50_time_stamp=error50_time_stamp, io=io, error22_time_stamp=error22_time_stamp, printer_cal_dhalf_data1=printer_cal_dhalf_data1, error7=error7, media16_name=media16_name, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, job_info_accounting_scanned_media_simplex_count=job_info_accounting_scanned_media_simplex_count, phd2_type=phd2_type, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, simm1_type=simm1_type, error35_date_time=error35_date_time, file_systems=file_systems, current_job_parsing_id=current_job_parsing_id, usb_serial_number=usb_serial_number, error11_time_stamp=error11_time_stamp, ram_disk_mode=ram_disk_mode, maximum_ram_disk_memory=maximum_ram_disk_memory, printer_average_marking_agent_coverage_sum_squared=printer_average_marking_agent_coverage_sum_squared, consumables_life=consumables_life, printed_media_duplex_count=printed_media_duplex_count, service_id=service_id, media10_short_name=media10_short_name, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual)
mibBuilder.exportSymbols("LJ6040mfp-MIB", background_message2=background_message2, error37_date_time=error37_date_time, marking_agent=marking_agent, settings_print_media=settings_print_media, error40_code=error40_code, job_info_attr_3=job_info_attr_3, north_edge_offset=north_edge_offset, media2_short_name=media2_short_name, media20_short_name=media20_short_name, status_system=status_system, job_info_attr_4=job_info_attr_4, error45_code=error45_code, job_input_auto_continue_timeout=job_input_auto_continue_timeout, upgradeable_devices_generic_name=upgradeable_devices_generic_name, destination_bin_usage_count=destination_bin_usage_count, media21_engine_media_mode=media21_engine_media_mode, printed_modes_usage=printed_modes_usage, source_tray_usage_count=source_tray_usage_count, intray1=intray1, error33_code=error33_code, simm1_bank1_capacity=simm1_bank1_capacity, error37_code=error37_code, job_info_accounting_media_type=job_info_accounting_media_type, error9=error9, page_frame_memory_available=page_frame_memory_available, destination_bin_usage=destination_bin_usage, collated_originals_support=collated_originals_support, error2_date_time=error2_date_time, file_system3=file_system3, printer_cal_dhalf_data2=printer_cal_dhalf_data2, printed_media_simplex_count=printed_media_simplex_count, destination_subsystem=destination_subsystem, accounting=accounting, source_tray_accounting=source_tray_accounting, default_scan_original_size=default_scan_original_size, error47_time_stamp=error47_time_stamp, media4_short_name=media4_short_name, clearable_warning=clearable_warning, control_panel_display_contents_crc=control_panel_display_contents_crc, simm2_capacity=simm2_capacity, upgradable_devices_current_state=upgradable_devices_current_state, default_copy_output_bin=default_copy_output_bin, scanner_accessory_digital_send_config_ldap_gateway=scanner_accessory_digital_send_config_ldap_gateway, media11_short_name=media11_short_name, error15=error15, media14=media14, background_message=background_message, error41_code=error41_code, error5_code=error5_code, media19=media19, default_scan_image_quality=default_scan_image_quality, scan_to_folder_count=scan_to_folder_count, control_panel_display_graphical_contents=control_panel_display_graphical_contents, supply_after_out_state=supply_after_out_state, source_subsystem=source_subsystem, media3=media3, error16_time_stamp=error16_time_stamp, error43_date_time=error43_date_time, error26_time_stamp=error26_time_stamp, error34=error34, job_info_name1=job_info_name1, error46=error46, error11_code=error11_code, ph=ph, error49=error49, postscript_print_errors=postscript_print_errors, printer_cal_dhalf_utc=printer_cal_dhalf_utc, error17=error17, error19_code=error19_code, mopy_mode=mopy_mode, io_timeout=io_timeout, error20=error20, error28_date_time=error28_date_time, error5_date_time=error5_date_time, media8_name=media8_name, remote_procedure_call=remote_procedure_call, status_fax_proc_sub=status_fax_proc_sub, tray6_media_size_loaded=tray6_media_size_loaded, error31_date_time=error31_date_time, error46_time_stamp=error46_time_stamp, error40_time_stamp=error40_time_stamp, default_audible_feedback=default_audible_feedback, errorlog=errorlog, media10_page_count=media10_page_count, error50=error50, simm1_bank1_type=simm1_bank1_type, media5=media5, job_info_attr_10=job_info_attr_10, copy_job_hold_time=copy_job_hold_time, tray7_media_size_loaded=tray7_media_size_loaded, outbin1_error_info=outbin1_error_info, media7_engine_media_mode=media7_engine_media_mode, media9_page_count=media9_page_count, consumable_reorder_url=consumable_reorder_url, device_system=device_system, usb_driver_name=usb_driver_name, mio1_type=mio1_type, engine_self_diagnostic=engine_self_diagnostic, intray3=intray3, held_job_control=held_job_control, cancel_job=cancel_job, error20_date_time=error20_date_time, media17_page_count=media17_page_count, error35=error35, media26_page_count=media26_page_count, copier=copier, marking_agent_shadows_density_setting=marking_agent_shadows_density_setting, media6_engine_media_mode=media6_engine_media_mode, simm1_bank1=simm1_bank1, scanner_accessory_digital_send_config_email_gateway=scanner_accessory_digital_send_config_email_gateway, consumable_string_information_reset=consumable_string_information_reset, settings_marking_agent=settings_marking_agent, error29_time_stamp=error29_time_stamp, media24_short_name=media24_short_name, pdl_postscript=pdl_postscript, settings_ph=settings_ph, scanner_accessory_digital_send_config_fax_embedded=scanner_accessory_digital_send_config_fax_embedded, job_output_auto_continue_timeout=job_output_auto_continue_timeout, background_message4=background_message4, control_panel_button_press=control_panel_button_press, error27=error27, test=test, error19=error19, media18_name=media18_name, media25_page_count=media25_page_count, error4_time_stamp=error4_time_stamp, error12=error12, scanner_accessory_flatbed_scan_count=scanner_accessory_flatbed_scan_count, imaging=imaging, held_job=held_job, intray2=intray2, printed_media_duplex_charge=printed_media_duplex_charge, scanner_accessory_copy_job_scan_count=scanner_accessory_copy_job_scan_count, media24_engine_media_mode=media24_engine_media_mode, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, scanner_accessory_digital_send_status=scanner_accessory_digital_send_status, default_copier_quantity=default_copier_quantity, error37=error37, pcl_default_font_number=pcl_default_font_number, os_execute_file=os_execute_file, media4=media4, default_copier_page_borders=default_copier_page_borders, media19_short_name=media19_short_name, intray=intray, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, localization_countries_supported=localization_countries_supported, error16_code=error16_code, job_info_attr_12=job_info_attr_12, error14_code=error14_code, firmware_download=firmware_download, job_info_attr_16=job_info_attr_16, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, job_info_accounting=job_info_accounting, consumable_status_page_count_envelope=consumable_status_page_count_envelope, error39_time_stamp=error39_time_stamp, job_info_io_source=job_info_io_source, print_internal_page=print_internal_page, afax_send_page_count=afax_send_page_count, error24=error24, job_info_accounting_media_size=job_info_accounting_media_size, media_names_available=media_names_available, configurable_low_threshold_setting=configurable_low_threshold_setting, error44_code=error44_code, media21_short_name=media21_short_name, job_info_attr_6=job_info_attr_6, printer_color_accounting=printer_color_accounting, error31_code=error31_code, rpc_bind_protocol_address=rpc_bind_protocol_address, error46_date_time=error46_date_time, media23_engine_media_mode=media23_engine_media_mode, settings_io=settings_io, printer_cal_dhalf_data=printer_cal_dhalf_data, usb_interface=usb_interface, media4_page_count=media4_page_count, outbin1=outbin1, mio4_type=mio4_type, simm1_bank2=simm1_bank2, media18_engine_media_mode=media18_engine_media_mode, error48_time_stamp=error48_time_stamp, pcl_default_font_source=pcl_default_font_source, device_name=device_name, scanner_accessory_digital_send_config_dsm_enabled_fax=scanner_accessory_digital_send_config_dsm_enabled_fax, error43=error43, held_job_user_name=held_job_user_name, status_prt_eng=status_prt_eng, settings_mass_storage_bd=settings_mass_storage_bd, scanner_accessory_digital_send_module_url=scanner_accessory_digital_send_module_url, settings_fax_proc_sub=settings_fax_proc_sub, error32=error32, job_info_accounting_job_type=job_info_accounting_job_type, error23_time_stamp=error23_time_stamp, error43_time_stamp=error43_time_stamp, simm2_bank1=simm2_bank1, error25_date_time=error25_date_time, override_media_size=override_media_size, destination_bin_usage_total=destination_bin_usage_total, pcl_default_font_width=pcl_default_font_width, media22_page_count=media22_page_count, error9_code=error9_code, held_job_retention=held_job_retention, error38_time_stamp=error38_time_stamp, error38_date_time=error38_date_time, error39_code=error39_code, error15_date_time=error15_date_time, default_copy_duplex_mode=default_copy_duplex_mode, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, media5_short_name=media5_short_name, error25=error25, outbin2_override_mode=outbin2_override_mode, media20_name=media20_name, scanned_media_simplex_charge=scanned_media_simplex_charge, error14_time_stamp=error14_time_stamp, consumable_life_usage_units=consumable_life_usage_units, error17_time_stamp=error17_time_stamp, media14_name=media14_name, usb_product_description=usb_product_description, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, error9_time_stamp=error9_time_stamp, error15_time_stamp=error15_time_stamp, media16_engine_media_mode=media16_engine_media_mode, fax_number_confirmation=fax_number_confirmation, web_server_security=web_server_security, error17_date_time=error17_date_time, media2=media2, error47_code=error47_code, media16_page_count=media16_page_count, usb_vendor_id=usb_vendor_id, media7_page_count=media7_page_count, firmware_download_version=firmware_download_version, scanner_accessory_total_copy_pages_printed=scanner_accessory_total_copy_pages_printed, supplies_replace_action_at_setting=supplies_replace_action_at_setting, ram_disk_size=ram_disk_size, media11_page_count=media11_page_count, error10_code=error10_code, media4_engine_media_mode=media4_engine_media_mode, error12_date_time=error12_date_time, media5_page_count=media5_page_count, settings_webserver=settings_webserver, file_system4_initialize_volume=file_system4_initialize_volume, error18=error18, media15=media15, faxjob_rx_count=faxjob_rx_count, marker_density_calibration=marker_density_calibration, tray7_phd=tray7_phd, default_scan_content_orientation=default_scan_content_orientation, error34_date_time=error34_date_time, intrays=intrays, scanner_accessory_adf_two_sided_sheet_count=scanner_accessory_adf_two_sided_sheet_count, job_info_attr_14=job_info_attr_14, scanned_media_usage=scanned_media_usage, tray5_media_size_loaded=tray5_media_size_loaded, job_info_attr_7=job_info_attr_7, status_pdl=status_pdl)
mibBuilder.exportSymbols("LJ6040mfp-MIB", consumable_status_page_count_a3_ledger=consumable_status_page_count_a3_ledger, control_panel_display=control_panel_display, media15_name=media15_name, media25_engine_media_mode=media25_engine_media_mode, error13=error13, media19_page_count=media19_page_count, error3_code=error3_code, remote_upgrade_version_checking_enable=remote_upgrade_version_checking_enable, media22=media22, error36_date_time=error36_date_time, scanner=scanner, netPMLmgmt=netPMLmgmt, scanned_media_simplex_count=scanned_media_simplex_count, error30_code=error30_code, error10_time_stamp=error10_time_stamp, error18_code=error18_code, tray6_phd=tray6_phd, outbin2_error_info=outbin2_error_info, background_status_msg_line2_part1=background_status_msg_line2_part1, media6_page_count=media6_page_count, error1_date_time=error1_date_time, usage_instructions_line4=usage_instructions_line4, error45_time_stamp=error45_time_stamp, printed_media_dimplex_count=printed_media_dimplex_count, error39_date_time=error39_date_time, media16_short_name=media16_short_name, default_copier_pages_per_sheet=default_copier_pages_per_sheet, override_media_name=override_media_name, default_copier_contrast=default_copier_contrast, phd=phd, consumable_current_state=consumable_current_state, error13_code=error13_code, usage_instructions_line3=usage_instructions_line3, media1_name=media1_name, io_switch=io_switch, engine_media_modes_supported1=engine_media_modes_supported1, error8_code=error8_code, error20_time_stamp=error20_time_stamp, simm2_bank1_type=simm2_bank1_type, error23=error23, error27_code=error27_code, usage_printer_mono_total_charge=usage_printer_mono_total_charge, control_panel_supplies_status_message=control_panel_supplies_status_message, error42=error42, outbin2=outbin2, job_being_parsed=job_being_parsed, error23_code=error23_code, default_copier_collate=default_copier_collate, consumable_string=consumable_string, copy_job_alternative_letterhead_mode=copy_job_alternative_letterhead_mode, destination_bin_accounting=destination_bin_accounting, file_system2=file_system2, consumable_notification_status=consumable_notification_status, error41_time_stamp=error41_time_stamp, fax_job_scan_count=fax_job_scan_count, simm2_bank2=simm2_bank2, error21_date_time=error21_date_time, consumable_life_low_threshold=consumable_life_low_threshold, error8_date_time=error8_date_time, cold_reset_media_size=cold_reset_media_size, error1=error1, error18_time_stamp=error18_time_stamp, job_info_attr_9=job_info_attr_9, media14_engine_media_mode=media14_engine_media_mode, control_panel_key_press=control_panel_key_press, media21=media21, copy_job_scan_ahead=copy_job_scan_ahead, error13_date_time=error13_date_time, error15_code=error15_code, error33=error33, settings_web_server=settings_web_server, engine_parameter=engine_parameter, scanned_media_duplex_charge=scanned_media_duplex_charge, media23_name=media23_name, firmware_download_name=firmware_download_name, on_off_line=on_off_line, printer_accounting=printer_accounting, simm1_bank2_capacity=simm1_bank2_capacity, ews_request_control_panel_supplies_status=ews_request_control_panel_supplies_status, job_info_attr_8=job_info_attr_8, simm2_type=simm2_type, error25_time_stamp=error25_time_stamp, error8_time_stamp=error8_time_stamp, consumables_status=consumables_status, media20_page_count=media20_page_count, faxjob_rx_status=faxjob_rx_status, error30_date_time=error30_date_time, media1_short_name=media1_short_name, default_copier_image_type=default_copier_image_type, media17_short_name=media17_short_name, port1=port1)
