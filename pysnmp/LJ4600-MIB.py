...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ4600-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:21 2019
...
ModuleIdentity, Gauge32, Bits, MibIdentifier, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, TimeTicks, iso, NotificationType, IpAddress, Counter64, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Bits", "MibIdentifier", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "TimeTicks", "iso", "NotificationType", "IpAddress", "Counter64", "Integer32")
...
mibBuilder.exportSymbols("LJ4600-MIB", error1_time_stamp=error1_time_stamp, media20=media20, simm3_bank1_type=simm3_bank1_type, consumables_status=consumables_status, energy_star=energy_star, media18_name=media18_name, error21_time_stamp=error21_time_stamp, error13=error13, settings_marking_agent=settings_marking_agent, simm2_bank1=simm2_bank1, consumable_status_manufacturer_name=consumable_status_manufacturer_name, outbin7_maximum_binding=outbin7_maximum_binding, consumables_life=consumables_life, background_message1=background_message1, file_system2=file_system2, outbin7_phd=outbin7_phd, error5_time_stamp=error5_time_stamp, media32_name=media32_name, mass_storage_resource_changed=mass_storage_resource_changed, error23_time_stamp=error23_time_stamp, error8_code=error8_code, media4=media4, media7=media7, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, simm1=simm1, error24=error24, error43_code=error43_code, consumable_status_info=consumable_status_info, error6_time_stamp=error6_time_stamp, webserver_proc_sub=webserver_proc_sub, error43_time_stamp=error43_time_stamp, simm4_bank2_capacity=simm4_bank2_capacity, media21_page_count=media21_page_count, simm1_bank1_capacity=simm1_bank1_capacity, simm1_capacity=simm1_capacity, simm2_type=simm2_type, port1_parallel_speed=port1_parallel_speed, error28_code=error28_code, media8_short_name=media8_short_name, upgradable_devices_write_time=upgradable_devices_write_time, simm3_capacity=simm3_capacity, error8_time_stamp=error8_time_stamp, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, job_info_change_id=job_info_change_id, outbin12_maximum_binding=outbin12_maximum_binding, job_info_name2=job_info_name2, background_status_msg_line2_part1=background_status_msg_line2_part1, error38=error38, mio2_manufacturing_info=mio2_manufacturing_info, postscript_print_errors=postscript_print_errors, outbin8=outbin8, error47=error47, mio3_model_name=mio3_model_name, simm2_bank1_capacity=simm2_bank1_capacity, consumable_reorder_url=consumable_reorder_url, error5=error5, default_media_name=default_media_name, channelprinteralert=channelprinteralert, job_info_attr_7=job_info_attr_7, ph6=ph6, consumable_status_usage_units=consumable_status_usage_units, printed_media_simplex_count=printed_media_simplex_count, tray1_phd=tray1_phd, error13_time_stamp=error13_time_stamp, mio2_model_name=mio2_model_name, media5_page_count=media5_page_count, channelnumberofchannels=channelnumberofchannels, media19_engine_media_mode=media19_engine_media_mode, error32=error32, error7_code=error7_code, duplex_page_count=duplex_page_count, media17_page_count=media17_page_count, media2_engine_media_mode=media2_engine_media_mode, error4_code=error4_code, device_name=device_name, media10_name=media10_name, printed_media_simplex_charge=printed_media_simplex_charge, consumable_status_engine_job_count=consumable_status_engine_job_count, consumable_status_engine_usage_units=consumable_status_engine_usage_units, settings_system=settings_system, outbin8_maximum_binding=outbin8_maximum_binding, default_vmi=default_vmi, outbin10_error_info=outbin10_error_info, job_info_attr_8=job_info_attr_8, media17_short_name=media17_short_name, firmware_download=firmware_download, usage_instructions_line2=usage_instructions_line2, error3_code=error3_code, channelEntry=channelEntry, media6_name=media6_name, error9_code=error9_code, media21_engine_media_mode=media21_engine_media_mode, mio3_manufacturing_info=mio3_manufacturing_info, media3_page_count=media3_page_count, pdl=pdl, media10_engine_media_mode=media10_engine_media_mode, mio2=mio2, media5_engine_media_mode=media5_engine_media_mode, held_job_print=held_job_print, simm1_bank1_type=simm1_bank1_type, media21=media21, consumable_status_total_page_count=consumable_status_total_page_count, background_message=background_message, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, job_input_auto_continue_mode=job_input_auto_continue_mode, outbin5_override_mode=outbin5_override_mode, outbin6_maximum_binding=outbin6_maximum_binding, north_edge_offset=north_edge_offset, error39_time_stamp=error39_time_stamp, PYSNMP_MODULE_ID=hp, media22_name=media22_name, error12_time_stamp=error12_time_stamp, overflow_bin=overflow_bin, control_panel_display=control_panel_display, job_info_attr_2=job_info_attr_2, id=id, simm1_type=simm1_type, simm5_bank1_capacity=simm5_bank1_capacity, error34=error34, simm5_bank1_type=simm5_bank1_type, tray6_media_size_loaded=tray6_media_size_loaded, media6_short_name=media6_short_name, media23_engine_media_mode=media23_engine_media_mode, settings_print_media=settings_print_media, media20_page_count=media20_page_count, media6_page_count=media6_page_count, media_info=media_info, media14_name=media14_name, error15=error15, settings_webserver=settings_webserver, upgradable_devices_write_count=upgradable_devices_write_count, error10=error10, control_panel_display_graphical_contents=control_panel_display_graphical_contents, socket_ping=socket_ping, media6=media6, error10_time_stamp=error10_time_stamp, media10=media10, outbin1_override_mode=outbin1_override_mode, default_custom_paper_dim_unit=default_custom_paper_dim_unit, simm4_type=simm4_type, print_internal_page=print_internal_page, media14_page_count=media14_page_count, consumable_status_cartridge_model=consumable_status_cartridge_model, pysmi_continue=pysmi_continue, consumable_status_page_count_a3_ledger=consumable_status_page_count_a3_ledger, error21=error21, consumable_status_drum_life=consumable_status_drum_life, printed_media_duplex_count=printed_media_duplex_count, print_engine_revision=print_engine_revision, marking_agent_density_setting=marking_agent_density_setting, error36=error36, outbin3_phd=outbin3_phd, error7_time_stamp=error7_time_stamp, job_being_parsed=job_being_parsed, error32_time_stamp=error32_time_stamp, simm3_bank1_capacity=simm3_bank1_capacity, job_info_attr_6=job_info_attr_6, ph5=ph5, error28_time_stamp=error28_time_stamp, error34_time_stamp=error34_time_stamp, ram_disk_size=ram_disk_size, deviceChannelTable=deviceChannelTable, channelinformation=channelinformation, usage_instructions_line4=usage_instructions_line4, default_page_protect=default_page_protect, status_pdl=status_pdl, mio1=mio1, error29_time_stamp=error29_time_stamp, outbin3=outbin3, settings_io=settings_io, outbin12_error_info=outbin12_error_info, consumable_status_page_count_legal=consumable_status_page_count_legal, media1_name=media1_name, rpc_bind_protocol_address=rpc_bind_protocol_address, job_info_page_count_current_original=job_info_page_count_current_original, error6_code=error6_code, simm4_bank1=simm4_bank1, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, status_prt_eng=status_prt_eng, simm3_bank2=simm3_bank2, error27_time_stamp=error27_time_stamp, outbin5=outbin5, media10_short_name=media10_short_name, resource_manager=resource_manager, ports=ports, error4_time_stamp=error4_time_stamp, spooler=spooler, job_info_requested_originals=job_info_requested_originals, tray1_media_size_loaded=tray1_media_size_loaded, outbin8_override_mode=outbin8_override_mode, error19_time_stamp=error19_time_stamp, file_system=file_system, tables=tables, job_output_auto_continue_timeout=job_output_auto_continue_timeout, ph=ph, error40_time_stamp=error40_time_stamp, consumables_1=consumables_1, media19_name=media19_name, media4_name=media4_name, media23_short_name=media23_short_name, simm4_bank=simm4_bank, intray=intray, outbin5_phd=outbin5_phd, outbin12_phd=outbin12_phd, io_switch=io_switch, error39_code=error39_code, error16_code=error16_code, simm5_capacity=simm5_capacity, simm3=simm3, error26=error26, media32_short_name=media32_short_name, asset_number=asset_number, outbin11_error_info=outbin11_error_info, error31_time_stamp=error31_time_stamp, firmware_download_write_time=firmware_download_write_time, error19_code=error19_code, media14=media14, held_job_job_name=held_job_job_name, source_subsystem=source_subsystem, held_job_user_name=held_job_user_name, consumable_status_drum_life_units=consumable_status_drum_life_units, outbin=outbin, media8_name=media8_name, firmware_download_name=firmware_download_name, pcl_default_font_source=pcl_default_font_source, printer_average_marking_agent_coverage_sum_squared=printer_average_marking_agent_coverage_sum_squared, held_job_info=held_job_info, media15_page_count=media15_page_count, media2=media2, usage_staple_count=usage_staple_count, override_media_size=override_media_size, phd4_device_specific_command=phd4_device_specific_command, error4=error4, outbin9_phd=outbin9_phd, error50_code=error50_code, job_info_size=job_info_size, media13=media13, phd2_device_specific_command=phd2_device_specific_command, outbin5_maximum_binding=outbin5_maximum_binding, outbin7_override_mode=outbin7_override_mode, outbin6_phd=outbin6_phd, error48=error48, outbins=outbins, simm4_bank1_capacity=simm4_bank1_capacity, simm5=simm5, job_info_outcome=job_info_outcome, phd3_device_specific_command=phd3_device_specific_command, error33=error33, phd5_device_specific_command=phd5_device_specific_command, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, outbin4_maximum_binding=outbin4_maximum_binding, form_feed_needed=form_feed_needed, media8_page_count=media8_page_count, media10_page_count=media10_page_count)
mibBuilder.exportSymbols("LJ4600-MIB", self_test=self_test, error28=error28, error41=error41, simm4=simm4, outbin4_phd=outbin4_phd, consumable_status_serial_number=consumable_status_serial_number, error10_code=error10_code, error46_code=error46_code, file_system_delete_files=file_system_delete_files, error49_code=error49_code, media16_engine_media_mode=media16_engine_media_mode, outbin4=outbin4, default_bits_per_pixel=default_bits_per_pixel, error13_code=error13_code, media3_short_name=media3_short_name, media4_page_count=media4_page_count, media2_name=media2_name, consumable_status_total_equiv_page_count=consumable_status_total_equiv_page_count, outbin12=outbin12, error2=error2, job_info_accounting_finishing_options=job_info_accounting_finishing_options, web_server_url=web_server_url, media6_engine_media_mode=media6_engine_media_mode, fw_rom_datecode=fw_rom_datecode, error49=error49, error18_time_stamp=error18_time_stamp, error47_time_stamp=error47_time_stamp, status_rpc=status_rpc, media21_name=media21_name, error35=error35, error34_code=error34_code, error24_time_stamp=error24_time_stamp, control_panel_display_contents_crc=control_panel_display_contents_crc, settings_outbin=settings_outbin, error12=error12, media3=media3, upgradable_devices_name=upgradable_devices_name, simm3_bank2_type=simm3_bank2_type, job_info_attr_1=job_info_attr_1, os_execute_file=os_execute_file, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, file_system4_initialize_volume=file_system4_initialize_volume, printer_accounting=printer_accounting, job_input_auto_continue_timeout=job_input_auto_continue_timeout, outbin5_error_info=outbin5_error_info, channelstatus=channelstatus, channeltype=channeltype, print_density=print_density, error20=error20, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, consumable_status_job_count=consumable_status_job_count, engine_self_diagnostic=engine_self_diagnostic, firmware_download_write_count=firmware_download_write_count, model_name=model_name, error49_time_stamp=error49_time_stamp, intray1=intray1, error40_code=error40_code, channelifindex=channelifindex, clearable_warning=clearable_warning, media7_short_name=media7_short_name, postscript_total_page_count=postscript_total_page_count, simm2_bank=simm2_bank, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, consumable_life_usage_units=consumable_life_usage_units, media_modes=media_modes, job_info_accounting_media_type=job_info_accounting_media_type, outbin3_maximum_binding=outbin3_maximum_binding, media18_short_name=media18_short_name, web_server_security=web_server_security, error24_code=error24_code, ram_disk_mode=ram_disk_mode, error8=error8, media16_name=media16_name, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, simm=simm, simm4_bank2_type=simm4_bank2_type, error23=error23, error19=error19, maximum_ram_disk_memory=maximum_ram_disk_memory, ph2=ph2, consumable_status_page_count_a4_letter=consumable_status_page_count_a4_letter, channel=channel, media1=media1, error3=error3, error25_code=error25_code, simm1_bank=simm1_bank, error11_code=error11_code, error27_code=error27_code, io_timeout=io_timeout, tray3_media_size_loaded=tray3_media_size_loaded, held_job_control=held_job_control, firmware_download_write_status_supported=firmware_download_write_status_supported, held_job_retention=held_job_retention, error35_time_stamp=error35_time_stamp, job=job, job_info_name1=job_info_name1, error38_code=error38_code, job_info_attr_11=job_info_attr_11, channel_mio=channel_mio, simm5_bank=simm5_bank, localization_languages_supported=localization_languages_supported, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, error22=error22, error39=error39, input_tray_auto_select=input_tray_auto_select, media23_name=media23_name, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, media18_page_count=media18_page_count, held_job_enable=held_job_enable, error37=error37, simm1_bank1=simm1_bank1, hp=hp, settings_rpc=settings_rpc, cancel_job=cancel_job, error6=error6, media23_page_count=media23_page_count, error31=error31, settings_spooler=settings_spooler, error36_time_stamp=error36_time_stamp, settings_prt_eng=settings_prt_eng, media19_page_count=media19_page_count, channelprotocolversion=channelprotocolversion, held_job_security=held_job_security, sleep_mode=sleep_mode, error25=error25, error27=error27, media19_short_name=media19_short_name, settings_intray=settings_intray, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, outbin6=outbin6, error21_code=error21_code, consumable_status_color_page_count=consumable_status_color_page_count, accounting=accounting, error9=error9, job_info_accounting=job_info_accounting, error20_code=error20_code, consumable_status_input_option_sheet_count=consumable_status_input_option_sheet_count, simm5_bank2=simm5_bank2, channel_bytes_sent=channel_bytes_sent, error33_time_stamp=error33_time_stamp, deviceChannelEntry=deviceChannelEntry, media14_engine_media_mode=media14_engine_media_mode, on_off_line=on_off_line, error47_code=error47_code, usage_printer_total_charge=usage_printer_total_charge, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, channelTable=channelTable, outbin1=outbin1, outbin9_maximum_binding=outbin9_maximum_binding, held_job_set_queue_size=held_job_set_queue_size, file_systems=file_systems, simm5_bank2_type=simm5_bank2_type, collated_originals_support=collated_originals_support, tray7_phd=tray7_phd, media4_engine_media_mode=media4_engine_media_mode, media8_engine_media_mode=media8_engine_media_mode, localization_countries_supported=localization_countries_supported, printer_average=printer_average, low_marking_agent_processing=low_marking_agent_processing, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, media22_short_name=media22_short_name, device=device, DisplayString=DisplayString, media32_page_count=media32_page_count, form_feed=form_feed, file_system2_initialize_volume=file_system2_initialize_volume, media7_engine_media_mode=media7_engine_media_mode, job_info_io_source=job_info_io_source, media16_short_name=media16_short_name, cold_reset_media_size=cold_reset_media_size, tray2_phd=tray2_phd, processing_subsystem=processing_subsystem, error9_time_stamp=error9_time_stamp, consumable_status_last_use_date=consumable_status_last_use_date, settings_job=settings_job, mio3=mio3, error18=error18, upgradable_devices=upgradable_devices, error48_code=error48_code, file_system_max_open_files=file_system_max_open_files, tray6_phd=tray6_phd, outbin3_error_info=outbin3_error_info, settings_mass_storage_bd=settings_mass_storage_bd, media20_name=media20_name, error42_code=error42_code, consumable_status_developer_life_units=consumable_status_developer_life_units, simm5_bank2_capacity=simm5_bank2_capacity, simm3_type=simm3_type, media9_engine_media_mode=media9_engine_media_mode, error42=error42, tray2_media_size_loaded=tray2_media_size_loaded, error22_code=error22_code, consumable_status_page_count_third_speed=consumable_status_page_count_third_speed, media17_name=media17_name, job_info_attr_13=job_info_attr_13, active_print_jobs=active_print_jobs, error42_time_stamp=error42_time_stamp, outbin4_error_info=outbin4_error_info, host_application_available_memory=host_application_available_memory, media14_short_name=media14_short_name, status_mass_storage_bd=status_mass_storage_bd, outbin6_error_info=outbin6_error_info, media3_name=media3_name, phd6_device_specific_command=phd6_device_specific_command, error30_code=error30_code, device_location=device_location, io=io, mass_storage_resource_change_counter=mass_storage_resource_change_counter, engine_media_modes_supported1=engine_media_modes_supported1, job_info_attr_9=job_info_attr_9, error25_time_stamp=error25_time_stamp, default_vertical_black_resolution=default_vertical_black_resolution, job_info_attribute=job_info_attribute, simm2=simm2, service_id=service_id, pdl_pcl=pdl_pcl, tray7_media_size_loaded=tray7_media_size_loaded, background_status_msg_line1_part1=background_status_msg_line1_part1, job_info_physical_outbins_used=job_info_physical_outbins_used, media3_engine_media_mode=media3_engine_media_mode, simm2_bank2_type=simm2_bank2_type, simm1_bank2_capacity=simm1_bank2_capacity, simm4_bank1_type=simm4_bank1_type, mass_storage_resources=mass_storage_resources, serial_number=serial_number, default_lines_per_page=default_lines_per_page, outbin9_error_info=outbin9_error_info, test=test, consumable_status_page_count_quarter_speed=consumable_status_page_count_quarter_speed, upgradable_devices_max_write_count=upgradable_devices_max_write_count, job_info_accounting_job_type=job_info_accounting_job_type, error35_code=error35_code, simm4_capacity=simm4_capacity, media_names_available=media_names_available, media22_page_count=media22_page_count, total_color_page_count=total_color_page_count, media7_page_count=media7_page_count, media17=media17, upgradable_devices_current_state=upgradable_devices_current_state, media23=media23, error40=error40, mio=mio, background_message2=background_message2, interface=interface, error1_code=error1_code, job_info_pages_printed=job_info_pages_printed, install_date=install_date, simm5_bank1=simm5_bank1, mio1_type=mio1_type, media32_engine_media_mode=media32_engine_media_mode, intrays=intrays, error48_time_stamp=error48_time_stamp, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, socket_ping_job_events_version=socket_ping_job_events_version)
mibBuilder.exportSymbols("LJ4600-MIB", input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, current_job_parsing_id=current_job_parsing_id, printed_media_duplex_charge=printed_media_duplex_charge, error14_time_stamp=error14_time_stamp, remote_procedure_call=remote_procedure_call, job_info_stage=job_info_stage, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, usage_instructions_line1=usage_instructions_line1, job_info_attr_4=job_info_attr_4, media13_name=media13_name, file_system3=file_system3, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, outbin3_override_mode=outbin3_override_mode, simm3_bank1=simm3_bank1, outbin10_phd=outbin10_phd, error32_code=error32_code, marking_agent=marking_agent, media18_engine_media_mode=media18_engine_media_mode, control_panel_button_press=control_panel_button_press, error18_code=error18_code, operating_system=operating_system, error29=error29, printed_media_usage=printed_media_usage, media1_page_count=media1_page_count, reprint=reprint, media16=media16, channel_jobs_received=channel_jobs_received, outbin12_override_mode=outbin12_override_mode, media22_engine_media_mode=media22_engine_media_mode, error2_time_stamp=error2_time_stamp, consumable_status=consumable_status, auto_continue=auto_continue, channel_bytes_received=channel_bytes_received, media9_name=media9_name, consumable_status_reseller_id=consumable_status_reseller_id, printed_media_total_charge=printed_media_total_charge, media9=media9, consumable_status_usage_count=consumable_status_usage_count, mio2_type=mio2_type, media2_page_count=media2_page_count, error30_time_stamp=error30_time_stamp, simm5_type=simm5_type, firmware_download_current_state=firmware_download_current_state, error17_time_stamp=error17_time_stamp, error46_time_stamp=error46_time_stamp, consumable_status_total_capacity=consumable_status_total_capacity, media15_engine_media_mode=media15_engine_media_mode, simm4_bank2=simm4_bank2, device_system=device_system, out_marking_agent_processing=out_marking_agent_processing, job_info_printed_originals=job_info_printed_originals, media13_short_name=media13_short_name, error_log_clear=error_log_clear, job_info_attr_15=job_info_attr_15, error2_code=error2_code, hold_job_timeout=hold_job_timeout, media5_name=media5_name, model_number=model_number, media_size_count=media_size_count, media_size=media_size, media2_short_name=media2_short_name, error38_time_stamp=error38_time_stamp, ph3=ph3, error17_code=error17_code, error36_code=error36_code, job_info_accounting_media_size=job_info_accounting_media_size, outbin8_error_info=outbin8_error_info, intray7=intray7, error14_code=error14_code, consumables=consumables, outbin11=outbin11, media5_short_name=media5_short_name, settings_pdl=settings_pdl, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, simm3_bank2_capacity=simm3_bank2_capacity, media20_engine_media_mode=media20_engine_media_mode, error17=error17, job_info=job_info, error46=error46, port1=port1, media16_page_count=media16_page_count, consumable_status_first_install_date=consumable_status_first_install_date, error41_code=error41_code, printer_average_marking_agent_coverage_sum=printer_average_marking_agent_coverage_sum, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, error44_code=error44_code, file_system4=file_system4, media1_engine_media_mode=media1_engine_media_mode, pdl_postscript=pdl_postscript, consumable_status_duplex_sheet_count=consumable_status_duplex_sheet_count, status_system=status_system, error15_code=error15_code, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, error41_time_stamp=error41_time_stamp, simm2_bank2_capacity=simm2_bank2_capacity, error26_code=error26_code, perm_store_init_occurred=perm_store_init_occurred, error5_code=error5_code, held_job_delete=held_job_delete, consumable_status_engine_usage_count=consumable_status_engine_usage_count, intray2=intray2, outbin10_maximum_binding=outbin10_maximum_binding, error44_time_stamp=error44_time_stamp, held_job_pin=held_job_pin, media9_page_count=media9_page_count, media21_short_name=media21_short_name, job_info_attr_16=job_info_attr_16, pcl_default_font_number=pcl_default_font_number, outbin6_override_mode=outbin6_override_mode, error22_time_stamp=error22_time_stamp, consumable_status_oem_name=consumable_status_oem_name, error37_code=error37_code, media13_page_count=media13_page_count, error45_time_stamp=error45_time_stamp, error15_time_stamp=error15_time_stamp, job_info_attr_12=job_info_attr_12, error16=error16, error1=error1, simm2_bank2=simm2_bank2, error11=error11, ph4=ph4, error29_code=error29_code, print_meter=print_meter, mio1_manufacturing_info=mio1_manufacturing_info, consumable_status_page_count_half_speed=consumable_status_page_count_half_speed, simm2_capacity=simm2_capacity, error43=error43, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, consumable_status_capacity_units=consumable_status_capacity_units, error33_code=error33_code, error20_time_stamp=error20_time_stamp, pcl_total_page_count=pcl_total_page_count, held_job=held_job, error44=error44, media15_short_name=media15_short_name, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, firmware_download_maximum_write_count=firmware_download_maximum_write_count, mono_color_switching_mode=mono_color_switching_mode, tray3_phd=tray3_phd, default_media_size=default_media_size, media15_name=media15_name, job_info_pages_processed=job_info_pages_processed, mopy_mode=mopy_mode, pjl=pjl, job_info_accounting_black_dots=job_info_accounting_black_dots, job_info_attr_5=job_info_attr_5, simm2_bank1_type=simm2_bank1_type, error50=error50, mio1_model_name=mio1_model_name, settings_file_system=settings_file_system, outbin10=outbin10, channelstate=channelstate, media8=media8, consumable_status_developer_life=consumable_status_developer_life, channel_io_errors=channel_io_errors, port1_parallel_bidirectionality=port1_parallel_bidirectionality, marker_density_calibration=marker_density_calibration, intray6=intray6, pcl_default_font_width=pcl_default_font_width, default_horizontal_black_resolution=default_horizontal_black_resolution, error11_time_stamp=error11_time_stamp, mio3_type=mio3_type, pcl_default_font_height=pcl_default_font_height, error14=error14, errorlog=errorlog, media15=media15, simm1_bank2_type=simm1_bank2_type, job_info_attr_14=job_info_attr_14, media7_name=media7_name, media17_engine_media_mode=media17_engine_media_mode, error37_time_stamp=error37_time_stamp, simm3_bank=simm3_bank, ph_devices=ph_devices, print_engine=print_engine, media19=media19, print_media=print_media, outbin11_override_mode=outbin11_override_mode, media32=media32, consumable_status_manufacturing_date=consumable_status_manufacturing_date, usage_average_toner_coverage=usage_average_toner_coverage, intray3=intray3, error45=error45, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, error50_time_stamp=error50_time_stamp, job_info_state=job_info_state, override_media_name=override_media_name, error45_code=error45_code, firmware_download_version=firmware_download_version, error26_time_stamp=error26_time_stamp, media4_short_name=media4_short_name, error3_time_stamp=error3_time_stamp, media22=media22, consumable_status_page_count_xy_other=consumable_status_page_count_xy_other, error7=error7, media13_engine_media_mode=media13_engine_media_mode, destination_subsystem=destination_subsystem, outbin11_phd=outbin11_phd, media9_short_name=media9_short_name, media1_short_name=media1_short_name, simm1_bank2=simm1_bank2, rpc_bound_protocol_address=rpc_bound_protocol_address, file_system3_initialize_volume=file_system3_initialize_volume, netPMLmgmt=netPMLmgmt, outbin9=outbin9, error12_code=error12_code, fw_rom_revision=fw_rom_revision, media18=media18, job_info_pages_in_original=job_info_pages_in_original, error16_time_stamp=error16_time_stamp, held_job_quantity=held_job_quantity, outbin7=outbin7, error23_code=error23_code, job_info_attr_10=job_info_attr_10, outbin8_phd=outbin8_phd, consumable_status_mono_page_count=consumable_status_mono_page_count, upgradable_devices_version=upgradable_devices_version, default_custom_paper_feed_dim=default_custom_paper_feed_dim, job_info_attr_3=job_info_attr_3, outbin4_override_mode=outbin4_override_mode, outbin9_override_mode=outbin9_override_mode, error30=error30, error31_code=error31_code, job_info_outbins_used=job_info_outbins_used, remote_upgrade_enable=remote_upgrade_enable, marking_agent_density=marking_agent_density, usage_instructions_line3=usage_instructions_line3, default_copies=default_copies, outbin7_error_info=outbin7_error_info, outbin11_maximum_binding=outbin11_maximum_binding, media5=media5, mass_storage_block_driver=mass_storage_block_driver, outbin10_override_mode=outbin10_override_mode, media20_short_name=media20_short_name)
