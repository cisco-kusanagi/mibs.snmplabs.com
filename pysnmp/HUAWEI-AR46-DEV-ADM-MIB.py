...
# Produced by pysmi-0.3.4 at Mon Apr 29 19:30:47 2019
...
MibIdentifier, Counter32, IpAddress, NotificationType, ModuleIdentity, Integer32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, ObjectIdentity, Gauge32, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter32", "IpAddress", "NotificationType", "ModuleIdentity", "Integer32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "ObjectIdentity", "Gauge32", "Unsigned32", "iso")
...
mibBuilder.exportSymbols("HUAWEI-AR46-DEV-ADM-MIB", hw8060SlotType=hw8060SlotType, hw8060SlotPcbVersion=hw8060SlotPcbVersion, hw8060SubslotIndex=hw8060SubslotIndex, PYSNMP_MODULE_ID=aR46_E200, hwHSCardJtagErr=hwHSCardJtagErr, hw8060PortType=hw8060PortType, hw8060SlotDesc=hw8060SlotDesc, hwFanUnitNormal=hwFanUnitNormal, hw8060SubslotTable=hw8060SubslotTable, dev8060MGlobalTable=dev8060MGlobalTable, hw8060SlotTable=hw8060SlotTable, hwNpuJtagErr=hwNpuJtagErr, hw8060SlotIndex=hw8060SlotIndex, hwPowerUnitFail=hwPowerUnitFail, hwRpuTempOK=hwRpuTempOK, hw8060SubslotType=hw8060SubslotType, hwPciNormal=hwPciNormal, hwNpRpuDmuErr=hwNpRpuDmuErr, dev8060MFanStatusEntry=dev8060MFanStatusEntry, hw8060FrameTable=hw8060FrameTable, dev8060MFanStatus=dev8060MFanStatus, aR46_E200=aR46_E200, hw8060SubslotPortNum=hw8060SubslotPortNum, hw8060FrameEntry=hw8060FrameEntry, hwRpuTempTooHigh=hwRpuTempTooHigh, hw8060SubslotAdminStatus=hw8060SubslotAdminStatus, hwNpConfPathErr=hwNpConfPathErr, hwRpuReset=hwRpuReset, hwNpTempOK=hwNpTempOK, hwXmodemLoadFail=hwXmodemLoadFail, hwNpResetOK=hwNpResetOK, hwVentTempTooHigh=hwVentTempTooHigh, hw8060PortDesc=hw8060PortDesc, hw8060SlotEntry=hw8060SlotEntry, hwFtpLoadFail=hwFtpLoadFail, dev8060MFanStatusTable=dev8060MFanStatusTable, hwSlotReset=hwSlotReset, hw8060SlotOperStatus=hw8060SlotOperStatus, hwNpIntReportErr=hwNpIntReportErr, dev8060MPowerNum=dev8060MPowerNum, dev8060MPowerStatus=dev8060MPowerStatus, hw8060PortAdminStatus=hw8060PortAdminStatus, hw8060DevMRpuTemperature=hw8060DevMRpuTemperature, hw8060DevNotifications=hw8060DevNotifications, hwFanUnitFail=hwFanUnitFail, hw8060FrameType=hw8060FrameType, hwVentTempTooLow=hwVentTempTooLow, hwPowerUnitNormal=hwPowerUnitNormal, hwLSCardJtagErr=hwLSCardJtagErr, hw8060SlotSoftwareVersion=hw8060SlotSoftwareVersion, hwLSCardHealthyErr=hwLSCardHealthyErr, hw8060PortIndex=hw8060PortIndex, hwNpTempTooHigh=hwNpTempTooHigh, hwVentTempOK=hwVentTempOK, hwHSCardPowerErr=hwHSCardPowerErr, hw8060PortEntry=hw8060PortEntry, dev8060MPowerStatusEntry=dev8060MPowerStatusEntry, hwNpTempTooLow=hwNpTempTooLow, hw8060SysTime=hw8060SysTime, hwRpuIntReportErr=hwRpuIntReportErr, hwHSCardConfPathErr=hwHSCardConfPathErr, hwPciAlarm=hwPciAlarm, hwRpuResetOK=hwRpuResetOK, hw8060SlotCpuRatio=hw8060SlotCpuRatio, hw8060FrameDesc=hw8060FrameDesc, hwCardPciHealthyErr=hwCardPciHealthyErr, dev8060MFanNum=dev8060MFanNum, hw8060FrameAdminStatus=hw8060FrameAdminStatus, hw8060DevMTemperatureMax=hw8060DevMTemperatureMax, hw8060FrameSlotNumber=hw8060FrameSlotNumber, hw8060DevObjects=hw8060DevObjects, hw8060SlotSubslotNumber=hw8060SlotSubslotNumber, hw8060PortTable=hw8060PortTable, hw8060SubslotEntry=hw8060SubslotEntry, hw8060SlotAdminStatus=hw8060SlotAdminStatus, hw8060FrameIndex=hw8060FrameIndex, dev8060MPowerStatusTable=dev8060MPowerStatusTable, hw8060DevConformance=hw8060DevConformance, hwSlotResetOK=hwSlotResetOK, hw8060DevMVentTemperature=hw8060DevMVentTemperature, hw8060SysVersion=hw8060SysVersion, hwTftpLoadFail=hwTftpLoadFail, hwWriteFlashErr=hwWriteFlashErr, hwSlotIntReportErr=hwSlotIntReportErr, hwHSCardHealthyErr=hwHSCardHealthyErr, hw8060PortSpeed=hw8060PortSpeed, hw8060DevMTemperatureMin=hw8060DevMTemperatureMin, hwNpReset=hwNpReset, hwRpuTempTooLow=hwRpuTempTooLow, hw8060PortOperateStatus=hw8060PortOperateStatus)
