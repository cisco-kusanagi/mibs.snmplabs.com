...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:32:22 2019
...
Counter32, enterprises, mib_2, Counter64, IpAddress, iso, NotificationType, ModuleIdentity, TimeTicks, MibIdentifier, Unsigned32, ObjectIdentity, Integer32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "enterprises", "mib-2", "Counter64", "IpAddress", "iso", "NotificationType", "ModuleIdentity", "TimeTicks", "MibIdentifier", "Unsigned32", "ObjectIdentity", "Integer32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("DKSF-253-5-X-A-X", npIoTraps=npIoTraps, npIoTable=npIoTable, npIoTrapLevelIn3=npIoTrapLevelIn3, npIoLevelIn=npIoLevelIn, npElecPower=npElecPower, npElecIndex=npElecIndex, npResetStack=npResetStack, npSoftReboot=npSoftReboot, npIoTrapLevelIn2=npIoTrapLevelIn2, npElecMeter=npElecMeter, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npIoEntry=npIoEntry, npIoSinglePulseStart=npIoSinglePulseStart, npIoTrapLineN=npIoTrapLineN, netPing=netPing, npIoTrapMemo=npIoTrapMemo, npIoMemo=npIoMemo, npReboot=npReboot, lightcom=lightcom, PYSNMP_MODULE_ID=netPing, npIoTrap=npIoTrap, npIo=npIo, npElecPulsesPerKwh=npElecPulsesPerKwh, npElecEnergy100=npElecEnergy100, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoLevelOut=npIoLevelOut, npIoTrapLevelIn4=npIoTrapLevelIn4, npIoPulseCounter=npIoPulseCounter, npIoTrapLevelIn1=npIoTrapLevelIn1, npElecEntry=npElecEntry, npIoLineN=npIoLineN, npElecTable=npElecTable, npElecEnergy=npElecEnergy, npIoTrapLevelIn=npIoTrapLevelIn)
