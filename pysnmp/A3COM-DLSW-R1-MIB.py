...
Gauge32, ModuleIdentity, TimeTicks, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, NotificationType, Counter64, Counter32, enterprises, NotificationType, ObjectIdentity, Bits, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "TimeTicks", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "NotificationType", "Counter64", "Counter32", "enterprises", "NotificationType", "ObjectIdentity", "Bits", "Integer32")
...
mibBuilder.exportSymbols("A3COM-DLSW-R1-MIB", RowStatus=RowStatus, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswCircuitEntry=dlswCircuitEntry, MacAddress=MacAddress, dlswVendorID=dlswVendorID, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirNBTable=dlswDirNBTable, dlswDirNBLocationType=dlswDirNBLocationType, dlswStdPacingSupport=dlswStdPacingSupport, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswDirCache=dlswDirCache, dlswStatus=dlswStatus, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswDirMacEntries=dlswDirMacEntries, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswDirMacLocation=dlswDirMacLocation, dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswSdlc=dlswSdlc, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigOpens=dlswTConnConfigOpens, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswTConnConfigSetupType=dlswTConnConfigSetupType, DlcType=DlcType, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswDirMacEntry=dlswDirMacEntry, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitCreates=dlswCircuitCreates, dlswDirNBEntryType=dlswDirNBEntryType, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswTrapTConnUp=dlswTrapTConnUp, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswUpTime=dlswUpTime, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnConfigTable=dlswTConnConfigTable, dlswTrapControl=dlswTrapControl, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswNode=dlswNode, dlswCircuitState=dlswCircuitState, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswResourceNBExclusivity=dlswResourceNBExclusivity, EndStationLocation=EndStationLocation, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswMIB_3Com=dlswMIB_3Com, dlswResourceMacExclusivity=dlswResourceMacExclusivity, dlswCircuitTable=dlswCircuitTable, dlswDirMacTable=dlswDirMacTable, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswDirectory=dlswDirectory, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnStat=dlswTConnStat, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswVersion=dlswVersion, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswDirMacMac=dlswDirMacMac, dlswDirNBName=dlswDirNBName, dlswTConnOperTable=dlswTConnOperTable, Instancepointer=Instancepointer, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswTConnOperState=dlswTConnOperState, dlswDirNBNameType=dlswDirNBNameType, DlswTimeStamp=DlswTimeStamp, dlswDirMacEntryType=dlswDirMacEntryType, dlswTConnOperICRexSents=dlswTConnOperICRexSents, a3Com=a3Com, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirNBEntries=dlswDirNBEntries, dlswDirNBLocation=dlswDirNBLocation, TAddress=TAddress, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswCircuitS2Location=dlswCircuitS2Location, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswDirNBStatus=dlswDirNBStatus, dlswInterface=dlswInterface, dlswCircuitStateTime=dlswCircuitStateTime, dlswTraps=dlswTraps, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswCircuit=dlswCircuit, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, LFSize=LFSize, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswVersionString=dlswVersionString, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswCircuitOrigin=dlswCircuitOrigin, dlswActiveCircuits=dlswActiveCircuits, dlswDirMacStatus=dlswDirMacStatus, dlswDirNBEntry=dlswDirNBEntry, dlswCircuitPriority=dlswCircuitPriority, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTrapTConnDown=dlswTrapTConnDown, dlswCircuitStat=dlswCircuitStat, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswDirStat=dlswDirStat, dlswTConnOperEntry=dlswTConnOperEntry, dlswCircuitS1Mac=dlswCircuitS1Mac, brouterMIB=brouterMIB, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, Truthvalue=Truthvalue, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswDirNBLFSize=dlswDirNBLFSize, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnConfigEntryType=dlswTConnConfigEntryType, NBName=NBName, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswVirtualSegmentLFSize=dlswVirtualSegmentLFSize, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswDirMacMask=dlswDirMacMask, dlswDirMacIndex=dlswDirMacIndex, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConn=dlswTConn)
