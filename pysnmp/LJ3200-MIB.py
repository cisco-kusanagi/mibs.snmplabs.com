...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ3200-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:08 2019
...
NotificationType, iso, MibIdentifier, Bits, ModuleIdentity, TimeTicks, ObjectIdentity, IpAddress, Integer32, Unsigned32, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "MibIdentifier", "Bits", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "IpAddress", "Integer32", "Unsigned32", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
mibBuilder.exportSymbols("LJ3200-MIB", serial_number=serial_number, faxjob_rx_duration=faxjob_rx_duration, prtGeneral=prtGeneral, faxjob_tx_id=faxjob_tx_id, total_engine_page_count=total_engine_page_count, error4_time_stamp=error4_time_stamp, prtinterpreterdefaultcharsetin=prtinterpreterdefaultcharsetin, prtmarkerspotcolorants=prtmarkerspotcolorants, scan_resolution_range=scan_resolution_range, error5_time_stamp=error5_time_stamp, prtmarkerstatus=prtmarkerstatus, print_engine_mispick_count=print_engine_mispick_count, fax_receive_stamping_enable=fax_receive_stamping_enable, print_engine=print_engine, prtMarkerSuppliesTable=prtMarkerSuppliesTable, imaging=imaging, prtalertcriticalevents=prtalertcriticalevents, scan_token=scan_token, prtinputcurrentlevel=prtinputcurrentlevel, faxjob_download_id=faxjob_download_id, prtalerttraininglevel=prtalerttraininglevel, error9=error9, faxjob_rx_id=faxjob_rx_id, scanner_adf_page_count=scanner_adf_page_count, prtinputtype=prtinputtype, fax_pstn_access_code=fax_pstn_access_code, prtconsolelocalization=prtconsolelocalization, scanner_retrieve_scanline=scanner_retrieve_scanline, service_password=service_password, copier_job_contrast=copier_job_contrast, settings_scanner=settings_scanner, fax_thumbnail_enable=fax_thumbnail_enable, job_info_outcome=job_info_outcome, job_info_attr_10=job_info_attr_10, hrstoragesize=hrstoragesize, hrStorageEntry=hrStorageEntry, prtInterpreter=prtInterpreter, error7_code=error7_code, prtalertdescription=prtalertdescription, job_info_attr_1=job_info_attr_1, prtInputTable=prtInputTable, device_cfg_param_command=device_cfg_param_command, fax_upload_token=fax_upload_token, status_system=status_system, prtLocalization=prtLocalization, prtchannelstate=prtchannelstate, hrStorage=hrStorage, scan_upload=scan_upload, error6_time_stamp=error6_time_stamp, prtmarkerprocesscolorants=prtmarkerprocesscolorants, fax_contrast=fax_contrast, fax_log_action=fax_log_action, fax_allow_redials=fax_allow_redials, status_pdl=status_pdl, job=job, hrprinterdetectederrorstate=hrprinterdetectederrorstate, prtalerttime=prtalerttime, settings_job=settings_job, prtStorageRefEntry=prtStorageRefEntry, prtMarkerSuppliesEntry=prtMarkerSuppliesEntry, collated_originals_support=collated_originals_support, prtalertseveritylevel=prtalertseveritylevel, prtmarkerlifecount=prtmarkerlifecount, device_cfg_download_data_type=device_cfg_download_data_type, scan_calibration_error=scan_calibration_error, simm1_type=simm1_type, device_cfg_upload_error=device_cfg_upload_error, prtinputmedianame=prtinputmedianame, job_info_change_id=job_info_change_id, fax_forwarding=fax_forwarding, hrdevicestatus=hrdevicestatus, custom_paper_feed_dim=custom_paper_feed_dim, prtinterpreterdefaultcharsetout=prtinterpreterdefaultcharsetout, fax_additional_wait=fax_additional_wait, copier=copier, upload_timeout=upload_timeout, fax_redial_time=fax_redial_time, settings_pdl=settings_pdl, date_display=date_display, prtinterpretertwoway=prtinterpretertwoway, prtmediapathminmediaxfeeddir=prtmediapathminmediaxfeeddir, intrays=intrays, faxjob_tx_type=faxjob_tx_type, default_print_quality=default_print_quality, pcl_default_font_source=pcl_default_font_source, scan_upload_error=scan_upload_error, fax_download_error=fax_download_error, prtinterpreterlanglevel=prtinterpreterlanglevel, simm3_capacity=simm3_capacity, prtinterpreterxfeedaddressability=prtinterpreterxfeedaddressability, fax_upload_error=fax_upload_error, auto_continue=auto_continue, prtconsolenumberofdisplaychars=prtconsolenumberofdisplaychars, scan_resolution=scan_resolution, default_vertical_black_resolution=default_vertical_black_resolution, prtConsoleLightEntry=prtConsoleLightEntry, prtOutputTable=prtOutputTable, prtLocalizationEntry=prtLocalizationEntry, prtOutput=prtOutput, faxjob_upload_id=faxjob_upload_id, prtInputEntry=prtInputEntry, prtmediapathminmediafeeddir=prtmediapathminmediafeeddir, prtinterpreterversion=prtinterpreterversion, prtalertlocation=prtalertlocation, copier_quality=copier_quality, simm=simm, print_density=print_density, scan_calibration=scan_calibration, wide_a4=wide_a4, simm2_capacity=simm2_capacity, prtAlert=prtAlert, copier_job_quality=copier_job_quality, form_feed=form_feed, energy_star=energy_star, prtinterpreterlangversion=prtinterpreterlangversion, prtmarkersuppliesmarkerindex=prtmarkersuppliesmarkerindex, prtgeneralserialnumber=prtgeneralserialnumber, hrm=hrm, faxjob_action_id=faxjob_action_id, settings_fax_send=settings_fax_send, prtMediaPath=prtMediaPath, prtmarkersuppliesmaxcapacity=prtmarkersuppliesmaxcapacity, default_horizontal_black_resolution=default_horizontal_black_resolution, install_date=install_date, prtlocalizationlanguage=prtlocalizationlanguage, prtOutputEntry=prtOutputEntry, prtmediapathmaxmediaxfeeddir=prtmediapathmaxmediaxfeeddir, error8_time_stamp=error8_time_stamp, prtinputmediadimfeeddirchosen=prtinputmediadimfeeddirchosen, prtStorageRefTable=prtStorageRefTable, copier_job_collation=copier_job_collation, prtmediapathmaxspeed=prtmediapathmaxspeed, printmib=printmib, hrstoragetype=hrstoragetype, error8=error8, job_info_name1=job_info_name1, fax_error_correction_mode=fax_error_correction_mode, device_location=device_location, prtconsoleofftime=prtconsoleofftime, prtoutputmaxcapacity=prtoutputmaxcapacity, fax_send=fax_send, prtdevicerefindex=prtdevicerefindex, copier_collation=copier_collation, prtcoverstatus=prtcoverstatus, job_info_attr_7=job_info_attr_7, transmit_fax=transmit_fax, error8_code=error8_code, prtlocalizationcharacterset=prtlocalizationcharacterset, default_vmi=default_vmi, answer=answer, error2_code=error2_code, prtalertgroupindex=prtalertgroupindex, faxjob_rx_current_page_1=faxjob_rx_current_page_1, faxjob_rx_status=faxjob_rx_status, prtMediaPathEntry=prtMediaPathEntry, copier_reduction=copier_reduction, job_info_state=job_info_state, job_info_attr_4=job_info_attr_4, model_name=model_name, prtchannelcurrentjobcntllangindex=prtchannelcurrentjobcntllangindex, prtinputname=prtinputname, hrdeviceerrors=hrdeviceerrors, prtinputcapacityunit=prtinputcapacityunit, fax_ring_enable=fax_ring_enable, prtConsoleLightTable=prtConsoleLightTable, settings_fax_receive=settings_fax_receive, prtinputvendorname=prtinputvendorname, prtmediapathstatus=prtmediapathstatus, copier_print_page_count=copier_print_page_count, prtinputmediadimfeeddirdeclared=prtinputmediadimfeeddirdeclared, job_info_attribute=job_info_attribute, prtinputmediadimxfeeddirdeclared=prtinputmediadimxfeeddirdeclared, prtmarkeraddressabilityfeeddir=prtmarkeraddressabilityfeeddir, prtAlertTable=prtAlertTable, hrPrinterTable=hrPrinterTable, simm2_type=simm2_type, prtalertallevents=prtalertallevents, error7_time_stamp=error7_time_stamp, job_info_attr_15=job_info_attr_15, error6=error6, dial_all_lines=dial_all_lines, sleep_mode=sleep_mode, error_log_clear=error_log_clear, error7=error7, settings_intray=settings_intray, error9_time_stamp=error9_time_stamp, fax_download=fax_download, prtConsoleDisplayBuffer=prtConsoleDisplayBuffer, error3=error3, scanner_jam_page_count=scanner_jam_page_count, prtinputdimunit=prtinputdimunit, scan_pixel_data_type=scan_pixel_data_type, prtinputsecurity=prtinputsecurity, scan_compression=scan_compression, prtoutputtype=prtoutputtype, channel_bytes_received=channel_bytes_received, prtmediapathdefaultindex=prtmediapathdefaultindex, fax_rx_disposition=fax_rx_disposition, faxjob_tx_duration_1=faxjob_tx_duration_1, prtmarkereastmargin=prtmarkereastmargin, prtconsoleontime=prtconsoleontime, print_engine_jam_count=print_engine_jam_count, error1_time_stamp=error1_time_stamp, device=device, scan_calibration_download=scan_calibration_download, prtMarkerEntry=prtMarkerEntry, prtGeneralEntry=prtGeneralEntry, prtConsoleDisplayBufferTable=prtConsoleDisplayBufferTable, hrdeviceid=hrdeviceid, fax_master_host=fax_master_host, prtstoragerefindex=prtstoragerefindex, destination_subsystem=destination_subsystem, error4=error4, prtmarkerwestmargin=prtmarkerwestmargin, job_info_outbins_used=job_info_outbins_used, current_job_parsing_id=current_job_parsing_id, pdl_pcl=pdl_pcl, pcl_resource_saving_memory_size=pcl_resource_saving_memory_size, scan_pad_image=scan_pad_image, copier_num_copies=copier_num_copies, pjl=pjl, prtInterpreterTable=prtInterpreterTable, prtoutputstatus=prtoutputstatus, io=io, prtChannel=prtChannel, default_page_protect=default_page_protect, self_test=self_test, io_switch=io_switch, prtinputdefaultindex=prtinputdefaultindex, prtconsoledisplaybuffertext=prtconsoledisplaybuffertext, prtalertcode=prtalertcode, prtmarkeraddressabilityxfeeddir=prtmarkeraddressabilityxfeeddir, copier_job=copier_job, fax_upload=fax_upload, fax_report_transmission=fax_report_transmission, scan_contrast=scan_contrast, custom_paper_xfeed_dim=custom_paper_xfeed_dim, job_info_name2=job_info_name2, maximum_resource_saving_memory=maximum_resource_saving_memory, intray=intray, simm1_capacity=simm1_capacity, DisplayString=DisplayString, job_info_attr_6=job_info_attr_6, prtinputmodel=prtinputmodel, prtmarkersuppliesdescription=prtmarkersuppliesdescription, pysmi_continue=pysmi_continue, hrStorageTable=hrStorageTable, default_copies=default_copies, job_info_attr_5=job_info_attr_5, tray1_fuser_temperature=tray1_fuser_temperature, prtmediapathtype=prtmediapathtype, prtLocalizationTable=prtLocalizationTable, default_scanner_margin_left=default_scanner_margin_left, prtoutputremainingcapacity=prtoutputremainingcapacity)
mibBuilder.exportSymbols("LJ3200-MIB", phone=phone, faxjob_tx_current_page_1=faxjob_tx_current_page_1, faxjob_tx_error_1=faxjob_tx_error_1, scanner_scanline_statistics=scanner_scanline_statistics, status_scanner=status_scanner, prtinterpreterdefaultorientation=prtinterpreterdefaultorientation, error10_code=error10_code, prtchanneldefaultpagedesclangindex=prtchanneldefaultpagedesclangindex, hrprinterstatus=hrprinterstatus, hrdeviceindex=hrdeviceindex, status_prt_eng=status_prt_eng, hp=hp, fax_report_activity_log=fax_report_activity_log, device_name=device_name, faxjob_rx_duration_1=faxjob_rx_duration_1, print_internal_page=print_internal_page, job_info_attr_8=job_info_attr_8, channel_entry=channel_entry, copier_job_num_copies=copier_job_num_copies, tables=tables, processing_subsystem=processing_subsystem, prtinputmaxcapacity=prtinputmaxcapacity, prtmarkercounterunit=prtmarkercounterunit, answer_all_lines=answer_all_lines, fax_min_rings_pickup=fax_min_rings_pickup, prtconsoledisable=prtconsoledisable, error10=error10, hrdevicedescr=hrdevicedescr, pcl_default_font_width=pcl_default_font_width, hrdevicetype=hrdevicetype, not_ready_fax_receive=not_ready_fax_receive, intray1=intray1, prtgeneralconfigchanges=prtgeneralconfigchanges, copier_job_reduction=copier_job_reduction, settings_fax_job=settings_fax_job, job_info_attr_13=job_info_attr_13, faxjob_rx_status_1=faxjob_rx_status_1, prtlocalizationcountry=prtlocalizationcountry, prtMarkerTable=prtMarkerTable, copier_job_media_size=copier_job_media_size, prtoutputcapacityunit=prtoutputcapacityunit, reprint=reprint, error6_code=error6_code, pdl=pdl, prtmarkeraddressabilityunit=prtmarkeraddressabilityunit, scan_height=scan_height, prtCoverTable=prtCoverTable, error4_code=error4_code, channel_table=channel_table, status_fax_job=status_fax_job, form_feed_needed=form_feed_needed, fax_proc_sub=fax_proc_sub, prtCoverEntry=prtCoverEntry, prtgeneralserviceperson=prtgeneralserviceperson, prtChannelEntry=prtChannelEntry, channel_io_errors=channel_io_errors, prtConsoleLights=prtConsoleLights, fax_firmware_revision=fax_firmware_revision, hrstorageindex=hrstorageindex, hrstorageused=hrstorageused, channel_bytes_sent=channel_bytes_sent, prtalertgroup=prtalertgroup, fax_resolution=fax_resolution, date_and_time=date_and_time, fax_log_reporting=fax_log_reporting, job_info_attr_9=job_info_attr_9, prtcoverdescription=prtcoverdescription, job_info_attr_12=job_info_attr_12, download_timeout=download_timeout, prtMarkerSupplies=prtMarkerSupplies, job_info_attr_16=job_info_attr_16, hrDevice=hrDevice, prtconsolecolor=prtconsolecolor, default_bits_per_pixel=default_bits_per_pixel, faxjob_tx_duration=faxjob_tx_duration, prtgeneralreset=prtgeneralreset, prtchannelprotocolversion=prtchannelprotocolversion, fax_dial_tone_detection=fax_dial_tone_detection, prtmarkerpoweroncount=prtmarkerpoweroncount, prtinputmediadimxfeeddirchosen=prtinputmediadimxfeeddirchosen, simm3_type=simm3_type, prtInput=prtInput, fw_rom_datecode=fw_rom_datecode, status_fax_proc_sub=status_fax_proc_sub, settings_system=settings_system, prtconsoledescription=prtconsoledescription, job_info_io_source=job_info_io_source, fax_phone_pickup_enable=fax_phone_pickup_enable, default_ret=default_ret, job_being_parsed=job_being_parsed, scan_gamma_correction=scan_gamma_correction, prtmarkersupplieslevel=prtmarkersupplieslevel, hrPrinterEntry=hrPrinterEntry, prtinputdescription=prtinputdescription, prtInterpreterEntry=prtInterpreterEntry, fax_pixel_data_type=fax_pixel_data_type, prtmediapathmaxmediafeeddir=prtmediapathmaxmediafeeddir, fax_tx_phone_number=fax_tx_phone_number, dial=dial, time_display=time_display, default_scanner_margin_right=default_scanner_margin_right, prtinterpreterdescription=prtinterpreterdescription, asset_number=asset_number, job_info_physical_outbins_used=job_info_physical_outbins_used, simm1=simm1, error9_code=error9_code, prtmarkersuppliescolorantindex=prtmarkersuppliescolorantindex, hrstoragedescr=hrstoragedescr, prtinterpreterfeedaddressability=prtinterpreterfeedaddressability, fax_noise_volume=fax_noise_volume, prtchannelstatus=prtchannelstatus, on_off_line=on_off_line, default_media_size=default_media_size, scan_image_type=scan_image_type, scan_control_descriptor=scan_control_descriptor, prtmarkersouthmargin=prtmarkersouthmargin, hrstorageallocationunits=hrstorageallocationunits, device_ring_type_pickup=device_ring_type_pickup, faxjob_tx_error=faxjob_tx_error, faxjob_tx_status_1=faxjob_tx_status_1, prtMarker=prtMarker, ui_add_option=ui_add_option, status_fax_receive=status_fax_receive, fax_country=fax_country, simm3=simm3, job_info_attr_2=job_info_attr_2, prtinputstatus=prtinputstatus, prtmediapathmaxspeedprintunit=prtmediapathmaxspeedprintunit, io_timeout=io_timeout, prtgeneralprintername=prtgeneralprintername, fax_dial_mode=fax_dial_mode, fax_activity_log=fax_activity_log, prtAlertEntry=prtAlertEntry, error3_time_stamp=error3_time_stamp, settings_copier=settings_copier, prtGeneralTable=prtGeneralTable, prtinputserialnumber=prtinputserialnumber, fax_job_control=fax_job_control, fax_num_rings_pickup=fax_num_rings_pickup, prtmarkersuppliessupplyunit=prtmarkersuppliessupplyunit, job_info_size=job_info_size, hrDeviceTable=hrDeviceTable, copier_adf_page_count=copier_adf_page_count, scan_adf_page_count=scan_adf_page_count, fax_max_rings_pickup=fax_max_rings_pickup, prtmarkermarktech=prtmarkermarktech, prtChannelTable=prtChannelTable, default_lines_per_page=default_lines_per_page, job_info_attr_3=job_info_attr_3, settings_prt_eng=settings_prt_eng, prtmediapathmediasizeunit=prtmediapathmediasizeunit, error1=error1, error3_code=error3_code, device_cfg_upload=device_cfg_upload, not_ready_fax_send=not_ready_fax_send, scan_subsample=scan_subsample, prtmarkernorthmargin=prtmarkernorthmargin, custom_paper_dim_unit=custom_paper_dim_unit, cold_reset_media_size=cold_reset_media_size, pcl_default_font_height=pcl_default_font_height, override_media_size=override_media_size, prtconsolenumberofdisplaylines=prtconsolenumberofdisplaylines, prtDeviceRefTable=prtDeviceRefTable, fax_line_interface_unit_id=fax_line_interface_unit_id, job_info_pages_printed=job_info_pages_printed, job_info_pages_processed=job_info_pages_processed, job_info=job_info, interface=interface, prtmediapathdescription=prtmediapathdescription, scanner_button_status=scanner_button_status, fax_silent_detection=fax_silent_detection, dark_courier=dark_courier, error5_code=error5_code, fax_local_phone_num=fax_local_phone_num, prtCover=prtCover, prtoutputdefaultindex=prtoutputdefaultindex, system=system, prtmarkerdefaultindex=prtmarkerdefaultindex, ui_delete_option=ui_delete_option, settings_faxlog=settings_faxlog, errorlog=errorlog, faxjob_tx_status=faxjob_tx_status, job_info_attr_14=job_info_attr_14, prtMediaPathTable=prtMediaPathTable, prtmarkersuppliesclass=prtmarkersuppliesclass, prtchannelinformation=prtchannelinformation, error10_time_stamp=error10_time_stamp, device_cfg_upload_data_type=device_cfg_upload_data_type, device_config_token=device_config_token, scan_calibration_target=scan_calibration_target, id=id, fax_rxscale=fax_rxscale, fax_answer_mode=fax_answer_mode, not_ready_source_scanner=not_ready_source_scanner, channel_jobs_received=channel_jobs_received, job_info_stage=job_info_stage, error2=error2, hrmemorysize=hrmemorysize, scanner=scanner, active_print_jobs=active_print_jobs, source_subsystem=source_subsystem, fax_forwarding_phone_num=fax_forwarding_phone_num, device_cfg_download=device_cfg_download, ui_select_option=ui_select_option, settings_fax_proc_sub=settings_fax_proc_sub, dm=dm, device_redial=device_redial, copier_token=copier_token, fax_download_token=fax_download_token, faxjob_action=faxjob_action, scanner_motor_control=scanner_motor_control, copier_contrast=copier_contrast, fax_max_redials=fax_max_redials, prtmarkersuppliestype=prtmarkersuppliestype, prtchanneltype=prtchanneltype, fax_station_name=fax_station_name, test=test, simm2=simm2, status_fax_send=status_fax_send, prtinterpreterlangfamily=prtinterpreterlangfamily, pcl_default_font_number=pcl_default_font_number, settings_io=settings_io, prtchannelifindex=prtchannelifindex, prtDeviceRefEntry=prtDeviceRefEntry, faxjob_rx_current_page=faxjob_rx_current_page, hrDeviceEntry=hrDeviceEntry, prtgeneralcurrentoperator=prtgeneralcurrentoperator, faxjob=faxjob, hrstorageallocationfailures=hrstorageallocationfailures, faxjob_tx_current_page=faxjob_tx_current_page, error5=error5, error2_time_stamp=error2_time_stamp, cancel_job=cancel_job, job_info_attr_11=job_info_attr_11, prtinputversion=prtinputversion, fax_alarm_volume=fax_alarm_volume, pjl_password=pjl_password, fax_beep_volume=fax_beep_volume, fax_ring_volume=fax_ring_volume, prtgeneralcurrentlocalization=prtgeneralcurrentlocalization, fax_receive=fax_receive, prtConsoleDisplayBufferEntry=prtConsoleDisplayBufferEntry, scan_compression_factor=scan_compression_factor, device_cfg_download_error=device_cfg_download_error, error1_code=error1_code)
