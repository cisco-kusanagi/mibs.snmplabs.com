...
# Produced by pysmi-0.3.4 at Mon Apr 29 19:00:14 2019
...
Counter32, MibIdentifier, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, NotificationType, Bits, ModuleIdentity, ObjectIdentity, Unsigned32, IpAddress, TimeTicks, mib_2, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibIdentifier", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "NotificationType", "Bits", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "IpAddress", "TimeTicks", "mib-2", "Gauge32")
...
mibBuilder.exportSymbols("FLOAT-TC-MIB", PYSNMP_MODULE_ID=floatTcMIB, Float32TC=Float32TC, floatTcMIB=floatTcMIB, Float128TC=Float128TC, Float64TC=Float64TC)
