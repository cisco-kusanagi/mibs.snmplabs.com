...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:37:16 2019
...
Counter32, Integer32, ModuleIdentity, NotificationType, Unsigned32, IpAddress, Bits, TimeTicks, Gauge32, Counter64, ObjectIdentity, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Integer32", "ModuleIdentity", "NotificationType", "Unsigned32", "IpAddress", "Bits", "TimeTicks", "Gauge32", "Counter64", "ObjectIdentity", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DNOS-SNTP-CLIENT-MIB", agentSntpClientCompliance=agentSntpClientCompliance, agentSntpClientSupportedMode=agentSntpClientSupportedMode, agentSntpClientMIB=agentSntpClientMIB, agentSntpClientUcastServerAddressType=agentSntpClientUcastServerAddressType, agentSntpClientUcastServerPrecedence=agentSntpClientUcastServerPrecedence, agentSntpClientUcastServerVersion=agentSntpClientUcastServerVersion, agentSntpClient=agentSntpClient, agentSntpClientUnicastPollInterval=agentSntpClientUnicastPollInterval, agentSntpClientPollInterval=agentSntpClientPollInterval, agentSntpClientUnicastPollTimeout=agentSntpClientUnicastPollTimeout, agentSntpClientUcastServerCurrEntries=agentSntpClientUcastServerCurrEntries, agentSntpClientUcastServerLastUpdateTime=agentSntpClientUcastServerLastUpdateTime, agentSntpClientServerRefClkId=agentSntpClientServerRefClkId, agentSntpClientGroups=agentSntpClientGroups, agentSntpClientDeviceGroup=agentSntpClientDeviceGroup, agentSntpClientBroadcast=agentSntpClientBroadcast, agentSntpClientUcastServerTable=agentSntpClientUcastServerTable, agentSntpClientUcastServerMaxEntries=agentSntpClientUcastServerMaxEntries, agentSntpClientLastAttemptTime=agentSntpClientLastAttemptTime, agentSntpClientUcastServerRowStatus=agentSntpClientUcastServerRowStatus, agentSntpClientUcastServerNumRequests=agentSntpClientUcastServerNumRequests, agentSntpClientBroadcastInterval=agentSntpClientBroadcastInterval, agentSntpClientServerAddressType=agentSntpClientServerAddressType, SntpClientAdminMode=SntpClientAdminMode, agentSntpClientUcastServerLastAttemptStatus=agentSntpClientUcastServerLastAttemptStatus, agentSntpClientUcastServerLastAttemptTime=agentSntpClientUcastServerLastAttemptTime, agentSntpClientServerStratum=agentSntpClientServerStratum, agentSntpClientSourceInterface=agentSntpClientSourceInterface, agentSntpClientConformance=agentSntpClientConformance, agentSntpClientLastAttemptStatus=agentSntpClientLastAttemptStatus, agentSntpClientUcastServerAddress=agentSntpClientUcastServerAddress, agentSntpClientUnicastPollRetry=agentSntpClientUnicastPollRetry, agentSntpClientBroadcastGroup=agentSntpClientBroadcastGroup, agentSntpClientLastUpdateTime=agentSntpClientLastUpdateTime, agentSntpClientUcastServerEntry=agentSntpClientUcastServerEntry, PYSNMP_MODULE_ID=agentSntpClientMIB, agentSntpClientMode=agentSntpClientMode, agentSntpClientCompliances=agentSntpClientCompliances, agentSntpClientBroadcastCount=agentSntpClientBroadcastCount, agentSntpClientUnicast=agentSntpClientUnicast, agentSntpClientServerAddress=agentSntpClientServerAddress, SntpClientUpdateStatus=SntpClientUpdateStatus, agentSntpClientVersion=agentSntpClientVersion, agentSntpClientPort=agentSntpClientPort, agentSntpClientUcastServerPort=agentSntpClientUcastServerPort, agentSntpClientUcastServerNumFailedRequests=agentSntpClientUcastServerNumFailedRequests, agentSntpClientUcastServerIndex=agentSntpClientUcastServerIndex, agentSntpClientUnicastGroup=agentSntpClientUnicastGroup, agentSntpClientObjects=agentSntpClientObjects, agentSntpClientServerMode=agentSntpClientServerMode)
