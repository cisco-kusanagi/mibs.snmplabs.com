...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, enterprises, MibIdentifier, ModuleIdentity, Unsigned32, Bits, Integer32, Counter32, IpAddress, TimeTicks, ObjectIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "enterprises", "MibIdentifier", "ModuleIdentity", "Unsigned32", "Bits", "Integer32", "Counter32", "IpAddress", "TimeTicks", "ObjectIdentity", "Gauge32", "NotificationType")
