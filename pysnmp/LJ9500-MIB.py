...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/LJ9500-MIB
# Produced by pysmi-0.3.4 at Mon Apr 29 19:57:36 2019
...
ModuleIdentity, Gauge32, Integer32, NotificationType, IpAddress, iso, Unsigned32, Counter64, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Integer32", "NotificationType", "IpAddress", "iso", "Unsigned32", "Counter64", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "Bits")
...
mibBuilder.exportSymbols("LJ9500-MIB", media21_engine_media_mode=media21_engine_media_mode, phd3=phd3, upgradable_devices_write_status_supported=upgradable_devices_write_status_supported, upgradable_devices_version=upgradable_devices_version, active_print_jobs=active_print_jobs, mio2_model_name=mio2_model_name, upgradable_devices_write_count=upgradable_devices_write_count, error27_code=error27_code, printer_calibration_cpr=printer_calibration_cpr, phd2_type=phd2_type, pysmi_continue=pysmi_continue, consumable_life_usage_units=consumable_life_usage_units, printer_cal_dhalf_utc=printer_cal_dhalf_utc, io=io, simm3_bank2=simm3_bank2, media2_short_name=media2_short_name, id=id, error24_code=error24_code, media14_name=media14_name, tray2_phd=tray2_phd, media9_engine_media_mode=media9_engine_media_mode, job_info_name1=job_info_name1, media3_name=media3_name, media24=media24, error18_time_stamp=error18_time_stamp, settings_intray=settings_intray, default_page_protect=default_page_protect, error11=error11, error24_time_stamp=error24_time_stamp, port1_parallel_bidirectionality=port1_parallel_bidirectionality, web_server_url=web_server_url, settings_io=settings_io, simm3_type=simm3_type, destination_bin_usage=destination_bin_usage, media22_engine_media_mode=media22_engine_media_mode, error28_time_stamp=error28_time_stamp, tray3_phd=tray3_phd, error38_time_stamp=error38_time_stamp, hp=hp, outbin3_phd=outbin3_phd, error13_time_stamp=error13_time_stamp, media16_engine_media_mode=media16_engine_media_mode, channel_jobs_received=channel_jobs_received, printed_modes_mono_count=printed_modes_mono_count, error2=error2, model_name=model_name, device_system=device_system, error9_code=error9_code, media8_page_count=media8_page_count, consumable_status_serial_number=consumable_status_serial_number, printer_calibration_dhalf=printer_calibration_dhalf, settings_marking_agent=settings_marking_agent, error44_code=error44_code, serial_number=serial_number, job_info_requested_originals=job_info_requested_originals, consumable_status_engine_job_count=consumable_status_engine_job_count, media13_page_count=media13_page_count, port1=port1, timestamp=timestamp, phd3_capacity=phd3_capacity, media19_page_count=media19_page_count, media24_short_name=media24_short_name, duplex_page_count=duplex_page_count, consumable_status_job_count=consumable_status_job_count, media23=media23, consumable_status_engine_usage_units=consumable_status_engine_usage_units, mio2_manufacturing_info=mio2_manufacturing_info, self_test=self_test, printed_media_maximum_pixels_per_page=printed_media_maximum_pixels_per_page, ph2=ph2, error15=error15, error40_code=error40_code, error45_time_stamp=error45_time_stamp, error15_time_stamp=error15_time_stamp, media4_engine_media_mode=media4_engine_media_mode, channelprotocolversion=channelprotocolversion, job_info_accounting_cyan_dots=job_info_accounting_cyan_dots, media5_engine_media_mode=media5_engine_media_mode, media9_name=media9_name, mio=mio, simm2_bank2_type=simm2_bank2_type, file_system_set_system_partition_writeable=file_system_set_system_partition_writeable, media21=media21, device_name=device_name, mio1=mio1, error41_time_stamp=error41_time_stamp, background_message2=background_message2, outbin3_maximum_binding=outbin3_maximum_binding, consumable_status_total_equiv_color_page_count=consumable_status_total_equiv_color_page_count, error20_code=error20_code, job_info_accounting_media_duplex_count=job_info_accounting_media_duplex_count, media_modes=media_modes, pcl_default_font_height=pcl_default_font_height, error23_code=error23_code, job_info_pages_in_original=job_info_pages_in_original, media32_page_count=media32_page_count, job_info_attr_11=job_info_attr_11, consumable_status_input_option_sheet_count=consumable_status_input_option_sheet_count, consumable_status_cartridge_model=consumable_status_cartridge_model, outbin1=outbin1, printed_modes_total_count=printed_modes_total_count, intray=intray, collated_originals_support=collated_originals_support, upgradable_devices_name=upgradable_devices_name, error13=error13, error5_code=error5_code, job_info_accounting_media_size=job_info_accounting_media_size, hold_job_timeout=hold_job_timeout, consumable_status_first_install_date=consumable_status_first_install_date, consumable_status_capacity_units=consumable_status_capacity_units, media13=media13, simm5_bank1_type=simm5_bank1_type, error30_code=error30_code, error25_code=error25_code, job_info_attr_4=job_info_attr_4, media15=media15, job_info_attr_15=job_info_attr_15, media6_engine_media_mode=media6_engine_media_mode, error5=error5, job_info_attr_12=job_info_attr_12, print_engine=print_engine, media3_engine_media_mode=media3_engine_media_mode, error1_code=error1_code, held_job_enable=held_job_enable, printer_average_marking_agent_units_per_gram=printer_average_marking_agent_units_per_gram, printer_color_accounting=printer_color_accounting, background_status_msg_line2_part1=background_status_msg_line2_part1, error_log_clear=error_log_clear, error14=error14, error22_code=error22_code, destination_subsystem=destination_subsystem, media18_engine_media_mode=media18_engine_media_mode, job_info_outbins_used=job_info_outbins_used, phd3_model=phd3_model, firmware_download_name=firmware_download_name, mio1_manufacturing_info=mio1_manufacturing_info, powersave_mode=powersave_mode, simm4_bank1_type=simm4_bank1_type, consumable_status_page_count_xy_other=consumable_status_page_count_xy_other, simm1_type=simm1_type, printed_modes_usage=printed_modes_usage, simm2_bank2=simm2_bank2, consumable_status_total_equiv_page_count=consumable_status_total_equiv_page_count, media7_page_count=media7_page_count, spooler=spooler, control_panel_display_contents_change_counter=control_panel_display_contents_change_counter, error1_time_stamp=error1_time_stamp, job_input_auto_continue_timeout=job_input_auto_continue_timeout, media_size_count=media_size_count, error19_time_stamp=error19_time_stamp, media_size_west_edge_second_side_offset=media_size_west_edge_second_side_offset, simm5_type=simm5_type, device=device, tray1_phd=tray1_phd, form_feed=form_feed, error17_time_stamp=error17_time_stamp, source_tray_usage_count=source_tray_usage_count, phd2=phd2, error14_time_stamp=error14_time_stamp, source_subsystem=source_subsystem, tray6_media_size_loaded=tray6_media_size_loaded, simm2_bank1=simm2_bank1, printed_media_combined_total=printed_media_combined_total, mio1_type=mio1_type, job_info_attr_9=job_info_attr_9, file_system3=file_system3, background_message1=background_message1, media14=media14, error35_code=error35_code, DisplayString=DisplayString, error44_time_stamp=error44_time_stamp, tables=tables, printer_average=printer_average, media10_name=media10_name, netPMLmgmt=netPMLmgmt, media8_short_name=media8_short_name, error34_code=error34_code, print_meter=print_meter, simm3_bank2_capacity=simm3_bank2_capacity, error27_time_stamp=error27_time_stamp, error45=error45, maximum_ram_disk_memory=maximum_ram_disk_memory, default_custom_paper_xfeed_dim=default_custom_paper_xfeed_dim, simm2_bank1_type=simm2_bank1_type, printed_media_color_total_count=printed_media_color_total_count, upgradable_devices_write_time=upgradable_devices_write_time, printed_media_simplex_count=printed_media_simplex_count, default_vertical_black_resolution=default_vertical_black_resolution, simm1_bank2=simm1_bank2, energy_star=energy_star, file_system_delete_files=file_system_delete_files, error30_time_stamp=error30_time_stamp, channelstatus=channelstatus, media13_engine_media_mode=media13_engine_media_mode, printer_accounting=printer_accounting, errorlog=errorlog, mio3_model_name=mio3_model_name, consumable_reorder_url=consumable_reorder_url, current_job_parsing_id=current_job_parsing_id, pcl_default_font_width=pcl_default_font_width, media32_engine_media_mode=media32_engine_media_mode, media2_engine_media_mode=media2_engine_media_mode, error36=error36, error16=error16, channelinformation=channelinformation, simm2_bank1_capacity=simm2_bank1_capacity, job_info_attr_1=job_info_attr_1, resource_manager=resource_manager, error17_code=error17_code, media7=media7, consumables_status=consumables_status, error7_time_stamp=error7_time_stamp, simm4_type=simm4_type, media10_page_count=media10_page_count, default_vmi=default_vmi, job_info_accounting_color_impression_count=job_info_accounting_color_impression_count, source_tray_usage=source_tray_usage, socket_ping=socket_ping, media7_short_name=media7_short_name, printer_average_marking_agent_coverage=printer_average_marking_agent_coverage, job_info_accounting_yellow_dots=job_info_accounting_yellow_dots, error13_code=error13_code, error9=error9, job_info_attr_6=job_info_attr_6, processing_subsystem=processing_subsystem, error3_code=error3_code, default_custom_paper_feed_dim=default_custom_paper_feed_dim, job_info_accounting=job_info_accounting, job_info_attr_8=job_info_attr_8, consumable_life_usage_units_remaining=consumable_life_usage_units_remaining, error6_time_stamp=error6_time_stamp, error17=error17, engine_media_modes_supported1=engine_media_modes_supported1, consumable_status_last_use_date=consumable_status_last_use_date, error35_time_stamp=error35_time_stamp, error10=error10, error23_time_stamp=error23_time_stamp, settings_pdl=settings_pdl, perm_store_init_occurred=perm_store_init_occurred, media19_engine_media_mode=media19_engine_media_mode, cold_reset_media_size=cold_reset_media_size, media7_name=media7_name, mio3=mio3, settings_rpc=settings_rpc, error29=error29, printer_average_marking_agent_coverage_sum_squared=printer_average_marking_agent_coverage_sum_squared, override_media_size=override_media_size, consumable_status_duplex_sheet_count=consumable_status_duplex_sheet_count, settings_mass_storage_bd=settings_mass_storage_bd, error42_time_stamp=error42_time_stamp, asset_number=asset_number, media17=media17, background_message=background_message, usage_average_toner_coverage=usage_average_toner_coverage)
mibBuilder.exportSymbols("LJ9500-MIB", control_panel_display_contents_crc=control_panel_display_contents_crc, media14_short_name=media14_short_name, outbin4_override_mode=outbin4_override_mode, pcl_default_font_source=pcl_default_font_source, error29_time_stamp=error29_time_stamp, interface=interface, default_custom_paper_dim_unit=default_custom_paper_dim_unit, tray2_media_size_loaded=tray2_media_size_loaded, media20_name=media20_name, simm3_bank2_type=simm3_bank2_type, media13_short_name=media13_short_name, mass_storage_resources=mass_storage_resources, error32=error32, consumables=consumables, error5_time_stamp=error5_time_stamp, marking_agent_density_setting=marking_agent_density_setting, control_panel_button_press=control_panel_button_press, job_info_attr_7=job_info_attr_7, error47_time_stamp=error47_time_stamp, channelifindex=channelifindex, media7_engine_media_mode=media7_engine_media_mode, media8_engine_media_mode=media8_engine_media_mode, operating_system=operating_system, fw_rom_datecode=fw_rom_datecode, job_info_accounting_media_type=job_info_accounting_media_type, channel_io_errors=channel_io_errors, error4_time_stamp=error4_time_stamp, error26_time_stamp=error26_time_stamp, held_job_job_name=held_job_job_name, error42_code=error42_code, error47_code=error47_code, status_mass_storage_bd=status_mass_storage_bd, media_size=media_size, held_job_pin=held_job_pin, media22_short_name=media22_short_name, phd3_device_specific_command=phd3_device_specific_command, print_engine_revision=print_engine_revision, device_location=device_location, upgradable_devices_max_write_count=upgradable_devices_max_write_count, consumable_status_manufacturing_date=consumable_status_manufacturing_date, ph_devices=ph_devices, consumable_status_drum_life_units=consumable_status_drum_life_units, job_info_accounting_black_dots=job_info_accounting_black_dots, consumables_life=consumables_life, outbin3=outbin3, control_panel_display=control_panel_display, error19_code=error19_code, error40=error40, error16_code=error16_code, media3_short_name=media3_short_name, firmware_download_write_time=firmware_download_write_time, media8=media8, print_internal_page=print_internal_page, sleep_mode=sleep_mode, error10_code=error10_code, simm2_type=simm2_type, overflow_bin=overflow_bin, phd2_device_specific_command=phd2_device_specific_command, error48=error48, job_being_parsed=job_being_parsed, error7_code=error7_code, media23_name=media23_name, media6_name=media6_name, simm3=simm3, simm5_bank2=simm5_bank2, status_pdl=status_pdl, error9_time_stamp=error9_time_stamp, simm1_bank1=simm1_bank1, default_media_name=default_media_name, media32_short_name=media32_short_name, pjl=pjl, source_tray_accounting=source_tray_accounting, job_info_page_count_current_original=job_info_page_count_current_original, file_system_set_system_partition_readonly=file_system_set_system_partition_readonly, consumable_status_oem_name=consumable_status_oem_name, error30=error30, media2_page_count=media2_page_count, media16_page_count=media16_page_count, outbin3_override_mode=outbin3_override_mode, model_number=model_number, media4_name=media4_name, error21_code=error21_code, job_info_size=job_info_size, mio1_model_name=mio1_model_name, ports=ports, job_info_change_id=job_info_change_id, media_info=media_info, error29_code=error29_code, consumable_status_developer_life_units=consumable_status_developer_life_units, error46_code=error46_code, pdl=pdl, host_application_available_memory=host_application_available_memory, printed_media_color_simplex_count=printed_media_color_simplex_count, media5_short_name=media5_short_name, error14_code=error14_code, job_info_attr_16=job_info_attr_16, simm5=simm5, error8_time_stamp=error8_time_stamp, job_info_attr_10=job_info_attr_10, outbin4_phd=outbin4_phd, file_system2_initialize_volume=file_system2_initialize_volume, error15_code=error15_code, consumable_status_total_capacity=consumable_status_total_capacity, media1_name=media1_name, media17_name=media17_name, consumable_status_reseller_id=consumable_status_reseller_id, settings_job=settings_job, error31_time_stamp=error31_time_stamp, simm4=simm4, media20_page_count=media20_page_count, simm4_bank1=simm4_bank1, error43_time_stamp=error43_time_stamp, error24=error24, mass_storage_resource_change_counter=mass_storage_resource_change_counter, printed_media_simplex_charge=printed_media_simplex_charge, input_tray_max_media_feed_dim=input_tray_max_media_feed_dim, error3=error3, printed_modes_accounting=printed_modes_accounting, settings_outbin=settings_outbin, outbin4=outbin4, consumable_status_developer_life=consumable_status_developer_life, channelstate=channelstate, out_marking_agent_processing=out_marking_agent_processing, error12_time_stamp=error12_time_stamp, error19=error19, consumable_status_mono_page_count=consumable_status_mono_page_count, error3_time_stamp=error3_time_stamp, error32_time_stamp=error32_time_stamp, simm4_bank2_type=simm4_bank2_type, held_job_info=held_job_info, file_system_max_open_files=file_system_max_open_files, error31=error31, job_info_accounting_media_simplex_count=job_info_accounting_media_simplex_count, error8=error8, remote_procedure_call=remote_procedure_call, settings_print_media=settings_print_media, media2_name=media2_name, mio3_manufacturing_info=mio3_manufacturing_info, firmware_download_version=firmware_download_version, settings_webserver=settings_webserver, error35=error35, error36_time_stamp=error36_time_stamp, error44=error44, consumables_1=consumables_1, error6_code=error6_code, job_input_auto_continue_mode=job_input_auto_continue_mode, error37_code=error37_code, deviceChannelTable=deviceChannelTable, error39=error39, error7=error7, simm3_bank=simm3_bank, service_id=service_id, error22_time_stamp=error22_time_stamp, media4=media4, on_off_line=on_off_line, form_feed_needed=form_feed_needed, job_info_state=job_info_state, job_info_attr_14=job_info_attr_14, error49_time_stamp=error49_time_stamp, usage_printer_mono_total_charge=usage_printer_mono_total_charge, error18=error18, error39_code=error39_code, pdl_pcl=pdl_pcl, simm5_bank1=simm5_bank1, clearable_warning=clearable_warning, error46_time_stamp=error46_time_stamp, media_size_west_edge_side_offset_by_tray=media_size_west_edge_side_offset_by_tray, job_info=job_info, error33=error33, media9_short_name=media9_short_name, media16=media16, upgradable_devices_current_state=upgradable_devices_current_state, port1_parallel_speed=port1_parallel_speed, settings_file_system=settings_file_system, phd2_model=phd2_model, media9_page_count=media9_page_count, media5_name=media5_name, simm2_capacity=simm2_capacity, settings_system=settings_system, simm5_bank2_capacity=simm5_bank2_capacity, media20_short_name=media20_short_name, consumable_status_total_page_count=consumable_status_total_page_count, error12=error12, media8_name=media8_name, error37_time_stamp=error37_time_stamp, north_edge_offset=north_edge_offset, intray6=intray6, error39_time_stamp=error39_time_stamp, job_info_accounting_job_type=job_info_accounting_job_type, job_output_auto_continue_timeout=job_output_auto_continue_timeout, rpc_bind_protocol_address=rpc_bind_protocol_address, file_system3_initialize_volume=file_system3_initialize_volume, media6_page_count=media6_page_count, pdl_postscript=pdl_postscript, job_info_attr_5=job_info_attr_5, error43_code=error43_code, print_media=print_media, mio3_type=mio3_type, printed_media_usage=printed_media_usage, error26=error26, postscript_total_page_count=postscript_total_page_count, channelEntry=channelEntry, error46=error46, outbin1_override_mode=outbin1_override_mode, consumable_status_page_count_half_speed=consumable_status_page_count_half_speed, upgradable_devices=upgradable_devices, job_info_attr_2=job_info_attr_2, media1_page_count=media1_page_count, media17_short_name=media17_short_name, media18_short_name=media18_short_name, usage_instructions_line3=usage_instructions_line3, pcl_default_font_number=pcl_default_font_number, tray3_media_size_loaded=tray3_media_size_loaded, media22=media22, control_panel_display_graphical_contents=control_panel_display_graphical_contents, error50_code=error50_code, printed_media_duplex_charge=printed_media_duplex_charge, error45_code=error45_code, simm4_bank=simm4_bank, error49=error49, simm1_capacity=simm1_capacity, printer_average_marking_agent_coverage_sum=printer_average_marking_agent_coverage_sum, input_tray_auto_select=input_tray_auto_select, test=test, consumable_status_manufacturer_name=consumable_status_manufacturer_name, ram_disk_size=ram_disk_size, held_job_quantity=held_job_quantity, media17_page_count=media17_page_count, intray2=intray2, marker_density_calibration=marker_density_calibration, printed_modes_color_count=printed_modes_color_count, channeltype=channeltype, channelprinteralert=channelprinteralert, error33_code=error33_code, channelnumberofchannels=channelnumberofchannels, localization_languages_supported=localization_languages_supported, outbin3_error_info=outbin3_error_info, install_date=install_date, job_info_pages_printed=job_info_pages_printed, io_timeout=io_timeout, usage_instructions_line4=usage_instructions_line4, error37=error37, held_job_set_queue_size=held_job_set_queue_size, simm4_bank2=simm4_bank2, error49_code=error49_code, display=display, simm1_bank=simm1_bank, input_tray_min_media_xfeed_dim=input_tray_min_media_xfeed_dim, accounting=accounting, error25_time_stamp=error25_time_stamp, consumable_status=consumable_status, simm1_bank1_type=simm1_bank1_type, held_job_delete=held_job_delete, media21_page_count=media21_page_count)
mibBuilder.exportSymbols("LJ9500-MIB", background_status_msg_line1_part1=background_status_msg_line1_part1, media3=media3, ph3=ph3, firmware_download_write_status_supported=firmware_download_write_status_supported, ph=ph, override_media_name=override_media_name, error32_code=error32_code, phd2_manufacturing_info=phd2_manufacturing_info, job_info_pages_processed=job_info_pages_processed, postscript_print_errors=postscript_print_errors, error48_code=error48_code, media5_page_count=media5_page_count, media20_engine_media_mode=media20_engine_media_mode, media5=media5, error28_code=error28_code, media1=media1, mass_storage_block_driver=mass_storage_block_driver, consumable_status_usage_count=consumable_status_usage_count, deviceChannelEntry=deviceChannelEntry, error2_time_stamp=error2_time_stamp, simm1_bank1_capacity=simm1_bank1_capacity, channel_mio=channel_mio, media22_name=media22_name, mio2=mio2, consumable_status_page_count_a4_letter=consumable_status_page_count_a4_letter, mio2_type=mio2_type, job_info_attr_13=job_info_attr_13, media10=media10, error4_code=error4_code, media14_engine_media_mode=media14_engine_media_mode, consumable_status_drum_life=consumable_status_drum_life, error20=error20, default_bits_per_pixel=default_bits_per_pixel, simm3_capacity=simm3_capacity, fw_rom_revision=fw_rom_revision, printer_average_marking_agent_coverage_actual=printer_average_marking_agent_coverage_actual, file_systems=file_systems, printer_cal_cpr_page_count=printer_cal_cpr_page_count, media6_short_name=media6_short_name, job_info_accounting_magenta_dots=job_info_accounting_magenta_dots, printed_media_total_charge=printed_media_total_charge, web_server_security=web_server_security, error22=error22, media17_engine_media_mode=media17_engine_media_mode, simm3_bank1_type=simm3_bank1_type, media19_name=media19_name, usage_instructions_line2=usage_instructions_line2, error40_time_stamp=error40_time_stamp, media19_short_name=media19_short_name, media22_page_count=media22_page_count, usage_instructions_line1=usage_instructions_line1, error4=error4, status_system=status_system, media24_name=media24_name, held_job_control=held_job_control, intrays=intrays, outbins=outbins, firmware_download=firmware_download, job=job, consumable_status_page_count_envelope=consumable_status_page_count_envelope, phd2_capacity=phd2_capacity, display_status=display_status, error23=error23, error12_code=error12_code, file_system=file_system, error8_code=error8_code, error16_time_stamp=error16_time_stamp, media24_page_count=media24_page_count, simm5_bank1_capacity=simm5_bank1_capacity, cancel_job=cancel_job, rpc_bound_protocol_address=rpc_bound_protocol_address, os_execute_file=os_execute_file, usage_printer_color_total_charge=usage_printer_color_total_charge, error33_time_stamp=error33_time_stamp, media13_name=media13_name, media24_engine_media_mode=media24_engine_media_mode, media21_name=media21_name, consumable_status_info=consumable_status_info, job_info_physical_outbins_used=job_info_physical_outbins_used, media3_page_count=media3_page_count, file_system2=file_system2, simm2_bank2_capacity=simm2_bank2_capacity, media32_name=media32_name, job_info_io_source=job_info_io_source, simm4_bank2_capacity=simm4_bank2_capacity, error28=error28, media19=media19, simm=simm, destination_bin_usage_total=destination_bin_usage_total, outbin4_maximum_binding=outbin4_maximum_binding, error25=error25, media2=media2, error50=error50, mass_storage_resource_changed=mass_storage_resource_changed, phd3_type=phd3_type, media15_engine_media_mode=media15_engine_media_mode, firmware_download_current_state=firmware_download_current_state, error50_time_stamp=error50_time_stamp, media23_page_count=media23_page_count, intray1=intray1, error27=error27, PYSNMP_MODULE_ID=hp, socket_ping_job_events_version=socket_ping_job_events_version, media4_page_count=media4_page_count, printed_media_color_duplex_count=printed_media_color_duplex_count, simm1=simm1, simm5_capacity=simm5_capacity, error11_time_stamp=error11_time_stamp, media10_short_name=media10_short_name, consumable_status_color_page_count=consumable_status_color_page_count, usage_printer_total_charge=usage_printer_total_charge, media10_engine_media_mode=media10_engine_media_mode, error42=error42, destination_bin_accounting=destination_bin_accounting, localization_countries_supported=localization_countries_supported, media18_name=media18_name, outbin=outbin, mono_color_switching_mode=mono_color_switching_mode, job_info_stage=job_info_stage, marking_agent=marking_agent, media15_name=media15_name, job_info_attr_3=job_info_attr_3, pcl_total_page_count=pcl_total_page_count, mopy_mode=mopy_mode, tray6_phd=tray6_phd, printed_media_color_usage=printed_media_color_usage, firmware_download_write_count=firmware_download_write_count, error10_time_stamp=error10_time_stamp, default_lines_per_page=default_lines_per_page, simm5_bank2_type=simm5_bank2_type, media16_short_name=media16_short_name, error38=error38, input_tray_min_media_feed_dim=input_tray_min_media_feed_dim, low_marking_agent_processing=low_marking_agent_processing, remote_upgrade_enable=remote_upgrade_enable, printer_cal_cpr_utc=printer_cal_cpr_utc, error20_time_stamp=error20_time_stamp, error34=error34, error2_code=error2_code, error21_time_stamp=error21_time_stamp, error18_code=error18_code, error6=error6, held_job_print=held_job_print, tray1_media_size_loaded=tray1_media_size_loaded, media16_name=media16_name, simm2=simm2, io_switch=io_switch, media18_page_count=media18_page_count, media9=media9, media15_short_name=media15_short_name, media1_engine_media_mode=media1_engine_media_mode, printed_modes_usage_total=printed_modes_usage_total, simm1_bank2_capacity=simm1_bank2_capacity, job_info_name2=job_info_name2, error47=error47, default_horizontal_black_resolution=default_horizontal_black_resolution, channel=channel, held_job_user_name=held_job_user_name, default_copies=default_copies, media4_short_name=media4_short_name, error26_code=error26_code, media23_short_name=media23_short_name, ram_disk_mode=ram_disk_mode, media20=media20, total_color_page_count=total_color_page_count, media15_page_count=media15_page_count, error1=error1, job_info_outcome=job_info_outcome, reprint=reprint, media32=media32, file_system4_initialize_volume=file_system4_initialize_volume, consumable_status_page_count_legal=consumable_status_page_count_legal, error43=error43, media18=media18, error21=error21, default_media_size=default_media_size, outbin4_error_info=outbin4_error_info, held_job=held_job, printed_media_duplex_count=printed_media_duplex_count, media6=media6, media1_short_name=media1_short_name, simm2_bank=simm2_bank, job_info_accounting_grayscale_impression_count=job_info_accounting_grayscale_impression_count, simm5_bank=simm5_bank, destination_bin_usage_count=destination_bin_usage_count, error11_code=error11_code, phd=phd, file_system4=file_system4, webserver_proc_sub=webserver_proc_sub, media_names_available=media_names_available, media_size_west_edge_first_side_offset=media_size_west_edge_first_side_offset, settings_prt_eng=settings_prt_eng, settings_spooler=settings_spooler, marking_agent_density=marking_agent_density, error41_code=error41_code, media21_short_name=media21_short_name, consumable_status_usage_units=consumable_status_usage_units, consumable_status_page_count_a3_ledger=consumable_status_page_count_a3_ledger, auto_continue=auto_continue, job_info_accounting_finishing_options=job_info_accounting_finishing_options, firmware_download_maximum_write_count=firmware_download_maximum_write_count, simm1_bank2_type=simm1_bank2_type, job_info_attribute=job_info_attribute, status_rpc=status_rpc, simm4_capacity=simm4_capacity, source_tray_usage_total=source_tray_usage_total, media14_page_count=media14_page_count, error48_time_stamp=error48_time_stamp, input_tray_max_media_xfeed_dim=input_tray_max_media_xfeed_dim, error34_time_stamp=error34_time_stamp, channelTable=channelTable, simm3_bank1=simm3_bank1, usage_staple_count=usage_staple_count, phd3_manufacturing_info=phd3_manufacturing_info, intray3=intray3, held_job_retention=held_job_retention, printer_cal_dhalf_page_count=printer_cal_dhalf_page_count, error36_code=error36_code, simm3_bank1_capacity=simm3_bank1_capacity, status_prt_eng=status_prt_eng, held_job_security=held_job_security, job_info_printed_originals=job_info_printed_originals, engine_self_diagnostic=engine_self_diagnostic, engine_parameter=engine_parameter, error31_code=error31_code, simm4_bank1_capacity=simm4_bank1_capacity, channel_bytes_received=channel_bytes_received, show_address=show_address, error38_code=error38_code, media23_engine_media_mode=media23_engine_media_mode, consumable_status_total_equiv_mono_page_count=consumable_status_total_equiv_mono_page_count, error41=error41, channel_bytes_sent=channel_bytes_sent)
