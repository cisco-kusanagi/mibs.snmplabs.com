...
TimeTicks, IpAddress, Bits, ModuleIdentity, Gauge32, ObjectIdentity, Counter64, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, Unsigned32, Counter32, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "IpAddress", "Bits", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Counter64", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "Unsigned32", "Counter32", "NotificationType", "iso")
...
mibBuilder.exportSymbols("RITTAL-CMC-III-CAPABILITY-MIB", PYSNMP_MODULE_ID=cmcIIICapability, cmcIIIPuCapsV102=cmcIIIPuCapsV102, cmcIIICapability=cmcIIICapability, cmcIIIPuCapsV104=cmcIIIPuCapsV104, cmcIIIPduCapsV104=cmcIIIPduCapsV104, cmcIIIPuCapsV103=cmcIIIPuCapsV103)
