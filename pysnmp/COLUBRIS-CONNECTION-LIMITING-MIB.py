...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:09:51 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Counter32, Unsigned32, Bits, MibIdentifier, Counter64, ModuleIdentity, TimeTicks, iso, NotificationType, Gauge32, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Counter32", "Unsigned32", "Bits", "MibIdentifier", "Counter64", "ModuleIdentity", "TimeTicks", "iso", "NotificationType", "Gauge32", "Integer32", "IpAddress")
...
mibBuilder.exportSymbols("COLUBRIS-CONNECTION-LIMITING-MIB", colubrisConnectionLimitingMIB=colubrisConnectionLimitingMIB, colubrisConnectionLimitingMIBNotifications=colubrisConnectionLimitingMIBNotifications, connectionLimitingNotificationEnabled=connectionLimitingNotificationEnabled, colubrisConnectionLimitingMIBConformance=colubrisConnectionLimitingMIBConformance, colubrisConnectionLimitingConfigMIBGroup=colubrisConnectionLimitingConfigMIBGroup, connectionLimitingUserMACAddress=connectionLimitingUserMACAddress, colubrisConnectionLimitingNotificationGroup=colubrisConnectionLimitingNotificationGroup, connectionLimitingUserIPAddress=connectionLimitingUserIPAddress, connectionLimitingMaximumSystemConnections=connectionLimitingMaximumSystemConnections, colubrisConnectionLimitingInfoMIBGroup=colubrisConnectionLimitingInfoMIBGroup, colubrisConnectionLimitingMIBGroups=colubrisConnectionLimitingMIBGroups, PYSNMP_MODULE_ID=colubrisConnectionLimitingMIB, colubrisConnectionLimitingMIBCompliance=colubrisConnectionLimitingMIBCompliance, connectionLimitingInfo=connectionLimitingInfo, connectionLimitingMaximumUserConnectionsReached=connectionLimitingMaximumUserConnectionsReached, connectionLimitingMaximumUserConnections=connectionLimitingMaximumUserConnections, colubrisConnectionLimitingMIBNotificationPrefix=colubrisConnectionLimitingMIBNotificationPrefix, connectionLimitingConfig=connectionLimitingConfig, colubrisConnectionLimitingMIBObjects=colubrisConnectionLimitingMIBObjects, colubrisConnectionLimitingMIBCompliances=colubrisConnectionLimitingMIBCompliances)
