...
# Produced by pysmi-0.3.4 at Mon Apr 29 20:10:07 2019
...
ModuleIdentity, Gauge32, Integer32, ObjectIdentity, Unsigned32, Bits, IpAddress, iso, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, enterprises, TimeTicks, NotificationType, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Gauge32", "Integer32", "ObjectIdentity", "Unsigned32", "Bits", "IpAddress", "iso", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "enterprises", "TimeTicks", "NotificationType", "Counter64")
...
mibBuilder.exportSymbols("NETONIX-SWITCH-MIB", netonixSwitchGroups=netonixSwitchGroups, netonixSwitchCompliance=netonixSwitchCompliance, VoltageTC=VoltageTC, tempDescription=tempDescription, tempTable=tempTable, dcdcInputCurrent=dcdcInputCurrent, fanIndex=fanIndex, PYSNMP_MODULE_ID=netonixSwitch, fanSpeed=fanSpeed, voltageTable=voltageTable, firmwareVersion=firmwareVersion, tempEntry=tempEntry, voltage=voltage, netonixSwitchConformance=netonixSwitchConformance, poeStatus=poeStatus, fanTable=fanTable, netonixSwitch=netonixSwitch, netonixSwitchCompliances=netonixSwitchCompliances, totalPowerConsumption=totalPowerConsumption, temp=temp, voltageEntry=voltageEntry, PowerTC=PowerTC, poeStatusTable=poeStatusTable, voltageDescription=voltageDescription, CurrentTC=CurrentTC, poeStatusEntry=poeStatusEntry, voltageIndex=voltageIndex, fanEntry=fanEntry, poeStatusIndex=poeStatusIndex, netonixSwitchGroup=netonixSwitchGroup, tempIndex=tempIndex, dcdcEfficiency=dcdcEfficiency)
