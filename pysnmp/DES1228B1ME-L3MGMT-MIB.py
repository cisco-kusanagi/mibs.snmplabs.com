...
MibIdentifier, iso, NotificationType, TimeTicks, Counter64, Unsigned32, Gauge32, Counter32, Bits, ModuleIdentity, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "NotificationType", "TimeTicks", "Counter64", "Unsigned32", "Gauge32", "Counter32", "Bits", "ModuleIdentity", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
TextualConvention, RowStatus, DisplayString, MacAddress, TimeStamp, PhysAddress, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "RowStatus", "DisplayString", "MacAddress", "TimeStamp", "PhysAddress", "TruthValue")
...
mibBuilder.exportSymbols("DES1228B1ME-L3MGMT-MIB", swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3MgmtMIB=swL3MgmtMIB, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3Ipv6Address=swL3Ipv6Address, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3IpMgmt=swL3IpMgmt, Ipv6Address=Ipv6Address, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3DevMgmt=swL3DevMgmt, swL3IpCtrlTable=swL3IpCtrlTable)
