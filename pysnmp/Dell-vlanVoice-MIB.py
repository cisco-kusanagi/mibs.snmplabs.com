...
# Produced by pysmi-0.3.4 at Mon Apr 29 18:43:18 2019
...
Counter64, Bits, IpAddress, Gauge32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, MibIdentifier, TimeTicks, iso, NotificationType, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Bits", "IpAddress", "Gauge32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "MibIdentifier", "TimeTicks", "iso", "NotificationType", "ObjectIdentity", "Integer32")
...
mibBuilder.exportSymbols("Dell-vlanVoice-MIB", vlanVoiceOUIBasedAgingTimeout=vlanVoiceOUIBasedAgingTimeout, vlanVoiceOUIBasedPortVlanIndex=vlanVoiceOUIBasedPortVlanIndex, vlanVoiceAuto=vlanVoiceAuto, vlanVoiceAutoOperDscp=vlanVoiceAutoOperDscp, vlanVoiceOUIBasedEntry=vlanVoiceOUIBasedEntry, vlanVoiceAutoRefresh=vlanVoiceAutoRefresh, vlanVoiceAdminState=vlanVoiceAdminState, vlanVoiceOUIBasedPortQosMode=vlanVoiceOUIBasedPortQosMode, vlanVoiceOUIBasedPortTable=vlanVoiceOUIBasedPortTable, vlanVoiceOUIBasedAdminRemark=vlanVoiceOUIBasedAdminRemark, vlanVoiceAutoAdminVpt=vlanVoiceAutoAdminVpt, vlanVoiceUcDeviceVpt=vlanVoiceUcDeviceVpt, vlanVoiceAutoAdminDscp=vlanVoiceAutoAdminDscp, vlanVoiceAutoOperPriority=vlanVoiceAutoOperPriority, vlanVoiceOUIBasedPrefix=vlanVoiceOUIBasedPrefix, vlanVoiceUcDeviceVid=vlanVoiceUcDeviceVid, vlanVoiceAutoAgreedVlanLastChange=vlanVoiceAutoAgreedVlanLastChange, vlanVoiceUcDeviceTable=vlanVoiceUcDeviceTable, vlanVoiceOUIBasedPortEntry=vlanVoiceOUIBasedPortEntry, vlanVoiceOUIBasedSetToDefault=vlanVoiceOUIBasedSetToDefault, vlanVoiceUcDeviceMacAddress=vlanVoiceUcDeviceMacAddress, vlanVoiceUcDeviceType=vlanVoiceUcDeviceType, vlanVoiceOUIBasedEntryRowStatus=vlanVoiceOUIBasedEntryRowStatus, vlanVoiceUcDeviceEntry=vlanVoiceUcDeviceEntry, vlanVoiceOUIBasedPortEnable=vlanVoiceOUIBasedPortEnable, vlanVoiceUcDeviceIsBest=vlanVoiceUcDeviceIsBest, vlanVoiceOperState=vlanVoiceOperState, vlanVoiceAutoOperVpt=vlanVoiceAutoOperVpt, vlanVoiceAutoOperSource=vlanVoiceAutoOperSource, vlanVoiceOUIBasedTable=vlanVoiceOUIBasedTable, vlanVoiceOUIBasedPortCurrentMembership=vlanVoiceOUIBasedPortCurrentMembership, vlanVoiceAutoOper=vlanVoiceAutoOper, vlanVoiceUcDeviceInterface=vlanVoiceUcDeviceInterface, vlanVoiceOUIBasedDescription=vlanVoiceOUIBasedDescription, vlanVoice=vlanVoice, PYSNMP_MODULE_ID=vlanVoice, vlanVoiceUcDeviceDscp=vlanVoiceUcDeviceDscp, vlanVoiceOUIBasedPortSecure=vlanVoiceOUIBasedPortSecure, vlanVoiceAutoAdmin=vlanVoiceAutoAdmin, vlanVoiceOUIBasedAdminPriority=vlanVoiceOUIBasedAdminPriority, vlanVoiceOUIBased=vlanVoiceOUIBased, vlanVoiceOperVid=vlanVoiceOperVid, vlanVoiceAdminVid=vlanVoiceAdminVid)
