...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/NET-SNMP-EXTEND-MIB
# Produced by pysmi-0.3.4 at Wed May  1 14:18:08 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, ObjectIdentity, MibIdentifier, Gauge32, IpAddress, NotificationType, Unsigned32, TimeTicks, Bits, iso, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "ObjectIdentity", "MibIdentifier", "Gauge32", "IpAddress", "NotificationType", "Unsigned32", "TimeTicks", "Bits", "iso", "ModuleIdentity", "Counter64")
...
mibBuilder.exportSymbols("NET-SNMP-EXTEND-MIB", nsExtendOutNumLines=nsExtendOutNumLines, nsExtendOutput2Entry=nsExtendOutput2Entry, nsExtendConfigEntry=nsExtendConfigEntry, nsExtendOutput1Table=nsExtendOutput1Table, nsExtendOutputGroup=nsExtendOutputGroup, nsExtendLineIndex=nsExtendLineIndex, netSnmpExtendMIB=netSnmpExtendMIB, nsExtendToken=nsExtendToken, nsExtendInput=nsExtendInput, nsExtendConfigGroup=nsExtendConfigGroup, nsExtendStatus=nsExtendStatus, nsExtendOutput1Entry=nsExtendOutput1Entry, nsExtendOutLine=nsExtendOutLine, nsExtendOutput2Table=nsExtendOutput2Table, nsExtendResult=nsExtendResult, nsExtendObjects=nsExtendObjects, nsExtendStorage=nsExtendStorage, nsExtendCommand=nsExtendCommand, nsExtendOutput1Line=nsExtendOutput1Line, nsExtendArgs=nsExtendArgs, nsExtendOutputFull=nsExtendOutputFull, nsExtendExecType=nsExtendExecType, nsExtendCacheTime=nsExtendCacheTime, nsExtendGroups=nsExtendGroups, nsExtendNumEntries=nsExtendNumEntries, nsExtendConfigTable=nsExtendConfigTable, PYSNMP_MODULE_ID=netSnmpExtendMIB, nsExtendRunType=nsExtendRunType)
