...
# Produced by pysmi-0.3.4 at Wed May  1 12:39:23 2019
...
Bits, TimeTicks, Unsigned32, ModuleIdentity, NotificationType, IpAddress, enterprises, iso, MibIdentifier, Counter32, Gauge32, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, mib_2, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "TimeTicks", "Unsigned32", "ModuleIdentity", "NotificationType", "IpAddress", "enterprises", "iso", "MibIdentifier", "Counter32", "Gauge32", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "mib-2", "Counter64")
...
mibBuilder.exportSymbols("DES-2110-MIB", swFiberInsert=swFiberInsert, swFiberAbnormalTXError=swFiberAbnormalTXError, igsSystem=igsSystem, configVLANMode=configVLANMode, companyStormCtrlGroup=companyStormCtrlGroup, commTrapName=commTrapName, tvlanPortEntry=tvlanPortEntry, configPortOperStatus=configPortOperStatus, RowStatus=RowStatus, configMirrorSrc=configMirrorSrc, staticEntry=staticEntry, commTrapStatus=commTrapStatus, configPortTable=configPortTable, pvlanStatus=pvlanStatus, igsBrgRouterPortList=igsBrgRouterPortList, configPhysAddress=configPhysAddress, commTrapSNMPFiberLinkUpDown=commTrapSNMPFiberLinkUpDown, configRestoreDefaults=configRestoreDefaults, pvlanMember=pvlanMember, configGateway=configGateway, staticTable=staticTable, configMirrorMon=configMirrorMon, commSetTable=commSetTable, staticMac=staticMac, swFiberAbnormalRXError=swFiberAbnormalRXError, staticVlanID=staticVlanID, commTrapSNMPTPLinkUpDown=commTrapSNMPTPLinkUpDown, companyConfigGroup=companyConfigGroup, pvlanName=pvlanName, commSetEntry=commSetEntry, miscStatisticsReset=miscStatisticsReset, staticStatus=staticStatus, tvlanMember=tvlanMember, igsBrgMcastFwdEntry=igsBrgMcastFwdEntry, configPasswordAdmin=configPasswordAdmin, tvlanTable=tvlanTable, d_link=d_link, commTrapIndex=commTrapIndex, configPortSpeed=configPortSpeed, tvlanStatus=tvlanStatus, swFiberRemove=swFiberRemove, commTrapTrapAbnormalFiberTXError=commTrapTrapAbnormalFiberTXError, configIpAssignmentMode=configIpAssignmentMode, companyPVlanGroup=companyPVlanGroup, staticPort=staticPort, commGetIndex=commGetIndex, PortList=PortList, configVerSwPrimary=configVerSwPrimary, igsBrgMcastFwdPortListMac=igsBrgMcastFwdPortListMac, configPort=configPort, igsBrg=igsBrg, companyTVlanGroup=companyTVlanGroup, stormctrlStatus=stormctrlStatus, commGetName=commGetName, companyStaticGroup=companyStaticGroup, commTrapVlanId=commTrapVlanId, commSetIndex=commSetIndex, tvlanPortVlanId=tvlanPortVlanId, configMirrorStatus=configMirrorStatus, commGetStatus=commGetStatus, MacAddress=MacAddress, commTrapTable=commTrapTable, configMirrorId=configMirrorId, pvlanTable=pvlanTable, swTPAbnormalRXError=swTPAbnormalRXError, configIpAddress=configIpAddress, tvlanPortPortId=tvlanPortPortId, staticOnOff=staticOnOff, des_2110=des_2110, companyCommGroup=companyCommGroup, configMirrorMode=configMirrorMode, commTrapIpAddress=commTrapIpAddress, dlink_products=dlink_products, configSave=configSave, commGetTable=commGetTable, tvlanPortPriority=tvlanPortPriority, igsHostPortPurgeInterval=igsHostPortPurgeInterval, OwnerString=OwnerString, configPortFlowControl=configPortFlowControl, configMirrorEntry=configMirrorEntry, igsStatus=igsStatus, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, companyIgsGroup=companyIgsGroup, commTrapEntry=commTrapEntry, commSetName=commSetName, pvlanId=pvlanId, staticAutoLearning=staticAutoLearning, configMirrorTable=configMirrorTable, stormctrlOnOff=stormctrlOnOff, swTPAbnormalTXError=swTPAbnormalTXError, configSNMPEnable=configSNMPEnable, commSetStatus=commSetStatus, staticId=staticId, miscReset=miscReset, configVerHwChipSet=configVerHwChipSet, tvlanUntaggedPorts=tvlanUntaggedPorts, configNetMask=configNetMask, tvlanManagement=tvlanManagement, tvlanEntry=tvlanEntry, configPortPriority=configPortPriority, companySpanGroup=companySpanGroup, spanOnOff=spanOnOff, companyMiscGroup=companyMiscGroup, igsBrgMcastFwdTable=igsBrgMcastFwdTable, configPortEntry=configPortEntry, commGetEntry=commGetEntry, commTrapSNMPBootup=commTrapSNMPBootup, commTrapTrapAbnormalTPTXError=commTrapTrapAbnormalTPTXError, commTrapTrapAbnormalTPRXError=commTrapTrapAbnormalTPRXError, dlink_DES21XXSeriesProd=dlink_DES21XXSeriesProd, configPortFlowControlOper=configPortFlowControlOper, tvlanId=tvlanId, commTrapTrapAbnormalFiberRXError=commTrapTrapAbnormalFiberRXError, pvlanEntry=pvlanEntry, igsBrgMcastFwdGroupAddress=igsBrgMcastFwdGroupAddress, tvlanPortTable=tvlanPortTable)
