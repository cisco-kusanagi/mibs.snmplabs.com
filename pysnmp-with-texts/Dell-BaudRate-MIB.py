...
# Produced by pysmi-0.3.4 at Wed May  1 12:55:29 2019
...
Gauge32, Counter32, iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, ModuleIdentity, IpAddress, Unsigned32, ObjectIdentity, Bits, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter32", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "ModuleIdentity", "IpAddress", "Unsigned32", "ObjectIdentity", "Bits", "MibIdentifier", "NotificationType")
...
if mibBuilder.loadTexts: rlRs232.setContactInfo('www.dell.com')
...
mibBuilder.exportSymbols("Dell-BaudRate-MIB", PYSNMP_MODULE_ID=rlRs232, rlRs232AutoBaudRateStatus=rlRs232AutoBaudRateStatus, rlRs232AutoBaudRateStatusAfterReset=rlRs232AutoBaudRateStatusAfterReset, rlRs232BaudRate=rlRs232BaudRate, rlRs232=rlRs232, rlRs232MibVersion=rlRs232MibVersion)
