...
# Produced by pysmi-0.3.4 at Wed May  1 14:24:10 2019
...
ObjectIdentity, Counter32, iso, Integer32, Gauge32, ModuleIdentity, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Counter64, NotificationType, TimeTicks, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter32", "iso", "Integer32", "Gauge32", "ModuleIdentity", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Counter64", "NotificationType", "TimeTicks", "enterprises", "NotificationType")
...
if mibBuilder.loadTexts: ipxCircDialName.setDescription('The symbolic name used to reference the dialing information used to create this circuit. This value may be written only when creating a new entry in the table.')
...
if mibBuilder.loadTexts: ipxCircStaticStatus.setDescription('Indicates whether the information about static routes and services reached via this circuit matches that saved in permanent storage (currentt). Setting the value to write when it had the value changed will write the currently in use information to permanent storage, if supported. Setting the value to read when it had the value changed will replace any routes and services currently defined for the circuit with those read from permanent storage, if supported.')
...
mibBuilder.exportSymbols("NOVELL-IPX-MIB", ipxDestTable=ipxDestTable, ipxBasicSysEntry=ipxBasicSysEntry, ipxBasicSysOutMalformedRequests=ipxBasicSysOutMalformedRequests, ipxBasicSysOutDiscards=ipxBasicSysOutDiscards, ipxStaticRouteExistState=ipxStaticRouteExistState, ipxCircType=ipxCircType, ipxTrapCircuitDown=ipxTrapCircuitDown, ipxDestSysInstance=ipxDestSysInstance, ipxServNode=ipxServNode, ipxAdvSysInCompressDiscards=ipxAdvSysInCompressDiscards, ipxCircDialName=ipxCircDialName, ipxCircNetNumber=ipxCircNetNumber, ipxServSocket=ipxServSocket, ipxStaticServSocket=ipxStaticServSocket, ipxBasicSysConfigSockets=ipxBasicSysConfigSockets, ipxStaticRouteTicks=ipxStaticRouteTicks, ipxDestEntry=ipxDestEntry, ipxBasicSysInBadChecksums=ipxBasicSysInBadChecksums, ipxSystem=ipxSystem, ipxAdvSysMaxHops=ipxAdvSysMaxHops, ipxCircMediaType=ipxCircMediaType, ipxServices=ipxServices, ipxDestHopCount=ipxDestHopCount, ipxDestServSysInstance=ipxDestServSysInstance, ipxBasicSysInDiscards=ipxBasicSysInDiscards, ipxStaticServHopCount=ipxStaticServHopCount, ipxBasicSysName=ipxBasicSysName, ipxServSysInstance=ipxServSysInstance, ipxStaticServSysInstance=ipxStaticServSysInstance, ipxStaticServTable=ipxStaticServTable, ipxDestNextHopCircIndex=ipxDestNextHopCircIndex, mibDoc=mibDoc, ipxCircCompressSlots=ipxCircCompressSlots, ipxDestServNode=ipxDestServNode, ipxCircName=ipxCircName, ipxStaticServExistState=ipxStaticServExistState, ipxBasicSysOutRequests=ipxBasicSysOutRequests, NetNumber=NetNumber, ipxTrapCircuitUp=ipxTrapCircuitUp, ipxDestNextHopNetNum=ipxDestNextHopNetNum, ipxTraps=ipxTraps, ipxCircCompressedSent=ipxCircCompressedSent, ipxBasicSysInstance=ipxBasicSysInstance, ipxCircEntry=ipxCircEntry, ipxCircLocalMaxPacketSize=ipxCircLocalMaxPacketSize, ipxDestServNetNum=ipxDestServNetNum, ipxCircIfIndex=ipxCircIfIndex, ipxCircCompressState=ipxCircCompressState, ipxAdvSysInstance=ipxAdvSysInstance, ipxServHopCount=ipxServHopCount, ipxCircOperState=ipxCircOperState, ipxCircNeighRouterName=ipxCircNeighRouterName, ipxBasicSysInReceives=ipxBasicSysInReceives, ipxServType=ipxServType, ipxStaticServName=ipxStaticServName, ipxDestTicks=ipxDestTicks, ipxBasicSysInUnknownSockets=ipxBasicSysInUnknownSockets, ipxBasicSysOpenSocketFails=ipxBasicSysOpenSocketFails, ipxDestNetNum=ipxDestNetNum, ipxStaticServEntry=ipxStaticServEntry, ipxDestServEntry=ipxDestServEntry, ipxAdvSysNETBIOSPackets=ipxAdvSysNETBIOSPackets, ipxCircCompressedInitReceived=ipxCircCompressedInitReceived, ipxDestProtocol=ipxDestProtocol, ipxBasicSysNoRoutes=ipxBasicSysNoRoutes, ipxAdvSysEntry=ipxAdvSysEntry, ipxStaticServCircIndex=ipxStaticServCircIndex, ipxStaticServNode=ipxStaticServNode, ipxBasicSysNode=ipxBasicSysNode, ipxBasicSysExistState=ipxBasicSysExistState, ipxCircUncompressedSent=ipxCircUncompressedSent, ipxDestServName=ipxDestServName, ipxCircStaticStatus=ipxCircStaticStatus, ipxCircCompressedInitSent=ipxCircCompressedInitSent, ipxStaticRouteCircIndex=ipxStaticRouteCircIndex, novellMib=novellMib, ipxCircIndex=ipxCircIndex, ipxStaticServType=ipxStaticServType, ipxAdvSysOutCompressDiscards=ipxAdvSysOutCompressDiscards, ipxAdvSysMaxPathSplits=ipxAdvSysMaxPathSplits, ipxAdvSysForwPackets=ipxAdvSysForwPackets, ipxCircStateChanges=ipxCircStateChanges, ipxAdvSysTable=ipxAdvSysTable, ipxCircUncompressedReceived=ipxCircUncompressedReceived, ipxCircTable=ipxCircTable, ipxBasicSysInDelivers=ipxBasicSysInDelivers, ipxServNetNum=ipxServNetNum, ipxServEntry=ipxServEntry, ipxBasicSysTable=ipxBasicSysTable, ipxBasicSysOutPackets=ipxBasicSysOutPackets, ipxCircExistState=ipxCircExistState, ipxDestServTable=ipxDestServTable, ipxBasicSysNetNumber=ipxBasicSysNetNumber, ipxServTable=ipxServTable, ipxAdvSysDestCount=ipxAdvSysDestCount, ipxServName=ipxServName, ipxForwarding=ipxForwarding, ipxCircSysInstance=ipxCircSysInstance, ipxDestServHopCount=ipxDestServHopCount, ipxStaticRouteSysInstance=ipxStaticRouteSysInstance, ipxStaticServNetNum=ipxStaticServNetNum, ipxBasicSysInHdrErrors=ipxBasicSysInHdrErrors, ipxStaticRouteHopCount=ipxStaticRouteHopCount, ipxAdvSysServCount=ipxAdvSysServCount, ipxCircCompressedRejectsSent=ipxCircCompressedRejectsSent, ipx=ipx, ipxCircCompressedRejectsReceived=ipxCircCompressedRejectsReceived, ipxStaticRouteNetNum=ipxStaticRouteNetNum, ipxCircDelay=ipxCircDelay, ipxAdvSysOutFiltered=ipxAdvSysOutFiltered, ipxAdvSysCircCount=ipxAdvSysCircCount, ipxCircThroughput=ipxCircThroughput, ipxDestServType=ipxDestServType, ipxStaticRouteEntry=ipxStaticRouteEntry, ipxDestNextHopNICAddress=ipxDestNextHopNICAddress, ipxCircuit=ipxCircuit, ipxDestServProtocol=ipxDestServProtocol, ipxStaticRouteTable=ipxStaticRouteTable, ipxCircCompressedReceived=ipxCircCompressedReceived, ipxDestServSocket=ipxDestServSocket, ipxCircNeighInternalNetNum=ipxCircNeighInternalNetNum, ipxCircInitFails=ipxCircInitFails, ipxAdvSysInFiltered=ipxAdvSysInFiltered, ipxAdvSysInTooManyHops=ipxAdvSysInTooManyHops, ipxServProtocol=ipxServProtocol)
