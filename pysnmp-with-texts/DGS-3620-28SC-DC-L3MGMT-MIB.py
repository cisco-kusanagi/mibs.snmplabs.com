...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS-3620-28SC-DC-L3MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:44:29 2019
...
Status, UpToMaxAge, TOSType, DesignatedRouterPriority, RouterID, HelloRange, Metric, PositiveInteger, AreaID = mibBuilder.importSymbols("OSPF-MIB", "Status", "UpToMaxAge", "TOSType", "DesignatedRouterPriority", "RouterID", "HelloRange", "Metric", "PositiveInteger", "AreaID")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Integer32, Bits, Counter32, Unsigned32, iso, NotificationType, MibIdentifier, Counter64, TimeTicks, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Integer32", "Bits", "Counter32", "Unsigned32", "iso", "NotificationType", "MibIdentifier", "Counter64", "TimeTicks", "Gauge32", "ObjectIdentity")
TextualConvention, DisplayString, TimeStamp, TruthValue, MacAddress, PhysAddress, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "TimeStamp", "TruthValue", "MacAddress", "PhysAddress", "RowStatus")
...
swL3IpCtrlIpDhcpOption12State = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 2, 1, 3, 1, 22), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpDhcpOption12HostName = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 2, 1, 3, 1, 23), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 63))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 2, 1, 3, 1, 28), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigDefault = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 2, 1, 3, 1, 29), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 2, 1, 3, 1, 30), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientPDRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 2, 1, 3, 1, 31), TruthValue()).setMaxAccess("readwrite")
...
swL3ospfIfDistributeListInType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 8, 1, 24), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
swL3ospfIfBfdStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 8, 1, 26), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("disabled", 1), ("enabled", 2)))).setMaxAccess("readwrite")
...
swL3VrrpOperBfdPeerAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 14, 1, 1, 17), IpAddress().clone(hexValue="00000000")).setMaxAccess("readcreate")
...
swL3RIPInboundRouteFilterType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 9, 3, 19, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS-3620-28SC-DC-L3MGMT-MIB", swL3ospfIfType=swL3ospfIfType, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3Ipv6DHCPv6CPDAddrCtrlState=swL3Ipv6DHCPv6CPDAddrCtrlState, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3OspfECMPState=swL3OspfECMPState, swL3RIPTimeOutTime=swL3RIPTimeOutTime, swL3Route6RedistriDstProtocol=swL3Route6RedistriDstProtocol, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3DevMgmt=swL3DevMgmt, swL3RoutePreferenceEBGP=swL3RoutePreferenceEBGP, swL3Md5Entry=swL3Md5Entry, swL3RelayMgmt=swL3RelayMgmt, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3RoutePreferenceIBGP=swL3RoutePreferenceIBGP, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3OspfDefInfoOrigMgmt=swL3OspfDefInfoOrigMgmt, swL3RIPUpdateTime=swL3RIPUpdateTime, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, VrId=VrId, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr, swL3RelayDnsState=swL3RelayDnsState, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3IpCtrlDhcpv6ClientRapidCommit=swL3IpCtrlDhcpv6ClientRapidCommit, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3LoopBackIpCtrlIfIndex=swL3LoopBackIpCtrlIfIndex, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3IpStaticRouteTunnelEntry=swL3IpStaticRouteTunnelEntry, swL3ospfIfEvents=swL3ospfIfEvents, swL3ospfAreaType=swL3ospfAreaType, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3ospfIfDistributeListInName=swL3ospfIfDistributeListInName, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3LoopBackIpCtrlIpSubnetMask=swL3LoopBackIpCtrlIpSubnetMask, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3RoutePreference=swL3RoutePreference, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3IpCtrlDhcpv6ClientPDPrefixLen=swL3IpCtrlDhcpv6ClientPDPrefixLen, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3OspfHostTOS=swL3OspfHostTOS, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3OspfHostMetric=swL3OspfHostMetric, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3ospfIfBfdStatus=swL3ospfIfBfdStatus, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3IpCtrlDhcpv6ClientPDPrefixName=swL3IpCtrlDhcpv6ClientPDPrefixName, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3RIPInboundRouteFilterEntry=swL3RIPInboundRouteFilterEntry, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=swL3Ipv6DHCPv6CPDAddrCtrlPrefixName, swL3DevCtrl=swL3DevCtrl, swL3Route6RedistriTable=swL3Route6RedistriTable, swL3IpStaticRouteTunnelTable=swL3IpStaticRouteTunnelTable, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3Md5Key=swL3Md5Key, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3VrrpOperTable=swL3VrrpOperTable, swL3VrrpOperState=swL3VrrpOperState, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3OspfHostStatus=swL3OspfHostStatus, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3Route6RedistriType=swL3Route6RedistriType, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3ospfAreaTable=swL3ospfAreaTable, swL3LoopBackIpCtrlEntry=swL3LoopBackIpCtrlEntry, swL3Md5KeyId=swL3Md5KeyId, swL3IpCtrlMode=swL3IpCtrlMode, swL3ospfIfEntry=swL3ospfIfEntry, swL3ospfIfMetric=swL3ospfIfMetric, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3LoopBackIpCtrlIpAddr=swL3LoopBackIpCtrlIpAddr, swL3OspfDefInfoOrigMetricType=swL3OspfDefInfoOrigMetricType, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3Route6RedistriEntry=swL3Route6RedistriEntry, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3LoopBackIpCtrlAdminState=swL3LoopBackIpCtrlAdminState, swL3IpCtrlDhcpv6ClientPDRapidCommit=swL3IpCtrlDhcpv6ClientPDRapidCommit, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3IpCtrlIpv6AdminState=swL3IpCtrlIpv6AdminState, swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3RIPGarbageCollectionTime=swL3RIPGarbageCollectionTime, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3LoopBackIpCtrlRowStatus=swL3LoopBackIpCtrlRowStatus, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3RIPInboundRouteFilterType=swL3RIPInboundRouteFilterType, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3Ipv6Address=swL3Ipv6Address, swL3Md5Table=swL3Md5Table, swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3LoopBackIpCtrlTable=swL3LoopBackIpCtrlTable, swL3Md5RowStatus=swL3Md5RowStatus, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3IpCtrlDhcpv6ClientPDState=swL3IpCtrlDhcpv6ClientPDState, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3ospfAreaId=swL3ospfAreaId, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3RIPInboundRouteFilterName=swL3RIPInboundRouteFilterName, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3IpCtrlState=swL3IpCtrlState, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3Route6RedistriSrcProtocol=swL3Route6RedistriSrcProtocol, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, NodeAddress=NodeAddress, swL3IpCtrlIpv6AutoConfigDefault=swL3IpCtrlIpv6AutoConfigDefault, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3ospfIfState=swL3ospfIfState, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3IpStaticRouteTunnelRowStatus=swL3IpStaticRouteTunnelRowStatus, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3Ipv6DHCPv6CPDAddrCtrlEntry=swL3Ipv6DHCPv6CPDAddrCtrlEntry, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3IpMgmt=swL3IpMgmt, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3ospfIfTable=swL3ospfIfTable, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3Ipv6DHCPv6CPDAddrCtrlTable=swL3Ipv6DHCPv6CPDAddrCtrlTable, swL3ospfIfDistributeListInType=swL3ospfIfDistributeListInType, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3Route6RedistriMetric=swL3Route6RedistriMetric, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3RIPInboundRouteFilterTable=swL3RIPInboundRouteFilterTable, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3OspfHostEntry=swL3OspfHostEntry, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3MgmtMIB=swL3MgmtMIB, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3Route6RedistriRowStatus=swL3Route6RedistriRowStatus, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3RouteRedistriType=swL3RouteRedistriType, swL3IpCtrlIpDirectedBroadcastState=swL3IpCtrlIpDirectedBroadcastState, swL3LoopBackIpCtrlInterfaceName=swL3LoopBackIpCtrlInterfaceName, swL3IpCtrlIpv6AutoConfigState=swL3IpCtrlIpv6AutoConfigState, swL3IpCtrlDhcpv6ClientPDPrefix=swL3IpCtrlDhcpv6ClientPDPrefix, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3RouteRedistriRouteMapName=swL3RouteRedistriRouteMapName, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3OspfHostTable=swL3OspfHostTable, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3OspfDefInfoOrigMetric=swL3OspfDefInfoOrigMetric, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3VrrpOperBfdPeerAddr=swL3VrrpOperBfdPeerAddr, swL3RIPInboundRouteFilterIfIpAddress=swL3RIPInboundRouteFilterIfIpAddress, swL3RouteRedistriMetric=swL3RouteRedistriMetric)
mibBuilder.exportSymbols("DGS-3620-28SC-DC-L3MGMT-MIB", swL3IpCtrlEntry=swL3IpCtrlEntry, swL3RIPTimerMgmt=swL3RIPTimerMgmt, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3IpCtrlIpv4AdminState=swL3IpCtrlIpv4AdminState, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3IpStaticRouteTunnelInterfaceName=swL3IpStaticRouteTunnelInterfaceName, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3RoutePreferenceDefault=swL3RoutePreferenceDefault, swL3IpCtrlTable=swL3IpCtrlTable, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, NetAddress=NetAddress, swL3IpCtrlLocalProxyArp=swL3IpCtrlLocalProxyArp, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3ospfIfDemand=swL3ospfIfDemand, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3OspfDefInfoOriginate=swL3OspfDefInfoOriginate, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable)
