...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS-3620-28PC-L3MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:44:23 2019
...
Metric, Status, PositiveInteger, DesignatedRouterPriority, UpToMaxAge, TOSType, AreaID, HelloRange, RouterID = mibBuilder.importSymbols("OSPF-MIB", "Metric", "Status", "PositiveInteger", "DesignatedRouterPriority", "UpToMaxAge", "TOSType", "AreaID", "HelloRange", "RouterID")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
IpAddress, Unsigned32, Integer32, Counter32, iso, Counter64, Gauge32, MibIdentifier, ObjectIdentity, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Unsigned32", "Integer32", "Counter32", "iso", "Counter64", "Gauge32", "MibIdentifier", "ObjectIdentity", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits")
...
swL3IpCtrlIpDhcpOption12State = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 3, 2, 1, 3, 1, 22), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpDhcpOption12HostName = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 3, 2, 1, 3, 1, 23), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 63))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 3, 2, 1, 3, 1, 28), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigDefault = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 3, 2, 1, 3, 1, 29), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 3, 2, 1, 3, 1, 30), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientPDRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 3, 2, 1, 3, 1, 31), TruthValue()).setMaxAccess("readwrite")
...
swL3ospfIfDistributeListInType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 3, 8, 1, 24), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
swL3ospfIfBfdStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 3, 8, 1, 26), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("disabled", 1), ("enabled", 2)))).setMaxAccess("readwrite")
...
swL3VrrpOperBfdPeerAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 3, 14, 1, 1, 17), IpAddress().clone(hexValue="00000000")).setMaxAccess("readcreate")
...
swL3RIPInboundRouteFilterType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 3, 19, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS-3620-28PC-L3MGMT-MIB", swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3IpCtrlIpv6AutoConfigDefault=swL3IpCtrlIpv6AutoConfigDefault, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3ospfIfBfdStatus=swL3ospfIfBfdStatus, swL3IpCtrlDhcpv6ClientPDPrefixName=swL3IpCtrlDhcpv6ClientPDPrefixName, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3OspfHostTable=swL3OspfHostTable, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3OspfHostStatus=swL3OspfHostStatus, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3IpStaticRouteTunnelTable=swL3IpStaticRouteTunnelTable, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3VrrpOperState=swL3VrrpOperState, swL3RouteRedistriType=swL3RouteRedistriType, swL3ospfAreaTable=swL3ospfAreaTable, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3IpMgmt=swL3IpMgmt, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3IpStaticRouteTable=swL3IpStaticRouteTable, NodeAddress=NodeAddress, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3Route6RedistriSrcProtocol=swL3Route6RedistriSrcProtocol, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3IpCtrlTable=swL3IpCtrlTable, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3RoutePreferenceEBGP=swL3RoutePreferenceEBGP, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3LoopBackIpCtrlRowStatus=swL3LoopBackIpCtrlRowStatus, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3Route6RedistriDstProtocol=swL3Route6RedistriDstProtocol, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3Md5RowStatus=swL3Md5RowStatus, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3OspfHostEntry=swL3OspfHostEntry, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3Ipv6Address=swL3Ipv6Address, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3RouteRedistriRouteMapName=swL3RouteRedistriRouteMapName, swL3RoutePreference=swL3RoutePreference, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3RIPInboundRouteFilterIfIpAddress=swL3RIPInboundRouteFilterIfIpAddress, swL3ospfIfDistributeListInType=swL3ospfIfDistributeListInType, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3ospfIfEntry=swL3ospfIfEntry, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3RoutePreferenceIBGP=swL3RoutePreferenceIBGP, swL3ospfIfState=swL3ospfIfState, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3OspfDefInfoOrigMetricType=swL3OspfDefInfoOrigMetricType, swL3OspfDefInfoOrigMetric=swL3OspfDefInfoOrigMetric, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3RIPGarbageCollectionTime=swL3RIPGarbageCollectionTime, swL3LoopBackIpCtrlInterfaceName=swL3LoopBackIpCtrlInterfaceName, swL3RIPInboundRouteFilterType=swL3RIPInboundRouteFilterType, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3IpCtrlIpv4AdminState=swL3IpCtrlIpv4AdminState, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3OspfDefInfoOriginate=swL3OspfDefInfoOriginate, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3IpCtrlIpv6AdminState=swL3IpCtrlIpv6AdminState, VrId=VrId, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3ospfIfEvents=swL3ospfIfEvents, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3Ipv6DHCPv6CPDAddrCtrlState=swL3Ipv6DHCPv6CPDAddrCtrlState, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3ospfAreaId=swL3ospfAreaId, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3ospfAreaType=swL3ospfAreaType, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3Route6RedistriRowStatus=swL3Route6RedistriRowStatus, swL3IpStaticRouteTunnelEntry=swL3IpStaticRouteTunnelEntry, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3Md5KeyId=swL3Md5KeyId, swL3RIPInboundRouteFilterEntry=swL3RIPInboundRouteFilterEntry, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3ospfIfMetric=swL3ospfIfMetric, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3Route6RedistriEntry=swL3Route6RedistriEntry, swL3LoopBackIpCtrlTable=swL3LoopBackIpCtrlTable, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3IpCtrlDhcpv6ClientRapidCommit=swL3IpCtrlDhcpv6ClientRapidCommit, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=swL3Ipv6DHCPv6CPDAddrCtrlPrefixName, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3Route6RedistriType=swL3Route6RedistriType, swL3IpStaticRouteTunnelRowStatus=swL3IpStaticRouteTunnelRowStatus, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3VrrpOperTable=swL3VrrpOperTable, swL3IpStaticRouteTunnelInterfaceName=swL3IpStaticRouteTunnelInterfaceName, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3OspfHostMetric=swL3OspfHostMetric, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3IpCtrlDhcpv6ClientPDState=swL3IpCtrlDhcpv6ClientPDState, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName, swL3RIPUpdateTime=swL3RIPUpdateTime, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3VrrpOperBfdPeerAddr=swL3VrrpOperBfdPeerAddr, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3OspfHostTOS=swL3OspfHostTOS, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3IpCtrlDhcpv6ClientPDPrefix=swL3IpCtrlDhcpv6ClientPDPrefix, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3RoutePreferenceDefault=swL3RoutePreferenceDefault, swL3RIPInboundRouteFilterName=swL3RIPInboundRouteFilterName, NetAddress=NetAddress, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3DevMgmt=swL3DevMgmt, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3ospfIfTable=swL3ospfIfTable, swL3MgmtMIB=swL3MgmtMIB, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3OspfECMPState=swL3OspfECMPState, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3OspfDefInfoOrigMgmt=swL3OspfDefInfoOrigMgmt, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3LoopBackIpCtrlAdminState=swL3LoopBackIpCtrlAdminState, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3DevCtrl=swL3DevCtrl, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3LoopBackIpCtrlEntry=swL3LoopBackIpCtrlEntry, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3ospfIfType=swL3ospfIfType, swL3Md5Key=swL3Md5Key, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3ospfIfDistributeListInName=swL3ospfIfDistributeListInName, swL3IpCtrlIpv6AutoConfigState=swL3IpCtrlIpv6AutoConfigState, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3Route6RedistriMetric=swL3Route6RedistriMetric, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3IpCtrlLocalProxyArp=swL3IpCtrlLocalProxyArp, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3Md5Table=swL3Md5Table, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3ospfIfDemand=swL3ospfIfDemand, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3Ipv6DHCPv6CPDAddrCtrlEntry=swL3Ipv6DHCPv6CPDAddrCtrlEntry, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3IpCtrlIpDirectedBroadcastState=swL3IpCtrlIpDirectedBroadcastState, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3RelayDnsState=swL3RelayDnsState, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3LoopBackIpCtrlIfIndex=swL3LoopBackIpCtrlIfIndex)
mibBuilder.exportSymbols("DGS-3620-28PC-L3MGMT-MIB", swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3IpCtrlDhcpv6ClientPDPrefixLen=swL3IpCtrlDhcpv6ClientPDPrefixLen, swL3LoopBackIpCtrlIpAddr=swL3LoopBackIpCtrlIpAddr, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3RIPTimeOutTime=swL3RIPTimeOutTime, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3Route6RedistriTable=swL3Route6RedistriTable, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3Md5Entry=swL3Md5Entry, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3IpCtrlState=swL3IpCtrlState, swL3RIPTimerMgmt=swL3RIPTimerMgmt, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3IpCtrlMode=swL3IpCtrlMode, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3Ipv6DHCPv6CPDAddrCtrlTable=swL3Ipv6DHCPv6CPDAddrCtrlTable, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3RIPInboundRouteFilterTable=swL3RIPInboundRouteFilterTable, swL3RelayMgmt=swL3RelayMgmt, swL3LoopBackIpCtrlIpSubnetMask=swL3LoopBackIpCtrlIpSubnetMask, swL3IpCtrlDhcpv6ClientPDRapidCommit=swL3IpCtrlDhcpv6ClientPDRapidCommit)
