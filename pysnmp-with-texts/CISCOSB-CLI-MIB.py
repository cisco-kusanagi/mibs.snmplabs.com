...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/CISCOSB-CLI-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:22:04 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, ModuleIdentity, NotificationType, MibIdentifier, Unsigned32, TimeTicks, IpAddress, iso, Counter32, Gauge32, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "ModuleIdentity", "NotificationType", "MibIdentifier", "Unsigned32", "TimeTicks", "IpAddress", "iso", "Counter32", "Gauge32", "ObjectIdentity", "Integer32")
...
if mibBuilder.loadTexts: rlCli.setOrganization('Cisco Small Business')
if mibBuilder.loadTexts: rlCli.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
rlCLIremoteCLIcommand = MibScalar((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 52, 6, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6))).clone(namedValues=NamedValues(("takeRemoteCLI", 1), ("releaseRemoteCLI", 2), ("applySentCLI", 3), ("deleteCommandsCLI", 4), ("setEchoModeCLI", 5), ("unsetEchoModeCLI", 6)))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("CISCOSB-CLI-MIB", rlCliTimer=rlCliTimer, PYSNMP_MODULE_ID=rlCli, rlCLIremoteCLIcommandPart=rlCLIremoteCLIcommandPart, rlCLIremoteCLImode=rlCLIremoteCLImode, rlCLIremoteCLIoutputCommandNumber=rlCLIremoteCLIoutputCommandNumber, rlCLIremoteCLIinstance=rlCLIremoteCLIinstance, rlCli=rlCli, rlCLIremoteCLIcommandsEntry=rlCLIremoteCLIcommandsEntry, rlCLIremoteCLIoutputsTable=rlCLIremoteCLIoutputsTable, rlCliMibVersion=rlCliMibVersion, rlCLIremoteCLIactivationStatus=rlCLIremoteCLIactivationStatus, rlCliFileEnable=rlCliFileEnable, rlCLIremoteCLIcommand=rlCLIremoteCLIcommand, rlCLIremoteCLIsupport=rlCLIremoteCLIsupport, rlCLIremoteCLIcommandsTable=rlCLIremoteCLIcommandsTable, rlCLIremoteCLIoutputsEntry=rlCLIremoteCLIoutputsEntry, rlCLIremoteCLIoutputRowIndex=rlCLIremoteCLIoutputRowIndex, rlCLIremoteCLIexecutionCommandIndex=rlCLIremoteCLIexecutionCommandIndex, rlCLIremoteCLIoutputRowPart=rlCLIremoteCLIoutputRowPart, rlCLIremoteCLIoutputRowPartNumber=rlCLIremoteCLIoutputRowPartNumber, rlCliPassword=rlCliPassword, rlCliFileEnableAfterReset=rlCliFileEnableAfterReset, rlCLIremoteCLIcommandIndex=rlCLIremoteCLIcommandIndex, rlCLIremoteCLIexecutionState=rlCLIremoteCLIexecutionState, rlCLIremoteCLIcommandPartNumber=rlCLIremoteCLIcommandPartNumber, rlCLIremoteCLIcommandStatus=rlCLIremoteCLIcommandStatus, rlCLIremoteCLIoutputRowStatus=rlCLIremoteCLIoutputRowStatus)
