...
# Produced by pysmi-0.3.4 at Wed May  1 14:32:58 2019
...
MibIdentifier, NotificationType, ModuleIdentity, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter64, IpAddress, Gauge32, Bits, iso, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "ModuleIdentity", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter64", "IpAddress", "Gauge32", "Bits", "iso", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("OLD-DNOS-BOXSERVICES-PRIVATE-MIB", boxServicesTempSensorState=boxServicesTempSensorState, boxServicesStackTempSensorTemperature=boxServicesStackTempSensorTemperature, boxServicesFanSpeed=boxServicesFanSpeed, boxServicesTempSensorsTable=boxServicesTempSensorsTable, boxServicesTempSensorTemperature=boxServicesTempSensorTemperature, fastPathBoxServices=fastPathBoxServices, boxServicesTempSensorsEntry=boxServicesTempSensorsEntry, PYSNMP_MODULE_ID=fastPathBoxServices, boxServicesPSMStateTrapEnable=boxServicesPSMStateTrapEnable, boxsFanStateChange=boxsFanStateChange, boxsPowSupplyStateChange=boxsPowSupplyStateChange, boxServicesFanItemType=boxServicesFanItemType, boxServicesStackTempSensorsTable=boxServicesStackTempSensorsTable, boxServicesUnitIndex=boxServicesUnitIndex, boxsTemperatureChangeEvent=boxsTemperatureChangeEvent, boxServicesStackTempSensorIndex=boxServicesStackTempSensorIndex, boxsItemStateChangeEvent=boxsItemStateChangeEvent, boxServicesNormalTempRangeMax=boxServicesNormalTempRangeMax, boxServicesFanStateTrapEnable=boxServicesFanStateTrapEnable, boxServicesStackTempSensorType=boxServicesStackTempSensorType, boxServicesStackTempSensorsEntry=boxServicesStackTempSensorsEntry, boxServicesFanItemState=boxServicesFanItemState, boxServicesGroup=boxServicesGroup, boxServicesFansEntry=boxServicesFansEntry, boxsTemperatureChange=boxsTemperatureChange, boxServicesPowSuppliesTable=boxServicesPowSuppliesTable, boxServicesFanDutyLevel=boxServicesFanDutyLevel, boxServicesFansTable=boxServicesFansTable, boxServicesTempSensorIndex=boxServicesTempSensorIndex, fastPathBoxServicesTraps=fastPathBoxServicesTraps, boxServicesNormalTempRangeMin=boxServicesNormalTempRangeMin, boxServicesPowSupplyIndex=boxServicesPowSupplyIndex, boxServicesTempSensorType=boxServicesTempSensorType, boxServicesStackTempSensorState=boxServicesStackTempSensorState, boxServicesPowSupplyItemType=boxServicesPowSupplyItemType, boxServicesTemperatureTrapEnable=boxServicesTemperatureTrapEnable, boxServicesFansIndex=boxServicesFansIndex, boxServicesNotificationsGroup=boxServicesNotificationsGroup, boxServicesPowSuppliesEntry=boxServicesPowSuppliesEntry, boxServicesPowSupplyItemState=boxServicesPowSupplyItemState)
