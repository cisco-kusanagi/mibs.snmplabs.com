...
# Produced by pysmi-0.3.4 at Wed May  1 12:42:45 2019
...
Bits, MibIdentifier, enterprises, Counter32, ObjectIdentity, TimeTicks, iso, Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Integer32, Unsigned32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibIdentifier", "enterprises", "Counter32", "ObjectIdentity", "TimeTicks", "iso", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Integer32", "Unsigned32", "NotificationType")
...
mibBuilder.exportSymbols("DGS-1210-20_BX", ipv4snmpV3HostAddress=ipv4snmpV3HostAddress, impbInsIpPacPortState=impbInsIpPacPortState, syslogSrvSeverity=syslogSrvSeverity, companySyslog=companySyslog, qosDiffServType09=qosDiffServType09, qosDiffServType42=qosDiffServType42, aclL3RulePortList=aclL3RulePortList, ipv4dhcpServerScreenServerAddress=ipv4dhcpServerScreenServerAddress, ipifv6AutolinkloStatus=ipifv6AutolinkloStatus, qosDiffServType21=qosDiffServType21, broadcastStormCtrlThreshold=broadcastStormCtrlThreshold, laPortChannelMemberList=laPortChannelMemberList, aclL2RuleEtherType=aclL2RuleEtherType, sysRestart=sysRestart, voicevlanDeviceIndexMac=voicevlanDeviceIndexMac, rmonHistoryBucketsRequested=rmonHistoryBucketsRequested, staticMcastEntry=staticMcastEntry, sysLBDRecoverTime=sysLBDRecoverTime, stpAdminPortPathCost=stpAdminPortPathCost, dlinklldpLocManAddrSubtype=dlinklldpLocManAddrSubtype, sysPortCtrlEntry=sysPortCtrlEntry, aclL3RuleAccessID=aclL3RuleAccessID, neighborCacheState=neighborCacheState, impbWhiteListRowStatus=impbWhiteListRowStatus, impbSettingEntry=impbSettingEntry, qosDiffServType30=qosDiffServType30, queuingMechanism=queuingMechanism, aclProfileArpSenderMacAddrMask=aclProfileArpSenderMacAddrMask, dot3azEEEset=dot3azEEEset, stpTopChanges=stpTopChanges, companyTrapSetting=companyTrapSetting, qosDiffServType45=qosDiffServType45, snmpV3HostTable=snmpV3HostTable, sysTrapPortEvent=sysTrapPortEvent, ipv4sysSNTPDSTEndMon=ipv4sysSNTPDSTEndMon, ipv4sysIpAddr=ipv4sysIpAddr, aclProfileSrcIpAddrMaskType=aclProfileSrcIpAddrMaskType, impbSmartPort=impbSmartPort, sysSNTPDSTEndHour=sysSNTPDSTEndHour, ipv4snmpV3HostCommunityName=ipv4snmpV3HostCommunityName, ipifV6AddressIpAddr=ipifV6AddressIpAddr, staticMcastEgressPorts=staticMcastEgressPorts, stpHoldTime=stpHoldTime, dlinkGreenPortShutoffPortList=dlinkGreenPortShutoffPortList, rmonStatistics=rmonStatistics, dot1qVlanName=dot1qVlanName, rmonHistoryEntry=rmonHistoryEntry, qosDiffServType00=qosDiffServType00, voicevlanDeviceStatus=voicevlanDeviceStatus, tftpConfigTftpOperation=tftpConfigTftpOperation, ipv4aclProfileArpSenderIpAddrMask=ipv4aclProfileArpSenderIpAddrMask, stpPortDesignatedRoot=stpPortDesignatedRoot, snmpV3viewTreeMask=snmpV3viewTreeMask, portSecTable=portSecTable, rstpStatus=rstpStatus, companyStaticMAC=companyStaticMAC, sysTrapStatus=sysTrapStatus, aclv6L3RuleTcpPshBit=aclv6L3RuleTcpPshBit, rmonAlarm=rmonAlarm, sysSNTPTimeSeconds=sysSNTPTimeSeconds, qosDiffServType50=qosDiffServType50, swTimeRangeIndex=swTimeRangeIndex, dhcpServerScreenIPType=dhcpServerScreenIPType, qosDiffServType08=qosDiffServType08, ipv4sysIpSubnetMask=ipv4sysIpSubnetMask, qosDiffServType39=qosDiffServType39, radiusServerTable=radiusServerTable, qosDiffServType11=qosDiffServType11, aclProfileSrcPortMask=aclProfileSrcPortMask, qosTOSType06=qosTOSType06, impbBlackListIpAddress=impbBlackListIpAddress, sysLocationName=sysLocationName, PortList=PortList, aclL2RuleDstMacAddr=aclL2RuleDstMacAddr, aclProfile=aclProfile, stpPortOperEdgePort=stpPortOperEdgePort, rmonStatsIndex=rmonStatsIndex, aclProfileTable=aclProfileTable, aclL3RuleDscp=aclL3RuleDscp, qosDiffServType17=qosDiffServType17, ipifV6AddressIpType=ipifV6AddressIpType, snmpV3User=snmpV3User, snmpV3UserGroupName=snmpV3UserGroupName, snmpV3GroupTable=snmpV3GroupTable, sysLBDCtrlTable=sysLBDCtrlTable, tftpFwTargetServerIpType=tftpFwTargetServerIpType, voicevlanDeviceTable=voicevlanDeviceTable, stpRootPort=stpRootPort, qosDiffServType16=qosDiffServType16, aclL3RuleTcpUdpDstPortMask=aclL3RuleTcpUdpDstPortMask, stpBridgeMaxAge=stpBridgeMaxAge, sysSNTPDSTStartMon=sysSNTPDSTStartMon, LacpKey=LacpKey, rmonEventTable=rmonEventTable, aclQosStatus=aclQosStatus, aclL3RuleTable=aclL3RuleTable, dot1qVlanUngisterMCFilterVlanId=dot1qVlanUngisterMCFilterVlanId, sysMirrorStatus=sysMirrorStatus, aclv6L3RuleSrcIpAddrMask=aclv6L3RuleSrcIpAddrMask, snmpV3viewTreeType=snmpV3viewTreeType, trafficSegStatus=trafficSegStatus, snmpV3UserAuthProtocol=snmpV3UserAuthProtocol, dlinkGreenLEDShutoffTimeProfile1=dlinkGreenLEDShutoffTimeProfile1, qosDiffServType02=qosDiffServType02, stpForwardDelay=stpForwardDelay, qosDiffServType60=qosDiffServType60, stpPortState=stpPortState, sysLBDVlanLoopPorts=sysLBDVlanLoopPorts, aRPSpoofPreventMacAddress=aRPSpoofPreventMacAddress, dlink_products=dlink_products, tftpFwServerIpAddress=tftpFwServerIpAddress, laSystem=laSystem, igsVlanRouterPortList=igsVlanRouterPortList, aclQosIP6TC=aclQosIP6TC, aclProfileStatus=aclProfileStatus, neighborType=neighborType, laPortControlIndex=laPortControlIndex, igsVlan=igsVlan, sysLoginTimeoutInterval=sysLoginTimeoutInterval, sysPortCtrlOperStatus=sysPortCtrlOperStatus, aclProfileSrcMacAddrMask=aclProfileSrcMacAddrMask, sysLBDVlanLoopEntry=sysLBDVlanLoopEntry, swRadiusServerIPType=swRadiusServerIPType, ipv4sysGateway=ipv4sysGateway, snmpV3UserPrivProtocol=snmpV3UserPrivProtocol, igsQueryInterval=igsQueryInterval, tftpFwTargetServerIpAddress=tftpFwTargetServerIpAddress, qosDiffServType06=qosDiffServType06, qosDiffServType41=qosDiffServType41, dlinkGreenPortStandbyPortList=dlinkGreenPortStandbyPortList, aclv6L3RuleTcpSynBit=aclv6L3RuleTcpSynBit, dot1pPortIndex=dot1pPortIndex, dot1pPortPriority=dot1pPortPriority, impbBlackListTable=impbBlackListTable, ipv4aclProfileSrcMacAddrMask=ipv4aclProfileSrcMacAddrMask, autoSurveillanceVlanOUITable=autoSurveillanceVlanOUITable, ipv4sysSNTPDSTStartDay=ipv4sysSNTPDSTStartDay, qosDiffServType44=qosDiffServType44, voicevlanOUIMask=voicevlanOUIMask, rmonHistoryOwner=rmonHistoryOwner, aRPSpoofPreventTable=aRPSpoofPreventTable, aclL2RuleAction=aclL2RuleAction, neighborIPv6Addr=neighborIPv6Addr, swRadiusServerInterfaceName=swRadiusServerInterfaceName, qosDiffServType46=qosDiffServType46, voicevlanPortAutoDetection=voicevlanPortAutoDetection, rmonHistory=rmonHistory, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, tftpFwTftpOperationStatus=tftpFwTftpOperationStatus, companyNeighbor=companyNeighbor, igsVlanSnoopStatus=igsVlanSnoopStatus, trafficSegEntry=trafficSegEntry, broadcastStormCtrlLimitType=broadcastStormCtrlLimitType, ipv4sysSNTPDSTStartMon=ipv4sysSNTPDSTStartMon, staticMcastTable=staticMcastTable, qosTOSEnable=qosTOSEnable, dot1qVlanPortEntry=dot1qVlanPortEntry, dlinkGreenLEDShutoffState=dlinkGreenLEDShutoffState, rmonEventCommunity=rmonEventCommunity, securityTrustedHost=securityTrustedHost, impbDHCPPortState=impbDHCPPortState, snmpV3UserAuthProtocolPassword=snmpV3UserAuthProtocolPassword, dhcpServerScreenTrustedServerStatus=dhcpServerScreenTrustedServerStatus, cableDiagPair3TestResult=cableDiagPair3TestResult, impbSmartBinding=impbSmartBinding, ipv4syslogSeverity=ipv4syslogSeverity, aclv6L3RuleProtocol=aclv6L3RuleProtocol, impbBlackListMacAddress=impbBlackListMacAddress, sslSecurityHttpStatus=sslSecurityHttpStatus, impbWhiteListTable=impbWhiteListTable, ipv4aclProfileDstIpAddrMask=ipv4aclProfileDstIpAddrMask, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, aclL3RuleTcpSynBit=aclL3RuleTcpSynBit, dlinkGreenSystemHibernationState=dlinkGreenSystemHibernationState, igsHostPortPurgeInterval=igsHostPortPurgeInterval, snmpV3ViewTreeTable=snmpV3ViewTreeTable, sysSNTPDSTStartHour=sysSNTPDSTStartHour, swTimeRangeStartHour=swTimeRangeStartHour, dhcpServerScreenTrustedServerTable=dhcpServerScreenTrustedServerTable, aclL3RuleProfileNo=aclL3RuleProfileNo, dgs_1210_20bx=dgs_1210_20bx, cableDiagPair1TestResult=cableDiagPair1TestResult, trustedHostIpAddr=trustedHostIpAddr, snmpV3Host=snmpV3Host, companyAutoSurveillanceVlan=companyAutoSurveillanceVlan, aclProfileDstIpAddrMaskType=aclProfileDstIpAddrMaskType, dlinkGreenPortStandbyState=dlinkGreenPortStandbyState, sysGroupInterval=sysGroupInterval, qosTOSType02=qosTOSType02, autoSurveillanceVlanMode=autoSurveillanceVlanMode, tftpFwTargetGroup=tftpFwTargetGroup, snmpV3ViewTree=snmpV3ViewTree, sysSNTPFirstServer=sysSNTPFirstServer, igsQueryMaxResponseTime=igsQueryMaxResponseTime, dlinkGreenLEDShutoffTimeProfile2=dlinkGreenLEDShutoffTimeProfile2, BridgeId=BridgeId, dhcpServerScreenTrustedServerAddress=dhcpServerScreenTrustedServerAddress, portSecMLA=portSecMLA, sysJumboFrameEnable=sysJumboFrameEnable, impbBlackListEntry=impbBlackListEntry, aclv6L3RuleSrcIpAddr=aclv6L3RuleSrcIpAddr, voicevlanPortManuTagMode=voicevlanPortManuTagMode, companyIpifGroup=companyIpifGroup, companySNTPSetting=companySNTPSetting, neighborEntry=neighborEntry, companyMiscGroup=companyMiscGroup, sysPortCtrlFlowControlOper=sysPortCtrlFlowControlOper, qosDiffServType26=qosDiffServType26, ipifV6AddressEntry=ipifV6AddressEntry, stpProtocolSpecification=stpProtocolSpecification, rmonAlarmVariable=rmonAlarmVariable, tftpCfgTargetServerIpType=tftpCfgTargetServerIpType, sysLBDPortStatus=sysLBDPortStatus, portSecEntry=portSecEntry, sysLBDVlanLoopTable=sysLBDVlanLoopTable, voicevlanDevicePort=voicevlanDevicePort, dlinkGreenSystemHibernation=dlinkGreenSystemHibernation, swTimeRangeStartMonth=swTimeRangeStartMonth, sysLBDCtrlEntry=sysLBDCtrlEntry, igsStatus=igsStatus, snmpV3GroupSecurityModel=snmpV3GroupSecurityModel, qosDiffServType04=qosDiffServType04, companyCableDiagnostic=companyCableDiagnostic, syslogSrvFacility=syslogSrvFacility, syslogInterfaceName=syslogInterfaceName, aclL2RuleSrcMacAddr=aclL2RuleSrcMacAddr, snmpV3TrapFirmUpgrade=snmpV3TrapFirmUpgrade, aclL3RuleTcpRstBit=aclL3RuleTcpRstBit, ipv4aclProfileDstMacAddrMask=ipv4aclProfileDstMacAddrMask, voicevlanOUITelephonyOUI=voicevlanOUITelephonyOUI, rmonAlarmEntry=rmonAlarmEntry, companyDot1qVlanGroup=companyDot1qVlanGroup, ipv4aclProfileStatus=ipv4aclProfileStatus, syslogTimeStampOption=syslogTimeStampOption, dot1qVlanEgressPorts=dot1qVlanEgressPorts, autoSurveillanceVlanOUIComponentType=autoSurveillanceVlanOUIComponentType, impbPortIndex=impbPortIndex, impbSettingTable=impbSettingTable, ipv4aclProfileDstPortMask=ipv4aclProfileDstPortMask, snmpV3HostInterfaceName=snmpV3HostInterfaceName, aclL3Rule=aclL3Rule, sysSNTPSecondServer=sysSNTPSecondServer, aclL3RuleICMPMessageCode=aclL3RuleICMPMessageCode, dlinkGreenPortStandbyTimeProfile1=dlinkGreenPortStandbyTimeProfile1, staticEntry=staticEntry, aRPSpoofPreventIpAddr=aRPSpoofPreventIpAddr, aclProfileIPProtocol=aclProfileIPProtocol, aclL2RuleSrcMacAddrMask=aclL2RuleSrcMacAddrMask, qosDiffServType38=qosDiffServType38, qosTOSType04=qosTOSType04, ipv4aclProfileEntry=ipv4aclProfileEntry, voicevlanPortCurrentTagMode=voicevlanPortCurrentTagMode, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval)
mibBuilder.exportSymbols("DGS-1210-20_BX", voicevlanPortControlEntry=voicevlanPortControlEntry, swTimeRangeStartYear=swTimeRangeStartYear, firmwareUpgradeSuccess=firmwareUpgradeSuccess, qosDiffServType10=qosDiffServType10, portSecIndex=portSecIndex, qosTOSGroup=qosTOSGroup, sysSNTPSecondInterfaceName=sysSNTPSecondInterfaceName, dlinkGreenSystemHibernationTimeProfile1=dlinkGreenSystemHibernationTimeProfile1, dot1qVlanUngisterMCFilterEntry=dot1qVlanUngisterMCFilterEntry, qosDiffServType28=qosDiffServType28, ipv4sysSNTPDSTEndDay=ipv4sysSNTPDSTEndDay, qosAclPrioritySettings=qosAclPrioritySettings, ipifName=ipifName, ipv4sysSNTPDSTState=ipv4sysSNTPDSTState, igsVlanMulticastGroupVlanId=igsVlanMulticastGroupVlanId, ipv4syslogLogSrvAddr=ipv4syslogLogSrvAddr, snmpV3UserTable=snmpV3UserTable, stpPortRestrictedRole=stpPortRestrictedRole, snmpV3ViewTreeEntry=snmpV3ViewTreeEntry, rmonAlarmRisingThreshold=rmonAlarmRisingThreshold, tftpFwTftpOperation=tftpFwTftpOperation, qosDiffServType05=qosDiffServType05, sysSNTPDSTStartDay=sysSNTPDSTStartDay, rmonAlarmOwner=rmonAlarmOwner, snmpV3TrapPortLinkUpDown=snmpV3TrapPortLinkUpDown, dot1xAuthTxPeriod=dot1xAuthTxPeriod, rmonHistoryInterval=rmonHistoryInterval, companyLBD=companyLBD, swTimeRangeFriday=swTimeRangeFriday, laPortChannelEntry=laPortChannelEntry, dlinkGreenPortShutoffTimeProfile2=dlinkGreenPortShutoffTimeProfile2, dlinklldpMsgTxInterval=dlinklldpMsgTxInterval, stpPortEnable=stpPortEnable, laPortControl=laPortControl, rmonAlarmSampleType=rmonAlarmSampleType, igsVlanRtrPortList=igsVlanRtrPortList, rmonEventType=rmonEventType, rmonEventOwner=rmonEventOwner, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, dot1qVlanManagementid=dot1qVlanManagementid, aclv6L3RuleTcpUdpSrcPort=aclv6L3RuleTcpUdpSrcPort, swTimeRangeSunday=swTimeRangeSunday, aclQosIndex=aclQosIndex, companySystem=companySystem, ipv4trustedHostIpAddr=ipv4trustedHostIpAddr, autoSurveillanceVlanOUIEntry=autoSurveillanceVlanOUIEntry, securityIpMacPortBinding=securityIpMacPortBinding, staticMcastStatus=staticMcastStatus, igsVlanCfgQuerier=igsVlanCfgQuerier, qosDiffServType15=qosDiffServType15, dlinkGreenLEDShutoff=dlinkGreenLEDShutoff, RmonStatus=RmonStatus, igsGrpQueryInterval=igsGrpQueryInterval, qosDiffServType59=qosDiffServType59, sysTrapStateChangeEvent=sysTrapStateChangeEvent, stpPortDesignatedBridge=stpPortDesignatedBridge, sysSafeGuardEnable=sysSafeGuardEnable, companyQoSGroup=companyQoSGroup, companySecurity=companySecurity, qosDiffServType25=qosDiffServType25, securityPortSecurity=securityPortSecurity, companyACLGroup=companyACLGroup, sysSNTPDSTStartMin=sysSNTPDSTStartMin, rmonAlarmTable=rmonAlarmTable, rmonAlarmFallingEventIndex=rmonAlarmFallingEventIndex, qosDiffServType43=qosDiffServType43, trustedHostTable=trustedHostTable, snmpV3CommunityEntry=snmpV3CommunityEntry, PortLaMode=PortLaMode, aclProfileEntry=aclProfileEntry, ipv4aclProfileSrcPortMask=ipv4aclProfileSrcPortMask, aclQosEntry=aclQosEntry, ipv4aclProfileNo=ipv4aclProfileNo, miscReset=miscReset, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, dot1qVlanRowStatus=dot1qVlanRowStatus, aclProfileMask=aclProfileMask, snmpV3GroupNotifyViewName=snmpV3GroupNotifyViewName, snmpV3TrapRSTPStateChange=snmpV3TrapRSTPStateChange, qosTOSType00=qosTOSType00, tftpFwTargetImageFileName=tftpFwTargetImageFileName, dlinklldpMsgHoldMultiplier=dlinklldpMsgHoldMultiplier, sysSystemPassword=sysSystemPassword, aclProfileDstIpAddrMask=aclProfileDstIpAddrMask, Ipv6Address=Ipv6Address, ipv4radiusServerAddress=ipv4radiusServerAddress, igsRobustnessValue=igsRobustnessValue, qosDiffServType23=qosDiffServType23, igsVlanMulticastGroupTable=igsVlanMulticastGroupTable, swTimeRangeWednesday=swTimeRangeWednesday, aclL2RuleTable=aclL2RuleTable, qosDiffServType12=qosDiffServType12, ipv4syslogUDPPort=ipv4syslogUDPPort, ipv4sysSNTPPollInterval=ipv4sysSNTPPollInterval, aclProfileNo=aclProfileNo, LldpManAddress=LldpManAddress, tftpFwTargetTftpOperation=tftpFwTargetTftpOperation, qosDiffServType20=qosDiffServType20, voiceVlanId=voiceVlanId, neighborMACAddr=neighborMACAddr, aclv6L3RuleTcpAckBit=aclv6L3RuleTcpAckBit, sysSNTPDSTEndDay=sysSNTPDSTEndDay, stpPortDesignatedPort=stpPortDesignatedPort, aclL3RuleTcpAckBit=aclL3RuleTcpAckBit, stpDesignatedRoot=stpDesignatedRoot, tftpConfigFileName=tftpConfigFileName, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, companyTrafficMgmt=companyTrafficMgmt, snmpV3CommunityPolicy=snmpV3CommunityPolicy, sysMirrorTargetPort=sysMirrorTargetPort, stpRootCost=stpRootCost, aclL3RuleSrcIpAddr=aclL3RuleSrcIpAddr, sysGateway=sysGateway, igsVlanQueryInterval=igsVlanQueryInterval, rmonAlarmRisingEventIndex=rmonAlarmRisingEventIndex, companydot3azEEE=companydot3azEEE, rmonEventStatus=rmonEventStatus, sysSNTPPollInterval=sysSNTPPollInterval, ipv4dhcpServerScreenServerIndex=ipv4dhcpServerScreenServerIndex, staticMcastVlanID=staticMcastVlanID, dlinkGreenPortShutoffTimeProfile1=dlinkGreenPortShutoffTimeProfile1, stpPortEntry=stpPortEntry, tftpCfgTargetTftpOperation=tftpCfgTargetTftpOperation, bandwidthCtrlSettings=bandwidthCtrlSettings, ipv4sysSNTPSecondServer=ipv4sysSNTPSecondServer, trafficSegIfIndex=trafficSegIfIndex, snmpV3viewTreeName=snmpV3viewTreeName, autoSurveillanceVlanOUISurveillanceOUI=autoSurveillanceVlanOUISurveillanceOUI, companyLLDPSetting=companyLLDPSetting, rmonEventEntry=rmonEventEntry, sysPortCtrlIndex=sysPortCtrlIndex, impbBlackListPort=impbBlackListPort, laPortChannelTable=laPortChannelTable, sysSNTPServerTable=sysSNTPServerTable, autoSurveillanceVlanOUIStatus=autoSurveillanceVlanOUIStatus, qosMode=qosMode, rmonStatsEntry=rmonStatsEntry, ipv4syslogLogging=ipv4syslogLogging, stpTimeSinceTopologyChange=stpTimeSinceTopologyChange, dot1xAuth=dot1xAuth, sysSNTPFirstInterfaceName=sysSNTPFirstInterfaceName, sysIpSubnetMask=sysIpSubnetMask, ipv4aclProfileType=ipv4aclProfileType, syslogSrvIP=syslogSrvIP, sysIpAddrCfgMode=sysIpAddrCfgMode, swRadiusServerSharedSecret=swRadiusServerSharedSecret, portD3Index=portD3Index, companyTraps=companyTraps, snmpV3UserPrivProtocolPassword=snmpV3UserPrivProtocolPassword, impbAutoScanIpAddressTo=impbAutoScanIpAddressTo, ipv4sysSNTPDSTEndHour=ipv4sysSNTPDSTEndHour, ipifv6NSRetransmitTime=ipifv6NSRetransmitTime, staticDisableAutoLearn=staticDisableAutoLearn, rmonHistoryStatus=rmonHistoryStatus, ipv4trustedHostRowStatus=ipv4trustedHostRowStatus, tftpCfgTargetImageFileName=tftpCfgTargetImageFileName, qosTOSType03=qosTOSType03, snmpV3HostAddress=snmpV3HostAddress, snmpV3Trap=snmpV3Trap, qosTOSType05=qosTOSType05, impbBlackListVlanId=impbBlackListVlanId, rmonStatsTable=rmonStatsTable, qosTOS=qosTOS, impbSmartEntry=impbSmartEntry, dot1qVlanManagementOnOff=dot1qVlanManagementOnOff, staticMac=staticMac, ipv4aclProfileRuleCount=ipv4aclProfileRuleCount, igsSystem=igsSystem, dot1qVlanTable=dot1qVlanTable, ipifV6AddressIpPrefix=ipifV6AddressIpPrefix, companyTftpGroup=companyTftpGroup, impbPortState=impbPortState, sysLBDVlanLoopIndex=sysLBDVlanLoopIndex, securityDhcpServerScreen=securityDhcpServerScreen, igsVlanMulticastGroupMacAddress=igsVlanMulticastGroupMacAddress, ipv4radiusServerSharedSecret=ipv4radiusServerSharedSecret, stpTxHoldCount=stpTxHoldCount, qosTOSType01=qosTOSType01, aclv6L3RulePortList=aclv6L3RulePortList, igsVlanQuerier=igsVlanQuerier, aclProfileRuleCount=aclProfileRuleCount, trustedHostEntry=trustedHostEntry, voicevlanOUIDescription=voicevlanOUIDescription, igsVlanFilterTable=igsVlanFilterTable, ipv4sysSNTPDSTEndMin=ipv4sysSNTPDSTEndMin, dhcpServerScreenTrustedServerIndex=dhcpServerScreenTrustedServerIndex, radius=radius, aclL2Rule=aclL2Rule, cableDiagPair3FaultDistance=cableDiagPair3FaultDistance, swRadiusServerAddress=swRadiusServerAddress, aclQosType=aclQosType, aRPSpoofPreventEntry=aRPSpoofPreventEntry, ipv4sysSNTPState=ipv4sysSNTPState, neighborTable=neighborTable, sysPortCtrlSpeed=sysPortCtrlSpeed, dlinklldpTxDelay=dlinklldpTxDelay, qosDiffServType01=qosDiffServType01, snmpV3CommunityStatus=snmpV3CommunityStatus, aclL3RuleIgmpType=aclL3RuleIgmpType, sysSNTPDSTEndMin=sysSNTPDSTEndMin, swTimeRangeMonday=swTimeRangeMonday, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, aclv6L3RuleAction=aclv6L3RuleAction, sysHardwareVersion=sysHardwareVersion, stpHelloTime=stpHelloTime, cableDiagTriggerIndex=cableDiagTriggerIndex, swTimeRangeEndMonth=swTimeRangeEndMonth, voicevlanSystem=voicevlanSystem, qosDiffServType37=qosDiffServType37, qosDiffServType47=qosDiffServType47, qosDiffServType61=qosDiffServType61, swTimeRangeSettingEntry=swTimeRangeSettingEntry, rmonEventIndex=rmonEventIndex, aclv6L3RuleAccessID=aclv6L3RuleAccessID, aclv6L3RuleTrafficClass=aclv6L3RuleTrafficClass, dlinkGreenPortShutoffState=dlinkGreenPortShutoffState, dot1qVlanUngisterMCFilterTable=dot1qVlanUngisterMCFilterTable, ipifV6AddressMainIndex=ipifV6AddressMainIndex, snmpV3UserStatus=snmpV3UserStatus, igsVlanMulticastGroupIpAddress=igsVlanMulticastGroupIpAddress, snmpV3HostCommunityName=snmpV3HostCommunityName, dlinkGreenPortShutoff=dlinkGreenPortShutoff, snmpV3Group=snmpV3Group, ipv4aclProfileMask=ipv4aclProfileMask, tftpCfgTargetGroup=tftpCfgTargetGroup, bandwidthCtrlIndex=bandwidthCtrlIndex, aclv6L3RuleProfileNo=aclv6L3RuleProfileNo, aclL3RuleAction=aclL3RuleAction, dlinkPowerSavCableLenDetectionState=dlinkPowerSavCableLenDetectionState, ipv4sysSNTPTimeSeconds=ipv4sysSNTPTimeSeconds, stpPriority=stpPriority, stpPortPathCost=stpPortPathCost, securityTrafficSeg=securityTrafficSeg, dlinkGreenSystemHibernationTimeProfile2=dlinkGreenSystemHibernationTimeProfile2, aclv6L3RuleTcpRstBit=aclv6L3RuleTcpRstBit, impbWhiteListMacAddress=impbWhiteListMacAddress, bandwidthCtrlTxThreshold=bandwidthCtrlTxThreshold, rmonEvent=rmonEvent, dlinkGreenPortStandby=dlinkGreenPortStandby, qosDiffServType52=qosDiffServType52, snmpV3TrapBootup=snmpV3TrapBootup, snmpV3GroupEntry=snmpV3GroupEntry, snmpV3GroupStatus=snmpV3GroupStatus, aclL3RuleEntry=aclL3RuleEntry, snmpV3viewTreeSubtree=snmpV3viewTreeSubtree, qosQ1p=qosQ1p, qosDiffServType14=qosDiffServType14, stpPort=stpPort, qosDiffServType32=qosDiffServType32, aclL3RuleTcpUdpDstPort=aclL3RuleTcpUdpDstPort, swTimeRangeName=swTimeRangeName, ipifv6DHCPStatus=ipifv6DHCPStatus, firmwareUpgradeFailure=firmwareUpgradeFailure, qosDiffServType24=qosDiffServType24)
mibBuilder.exportSymbols("DGS-1210-20_BX", swTimeRangeEndMinute=swTimeRangeEndMinute, companyRSTP=companyRSTP, stpGlobal=stpGlobal, igsVlanRouterVlanId=igsVlanRouterVlanId, cableDiagPair1FaultDistance=cableDiagPair1FaultDistance, dhcpServerScreenEnablePortlist=dhcpServerScreenEnablePortlist, sysMirrorCtrlEgressMirroring=sysMirrorCtrlEgressMirroring, aclL2RuleStatus=aclL2RuleStatus, voicevlanOUIStatus=voicevlanOUIStatus, stpBridgeForwardDelay=stpBridgeForwardDelay, aclQosTable=aclQosTable, ipv4syslogTimeStamp=ipv4syslogTimeStamp, qosTOSType07=qosTOSType07, aclQosTCPUDPPort=aclQosTCPUDPPort, stpPortEdge=stpPortEdge, portSecState=portSecState, companyDot1xGroup=companyDot1xGroup, syslogSrvRowStatus=syslogSrvRowStatus, aclL3RuleStatus=aclL3RuleStatus, laPortControlTable=laPortControlTable, ipv4sysSNTPDSTStartHour=ipv4sysSNTPDSTStartHour, voicevlanDeviceEntry=voicevlanDeviceEntry, rmonAlarmIndex=rmonAlarmIndex, dlinklldpConfigManAddrPortsTxEnable=dlinklldpConfigManAddrPortsTxEnable, qosDiffServType31=qosDiffServType31, swTimeRangeDate=swTimeRangeDate, igsVlanFilterVlanId=igsVlanFilterVlanId, rmonStatsDataSource=rmonStatsDataSource, companyIgsGroup=companyIgsGroup, aclv6L3RuleStatus=aclv6L3RuleStatus, sysLBDCtrlIndex=sysLBDCtrlIndex, dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, igsVlanRouterEntry=igsVlanRouterEntry, laPortChannelIfIndex=laPortChannelIfIndex, swTimeRangeEndYear=swTimeRangeEndYear, swTimeRangeRowStatus=swTimeRangeRowStatus, impbWhiteListPort=impbWhiteListPort, qosDiffServType03=qosDiffServType03, voicevlanDevicePriority=voicevlanDevicePriority, aclv6L3RuleTcpUrgBit=aclv6L3RuleTcpUrgBit, qosDiffServType54=qosDiffServType54, sysSNTPDSTEndMon=sysSNTPDSTEndMon, laStatus=laStatus, snmpV3CommunityName=snmpV3CommunityName, ipv4aclProfileIPProtocol=ipv4aclProfileIPProtocol, traps=traps, ipifV6AddressRowStatus=ipifV6AddressRowStatus, sysLBDInterval=sysLBDInterval, aclv6L3RuleTcpUdpSrcPortMask=aclv6L3RuleTcpUdpSrcPortMask, aclv6L3RuleTcpUdpDstPortMask=aclv6L3RuleTcpUdpDstPortMask, ipv4sysSNTPDSTOffset=ipv4sysSNTPDSTOffset, dlinklldpConfigManAddrEntry=dlinklldpConfigManAddrEntry, voicevlanOUITable=voicevlanOUITable, voicevlanPortControlTable=voicevlanPortControlTable, autoSurveillanceVlanSystem=autoSurveillanceVlanSystem, qosDiffServTypeGroup=qosDiffServTypeGroup, stpBridgeHelloTime=stpBridgeHelloTime, ipv4snmpV3HostVersion=ipv4snmpV3HostVersion, ipv4sysSNTPDSTStartMin=ipv4sysSNTPDSTStartMin, laPortControlEntry=laPortControlEntry, sysPortCtrlMDI=sysPortCtrlMDI, snmpGlobalState=snmpGlobalState, aRPSpoofPreventRowStatus=aRPSpoofPreventRowStatus, qosDiffServEnable=qosDiffServEnable, qosDiffServ=qosDiffServ, snmpV3GroupSecurityLevel=snmpV3GroupSecurityLevel, dlinkGreenLEDShutoffPortList=dlinkGreenLEDShutoffPortList, sysPortCtrlFlowControl=sysPortCtrlFlowControl, impbSmartTable=impbSmartTable, snmpV3GroupName=snmpV3GroupName, dlinklldpConfigManAddrTable=dlinklldpConfigManAddrTable, sysSNTPDSTState=sysSNTPDSTState, cableDiagPair4FaultDistance=cableDiagPair4FaultDistance, sslCiphers=sslCiphers, snmpV3HostStatus=snmpV3HostStatus, qosDiffServType36=qosDiffServType36, snmpV3EngineID=snmpV3EngineID, VlanIndex=VlanIndex, stpPortForwardTransitions=stpPortForwardTransitions, staticMcastMac=staticMcastMac, sysSNTPDSTOffset=sysSNTPDSTOffset, stpMaxAge=stpMaxAge, rmonStatsStatus=rmonStatsStatus, portD3State=portD3State, aclv6L3RuleICMPMessageCode=aclv6L3RuleICMPMessageCode, qosDiffServType35=qosDiffServType35, bandwidthCtrlRxThreshold=bandwidthCtrlRxThreshold, dot3azEntry=dot3azEntry, sysPortCtrlTable=sysPortCtrlTable, ipv4sysIpAddrCfgMode=ipv4sysIpAddrCfgMode, aclL2RuleInPortList=aclL2RuleInPortList, tftpFwImageFileName=tftpFwImageFileName, swTimeRangeSettingTable=swTimeRangeSettingTable, voicevlanOUIEntry=voicevlanOUIEntry, impbSmartVlanId=impbSmartVlanId, igsReportToAllPort=igsReportToAllPort, aclL3RuleDstIpAddrMask=aclL3RuleDstIpAddrMask, sysFirmwareVersion=sysFirmwareVersion, sysLBDPortLoopStatus=sysLBDPortLoopStatus, snmpV3HostVersion=snmpV3HostVersion, bandwidthCtrlTable=bandwidthCtrlTable, aclL2ProfileID=aclL2ProfileID, rmonAlarmInterval=rmonAlarmInterval, sysSNTPSecondType=sysSNTPSecondType, trustedHostStatus=trustedHostStatus, ipv4dhcpServerScreenServerStatus=ipv4dhcpServerScreenServerStatus, snmpV3GroupWriteViewName=snmpV3GroupWriteViewName, sysMirrorCtrlIngressMirroring=sysMirrorCtrlIngressMirroring, qosDiffServType27=qosDiffServType27, sysSNTPState=sysSNTPState, tftpFwTargetTftpOperationStatus=tftpFwTargetTftpOperationStatus, igsVlanFastLeave=igsVlanFastLeave, impbSmartIpAddress=impbSmartIpAddress, autoSurveillanceVlanTaggedUplinkDownlinkPort=autoSurveillanceVlanTaggedUplinkDownlinkPort, aclL2Rule1pPriority=aclL2Rule1pPriority, aclL2RuleEntry=aclL2RuleEntry, ipv4aclProfileTable=ipv4aclProfileTable, topologyChange=topologyChange, autoSurveillanceVlanId=autoSurveillanceVlanId, qosDiffServType56=qosDiffServType56, cableDiagPair2FaultDistance=cableDiagPair2FaultDistance, aclL2AccessID=aclL2AccessID, sysTrapIP=sysTrapIP, swTimeRangeStartDay=swTimeRangeStartDay, stpPortDesignatedCost=stpPortDesignatedCost, qosDiffServType22=qosDiffServType22, voicevlanOUI=voicevlanOUI, staticPort=staticPort, voicevlanPortState=voicevlanPortState, staticVlanID=staticVlanID, ipv4dhcpServerScreenServerTable=ipv4dhcpServerScreenServerTable, qosDiffServType53=qosDiffServType53, aclProfileDstPortMask=aclProfileDstPortMask, ipv4snmpV3HostStatus=ipv4snmpV3HostStatus, dot1qVlanAsyOnOff=dot1qVlanAsyOnOff, autoSurveillanceVlanOUIMask=autoSurveillanceVlanOUIMask, stpPortTable=stpPortTable, qosDiffServType40=qosDiffServType40, swTimeRangeEndDay=swTimeRangeEndDay, aclv6L3RuleTcpUdpDstPort=aclv6L3RuleTcpUdpDstPort, firmwareChecksumError=firmwareChecksumError, sysTrapFirmUpgradeEvent=sysTrapFirmUpgradeEvent, d_link=d_link, tftpCfgTargetInterfaceName=tftpCfgTargetInterfaceName, syslogGeneralGroup=syslogGeneralGroup, voiceVlanTimeout=voiceVlanTimeout, swTimeRangeEndHour=swTimeRangeEndHour, aclv6L3RuleICMPMessageType=aclv6L3RuleICMPMessageType, dlinklldpReinitDelay=dlinklldpReinitDelay, stpPortAdminPointToPoint=stpPortAdminPointToPoint, ipv4trustedHostEntry=ipv4trustedHostEntry, rmonHistoryIndex=rmonHistoryIndex, aclL3RuleTcpPshBit=aclL3RuleTcpPshBit, dlinkPowerSavLinkStatusDetectState=dlinkPowerSavLinkStatusDetectState, dot1xAuthStatus=dot1xAuthStatus, cableDiagPair4TestResult=cableDiagPair4TestResult, tftpCfgServerIpAddress=tftpCfgServerIpAddress, qosDiffServType19=qosDiffServType19, dlinklldpState=dlinklldpState, syslogSrvEntry=syslogSrvEntry, miscStatisticsReset=miscStatisticsReset, qosDiffServType07=qosDiffServType07, qosDiffServType55=qosDiffServType55, snmpV3UserName=snmpV3UserName, qosDiffServType48=qosDiffServType48, ipifV6AddressTable=ipifV6AddressTable, snmpV3CommunityTable=snmpV3CommunityTable, aclProfileType=aclProfileType, sslCipherSuiteList=sslCipherSuiteList, ipifv6GlobalStatus=ipifv6GlobalStatus, broadcastStormCtrlSettings=broadcastStormCtrlSettings, snmpV3HostEntry=snmpV3HostEntry, companyStaticMcast=companyStaticMcast, stpVersion=stpVersion, cableDiagLengthinRange=cableDiagLengthinRange, snmpV3UserVersion=snmpV3UserVersion, igsVlanMulticastGroupEntry=igsVlanMulticastGroupEntry, igsVlanMulticastGroupPortList=igsVlanMulticastGroupPortList, rmonHistoryTable=rmonHistoryTable, companyLA=companyLA, syslogSrvTable=syslogSrvTable, syslogSrvPort=syslogSrvPort, qosDiffServType18=qosDiffServType18, sysSwitchName=sysSwitchName, tftpCfgTargetServerIpAddress=tftpCfgTargetServerIpAddress, laPortActorActivity=laPortActorActivity, companySNMPV3=companySNMPV3, rmonStatsOwner=rmonStatsOwner, companyGreenSetting=companyGreenSetting, ipv4trustedHostIpMask=ipv4trustedHostIpMask, securitySSL=securitySSL, stpPortPriority=stpPortPriority, ipifv6DefaultGateway=ipifv6DefaultGateway, aclL3RuleTcpUdpSrcPortMask=aclL3RuleTcpUdpSrcPortMask, dot1qVlanUntaggedPorts=dot1qVlanUntaggedPorts, bandwidthCtrlEntry=bandwidthCtrlEntry, qosDiffServType34=qosDiffServType34, qosDiffServType63=qosDiffServType63, swTimeRangeThursday=swTimeRangeThursday, aclL2RuleVlanId=aclL2RuleVlanId, voiceVlanPriority=voiceVlanPriority, tftpFwTargetInterfaceName=tftpFwTargetInterfaceName, aclv6L3RuleTcpFinBit=aclv6L3RuleTcpFinBit, staticTable=staticTable, autoSurveillanceVlanPriority=autoSurveillanceVlanPriority, cableDiagPair2TestResult=cableDiagPair2TestResult, voicevlanPortControlIndex=voicevlanPortControlIndex, voicevlanDeviceTagType=voicevlanDeviceTagType, sysSNTPGMTMinutes=sysSNTPGMTMinutes, trafficSegTable=trafficSegTable, neighborRowStatus=neighborRowStatus, ipv4trustedHostTable=ipv4trustedHostTable, impbWhiteListEntry=impbWhiteListEntry, trustedHostRowStatus=trustedHostRowStatus, swTimeRangeTuesday=swTimeRangeTuesday, ipv4syslogGeneralGroup=ipv4syslogGeneralGroup, stpPortOperPointToPoint=stpPortOperPointToPoint, companyTimeRangeMgmt=companyTimeRangeMgmt, firmwareTransferError=firmwareTransferError, aclProfileArpSenderIpAddrMask=aclProfileArpSenderIpAddrMask, syslogSrvIPType=syslogSrvIPType, rmonGlobalState=rmonGlobalState, impbAutoScanStatus=impbAutoScanStatus, rmonEventDescription=rmonEventDescription, ipv4aclProfileSrcIpAddrMask=ipv4aclProfileSrcIpAddrMask, dhcpServerScreenTrustedServerEntry=dhcpServerScreenTrustedServerEntry, dot1qVlanPvid=dot1qVlanPvid, companyMirror=companyMirror, qosDiffServType58=qosDiffServType58, autoSurveillanceVlanOUIDescription=autoSurveillanceVlanOUIDescription, laPortChannelMode=laPortChannelMode, dot1qVlanPortTable=dot1qVlanPortTable, aclv6L3RuleEntry=aclv6L3RuleEntry, sysSNTPFirstType=sysSNTPFirstType, dlinkGreenPortStandbyTimeProfile2=dlinkGreenPortStandbyTimeProfile2, voiceVlanMode=voiceVlanMode, qosDiffServType51=qosDiffServType51, neighborIfindex=neighborIfindex, companyVoiceVlan=companyVoiceVlan, aclL3RuleTcpUdpSrcPort=aclL3RuleTcpUdpSrcPort, sysDhcpAutoConfiguration=sysDhcpAutoConfiguration, trustedHostIPType=trustedHostIPType, sysLBDMode=sysLBDMode, qosDiffServType62=qosDiffServType62, aclv6L3RuleDstIpAddrMask=aclv6L3RuleDstIpAddrMask, swTimeRangeSaturday=swTimeRangeSaturday, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, aclL2RuleDstMacAddrMask=aclL2RuleDstMacAddrMask, sysPortCtrlType=sysPortCtrlType, companyRMON=companyRMON, aclL3RuleSrcIpAddrMask=aclL3RuleSrcIpAddrMask, impbBlackListStatus=impbBlackListStatus, qosDiffServType57=qosDiffServType57)
mibBuilder.exportSymbols("DGS-1210-20_BX", aclProfileDstMacAddrMask=aclProfileDstMacAddrMask, snmpV3viewTreeStatus=snmpV3viewTreeStatus, aclProfileSrcIpAddrMask=aclProfileSrcIpAddrMask, tftpCfgTargetTftpOperationStatus=tftpCfgTargetTftpOperationStatus, aclv6L3RuleTable=aclv6L3RuleTable, snmpV3GroupReadViewName=snmpV3GroupReadViewName, qosDiffServType29=qosDiffServType29, aRPSpoofPreventPortList=aRPSpoofPreventPortList, firmwareIllegalFile=firmwareIllegalFile, ipv4snmpV3HostTable=ipv4snmpV3HostTable, sysIpAddr=sysIpAddr, ipv4aclProfileArpSenderMacAddrMask=ipv4aclProfileArpSenderMacAddrMask, qosDiffServType49=qosDiffServType49, aclQosAssignPriority=aclQosAssignPriority, staticAutoLearningList=staticAutoLearningList, aclL3RuleDstIpAddr=aclL3RuleDstIpAddr, impbSmartMacAddress=impbSmartMacAddress, dot3azTable=dot3azTable, ipv4dhcpServerScreenServerEntry=ipv4dhcpServerScreenServerEntry, voicevlanDevice=voicevlanDevice, aclL3RuleProtocol=aclL3RuleProtocol, aclL3RuleTcpFinBit=aclL3RuleTcpFinBit, sysLBDStateEnable=sysLBDStateEnable, igsVlanFilterEntry=igsVlanFilterEntry, aclv6L3RuleDstIpAddr=aclv6L3RuleDstIpAddr, dot1qVlanUngisterMCFiltermode=dot1qVlanUngisterMCFiltermode, rmonHistoryDataSource=rmonHistoryDataSource, ipifSupportV4V6Info=ipifSupportV4V6Info, syslogState=syslogState, dlink_DGS12XXSeriesProd=dlink_DGS12XXSeriesProd, snmpV3UserEntry=snmpV3UserEntry, rmonAlarmFallingThreshold=rmonAlarmFallingThreshold, rmonAlarmStatus=rmonAlarmStatus, tftpConfigTftpOperationStatus=tftpConfigTftpOperationStatus, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, qosDiffServType13=qosDiffServType13, trustedHostIpMask=trustedHostIpMask, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, laPortActorTimeout=laPortActorTimeout, sysTrapSystemEvent=sysTrapSystemEvent, swTimeRangeStartMinute=swTimeRangeStartMinute, ipv4snmpV3HostEntry=ipv4snmpV3HostEntry, sysSave=sysSave, dlinklldpLocManAddr=dlinklldpLocManAddr, igsVlanRouterTable=igsVlanRouterTable, ipv4syslogFacility=ipv4syslogFacility, impbAutoScanIpAddressFrom=impbAutoScanIpAddressFrom, dot1pPortTable=dot1pPortTable, stpPortProtocolMigration=stpPortProtocolMigration, ipv4sysSNTPGMTMinutes=ipv4sysSNTPGMTMinutes, dot1qVlanEntry=dot1qVlanEntry, staticStatus=staticStatus, trafficSegMemberList=trafficSegMemberList, snmpV3Community=snmpV3Community, autoSurveillanceVlanOUI=autoSurveillanceVlanOUI, securityARPSpoofPrevent=securityARPSpoofPrevent, dot1xAuthMaxReq=dot1xAuthMaxReq, qosDiffServType33=qosDiffServType33, snmpV3IPType=snmpV3IPType, impbWhiteListIpAddress=impbWhiteListIpAddress, dot1xAuthServerTimeout=dot1xAuthServerTimeout, dot1pPortEntry=dot1pPortEntry, Timeout=Timeout, aclL3RuleTcpUrgBit=aclL3RuleTcpUrgBit, stpPortRestrictedTCN=stpPortRestrictedTCN, snmpV3TrapSNMPAuthentication=snmpV3TrapSNMPAuthentication, aclL3RuleICMPMessageType=aclL3RuleICMPMessageType, ipv4sysSNTPFirstServer=ipv4sysSNTPFirstServer)
