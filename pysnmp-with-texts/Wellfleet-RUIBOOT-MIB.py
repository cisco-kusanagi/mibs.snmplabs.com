...
# Produced by pysmi-0.3.4 at Wed May  1 15:41:34 2019
...
Counter64, mib_2, mgmt, Unsigned32, Integer32, MibIdentifier, NotificationType, enterprises, NotificationType, Bits, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, Counter32, IpAddress, TimeTicks, ModuleIdentity, Opaque = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "mib-2", "mgmt", "Unsigned32", "Integer32", "MibIdentifier", "NotificationType", "enterprises", "NotificationType", "Bits", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "Counter32", "IpAddress", "TimeTicks", "ModuleIdentity", "Opaque")
...
if mibBuilder.loadTexts: wfRuiBootBaseDelete.setDescription('Create/Delete parameter. Default is created. Users perform a set operation on this object in order to create/delete RUI BOOT Gate.')
...
if mibBuilder.loadTexts: wfRuiBootBaseDisable.setDescription('Enable/Disable parameter. Default is enabled. Users perform a set operation on this object in order to enable/disable RUI BOOT Gate.')
...
if mibBuilder.loadTexts: wfRuiBootBaseState.setDescription('The current state of the entire Boot Mib Gate.')
wfRuiBootTable = MibTable((1, 3, 6, 1, 4, 1, 18, 3, 3, 2, 14, 2), )
if mibBuilder.loadTexts: wfRuiBootTable.setStatus('mandatory')
if mibBuilder.loadTexts: wfRuiBootTable.setDescription('Remote User Interface Boot Object Table ')
...
if mibBuilder.loadTexts: wfRuiBootEntry.setDescription('A description of a Boot Entry')
...
if mibBuilder.loadTexts: wfRuiBootDelete.setDescription('Create/Delete parameter for determining whether or not BOOT is configured on this slot.')
...
if mibBuilder.loadTexts: wfRuiBootDisable.setDescription('Enable/Disable parameter. Users perform an SNMP SET operation on this object to enable/disable a BOOT Entry. Default is enabled.')
...
if mibBuilder.loadTexts: wfRuiBootState.setDescription('The current state of this Boot Entry')
...
if mibBuilder.loadTexts: wfRuiBootImageName.setDescription('Name of boot Image')
...
if mibBuilder.loadTexts: wfRuiBootConfigName.setDescription('Parameter for the specified command')
...
if mibBuilder.loadTexts: wfRuiBootErrorCode.setDescription('Error code from last execution.')
