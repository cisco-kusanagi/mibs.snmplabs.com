...
# Produced by pysmi-0.3.4 at Wed May  1 12:56:17 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Bits, Counter64, TimeTicks, ObjectIdentity, Counter32, Gauge32, IpAddress, ModuleIdentity, NotificationType, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Bits", "Counter64", "TimeTicks", "ObjectIdentity", "Counter32", "Gauge32", "IpAddress", "ModuleIdentity", "NotificationType", "iso", "MibIdentifier")
...
if mibBuilder.loadTexts: rlPoe.setContactInfo('Dell.com')
...
mibBuilder.exportSymbols("Dell-POE-MIB", rlPethPowerPsedisconnectMethod=rlPethPowerPsedisconnectMethod, rlPethMainPseSwVersion=rlPethMainPseSwVersion, rlPethPsePortSupportPoe=rlPethPsePortSupportPoe, rlPethPsePortOutputCurrent=rlPethPsePortOutputCurrent, rlPethPowerPseRpsPower=rlPethPowerPseRpsPower, rlPethPsePortOutputVoltage=rlPethPsePortOutputVoltage, rlPethPsePortMaxPowerAllocAllowed=rlPethPsePortMaxPowerAllocAllowed, rlPethPowerPsePower=rlPethPowerPsePower, rlPethPsePortSupportPoePlus=rlPethPsePortSupportPoePlus, rlPethPsePortIndex=rlPethPsePortIndex, rlPethPowerPseTemperatureSensor=rlPethPowerPseTemperatureSensor, rlPethMainPseTable=rlPethMainPseTable, rlPethPowerPseGroupIndex=rlPethPowerPseGroupIndex, rlPethPsePortStatus=rlPethPsePortStatus, rlPethPsePortEntry=rlPethPsePortEntry, rlPethPowerPseTable=rlPethPowerPseTable, rlPethPsePortTimeRangeName=rlPethPsePortTimeRangeName, rlPethPsePortOperPowerLimit=rlPethPsePortOperPowerLimit, rlPethMainPseEntry=rlPethMainPseEntry, rlPethMainPseHwType=rlPethMainPseHwType, rlPethPsePortGroupIndex=rlPethPsePortGroupIndex, rlPethPowerPseInrushTestEnabled=rlPethPowerPseInrushTestEnabled, rlPethPowerPseEntry=rlPethPowerPseEntry, rlPoe=rlPoe, rlPethMainPseHwVersion=rlPethMainPseHwVersion, rlPethPsePortStatusDescription=rlPethPsePortStatusDescription, rlPethPsePortTable=rlPethPsePortTable, rlPethPsePortOperStatus=rlPethPsePortOperStatus, rlPethPsePortOutputPower=rlPethPsePortOutputPower, rlPethPsePortPowerLimit=rlPethPsePortPowerLimit, rlPethMainPseGroupIndex=rlPethMainPseGroupIndex, PYSNMP_MODULE_ID=rlPoe, rlPethPowerPseLegacyDisabled=rlPethPowerPseLegacyDisabled, rlPethMainPsePowerGuardBand=rlPethMainPsePowerGuardBand, rlPethPowerPsePowerManagementMode=rlPethPowerPsePowerManagementMode)
