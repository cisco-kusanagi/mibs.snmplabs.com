...
# Produced by pysmi-0.3.4 at Wed May  1 13:06:22 2019
...
Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, Counter64, TimeTicks, IpAddress, enterprises, Counter32, Bits, ObjectIdentity, MibIdentifier, Unsigned32, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "Counter64", "TimeTicks", "IpAddress", "enterprises", "Counter32", "Bits", "ObjectIdentity", "MibIdentifier", "Unsigned32", "ModuleIdentity", "NotificationType")
...
if mibBuilder.loadTexts: swDevCtrlStpState.setDescription('This object can be enabled or disabled spanning tree algorithm during runtime of the system.')
...
if mibBuilder.loadTexts: addressTableFull.setDescription('The trap is sent whenever the address table is full . ')
mibBuilder.exportSymbols("ES1000-MIB", swPortStFragments=swPortStFragments, swPortInfoNwayStatus=swPortInfoNwayStatus, marconi=marconi, swPortCtrlLockState=swPortCtrlLockState, swPortStFrames_128_255_bytes=swPortStFrames_128_255_bytes, swFdbFilterEntry=swFdbFilterEntry, swPortInfoPortIndex=swPortInfoPortIndex, swDevCtrlUploadImage=swDevCtrlUploadImage, swPortStBroadcastFramesTx=swPortStBroadcastFramesTx, swPortInfoFlowCtrlStatus=swPortInfoFlowCtrlStatus, swPortCtrlStpState=swPortCtrlStpState, swDevInfoConsoleInUse=swDevInfoConsoleInUse, swPortStEntry=swPortStEntry, swPortInfoModuleIndex=swPortInfoModuleIndex, swPortStByteRx=swPortStByteRx, swModuleInfoTable=swModuleInfoTable, swPortStMulticastFramesTx=swPortStMulticastFramesTx, swFdbFilterVid=swFdbFilterVid, swPortStFrames_64_bytes=swPortStFrames_64_bytes, swDevAlarmPartition=swDevAlarmPartition, swPortCtrlFlowCtrlState=swPortCtrlFlowCtrlState, swFdbStaticTable=swFdbStaticTable, swFdbFilterTable=swFdbFilterTable, broadcastFallingStorm=broadcastFallingStorm, swPortStBroadcastFramesRx=swPortStBroadcastFramesRx, linkChangeEvent=linkChangeEvent, swPortStTotalFramesRx=swPortStTotalFramesRx, broadcastRisingStorm=broadcastRisingStorm, swDevAlarmNewRoot=swDevAlarmNewRoot, swDevAlarmLinkChange=swDevAlarmLinkChange, external=external, swDevCtrlHOLState=swDevCtrlHOLState, swPortStCRCError=swPortStCRCError, swFdbFilterState=swFdbFilterState, swPortCtrlNwayState=swPortCtrlNwayState, swPortStFrames_1024_1536_bytes=swPortStFrames_1024_1536_bytes, swPortInfoTable=swPortInfoTable, swPortStModuleIndex=swPortStModuleIndex, swPortStUndersizeFrames=swPortStUndersizeFrames, swDevCtrlSaveCfg=swDevCtrlSaveCfg, swDevCtrlPartitionModeState=swDevCtrlPartitionModeState, swPortCtrlPriority=swPortCtrlPriority, swPortStTable=swPortStTable, swDevCtrlAddrLookupModesAndHitRate=swDevCtrlAddrLookupModesAndHitRate, swDevAlarmTopologyChange=swDevAlarmTopologyChange, swModulePackage=swModulePackage, swPortStLateCollision=swPortStLateCollision, golfcommon=golfcommon, swPortCtrlBroadcastRisingThr=swPortCtrlBroadcastRisingThr, swDevCtrlTableLockState=swDevCtrlTableLockState, swModuleInfoType=swModuleInfoType, swPortCtrlAdminState=swPortCtrlAdminState, swFdbStaticStatus=swFdbStaticStatus, swPortCtrlEntry=swPortCtrlEntry, swPortStFrameRx=swPortStFrameRx, swDevCtrlStpState=swDevCtrlStpState, swPortStPortIndex=swPortStPortIndex, swDevInfo=swDevInfo, swFdbStaticVid=swFdbStaticVid, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, marconi_mgmt=marconi_mgmt, golfproducts=golfproducts, es1000Series=es1000Series, swDevPackage=swDevPackage, swPortStFramesDroppedFrames=swPortStFramesDroppedFrames, swDevInfoSaveCfg=swDevInfoSaveCfg, swDevCtrlUploadImageFileName=swDevCtrlUploadImageFileName, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swModule=swModule, swDevInfoSystemLedStatus=swDevInfoSystemLedStatus, swPortStFrames_256_511_bytes=swPortStFrames_256_511_bytes, swPortInfoEntry=swPortInfoEntry, swDevInfoMaxNumOfModule=swDevInfoMaxNumOfModule, swModuleInfoDesc=swModuleInfoDesc, swPortStJabber=swPortStJabber, swPortStFrameTx=swPortStFrameTx, swPortInfoLinkStatus=swPortInfoLinkStatus, addressTableFull=addressTableFull, swPortStCollision=swPortStCollision, swPortCtrlLinkStatusAlarmState=swPortCtrlLinkStatusAlarmState, swDevAlarm=swDevAlarm, swFdbStaticPortMap=swFdbStaticPortMap, swPortCtrlBroadcastFallingAct=swPortCtrlBroadcastFallingAct, es1000=es1000, swProperty=swProperty, swModuleInfoNumOfPortInUse=swModuleInfoNumOfPortInUse, systems=systems, swDevInfoSystemUpTime=swDevInfoSystemUpTime, swPortCtrlCleanAllStatisticCounter=swPortCtrlCleanAllStatisticCounter, swPortStOversizeFrames=swPortStOversizeFrames, swPortCtrlBroadcastFallingThr=swPortCtrlBroadcastFallingThr, golf=golf, swDevInfoTotalNumOfModule=swDevInfoTotalNumOfModule, swModuleInfoTotalNumOfPort=swModuleInfoTotalNumOfPort, swFdbStaticEntry=swFdbStaticEntry, portPartition=portPartition, swPortStTotalBytesRx=swPortStTotalBytesRx, swPortCtrlPortIndex=swPortCtrlPortIndex, dlink=dlink, marconi_products=marconi_products, swModuleInfoPortLedStatus=swModuleInfoPortLedStatus, swFdbFilterAddressIndex=swFdbFilterAddressIndex, swPortCtrlHOLState=swPortCtrlHOLState, marconi_es1000Prod=marconi_es1000Prod, swPortStMulticastFramesRx=swPortStMulticastFramesRx, swDevIGMPCaptureState=swDevIGMPCaptureState, dlinkcommon=dlinkcommon, swDevCtrl=swDevCtrl, swPortCtrlModuleIndex=swPortCtrlModuleIndex, swModuleInfoIndex=swModuleInfoIndex, swModuleInfoEntry=swModuleInfoEntry, swFdbStaticAddressIndex=swFdbStaticAddressIndex, swPortInfoType=swPortInfoType, swPortStByteTx=swPortStByteTx, swFdbStaticState=swFdbStaticState, swFdbPackage=swFdbPackage, swPortCtrlTable=swPortCtrlTable, swPortStFrames_512_1023_bytes=swPortStFrames_512_1023_bytes, swPortCtrlBackPressState=swPortCtrlBackPressState, swPortStFrames_65_127_bytes=swPortStFrames_65_127_bytes, swPortPackage=swPortPackage, swPortCtrlBroadcastRisingAct=swPortCtrlBroadcastRisingAct)
