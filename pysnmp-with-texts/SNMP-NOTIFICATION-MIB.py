...
ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, TimeTicks, iso, MibIdentifier, snmpModules, Bits, ModuleIdentity, Gauge32, IpAddress, Unsigned32, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "TimeTicks", "iso", "MibIdentifier", "snmpModules", "Bits", "ModuleIdentity", "Gauge32", "IpAddress", "Unsigned32", "Counter32", "NotificationType")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: snmpNotificationMIB.setRevisionsDescriptions(('Clarifications, published as RFC 3413.', 'Clarifications, published as RFC 2573.', 'The initial revision, published as RFC2273.',))
...
mibBuilder.exportSymbols("SNMP-NOTIFICATION-MIB", snmpNotifyType=snmpNotifyType, snmpNotifyTable=snmpNotifyTable, snmpNotifyFilterMask=snmpNotifyFilterMask, snmpNotifyFilterSubtree=snmpNotifyFilterSubtree, snmpNotifyGroup=snmpNotifyGroup, snmpNotifyFilterProfileEntry=snmpNotifyFilterProfileEntry, snmpNotifyFilterType=snmpNotifyFilterType, snmpNotifyFilterGroup=snmpNotifyFilterGroup, snmpNotifyBasicCompliance=snmpNotifyBasicCompliance, snmpNotifyFilterProfileRowStatus=snmpNotifyFilterProfileRowStatus, snmpNotifyName=snmpNotifyName, snmpNotificationMIB=snmpNotificationMIB, snmpNotifyFilterProfileTable=snmpNotifyFilterProfileTable, snmpNotifyRowStatus=snmpNotifyRowStatus, snmpNotifyFullCompliance=snmpNotifyFullCompliance, snmpNotifyObjects=snmpNotifyObjects, snmpNotifyFilterEntry=snmpNotifyFilterEntry, snmpNotifyFilterStorageType=snmpNotifyFilterStorageType, snmpNotifyBasicFiltersCompliance=snmpNotifyBasicFiltersCompliance, PYSNMP_MODULE_ID=snmpNotificationMIB, snmpNotifyEntry=snmpNotifyEntry, snmpNotifyFilterRowStatus=snmpNotifyFilterRowStatus, snmpNotifyTag=snmpNotifyTag, snmpNotifyFilterProfileName=snmpNotifyFilterProfileName, snmpNotifyStorageType=snmpNotifyStorageType, snmpNotifyCompliances=snmpNotifyCompliances, snmpNotifyGroups=snmpNotifyGroups, snmpNotifyFilterTable=snmpNotifyFilterTable, snmpNotifyFilterProfileStorType=snmpNotifyFilterProfileStorType, snmpNotifyConformance=snmpNotifyConformance)
