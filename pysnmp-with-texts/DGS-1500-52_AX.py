...
# Produced by pysmi-0.3.4 at Wed May  1 12:43:37 2019
...
Counter32, IpAddress, enterprises, Counter64, iso, ModuleIdentity, Unsigned32, Integer32, Gauge32, NotificationType, Bits, MibIdentifier, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "IpAddress", "enterprises", "Counter64", "iso", "ModuleIdentity", "Unsigned32", "Integer32", "Gauge32", "NotificationType", "Bits", "MibIdentifier", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DGS-1500-52_AX", igsRobustnessValue=igsRobustnessValue, dot1qVlanTable=dot1qVlanTable, snmpV3viewTreeName=snmpV3viewTreeName, igsVlanRouterEntry=igsVlanRouterEntry, igsVlanMulticastGroupVlanId=igsVlanMulticastGroupVlanId, aclL2RuleDstMacAddr=aclL2RuleDstMacAddr, swTimeRangeMonday=swTimeRangeMonday, dhcpServerScreenEnablePortlist=dhcpServerScreenEnablePortlist, dlinklldpMsgHoldMultiplier=dlinklldpMsgHoldMultiplier, qosDiffServType54=qosDiffServType54, swAuthUserTable=swAuthUserTable, aclProfileDstPortMask=aclProfileDstPortMask, aclProfileStatus=aclProfileStatus, sysPortCtrlEntry=sysPortCtrlEntry, Timeout=Timeout, dlinkGreenPortShutoffTimeProfile2=dlinkGreenPortShutoffTimeProfile2, qosDiffServType46=qosDiffServType46, cmSingleIPNeighborEntry=cmSingleIPNeighborEntry, mulifMainOperStatus=mulifMainOperStatus, staticTable=staticTable, broadcastStormCtrlSettings=broadcastStormCtrlSettings, voiceVlanPriority=voiceVlanPriority, companyAuthGroup=companyAuthGroup, swTimeRangeStartDay=swTimeRangeStartDay, autoSurveillanceVlanMode=autoSurveillanceVlanMode, dhcpServerScreenServerAddress=dhcpServerScreenServerAddress, voicevlanOUIDescription=voicevlanOUIDescription, gvrpGVRPGlobalSettingsOnOff=gvrpGVRPGlobalSettingsOnOff, qosDiffServType12=qosDiffServType12, qosDiffServType50=qosDiffServType50, mulifMainAdminStatus=mulifMainAdminStatus, cmSingleIPMSPowerRecover=cmSingleIPMSPowerRecover, cmSingleIPMSTrapMessage=cmSingleIPMSTrapMessage, companyTrafficMgmt=companyTrafficMgmt, aclL2RuleInPortList=aclL2RuleInPortList, dlinkGreenPortStandby=dlinkGreenPortStandby, cmSingleIPGroupCapability=cmSingleIPGroupCapability, sysGratuitousARPInterval=sysGratuitousARPInterval, snmpV3GroupStatus=snmpV3GroupStatus, staticMcastStatus=staticMcastStatus, igsQueryMaxResponseTime=igsQueryMaxResponseTime, sysMirrorStatus=sysMirrorStatus, swAuthStatus=swAuthStatus, sysIpInterfaceName=sysIpInterfaceName, cmSingleIPTimeInterval=cmSingleIPTimeInterval, laStatus=laStatus, sysSNTPDSTEndDay=sysSNTPDSTEndDay, stpPortTable=stpPortTable, rmonAlarmTable=rmonAlarmTable, companySyslog=companySyslog, mulifMainTable=mulifMainTable, sysTrapGratuitousARP=sysTrapGratuitousARP, sysSNTPSecondServer=sysSNTPSecondServer, sysLBDPortStatus=sysLBDPortStatus, snmpV3Trap=snmpV3Trap, portSecEntry=portSecEntry, swTimeRangeEndMinute=swTimeRangeEndMinute, cmSingleIPMSCapability=cmSingleIPMSCapability, portSecIndex=portSecIndex, securitySSL=securitySSL, sslCipherSuiteList=sslCipherSuiteList, bandwidthCtrlIndex=bandwidthCtrlIndex, igsVlanSnoopStatus=igsVlanSnoopStatus, snmpV3TrapGratuitousARP=snmpV3TrapGratuitousARP, swAuthUser=swAuthUser, swAuthRadiusServer=swAuthRadiusServer, aclProfile=aclProfile, gvrpSettingsAcceptableFrameType=gvrpSettingsAcceptableFrameType, aclProfileTable=aclProfileTable, companySecurity=companySecurity, swAuthAuthQuietPeriod=swAuthAuthQuietPeriod, voicevlanOUIEntry=voicevlanOUIEntry, aclL3RuleDstIpAddrMask=aclL3RuleDstIpAddrMask, aclL3RuleSrcIpAddr=aclL3RuleSrcIpAddr, swTimeRangeIndex=swTimeRangeIndex, rmonStatistics=rmonStatistics, dot1qVlanName=dot1qVlanName, bandwidthCtrlTable=bandwidthCtrlTable, qosDiffServType32=qosDiffServType32, swTimeRangeStartYear=swTimeRangeStartYear, igsVlanCfgQuerier=igsVlanCfgQuerier, voicevlanPortState=voicevlanPortState, dlinklldpLocManAddr=dlinklldpLocManAddr, dhcpServerScreenServerStatus=dhcpServerScreenServerStatus, cmSingleIPGroupMacAddr=cmSingleIPGroupMacAddr, sysSNTPFirstServer=sysSNTPFirstServer, snmpV3HostAddress=snmpV3HostAddress, dlinkPowerSavCableLenDetectionState=dlinkPowerSavCableLenDetectionState, qosDiffServType52=qosDiffServType52, sysHardwareVersion=sysHardwareVersion, cmSingleIPVersion=cmSingleIPVersion, rmonHistoryIndex=rmonHistoryIndex, aclL3RuleTcpPshBit=aclL3RuleTcpPshBit, dgs_1500_52=dgs_1500_52, dgs_1500_52ax=dgs_1500_52ax, aclL3RuleICMPMessageType=aclL3RuleICMPMessageType, gvrpSettingsPVID=gvrpSettingsPVID, portSecState=portSecState, aclL2Rule1pPriority=aclL2Rule1pPriority, rmonAlarm=rmonAlarm, voicevlanDeviceStatus=voicevlanDeviceStatus, igsGrpQueryInterval=igsGrpQueryInterval, cmSingleIPMSDeviceName=cmSingleIPMSDeviceName, tftpConfigFileName=tftpConfigFileName, snmpV3UserPrivProtocol=snmpV3UserPrivProtocol, staticRouteTable=staticRouteTable, swTimeRangeSaturday=swTimeRangeSaturday, qosDiffServType53=qosDiffServType53, stpPriority=stpPriority, igsVlanRouterVlanId=igsVlanRouterVlanId, snmpV3UserPrivProtocolPassword=snmpV3UserPrivProtocolPassword, snmpV3GroupSecurityLevel=snmpV3GroupSecurityLevel, voicevlanDevicePriority=voicevlanDevicePriority, aclL3RuleSrcIpAddrMask=aclL3RuleSrcIpAddrMask, stpPortDesignatedCost=stpPortDesignatedCost, companyTimeRangeMgmt=companyTimeRangeMgmt, rmonHistory=rmonHistory, aclL3RuleAccessID=aclL3RuleAccessID, d_link=d_link, tftpFwImageFileName=tftpFwImageFileName, aclL3RuleICMPMessageCode=aclL3RuleICMPMessageCode, stpPortEntry=stpPortEntry, firmwareChecksumError=firmwareChecksumError, aclProfileDstIpAddrMask=aclProfileDstIpAddrMask, gvrpSettingsLeaveTime=gvrpSettingsLeaveTime, voicevlanOUI=voicevlanOUI, syslogFacility=syslogFacility, companyRSTP=companyRSTP, staticRouteIpAddr=staticRouteIpAddr, sysPortCtrlMDI=sysPortCtrlMDI, cmSingleIPMSMacAddr=cmSingleIPMSMacAddr, rmonAlarmOwner=rmonAlarmOwner, sysLBDPortLoopStatus=sysLBDPortLoopStatus, dot1qVlanAdvertisementStatus=dot1qVlanAdvertisementStatus, qosDiffServType62=qosDiffServType62, igsHostPortPurgeInterval=igsHostPortPurgeInterval, sysSNTPPollInterval=sysSNTPPollInterval, dlinkPowerSavLinkStatusDetectState=dlinkPowerSavLinkStatusDetectState, autoSurveillanceVlanOUIComponentType=autoSurveillanceVlanOUIComponentType, snmpV3HostEntry=snmpV3HostEntry, swTimeRangeRowStatus=swTimeRangeRowStatus, snmpV3User=snmpV3User, laPortControlIndex=laPortControlIndex, qosDiffServType14=qosDiffServType14, cmSingleIPMSCasSource=cmSingleIPMSCasSource, swAuthRadiusServerAuthenticationPort=swAuthRadiusServerAuthenticationPort, sysPortCtrlTable=sysPortCtrlTable, dot1pPortIndex=dot1pPortIndex, companyStaticMcast=companyStaticMcast, cmSingleIPRoleState=cmSingleIPRoleState, aclL3RulePortList=aclL3RulePortList, sysSafeGuardEnable=sysSafeGuardEnable, snmpV3HostVersion=snmpV3HostVersion, companyGratuitousARP=companyGratuitousARP, snmpV3CommunityName=snmpV3CommunityName, topologyChange=topologyChange, igsVlanMulticastGroupMacAddress=igsVlanMulticastGroupMacAddress, qosDiffServType24=qosDiffServType24, snmpV3TrapPortLinkUpDown=snmpV3TrapPortLinkUpDown, cmSingleIPMSLinkDown=cmSingleIPMSLinkDown, bandwidthCtrlEntry=bandwidthCtrlEntry, snmpV3ViewTreeTable=snmpV3ViewTreeTable, companyLBD=companyLBD, dot1pPortTable=dot1pPortTable, igsVlanRouterPortList=igsVlanRouterPortList, qosDiffServType49=qosDiffServType49, mulifIpAddr=mulifIpAddr, rmonEventTable=rmonEventTable, trafficSegStatus=trafficSegStatus, staticMcastTable=staticMcastTable, swAuthenCtrl=swAuthenCtrl, companyIpifGroup=companyIpifGroup, cmSingleIPMSHoldtime=cmSingleIPMSHoldtime, cmSingleIPGroupPlatform=cmSingleIPGroupPlatform, stpPortOperPointToPoint=stpPortOperPointToPoint, staticMcastMac=staticMcastMac, sysSNTPDSTOffset=sysSNTPDSTOffset, qosDiffServType22=qosDiffServType22, mulifMainIndex=mulifMainIndex, rmonHistoryEntry=rmonHistoryEntry, stpPortDesignatedRoot=stpPortDesignatedRoot, cmSingleIPNBMacAddr=cmSingleIPNBMacAddr, dot1qVlanAsyOnOff=dot1qVlanAsyOnOff, cmSingleIPCaSFirmwareVer=cmSingleIPCaSFirmwareVer, dlinkGreenPortStandbyTimeProfile1=dlinkGreenPortStandbyTimeProfile1, cmSingleIPNBRoleState=cmSingleIPNBRoleState, sysIpAddr=sysIpAddr, laPortChannelEntry=laPortChannelEntry, dlink_DGS1500Series=dlink_DGS1500Series, PortLaMode=PortLaMode, qosDiffServType15=qosDiffServType15, companySNMPV3=companySNMPV3, cmSingleIPCtrl=cmSingleIPCtrl, igsVlanFilterTable=igsVlanFilterTable, snmpV3Host=snmpV3Host, rmonStatsIndex=rmonStatsIndex, securityARPSpoofPrevent=securityARPSpoofPrevent, bandwidthCtrlRxThreshold=bandwidthCtrlRxThreshold, companyGVRPGroup=companyGVRPGroup, aclL2AccessID=aclL2AccessID, gvrpSettingsEntry=gvrpSettingsEntry, snmpV3Group=snmpV3Group, stpBridgeMaxAge=stpBridgeMaxAge, swTimeRangeSunday=swTimeRangeSunday, aclL3RuleTable=aclL3RuleTable, rmonAlarmEntry=rmonAlarmEntry, snmpGlobalState=snmpGlobalState, companyStaticARP=companyStaticARP, cmSingleIPGroupDeviceName=cmSingleIPGroupDeviceName, voicevlanDeviceEntry=voicevlanDeviceEntry, dot1qVlanUngisterMCFiltermode=dot1qVlanUngisterMCFiltermode, laPortChannelTable=laPortChannelTable, sysLBDRecoverTime=sysLBDRecoverTime, stpPortDesignatedPort=stpPortDesignatedPort, BridgeId=BridgeId, swTimeRangeDate=swTimeRangeDate, qosDiffServType25=qosDiffServType25, igsVlanRtrPortList=igsVlanRtrPortList, aclProfileSrcPortMask=aclProfileSrcPortMask, voicevlanPortCurrentTagMode=voicevlanPortCurrentTagMode, staticRouteBackup=staticRouteBackup, tftpFwTftpOperationStatus=tftpFwTftpOperationStatus, gvrpSettingsTable=gvrpSettingsTable, swTimeRangeEndDay=swTimeRangeEndDay, rmonEventIndex=rmonEventIndex, staticMcastEntry=staticMcastEntry, rmonAlarmStatus=rmonAlarmStatus, voicevlanDevicePort=voicevlanDevicePort, companyIgsGroup=companyIgsGroup, voicevlanPortManuTagMode=voicevlanPortManuTagMode, autoSurveillanceVlanOUIEntry=autoSurveillanceVlanOUIEntry, dlinklldpConfigManAddrEntry=dlinklldpConfigManAddrEntry, stpVersion=stpVersion, qosDiffServType48=qosDiffServType48, swAuthRadiusServerAddress=swAuthRadiusServerAddress, cmSingleIPMSColdStart=cmSingleIPMSColdStart, mulIfMainEntry=mulIfMainEntry, stpBridgeHelloTime=stpBridgeHelloTime, dhcpServerScreenServerEntry=dhcpServerScreenServerEntry, rmonHistoryDataSource=rmonHistoryDataSource, aclProfileEntry=aclProfileEntry, gvrpSettingsPortControlIndex=gvrpSettingsPortControlIndex, dlinkGreenPortShutoff=dlinkGreenPortShutoff, sysGPIOStatus=sysGPIOStatus, tftpCfgServerIpAddress=tftpCfgServerIpAddress, voicevlanDevice=voicevlanDevice, sysSwitchName=sysSwitchName, stpHelloTime=stpHelloTime, snmpV3TrapRSTPStateChange=snmpV3TrapRSTPStateChange, dlinklldpConfigManAddrPortsTxEnable=dlinklldpConfigManAddrPortsTxEnable, sysSNTPDSTState=sysSNTPDSTState, aclL3RuleTcpAckBit=aclL3RuleTcpAckBit, autoSurveillanceVlanOUITable=autoSurveillanceVlanOUITable, sysMirrorTargetPort=sysMirrorTargetPort)
mibBuilder.exportSymbols("DGS-1500-52_AX", dot1qVlanUntaggedPorts=dot1qVlanUntaggedPorts, dlinkGreenPortShutoffPortList=dlinkGreenPortShutoffPortList, trafficSegEntry=trafficSegEntry, qosDiffServType45=qosDiffServType45, snmpV3GroupName=snmpV3GroupName, staticRouteActiveStatus=staticRouteActiveStatus, igsVlan=igsVlan, swAuthCtrlPktFwdMode=swAuthCtrlPktFwdMode, aclProfileRuleCount=aclProfileRuleCount, qosDiffServType13=qosDiffServType13, swAuthUserName=swAuthUserName, qosDiffServType58=qosDiffServType58, VlanIndex=VlanIndex, aRPSpoofPreventRowStatus=aRPSpoofPreventRowStatus, staticRouteGateway=staticRouteGateway, snmpV3viewTreeStatus=snmpV3viewTreeStatus, staticRouteRowStatus=staticRouteRowStatus, companyMirror=companyMirror, aRPSpoofPreventTable=aRPSpoofPreventTable, swTimeRangeStartMonth=swTimeRangeStartMonth, staticVlanID=staticVlanID, aRPSpoofPreventEntry=aRPSpoofPreventEntry, cmSingleIPMSPowerFailure=cmSingleIPMSPowerFailure, sysPortCtrlFlowControl=sysPortCtrlFlowControl, dot1qVlanEntry=dot1qVlanEntry, dhcpServerScreenServerIndex=dhcpServerScreenServerIndex, sysSNTPDSTStartHour=sysSNTPDSTStartHour, aclProfileNo=aclProfileNo, cmSingleIPMSTopologyChange=cmSingleIPMSTopologyChange, swAuthAuthDirection=swAuthAuthDirection, qosDiffServType04=qosDiffServType04, rmonAlarmSampleType=rmonAlarmSampleType, stpForwardDelay=stpForwardDelay, syslogUDPPort=syslogUDPPort, stpTopChanges=stpTopChanges, companyTftpGroup=companyTftpGroup, snmpV3GroupTable=snmpV3GroupTable, swAuthRadiusServerAccountingPort=swAuthRadiusServerAccountingPort, sysGroupInterval=sysGroupInterval, qosDiffServType27=qosDiffServType27, dlinkGreenLEDShutoffTimeProfile1=dlinkGreenLEDShutoffTimeProfile1, voicevlanOUIStatus=voicevlanOUIStatus, igsVlanMulticastGroupPortList=igsVlanMulticastGroupPortList, aclL2RuleAction=aclL2RuleAction, sysIpAddrCfgMode=sysIpAddrCfgMode, qosDiffServType36=qosDiffServType36, dlinkGreenPortShutoffState=dlinkGreenPortShutoffState, rmonStatsStatus=rmonStatsStatus, qosDiffServType28=qosDiffServType28, aclL2RuleTable=aclL2RuleTable, trustedHostIpMask=trustedHostIpMask, aclL3RuleTcpFinBit=aclL3RuleTcpFinBit, aclL2RuleSrcMacAddrMask=aclL2RuleSrcMacAddrMask, companyACLGroup=companyACLGroup, cmSingleIPMSWarmStart=cmSingleIPMSWarmStart, swAuthRadiusServerIndex=swAuthRadiusServerIndex, staticAutoLearningList=staticAutoLearningList, aclL3RuleDscp=aclL3RuleDscp, sysGratuitousARPGlobalSettings=sysGratuitousARPGlobalSettings, snmpV3GroupSecurityModel=snmpV3GroupSecurityModel, swTimeRangeSettingEntry=swTimeRangeSettingEntry, snmpV3UserEntry=snmpV3UserEntry, qosDiffServType56=qosDiffServType56, qosDiffServType63=qosDiffServType63, stpPortEnable=stpPortEnable, cmSingleIPGroupHoldtime=cmSingleIPGroupHoldtime, sysPortCtrlSpeed=sysPortCtrlSpeed, staticARPMac=staticARPMac, snmpV3UserGroupName=snmpV3UserGroupName, companyLA=companyLA, stpPortDesignatedBridge=stpPortDesignatedBridge, cmSingleIPCaSID=cmSingleIPCaSID, aclL3RuleEntry=aclL3RuleEntry, trafficSegTable=trafficSegTable, voicevlanDeviceTable=voicevlanDeviceTable, rmonAlarmRisingThreshold=rmonAlarmRisingThreshold, aclL3RuleDstIpAddr=aclL3RuleDstIpAddr, sysPortCtrlType=sysPortCtrlType, sysTrapStatus=sysTrapStatus, sysSNTPTimeSeconds=sysSNTPTimeSeconds, aclL3RuleTcpSynBit=aclL3RuleTcpSynBit, dot1pPortPriority=dot1pPortPriority, companyMultiIPInterface=companyMultiIPInterface, dot1qVlanRowStatus=dot1qVlanRowStatus, sysPortCtrlOperStatus=sysPortCtrlOperStatus, dlinkGreenSystemHibernationState=dlinkGreenSystemHibernationState, sysGateway=sysGateway, rmonGlobalState=rmonGlobalState, dhcpServerScreenServerTable=dhcpServerScreenServerTable, staticStatus=staticStatus, aRPSpoofPreventMacAddress=aRPSpoofPreventMacAddress, sysSNTPDSTEndMin=sysSNTPDSTEndMin, sysLBDCtrlIndex=sysLBDCtrlIndex, aclL2ProfileID=aclL2ProfileID, qosDiffServType11=qosDiffServType11, snmpV3GroupNotifyViewName=snmpV3GroupNotifyViewName, sysSNTPDSTStartDay=sysSNTPDSTStartDay, stpPortProtocolMigration=stpPortProtocolMigration, swAuthPortAccessControlEntry=swAuthPortAccessControlEntry, sysPortCtrlIndex=sysPortCtrlIndex, qosDiffServType05=qosDiffServType05, laSystem=laSystem, swAuthAuthReAuthPeriod=swAuthAuthReAuthPeriod, qosDiffServType26=qosDiffServType26, snmpV3viewTreeMask=snmpV3viewTreeMask, sysGratuitousARPLearning=sysGratuitousARPLearning, tftpFwTftpOperation=tftpFwTftpOperation, cmSingleIPMSPlatform=cmSingleIPMSPlatform, rmonEventStatus=rmonEventStatus, laPortControl=laPortControl, qosDiffServType30=qosDiffServType30, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, autoSurveillanceVlanOUIStatus=autoSurveillanceVlanOUIStatus, swAuthAuthServerTimeout=swAuthAuthServerTimeout, broadcastStormCtrlLimitType=broadcastStormCtrlLimitType, staticMcastEgressPorts=staticMcastEgressPorts, swAuthRadiusServerStatus=swAuthRadiusServerStatus, sysGratuitousARPIPIfStatusUp=sysGratuitousARPIPIfStatusUp, mulifMainRowStatus=mulifMainRowStatus, gvrpSettingsIngressChecking=gvrpSettingsIngressChecking, tftpConfigTftpOperation=tftpConfigTftpOperation, staticMcastVlanID=staticMcastVlanID, qosDiffServType38=qosDiffServType38, rmonEvent=rmonEvent, rmonHistoryTable=rmonHistoryTable, dlinklldpState=dlinklldpState, stpHoldTime=stpHoldTime, sslCiphers=sslCiphers, igsVlanFastLeave=igsVlanFastLeave, stpRootPort=stpRootPort, aclL2RuleVlanId=aclL2RuleVlanId, sysSNTPGMTMinutes=sysSNTPGMTMinutes, swAuthAuthTxPeriod=swAuthAuthTxPeriod, gvrpSettingsJoinTime=gvrpSettingsJoinTime, qosDiffServType43=qosDiffServType43, staticEntry=staticEntry, RmonStatus=RmonStatus, snmpV3HostStatus=snmpV3HostStatus, igsQueryInterval=igsQueryInterval, qosDiffServType06=qosDiffServType06, igsSystem=igsSystem, qosDiffServType21=qosDiffServType21, companyMiscGroup=companyMiscGroup, cmSingleIPGroupFirmwareVer=cmSingleIPGroupFirmwareVer, aclL3RuleStatus=aclL3RuleStatus, voicevlanOUITelephonyOUI=voicevlanOUITelephonyOUI, cmSingleIPCaSPlatform=cmSingleIPCaSPlatform, sysPortCtrlFlowControlOper=sysPortCtrlFlowControlOper, dot1qVlanUngisterMCFilterEntry=dot1qVlanUngisterMCFilterEntry, laPortChannelIfIndex=laPortChannelIfIndex, sysTrapSystemEvent=sysTrapSystemEvent, companyTrapSetting=companyTrapSetting, laPortControlTable=laPortControlTable, cmSingleIPMSID=cmSingleIPMSID, qosDiffServType20=qosDiffServType20, qosMode=qosMode, sysLBDVlanLoopPorts=sysLBDVlanLoopPorts, firmwareUpgradeSuccess=firmwareUpgradeSuccess, swAuthRadiusServerTable=swAuthRadiusServerTable, sysSNTPDSTStartMin=sysSNTPDSTStartMin, mulifIpSubnetMask=mulifIpSubnetMask, laPortControlEntry=laPortControlEntry, staticRouteInterfaceID=staticRouteInterfaceID, companyRMON=companyRMON, qosDiffServType37=qosDiffServType37, mulifVLANID=mulifVLANID, dlinkGreenPortShutoffTimeProfile1=dlinkGreenPortShutoffTimeProfile1, rmonEventEntry=rmonEventEntry, snmpV3CommunityEntry=snmpV3CommunityEntry, mulifVLANname=mulifVLANname, LldpManAddress=LldpManAddress, stpPortRestrictedTCN=stpPortRestrictedTCN, qosDiffServType57=qosDiffServType57, companyTraps=companyTraps, swAuthAuthConfigPortControl=swAuthAuthConfigPortControl, sslSecurityHttpStatus=sslSecurityHttpStatus, trafficSegMemberList=trafficSegMemberList, rmonAlarmInterval=rmonAlarmInterval, dlinklldpTxDelay=dlinklldpTxDelay, aclProfileIPProtocol=aclProfileIPProtocol, swAuthUserEntry=swAuthUserEntry, snmpV3CommunityPolicy=snmpV3CommunityPolicy, rmonStatsEntry=rmonStatsEntry, qosDiffServType59=qosDiffServType59, staticRouteProtocol=staticRouteProtocol, PortList=PortList, sysIpInterfaceAdminStatus=sysIpInterfaceAdminStatus, cmSingleIPCaSTable=cmSingleIPCaSTable, gvrpSettingsLeaveAllTime=gvrpSettingsLeaveAllTime, qosDiffServType41=qosDiffServType41, stpGlobal=stpGlobal, cmSingleIPCaSHoldtime=cmSingleIPCaSHoldtime, swAuthAuthConfigPortNumber=swAuthAuthConfigPortNumber, voicevlanPortControlTable=voicevlanPortControlTable, autoSurveillanceVlanId=autoSurveillanceVlanId, trustedHostIpAddr=trustedHostIpAddr, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, cmSingleIPMSRowStatus=cmSingleIPMSRowStatus, sysLocationName=sysLocationName, stpBridgeForwardDelay=stpBridgeForwardDelay, qosDiffServType33=qosDiffServType33, stpPort=stpPort, singleIPMSNotifyPrefix=singleIPMSNotifyPrefix, snmpV3UserName=snmpV3UserName, qosDiffServType51=qosDiffServType51, sysIpSubnetMask=sysIpSubnetMask, sysMirrorCtrlIngressMirroring=sysMirrorCtrlIngressMirroring, aclProfileMask=aclProfileMask, aclL3RuleIgmpType=aclL3RuleIgmpType, dlinkGreenLEDShutoff=dlinkGreenLEDShutoff, sysSNTPDSTStartMon=sysSNTPDSTStartMon, staticARPIP=staticARPIP, qosDiffServType42=qosDiffServType42, companyLLDPSetting=companyLLDPSetting, staticARPType=staticARPType, aclL3RuleTcpUdpDstPortMask=aclL3RuleTcpUdpDstPortMask, sysARPAgingTime=sysARPAgingTime, swTimeRangeWednesday=swTimeRangeWednesday, voiceVlanMode=voiceVlanMode, snmpV3viewTreeType=snmpV3viewTreeType, sysLBDVlanLoopIndex=sysLBDVlanLoopIndex, staticPort=staticPort, swAuthAuthMaxReq=swAuthAuthMaxReq, staticRouteMetric=staticRouteMetric, qosDiffServType55=qosDiffServType55, swTimeRangeSettingTable=swTimeRangeSettingTable, swTimeRangeFriday=swTimeRangeFriday, mulifName=mulifName, singleIPMSNotify=singleIPMSNotify, igsVlanMulticastGroupTable=igsVlanMulticastGroupTable, swTimeRangeTuesday=swTimeRangeTuesday, rmonEventType=rmonEventType, cmSingleIPMSLinkUp=cmSingleIPMSLinkUp, rmonStatsTable=rmonStatsTable, aclL3RuleProtocol=aclL3RuleProtocol, sysLoginTimeoutInterval=sysLoginTimeoutInterval, igsStatus=igsStatus, cmSingleIPMSEntry=cmSingleIPMSEntry, aclL2RuleEtherType=aclL2RuleEtherType, dlinkGreenLEDShutoffPortList=dlinkGreenLEDShutoffPortList, companyGreenSetting=companyGreenSetting, qosDiffServEnable=qosDiffServEnable, swAuthAuthCapability=swAuthAuthCapability, voicevlanDeviceTagType=voicevlanDeviceTagType, tftpFwServerIpAddress=tftpFwServerIpAddress, aclL2RuleDstMacAddrMask=aclL2RuleDstMacAddrMask, syslogTimeStamp=syslogTimeStamp, rmonAlarmRisingEventIndex=rmonAlarmRisingEventIndex, voicevlanPortControlIndex=voicevlanPortControlIndex, companyQoSGroup=companyQoSGroup, sysRestart=sysRestart, staticMac=staticMac, igsVlanMulticastGroupIpAddress=igsVlanMulticastGroupIpAddress, swAuthRadiusServerRetransmit=swAuthRadiusServerRetransmit)
mibBuilder.exportSymbols("DGS-1500-52_AX", qosDiffServType09=qosDiffServType09, companyDot1qVlanGroup=companyDot1qVlanGroup, traps=traps, dlinkGreenSystemHibernation=dlinkGreenSystemHibernation, staticARPEntry=staticARPEntry, qosDiffServType08=qosDiffServType08, companyVoiceVlan=companyVoiceVlan, laPortActorTimeout=laPortActorTimeout, sysLBDCtrlEntry=sysLBDCtrlEntry, voicevlanPortControlEntry=voicevlanPortControlEntry, snmpV3TrapFirmUpgrade=snmpV3TrapFirmUpgrade, dot1pPortEntry=dot1pPortEntry, cmSingleIPNBReceivedPort=cmSingleIPNBReceivedPort, aRPSpoofPreventIpAddr=aRPSpoofPreventIpAddr, aRPSpoofPreventPortList=aRPSpoofPreventPortList, igsVlanRouterTable=igsVlanRouterTable, qosDiffServType61=qosDiffServType61, autoSurveillanceVlanOUISurveillanceOUI=autoSurveillanceVlanOUISurveillanceOUI, igsVlanQuerier=igsVlanQuerier, cmSingleIPMSPowerStatusChg=cmSingleIPMSPowerStatusChg, qosDiffServ=qosDiffServ, stpTxHoldCount=stpTxHoldCount, aclProfileDstMacAddrMask=aclProfileDstMacAddrMask, aclL3RuleTcpUdpSrcPortMask=aclL3RuleTcpUdpSrcPortMask, cmSingleIPMSAuthFail=cmSingleIPMSAuthFail, snmpV3UserAuthProtocolPassword=snmpV3UserAuthProtocolPassword, sysDhcpAutoConfiguration=sysDhcpAutoConfiguration, rmonStatsOwner=rmonStatsOwner, cmSingleIPInfo=cmSingleIPInfo, dlinklldpMsgTxInterval=dlinklldpMsgTxInterval, qosDiffServType10=qosDiffServType10, sysGratuitousARPIFName=sysGratuitousARPIFName, sysLBDInterval=sysLBDInterval, broadcastStormCtrlThreshold=broadcastStormCtrlThreshold, LacpKey=LacpKey, sysSNTPDSTEndHour=sysSNTPDSTEndHour, snmpV3UserVersion=snmpV3UserVersion, rmonEventCommunity=rmonEventCommunity, trafficSegIfIndex=trafficSegIfIndex, stpDesignatedRoot=stpDesignatedRoot, sysTrapPortLinkUpDownEvent=sysTrapPortLinkUpDownEvent, cmSingleIPMSTable=cmSingleIPMSTable, qosDiffServType31=qosDiffServType31, securityDhcpServerScreen=securityDhcpServerScreen, staticARPTable=staticARPTable, staticARPIPInterface=staticARPIPInterface, voiceVlanTimeout=voiceVlanTimeout, qosDiffServType18=qosDiffServType18, firmwareIllegalFile=firmwareIllegalFile, stpTimeSinceTopologyChange=stpTimeSinceTopologyChange, laPortActorPortPriority=laPortActorPortPriority, voicevlanOUIMask=voicevlanOUIMask, cmSingleIPGroupMSNumber=cmSingleIPGroupMSNumber, bandwidthCtrlTxThreshold=bandwidthCtrlTxThreshold, queuingMechanism=queuingMechanism, firmwareUpgradeFailure=firmwareUpgradeFailure, rmonHistoryInterval=rmonHistoryInterval, stpPortState=stpPortState, dot1qVlanForbiddenPorts=dot1qVlanForbiddenPorts, gvrpSettingsGVRPState=gvrpSettingsGVRPState, snmpV3ViewTreeEntry=snmpV3ViewTreeEntry, authProtocol=authProtocol, aclL3RuleProfileNo=aclL3RuleProfileNo, qosDiffServType03=qosDiffServType03, aclL2RuleSrcMacAddr=aclL2RuleSrcMacAddr, sysFanStatus=sysFanStatus, swAuthUserPassword=swAuthUserPassword, companySIM=companySIM, rmonAlarmVariable=rmonAlarmVariable, qosDiffServType35=qosDiffServType35, snmpV3EngineID=snmpV3EngineID, voicevlanSystem=voicevlanSystem, dlinkGreenSystemHibernationTimeProfile2=dlinkGreenSystemHibernationTimeProfile2, cmSingleIPGroupName=cmSingleIPGroupName, qosDiffServType34=qosDiffServType34, cmSingleIPMSrisingAlarm=cmSingleIPMSrisingAlarm, swAuthAuthReAuthentication=swAuthAuthReAuthentication, stpPortOperEdgePort=stpPortOperEdgePort, qosDiffServType02=qosDiffServType02, rmonHistoryOwner=rmonHistoryOwner, autoSurveillanceVlanOUI=autoSurveillanceVlanOUI, swTimeRangeStartHour=swTimeRangeStartHour, snmpV3UserTable=snmpV3UserTable, miscStatisticsReset=miscStatisticsReset, snmpV3GroupEntry=snmpV3GroupEntry, snmpV3CommunityStatus=snmpV3CommunityStatus, igsVlanMulticastGroupEntry=igsVlanMulticastGroupEntry, trustedHostEntry=trustedHostEntry, aclProfileSrcIpAddrMask=aclProfileSrcIpAddrMask, snmpV3TrapSNMPAuthentication=snmpV3TrapSNMPAuthentication, cmSingleIPCaSEntry=cmSingleIPCaSEntry, rstpStatus=rstpStatus, swAuthRadiusServerKey=swAuthRadiusServerKey, snmpV3GroupWriteViewName=snmpV3GroupWriteViewName, stpAdminPortPathCost=stpAdminPortPathCost, snmpV3Community=snmpV3Community, dlinkGreenPortStandbyPortList=dlinkGreenPortStandbyPortList, rmonAlarmFallingThreshold=rmonAlarmFallingThreshold, snmpV3UserAuthProtocol=snmpV3UserAuthProtocol, portSecTable=portSecTable, bandwidthCtrlSettings=bandwidthCtrlSettings, cmSingleIPMSFirmwareVer=cmSingleIPMSFirmwareVer, swAuthUserStatus=swAuthUserStatus, aclL3Rule=aclL3Rule, snmpV3UserStatus=snmpV3UserStatus, staticARPRowStatus=staticARPRowStatus, companyStaticMAC=companyStaticMAC, swAuthPortAccessControlTable=swAuthPortAccessControlTable, autoSurveillanceVlanTaggedUplinkDownlinkPort=autoSurveillanceVlanTaggedUplinkDownlinkPort, swTimeRangeEndMonth=swTimeRangeEndMonth, snmpV3GroupReadViewName=snmpV3GroupReadViewName, laPortChannelMode=laPortChannelMode, cmSingleIPPlatform=cmSingleIPPlatform, dlink_products=dlink_products, companyAutoSurveillanceVlan=companyAutoSurveillanceVlan, qosDiffServType39=qosDiffServType39, laPortActorActivity=laPortActorActivity, igsVlanQueryInterval=igsVlanQueryInterval, rmonEventOwner=rmonEventOwner, stpPortAdminPointToPoint=stpPortAdminPointToPoint, aclL3RuleTcpUrgBit=aclL3RuleTcpUrgBit, sysTrapStateChangeEvent=sysTrapStateChangeEvent, stpPortRestrictedRole=stpPortRestrictedRole, rmonAlarmFallingEventIndex=rmonAlarmFallingEventIndex, aclProfileSrcMacAddrMask=aclProfileSrcMacAddrMask, swAuthRadiusServerTimeout=swAuthRadiusServerTimeout, rmonEventDescription=rmonEventDescription, syslogLogSrvAddr=syslogLogSrvAddr, qosDiffServType00=qosDiffServType00, cmSingleIPMSPortTypeChange=cmSingleIPMSPortTypeChange, sysFirmwareVersion=sysFirmwareVersion, dot1qVlanEgressPorts=dot1qVlanEgressPorts, cmSingleIPAdmin=cmSingleIPAdmin, swTimeRangeStartMinute=swTimeRangeStartMinute, qosQ1p=qosQ1p, staticRouteNetmask=staticRouteNetmask, sysLBDStateEnable=sysLBDStateEnable, firmwareTransferError=firmwareTransferError, cmSingleIPGroupEntry=cmSingleIPGroupEntry, sysGratuitousARPTable=sysGratuitousARPTable, sysTrapFirmUpgradeEvent=sysTrapFirmUpgradeEvent, qosDiffServType60=qosDiffServType60, aclL2Rule=aclL2Rule, snmpV3viewTreeSubtree=snmpV3viewTreeSubtree, qosDiffServType01=qosDiffServType01, cmSingleIPMgmt=cmSingleIPMgmt, voicevlanOUITable=voicevlanOUITable, dlinkGreenPortStandbyState=dlinkGreenPortStandbyState, sysTrapIP=sysTrapIP, aclL2RuleEntry=aclL2RuleEntry, cmSingleIPMSmacNotification=cmSingleIPMSmacNotification, stpRootCost=stpRootCost, qosDiffServType07=qosDiffServType07, voicevlanDeviceIndexMac=voicevlanDeviceIndexMac, igsVlanFilterVlanId=igsVlanFilterVlanId, sysSNTPDSTEndMon=sysSNTPDSTEndMon, sysLBDVlanLoopEntry=sysLBDVlanLoopEntry, syslogSeverity=syslogSeverity, autoSurveillanceVlanOUIDescription=autoSurveillanceVlanOUIDescription, autoSurveillanceVlanPriority=autoSurveillanceVlanPriority, securityTrafficSeg=securityTrafficSeg, cmSingleIPHoldtime=cmSingleIPHoldtime, rmonHistoryStatus=rmonHistoryStatus, dlinkGreenSystemHibernationTimeProfile1=dlinkGreenSystemHibernationTimeProfile1, cmSingleIPCaSMacAddr=cmSingleIPCaSMacAddr, dot1qVlanUngisterMCFilterVlanId=dot1qVlanUngisterMCFilterVlanId, qosDiffServType47=qosDiffServType47, autoSurveillanceVlanSystem=autoSurveillanceVlanSystem, sysSave=sysSave, aclL2RuleStatus=aclL2RuleStatus, voicevlanPortAutoDetection=voicevlanPortAutoDetection, miscReset=miscReset, staticRouteEntry=staticRouteEntry, sysSNTPState=sysSNTPState, cmSingleIPMSPassword=cmSingleIPMSPassword, multiIFInfo=multiIFInfo, aclProfileArpSenderIpAddrMask=aclProfileArpSenderIpAddrMask, sysIpManagementVLANName=sysIpManagementVLANName, dot1qVlanUngisterMCFilterTable=dot1qVlanUngisterMCFilterTable, qosDiffServType16=qosDiffServType16, trustedHostStatus=trustedHostStatus, aclL3RuleTcpUdpSrcPort=aclL3RuleTcpUdpSrcPort, portSecMLA=portSecMLA, snmpV3HostCommunityName=snmpV3HostCommunityName, syslogGeneralGroup=syslogGeneralGroup, qosDiffServType17=qosDiffServType17, snmpV3TrapBootup=snmpV3TrapBootup, autoSurveillanceVlanOUIMask=autoSurveillanceVlanOUIMask, qosDiffServType29=qosDiffServType29, snmpV3ViewTree=snmpV3ViewTree, igsVlanFilterEntry=igsVlanFilterEntry, aclProfileType=aclProfileType, companySystem=companySystem, qosDiffServType23=qosDiffServType23, dlinklldpLocManAddrSubtype=dlinklldpLocManAddrSubtype, voiceVlanId=voiceVlanId, dlinkGreenPortStandbyTimeProfile2=dlinkGreenPortStandbyTimeProfile2, tftpConfigTftpOperationStatus=tftpConfigTftpOperationStatus, sysLBDMode=sysLBDMode, swTimeRangeName=swTimeRangeName, companySNTPSetting=companySNTPSetting, stpMaxAge=stpMaxAge, sysMirrorCtrlEgressMirroring=sysMirrorCtrlEgressMirroring, dlinkGreenLEDShutoffTimeProfile2=dlinkGreenLEDShutoffTimeProfile2, sysGratuitousARPEntry=sysGratuitousARPEntry, aclL3RuleAction=aclL3RuleAction, sysJumboFrameEnable=sysJumboFrameEnable, staticDisableAutoLearn=staticDisableAutoLearn, aclL3RuleTcpRstBit=aclL3RuleTcpRstBit, swTimeRangeThursday=swTimeRangeThursday, sysSystemPassword=sysSystemPassword, aclL3RuleTcpUdpDstPort=aclL3RuleTcpUdpDstPort, qosDiffServTypeGroup=qosDiffServTypeGroup, qosDiffServType40=qosDiffServType40, laPortChannelMemberList=laPortChannelMemberList, swAuthRadiusServerEntry=swAuthRadiusServerEntry, securityTrustedHost=securityTrustedHost, dlinklldpConfigManAddrTable=dlinklldpConfigManAddrTable, cmSingleIPGroupTable=cmSingleIPGroupTable, qosDiffServType19=qosDiffServType19, companyStaticRoute=companyStaticRoute, swAuthAuthSuppTimeout=swAuthAuthSuppTimeout, syslogLogging=syslogLogging, trustedHostTable=trustedHostTable, dlinkGreenLEDShutoffState=dlinkGreenLEDShutoffState, securityPortSecurity=securityPortSecurity, cmSingleIPCaSCapability=cmSingleIPCaSCapability, snmpV3HostTable=snmpV3HostTable, singleIPNotifyBidings=singleIPNotifyBidings, stpPortForwardTransitions=stpPortForwardTransitions, rmonAlarmIndex=rmonAlarmIndex, cmSingleIPCaSDeviceName=cmSingleIPCaSDeviceName, aclProfileArpSenderMacAddrMask=aclProfileArpSenderMacAddrMask, cmSingleIPMSnewRoot=cmSingleIPMSnewRoot, trustedHostRowStatus=trustedHostRowStatus, cmSingleIPMSfallingAlarm=cmSingleIPMSfallingAlarm, rmonHistoryBucketsRequested=rmonHistoryBucketsRequested, cmSingleIPCapability=cmSingleIPCapability, sysLBDVlanLoopTable=sysLBDVlanLoopTable, sysLBDCtrlTable=sysLBDCtrlTable, snmpV3CommunityTable=snmpV3CommunityTable, swTimeRangeEndHour=swTimeRangeEndHour, stpPortPriority=stpPortPriority, gratuitousARPDuplicatedIP=gratuitousARPDuplicatedIP, stpPortPathCost=stpPortPathCost, dlinklldpReinitDelay=dlinklldpReinitDelay, swAuthPortAccessCtrl=swAuthPortAccessCtrl, sysGratuitousARPDuplicateIPDetected=sysGratuitousARPDuplicateIPDetected, stpProtocolSpecification=stpProtocolSpecification, sysGratuitousARPSettings=sysGratuitousARPSettings, swTimeRangeEndYear=swTimeRangeEndYear, qosDiffServType44=qosDiffServType44, rmonStatsDataSource=rmonStatsDataSource, stpPortEdge=stpPortEdge)
mibBuilder.exportSymbols("DGS-1500-52_AX", cmSingleIPNeighborTable=cmSingleIPNeighborTable)
