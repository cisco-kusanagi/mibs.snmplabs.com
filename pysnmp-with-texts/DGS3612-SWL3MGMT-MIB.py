...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS3612-SWL3MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:46:34 2019
...
TOSType, Status, Metric, DesignatedRouterPriority, RouterID, AreaID, HelloRange, UpToMaxAge, PositiveInteger = mibBuilder.importSymbols("OSPF-MIB", "TOSType", "Status", "Metric", "DesignatedRouterPriority", "RouterID", "AreaID", "HelloRange", "UpToMaxAge", "PositiveInteger")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
IpAddress, Bits, ModuleIdentity, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, ObjectIdentity, MibIdentifier, Unsigned32, NotificationType, Counter32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "ModuleIdentity", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "ObjectIdentity", "MibIdentifier", "Unsigned32", "NotificationType", "Counter32", "iso", "Integer32")
RowStatus, MacAddress, TimeStamp, PhysAddress, TextualConvention, DisplayString, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "MacAddress", "TimeStamp", "PhysAddress", "TextualConvention", "DisplayString", "TruthValue")
...
swL3IpCtrlSecondary = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 10, 3, 2, 1, 3, 1, 7), TruthValue()).setMaxAccess("readwrite")
...
swL3IpStaticRouteNextHop = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 10, 3, 2, 5, 1, 4), IpAddress()).setMaxAccess("readonly")
...
swL3RouteRedistriSrcProtocol = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 10, 3, 5, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))).clone(namedValues=NamedValues(("other", 1), ("rip", 2), ("ospf", 3), ("static", 4), ("local", 5)))).setMaxAccess("readonly")
...
swL3RouteRedistriDstProtocol = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 10, 3, 5, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("other", 1), ("rip", 2), ("ospf", 3)))).setMaxAccess("readonly")
...
swL3RouteRedistriMetric = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 10, 3, 5, 1, 4), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 16777214))).setMaxAccess("readcreate")
...
if mibBuilder.loadTexts: swL3OspfExternalLsdbChecksum.setDescription("This field is the checksum of the complete contents of the advertisement, excepting the age field. The age field is excepted so that an advertisement's age can be incremented without updating the checksum. The checksum used is the same that is used for ISO connec- tionless datagrams; it is commonly referred to as the Fletcher checksum.")
...
if mibBuilder.loadTexts: swL3OspfExternalLsdbForwardingAddress.setDescription('This field is the forwarding dddress.')
...
mibBuilder.exportSymbols("DGS3612-SWL3MGMT-MIB", swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3ospfIfType=swL3ospfIfType, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3Md5KeyId=swL3Md5KeyId, swL3VrrpOperState=swL3VrrpOperState, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3DevMgmt=swL3DevMgmt, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3RelayDhcpCtrlServer=swL3RelayDhcpCtrlServer, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3Md5Entry=swL3Md5Entry, swL3ospfAreaId=swL3ospfAreaId, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3IpMgmt=swL3IpMgmt, swL3RouteRedistriType=swL3RouteRedistriType, swL3VrrpOperTable=swL3VrrpOperTable, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3Md5RowStatus=swL3Md5RowStatus, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3RelayMgmt=swL3RelayMgmt, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3RelayDhcpOption82Policy=swL3RelayDhcpOption82Policy, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3ospfIfEvents=swL3ospfIfEvents, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3RelayDhcpCtrlState=swL3RelayDhcpCtrlState, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3ospfIfEntry=swL3ospfIfEntry, swL3OspfHostTable=swL3OspfHostTable, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3ospfIfTable=swL3ospfIfTable, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3RelayDhcpOption82CheckState=swL3RelayDhcpOption82CheckState, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3DevCtrlDHCPAutoConfigState=swL3DevCtrlDHCPAutoConfigState, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3RelayDhcpHopCount=swL3RelayDhcpHopCount, swL3Md5Key=swL3Md5Key, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3ospfIfMetric=swL3ospfIfMetric, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3ospfIfDemand=swL3ospfIfDemand, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3IpCtrlState=swL3IpCtrlState, swL3DevCtrl=swL3DevCtrl, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3ospfAreaTable=swL3ospfAreaTable, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3RoutePreference=swL3RoutePreference, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3Md5Table=swL3Md5Table, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, Ipv6Address=Ipv6Address, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3ospfIfState=swL3ospfIfState, swL3RelayDhcpState=swL3RelayDhcpState, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3RelayDnsState=swL3RelayDnsState, swL3RouteRedistriEntry=swL3RouteRedistriEntry, NodeAddress=NodeAddress, swL3OspfHostMetric=swL3OspfHostMetric, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3RelayDhcpMgmt=swL3RelayDhcpMgmt, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3RelayDhcpTimeThreshold=swL3RelayDhcpTimeThreshold, swL3OspfHostEntry=swL3OspfHostEntry, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3Ipv6Address=swL3Ipv6Address, swL3ospfAreaType=swL3ospfAreaType, swL3RelayDhcpCtrlTable=swL3RelayDhcpCtrlTable, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3RelayDhcpOption82State=swL3RelayDhcpOption82State, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3IpCtrlTable=swL3IpCtrlTable, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, VrId=VrId, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3MgmtMIB=swL3MgmtMIB, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3OspfHostStatus=swL3OspfHostStatus, NetAddress=NetAddress, swL3OspfHostTOS=swL3OspfHostTOS, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3IpCtrlMode=swL3IpCtrlMode, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3RelayDhcpCtrlEntry=swL3RelayDhcpCtrlEntry, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3RelayDhcpCtrlInterfaceName=swL3RelayDhcpCtrlInterfaceName)
