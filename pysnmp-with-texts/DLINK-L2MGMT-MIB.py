...
# Produced by pysmi-0.3.4 at Wed May  1 12:49:54 2019
...
Bits, Integer32, IpAddress, Gauge32, TimeTicks, ObjectIdentity, iso, Counter64, MibIdentifier, NotificationType, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Integer32", "IpAddress", "Gauge32", "TimeTicks", "ObjectIdentity", "iso", "Counter64", "MibIdentifier", "NotificationType", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
...
if mibBuilder.loadTexts: swDlinkL2Mgmt.setContactInfo(' D-Link Customer Service Postal: No. 20,Park Ave, II, Science-based Industrial Park, Hsinchu, taiwan, R.O.C. Tel: 886-3-577-9966 E-mail: ')
if mibBuilder.loadTexts: swDlinkL2Mgmt.setDescription('The Structure of Common Management Information for making a trunk and IGMP related function for D-Link devices.')
...
mibBuilder.exportSymbols("DLINK-L2MGMT-MIB", swPortTrunkMaxPortMembers=swPortTrunkMaxPortMembers, swPortTrunkMasterPort=swPortTrunkMasterPort, swIGMPCtrlMaxEntries=swIGMPCtrlMaxEntries, swPortTrunkPackage=swPortTrunkPackage, swIGMPQueryInterval=swIGMPQueryInterval, swIGMPQuerierVersion=swIGMPQuerierVersion, swIGMPIpGroupReportCount=swIGMPIpGroupReportCount, swPortTrunkName=swPortTrunkName, swIGMPGroupIpAddr=swIGMPGroupIpAddr, swIGMPCtrlTable=swIGMPCtrlTable, swIGMPPackage=swIGMPPackage, swIGMPCtrlStatus=swIGMPCtrlStatus, swPortMirrorSourcePort=swPortMirrorSourcePort, swIGMPInfoTable=swIGMPInfoTable, swPortTrunkTable=swPortTrunkTable, swIGMPMacAddr=swIGMPMacAddr, swDlinkL2Mgmt=swDlinkL2Mgmt, swPortTrunkIndex=swPortTrunkIndex, swIGMPInfoVid=swIGMPInfoVid, MacAddress=MacAddress, swPortMirrorCtrlEntry=swPortMirrorCtrlEntry, swPortMirrorState=swPortMirrorState, swIGMPInfoTxQueryCount=swIGMPInfoTxQueryCount, swIGMPCtrlEntry=swIGMPCtrlEntry, swIGMPPortMap=swIGMPPortMap, swIGMPRobustness=swIGMPRobustness, swPortMirrorDirection=swPortMirrorDirection, swPortMirrorIndex=swPortMirrorIndex, swIGMPTableMaxEntries=swIGMPTableMaxEntries, PYSNMP_MODULE_ID=swDlinkL2Mgmt, swPortMirrorCtrlTable=swPortMirrorCtrlTable, swPortMirrorMaxEntries=swPortMirrorMaxEntries, swPortTrunkState=swPortTrunkState, swIGMPVid=swIGMPVid, swIGMPQueryMaxResponseTime=swIGMPQueryMaxResponseTime, swIGMPIfnoMaxEntries=swIGMPIfnoMaxEntries, swIGMPTable=swIGMPTable, swPortTrunkEntry=swPortTrunkEntry, swIGMPInfoQueryCount=swIGMPInfoQueryCount, PortList=PortList, swIGMPCtrlVid=swIGMPCtrlVid, swPortMirrorTargetPort=swPortMirrorTargetPort, swPortTrunkMaxEntries=swPortTrunkMaxEntries, swPortTrunkPortList=swPortTrunkPortList, swIGMPCtrlTimer=swIGMPCtrlTimer, swPortMirrorPackage=swPortMirrorPackage, swIGMPCtrlState=swIGMPCtrlState, swIGMPEntry=swIGMPEntry, swIGMPInfoEntry=swIGMPInfoEntry)
