...
# Produced by pysmi-0.3.4 at Wed May  1 12:48:45 2019
...
ModuleIdentity, Unsigned32, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Gauge32, NotificationType, Integer32, ObjectIdentity, Counter64, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Gauge32", "NotificationType", "Integer32", "ObjectIdentity", "Counter64", "Bits", "Counter32")
TruthValue, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "DisplayString")
rlPoe = ModuleIdentity((1, 3, 6, 1, 4, 1, 171, 10, 94, 89, 89, 108))
rlPoe.setRevisions(('2005-04-14 00:00',))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: rlPoe.setRevisionsDescriptions(('Initial revision.',))
if mibBuilder.loadTexts: rlPoe.setLastUpdated('200504140000Z')
if mibBuilder.loadTexts: rlPoe.setOrganization('Dlink, Inc.')
if mibBuilder.loadTexts: rlPoe.setContactInfo('www.dlink.com')
if mibBuilder.loadTexts: rlPoe.setDescription('The private MIB module definition for Power Over Ethernet.')
...
if mibBuilder.loadTexts: rlPethPsePortPowerLimit.setDescription('This variable indicates on the maximum power level in milli watts which is available from rlPethPsePortIndex.')
...
mibBuilder.exportSymbols("DLINK-3100-POE-MIB", rlPethMainPseSwVersion=rlPethMainPseSwVersion, rlPethPsePortOperStatus=rlPethPsePortOperStatus, rlPethPsePortOutputVoltage=rlPethPsePortOutputVoltage, rlPethPowerPseRpsPower=rlPethPowerPseRpsPower, rlPethPowerPsedisconnectMethod=rlPethPowerPsedisconnectMethod, rlPethMainPseTable=rlPethMainPseTable, rlPethMainPseEntry=rlPethMainPseEntry, rlPethPsePortOutputPower=rlPethPsePortOutputPower, rlPethPowerPsePowerManagementMode=rlPethPowerPsePowerManagementMode, rlPethPsePortOutputCurrent=rlPethPsePortOutputCurrent, rlPethPsePortGroupIndex=rlPethPsePortGroupIndex, rlPethPsePortTimeRangeName=rlPethPsePortTimeRangeName, rlPethMainPsePowerGuardBand=rlPethMainPsePowerGuardBand, rlPethPowerPsePower=rlPethPowerPsePower, rlPethPsePortEntry=rlPethPsePortEntry, rlPethPowerPseGroupIndex=rlPethPowerPseGroupIndex, rlPoe=rlPoe, rlPethPsePortPowerLimit=rlPethPsePortPowerLimit, rlPethMainPseHwType=rlPethMainPseHwType, PYSNMP_MODULE_ID=rlPoe, rlPethMainPseHwVersion=rlPethMainPseHwVersion, rlPethPowerPseTable=rlPethPowerPseTable, rlPethPsePortIndex=rlPethPsePortIndex, rlPethPsePortStatus=rlPethPsePortStatus, rlPethPowerPseEntry=rlPethPowerPseEntry, rlPethMainPseGroupIndex=rlPethMainPseGroupIndex, rlPethPsePortTable=rlPethPsePortTable)
