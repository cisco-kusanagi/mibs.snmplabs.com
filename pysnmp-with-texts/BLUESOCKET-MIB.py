...
Unsigned32, iso, Bits, NotificationType, enterprises, Gauge32, ObjectIdentity, MibIdentifier, ModuleIdentity, Counter64, Counter32, IpAddress, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Bits", "NotificationType", "enterprises", "Gauge32", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Counter64", "Counter32", "IpAddress", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks")
...
if mibBuilder.loadTexts: roleVpn.setDescription('Requires the user to connect to the WG-1000 with a vpn of this type already enabled')
...
mibBuilder.exportSymbols("BLUESOCKET-MIB", adminUserNotes=adminUserNotes, exLdapServName=exLdapServName, serviceGrpMemEntry=serviceGrpMemEntry, natId=natId, exRdAccServNotes=exRdAccServNotes, roleQosUserIn=roleQosUserIn, exLdapServSslServer=exLdapServSslServer, mIntNetmask=mIntNetmask, macDevAuthId=macDevAuthId, schedGrpMemTable=schedGrpMemTable, usmSumTtlBandWthInUse=usmSumTtlBandWthInUse, policy=policy, httpDefaultUrl=httpDefaultUrl, pIntPrimaryDNS=pIntPrimaryDNS, pptpLdapPwdAttrName=pptpLdapPwdAttrName, statusRefreshTime=statusRefreshTime, appLogLevTable=appLogLevTable, blueEventTable=blueEventTable, BlueMacAddress=BlueMacAddress, mIntNetbiosNameServ=mIntNetbiosNameServ, adUsrAccessNativeUser=adUsrAccessNativeUser, nativeUserFixedIpAddr=nativeUserFixedIpAddr, policyRowStatus=policyRowStatus, adminUserEmailId=adminUserEmailId, vlanRowStatus=vlanRowStatus, hostInvertDest=hostInvertDest, roleUnGuestLogin=roleUnGuestLogin, machineRole=machineRole, hostGrpTable=hostGrpTable, policyEntry=policyEntry, exLdapServSsl=exLdapServSsl, adUsrAccessEntry=adUsrAccessEntry, serviceGrpMemId=serviceGrpMemId, connectionHost=connectionHost, adUsrAccessConfiguration=adUsrAccessConfiguration, nativeUserEmailId=nativeUserEmailId, exLdapServRdAccState=exLdapServRdAccState, httpPasswdChangeChoice=httpPasswdChangeChoice, tSeconds=tSeconds, logMaxRemSysLogLevel=logMaxRemSysLogLevel, l2tpLocalIpAddr=l2tpLocalIpAddr, exLdapServTable=exLdapServTable, exUserRuleAttribute=exUserRuleAttribute, exRdAuthServDefRoleId=exRdAuthServDefRoleId, snmpTrapMgmtIpAddress=snmpTrapMgmtIpAddress, exRdAuthServSecret=exRdAuthServSecret, autoBkupRate=autoBkupRate, connectionLoginAttempt=connectionLoginAttempt, authenticationMethod=authenticationMethod, exLdapServSecret=exLdapServSecret, sysStatMemUtil=sysStatMemUtil, httpChainCertChangeChoice=httpChainCertChangeChoice, mIntTable=mIntTable, schedGrpId=schedGrpId, certRowStatus=certRowStatus, adUsrAccessRoles=adUsrAccessRoles, schedEveryDay=schedEveryDay, pIntGateway=pIntGateway, connectionLoginTime=connectionLoginTime, tMonth=tMonth, users=users, exLdapServId=exLdapServId, roleQosDscpOut=roleQosDscpOut, exLdapServSslClient=exLdapServSslClient, hostId=hostId, hostAddress=hostAddress, schedEndDateAndTime=schedEndDateAndTime, nativeUserName=nativeUserName, confLogGroup=confLogGroup, certSerial=certSerial, sysStatDiskSpaceFree=sysStatDiskSpaceFree, mIntId=mIntId, policyTable=policyTable, autoBkupFtpServPasswd=autoBkupFtpServPasswd, httpExServerChoice=httpExServerChoice, mIntMulticastOpt=mIntMulticastOpt, roleQosRateQntOut=roleQosRateQntOut, nativeUserPassword=nativeUserPassword, l2tpRoleId=l2tpRoleId, adUsrAccessVlans=adUsrAccessVlans, exRdAuthServNotes=exRdAuthServNotes, policySeqId=policySeqId, hostGrpName=hostGrpName, userSumNoOfLogdInUsr=userSumNoOfLogdInUsr, time=time, vlanGrpMemTable=vlanGrpMemTable, connectionUserId=connectionUserId, exNtlmServState=exNtlmServState, snmpTrapMgmtId=snmpTrapMgmtId, schedGrpMemRowStatus=schedGrpMemRowStatus, ipsecConfEsp56BitDESWithSHA1=ipsecConfEsp56BitDESWithSHA1, exLdapServEntry=exLdapServEntry, certId=certId, subnetVpnRtLastIp=subnetVpnRtLastIp, exRdAuthServEntry=exRdAuthServEntry, natEntry=natEntry, serviceName=serviceName, LocalDateAndTime=LocalDateAndTime, adminUserName=adminUserName, mIntEntry=mIntEntry, httpAttemptWait=httpAttemptWait, hostType=hostType, authMethodCertificates=authMethodCertificates, maxLifeTimeInSecs=maxLifeTimeInSecs, userSumNoOfLogdVPNUsr=userSumNoOfLogdVPNUsr, fixedIpAddrHost=fixedIpAddrHost, httpAdminACL=httpAdminACL, vlan=vlan, httpRedirect=httpRedirect, authentication=authentication, pptp=pptp, ex802AuthServNotes=ex802AuthServNotes, vlanGrpTable=vlanGrpTable, schedGrpEntry=schedGrpEntry, certName=certName, statistics=statistics, httpMaxNumOfActiveSess=httpMaxNumOfActiveSess, httpLangChangeChoice=httpLangChangeChoice, snmpTrapMgmtCommunity=snmpTrapMgmtCommunity, roleQosPriorityOut=roleQosPriorityOut, roleId=roleId, hostNetmask=hostNetmask, policyScheduleId=policyScheduleId, servicePort=servicePort, destination=destination, connectionDev=connectionDev, pIntId=pIntId, exUserRuleId=exUserRuleId, stThresholdTable=stThresholdTable, serviceGrpRowStatus=serviceGrpRowStatus, serviceMgmtDesr=serviceMgmtDesr, publicAccess=publicAccess, tZone=tZone, adUsrAccessAdminUser=adUsrAccessAdminUser, hostGrpMemRowStatus=hostGrpMemRowStatus, exRdAuthServAddr=exRdAuthServAddr, roleQosRate=roleQosRate, vlanGrpId=vlanGrpId, vlanGrpName=vlanGrpName, replication=replication, roleVpn=roleVpn, exRdAccServAddr=exRdAccServAddr, mIntMaximumLease=mIntMaximumLease, roleQosRateOut=roleQosRateOut, certPkey=certPkey, exLdapServAddr=exLdapServAddr, connectionEntry=connectionEntry, roleQosPriInOverride=roleQosPriInOverride, exNtlmServDomainName=exNtlmServDomainName, fixedIpAddrEntry=fixedIpAddrEntry, ipsecConfTable=ipsecConfTable, ipsecConfName=ipsecConfName, pIntName=pIntName, authMethodPreSharedKeys=authMethodPreSharedKeys, l2tpEnable=l2tpEnable, vlanGrpMemRowStatus=vlanGrpMemRowStatus, serviceGrpTable=serviceGrpTable, exServId=exServId, subnetIpConfIdInUse=subnetIpConfIdInUse, exRdAccServId=exRdAccServId, heartBeatInterval=heartBeatInterval, slaveId=slaveId, adUsrAccessMacDev=adUsrAccessMacDev, stThresholdToFailover=stThresholdToFailover, serviceMgmtEntry=serviceMgmtEntry, connectionRoamMac=connectionRoamMac, slaveEntry=slaveEntry, hostGrpMemTable=hostGrpMemTable, ipsecConfEspTripleDESWithMD5=ipsecConfEspTripleDESWithMD5, pIntDefaultDomain=pIntDefaultDomain, ipsecConfId=ipsecConfId, roleQosDscpInOverride=roleQosDscpInOverride, ipsecConfCompressionDeflate=ipsecConfCompressionDeflate, macDevAuthState=macDevAuthState, userSumNoOfUsr=userSumNoOfUsr, nativeUserAccess=nativeUserAccess, subnetVpnMode=subnetVpnMode, vlanName=vlanName, roleVlanId=roleVlanId, adUsrAccessDestination=adUsrAccessDestination, schedMonth=schedMonth, roleUnUserLogin=roleUnUserLogin, misc=misc, exNtlmServDefRoleId=exNtlmServDefRoleId, nativeUserNotes=nativeUserNotes, adUsrAccessMaintance=adUsrAccessMaintance, adUsrAccessNetwork=adUsrAccessNetwork, exUserRuleSeqId=exUserRuleSeqId, autoBkupFtpServName=autoBkupFtpServName, serviceTable=serviceTable, pIntEntry=pIntEntry, slaveTable=slaveTable, ipsecConfEsp256BitAESWithMD5=ipsecConfEsp256BitAESWithMD5, certPkeySize=certPkeySize, mIntEnableDhcpRelay=mIntEnableDhcpRelay, adUsrAccessStatus=adUsrAccessStatus, adminUserTable=adminUserTable, nativeUsers=nativeUsers, logNoOfDelLogEntries=logNoOfDelLogEntries, ipsecConfEntry=ipsecConfEntry, pIntSecondaryDNS=pIntSecondaryDNS, ipsecConfDiffieHellmanGrp5=ipsecConfDiffieHellmanGrp5, roleInherit=roleInherit, pIntTable=pIntTable, ipsecConfEsp256BitAESWithSHA1=ipsecConfEsp256BitAESWithSHA1, fixedIpAddrRoleId=fixedIpAddrRoleId, ex802AuthServPort=ex802AuthServPort, vlanTable=vlanTable, mobilityMode=mobilityMode, blueEventEntry=blueEventEntry, pptpEncryption128Bit=pptpEncryption128Bit, systemStats=systemStats, macDevAuthName=macDevAuthName, serviceGrpMemTable=serviceGrpMemTable, noOfFailedBeats=noOfFailedBeats, logMaxLogEntries=logMaxLogEntries, exUserRuleValue=exUserRuleValue, pIntDhcpTimeout=pIntDhcpTimeout, fixedIpAddrMac=fixedIpAddrMac, btName=btName, certVersion=certVersion, exchangeMode=exchangeMode, btEventOptStatus=btEventOptStatus, hostNotes=hostNotes, roles=roles, ipsecConfEsp56BitDESWithMD5=ipsecConfEsp56BitDESWithMD5, apCheckTime=apCheckTime, schedAllDay=schedAllDay, serviceGrpId=serviceGrpId, pIntIpAddress=pIntIpAddress, schedStartDateAndTime=schedStartDateAndTime, serviceGrpName=serviceGrpName, subnetVpnRtFirstIp=subnetVpnRtFirstIp, serviceMgmtId=serviceMgmtId, roleQosUserOut=roleQosUserOut, serviceCosPriorityIn=serviceCosPriorityIn, mIntDynamicDNS=mIntDynamicDNS, hostGrpMemId=hostGrpMemId, certIssuer=certIssuer, connectionCheckTime=connectionCheckTime, roleTable=roleTable, mIntVlanInterface=mIntVlanInterface, mIntDhcpStartIpAddr=mIntDhcpStartIpAddr, exNtlmServEntry=exNtlmServEntry, macDevAuthTable=macDevAuthTable, exUserRuleEntry=exUserRuleEntry, ipsecConfEsp128BitAESWithMD5=ipsecConfEsp128BitAESWithMD5, connectionTable=connectionTable, hostGrpId=hostGrpId, autoBkupFtpServUser=autoBkupFtpServUser, connectionBytes=connectionBytes, exNtlmServId=exNtlmServId, nativeUserRoleId=nativeUserRoleId, exNtlmServName=exNtlmServName)
mibBuilder.exportSymbols("BLUESOCKET-MIB", exRdAccServState=exRdAccServState, exRdAccServSecret=exRdAccServSecret, tYear=tYear, appLogLevEntry=appLogLevEntry, hostName=hostName, exRdAccServEntry=exRdAccServEntry, pIntGetIpFromDhcp=pIntGetIpFromDhcp, macDevAuthMac=macDevAuthMac, roleType=roleType, serviceRowStatus=serviceRowStatus, snmpTrapMgmtRowStatus=snmpTrapMgmtRowStatus, l2tpRemoteIpStartAddr=l2tpRemoteIpStartAddr, managed=managed, roleQosPriOutOverride=roleQosPriOutOverride, exRdAuthServId=exRdAuthServId, pIntEnableMulticast=pIntEnableMulticast, schedRowId=schedRowId, exRdAuthServRdAccId=exRdAuthServRdAccId, l2tpIdleTimeout=l2tpIdleTimeout, fixedIpAddrAddress=fixedIpAddrAddress, adminUserPassword=adminUserPassword, adminUserStatus=adminUserStatus, exRdAccServName=exRdAccServName, subnetVpnSharedSec=subnetVpnSharedSec, adUsrAccessTable=adUsrAccessTable, snmpTrapMgmtEntry=snmpTrapMgmtEntry, appLogLevId=appLogLevId, fixedIpAddrRowStatus=fixedIpAddrRowStatus, BlueIpAddress=BlueIpAddress, nativeUserTable=nativeUserTable, snmpTrapConf=snmpTrapConf, macDevAuthDefaultRole=macDevAuthDefaultRole, connectionLoginAttemptCnt=connectionLoginAttemptCnt, slaveNotes=slaveNotes, nativeUserRadAcctServId=nativeUserRadAcctServId, roleQosDscpIn=roleQosDscpIn, ipsecConfEsp192BitAESWithSHA1=ipsecConfEsp192BitAESWithSHA1, genSnapshot=genSnapshot, connectionMac=connectionMac, adminUsers=adminUsers, certType=certType, appLogLevLevel=appLogLevLevel, schedWeekDay=schedWeekDay, exRdAccServTable=exRdAccServTable, serviceEntry=serviceEntry, exUserRuleRoleId=exUserRuleRoleId, vlanGrpEntry=vlanGrpEntry, exRdAccServPort=exRdAccServPort, stThresholdToLogMessage=stThresholdToLogMessage, failover=failover, httpLoginAttempts=httpLoginAttempts, nativeUserId=nativeUserId, exLdapServNotes=exLdapServNotes, adminUserEntry=adminUserEntry, serviceId=serviceId, pptpLocalIpAddr=pptpLocalIpAddr, exRdAuthServPrecedence=exRdAuthServPrecedence, ex802AuthServState=ex802AuthServState, schedGrpTable=schedGrpTable, schedGrpMemId=schedGrpMemId, pptpIdleTimeout=pptpIdleTimeout, ipsecConfCompressionLZS=ipsecConfCompressionLZS, connectionIp=connectionIp, exUserRuleOperator=exUserRuleOperator, paSMTPServerIp=paSMTPServerIp, ex802AuthServRowStatus=ex802AuthServRowStatus, connectionAP=connectionAP, roleQosPriorityIn=roleQosPriorityIn, l2tp=l2tp, natProtectedIp=natProtectedIp, exLdapServRdAccId=exLdapServRdAccId, ex802AuthServDefaultRole=ex802AuthServDefaultRole, sysStatCpuUtil=sysStatCpuUtil, schedGrpMemEntry=schedGrpMemEntry, schedule=schedule, hostTable=hostTable, tHours=tHours, hostRowStatus=hostRowStatus, pIntHostName=pIntHostName, certSignAlgo=certSignAlgo, ipsecConfLocalAuth=ipsecConfLocalAuth, autoBackup=autoBackup, pIntProxyArpStatus=pIntProxyArpStatus, serviceMgmtName=serviceMgmtName, vlanGrpMemId=vlanGrpMemId, macDevAuthNotes=macDevAuthNotes, pIntVlanId=pIntVlanId, exNtlmServTable=exNtlmServTable, pIntVlanInterface=pIntVlanInterface, paFixedIpClientAccess=paFixedIpClientAccess, service=service, serviceMgmtOptStatus=serviceMgmtOptStatus, sysStatDiskSpaceUsed=sysStatDiskSpaceUsed, schedRowStatus=schedRowStatus, ex802AuthServAddr=ex802AuthServAddr, certificate=certificate, httpRootCaUrl=httpRootCaUrl, refreshThresholdInSecs=refreshThresholdInSecs, sysStatLOgSpaceUsed=sysStatLOgSpaceUsed, adUsrAccessExServer=adUsrAccessExServer, natRowStatus=natRowStatus, httpLogoutPopup=httpLogoutPopup, mIntDnsDomainName=mIntDnsDomainName, nativeUserRowStatus=nativeUserRowStatus, snmpTrapMgmtTable=snmpTrapMgmtTable, natTable=natTable, hostGrpMemEntry=hostGrpMemEntry, connectionCurRate=connectionCurRate, mIntRowStatus=mIntRowStatus, roleName=roleName, ipsecConfEspTripleDESWithSHA1=ipsecConfEspTripleDESWithSHA1, interface=interface, hostGrpRowStatus=hostGrpRowStatus, ipsecConfEsp192BitAESWithMD5=ipsecConfEsp192BitAESWithMD5, mIntVlanId=mIntVlanId, roleNotes=roleNotes, connectionChecked=connectionChecked, serviceCosPriorityOut=serviceCosPriorityOut, httpAutoPause=httpAutoPause, exLdapServUniqueId=exLdapServUniqueId, slaveRowStatus=slaveRowStatus, ipsecConfRowStatus=ipsecConfRowStatus, adminUserRowStatus=adminUserRowStatus, httpRedirectToHostName=httpRedirectToHostName, hostGrpEntry=hostGrpEntry, serviceNotes=serviceNotes, ex802AuthServTable=ex802AuthServTable, mIntIpAddress=mIntIpAddress, roleRowStatus=roleRowStatus, exNtlmServRowStatus=exNtlmServRowStatus, appLogLevName=appLogLevName, httpLoginHelpButton=httpLoginHelpButton, exModeMain=exModeMain, exRdAuthServPort=exRdAuthServPort, fixedIpAddrId=fixedIpAddrId, schedEntry=schedEntry, configuration=configuration, mIntProxyArpStatus=mIntProxyArpStatus, exNtlmServMsdc=exNtlmServMsdc, roleQosQnt=roleQosQnt, pptpEnable=pptpEnable, mIntDhcpEndIpAddr=mIntDhcpEndIpAddr, protected=protected, certSubject=certSubject, stThresholdAttrName=stThresholdAttrName, roleQosDscpOutOverride=roleQosDscpOutOverride, pIntRowStatus=pIntRowStatus, exLdapServBase=exLdapServBase, minLifeTimeInKbs=minLifeTimeInKbs, exRdAuthServName=exRdAuthServName, ipsecConfEsp128BitAESWithSHA1=ipsecConfEsp128BitAESWithSHA1, l2tpRemoteIpEndAddr=l2tpRemoteIpEndAddr, exLdapServPort=exLdapServPort, userSummary=userSummary, macDevAuthRowStatus=macDevAuthRowStatus, ipsecConfEnableConfiguration=ipsecConfEnableConfiguration, sysStatNeedRestart=sysStatNeedRestart, exLdapServRowStatus=exLdapServRowStatus, exLdapServDefRoleId=exLdapServDefRoleId, snmpConf=snmpConf, btId=btId, certTable=certTable, stThresholdId=stThresholdId, httpAutoRedirectStatus=httpAutoRedirectStatus, statusUpTime=statusUpTime, exNtlmServRdAccState=exNtlmServRdAccState, sysStatTotalDiskSpace=sysStatTotalDiskSpace, policyHostId=policyHostId, certEntry=certEntry, certEndDate=certEndDate, schedTable=schedTable, exNtlmServNotes=exNtlmServNotes, macDevAuthEntry=macDevAuthEntry, exNtlmServMsrpc=exNtlmServMsrpc, ipsecConfDiffieHellmanGrp1=ipsecConfDiffieHellmanGrp1, apSnmpCommunity=apSnmpCommunity, exNtlmServRdAccId=exNtlmServRdAccId, vlanEntry=vlanEntry, remoteLog=remoteLog, systemTracker=systemTracker, ex802AuthServName=ex802AuthServName, adUsrAccessServices=adUsrAccessServices, httpPort=httpPort, mobilityMeshKey=mobilityMeshKey, vlanNotes=vlanNotes, logStorage=logStorage, pptpEncryption40Bit=pptpEncryption40Bit, exModeAggressive=exModeAggressive, tMinutes=tMinutes, certOrg=certOrg, mIntNatAddresses=mIntNatAddresses, exRdAuthServRowStatus=exRdAuthServRowStatus, mobility=mobility, slaveAddress=slaveAddress, exRdAuthServTable=exRdAuthServTable, schedGrpRowStatus=schedGrpRowStatus, blueServer=blueServer, exNtlmServMsad=exNtlmServMsad, stThresholdEntry=stThresholdEntry, vlanGrpMemEntry=vlanGrpMemEntry, exAuthServer=exAuthServer, adUsrAccessVpn=adUsrAccessVpn, connectionId=connectionId, schedGrpName=schedGrpName, tDay=tDay, ipsecConfPsfMode=ipsecConfPsfMode, exLdapServState=exLdapServState, roleEntry=roleEntry, exLdapServFilters=exLdapServFilters, certStartDate=certStartDate, mIntDefaultLease=mIntDefaultLease, exLdapServAccount=exLdapServAccount, refreshThresholdInKbs=refreshThresholdInKbs, serviceProtocol=serviceProtocol, connectionName=connectionName, vlanRowId=vlanRowId, minLifeTimeInSecs=minLifeTimeInSecs, adUsrAccessSchedules=adUsrAccessSchedules, vlanId=vlanId, policyServiceId=policyServiceId, ipsec=ipsec, fixedIpAddrTable=fixedIpAddrTable, nativeUserEntry=nativeUserEntry, slaveEnabled=slaveEnabled, schedName=schedName, adUsrAccessAccounting=adUsrAccessAccounting, adminUserId=adminUserId, hostEntry=hostEntry, subnetVpn=subnetVpn, ex802AuthServEntry=ex802AuthServEntry, tNtpServers=tNtpServers, connection=connection, idleTimeout=idleTimeout, serviceCosDscpIn=serviceCosDscpIn, schedDayOfMonth=schedDayOfMonth, http=http, exLdapServPrecedence=exLdapServPrecedence, serviceCosDscpOut=serviceCosDscpOut, roleRedirect=roleRedirect, connectionUnReg=connectionUnReg, certPkeyAlgo=certPkeyAlgo, adminUserAccess=adminUserAccess, ipsecConfDiffieHellmanGrp2=ipsecConfDiffieHellmanGrp2, l2tpLdapPwdAttrName=l2tpLdapPwdAttrName, ex802AuthServId=ex802AuthServId, pptpRemoteIpEndAddr=pptpRemoteIpEndAddr, vpn=vpn, certContent=certContent, policyId=policyId, natManagedIp=natManagedIp, serviceGrpEntry=serviceGrpEntry, policyAction=policyAction, confLog=confLog, serviceMgmt=serviceMgmt)
mibBuilder.exportSymbols("BLUESOCKET-MIB", pIntNetmask=pIntNetmask, vlanGrpRowStatus=vlanGrpRowStatus, stThresholdToSendTrap=stThresholdToSendTrap, pptpRoleId=pptpRoleId, sysLogFacility=sysLogFacility, policyDirection=policyDirection, slaveMobility=slaveMobility, adUsrAccessReplication=adUsrAccessReplication, mIntDhcpServerOpt=mIntDhcpServerOpt, mIntName=mIntName, policyVlanId=policyVlanId, tNtpSync=tNtpSync, connectionExpiry=connectionExpiry, exRdAuthServState=exRdAuthServState, serviceGrpMemRowStatus=serviceGrpMemRowStatus, pptpRemoteIpStartAddr=pptpRemoteIpStartAddr, exUserRuleTable=exUserRuleTable, maxLifeTimeInKbs=maxLifeTimeInKbs, serviceMgmtTable=serviceMgmtTable, exUserRuleRowStatus=exUserRuleRowStatus, autoBkupFtpDestDir=autoBkupFtpDestDir, connectionRoleId=connectionRoleId, exRdAccServRowStatus=exRdAccServRowStatus)
