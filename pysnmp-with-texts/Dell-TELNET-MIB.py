...
# Produced by pysmi-0.3.4 at Wed May  1 12:56:50 2019
...
TimeTicks, ObjectIdentity, MibIdentifier, IpAddress, Counter32, Integer32, Bits, Unsigned32, NotificationType, Gauge32, Counter64, iso, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "MibIdentifier", "IpAddress", "Counter32", "Integer32", "Bits", "Unsigned32", "NotificationType", "Gauge32", "Counter64", "iso", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
if mibBuilder.loadTexts: rlTelnet.setContactInfo('www.dell.com')
...
mibBuilder.exportSymbols("Dell-TELNET-MIB", rlTelnetSessionClientAddress=rlTelnetSessionClientAddress, rlTelnetUsersTable=rlTelnetUsersTable, rlTelnetTimeout=rlTelnetTimeout, rlTelnetSessionLoginTime=rlTelnetSessionLoginTime, rlTelnetSecondLoginBanner=rlTelnetSecondLoginBanner, PYSNMP_MODULE_ID=rlTelnet, rlTelnetSessionId=rlTelnetSessionId, rlTelnetEnable=rlTelnetEnable, rlTelnetSessionClientAddressType=rlTelnetSessionClientAddressType, rlTelnet=rlTelnet, rlTelnetPassword=rlTelnetPassword, rlTelnetSessionStatus=rlTelnetSessionStatus, rlTelnetMibVersion=rlTelnetMibVersion, rlTelnetUsersEntry=rlTelnetUsersEntry, rlTelnetLoginBanner=rlTelnetLoginBanner)
