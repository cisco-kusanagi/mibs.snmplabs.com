...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, NotificationType, MibIdentifier, Counter64, ObjectIdentity, Counter32, Integer32, ModuleIdentity, Gauge32, iso, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "NotificationType", "MibIdentifier", "Counter64", "ObjectIdentity", "Counter32", "Integer32", "ModuleIdentity", "Gauge32", "iso", "Unsigned32", "IpAddress")
...
if mibBuilder.loadTexts: snBgp4GenDampening.setDescription("The dampening of BGP4 in the router. value 'none' denotes that the BGP4 dampening is off 'parameters' denotes parameters are confibrurable. 'routeMap' denotes routemap is configurable.")
...
if mibBuilder.loadTexts: snBgp4GenDampenHalfLife.setDescription('Bgp4 Dampening Half Life.')
...
if mibBuilder.loadTexts: snBgp4GenDampenReuse.setDescription('Bgp4 Dampening Reuse.')
...
if mibBuilder.loadTexts: snBgp4GenDampenSuppress.setDescription('Bgp4 Dampening Suppress.')
...
if mibBuilder.loadTexts: snBgp4GenDampenMaxSuppress.setDescription('Bgp4 Dampening Max Suppress Time.')
...
if mibBuilder.loadTexts: snBgp4GenDampenMap.setDescription('An octet string of the route-map name for dampening, each character of the name is represented by one octet.')
...
if mibBuilder.loadTexts: snBgp4NeighGenCfgDefOrigMap.setDescription('An octet string of the route-map name, each character of the name is represented by one octet.')
...
if mibBuilder.loadTexts: snBgp4NeighGenCfgDesc.setDescription('An octet string of the neighbor description.')
...
if mibBuilder.loadTexts: snBgp4NeighGenCfgPass.setDescription('An octet string of the neighbor Md5 password.')
...
if mibBuilder.loadTexts: snBgp4NeighDistGroupInFilterList.setDescription('A number from 1 to 0xFFFF. There are 16 of them. This integer number is represented by 2 OCTETs.')
...
if mibBuilder.loadTexts: snBgp4NeighDistGroupOutFilterList.setDescription('A number from 1 to 0xFFFF. There are 16 of them. This integer number is represented by 2 OCTETs.')
...
if mibBuilder.loadTexts: snBgp4NeighDistGroupInIpAccessList.setDescription('A number from 1 to 0xFFFF. There are 1 of them. This integer number is represented by 2 OCTETs.')
...
if mibBuilder.loadTexts: snBgp4NeighDistGroupOutIpAccessList.setDescription('A number from 1 to 0xFFFF. There are 1 of them. This integer number is represented by 2 OCTETs.')
...
if mibBuilder.loadTexts: snBgp4NeighDistGroupInPrefixList.setDescription('A Prefix name list. ')
...
if mibBuilder.loadTexts: snBgp4NeighDistGroupOutPrefixList.setDescription('A Prefix name list. ')
...
if mibBuilder.loadTexts: snBgp4NeighFilterGroupInFilterList.setDescription('A number from 1 to 0xFFFF. There are 16 of them. This integer number is represented by 2 OCTETs.')
...
if mibBuilder.loadTexts: snBgp4NeighFilterGroupOutFilterList.setDescription('A number from 1 to 0xFFFF. There are 16 of them. This integer number is represented by 2 OCTETs.')
...
if mibBuilder.loadTexts: snBgp4NeighFilterGroupInAsPathAccessList.setDescription('A number from 1 to 0xFFFF. There are 1 of them. This integer number is represented by 2 OCTETs.')
...
if mibBuilder.loadTexts: snBgp4NeighFilterGroupOutAsPathAccessList.setDescription('A number from 1 to 0xFFFF. There are 1 of them. This integer number is represented by 2 OCTETs.')
...
if mibBuilder.loadTexts: snBgp4NeighFilterGroupWeight.setDescription('To assign a weight to a neighbor filter.')
...
if mibBuilder.loadTexts: snBgp4NeighFilterGroupWeightAccessList.setDescription('A number from 1 to 0xFFFF. There are 1 of them. This integer number is represented by 2 OCTETs.')
...
if mibBuilder.loadTexts: snBgp4RedisProtocol.setDescription('The imported configuration into BGP4 domain is set in the following: rip(1): - the RIP. ospf(2): - the OSPF. static(3): - the static. connected(4): - the connected. isis(5): - the ISIS.')
...
if mibBuilder.loadTexts: snBgp4RouteMapMatchAsPathAccessList.setDescription('A number from 1 to 0xFFFFFFFF and there are 5 of 4 OCTETs. This integer number is represented by 4 OCTETs. To match a BGP autonomous system path access list.')
...
if mibBuilder.loadTexts: snBgp4RouteMapMatchCommunityList.setDescription('A number from 1 to 0xFFFFFFFF and there are 5 of 4 OCTETs. This integer number is represented by 4 OCTETs. To match a BGP community access list.')
...
if mibBuilder.loadTexts: snBgp4RouteMapMatchAddressAccessList.setDescription('A number from 1 to 0xFFFF and there are 5 of 2 OCTETs. This integer number is represented by 2 OCTETs. To match a BGP address access list.')
...
if mibBuilder.loadTexts: snBgp4RouteMapMatchAddressPrefixList.setDescription('Prefix list To match a BGP address access list.')
...
if mibBuilder.loadTexts: snBgp4RouteMapMatchNextHopAccessList.setDescription('A number from 1 to 0xFFFF and there are 5 of 2 OCTETs. This integer number is represented by 2 OCTETs. To match a BGP address access list.')
...
if mibBuilder.loadTexts: snBgp4RouteMapMatchNextHopPrefixList.setDescription('Prefix list To match a BGP address access list.')
...
if mibBuilder.loadTexts: snBgp4RouteMapSetDampenHalfLife.setDescription('Bgp4 Route Map Dampening Half Life.')
...
if mibBuilder.loadTexts: snBgp4RouteMapSetDampenReuse.setDescription('Bgp4 Route Map Dampening Reuse.')
...
if mibBuilder.loadTexts: snBgp4RouteMapSetDampenSuppress.setDescription('Bgp4 Route Map Dampening Suppress.')
...
if mibBuilder.loadTexts: snBgp4RouteMapSetDampenMaxSuppress.setDescription('Bgp4 Route Map Dampening Max Suppress Time.')
...
if mibBuilder.loadTexts: snBgp4NeighPrefixGroupTable.setDescription('Bgp4 Neighbor Prefix Group table.')
...
if mibBuilder.loadTexts: snBgp4NeighPrefixGroupEntry.setDescription('An entry in the Bgp4 Prefix Group table.')
...
if mibBuilder.loadTexts: snBgp4NeighPrefixGroupNeighIp.setDescription('The IP Address for a neighbor entry.')
...
if mibBuilder.loadTexts: snBgp4NeighPrefixGroupDir.setDescription('The incoming/outgoing advertisements to which the access list is applied.')
...
if mibBuilder.loadTexts: snBgp4NeighPrefixGroupInAccessList.setDescription('An in access prefix list name. ')
...
if mibBuilder.loadTexts: snBgp4NeighPrefixGroupOutAccessList.setDescription('An out prefix list name. ')
...
if mibBuilder.loadTexts: snBgp4NeighPrefixGroupRowStatus.setDescription("This object is used to create and delete row in the table and control if they are used. The values that can be written are: delete(3)...deletes the row create(4)...creates a new row modify(5)...modifies an exsisting row If the row exists, then a SET with value of create(4) returns error 'badValue'. Deleted rows go away immediately. The following values can be returned on reads: noSuch(0)...no such row invalid(1)...Setting it to 'invalid' has the effect of rendering it inoperative.. valid(2)....the row exists and is valid")
mibBuilder.exportSymbols("FOUNDRY-SN-BGP4-GROUP-MIB", snBgp4GenDampenHalfLife=snBgp4GenDampenHalfLife, snBgp4NeighGenCfgEbgpMultihop=snBgp4NeighGenCfgEbgpMultihop, snBgp4RouteOperStatusSubnetMask=snBgp4RouteOperStatusSubnetMask, snBgp4AsPathFilter=snBgp4AsPathFilter, snBgp4NeighDistGroupRowStatus=snBgp4NeighDistGroupRowStatus, snBgp4RouteMapSetCommunityAdditive=snBgp4RouteMapSetCommunityAdditive, snBgp4AsPathFilterEntry=snBgp4AsPathFilterEntry, snBgp4RouteMapFilterTable=snBgp4RouteMapFilterTable, snBgp4RouteMapFilterSequenceNum=snBgp4RouteMapFilterSequenceNum, snBgp4NeighFilterGroupInFilterList=snBgp4NeighFilterGroupInFilterList, snBgp4NeighOperStatusOpenRxCounts=snBgp4NeighOperStatusOpenRxCounts, snBgp4CommunityFilterInternet=snBgp4CommunityFilterInternet, snBgp4NeighPrefixGroupInAccessList=snBgp4NeighPrefixGroupInAccessList, snBgp4AttributeIndex=snBgp4AttributeIndex, snBgp4RouteMapSetDampenHalfLife=snBgp4RouteMapSetDampenHalfLife, snBgp4GenRoutesInstalled=snBgp4GenRoutesInstalled, snBgp4GenAlwaysCompareMed=snBgp4GenAlwaysCompareMed, snBgp4NextBootMaxAttributes=snBgp4NextBootMaxAttributes, snBgp4NeighGenCfgAdvertlevel=snBgp4NeighGenCfgAdvertlevel, snBgp4NeighGenCfgMaxPrefix=snBgp4NeighGenCfgMaxPrefix, snBgp4OperNumOfAttributes=snBgp4OperNumOfAttributes, snBgp4RouteOperStatusTable=snBgp4RouteOperStatusTable, snBgp4NeighDistGroupDir=snBgp4NeighDistGroupDir, snBgp4RouteMapMatchEntry=snBgp4RouteMapMatchEntry, snBgp4RouteMapSetTag=snBgp4RouteMapSetTag, snBgp4NeighOperStatusRemoteAs=snBgp4NeighOperStatusRemoteAs, snBgp4RouteOperStatusIndex=snBgp4RouteOperStatusIndex, snBgp4RouteMapSetAsPathType=snBgp4RouteMapSetAsPathType, snBgp4RedisMatchExternal1=snBgp4RedisMatchExternal1, snBgp4NeighOperStatus=snBgp4NeighOperStatus, snBgp4NeighborSummaryRouteInstalled=snBgp4NeighborSummaryRouteInstalled, snBgp4ClearNeighborCmd=snBgp4ClearNeighborCmd, snBgp4RouteMapSetLocalPreference=snBgp4RouteMapSetLocalPreference, snBgp4NeighOperStatusEntry=snBgp4NeighOperStatusEntry, snBgp4Network=snBgp4Network, snBgp4NeighGenCfgKeepAliveTime=snBgp4NeighGenCfgKeepAliveTime, snBgp4NeighDistGroupInIpAccessList=snBgp4NeighDistGroupInIpAccessList, snBgp4AggregateAddrIp=snBgp4AggregateAddrIp, snBgp4RouteOperStatusLocalPreference=snBgp4RouteOperStatusLocalPreference, snBgp4NeighborSummaryTable=snBgp4NeighborSummaryTable, snBgp4GenHoldTime=snBgp4GenHoldTime, snBgp4GenFastExternalFallover=snBgp4GenFastExternalFallover, snBgp4AddrFilterIndex=snBgp4AddrFilterIndex, snBgp4GenNextBootNeighbors=snBgp4GenNextBootNeighbors, snBgp4NeighGenCfgWeightFilterList=snBgp4NeighGenCfgWeightFilterList, snBgp4NeighOperStatusIp=snBgp4NeighOperStatusIp, snBgp4AttributeAtomicAggregatePresent=snBgp4AttributeAtomicAggregatePresent, snBgp4NeighFilterGroupTable=snBgp4NeighFilterGroupTable, snBgp4NeighFilterGroupDir=snBgp4NeighFilterGroupDir, snBgp4GenOperNeighbors=snBgp4GenOperNeighbors, snBgp4NeighFilterGroupWeight=snBgp4NeighFilterGroupWeight, snBgp4RouteMapMatchCommunityList=snBgp4RouteMapMatchCommunityList, snBgp4NeighOperStatusIndex=snBgp4NeighOperStatusIndex, snBgp4AddrFilterEntry=snBgp4AddrFilterEntry, snBgp4GenDampenSuppress=snBgp4GenDampenSuppress, snBgp4RouteOperStatusOrigin=snBgp4RouteOperStatusOrigin, snBgp4RouteMapSetAsPathString=snBgp4RouteMapSetAsPathString, snBgp4CommunityFilterIndex=snBgp4CommunityFilterIndex, snBgp4GenKeepAliveTime=snBgp4GenKeepAliveTime, snBgp4RouteMapMatchTable=snBgp4RouteMapMatchTable, snBgp4NeighFilterGroupNeighIp=snBgp4NeighFilterGroupNeighIp, snBgp4AddrFilterDestMask=snBgp4AddrFilterDestMask, snBgp4CommunityFilterTable=snBgp4CommunityFilterTable, snBgp4NeighGenCfgNextHopSelf=snBgp4NeighGenCfgNextHopSelf, snBgp4RouteOperStatusEntry=snBgp4RouteOperStatusEntry, snBgp4NeighPrefixGroupEntry=snBgp4NeighPrefixGroupEntry, snBgp4NeighGenCfgNeighIp=snBgp4NeighGenCfgNeighIp, snBgp4GenDampenMap=snBgp4GenDampenMap, snBgp4NeighGenCfgPass=snBgp4NeighGenCfgPass, snBgp4RedisMatchInternal=snBgp4RedisMatchInternal, snBgp4GenMaxNeighbors=snBgp4GenMaxNeighbors, snBgp4GenDampenMaxSuppress=snBgp4GenDampenMaxSuppress, snBgp4CommunityFilterEntry=snBgp4CommunityFilterEntry, snBgp4NeighOperStatusKeepAliveTime=snBgp4NeighOperStatusKeepAliveTime, snBgp4NeighPrefixGroupOutAccessList=snBgp4NeighPrefixGroupOutAccessList, snBgp4NeighDistGroupNeighIp=snBgp4NeighDistGroupNeighIp, snBgp4GenLocalAs=snBgp4GenLocalAs, snBgp4AttributeClusterList=snBgp4AttributeClusterList, snBgp4GenDefaultInfoOriginate=snBgp4GenDefaultInfoOriginate, snBgp4NeighOperStatusNotifRxCounts=snBgp4NeighOperStatusNotifRxCounts, snBgp4NeighGenCfgRowStatus=snBgp4NeighGenCfgRowStatus, snBgp4AggregateAddrOption=snBgp4AggregateAddrOption, snBgp4CommunityFilterLocalAs=snBgp4CommunityFilterLocalAs, snBgp4NeighFilterGroup=snBgp4NeighFilterGroup, snBgp4NeighRouteMapDir=snBgp4NeighRouteMapDir, snBgp4ClearNeighborCmdTable=snBgp4ClearNeighborCmdTable, snBgp4AddrFilterDestIp=snBgp4AddrFilterDestIp, snBgp4GenConfedId=snBgp4GenConfedId, snBgp4GenSynchronization=snBgp4GenSynchronization, snBgp4NeighOperStatusKeepAliveRxCounts=snBgp4NeighOperStatusKeepAliveRxCounts, snBgp4RouteMapMatchSequenceNum=snBgp4RouteMapMatchSequenceNum, snBgp4RouteOperStatusAsPathList=snBgp4RouteOperStatusAsPathList, snBgp4NeighOperStatusOpenTxCounts=snBgp4NeighOperStatusOpenTxCounts, snBgp4NeighborSummaryEntry=snBgp4NeighborSummaryEntry, snBgp4AddrFilterRowStatus=snBgp4AddrFilterRowStatus, snBgp4GenMaxRoutes=snBgp4GenMaxRoutes, snBgp4AttributeTable=snBgp4AttributeTable, snBgp4AsPathFilterRowStatus=snBgp4AsPathFilterRowStatus, snBgp4NeighGenCfgRemovePrivateAs=snBgp4NeighGenCfgRemovePrivateAs, snBgp4NeighborSummary=snBgp4NeighborSummary, snBgp4NeighFilterGroupWeightAccessList=snBgp4NeighFilterGroupWeightAccessList, snBgp4NeighGenCfgDefOriginate=snBgp4NeighGenCfgDefOriginate, snBgp4CommunityFilterCommNum=snBgp4CommunityFilterCommNum, snBgp4NeighGenCfgWeight=snBgp4NeighGenCfgWeight, snBgp4RouteMapSetCommunityNums=snBgp4RouteMapSetCommunityNums, snBgp4RouteMapSetEntry=snBgp4RouteMapSetEntry, snBgp4NetworkBackdoor=snBgp4NetworkBackdoor, snBgp4NeighDistGroupInPrefixList=snBgp4NeighDistGroupInPrefixList, snBgp4RedisWeight=snBgp4RedisWeight, snBgp4AttributeAsPathList=snBgp4AttributeAsPathList, snBgp4AggregateAddrTable=snBgp4AggregateAddrTable, snBgp4NeighDistGroupOutIpAccessList=snBgp4NeighDistGroupOutIpAccessList, snBgp4RedisRouteMap=snBgp4RedisRouteMap, snBgp4RouteOperStatusIp=snBgp4RouteOperStatusIp, snBgp4NeighGenCfg=snBgp4NeighGenCfg, snBgp4NeighOperStatusTable=snBgp4NeighOperStatusTable, snBgp4RouteMapMatchCommunityFilter=snBgp4RouteMapMatchCommunityFilter, snBgp4NetworkSubnetMask=snBgp4NetworkSubnetMask, snBgp4AttributeOrigin=snBgp4AttributeOrigin, snBgp4AddrFilterTable=snBgp4AddrFilterTable, snBgp4AddrFilterSourceMask=snBgp4AddrFilterSourceMask, snBgp4NeighborSummaryStateChgTime=snBgp4NeighborSummaryStateChgTime, snBgp4GenAdminStat=snBgp4GenAdminStat, snBgp4CommunityFilterAction=snBgp4CommunityFilterAction, snBgp4RedisProtocol=snBgp4RedisProtocol, snBgp4RouteMapMatchNextHopPrefixList=snBgp4RouteMapMatchNextHopPrefixList, snBgp4AddrFilterAction=snBgp4AddrFilterAction, snBgp4RouteMapMatchNextHopAccessList=snBgp4RouteMapMatchNextHopAccessList, snBgp4NeighRouteMap=snBgp4NeighRouteMap, snBgp4AsPathFilterIndex=snBgp4AsPathFilterIndex, snBgp4NeighGenCfgHoldTime=snBgp4NeighGenCfgHoldTime, snBgp4AttributeOriginator=snBgp4AttributeOriginator, snBgp4RouteMapMatchTagList=snBgp4RouteMapMatchTagList, snBgp4GenNeighPrefixMinValue=snBgp4GenNeighPrefixMinValue, snBgp4NeighRouteMapRowStatus=snBgp4NeighRouteMapRowStatus, snBgp4GenTotalNeighbors=snBgp4GenTotalNeighbors, snBgp4NeighOperStatusUpdateRxCounts=snBgp4NeighOperStatusUpdateRxCounts, snBgp4AttributeEntry=snBgp4AttributeEntry, snBgp4AddrFilter=snBgp4AddrFilter, snBgp4AggregateAddrMap=snBgp4AggregateAddrMap, snBgp4RouteMapSetNextHop=snBgp4RouteMapSetNextHop, snBgp4RouteOperStatusNextHop=snBgp4RouteOperStatusNextHop, snBgp4RouteOperStatusWeight=snBgp4RouteOperStatusWeight, snBgp4RouteMapMatchNextHopList=snBgp4RouteMapMatchNextHopList, snBgp4AttributeCommunityList=snBgp4AttributeCommunityList, snBgp4RouteMapSetRowMask=snBgp4RouteMapSetRowMask, snBgp4ClusterId=snBgp4ClusterId, snBgp4NeighGenCfgEbgpMultihopTtl=snBgp4NeighGenCfgEbgpMultihopTtl, snBgp4ClearNeighborCmdIp=snBgp4ClearNeighborCmdIp, snBgp4NeighborSummaryRouteReceived=snBgp4NeighborSummaryRouteReceived, snBgp4NeighDistGroupOutFilterList=snBgp4NeighDistGroupOutFilterList, snBgp4RouteMapMatchAsPathAccessList=snBgp4RouteMapMatchAsPathAccessList, snBgp4RouteMapSetDampenSuppress=snBgp4RouteMapSetDampenSuppress, snBgp4RouteMapMatchRouteType=snBgp4RouteMapMatchRouteType, snBgp4RouteMapSet=snBgp4RouteMapSet, snBgp4NeighFilterGroupEntry=snBgp4NeighFilterGroupEntry, snBgp4AggregateAddr=snBgp4AggregateAddr, snBgp4GenNextBootRoutes=snBgp4GenNextBootRoutes, snBgp4NeighRouteMapNeighIp=snBgp4NeighRouteMapNeighIp, snBgp4GenDampening=snBgp4GenDampening, snBgp4NeighGenCfgUpdateSrcLpbIntf=snBgp4NeighGenCfgUpdateSrcLpbIntf, snBgp4NetworkTable=snBgp4NetworkTable, snBgp4GenMaxPaths=snBgp4GenMaxPaths, snBgp4NeighGenCfgRouteRefClient=snBgp4NeighGenCfgRouteRefClient, snBgp4RouteMapSetDampenReuse=snBgp4RouteMapSetDampenReuse, snBgp4NeighPrefixGroupTable=snBgp4NeighPrefixGroupTable, snBgp4GenMinNeighbors=snBgp4GenMinNeighbors, snBgp4NeighGenCfgRemoteAs=snBgp4NeighGenCfgRemoteAs, snBgp4NeighPrefixGroupDir=snBgp4NeighPrefixGroupDir, snBgp4CommunityFilterNoExport=snBgp4CommunityFilterNoExport, snBgp4GenDefaultMetric=snBgp4GenDefaultMetric, snBgp4RouteMapSetOrigin=snBgp4RouteMapSetOrigin, snBgp4CommunityFilterNoAdvertise=snBgp4CommunityFilterNoAdvertise, snBgp4CommunityFilter=snBgp4CommunityFilter, snBgp4NeighFilterGroupOutAsPathAccessList=snBgp4NeighFilterGroupOutAsPathAccessList, snBgp4NetworkIp=snBgp4NetworkIp, snBgp4RouteMapSetTable=snBgp4RouteMapSetTable, snBgp4AttributeNextHop=snBgp4AttributeNextHop, snBgp4GenRouterId=snBgp4GenRouterId, snBgp4NeighDistGroupEntry=snBgp4NeighDistGroupEntry, snBgp4GenOperRoutes=snBgp4GenOperRoutes, snBgp4NeighOperStatusNotifTxCounts=snBgp4NeighOperStatusNotifTxCounts, snBgp4NeighRouteMapEntry=snBgp4NeighRouteMapEntry, snBgp4RouteMapFilterRowStatus=snBgp4RouteMapFilterRowStatus, snBgp4NeighFilterGroupAccessList=snBgp4NeighFilterGroupAccessList, snBgp4NeighOperStatusBgpType=snBgp4NeighOperStatusBgpType, snBgp4RouteMapSetMapName=snBgp4RouteMapSetMapName, snBgp4AggregateAddrMask=snBgp4AggregateAddrMask, snBgp4ClearNeighborCmdElement=snBgp4ClearNeighborCmdElement, snBgp4GenTableMap=snBgp4GenTableMap, snBgp4GenMaxRouteMapFilters=snBgp4GenMaxRouteMapFilters, snBgp4AggregateAddrRowStatus=snBgp4AggregateAddrRowStatus, snBgp4RouteMapSetCommunityNum=snBgp4RouteMapSetCommunityNum, snBgp4NeighOperStatusHoldTime=snBgp4NeighOperStatusHoldTime, snBgp4GenConfedPeers=snBgp4GenConfedPeers, snBgp4NeighDistGroupOutPrefixList=snBgp4NeighDistGroupOutPrefixList, snBgp4AttributeAggregatorAs=snBgp4AttributeAggregatorAs, snBgp4AsPathFilterAction=snBgp4AsPathFilterAction, snBgp4RouteMapFilter=snBgp4RouteMapFilter, snBgp4GenMaxAggregateAddresses=snBgp4GenMaxAggregateAddresses, snBgp4RouteMapSetSequenceNum=snBgp4RouteMapSetSequenceNum, snBgp4GenMaxAddrFilters=snBgp4GenMaxAddrFilters, snBgp4RouteMapSetCommunityType=snBgp4RouteMapSetCommunityType, snBgp4RouteMapSetMetric=snBgp4RouteMapSetMetric, snBgp4NeighGenCfgSendComm=snBgp4NeighGenCfgSendComm, snBgp4NeighOperStatusAdvertlevel=snBgp4NeighOperStatusAdvertlevel, snBgp4LocalDistance=snBgp4LocalDistance, snBgp4RouteMapFilterMapName=snBgp4RouteMapFilterMapName, snBgp4RouteOperStatus=snBgp4RouteOperStatus, snBgp4CommunityFilterRowStatus=snBgp4CommunityFilterRowStatus, snBgp4NetworkRowStatus=snBgp4NetworkRowStatus, snBgp4RouteMapMatch=snBgp4RouteMapMatch, snBgp4GenMaxAsPathFilters=snBgp4GenMaxAsPathFilters, snBgp4NeighPrefixGroupNeighIp=snBgp4NeighPrefixGroupNeighIp, snBgp4RedisRowStatus=snBgp4RedisRowStatus, snBgp4GenAutoSummary=snBgp4GenAutoSummary, snBgp4InternalDistance=snBgp4InternalDistance, snBgp4NeighDistGroupInFilterList=snBgp4NeighDistGroupInFilterList, snBgp4RouteMapSetDampenMaxSuppress=snBgp4RouteMapSetDampenMaxSuppress, snBgp4GenDampenReuse=snBgp4GenDampenReuse, snBgp4AsPathFilterTable=snBgp4AsPathFilterTable, snBgp4RouteMapFilterAction=snBgp4RouteMapFilterAction, snBgp4RouteMapMatchMapName=snBgp4RouteMapMatchMapName, snBgp4NeighborSummaryState=snBgp4NeighborSummaryState, snBgp4AggregateAddrEntry=snBgp4AggregateAddrEntry, snBgp4RouteMapFilterEntry=snBgp4RouteMapFilterEntry, snBgp4RouteMapMatchMetric=snBgp4RouteMapMatchMetric, snBgp4RouteMapMatchAddressAccessList=snBgp4RouteMapMatchAddressAccessList, snBgp4RouteOperStatusMetric=snBgp4RouteOperStatusMetric, snBgp4AsPathFilterRegExpression=snBgp4AsPathFilterRegExpression, snBgp4NeighGenCfgEntry=snBgp4NeighGenCfgEntry, snBgp4NeighFilterGroupOutFilterList=snBgp4NeighFilterGroupOutFilterList, snBgp4NeighOperStatusState=snBgp4NeighOperStatusState, snBgp4AttributeLocalPreference=snBgp4AttributeLocalPreference, snBgp4NeighDistGroupAccessList=snBgp4NeighDistGroupAccessList, snBgp4NeighborSummaryIndex=snBgp4NeighborSummaryIndex, snBgp4ExternalDistance=snBgp4ExternalDistance, snBgp4NeighDistGroupTable=snBgp4NeighDistGroupTable, snBgp4RedisTable=snBgp4RedisTable, snBgp4NeighPrefixGroup=snBgp4NeighPrefixGroup, snBgp4GenMaxNetworks=snBgp4GenMaxNetworks, snBgp4RedisMetric=snBgp4RedisMetric, snBgp4NeighGenCfgDesc=snBgp4NeighGenCfgDesc, snBgp4RouteMapMatchAddressPrefixList=snBgp4RouteMapMatchAddressPrefixList, snBgp4NetworkEntry=snBgp4NetworkEntry, snBgp4NeighPrefixGroupRowStatus=snBgp4NeighPrefixGroupRowStatus, snBgp4RouteMapMatchRowMask=snBgp4RouteMapMatchRowMask, snBgp4RouteMapSetAutoTag=snBgp4RouteMapSetAutoTag, snBgp4AddrFilterSourceIp=snBgp4AddrFilterSourceIp, snBgp4NeighOperStatusUpdateTxCounts=snBgp4NeighOperStatusUpdateTxCounts, snBgp4Redis=snBgp4Redis, snBgp4NeighGenCfgShutdown=snBgp4NeighGenCfgShutdown, snBgp4RedisMatchExternal2=snBgp4RedisMatchExternal2, snBgp4ClientToClientReflection=snBgp4ClientToClientReflection)
mibBuilder.exportSymbols("FOUNDRY-SN-BGP4-GROUP-MIB", snBgp4NeighRouteMapTable=snBgp4NeighRouteMapTable, snBgp4GenMinRoutes=snBgp4GenMinRoutes, snBgp4NeighborSummaryIp=snBgp4NeighborSummaryIp, snBgp4GenDefaultLocalPreference=snBgp4GenDefaultLocalPreference, snBgp4GenAsPathInstalled=snBgp4GenAsPathInstalled, snBgp4GenMaxCommunityFilters=snBgp4GenMaxCommunityFilters, snBgp4RouteOperStatusRouteTag=snBgp4RouteOperStatusRouteTag, snBgp4NetworkWeight=snBgp4NetworkWeight, snBgp4NeighOperStatusKeepAliveTxCounts=snBgp4NeighOperStatusKeepAliveTxCounts, snBgp4AttributeMetric=snBgp4AttributeMetric, snBgp4NeighGenCfgTable=snBgp4NeighGenCfgTable, snBgp4NeighFilterGroupRowStatus=snBgp4NeighFilterGroupRowStatus, snBgp4RouteMapMatchAddressFilter=snBgp4RouteMapMatchAddressFilter, snBgp4RouteOperStatusCommunityList=snBgp4RouteOperStatusCommunityList, snBgp4NeighFilterGroupInAsPathAccessList=snBgp4NeighFilterGroupInAsPathAccessList, snBgp4AttributeRouterId=snBgp4AttributeRouterId, snBgp4NeighGenCfgDefOrigMap=snBgp4NeighGenCfgDefOrigMap, snBgp4NeighRouteMapMapName=snBgp4NeighRouteMapMapName, snBgp4RouteMapSetWeight=snBgp4RouteMapSetWeight, snBgp4RedisEntry=snBgp4RedisEntry, snBgp4RouteOperStatusStatus=snBgp4RouteOperStatusStatus, snBgp4ClearNeighborCmdEntry=snBgp4ClearNeighborCmdEntry, snBgp4Attribute=snBgp4Attribute, snBgp4RouteMapMatchAsPathFilter=snBgp4RouteMapMatchAsPathFilter, snBgp4NeighDistGroup=snBgp4NeighDistGroup, snBgp4Gen=snBgp4Gen)
