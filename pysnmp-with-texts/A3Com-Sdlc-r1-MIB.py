...
# Produced by pysmi-0.3.4 at Wed May  1 11:08:17 2019
...
NotificationType, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, iso, Counter64, enterprises, Integer32, Bits, NotificationType, ObjectIdentity, Unsigned32, IpAddress, Counter32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "iso", "Counter64", "enterprises", "Integer32", "Bits", "NotificationType", "ObjectIdentity", "Unsigned32", "IpAddress", "Counter32", "ModuleIdentity")
...
mibBuilder.exportSymbols("A3Com-Sdlc-r1-MIB", sdlcLSOperGPoll=sdlcLSOperGPoll, sdlcLSGroup=sdlcLSGroup, sdlcLSOperEntry=sdlcLSOperEntry, sdlcPortOperPAUSE=sdlcPortOperPAUSE, sdlcPortStatsTable=sdlcPortStatsTable, sdlcMapPollAddress=sdlcMapPollAddress, sdlcLSStatsXIDsOut=sdlcLSStatsXIDsOut, sdlcLSOperTable=sdlcLSOperTable, sdlcLSStatsRIMsOut=sdlcLSStatsRIMsOut, sdlcLSOperRETRIESn=sdlcLSOperRETRIESn, sdlcPortOperSlowPollTimer=sdlcPortOperSlowPollTimer, sdlcMapPortState=sdlcMapPortState, sdlcLSStatusChange=sdlcLSStatusChange, sdlcLSOperRETRIESm=sdlcLSOperRETRIESm, sdlcLSStatsOctetsOut=sdlcLSStatsOctetsOut, sdlcLSStatsRetransmits=sdlcLSStatsRetransmits, sdlcLSOperState=sdlcLSOperState, sdlcMapLocalSap=sdlcMapLocalSap, sdlcMapRemoteSap=sdlcMapRemoteSap, sdlcLSOperLastFailREPLYTOs=sdlcLSOperLastFailREPLYTOs, sdlcLSStatsEntry=sdlcLSStatsEntry, sdlcLSOperDATMODE=sdlcLSOperDATMODE, sdlcLSStatsProtocolErrs=sdlcLSStatsProtocolErrs, sdlcLSAdminGPoll=sdlcLSAdminGPoll, sdlcLSStatsSIMsIn=sdlcLSStatsSIMsIn, a3com=a3com, sdlcLSAdminRETRIESn=sdlcLSAdminRETRIESn, sdlcLSAdminRETRIESm=sdlcLSAdminRETRIESm, sdlcPortAdminName=sdlcPortAdminName, sdlcLSAdminName=sdlcLSAdminName, brouterMIB=brouterMIB, sdlcMapGroup=sdlcMapGroup, sdlcLSAdminMODULO=sdlcLSAdminMODULO, sdlcLSAdminMAXOUT=sdlcLSAdminMAXOUT, sdlcLSStatsTESTsOut=sdlcLSStatsTESTsOut, sdlcLSStatsLocalBusies=sdlcLSStatsLocalBusies, sdlcLSOperMAXIN=sdlcLSOperMAXIN, sdlcLSStatsFRMRsIn=sdlcLSStatsFRMRsIn, sdlcMapTable=sdlcMapTable, sdlcLSOperMODULO=sdlcLSOperMODULO, sdlcLSAdminEntry=sdlcLSAdminEntry, sdlcLSAdminDATMODE=sdlcLSAdminDATMODE, sdlcPortOperSlowPollMethod=sdlcPortOperSlowPollMethod, sdlcLSStatsBLUsOut=sdlcLSStatsBLUsOut, sdlcLSOperLastFailFRMRInfo=sdlcLSOperLastFailFRMRInfo, sdlcPortGroup=sdlcPortGroup, sdlcLSAddress=sdlcLSAddress, sdlcLSStatsRIMsIn=sdlcLSStatsRIMsIn, sdlcLSStatsIOctetsOut=sdlcLSStatsIOctetsOut, sdlcLSOperLastFailCause=sdlcLSOperLastFailCause, sdlcLSStatsTable=sdlcLSStatsTable, sdlcPortStatsInvalidAddresses=sdlcPortStatsInvalidAddresses, sdlcMapLSState=sdlcMapLSState, sdlcLSStatsRemoteBusies=sdlcLSStatsRemoteBusies, sdlcPortStatusChange=sdlcPortStatusChange, sdlcLSStatsRNRLIMITs=sdlcLSStatsRNRLIMITs, sdlcLSStatsSIMsOut=sdlcLSStatsSIMsOut, sdlcLSOperLastFailCtrlOut=sdlcLSOperLastFailCtrlOut, sdlcPortOperName=sdlcPortOperName, sdlcMapRemoteMacAddress=sdlcMapRemoteMacAddress, sdlcLSOperREPLYTO=sdlcLSOperREPLYTO, sdlcPortAdminTable=sdlcPortAdminTable, sdlcPortAdminRole=sdlcPortAdminRole, sdlcPortAdminPAUSE=sdlcPortAdminPAUSE, sdlcPortStatsEntry=sdlcPortStatsEntry, sdlcLSStatsTESTsIn=sdlcLSStatsTESTsIn, sdlcPortOperACTIVTO=sdlcPortOperACTIVTO, sdlcPortOperType=sdlcPortOperType, sdlcLSOperLastFailTime=sdlcLSOperLastFailTime, sdlcLSOperRETRIESt=sdlcLSOperRETRIESt, sdlcMapLocalMacAddress=sdlcMapLocalMacAddress, sdlcLSAdminSimRim=sdlcLSAdminSimRim, sdlcLSStatsActivityTOs=sdlcLSStatsActivityTOs, sdlc=sdlc, sdlcLSStatsPollsOut=sdlcLSStatsPollsOut, sdlcLSStatsXIDsIn=sdlcLSStatsXIDsIn, sdlcLSStatsIFramesIn=sdlcLSStatsIFramesIn, sdlcLSStatsOctetsIn=sdlcLSStatsOctetsIn, sdlcLSOperRole=sdlcLSOperRole, sdlcLSAdminMAXIN=sdlcLSAdminMAXIN, sdlcLSAdminState=sdlcLSAdminState, sdlcPortAdminTopology=sdlcPortAdminTopology, MacAddress=MacAddress, sdlcPortAdminType=sdlcPortAdminType, sdlcLSAdminRNRLIMIT=sdlcLSAdminRNRLIMIT, sdlcLSAdminRETRIESt=sdlcLSAdminRETRIESt, sdlcPortAdminEntry=sdlcPortAdminEntry, sdlcPortStatsPhysicalFailures=sdlcPortStatsPhysicalFailures, sdlcPortAdminACTIVTO=sdlcPortAdminACTIVTO, sdlcPortOperTable=sdlcPortOperTable, sdlcMapName=sdlcMapName, sdlcLSOperRNRLIMIT=sdlcLSOperRNRLIMIT, sdlcLSStatsFRMRsOut=sdlcLSStatsFRMRsOut, sdlcMapEntry=sdlcMapEntry, sdlcLSStatsREJsIn=sdlcLSStatsREJsIn, sdlcLSOperSimRim=sdlcLSOperSimRim, sdlcLSStatsIOctetsIn=sdlcLSStatsIOctetsIn, sdlcLSStatsRetriesExps=sdlcLSStatsRetriesExps, sdlcLSOperMAXOUT=sdlcLSOperMAXOUT, sdlcLSAdminMAXDATA=sdlcLSAdminMAXDATA, sdlcLSOperMAXDATA=sdlcLSOperMAXDATA, sdlcLSOperLastFailCtrlIn=sdlcLSOperLastFailCtrlIn, sdlcPortOperRole=sdlcPortOperRole, sdlcPortOperLastFailTime=sdlcPortOperLastFailTime, sdlcLSStatsREJsOut=sdlcLSStatsREJsOut, sdlcLSStatsIFramesOut=sdlcLSStatsIFramesOut, pysmiFakeCol1000=pysmiFakeCol1000, sdlcLSAdminREPLYTO=sdlcLSAdminREPLYTO, sdlcLSStatsPollRspsOut=sdlcLSStatsPollRspsOut, sdlcLSStatsBLUsIn=sdlcLSStatsBLUsIn, sdlcPortOperLastFailCause=sdlcPortOperLastFailCause, sdlcLSStatsUIFramesOut=sdlcLSStatsUIFramesOut, sdlcPortStatsDwarfFrames=sdlcPortStatsDwarfFrames, sdlcPortOperTopology=sdlcPortOperTopology, sdlcLSAdminTable=sdlcLSAdminTable, sdlcLSOperName=sdlcLSOperName, sdlcLSStatsUIFramesIn=sdlcLSStatsUIFramesIn, sdlcPortOperEntry=sdlcPortOperEntry, sdlcPortAdminSlowPollTimer=sdlcPortAdminSlowPollTimer)
