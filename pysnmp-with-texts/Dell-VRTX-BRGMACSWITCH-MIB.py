...
# Produced by pysmi-0.3.4 at Wed May  1 12:57:08 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, ModuleIdentity, Counter64, Unsigned32, TimeTicks, Gauge32, NotificationType, Bits, Counter32, ObjectIdentity, MibIdentifier, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "ModuleIdentity", "Counter64", "Unsigned32", "TimeTicks", "Gauge32", "NotificationType", "Bits", "Counter32", "ObjectIdentity", "MibIdentifier", "IpAddress", "iso")
...
mibBuilder.exportSymbols("Dell-VRTX-BRGMACSWITCH-MIB", rlBrgMacSwRedBoundary=rlBrgMacSwRedBoundary, rlBrgMacSwitch=rlBrgMacSwitch, rlBrgMacSwDynamicTables=rlBrgMacSwDynamicTables, rlBrgMacSwOldEntryDeleteMode=rlBrgMacSwOldEntryDeleteMode, rlBrgMacSwMaxTableNumber=rlBrgMacSwMaxTableNumber, rlBrgMacSwVersion=rlBrgMacSwVersion, rlBrgMacSwOperTrapCount=rlBrgMacSwOperTrapCount, rlBrgMacSwAdminTrapFrequency=rlBrgMacSwAdminTrapFrequency, rlBrgMacSwKeyType=rlBrgMacSwKeyType, rlBrgMacSwTrapEnable=rlBrgMacSwTrapEnable, PYSNMP_MODULE_ID=rlBrgMacSwitch, rlBrgMacSwYellowBoundary=rlBrgMacSwYellowBoundary, rlBrgMacSwSpanningTree=rlBrgMacSwSpanningTree)
