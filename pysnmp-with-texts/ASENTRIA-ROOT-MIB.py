...
# Produced by pysmi-0.3.4 at Wed May  1 11:29:21 2019
...
Bits, ModuleIdentity, NotificationType, Integer32, Unsigned32, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, TimeTicks, ObjectIdentity, enterprises, IpAddress, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "NotificationType", "Integer32", "Unsigned32", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "TimeTicks", "ObjectIdentity", "enterprises", "IpAddress", "MibIdentifier")
...
if mibBuilder.loadTexts: asentria.setContactInfo('Phone: 206-344-8800 Fax: 206-344-2116 Email: support@asentria.com')
