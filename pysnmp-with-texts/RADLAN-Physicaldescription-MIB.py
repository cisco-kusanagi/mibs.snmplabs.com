...
if mibBuilder.loadTexts: rlCascadeAdminIndexList.setDescription('Indicates the stack ports indexes list. A set of indexes that are identified by a bit-map, in which each index is represented as a bit.')
...
if mibBuilder.loadTexts: rlPhdUnitStackPortTable.setDescription('The table listing information required for stack port. The index for the table is ifindex; the ports that represented in that table are operational stack ports or ports that can be stack ports after reset')
...
if mibBuilder.loadTexts: rlPhdUnitStackPortConnectionType.setDescription('Operational connection type (copper(1), combo-copper(2), combo-fiber(3), fiber(4), direct-Attached(5))')
...
if mibBuilder.loadTexts: rlPhdUnitStackPortRow.setDescription('On which row (the uppermost being numbered 1 and the highest row number assigned to the lowest row) this actual/candidate cascade port resides within the chassis of its stack unit.')
...
if mibBuilder.loadTexts: rlPhdUnitStackPortColumn.setDescription('On which column (the leftmost being numbered 1 and the highest column number assigned to the rightmost column) this actual/candidate cascade port resides within the chassis of its stack unit.')
mibBuilder.exportSymbols("RADLAN-Physicaldescription-MIB", rlStackUnitDifferentSwVersion=rlStackUnitDifferentSwVersion, rlStackUnitRemoved=rlStackUnitRemoved, rlPhdStackOrderDesiredUnitPosition=rlPhdStackOrderDesiredUnitPosition, rlPhdUnitEnvParamFan1Status=rlPhdUnitEnvParamFan1Status, rlPhdPortsColumn=rlPhdPortsColumn, rlPhdPhyLedTimeout=rlPhdPhyLedTimeout, rlPhdStackEntry=rlPhdStackEntry, rlPhdNumberOfPoeUnits=rlPhdNumberOfPoeUnits, rlPhdModuleIndex=rlPhdModuleIndex, rlCascadeAdminUnitId=rlCascadeAdminUnitId, rlPhdPoeEntry=rlPhdPoeEntry, rlPhdModuleHotSwapEntry=rlPhdModuleHotSwapEntry, rlPhdUnitGenParamMd5ChksumBoot=rlPhdUnitGenParamMd5ChksumBoot, rlPhdPortHaul=rlPhdPortHaul, rlPhdStackFixedUnit=rlPhdStackFixedUnit, rlPhdUnitEnvParamTempSensorStatus=rlPhdUnitEnvParamTempSensorStatus, rlCascadeNeighborUnit=rlCascadeNeighborUnit, rlCascadePortSpeed=rlCascadePortSpeed, rlStackBackupUnitRemoved=rlStackBackupUnitRemoved, rlPhdUnitGenParamServiceTag=rlPhdUnitGenParamServiceTag, rlPhdUnitGenParamAssetTag=rlPhdUnitGenParamAssetTag, rlPhdMaxNumberOfUnits=rlPhdMaxNumberOfUnits, rlPhdModuleColumn=rlPhdModuleColumn, rlPhdUnitGenParamStackUnit=rlPhdUnitGenParamStackUnit, rlPhdUnitGenParamRegistrationSuppressed=rlPhdUnitGenParamRegistrationSuppressed, rlPhdUnitGenParamTable=rlPhdUnitGenParamTable, rlPhdPhyLedStackUnit=rlPhdPhyLedStackUnit, rlPhdModuleTable=rlPhdModuleTable, rlPhdUnitEnvParamFan6Status=rlPhdUnitEnvParamFan6Status, rlStackDuplicateUnitNotJoin=rlStackDuplicateUnitNotJoin, rlPhdUnitGenParamManufacturer=rlPhdUnitGenParamManufacturer, rlPhdModuleEntry=rlPhdModuleEntry, rlPhdModuleHotSwapTable=rlPhdModuleHotSwapTable, rlCascadeAdminTable=rlCascadeAdminTable, rlPhdModuleRole=rlPhdModuleRole, rlPhdPoeTable=rlPhdPoeTable, rlPhdUnitStackPortConnectionType=rlPhdUnitStackPortConnectionType, rlPhdUnitGenParamSerialNum=rlPhdUnitGenParamSerialNum, rlPhdStackOrderCurrentUnitPosition=rlPhdStackOrderCurrentUnitPosition, rlCascadeTable=rlCascadeTable, rlPhdModuleHotSwapOperStatus=rlPhdModuleHotSwapOperStatus, rlCascadeUnitId=rlCascadeUnitId, rlPhdStackOrderPermutation=rlPhdStackOrderPermutation, ConnectionType=ConnectionType, rlPhdModuleRow=rlPhdModuleRow, StackPortType=StackPortType, rlPhdStackOrderEntry=rlPhdStackOrderEntry, rlPhdPortsIfIndexName=rlPhdPortsIfIndexName, rlPhdStackProductID=rlPhdStackProductID, CascadePortState=CascadePortState, rlPhdUnitEnvParamUpTime=rlPhdUnitEnvParamUpTime, rlPhdUnitEnvParamRedundantPSStatus=rlPhdUnitEnvParamRedundantPSStatus, rlPhdStackFixedUnitLocation=rlPhdStackFixedUnitLocation, rlPhdUnitStackPortName=rlPhdUnitStackPortName, PYSNMP_MODULE_ID=rlPhysicalDescription, rlCascadeTrunkId=rlCascadeTrunkId, rlPhdUnitGenParamMd5ChksumImage2=rlPhdUnitGenParamMd5ChksumImage2, rlPhdUnitEnvParamMonitorOperStatus=rlPhdUnitEnvParamMonitorOperStatus, rlCascadeAdminIndexList=rlCascadeAdminIndexList, rlPhdUnitGenParamHardwareVersion=rlPhdUnitGenParamHardwareVersion, rlCascadePortState=rlCascadePortState, rlPhdUnitStackPortType=rlPhdUnitStackPortType, CascadePortSpeed=CascadePortSpeed, rlPhdUnitGenParamEntry=rlPhdUnitGenParamEntry, rlPhdModuleStartingPort=rlPhdModuleStartingPort, rlPhdStackConnect1=rlPhdStackConnect1, rlPhdUnitStackPortColumn=rlPhdUnitStackPortColumn, rlPhdStackOrderBottomUnit=rlPhdStackOrderBottomUnit, rlPhdUnitEnvParamTable=rlPhdUnitEnvParamTable, rlPhdPortsModuleNumber=rlPhdPortsModuleNumber, rlPhdUnitGenParamFirmwareVersion=rlPhdUnitGenParamFirmwareVersion, rlPhdUnitEnvParamMainPSStatus=rlPhdUnitEnvParamMainPSStatus, rlPhdUnitEnvParamFan5Status=rlPhdUnitEnvParamFan5Status, rlCascadeAdminSpeed=rlCascadeAdminSpeed, rlPhdUnitEnvParamTempSensorCriticalThresholdValue=rlPhdUnitEnvParamTempSensorCriticalThresholdValue, rlPhdStackMacAddr=rlPhdStackMacAddr, rlPhdUnitGenParamFirmwareDate=rlPhdUnitGenParamFirmwareDate, rlPhdStackConnect2=rlPhdStackConnect2, rlPhdModuleType=rlPhdModuleType, rlPhdUnitEnvParamFan2Status=rlPhdUnitEnvParamFan2Status, rlPhdUnitStackPortTable=rlPhdUnitStackPortTable, rlPhdStackOrderUnitType=rlPhdStackOrderUnitType, rlPhdUnitEnvParamTempSensorValue=rlPhdUnitEnvParamTempSensorValue, rlCascadeEntry=rlCascadeEntry, rlPhdStackSofrwareVer=rlPhdStackSofrwareVer, rlPhdUnitGenParamSoftwareVersion=rlPhdUnitGenParamSoftwareVersion, rlPhdUnitEnvParamMonitorTemperatureStatus=rlPhdUnitEnvParamMonitorTemperatureStatus, rlPhdPoeStackUnit=rlPhdPoeStackUnit, rlPhdModuleNumberOfPorts=rlPhdModuleNumberOfPorts, rlPhdStackReorder=rlPhdStackReorder, rlPhdModuleStackUnit=rlPhdModuleStackUnit, rlPhdPortsEntry=rlPhdPortsEntry, rlPhdMibVersion=rlPhdMibVersion, rlPhdNumberOfUnits=rlPhdNumberOfUnits, rlPhdConnectorType=rlPhdConnectorType, rlPhdUnitEnvParamFan3Status=rlPhdUnitEnvParamFan3Status, rlPhdPortsRow=rlPhdPortsRow, rlPhdUnitGenParamModelName=rlPhdUnitGenParamModelName, rlPhdPortsIfIndex=rlPhdPortsIfIndex, rlPhdUnitGenParamMd5ChksumImage1=rlPhdUnitGenParamMd5ChksumImage1, rlStackLinkChange=rlStackLinkChange, rlPhdUnitEnvParamStackUnit=rlPhdUnitEnvParamStackUnit, rlPhdPortsTable=rlPhdPortsTable, rlPhdPortsStackUnit=rlPhdPortsStackUnit, rlPhdStackType=rlPhdStackType, rlPhdForceMasterUnit=rlPhdForceMasterUnit, rlPhdUnitGenParamRegistrationDone=rlPhdUnitGenParamRegistrationDone, rlPhdUnitStackPortEntry=rlPhdUnitStackPortEntry, rlStackMasterSwitchover=rlStackMasterSwitchover, rlCascadeNeighborIfIndex=rlCascadeNeighborIfIndex, rlPhysicalDescription=rlPhysicalDescription, rlPhdModuleHotSwapAdminStatus=rlPhdModuleHotSwapAdminStatus, rlPhdUnitEnvParamMonitorAutoRecoveryEnable=rlPhdUnitEnvParamMonitorAutoRecoveryEnable, rlPhdUnitEnvParamTempSensorWarningThresholdValue=rlPhdUnitEnvParamTempSensorWarningThresholdValue, rlCascadeAdminEntry=rlCascadeAdminEntry, rlPhdStackTable=rlPhdStackTable, rlPhdStackOrderUnitIndex=rlPhdStackOrderUnitIndex, rlPhdPortsMediaType=rlPhdPortsMediaType, rlPhdStackOrderTable=rlPhdStackOrderTable, rlPhdPoePresent=rlPhdPoePresent, rlPhdStackUnit=rlPhdStackUnit, rlStackConfigChangedRingChain=rlStackConfigChangedRingChain, rlPhdStackOrderTopUnit=rlPhdStackOrderTopUnit, rlPhdUnitEnvParamEntry=rlPhdUnitEnvParamEntry, rlPhdStackReloadUnit=rlPhdStackReloadUnit, rlPhdUnitGenParamSoftwareDate=rlPhdUnitGenParamSoftwareDate, rlPhdUnitStackPortRow=rlPhdUnitStackPortRow, rlPhdUnitEnvParamFan4Status=rlPhdUnitEnvParamFan4Status)
