...
# Produced by pysmi-0.3.4 at Wed May  1 13:54:52 2019
...
Bits, Counter64, iso, NotificationType, Gauge32, ObjectIdentity, ModuleIdentity, MibIdentifier, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter32, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "iso", "NotificationType", "Gauge32", "ObjectIdentity", "ModuleIdentity", "MibIdentifier", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter32", "TimeTicks", "Unsigned32")
...
mibBuilder.exportSymbols("INTEL-X25EXT-MIB", x25extCircuit=x25extCircuit, x25extCircuitOutFlowStuckResets=x25extCircuitOutFlowStuckResets, IfIndexType=IfIndexType, x25extCircuitLogicalIndex=x25extCircuitLogicalIndex, x25extCircuitOutResets=x25extCircuitOutResets, x25extCircuitTimeout=x25extCircuitTimeout, x25extCircuitWindowSize=x25extCircuitWindowSize, x25extCircuitIndex=x25extCircuitIndex, x25extCircuitPacketSize=x25extCircuitPacketSize, x25ext=x25ext, x25extCircuitEntry=x25extCircuitEntry, x25extCircuitChannel=x25extCircuitChannel, x25extCircuitTable=x25extCircuitTable)
