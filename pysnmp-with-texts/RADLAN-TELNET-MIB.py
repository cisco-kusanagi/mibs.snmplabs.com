...
# Produced by pysmi-0.3.4 at Wed May  1 14:49:51 2019
...
Integer32, iso, TimeTicks, Bits, Unsigned32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, ModuleIdentity, IpAddress, Gauge32, MibIdentifier, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "iso", "TimeTicks", "Bits", "Unsigned32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "ModuleIdentity", "IpAddress", "Gauge32", "MibIdentifier", "Counter64", "Counter32")
...
if mibBuilder.loadTexts: rlTelnet.setContactInfo('www.marvell.com')
...
mibBuilder.exportSymbols("RADLAN-TELNET-MIB", rlTelnetUsersTable=rlTelnetUsersTable, rlTelnetSessionId=rlTelnetSessionId, rlTelnetSessionLoginTime=rlTelnetSessionLoginTime, rlTelnetSecondLoginBanner=rlTelnetSecondLoginBanner, rlTelnetPassword=rlTelnetPassword, rlTelnetSessionStatus=rlTelnetSessionStatus, rlTelnetUsersEntry=rlTelnetUsersEntry, rlTelnetSessionClientAddressType=rlTelnetSessionClientAddressType, rlTelnetSessionClientAddress=rlTelnetSessionClientAddress, rlTelnetMibVersion=rlTelnetMibVersion, PYSNMP_MODULE_ID=rlTelnet, rlTelnet=rlTelnet, rlTelnetLoginBanner=rlTelnetLoginBanner, rlTelnetTimeout=rlTelnetTimeout, rlTelnetEnable=rlTelnetEnable)
