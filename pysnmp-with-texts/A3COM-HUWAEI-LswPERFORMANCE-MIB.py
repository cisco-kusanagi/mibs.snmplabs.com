...
# Produced by pysmi-0.3.4 at Wed May  1 11:08:00 2019
...
Counter64, Unsigned32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Bits, TimeTicks, Gauge32, iso, Integer32, Counter32, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Unsigned32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Bits", "TimeTicks", "Gauge32", "iso", "Integer32", "Counter32", "NotificationType", "ObjectIdentity")
...
mibBuilder.exportSymbols("A3COM-HUWAEI-LswPERFORMANCE-MIB", performance=performance, pririsingAlarm=pririsingAlarm, hwTrapDestVersion=hwTrapDestVersion, hwrmonEnableTableEntry=hwrmonEnableTableEntry, prialarmRisingEventIndex=prialarmRisingEventIndex, prialarmStatType=prialarmStatType, hwTrapDestEntry=hwTrapDestEntry, hwTrapDestTable=hwTrapDestTable, prialarmInterval=prialarmInterval, prialarmVariable=prialarmVariable, prialarmTable=prialarmTable, prifallingAlarm=prifallingAlarm, prialarmSympol=prialarmSympol, hwrmonEnableStatus=hwrmonEnableStatus, prialarmStartupAlarm=prialarmStartupAlarm, prialarmOwner=prialarmOwner, prialarmEntry=prialarmEntry, prialarmRisingThreshold=prialarmRisingThreshold, prialarmFallingThreshold=prialarmFallingThreshold, PYSNMP_MODULE_ID=performance, prialarmIndex=prialarmIndex, hwrmonEnableTable=hwrmonEnableTable, hwrmonEnableIfIndex=hwrmonEnableIfIndex, prialarmFallingEventIndex=prialarmFallingEventIndex, rmonExtendEventsV2=rmonExtendEventsV2, prialarmSampleType=prialarmSampleType, prialarmStatCycle=prialarmStatCycle, prialarmStatus=prialarmStatus, prialarmValue=prialarmValue)
