...
# Produced by pysmi-0.3.4 at Wed May  1 12:45:01 2019
...
Counter64, ModuleIdentity, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, Integer32, iso, Bits, ObjectIdentity, Unsigned32, Counter32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "ModuleIdentity", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "Integer32", "iso", "Bits", "ObjectIdentity", "Unsigned32", "Counter32", "TimeTicks", "NotificationType")
TruthValue, DisplayString, TextualConvention, PhysAddress, MacAddress, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "DisplayString", "TextualConvention", "PhysAddress", "MacAddress", "RowStatus", "TimeStamp")
...
mibBuilder.exportSymbols("DGS-3700-12G-L3MGMT-MIB", swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, VrId=VrId, Ipv6Address=Ipv6Address, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3IpCtrlTable=swL3IpCtrlTable, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3IpCtrlState=swL3IpCtrlState, swL3IpMgmt=swL3IpMgmt, swL3IpCtrlAdminState=swL3IpCtrlAdminState, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3IpCtrlMode=swL3IpCtrlMode, swL3MgmtMIB=swL3MgmtMIB, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, NetAddress=NetAddress, swL3Ipv6Address=swL3Ipv6Address, NodeAddress=NodeAddress)
