...
MibIdentifier, Bits, Integer32, Counter32, iso, TimeTicks, IpAddress, ModuleIdentity, Unsigned32, NotificationType, ObjectIdentity, snmpModules, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Integer32", "Counter32", "iso", "TimeTicks", "IpAddress", "ModuleIdentity", "Unsigned32", "NotificationType", "ObjectIdentity", "snmpModules", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Gauge32")
...
mibBuilder.exportSymbols("SNMP-COMMUNITY-MIB", snmpTargetAddrExtEntry=snmpTargetAddrExtEntry, snmpCommunityContextEngineID=snmpCommunityContextEngineID, snmpCommunityStorageType=snmpCommunityStorageType, snmpCommunityStatus=snmpCommunityStatus, snmpTargetAddrMMS=snmpTargetAddrMMS, snmpProxyTrapForwardCompliance=snmpProxyTrapForwardCompliance, snmpProxyTrapForwardGroup=snmpProxyTrapForwardGroup, snmpCommunityTable=snmpCommunityTable, snmpCommunityMIBConformance=snmpCommunityMIBConformance, snmpTargetAddrTMask=snmpTargetAddrTMask, snmpCommunityMIBCompliances=snmpCommunityMIBCompliances, snmpCommunityMIB=snmpCommunityMIB, snmpCommunityTableGroup=snmpCommunityTableGroup, snmpCommunityContextName=snmpCommunityContextName, snmpTrapAddress=snmpTrapAddress, PYSNMP_MODULE_ID=snmpCommunityMIB, snmpCommunityMIBFullCompliance=snmpCommunityMIBFullCompliance, snmpTargetAddrExtTable=snmpTargetAddrExtTable, snmpCommunityIndex=snmpCommunityIndex, snmpCommunityMIBCompliance=snmpCommunityMIBCompliance, snmpCommunityTransportTag=snmpCommunityTransportTag, snmpCommunityMIBObjects=snmpCommunityMIBObjects, snmpCommunityEntry=snmpCommunityEntry, snmpCommunityMIBGroups=snmpCommunityMIBGroups, snmpCommunitySecurityName=snmpCommunitySecurityName, snmpCommunityName=snmpCommunityName, snmpTrapCommunity=snmpTrapCommunity)
