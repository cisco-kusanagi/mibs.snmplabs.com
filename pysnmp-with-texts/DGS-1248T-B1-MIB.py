...
# Produced by pysmi-0.3.4 at Wed May  1 12:43:31 2019
...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, ModuleIdentity, MibIdentifier, iso, ObjectIdentity, Unsigned32, enterprises, Bits, Counter64, Gauge32, IpAddress, mib_2, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "ModuleIdentity", "MibIdentifier", "iso", "ObjectIdentity", "Unsigned32", "enterprises", "Bits", "Counter64", "Gauge32", "IpAddress", "mib-2", "TimeTicks")
...
mibBuilder.exportSymbols("DGS-1248T-B1-MIB", tvlanStatus=tvlanStatus, portTrunkName=portTrunkName, commTrapSNMPFiberLinkUpDown=commTrapSNMPFiberLinkUpDown, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, igsVlanMcastFwdPortListMac=igsVlanMcastFwdPortListMac, miscStatisticsReset=miscStatisticsReset, commTrapTrapAbnormalFiberRXError=commTrapTrapAbnormalFiberRXError, configPortTable=configPortTable, dot1xAuthServerTimeout=dot1xAuthServerTimeout, swFiberAbnormalTXError=swFiberAbnormalTXError, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, portTrunkEntry=portTrunkEntry, PortList=PortList, commTrapIndex=commTrapIndex, commTrapEntry=commTrapEntry, configMirrorTXSrc=configMirrorTXSrc, commSetStatus=commSetStatus, configPortSpeed=configPortSpeed, dgs_1248tb1=dgs_1248tb1, igsSharedSegmentAggregationInterval=igsSharedSegmentAggregationInterval, igsQueryMaxResponseTime=igsQueryMaxResponseTime, commSetTable=commSetTable, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, configMirrorRXSrc=configMirrorRXSrc, tvlanTable=tvlanTable, configPortFlowControlOper=configPortFlowControlOper, igsVlanRouterPortListEntry=igsVlanRouterPortListEntry, commSetIndex=commSetIndex, igsMcastEntryAgeingInterval=igsMcastEntryAgeingInterval, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, configSave=configSave, companyIgsGroup=companyIgsGroup, OwnerString=OwnerString, tvlanUntaggedPorts=tvlanUntaggedPorts, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, igsLastMembQueryInterval=igsLastMembQueryInterval, configPortPriority=configPortPriority, radius=radius, configVerSwPrimary=configVerSwPrimary, radiusServerSharedSecret=radiusServerSharedSecret, configGateway=configGateway, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, dot1xAuthMaxReq=dot1xAuthMaxReq, commTrapTrapAbnormalTPTXError=commTrapTrapAbnormalTPTXError, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, portTrunkMember=portTrunkMember, igsNextMcastFwdMode=igsNextMcastFwdMode, configMirrorTable=configMirrorTable, tvlanId=tvlanId, igsRobustnessValue=igsRobustnessValue, dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, commTrapSNMPTPLinkUpDown=commTrapSNMPTPLinkUpDown, swFiberInsert=swFiberInsert, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, companyPortTrunkGroup=companyPortTrunkGroup, configMirrorMon=configMirrorMon, igsHostPortPurgeInterval=igsHostPortPurgeInterval, commTrapSNMPBootup=commTrapSNMPBootup, portTrunkTable=portTrunkTable, tvlanMember=tvlanMember, miscReset=miscReset, portTrunkId=portTrunkId, configVLANMode=configVLANMode, dot1xAuthSystemControl=dot1xAuthSystemControl, igsVlanId=igsVlanId, commGetTable=commGetTable, RowStatus=RowStatus, igsQueryInterval=igsQueryInterval, staticTable=staticTable, companyDot1xGroup=companyDot1xGroup, commTrapTrapAbnormalFiberTXError=commTrapTrapAbnormalFiberTXError, configIpAssignmentMode=configIpAssignmentMode, igsVlanMcastFwdEntry=igsVlanMcastFwdEntry, igsVlanRouterPortListTable=igsVlanRouterPortListTable, igsv3Processing=igsv3Processing, tvlanEntry=tvlanEntry, configMirrorId=configMirrorId, companyCommGroup=companyCommGroup, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, igsLeaveProcessInterval=igsLeaveProcessInterval, staticOnOff=staticOnOff, igsVlanFilterTable=igsVlanFilterTable, dot1xAuthTxPeriod=dot1xAuthTxPeriod, igsStatus=igsStatus, swTPAbnormalTXError=swTPAbnormalTXError, staticPort=staticPort, igsGblReportFwdOnAllPorts=igsGblReportFwdOnAllPorts, commGetName=commGetName, commTrapName=commTrapName, commSetName=commSetName, configRestoreDefaults=configRestoreDefaults, igsSystem=igsSystem, configSNMPEnable=configSNMPEnable, tvlanName=tvlanName, igsVlanFilterEntry=igsVlanFilterEntry, spanOnOff=spanOnOff, configPortFlowControl=configPortFlowControl, staticEntry=staticEntry, radiusServerAddress=radiusServerAddress, swFiberRemove=swFiberRemove, igsVlanMcastFwdVlanIdMac=igsVlanMcastFwdVlanIdMac, commGetEntry=commGetEntry, staticAutoLearning=staticAutoLearning, configPort=configPort, commTrapIpAddress=commTrapIpAddress, configPortOperStatus=configPortOperStatus, MacAddress=MacAddress, companyConfigGroup=companyConfigGroup, dot1xAuth=dot1xAuth, swTPAbnormalRXError=swTPAbnormalRXError, radiusServerPort=radiusServerPort, igsVlanFilterStatus=igsVlanFilterStatus, commGetIndex=commGetIndex, companyTVlanGroup=companyTVlanGroup, configMirrorEntry=configMirrorEntry, commTrapTrapAbnormalTPRXError=commTrapTrapAbnormalTPRXError, swFiberAbnormalRXError=swFiberAbnormalRXError, dlink_DGS12XXTSeriesProd=dlink_DGS12XXTSeriesProd, igsVlanRouterPortListVlanId=igsVlanRouterPortListVlanId, commTrapTable=commTrapTable, configMirrorStatus=configMirrorStatus, staticId=staticId, commGetStatus=commGetStatus, dlink_products=dlink_products, staticVlanID=staticVlanID, igsVlanMcastFwdTable=igsVlanMcastFwdTable, commTrapStatus=commTrapStatus, configVerHwChipSet=configVerHwChipSet, igsVlan=igsVlan, companyStaticGroup=companyStaticGroup, configPasswordAdmin=configPasswordAdmin, configNetMask=configNetMask, configPortEntry=configPortEntry, configIpAddress=configIpAddress, staticMac=staticMac, companyMiscGroup=companyMiscGroup, igsVlanMcastFwdGroupAddress=igsVlanMcastFwdGroupAddress, igsReportForwardInterval=igsReportForwardInterval, companySpanGroup=companySpanGroup, configPhysAddress=configPhysAddress, commSetEntry=commSetEntry, staticStatus=staticStatus, d_link=d_link, igsVlanRouterPortList=igsVlanRouterPortList)
