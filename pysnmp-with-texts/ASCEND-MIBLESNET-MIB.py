...
# Produced by pysmi-0.3.4 at Wed May  1 11:27:42 2019
...
if mibBuilder.loadTexts: miblesNetworkProfileTable.setDescription('A list of miblesNetworkProfile profile entries.')
...
if mibBuilder.loadTexts: miblesNetworkProfileEntry.setDescription('A miblesNetworkProfile entry containing objects that maps to the parameters of miblesNetworkProfile profile.')
...
if mibBuilder.loadTexts: lesNetworkProfile_Shelf_o.setDescription('')
...
if mibBuilder.loadTexts: lesNetworkProfile_Slot_o.setDescription('')
...
if mibBuilder.loadTexts: lesNetworkProfile_Item_o.setDescription('')
...
if mibBuilder.loadTexts: lesNetworkProfile_PhysicalAddress_Shelf.setDescription('The number of the shelf that the addressed physical device resides on.')
...
if mibBuilder.loadTexts: lesNetworkProfile_PhysicalAddress_Slot.setDescription('The number of the slot that the addressed physical device resides on.')
...
if mibBuilder.loadTexts: lesNetworkProfile_PhysicalAddress_ItemNumber.setDescription('A number that specifies an addressable entity within the context of shelf and slot.')
...
if mibBuilder.loadTexts: lesNetworkProfile_Enabled.setDescription('TRUE if Loop Emulation Services are enabled, otherwise FALSE.')
...
if mibBuilder.loadTexts: lesNetworkProfile_NailedGroup.setDescription('A number that identifies the set of lines that makes up a nailed group. 0 means this line is not part of a nailed group.')
...
if mibBuilder.loadTexts: lesNetworkProfile_Action_o.setDescription('')
...
if mibBuilder.loadTexts: miblesNetworkProfile_PotsLineConfigTable.setDescription('A list of miblesNetworkProfile__pots_line_config profile entries.')
...
if mibBuilder.loadTexts: miblesNetworkProfile_PotsLineConfigEntry.setDescription('A miblesNetworkProfile__pots_line_config entry containing objects that maps to the parameters of miblesNetworkProfile__pots_line_config profile.')
...
if mibBuilder.loadTexts: lesNetworkProfile_PotsLineConfig_Shelf_o.setDescription('')
...
if mibBuilder.loadTexts: lesNetworkProfile_PotsLineConfig_Slot_o.setDescription('')
...
if mibBuilder.loadTexts: lesNetworkProfile_PotsLineConfig_Item_o.setDescription('')
...
if mibBuilder.loadTexts: lesNetworkProfile_PotsLineConfig_Index_o.setDescription('')
...
if mibBuilder.loadTexts: lesNetworkProfile_PotsLineConfig_Enabled.setDescription('TRUE if this loop is enabled, otherwise FALSE.')
...
if mibBuilder.loadTexts: lesNetworkProfile_PotsLineConfig_Mode.setDescription("POT's loop mode.")
...
if mibBuilder.loadTexts: lesNetworkProfile_PotsLineConfig_EncodingFormatProfile.setDescription('ITU-T standardized Encoding Format Profiles. From Annex B through H of I.366.2.')
...
if mibBuilder.loadTexts: lesNetworkProfile_PotsLineConfig_FwdDisc.setDescription('TRUE if Forward Disconnect feature is enabled, otherwise FALSE.')
...
if mibBuilder.loadTexts: lesNetworkProfile_PotsLineConfig_OverRideCid.setDescription("Override default allocation of CID's when ELCP is not used.")
mibBuilder.exportSymbols("ASCEND-MIBLESNET-MIB", lesNetworkProfile_PotsLineConfig_Slot_o=lesNetworkProfile_PotsLineConfig_Slot_o, lesNetworkProfile_PotsLineConfig_Item_o=lesNetworkProfile_PotsLineConfig_Item_o, lesNetworkProfile_NailedGroup=lesNetworkProfile_NailedGroup, lesNetworkProfile_PotsLineConfig_FwdDisc=lesNetworkProfile_PotsLineConfig_FwdDisc, lesNetworkProfile_PhysicalAddress_Slot=lesNetworkProfile_PhysicalAddress_Slot, lesNetworkProfile_Slot_o=lesNetworkProfile_Slot_o, lesNetworkProfile_PotsLineConfig_OverRideCid=lesNetworkProfile_PotsLineConfig_OverRideCid, lesNetworkProfile_PotsLineConfig_Index_o=lesNetworkProfile_PotsLineConfig_Index_o, miblesNetworkProfile_PotsLineConfigEntry=miblesNetworkProfile_PotsLineConfigEntry, miblesNetworkProfileEntry=miblesNetworkProfileEntry, lesNetworkProfile_PhysicalAddress_Shelf=lesNetworkProfile_PhysicalAddress_Shelf, miblesNetworkProfileTable=miblesNetworkProfileTable, DisplayString=DisplayString, lesNetworkProfile_Enabled=lesNetworkProfile_Enabled, lesNetworkProfile_PotsLineConfig_Enabled=lesNetworkProfile_PotsLineConfig_Enabled, lesNetworkProfile_PotsLineConfig_Mode=lesNetworkProfile_PotsLineConfig_Mode, miblesNetworkProfile=miblesNetworkProfile, lesNetworkProfile_Item_o=lesNetworkProfile_Item_o, lesNetworkProfile_Action_o=lesNetworkProfile_Action_o, miblesNetworkProfile_PotsLineConfigTable=miblesNetworkProfile_PotsLineConfigTable, lesNetworkProfile_PotsLineConfig_EncodingFormatProfile=lesNetworkProfile_PotsLineConfig_EncodingFormatProfile, lesNetworkProfile_Name=lesNetworkProfile_Name, lesNetworkProfile_Shelf_o=lesNetworkProfile_Shelf_o, lesNetworkProfile_PotsLineConfig_Shelf_o=lesNetworkProfile_PotsLineConfig_Shelf_o, lesNetworkProfile_PhysicalAddress_ItemNumber=lesNetworkProfile_PhysicalAddress_ItemNumber)
