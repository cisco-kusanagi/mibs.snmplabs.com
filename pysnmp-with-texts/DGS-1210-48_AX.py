...
# Produced by pysmi-0.3.4 at Wed May  1 12:43:19 2019
...
TimeTicks, enterprises, ModuleIdentity, iso, Counter64, MibIdentifier, Integer32, Unsigned32, ObjectIdentity, Counter32, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "ModuleIdentity", "iso", "Counter64", "MibIdentifier", "Integer32", "Unsigned32", "ObjectIdentity", "Counter32", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Bits")
...
mibBuilder.exportSymbols("DGS-1210-48_AX", snmpV3TrapBootup=snmpV3TrapBootup, aclProfileArpSenderMacAddrMask=aclProfileArpSenderMacAddrMask, sysLoginTimeoutInterval=sysLoginTimeoutInterval, laPortChannelMode=laPortChannelMode, aclL2RuleEntry=aclL2RuleEntry, broadcastStormCtrlThreshold=broadcastStormCtrlThreshold, aclL2RuleInPortList=aclL2RuleInPortList, dot1qVlanAsyOnOff=dot1qVlanAsyOnOff, aclL2RuleDstMacAddrMask=aclL2RuleDstMacAddrMask, companyLA=companyLA, qosDiffServType48=qosDiffServType48, laSystem=laSystem, qosDiffServType41=qosDiffServType41, stpAdminPortPathCost=stpAdminPortPathCost, laPortControl=laPortControl, companySNMPV3=companySNMPV3, sysPowerSavingEnable=sysPowerSavingEnable, sysMirrorTargetPort=sysMirrorTargetPort, aRPSpoofPreventRowStatus=aRPSpoofPreventRowStatus, sysPortCtrlFlowControlOper=sysPortCtrlFlowControlOper, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, qosDiffServType30=qosDiffServType30, miscStatisticsReset=miscStatisticsReset, dot1xAuth=dot1xAuth, qosDiffServType59=qosDiffServType59, aclL2RuleStatus=aclL2RuleStatus, tftpCfgServerIpAddress=tftpCfgServerIpAddress, trustedHostIpMask=trustedHostIpMask, sysTrapIP=sysTrapIP, voiceVlanId=voiceVlanId, sysLBDInterval=sysLBDInterval, snmpV3GroupTable=snmpV3GroupTable, sslCipherSuiteList=sslCipherSuiteList, aclL2ProfileID=aclL2ProfileID, stpPortDesignatedBridge=stpPortDesignatedBridge, queuingMechanism=queuingMechanism, sysTrapFiberPortEvent=sysTrapFiberPortEvent, qosDiffServType11=qosDiffServType11, sysDhcpAutoConfiguration=sysDhcpAutoConfiguration, dot1qVlanUngisterMCFilterEntry=dot1qVlanUngisterMCFilterEntry, snmpV3TrapSNMPAuthentication=snmpV3TrapSNMPAuthentication, stpPortRestrictedTCN=stpPortRestrictedTCN, qosDiffServType19=qosDiffServType19, dot1qVlanUngisterMCFiltermode=dot1qVlanUngisterMCFiltermode, bandwidthCtrlSettings=bandwidthCtrlSettings, snmpV3ViewTree=snmpV3ViewTree, dot1qVlanUngisterMCFilterTable=dot1qVlanUngisterMCFilterTable, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, stpBridgeHelloTime=stpBridgeHelloTime, stpHoldTime=stpHoldTime, snmpV3UserName=snmpV3UserName, aclL3RuleAccessID=aclL3RuleAccessID, laPortControlEntry=laPortControlEntry, igsStatus=igsStatus, stpRootPort=stpRootPort, snmpV3UserAuthProtocolPassword=snmpV3UserAuthProtocolPassword, igsVlanMulticastGroupMacAddress=igsVlanMulticastGroupMacAddress, igsSystem=igsSystem, igsVlanFilterTable=igsVlanFilterTable, aclL3RuleTcpUdpDstPort=aclL3RuleTcpUdpDstPort, stpProtocolSpecification=stpProtocolSpecification, snmpV3Trap=snmpV3Trap, igsVlanQuerier=igsVlanQuerier, qosDiffServType39=qosDiffServType39, portSecTable=portSecTable, sysSNTPFirstServer=sysSNTPFirstServer, voicevlanOUI=voicevlanOUI, aclProfileSrcPortMask=aclProfileSrcPortMask, sysGateway=sysGateway, snmpV3GroupEntry=snmpV3GroupEntry, companyQoSGroup=companyQoSGroup, snmpV3HostVersion=snmpV3HostVersion, igsVlanRouterEntry=igsVlanRouterEntry, laPortChannelTable=laPortChannelTable, sysSNTPDSTEndDay=sysSNTPDSTEndDay, sysSNTPDSTState=sysSNTPDSTState, qosDiffServType07=qosDiffServType07, companyIpifGroup=companyIpifGroup, sysTrapSystemEvent=sysTrapSystemEvent, sysSNTPGMTMinutes=sysSNTPGMTMinutes, firmwareUpgradeSuccess=firmwareUpgradeSuccess, bandwidthCtrlRxThreshold=bandwidthCtrlRxThreshold, autoSurveillanceVlanOUISurveillanceOUI=autoSurveillanceVlanOUISurveillanceOUI, snmpV3UserEntry=snmpV3UserEntry, companyDot1xGroup=companyDot1xGroup, aclL2Rule1pPriority=aclL2Rule1pPriority, staticAutoLearningList=staticAutoLearningList, dot1pPortPriority=dot1pPortPriority, dgs_1210_48ax=dgs_1210_48ax, laPortChannelEntry=laPortChannelEntry, tftpFwServerIpAddress=tftpFwServerIpAddress, qosDiffServ=qosDiffServ, aclL3RuleSrcIpAddrMask=aclL3RuleSrcIpAddrMask, autoSurveillanceVlanMode=autoSurveillanceVlanMode, sysPortCtrlOperStatus=sysPortCtrlOperStatus, stpHelloTime=stpHelloTime, aclL3RuleSrcIpAddr=aclL3RuleSrcIpAddr, trustedHostTable=trustedHostTable, qosDiffServType10=qosDiffServType10, igsQueryInterval=igsQueryInterval, sslCiphers=sslCiphers, sysLBDCtrlIndex=sysLBDCtrlIndex, aclL3RuleICMPMessageType=aclL3RuleICMPMessageType, snmpV3GroupReadViewName=snmpV3GroupReadViewName, staticVlanID=staticVlanID, VlanIndex=VlanIndex, laPortActorActivity=laPortActorActivity, qosDiffServType33=qosDiffServType33, snmpV3UserPrivProtocol=snmpV3UserPrivProtocol, qosDiffServType02=qosDiffServType02, sysLBDPortStatus=sysLBDPortStatus, sysPortCtrlFlowControl=sysPortCtrlFlowControl, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, laPortChannelMemberList=laPortChannelMemberList, aclProfile=aclProfile, radiusServerSharedSecret=radiusServerSharedSecret, voicevlanPortControlTable=voicevlanPortControlTable, dhcpServerScreenEnablePortlist=dhcpServerScreenEnablePortlist, stpPortEnable=stpPortEnable, aRPSpoofPreventPortList=aRPSpoofPreventPortList, qosDiffServType37=qosDiffServType37, qosDiffServType04=qosDiffServType04, voicevlanOUIStatus=voicevlanOUIStatus, sysSNTPDSTStartMin=sysSNTPDSTStartMin, igsVlanMulticastGroupIpAddress=igsVlanMulticastGroupIpAddress, sysLocationName=sysLocationName, aclProfileDstPortMask=aclProfileDstPortMask, companyTraps=companyTraps, syslogLogSrvAddr=syslogLogSrvAddr, dot1qVlanPortEntry=dot1qVlanPortEntry, laPortControlIndex=laPortControlIndex, snmpV3UserVersion=snmpV3UserVersion, trustedHostRowStatus=trustedHostRowStatus, qosDiffServType18=qosDiffServType18, voicevlanOUITelephonyOUI=voicevlanOUITelephonyOUI, aclL2RuleAction=aclL2RuleAction, dot1qVlanEgressPorts=dot1qVlanEgressPorts, igsRobustnessValue=igsRobustnessValue, aclL2RuleDstMacAddr=aclL2RuleDstMacAddr, qosDiffServType14=qosDiffServType14, aclL3RuleDscp=aclL3RuleDscp, dot1qVlanEntry=dot1qVlanEntry, stpPortPriority=stpPortPriority, syslogFacility=syslogFacility, aclL3RuleDstIpAddr=aclL3RuleDstIpAddr, dot1pPortEntry=dot1pPortEntry, stpPortDesignatedCost=stpPortDesignatedCost, qosDiffServType28=qosDiffServType28, snmpV3viewTreeMask=snmpV3viewTreeMask, autoSurveillanceVlanOUI=autoSurveillanceVlanOUI, snmpGlobalState=snmpGlobalState, stpPortTable=stpPortTable, igsVlanFilterEntry=igsVlanFilterEntry, voiceVlanTimeout=voiceVlanTimeout, sysSNTPSecondServer=sysSNTPSecondServer, companyACLGroup=companyACLGroup, sysTrapFirmUpgradeEvent=sysTrapFirmUpgradeEvent, voicevlanOUIEntry=voicevlanOUIEntry, stpTimeSinceTopologyChange=stpTimeSinceTopologyChange, aclL3RuleTcpFinBit=aclL3RuleTcpFinBit, snmpV3TrapFiberLinkUpDown=snmpV3TrapFiberLinkUpDown, snmpV3CommunityTable=snmpV3CommunityTable, qosDiffServType38=qosDiffServType38, companyIgsGroup=companyIgsGroup, traps=traps, tftpFwImageFileName=tftpFwImageFileName, igsVlanMulticastGroupTable=igsVlanMulticastGroupTable, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, bandwidthCtrlIndex=bandwidthCtrlIndex, qosDiffServType44=qosDiffServType44, companyMiscGroup=companyMiscGroup, voiceVlanPriority=voiceVlanPriority, sysLBDCtrlTable=sysLBDCtrlTable, qosDiffServType63=qosDiffServType63, sysSNTPDSTEndMin=sysSNTPDSTEndMin, companyTftpGroup=companyTftpGroup, aclProfileEntry=aclProfileEntry, igsVlanMulticastGroupVlanId=igsVlanMulticastGroupVlanId, companyVoiceVlan=companyVoiceVlan, qosDiffServType42=qosDiffServType42, aclProfileSrcIpAddrMask=aclProfileSrcIpAddrMask, snmpV3viewTreeStatus=snmpV3viewTreeStatus, sysSNTPState=sysSNTPState, staticPort=staticPort, aclProfileMask=aclProfileMask, sysSNTPDSTStartDay=sysSNTPDSTStartDay, qosDiffServTypeGroup=qosDiffServTypeGroup, sysPortCtrlEntry=sysPortCtrlEntry, autoSurveillanceVlanOUIComponentType=autoSurveillanceVlanOUIComponentType, qosDiffServType52=qosDiffServType52, aclL3RuleTcpSynBit=aclL3RuleTcpSynBit, tftpConfigTftpOperation=tftpConfigTftpOperation, miscReset=miscReset, qosDiffServType60=qosDiffServType60, aclL3RuleStatus=aclL3RuleStatus, snmpV3TrapFirmUpgrade=snmpV3TrapFirmUpgrade, dot1xAuthTxPeriod=dot1xAuthTxPeriod, companySyslog=companySyslog, sysPortCtrlSpeed=sysPortCtrlSpeed, qosQ1p=qosQ1p, dot1qVlanManagementOnOff=dot1qVlanManagementOnOff, broadcastStormCtrlSettings=broadcastStormCtrlSettings, bandwidthCtrlTxThreshold=bandwidthCtrlTxThreshold, igsVlanFilterVlanId=igsVlanFilterVlanId, snmpV3Group=snmpV3Group, sysRestart=sysRestart, dot1xAuthStatus=dot1xAuthStatus, voicevlanOUIDescription=voicevlanOUIDescription, qosDiffServType23=qosDiffServType23, companyTrapSetting=companyTrapSetting, qosDiffServType16=qosDiffServType16, snmpV3UserPrivProtocolPassword=snmpV3UserPrivProtocolPassword, autoSurveillanceVlanOUIMask=autoSurveillanceVlanOUIMask, dot1xAuthServerTimeout=dot1xAuthServerTimeout, qosDiffServType29=qosDiffServType29, stpPortDesignatedRoot=stpPortDesignatedRoot, dot1qVlanPvid=dot1qVlanPvid, snmpV3GroupName=snmpV3GroupName, portSecEntry=portSecEntry, sysMirrorCtrlIngressMirroring=sysMirrorCtrlIngressMirroring, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, sysGPIOStatus=sysGPIOStatus, aclL2RuleSrcMacAddr=aclL2RuleSrcMacAddr, igsVlanQueryInterval=igsVlanQueryInterval, qosDiffServEnable=qosDiffServEnable, qosDiffServType00=qosDiffServType00, stpMaxAge=stpMaxAge, qosDiffServType50=qosDiffServType50, aclL3RuleTcpUrgBit=aclL3RuleTcpUrgBit, sysSave=sysSave, aclL2RuleSrcMacAddrMask=aclL2RuleSrcMacAddrMask, PortList=PortList, sysGroupInterval=sysGroupInterval, aclL3RuleICMPMessageCode=aclL3RuleICMPMessageCode, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, aclProfileRuleCount=aclProfileRuleCount, qosDiffServType13=qosDiffServType13, sysSNTPDSTStartHour=sysSNTPDSTStartHour, aclProfileIPProtocol=aclProfileIPProtocol, qosDiffServType51=qosDiffServType51, igsVlanRouterTable=igsVlanRouterTable, autoSurveillanceVlanSystem=autoSurveillanceVlanSystem, sysPortCtrlType=sysPortCtrlType, tftpFwTftpOperationStatus=tftpFwTftpOperationStatus, qosDiffServType06=qosDiffServType06, portSecMLA=portSecMLA, aRPSpoofPreventEntry=aRPSpoofPreventEntry, stpPortPathCost=stpPortPathCost, igsVlanMulticastGroupEntry=igsVlanMulticastGroupEntry, igsVlanRouterPortList=igsVlanRouterPortList, syslogGeneralGroup=syslogGeneralGroup, igsGrpQueryInterval=igsGrpQueryInterval, dot1qVlanUngisterMCFilterVlanId=dot1qVlanUngisterMCFilterVlanId, stpPortState=stpPortState)
mibBuilder.exportSymbols("DGS-1210-48_AX", qosDiffServType56=qosDiffServType56, dot1qVlanPortTable=dot1qVlanPortTable, qosDiffServType01=qosDiffServType01, stpRootCost=stpRootCost, aclL3RuleTcpAckBit=aclL3RuleTcpAckBit, stpPortOperEdgePort=stpPortOperEdgePort, voiceVlanMode=voiceVlanMode, radius=radius, voicevlanPortState=voicevlanPortState, tftpFwTftpOperation=tftpFwTftpOperation, sysSNTPDSTStartMon=sysSNTPDSTStartMon, igsVlanRtrPortList=igsVlanRtrPortList, dlink_DGS1210SeriesProd=dlink_DGS1210SeriesProd, qosDiffServType22=qosDiffServType22, sysLBDStateEnable=sysLBDStateEnable, trustedHostStatus=trustedHostStatus, dot1qVlanManagementid=dot1qVlanManagementid, companyLBD=companyLBD, portSecState=portSecState, snmpV3GroupNotifyViewName=snmpV3GroupNotifyViewName, snmpV3GroupSecurityLevel=snmpV3GroupSecurityLevel, radiusServerAddress=radiusServerAddress, qosDiffServType57=qosDiffServType57, voicevlanOUITable=voicevlanOUITable, qosDiffServType27=qosDiffServType27, staticStatus=staticStatus, broadcastStormCtrlLimitType=broadcastStormCtrlLimitType, securitySSL=securitySSL, bandwidthCtrlEntry=bandwidthCtrlEntry, staticTable=staticTable, aclProfileSrcMacAddrMask=aclProfileSrcMacAddrMask, qosDiffServType47=qosDiffServType47, laPortActorTimeout=laPortActorTimeout, aRPSpoofPreventTable=aRPSpoofPreventTable, aclL3RuleEntry=aclL3RuleEntry, snmpV3CommunityEntry=snmpV3CommunityEntry, snmpV3HostCommunityName=snmpV3HostCommunityName, autoSurveillanceVlanOUIDescription=autoSurveillanceVlanOUIDescription, stpPortRestrictedRole=stpPortRestrictedRole, snmpV3CommunityStatus=snmpV3CommunityStatus, qosDiffServType58=qosDiffServType58, qosDiffServType09=qosDiffServType09, sysHardwareVersion=sysHardwareVersion, aclL3RuleProfileNo=aclL3RuleProfileNo, aclProfileTable=aclProfileTable, tftpConfigTftpOperationStatus=tftpConfigTftpOperationStatus, sysFanStatus=sysFanStatus, laPortControlTable=laPortControlTable, laPortActorPortPriority=laPortActorPortPriority, sysSafeGuardEnable=sysSafeGuardEnable, voicevlanOUIMask=voicevlanOUIMask, qosDiffServType53=qosDiffServType53, snmpV3GroupStatus=snmpV3GroupStatus, firmwareTransferError=firmwareTransferError, stpVersion=stpVersion, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, companyRSTP=companyRSTP, aclL3RuleTable=aclL3RuleTable, aclL3RuleDstIpAddrMask=aclL3RuleDstIpAddrMask, stpTxHoldCount=stpTxHoldCount, stpPortForwardTransitions=stpPortForwardTransitions, qosDiffServType08=qosDiffServType08, qosDiffServType05=qosDiffServType05, aclL3RuleTcpUdpSrcPort=aclL3RuleTcpUdpSrcPort, aRPSpoofPreventMacAddress=aRPSpoofPreventMacAddress, aclL3RulePortList=aclL3RulePortList, stpPortOperPointToPoint=stpPortOperPointToPoint, aclProfileDstIpAddrMask=aclProfileDstIpAddrMask, qosDiffServType03=qosDiffServType03, sysLBDRecoverTime=sysLBDRecoverTime, snmpV3UserAuthProtocol=snmpV3UserAuthProtocol, sysSNTPDSTEndMon=sysSNTPDSTEndMon, sysLBDPortLoopStatus=sysLBDPortLoopStatus, sysMirrorCtrlEgressMirroring=sysMirrorCtrlEgressMirroring, snmpV3Host=snmpV3Host, syslogLogging=syslogLogging, BridgeId=BridgeId, rstpStatus=rstpStatus, stpGlobal=stpGlobal, aclProfileDstMacAddrMask=aclProfileDstMacAddrMask, sysLBDCtrlEntry=sysLBDCtrlEntry, qosDiffServType43=qosDiffServType43, Timeout=Timeout, aclL3RuleTcpRstBit=aclL3RuleTcpRstBit, igsVlanSnoopStatus=igsVlanSnoopStatus, aclProfileArpSenderIpAddrMask=aclProfileArpSenderIpAddrMask, voicevlanPortAutoDetection=voicevlanPortAutoDetection, staticMac=staticMac, autoSurveillanceVlanOUIStatus=autoSurveillanceVlanOUIStatus, companySystem=companySystem, securityARPSpoofPrevent=securityARPSpoofPrevent, autoSurveillanceVlanOUIEntry=autoSurveillanceVlanOUIEntry, snmpV3UserGroupName=snmpV3UserGroupName, snmpV3HostStatus=snmpV3HostStatus, autoSurveillanceVlanPriority=autoSurveillanceVlanPriority, stpPriority=stpPriority, snmpV3viewTreeSubtree=snmpV3viewTreeSubtree, stpDesignatedRoot=stpDesignatedRoot, snmpV3EngineID=snmpV3EngineID, sysPortCtrlTable=sysPortCtrlTable, dot1qVlanUntaggedPorts=dot1qVlanUntaggedPorts, snmpV3UserTable=snmpV3UserTable, sysSNTPTimeSeconds=sysSNTPTimeSeconds, qosDiffServType45=qosDiffServType45, stpBridgeForwardDelay=stpBridgeForwardDelay, qosDiffServType36=qosDiffServType36, stpPortEdge=stpPortEdge, qosDiffServType55=qosDiffServType55, aclL2RuleVlanId=aclL2RuleVlanId, portSecIndex=portSecIndex, sysJumboFrameEnable=sysJumboFrameEnable, snmpV3TrapRSTPStateChange=snmpV3TrapRSTPStateChange, snmpV3HostTable=snmpV3HostTable, qosDiffServType62=qosDiffServType62, voicevlanPortControlEntry=voicevlanPortControlEntry, securityTrustedHost=securityTrustedHost, stpForwardDelay=stpForwardDelay, qosDiffServType46=qosDiffServType46, snmpV3HostAddress=snmpV3HostAddress, sysTrapTwistedPortEvent=sysTrapTwistedPortEvent, autoSurveillanceVlanId=autoSurveillanceVlanId, igsVlanMulticastGroupPortList=igsVlanMulticastGroupPortList, dot1qVlanName=dot1qVlanName, dlink_products=dlink_products, snmpV3GroupWriteViewName=snmpV3GroupWriteViewName, aclL3RuleIgmpType=aclL3RuleIgmpType, companyMirror=companyMirror, stpPortDesignatedPort=stpPortDesignatedPort, syslogSeverity=syslogSeverity, LacpKey=LacpKey, firmwareChecksumError=firmwareChecksumError, aclL3Rule=aclL3Rule, qosDiffServType17=qosDiffServType17, sysSNTPPollInterval=sysSNTPPollInterval, syslogUDPPort=syslogUDPPort, igsVlan=igsVlan, companyTrafficMgmt=companyTrafficMgmt, qosDiffServType31=qosDiffServType31, qosDiffServType40=qosDiffServType40, firmwareUpgradeFailure=firmwareUpgradeFailure, PortLaMode=PortLaMode, qosDiffServType34=qosDiffServType34, aclL3RuleTcpUdpDstPortMask=aclL3RuleTcpUdpDstPortMask, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, companyAutoSurveillanceVlan=companyAutoSurveillanceVlan, sysIpSubnetMask=sysIpSubnetMask, aclL3RuleTcpPshBit=aclL3RuleTcpPshBit, aclL2RuleEtherType=aclL2RuleEtherType, companySecurity=companySecurity, snmpV3User=snmpV3User, staticDisableAutoLearn=staticDisableAutoLearn, stpTopChanges=stpTopChanges, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, snmpV3viewTreeType=snmpV3viewTreeType, staticEntry=staticEntry, aRPSpoofPreventIpAddr=aRPSpoofPreventIpAddr, igsVlanCfgQuerier=igsVlanCfgQuerier, aclProfileStatus=aclProfileStatus, stpPortAdminPointToPoint=stpPortAdminPointToPoint, sysPortCtrlIndex=sysPortCtrlIndex, companySNTPSetting=companySNTPSetting, sysSNTPDSTOffset=sysSNTPDSTOffset, aclL3RuleTcpUdpSrcPortMask=aclL3RuleTcpUdpSrcPortMask, snmpV3UserStatus=snmpV3UserStatus, snmpV3CommunityName=snmpV3CommunityName, trustedHostEntry=trustedHostEntry, sysSNTPDSTEndHour=sysSNTPDSTEndHour, laPortChannelIfIndex=laPortChannelIfIndex, stpPort=stpPort, qosDiffServType15=qosDiffServType15, snmpV3HostEntry=snmpV3HostEntry, aclL2RuleTable=aclL2RuleTable, syslogTimeStamp=syslogTimeStamp, qosDiffServType61=qosDiffServType61, snmpV3CommunityPolicy=snmpV3CommunityPolicy, topologyChange=topologyChange, snmpV3TrapCopperLinkUpDown=snmpV3TrapCopperLinkUpDown, aclL3RuleAction=aclL3RuleAction, qosDiffServType26=qosDiffServType26, firmwareIllegalFile=firmwareIllegalFile, securityDhcpServerScreen=securityDhcpServerScreen, aclL2AccessID=aclL2AccessID, trustedHostIpAddr=trustedHostIpAddr, qosMode=qosMode, companyDot1qVlanGroup=companyDot1qVlanGroup, dot1pPortTable=dot1pPortTable, qosDiffServType12=qosDiffServType12, sslSecurityHttpStatus=sslSecurityHttpStatus, snmpV3ViewTreeTable=snmpV3ViewTreeTable, voicevlanSystem=voicevlanSystem, autoSurveillanceVlanOUITable=autoSurveillanceVlanOUITable, igsQueryMaxResponseTime=igsQueryMaxResponseTime, sysTrapStatus=sysTrapStatus, qosDiffServType21=qosDiffServType21, aclProfileNo=aclProfileNo, snmpV3Community=snmpV3Community, aclL3RuleProtocol=aclL3RuleProtocol, igsVlanRouterVlanId=igsVlanRouterVlanId, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, sysMirrorStatus=sysMirrorStatus, qosDiffServType32=qosDiffServType32, sysIpAddr=sysIpAddr, qosDiffServType54=qosDiffServType54, stpBridgeMaxAge=stpBridgeMaxAge, companyStaticMAC=companyStaticMAC, qosDiffServType35=qosDiffServType35, qosDiffServType49=qosDiffServType49, igsHostPortPurgeInterval=igsHostPortPurgeInterval, tftpConfigFileName=tftpConfigFileName, aclL2Rule=aclL2Rule, dot1qVlanTable=dot1qVlanTable, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, dot1qVlanRowStatus=dot1qVlanRowStatus, bandwidthCtrlTable=bandwidthCtrlTable, dot1qVlanForbiddenPorts=dot1qVlanForbiddenPorts, sysSwitchName=sysSwitchName, sysSystemPassword=sysSystemPassword, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, stpPortProtocolMigration=stpPortProtocolMigration, snmpV3viewTreeName=snmpV3viewTreeName, stpPortEntry=stpPortEntry, qosDiffServType24=qosDiffServType24, d_link=d_link, sysIpAddrCfgMode=sysIpAddrCfgMode, snmpV3ViewTreeEntry=snmpV3ViewTreeEntry, qosDiffServType25=qosDiffServType25, sysTrapStateChangeEvent=sysTrapStateChangeEvent, securityPortSecurity=securityPortSecurity, dot1pPortIndex=dot1pPortIndex, sysPortCtrlMDI=sysPortCtrlMDI, aclProfileType=aclProfileType, dot1xAuthMaxReq=dot1xAuthMaxReq, snmpV3GroupSecurityModel=snmpV3GroupSecurityModel, qosDiffServType20=qosDiffServType20, sysFirmwareVersion=sysFirmwareVersion, laStatus=laStatus, voicevlanPortControlIndex=voicevlanPortControlIndex)
