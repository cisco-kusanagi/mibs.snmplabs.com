...
# Produced by pysmi-0.3.4 at Wed May  1 12:46:43 2019
...
UpToMaxAge, DesignatedRouterPriority, Status, AreaID, TOSType, PositiveInteger, RouterID, Metric, HelloRange = mibBuilder.importSymbols("OSPF-MIB", "UpToMaxAge", "DesignatedRouterPriority", "Status", "AreaID", "TOSType", "PositiveInteger", "RouterID", "Metric", "HelloRange")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
MibIdentifier, Unsigned32, NotificationType, ModuleIdentity, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Integer32, Counter32, TimeTicks, iso, Counter64, IpAddress, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "NotificationType", "ModuleIdentity", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Integer32", "Counter32", "TimeTicks", "iso", "Counter64", "IpAddress", "ObjectIdentity")
TimeStamp, MacAddress, DisplayString, TruthValue, PhysAddress, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "MacAddress", "DisplayString", "TruthValue", "PhysAddress", "TextualConvention", "RowStatus")
...
if mibBuilder.loadTexts: swL3RelayDhcpState.setDescription('This object indicates if the DHCP Relay function is enabled or disabled.')
...
if mibBuilder.loadTexts: swL3RelayDhcpCtrlTable.setDescription('This table specifies the IP address as a destination to forward (relay) DHCP packets to.')
...
if mibBuilder.loadTexts: swL3RelayDhcpCtrlEntry.setDescription('A list of information specifying the IP address as a destination to forward (relay) DHCP packets to.')
...
if mibBuilder.loadTexts: swL3RoutePreferenceEBGP.setDescription('Used to configure the route preference of EBGP.')
...
if mibBuilder.loadTexts: swL3RoutePreferenceIBGP.setDescription('Used to configure the route preference of IBGP.')
...
mibBuilder.exportSymbols("DGS3627G-SWL3MGMT-MIB", swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3Route6RedistriDstProtocol=swL3Route6RedistriDstProtocol, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3IpCtrlDhcpv6ClientPDState=swL3IpCtrlDhcpv6ClientPDState, swL3LoopBackIpCtrlInterfaceName=swL3LoopBackIpCtrlInterfaceName, swL3DHCPRelayOption60String=swL3DHCPRelayOption60String, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3RelayDhcpState=swL3RelayDhcpState, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3RelayDhcpOption82Policy=swL3RelayDhcpOption82Policy, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3LoopBackIpCtrlRowStatus=swL3LoopBackIpCtrlRowStatus, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3RelayDhcpHopCount=swL3RelayDhcpHopCount, swL3ospfIfType=swL3ospfIfType, swL3RIPInboundRouteFilterType=swL3RIPInboundRouteFilterType, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3LoopBackIpCtrlTable=swL3LoopBackIpCtrlTable, swL3IpCtrlMode=swL3IpCtrlMode, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3RelayDhcpCtrlInterfaceName=swL3RelayDhcpCtrlInterfaceName, swL3DHCPRelayOption61Entry=swL3DHCPRelayOption61Entry, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3IpCtrlIpDirectedBroadcastState=swL3IpCtrlIpDirectedBroadcastState, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3Ipv6DHCPv6CPDAddrCtrlTable=swL3Ipv6DHCPv6CPDAddrCtrlTable, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3RelayDnsState=swL3RelayDnsState, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3RelayDhcpOption82State=swL3RelayDhcpOption82State, swL3Route6RedistriMetric=swL3Route6RedistriMetric, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3IpCtrlState=swL3IpCtrlState, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3LoopBackIpCtrlEntry=swL3LoopBackIpCtrlEntry, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3OspfHostTable=swL3OspfHostTable, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3DHCPRelayOption60DefRowStatus=swL3DHCPRelayOption60DefRowStatus, swL3ospfAreaId=swL3ospfAreaId, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3DevCtrl=swL3DevCtrl, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3RoutePreferenceIBGP=swL3RoutePreferenceIBGP, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3LoopBackIpCtrlIpAddr=swL3LoopBackIpCtrlIpAddr, swL3ospfIfMetric=swL3ospfIfMetric, swL3ospfIfDistributeListInType=swL3ospfIfDistributeListInType, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3DHCPRelayOption61Table=swL3DHCPRelayOption61Table, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3ospfAreaType=swL3ospfAreaType, swL3DHCPRelayOption60DefEntry=swL3DHCPRelayOption60DefEntry, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3ospfIfState=swL3ospfIfState, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3RelayDhcpCtrlTable=swL3RelayDhcpCtrlTable, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3OspfHostStatus=swL3OspfHostStatus, swL3Md5KeyId=swL3Md5KeyId, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3DHCPRelayOption61State=swL3DHCPRelayOption61State, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3DHCPRelayOption61RowStatus=swL3DHCPRelayOption61RowStatus, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3DevMgmt=swL3DevMgmt, swL3IpCtrlLocalProxyArp=swL3IpCtrlLocalProxyArp, swL3DHCPRelayOption60DefMode=swL3DHCPRelayOption60DefMode, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3RouteRedistriType=swL3RouteRedistriType, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3RIPInboundRouteFilterName=swL3RIPInboundRouteFilterName, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3OspfHostMetric=swL3OspfHostMetric, swL3ospfAreaTable=swL3ospfAreaTable, swL3DHCPRelayOption61DefRelayIp=swL3DHCPRelayOption61DefRelayIp, swL3DHCPRelayOption61ClientID=swL3DHCPRelayOption61ClientID, swL3RouteRedistriRouteMapName=swL3RouteRedistriRouteMapName, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3RoutePreferenceDefault=swL3RoutePreferenceDefault, swL3OspfHostEntry=swL3OspfHostEntry, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3Md5Key=swL3Md5Key, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3Route6RedistriType=swL3Route6RedistriType, swL3RIPInboundRouteFilterTable=swL3RIPInboundRouteFilterTable, swL3ospfIfDemand=swL3ospfIfDemand, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3LoopBackIpCtrlAdminState=swL3LoopBackIpCtrlAdminState, VrId=VrId, swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3Ipv6AddressCtrlAddressType=swL3Ipv6AddressCtrlAddressType, NetAddress=NetAddress, swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3RelayDhcpCtrlServer=swL3RelayDhcpCtrlServer, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3RIPInboundRouteFilterIfIpAddress=swL3RIPInboundRouteFilterIfIpAddress, swL3Route6RedistriSrcProtocol=swL3Route6RedistriSrcProtocol, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3VrrpOperState=swL3VrrpOperState, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3Md5RowStatus=swL3Md5RowStatus, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3DHCPRelayOption60Table=swL3DHCPRelayOption60Table, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3DHCPRelayOption60RelayIp=swL3DHCPRelayOption60RelayIp, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3DevCtrlDHCPAutoConfigState=swL3DevCtrlDHCPAutoConfigState, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3ospfIfDistributeListInName=swL3ospfIfDistributeListInName, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3IpMgmt=swL3IpMgmt, swL3RoutePreference=swL3RoutePreference, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3Md5Entry=swL3Md5Entry, swL3Route6RedistriRowStatus=swL3Route6RedistriRowStatus, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3DHCPRelayOption60RowStatus=swL3DHCPRelayOption60RowStatus, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3OspfHostTOS=swL3OspfHostTOS, swL3DHCPRelayOption60Entry=swL3DHCPRelayOption60Entry, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3RoutePreferenceEBGP=swL3RoutePreferenceEBGP, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3LoopBackIpCtrlIpSubnetMask=swL3LoopBackIpCtrlIpSubnetMask, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3RelayDhcpCtrlState=swL3RelayDhcpCtrlState, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3DHCPRelayOption61DefMode=swL3DHCPRelayOption61DefMode, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3DHCPRelayOption60State=swL3DHCPRelayOption60State, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3DHCPRelayOption60MatchType=swL3DHCPRelayOption60MatchType, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3LoopBackIpCtrlIfIndex=swL3LoopBackIpCtrlIfIndex, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3Ipv6Address=swL3Ipv6Address, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3Route6RedistriEntry=swL3Route6RedistriEntry, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3DHCPRelayOption60DefTable=swL3DHCPRelayOption60DefTable, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3IpCtrlTable=swL3IpCtrlTable, swL3Ipv6DHCPv6CPDAddrCtrlEntry=swL3Ipv6DHCPv6CPDAddrCtrlEntry, swL3RelayMgmt=swL3RelayMgmt, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3RelayDhcpCtrlEntry=swL3RelayDhcpCtrlEntry, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3DHCPRelayOption61ClientType=swL3DHCPRelayOption61ClientType, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3RelayDhcpMgmt=swL3RelayDhcpMgmt, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, Ipv6Address=Ipv6Address, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3DHCPRelayOption61Mode=swL3DHCPRelayOption61Mode, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3IpCtrlDhcpv6ClientPDPrefix=swL3IpCtrlDhcpv6ClientPDPrefix, swL3Route6RedistriTable=swL3Route6RedistriTable, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState)
mibBuilder.exportSymbols("DGS3627G-SWL3MGMT-MIB", swL3Md5Table=swL3Md5Table, swL3Ipv6DHCPv6CPDAddrCtrlState=swL3Ipv6DHCPv6CPDAddrCtrlState, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3RelayDhcpOption82CheckState=swL3RelayDhcpOption82CheckState, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3RIPInboundRouteFilterEntry=swL3RIPInboundRouteFilterEntry, swL3IpCtrlDhcpv6ClientPDPrefixName=swL3IpCtrlDhcpv6ClientPDPrefixName, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3VrrpOperTable=swL3VrrpOperTable, swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=swL3Ipv6DHCPv6CPDAddrCtrlPrefixName, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3DHCPRelayOption60DefRelayIp=swL3DHCPRelayOption60DefRelayIp, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3DHCPRelayOption60=swL3DHCPRelayOption60, swL3DevCtrlPIMState=swL3DevCtrlPIMState, NodeAddress=NodeAddress, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3DHCPRelayOption61=swL3DHCPRelayOption61, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3ospfIfEntry=swL3ospfIfEntry, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3OspfECMPState=swL3OspfECMPState, swL3ospfIfEvents=swL3ospfIfEvents, swL3DHCPRelayOption61RelayIp=swL3DHCPRelayOption61RelayIp, swL3IpCtrlDhcpv6ClientPDPrefixLen=swL3IpCtrlDhcpv6ClientPDPrefixLen, swL3ospfIfTable=swL3ospfIfTable, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3MgmtMIB=swL3MgmtMIB, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3RelayDhcpTimeThreshold=swL3RelayDhcpTimeThreshold)
