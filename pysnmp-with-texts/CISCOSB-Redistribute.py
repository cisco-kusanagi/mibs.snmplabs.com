...
# Produced by pysmi-0.3.4 at Wed May  1 12:23:20 2019
...
MibIdentifier, Counter32, Integer32, NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ModuleIdentity, Gauge32, iso, Unsigned32, Bits, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter32", "Integer32", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ModuleIdentity", "Gauge32", "iso", "Unsigned32", "Bits", "ObjectIdentity", "IpAddress")
...
mibBuilder.exportSymbols("CISCOSB-Redistribute", RlRedistDstProtocol=RlRedistDstProtocol, rlRedistTable=rlRedistTable, rlRedistDstProcessId=rlRedistDstProcessId, rlRedistAsNumber=rlRedistAsNumber, rlRedistEntry=rlRedistEntry, rlRedistMetricTransparent=rlRedistMetricTransparent, rlRedistribute=rlRedistribute, rlRedistRoutMapName=rlRedistRoutMapName, rlRedistDstProtocol=rlRedistDstProtocol, rlRedistSubnets=rlRedistSubnets, rlRedistSrcProtocol=rlRedistSrcProtocol, RlRedistMatchType=RlRedistMatchType, RlRedistSrcProtocol=RlRedistSrcProtocol, rlRedistRowStatus=rlRedistRowStatus, rlRedistMetricValue=rlRedistMetricValue, rlRedistMetricType=rlRedistMetricType, RlRedistMetricType=RlRedistMetricType, rlRedistSrcProcessId=rlRedistSrcProcessId, rlRedistOnlyNSSA=rlRedistOnlyNSSA, rlRedistMatchType=rlRedistMatchType)
