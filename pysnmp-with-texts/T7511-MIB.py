...
# Produced by pysmi-0.3.4 at Wed May  1 15:15:24 2019
...
ObjectIdentity, Counter64, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, NotificationType, Gauge32, Unsigned32, IpAddress, TimeTicks, enterprises, iso, Bits, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Counter64", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "NotificationType", "Gauge32", "Unsigned32", "IpAddress", "TimeTicks", "enterprises", "iso", "Bits", "Counter32")
...
mibBuilder.exportSymbols("T7511-MIB", settingsint=settingsint, readings=readings, DisplayString=DisplayString, pressure=pressure, humiditylow=humiditylow, temperaturei=temperaturei, temperature=temperature, presslow=presslow, presstime=presstime, temptime=temptime, traps=traps, humidityHyst=humidityHyst, pressurei=pressurei, cvhighi=cvhighi, presstimei=presstimei, alarmTemperature=alarmTemperature, histhumidity=histhumidity, t7511=t7511, tempHyst=tempHyst, presshighi=presshighi, cvHysti=cvHysti, humidityTime=humidityTime, tempHysti=tempHysti, humidityHysti=humidityHysti, cvTime=cvTime, alarmhumidity=alarmhumidity, historyEntry=historyEntry, histtemperature=histtemperature, templow=templow, historyTable=historyTable, humidity=humidity, alarmPressure=alarmPressure, humiditylowi=humiditylowi, tables=tables, cvlow=cvlow, histcomputedValue=histcomputedValue, pressureHyst=pressureHyst, histpressure=histpressure, computedValue=computedValue, readingsint=readingsint, humidityi=humidityi, cvHyst=cvHyst, cvhigh=cvhigh, humidityhigh=humidityhigh, templowi=templowi, temphighi=temphighi, humidityhighi=humidityhighi, messageString=messageString, pressHysti=pressHysti, settings=settings, presshigh=presshigh, cvTimei=cvTimei, alarmCv=alarmCv, temptimei=temptimei, cvlowi=cvlowi, products=products, cvi=cvi, presslowi=presslowi, humidityTimei=humidityTimei, comet=comet, temphigh=temphigh)
