...
# ASN.1 source file:///home/tin/Dev/mibs.snmplabs.com/asn1/A3COM-DLSW-R1-MIB
# Produced by pysmi-0.3.4 at Fri Jan 31 21:32:18 2020
...
Gauge32, ModuleIdentity, ObjectIdentity, Counter64, Bits, Unsigned32, Counter32, iso, enterprises, NotificationType, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Integer32, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "ObjectIdentity", "Counter64", "Bits", "Unsigned32", "Counter32", "iso", "enterprises", "NotificationType", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Integer32", "MibIdentifier", "IpAddress")
...
mibBuilder.exportSymbols("A3COM-DLSW-R1-MIB", dlswTConnConfigInitCirRecvWndw=dlswTConnConfigInitCirRecvWndw, dlswTConnOperDiscTime=dlswTConnOperDiscTime, dlswTConnStatActiveConnections=dlswTConnStatActiveConnections, dlswDirNBEntryType=dlswDirNBEntryType, dlswCircuitFCResetOpSents=dlswCircuitFCResetOpSents, EndStationLocation=EndStationLocation, dlswCircuitS1DlcType=dlswCircuitS1DlcType, Instancepointer=Instancepointer, dlswTConn=dlswTConn, dlswDirMacMac=dlswDirMacMac, dlswTConnConfigTDomain=dlswTConnConfigTDomain, dlswTConnOperDiscReason=dlswTConnOperDiscReason, dlswTConnConfigLastModifyTime=dlswTConnConfigLastModifyTime, dlswMIB_3Com=dlswMIB_3Com, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, a3Com=a3Com, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, brouterMIB=brouterMIB, dlswCircuitPriority=dlswCircuitPriority, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswTConnConfigRemoteTAddr=dlswTConnConfigRemoteTAddr, dlswTConnOperPartnerNBExcl=dlswTConnOperPartnerNBExcl, dlswTConnOperNQexSents=dlswTConnOperNQexSents, dlswTConnOperCirCreates=dlswTConnOperCirCreates, dlswDirNBLocation=dlswDirNBLocation, dlswTConnOperRemoteTAddr=dlswTConnOperRemoteTAddr, dlswTConnConfigTable=dlswTConnConfigTable, dlswTConnOperState=dlswTConnOperState, dlswDirCache=dlswDirCache, dlswTConnOperEntryTime=dlswTConnOperEntryTime, dlswTConnOperPartnerMacInfo=dlswTConnOperPartnerMacInfo, dlswTConnOperPartnerVersion=dlswTConnOperPartnerVersion, dlswTConnConfigEntryType=dlswTConnConfigEntryType, dlswResourceNBExclusivity=dlswResourceNBExclusivity, TAddress=TAddress, dlswTConnOperPartnerInitPacingWndw=dlswTConnOperPartnerInitPacingWndw, dlswTConnOperLocalTAddr=dlswTConnOperLocalTAddr, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswTConnConfigLocalTAddr=dlswTConnConfigLocalTAddr, dlswTConnConfigOpens=dlswTConnConfigOpens, LFSize=LFSize, dlswCircuitFCResetOpRcvds=dlswCircuitFCResetOpRcvds, dlswVersionString=dlswVersionString, dlswTConnOperOutCntlPkts=dlswTConnOperOutCntlPkts, dlswDirNBName=dlswDirNBName, dlswDirMacEntries=dlswDirMacEntries, dlswSdlc=dlswSdlc, RowStatus=RowStatus, dlswCircuitCreates=dlswCircuitCreates, dlswCircuitTable=dlswCircuitTable, dlswCircuitStateTime=dlswCircuitStateTime, dlswCircuitEntry=dlswCircuitEntry, dlswTConnOperPartnerMacExcl=dlswTConnOperPartnerMacExcl, dlswCircuitOrigin=dlswCircuitOrigin, dlswCircuitDiscReasonRemoteData=dlswCircuitDiscReasonRemoteData, dlswCircuit=dlswCircuit, dlswTConnOperNRexSents=dlswTConnOperNRexSents, dlswCircuitS1RouteInfo=dlswCircuitS1RouteInfo, dlswTConnOperTDomain=dlswTConnOperTDomain, dlswTConnConfigRowStatus=dlswTConnConfigRowStatus, dlswCircuitState=dlswCircuitState, DlswTimeStamp=DlswTimeStamp, dlswTConnConfigSapList=dlswTConnConfigSapList, dlswTConnOperPartnerVendorID=dlswTConnOperPartnerVendorID, dlswCircuitStat=dlswCircuitStat, dlswDirectory=dlswDirectory, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswTConnOperTable=dlswTConnOperTable, dlswTConnConfigGroupDefinition=dlswTConnConfigGroupDefinition, dlswVirtualSegmentLFSize=dlswVirtualSegmentLFSize, dlswTrapTConnDown=dlswTrapTConnDown, dlswTConnOperConfigIndex=dlswTConnOperConfigIndex, NBName=NBName, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswCircuitDiscReasonLocal=dlswCircuitDiscReasonLocal, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswTrapCircuitDown=dlswTrapCircuitDown, dlswTConnOperICRexSents=dlswTConnOperICRexSents, dlswDirMacStatus=dlswDirMacStatus, dlswDirMacEntryType=dlswDirMacEntryType, dlswDirNBRowStatus=dlswDirNBRowStatus, dlswDirNBEntry=dlswDirNBEntry, dlswDirMacTable=dlswDirMacTable, dlswDirNBIndex=dlswDirNBIndex, dlswTConnOperPartnerVersionStr=dlswTConnOperPartnerVersionStr, dlswDirNBEntries=dlswDirNBEntries, dlswNode=dlswNode, dlswTConnConfigSetupType=dlswTConnConfigSetupType, Truthvalue=Truthvalue, DlcType=DlcType, dlswInterface=dlswInterface, dlswVendorID=dlswVendorID, dlswTConnOperICRexRcvds=dlswTConnOperICRexRcvds, dlswDirMacMask=dlswDirMacMask, dlswTConnOperNRexRcvds=dlswTConnOperNRexRcvds, dlswResourceMacExclusivity=dlswResourceMacExclusivity, dlswDirNBStatus=dlswDirNBStatus, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswDirStat=dlswDirStat, dlswDirMacLFSize=dlswDirMacLFSize, dlswTConnOperInDataPkts=dlswTConnOperInDataPkts, dlswTConnOperCURexSents=dlswTConnOperCURexSents, dlswCircuitS1Dlc=dlswCircuitS1Dlc, dlswTConnOperCURexRcvds=dlswTConnOperCURexRcvds, dlswTConnOperPartnerNBInfo=dlswTConnOperPartnerNBInfo, dlswDirMacEntry=dlswDirMacEntry, dlswStdPacingSupport=dlswStdPacingSupport, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswCircuitS2TDomain=dlswCircuitS2TDomain, dlswTrapCircuitUp=dlswTrapCircuitUp, dlswCircuitFCHalveWndwRcvds=dlswCircuitFCHalveWndwRcvds, dlswTConnStat=dlswTConnStat, dlswVersion=dlswVersion, dlswTConnOperDiscActiveCir=dlswTConnOperDiscActiveCir, dlswTConnStatCloseIdles=dlswTConnStatCloseIdles, dlswTrapCntlCircuit=dlswTrapCntlCircuit, dlswDirNBLocationType=dlswDirNBLocationType, dlswTConnOperOutDataPkts=dlswTConnOperOutDataPkts, dlswStatus=dlswStatus, dlswDirMacRowStatus=dlswDirMacRowStatus, dlswDirNBLFSize=dlswDirNBLFSize, dlswTrapTConnUp=dlswTrapTConnUp, dlswDirMacIndex=dlswDirMacIndex, dlswTConnOperInCntlPkts=dlswTConnOperInCntlPkts, dlswTConnStatCloseBusys=dlswTConnStatCloseBusys, dlswTConnOperOutDataOctets=dlswTConnOperOutDataOctets, dlswDirMacLocation=dlswDirMacLocation, dlswDirNBTable=dlswDirNBTable, MacAddress=MacAddress, dlswTConnOperCircuits=dlswTConnOperCircuits, dlswActiveCircuits=dlswActiveCircuits, dlswCircuitS2Location=dlswCircuitS2Location, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswTConnOperEntry=dlswTConnOperEntry, dlswTConnOperConnectTime=dlswTConnOperConnectTime, dlswTrapCntlTConn=dlswTrapCntlTConn, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswTConnConfigIndex=dlswTConnConfigIndex, dlswTConnConfigEntry=dlswTConnConfigEntry, dlswCircuitDiscReasonRemote=dlswCircuitDiscReasonRemote, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswTrapControl=dlswTrapControl, dlswUpTime=dlswUpTime, dlswDirMacLocationType=dlswDirMacLocationType, dlswTConnOperNQexRcvds=dlswTConnOperNQexRcvds, dlswDirNBNameType=dlswDirNBNameType, dlswTConnOperFlowCntlMode=dlswTConnOperFlowCntlMode, dlswTConnOperInDataOctets=dlswTConnOperInDataOctets, dlswTraps=dlswTraps, dlswTConnOperPartnerSapList=dlswTConnOperPartnerSapList, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswTConnConfigAdvertiseMacNB=dlswTConnConfigAdvertiseMacNB, dlswCircuitFCHalveWndwSents=dlswCircuitFCHalveWndwSents)
