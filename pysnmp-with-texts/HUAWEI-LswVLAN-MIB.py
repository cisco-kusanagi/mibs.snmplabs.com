...
NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Counter32, IpAddress, Integer32, Counter64, Gauge32, ObjectIdentity, ModuleIdentity, Bits, Unsigned32, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Counter32", "IpAddress", "Integer32", "Counter64", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Bits", "Unsigned32", "MibIdentifier", "iso")
...
mibBuilder.exportSymbols("HUAWEI-LswVLAN-MIB", hwdot1qVlanPriority=hwdot1qVlanPriority, hwdot1qVlanBatchRowStatus=hwdot1qVlanBatchRowStatus, hwdot1qVlanIpAddress=hwdot1qVlanIpAddress, hwifSuperVlanMappingEntry=hwifSuperVlanMappingEntry, hwdot1qVlanName=hwdot1qVlanName, hwifSuperVlanID=hwifSuperVlanID, hwVlanInterfaceIndex=hwVlanInterfaceIndex, hwdot1qVlanTaggedPorts=hwdot1qVlanTaggedPorts, hwVlanInterfaceIfIndex=hwVlanInterfaceIfIndex, hwdot1qVlanMIBEntry=hwdot1qVlanMIBEntry, hwdot1qVlanMulticast=hwdot1qVlanMulticast, hwVlanInterfaceIpAddr=hwVlanInterfaceIpAddr, hwdot1qVlanPorts=hwdot1qVlanPorts, hwLswVlan=hwLswVlan, PYSNMP_MODULE_ID=hwLswVlan, hwLswVlanProtoObject=hwLswVlanProtoObject, hwifSuperVlanMappingTable=hwifSuperVlanMappingTable, hwifSubVlanlistLow=hwifSubVlanlistLow, hwVlanInterfaceFrameType=hwVlanInterfaceFrameType, hwdot1qVlanType=hwdot1qVlanType, hwdot1qVlanMacFilter=hwdot1qVlanMacFilter, hwVlanInterfaceTable=hwVlanInterfaceTable, hwVLANMibSwitchGVRPRXPkt=hwVLANMibSwitchGVRPRXPkt, hwdot1qVlanBroadcastSuppression=hwdot1qVlanBroadcastSuppression, hwdot1qVlanBcastSuppressionPPS=hwdot1qVlanBcastSuppressionPPS, hwdot1qVlanBatchOperIndex=hwdot1qVlanBatchOperIndex, hwdot1qVlanBatchSetOperate=hwdot1qVlanBatchSetOperate, hwExistInterface=hwExistInterface, hwdot1qVlanBatchStartIndex=hwdot1qVlanBatchStartIndex, hwdot1qVlanUntaggedPorts=hwdot1qVlanUntaggedPorts, hwVLANMibSwitchDiscardedPkt=hwVLANMibSwitchDiscardedPkt, hwVlanInterfaceAddrEntry=hwVlanInterfaceAddrEntry, hwDot1qVlanBatchMIBEntry=hwDot1qVlanBatchMIBEntry, hwdot1qVlanBatchEndIndex=hwdot1qVlanBatchEndIndex, hwVlanInterfaceIpRowStatus=hwVlanInterfaceIpRowStatus, hwifSubVlanlistHigh=hwifSubVlanlistHigh, hwVlanInterfaceID=hwVlanInterfaceID, hwdot1qVlanMacLearn=hwdot1qVlanMacLearn, hwvLANMibSwitchCountTable=hwvLANMibSwitchCountTable, hwVlanInterfaceIpType=hwVlanInterfaceIpType, hwdot1qVlanMIBTable=hwdot1qVlanMIBTable, hwdot1qVlanIpAddressMask=hwdot1qVlanIpAddressMask, hwifIsolateMappingTable=hwifIsolateMappingTable, hwifIsolateSecondaryVlanlistHigh=hwifIsolateSecondaryVlanlistHigh, hwVLANMibSwitchGMRPTXPkt=hwVLANMibSwitchGMRPTXPkt, hwVLANMibSwitchGVRPTXPkt=hwVLANMibSwitchGVRPTXPkt, hwvLANMibHoldTimeTable=hwvLANMibHoldTimeTable, hwVLANMibHoldTime=hwVLANMibHoldTime, hwInterfaceRowStatus=hwInterfaceRowStatus, hwdot1qVlanCreationTime=hwdot1qVlanCreationTime, hwvLANMibHoldTimeEntry=hwvLANMibHoldTimeEntry, hwVlanInterfaceEntry=hwVlanInterfaceEntry, hwdot1qVlanIndex=hwdot1qVlanIndex, hwdot1qVlanPortIndexs=hwdot1qVlanPortIndexs, hwLswVlanMngObject=hwLswVlanMngObject, hwifIsolatePrimaryVlanID=hwifIsolatePrimaryVlanID, HwVlanIndex=HwVlanIndex, hwVlanInterfaceIpIfIndex=hwVlanInterfaceIpIfIndex, hwVLANMibSwitchGarpStatClear=hwVLANMibSwitchGarpStatClear, hwifIsolateMappingEntry=hwifIsolateMappingEntry, hwifIsolateSecondaryVlanlistLow=hwifIsolateSecondaryVlanlistLow, hwVlanInterfaceIpMethod=hwVlanInterfaceIpMethod, hwdot1qVlanStatus=hwdot1qVlanStatus, hwdot1qVlanRowStatus=hwdot1qVlanRowStatus, hwdot1qVlanBatchOperStatus=hwdot1qVlanBatchOperStatus, hwvLANMibSwitchCountEntry=hwvLANMibSwitchCountEntry, hwdot1qVlanBatchMIBTable=hwdot1qVlanBatchMIBTable, hwVlanInterfaceIpMask=hwVlanInterfaceIpMask, hwVlanInterfaceAddrTable=hwVlanInterfaceAddrTable, hwVlanInterfaceAdminStatus=hwVlanInterfaceAdminStatus, hwVLANMibGarpLeaveAllTime=hwVLANMibGarpLeaveAllTime, hwdot1qVlanID=hwdot1qVlanID, hwdot1qVlanMcastUnknownProtos=hwdot1qVlanMcastUnknownProtos, hwVLANMibSwitchGMRPRXPkt=hwVLANMibSwitchGMRPRXPkt)
