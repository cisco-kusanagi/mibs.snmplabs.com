...
# Produced by pysmi-0.3.4 at Wed May  1 13:46:57 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ObjectIdentity, Gauge32, ModuleIdentity, Integer32, Counter64, NotificationType, iso, MibIdentifier, TimeTicks, Unsigned32, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ObjectIdentity", "Gauge32", "ModuleIdentity", "Integer32", "Counter64", "NotificationType", "iso", "MibIdentifier", "TimeTicks", "Unsigned32", "Counter32", "IpAddress")
...
mibBuilder.exportSymbols("HUAWEI-MLSR-DEV-ADM-MIB", hwBuffer32FreeError2=hwBuffer32FreeError2, hwBuffer128Free=hwBuffer128Free, hwBuffer45KFree=hwBuffer45KFree, loghostTable=loghostTable, hwBuzzerStatus=hwBuzzerStatus, hwBuffer32Free=hwBuffer32Free, hwBuffer512FreeError2=hwBuffer512FreeError2, hwBuffer4096FreeError2=hwBuffer4096FreeError2, hwFlashMan=hwFlashMan, logfilterEntry=logfilterEntry, hwBuffer2048DropCounts=hwBuffer2048DropCounts, vrp=vrp, hwFlhUnusedSize=hwFlhUnusedSize, hwBuffer512FreeError3=hwBuffer512FreeError3, hwmHostHwVersion=hwmHostHwVersion, hwBuffer8192FreeError2=hwBuffer8192FreeError2, moduleSwVersion=moduleSwVersion, hwConfigFile=hwConfigFile, hwBuffer8192Used=hwBuffer8192Used, hwFlhTotalSize=hwFlhTotalSize, hwBuffer512Size=hwBuffer512Size, hwBuffer1024FreeError2=hwBuffer1024FreeError2, hwRunCfgSavedTime=hwRunCfgSavedTime, hwBuffer4096CollectCounts=hwBuffer4096CollectCounts, loghostaddress=loghostaddress, hwBuffer45KDropCounts=hwBuffer45KDropCounts, hwMemoryMallocNoMem=hwMemoryMallocNoMem, hwModuleId=hwModuleId, hwCpuCostRatePer5Minute=hwCpuCostRatePer5Minute, hwBuffer32Size=hwBuffer32Size, moduleSlotNum=moduleSlotNum, hwBuffer256KFreeError2=hwBuffer256KFreeError2, hwBuffer256KDropCounts=hwBuffer256KDropCounts, hwRunCfgChangedTime=hwRunCfgChangedTime, hwBuffer8192Free=hwBuffer8192Free, huaweiMixinfo=huaweiMixinfo, hwBuffer512DropCounts=hwBuffer512DropCounts, hwNetConfigName=hwNetConfigName, hwBuffer4096Used=hwBuffer4096Used, hwBuffer32Total=hwBuffer32Total, hwBuffer2048FreeError3=hwBuffer2048FreeError3, HwFlashStatus=HwFlashStatus, hwBuffer8192Total=hwBuffer8192Total, hwBuffer2048Free=hwBuffer2048Free, hwBuffer128DropCounts=hwBuffer128DropCounts, hwNVRAMUsed=hwNVRAMUsed, hwFlhEraseTime=hwFlhEraseTime, hwBuffer128Total=hwBuffer128Total, hwBuffer4096Total=hwBuffer4096Total, hwBuffer256KFree=hwBuffer256KFree, hwmSystem=hwmSystem, hwBuffer32FreeError3=hwBuffer32FreeError3, hwBuffer256Free=hwBuffer256Free, hwBuffer256FreeError3=hwBuffer256FreeError3, hwBuffer4096Size=hwBuffer4096Size, hwBuffer4096FreeError3=hwBuffer4096FreeError3, logfilterIndex=logfilterIndex, hwTFTPEnabled=hwTFTPEnabled, hwFlhEraseStat=hwFlhEraseStat, hwMemoryLargestFree=hwMemoryLargestFree, hwBuffer4096Free=hwBuffer4096Free, hwMemoryMallocFail=hwMemoryMallocFail, hwBuffer1024FreeError3=hwBuffer1024FreeError3, hwBuffer64Total=hwBuffer64Total, hwBuffer45KFreeError2=hwBuffer45KFreeError2, hwCpuCostRatePer5Sec=hwCpuCostRatePer5Sec, hwBuffer1024Total=hwBuffer1024Total, logcontroller=logcontroller, hwStartCfgChangedTime=hwStartCfgChangedTime, moduleNumberOfPorts=moduleNumberOfPorts, hwBuffer64Size=hwBuffer64Size, hwBuffer32DropCounts=hwBuffer32DropCounts, moduleEntry=moduleEntry, hwBuffer128Size=hwBuffer128Size, hwBuffer64Used=hwBuffer64Used, hwBuffer128FreeError2=hwBuffer128FreeError2, hwBuffer1024Size=hwBuffer1024Size, hwBuffer256KFreeError3=hwBuffer256KFreeError3, module=module, hwBuffer256CollectCounts=hwBuffer256CollectCounts, loghostfacility=loghostfacility, basis=basis, hwBuffer512Used=hwBuffer512Used, hwNVRAMSize=hwNVRAMSize, version=version, loghoststatus=loghoststatus, log=log, hwBuffer2048CollectCounts=hwBuffer2048CollectCounts, hwBuffer1024Free=hwBuffer1024Free, hwRAMSize=hwRAMSize, hwmHostName=hwmHostName, hwBuffer45KUsed=hwBuffer45KUsed, RowStatus=RowStatus, hwBuffer128FreeError3=hwBuffer128FreeError3, hwBuffer8192FreeError3=hwBuffer8192FreeError3, HwFlashEreaseStatus=HwFlashEreaseStatus, hwmWhyReboot=hwmWhyReboot, hwBuffer128CollectCounts=hwBuffer128CollectCounts, attr=attr, hwBuffer256KUsed=hwBuffer256KUsed, hwBuffer512Free=hwBuffer512Free, hwBuffer256Total=hwBuffer256Total, hwBuffer256FreeError2=hwBuffer256FreeError2, hwBuffer512Total=hwBuffer512Total, hwBuffer2048Size=hwBuffer2048Size, hwBuffer1024DropCounts=hwBuffer1024DropCounts, hwROMSysVersion=hwROMSysVersion, hwBuffer8192CollectCounts=hwBuffer8192CollectCounts, hwBuffer32Used=hwBuffer32Used, hwmRouterSerialNO=hwmRouterSerialNO, hwBuffer45KFreeError3=hwBuffer45KFreeError3, hwFlhCurStat=hwFlhCurStat, hwBuffer1024Used=hwBuffer1024Used, hwBuffer256Used=hwBuffer256Used, hwHostConfigName=hwHostConfigName, routerGeneral=routerGeneral, loghostaccess=loghostaccess, hwBuffer45KTotal=hwBuffer45KTotal, loghostEntry=loghostEntry, logfilterTable=logfilterTable, hwBuffer8192DropCounts=hwBuffer8192DropCounts, hwBuffer45KSize=hwBuffer45KSize, huaweiMemoryMan=huaweiMemoryMan, loghostlanguage=loghostlanguage, hwCurrentTime=hwCurrentTime, hwFansStatus=hwFansStatus, hwBuffer2048Used=hwBuffer2048Used, hwConfigReg=hwConfigReg, hwUsedMemory=hwUsedMemory, hwBuffer4096DropCounts=hwBuffer4096DropCounts, loghostseverity=loghostseverity, hwBuffer64FreeError2=hwBuffer64FreeError2, hwBuffer64Free=hwBuffer64Free, hwBuffer2048Total=hwBuffer2048Total, hwBuffer32CollectCounts=hwBuffer32CollectCounts, hwBuffer64DropCounts=hwBuffer64DropCounts, hwBuffer2048FreeError2=hwBuffer2048FreeError2, hwConfigRegNextReboot=hwConfigRegNextReboot, hwSysAirFlowTempIn=hwSysAirFlowTempIn, trap=trap, hwBuffer128Used=hwBuffer128Used, hwBuffer8192Size=hwBuffer8192Size, loghostIndex=loghostIndex, loghostport=loghostport, moduleVersion=moduleVersion, moduleType=moduleType, moduleFirstPort=moduleFirstPort, hwBuffer64CollectCounts=hwBuffer64CollectCounts, hwBuffer256KCollectCounts=hwBuffer256KCollectCounts, hwBuffer256Size=hwBuffer256Size, logfilterstatus=logfilterstatus, moduleIndex=moduleIndex, hwFreeMemory=hwFreeMemory, hwBuffer256KTotal=hwBuffer256KTotal, moduleTable=moduleTable, hwBuffer64FreeError3=hwBuffer64FreeError3, moduleHwVersion=moduleHwVersion, hwMemoryFree=hwMemoryFree, hwPowerStatus=hwPowerStatus, logdevfacility=logdevfacility, hwBuffer45KCollectCounts=hwBuffer45KCollectCounts, hwBuffer256DropCounts=hwBuffer256DropCounts, hwBuffer512CollectCounts=hwBuffer512CollectCounts, hwBuffer256KSize=hwBuffer256KSize, hwSecondPowerStatus=hwSecondPowerStatus, hwBuffer1024CollectCounts=hwBuffer1024CollectCounts, hwROMVersion=hwROMVersion, hwROMID=hwROMID)
