...
# Produced by pysmi-0.3.4 at Wed May  1 15:13:51 2019
...
MibIdentifier, iso, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Unsigned32, enterprises, NotificationType, IpAddress, Integer32, Counter64, NotificationType, ObjectIdentity, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "iso", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Unsigned32", "enterprises", "NotificationType", "IpAddress", "Integer32", "Counter64", "NotificationType", "ObjectIdentity", "Bits", "TimeTicks")
...
if mibBuilder.loadTexts: storageDevicesTrap1.setDescription('Self-Monitoring Warning (predictive failure - data recovery possible)')
...
if mibBuilder.loadTexts: storageDevicesTrap2.setDescription('Self-Monitoring Warning (predictive failure - data recovery questionable)')
...
if mibBuilder.loadTexts: storageControllerTrap3.setDescription('Storage Controller Error (not responding)')
...
if mibBuilder.loadTexts: massStorageAssociationTrap4.setDescription('New Storage controller detected')
...
if mibBuilder.loadTexts: massStorageAssociationTrap5.setDescription('New device detected')
...
if mibBuilder.loadTexts: massStorageAssociationTrap6.setDescription('Existing controller changed')
...
if mibBuilder.loadTexts: massStorageAssociationTrap7.setDescription('Existing device changed')
mibBuilder.exportSymbols("SYMBIOSDMI20MIFDEFINITION-MIB", a9ConnectorGender=a9ConnectorGender, a12EventSystem=a12EventSystem, a24EventType=a24EventType, a5FormattedMediaCapacity=a5FormattedMediaCapacity, a9BusPortIndex=a9BusPortIndex, DmiInteger=DmiInteger, a16SmartReportingCapability=a16SmartReportingCapability, tEventGenerationForFans=tEventGenerationForFans, a5Sub_identifier=a5Sub_identifier, a5MediaLoaded=a5MediaLoaded, a15SmartEventPolling=a15SmartEventPolling, a17TemperatureOutOfRange=a17TemperatureOutOfRange, eMiftomib=eMiftomib, a22DataRate=a22DataRate, a12EventIsStateBased=a12EventIsStateBased, a25EventSystem=a25EventSystem, a11Reference2=a11Reference2, a6EventSubsystem=a6EventSubsystem, eOperationalState=eOperationalState, a19Status=a19Status, a5RemovableDevice=a5RemovableDevice, a5DeviceLoaded=a5DeviceLoaded, eSaf_teControlledPowerSupply=eSaf_teControlledPowerSupply, DmiInteger64X=DmiInteger64X, a22CurrentNetworkAddress=a22CurrentNetworkAddress, a5Type=a5Type, a14CurrentErrorStatus=a14CurrentErrorStatus, a26EventMessage=a26EventMessage, a17Saf_teSpecificationRevisionLevel=a17Saf_teSpecificationRevisionLevel, a24EventMessage=a24EventMessage, a99DisableTrap=a99DisableTrap, a9MaximumWidth=a9MaximumWidth, tStorageDevicesEvents=tStorageDevicesEvents, a10FabricTopology=a10FabricTopology, a24EventStateKey=a24EventStateKey, a26EventSubsystem=a26EventSubsystem, a21Saf_teControlledTemperatureSensorInde=a21Saf_teControlledTemperatureSensorInde, a7BusMaster=a7BusMaster, a16SymSmartDeviceIndex=a16SymSmartDeviceIndex, cosprings=cosprings, a17ScsiId=a17ScsiId, massStorageAssociationTrap6=massStorageAssociationTrap6, a17EnclosureUniqueIdentifier=a17EnclosureUniqueIdentifier, a17SpeakerStatus=a17SpeakerStatus, eWorldwideIdentifer=eWorldwideIdentifer, eComponentid=eComponentid, a20ParityCheck=a20ParityCheck, a4PartNumber=a4PartNumber, a21Temperature=a21Temperature, tEventGenerationForTemperatureProbe=tEventGenerationForTemperatureProbe, a2Description=a2Description, a9Isochronous=a9Isochronous, eSymbiosEventPolling=eSymbiosEventPolling, a1Product=a1Product, tSaf_teProcessor=tSaf_teProcessor, massStorageAssociationTrap5=massStorageAssociationTrap5, tFieldReplaceableUnit=tFieldReplaceableUnit, a14DevicePredictedFailureStatus=a14DevicePredictedFailureStatus, a4FruInternetUniformResourceLocator=a4FruInternetUniformResourceLocator, a6AssociatedGroup=a6AssociatedGroup, a4Description=a4Description, a17StorageControllerIndex=a17StorageControllerIndex, storageDevicesTrap2=storageDevicesTrap2, a21Saf_teProcessorIndex=a21Saf_teProcessorIndex, a14WarningErrorCount=a14WarningErrorCount, a23BusType=a23BusType, a25EventType=a25EventType, a14OperationalStateInstanceIndex=a14OperationalStateInstanceIndex, scsi=scsi, a8EventSystem=a8EventSystem, eEventGenerationForTemperatureProbe=eEventGenerationForTemperatureProbe, a12EventStateKey=a12EventStateKey, tWorldwideIdentifer=tWorldwideIdentifer, a7ProtectionManagement=a7ProtectionManagement, a20State=a20State, a23TransmissionCapability=a23TransmissionCapability, a23BusWidth=a23BusWidth, a6StorageDevicesEventType=a6StorageDevicesEventType, a19Saf_teProcessorIndex=a19Saf_teProcessorIndex, eNetworkAdapter802PortGroup=eNetworkAdapter802PortGroup, a2InterfaceVersion=a2InterfaceVersion, a2SoftwareIndex=a2SoftwareIndex, a18Status=a18Status, a26EventType=a26EventType, tMiftomib=tMiftomib, a11Type=a11Type, eEventGenerationForFans=eEventGenerationForFans, a15ScanEventPolling=a15ScanEventPolling, tSaf_teControlledTemperatureSensor=tSaf_teControlledTemperatureSensor, a15Saf_teEventPolling=a15Saf_teEventPolling, a24EventSystem=a24EventSystem, a3WorldwideIdentifier=a3WorldwideIdentifier, a4Model=a4Model, tSymbiosSmartDevice=tSymbiosSmartDevice, tSaf_teControlledSlot=tSaf_teControlledSlot, a20Saf_teProcessorIndex=a20Saf_teProcessorIndex, massStorageAssociationTrap4=massStorageAssociationTrap4, a5Compression=a5Compression, DmiDisplaystring=DmiDisplaystring, a13BusPortAssociationIndex=a13BusPortAssociationIndex, a18Saf_teControlledFanIndex=a18Saf_teControlledFanIndex, a26IsEventState_based=a26IsEventState_based, a2IdentificationCode=a2IdentificationCode, a12AssociatedGroup=a12AssociatedGroup, tStorageDevices=tStorageDevices, a13NegotiatedWidth=a13NegotiatedWidth, storageDevicesTrap1=storageDevicesTrap1, tSaf_teControlledPowerSupply=tSaf_teControlledPowerSupply, a99MibName=a99MibName, storageControllerTrap3=storageControllerTrap3, a18Saf_teProcessorIndex=a18Saf_teProcessorIndex, a25IsEventState_based=a25IsEventState_based, eSaf_teProcessor=eSaf_teProcessor, a2Version=a2Version, a17PowerOnCycles=a17PowerOnCycles, a10FlowControlClassType=a10FlowControlClassType, a9SignalCharacteristics=a9SignalCharacteristics, a26AssociatedGroup=a26AssociatedGroup, tSaf_teControlledFan=tSaf_teControlledFan, a14DeviceGroupIndex=a14DeviceGroupIndex, tBusPort=tBusPort, a6EventSeverity=a6EventSeverity, a24AssociatedGroup=a24AssociatedGroup, a17HasSpeakers=a17HasSpeakers, a10BusPortIndex=a10BusPortIndex, a26IsInstanceDataPresent=a26IsInstanceDataPresent, a25EventSeverity=a25EventSeverity, a6EventIsStateBased=a6EventIsStateBased, a4Manufacturer=a4Manufacturer, eMassStorageAssociation=eMassStorageAssociation, id19=id19, a12EventSeverity=a12EventSeverity, a17VendorId=a17VendorId, tSymbiosEventPolling=tSymbiosEventPolling, a14AdministrativeState=a14AdministrativeState, a12MassStorageAssociationEventType=a12MassStorageAssociationEventType, a9ProtocolDescription=a9ProtocolDescription, a11Reference1=a11Reference1, a17Saf_teProcessorIndex=a17Saf_teProcessorIndex, a4RevisionLevel=a4RevisionLevel, a14AvailabilityStatus=a14AvailabilityStatus, eNetworkAdapterHardwareGroup=eNetworkAdapterHardwareGroup, a2Vendor=a2Vendor, a4FruSerialNumber=a4FruSerialNumber, a15EventPollingPeriod=a15EventPollingPeriod, eSaf_teControlledFan=eSaf_teControlledFan, a7ControllerIndex=a7ControllerIndex, DmiCounter=DmiCounter, a10LinkType=a10LinkType, eStorageDevices=eStorageDevices, tMassStorageAssociationEvents=tMassStorageAssociationEvents, eStorageController=eStorageController, eMassStorageAssociationEvents=eMassStorageAssociationEvents, a10EndToEndCredit=a10EndToEndCredit, a26EventSeverity=a26EventSeverity, fam8xx=fam8xx, a99MibOid=a99MibOid, a25EventSubsystem=a25EventSubsystem, DmiDateX=DmiDateX, tNetworkAdapterHardwareGroup=tNetworkAdapterHardwareGroup, a4FruIndex=a4FruIndex, a20NumberOfInsertions=a20NumberOfInsertions, tStorageController=tStorageController, a1Version=a1Version, a10FlowControlAcknowledgmentType=a10FlowControlAcknowledgmentType, a8EventIsStateBased=a8EventIsStateBased, a8EventSubsystem=a8EventSubsystem, a8EventStateKey=a8EventStateKey, tComponentid=tComponentid, a3WorldwideIdentifierIndex=a3WorldwideIdentifierIndex, a24IsEventState_based=a24IsEventState_based, tMassStorageAssociation=tMassStorageAssociation, a4WarrantyDuration=a4WarrantyDuration, a17FirmwareRevisionLevel=a17FirmwareRevisionLevel, eSubcomponentSoftware=eSubcomponentSoftware, a1Manufacturer=a1Manufacturer, a17PowerOnMinutes=a17PowerOnMinutes, a9AddressDescriptor=a9AddressDescriptor, a5StorageDeviceIndex=a5StorageDeviceIndex, a17DoorLocked=a17DoorLocked, DmiComponentIndex=DmiComponentIndex, a8AssociatedGroup=a8AssociatedGroup, a14MajorErrorCount=a14MajorErrorCount, a2InterfaceDescription=a2InterfaceDescription, a13NegotiatedSpeed=a13NegotiatedSpeed, a7SecondsSinceLastPower_up=a7SecondsSinceLastPower_up, a5Encryption=a5Encryption, a9MaximumTransferRate=a9MaximumTransferRate, a20PredictedFault=a20PredictedFault, a22PortIndex=a22PortIndex, a14UsageState=a14UsageState, a25EventStateKey=a25EventStateKey, a24EventSubsystem=a24EventSubsystem, a11AssociationIndex=a11AssociationIndex, eFibreChannelBusPortExtensions=eFibreChannelBusPortExtensions, a17ProductId=a17ProductId, tFibreChannelBusPortExtensions=tFibreChannelBusPortExtensions, a5TypeDescription=a5TypeDescription, a20InCriticalArray=a20InCriticalArray, a9Protocol=a9Protocol, a23NetworkTopology=a23NetworkTopology, a2Type=a2Type, a23NetworkAdapterRamSize=a23NetworkAdapterRamSize, eFieldReplaceableUnit=eFieldReplaceableUnit, a15SymbiosFlag=a15SymbiosFlag, a20DeviceFault=a20DeviceFault, a25EventMessage=a25EventMessage, a26EventSystem=a26EventSystem, a14OperationalStatus=a14OperationalStatus, a8StorageControllerEventType=a8StorageControllerEventType, a14FatalErrorCount=a14FatalErrorCount, a9ConnectorType=a9ConnectorType, a8EventSeverity=a8EventSeverity, tOperationalState=tOperationalState, eEventGenerationForPowerSupply=eEventGenerationForPowerSupply, a4SupportPhoneNumber=a4SupportPhoneNumber, a5RemovableMedia=a5RemovableMedia, tStorageControllerEvents=tStorageControllerEvents, tEventGenerationForPowerSupply=tEventGenerationForPowerSupply, a9MaximumNumberOfAttachments=a9MaximumNumberOfAttachments, tNetworkAdapter802PortGroup=tNetworkAdapter802PortGroup, a17ScsiLun=a17ScsiLun, a9ConnectorTypeDescription=a9ConnectorTypeDescription, a6EventSystem=a6EventSystem, a19Saf_teControlledPowerSupplyIndex=a19Saf_teControlledPowerSupplyIndex, a1SerialNumber=a1SerialNumber, a5MediaDataBlockSize=a5MediaDataBlockSize, eBusPortAssociation=eBusPortAssociation, a3WorldwideIdentifierType=a3WorldwideIdentifierType, a24EventSeverity=a24EventSeverity, tBusPortAssociation=tBusPortAssociation, a25IsInstanceDataPresent=a25IsInstanceDataPresent, a20Saf_teControlledSlotIndex=a20Saf_teControlledSlotIndex, dmtfGroups=dmtfGroups, a20Rebuild=a20Rebuild, a22ConnectorType=a22ConnectorType, a4DeviceGroupIndex=a4DeviceGroupIndex, eStorageDevicesEvents=eStorageDevicesEvents, a20ScsiId=a20ScsiId, a10BufferToBufferCredit=a10BufferToBufferCredit, a24IsInstanceDataPresent=a24IsInstanceDataPresent, a26EventStateKey=a26EventStateKey, a6EventStateKey=a6EventStateKey, a1Installation=a1Installation, a12EventSubsystem=a12EventSubsystem, a20InFailedArray=a20InFailedArray, eStorageControllerEvents=eStorageControllerEvents, a2LanguageEdition=a2LanguageEdition, eBusPort=eBusPort, a17HasLocks=a17HasLocks, eSaf_teControlledTemperatureSensor=eSaf_teControlledTemperatureSensor, symbios=symbios, a7Identification=a7Identification, a4WarrantyStartDate=a4WarrantyStartDate)
mibBuilder.exportSymbols("SYMBIOSDMI20MIFDEFINITION-MIB", eSymbiosSmartDevice=eSymbiosSmartDevice, a22PermanentNetworkAddress=a22PermanentNetworkAddress, massStorageAssociationTrap7=massStorageAssociationTrap7, tSubcomponentSoftware=tSubcomponentSoftware, eSaf_teControlledSlot=eSaf_teControlledSlot, a25AssociatedGroup=a25AssociatedGroup, a1Verify=a1Verify)
