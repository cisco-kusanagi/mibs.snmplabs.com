...
# Produced by pysmi-0.3.4 at Wed May  1 14:46:07 2019
...
ObjectIdentity, iso, ModuleIdentity, Integer32, Unsigned32, NotificationType, Counter32, MibIdentifier, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress, TimeTicks, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "ModuleIdentity", "Integer32", "Unsigned32", "NotificationType", "Counter32", "MibIdentifier", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress", "TimeTicks", "Bits")
...
if mibBuilder.loadTexts: rlDhcpCl.setContactInfo('www.marvell.com')
...
if mibBuilder.loadTexts: rlDhcpClEnabledByDefaultRemovedTable.setDescription('DHCP Client flag is relevant when host parameter dhcp_client_active_on_start is TRUE. If the MIB has non zero value the meaning is that DHCP client has removed from configuration by the user on the interface and signs to application not to add DHCP client entry. Otherwise (zero value) - the meaning is that DHCP client entry must be added. ')
...
mibBuilder.exportSymbols("RADLAN-DHCPCL-MIB", rlDhcpClSelectedTftpServerAddress=rlDhcpClSelectedTftpServerAddress, rlDhcpApprovalWaitingAddress=rlDhcpApprovalWaitingAddress, rlDhcpClInformationT2=rlDhcpClInformationT2, rlDhcpApprovalEnabled=rlDhcpApprovalEnabled, rlDhcpClInformationTftpServerListIfIndex=rlDhcpClInformationTftpServerListIfIndex, rlDhcpClActionHostName=rlDhcpClActionHostName, rlDhcpClInformationTimeZone=rlDhcpClInformationTimeZone, rlDhcpClInformationTftpServerListPriority=rlDhcpClInformationTftpServerListPriority, rlDhcpClEnabledByDefaultRemovedIfIndex=rlDhcpClEnabledByDefaultRemovedIfIndex, rlDhcpApprovalActionApprove=rlDhcpApprovalActionApprove, rlDhcpClInformationTftpServerListEntry=rlDhcpClInformationTftpServerListEntry, rlDhcpClAutoConfigProtocol=rlDhcpClAutoConfigProtocol, rlDhcpClActionEntry=rlDhcpClActionEntry, rlDhcpClManualAutoConfigDataTable=rlDhcpClManualAutoConfigDataTable, rlDhcpCl=rlDhcpCl, rlDhcpApprovalWaitingTable=rlDhcpApprovalWaitingTable, rlDhcpClCommandTable=rlDhcpClCommandTable, rlDhcpClInformationDefaultGateway=rlDhcpClInformationDefaultGateway, rlDhcpClAutoUpdateEnabled=rlDhcpClAutoUpdateEnabled, rlDhcpClActionTable=rlDhcpClActionTable, rlDhcpClManualConfigurationFileName=rlDhcpClManualConfigurationFileName, rlDhcpClAutoConfigStatus=rlDhcpClAutoConfigStatus, rlDhcpClActionStatus=rlDhcpClActionStatus, rlDhcpClCommandAction=rlDhcpClCommandAction, rlDhcpApprovalWaitingMask=rlDhcpApprovalWaitingMask, rlDhcpApprovalWaitingGateway=rlDhcpApprovalWaitingGateway, rlDhcpClManualServerInetAddressType=rlDhcpClManualServerInetAddressType, rlDhcpClAutoUpdateProtocol=rlDhcpClAutoUpdateProtocol, rlDhcpClInformationT1=rlDhcpClInformationT1, rlDhcpClAutoUpdateScpFileExtention=rlDhcpClAutoUpdateScpFileExtention, rlDhcpClInformationTftpServerListTable=rlDhcpClInformationTftpServerListTable, rlDhcpClManualTftpServerAddress=rlDhcpClManualTftpServerAddress, rlDhcpClInformationTftpServerName=rlDhcpClInformationTftpServerName, rlDhcpClInformationDnsServerListEntry=rlDhcpClInformationDnsServerListEntry, rlDhcpClSelectedConfigurationFileNameOrigin=rlDhcpClSelectedConfigurationFileNameOrigin, PYSNMP_MODULE_ID=rlDhcpCl, rlDhcpApprovalActionMask=rlDhcpApprovalActionMask, rlDhcpClManualImageIndirectFileName=rlDhcpClManualImageIndirectFileName, rlDhcpApprovalActionTable=rlDhcpApprovalActionTable, rlDhcpClManualServerInetAddress=rlDhcpClManualServerInetAddress, rlDhcpClInformationTftpFileName=rlDhcpClInformationTftpFileName, rlDhcpClInformationIpMask=rlDhcpClInformationIpMask, rlDhcpClInformationEntry=rlDhcpClInformationEntry, rlDhcpClEnabledByDefaultRemovedEntry=rlDhcpClEnabledByDefaultRemovedEntry, rlDhcpClManualAutoConfigDataIndex=rlDhcpClManualAutoConfigDataIndex, rlDhcpClInformationTftpServerListAddress=rlDhcpClInformationTftpServerListAddress, rlDhcpClAutoUpdateStatus=rlDhcpClAutoUpdateStatus, rlDhcpClInformationHostName=rlDhcpClInformationHostName, rlDhcpClOption67Enable=rlDhcpClOption67Enable, rlDhcpClSelectedTftpServerInetAddress=rlDhcpClSelectedTftpServerInetAddress, rlDhcpClEnabledByDefaultRemovedIfindex=rlDhcpClEnabledByDefaultRemovedIfindex, rlDhcpApprovalWaitingIfIndex=rlDhcpApprovalWaitingIfIndex, rlDhcpClManualAutoConfigDataEntry=rlDhcpClManualAutoConfigDataEntry, rlDhcpClInformationTftpImageName=rlDhcpClInformationTftpImageName, rlDhcpClInformationDnsServerListTable=rlDhcpClInformationDnsServerListTable, rlDhcpClEnabledByDefaultRemovedStatus=rlDhcpClEnabledByDefaultRemovedStatus, rlDhcpClInformationDnsServerListPriority=rlDhcpClInformationDnsServerListPriority, rlDhcpClSelectedTftpServerInetAddressType=rlDhcpClSelectedTftpServerInetAddressType, rlDhcpClInformationDomainName=rlDhcpClInformationDomainName, rlDhcpClInformationIpAddress=rlDhcpClInformationIpAddress, rlDhcpApprovalWaitingEntry=rlDhcpApprovalWaitingEntry, rlDhcpClAutoConfigForce=rlDhcpClAutoConfigForce, rlDhcpClSelectedTftpServerAddressOrigin=rlDhcpClSelectedTftpServerAddressOrigin, rlDhcpClCommandEntry=rlDhcpClCommandEntry, rlDhcpClActionIfIndex=rlDhcpClActionIfIndex, rlDhcpApprovalActionAddress=rlDhcpApprovalActionAddress, rlDhcpApprovalActionIfIndex=rlDhcpApprovalActionIfIndex, rlDhcpClInformationTable=rlDhcpClInformationTable, rlDhcpClInformationDnsServerListIfIndex=rlDhcpClInformationDnsServerListIfIndex, rlDhcpClInformationDnsServerListAddress=rlDhcpClInformationDnsServerListAddress, rlDhcpClEnabledByDefaultRemovedTable=rlDhcpClEnabledByDefaultRemovedTable, rlDhcpClInformationIfIndex=rlDhcpClInformationIfIndex, rlDhcpClSelectedConfigurationFileName=rlDhcpClSelectedConfigurationFileName, rlDhcpApprovalActionEntry=rlDhcpApprovalActionEntry, rlDhcpClAutoConfigAutoSave=rlDhcpClAutoConfigAutoSave, rlDhcpClConfigurationFileName=rlDhcpClConfigurationFileName, rlDhcpClAutoConfigScpFileExtention=rlDhcpClAutoConfigScpFileExtention)
