...
iso, enterprises, Gauge32, Counter64, NotificationType, TimeTicks, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, MibIdentifier, ModuleIdentity, ObjectIdentity, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "enterprises", "Gauge32", "Counter64", "NotificationType", "TimeTicks", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Bits", "IpAddress")
...
if mibBuilder.loadTexts: tempager3e_snmp_trap.setDescription('A tempager3e-snmp-trap indicates that an alarm condition has occurred on the sensor indicated by the alarmmessage variable.')
mibBuilder.exportSymbols("TEMPAGER3E-MIB", digital_sen1=digital_sen1, internal=internal, tempager3e_snmp_trap=tempager3e_snmp_trap, TEMPAGER3E=TEMPAGER3E, digital_sen2_4=digital_sen2_4, products=products, digital_sen1_4=digital_sen1_4, internal_tempc=internal_tempc, digital_sen1_2=digital_sen1_2, digital_sen2_1=digital_sen2_1, avtech=avtech, internal_tempf=internal_tempf, digital=digital, digital_sen2_3=digital_sen2_3, alarmmessage=alarmmessage, digital_sen2_2=digital_sen2_2, temperature=temperature, traps=traps, digital_sen1_1=digital_sen1_1, digital_sen2=digital_sen2, digital_sen1_3=digital_sen1_3, sensors=sensors)
