...
# Produced by pysmi-0.3.4 at Wed May  1 14:43:01 2019
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: pysnmpSourceMIB.setRevisionsDescriptions(('Updated addresses', 'Initial Revision',))
...
mibBuilder.exportSymbols("PYSNMP-SOURCE-MIB", snmpSourceAddrEntry=snmpSourceAddrEntry, pysnmpSourceMIB=pysnmpSourceMIB, pysnmpSourceMIBGroups=pysnmpSourceMIBGroups, pysnmpSourceMIBCompliances=pysnmpSourceMIBCompliances, PYSNMP_MODULE_ID=pysnmpSourceMIB, pysnmpSourceMIBObjects=pysnmpSourceMIBObjects, snmpSourceAddrTable=snmpSourceAddrTable, pysnmpSourceMIBConformance=pysnmpSourceMIBConformance, snmpSourceAddrTAddress=snmpSourceAddrTAddress)
