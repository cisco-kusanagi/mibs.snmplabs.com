...
# Produced by pysmi-0.3.4 at Wed May  1 12:39:06 2019
...
Counter32, Gauge32, MibIdentifier, Bits, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, iso, Counter64, NotificationType, Unsigned32, ObjectIdentity, IpAddress, Integer32, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibIdentifier", "Bits", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "iso", "Counter64", "NotificationType", "Unsigned32", "ObjectIdentity", "IpAddress", "Integer32", "enterprises")
...
if mibBuilder.loadTexts: ipv4aclProfileType.setDescription('The ACL Profile type, possible value are l2 (1) - for MAC-based rule. l3v4 (2) - for IPv4-based rule. impb (3) - for IMPB entry. arpSP-permit(4) - for ARP Spoofing prevention entry. arpSP-deny(5) - for ARP Spoofing prevention entry. voiceVlan(6) - for Voice VLAN OUI entry. surveillanceVlan(7) - for Surveillance VLAN OUI entry. aclQoS(8) - for ACL QoS entry. dhcpServerScreen(10) - for DHCP server screening entry. Note that only l2, l3v4 and l3v6 could be set by user, other is reserved for system to show information. ')
...
if mibBuilder.loadTexts: aclProfileType.setDescription('The ACL Profile type, possible value are l2 (1) - for MAC-based rule. l3v4 (2) - for IPv4-based rule. impb (3) - for IMPB entry. l3v6 (11) - for IPv6-based rule. zone defense (12) - for zone defense entry. arpSP-permit(4) - for ARP Spoofing prevention entry. arpSP-deny(5) - for ARP Spoofing prevention entry. voiceVlan(6) - for Voice VLAN OUI entry. surveillanceVlan(7) - for Surveillance VLAN OUI entry. aclQoS(8) - for ACL QoS entry. dhcpServerScreen(10) - for DHCP server screening entry. Note that only l2, l3v4 and l3v6 could be set by user, other is reserved for system to show information. ')
...
mibBuilder.exportSymbols("DES-1210-52-BX", aclL3RuleTcpRstBit=aclL3RuleTcpRstBit, tftpCfgTargetTftpOperation=tftpCfgTargetTftpOperation, voicevlanOUIStatus=voicevlanOUIStatus, autoSurveillanceVlanOUISurveillanceOUI=autoSurveillanceVlanOUISurveillanceOUI, igsVlanMulticastGroupIpAddress=igsVlanMulticastGroupIpAddress, aclL2RuleEtherType=aclL2RuleEtherType, neighborType=neighborType, swTimeRangeSunday=swTimeRangeSunday, dlinkGreenLEDShutoffTimeProfile1=dlinkGreenLEDShutoffTimeProfile1, qosMode=qosMode, laPortActorActivity=laPortActorActivity, dhcpv6RelayInterfaceSettingsTable=dhcpv6RelayInterfaceSettingsTable, igsQueryInterval=igsQueryInterval, swTimeRangeStartMonth=swTimeRangeStartMonth, sysSave=sysSave, sysSNTPDSTEndMin=sysSNTPDSTEndMin, stpPortDesignatedBridge=stpPortDesignatedBridge, cableDiagPair1FaultDistance=cableDiagPair1FaultDistance, qosDiffServType60=qosDiffServType60, aclL2RuleDstMacAddrMask=aclL2RuleDstMacAddrMask, ipv4sysIpAddrCfgMode=ipv4sysIpAddrCfgMode, tftpConfigTftpOperation=tftpConfigTftpOperation, qosDiffServEnable=qosDiffServEnable, companyMiscGroup=companyMiscGroup, sysPortCtrlMDI=sysPortCtrlMDI, snmpV3UserAuthProtocol=snmpV3UserAuthProtocol, sslCipherSuiteList=sslCipherSuiteList, aclL3RuleICMPMessageType=aclL3RuleICMPMessageType, swTimeRangeEndYear=swTimeRangeEndYear, companyACLGroup=companyACLGroup, bandwidthCtrlTxThreshold=bandwidthCtrlTxThreshold, companyQoSGroup=companyQoSGroup, ipv4sysSNTPDSTOffset=ipv4sysSNTPDSTOffset, rmonAlarmTable=rmonAlarmTable, aclL3RulePriority=aclL3RulePriority, ipv4trustedHostRowStatus=ipv4trustedHostRowStatus, qosDiffServType50=qosDiffServType50, staticDisableAutoLearn=staticDisableAutoLearn, sysTrapStateChangeEvent=sysTrapStateChangeEvent, snmpV3HostAddress=snmpV3HostAddress, snmpV3UserAuthProtocolPassword=snmpV3UserAuthProtocolPassword, voicevlanPortCurrentTagMode=voicevlanPortCurrentTagMode, dot1qVlanAsyOnOff=dot1qVlanAsyOnOff, aclv6L3RuleTcpUdpSrcPortMask=aclv6L3RuleTcpUdpSrcPortMask, dhcpServerScreenEnablePortlist=dhcpServerScreenEnablePortlist, qosDiffServType36=qosDiffServType36, sysLBDVlanLoopEntry=sysLBDVlanLoopEntry, aclv6L3RuleTcpSynBit=aclv6L3RuleTcpSynBit, staticMcastEntry=staticMcastEntry, aclL3RuleDstIpAddr=aclL3RuleDstIpAddr, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, staticMcastTable=staticMcastTable, aclProfileSrcIpAddrMaskType=aclProfileSrcIpAddrMaskType, impbInsIpPacPortState=impbInsIpPacPortState, snmpV3UserEntry=snmpV3UserEntry, dot1qVlanManagementOnOff=dot1qVlanManagementOnOff, ipv4aclProfileDstMacAddrMask=ipv4aclProfileDstMacAddrMask, qosTOSType01=qosTOSType01, aclv6L3RuleICMPMessageCode=aclv6L3RuleICMPMessageCode, cableDiagPair2TestResult=cableDiagPair2TestResult, swTimeRangeEndMonth=swTimeRangeEndMonth, dot1xAuth=dot1xAuth, snmpV3CommunityName=snmpV3CommunityName, voiceVlanTimeout=voiceVlanTimeout, qosDiffServType46=qosDiffServType46, ipifV6AddressRowStatus=ipifV6AddressRowStatus, dlink_products=dlink_products, dhcpv6RelayInterfaceSettingsEntry=dhcpv6RelayInterfaceSettingsEntry, stpProtocolSpecification=stpProtocolSpecification, dhcpv6RelayInterfaceSettingsRowStatus=dhcpv6RelayInterfaceSettingsRowStatus, aclv6L3RuleAccessID=aclv6L3RuleAccessID, laStatus=laStatus, swTimeRangeTuesday=swTimeRangeTuesday, ipifV6AddressEntry=ipifV6AddressEntry, dlinklldpState=dlinklldpState, sysSNTPSecondServer=sysSNTPSecondServer, Ipv6Address=Ipv6Address, miscReset=miscReset, trafficSegTable=trafficSegTable, tftpCfgTargetImageFileName=tftpCfgTargetImageFileName, stpPort=stpPort, swRadiusServerAddress=swRadiusServerAddress, dhcpBOOTPRelayOption82RemoteID=dhcpBOOTPRelayOption82RemoteID, igsVlanRouterPortList=igsVlanRouterPortList, qosTOSEnable=qosTOSEnable, dhcpv6RelayOption37RemoteID=dhcpv6RelayOption37RemoteID, ipv4trustedHostIpAddr=ipv4trustedHostIpAddr, RmonStatus=RmonStatus, bandwidthCtrlTable=bandwidthCtrlTable, staticVlanID=staticVlanID, igsQueryMaxResponseTime=igsQueryMaxResponseTime, snmpV3viewTreeMask=snmpV3viewTreeMask, companyIgsGroup=companyIgsGroup, syslogSrvIPType=syslogSrvIPType, stpBridgeHelloTime=stpBridgeHelloTime, dot1xAuthStatus=dot1xAuthStatus, aclL2RuleAction=aclL2RuleAction, stpPortDesignatedRoot=stpPortDesignatedRoot, snmpV3UserPrivProtocolPassword=snmpV3UserPrivProtocolPassword, ipv4aclProfileEntry=ipv4aclProfileEntry, laPortControlTable=laPortControlTable, aclL3RuleTcpFinBit=aclL3RuleTcpFinBit, rmonHistoryTable=rmonHistoryTable, voicevlanDevice=voicevlanDevice, ipifV6AddressMainIndex=ipifV6AddressMainIndex, rmonAlarmSampleType=rmonAlarmSampleType, impbDHCPPortState=impbDHCPPortState, snmpV3CommunityTable=snmpV3CommunityTable, voicevlanOUIMask=voicevlanOUIMask, swTimeRangeStartMinute=swTimeRangeStartMinute, neighborIPv6Addr=neighborIPv6Addr, impbWhiteListEntry=impbWhiteListEntry, igsVlanMulticastGroupTable=igsVlanMulticastGroupTable, ipv4dhcpServerScreenServerIndex=ipv4dhcpServerScreenServerIndex, voicevlanPortControlIndex=voicevlanPortControlIndex, companyTimeRangeMgmt=companyTimeRangeMgmt, sysDdpProtStatusTable=sysDdpProtStatusTable, stpBridgeMaxAge=stpBridgeMaxAge, ipv4trustedHostIpMask=ipv4trustedHostIpMask, aclv6L3RuleReplacePriority=aclv6L3RuleReplacePriority, snmpV3CommunityEntry=snmpV3CommunityEntry, ipv4sysSNTPDSTEndHour=ipv4sysSNTPDSTEndHour, dhcpServerScreenTrustedServerAddress=dhcpServerScreenTrustedServerAddress, igsVlanMulticastGroupPortList=igsVlanMulticastGroupPortList, ipv4sysSNTPDSTStartMin=ipv4sysSNTPDSTStartMin, ipv4aclProfileIPProtocol=ipv4aclProfileIPProtocol, ipv4sysSNTPDSTStartMon=ipv4sysSNTPDSTStartMon, qosDiffServType28=qosDiffServType28, aRPSpoofPreventIpAddr=aRPSpoofPreventIpAddr, rmonStatsEntry=rmonStatsEntry, tftpFwTftpOperation=tftpFwTftpOperation, qosDiffServType10=qosDiffServType10, qosDiffServType52=qosDiffServType52, tftpFwTargetInterfaceName=tftpFwTargetInterfaceName, ipv4syslogSeverity=ipv4syslogSeverity, ipv4aclProfileSrcIpAddrMask=ipv4aclProfileSrcIpAddrMask, sysPortCtrlFlowControlOper=sysPortCtrlFlowControlOper, ipv4sysSNTPSecondServer=ipv4sysSNTPSecondServer, swTimeRangeSaturday=swTimeRangeSaturday, ipv4sysSNTPDSTStartDay=ipv4sysSNTPDSTStartDay, aclL2AccessID=aclL2AccessID, tftpFwTargetImageFileName=tftpFwTargetImageFileName, tftpFwTargetServerIpType=tftpFwTargetServerIpType, sysFirmwareVersion=sysFirmwareVersion, tftpFwTargetTftpOperationStatus=tftpFwTargetTftpOperationStatus, ipv4snmpV3HostEntry=ipv4snmpV3HostEntry, dlinklldpConfigManAddrPortsTxEnable=dlinklldpConfigManAddrPortsTxEnable, dhcpBOOTPRelayInterface=dhcpBOOTPRelayInterface, qosTOSGroup=qosTOSGroup, dhcpBOOTPRelayOption82CheckState=dhcpBOOTPRelayOption82CheckState, snmpV3TrapRSTPStateChange=snmpV3TrapRSTPStateChange, sysTrapSystemEvent=sysTrapSystemEvent, snmpV3GroupNotifyViewName=snmpV3GroupNotifyViewName, sysSNTPDSTStartHour=sysSNTPDSTStartHour, trafficSegMemberList=trafficSegMemberList, sysLBDRecoverTime=sysLBDRecoverTime, dhcpBOOTPRelayOption82State=dhcpBOOTPRelayOption82State, trafficSegEntry=trafficSegEntry, sslCiphers=sslCiphers, snmpV3Trap=snmpV3Trap, sysPortCtrlOperStatus=sysPortCtrlOperStatus, sysDhcpAutoConfiguration=sysDhcpAutoConfiguration, qosDiffServType29=qosDiffServType29, aclProfileSrcMacAddrMask=aclProfileSrcMacAddrMask, autoSurveillanceVlanMode=autoSurveillanceVlanMode, dhcpv6RelayInterface=dhcpv6RelayInterface, stpPortAdminPointToPoint=stpPortAdminPointToPoint, qosDiffServType07=qosDiffServType07, aclProfileSrcPortMask=aclProfileSrcPortMask, igsVlanRtrPortList=igsVlanRtrPortList, qosDiffServType14=qosDiffServType14, dot1qVlanTable=dot1qVlanTable, igsVlanSnoopStatus=igsVlanSnoopStatus, snmpV3ViewTreeTable=snmpV3ViewTreeTable, sslSecurityHttpStatus=sslSecurityHttpStatus, dlinkGreenSystemHibernationTimeProfile1=dlinkGreenSystemHibernationTimeProfile1, dot1pPortEntry=dot1pPortEntry, syslogSrvIP=syslogSrvIP, impbSmartIpAddress=impbSmartIpAddress, snmpV3ViewTree=snmpV3ViewTree, swTimeRangeStartHour=swTimeRangeStartHour, dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, trustedHostRowStatus=trustedHostRowStatus, aclv6L3RuleTcpUdpSrcPort=aclv6L3RuleTcpUdpSrcPort, aclL3RuleTcpSynBit=aclL3RuleTcpSynBit, rmonStatsIndex=rmonStatsIndex, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, dlinklldpLocManAddr=dlinklldpLocManAddr, sysPortCtrlType=sysPortCtrlType, dhcpBOOTPRelayManagementOption82=dhcpBOOTPRelayManagementOption82, qosDiffServType35=qosDiffServType35, ipv4radiusServerAddress=ipv4radiusServerAddress, stpPortDesignatedPort=stpPortDesignatedPort, snmpGlobalState=snmpGlobalState, tftpCfgTargetServerIpType=tftpCfgTargetServerIpType, companySyslog=companySyslog, impbWhiteListTable=impbWhiteListTable, snmpV3viewTreeStatus=snmpV3viewTreeStatus, ipv4syslogFacility=ipv4syslogFacility, aclL3RuleTcpUdpDstPort=aclL3RuleTcpUdpDstPort, sysMirrorCtrlIngressMirroring=sysMirrorCtrlIngressMirroring, swTimeRangeStartDay=swTimeRangeStartDay, cableDiagLengthinRange=cableDiagLengthinRange, swTimeRangeEndDay=swTimeRangeEndDay, impbSettingEntry=impbSettingEntry, sysLBDVlanLoopPorts=sysLBDVlanLoopPorts, sysSNTPSecondInterfaceName=sysSNTPSecondInterfaceName, ipv4dhcpServerScreenServerTable=ipv4dhcpServerScreenServerTable, aclv6L3RuleTable=aclv6L3RuleTable, ipv4syslogLogSrvAddr=ipv4syslogLogSrvAddr, des_1210_52bx=des_1210_52bx, companyLA=companyLA, rmonEventType=rmonEventType, ipifV6AddressTable=ipifV6AddressTable, Timeout=Timeout, snmpV3CommunityStatus=snmpV3CommunityStatus, dlinkGreenSystemHibernationTimeProfile2=dlinkGreenSystemHibernationTimeProfile2, igsStatus=igsStatus, voicevlanPortAutoDetection=voicevlanPortAutoDetection, voicevlanPortControlTable=voicevlanPortControlTable, companyAutoSurveillanceVlan=companyAutoSurveillanceVlan, companyLBD=companyLBD, dhcpBOOTPRelayState=dhcpBOOTPRelayState, ipv4sysIpSubnetMask=ipv4sysIpSubnetMask, companyDHCPv6Relay=companyDHCPv6Relay, dhcpServerScreenTrustedServerEntry=dhcpServerScreenTrustedServerEntry, sysDdpGeneralReportTimer=sysDdpGeneralReportTimer, sysTrapStatus=sysTrapStatus, autoSurveillanceVlanOUIEntry=autoSurveillanceVlanOUIEntry, stpPortForwardTransitions=stpPortForwardTransitions, companyIpifGroup=companyIpifGroup, dhcpServerScreenIPType=dhcpServerScreenIPType, qosQ1p=qosQ1p, neighborIfindex=neighborIfindex, trustedHostIpMask=trustedHostIpMask, aclProfile=aclProfile, swRadiusServerIPType=swRadiusServerIPType, dlinkGreenLEDShutoff=dlinkGreenLEDShutoff, aclProfileArpSenderIpAddrMask=aclProfileArpSenderIpAddrMask, ipv4sysSNTPDSTEndMon=ipv4sysSNTPDSTEndMon, aclProfileDstIpAddrMaskType=aclProfileDstIpAddrMaskType, impbWhiteListMacAddress=impbWhiteListMacAddress, sysLBDInterval=sysLBDInterval, autoSurveillanceVlanOUIStatus=autoSurveillanceVlanOUIStatus, dhcpServerScreenTrustedServerIndex=dhcpServerScreenTrustedServerIndex, qosTOSType02=qosTOSType02, snmpV3CommunityPolicy=snmpV3CommunityPolicy, securitySSL=securitySSL, aclProfileArpSenderMacAddrMask=aclProfileArpSenderMacAddrMask, ipv4syslogUDPPort=ipv4syslogUDPPort, laPortChannelMode=laPortChannelMode, rmonEventTable=rmonEventTable, syslogSrvEntry=syslogSrvEntry, ipifv6GlobalStatus=ipifv6GlobalStatus)
mibBuilder.exportSymbols("DES-1210-52-BX", dot1qVlanPortEntry=dot1qVlanPortEntry, sysTrapIP=sysTrapIP, syslogTimeStampOption=syslogTimeStampOption, impbSmartBinding=impbSmartBinding, dot1qVlanPvid=dot1qVlanPvid, trustedHostEntry=trustedHostEntry, bandwidthCtrlRxThreshold=bandwidthCtrlRxThreshold, rmonEventIndex=rmonEventIndex, securityTrustedHost=securityTrustedHost, tftpCfgTargetGroup=tftpCfgTargetGroup, snmpV3GroupName=snmpV3GroupName, companyDot1qVlanGroup=companyDot1qVlanGroup, rmonStatsOwner=rmonStatsOwner, rmonAlarmRisingThreshold=rmonAlarmRisingThreshold, dot1xAuthTxPeriod=dot1xAuthTxPeriod, impbAutoScanIpAddressTo=impbAutoScanIpAddressTo, aclL3RuleAccessID=aclL3RuleAccessID, tftpConfigFileName=tftpConfigFileName, aclL3RuleSrcIpAddrMask=aclL3RuleSrcIpAddrMask, stpPortEnable=stpPortEnable, neighborCacheState=neighborCacheState, tftpConfigTftpOperationStatus=tftpConfigTftpOperationStatus, tftpCfgTargetInterfaceName=tftpCfgTargetInterfaceName, snmpV3UserVersion=snmpV3UserVersion, igsVlanCfgQuerier=igsVlanCfgQuerier, qosTOSType05=qosTOSType05, ipifV6AddressIpAddr=ipifV6AddressIpAddr, qosDiffServType22=qosDiffServType22, rmonEventEntry=rmonEventEntry, impbBlackListEntry=impbBlackListEntry, ipv4snmpV3HostTable=ipv4snmpV3HostTable, impbSmartPort=impbSmartPort, aclL3RuleSrcIpAddr=aclL3RuleSrcIpAddr, aclv6L3RuleICMPMessageType=aclv6L3RuleICMPMessageType, sysLoginTimeoutInterval=sysLoginTimeoutInterval, ipifSupportV4V6Info=ipifSupportV4V6Info, rmonEvent=rmonEvent, qosDiffServType25=qosDiffServType25, dhcpBOOTPRelayInterfaceSettingsTable=dhcpBOOTPRelayInterfaceSettingsTable, swTimeRangeSettingTable=swTimeRangeSettingTable, voicevlanDeviceEntry=voicevlanDeviceEntry, laPortChannelEntry=laPortChannelEntry, swTimeRangeRowStatus=swTimeRangeRowStatus, qosDiffServType40=qosDiffServType40, tftpFwTargetGroup=tftpFwTargetGroup, voicevlanDevicePort=voicevlanDevicePort, stpPortPathCost=stpPortPathCost, dhcpBOOTPRelayServerIP=dhcpBOOTPRelayServerIP, impbAutoScanIpAddressFrom=impbAutoScanIpAddressFrom, staticMcastVlanID=staticMcastVlanID, rmonAlarmInterval=rmonAlarmInterval, autoSurveillanceVlanTaggedUplinkDownlinkPort=autoSurveillanceVlanTaggedUplinkDownlinkPort, sysIpSubnetMask=sysIpSubnetMask, stpVersion=stpVersion, rstpStatus=rstpStatus, snmpV3UserStatus=snmpV3UserStatus, voicevlanDeviceTable=voicevlanDeviceTable, trafficSegStatus=trafficSegStatus, sysDdpProtStatusIndex=sysDdpProtStatusIndex, sysPortCtrlTable=sysPortCtrlTable, qosTOSType07=qosTOSType07, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, portSecMLA=portSecMLA, ipv4snmpV3HostAddress=ipv4snmpV3HostAddress, snmpV3HostTable=snmpV3HostTable, securityDhcpServerScreen=securityDhcpServerScreen, dhcpv6RelayOption37CheckState=dhcpv6RelayOption37CheckState, companySecurity=companySecurity, dlinkGreenSystemHibernation=dlinkGreenSystemHibernation, aclProfileSrcIpAddrMask=aclProfileSrcIpAddrMask, rmonStatsTable=rmonStatsTable, snmpV3Group=snmpV3Group, dlinklldpMsgHoldMultiplier=dlinklldpMsgHoldMultiplier, aclProfileDstPortMask=aclProfileDstPortMask, trustedHostIPType=trustedHostIPType, aclL2RuleVlanId=aclL2RuleVlanId, voicevlanDeviceTagType=voicevlanDeviceTagType, impbWhiteListIpAddress=impbWhiteListIpAddress, rmonHistoryInterval=rmonHistoryInterval, rmonAlarmEntry=rmonAlarmEntry, qosTOSType03=qosTOSType03, aclv6L3RuleTrafficClass=aclv6L3RuleTrafficClass, dot1qVlanUntaggedPorts=dot1qVlanUntaggedPorts, dhcpBOOTPRelayInterfaceSettingsRowStatus=dhcpBOOTPRelayInterfaceSettingsRowStatus, qosDiffServType54=qosDiffServType54, dot1qVlanUngisterMCFiltermode=dot1qVlanUngisterMCFiltermode, voicevlanOUITable=voicevlanOUITable, broadcastStormCtrlSettings=broadcastStormCtrlSettings, dhcpServerScreenTrustedServerTable=dhcpServerScreenTrustedServerTable, impbBlackListVlanId=impbBlackListVlanId, swTimeRangeSettingEntry=swTimeRangeSettingEntry, firmwareIllegalFile=firmwareIllegalFile, ipv4snmpV3HostStatus=ipv4snmpV3HostStatus, aclv6L3RuleSrcIpAddrMask=aclv6L3RuleSrcIpAddrMask, aclv6L3RuleTcpAckBit=aclv6L3RuleTcpAckBit, qosDiffServType27=qosDiffServType27, snmpV3TrapPortLinkUpDown=snmpV3TrapPortLinkUpDown, stpRootCost=stpRootCost, swTimeRangeFriday=swTimeRangeFriday, dhcpLocalRelaySettingsVLANID=dhcpLocalRelaySettingsVLANID, impbBlackListIpAddress=impbBlackListIpAddress, qosDiffServType59=qosDiffServType59, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, laPortChannelIfIndex=laPortChannelIfIndex, aclL2RuleDstMacAddr=aclL2RuleDstMacAddr, dhcpLocalRelayEntry=dhcpLocalRelayEntry, cableDiagPair2FaultDistance=cableDiagPair2FaultDistance, igsGrpQueryInterval=igsGrpQueryInterval, ipv4aclProfileArpSenderIpAddrMask=ipv4aclProfileArpSenderIpAddrMask, aclL3RuleTcpUdpSrcPort=aclL3RuleTcpUdpSrcPort, cableDiagPair3TestResult=cableDiagPair3TestResult, qosDiffServType23=qosDiffServType23, ipifv6AutolinkloStatus=ipifv6AutolinkloStatus, swTimeRangeEndHour=swTimeRangeEndHour, qosDiffServType17=qosDiffServType17, sysSNTPDSTEndMon=sysSNTPDSTEndMon, dlinklldpReinitDelay=dlinklldpReinitDelay, aclProfileTable=aclProfileTable, laPortControlEntry=laPortControlEntry, neighborMACAddr=neighborMACAddr, companyTrafficMgmt=companyTrafficMgmt, laPortControlIndex=laPortControlIndex, snmpV3GroupReadViewName=snmpV3GroupReadViewName, qosDiffServType49=qosDiffServType49, dhcpv6RelayServerIP=dhcpv6RelayServerIP, neighborTable=neighborTable, companySNTPSetting=companySNTPSetting, qosDiffServType48=qosDiffServType48, ipv4syslogGeneralGroup=ipv4syslogGeneralGroup, rmonStatsDataSource=rmonStatsDataSource, companyCableDiagnostic=companyCableDiagnostic, snmpV3UserName=snmpV3UserName, sysHardwareVersion=sysHardwareVersion, aclL3RuleTcpUdpDstPortMask=aclL3RuleTcpUdpDstPortMask, aclv6L3RuleEntry=aclv6L3RuleEntry, aclL2RulePriority=aclL2RulePriority, stpPortDesignatedCost=stpPortDesignatedCost, aclL3RuleICMPMessageCode=aclL3RuleICMPMessageCode, neighborRowStatus=neighborRowStatus, dhcpv6RelayHopCount=dhcpv6RelayHopCount, snmpV3IPType=snmpV3IPType, staticTable=staticTable, snmpV3UserTable=snmpV3UserTable, sysSwitchName=sysSwitchName, sysSNTPDSTEndHour=sysSNTPDSTEndHour, voicevlanPortControlEntry=voicevlanPortControlEntry, LldpManAddress=LldpManAddress, aclL3RuleProfileNo=aclL3RuleProfileNo, qosDiffServType37=qosDiffServType37, topologyChange=topologyChange, rmonEventStatus=rmonEventStatus, snmpV3TrapBootup=snmpV3TrapBootup, rmonHistoryStatus=rmonHistoryStatus, laSystem=laSystem, autoSurveillanceVlanSystem=autoSurveillanceVlanSystem, snmpV3Host=snmpV3Host, qosTOSType04=qosTOSType04, sysTrapFirmUpgradeEvent=sysTrapFirmUpgradeEvent, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, aclv6L3RuleProfileNo=aclv6L3RuleProfileNo, qosDiffServType61=qosDiffServType61, tftpCfgServerIpAddress=tftpCfgServerIpAddress, trustedHostIpAddr=trustedHostIpAddr, qosDiffServType58=qosDiffServType58, qosTOSType06=qosTOSType06, rmonAlarmOwner=rmonAlarmOwner, companyStaticMAC=companyStaticMAC, aclL2RuleInPortList=aclL2RuleInPortList, ipv4aclProfileTable=ipv4aclProfileTable, securityTrafficSeg=securityTrafficSeg, ipv4sysSNTPTimeSeconds=ipv4sysSNTPTimeSeconds, staticStatus=staticStatus, qosDiffServType55=qosDiffServType55, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, rmonAlarmStatus=rmonAlarmStatus, dlinklldpLocManAddrSubtype=dlinklldpLocManAddrSubtype, dlinkGreenLEDShutoffState=dlinkGreenLEDShutoffState, sysPortCtrlIndex=sysPortCtrlIndex, queuingMechanism=queuingMechanism, rmonEventOwner=rmonEventOwner, sysSystemPassword=sysSystemPassword, qosDiffServType42=qosDiffServType42, rmonHistoryBucketsRequested=rmonHistoryBucketsRequested, qosDiffServType12=qosDiffServType12, rmonStatistics=rmonStatistics, sysLBDCtrlIndex=sysLBDCtrlIndex, laPortChannelTable=laPortChannelTable, staticMcastStatus=staticMcastStatus, stpPortState=stpPortState, companyGreenSetting=companyGreenSetting, voicevlanDevicePriority=voicevlanDevicePriority, aclProfileRuleCount=aclProfileRuleCount, aclL3RuleDstIpAddrMask=aclL3RuleDstIpAddrMask, snmpV3GroupEntry=snmpV3GroupEntry, ipv4sysSNTPDSTEndDay=ipv4sysSNTPDSTEndDay, voicevlanDeviceIndexMac=voicevlanDeviceIndexMac, qosDiffServType56=qosDiffServType56, aclv6L3RulePriority=aclv6L3RulePriority, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, aclL3RuleTcpAckBit=aclL3RuleTcpAckBit, ipv4sysSNTPDSTEndMin=ipv4sysSNTPDSTEndMin, aclL3RuleEntry=aclL3RuleEntry, autoSurveillanceVlanPriority=autoSurveillanceVlanPriority, aclv6L3RuleAction=aclv6L3RuleAction, cableDiagPair4FaultDistance=cableDiagPair4FaultDistance, impbBlackListTable=impbBlackListTable, neighborEntry=neighborEntry, qosDiffServType41=qosDiffServType41, ipv4sysIpAddr=ipv4sysIpAddr, staticMac=staticMac, snmpV3EngineID=snmpV3EngineID, aclv6L3RuleTcpFinBit=aclv6L3RuleTcpFinBit, aclv6L3RuleSrcIpAddr=aclv6L3RuleSrcIpAddr, impbBlackListStatus=impbBlackListStatus, sysSNTPGMTMinutes=sysSNTPGMTMinutes, dhcpv6RelayOption37State=dhcpv6RelayOption37State, tftpFwTftpOperationStatus=tftpFwTftpOperationStatus, portSecEntry=portSecEntry, qosDiffServType32=qosDiffServType32, ipv4sysSNTPFirstServer=ipv4sysSNTPFirstServer, dlinkGreenLEDShutoffTimeProfile2=dlinkGreenLEDShutoffTimeProfile2, dhcpBOOTPRelayInterfaceSettingsEntry=dhcpBOOTPRelayInterfaceSettingsEntry, igsVlanRouterEntry=igsVlanRouterEntry, stpPortEdge=stpPortEdge, aclL2RuleSrcMacAddr=aclL2RuleSrcMacAddr, snmpV3UserPrivProtocol=snmpV3UserPrivProtocol, dhcpv6RelayState=dhcpv6RelayState, PortList=PortList, aclL3RuleStatus=aclL3RuleStatus, tftpFwTargetServerIpAddress=tftpFwTargetServerIpAddress, stpPriority=stpPriority, rmonAlarmIndex=rmonAlarmIndex, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, qosDiffServType02=qosDiffServType02, aclL3RuleTcpUrgBit=aclL3RuleTcpUrgBit, swTimeRangeStartYear=swTimeRangeStartYear, stpPortRestrictedRole=stpPortRestrictedRole, syslogSrvRowStatus=syslogSrvRowStatus, qosDiffServTypeGroup=qosDiffServTypeGroup, swRadiusServerSharedSecret=swRadiusServerSharedSecret, companyTrapSetting=companyTrapSetting, igsReportToAllPort=igsReportToAllPort, companyNeighbor=companyNeighbor, trustedHostTable=trustedHostTable, snmpV3User=snmpV3User, bandwidthCtrlSettings=bandwidthCtrlSettings, voicevlanOUIDescription=voicevlanOUIDescription, sysDdpGlobalOnOff=sysDdpGlobalOnOff, companyLLDPSetting=companyLLDPSetting, tftpCfgTargetServerIpAddress=tftpCfgTargetServerIpAddress, impbBlackListPort=impbBlackListPort, trafficSegIfIndex=trafficSegIfIndex, ipv4aclProfileStatus=ipv4aclProfileStatus)
mibBuilder.exportSymbols("DES-1210-52-BX", dhcpv6RelayManagement=dhcpv6RelayManagement, qosDiffServType05=qosDiffServType05, ipv4trustedHostEntry=ipv4trustedHostEntry, dot1qVlanPortTable=dot1qVlanPortTable, qosDiffServType45=qosDiffServType45, stpDesignatedRoot=stpDesignatedRoot, sysSNTPDSTState=sysSNTPDSTState, snmpV3viewTreeType=snmpV3viewTreeType, sysDdpProtStatusEntry=sysDdpProtStatusEntry, snmpV3GroupStatus=snmpV3GroupStatus, radius=radius, dhcpv6RelayOption37RemoteIDType=dhcpv6RelayOption37RemoteIDType, stpPortOperEdgePort=stpPortOperEdgePort, staticAutoLearningList=staticAutoLearningList, dot1qVlanRowStatus=dot1qVlanRowStatus, PortLaMode=PortLaMode, dot1qVlanEntry=dot1qVlanEntry, aclProfileDstIpAddrMask=aclProfileDstIpAddrMask, sysLBDCtrlTable=sysLBDCtrlTable, companyRMON=companyRMON, ipv4aclProfileRuleCount=ipv4aclProfileRuleCount, aRPSpoofPreventMacAddress=aRPSpoofPreventMacAddress, dlinkGreenPortShutoffState=dlinkGreenPortShutoffState, dlink=dlink, swAuthCtrlPktFwdMode=swAuthCtrlPktFwdMode, impbWhiteListPort=impbWhiteListPort, sysSNTPDSTOffset=sysSNTPDSTOffset, sysSNTPState=sysSNTPState, dlinkGreenSystemHibernationState=dlinkGreenSystemHibernationState, ipifV6AddressIpType=ipifV6AddressIpType, laPortControl=laPortControl, securityIpMacPortBinding=securityIpMacPortBinding, snmpV3HostInterfaceName=snmpV3HostInterfaceName, sysMirrorTargetPort=sysMirrorTargetPort, companyStaticMcast=companyStaticMcast, stpForwardDelay=stpForwardDelay, tftpCfgTargetTftpOperationStatus=tftpCfgTargetTftpOperationStatus, aRPSpoofPreventTable=aRPSpoofPreventTable, sysLBDStateEnable=sysLBDStateEnable, sysSNTPDSTStartDay=sysSNTPDSTStartDay, aclProfileStatus=aclProfileStatus, qosDiffServType47=qosDiffServType47, qosDiffServType24=qosDiffServType24, dhcpLocalRelaySettingsState=dhcpLocalRelaySettingsState, qosDiffServType21=qosDiffServType21, aclProfileType=aclProfileType, firmwareTransferError=firmwareTransferError, snmpV3GroupSecurityModel=snmpV3GroupSecurityModel, snmpV3viewTreeName=snmpV3viewTreeName, impbAutoScanStatus=impbAutoScanStatus, traps=traps, cableDiagPair4TestResult=cableDiagPair4TestResult, aclL3RuleTcpPshBit=aclL3RuleTcpPshBit, qosDiffServType51=qosDiffServType51, dhcpBOOTPRelayOption82Policy=dhcpBOOTPRelayOption82Policy, syslogInterfaceName=syslogInterfaceName, aclv6L3RuleProtocol=aclv6L3RuleProtocol, aclv6L3RuleTcpPshBit=aclv6L3RuleTcpPshBit, bandwidthCtrlEntry=bandwidthCtrlEntry, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, swTimeRangeDate=swTimeRangeDate, rmonHistoryDataSource=rmonHistoryDataSource, sysSNTPFirstServer=sysSNTPFirstServer, dlinkGreenPortShutoffPortList=dlinkGreenPortShutoffPortList, qosTOS=qosTOS, rmonHistoryEntry=rmonHistoryEntry, snmpV3GroupSecurityLevel=snmpV3GroupSecurityLevel, syslogGeneralGroup=syslogGeneralGroup, snmpV3Community=snmpV3Community, igsVlanFilterTable=igsVlanFilterTable, dlinkGreenLEDShutoffPortList=dlinkGreenLEDShutoffPortList, aclL3RuleDscp=aclL3RuleDscp, aclL3RuleProtocol=aclL3RuleProtocol, firmwareUpgradeSuccess=firmwareUpgradeSuccess, ipv4aclProfileNo=ipv4aclProfileNo, dot1qVlanName=dot1qVlanName, sysSNTPFirstInterfaceName=sysSNTPFirstInterfaceName, aclL3RuleAction=aclL3RuleAction, ipv4aclProfileType=ipv4aclProfileType, sysSNTPDSTStartMon=sysSNTPDSTStartMon, igsVlanFilterVlanId=igsVlanFilterVlanId, aclL2RuleEntry=aclL2RuleEntry, igsVlanQueryInterval=igsVlanQueryInterval, aclL2RuleTable=aclL2RuleTable, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, aclL3RuleTable=aclL3RuleTable, qosDiffServType44=qosDiffServType44, snmpV3HostEntry=snmpV3HostEntry, syslogSrvTable=syslogSrvTable, dot1qVlanManagementid=dot1qVlanManagementid, voicevlanOUI=voicevlanOUI, qosDiffServType15=qosDiffServType15, ipv4snmpV3HostVersion=ipv4snmpV3HostVersion, stpPortPriority=stpPortPriority, autoSurveillanceVlanOUITable=autoSurveillanceVlanOUITable, stpTopChanges=stpTopChanges, rmonHistoryIndex=rmonHistoryIndex, impbBlackListMacAddress=impbBlackListMacAddress, qosDiffServType06=qosDiffServType06, ipv4aclProfileArpSenderMacAddrMask=ipv4aclProfileArpSenderMacAddrMask, securityPortSecurity=securityPortSecurity, qosDiffServType11=qosDiffServType11, ipv4dhcpServerScreenServerEntry=ipv4dhcpServerScreenServerEntry, dhcpBOOTPRelayOption82RemoteIDType=dhcpBOOTPRelayOption82RemoteIDType, sysSNTPDSTStartMin=sysSNTPDSTStartMin, bandwidthCtrlIndex=bandwidthCtrlIndex, aRPSpoofPreventPortList=aRPSpoofPreventPortList, dot1xAuthMaxReq=dot1xAuthMaxReq, qosDiffServType18=qosDiffServType18, qosDiffServType57=qosDiffServType57, swTimeRangeEndMinute=swTimeRangeEndMinute, portSecState=portSecState, aclL3RulePortList=aclL3RulePortList, dot1qVlanEgressPorts=dot1qVlanEgressPorts, stpBridgeForwardDelay=stpBridgeForwardDelay, snmpV3TrapSNMPAuthentication=snmpV3TrapSNMPAuthentication, aclProfileIPProtocol=aclProfileIPProtocol, sysMirrorStatus=sysMirrorStatus, companyVoiceVlan=companyVoiceVlan, voicevlanPortManuTagMode=voicevlanPortManuTagMode, sysIpAddr=sysIpAddr, snmpV3TrapFirmUpgrade=snmpV3TrapFirmUpgrade, rmonAlarmFallingThreshold=rmonAlarmFallingThreshold, ipv4aclProfileSrcPortMask=ipv4aclProfileSrcPortMask, sysLocationName=sysLocationName, sysLBDPortLoopStatus=sysLBDPortLoopStatus, autoSurveillanceVlanOUI=autoSurveillanceVlanOUI, sysSNTPTimeSeconds=sysSNTPTimeSeconds, qosTOSType00=qosTOSType00, sysSNTPDSTEndDay=sysSNTPDSTEndDay, qosDiffServType39=qosDiffServType39, miscStatisticsReset=miscStatisticsReset, stpGlobal=stpGlobal, stpMaxAge=stpMaxAge, qosDiffServType31=qosDiffServType31, sysSNTPPollInterval=sysSNTPPollInterval, dhcpBOOTPRelayHopCount=dhcpBOOTPRelayHopCount, dlinkGreenPortShutoffTimeProfile2=dlinkGreenPortShutoffTimeProfile2, ipv4aclProfileMask=ipv4aclProfileMask, autoSurveillanceVlanOUIMask=autoSurveillanceVlanOUIMask, ipifv6DefaultGateway=ipifv6DefaultGateway, snmpV3GroupTable=snmpV3GroupTable, sysGateway=sysGateway, sysTrapPortEvent=sysTrapPortEvent, ipv4radiusServerSharedSecret=ipv4radiusServerSharedSecret, ipifv6NSRetransmitTime=ipifv6NSRetransmitTime, tftpFwTargetTftpOperation=tftpFwTargetTftpOperation, rmonAlarmRisingEventIndex=rmonAlarmRisingEventIndex, dhcpv6RelayControl=dhcpv6RelayControl, stpPortTable=stpPortTable, swTimeRangeWednesday=swTimeRangeWednesday, igsVlanRouterTable=igsVlanRouterTable, igsSystem=igsSystem, qosDiffServType20=qosDiffServType20, VlanIndex=VlanIndex, staticMcastEgressPorts=staticMcastEgressPorts, igsVlanRouterVlanId=igsVlanRouterVlanId, stpPortRestrictedTCN=stpPortRestrictedTCN, igsVlanMulticastGroupVlanId=igsVlanMulticastGroupVlanId, igsVlanFastLeave=igsVlanFastLeave, aclProfileNo=aclProfileNo, sysRestart=sysRestart, snmpV3HostCommunityName=snmpV3HostCommunityName, aRPSpoofPreventEntry=aRPSpoofPreventEntry, sysLBDVlanLoopIndex=sysLBDVlanLoopIndex, rmonHistory=rmonHistory, ipv4sysGateway=ipv4sysGateway, staticEntry=staticEntry, rmonEventCommunity=rmonEventCommunity, LacpKey=LacpKey, impbPortIndex=impbPortIndex, sysDdpGeneralReportOnOff=sysDdpGeneralReportOnOff, dot1qVlanUngisterMCFilterVlanId=dot1qVlanUngisterMCFilterVlanId, qosDiffServType00=qosDiffServType00, aclL2Rule1pPriority=aclL2Rule1pPriority, cableDiagTriggerIndex=cableDiagTriggerIndex, dlinklldpConfigManAddrEntry=dlinklldpConfigManAddrEntry, rmonHistoryOwner=rmonHistoryOwner, companyRSTP=companyRSTP, companyDHCPRelay=companyDHCPRelay, ipv4snmpV3HostCommunityName=ipv4snmpV3HostCommunityName, aclv6L3RuleTcpUdpDstPortMask=aclv6L3RuleTcpUdpDstPortMask, syslogState=syslogState, sysSNTPSecondType=sysSNTPSecondType, snmpV3HostVersion=snmpV3HostVersion, staticPort=staticPort, ipv4sysSNTPDSTStartHour=ipv4sysSNTPDSTStartHour, ipifName=ipifName, sysPortCtrlEntry=sysPortCtrlEntry, dlinklldpTxDelay=dlinklldpTxDelay, aclv6L3RulePortList=aclv6L3RulePortList, companySystem=companySystem, sysLBDMode=sysLBDMode, ipv4syslogTimeStamp=ipv4syslogTimeStamp, aclProfileMask=aclProfileMask, aclL2RuleSrcMacAddrMask=aclL2RuleSrcMacAddrMask, voiceVlanMode=voiceVlanMode, impbSmartEntry=impbSmartEntry, impbWhiteListRowStatus=impbWhiteListRowStatus, stpRootPort=stpRootPort, voicevlanPortState=voicevlanPortState, BridgeId=BridgeId, qosDiffServType30=qosDiffServType30, qosDiffServType33=qosDiffServType33, qosDiffServType01=qosDiffServType01, ipv4sysSNTPState=ipv4sysSNTPState, rmonEventDescription=rmonEventDescription, qosDiffServType19=qosDiffServType19, companyDot1xGroup=companyDot1xGroup, aclL2RuleStatus=aclL2RuleStatus, aclL2Rule=aclL2Rule, igsVlanMulticastGroupEntry=igsVlanMulticastGroupEntry, laPortChannelMemberList=laPortChannelMemberList, aclv6L3RuleDstIpAddr=aclv6L3RuleDstIpAddr, sysLBDVlanLoopTable=sysLBDVlanLoopTable, aclProfileDstMacAddrMask=aclProfileDstMacAddrMask, companyMirror=companyMirror, igsVlanFilterEntry=igsVlanFilterEntry, dot1xAuthServerTimeout=dot1xAuthServerTimeout, qosDiffServType04=qosDiffServType04, portSecTable=portSecTable, aclL3RuleTcpUdpSrcPortMask=aclL3RuleTcpUdpSrcPortMask, ipv4sysSNTPPollInterval=ipv4sysSNTPPollInterval, dlinklldpMsgTxInterval=dlinklldpMsgTxInterval, qosDiffServType53=qosDiffServType53, igsVlanQuerier=igsVlanQuerier, companySNMPV3=companySNMPV3, snmpV3viewTreeSubtree=snmpV3viewTreeSubtree, stpTxHoldCount=stpTxHoldCount, qosDiffServType63=qosDiffServType63, sysSNTPFirstType=sysSNTPFirstType, rmonAlarmVariable=rmonAlarmVariable, syslogSrvSeverity=syslogSrvSeverity, ipv4aclProfileDstIpAddrMask=ipv4aclProfileDstIpAddrMask, ipv4syslogLogging=ipv4syslogLogging, rmonGlobalState=rmonGlobalState, dlinkGreenPortShutoff=dlinkGreenPortShutoff, sysLBDCtrlEntry=sysLBDCtrlEntry, rmonAlarm=rmonAlarm, autoSurveillanceVlanOUIComponentType=autoSurveillanceVlanOUIComponentType, qosDiffServType03=qosDiffServType03, qosDiffServType26=qosDiffServType26, sysLBDPortStatus=sysLBDPortStatus, trustedHostStatus=trustedHostStatus, snmpV3ViewTreeEntry=snmpV3ViewTreeEntry, securityARPSpoofPrevent=securityARPSpoofPrevent, autoSurveillanceVlanOUIDescription=autoSurveillanceVlanOUIDescription, voiceVlanPriority=voiceVlanPriority, snmpV3UserGroupName=snmpV3UserGroupName, ipv4sysSNTPGMTMinutes=ipv4sysSNTPGMTMinutes, impbSettingTable=impbSettingTable, companyTraps=companyTraps, firmwareUpgradeFailure=firmwareUpgradeFailure, qosDiffServType34=qosDiffServType34)
mibBuilder.exportSymbols("DES-1210-52-BX", autoSurveillanceVlanId=autoSurveillanceVlanId, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, sysIpAddrCfgMode=sysIpAddrCfgMode, aclv6L3RuleTcpUrgBit=aclv6L3RuleTcpUrgBit, voiceVlanId=voiceVlanId, rmonAlarmFallingEventIndex=rmonAlarmFallingEventIndex, snmpV3GroupWriteViewName=snmpV3GroupWriteViewName, sysDdpProtStatusControl=sysDdpProtStatusControl, tftpFwServerIpAddress=tftpFwServerIpAddress, impbSmartMacAddress=impbSmartMacAddress, stpHoldTime=stpHoldTime, igsRobustnessValue=igsRobustnessValue, syslogSrvPort=syslogSrvPort, qosDiffServType13=qosDiffServType13, qosDiffServType16=qosDiffServType16, impbSmartTable=impbSmartTable, voicevlanOUIEntry=voicevlanOUIEntry, stpHelloTime=stpHelloTime, ipv4aclProfileDstPortMask=ipv4aclProfileDstPortMask, aclv6L3RuleTcpUdpDstPort=aclv6L3RuleTcpUdpDstPort, cableDiagPair3FaultDistance=cableDiagPair3FaultDistance, dlinkGreenPortShutoffTimeProfile1=dlinkGreenPortShutoffTimeProfile1, igsVlan=igsVlan, sysGroupInterval=sysGroupInterval, qosDiffServType08=qosDiffServType08, sysMirrorCtrlEgressMirroring=sysMirrorCtrlEgressMirroring, swRadiusServerInterfaceName=swRadiusServerInterfaceName, qosDiffServ=qosDiffServ, impbPortState=impbPortState, portSecIndex=portSecIndex, qosDiffServType43=qosDiffServType43, sysSafeGuardEnable=sysSafeGuardEnable, dot1qVlanUngisterMCFilterEntry=dot1qVlanUngisterMCFilterEntry, cableDiagPair1TestResult=cableDiagPair1TestResult, aclL3Rule=aclL3Rule, aclL3RuleReplacePriority=aclL3RuleReplacePriority, laPortActorTimeout=laPortActorTimeout, sysSNTPServerTable=sysSNTPServerTable, stpAdminPortPathCost=stpAdminPortPathCost, broadcastStormCtrlThreshold=broadcastStormCtrlThreshold, sysDdp=sysDdp, companyDHCPLocalRelay=companyDHCPLocalRelay, aclL2ProfileID=aclL2ProfileID, dlink_DES12XXSeriesProd=dlink_DES12XXSeriesProd, impbSmartVlanId=impbSmartVlanId, qosDiffServType09=qosDiffServType09, companyTftpGroup=companyTftpGroup, sysPortCtrlFlowControl=sysPortCtrlFlowControl, dot1pPortIndex=dot1pPortIndex, voicevlanSystem=voicevlanSystem, stpPortEntry=stpPortEntry, dhcpServerScreenTrustedServerStatus=dhcpServerScreenTrustedServerStatus, ipv4dhcpServerScreenServerStatus=ipv4dhcpServerScreenServerStatus, radiusServerTable=radiusServerTable, swTimeRangeIndex=swTimeRangeIndex, syslogSrvFacility=syslogSrvFacility, igsHostPortPurgeInterval=igsHostPortPurgeInterval, swTimeRangeName=swTimeRangeName, stpPortOperPointToPoint=stpPortOperPointToPoint, aclv6L3RuleStatus=aclv6L3RuleStatus, dhcpv6RelayOption37=dhcpv6RelayOption37, dhcpLocalRelayGlobalState=dhcpLocalRelayGlobalState, sysPortCtrlSpeed=sysPortCtrlSpeed, broadcastStormCtrlLimitType=broadcastStormCtrlLimitType, ipv4aclProfileSrcMacAddrMask=ipv4aclProfileSrcMacAddrMask, dlinklldpConfigManAddrTable=dlinklldpConfigManAddrTable, voicevlanDeviceStatus=voicevlanDeviceStatus, dot1pPortPriority=dot1pPortPriority, tftpFwImageFileName=tftpFwImageFileName, dot1qVlanUngisterMCFilterTable=dot1qVlanUngisterMCFilterTable, qosDiffServType62=qosDiffServType62, snmpV3HostStatus=snmpV3HostStatus, igsVlanMulticastGroupMacAddress=igsVlanMulticastGroupMacAddress, firmwareChecksumError=firmwareChecksumError, ipifv6DHCPStatus=ipifv6DHCPStatus, aclL2RuleReplacePriority=aclL2RuleReplacePriority, stpPortProtocolMigration=stpPortProtocolMigration, stpTimeSinceTopologyChange=stpTimeSinceTopologyChange, ipv4dhcpServerScreenServerAddress=ipv4dhcpServerScreenServerAddress, dhcpBOOTPRelayManagement=dhcpBOOTPRelayManagement, ipv4sysSNTPDSTState=ipv4sysSNTPDSTState, voicevlanOUITelephonyOUI=voicevlanOUITelephonyOUI, aclProfileEntry=aclProfileEntry, aclL3RuleIgmpType=aclL3RuleIgmpType, aclv6L3RuleDstIpAddrMask=aclv6L3RuleDstIpAddrMask, swTimeRangeMonday=swTimeRangeMonday, dhcpBOOTPRelayTimeThreshold=dhcpBOOTPRelayTimeThreshold, dot1pPortTable=dot1pPortTable, dhcpLocalRelayTable=dhcpLocalRelayTable, ipv4trustedHostTable=ipv4trustedHostTable, aclv6L3RuleTcpRstBit=aclv6L3RuleTcpRstBit, staticMcastMac=staticMcastMac, ipifV6AddressIpPrefix=ipifV6AddressIpPrefix, aRPSpoofPreventRowStatus=aRPSpoofPreventRowStatus, swTimeRangeThursday=swTimeRangeThursday, dhcpBOOTPRelayControl=dhcpBOOTPRelayControl, rmonStatsStatus=rmonStatsStatus, qosDiffServType38=qosDiffServType38)
