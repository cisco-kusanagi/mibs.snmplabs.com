...
Bits, ModuleIdentity, Counter64, Integer32, Gauge32, TimeTicks, MibIdentifier, IpAddress, Unsigned32, NotificationType, iso, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "Counter64", "Integer32", "Gauge32", "TimeTicks", "MibIdentifier", "IpAddress", "Unsigned32", "NotificationType", "iso", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("DES3828-L2MGMT-MIB", swL2QOS8021pUserPriorityIndex=swL2QOS8021pUserPriorityIndex, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2PortInfoUnitIndex=swL2PortInfoUnitIndex, swL2PortSecurityControlEntry=swL2PortSecurityControlEntry, swL2IGMPMulticastVlanName=swL2IGMPMulticastVlanName, swL2PortSecurityMode=swL2PortSecurityMode, swL2QOSBandwidthControlTable=swL2QOSBandwidthControlTable, swL2PortInfoTable=swL2PortInfoTable, swL2QOSSchedulingEntry=swL2QOSSchedulingEntry, swL2TrafficSegPort=swL2TrafficSegPort, swL2PortSecurityMgmt=swL2PortSecurityMgmt, swL2IGMPIpGroupReportCount=swL2IGMPIpGroupReportCount, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2QOS8021pUserPriorityEntry=swL2QOS8021pUserPriorityEntry, swDevInfoFrontPanelLedMode=swDevInfoFrontPanelLedMode, swL2IGMPRouterPortEntry=swL2IGMPRouterPortEntry, swL2QOSBandwidthRxRate=swL2QOSBandwidthRxRate, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2QOS8021pDefaultPriority=swL2QOS8021pDefaultPriority, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2IGMPMaxResponseTime=swL2IGMPMaxResponseTime, swL2IGMPRobustness=swL2IGMPRobustness, swL2VlanIndex=swL2VlanIndex, swL2IGMPRouterPortVlanName=swL2IGMPRouterPortVlanName, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2PortControlFlowCtrlState=swL2PortControlFlowCtrlState, swL2IGMPInfoVid=swL2IGMPInfoVid, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2VlanMgmt=swL2VlanMgmt, swL2DevCtrlStpState=swL2DevCtrlStpState, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2IGMPRouterPortDynamicPortList=swL2IGMPRouterPortDynamicPortList, swL2IGMPInfoEntry=swL2IGMPInfoEntry, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swPowerFailure=swPowerFailure, swL2QOSBandwidthControlEntry=swL2QOSBandwidthControlEntry, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swDevInfoPowerID=swDevInfoPowerID, swL2TrunkState=swL2TrunkState, swL2PortSecurityPortIndex=swL2PortSecurityPortIndex, swL2MgmtMIB=swL2MgmtMIB, swL2IGMPInfoTxQueryCount=swL2IGMPInfoTxQueryCount, swL2IGMPMacAddr=swL2IGMPMacAddr, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2MACNotifyInterval=swL2MACNotifyInterval, PortList=PortList, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swDevInfoConsoleInUse=swDevInfoConsoleInUse, swL2DevCtrlRmonState=swL2DevCtrlRmonState, swL2IGMPMgmt=swL2IGMPMgmt, swL2IGMPLastMemberQueryInterval=swL2IGMPLastMemberQueryInterval, swL2PortControlEntry=swL2PortControlEntry, swL2IGMPPortMap=swL2IGMPPortMap, swDevInfoSystemUpTime=swDevInfoSystemUpTime, swL2IGMPRouterPortTable=swL2IGMPRouterPortTable, swL2MgmtMIBTrapPrefix=swL2MgmtMIBTrapPrefix, swL2MACNotifyState=swL2MACNotifyState, swL2IGMPCurrentState=swL2IGMPCurrentState, swL2VlanAdvertisementTable=swL2VlanAdvertisementTable, swL2PortControlPortIndex=swL2PortControlPortIndex, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2PortControlMACNotifyState=swL2PortControlMACNotifyState, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2VlanName=swL2VlanName, swL2PortControlMulticastfilter=swL2PortControlMulticastfilter, swL2PortControlNwayState=swL2PortControlNwayState, swDevInfoModuleType=swDevInfoModuleType, swL2IGMPFastLeaveState=swL2IGMPFastLeaveState, swPowerStatusChg=swPowerStatusChg, swL2QOSSchedulingMaxPkts=swL2QOSSchedulingMaxPkts, swL2VlanAdvertisementEntry=swL2VlanAdvertisementEntry, swL2PortInformationNwayStatus=swL2PortInformationNwayStatus, VlanId=VlanId, swDevInfoPowerUnitIndex=swDevInfoPowerUnitIndex, swL2IGMPInfoTable=swL2IGMPInfoTable, swL2PortSecurityControlTable=swL2PortSecurityControlTable, swL2QOSBandwidthPortIndex=swL2QOSBandwidthPortIndex, swL2IGMPCtrlTable=swL2IGMPCtrlTable, swL2PortInformationTable=swL2PortInformationTable, swL2PortControlUnitIndex=swL2PortControlUnitIndex, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swL2PortInfoEntry=swL2PortInfoEntry, swDevInfoPowerStatus=swDevInfoPowerStatus, swL2IGMPQueryInfoEntry=swL2IGMPQueryInfoEntry, swL2BroadcastSegFilterPorts=swL2BroadcastSegFilterPorts, swl2NotifyPortSecurity=swl2NotifyPortSecurity, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2IGMPMulticastVlanEntry=swL2IGMPMulticastVlanEntry, swl2NotificationBidings=swl2NotificationBidings, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2MirrorMgmt=swL2MirrorMgmt, swL2DevMgmt=swL2DevMgmt, swL2QOS8021pDefaultPriorityTable=swL2QOS8021pDefaultPriorityTable, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2PortSecurityTrapLogState=swL2PortSecurityTrapLogState, swL2PortInformationUnitID=swL2PortInformationUnitID, swL2IGMPHostTimeout=swL2IGMPHostTimeout, swL2IGMPCtrlState=swL2IGMPCtrlState, swL2PortCtrlTable=swL2PortCtrlTable, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2PortInformationEntry=swL2PortInformationEntry, swL2IGMPQueryInfoTable=swL2IGMPQueryInfoTable, swL2IGMPMulticastVlanTable=swL2IGMPMulticastVlanTable, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2TrunkIndex=swL2TrunkIndex, swL2DevCtrlIGMPSnooping=swL2DevCtrlIGMPSnooping, swL2QOS8021pUserPriorityTable=swL2QOS8021pUserPriorityTable, swL2QOSMgmt=swL2QOSMgmt, swL2IGMPRouteTimeout=swL2IGMPRouteTimeout, swL2IGMPLeaveTimer=swL2IGMPLeaveTimer, swL2TrunkMember=swL2TrunkMember, swL2macNotifyInfo=swL2macNotifyInfo, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2QOS8021pDefaultPriorityEntry=swL2QOS8021pDefaultPriorityEntry, swL2DevAlarm=swL2DevAlarm, swL2QOSSchedulingClassIndex=swL2QOSSchedulingClassIndex, swL2IGMPMaxSupportedVlans=swL2IGMPMaxSupportedVlans, swL2PortInfoType=swL2PortInfoType, swL2PortInformationPortIndex=swL2PortInformationPortIndex, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2QOSBandwidthTxRate=swL2QOSBandwidthTxRate, swL2VlanAdvertiseState=swL2VlanAdvertiseState, swL2PortInformationMediumType=swL2PortInformationMediumType, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2QOS8021pUserPriorityClass=swL2QOS8021pUserPriorityClass, swL2TrunkName=swL2TrunkName, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2IGMPMulticastVlanSourcePort=swL2IGMPMulticastVlanSourcePort, swL2PortSecurityMaxLernAddr=swL2PortSecurityMaxLernAddr, swL2QOS8021pRadiusPriority=swL2QOS8021pRadiusPriority, swL2MirrorPortState=swL2MirrorPortState, swL2IGMPGroupIpAddr=swL2IGMPGroupIpAddr, swL2BroadcastSegARPForwardPorts=swL2BroadcastSegARPForwardPorts, swL2PortInformationLinkStatus=swL2PortInformationLinkStatus, swPowerRecover=swPowerRecover, swL2DevInfo=swL2DevInfo, swL2TrafficSegTable=swL2TrafficSegTable, swL2BroadcastSegCtrl=swL2BroadcastSegCtrl, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2PortControlMediumType=swL2PortControlMediumType, swL2PortControlLearningState=swL2PortControlLearningState, swL2IGMPMulticastVlanid=swL2IGMPMulticastVlanid, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2QOS8021pDefaultPriorityIndex=swL2QOS8021pDefaultPriorityIndex, swDevInfoPowerEntry=swDevInfoPowerEntry, swL2PortSecurityAdmState=swL2PortSecurityAdmState, swL2QOSBandwidthRadiusRxRate=swL2QOSBandwidthRadiusRxRate, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2IGMPRouterPortStaticPortList=swL2IGMPRouterPortStaticPortList, swL2IGMPQueryInterval=swL2IGMPQueryInterval, swL2QOSSchedulingTable=swL2QOSSchedulingTable, swL2PortInformationModuleType=swL2PortInformationModuleType, swL2IGMPCtrlEntry=swL2IGMPCtrlEntry, swL2IGMPRouterPortVlanid=swL2IGMPRouterPortVlanid, swL2IGMPRouterPortForbiddenPortList=swL2IGMPRouterPortForbiddenPortList, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2PortInfoModuleType=swL2PortInfoModuleType, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, VlanIndex=VlanIndex, swL2IGMPInfoQueryCount=swL2IGMPInfoQueryCount, swL2TrunkMgmt=swL2TrunkMgmt, swL2PortControlAdminState=swL2PortControlAdminState, swL2PortInformationType=swL2PortInformationType, swL2PortInformationErrorDisabled=swL2PortInformationErrorDisabled, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2TrunkType=swL2TrunkType, swL2IGMPCtrlVid=swL2IGMPCtrlVid, swDevInfoPowerTable=swDevInfoPowerTable, swL2DevCtrl=swL2DevCtrl, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2QOSBandwidthRadiusTxRate=swL2QOSBandwidthRadiusTxRate, swL2porttypechgNotification=swL2porttypechgNotification, swL2IGMPMulticastVlanMemberPort=swL2IGMPMulticastVlanMemberPort, swL2PortInfoErrorDisabled=swL2PortInfoErrorDisabled, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2IGMPVid=swL2IGMPVid, swL2IGMPMulticastVlanRowStatus=swL2IGMPMulticastVlanRowStatus, swL2PortCtrlLockState=swL2PortCtrlLockState, swL2IGMPQueryState=swL2IGMPQueryState, swL2macNotification=swL2macNotification, swL2PortMgmt=swL2PortMgmt, swL2PortControlTable=swL2PortControlTable)
