...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/Dell-TIMESYNCHRONIZATION-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:56:52 2019
...
Counter64, iso, IpAddress, MibIdentifier, Integer32, Unsigned32, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, ObjectIdentity, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "IpAddress", "MibIdentifier", "Integer32", "Unsigned32", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "ObjectIdentity", "Gauge32", "ModuleIdentity")
...
if mibBuilder.loadTexts: rlTimeSynchronization.setContactInfo('www.dell.com')
...
class NTPSignedTimeValue(TextualConvention, OctetString):
    description = 'The time in seconds that could represent signed quantities like time delay with respect to some source. This textual-convention is specific to Dell implementation of NTP where 32-bit integers are used for such quantities. The signed integer part is in the first 16 bits and the fraction part is in the last 16 bits.'
    status = 'current'
    displayHint = '2d.2d'
...
if mibBuilder.loadTexts: rlSntpRestoreDefaultServers.setDescription("Setting this scalar to true restores sntp default unicast servers. Meaning: all manually configured servers are deleted, and the default SNTP servers are recreated with their default values. This is an 'action' scalar.")
mibBuilder.exportSymbols("Dell-TIMESYNCHRONIZATION-MIB", rlTimeZoneDaylightSavingTimeMode=rlTimeZoneDaylightSavingTimeMode, rlSntpNtpConfigSrvInetAddress=rlSntpNtpConfigSrvInetAddress, rlSntpAllServerInetTable=rlSntpAllServerInetTable, rndTimeSyncManagedDate=rndTimeSyncManagedDate, rlSntpNtpConfigPollInterval=rlSntpNtpConfigPollInterval, rlSntpServerInetStratum=rlSntpServerInetStratum, rlSntpAllServerInetDelay=rlSntpAllServerInetDelay, rlSntpNtpConfigRetryTimeout=rlSntpNtpConfigRetryTimeout, rlSntpAllServerInetLastResp=rlSntpAllServerInetLastResp, rlSntpConfigServerTable=rlSntpConfigServerTable, rlDaylightSavingTimeOffset=rlDaylightSavingTimeOffset, rlTimeSyncMethod=rlTimeSyncMethod, RlDaylightSavingTimeMode=RlDaylightSavingTimeMode, rlSntpAnycastAdminState=rlSntpAnycastAdminState, rlSntpNtpClient=rlSntpNtpClient, rlDaylightSavingTimeEnd=rlDaylightSavingTimeEnd, PYSNMP_MODULE_ID=rlTimeSynchronization, rlTimeZone=rlTimeZone, rlTimeZoneIndex=rlTimeZoneIndex, rlSntpAuthenticationKeyID=rlSntpAuthenticationKeyID, rlSntpAnycastDelay=rlSntpAnycastDelay, rlTimeZoneTimeZoneOffset=rlTimeZoneTimeZoneOffset, rlSntpAuthenticationRowStatus=rlSntpAuthenticationRowStatus, rlSntpNtpConfigSrvStratum=rlSntpNtpConfigSrvStratum, rlDhcpTimezoneOptionEnabled=rlDhcpTimezoneOptionEnabled, rlSntpBroadcastPollState=rlSntpBroadcastPollState, rlSntpAllServerInetOffset=rlSntpAllServerInetOffset, rlTimeZoneName=rlTimeZoneName, rlSntpAuthenticationEntry=rlSntpAuthenticationEntry, rlSntpAnycastInetAddressType=rlSntpAnycastInetAddressType, rlSntpAllServerInetEntry=rlSntpAllServerInetEntry, rlSntpAnycastInetOffset=rlSntpAnycastInetOffset, rlSntpAllServerInetKeyIdentifier=rlSntpAllServerInetKeyIdentifier, NTPStratum=NTPStratum, rlSntpBroadcastEntry=rlSntpBroadcastEntry, rlSntpAllServerInetAddress=rlSntpAllServerInetAddress, rlSntpNtpConfigSyncSrvStratum=rlSntpNtpConfigSyncSrvStratum, rlSntpAnycastInetDelay=rlSntpAnycastInetDelay, rlTimeZoneDataDynamicConfSource=rlTimeZoneDataDynamicConfSource, rlSntpNtpConfigPrimaryPollSrvAddr=rlSntpNtpConfigPrimaryPollSrvAddr, rlSntpAnycastLastResp=rlSntpAnycastLastResp, rlSntpConfigAnycastInetTable=rlSntpConfigAnycastInetTable, rlTimeSynchronization=rlTimeSynchronization, rlSntpAnycastRowStatus=rlSntpAnycastRowStatus, rlTimeSyncMethodMode=rlTimeSyncMethodMode, rlSntpAllServerPreference=rlSntpAllServerPreference, rlTimeZoneTimeZoneName=rlTimeZoneTimeZoneName, rlSntpConfigBroadcastInetTable=rlSntpConfigBroadcastInetTable, rlSntpAnycastOffset=rlSntpAnycastOffset, rlSntpBroadcastInetAddress=rlSntpBroadcastInetAddress, rlSntpNtpConfigPrimaryPollSrvIfIndex=rlSntpNtpConfigPrimaryPollSrvIfIndex, rlSntpAllServerInetStratum=rlSntpAllServerInetStratum, rlSntpAnycastInetStatus=rlSntpAnycastInetStatus, rlSntpConfigAnycastTable=rlSntpConfigAnycastTable, rlSntpBroadcastInetMode=rlSntpBroadcastInetMode, rlSntpBroadcastOffset=rlSntpBroadcastOffset, rlSntpNtpConfigSyncSrvType=rlSntpNtpConfigSyncSrvType, rlTimeZoneTimeZoneCode=rlTimeZoneTimeZoneCode, rlSntpServerInetAddressType=rlSntpServerInetAddressType, rlSntpNtpConfigSyncSrvAddr=rlSntpNtpConfigSyncSrvAddr, rlSntpAllServerIfIndex=rlSntpAllServerIfIndex, rlSntpServersKeyIdentifier=rlSntpServersKeyIdentifier, rlSntpServerStatus=rlSntpServerStatus, rlSntpUnicastAdminState=rlSntpUnicastAdminState, rlSntpBroadcastInetAddressType=rlSntpBroadcastInetAddressType, rlSntpNtpConfigSrvEntry=rlSntpNtpConfigSrvEntry, rlSntpAllServerInetAddressType=rlSntpAllServerInetAddressType, rlSntpAnycastInetIfIndex=rlSntpAnycastInetIfIndex, rlSntpBroadcastInetStatus=rlSntpBroadcastInetStatus, rlSntpAnycastInetEntry=rlSntpAnycastInetEntry, rlSntpBroadcastInetIfIndex=rlSntpBroadcastInetIfIndex, rlTimeZoneCode=rlTimeZoneCode, rlSntpBroadcastIfAdminState=rlSntpBroadcastIfAdminState, rlTZDSTOffset=rlTZDSTOffset, rlSntpAnycastInetStratum=rlSntpAnycastInetStratum, rlSntpBroadcastIfIndex=rlSntpBroadcastIfIndex, rlSntpBroadcastStatus=rlSntpBroadcastStatus, rlSntpServerInetLastResp=rlSntpServerInetLastResp, rlSntpBroadcastAdminState=rlSntpBroadcastAdminState, rlSntpNtpConfigMode=rlSntpNtpConfigMode, rlSntpNtpConfigRetryCnt=rlSntpNtpConfigRetryCnt, rlSntpServerLastResp=rlSntpServerLastResp, rlSntpServerInetRowStatus=rlSntpServerInetRowStatus, rlTimeAndDateHaveBeenSet=rlTimeAndDateHaveBeenSet, rlSntpAnycastStatus=rlSntpAnycastStatus, rlSntpServerInetKeyIdentifier=rlSntpServerInetKeyIdentifier, rlTimeZoneTimeSyncMethod=rlTimeZoneTimeSyncMethod, rlSntpBroadcastLastResp=rlSntpBroadcastLastResp, NTPTimeStamp=NTPTimeStamp, rlTimeSyncMibVersion=rlTimeSyncMibVersion, rlSntpServerPolled=rlSntpServerPolled, rlSntpNtpConfigSrvMrid=rlSntpNtpConfigSrvMrid, rlSntpBroadcastMode=rlSntpBroadcastMode, rlSntpBroadcastInetEntry=rlSntpBroadcastInetEntry, rlSntpServersOffset=rlSntpServersOffset, rlSntpRestoreDefaultServers=rlSntpRestoreDefaultServers, rlSntpNtpConfigSrvTable=rlSntpNtpConfigSrvTable, rlTimeZoneDataType=rlTimeZoneDataType, rlTimeZoneTable=rlTimeZoneTable, rlClockStatus=rlClockStatus, rlSntpNtpMibVersion=rlSntpNtpMibVersion, rlSntpBroadcastInetDelay=rlSntpBroadcastInetDelay, rlSntpNtpConfigSrvInetAddressType=rlSntpNtpConfigSrvInetAddressType, rlSntpServerInetStatus=rlSntpServerInetStatus, rlNtpConfig=rlNtpConfig, rlSntpNtpConfigPrimaryPollSrvMrid=rlSntpNtpConfigPrimaryPollSrvMrid, rlSntpAllServerInetStatus=rlSntpAllServerInetStatus, rlTimeValidFlag=rlTimeValidFlag, rlSntpNtpConfigPrimaryPollSrvStratum=rlSntpNtpConfigPrimaryPollSrvStratum, rlSntpAnycastIfIndex=rlSntpAnycastIfIndex, rlSntpAnycastInetAddress=rlSntpAnycastInetAddress, rlSntpBroadcastInetOffset=rlSntpBroadcastInetOffset, rlSntpNtpConfigSrvIfIndex=rlSntpNtpConfigSrvIfIndex, rlSntpClientMode=rlSntpClientMode, rlSntpServerInetDelay=rlSntpServerInetDelay, rlTimeZoneDaylightSavingTimeStart=rlTimeZoneDaylightSavingTimeStart, rlSntpPort=rlSntpPort, rlSntpConfig=rlSntpConfig, rlSntpNtpConfigSyncSrvIfIndex=rlSntpNtpConfigSyncSrvIfIndex, rlSntpNtpConfigSrvEntryType=rlSntpNtpConfigSrvEntryType, rlSntpBroadcastInetIfAdminState=rlSntpBroadcastInetIfAdminState, rlSntpAnycastInetRowStatus=rlSntpAnycastInetRowStatus, rndTimeSyncManagedDateTime=rndTimeSyncManagedDateTime, rlSntpServerStratum=rlSntpServerStratum, rlDaylightSavingTimeCode=rlDaylightSavingTimeCode, RlTimeSyncMethod=RlTimeSyncMethod, rlSntpBroadcastInetRowStatus=rlSntpBroadcastInetRowStatus, rlSntpServerEntry=rlSntpServerEntry, rlSntpAuthenticationState=rlSntpAuthenticationState, RlSntpNtpSyncEntryType=RlSntpNtpSyncEntryType, rlTimeZoneDaylightSavingTimeEnd=rlTimeZoneDaylightSavingTimeEnd, rlSntpNtpConfigSrvSyncType=rlSntpNtpConfigSrvSyncType, rlSntpBroadcastDelay=rlSntpBroadcastDelay, rlSntpAnycastInetLastResp=rlSntpAnycastInetLastResp, rlSntpAllServerInetPolled=rlSntpAllServerInetPolled, rlSntpBroadcastRowStatus=rlSntpBroadcastRowStatus, rlSntpServerRowStatus=rlSntpServerRowStatus, rlSntpServerInetOffset=rlSntpServerInetOffset, rlSntpAuthenticationKeyValue=rlSntpAuthenticationKeyValue, rlSntpConfigAuthenticationTable=rlSntpConfigAuthenticationTable, rlSntpAuthenticationKeyState=rlSntpAuthenticationKeyState, rlSntpServerInetAddress=rlSntpServerInetAddress, rlSntpBroadcastInetPolled=rlSntpBroadcastInetPolled, rlTimeZoneTZDSTOffset=rlTimeZoneTZDSTOffset, rlSntpServerInetEntry=rlSntpServerInetEntry, rlTimeZoneDaylightSavingTimeCode=rlTimeZoneDaylightSavingTimeCode, rlSntpAllServerSource=rlSntpAllServerSource, rlSntpConfigServerInetTable=rlSntpConfigServerInetTable, rlSntpServerAddress=rlSntpServerAddress, rlTimeZoneDataSourceIfIndex=rlTimeZoneDataSourceIfIndex, NTPSignedTimeValue=NTPSignedTimeValue, rlSntpNtpConfig=rlSntpNtpConfig, rlSntpBroadcastPolled=rlSntpBroadcastPolled, rlSntpBroadcastInetStratum=rlSntpBroadcastInetStratum, rlTimeZoneEntry=rlTimeZoneEntry, rlSntpAnycastEntry=rlSntpAnycastEntry, rlSntpBroadcastStratum=rlSntpBroadcastStratum, rlSntpNtpConfigSyncSrvMrid=rlSntpNtpConfigSyncSrvMrid, rlDaylightSavingTimeStart=rlDaylightSavingTimeStart, rlSntpServersDelay=rlSntpServersDelay, rlSntpAnycastPollState=rlSntpAnycastPollState, rlAutomaticClockSetFromPCEnabled=rlAutomaticClockSetFromPCEnabled, rlSntpAnycastAddress=rlSntpAnycastAddress, rlDaylightSavingTimeMode=rlDaylightSavingTimeMode, rlSntpAnycastStratum=rlSntpAnycastStratum, rlSntpNtpConfigSysStratum=rlSntpNtpConfigSysStratum, rlSntpBroadcastInetLastResp=rlSntpBroadcastInetLastResp, RlSntpNtpSyncType=RlSntpNtpSyncType, rndTimeSyncManagedTime=rndTimeSyncManagedTime, rlSntpConfigBroadcastTable=rlSntpConfigBroadcastTable, rlSntpBroadcastAddress=rlSntpBroadcastAddress, rlSntpServerInetPolled=rlSntpServerInetPolled, rlTimeZoneDaylightSavingTimeOffset=rlTimeZoneDaylightSavingTimeOffset, rlSntpUnicastPollState=rlSntpUnicastPollState)
