...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/Dell-vlanVoice-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:58:02 2019
...
Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, TimeTicks, Counter32, IpAddress, Integer32, NotificationType, ModuleIdentity, iso, Unsigned32, Counter64, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "TimeTicks", "Counter32", "IpAddress", "Integer32", "NotificationType", "ModuleIdentity", "iso", "Unsigned32", "Counter64", "Bits")
...
if mibBuilder.loadTexts: vlanVoice.setContactInfo('Dell.com')
if mibBuilder.loadTexts: vlanVoice.setDescription('The private MIB module definition for voice vlan support in Dell devices.')
...
mibBuilder.exportSymbols("Dell-vlanVoice-MIB", vlanVoiceOUIBasedPrefix=vlanVoiceOUIBasedPrefix, vlanVoiceOUIBasedDescription=vlanVoiceOUIBasedDescription, vlanVoiceOUIBasedPortEntry=vlanVoiceOUIBasedPortEntry, vlanVoiceUcDeviceVid=vlanVoiceUcDeviceVid, vlanVoiceOUIBased=vlanVoiceOUIBased, vlanVoiceAuto=vlanVoiceAuto, vlanVoiceUcDeviceInterface=vlanVoiceUcDeviceInterface, vlanVoiceUcDeviceTable=vlanVoiceUcDeviceTable, vlanVoiceAutoAdminDscp=vlanVoiceAutoAdminDscp, vlanVoiceOperState=vlanVoiceOperState, vlanVoiceUcDeviceIsBest=vlanVoiceUcDeviceIsBest, vlanVoiceOUIBasedAgingTimeout=vlanVoiceOUIBasedAgingTimeout, vlanVoiceOUIBasedPortSecure=vlanVoiceOUIBasedPortSecure, vlanVoiceUcDeviceDscp=vlanVoiceUcDeviceDscp, vlanVoiceOUIBasedPortCurrentMembership=vlanVoiceOUIBasedPortCurrentMembership, vlanVoiceAutoOperPriority=vlanVoiceAutoOperPriority, vlanVoiceAutoOperVpt=vlanVoiceAutoOperVpt, vlanVoiceAutoOper=vlanVoiceAutoOper, vlanVoiceUcDeviceEntry=vlanVoiceUcDeviceEntry, vlanVoiceAutoOperDscp=vlanVoiceAutoOperDscp, vlanVoiceAutoAdminVpt=vlanVoiceAutoAdminVpt, vlanVoiceOUIBasedEntryRowStatus=vlanVoiceOUIBasedEntryRowStatus, vlanVoiceOperVid=vlanVoiceOperVid, vlanVoiceUcDeviceType=vlanVoiceUcDeviceType, vlanVoiceOUIBasedAdminRemark=vlanVoiceOUIBasedAdminRemark, vlanVoiceOUIBasedTable=vlanVoiceOUIBasedTable, vlanVoiceAutoAgreedVlanLastChange=vlanVoiceAutoAgreedVlanLastChange, vlanVoiceOUIBasedAdminPriority=vlanVoiceOUIBasedAdminPriority, vlanVoiceUcDeviceMacAddress=vlanVoiceUcDeviceMacAddress, vlanVoiceAutoAdmin=vlanVoiceAutoAdmin, vlanVoiceOUIBasedEntry=vlanVoiceOUIBasedEntry, PYSNMP_MODULE_ID=vlanVoice, vlanVoiceAdminState=vlanVoiceAdminState, vlanVoiceOUIBasedPortQosMode=vlanVoiceOUIBasedPortQosMode, vlanVoiceOUIBasedSetToDefault=vlanVoiceOUIBasedSetToDefault, vlanVoiceOUIBasedPortVlanIndex=vlanVoiceOUIBasedPortVlanIndex, vlanVoice=vlanVoice, vlanVoiceOUIBasedPortEnable=vlanVoiceOUIBasedPortEnable, vlanVoiceOUIBasedPortTable=vlanVoiceOUIBasedPortTable, vlanVoiceAdminVid=vlanVoiceAdminVid, vlanVoiceAutoOperSource=vlanVoiceAutoOperSource, vlanVoiceUcDeviceVpt=vlanVoiceUcDeviceVpt, vlanVoiceAutoRefresh=vlanVoiceAutoRefresh)
