...
# Produced by pysmi-0.3.4 at Wed May  1 12:46:02 2019
...
MibIdentifier, NotificationType, Counter32, ObjectIdentity, TimeTicks, IpAddress, Bits, Gauge32, Integer32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Unsigned32, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "Counter32", "ObjectIdentity", "TimeTicks", "IpAddress", "Bits", "Gauge32", "Integer32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Unsigned32", "Counter64")
...
mibBuilder.exportSymbols("DGS3120-48PC-L2MGMT-MIB", swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2PortInfoMediumType=swL2PortInfoMediumType, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2DevInfo=swL2DevInfo, swL2PortSecurityViolationSeverity=swL2PortSecurityViolationSeverity, swL2TrunkVLANTable=swL2TrunkVLANTable, swL2DhcpLocalRelayState=swL2DhcpLocalRelayState, swL2macNotification=swL2macNotification, swL2SubnetVLANPriority=swL2SubnetVLANPriority, swL2TrunkVLANPort=swL2TrunkVLANPort, swL2VlanPrecedenceClassification=swL2VlanPrecedenceClassification, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2TrunkMgmt=swL2TrunkMgmt, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2PortCtrlJumboFrameMaxSize=swL2PortCtrlJumboFrameMaxSize, swL2IGMPAccessAuthState=swL2IGMPAccessAuthState, swL2DhcpLocalRelayVLANState=swL2DhcpLocalRelayVLANState, swL2PortInfoType=swL2PortInfoType, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2NotifyPrefix=swL2NotifyPrefix, swL2DhcpLocalRelayMgmt=swL2DhcpLocalRelayMgmt, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2SubnetVLANEntry=swL2SubnetVLANEntry, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2TrunkMember=swL2TrunkMember, PortList=PortList, swL2PortCtrlMDIXState=swL2PortCtrlMDIXState, swL2VlanStaticEntry=swL2VlanStaticEntry, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, IANAifMauAutoNegCapBits=IANAifMauAutoNegCapBits, swL2TrunkState=swL2TrunkState, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2VlanPortInfoTable=swL2VlanPortInfoTable, swL2PortCounterCtrlPortIndex=swL2PortCounterCtrlPortIndex, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2VlanPortInfoPortIndex=swL2VlanPortInfoPortIndex, swL2DevAlarm=swL2DevAlarm, swL2SubnetVLANID=swL2SubnetVLANID, swL2VLANMgmt=swL2VLANMgmt, swL2PortCtrlMediumType=swL2PortCtrlMediumType, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2PortMgmt=swL2PortMgmt, swL2TrunkVLANState=swL2TrunkVLANState, swL2VlanPortInfoEntry=swL2VlanPortInfoEntry, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2DhcpLocalRelayVLANTable=swL2DhcpLocalRelayVLANTable, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2DevCtrlSnmpTrapState=swL2DevCtrlSnmpTrapState, swL2PVIDAutoAssignmentState=swL2PVIDAutoAssignmentState, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swL2VlanPrecedencePortIndex=swL2VlanPrecedencePortIndex, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2DevCtrlCFMPortState=swL2DevCtrlCFMPortState, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2DevCtrlCFMState=swL2DevCtrlCFMState, swL2PortCounterClearCtrl=swL2PortCounterClearCtrl, swL2MACNotifyState=swL2MACNotifyState, swL2VlanPrecedenceEntry=swL2VlanPrecedenceEntry, swL2MulticastFilterModeVlanTable=swL2MulticastFilterModeVlanTable, swL2VlanPortInfoVid=swL2VlanPortInfoVid, swL2NotifFirmware=swL2NotifFirmware, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2PortInfoTable=swL2PortInfoTable, swL2DevCtrlCFM=swL2DevCtrlCFM, swL2PortCounterCtrlEntry=swL2PortCounterCtrlEntry, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2IGMPAccessAuthPort=swL2IGMPAccessAuthPort, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2macNotifyInfo=swL2macNotifyInfo, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2IGMPMgmt=swL2IGMPMgmt, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2PortInfoEntry=swL2PortInfoEntry, swL2MgmtMIB=swL2MgmtMIB, swL2TrunkType=swL2TrunkType, swL2SubnetVLANIPMask=swL2SubnetVLANIPMask, swL2VlanIndex=swL2VlanIndex, swL2NotifyMgmt=swL2NotifyMgmt, swL2IGMPAccessAuthTable=swL2IGMPAccessAuthTable, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2MulticastFilterVlanMode=swL2MulticastFilterVlanMode, MacAddress=MacAddress, swL2MulticastFilterVid=swL2MulticastFilterVid, swL2VlanStaticTable=swL2VlanStaticTable, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2TrafficSegTable=swL2TrafficSegTable, swL2DevCtrlCFMPortTable=swL2DevCtrlCFMPortTable, swL2MACNotifyInterval=swL2MACNotifyInterval, VlanId=VlanId, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2TrunkVLANEntry=swL2TrunkVLANEntry, swL2Notify=swL2Notify, swL2DevMgmt=swL2DevMgmt, swL2SubnetVLANIPAddress=swL2SubnetVLANIPAddress, swL2DevCtrlCFMPortIndex=swL2DevCtrlCFMPortIndex, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2DevCtrlVLANTrunkState=swL2DevCtrlVLANTrunkState, swL2DevCtrlCFMPortEntry=swL2DevCtrlCFMPortEntry, swL2IGMPAccessAuthEntry=swL2IGMPAccessAuthEntry, swL2VlanPortInfoPortRole=swL2VlanPortInfoPortRole, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2MirrorMgmt=swL2MirrorMgmt, swL2PortCtrlLearningState=swL2PortCtrlLearningState, swL2macNotificationSeverity=swL2macNotificationSeverity, swL2DevCtrl=swL2DevCtrl, swL2DhcpLocalRelayVLANID=swL2DhcpLocalRelayVLANID, swL2PortCtrlTable=swL2PortCtrlTable, swL2TrafficSegPort=swL2TrafficSegPort, swL2PortCounterCtrlTable=swL2PortCounterCtrlTable, swL2MulticastFilterMode=swL2MulticastFilterMode, swL2PortInfoErrorDisabled=swL2PortInfoErrorDisabled, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2DevCtrlIpAutoconfig=swL2DevCtrlIpAutoconfig, swL2NniGvrpBpduAddress=swL2NniGvrpBpduAddress, swL2MulticastFilterModeVlanEntry=swL2MulticastFilterModeVlanEntry, swL2DevCtrlAsymVlanState=swL2DevCtrlAsymVlanState, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swL2DhcpLocalRelayVLANEntry=swL2DhcpLocalRelayVLANEntry, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2PortInfoUnitID=swL2PortInfoUnitID, swL2SubnetVLANRowStatus=swL2SubnetVLANRowStatus, swL2VlanPrecedenceTable=swL2VlanPrecedenceTable, swL2MirrorPortState=swL2MirrorPortState, swL2SubnetVLANTable=swL2SubnetVLANTable, swl2NotificationBidings=swl2NotificationBidings, swL2TrunkIndex=swL2TrunkIndex, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2VLANAdvertisement=swL2VLANAdvertisement, swL2TrafficSegEntry=swL2TrafficSegEntry)
