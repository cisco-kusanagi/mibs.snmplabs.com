...
if mibBuilder.loadTexts: st2AgentCopyright.setDescription('provider of (company which wrote) the ST-II agent code, code release info and copyright info')
...
if mibBuilder.loadTexts: st2ProtoVersion.setDescription('version of ST-II running; RFC-1190 for starters')
...
if mibBuilder.loadTexts: st2FlowSpecVersion.setDescription('registered version number of Flow Spec')
...
if mibBuilder.loadTexts: st2AgentType.setDescription('whether this system performs ST-II end-system or intermediate-system functions or both')
...
if mibBuilder.loadTexts: st2RoutingDerived.setDescription('where does ST-II get routes from, whether IP routing tables or some other means')
...
if mibBuilder.loadTexts: st2ToAccept.setDescription('Initial hop-by-hop timeout for acknowledgment of ACCEPT')
...
if mibBuilder.loadTexts: st2NAccept.setDescription('number of ACCEPT retries before returning a failure')
...
if mibBuilder.loadTexts: st2ToConnect.setDescription('Initial hop-by-hop timeout for acknowledgment of CONNECT')
...
if mibBuilder.loadTexts: st2NConnect.setDescription('number of CONNECT retries before returning a failure')
...
if mibBuilder.loadTexts: st2ToDisconnect.setDescription('Initial hop-by-hop timeout for acknowledgment of DISCONNECT')
...
if mibBuilder.loadTexts: st2NDisconnect.setDescription('number of DISCONNECT retries before returning a failure')
...
if mibBuilder.loadTexts: st2ToHidAck.setDescription('Initial hop-by-hop timeout for acknowledgment of HID-CHANGE-REQUEST')
...
if mibBuilder.loadTexts: st2NHidAck.setDescription('number of HID-CHANGE-REQUEST retries before returning a failure')
...
if mibBuilder.loadTexts: st2ToHidChange.setDescription('Initial hop-by-hop timeout for acknowledgment of HID-CHANGE')
...
if mibBuilder.loadTexts: st2NHidChange.setDescription('number of HID-CHANGE retries before returning a failure')
...
if mibBuilder.loadTexts: st2ToNotify.setDescription('Initial hop-by-hop timeout for acknowledgment of NOTIFY')
...
if mibBuilder.loadTexts: st2NNotify.setDescription('number of NOTIFY retries before returning a failure')
...
if mibBuilder.loadTexts: st2ToRefuse.setDescription('Initial hop-by-hop timeout for acknowledgment of REFUSE')
...
if mibBuilder.loadTexts: st2NRefuse.setDescription('number of REFUSE retries before returning a failure')
...
if mibBuilder.loadTexts: st2ToReroute.setDescription('Timeout for receipt of ACCEPT or REFUSE from targets during failure recovery, allowing intermediate systems time to try recovery')
...
if mibBuilder.loadTexts: st2NReroute.setDescription('number of CONNECT retries before returning a failure from targets')
...
if mibBuilder.loadTexts: st2ToEnd2End.setDescription('End-to-end timeout for receipt of ACCEPT or REFUSE from targets by origin during failure recovery, allowing intermediate systems time to try recovery')
...
if mibBuilder.loadTexts: st2NEnd2End.setDescription('number of CONNECT retries before origin returns a failure from targets')
...
if mibBuilder.loadTexts: st2NHidAbort.setDescription('Number of rejected HID proposals before aborting the HID negotiation process')
...
if mibBuilder.loadTexts: st2HelloTimerHoldDown.setDescription('Interval that Restarted bit must be set after ST Agent restart')
...
if mibBuilder.loadTexts: st2HelloLossFactor.setDescription('Number of consecutively missed HELLO messages before declaring link failure to neighbor')
...
if mibBuilder.loadTexts: st2DefaultRecoveryTimeout.setDescription('Default for interval between successive HELLOs to/from active neighbors')
...
if mibBuilder.loadTexts: st2DefaultHelloFactor.setDescription('HELLO filtering function factor')
...
if mibBuilder.loadTexts: st2ScmpRcvdOctets.setDescription('Total octets of SCMP messages received')
...
if mibBuilder.loadTexts: st2ScmpSentOctets.setDescription('Total octets of SCMP messages sent')
...
if mibBuilder.loadTexts: st2ScmpRcvdBadTypes.setDescription('Count of SCMP messages received with bad type field')
...
if mibBuilder.loadTexts: st2ScmpRcvdBadCks.setDescription('Count of SCMP messages received with bad checksum')
...
if mibBuilder.loadTexts: st2ScmpSentAccepts.setDescription('Count of SCMP ACCEPT messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentAcks.setDescription('Count of SCMP ACK messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentChanges.setDescription('Count of SCMP CHANGE messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentChangeReqs.setDescription('Count of SCMP CHANGE-REQUEST messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentConnects.setDescription('Count of SCMP CONNECT messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentDisconnects.setDescription('Count of SCMP DISCONNECT messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentErrorInReqs.setDescription('Count of SCMP ERROR-IN-REQUEST messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentErrorInResps.setDescription('Count of SCMP ERROR-IN-RESPONSE messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentHellos.setDescription('Count of SCMP HELLO messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentHidApproves.setDescription('Count of SCMP HID-APPROVE messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentHidChanges.setDescription('Count of SCMP HID-CHANGE messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentHidChangeReqs.setDescription('Count of SCMP HID-CHANGE-REQUEST messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentHidRejects.setDescription('Count of SCMP HID-REJECT messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentNotifys.setDescription('Count of SCMP NOTIFY messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentRefuses.setDescription('Count of SCMP REFUSE messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentStatus.setDescription('Count of SCMP STATUS messages sent')
...
if mibBuilder.loadTexts: st2ScmpSentStatusResps.setDescription('Count of SCMP STATUS-RESPONSE messages sent')
...
if mibBuilder.loadTexts: st2ScmpRcvdAccepts.setDescription('Count of SCMP ACCEPT messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdAcks.setDescription('Count of SCMP ACK messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdChanges.setDescription('Count of SCMP CHANGE messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdChangeReqs.setDescription('Count of SCMP CHANGE-REQUEST messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdConnects.setDescription('Count of SCMP CONNECT messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdDisconnects.setDescription('Count of SCMP DISCONNECT messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdErrorInReqs.setDescription('Count of SCMP ERROR-IN-REQUEST messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdErrorInResps.setDescription('Count of SCMP ERROR-IN-RESPONSE messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdHellos.setDescription('Count of SCMP HELLO messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdHidApproves.setDescription('Count of SCMP HID-APPROVE messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdHidChanges.setDescription('Count of SCMP HID-CHANGE messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdHidChangeReqs.setDescription('Count of SCMP HID-CHANGE-REQUEST messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdHidRejects.setDescription('Count of SCMP HID-REJECT messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdNotifys.setDescription('Count of SCMP NOTIFY messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdRefuses.setDescription('Count of SCMP REFUSE messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdStatus.setDescription('Count of SCMP STATUS messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdStatusResps.setDescription('Count of SCMP STATUS-RESPONSE messages received')
...
if mibBuilder.loadTexts: st2ScmpRcvdErrorSnap.setDescription('Contents from last SCMP packet received with error')
...
if mibBuilder.loadTexts: st2ScmpRcvdBadTypeTime.setDescription('Time that last SCMP packet was received with bad Type field')
...
if mibBuilder.loadTexts: st2ScmpRcvdBadCksTime.setDescription('Time that last SCMP packet was received with bad checksum')
...
if mibBuilder.loadTexts: st2OriginOpens.setDescription('Count of streams opened with this agent as origin, but they may have since been closed')
...
if mibBuilder.loadTexts: st2IntermedOpens.setDescription('Count of streams opened with this agent as intermediate system')
...
if mibBuilder.loadTexts: st2TargetOpens.setDescription('Count of streams opened with this agent as target (destination) - may also be counted in intermediate')
...
if mibBuilder.loadTexts: st2FailOpens.setDescription('Count of stream opens attempted which did not complete')
...
if mibBuilder.loadTexts: st2AcceptTimeouts.setDescription('Count of stream opens failed because ACCEPT did not get acknowledged')
...
if mibBuilder.loadTexts: st2ParamChangeFails.setDescription('Count of stream parameter changes which failed')
...
if mibBuilder.loadTexts: st2NumStreamEntries.setDescription('Count of stream table entries (extent of streams table)')
...
if mibBuilder.loadTexts: st2NumOpenStreams.setDescription('Count of streams which are open (number of table entries for them)')
...
if mibBuilder.loadTexts: st2NumOpenOriginStreams.setDescription('Count of current open streams which were originated here')
...
if mibBuilder.loadTexts: st2NumHops.setDescription('Count of Hop entries (extent of next-hop table)')
...
if mibBuilder.loadTexts: st2NumNeighbors.setDescription('Count of Neighbor entries (extent of neighbor table)')
...
if mibBuilder.loadTexts: st2NumTargets.setDescription('Count of target entries (extent of target table)')
...
if mibBuilder.loadTexts: st2NumGroups.setDescription('count of group entries (extent of groups table)')
...
if mibBuilder.loadTexts: st2NumSubgroups.setDescription('Count of subgroup entries (extent of subgroups table)')
...
if mibBuilder.loadTexts: st2RouteFailures.setDescription('Count of stream opens failed because no route found')
...
if mibBuilder.loadTexts: st2RouteLoops.setDescription('Count of stream opens failed because route inconsistency found, e.g. potential or actual loop')
...
if mibBuilder.loadTexts: st2ScmpRetrans.setDescription('count of SCMP control timeout and retransmissions')
st2StreamTable = MibTable((1, 3, 6, 1, 4, 1, 18, 3, 5, 16, 1, 2, 5, 87), )
if mibBuilder.loadTexts: st2StreamTable.setStatus('mandatory')
if mibBuilder.loadTexts: st2StreamTable.setDescription('table of information for each stream')
...
if mibBuilder.loadTexts: st2StreamName.setDescription('internal format name of this stream')
...
if mibBuilder.loadTexts: st2StreamPrevHopAddr.setDescription('previous hop entry which feeds data to this node')
...
if mibBuilder.loadTexts: st2StreamPrevHopVlid.setDescription('virtual link identifier of the previous hop')
...
if mibBuilder.loadTexts: st2StreamStartTime.setDescription('timestamp when this stream was first entered in this table')
...
if mibBuilder.loadTexts: st2StreamState.setDescription('current state of this stream at this node')
...
if mibBuilder.loadTexts: st2StreamStateTime.setDescription('time this stream entered its current state')
...
if mibBuilder.loadTexts: st2StreamRole.setDescription('role that this agent performs for this stream')
...
if mibBuilder.loadTexts: st2StreamGroup.setDescription('group (if any) which this stream is in')
...
if mibBuilder.loadTexts: st2StreamNumSubgroups.setDescription('number of subgroups which this stream is in (get info from subgroup table)')
...
if mibBuilder.loadTexts: st2StreamNumNextHops.setDescription('number of nexthops to which this stream feeds data (get info from hop table)')
...
if mibBuilder.loadTexts: st2StreamNumTargets.setDescription('number of targets to which this stream feeds data (get info from target table)')
...
if mibBuilder.loadTexts: st2StreamRefuses.setDescription('number of times this stream has suffered the ignominy of getting changes refused')
...
if mibBuilder.loadTexts: st2StreamFlowspecChanges.setDescription('number of times this flowspec has been changed over the duration of this stream.')
...
if mibBuilder.loadTexts: st2StreamFlowPrecedence.setDescription('flowspec precedence field (8 bits) -- NOTE: THIS MOVES DOWN BELOW ERROR RATE')
...
if mibBuilder.loadTexts: st2StreamFlowDutyFactor.setDescription('flowspec dutyfactor field (8 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowErrorRate.setDescription('flowspec error rate field (8 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowReliability.setDescription('flowspec reliability field (8 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowTradeoffs.setDescription('flowspec tradeoffs field (16 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowRecoveryTimeout.setDescription('flowspec recovery timeout field (16 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowLimitOnCost.setDescription('flowspec limit on cost field (16 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowLimitOnDelay.setDescription('flowspec limit on delay field (16 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowLimitOnPduBytes.setDescription('flowspec LIMIT ON PDU BYTES (pdu size in octets) field (16 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowLimitOnPduRate.setDescription('flowspec limit on pdu rate field (16 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowMinBytesXRate.setDescription('flowspec min bytes x rate field (product gives bandwidth in bytes per 10 seconds; divide by 1250 for Kbits per second) (32 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowMeanDelay.setDescription('flowspec accumulated mean delay field (32 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowDelayVariance.setDescription('flowspec accumulated delay variance field (32 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowDesPduBytes.setDescription('flowspec desired pdu bytes (size) field (16 bits)')
...
if mibBuilder.loadTexts: st2StreamFlowDesPduRate.setDescription('flowspec desired pdu rate field (16 bits)')
...
if mibBuilder.loadTexts: st2StreamOptionPtp.setDescription('true if POINT TO POINT option specified on this stream')
...
if mibBuilder.loadTexts: st2StreamOptionFdx.setDescription('true if FULL DUPLEX option specified on this stream; reverse stream is the same but takes a separate stream table entry in this MIB')
...
if mibBuilder.loadTexts: st2StreamOptionRecover.setDescription('false if NO RECOVERY option specified for this stream')
...
if mibBuilder.loadTexts: st2StreamOptionReverseCharge.setDescription('true if REVERSE CHARGE option specified for this stream')
...
if mibBuilder.loadTexts: st2StreamOptionTimestamp.setDescription('the TIMESTAMP option specified for this stream')
st2HopTable = MibTable((1, 3, 6, 1, 4, 1, 18, 3, 5, 16, 1, 2, 5, 88), )
if mibBuilder.loadTexts: st2HopTable.setStatus('mandatory')
if mibBuilder.loadTexts: st2HopTable.setDescription('table of information for each prev- or next-hop')
...
if mibBuilder.loadTexts: st2HopHid.setDescription('HID which this node has negotiated with this next hop (and all others on a multicast)')
...
if mibBuilder.loadTexts: st2HopMyVlid.setDescription('VLID (table index or something) by which this next hop addresses me')
...
if mibBuilder.loadTexts: st2HopYourVlid.setDescription('VLID (table index or something) by which I address this next hop')
...
if mibBuilder.loadTexts: st2HopState.setDescription('state of negotiation for this stream to this hop')
...
if mibBuilder.loadTexts: st2HopStateTime.setDescription('time this state was entered')
...
if mibBuilder.loadTexts: st2HopNumTargets.setDescription('number of targets reached via this next hop')
...
if mibBuilder.loadTexts: st2HopMcastAddr.setDescription('multicast address, if any, used to reach this hop and others on same net (for current ST-II, this does not work here)(this should be an IP multicast address, or some magic IP address which translates into local-net multicast')
...
if mibBuilder.loadTexts: st2HopErrorCode.setDescription('refuse code or other error indicator received from next hop')
...
if mibBuilder.loadTexts: st2HopDetectorAddr.setDescription('detector address field from error message received from next hop')
...
if mibBuilder.loadTexts: st2HopNeighborAddr.setDescription('ip address of neighbor which is this next hop (it has the info rfc1190 to all next hops for streams which go through that node)')
...
if mibBuilder.loadTexts: st2HopStreamName.setDescription('back pointer to stream for which this is a hop')
...
if mibBuilder.loadTexts: st2HopPkts.setDescription('count of packets received from this hop in this stream, or sent in this stream to this hop, depending on st2HopRole')
...
if mibBuilder.loadTexts: st2HopOctets.setDescription('count of octets received from this hop in this stream, or sent in this stream to this hop, depending on st2HopRole')
...
if mibBuilder.loadTexts: st2HopDiscards.setDescription('count of packets received from this hop in this stream and not processed, or not able to be sent in this stream to this hop, depending on st2HopRole')
...
if mibBuilder.loadTexts: st2HopIpEncap.setDescription('true if data for this stream is sent with IP encapsulation to this next hop')
...
if mibBuilder.loadTexts: st2HopIpAddr.setDescription('if ip encapsulation is on, this is the direct (local) next hop IP address of the next router on the path. the ST agent next hop can be further away. Implementations might store this so as to bypass the IP routing function.')
...
if mibBuilder.loadTexts: st2HopRole.setDescription('tells whether this hop entry is a previous-hop for this stream or a next-hop. this is to help identify whether the packet, octet and discard counters are for input from a prev-hop or output to a next-hop.')
...
if mibBuilder.loadTexts: st2HopInterfaceIndex.setDescription('Interface Index')
...
if mibBuilder.loadTexts: st2HopErrorTime.setDescription('Time when refuse code or other error occurs')
st2NeighborTable = MibTable((1, 3, 6, 1, 4, 1, 18, 3, 5, 16, 1, 2, 5, 89), )
if mibBuilder.loadTexts: st2NeighborTable.setStatus('mandatory')
if mibBuilder.loadTexts: st2NeighborTable.setDescription('table of information for each neighbor common info')
...
if mibBuilder.loadTexts: st2NeighborAddr.setDescription('address of neighbor ST Agent serving as nexthop or previous hop for one or more streams')
...
if mibBuilder.loadTexts: st2NeighborState.setDescription('state of neighbor ST Agent w.r.t. hellos and data')
...
if mibBuilder.loadTexts: st2NeighborStateTime.setDescription('time entered this state of neighbor ST Agent')
...
if mibBuilder.loadTexts: st2NeighborNumHops.setDescription('number of hops using this neighbor for next or prev')
...
if mibBuilder.loadTexts: st2NeighborHelloTimer.setDescription('min of hello times based on RecoveryTimeout for all streams via this neighbor - or possibly default. Note: ST specifies this in milliseconds')
...
if mibBuilder.loadTexts: st2NeighborHelloRcvdTime.setDescription('timestamp when most recent hello received from this neighbor')
...
if mibBuilder.loadTexts: st2NeighborDataRcvdTime.setDescription('timestamp when most recent ST data received from this neighbor - this may be updated infrequently, perhaps every couple of seconds')
...
if mibBuilder.loadTexts: st2NeighborAckRequested.setDescription('I have requested an ACK from this neighbor, still outstanding - for RTT estimation')
...
if mibBuilder.loadTexts: st2NeighborRestarted.setDescription('hello received from this neighbor with the restart bit on indicating neighbor has restarted recently')
...
if mibBuilder.loadTexts: st2NeighborSentHellos.setDescription('count of hellos sent to this neighbor')
...
if mibBuilder.loadTexts: st2NeighborRcvdHellos.setDescription('count of hellos received from this neighbor')
...
if mibBuilder.loadTexts: st2NeighborMissedHellos.setDescription('count of hellos expected which were not received from this neighbor')
...
if mibBuilder.loadTexts: st2NeighborRoundTripTime.setDescription('current estimate of round trip time to this neighbor based on hello exchanges')
...
if mibBuilder.loadTexts: st2NeighborInterfaceIdx.setDescription('internal index of interface which reaches this neighbor')
...
if mibBuilder.loadTexts: st2NeighborStBadMsgs.setDescription('count of bad stream data messages received from this neighbor')
...
if mibBuilder.loadTexts: st2NeighborScmpBadMsgs.setDescription('count of bad stream control messages received from this neighbor')
st2TargetTable = MibTable((1, 3, 6, 1, 4, 1, 18, 3, 5, 16, 1, 2, 5, 90), )
if mibBuilder.loadTexts: st2TargetTable.setStatus('mandatory')
if mibBuilder.loadTexts: st2TargetTable.setDescription('table of information for each target')
...
if mibBuilder.loadTexts: st2TargetAddr.setDescription('ip address of target')
...
if mibBuilder.loadTexts: st2TargetHop.setDescription('ip address of the nexthop which gets to this target')
...
if mibBuilder.loadTexts: st2TargetStreamName.setDescription('name of the stream this target is a member of')
st2GroupTable = MibTable((1, 3, 6, 1, 4, 1, 18, 3, 5, 16, 1, 2, 5, 91), )
if mibBuilder.loadTexts: st2GroupTable.setStatus('mandatory')
if mibBuilder.loadTexts: st2GroupTable.setDescription('table of information for each group')
...
if mibBuilder.loadTexts: st2GroupName.setDescription('the ST-II name of this group of streams')
...
if mibBuilder.loadTexts: st2GroupId.setDescription('a group identifier')
...
if mibBuilder.loadTexts: st2GroupNumStreams.setDescription('number of streams which are members of this group')
...
if mibBuilder.loadTexts: st2GroupNumSubgroups.setDescription('number of subgroups in this group')
st2SubgroupTable = MibTable((1, 3, 6, 1, 4, 1, 18, 3, 5, 16, 1, 2, 5, 92), )
if mibBuilder.loadTexts: st2SubgroupTable.setStatus('mandatory')
if mibBuilder.loadTexts: st2SubgroupTable.setDescription('table of information for each sub-group')
...
if mibBuilder.loadTexts: st2SubgroupGroup.setDescription('group which this subgroup is a member')
...
if mibBuilder.loadTexts: st2SubgroupNumStreams.setDescription('number of streams in this subgroup')
...
if mibBuilder.loadTexts: st2SubgroupIndex.setDescription('internal index into sub-group table')
st2InterfaceTable = MibTable((1, 3, 6, 1, 4, 1, 18, 3, 5, 16, 1, 2, 5, 93), )
if mibBuilder.loadTexts: st2InterfaceTable.setStatus('mandatory')
if mibBuilder.loadTexts: st2InterfaceTable.setDescription('table of information for each interface')
...
if mibBuilder.loadTexts: st2InterfaceIndex.setDescription('interface index of this interface - like ifIndex from main MIB')
...
if mibBuilder.loadTexts: st2InterfaceNumInStreams.setDescription('number of streams coming in this interface')
...
if mibBuilder.loadTexts: st2InterfaceNumOutStreams.setDescription('number of streams going out this interface')
...
if mibBuilder.loadTexts: st2InterfaceNumNeighbors.setDescription('number of neighbors on this interface being used as prev or next hop')
...
if mibBuilder.loadTexts: st2InterfaceInBwReserved.setDescription('total of flowspec (bytes x rate) into this interface in units of bits-per-second')
...
if mibBuilder.loadTexts: st2InterfaceInBwReservable.setDescription('amount of bandwidth remaining able to be reserved for input into this interface in units of bits-per-second')
...
if mibBuilder.loadTexts: st2InterfaceOutBwReserved.setDescription('total of flowspec (bytes x rate) out of this interface in units of bits-per-second')
...
if mibBuilder.loadTexts: st2InterfaceOutBwReservable.setDescription('amount of bandwidth remaining able to be reserved for output out of this interface in units of bits-per-second')
...
if mibBuilder.loadTexts: st2InterfaceTotRcvdPkts.setDescription('Count of stream data packets received overall (for streams both current and expired)')
...
if mibBuilder.loadTexts: st2InterfaceTotSentPkts.setDescription('Count of stream data packets sent overall (??) including replications for multiple output interfaces and multiple next-hops when multicast is not used ( make this per interface ??)')
...
if mibBuilder.loadTexts: st2InterfaceTotRcvdOctets.setDescription('Count of stream data octets received overall')
...
if mibBuilder.loadTexts: st2InterfaceTotSentOctets.setDescription('Count of stream data octets sent')
...
if mibBuilder.loadTexts: st2InterfaceRcvdHdrErrors.setDescription('Count of stream data packets received with header format errors')
...
if mibBuilder.loadTexts: st2InterfaceRcvdHidErrors.setDescription('Count of stream data packets received with errors in HID')
...
if mibBuilder.loadTexts: st2InterfaceRcvdLenErrors.setDescription('Count of stream data packets received with errors in length')
...
if mibBuilder.loadTexts: st2InterfaceRcvdHdrErrorTime.setDescription('Time of last stream data packet received with header format errors')
...
if mibBuilder.loadTexts: st2InterfaceRcvdHidErrorTime.setDescription('Time of last stream data packet received with errors in HID')
...
if mibBuilder.loadTexts: st2InterfaceRcvdLenErrorTime.setDescription('Time of last stream data packet received with errors in length')
...
if mibBuilder.loadTexts: st2InterfaceRcvdErrorSnap.setDescription('Contents from last stream data packet received with error')
...
if mibBuilder.loadTexts: st2InterfaceRcvdPktDrops.setDescription('Count of stream data packets received and dropped due to resource limitations')
...
if mibBuilder.loadTexts: st2InterfaceSentPktDrops.setDescription('Count of stream data packets sent and dropped due to resource limitations')
...
if mibBuilder.loadTexts: st2InterfaceIpAddr.setDescription('Interface Ip address')
...
if mibBuilder.loadTexts: st2LastCloseStreamName.setDescription('Last close stream name')
...
if mibBuilder.loadTexts: st2LastClosePrevHopIpAddr.setDescription('Last close previous hop Ip address')
...
if mibBuilder.loadTexts: st2LastCloseReasonCode.setDescription('Reason code field from the last close message')
...
if mibBuilder.loadTexts: st2LastCloseDetectorIpAddress.setDescription('detector address from the last close message')
...
if mibBuilder.loadTexts: st2LastCloseTime.setDescription('sysuptime when the last close received')
mibBuilder.exportSymbols("ST2-MIB", st2StreamFlowDesPduRate=st2StreamFlowDesPduRate, st2ScmpSentDisconnects=st2ScmpSentDisconnects, st2StreamGroup=st2StreamGroup, st2ScmpSentErrorInReqs=st2ScmpSentErrorInReqs, st2InterfaceEntry=st2InterfaceEntry, st2NumOpenStreams=st2NumOpenStreams, st2StreamFlowReliability=st2StreamFlowReliability, st2ScmpSentErrorInResps=st2ScmpSentErrorInResps, st2ProtoVersion=st2ProtoVersion, st2StreamFlowMinBytesXRate=st2StreamFlowMinBytesXRate, st2StreamFlowDelayVariance=st2StreamFlowDelayVariance, st2InterfaceOutBwReserved=st2InterfaceOutBwReserved, st2StreamFlowMeanDelay=st2StreamFlowMeanDelay, st2InterfaceRcvdHdrErrorTime=st2InterfaceRcvdHdrErrorTime, st2StreamOptionPtp=st2StreamOptionPtp, st2ScmpRcvdHellos=st2ScmpRcvdHellos, st2ScmpRcvdBadTypeTime=st2ScmpRcvdBadTypeTime, st2StreamFlowLimitOnDelay=st2StreamFlowLimitOnDelay, st2GroupNumSubgroups=st2GroupNumSubgroups, st2StreamStateTime=st2StreamStateTime, st2LastCloseTime=st2LastCloseTime, st2InterfaceIpAddr=st2InterfaceIpAddr, st2InterfaceInBwReserved=st2InterfaceInBwReserved, st2NHidAbort=st2NHidAbort, st2InterfaceTable=st2InterfaceTable, st2HopMcastAddr=st2HopMcastAddr, st2HopErrorCode=st2HopErrorCode, st2LastCloseStreamName=st2LastCloseStreamName, st2LastCloseReasonCode=st2LastCloseReasonCode, st2StreamOptionRecover=st2StreamOptionRecover, st2NumHops=st2NumHops, st2StreamNumSubgroups=st2StreamNumSubgroups, st2NDisconnect=st2NDisconnect, st2ScmpRcvdOctets=st2ScmpRcvdOctets, st2InterfaceIndex=st2InterfaceIndex, st2NReroute=st2NReroute, st2SubgroupTable=st2SubgroupTable, st2NeighborSentHellos=st2NeighborSentHellos, st2StreamNumTargets=st2StreamNumTargets, st2ToConnect=st2ToConnect, st2StreamOptionTimestamp=st2StreamOptionTimestamp, st2ScmpSentHidChanges=st2ScmpSentHidChanges, st2HopStreamName=st2HopStreamName, st2GroupTable=st2GroupTable, st2ToHidChange=st2ToHidChange, st2ScmpSentHellos=st2ScmpSentHellos, st2LastClosePrevHopIpAddr=st2LastClosePrevHopIpAddr, st2ScmpSentChanges=st2ScmpSentChanges, st2NRefuse=st2NRefuse, st2InterfaceRcvdHidErrors=st2InterfaceRcvdHidErrors, st2NeighborState=st2NeighborState, st2ScmpSentStatusResps=st2ScmpSentStatusResps, st2ScmpSentHidApproves=st2ScmpSentHidApproves, st2HopEntry=st2HopEntry, st2HopNeighborAddr=st2HopNeighborAddr, st2NeighborRoundTripTime=st2NeighborRoundTripTime, st2SubgroupEntry=st2SubgroupEntry, st2ToHidAck=st2ToHidAck, st2ScmpRcvdStatus=st2ScmpRcvdStatus, st2NNotify=st2NNotify, st2HopStateTime=st2HopStateTime, st2AgentType=st2AgentType, st2StreamStartTime=st2StreamStartTime, st2ToAccept=st2ToAccept, st2InterfaceNumInStreams=st2InterfaceNumInStreams, st2StreamFlowErrorRate=st2StreamFlowErrorRate, st2GroupId=st2GroupId, st2ScmpRcvdErrorInResps=st2ScmpRcvdErrorInResps, st2ScmpSentStatus=st2ScmpSentStatus, st2StreamPrevHopAddr=st2StreamPrevHopAddr, st2InterfaceRcvdHdrErrors=st2InterfaceRcvdHdrErrors, st2NeighborAddr=st2NeighborAddr, st2StreamFlowRecoveryTimeout=st2StreamFlowRecoveryTimeout, st2NeighborStateTime=st2NeighborStateTime, st2HopIpEncap=st2HopIpEncap, st2StreamFlowLimitOnPduRate=st2StreamFlowLimitOnPduRate, st2FlowSpecVersion=st2FlowSpecVersion, st2ScmpRcvdErrorInReqs=st2ScmpRcvdErrorInReqs, st2TargetStreamName=st2TargetStreamName, st2ScmpRetrans=st2ScmpRetrans, st2ToRefuse=st2ToRefuse, st2ScmpSentHidRejects=st2ScmpSentHidRejects, st2TargetTable=st2TargetTable, st2DefaultHelloFactor=st2DefaultHelloFactor, st2AcceptTimeouts=st2AcceptTimeouts, st2ScmpSentAcks=st2ScmpSentAcks, st2NumSubgroups=st2NumSubgroups, st2ToDisconnect=st2ToDisconnect, st2NeighborRestarted=st2NeighborRestarted, st2TargetAddr=st2TargetAddr, st2InterfaceRcvdHidErrorTime=st2InterfaceRcvdHidErrorTime, st2ScmpRcvdBadCks=st2ScmpRcvdBadCks, st2StreamNumNextHops=st2StreamNumNextHops, st2NHidAck=st2NHidAck, st2NConnect=st2NConnect, st2ScmpRcvdHidChanges=st2ScmpRcvdHidChanges, st2StreamFlowDutyFactor=st2StreamFlowDutyFactor, st2NeighborScmpBadMsgs=st2NeighborScmpBadMsgs, st2InterfaceTotSentOctets=st2InterfaceTotSentOctets, st2InterfaceRcvdErrorSnap=st2InterfaceRcvdErrorSnap, st2ScmpSentRefuses=st2ScmpSentRefuses, st2StreamTable=st2StreamTable, st2ToReroute=st2ToReroute, st2ScmpSentAccepts=st2ScmpSentAccepts, st2ScmpSentConnects=st2ScmpSentConnects, st2HopNumTargets=st2HopNumTargets, st2StreamRole=st2StreamRole, st2GroupNumStreams=st2GroupNumStreams, st2RouteFailures=st2RouteFailures, st2AgentCopyright=st2AgentCopyright, st2ScmpSentChangeReqs=st2ScmpSentChangeReqs, st2ScmpSentHidChangeReqs=st2ScmpSentHidChangeReqs, st2ScmpRcvdDisconnects=st2ScmpRcvdDisconnects, st2ScmpRcvdStatusResps=st2ScmpRcvdStatusResps, st2SubgroupNumStreams=st2SubgroupNumStreams, st2HopHid=st2HopHid, st2NAccept=st2NAccept, st2NeighborHelloRcvdTime=st2NeighborHelloRcvdTime, st2NeighborTable=st2NeighborTable, st2RoutingDerived=st2RoutingDerived, st2HopYourVlid=st2HopYourVlid, st2NumTargets=st2NumTargets, st2ScmpSentNotifys=st2ScmpSentNotifys, st2DefaultRecoveryTimeout=st2DefaultRecoveryTimeout, st2ScmpRcvdBadCksTime=st2ScmpRcvdBadCksTime, st2StreamOptionFdx=st2StreamOptionFdx, st2NeighborMissedHellos=st2NeighborMissedHellos, st2NeighborStBadMsgs=st2NeighborStBadMsgs, st2SubgroupGroup=st2SubgroupGroup, st2HopErrorTime=st2HopErrorTime, st2HopPkts=st2HopPkts, st2StreamFlowLimitOnPduBytes=st2StreamFlowLimitOnPduBytes, st2HopDiscards=st2HopDiscards, st2TargetEntry=st2TargetEntry, st2InterfaceRcvdLenErrorTime=st2InterfaceRcvdLenErrorTime, st2HelloTimerHoldDown=st2HelloTimerHoldDown, st2HopIpAddr=st2HopIpAddr, st2ScmpRcvdChangeReqs=st2ScmpRcvdChangeReqs, st2HopOctets=st2HopOctets, stii=stii, st2StreamState=st2StreamState, st2NeighborEntry=st2NeighborEntry, st2NeighborInterfaceIdx=st2NeighborInterfaceIdx, st2NumStreamEntries=st2NumStreamEntries, st2HopState=st2HopState, st2ToNotify=st2ToNotify, st2StreamName=st2StreamName, st2NeighborAckRequested=st2NeighborAckRequested, st2StreamFlowPrecedence=st2StreamFlowPrecedence, st2LastCloseDetectorIpAddress=st2LastCloseDetectorIpAddress, st2StreamOptionReverseCharge=st2StreamOptionReverseCharge, st2NEnd2End=st2NEnd2End, st2InterfaceNumNeighbors=st2InterfaceNumNeighbors, st2InterfaceNumOutStreams=st2InterfaceNumOutStreams, st2ScmpRcvdNotifys=st2ScmpRcvdNotifys, st2InterfaceSentPktDrops=st2InterfaceSentPktDrops, st2ScmpRcvdChanges=st2ScmpRcvdChanges, st2GroupName=st2GroupName, st2NeighborDataRcvdTime=st2NeighborDataRcvdTime, st2InterfaceInBwReservable=st2InterfaceInBwReservable, st2InterfaceRcvdPktDrops=st2InterfaceRcvdPktDrops, st2NeighborRcvdHellos=st2NeighborRcvdHellos, st2TargetHop=st2TargetHop, st2NHidChange=st2NHidChange, st2NumNeighbors=st2NumNeighbors, st2NeighborHelloTimer=st2NeighborHelloTimer, st2SubgroupIndex=st2SubgroupIndex, st2HopRole=st2HopRole, st2StreamFlowTradeoffs=st2StreamFlowTradeoffs, st2InterfaceTotRcvdPkts=st2InterfaceTotRcvdPkts, st2ScmpRcvdHidChangeReqs=st2ScmpRcvdHidChangeReqs, st2ScmpRcvdConnects=st2ScmpRcvdConnects, st2ScmpRcvdBadTypes=st2ScmpRcvdBadTypes, st2StreamFlowLimitOnCost=st2StreamFlowLimitOnCost, st2HopDetectorAddr=st2HopDetectorAddr, st2NumGroups=st2NumGroups, st2InterfaceTotSentPkts=st2InterfaceTotSentPkts, st2OriginOpens=st2OriginOpens, st2HopInterfaceIndex=st2HopInterfaceIndex, st2StreamPrevHopVlid=st2StreamPrevHopVlid, st2StreamEntry=st2StreamEntry, st2InterfaceOutBwReservable=st2InterfaceOutBwReservable, st2ScmpRcvdHidRejects=st2ScmpRcvdHidRejects, st2ScmpRcvdHidApproves=st2ScmpRcvdHidApproves, st2NumOpenOriginStreams=st2NumOpenOriginStreams, st2HopMyVlid=st2HopMyVlid, st2ScmpRcvdRefuses=st2ScmpRcvdRefuses, st2HopTable=st2HopTable, st2ScmpSentOctets=st2ScmpSentOctets, st2StreamFlowspecChanges=st2StreamFlowspecChanges, st2ParamChangeFails=st2ParamChangeFails, st2InterfaceRcvdLenErrors=st2InterfaceRcvdLenErrors, st2HelloLossFactor=st2HelloLossFactor, st2ScmpRcvdAcks=st2ScmpRcvdAcks, st2ToEnd2End=st2ToEnd2End, st2GroupEntry=st2GroupEntry, st2ScmpRcvdErrorSnap=st2ScmpRcvdErrorSnap, st2ScmpRcvdAccepts=st2ScmpRcvdAccepts, st2StreamRefuses=st2StreamRefuses, st2IntermedOpens=st2IntermedOpens, st2InterfaceTotRcvdOctets=st2InterfaceTotRcvdOctets, st2FailOpens=st2FailOpens, st2NeighborNumHops=st2NeighborNumHops, st2StreamFlowDesPduBytes=st2StreamFlowDesPduBytes, st2RouteLoops=st2RouteLoops, st2TargetOpens=st2TargetOpens)
