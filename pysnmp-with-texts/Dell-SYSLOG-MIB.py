...
# Produced by pysmi-0.3.4 at Wed May  1 12:56:47 2019
...
ModuleIdentity, iso, Integer32, Counter32, ObjectIdentity, Counter64, IpAddress, Bits, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "iso", "Integer32", "Counter32", "ObjectIdentity", "Counter64", "IpAddress", "Bits", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "NotificationType")
...
if mibBuilder.loadTexts: rlSyslog.setContactInfo('www.dell.com')
if mibBuilder.loadTexts: rlSyslog.setDescription('The private MIB module definition for SYSLOG services in Dell devices.')
...
mibBuilder.exportSymbols("Dell-SYSLOG-MIB", rlSyslogClearCache=rlSyslogClearCache, rlSyslogLogCacheText4=rlSyslogLogCacheText4, rlSyslogLogTable=rlSyslogLogTable, rlSyslogCountersPerSeverityEntry=rlSyslogCountersPerSeverityEntry, rlSyslogLogAppMnemonic=rlSyslogLogAppMnemonic, rlSyslogLastIndexPerSeverityEmergencyIndex=rlSyslogLastIndexPerSeverityEmergencyIndex, rlSyslogCountersPerSeverityErrorCounter=rlSyslogCountersPerSeverityErrorCounter, rlSyslogMinLogToCacheSeverity=rlSyslogMinLogToCacheSeverity, rlSyslogFileMessagesLogged=rlSyslogFileMessagesLogged, rlSyslogConsoleMessagesIgnored=rlSyslogConsoleMessagesIgnored, rlSyslogFileMessagesIgnored=rlSyslogFileMessagesIgnored, PYSNMP_MODULE_ID=rlSyslog, rlSyslogMinLogToFileSeverity=rlSyslogMinLogToFileSeverity, rlSyslogLogCacheDateTime=rlSyslogLogCacheDateTime, rlSyslogOriginIdString=rlSyslogOriginIdString, rlSyslogHeaderSendingEnabled=rlSyslogHeaderSendingEnabled, rlSyslogCountersPerSeverityCriticalCounter=rlSyslogCountersPerSeverityCriticalCounter, rlSyslogCountersPerSeverityNoticeCounter=rlSyslogCountersPerSeverityNoticeCounter, rlSyslogLogText1=rlSyslogLogText1, rlSyslogLastIndexPerSeverityIndex=rlSyslogLastIndexPerSeverityIndex, rlSyslogLogText2=rlSyslogLogText2, RlSyslogSeverity=RlSyslogSeverity, rlSyslogCountersPerSeverityEmergencyCounter=rlSyslogCountersPerSeverityEmergencyCounter, rlSyslogCountersPerSeverityInfoCounter=rlSyslogCountersPerSeverityInfoCounter, rlSyslog=rlSyslog, rlSyslogLogCacheCounter=rlSyslogLogCacheCounter, rlSyslogLogCacheMessageMnemonic=rlSyslogLogCacheMessageMnemonic, rlSyslogLastIndexPerSeverityWarningIndex=rlSyslogLastIndexPerSeverityWarningIndex, rlSyslogLastIndexPerSeverityEntry=rlSyslogLastIndexPerSeverityEntry, rlSyslogLastIndexPerSeverityNoticeIndex=rlSyslogLastIndexPerSeverityNoticeIndex, rlSyslogAggregationEnable=rlSyslogAggregationEnable, rlSyslogPhaseOneTestGenerator=rlSyslogPhaseOneTestGenerator, rlSyslogGlobalEnable=rlSyslogGlobalEnable, rlSyslogLogCacheSeverity=rlSyslogLogCacheSeverity, rlSyslogLogCacheText2=rlSyslogLogCacheText2, rlSyslogMinLogToConsoleSeverity=rlSyslogMinLogToConsoleSeverity, rlSyslogLogSeverity=rlSyslogLogSeverity, rlSyslogAlarmFlag=rlSyslogAlarmFlag, rlSyslogCountersPerSeverityTable=rlSyslogCountersPerSeverityTable, rlSyslogLogCacheEntry=rlSyslogLogCacheEntry, rlSyslogLastIndexPerSeverityAlertIndex=rlSyslogLastIndexPerSeverityAlertIndex, rlSyslogLogText3=rlSyslogLogText3, rlSyslogPhaseOneTests=rlSyslogPhaseOneTests, rlSyslogLastIndexPerSeverityDebugIndex=rlSyslogLastIndexPerSeverityDebugIndex, rlSyslogLastIndexPerSeverityCriticalIndex=rlSyslogLastIndexPerSeverityCriticalIndex, rlSyslogPrivate=rlSyslogPrivate, rlSyslogLogCacheText1=rlSyslogLogCacheText1, rlSyslogCountersPerSeverityAlertCounter=rlSyslogCountersPerSeverityAlertCounter, rlSyslogCountersPerSeverityWarningCounter=rlSyslogCountersPerSeverityWarningCounter, rlSyslogCountersPerSeverityDebugCounter=rlSyslogCountersPerSeverityDebugCounter, rlSyslogLastIndexPerSeverityInfoIndex=rlSyslogLastIndexPerSeverityInfoIndex, rlSyslogClearLogfile=rlSyslogClearLogfile, rlSyslogLogCacheText3=rlSyslogLogCacheText3, rlSyslogLogCacheTable=rlSyslogLogCacheTable, rlSyslogLogEntry=rlSyslogLogEntry, rlSyslogCacheTotalMessages=rlSyslogCacheTotalMessages, rlSyslogLastIndexPerSeverityTable=rlSyslogLastIndexPerSeverityTable, rlSyslogMibVersion=rlSyslogMibVersion, rlSyslogAggregationAgingTime=rlSyslogAggregationAgingTime, rlSyslogLogDateTime=rlSyslogLogDateTime, rlSyslogMinLogToWebSeverity=rlSyslogMinLogToWebSeverity, rlSyslogLogCounter=rlSyslogLogCounter, rlSyslogLogCacheAppMnemonic=rlSyslogLogCacheAppMnemonic, rlSyslogLastIndexPerSeverityErrorIndex=rlSyslogLastIndexPerSeverityErrorIndex, rlSyslogLogText4=rlSyslogLogText4, rlSyslogLogMessageMnemonic=rlSyslogLogMessageMnemonic, rlSyslogOriginId=rlSyslogOriginId, rlSyslogCountersPerSeverityIndex=rlSyslogCountersPerSeverityIndex)
