...
# Produced by pysmi-0.3.4 at Wed May  1 12:46:54 2019
...
Unsigned32, IpAddress, Integer32, Counter32, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, iso, MibIdentifier, Counter64, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "IpAddress", "Integer32", "Counter32", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "iso", "MibIdentifier", "Counter64", "ModuleIdentity", "NotificationType")
...
if mibBuilder.loadTexts: dhcpClientPrivate.setContactInfo(' Customer Support Postal: Quanta Computer Inc. 4, Wen Ming 1 St., Kuei Shan Hsiang, Tao Yuan Shien, Taiwan, R.O.C. Tel: +886 3 328 0050 E-Mail: strong.chen@quantatw.com')
if mibBuilder.loadTexts: dhcpClientPrivate.setDescription('The Private MIB for DHCP Client')
...
mibBuilder.exportSymbols("DHCPCLIENT-PRIVATE-MIB", PYSNMP_MODULE_ID=dhcpClientPrivate, agentdhcp4ClientLeaseParameters=agentdhcp4ClientLeaseParameters, agentdhcp4ClientDhcpServerAddress=agentdhcp4ClientDhcpServerAddress, agentdhcp4ClientTransactionID=agentdhcp4ClientTransactionID, agentdhcp4ClientState=agentdhcp4ClientState, agentdhcp4ClientRetryCount=agentdhcp4ClientRetryCount, agentdhcp4ClientInterfaceIndex=agentdhcp4ClientInterfaceIndex, agentdhcp4ClientLeaseParametersTable=agentdhcp4ClientLeaseParametersTable, agentdhcp4ClientLeaseParametersEntry=agentdhcp4ClientLeaseParametersEntry, agentdhcp4ClientSubnetMask=agentdhcp4ClientSubnetMask, agentdhcp4ClientRebindTime=agentdhcp4ClientRebindTime, dhcpClientPrivate=dhcpClientPrivate, agentdhcp4ClientLeaseTime=agentdhcp4ClientLeaseTime, agentdhcp4ClientRenewTime=agentdhcp4ClientRenewTime, agentdhcp4ClientIpAddress=agentdhcp4ClientIpAddress)
