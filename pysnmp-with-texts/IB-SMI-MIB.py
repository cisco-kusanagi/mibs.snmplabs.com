...
if mibBuilder.loadTexts: infoblox.setContactInfo('Infoblox 4750 Patrick Henry Drive Santa Clara, CA 95054 1-888-463-6259 support@infoblox.com')
if mibBuilder.loadTexts: infoblox.setDescription('This is the MIB module for object type definitions that are used throughout the infoblox enterprise MIBs.')
...
mibBuilder.exportSymbols("IB-SMI-MIB", PYSNMP_MODULE_ID=infoblox, ibVm=ibVm, IbIpv6Addr=IbIpv6Addr, ib1550a=ib1550a, IbString=IbString, ibSNMP=ibSNMP, infobloxProducts=infobloxProducts, ibDefault=ibDefault, ib1552=ib1552, ib1050a=ib1050a, ibProduct=ibProduct, ibVnios=ibVnios, ib250a=ib250a, ibDHCPOne=ibDHCPOne, ib2000a=ib2000a, ibRsp2=ibRsp2, ibTrapOne=ibTrapOne, ib4010=ib4010, ib1220=ib1220, ibDNSOne=ibDNSOne, ib1000=ib1000, ib500=ib500, ib1200=ib1200, ib4020=ib4020, ib1550=ib1550, ibCisco=ibCisco, IbIpAddr=IbIpAddr, ib1050=ib1050, ib4000=ib4000, infoblox=infoblox, ibPlatformOne=ibPlatformOne, IbNode=IbNode, ib550a=ib550a, ib550=ib550, ib2000=ib2000, ib250=ib250, ib1852a=ib1852a, ibOne=ibOne, ib1552a=ib1552a)
