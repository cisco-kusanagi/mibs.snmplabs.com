...
# Produced by pysmi-0.3.4 at Wed May  1 11:33:28 2019
...
Integer32, Bits, Counter32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, NotificationType, Unsigned32, IpAddress, Gauge32, Counter64, enterprises, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Bits", "Counter32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "NotificationType", "Unsigned32", "IpAddress", "Gauge32", "Counter64", "enterprises", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("Avaya_46xxIPTelephone-MIB", endptSNTPSRVR=endptSNTPSRVR, endptNVM=endptNVM, endptDIRFULLNAME=endptDIRFULLNAME, endptDEFINITY=endptDEFINITY, endptJCPC=endptJCPC, endptSSON=endptSSON, endptDIRTELNUM=endptDIRTELNUM, endptDNSINUSE=endptDNSINUSE, endptHTTPSRVR=endptHTTPSRVR, endptNVIPADD=endptNVIPADD, endptNVHTTPSRVR=endptNVHTTPSRVR, endptDATETIMEFORMAT=endptDATETIMEFORMAT, endptDSCPAUD=endptDSCPAUD, endptDOMAIN=endptDOMAIN, endptESPEED=endptESPEED, endptLOGSTAT=endptLOGSTAT, endptNVIRSTAT=endptNVIRSTAT, endptPWBCC=endptPWBCC, endptTFTPINUSE=endptTFTPINUSE, endptRASGkEntryData=endptRASGkEntryData, endptNETMASK=endptNETMASK, endptWMLHOME=endptWMLHOME, endptCTIUDPPORT=endptCTIUDPPORT, endptREGISTERWAIT=endptREGISTERWAIT, endptPWBSN=endptPWBSN, endptPHNCC=endptPHNCC, endptNVL2Q=endptNVL2Q, endptRSVPRFRSH=endptRSVPRFRSH, endptVMLCODING=endptVMLCODING, endptDHCPSTD=endptDHCPSTD, endptMUSICSRVRINUSE=endptMUSICSRVRINUSE, endptPHNIC=endptPHNIC, endptNVL2QSIG=endptNVL2QSIG, endptNVPHONEXT=endptNVPHONEXT, endptHTTPPORT=endptHTTPPORT, endptNVDSCPSIG=endptNVDSCPSIG, endptResetLog=endptResetLog, endptWMLIDLETIME=endptWMLIDLETIME, endptTLSSRVR=endptTLSSRVR, avayaipEndpointMIBs=avayaipEndpointMIBs, endptCODESRVR=endptCODESRVR, endptDSCPBBE=endptDSCPBBE, endptAGCHAND=endptAGCHAND, endptDIRUSERID=endptDIRUSERID, endptAUDIOENV=endptAUDIOENV, endptCALLFWDADDR=endptCALLFWDADDR, avayaMibs=avayaMibs, endptNVALERT=endptNVALERT, endptPROCPSWD=endptPROCPSWD, endptNVLOGSTAT=endptNVLOGSTAT, endptNVAUTH=endptNVAUTH, endptGIPINUSE=endptGIPINUSE, endptNTWKAUDIO=endptNTWKAUDIO, endptAGCSPKR=endptAGCSPKR, endptNVHUBSTAT=endptNVHUBSTAT, endptNVAGCHEAD=endptNVAGCHEAD, endptNVL2QVLAN=endptNVL2QVLAN, endptAPPNAME=endptAPPNAME, endptSIPREGISTRARINUSE=endptSIPREGISTRARINUSE, PYSNMP_MODULE_ID=endpointMIB, endptTPSLIST=endptTPSLIST, endptMUSICSRVR=endptMUSICSRVR, endptFKEUHEALTH=endptFKEUHEALTH, endptRTCPMON=endptRTCPMON, endptAUDIOSTHS=endptAUDIOSTHS, endptNVCONTRAST=endptNVCONTRAST, endptNVPHY1STAT=endptNVPHY1STAT, endptHUBSTAT=endptHUBSTAT, avayaipEndpointProd=avayaipEndpointProd, endptNVFILESRVR=endptNVFILESRVR, endptFEIPADD=endptFEIPADD, endptPHONESN=endptPHONESN, endptSIPDOMAIN=endptSIPDOMAIN, endptNVTFTPSRVR=endptNVTFTPSRVR, endptNVGIPADD=endptNVGIPADD, endptCALLFWDDELAY=endptCALLFWDDELAY, endptTFTPDIR=endptTFTPDIR, endptAdjuncts=endptAdjuncts, endptSIPPROXYSRVR=endptSIPPROXYSRVR, endptNVL2QAUD=endptNVL2QAUD, endptNVAGCSPKR=endptNVAGCSPKR, endptWEBPROXY=endptWEBPROXY, endptRSVPPROF=endptRSVPPROF, endptGMTOFFSET=endptGMTOFFSET, endptDSTOFFSET=endptDSTOFFSET, endptAPPSTAT=endptAPPSTAT, endptPHNLD=endptPHNLD, endptDHCPT1REM=endptDHCPT1REM, endptWMLPORT=endptWMLPORT, endptVMLHOME=endptVMLHOME, endptRSVPCONT=endptRSVPCONT, endptWEBHOME=endptWEBHOME, endptHTTPDIR=endptHTTPDIR, endptRecentLog=endptRecentLog, endptDHCPT2REM=endptDHCPT2REM, endptNVCHADDR=endptNVCHADDR, endptCALLFWDSTAT=endptCALLFWDSTAT, avaya=avaya, endptMODEL=endptMODEL, endptDHCPLEASETIME=endptDHCPLEASETIME, endptCOVERAGEADDR=endptCOVERAGEADDR, endptCNASRVR=endptCNASRVR, endptRASGkList=endptRASGkList, endptAdvApps=endptAdvApps, endptDIRLDAPPORT=endptDIRLDAPPORT, endptWMLCODING=endptWMLCODING, endptNVBBURST=endptNVBBURST, endptETHERADD=endptETHERADD, endptCODEUSED=endptCODEUSED, endpointMIB=endpointMIB, endptPROCSTAT=endptPROCSTAT, endptSIPREGISTRAR=endptSIPREGISTRAR, endptRTCPCONT=endptRTCPCONT, endptNVPHY2STAT=endptNVPHY2STAT, endptCTISTAT=endptCTISTAT, endptTFTPSRVR=endptTFTPSRVR, endptL2QAUD=endptL2QAUD, endptDIRSRVRPWD=endptDIRSRVRPWD, endptBRURI=endptBRURI, endptNVDSCPAUD=endptNVDSCPAUD, endptSIPPROXYSRVRINUSE=endptSIPPROXYSRVRINUSE, endptMCIPINUSE=endptMCIPINUSE, endptPHNOL=endptPHNOL, endptRSVPRTRY=endptRSVPRTRY, endptTLSUSED=endptTLSUSED, endptSTKSTAT=endptSTKSTAT, endptIPADD=endptIPADD, endptRASGkEntry=endptRASGkEntry, endptCODECR=endptCODECR, endptWMLIDLEURI=endptWMLIDLEURI, endptFEPORT=endptFEPORT, endptDIRSRCHTIME=endptDIRSRCHTIME, endptFTPDIR=endptFTPDIR, endptPHNEMERGNUM=endptPHNEMERGNUM, endptPHNNUMOFFB=endptPHNNUMOFFB, endptCODECT=endptCODECT, endpt46XXUPGR=endpt46XXUPGR, endptLOGSRVR=endptLOGSRVR, avayaProducts=avayaProducts, endptBBURST=endptBBURST, endptDIRSRVR=endptDIRSRVR, endptGROUP=endptGROUP, endptRESTORESTAT=endptRESTORESTAT, endptDHCPLEASEEXP=endptDHCPLEASEEXP, endptDIALWAIT=endptDIALWAIT, endptAPPINUSE=endptAPPINUSE, endptWEBEXCEPT=endptWEBEXCEPT, endptWEBCODING=endptWEBCODING, endptDIRCODING=endptDIRCODING, endptSSONCONTENT=endptSSONCONTENT, endptMWISRVRINUSE=endptMWISRVRINUSE, endptCIBURL=endptCIBURL, endptSTATIC=endptSTATIC, endptPHY1STAT=endptPHY1STAT, endptNVNETMASK=endptNVNETMASK, endptPHNLDLENGTH=endptPHNLDLENGTH, endptNVSSON=endptNVSSON, endptL2QSTAT=endptL2QSTAT, endptFTPUSERSTAT=endptFTPUSERSTAT, endptSMTPSRVR=endptSMTPSRVR, endptRTCPFLOW=endptRTCPFLOW, endptFTPSRVR=endptFTPSRVR, endptMWISRVR=endptMWISRVR, endptPHNNUMOFCA=endptPHNNUMOFCA, endptSNMPADD=endptSNMPADD, endptL2QVLAN=endptL2QVLAN, endptVLANLIST=endptVLANLIST, endptNVAGCHAND=endptNVAGCHAND, endptSIP=endptSIP, endptPORTAUD=endptPORTAUD, endptICMPRED=endptICMPRED, endptFKEU=endptFKEU, endptL2Q=endptL2Q, endptResetLogEntry=endptResetLogEntry, endptDNSSRVR=endptDNSSRVR, endptPHONECC=endptPHONECC, endptBAKLIGHTOFF=endptBAKLIGHTOFF, endptL2QSIG=endptL2QSIG, endptPHNDPLENGTH=endptPHNDPLENGTH, endptSIPPORT=endptSIPPORT, endptPHNNUMOFSA=endptPHNNUMOFSA, endptENHDIALSTAT=endptENHDIALSTAT, endptID=endptID, endptPORTSIG=endptPORTSIG, endptNVVLANLIST=endptNVVLANLIST, endptMARKET=endptMARKET, endptDHCPLEASERENEW=endptDHCPLEASERENEW, endptCNAPORT=endptCNAPORT, endptDOT1X=endptDOT1X, endptAUDIOSTHD=endptAUDIOSTHD, endptMaintenance=endptMaintenance, endptWMLEXCEPT=endptWMLEXCEPT, endptCLACTIVE=endptCLACTIVE, endptUPGRADESCRIPT=endptUPGRADESCRIPT, endptSUBSCRIBELIST=endptSUBSCRIBELIST, endptDSTSTART=endptDSTSTART, endptMCPORT=endptMCPORT, endptDSCPSIG=endptDSCPSIG, endptVLANTEST=endptVLANTEST, endptWEBPORT=endptWEBPORT, endptRecentLogEntry=endptRecentLogEntry, endptMCIPADD=endptMCIPADD, endptAGCHEAD=endptAGCHEAD, endptNVMCPORT=endptNVMCPORT, endptGIPADD=endptGIPADD, endptHTTPUSED=endptHTTPUSED, endptNVMCIPADD=endptNVMCIPADD, endptDIALPLAN=endptDIALPLAN, endptResetLogText=endptResetLogText, endptDSPVERSION=endptDSPVERSION, endptDHCPINUSE=endptDHCPINUSE, endptDHCPLEASEREBIND=endptDHCPLEASEREBIND, endptDIRSTAT=endptDIRSTAT, endptBOOTNAME=endptBOOTNAME, endptTMSEC=endptTMSEC, endptPHY2STAT=endptPHY2STAT, endptSIG=endptSIG, endptICMPDU=endptICMPDU, endptRecentLogText=endptRecentLogText, endptDSTSTOP=endptDSTSTOP, endptL2QBBE=endptL2QBBE, endptDIRTOPDN=endptDIRTOPDN, endptIRSTAT=endptIRSTAT, endptWMLPROXY=endptWMLPROXY, endptSPEAKERSTAT=endptSPEAKERSTAT, endptNVVLANTEST=endptNVVLANTEST)
