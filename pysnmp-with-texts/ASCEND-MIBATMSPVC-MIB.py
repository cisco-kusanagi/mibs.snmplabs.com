...
# Produced by pysmi-0.3.4 at Wed May  1 11:26:39 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, NotificationType, ModuleIdentity, Counter32, ObjectIdentity, TimeTicks, Gauge32, Integer32, IpAddress, Unsigned32, iso, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "NotificationType", "ModuleIdentity", "Counter32", "ObjectIdentity", "TimeTicks", "Gauge32", "Integer32", "IpAddress", "Unsigned32", "iso", "MibIdentifier")
...
if mibBuilder.loadTexts: mibatmSoftPVcAddrProfileTable.setDescription('A list of mibatmSoftPVcAddrProfile profile entries.')
...
if mibBuilder.loadTexts: mibatmSoftPVcAddrProfileEntry.setDescription('A mibatmSoftPVcAddrProfile entry containing objects that maps to the parameters of mibatmSoftPVcAddrProfile profile.')
...
if mibBuilder.loadTexts: atmSoftPVcAddrProfile_Shelf_o.setDescription('')
...
if mibBuilder.loadTexts: atmSoftPVcAddrProfile_Slot_o.setDescription('')
...
if mibBuilder.loadTexts: atmSoftPVcAddrProfile_Item_o.setDescription('')
...
if mibBuilder.loadTexts: atmSoftPVcAddrProfile_LogicalItem_o.setDescription('')
...
if mibBuilder.loadTexts: atmSoftPVcAddrProfile_Index_PhysicalAddress_Shelf.setDescription('The number of the shelf that the addressed physical device resides on.')
...
if mibBuilder.loadTexts: atmSoftPVcAddrProfile_Index_PhysicalAddress_Slot.setDescription('The number of the slot that the addressed physical device resides on.')
...
if mibBuilder.loadTexts: atmSoftPVcAddrProfile_Index_PhysicalAddress_ItemNumber.setDescription('A number that specifies an addressable entity within the context of shelf and slot.')
...
if mibBuilder.loadTexts: atmSoftPVcAddrProfile_Index_LogicalItem.setDescription('A number that specifies an addressable logical entity within the context of a physical address.')
...
if mibBuilder.loadTexts: atmSoftPVcAddrProfile_SpvcAtmAddress.setDescription('Soft PVC Interface ATM Address')
...
if mibBuilder.loadTexts: atmSoftPVcAddrProfile_Action_o.setDescription('')
...
if mibBuilder.loadTexts: mibatmSpvcConfigProfileTable.setDescription('A list of mibatmSpvcConfigProfile profile entries.')
...
if mibBuilder.loadTexts: mibatmSpvcConfigProfileEntry.setDescription('A mibatmSpvcConfigProfile entry containing objects that maps to the parameters of mibatmSpvcConfigProfile profile.')
...
if mibBuilder.loadTexts: atmSpvcConfigProfile_Index_o.setDescription('')
...
if mibBuilder.loadTexts: atmSpvcConfigProfile_FailureTrapEnable.setDescription("Allows the generation of traps in response to call failures. By default, this object is set to 'false'.")
...
if mibBuilder.loadTexts: atmSpvcConfigProfile_FailureNotificationInterval.setDescription('The minimum interval between the sending of atmSoftPvcCallFailuresTrap notifications.')
...
if mibBuilder.loadTexts: atmSpvcConfigProfile_Action_o.setDescription('')
mibBuilder.exportSymbols("ASCEND-MIBATMSPVC-MIB", atmSoftPVcAddrProfile_Slot_o=atmSoftPVcAddrProfile_Slot_o, atmSoftPVcAddrProfile_Shelf_o=atmSoftPVcAddrProfile_Shelf_o, atmSpvcConfigProfile_Action_o=atmSpvcConfigProfile_Action_o, atmSoftPVcAddrProfile_Index_LogicalItem=atmSoftPVcAddrProfile_Index_LogicalItem, mibatmSoftPVcAddrProfile=mibatmSoftPVcAddrProfile, mibatmSoftPVcAddrProfileEntry=mibatmSoftPVcAddrProfileEntry, DisplayString=DisplayString, mibatmSpvcConfigProfileTable=mibatmSpvcConfigProfileTable, atmSoftPVcAddrProfile_Index_PhysicalAddress_Slot=atmSoftPVcAddrProfile_Index_PhysicalAddress_Slot, atmSoftPVcAddrProfile_Index_PhysicalAddress_ItemNumber=atmSoftPVcAddrProfile_Index_PhysicalAddress_ItemNumber, mibatmSpvcConfigProfile=mibatmSpvcConfigProfile, mibatmSpvcConfigProfileEntry=mibatmSpvcConfigProfileEntry, atmSoftPVcAddrProfile_Index_PhysicalAddress_Shelf=atmSoftPVcAddrProfile_Index_PhysicalAddress_Shelf, atmSpvcConfigProfile_FailureTrapEnable=atmSpvcConfigProfile_FailureTrapEnable, mibatmSoftPVcAddrProfileTable=mibatmSoftPVcAddrProfileTable, atmSoftPVcAddrProfile_LogicalItem_o=atmSoftPVcAddrProfile_LogicalItem_o, atmSoftPVcAddrProfile_Item_o=atmSoftPVcAddrProfile_Item_o, atmSpvcConfigProfile_FailureNotificationInterval=atmSpvcConfigProfile_FailureNotificationInterval, atmSpvcConfigProfile_Index_o=atmSpvcConfigProfile_Index_o, atmSoftPVcAddrProfile_SpvcAtmAddress=atmSoftPVcAddrProfile_SpvcAtmAddress, atmSoftPVcAddrProfile_Action_o=atmSoftPVcAddrProfile_Action_o)
