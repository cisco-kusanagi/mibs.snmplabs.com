...
# Produced by pysmi-0.3.4 at Wed May  1 12:41:16 2019
...
Status, DesignatedRouterPriority, AreaID, TOSType, Metric, HelloRange, UpToMaxAge, PositiveInteger, RouterID = mibBuilder.importSymbols("OSPF-MIB", "Status", "DesignatedRouterPriority", "AreaID", "TOSType", "Metric", "HelloRange", "UpToMaxAge", "PositiveInteger", "RouterID")
ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup")
TimeTicks, ObjectIdentity, NotificationType, iso, Integer32, Counter32, Gauge32, Unsigned32, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ObjectIdentity", "NotificationType", "iso", "Integer32", "Counter32", "Gauge32", "Unsigned32", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter64", "MibIdentifier")
TimeStamp, DisplayString, TruthValue, PhysAddress, TextualConvention, MacAddress, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "TimeStamp", "DisplayString", "TruthValue", "PhysAddress", "TextualConvention", "MacAddress", "RowStatus")
...
if mibBuilder.loadTexts: swL3IpCtrlProxyArpLocalState.setDescription('If the state is enabled, the switch will be allowed to respond to the proxy ARP proxy ARP when the source IP and destination IP are on the same interface.')
...
if mibBuilder.loadTexts: swL3Dhcpv6RelayHopCount.setDescription('This object indicates the maximum number of router hops that the dhcpv6 packets can cross.')
...
if mibBuilder.loadTexts: swL3Dhcpv6RelayCtrlTable.setDescription('This table displays the current DHCPv6 relay static table.')
...
if mibBuilder.loadTexts: swL3Dhcpv6RelayCtrlEntry.setDescription('A list of information display the current DHCPv6 relay static table.')
...
if mibBuilder.loadTexts: swL3Dhcpv6RelayCtrlInterfaceName.setDescription('This object indicates the name of the relay interface.')
...
if mibBuilder.loadTexts: swL3Dhcpv6RelayCtrlState.setDescription('TThis object indicates Dhcpv6 Relay function is enabled or disabled.')
...
if mibBuilder.loadTexts: swL3Dhcpv6RelayInfoTable.setDescription('This table displays the current DHCPv6 relay static table.')
...
if mibBuilder.loadTexts: swL3Dhcpv6RelayInfoEntry.setDescription('A list of information display the current DHCPv6 relay static table.')
...
if mibBuilder.loadTexts: swL3Dhcpv6RelayInfoInterfaceName.setDescription('This object indicates the name of the relay interface.')
...
if mibBuilder.loadTexts: swL3Dhcpv6RelayInfoServerAddress.setDescription('Specify the IPv6 address.')
...
if mibBuilder.loadTexts: swL3Dhcpv6RelayInfoServerInterfaceName.setDescription('When the swL3Dhcpv6RelayInfoServerAddress is multicast address, this object indicates the name of the interface, which is connected to the DHCPv6 server.')
...
if mibBuilder.loadTexts: swL3Dhcpv6RelayInfoRowStatus.setDescription('This object indicates the status of this entry.')
...
mibBuilder.exportSymbols("DES3552-SWL3MGMT-MIB", swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3ospfIfMetric=swL3ospfIfMetric, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3Md5KeyId=swL3Md5KeyId, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3IpCtrlMode=swL3IpCtrlMode, swL3Md5RowStatus=swL3Md5RowStatus, swL3OspfHostStatus=swL3OspfHostStatus, swL3DevCtrl=swL3DevCtrl, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, NetAddress=NetAddress, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3RelayDhcpState=swL3RelayDhcpState, swL3RelayDhcpCtrlInterfaceName=swL3RelayDhcpCtrlInterfaceName, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, NodeAddress=NodeAddress, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3Dhcpv6RelayInfoRowStatus=swL3Dhcpv6RelayInfoRowStatus, swL3MgmtMIB=swL3MgmtMIB, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3IpCtrlProxyArpLocalState=swL3IpCtrlProxyArpLocalState, swL3Dhcpv6RelayInfoTable=swL3Dhcpv6RelayInfoTable, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3IpStaticRouteCost=swL3IpStaticRouteCost, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3RelayMgmt=swL3RelayMgmt, swL3IpCtrlState=swL3IpCtrlState, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3RelayDhcpOption82Policy=swL3RelayDhcpOption82Policy, VrId=VrId, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3ospfAreaId=swL3ospfAreaId, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3Dhcpv6RelayHopCount=swL3Dhcpv6RelayHopCount, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3VrrpOperState=swL3VrrpOperState, swL3Ipv6Address=swL3Ipv6Address, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3LocalRouteMgmt=swL3LocalRouteMgmt, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3ospfAreaType=swL3ospfAreaType, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3RelayDhcpHopCount=swL3RelayDhcpHopCount, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3VrrpOperTable=swL3VrrpOperTable, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3ospfIfType=swL3ospfIfType, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3ospfIfState=swL3ospfIfState, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3RelayDhcpOption82CheckState=swL3RelayDhcpOption82CheckState, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3ospfIfEntry=swL3ospfIfEntry, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3OspfECMPState=swL3OspfECMPState, swL3LocalRouteIPv6GlobalState=swL3LocalRouteIPv6GlobalState, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3Dhcpv6RelayInfoInterfaceName=swL3Dhcpv6RelayInfoInterfaceName, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3DevCtrlDHCPAutoConfigState=swL3DevCtrlDHCPAutoConfigState, swL3RoutePreference=swL3RoutePreference, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3RelayDhcpTimeThreshold=swL3RelayDhcpTimeThreshold, swL3OspfHostMetric=swL3OspfHostMetric, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3Ipv6AddressCtrlAddressType=swL3Ipv6AddressCtrlAddressType, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3Dhcpv6RelayCtrlInterfaceName=swL3Dhcpv6RelayCtrlInterfaceName, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3DHCPv6RelayMgmt=swL3DHCPv6RelayMgmt, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3ospfIfEvents=swL3ospfIfEvents, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3Dhcpv6RelayInfoEntry=swL3Dhcpv6RelayInfoEntry, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3ospfIfDemand=swL3ospfIfDemand, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3RelayDnsState=swL3RelayDnsState, swL3OspfHostEntry=swL3OspfHostEntry, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3RelayDhcpCtrlState=swL3RelayDhcpCtrlState, swL3RouteRedistriType=swL3RouteRedistriType, swL3OspfHostTOS=swL3OspfHostTOS, swL3Dhcpv6RelayInfoServerInterfaceName=swL3Dhcpv6RelayInfoServerInterfaceName, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3RelayDhcpCtrlEntry=swL3RelayDhcpCtrlEntry, swL3IpMgmt=swL3IpMgmt, swL3RelayDhcpOption82State=swL3RelayDhcpOption82State, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3Dhcpv6RelayCtrlTable=swL3Dhcpv6RelayCtrlTable, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3IpCtrlTable=swL3IpCtrlTable, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3DevMgmt=swL3DevMgmt, swL3ospfIfTable=swL3ospfIfTable, swL3IpCtrlIpv4AdminState=swL3IpCtrlIpv4AdminState, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3RelayDhcpCtrlTable=swL3RelayDhcpCtrlTable, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3Md5Table=swL3Md5Table, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3OspfHostTable=swL3OspfHostTable, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3Dhcpv6RelayInfoServerAddress=swL3Dhcpv6RelayInfoServerAddress, swL3RelayDhcpMgmt=swL3RelayDhcpMgmt, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3LocalRouteIPv4GlobalState=swL3LocalRouteIPv4GlobalState, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3RelayDhcpCtrlServer=swL3RelayDhcpCtrlServer, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3IpCtrlIpv6AdminState=swL3IpCtrlIpv6AdminState, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3Md5Key=swL3Md5Key, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3ospfAreaTable=swL3ospfAreaTable, swL3Dhcpv6RelayCtrlEntry=swL3Dhcpv6RelayCtrlEntry, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3Md5Entry=swL3Md5Entry, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3Dhcpv6RelayCtrlState=swL3Dhcpv6RelayCtrlState, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable)
mibBuilder.exportSymbols("DES3552-SWL3MGMT-MIB", swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, Ipv6Address=Ipv6Address, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3IpMcastMgmt=swL3IpMcastMgmt)
