...
ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Unsigned32, IpAddress, MibIdentifier, Counter64, iso, Bits, ModuleIdentity, TimeTicks, Gauge32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Unsigned32", "IpAddress", "MibIdentifier", "Counter64", "iso", "Bits", "ModuleIdentity", "TimeTicks", "Gauge32", "Counter32")
...
if mibBuilder.loadTexts: rlSmartPorts.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
if mibBuilder.loadTexts: rlSmartPortsMacroType.setDescription('This variable identifies the macro type: user defined, CISCOSB provided per interface CISCOSB provided globally')
...
mibBuilder.exportSymbols("CISCOSB-SMARTPORTS-MIB", rlSmartPortsMacroDescriptionStatus=rlSmartPortsMacroDescriptionStatus, rlSmartPortsMacroOctetIndex=rlSmartPortsMacroOctetIndex, rlSmartPortsDiagCommandLine=rlSmartPortsDiagCommandLine, rlSmartPortsMacroContentTable=rlSmartPortsMacroContentTable, rlSmartPortsMacroKeywords=rlSmartPortsMacroKeywords, RlSmartPortsMacroNameOrZero=RlSmartPortsMacroNameOrZero, rlSmartPortsMacroDescriptionText=rlSmartPortsMacroDescriptionText, MacroType=MacroType, rlSmartPortsMacroStatus=rlSmartPortsMacroStatus, rlSmartPortsMacroDescriptionIndex=rlSmartPortsMacroDescriptionIndex, RlSmartPortsMacroName=RlSmartPortsMacroName, rlSmartPortsMacroManageTable=rlSmartPortsMacroManageTable, PYSNMP_MODULE_ID=rlSmartPorts, rlSmartPortsMacroManageEntry=rlSmartPortsMacroManageEntry, rlSmartPortsMacroIndex=rlSmartPortsMacroIndex, rlSmartPortsMacroDescriptionEntry=rlSmartPortsMacroDescriptionEntry, rlSmartPorts=rlSmartPorts, rlSmartPortsFreeIndexes=rlSmartPortsFreeIndexes, rlSmartPortsMacroContentEntry=rlSmartPortsMacroContentEntry, rlSmartPortsMacroText=rlSmartPortsMacroText, rlSmartPortsMacroName=rlSmartPortsMacroName, rlSmartPortsMacroDesc1=rlSmartPortsMacroDesc1, rlSmartPortsDiagMacroName=rlSmartPortsDiagMacroName, rlSmartPortsCondenseMode=rlSmartPortsCondenseMode, rlSmartPortsMacroDescriptionTable=rlSmartPortsMacroDescriptionTable, rlSmartPortsDiagLineNumber=rlSmartPortsDiagLineNumber, rlSmartPortsMacroDesc2=rlSmartPortsMacroDesc2, rlSmartPortsMacroType=rlSmartPortsMacroType)
