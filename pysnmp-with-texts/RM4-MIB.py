...
MibIdentifier, ObjectName, snmpModules, ModuleIdentity, Gauge32, Counter32, ObjectIdentity, NotificationType, Unsigned32, Counter64, IpAddress, Bits, iso, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "ObjectName", "snmpModules", "ModuleIdentity", "Gauge32", "Counter32", "ObjectIdentity", "NotificationType", "Unsigned32", "Counter64", "IpAddress", "Bits", "iso", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks")
...
if mibBuilder.loadTexts: rm4.setContactInfo('')
if mibBuilder.loadTexts: rm4.setDescription('The MIB module for entities implementing the xxxx protocol.')
...
mibBuilder.exportSymbols("RM4-MIB", resourceMonitor=resourceMonitor, diskUsageTable=diskUsageTable, rmControl=rmControl, fmCurSize=fmCurSize, duSize=duSize, rmProcessGrp=rmProcessGrp, duNumber=duNumber, diskUsageEntry=diskUsageEntry, duFSName=duFSName, fmTable=fmTable, processMemUsageAlarmMark=processMemUsageAlarmMark, processCPUUsageCurrent=processCPUUsageCurrent, filePeriod=filePeriod, duIndex=duIndex, cpuUtilWarningPct=cpuUtilWarningPct, fmNumber=fmNumber, products=products, cpuPeriod=cpuPeriod, diskUsageWarningPct=diskUsageWarningPct, processUpTime=processUpTime, rmFileGrp=rmFileGrp, diskUsageAlarmPct=diskUsageAlarmPct, rm4=rm4, processIndex=processIndex, processCPUUsageWarnMark=processCPUUsageWarnMark, rmObjectID=rmObjectID, fmThreshold=fmThreshold, processCPUUsageAlarmMark=processCPUUsageAlarmMark, processNumber=processNumber, PYSNMP_MODULE_ID=rm4, lucent=lucent, processTable=processTable, processPeriod=processPeriod, archiveDir=archiveDir, cpuLoadWarningThreshold=cpuLoadWarningThreshold, rmDescr=rmDescr, cpuLoadAlarmThreshold=cpuLoadAlarmThreshold, fmEntry=fmEntry, softSwitch=softSwitch, rmDiskGrp=rmDiskGrp, fmIndex=fmIndex, processName=processName, rmUpTime=rmUpTime, fmName=fmName, rmSystem=rmSystem, processID=processID, processMemUsageCurrent=processMemUsageCurrent, diskPeriod=diskPeriod, rmCpuGrp=rmCpuGrp, duPctUsed=duPctUsed, cpuLoad=cpuLoad, rmNetAddress=rmNetAddress, processEntry=processEntry, cpuUtilAlarmPct=cpuUtilAlarmPct, cpuUtilization=cpuUtilization)
