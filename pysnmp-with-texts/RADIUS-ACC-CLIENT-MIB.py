...
if mibBuilder.loadTexts: radiusAccClientBadAuthenticators.setDescription('The number of RADIUS Accounting-Response packets that contained invalid authenticators received from this server.')
...
if mibBuilder.loadTexts: radiusAccClientUnknownTypes.setDescription('The number of RADIUS packets of unknown type that were received from this server on the accounting port.')
...
if mibBuilder.loadTexts: radiusAccClientPacketsDropped.setDescription('The number of RADIUS packets that were received from this server on the accounting port and dropped for some other reason.')
...
mibBuilder.exportSymbols("RADIUS-ACC-CLIENT-MIB", radiusMIB=radiusMIB, radiusAccServerEntry=radiusAccServerEntry, radiusAccClientExtRoundTripTime=radiusAccClientExtRoundTripTime, radiusAccServerInetAddress=radiusAccServerInetAddress, radiusAccClientInvalidServerAddresses=radiusAccClientInvalidServerAddresses, radiusAccClientExtMIBGroup=radiusAccClientExtMIBGroup, radiusAccClientRequests=radiusAccClientRequests, radiusAccClientExtResponses=radiusAccClientExtResponses, radiusAccServerInetAddressType=radiusAccServerInetAddressType, radiusAccClientExtMIBCompliance=radiusAccClientExtMIBCompliance, radiusAccClientExtPendingRequests=radiusAccClientExtPendingRequests, radiusAccClientCounterDiscontinuity=radiusAccClientCounterDiscontinuity, radiusAccClientServerPortNumber=radiusAccClientServerPortNumber, radiusAccClientTimeouts=radiusAccClientTimeouts, radiusAccClientExtBadAuthenticators=radiusAccClientExtBadAuthenticators, radiusAccServerIndex=radiusAccServerIndex, radiusAccClientMIBGroups=radiusAccClientMIBGroups, radiusAccClientExtTimeouts=radiusAccClientExtTimeouts, radiusAccClientPacketsDropped=radiusAccClientPacketsDropped, radiusAccClientIdentifier=radiusAccClientIdentifier, radiusAccServerAddress=radiusAccServerAddress, radiusAccClientMIBObjects=radiusAccClientMIBObjects, radiusAccClientRoundTripTime=radiusAccClientRoundTripTime, radiusAccounting=radiusAccounting, radiusAccClientPendingRequests=radiusAccClientPendingRequests, radiusAccServerExtIndex=radiusAccServerExtIndex, radiusAccClientMIBConformance=radiusAccClientMIBConformance, radiusAccClientExtRequests=radiusAccClientExtRequests, radiusAccClientMIBCompliance=radiusAccClientMIBCompliance, radiusAccClientMIB=radiusAccClientMIB, radiusAccServerExtTable=radiusAccServerExtTable, radiusAccClientExtPacketsDropped=radiusAccClientExtPacketsDropped, radiusAccClientExtUnknownTypes=radiusAccClientExtUnknownTypes, radiusAccClientRetransmissions=radiusAccClientRetransmissions, radiusAccClientExtMalformedResponses=radiusAccClientExtMalformedResponses, radiusAccServerExtEntry=radiusAccServerExtEntry, radiusAccClient=radiusAccClient, radiusAccClientUnknownTypes=radiusAccClientUnknownTypes, radiusAccClientBadAuthenticators=radiusAccClientBadAuthenticators, radiusAccServerTable=radiusAccServerTable, PYSNMP_MODULE_ID=radiusAccClientMIB, radiusAccClientMIBCompliances=radiusAccClientMIBCompliances, radiusAccClientServerInetPortNumber=radiusAccClientServerInetPortNumber, radiusAccClientMalformedResponses=radiusAccClientMalformedResponses, radiusAccClientMIBGroup=radiusAccClientMIBGroup, radiusAccClientExtRetransmissions=radiusAccClientExtRetransmissions, radiusAccClientResponses=radiusAccClientResponses)
