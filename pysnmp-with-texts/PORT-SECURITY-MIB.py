...
iso, NotificationType, Gauge32, Bits, TimeTicks, Unsigned32, Counter32, Integer32, IpAddress, MibIdentifier, ObjectIdentity, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "NotificationType", "Gauge32", "Bits", "TimeTicks", "Unsigned32", "Counter32", "Integer32", "IpAddress", "MibIdentifier", "ObjectIdentity", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
if mibBuilder.loadTexts: swPortSecSysMaxLernAddr.setDescription('Indicates the maximum number of addresses to be authorized by port security on the system. The max entry range is (1..N). The value N means the max number and is determined by the project itself.')
...
mibBuilder.exportSymbols("PORT-SECURITY-MIB", swPortSecPortEntry=swPortSecPortEntry, swPortSecVLANMaxLernAddr=swPortSecVLANMaxLernAddr, swPortSecVLANOnPortMaxLernAddr=swPortSecVLANOnPortMaxLernAddr, swPortSecMIB=swPortSecMIB, swPortSecPortLockAddrMode=swPortSecPortLockAddrMode, swPortSecMgmtByVLANOnPortClearCtrl=swPortSecMgmtByVLANOnPortClearCtrl, swPortSecMgmt=swPortSecMgmt, swPortSecEntriesEntry=swPortSecEntriesEntry, PYSNMP_MODULE_ID=swPortSecMIB, swPortSecPort=swPortSecPort, swPortSecVLANOnPortEntry=swPortSecVLANOnPortEntry, swPortSecVLANEntry=swPortSecVLANEntry, swPortSecVLANOnPortAddCtrl=swPortSecVLANOnPortAddCtrl, swPortSecTrapState=swPortSecTrapState, swPortSecEntriesTable=swPortSecEntriesTable, swPortSecVID=swPortSecVID, swPortSecPortIndex=swPortSecPortIndex, swPortSecMgmtByVLANOnPort=swPortSecMgmtByVLANOnPort, swPortSecPortTable=swPortSecPortTable, swPortSecPortMaxLernAddr=swPortSecPortMaxLernAddr, swPortSecPortAdmState=swPortSecPortAdmState, swPortSecVLANID=swPortSecVLANID, swPortSecMgmtByVLANOnPortClearAction=swPortSecMgmtByVLANOnPortClearAction, swPortSecLogState=swPortSecLogState, swPortSecMgmtByVLAN=swPortSecMgmtByVLAN, swPortSecPortClearCtrl=swPortSecPortClearCtrl, swPortSecMgmtByVLANOnPortClearPort=swPortSecMgmtByVLANOnPortClearPort, swPortSecMgmtByPort=swPortSecMgmtByPort, swPortSecMgmtByVLANOnPortClearVID=swPortSecMgmtByVLANOnPortClearVID, swPortSecTrapLogState=swPortSecTrapLogState, swPortSecInfo=swPortSecInfo, swPortSecMac=swPortSecMac, swPortSecSysMaxLernAddr=swPortSecSysMaxLernAddr, swPortSecVLANOnPortTable=swPortSecVLANOnPortTable, swPortSecDelCtrl=swPortSecDelCtrl, swPortSecVLANClearCtrl=swPortSecVLANClearCtrl, swPortSecVLANTable=swPortSecVLANTable, swPortSecCtrl=swPortSecCtrl)
