...
# Produced by pysmi-0.3.4 at Wed May  1 14:37:34 2019
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Counter64, MibIdentifier, Integer32, iso, Bits, TimeTicks, Unsigned32, NotificationType, transmission, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Counter64", "MibIdentifier", "Integer32", "iso", "Bits", "TimeTicks", "Unsigned32", "NotificationType", "transmission", "ObjectIdentity", "Counter32")
...
if mibBuilder.loadTexts: para.setContactInfo(' Bob Stewart Postal: Xyplex, Inc. 295 Foster Street Littleton, MA 01460 Tel: 508-952-4816 Fax: 508-952-4887 E-mail: rlstewart@eng.xyplex.com')
...
if mibBuilder.loadTexts: paraPortIndex.setDescription('The value of ifIndex for the port. By convention and if possible, hardware port numbers map directly to external connectors. The value for each port must remain constant at least from one re-initialization of the network management agent to the next.')
...
if mibBuilder.loadTexts: paraPortInSigNumber.setDescription('The number of input signals for the port in the input signal table (paraPortInSigTable). The table contains entries only for those signals the software can detect and that are useful to observe.')
...
if mibBuilder.loadTexts: paraPortOutSigNumber.setDescription('The number of output signals for the port in the output signal table (paraPortOutSigTable). The table contains entries only for those signals the software can assert and that are useful to observe.')
...
if mibBuilder.loadTexts: paraCompliance.setDescription('The compliance statement for SNMPv2 entities which have Parallel-printer-like hardware interfaces.')
...
if mibBuilder.loadTexts: paraGroup.setDescription('A collection of objects providing information applicable to all Parallel-printer-like interfaces.')
mibBuilder.exportSymbols("PARALLEL-MIB", paraConformance=paraConformance, paraOutSigPortIndex=paraOutSigPortIndex, paraInSigChanges=paraInSigChanges, para=para, paraInSigTable=paraInSigTable, paraOutSigName=paraOutSigName, paraOutSigChanges=paraOutSigChanges, paraGroup=paraGroup, paraPortEntry=paraPortEntry, paraCompliances=paraCompliances, paraPortTable=paraPortTable, paraInSigPortIndex=paraInSigPortIndex, paraOutSigTable=paraOutSigTable, paraPortType=paraPortType, paraOutSigEntry=paraOutSigEntry, paraInSigName=paraInSigName, paraPortIndex=paraPortIndex, PYSNMP_MODULE_ID=para, paraPortInSigNumber=paraPortInSigNumber, paraInSigEntry=paraInSigEntry, paraOutSigState=paraOutSigState, paraPortOutSigNumber=paraPortOutSigNumber, paraGroups=paraGroups, paraNumber=paraNumber, paraInSigState=paraInSigState, paraCompliance=paraCompliance)
