...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, iso, transmission, Bits, Gauge32, ObjectIdentity, Unsigned32, IpAddress, Counter32, TimeTicks, NotificationType, ModuleIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "iso", "transmission", "Bits", "Gauge32", "ObjectIdentity", "Unsigned32", "IpAddress", "Counter32", "TimeTicks", "NotificationType", "ModuleIdentity", "Integer32")
...
if mibBuilder.loadTexts: fddimibMACMAUnitdataEnable.setDescription('This variable determines the value of the MA_UNITDATA_Enable flag in RMT. The default and initial value of this flag is true(1).')
...
mibBuilder.exportSymbols("FDDI-SMT73-MIB", fddimibMACTokenCts=fddimibMACTokenCts, fddimibSMTNonMasterCts=fddimibSMTNonMasterCts, fddimibPATHIndex=fddimibPATHIndex, fddimibSMTStationStatus=fddimibSMTStationStatus, fddimibMACTMax=fddimibMACTMax, fddimibPORTHardwarePresent=fddimibPORTHardwarePresent, fddimibSMTCFState=fddimibSMTCFState, fddimibMACDownstreamPORTType=fddimibMACDownstreamPORTType, fddimibPORTConnectionPolicies=fddimibPORTConnectionPolicies, fddimibMACIfIndex=fddimibMACIfIndex, fddi=fddi, fddimibPORTCurrentPath=fddimibPORTCurrentPath, fddimibMACTransmitCts=fddimibMACTransmitCts, fddimibPORTMACPlacement=fddimibPORTMACPlacement, fddimibMACMAUnitdataEnable=fddimibMACMAUnitdataEnable, fddimibMACOldDownstreamNbr=fddimibMACOldDownstreamNbr, fddimibPORTLerAlarm=fddimibPORTLerAlarm, fddimibPORTPCMState=fddimibPORTPCMState, fddimibPORTLerFlag=fddimibPORTLerFlag, fddimibPORTRequestedPaths=fddimibPORTRequestedPaths, fddimibSMTTable=fddimibSMTTable, fddimibPORTAvailablePaths=fddimibPORTAvailablePaths, fddimibSMTStationAction=fddimibSMTStationAction, fddimibSMTConnectionPolicy=fddimibSMTConnectionPolicy, fddimibSMTEntry=fddimibSMTEntry, fddimibSMTConfigCapabilities=fddimibSMTConfigCapabilities, fddimibMACTVXCapability=fddimibMACTVXCapability, fddimibMACOldUpstreamNbr=fddimibMACOldUpstreamNbr, fddimibPATHConfigEntry=fddimibPATHConfigEntry, fddimibMACRequestedPaths=fddimibMACRequestedPaths, fddimibPORTBSFlag=fddimibPORTBSFlag, fddimibPORTLerCutoff=fddimibPORTLerCutoff, fddimibPATHNumber=fddimibPATHNumber, fddimibSMTMasterCts=fddimibSMTMasterCts, fddimibMACEntry=fddimibMACEntry, fddimibSMTMACCts=fddimibSMTMACCts, fddimibPORT=fddimibPORT, fddimibMACNotCopiedThreshold=fddimibMACNotCopiedThreshold, fddimibPORTPCWithhold=fddimibPORTPCWithhold, fddimibSMTTimeStamp=fddimibSMTTimeStamp, fddimibMACDaFlag=fddimibMACDaFlag, fddimibMACUpstreamNbr=fddimibMACUpstreamNbr, fddimibPORTConnectionCapabilities=fddimibPORTConnectionCapabilities, fddimibPORTAction=fddimibPORTAction, fddimibPORTLerEstimate=fddimibPORTLerEstimate, fddimibSMTOpVersionId=fddimibSMTOpVersionId, fddimibSMTStationId=fddimibSMTStationId, fddimibSMTIndex=fddimibSMTIndex, fddimibSMTPeerWrapFlag=fddimibSMTPeerWrapFlag, fddimibMACCountersTable=fddimibMACCountersTable, fddimibMACTvxValue=fddimibMACTvxValue, fddimibMACTable=fddimibMACTable, fddimibPATHTMaxLowerBound=fddimibPATHTMaxLowerBound, fddimibPORTSMTIndex=fddimibPORTSMTIndex, fddimibMAC=fddimibMAC, fddimibPORTPMDClass=fddimibPORTPMDClass, fddimibSMTLoVersionId=fddimibSMTLoVersionId, FddiTimeNano=FddiTimeNano, fddimibMACRingOpCts=fddimibMACRingOpCts, fddimibPORTTable=fddimibPORTTable, fddimibSMTNumber=fddimibSMTNumber, fddimibMACAvailablePaths=fddimibMACAvailablePaths, fddimibMACFrameErrorFlag=fddimibMACFrameErrorFlag, fddimibMACCounters=fddimibMACCounters, fddimibSMTMIBVersionId=fddimibSMTMIBVersionId, fddimibSMTECMState=fddimibSMTECMState, fddimibMACIndex=fddimibMACIndex, fddimibMACCurrentPath=fddimibMACCurrentPath, fddimibSMTRemoteDisconnectFlag=fddimibSMTRemoteDisconnectFlag, fddimibPATHMaxTReq=fddimibPATHMaxTReq, fddimibSMTConfigPolicy=fddimibSMTConfigPolicy, fddimibSMTTransitionTimeStamp=fddimibSMTTransitionTimeStamp, FddiResourceId=FddiResourceId, fddimibMACDupAddressTest=fddimibMACDupAddressTest, fddimibMACNotCopiedFlag=fddimibMACNotCopiedFlag, fddimibMACFrameCts=fddimibMACFrameCts, fddimibPORTMACIndicated=fddimibPORTMACIndicated, fddimibMACHardwarePresent=fddimibMACHardwarePresent, fddimibMACNumber=fddimibMACNumber, fddimibPORTIndex=fddimibPORTIndex, fddimibMACLostCts=fddimibMACLostCts, fddimibPORTLCTFailCts=fddimibPORTLCTFailCts, fddimibMACNotCopiedRatio=fddimibMACNotCopiedRatio, fddimibPATHConfigSMTIndex=fddimibPATHConfigSMTIndex, fddimibMACSMTIndex=fddimibMACSMTIndex, fddimibMACFrameErrorThreshold=fddimibMACFrameErrorThreshold, fddimibPATH=fddimibPATH, FddiSMTStationIdType=FddiSMTStationIdType, fddimibMACCopiedCts=fddimibMACCopiedCts, fddimibMACUnaDaFlag=fddimibMACUnaDaFlag, fddimibMACMAUnitdataAvailable=fddimibMACMAUnitdataAvailable, fddimibPORTConnectState=fddimibPORTConnectState, fddimibPORTLemRejectCts=fddimibPORTLemRejectCts, fddimibSMT=fddimibSMT, fddimibMACTReq=fddimibMACTReq, fddimibPATHTVXLowerBound=fddimibPATHTVXLowerBound, fddimibPATHTable=fddimibPATHTable, FddiTimeMilli=FddiTimeMilli, fddimibMACRMTState=fddimibMACRMTState, fddimibPORTEntry=fddimibPORTEntry, fddimibSMTHiVersionId=fddimibSMTHiVersionId, fddimibPATHConfigResourceIndex=fddimibPATHConfigResourceIndex, fddimib=fddimib, fddimibPATHConfigTokenOrder=fddimibPATHConfigTokenOrder, fddimibMACSMTAddress=fddimibMACSMTAddress, fddimibMACFrameStatusFunctions=fddimibMACFrameStatusFunctions, fddimibPATHEntry=fddimibPATHEntry, FddiMACLongAddressType=FddiMACLongAddressType, fddimibSMTUserData=fddimibSMTUserData, fddimibPORTLemCts=fddimibPORTLemCts, fddimibMACFrameErrorRatio=fddimibMACFrameErrorRatio, fddimibSMTTraceMaxExpiration=fddimibSMTTraceMaxExpiration, fddimibSMTStatRptPolicy=fddimibSMTStatRptPolicy, fddimibMACTMaxCapability=fddimibMACTMaxCapability, fddimibSMTTNotify=fddimibSMTTNotify, fddimibSMTAvailablePaths=fddimibSMTAvailablePaths, fddimibMACLateCts=fddimibMACLateCts, fddimibMACCountersEntry=fddimibMACCountersEntry, fddimibPATHConfigTable=fddimibPATHConfigTable, fddimibMACDownstreamNbr=fddimibMACDownstreamNbr, fddimibPATHSMTIndex=fddimibPATHSMTIndex, fddimibMACErrorCts=fddimibMACErrorCts, fddimibPATHConfigPATHIndex=fddimibPATHConfigPATHIndex, fddimibMACTNeg=fddimibMACTNeg, fddimibPORTNeighborType=fddimibPORTNeighborType, fddimibPORTNumber=fddimibPORTNumber, fddimibMACTvxExpiredCts=fddimibMACTvxExpiredCts, fddimibMACNotCopiedCts=fddimibMACNotCopiedCts, fddimibPATHConfigResourceType=fddimibPATHConfigResourceType, fddimibSMTBypassPresent=fddimibSMTBypassPresent, fddimibPATHConfigCurrentPath=fddimibPATHConfigCurrentPath, fddimibPORTMyType=fddimibPORTMyType)
