...
if mibBuilder.loadTexts: avclVersion.setDescription("The software version of AVC-L basing on the Daemon as the data gathered is based on it. eg. '4.0'")
...
if mibBuilder.loadTexts: avclDeviceAssignedSpare.setDescription("The device's global spare assignment. Can be any of the ff.: - No Assigned Spare - HDD # eg. 'No Assigned Spare' or 'HDD 1' or 'HDD 2, HDD 6'")
...
mibBuilder.exportSymbols("ADTX-RAID-AVCL-MIB", avclDeviceRaidGrpsSize=avclDeviceRaidGrpsSize, avclDeviceRaidGrpsInitReconProgress=avclDeviceRaidGrpsInitReconProgress, avclDeviceTime=avclDeviceTime, avclOS=avclOS, avclDeviceInstantCopyLicense=avclDeviceInstantCopyLicense, avclDeviceVolumesRaidGrpNumber=avclDeviceVolumesRaidGrpNumber, avclDeviceComponentsType=avclDeviceComponentsType, avclDeviceManufacturer=avclDeviceManufacturer, avclDeviceSparesState=avclDeviceSparesState, avclDeviceComponentCount=avclDeviceComponentCount, avclDeviceAssignedSpare=avclDeviceAssignedSpare, avclDeviceRaidGrpCount=avclDeviceRaidGrpCount, avcl=avcl, avclDeviceICProgress=avclDeviceICProgress, avclDeviceProductName=avclDeviceProductName, avclDeviceVolumesNickname=avclDeviceVolumesNickname, avclVersion=avclVersion, avclDeviceSerialNumber=avclDeviceSerialNumber, avclDeviceSystemVersion=avclDeviceSystemVersion, avclDeviceICFlag=avclDeviceICFlag, avclDeviceLuToMirrorCount=avclDeviceLuToMirrorCount, avclDeviceDriveCount=avclDeviceDriveCount, avclDeviceDrivesRaidGrpOrSpareNumber=avclDeviceDrivesRaidGrpOrSpareNumber, avclDeviceRaidGrpsSurfaceVerifyProgress=avclDeviceRaidGrpsSurfaceVerifyProgress, avclDeviceComponentsState=avclDeviceComponentsState, avclDeviceRegHosts=avclDeviceRegHosts, avclDeviceDrivesUsageType=avclDeviceDrivesUsageType, avclDeviceICSourceLU=avclDeviceICSourceLU, avclDeviceDate=avclDeviceDate, avclDeviceVolumeCount=avclDeviceVolumeCount, avclDeviceICPairWWN=avclDeviceICPairWWN, avclDeviceMirroringLicense=avclDeviceMirroringLicense, avclDeviceRaidGrpsDriveCount=avclDeviceRaidGrpsDriveCount, avclDeviceSparesRaidGrpNumber=avclDeviceSparesRaidGrpNumber, avclDeviceIP=avclDeviceIP, avclDeviceRaidGrpsFreeSpace=avclDeviceRaidGrpsFreeSpace, avc=avc, avclDeviceSpareCount=avclDeviceSpareCount, avclNumOfDevices=avclNumOfDevices, avclDeviceRaidGrpsState=avclDeviceRaidGrpsState, avclDeviceIndex=avclDeviceIndex, avclDeviceRevisionLevel=avclDeviceRevisionLevel, avclDeviceInitiatorMode=avclDeviceInitiatorMode, avclDeviceInformationEntry=avclDeviceInformationEntry, avclEventInfo=avclEventInfo, avclDeviceSurfaceVerifyDuration=avclDeviceSurfaceVerifyDuration, avclDeviceVolumesInitProgress=avclDeviceVolumesInitProgress, avclDeviceDrivesState=avclDeviceDrivesState, avclDeviceICTargetLU=avclDeviceICTargetLU, avclDeviceWWNInfo=avclDeviceWWNInfo, avclDeviceSurfaceSchedMode=avclDeviceSurfaceSchedMode, avclDeviceRegHostCount=avclDeviceRegHostCount, avclDeviceWWNInfoCount=avclDeviceWWNInfoCount, avclDeviceSurfaceSchedTime=avclDeviceSurfaceSchedTime, avclDeviceRaidGrpsLuUnderSurfaceVerify=avclDeviceRaidGrpsLuUnderSurfaceVerify, avclDeviceComponentsInstanceNumber=avclDeviceComponentsInstanceNumber, avclHost=avclHost, avclDeviceVolumesRaidLevel=avclDeviceVolumesRaidLevel, daemonEvent=daemonEvent, avclDeviceVolumesState=avclDeviceVolumesState, AvcCounter=AvcCounter, avclDeviceLunsToMirror=avclDeviceLunsToMirror, AvcString=AvcString, avclDeviceInformationTable=avclDeviceInformationTable, AvcInteger=AvcInteger, avclDeviceVolumesSize=avclDeviceVolumesSize, AvcLongString=AvcLongString)
