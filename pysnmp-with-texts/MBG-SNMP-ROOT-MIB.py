...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/MBG-SNMP-ROOT-MIB
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: mbgSnmpRoot.setRevisionsDescriptions((' Rev 1.01 25 January 2012 7:45 UTC Philipp Rahns Changed MIB module name', ' Rev 1.00 14 October 2011 6:30 UTC Philipp Rahns Initial revision',))
...
if mibBuilder.loadTexts: mbgSnmpRoot.setContactInfo('postal: Meinberg Funkuhren Lange Wand 9 31812 Bad Pyrmont Germany email: info@meinberg.de web: http://www.meinberg.de tel: +49 (0) 52 81 / 93 09 - 0 fax: +49 (0) 52 81 / 93 09 - 30')
