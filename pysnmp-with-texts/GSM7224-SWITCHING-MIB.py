...
# Produced by pysmi-0.3.4 at Wed May  1 13:20:01 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, TimeTicks, Bits, IpAddress, Integer32, Counter64, ObjectIdentity, ModuleIdentity, Counter32, MibIdentifier, iso, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "TimeTicks", "Bits", "IpAddress", "Integer32", "Counter64", "ObjectIdentity", "ModuleIdentity", "Counter32", "MibIdentifier", "iso", "Gauge32")
RowStatus, DisplayString, TextualConvention, PhysAddress, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TextualConvention", "PhysAddress", "MacAddress")
gsm7224Switching = ModuleIdentity((1, 3, 6, 1, 4, 1, 4526, 1, 8, 1))
gsm7224Switching.setRevisions(('2003-02-06 18:35',))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: gsm7224Switching.setRevisionsDescriptions(('',))
...
if mibBuilder.loadTexts: gsm7224Switching.setContactInfo('')
if mibBuilder.loadTexts: gsm7224Switching.setDescription('')
...
mibBuilder.exportSymbols("GSM7224-SWITCHING-MIB", agentUserConfigTable=agentUserConfigTable, agentUserPortConfigEntry=agentUserPortConfigEntry, agentPortIfIndex=agentPortIfIndex, multipleUsersTrap=multipleUsersTrap, vlanDeleteLastTrap=vlanDeleteLastTrap, agentPortMaxFrameSize=agentPortMaxFrameSize, agentSwitchIGMPSnoopingPortMask=agentSwitchIGMPSnoopingPortMask, agentNetworkMgmtVlan=agentNetworkMgmtVlan, agentSwitchMFDBFilteringPortMask=agentSwitchMFDBFilteringPortMask, agentStpCstMaxAge=agentStpCstMaxAge, agentSwitchBroadcastControlMode=agentSwitchBroadcastControlMode, agentClearPortStats=agentClearPortStats, agentSwitchMFDBVlanId=agentSwitchMFDBVlanId, agentClassOfServicePriority=agentClassOfServicePriority, agentStpPortStatsRstpBpduRx=agentStpPortStatsRstpBpduRx, agentDot3adAggPortEntry=agentDot3adAggPortEntry, agentSnmpTrapReceiverConfigEntry=agentSnmpTrapReceiverConfigEntry, agentTransferUploadPath=agentTransferUploadPath, agentSaveConfigStatus=agentSaveConfigStatus, agentPortPhysicalStatus=agentPortPhysicalStatus, agentLoginSessionConnectionType=agentLoginSessionConnectionType, broadcastStormStartTrap=broadcastStormStartTrap, agentUserAuthenticationType=agentUserAuthenticationType, agentStpCstHelloTime=agentStpCstHelloTime, agentInventoryAdditionalPackages=agentInventoryAdditionalPackages, agentStpMstEntry=agentStpMstEntry, agentStpCstPortEntry=agentStpCstPortEntry, agentProtocolGroupProtocolIPX=agentProtocolGroupProtocolIPX, agentStpMstTopologyChangeParm=agentStpMstTopologyChangeParm, agentNetworkDefaultGateway=agentNetworkDefaultGateway, agentLoginSessionSessionTime=agentLoginSessionSessionTime, agentSnmpCommunityAccessMode=agentSnmpCommunityAccessMode, agentProtocolGroupVlanId=agentProtocolGroupVlanId, agentStpCstConfigGroup=agentStpCstConfigGroup, agentStpCstPortPathCost=agentStpCstPortPathCost, agentClassOfServiceGroup=agentClassOfServiceGroup, agentInventorySoftwareVersion=agentInventorySoftwareVersion, agentClearSwitchStats=agentClearSwitchStats, agentStpMstPortPriority=agentStpMstPortPriority, agentPortMaxFrameSizeLimit=agentPortMaxFrameSizeLimit, agentSwitchMFDBSummaryTable=agentSwitchMFDBSummaryTable, stpInstanceNewRootTrap=stpInstanceNewRootTrap, agentNetworkConfigGroup=agentNetworkConfigGroup, agentSnmpCommunityIndex=agentSnmpCommunityIndex, agentProtocolGroupPortStatus=agentProtocolGroupPortStatus, agentUserEncryptionPassword=agentUserEncryptionPassword, agentStpForceVersion=agentStpForceVersion, agentClassOfServiceClass=agentClassOfServiceClass, agentUserEncryptionType=agentUserEncryptionType, agentSwitchIGMPSnoopingAdminMode=agentSwitchIGMPSnoopingAdminMode, linkFailureTrap=linkFailureTrap, agentUserConfigDefaultAuthenticationList=agentUserConfigDefaultAuthenticationList, agentSwitchIGMPSnoopingGroup=agentSwitchIGMPSnoopingGroup, agentClearPasswords=agentClearPasswords, broadcastStormEndTrap=broadcastStormEndTrap, agentSwitchMFDBSummaryEntry=agentSwitchMFDBSummaryEntry, agentTransferUploadGroup=agentTransferUploadGroup, agentTrapLogTrap=agentTrapLogTrap, agentCableTesterMaximumCableLength=agentCableTesterMaximumCableLength, vlanRestoreFailureTrap=vlanRestoreFailureTrap, agentLagSummaryType=agentLagSummaryType, agentTransferDownloadStatus=agentTransferDownloadStatus, agentPortSTPMode=agentPortSTPMode, agentPortSTPState=agentPortSTPState, agentSwitchIGMPSnoopingMulticastControlFramesProcessed=agentSwitchIGMPSnoopingMulticastControlFramesProcessed, agentSnmpCommunityConfigTable=agentSnmpCommunityConfigTable, gsm7224Switching=gsm7224Switching, agentSwitchMFDBSummaryVlanId=agentSwitchMFDBSummaryVlanId, agentProtocolConfigGroup=agentProtocolConfigGroup, agentStpPortStatsMstpBpduTx=agentStpPortStatsMstpBpduTx, PYSNMP_MODULE_ID=gsm7224Switching, agentStpPortStatsRstpBpduTx=agentStpPortStatsRstpBpduTx, agentServicePortSubnetMask=agentServicePortSubnetMask, agentInfoGroup=agentInfoGroup, agentStpCstBridgeHelloTime=agentStpCstBridgeHelloTime, agentProtocolGroupStatus=agentProtocolGroupStatus, agentLagSummaryConfigTable=agentLagSummaryConfigTable, agentStpCstPortPriority=agentStpCstPortPriority, agentCableTesterCableStatus=agentCableTesterCableStatus, agentLagSummaryAdminMode=agentLagSummaryAdminMode, agentLagDetailedLagIndex=agentLagDetailedLagIndex, agentStpAdminMode=agentStpAdminMode, agentStpMstDesignatedRootId=agentStpMstDesignatedRootId, agentStpMstRootPathCost=agentStpMstRootPathCost, agentLagSummaryLagIndex=agentLagSummaryLagIndex, agentServicePortBurnedInMacAddress=agentServicePortBurnedInMacAddress, agentTelnetLoginTimeout=agentTelnetLoginTimeout, agentSwitchMFDBDescription=agentSwitchMFDBDescription, agentTransferUploadStart=agentTransferUploadStart, agentSwitchMFDBSummaryMacAddress=agentSwitchMFDBSummaryMacAddress, agentSnmpTrapReceiverCreate=agentSnmpTrapReceiverCreate, agentSnmpCommunityCreate=agentSnmpCommunityCreate, agentSnmpSpanningTreeTrapFlag=agentSnmpSpanningTreeTrapFlag, agentUserName=agentUserName, agentDot3adAggPortLACPMode=agentDot3adAggPortLACPMode, agentStpMstVlanEntry=agentStpMstVlanEntry, agentCableTesterGroup=agentCableTesterGroup, agentSwitchIGMPSnoopingMaxResponseTime=agentSwitchIGMPSnoopingMaxResponseTime, agentTransferUploadDataType=agentTransferUploadDataType, agentPortDot1dBasePort=agentPortDot1dBasePort, agentCableTesterStatus=agentCableTesterStatus, agentServicePortDefaultGateway=agentServicePortDefaultGateway, agentMirroredPortIfIndex=agentMirroredPortIfIndex, agentPortMirroringMode=agentPortMirroringMode, gsm7224SwitchingTraps=gsm7224SwitchingTraps, agentStpCstDesignatedBridgeId=agentStpCstDesignatedBridgeId, agentAuthenticationListTable=agentAuthenticationListTable, agentTransferConfigGroup=agentTransferConfigGroup, agentProtocolGroupName=agentProtocolGroupName, agentSnmpCommunityConfigEntry=agentSnmpCommunityConfigEntry, agentLagConfigGroup=agentLagConfigGroup, agentSnmpConfigGroup=agentSnmpConfigGroup, agentAuthenticationListMethod1=agentAuthenticationListMethod1, agentSwitchMFDBEntry=agentSwitchMFDBEntry, agentClearLags=agentClearLags, agentLoginSessionEntry=agentLoginSessionEntry, agentLoginSessionIdleTime=agentLoginSessionIdleTime, agentStpMstPortEntry=agentStpMstPortEntry, agentLoginSessionTable=agentLoginSessionTable, agentAuthenticationGroup=agentAuthenticationGroup, agentPortAutoNegAdminStatus=agentPortAutoNegAdminStatus, agentStpMstDesignatedCost=agentStpMstDesignatedCost, agentProtocolGroupPortIfIndex=agentProtocolGroupPortIfIndex, agentStpCstBridgeMaxAge=agentStpCstBridgeMaxAge, agentPortMirroringGroup=agentPortMirroringGroup, agentStpMstPortForwardingState=agentStpMstPortForwardingState, agentPortIanaType=agentPortIanaType, agentAuthenticationListCreate=agentAuthenticationListCreate, agentPortDot3FlowControlMode=agentPortDot3FlowControlMode, agentStpMstBridgePriority=agentStpMstBridgePriority, agentServicePortConfigGroup=agentServicePortConfigGroup, agentStpMstVlanTable=agentStpMstVlanTable, agentStpMstDesignatedPortId=agentStpMstDesignatedPortId, agentStpMstTable=agentStpMstTable, agentProbePortIfIndex=agentProbePortIfIndex, agentTransferDownloadMode=agentTransferDownloadMode, agentSupportedMibEntry=agentSupportedMibEntry, agentProtocolGroupPortEntry=agentProtocolGroupPortEntry, agentLagDetailedConfigTable=agentLagDetailedConfigTable, agentTrapLogSystemTime=agentTrapLogSystemTime, agentStpCstBridgeFwdDelay=agentStpCstBridgeFwdDelay, agentUserConfigGroup=agentUserConfigGroup, agentStpPortUpTime=agentStpPortUpTime, agentLagDetailedIfIndex=agentLagDetailedIfIndex, agentStpCstDesignatedPortId=agentStpCstDesignatedPortId, agentStpCstDesignatedCost=agentStpCstDesignatedCost, agentLagSummaryLinkTrap=agentLagSummaryLinkTrap, agentStpMstPortId=agentStpMstPortId, agentSwitchIGMPSnoopingMRPExpirationTime=agentSwitchIGMPSnoopingMRPExpirationTime, agentStpMstTopologyChangeCount=agentStpMstTopologyChangeCount, agentSerialBaudrate=agentSerialBaudrate, agentSwitchConfigGroup=agentSwitchConfigGroup, agentClearVlan=agentClearVlan, agentStpCstPortOperPointToPoint=agentStpCstPortOperPointToPoint, agentSnmpLinkUpDownTrapFlag=agentSnmpLinkUpDownTrapFlag, agentPortAdminMode=agentPortAdminMode, agentCLIConfigGroup=agentCLIConfigGroup, agentStpCstPortEdge=agentStpCstPortEdge, agentCableTesterIfIndex=agentCableTesterIfIndex, agentUserConfigCreate=agentUserConfigCreate, agentStpMstVlanRowStatus=agentStpMstVlanRowStatus, agentSerialParityType=agentSerialParityType, vlanDefaultCfgFailureTrap=vlanDefaultCfgFailureTrap, agentLagDetailedPortStatus=agentLagDetailedPortStatus, agentSerialHWFlowControlMode=agentSerialHWFlowControlMode, fanFailureTrap=fanFailureTrap, agentStpSwitchConfigGroup=agentStpSwitchConfigGroup, agentServicePortIPAddress=agentServicePortIPAddress, agentLagDetailedPortSpeed=agentLagDetailedPortSpeed, agentPortConfigEntry=agentPortConfigEntry, agentUserPassword=agentUserPassword, agentPortClearStats=agentPortClearStats, agentTrapLogIndex=agentTrapLogIndex, agentStpMstTimeSinceTopologyChange=agentStpMstTimeSinceTopologyChange, agentStpConfigFormatSelector=agentStpConfigFormatSelector, agentPortDVlanTagMode=agentPortDVlanTagMode, agentSnmpMultipleUsersTrapFlag=agentSnmpMultipleUsersTrapFlag, agentTransferDownloadServerIP=agentTransferDownloadServerIP, agentStpCstRootFwdDelay=agentStpCstRootFwdDelay, agentSnmpTrapFlagsConfigGroup=agentSnmpTrapFlagsConfigGroup, agentResetSystem=agentResetSystem, agentStpMstBridgeIdentifier=agentStpMstBridgeIdentifier, agentLoginSessionStatus=agentLoginSessionStatus, agentInventoryMachineType=agentInventoryMachineType, agentConfigGroup=agentConfigGroup, agentSnmpBroadcastStormTrapFlag=agentSnmpBroadcastStormTrapFlag, agentSaveConfig=agentSaveConfig, agentSwitchMFDBType=agentSwitchMFDBType, agentCableTesterMinimumCableLength=agentCableTesterMinimumCableLength, agentPortDVlanTagCustomerId=agentPortDVlanTagCustomerId, agentStpConfigRevision=agentStpConfigRevision, agentLagSummaryStpMode=agentLagSummaryStpMode, agentUserPortConfigTable=agentUserPortConfigTable, agentStpMstRootPortId=agentStpMstRootPortId, agentSwitchAddressAgingTimeout=agentSwitchAddressAgingTimeout, agentSnmpTrapReceiverCommunityName=agentSnmpTrapReceiverCommunityName, agentLoginSessionIndex=agentLoginSessionIndex, agentTrapLogTotal=agentTrapLogTotal, agentTelnetAllowNewMode=agentTelnetAllowNewMode, agentNetworkWebMode=agentNetworkWebMode, agentUserStatus=agentUserStatus, agentSystemGroup=agentSystemGroup, agentSupportedMibName=agentSupportedMibName, agentStpMstRowStatus=agentStpMstRowStatus, agentAuthenticationListIndex=agentAuthenticationListIndex, agentSwitchAddressAgingTimeoutTable=agentSwitchAddressAgingTimeoutTable, agentSnmpCommunityStatus=agentSnmpCommunityStatus, agentUserConfigEntry=agentUserConfigEntry, agentStpCstPortOperEdge=agentStpCstPortOperEdge, agentStpConfigName=agentStpConfigName, agentStpPortState=agentStpPortState, agentUserPortSecurity=agentUserPortSecurity, agentStpConfigDigestKey=agentStpConfigDigestKey, agentSpanningTreeConfigGroup=agentSpanningTreeConfigGroup, powerSupplyStatusChangeTrap=powerSupplyStatusChangeTrap, agentSerialStopBits=agentSerialStopBits, agentUserAuthenticationConfigEntry=agentUserAuthenticationConfigEntry, agentClearConfig=agentClearConfig, agentInventorySysDescription=agentInventorySysDescription, agentClassOfServiceTable=agentClassOfServiceTable, agentTelnetConfigGroup=agentTelnetConfigGroup, agentUserIndex=agentUserIndex, agentLagSummaryStatus=agentLagSummaryStatus, agentTelnetMaxSessions=agentTelnetMaxSessions, agentSwitchMFDBForwardingPortMask=agentSwitchMFDBForwardingPortMask, agentPortConfigTable=agentPortConfigTable, agentTransferUploadServerIP=agentTransferUploadServerIP, agentProtocolGroupPortTable=agentProtocolGroupPortTable, agentSnmpAuthenticationTrapFlag=agentSnmpAuthenticationTrapFlag, agentInventoryGroup=agentInventoryGroup, agentPortPhysicalMode=agentPortPhysicalMode, agentTransferDownloadDataType=agentTransferDownloadDataType, agentTransferDownloadFilename=agentTransferDownloadFilename, agentSwitchMFDBProtocolType=agentSwitchMFDBProtocolType, agentServicePortConfigProtocol=agentServicePortConfigProtocol, agentStpMstPortTable=agentStpMstPortTable, stpInstanceTopologyChangeTrap=stpInstanceTopologyChangeTrap, agentSupportedMibIndex=agentSupportedMibIndex, agentDot3adAggPort=agentDot3adAggPort, agentSwitchMFDBSummaryForwardingPortMask=agentSwitchMFDBSummaryForwardingPortMask, agentStpPortStatsMstpBpduRx=agentStpPortStatsMstpBpduRx, agentInventoryBurnedInMacAddress=agentInventoryBurnedInMacAddress, agentClearLoginSessions=agentClearLoginSessions, agentPortDefaultType=agentPortDefaultType, agentSnmpTrapReceiverConfigTable=agentSnmpTrapReceiverConfigTable, agentStpCstPortId=agentStpCstPortId, agentStpCstPortForwardingState=agentStpCstPortForwardingState, agentClearTrapLog=agentClearTrapLog, agentTransferDownloadGroup=agentTransferDownloadGroup, agentSerialTimeout=agentSerialTimeout, agentSwitchMFDBMacAddress=agentSwitchMFDBMacAddress, agentStpCstRegionalRootId=agentStpCstRegionalRootId, agentSwitchMFDBCurrentEntries=agentSwitchMFDBCurrentEntries, agentCableTesterCableFailureLocation=agentCableTesterCableFailureLocation)
mibBuilder.exportSymbols("GSM7224-SWITCHING-MIB", agentSwitchIGMPSnoopingGroupMembershipInterval=agentSwitchIGMPSnoopingGroupMembershipInterval, agentLagSummaryDeletePort=agentLagSummaryDeletePort, agentTrapLogGroup=agentTrapLogGroup, agentNetworkJavaMode=agentNetworkJavaMode, agentLagSummaryAddPort=agentLagSummaryAddPort, agentStpCstPortTopologyChangeAck=agentStpCstPortTopologyChangeAck, agentNetworkIPAddress=agentNetworkIPAddress, agentSnmpCommunityIPAddress=agentSnmpCommunityIPAddress, agentSnmpCommunityName=agentSnmpCommunityName, agentTrapLogTotalSinceLastViewed=agentTrapLogTotalSinceLastViewed, agentClassOfServiceEntry=agentClassOfServiceEntry, agentAuthenticationListMethod3=agentAuthenticationListMethod3, agentPortLinkTrapMode=agentPortLinkTrapMode, agentSwitchMFDBGroup=agentSwitchMFDBGroup, agentLagSummaryFlushTimer=agentLagSummaryFlushTimer, agentNetworkSubnetMask=agentNetworkSubnetMask, agentLoginSessionIPAddress=agentLoginSessionIPAddress, agentProtocolGroupProtocolARP=agentProtocolGroupProtocolARP, vlanRequestFailureTrap=vlanRequestFailureTrap, agentTrapLogTable=agentTrapLogTable, agentProtocolGroupTable=agentProtocolGroupTable, agentSwitchMFDBMostEntriesUsed=agentSwitchMFDBMostEntriesUsed, agentPortType=agentPortType, agentLagSummaryName=agentLagSummaryName, agentLagSummaryConfigEntry=agentLagSummaryConfigEntry, agentTrapLogEntry=agentTrapLogEntry, agentProtocolGroupId=agentProtocolGroupId, agentSnmpTrapReceiverIPAddress=agentSnmpTrapReceiverIPAddress, agentSwitchMFDBMaxTableEntries=agentSwitchMFDBMaxTableEntries, agentSupportedMibTable=agentSupportedMibTable, agentStpPortStatsStpBpduRx=agentStpPortStatsStpBpduRx, agentSnmpTrapReceiverStatus=agentSnmpTrapReceiverStatus, agentSnmpCommunityIPMask=agentSnmpCommunityIPMask, agentStpPortEntry=agentStpPortEntry, agentSnmpTrapReceiverIndex=agentSnmpTrapReceiverIndex, agentSwitchAddressAgingTimeoutEntry=agentSwitchAddressAgingTimeoutEntry, agentSwitchDot3FlowControlMode=agentSwitchDot3FlowControlMode, agentUserAccessMode=agentUserAccessMode, agentTransferUploadFilename=agentTransferUploadFilename, agentLagConfigStaticCapability=agentLagConfigStaticCapability, agentLagConfigCreate=agentLagConfigCreate, agentStpCstPortTable=agentStpCstPortTable, agentProtocolGroupEntry=agentProtocolGroupEntry, agentTransferDownloadStart=agentTransferDownloadStart, agentAuthenticationListStatus=agentAuthenticationListStatus, agentAuthenticationListName=agentAuthenticationListName, agentPortDVlanTagEthertype=agentPortDVlanTagEthertype, agentDot3adAggPortTable=agentDot3adAggPortTable, agentTransferDownloadPath=agentTransferDownloadPath, agentStpPortStatsStpBpduTx=agentStpPortStatsStpBpduTx, agentUserAuthenticationList=agentUserAuthenticationList, agentLoginSessionUserName=agentLoginSessionUserName, agentUserAuthenticationConfigTable=agentUserAuthenticationConfigTable, agentTransferUploadStatus=agentTransferUploadStatus, agentStpCstBridgeHoldTime=agentStpCstBridgeHoldTime, agentAuthenticationListMethod2=agentAuthenticationListMethod2, agentSpanningTreeMode=agentSpanningTreeMode, agentStpPortMigrationCheck=agentStpPortMigrationCheck, agentLagDetailedConfigEntry=agentLagDetailedConfigEntry, agentAuthenticationListEntry=agentAuthenticationListEntry, agentProtocolGroupProtocolIP=agentProtocolGroupProtocolIP, agentSerialCharacterSize=agentSerialCharacterSize, agentStpMstId=agentStpMstId, agentStpPortTable=agentStpPortTable, agentNetworkConfigProtocol=agentNetworkConfigProtocol, agentNetworkBurnedInMacAddress=agentNetworkBurnedInMacAddress, agentSerialGroup=agentSerialGroup, agentStpMstPortPathCost=agentStpMstPortPathCost, agentTransferUploadMode=agentTransferUploadMode, agentSwitchMFDBTable=agentSwitchMFDBTable, agentProtocolGroupCreate=agentProtocolGroupCreate, agentStpMstDesignatedBridgeId=agentStpMstDesignatedBridgeId, agentSupportedMibDescription=agentSupportedMibDescription, agentStpCstRegionalRootPathCost=agentStpCstRegionalRootPathCost)
