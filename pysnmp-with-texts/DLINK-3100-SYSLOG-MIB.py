...
# Produced by pysmi-0.3.4 at Wed May  1 12:49:10 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, NotificationType, Counter64, Bits, Integer32, Gauge32, TimeTicks, IpAddress, Counter32, ModuleIdentity, Unsigned32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "NotificationType", "Counter64", "Bits", "Integer32", "Gauge32", "TimeTicks", "IpAddress", "Counter32", "ModuleIdentity", "Unsigned32", "ObjectIdentity")
...
if mibBuilder.loadTexts: rlSyslog.setContactInfo('www.dlink.com')
if mibBuilder.loadTexts: rlSyslog.setDescription('The private MIB module definition for SYSLOG services in DLINK-3100 devices.')
...
mibBuilder.exportSymbols("DLINK-3100-SYSLOG-MIB", rlSyslogGlobalEnable=rlSyslogGlobalEnable, rlSyslogLogEntry=rlSyslogLogEntry, rlSyslogConsoleMessagesIgnored=rlSyslogConsoleMessagesIgnored, rlSyslogLogCacheText1=rlSyslogLogCacheText1, rlSyslogLogCacheCounter=rlSyslogLogCacheCounter, rlSyslogPrivate=rlSyslogPrivate, rlSyslogMinLogToConsoleSeverity=rlSyslogMinLogToConsoleSeverity, rlSyslogLogMessageMnemonic=rlSyslogLogMessageMnemonic, rlSyslogLogText4=rlSyslogLogText4, rlSyslogLogCacheTable=rlSyslogLogCacheTable, RlSyslogSeverity=RlSyslogSeverity, rlSyslogClearCache=rlSyslogClearCache, rlSyslogPhaseOneTests=rlSyslogPhaseOneTests, rlSyslogLogText3=rlSyslogLogText3, rlSyslogMinLogToFileSeverity=rlSyslogMinLogToFileSeverity, rlSyslogLogCacheMessageMnemonic=rlSyslogLogCacheMessageMnemonic, rlSyslogLogCacheDateTime=rlSyslogLogCacheDateTime, rlSyslogFileMessagesIgnored=rlSyslogFileMessagesIgnored, rlSyslogPhaseOneTestGenerator=rlSyslogPhaseOneTestGenerator, rlSyslogAggregationEnable=rlSyslogAggregationEnable, rlSyslogLogCounter=rlSyslogLogCounter, rlSyslogLogText1=rlSyslogLogText1, PYSNMP_MODULE_ID=rlSyslog, rlSyslogLogCacheText3=rlSyslogLogCacheText3, rlSyslogLogText2=rlSyslogLogText2, rlSyslog=rlSyslog, rlSyslogLogAppMnemonic=rlSyslogLogAppMnemonic, rlSyslogLogCacheText4=rlSyslogLogCacheText4, rlSyslogLogCacheAppMnemonic=rlSyslogLogCacheAppMnemonic, rlSyslogClearLogfile=rlSyslogClearLogfile, rlSyslogLogCacheSeverity=rlSyslogLogCacheSeverity, rlSyslogLogCacheText2=rlSyslogLogCacheText2, rlSyslogMibVersion=rlSyslogMibVersion, rlSyslogLogSeverity=rlSyslogLogSeverity, rlSyslogAggregationAgingTime=rlSyslogAggregationAgingTime, rlSyslogCacheTotalMessages=rlSyslogCacheTotalMessages, rlSyslogMinLogToCacheSeverity=rlSyslogMinLogToCacheSeverity, rlSyslogFileMessagesLogged=rlSyslogFileMessagesLogged, rlSyslogLogCacheEntry=rlSyslogLogCacheEntry, rlSyslogLogDateTime=rlSyslogLogDateTime, rlSyslogLogTable=rlSyslogLogTable)
