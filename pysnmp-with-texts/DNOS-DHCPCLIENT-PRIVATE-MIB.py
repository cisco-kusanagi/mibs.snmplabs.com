...
Counter32, Bits, MibIdentifier, Unsigned32, NotificationType, Counter64, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Integer32, ModuleIdentity, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Bits", "MibIdentifier", "Unsigned32", "NotificationType", "Counter64", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Integer32", "ModuleIdentity", "iso", "TimeTicks")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: fastPathDHCPClientPrivate.setRevisionsDescriptions(('Postal address updated.', 'Dell branding related changes.',))
...
if mibBuilder.loadTexts: fastPathDHCPClientPrivate.setDescription('The Broadcom Private MIB for DNOS DHCP Client')
...
mibBuilder.exportSymbols("DNOS-DHCPCLIENT-PRIVATE-MIB", agentdhcp4ClientLeaseParametersEntry=agentdhcp4ClientLeaseParametersEntry, agentdhcp4ClientRenewTime=agentdhcp4ClientRenewTime, agentdhcp4ClientRetryCount=agentdhcp4ClientRetryCount, agentdhcp4ClientDhcpServerAddress=agentdhcp4ClientDhcpServerAddress, fastPathDHCPClientPrivate=fastPathDHCPClientPrivate, agentdhcp4ClientLeaseParameters=agentdhcp4ClientLeaseParameters, agentdhcp4ClientSubnetMask=agentdhcp4ClientSubnetMask, agentdhcp4ClientTransactionID=agentdhcp4ClientTransactionID, agentdhcp4ClientLeaseTime=agentdhcp4ClientLeaseTime, agentdhcp4ClientRebindTime=agentdhcp4ClientRebindTime, PYSNMP_MODULE_ID=fastPathDHCPClientPrivate, agentdhcp4ClientState=agentdhcp4ClientState, agentdhcp4ClientIpAddress=agentdhcp4ClientIpAddress, agentdhcp4ClientInterfaceIndex=agentdhcp4ClientInterfaceIndex, agentdhcp4ClientLeaseParametersTable=agentdhcp4ClientLeaseParametersTable)
