...
# Produced by pysmi-0.3.4 at Wed May  1 14:51:08 2019
...
NotificationType, MibIdentifier, Integer32, IpAddress, Unsigned32, ObjectIdentity, Counter32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, iso, Counter64, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Integer32", "IpAddress", "Unsigned32", "ObjectIdentity", "Counter32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "iso", "Counter64", "Bits", "TimeTicks")
...
mibBuilder.exportSymbols("RADLAN-rlInterfaces", swIfMibVersion=swIfMibVersion, rlIfNumOfPhPorts=rlIfNumOfPhPorts, swIfLockAdminTrapFrequency=swIfLockAdminTrapFrequency, swIfSingleHostViolationOperTrapEnable=swIfSingleHostViolationOperTrapEnable, swIfOperFlowControlMode=swIfOperFlowControlMode, rlIfNumOfUserDefinedPorts=rlIfNumOfUserDefinedPorts, swIfSingleHostViolationOperAction=swIfSingleHostViolationOperAction, swIfPortLockActionSupport=swIfPortLockActionSupport, swIfOperBackPressureMode=swIfOperBackPressureMode, rlIfNumOfLoopbackPorts=rlIfNumOfLoopbackPorts, swIfAdminLockTrapEnable=swIfAdminLockTrapEnable, swIfFlowControlMode=swIfFlowControlMode, swIfTaggedMode=swIfTaggedMode, swIfDefaultPriority=swIfDefaultPriority, swIfTable=swIfTable, swIfBackPressureMode=swIfBackPressureMode, swIfSingleHostViolationAdminTrapEnable=swIfSingleHostViolationAdminTrapEnable, swIfPortLockSupport=swIfPortLockSupport, swIfPortLockIfRangeLockStatus=swIfPortLockIfRangeLockStatus, swIfExtTable=swIfExtTable, swIfDefaultTag=swIfDefaultTag, swIfDuplexOperMode=swIfDuplexOperMode, swIfAdminLockAction=swIfAdminLockAction, swIfPortLockIfRangeEntry=swIfPortLockIfRangeEntry, swIfPortLockIfRangeIndex=swIfPortLockIfRangeIndex, swIfLockAdminStatus=swIfLockAdminStatus, rlIfMibVersion=rlIfMibVersion, swIfHostMode=swIfHostMode, swIfSpeedDuplexNegotiationRemoteCapabilities=swIfSpeedDuplexNegotiationRemoteCapabilities, swIfAdminComboMode=swIfAdminComboMode, swIfPortLockTrapSupport=swIfPortLockTrapSupport, swIfTransceiverType=swIfTransceiverType, swIfSpeedDuplexAutoNegotiation=swIfSpeedDuplexAutoNegotiation, swIfSpeedAdminMode=swIfSpeedAdminMode, swIfLockMaxMacAddresses=swIfLockMaxMacAddresses, swIfAdminMdix=swIfAdminMdix, swIfLockLimitationMode=swIfLockLimitationMode, swIfLockMacAddressesCount=swIfLockMacAddressesCount, rlIfFirstOutOfBandIfIndex=rlIfFirstOutOfBandIfIndex, swIfLockOperStatus=swIfLockOperStatus, swIfPhysAddressType=swIfPhysAddressType, swIfOperLockAction=swIfOperLockAction, swIfReActivate=swIfReActivate, swIfSingleHostViolationAdminTrapFrequency=swIfSingleHostViolationAdminTrapFrequency, swIfEntry=swIfEntry, swIfAdminSpeedDuplexAutoNegotiationLocalCapabilities=swIfAdminSpeedDuplexAutoNegotiationLocalCapabilities, swIfLockOperTrapCount=swIfLockOperTrapCount, AutoNegCapabilitiesBits=AutoNegCapabilitiesBits, rlIfFirstLoopbackIfIndex=rlIfFirstLoopbackIfIndex, rlFlowControlCascadeMode=rlFlowControlCascadeMode, swIfIndex=swIfIndex, swIfOperSpeedDuplexAutoNegotiation=swIfOperSpeedDuplexAutoNegotiation, swIfPortLockIfRangeTrapFreq=swIfPortLockIfRangeTrapFreq, swIfExtSFPSpeed=swIfExtSFPSpeed, swIfOperSuspendedStatus=swIfOperSuspendedStatus, rlIfBaseMACAddressPerIfIndex=rlIfBaseMACAddressPerIfIndex, rlFlowControlCascadeType=rlFlowControlCascadeType, swIfExtEntry=swIfExtEntry, swIfPortLockIfRange=swIfPortLockIfRange, rlIfExistingPortList=rlIfExistingPortList, swIfPortLockIfRangeAction=swIfPortLockIfRangeAction, swIfSingleHostViolationAdminAction=swIfSingleHostViolationAdminAction, swIfSingleHostViolationOperTrapCount=swIfSingleHostViolationOperTrapCount, swIfPortLockIfRangeTable=swIfPortLockIfRangeTable, swIfOperLockTrapEnable=swIfOperLockTrapEnable, swIfPortLockIfRangeTrapEn=swIfPortLockIfRangeTrapEn, rlIfClearPortMibCounters=rlIfClearPortMibCounters, rlIfMapOfOnPhPorts=rlIfMapOfOnPhPorts, swIfType=swIfType, swIfOperMdix=swIfOperMdix, swIfOperSpeedDuplexAutoNegotiationLocalCapabilities=swIfOperSpeedDuplexAutoNegotiationLocalCapabilities, swIfOperComboMode=swIfOperComboMode, swIfStatus=swIfStatus, swIfDuplexAdminMode=swIfDuplexAdminMode)
