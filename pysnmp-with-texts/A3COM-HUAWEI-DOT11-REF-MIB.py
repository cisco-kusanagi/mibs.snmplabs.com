...
# Produced by pysmi-0.3.4 at Wed May  1 11:04:17 2019
...
TimeTicks, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, Counter32, Counter64, Gauge32, ModuleIdentity, Bits, ObjectIdentity, IpAddress, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "Counter32", "Counter64", "Gauge32", "ModuleIdentity", "Bits", "ObjectIdentity", "IpAddress", "Integer32", "NotificationType")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: h3cDot11.setRevisionsDescriptions(('Modified for CMCC of GuangDong province.', 'Modified for CMCC of GuangDong province.', 'Modified for CMCC(China Mobile Communication Corporation) requirements.', 'Modified to add new TC.', 'The initial revision of this MIB module.',))
...
if mibBuilder.loadTexts: h3cDot11APElementTable.setDescription('This table is used to represent fat AP and AP template on AC as one kind of AP element.')
...
if mibBuilder.loadTexts: h3cDot11APElementEntry.setDescription('Each entry contains information for each AP element.')
...
if mibBuilder.loadTexts: h3cDot11APElementIndex.setDescription('This object represents the index of AP element.')
...
if mibBuilder.loadTexts: h3cDot11APElementTemplateName.setDescription('This object represents the template name of AP element.')
...
if mibBuilder.loadTexts: h3cDot11APElementSerialID.setDescription('This object represents the serial ID of AP element.')
...
if mibBuilder.loadTexts: h3cDot11APElementModelAlias.setDescription('This object represents the alias of AP element model name.')
...
if mibBuilder.loadTexts: h3cDot11RadioElementTable.setDescription('This table is used to represent the radio element of fat AP and AC.')
...
if mibBuilder.loadTexts: h3cDot11RadioElementEntry.setDescription('Each entry contains information for each radio element.')
...
if mibBuilder.loadTexts: h3cDot11RadioElementRadioNum.setDescription('This object represents the number of the radio element.')
...
if mibBuilder.loadTexts: h3cDot11RadioElementRadioPolicy.setDescription('This object represents the radio policy of the radio element.')
...
if mibBuilder.loadTexts: h3cDot11RadioElementRadioIndex.setDescription('This object represents the index of the radio element. On AC, the higher 24 bits stand for the AP index, and the last 8 bits stand for the radio index. On fat AP, the index stands for the interface index of radio interface.')
mibBuilder.exportSymbols("A3COM-HUAWEI-DOT11-REF-MIB", H3cDot11TxPwrLevelScopeType=H3cDot11TxPwrLevelScopeType, H3cDot11AKMType=H3cDot11AKMType, h3cDot11APElementTemplateName=h3cDot11APElementTemplateName, h3cDot11APElementTable=h3cDot11APElementTable, H3cDot11ObjectIDType=H3cDot11ObjectIDType, H3cDot11RadioElementIndex=H3cDot11RadioElementIndex, h3cDot11APElementEntry=h3cDot11APElementEntry, h3cDot11APElementIndex=h3cDot11APElementIndex, PYSNMP_MODULE_ID=h3cDot11, H3cDot11SSIDEncryptModeType=H3cDot11SSIDEncryptModeType, h3cDot11Common=h3cDot11Common, H3cDot11TunnelSecSchemType=H3cDot11TunnelSecSchemType, H3cDot11RadioScopeType=H3cDot11RadioScopeType, h3cDot11RadioElementEntry=h3cDot11RadioElementEntry, h3cDot11RadioElementRadioIndex=h3cDot11RadioElementRadioIndex, H3cDot11AssocFailType=H3cDot11AssocFailType, H3cDot11SaIntfDevType=H3cDot11SaIntfDevType, h3cDot11APElementModelAlias=h3cDot11APElementModelAlias, h3cDot11ElementGroup=h3cDot11ElementGroup, H3cDot11MACModeType=H3cDot11MACModeType, h3cDot11RadioElementRadioNum=h3cDot11RadioElementRadioNum, H3cDot11RadioType2=H3cDot11RadioType2, H3cDot11QosAcType=H3cDot11QosAcType, h3cDot11=h3cDot11, H3cDot11CirMode=H3cDot11CirMode, H3cDot11RFModeType=H3cDot11RFModeType, h3cDot11APElementSerialID=h3cDot11APElementSerialID, H3cDot11NotifyReasonType=H3cDot11NotifyReasonType, H3cDot11ServicePolicyIDType=H3cDot11ServicePolicyIDType, H3cDot11AuthenType=H3cDot11AuthenType, H3cDot11PreambleType=H3cDot11PreambleType, H3cDot11WorkMode=H3cDot11WorkMode, h3cDot11RadioElementRadioPolicy=h3cDot11RadioElementRadioPolicy, H3cDot11SecIEStatusType=H3cDot11SecIEStatusType, H3cDot11RadioType=H3cDot11RadioType, H3cDot11CipherType=H3cDot11CipherType, H3cDot11SSIDStringType=H3cDot11SSIDStringType, H3cDot11AuthorFailType=H3cDot11AuthorFailType, H3cDot11ChannelScopeType=H3cDot11ChannelScopeType, h3cDot11RadioElementTable=h3cDot11RadioElementTable)
