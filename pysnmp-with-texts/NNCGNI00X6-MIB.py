...
# Produced by pysmi-0.3.4 at Wed May  1 14:23:09 2019
...
nncExtDiag, nncExtProbe, nncExtSystem, nncExtRestart, nncExtCodeSpace, nncExtNVM, nncExtEnvironmental = mibBuilder.importSymbols("NNCGNI00X1-SMI", "nncExtDiag", "nncExtProbe", "nncExtSystem", "nncExtRestart", "nncExtCodeSpace", "nncExtNVM", "nncExtEnvironmental")
ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup")
Counter32, NotificationType, Gauge32, ModuleIdentity, MibIdentifier, TimeTicks, Integer32, IpAddress, Bits, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Gauge32", "ModuleIdentity", "MibIdentifier", "TimeTicks", "Integer32", "IpAddress", "Bits", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64")
...
mibBuilder.exportSymbols("NNCGNI00X6-MIB", nncExtRestartRegisterTable=nncExtRestartRegisterTable, NVMPoolIndex=NVMPoolIndex, nncExtFaultRepetitions=nncExtFaultRepetitions, nncExtCodeSpaceNextActive=nncExtCodeSpaceNextActive, nncExtCodeSpaceDownloadServer=nncExtCodeSpaceDownloadServer, nncExtSysCurrentGeneric=nncExtSysCurrentGeneric, nncExtCodeSpaceStatus=nncExtCodeSpaceStatus, nncExtCodeSpaceDownloadTime=nncExtCodeSpaceDownloadTime, nncExtRestartCause=nncExtRestartCause, nncExtProbeMPLEntry=nncExtProbeMPLEntry, nncExtCodeSpaceTable=nncExtCodeSpaceTable, nncExtNVMLastRepair=nncExtNVMLastRepair, nncExtCodeSpaceSize=nncExtCodeSpaceSize, nncExtCodeSpaceCompressionType=nncExtCodeSpaceCompressionType, nncExtNVMUsageTable=nncExtNVMUsageTable, nncExtNVMPoolBytesUsed=nncExtNVMPoolBytesUsed, nncExtEnvPlus12Status=nncExtEnvPlus12Status, nncExtProbeMPL=nncExtProbeMPL, nncExtCodeSpaceIndex=nncExtCodeSpaceIndex, nncExtRestartRegisterValue=nncExtRestartRegisterValue, nncExtFaultInducedRestarts=nncExtFaultInducedRestarts, nncExtCodeSpaceEntry=nncExtCodeSpaceEntry, nncExtSysProductName=nncExtSysProductName, nncExtRestarts=nncExtRestarts, nncExtEnvFanStatus=nncExtEnvFanStatus, CodeSpaceIndex=CodeSpaceIndex, nncExtCodeSpaceCurrentlyActive=nncExtCodeSpaceCurrentlyActive, RestartCause=RestartCause, nncExtRestartTracebackIndex=nncExtRestartTracebackIndex, nncExtRestartTracebackTable=nncExtRestartTracebackTable, nncDiagUndoAll=nncDiagUndoAll, nncExtEnvTemperatureSensor=nncExtEnvTemperatureSensor, nncExtRestartRegisterIndex=nncExtRestartRegisterIndex, nncExtRestartForceToBoot=nncExtRestartForceToBoot, nncExtRestartRegisterEntry=nncExtRestartRegisterEntry, nncExtCodeSpaceGeneric=nncExtCodeSpaceGeneric, nncExtCodeSpaceNumber=nncExtCodeSpaceNumber, nncExtCodeSpaceDownloadRequestor=nncExtCodeSpaceDownloadRequestor, nncExtRestartTracebackPCValue=nncExtRestartTracebackPCValue, nncExtRestartTracebackEntry=nncExtRestartTracebackEntry, nncExtCodeSpaceLoadSize=nncExtCodeSpaceLoadSize, nncExtNVMPoolIndex=nncExtNVMPoolIndex, nncExtProbeMPLTable=nncExtProbeMPLTable, nncExtNVMPoolSize=nncExtNVMPoolSize, nncExtCodeSpaceDownloadDate=nncExtCodeSpaceDownloadDate, nncExtNVMUsageEntry=nncExtNVMUsageEntry, nncExtLastFault=nncExtLastFault, nncExtEnvMinus12Status=nncExtEnvMinus12Status)
