...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: rlCopy.setRevisionsDescriptions(('Added USB file type.', 'Added objects rlCopyInetDestinationUnitList,rlCopyHistoryInetDestinationUnitList,rlCopyInetUnitStatusList,rlCopyHistoryInetUnitStatusList.', 'Added mirror-config and MIB rlCopyMirrorTimeout.', 'The private MIB module definition for file copy in Dell devices.', 'Added objects rlCopyMessagesTable and rlCopyMessagesTableRemoveEntries.', 'Initial version of this MIB.',))
if mibBuilder.loadTexts: rlCopy.setLastUpdated('201005110000Z')
if mibBuilder.loadTexts: rlCopy.setOrganization('Dell')
if mibBuilder.loadTexts: rlCopy.setContactInfo('www.dell.com')
...
mibBuilder.exportSymbols("Dell-COPY-MIB", rlCopyRowStatus=rlCopyRowStatus, rlCopyInetIndex=rlCopyInetIndex, rlCopyHistoryDestinationLocation=rlCopyHistoryDestinationLocation, rlCopyInetSourceIpAddressType=rlCopyInetSourceIpAddressType, rlCopyInetDestinationIpAddressType=rlCopyInetDestinationIpAddressType, rlCopyHistoryInetSourceUnitNumber=rlCopyHistoryInetSourceUnitNumber, rlCopyMibVersion=rlCopyMibVersion, rlCopyInetRowStatus=rlCopyInetRowStatus, rlCopyHistorySourceFileName=rlCopyHistorySourceFileName, rlCopyHistoryInetBytesTransferred=rlCopyHistoryInetBytesTransferred, rlCopyInetUnitStatusList=rlCopyInetUnitStatusList, rlCopyMessagesCopyIndex=rlCopyMessagesCopyIndex, rlCopyMessagesStatus=rlCopyMessagesStatus, PYSNMP_MODULE_ID=rlCopy, rlCopyInetDestinationLocation=rlCopyInetDestinationLocation, rlCopyHistoryRowStatus=rlCopyHistoryRowStatus, rlCopyHistoryInetDestinationLocation=rlCopyHistoryInetDestinationLocation, rlCopyDestinationFileName=rlCopyDestinationFileName, rlCopyDestinationUnitNumber=rlCopyDestinationUnitNumber, rlCopyInetSourceFileName=rlCopyInetSourceFileName, rlCopyFailed=rlCopyFailed, rlCopyUnitsList=rlCopyUnitsList, rlCopyHistoryInetSourceFileType=rlCopyHistoryInetSourceFileType, rlCopyHistoryHistoryIndex=rlCopyHistoryHistoryIndex, rlCopyHistoryIndex=rlCopyHistoryIndex, rlCopyOptionsRequestedSsdAccess=rlCopyOptionsRequestedSsdAccess, rlCopyHistoryDestinationUnitNumber=rlCopyHistoryDestinationUnitNumber, rlCopyApplicationId=rlCopyApplicationId, rlCopyHistoryInetSourceIpAddressType=rlCopyHistoryInetSourceIpAddressType, rlCopyHistoryEntry=rlCopyHistoryEntry, rlCopyHistoryDestinationFileName=rlCopyHistoryDestinationFileName, rlCopyInetDestinationFileType=rlCopyInetDestinationFileType, rlCopyHistoryInetDestinationUnitList=rlCopyHistoryInetDestinationUnitList, rlCopyIndex=rlCopyIndex, RlCopySecSdAccessType=RlCopySecSdAccessType, rlCopyOptionsTable=rlCopyOptionsTable, rlCopyHistoryInetDestinationIpAddress=rlCopyHistoryInetDestinationIpAddress, rlCopyMessagesMessageText=rlCopyMessagesMessageText, rlCopyHistoryInBackground=rlCopyHistoryInBackground, rlCopy=rlCopy, rlCopySWToUnits=rlCopySWToUnits, rlCopyTable=rlCopyTable, rlCopyInetSpecificCopyInfo=rlCopyInetSpecificCopyInfo, rlCopyOperationState=rlCopyOperationState, rlCopyInetUpTime=rlCopyInetUpTime, rlCopyHistoryBytesTransferred=rlCopyHistoryBytesTransferred, rlCopyHistoryDestinationFileType=rlCopyHistoryDestinationFileType, rlCopyHistoryErrorMessage=rlCopyHistoryErrorMessage, rlCopyMessagesMessageIndex=rlCopyMessagesMessageIndex, rlCopyHistoryInetOperationState=rlCopyHistoryInetOperationState, rlCopyHistoryInetHistoryIndex=rlCopyHistoryInetHistoryIndex, rlCopySourceFileName=rlCopySourceFileName, rlCopyInetDestinationUnitNumber=rlCopyInetDestinationUnitNumber, rlCopyHistoryUpTime=rlCopyHistoryUpTime, rlCopyEntry=rlCopyEntry, rlCopyHistoryInetDestinationFileName=rlCopyHistoryInetDestinationFileName, rlCopyMessagesTable=rlCopyMessagesTable, rlCopyMessagesEntry=rlCopyMessagesEntry, rlCopyInetDestinationUnitList=rlCopyInetDestinationUnitList, rlCopySourceIpAddress=rlCopySourceIpAddress, rlCopyInetInBackground=rlCopyInetInBackground, rlCopyHistoryInetSourceLocation=rlCopyHistoryInetSourceLocation, rlCopyMirrorEnable=rlCopyMirrorEnable, rlCopyStaticDowngradeStatus=rlCopyStaticDowngradeStatus, rlCopyUpTime=rlCopyUpTime, rlCopyHistoryInetApplicationId=rlCopyHistoryInetApplicationId, rlCopyDestinationLocation=rlCopyDestinationLocation, rlCopyInetEntry=rlCopyInetEntry, rlCopyHistoryInetUpTime=rlCopyHistoryInetUpTime, rlCopyHistoryApplicationId=rlCopyHistoryApplicationId, rlCopyInetDestinationFileName=rlCopyInetDestinationFileName, rlCopyHistorySourceLocation=rlCopyHistorySourceLocation, rlCopyInetSourceLocation=rlCopyInetSourceLocation, rlCopyHistoryTable=rlCopyHistoryTable, rlCopyHistoryInetDestinationFileType=rlCopyHistoryInetDestinationFileType, rlCopyInetSourceIpAddress=rlCopyInetSourceIpAddress, rlCopyHistoryInetSourceFileName=rlCopyHistoryInetSourceFileName, rlCopyOptionsEntry=rlCopyOptionsEntry, rlCopyInetTable=rlCopyInetTable, rlCopyMirrorTimeout=rlCopyMirrorTimeout, rlCopyInetBytesTransferred=rlCopyInetBytesTransferred, rlCopySWFinished=rlCopySWFinished, rlCopySourceFileType=rlCopySourceFileType, rlCopyInetOperationState=rlCopyInetOperationState, rlCopyHistorySourceIpAddress=rlCopyHistorySourceIpAddress, rlCopyOptionsIndex=rlCopyOptionsIndex, rlCopyInetHistoryIndex=rlCopyInetHistoryIndex, rlCopyInetApplicationId=rlCopyInetApplicationId, rlCopyInBackground=rlCopyInBackground, rlCopyInetSourceUnitNumber=rlCopyInetSourceUnitNumber, rlCopyHistoryInetInBackground=rlCopyHistoryInetInBackground, rlCopyMirror=rlCopyMirror, rlCopyDestinationFileType=rlCopyDestinationFileType, rlCopyHistoryInetTotalFileSize=rlCopyHistoryInetTotalFileSize, rlCopyHistoryDestinationIpAddress=rlCopyHistoryDestinationIpAddress, rlCopyDestinationIpAddress=rlCopyDestinationIpAddress, rlCopyHistoryInetErrorMessage=rlCopyHistoryInetErrorMessage, rlCopySourceLocation=rlCopySourceLocation, rlCopyInetSourceFileType=rlCopyInetSourceFileType, RlCopyLocationType=RlCopyLocationType, rlCopyHistoryInetTable=rlCopyHistoryInetTable, rlCopyFinished=rlCopyFinished, rlCopyHistorySourceFileType=rlCopyHistorySourceFileType, rlCopyHistoryInetRowStatus=rlCopyHistoryInetRowStatus, rlCopyHistoryInetDestinationUnitNumber=rlCopyHistoryInetDestinationUnitNumber, rlCopySourceUnitNumber=rlCopySourceUnitNumber, rlCopyAuditingEnable=rlCopyAuditingEnable, rlCopyHistoryInetUnitStatusList=rlCopyHistoryInetUnitStatusList, RlCopyFileType=RlCopyFileType, rlCopyMessagesTableRemoveEntries=rlCopyMessagesTableRemoveEntries, rlCopyHistoryInetDestinationIpAddressType=rlCopyHistoryInetDestinationIpAddressType, rlCopyMirrorFileIllegal=rlCopyMirrorFileIllegal, rlCopyHistorySourceUnitNumber=rlCopyHistorySourceUnitNumber, rlCopyFreeHistoryIndex=rlCopyFreeHistoryIndex, rlCopyBytesTransferred=rlCopyBytesTransferred, rlCopyInetDestinationIpAddress=rlCopyInetDestinationIpAddress, rlCopyHistoryOperationState=rlCopyHistoryOperationState, rlCopyHistoryInetEntry=rlCopyHistoryInetEntry, rlCopyHistoryInetSourceIpAddress=rlCopyHistoryInetSourceIpAddress, RlCopyApplicationType=RlCopyApplicationType)
