...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DES3528DC-L2MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:41:07 2019
...
ModuleIdentity, ObjectIdentity, Counter32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Bits, iso, Gauge32, TimeTicks, IpAddress, MibIdentifier, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "Counter32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Bits", "iso", "Gauge32", "TimeTicks", "IpAddress", "MibIdentifier", "Integer32", "NotificationType")
...
des3528dc, = mibBuilder.importSymbols("SW3528PRIMGMT-MIB", "des3528dc")
...
swL2PortInfoErrorDisabled = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 105, 5, 2, 3, 1, 1, 8), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 3, 4))).clone(namedValues=NamedValues(("none", 0), ("storm", 1), ("unknow", 3), ("ctp-lbd", 4)))).setMaxAccess("readonly")
...
swL2PortErrPortReason = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 105, 5, 2, 3, 7, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(2, 3))).clone(namedValues=NamedValues(("storm-control", 2), ("ctp-lbd", 3)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("DES3528DC-L2MGMT-MIB", swL2QOS8021pRadiusPriority=swL2QOS8021pRadiusPriority, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2PortSecurityPortIndex=swL2PortSecurityPortIndex, swL2VlanLoopDetectVID=swL2VlanLoopDetectVID, swL2IGMPQueryState=swL2IGMPQueryState, swL2IGMPMulticastVlanGroupFromIp=swL2IGMPMulticastVlanGroupFromIp, swL2MulticastFilterPortMaxGroup=swL2MulticastFilterPortMaxGroup, swL2DevCtrlCFMPortTable=swL2DevCtrlCFMPortTable, swL2PortCableDiagnosisEntry=swL2PortCableDiagnosisEntry, swL2IGMPMulticastVlanGroupToIp=swL2IGMPMulticastVlanGroupToIp, swL2PortLoopRestart=swL2PortLoopRestart, swL2DevCtrlIpAutoconfig=swL2DevCtrlIpAutoconfig, swL2DevCtrlCFM=swL2DevCtrlCFM, swL2IGMPMulticastVlanGroupVid=swL2IGMPMulticastVlanGroupVid, swL2Notify=swL2Notify, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2IGMPQueryInterval=swL2IGMPQueryInterval, swL2IGMPMaxResponseTime=swL2IGMPMaxResponseTime, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2PortCableDiagnosisPairIndex=swL2PortCableDiagnosisPairIndex, swL2IGMPRouterPortTable=swL2IGMPRouterPortTable, swL2VlanStaticEntry=swL2VlanStaticEntry, swL2TrunkVLANPort=swL2TrunkVLANPort, swL2NniGvrpBpduAddress=swL2NniGvrpBpduAddress, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2PortCounterCtrlTable=swL2PortCounterCtrlTable, swL2TrunkType=swL2TrunkType, swL2TrunkVLANTable=swL2TrunkVLANTable, swL2IGMPSnoopingMulticastVlanState=swL2IGMPSnoopingMulticastVlanState, swL2DhcpRelayCtrlEntry=swL2DhcpRelayCtrlEntry, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2QOSBandwidthPortIndex=swL2QOSBandwidthPortIndex, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2IGMPCtrlState=swL2IGMPCtrlState, swL2DhcpLocalRelayVLANEntry=swL2DhcpLocalRelayVLANEntry, swL2DhcpRelayTimeThreshold=swL2DhcpRelayTimeThreshold, swL2MulticastFilterPortMaxGroupEntry=swL2MulticastFilterPortMaxGroupEntry, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2LoopDetectPortMgmt=swL2LoopDetectPortMgmt, swL2PortCtrlLearningState=swL2PortCtrlLearningState, swL2QOS8021pUserPriorityClass=swL2QOS8021pUserPriorityClass, swL2QOS8021pUserPriorityTable=swL2QOS8021pUserPriorityTable, swL2DhcpRelayOption82State=swL2DhcpRelayOption82State, swL2PortSecurityMode=swL2PortSecurityMode, swL2IGMPMulticastVlanGroupStatus=swL2IGMPMulticastVlanGroupStatus, swL2LoopDetectMgmt=swL2LoopDetectMgmt, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swL2VLANAdvertisement=swL2VLANAdvertisement, swL2macNotificationSeverity=swL2macNotificationSeverity, swL2IGMPVid=swL2IGMPVid, swL2PortCableDiagnosisPairStatus=swL2PortCableDiagnosisPairStatus, swL2PortSecurityDelMacAddress=swL2PortSecurityDelMacAddress, swL2VlanStaticTable=swL2VlanStaticTable, swL2TrunkState=swL2TrunkState, swL2MulticastFilterMode=swL2MulticastFilterMode, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2MulticastFilterPortMaxGroupPortIndex=swL2MulticastFilterPortMaxGroupPortIndex, swL2TrunkMember=swL2TrunkMember, swL2IGMPMulticastVlanRemoveAllMcastAddrListAction=swL2IGMPMulticastVlanRemoveAllMcastAddrListAction, swL2PortInfoMediumType=swL2PortInfoMediumType, swL2IGMPRouterPortVlanName=swL2IGMPRouterPortVlanName, swL2QOSSchedulingEntry=swL2QOSSchedulingEntry, swL2QOS8021pDefaultPriorityIndex=swL2QOS8021pDefaultPriorityIndex, swL2IGMPMulticastVlanState=swL2IGMPMulticastVlanState, swL2QOSBandwidthRadiusRxRate=swL2QOSBandwidthRadiusRxRate, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swL2PortCableDiagnosisPortIndex=swL2PortCableDiagnosisPortIndex, swL2PortErrPortState=swL2PortErrPortState, swL2DhcpRelayOption82Check=swL2DhcpRelayOption82Check, swL2IGMPRouterPortStaticPortList=swL2IGMPRouterPortStaticPortList, swL2MulticastFilterPortMaxGroupTable=swL2MulticastFilterPortMaxGroupTable, swL2DevCtrlCFMPortEntry=swL2DevCtrlCFMPortEntry, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2IGMPInfoTxQueryCount=swL2IGMPInfoTxQueryCount, swL2IGMPInfoTable=swL2IGMPInfoTable, swL2PortSecurityViolationSeverity=swL2PortSecurityViolationSeverity, swL2VlanIndex=swL2VlanIndex, swL2PortSecurityTrapLogState=swL2PortSecurityTrapLogState, swL2PPPoECirIDinsertState=swL2PPPoECirIDinsertState, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2DevCtrlVLANTrunkState=swL2DevCtrlVLANTrunkState, swL2PortCounterCtrlEntry=swL2PortCounterCtrlEntry, swL2IGMPInfoVid=swL2IGMPInfoVid, swL2TrafficSegTable=swL2TrafficSegTable, swL2QOSBandwidthRxRate=swL2QOSBandwidthRxRate, swL2DevCtrlStpState=swL2DevCtrlStpState, swL2LimitedMulticastFilterPortAccess=swL2LimitedMulticastFilterPortAccess, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2DhcpRelayHopCount=swL2DhcpRelayHopCount, swL2IGMPMulticastVlanTable=swL2IGMPMulticastVlanTable, swL2IGMPLeaveTimer=swL2IGMPLeaveTimer, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2PortCtrlTable=swL2PortCtrlTable, swL2DhcpRelayOption82Policy=swL2DhcpRelayOption82Policy, swL2IGMPHostTimeout=swL2IGMPHostTimeout, swL2VlanLoopRestart=swL2VlanLoopRestart, swL2VlanPortInfoPortRole=swL2VlanPortInfoPortRole, swL2TrunkIndex=swL2TrunkIndex, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2PortErrPortConnStatus=swL2PortErrPortConnStatus, swL2QOSSchedulingMaxPkts=swL2QOSSchedulingMaxPkts, swL2VlanPortInfoEntry=swL2VlanPortInfoEntry, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2IGMPLastMemberQueryInterval=swL2IGMPLastMemberQueryInterval, swL2PortInfoTable=swL2PortInfoTable, swL2MgmtMIB=swL2MgmtMIB, swL2macNotifyInfo=swL2macNotifyInfo, swL2MirrorPortState=swL2MirrorPortState, swL2DhcpRelayCtrlTable=swL2DhcpRelayCtrlTable, swL2IGMPMulticastVlanTagMemberPort=swL2IGMPMulticastVlanTagMemberPort, swL2QOS8021pDefaultPriority=swL2QOS8021pDefaultPriority, swL2LimitedMulticastFilterPortIndex=swL2LimitedMulticastFilterPortIndex, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2MulticastFilterProfileAddressTable=swL2MulticastFilterProfileAddressTable, swL2LimitedMulticastFilterPortEntry=swL2LimitedMulticastFilterPortEntry, swL2IGMPPortMap=swL2IGMPPortMap, swL2VlanPortInfoVid=swL2VlanPortInfoVid, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2IGMPInfoQueryCount=swL2IGMPInfoQueryCount, swL2QOSSchedulingMechanism=swL2QOSSchedulingMechanism, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2PortCounterClearCtrl=swL2PortCounterClearCtrl, swL2IGMPRouterPortEntry=swL2IGMPRouterPortEntry, swL2PortSecurityDelPort=swL2PortSecurityDelPort, swL2DhcpRelayCtrlInterfaceName=swL2DhcpRelayCtrlInterfaceName, swL2DevCtrlCFMState=swL2DevCtrlCFMState, swL2PortSecurityControlEntry=swL2PortSecurityControlEntry, swL2LoopDetectCtrl=swL2LoopDetectCtrl, swL2TrafficSegPort=swL2TrafficSegPort, swL2IGMPQueryInfoTable=swL2IGMPQueryInfoTable, swL2LoopDetectPortIndex=swL2LoopDetectPortIndex, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2DhcpLocalRelayVLANState=swL2DhcpLocalRelayVLANState, swL2MulticastFilterModeVlanTable=swL2MulticastFilterModeVlanTable, swL2PPPoEMgmt=swL2PPPoEMgmt, swL2QOS8021pUserPriorityIndex=swL2QOS8021pUserPriorityIndex, swL2IGMPIpGroupReportCount=swL2IGMPIpGroupReportCount, swL2MulticastFilterProfileIndex=swL2MulticastFilterProfileIndex, swL2DevCtrlIGMPSnooping=swL2DevCtrlIGMPSnooping, swL2QOSSchedulingMaxLatency=swL2QOSSchedulingMaxLatency, swL2TrunkVLANEntry=swL2TrunkVLANEntry, swL2DhcpLocalRelayVLANID=swL2DhcpLocalRelayVLANID, swL2QOSMgmt=swL2QOSMgmt, swL2PortInfoType=swL2PortInfoType, swL2PortErrPortIndex=swL2PortErrPortIndex, swL2IGMPRouterPortDynamicPortList=swL2IGMPRouterPortDynamicPortList, swL2LoopDetectPortState=swL2LoopDetectPortState, swL2MulticastFilterProfileIdIndex=swL2MulticastFilterProfileIdIndex, swL2MirrorMgmt=swL2MirrorMgmt, swL2DevCtrlSnmpTrapState=swL2DevCtrlSnmpTrapState, swL2VLANMgmt=swL2VLANMgmt, swL2IGMPMulticastVlanGroupEntry=swL2IGMPMulticastVlanGroupEntry, swL2LoopDetectPortTable=swL2LoopDetectPortTable, swL2MulticastFilterAddressState=swL2MulticastFilterAddressState, swL2DevCtrlIGMPSnoopingMcstRTOnly=swL2DevCtrlIGMPSnoopingMcstRTOnly, swL2MulticastFilterModeVlanEntry=swL2MulticastFilterModeVlanEntry, swL2MulticastFilterToIp=swL2MulticastFilterToIp, swL2IGMPRouteTimeout=swL2IGMPRouteTimeout, swL2LoopDetectTrapMode=swL2LoopDetectTrapMode, swL2IGMPMulticastVlanReplaceSourceIp=swL2IGMPMulticastVlanReplaceSourceIp, swL2DhcpRelayMgmt=swL2DhcpRelayMgmt, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2LoopDetectPortLoopStatus=swL2LoopDetectPortLoopStatus, swL2IGMPMulticastVlanEntry=swL2IGMPMulticastVlanEntry, swL2DhcpLocalRelayMgmt=swL2DhcpLocalRelayMgmt, swL2DevAlarm=swL2DevAlarm, swL2PortInfoErrorDisabled=swL2PortInfoErrorDisabled, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2PortSecurityAdmState=swL2PortSecurityAdmState, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2PortCtrlJumboFrameMaxSize=swL2PortCtrlJumboFrameMaxSize, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2IGMPInfoEntry=swL2IGMPInfoEntry, swL2LoopDetectPortLoopVLAN=swL2LoopDetectPortLoopVLAN, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2DevCtrl=swL2DevCtrl, swL2QOSSchedulingClassIndex=swL2QOSSchedulingClassIndex, swL2LimitedMulticastFilterPortProfileID=swL2LimitedMulticastFilterPortProfileID, swL2PortCableDiagnosisPairLength=swL2PortCableDiagnosisPairLength, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2MulticastFilterVid=swL2MulticastFilterVid, swL2PortLoopOccurred=swL2PortLoopOccurred, swL2QOSBandwidthControlTable=swL2QOSBandwidthControlTable, swL2DhcpRelayCtrlState=swL2DhcpRelayCtrlState, swL2IGMPMaxSupportedVlans=swL2IGMPMaxSupportedVlans, swL2TrunkMgmt=swL2TrunkMgmt, swL2LimitedMulticastFilterPortProfileStatus=swL2LimitedMulticastFilterPortProfileStatus, swL2MACNotifyState=swL2MACNotifyState, swL2IGMPRobustness=swL2IGMPRobustness, swL2IGMPGroupIpAddr=swL2IGMPGroupIpAddr, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2QOSBandwidthRadiusTxRate=swL2QOSBandwidthRadiusTxRate, swL2PVIDAutoAssignmentState=swL2PVIDAutoAssignmentState, swL2PortCableDiagnosisPairLengthInaccuracy=swL2PortCableDiagnosisPairLengthInaccuracy, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2LoopDetectAdminState=swL2LoopDetectAdminState, swL2PortInfoUnitID=swL2PortInfoUnitID, swL2VlanLoopOccurred=swL2VlanLoopOccurred, swL2QOS8021pDefaultPriorityTable=swL2QOS8021pDefaultPriorityTable, swL2QOSHolPreventionCtrl=swL2QOSHolPreventionCtrl, swL2macNotification=swL2macNotification, swL2PortSecurityEntryClearCtrl=swL2PortSecurityEntryClearCtrl, swL2IGMPCurrentState=swL2IGMPCurrentState, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2PortCableDiagnosisCableStatus=swL2PortCableDiagnosisCableStatus, swL2PortErrPortReason=swL2PortErrPortReason, swL2MulticastFilterProfileName=swL2MulticastFilterProfileName, swL2QOSBandwidthControlEntry=swL2QOSBandwidthControlEntry, swL2DhcpRelayCtrlServer=swL2DhcpRelayCtrlServer, swL2LoopDetectMode=swL2LoopDetectMode, swL2PortSecurityMaxLernAddr=swL2PortSecurityMaxLernAddr, swL2DhcpLocalRelayState=swL2DhcpLocalRelayState, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2IGMPMulticastVlanRowStatus=swL2IGMPMulticastVlanRowStatus, swL2DhcpLocalRelayVLANTable=swL2DhcpLocalRelayVLANTable, swL2DevMgmt=swL2DevMgmt, swL2PortInfoEntry=swL2PortInfoEntry, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2QOSSchedulingTable=swL2QOSSchedulingTable, swDevInfoFrontPanelLedStatus=swDevInfoFrontPanelLedStatus, swL2NotifFirmware=swL2NotifFirmware, swL2IGMPCtrlTable=swL2IGMPCtrlTable, swL2PortCtrlMediumType=swL2PortCtrlMediumType, swL2IGMPFastLeaveState=swL2IGMPFastLeaveState, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2PortMgmt=swL2PortMgmt, swL2PortCtrlMDIXState=swL2PortCtrlMDIXState, swL2IGMPRouterPortVlanid=swL2IGMPRouterPortVlanid, swL2PortCableDiagnosisTable=swL2PortCableDiagnosisTable, swL2PortSecurityDelVlanName=swL2PortSecurityDelVlanName, swL2MulticastFilterVlanMode=swL2MulticastFilterVlanMode, swL2DevCtrlAsymVlanState=swL2DevCtrlAsymVlanState, swL2DhcpRelayState=swL2DhcpRelayState, swL2PortCtrlAdminState=swL2PortCtrlAdminState, VlanId=VlanId, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2LimitedMulticastFilterPortTable=swL2LimitedMulticastFilterPortTable, swL2VlanPortInfoTable=swL2VlanPortInfoTable, swL2PortSecurityDelCtrl=swL2PortSecurityDelCtrl, swL2IGMPCtrlVid=swL2IGMPCtrlVid, swL2IGMPMulticastVlanGroupTable=swL2IGMPMulticastVlanGroupTable, swL2LimitedMulticastMgmt=swL2LimitedMulticastMgmt, swL2VlanPortInfoPortIndex=swL2VlanPortInfoPortIndex, swL2MulticastFilterProfileTable=swL2MulticastFilterProfileTable, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swL2IGMPQueryInfoEntry=swL2IGMPQueryInfoEntry)
mibBuilder.exportSymbols("DES3528DC-L2MGMT-MIB", swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2IGMPMulticastVlanName=swL2IGMPMulticastVlanName, swL2IGMPMgmt=swL2IGMPMgmt, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2PortCounterCtrlPortIndex=swL2PortCounterCtrlPortIndex, swL2PortSecurityControlTable=swL2PortSecurityControlTable, swL2IGMPCtrlEntry=swL2IGMPCtrlEntry, swL2IGMPMulticastVlanMemberPort=swL2IGMPMulticastVlanMemberPort, swL2LoopDetectRecoverTime=swL2LoopDetectRecoverTime, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2DevInfo=swL2DevInfo, swL2QOS8021pDefaultPriorityEntry=swL2QOS8021pDefaultPriorityEntry, swL2QOS8021pUserPriorityEntry=swL2QOS8021pUserPriorityEntry, swL2MulticastFilterProfileEntry=swL2MulticastFilterProfileEntry, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2QOSBandwidthTxRate=swL2QOSBandwidthTxRate, swL2MulticastFilterFromIp=swL2MulticastFilterFromIp, MacAddress=MacAddress, swL2DevCtrlCFMPortState=swL2DevCtrlCFMPortState, swL2IGMPMulticastVlanSourcePort=swL2IGMPMulticastVlanSourcePort, PortList=PortList, swL2IGMPRouterPortForbiddenPortList=swL2IGMPRouterPortForbiddenPortList, swL2PortSecurityMgmt=swL2PortSecurityMgmt, swL2LoopDetectInterval=swL2LoopDetectInterval, swl2NotificationBidings=swl2NotificationBidings, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2PortErrTable=swL2PortErrTable, swL2PortSecurityDelActivity=swL2PortSecurityDelActivity, swL2MulticastFilterStatus=swL2MulticastFilterStatus, swL2IGMPMulticastVlanid=swL2IGMPMulticastVlanid, swL2IGMPMacAddr=swL2IGMPMacAddr, swL2NotifyMgmt=swL2NotifyMgmt, swL2LoopDetectPortEntry=swL2LoopDetectPortEntry, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2QOSSchedulingMechanismCtrl=swL2QOSSchedulingMechanismCtrl, swL2IGMPMaxIpGroupNumPerVlan=swL2IGMPMaxIpGroupNumPerVlan, swL2TrunkVLANState=swL2TrunkVLANState, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2NotifyPrefix=swL2NotifyPrefix, swL2DevCtrlCFMPortIndex=swL2DevCtrlCFMPortIndex, swL2MulticastFilterProfileAddressEntry=swL2MulticastFilterProfileAddressEntry, swL2PortErrEntry=swL2PortErrEntry)
