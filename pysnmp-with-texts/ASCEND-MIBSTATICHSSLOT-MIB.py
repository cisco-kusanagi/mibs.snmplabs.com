...
# Produced by pysmi-0.3.4 at Wed May  1 11:28:29 2019
...
Gauge32, ModuleIdentity, Counter32, Unsigned32, NotificationType, IpAddress, TimeTicks, Integer32, Bits, iso, Counter64, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ModuleIdentity", "Counter32", "Unsigned32", "NotificationType", "IpAddress", "TimeTicks", "Integer32", "Bits", "iso", "Counter64", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity")
...
if mibBuilder.loadTexts: mibmibProfHighSpeedSlotStaticTable.setDescription('A list of mibmibProfHighSpeedSlotStatic profile entries.')
...
if mibBuilder.loadTexts: mibmibProfHighSpeedSlotStaticEntry.setDescription('A mibmibProfHighSpeedSlotStatic entry containing objects that maps to the parameters of mibmibProfHighSpeedSlotStatic profile.')
...
if mibBuilder.loadTexts: mibProfHighSpeedSlotStatic_Shelf_o.setDescription('')
...
if mibBuilder.loadTexts: mibProfHighSpeedSlotStatic_Slot_o.setDescription('')
...
if mibBuilder.loadTexts: mibProfHighSpeedSlotStatic_Item_o.setDescription('')
...
if mibBuilder.loadTexts: mibProfHighSpeedSlotStatic_Name.setDescription('For future use. The current design does not use this name attribute but instead references a LIM or CM slot by its profile index; we may in the future support referencing a LIM or CM slot by its name as well as by its physical address. This name attribute consists of a null-terminated ASCII string; is read-only; and defaults to the ASCII form of this LIM or CM slot physical address.')
...
if mibBuilder.loadTexts: mibProfHighSpeedSlotStatic_PhysicalAddress_Shelf.setDescription('The number of the shelf that the addressed physical device resides on.')
...
if mibBuilder.loadTexts: mibProfHighSpeedSlotStatic_PhysicalAddress_Slot.setDescription('The number of the slot that the addressed physical device resides on.')
...
if mibBuilder.loadTexts: mibProfHighSpeedSlotStatic_PhysicalAddress_ItemNumber.setDescription('A number that specifies an addressable entity within the context of shelf and slot.')
...
if mibBuilder.loadTexts: mibProfHighSpeedSlotStatic_TrunkCacConfig_Enable.setDescription('Enable or Disable CAC on this port. yes: CAC is enable on this port. no: CAC is disable on this port')
...
if mibBuilder.loadTexts: mibProfHighSpeedSlotStatic_TrunkCacConfig_PortNum.setDescription('Identifies this trunk port within the system. It is a read only field.')
...
if mibBuilder.loadTexts: mibProfHighSpeedSlotStatic_TrunkCacConfig_LineRate.setDescription('Line rate of the trunk port in Kbits/sec. The trunk port can have real-time (guaranteed) traffic bandwidth up to this limit. In case of over subscription, there is no guarantee.')
...
if mibBuilder.loadTexts: mibProfHighSpeedSlotStatic_TrunkCacConfig_OverSubscription.setDescription('Allowed to specify over subscription to the line rate to a factor of over-subscription/10. e.g Allowed BW = (over-subscription * line-rate) /10')
...
if mibBuilder.loadTexts: mibProfHighSpeedSlotStatic_Action_o.setDescription('')
mibBuilder.exportSymbols("ASCEND-MIBSTATICHSSLOT-MIB", mibProfHighSpeedSlotStatic_PhysicalAddress_Shelf=mibProfHighSpeedSlotStatic_PhysicalAddress_Shelf, mibProfHighSpeedSlotStatic_TrunkCacConfig_LineRate=mibProfHighSpeedSlotStatic_TrunkCacConfig_LineRate, mibProfHighSpeedSlotStatic_PhysicalAddress_Slot=mibProfHighSpeedSlotStatic_PhysicalAddress_Slot, mibProfHighSpeedSlotStatic_TrunkCacConfig_Enable=mibProfHighSpeedSlotStatic_TrunkCacConfig_Enable, DisplayString=DisplayString, mibProfHighSpeedSlotStatic_Shelf_o=mibProfHighSpeedSlotStatic_Shelf_o, mibProfHighSpeedSlotStatic_PhysicalAddress_ItemNumber=mibProfHighSpeedSlotStatic_PhysicalAddress_ItemNumber, mibProfHighSpeedSlotStatic_TrunkCacConfig_PortNum=mibProfHighSpeedSlotStatic_TrunkCacConfig_PortNum, mibmibProfHighSpeedSlotStaticEntry=mibmibProfHighSpeedSlotStaticEntry, mibmibProfHighSpeedSlotStaticTable=mibmibProfHighSpeedSlotStaticTable, mibProfHighSpeedSlotStatic_Item_o=mibProfHighSpeedSlotStatic_Item_o, mibProfHighSpeedSlotStatic_Name=mibProfHighSpeedSlotStatic_Name, mibmibProfHighSpeedSlotStatic=mibmibProfHighSpeedSlotStatic, mibProfHighSpeedSlotStatic_TrunkCacConfig_OverSubscription=mibProfHighSpeedSlotStatic_TrunkCacConfig_OverSubscription, mibProfHighSpeedSlotStatic_AtmParameters_IncomingPriority=mibProfHighSpeedSlotStatic_AtmParameters_IncomingPriority, mibProfHighSpeedSlotStatic_Slot_o=mibProfHighSpeedSlotStatic_Slot_o, mibProfHighSpeedSlotStatic_Action_o=mibProfHighSpeedSlotStatic_Action_o)
