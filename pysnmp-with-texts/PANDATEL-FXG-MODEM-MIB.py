...
# Produced by pysmi-0.3.4 at Wed May  1 14:37:21 2019
...
Bits, ObjectIdentity, IpAddress, Counter64, iso, Integer32, NotificationType, enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, MibIdentifier, TimeTicks, ModuleIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ObjectIdentity", "IpAddress", "Counter64", "iso", "Integer32", "NotificationType", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "MibIdentifier", "TimeTicks", "ModuleIdentity", "Counter32")
...
if mibBuilder.loadTexts: fxgModemTable.setDescription('The table of all FX-G modems in this housing.')
...
if mibBuilder.loadTexts: fxgTableEntry.setDescription('The index of the table.')
...
if mibBuilder.loadTexts: mdmOperationMode.setDescription("The possibility of operation mode: 'converter mode' or 'modem mode'.")
...
mibBuilder.exportSymbols("PANDATEL-FXG-MODEM-MIB", mdmAlarm=mdmAlarm, fxg=fxg, mdmModemName=mdmModemName, fxgTableEntry=fxgTableEntry, mdmModem=mdmModem, mdmPosition=mdmPosition, mdmClockRecovery=mdmClockRecovery, fxg_modem=fxg_modem, mdmOperationMode=mdmOperationMode, mdmRack=mdmRack, fxgModemTable=fxgModemTable, mdmForcedRemoteAccess=mdmForcedRemoteAccess, mdmInterfaceAlarmCondition=mdmInterfaceAlarmCondition, mdmLineAlarmCondition=mdmLineAlarmCondition, mdmRemoteAccessMode=mdmRemoteAccessMode)
