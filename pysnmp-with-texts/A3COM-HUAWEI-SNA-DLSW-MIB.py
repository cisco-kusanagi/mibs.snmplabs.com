...
# Produced by pysmi-0.3.4 at Wed May  1 11:07:03 2019
...
Unsigned32, Counter64, MibIdentifier, Bits, Integer32, TimeTicks, Counter32, ModuleIdentity, NotificationType, iso, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "MibIdentifier", "Bits", "Integer32", "TimeTicks", "Counter32", "ModuleIdentity", "NotificationType", "iso", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity")
...
class CreateLineFlag(TextualConvention, Integer32):
    description = "The 'DeleteLine' value means deleting a conceptual row object. The 'createLine' value means adding a conceptual row object."
    status = 'current'
...
if mibBuilder.loadTexts: dlswRemotePeerNumOfTcpSessions.setDescription('Number of TCP sessionss. ')
...
if mibBuilder.loadTexts: dlswRemotePeerSetStateToConfig.setDescription("When the value is set 'yes' from 'no', dlswRemotePeerIsConfig will change from 'no' to 'yes'.")
...
if mibBuilder.loadTexts: dlswBridgeStatus.setDescription("The 'DeleteLine' value means deleting a conceptual row object. The 'createLine' value means adding a conceptual row object.")
...
if mibBuilder.loadTexts: dlswBridgeIfStatus.setDescription(" This value whitch is equal to 'invalid' identifies to delete a conceptual row ")
...
if mibBuilder.loadTexts: dlswLocMacEntry.setDescription('Information of table')
...
if mibBuilder.loadTexts: dlswSdlcPortEntry.setDescription('Information of table')
...
if mibBuilder.loadTexts: dlswSdlcPortNrziEncoding.setDescription('Set line code to nrzi encoding mode. ')
...
if mibBuilder.loadTexts: dlswSdlcPortIdleMarkEnable.setDescription('Idle in mark mode. ')
...
if mibBuilder.loadTexts: dlswSdlcLsEntry.setDescription('Information of table')
...
if mibBuilder.loadTexts: dlswLlc2PortEntry.setDescription('Information of table')
...
if mibBuilder.loadTexts: dlswTrapTConnPartnerReject.setDescription('This trap is sent each time a transport connection is rejected by a partner DLSw during Capabilities Exchanges. The emission of this trap is controlled by dlswTrapCntlState.')
...
if mibBuilder.loadTexts: dlswTrapTConnChangeState.setDescription('This trap is sent each time a transport connection changes state. The emission of this trap is controlled by dlswTrapCntlState.')
...
if mibBuilder.loadTexts: dlswTrapCircuitChangeState.setDescription('This trap is sent each time a circuit change state. The emission of this trap is controlled by dlswTrapCntlState.')
mibBuilder.exportSymbols("A3COM-HUAWEI-SNA-DLSW-MIB", dlswSdlcLsRemoteMac=dlswSdlcLsRemoteMac, dlswNodeVendorID=dlswNodeVendorID, dlswLocDirectory=dlswLocDirectory, dlswNodeVersion=dlswNodeVersion, dlswLLC2PortT1=dlswLLC2PortT1, dlswSdlcPortIdleMarkEnable=dlswSdlcPortIdleMarkEnable, dlswCircuitS1IfIndex=dlswCircuitS1IfIndex, dlswRemotePeerCost=dlswRemotePeerCost, dlswCircuitS2Sap=dlswCircuitS2Sap, dlswLLC2PortN2=dlswLLC2PortN2, dlswCircuitS1DlcType=dlswCircuitS1DlcType, dlswRemotePeerLinger=dlswRemotePeerLinger, dlswBridgeEntry=dlswBridgeEntry, dlswLocMacHashIndex=dlswLocMacHashIndex, dlswSdlcPortEntry=dlswSdlcPortEntry, dlswSdlcLsLocalId=dlswSdlcLsLocalId, DlcType=DlcType, dlswBridgeIfEntry=dlswBridgeIfEntry, dlswLocMacMac=dlswLocMacMac, dlswNodePermitDynamic=dlswNodePermitDynamic, dlswCircuitS2CircuitId=dlswCircuitS2CircuitId, dlswLLC2PortAckDelayTime=dlswLLC2PortAckDelayTime, dlswSdlcLsTable=dlswSdlcLsTable, dlswNodeLocalAddr=dlswNodeLocalAddr, dlswRemotePeerEntryStatus=dlswRemotePeerEntryStatus, dlswRemotePeerIsConfig=dlswRemotePeerIsConfig, dlswCircuitS2Location=dlswCircuitS2Location, dlswNodeMaxWindow=dlswNodeMaxWindow, dlswBridgeNum=dlswBridgeNum, dlswNodeStatus=dlswNodeStatus, dlswLLC2PortAckMax=dlswLLC2PortAckMax, dlswNodeLocalPendTimeout=dlswNodeLocalPendTimeout, dlswRemotePeerRecvPacks=dlswRemotePeerRecvPacks, dlswRemotePeerBackupAddr=dlswRemotePeerBackupAddr, dlswCircuitFCSendGrantedUnits=dlswCircuitFCSendGrantedUnits, dlswLLC2PortTbusyTime=dlswLLC2PortTbusyTime, dlswSdlcPortPollPauseTimer=dlswSdlcPortPollPauseTimer, dlswCircuitFCLargestSendGranted=dlswCircuitFCLargestSendGranted, dlswNodeConnTimeout=dlswNodeConnTimeout, dlswRemotePeerPaceWindInit=dlswRemotePeerPaceWindInit, dlswTrapTConnChangeState=dlswTrapTConnChangeState, dlswRemotePeerVersionString=dlswRemotePeerVersionString, dlswSdlcPortT1=dlswSdlcPortT1, dlswNodeUpTime=dlswNodeUpTime, dlswSdlcLsDsap=dlswSdlcLsDsap, dlswCircuitS2Mac=dlswCircuitS2Mac, dlswBridgeIfBriGru=dlswBridgeIfBriGru, PYSNMP_MODULE_ID=dlsw, dlswLLC2PortTxqMax=dlswLLC2PortTxqMax, dlswSdlcPortModule=dlswSdlcPortModule, dlswSdlcLsEntry=dlswSdlcLsEntry, dlsw=dlsw, dlswLocMacHashIndexSeqNum=dlswLocMacHashIndexSeqNum, dlswCircuitFCRecvGrantedUnits=dlswCircuitFCRecvGrantedUnits, dlswBridgeIfStatus=dlswBridgeIfStatus, dlswLocMacLocalInterfaceName=dlswLocMacLocalInterfaceName, dlswRemotePeerHaveBackup=dlswRemotePeerHaveBackup, dlswSdlcLsSsap=dlswSdlcLsSsap, dlswCircuit=dlswCircuit, dlswLlc2=dlswLlc2, dlswLocMacEntry=dlswLocMacEntry, dlswLLC2PortModulus=dlswLLC2PortModulus, dlswRemotePeerEntry=dlswRemotePeerEntry, dlswLLC2PortTpfTime=dlswLLC2PortTpfTime, dlswSdlcPortTable=dlswSdlcPortTable, dlswTrapTConnPartnerReject=dlswTrapTConnPartnerReject, dlswCircuitFCSendCurrentWndw=dlswCircuitFCSendCurrentWndw, dlswCircuitTable=dlswCircuitTable, dlswBridgeTable=dlswBridgeTable, dlswSdlcPortK=dlswSdlcPortK, dlswSdlcPortNrziEncoding=dlswSdlcPortNrziEncoding, dlswRemotePeerDrops=dlswRemotePeerDrops, dlswCircuitS2TAddress=dlswCircuitS2TAddress, dlswRemotePeerIsBackup=dlswRemotePeerIsBackup, dlswRemotePeerNumOfTcpSessions=dlswRemotePeerNumOfTcpSessions, dlswNodeVirtualSegmentLFSize=dlswNodeVirtualSegmentLFSize, dlswTConn=dlswTConn, dlswCircuitFCRecvCurrentWndw=dlswCircuitFCRecvCurrentWndw, dlswSdlcPortVmac=dlswSdlcPortVmac, dlswSdlcPortSimultaneousEnable=dlswSdlcPortSimultaneousEnable, dlswLLC2PortLocalWnd=dlswLLC2PortLocalWnd, dlswSdlcPortN1=dlswSdlcPortN1, dlswLlc2PortEntry=dlswLlc2PortEntry, dlswBridgeGroup=dlswBridgeGroup, EntryStatus=EntryStatus, dlswRemotePeerSetStateToConfig=dlswRemotePeerSetStateToConfig, LFSize=LFSize, dlswRemotePeerSendPacks=dlswRemotePeerSendPacks, dlswNode=dlswNode, dlswSdlcPortT2=dlswSdlcPortT2, dlswTrapsV2=dlswTrapsV2, dlswCircuitEntry=dlswCircuitEntry, dlswBridgeStatus=dlswBridgeStatus, dlswBridgeIfTable=dlswBridgeIfTable, dlswCircuitPriority=dlswCircuitPriority, dlswSdlc=dlswSdlc, dlswCircuitEntryTime=dlswCircuitEntryTime, dlswBridgeIfName=dlswBridgeIfName, dlswSdlcPortN2=dlswSdlcPortN2, dlswRemotePeerKeepAlive=dlswRemotePeerKeepAlive, dlswCircuitS1Ifname=dlswCircuitS1Ifname, dlswLlc2PortTable=dlswLlc2PortTable, dlswRemotePeerLf=dlswRemotePeerLf, dlswCircuitOrigin=dlswCircuitOrigin, dlswSdlcPortSerialName=dlswSdlcPortSerialName, MacAddressNC=MacAddressNC, EndStationLocation=EndStationLocation, dlswRemotePeerLinkState=dlswRemotePeerLinkState, dlswCircuitS1Sap=dlswCircuitS1Sap, dlswNodePriority=dlswNodePriority, dlswSdlcPortEncap=dlswSdlcPortEncap, dlswRemotePeerTable=dlswRemotePeerTable, dlswTrapControl=dlswTrapControl, dlswNodeVersionString=dlswNodeVersionString, dlswRemotePeerVersion=dlswRemotePeerVersion, dlswSdlcPortHoldq=dlswSdlcPortHoldq, dlswNodeStdPacingSupport=dlswNodeStdPacingSupport, dlswTrapCntlState=dlswTrapCntlState, dlswRemotePeerTcpQueneMax=dlswRemotePeerTcpQueneMax, dlswCircuitStateTime=dlswCircuitStateTime, dlswTraps=dlswTraps, dlswCircuitS1CircuitId=dlswCircuitS1CircuitId, dlswNodeRemotePendTimeout=dlswNodeRemotePendTimeout, dlswSdlcLsAddress=dlswSdlcLsAddress, dlswCircuitFCLargestRecvGranted=dlswCircuitFCLargestRecvGranted, dlswLocMacTable=dlswLocMacTable, dlswNodeInitWindow=dlswNodeInitWindow, dlswSdlcLsStatus=dlswSdlcLsStatus, dlswLLC2PortTrejTime=dlswLLC2PortTrejTime, dlswNodeKeepAlive=dlswNodeKeepAlive, CreateLineFlag=CreateLineFlag, dlswNodeSnaCacheTimeout=dlswNodeSnaCacheTimeout, dlswRemotePeerVendorID=dlswRemotePeerVendorID, dlswCircuitState=dlswCircuitState, dlswCircuitS1Mac=dlswCircuitS1Mac, dlswSdlcPortRole=dlswSdlcPortRole, dlswRemotePeerUptime=dlswRemotePeerUptime, dlswTrapCircuitChangeState=dlswTrapCircuitChangeState, dlswRemotePeerAddr=dlswRemotePeerAddr)
