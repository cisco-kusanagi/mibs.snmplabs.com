...
# Produced by pysmi-0.3.4 at Wed May  1 15:08:55 2019
...
Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, TimeTicks, Opaque, MibIdentifier, Counter64, Counter32, Integer32, NotificationType, ModuleIdentity, Gauge32, enterprises, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "TimeTicks", "Opaque", "MibIdentifier", "Counter64", "Counter32", "Integer32", "NotificationType", "ModuleIdentity", "Gauge32", "enterprises", "Unsigned32")
...
if mibBuilder.loadTexts: signal1Contact8Alarm.setDescription('Check the text of message')
signal1Contact8Ok = NotificationType((1, 3, 6, 1, 4, 1, 40418, 2, 4, 0, 3))
if mibBuilder.loadTexts: signal1Contact8Ok.setStatus('current')
if mibBuilder.loadTexts: signal1Contact8Ok.setDescription('Check the text of message')
...
if mibBuilder.loadTexts: signal2Contact9Alarm.setDescription('Check the text of message')
signal2Contact9Ok = NotificationType((1, 3, 6, 1, 4, 1, 40418, 2, 4, 0, 5))
if mibBuilder.loadTexts: signal2Contact9Ok.setStatus('current')
if mibBuilder.loadTexts: signal2Contact9Ok.setDescription('Check the text of message')
...
if mibBuilder.loadTexts: anySensorSignal1contact5Alarm.setDescription('Check the text of message')
...
if mibBuilder.loadTexts: anySensorSignal1contact5Ok.setDescription('Check the text of message')
...
if mibBuilder.loadTexts: anySensorSignal2contact6Alarm.setDescription('Check the text of message')
...
if mibBuilder.loadTexts: anySensorSignal2contact6Ok.setDescription('Check the text of message')
...
if mibBuilder.loadTexts: anySensorSignal3contact7Alarm.setDescription('Check the text of message')
...
if mibBuilder.loadTexts: anySensorSignal3contact7Ok.setDescription('Check the text of message')
...
if mibBuilder.loadTexts: remoteControlContact11On.setDescription('Check the text of message')
...
if mibBuilder.loadTexts: remoteControlContact11Off.setDescription('Check the text of message')
...
if mibBuilder.loadTexts: resetedSmartContact10.setDescription('Check the text of message')
...
if mibBuilder.loadTexts: upsUtilityFail.setDescription('Check the text of message')
upsUtilityOk = NotificationType((1, 3, 6, 1, 4, 1, 40418, 2, 4, 0, 31))
if mibBuilder.loadTexts: upsUtilityOk.setStatus('current')
if mibBuilder.loadTexts: upsUtilityOk.setDescription('Check the text of message')
...
if mibBuilder.loadTexts: erd3sTrapGroup.setDescription(' ')
...
if mibBuilder.loadTexts: resetSmartContact10.setDescription('qwerty')
...
if mibBuilder.loadTexts: remoteControlContact11.setDescription('qwerty')
...
if mibBuilder.loadTexts: monitorAlarmSignal1Contact8.setDescription('qwerty')
...
if mibBuilder.loadTexts: monitorAlarmSignal2Contact9.setDescription('qwerty')
...
if mibBuilder.loadTexts: monitorAnySensorSignal1contact5.setDescription('qwerty')
...
if mibBuilder.loadTexts: monitorAnySensorSignal2contact6.setDescription('qwerty')
...
if mibBuilder.loadTexts: monitorAnySensorSignal3contact7.setDescription('qwerty')
...
if mibBuilder.loadTexts: voltageSensorContact12.setDescription('qwerty')
...
if mibBuilder.loadTexts: batteryVoltage.setDescription('qwerty')
...
if mibBuilder.loadTexts: upsTemperature.setDescription('qwerty')
...
if mibBuilder.loadTexts: inputVoltage.setDescription('qwerty')
...
if mibBuilder.loadTexts: outputVoltage.setDescription('qwerty')
...
if mibBuilder.loadTexts: upsLoading.setDescription('qwerty')
...
if mibBuilder.loadTexts: upsStatus.setDescription('qwerty')
mibBuilder.exportSymbols("SNR-ERD-3s", commS=commS, userSense2Name=userSense2Name, voltageSensorContact12=voltageSensorContact12, sensesSet2=sensesSet2, upsStatus=upsStatus, ipForTrap=ipForTrap, temperatureSensorAlarm=temperatureSensorAlarm, ipGatewayAddress=ipGatewayAddress, temperatureSensorRelease=temperatureSensorRelease, remoteControlContact11=remoteControlContact11, monitorVoltageSignal2=monitorVoltageSignal2, signal2Contact9Ok=signal2Contact9Ok, temperatureSensorOutAlarm=temperatureSensorOutAlarm, erd3sTraps=erd3sTraps, trapMode=trapMode, voltageSignal1Alarm=voltageSignal1Alarm, signal1Contact8Alarm=signal1Contact8Alarm, temperatureSensorOutOk=temperatureSensorOutOk, userSense3Name=userSense3Name, voltageSignal2Alarm=voltageSignal2Alarm, snr_erd=snr_erd, temperatureSensorOutSerial4=temperatureSensorOutSerial4, voltageSignal1Ok=voltageSignal1Ok, resetsSet=resetsSet, Float=Float, monitorAnySensorSignal3contact7=monitorAnySensorSignal3contact7, snr=snr, voltageOk=voltageOk, temperatureSensorOutFail=temperatureSensorOutFail, temperatureSensorOut5=temperatureSensorOut5, anySensorSignal1contact5Ok=anySensorSignal1contact5Ok, temperatureSensorOut4=temperatureSensorOut4, monitorAlarmSignal2Contact9=monitorAlarmSignal2Contact9, inputVoltage=inputVoltage, remoteControlContact11On=remoteControlContact11On, voltageAlarm=voltageAlarm, temperatureSensorOut1=temperatureSensorOut1, monitorAnySensorSignal2contact6=monitorAnySensorSignal2contact6, resetedSmartContact10=resetedSmartContact10, temperatureSensorOutSerial3=temperatureSensorOutSerial3, signal1Contact8Ok=signal1Contact8Ok, upsUtilityFail=upsUtilityFail, outputVoltage=outputVoltage, temperatureSensorOutSerial2=temperatureSensorOutSerial2, anySensorSignal2contact6Alarm=anySensorSignal2contact6Alarm, anySensorSignal3contact7Alarm=anySensorSignal3contact7Alarm, temperatureSensorOutRelease=temperatureSensorOutRelease, monitorAlarmSignal1Contact8=monitorAlarmSignal1Contact8, ipAddress=ipAddress, signal2Contact9Alarm=signal2Contact9Alarm, ipAddressEntry=ipAddressEntry, sensesSet1=sensesSet1, temperatureSensorOut2=temperatureSensorOut2, numberOfResetPositives=numberOfResetPositives, remoteControlContact11Off=remoteControlContact11Off, numberOfAlarmPositives=numberOfAlarmPositives, alarmSense2Name=alarmSense2Name, monitorAnySensorSignal1contact5=monitorAnySensorSignal1contact5, resetSmartContact10=resetSmartContact10, anySensorSignal2contact6Ok=anySensorSignal2contact6Ok, voltageSignal2Ok=voltageSignal2Ok, ipMonitoringDevice=ipMonitoringDevice, anySensorSignal3contact7Ok=anySensorSignal3contact7Ok, temperatureSensorOutSerial5=temperatureSensorOutSerial5, snr_erd_3s=snr_erd_3s, dataType=dataType, sysVoltageAlarm=sysVoltageAlarm, monitorVoltageSignal1=monitorVoltageSignal1, PYSNMP_MODULE_ID=snr, temperatureSensorsOut=temperatureSensorsOut, temperatureSensorOut3=temperatureSensorOut3, anySensorSignal1contact5Alarm=anySensorSignal1contact5Alarm, userSense1Name=userSense1Name, upsTemperature=upsTemperature, erd3sTrapGroup=erd3sTrapGroup, temperatureSensor=temperatureSensor, upsUtilityOk=upsUtilityOk, upsLoading=upsLoading, temperatureSensorOutSerial1=temperatureSensorOutSerial1, communityString=communityString, batteryVoltage=batteryVoltage, upsMonitoring=upsMonitoring, alarmSense1Name=alarmSense1Name)
