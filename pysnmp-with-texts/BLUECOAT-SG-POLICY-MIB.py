...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/BLUECOAT-SG-POLICY-MIB
# Produced by pysmi-0.3.4 at Wed May  1 11:39:48 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Counter64, Unsigned32, IpAddress, MibIdentifier, iso, Gauge32, NotificationType, Bits, Integer32, TimeTicks, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Counter64", "Unsigned32", "IpAddress", "MibIdentifier", "iso", "Gauge32", "NotificationType", "Bits", "Integer32", "TimeTicks", "ObjectIdentity", "ModuleIdentity")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: devicePolicyMIB.setRevisionsDescriptions(('Minor corrections and reformatting. Changed the trap OID for compatibility with SNMPv1.', 'Initial revision of this MIB.',))
...
if mibBuilder.loadTexts: devicePolicyMIB.setContactInfo('support.services@bluecoat.com http://www.bluecoat.com')
...
mibBuilder.exportSymbols("BLUECOAT-SG-POLICY-MIB", PYSNMP_MODULE_ID=devicePolicyMIB, devicePolicyMIBNotifications=devicePolicyMIBNotifications, PolicyMessageString=PolicyMessageString, devicePolicyMIBObjects=devicePolicyMIBObjects, devicePolicyMessage=devicePolicyMessage, devicePolicyMIB=devicePolicyMIB, devicePolicyMIBNotificationsPrefix=devicePolicyMIBNotificationsPrefix, devicePolicyTrap=devicePolicyTrap, devicePolicyValues=devicePolicyValues)
