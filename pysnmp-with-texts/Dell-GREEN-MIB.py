...
# Produced by pysmi-0.3.4 at Wed May  1 12:55:56 2019
...
Integer32, Gauge32, Counter64, iso, MibIdentifier, Unsigned32, TimeTicks, ModuleIdentity, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, ObjectIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Gauge32", "Counter64", "iso", "MibIdentifier", "Unsigned32", "TimeTicks", "ModuleIdentity", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "ObjectIdentity", "NotificationType")
...
if mibBuilder.loadTexts: rlGreenEth.setContactInfo('www.Dell.com')
...
mibBuilder.exportSymbols("Dell-GREEN-MIB", rlGreenEthCumulativePowerSaveMeter=rlGreenEthCumulativePowerSaveMeter, rlGreenEthShortReachEnable=rlGreenEthShortReachEnable, rlGreenEthPortSavingTypeValue=rlGreenEthPortSavingTypeValue, rlGreenEthPortTable=rlGreenEthPortTable, rlGreenEthPortEntry=rlGreenEthPortEntry, NonOperReasonType=NonOperReasonType, rlGreenEthPortAdminState=rlGreenEthPortAdminState, rlGreenEth=rlGreenEth, rlGreenEthCurrentEnergyConsumption=rlGreenEthCurrentEnergyConsumption, rlGreenEthCurrentMaxEnergyConsumption=rlGreenEthCurrentMaxEnergyConsumption, rlGreenEthCumulativePowerSaveMeterReset=rlGreenEthCumulativePowerSaveMeterReset, RlGreenSavingType=RlGreenSavingType, rlGreenEthEnergyDetectEnable=rlGreenEthEnergyDetectEnable, rlGreenEthForceShortReachIfIndexList=rlGreenEthForceShortReachIfIndexList, rlGreenEthPortNonOperReason=rlGreenEthPortNonOperReason, rlGreenEthPortOperState=rlGreenEthPortOperState, rlGreenEthMaskLedStatus=rlGreenEthMaskLedStatus, PYSNMP_MODULE_ID=rlGreenEth, rlGreenEthShortReachThreshold=rlGreenEthShortReachThreshold)
