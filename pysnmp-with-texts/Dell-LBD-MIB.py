...
# Produced by pysmi-0.3.4 at Wed May  1 12:56:07 2019
...
Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, Bits, TimeTicks, Unsigned32, Counter64, Integer32, MibIdentifier, ModuleIdentity, ObjectIdentity, IpAddress, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "Bits", "TimeTicks", "Unsigned32", "Counter64", "Integer32", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "IpAddress", "iso")
...
if mibBuilder.loadTexts: rlLbd.setContactInfo('www.dell.com')
...
mibBuilder.exportSymbols("Dell-LBD-MIB", rlLbdMode=rlLbdMode, rlLbd=rlLbd, rlLbdPortEntry=rlLbdPortEntry, PYSNMP_MODULE_ID=rlLbd, rlLbdPortAdminStatus=rlLbdPortAdminStatus, rlLbdDetectionInterval=rlLbdDetectionInterval, rlLbdPortTable=rlLbdPortTable, rlLbdPortOperStatus=rlLbdPortOperStatus, rlLbdEnable=rlLbdEnable)
