...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DES3552P-L2MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:41:17 2019
...
TimeTicks, Bits, NotificationType, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, ModuleIdentity, Integer32, Unsigned32, Counter64, IpAddress, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Bits", "NotificationType", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "ModuleIdentity", "Integer32", "Unsigned32", "Counter64", "IpAddress", "iso", "Counter32")
DisplayString, TruthValue, RowStatus, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowStatus", "TextualConvention")
des3552p, = mibBuilder.importSymbols("SW3528PRIMGMT-MIB", "des3552p")
...
swL2PortInfoErrorDisabled = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 105, 4, 2, 3, 1, 1, 8), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 3, 4))).clone(namedValues=NamedValues(("none", 0), ("storm", 1), ("unknow", 3), ("ctp-lbd", 4)))).setMaxAccess("readonly")
...
swL2PortErrPortReason = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 105, 4, 2, 3, 7, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(2, 3))).clone(namedValues=NamedValues(("storm-control", 2), ("ctp-lbd", 3)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("DES3552P-L2MGMT-MIB", swL2IGMPCtrlEntry=swL2IGMPCtrlEntry, swL2MulticastFilterProfileIndex=swL2MulticastFilterProfileIndex, swL2LimitedMulticastFilterPortIndex=swL2LimitedMulticastFilterPortIndex, swL2QOSSchedulingMaxPkts=swL2QOSSchedulingMaxPkts, swL2QOSSchedulingMechanismCtrl=swL2QOSSchedulingMechanismCtrl, swL2PortInfoType=swL2PortInfoType, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2PPPoEMgmt=swL2PPPoEMgmt, swL2DevCtrlCFMState=swL2DevCtrlCFMState, swL2PortCableDiagnosisPortIndex=swL2PortCableDiagnosisPortIndex, swL2PortSecurityPortIndex=swL2PortSecurityPortIndex, swL2PortErrEntry=swL2PortErrEntry, swL2DhcpRelayCtrlTable=swL2DhcpRelayCtrlTable, swL2PortCtrlMDIXState=swL2PortCtrlMDIXState, swL2PortCableDiagnosisPairLength=swL2PortCableDiagnosisPairLength, swL2PortLoopOccurred=swL2PortLoopOccurred, swL2VlanPortInfoTable=swL2VlanPortInfoTable, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2TrunkType=swL2TrunkType, swL2IGMPCurrentState=swL2IGMPCurrentState, swL2PortErrPortConnStatus=swL2PortErrPortConnStatus, swL2DevCtrlVLANTrunkState=swL2DevCtrlVLANTrunkState, swL2LimitedMulticastFilterPortEntry=swL2LimitedMulticastFilterPortEntry, swL2MulticastFilterProfileAddressTable=swL2MulticastFilterProfileAddressTable, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2IGMPCtrlState=swL2IGMPCtrlState, swL2IGMPMulticastVlanTable=swL2IGMPMulticastVlanTable, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2PortCableDiagnosisTable=swL2PortCableDiagnosisTable, swL2MirrorPortState=swL2MirrorPortState, swL2LimitedMulticastFilterPortAccess=swL2LimitedMulticastFilterPortAccess, VlanId=VlanId, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2TrunkMgmt=swL2TrunkMgmt, swL2PortCounterCtrlTable=swL2PortCounterCtrlTable, swL2QOSBandwidthRadiusTxRate=swL2QOSBandwidthRadiusTxRate, swL2PortSecurityDelVlanName=swL2PortSecurityDelVlanName, swL2LimitedMulticastFilterPortTable=swL2LimitedMulticastFilterPortTable, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2IGMPMulticastVlanReplaceSourceIp=swL2IGMPMulticastVlanReplaceSourceIp, swL2VlanIndex=swL2VlanIndex, swL2QOS8021pUserPriorityEntry=swL2QOS8021pUserPriorityEntry, swL2MulticastFilterPortMaxGroupEntry=swL2MulticastFilterPortMaxGroupEntry, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2VlanPortInfoPortRole=swL2VlanPortInfoPortRole, swL2PortSecurityMaxLernAddr=swL2PortSecurityMaxLernAddr, swL2IGMPMaxSupportedVlans=swL2IGMPMaxSupportedVlans, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2IGMPRobustness=swL2IGMPRobustness, swL2IGMPGroupIpAddr=swL2IGMPGroupIpAddr, swL2PortSecurityControlEntry=swL2PortSecurityControlEntry, swL2TrafficSegPort=swL2TrafficSegPort, swL2DhcpRelayOption82Policy=swL2DhcpRelayOption82Policy, swL2QOSBandwidthTxRate=swL2QOSBandwidthTxRate, swL2MulticastFilterToIp=swL2MulticastFilterToIp, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2DevCtrlCFMPortEntry=swL2DevCtrlCFMPortEntry, swL2QOSBandwidthPortIndex=swL2QOSBandwidthPortIndex, swL2LoopDetectPortState=swL2LoopDetectPortState, swL2DhcpRelayCtrlInterfaceName=swL2DhcpRelayCtrlInterfaceName, swL2VlanLoopRestart=swL2VlanLoopRestart, swL2LoopDetectCtrl=swL2LoopDetectCtrl, swL2DevCtrlCFMPortState=swL2DevCtrlCFMPortState, swL2IGMPMulticastVlanState=swL2IGMPMulticastVlanState, swL2LoopDetectPortIndex=swL2LoopDetectPortIndex, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swDevInfoFrontPanelLedStatus=swDevInfoFrontPanelLedStatus, swL2LoopDetectMode=swL2LoopDetectMode, swL2MulticastFilterProfileName=swL2MulticastFilterProfileName, swL2NotifFirmware=swL2NotifFirmware, swL2DevCtrlAsymVlanState=swL2DevCtrlAsymVlanState, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2PortCableDiagnosisPairStatus=swL2PortCableDiagnosisPairStatus, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2QOSSchedulingMaxLatency=swL2QOSSchedulingMaxLatency, swL2QOSHolPreventionCtrl=swL2QOSHolPreventionCtrl, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2DhcpRelayHopCount=swL2DhcpRelayHopCount, swL2DhcpRelayTimeThreshold=swL2DhcpRelayTimeThreshold, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2IGMPQueryInfoEntry=swL2IGMPQueryInfoEntry, swL2DhcpRelayState=swL2DhcpRelayState, swL2IGMPMulticastVlanGroupFromIp=swL2IGMPMulticastVlanGroupFromIp, swL2IGMPMulticastVlanName=swL2IGMPMulticastVlanName, swL2QOSSchedulingClassIndex=swL2QOSSchedulingClassIndex, swL2macNotificationSeverity=swL2macNotificationSeverity, swL2PortCableDiagnosisCableStatus=swL2PortCableDiagnosisCableStatus, swL2PortSecurityTrapLogState=swL2PortSecurityTrapLogState, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2IGMPMulticastVlanGroupVid=swL2IGMPMulticastVlanGroupVid, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2IGMPSnoopingMulticastVlanState=swL2IGMPSnoopingMulticastVlanState, swL2TrunkVLANPort=swL2TrunkVLANPort, swL2LoopDetectPortMgmt=swL2LoopDetectPortMgmt, swL2PortSecurityViolationSeverity=swL2PortSecurityViolationSeverity, swL2PortInfoMediumType=swL2PortInfoMediumType, swL2DevCtrlSnmpTrapState=swL2DevCtrlSnmpTrapState, swL2PortInfoTable=swL2PortInfoTable, swL2QOSBandwidthControlTable=swL2QOSBandwidthControlTable, swL2QOS8021pUserPriorityClass=swL2QOS8021pUserPriorityClass, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2PortErrTable=swL2PortErrTable, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2IGMPRouteTimeout=swL2IGMPRouteTimeout, swL2VlanLoopOccurred=swL2VlanLoopOccurred, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2IGMPCtrlVid=swL2IGMPCtrlVid, swL2PortMgmt=swL2PortMgmt, swL2VLANMgmt=swL2VLANMgmt, swL2MulticastFilterModeVlanEntry=swL2MulticastFilterModeVlanEntry, swL2MulticastFilterStatus=swL2MulticastFilterStatus, swL2MulticastFilterProfileAddressEntry=swL2MulticastFilterProfileAddressEntry, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2IGMPMulticastVlanRowStatus=swL2IGMPMulticastVlanRowStatus, swL2QOS8021pUserPriorityTable=swL2QOS8021pUserPriorityTable, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2LoopDetectMgmt=swL2LoopDetectMgmt, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2DevCtrlCFM=swL2DevCtrlCFM, swL2MulticastFilterFromIp=swL2MulticastFilterFromIp, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2TrunkVLANTable=swL2TrunkVLANTable, swL2QOSBandwidthRadiusRxRate=swL2QOSBandwidthRadiusRxRate, swL2IGMPMulticastVlanMemberPort=swL2IGMPMulticastVlanMemberPort, swL2TrunkIndex=swL2TrunkIndex, swL2IGMPMulticastVlanRemoveAllMcastAddrListAction=swL2IGMPMulticastVlanRemoveAllMcastAddrListAction, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swL2PortSecurityDelCtrl=swL2PortSecurityDelCtrl, swL2IGMPRouterPortVlanid=swL2IGMPRouterPortVlanid, swL2DevCtrlIGMPSnoopingMcstRTOnly=swL2DevCtrlIGMPSnoopingMcstRTOnly, swL2DhcpRelayCtrlEntry=swL2DhcpRelayCtrlEntry, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swl2NotificationBidings=swl2NotificationBidings, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2IGMPLastMemberQueryInterval=swL2IGMPLastMemberQueryInterval, swL2DevCtrlCFMPortTable=swL2DevCtrlCFMPortTable, swL2LoopDetectTrapMode=swL2LoopDetectTrapMode, swL2MulticastFilterModeVlanTable=swL2MulticastFilterModeVlanTable, swL2MulticastFilterPortMaxGroup=swL2MulticastFilterPortMaxGroup, swL2PortCableDiagnosisPairLengthInaccuracy=swL2PortCableDiagnosisPairLengthInaccuracy, swL2IGMPMacAddr=swL2IGMPMacAddr, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swL2VlanLoopDetectVID=swL2VlanLoopDetectVID, swL2TrunkState=swL2TrunkState, swL2DhcpLocalRelayState=swL2DhcpLocalRelayState, swL2NniGvrpBpduAddress=swL2NniGvrpBpduAddress, swL2MulticastFilterPortMaxGroupTable=swL2MulticastFilterPortMaxGroupTable, swL2DevMgmt=swL2DevMgmt, swL2LoopDetectPortLoopVLAN=swL2LoopDetectPortLoopVLAN, swL2IGMPMulticastVlanGroupToIp=swL2IGMPMulticastVlanGroupToIp, swL2MirrorMgmt=swL2MirrorMgmt, swL2PPPoECirIDinsertState=swL2PPPoECirIDinsertState, swL2QOS8021pDefaultPriorityEntry=swL2QOS8021pDefaultPriorityEntry, swL2DhcpLocalRelayMgmt=swL2DhcpLocalRelayMgmt, swL2DevCtrlStpState=swL2DevCtrlStpState, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2VlanPortInfoEntry=swL2VlanPortInfoEntry, swL2IGMPInfoVid=swL2IGMPInfoVid, swL2IGMPInfoTable=swL2IGMPInfoTable, swL2MulticastFilterVlanMode=swL2MulticastFilterVlanMode, swL2MulticastFilterPortMaxGroupPortIndex=swL2MulticastFilterPortMaxGroupPortIndex, swL2QOSSchedulingEntry=swL2QOSSchedulingEntry, swL2TrafficSegTable=swL2TrafficSegTable, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2MACNotifyState=swL2MACNotifyState, swL2IGMPInfoTxQueryCount=swL2IGMPInfoTxQueryCount, swL2QOS8021pUserPriorityIndex=swL2QOS8021pUserPriorityIndex, swL2IGMPInfoEntry=swL2IGMPInfoEntry, swL2IGMPRouterPortStaticPortList=swL2IGMPRouterPortStaticPortList, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2VLANAdvertisement=swL2VLANAdvertisement, swL2macNotification=swL2macNotification, swL2DhcpLocalRelayVLANState=swL2DhcpLocalRelayVLANState, swL2QOSBandwidthRxRate=swL2QOSBandwidthRxRate, swL2TrunkVLANState=swL2TrunkVLANState, swL2PortCounterCtrlEntry=swL2PortCounterCtrlEntry, swL2PortSecurityDelPort=swL2PortSecurityDelPort, swL2DhcpRelayOption82Check=swL2DhcpRelayOption82Check, swL2PortCableDiagnosisPairIndex=swL2PortCableDiagnosisPairIndex, swL2IGMPFastLeaveState=swL2IGMPFastLeaveState, swL2Notify=swL2Notify, swL2PortCtrlTable=swL2PortCtrlTable, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2IGMPMulticastVlanEntry=swL2IGMPMulticastVlanEntry, swL2QOSBandwidthControlEntry=swL2QOSBandwidthControlEntry, swL2LoopDetectPortEntry=swL2LoopDetectPortEntry, swL2QOS8021pDefaultPriority=swL2QOS8021pDefaultPriority, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2PortErrPortReason=swL2PortErrPortReason, swL2IGMPQueryInfoTable=swL2IGMPQueryInfoTable, swL2IGMPInfoQueryCount=swL2IGMPInfoQueryCount, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2IGMPIpGroupReportCount=swL2IGMPIpGroupReportCount, swL2IGMPRouterPortForbiddenPortList=swL2IGMPRouterPortForbiddenPortList, swL2DevCtrlIpAutoconfig=swL2DevCtrlIpAutoconfig, swL2DevCtrl=swL2DevCtrl, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2IGMPMulticastVlanGroupTable=swL2IGMPMulticastVlanGroupTable, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2NotifyMgmt=swL2NotifyMgmt, MacAddress=MacAddress, swL2LimitedMulticastFilterPortProfileStatus=swL2LimitedMulticastFilterPortProfileStatus, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2LoopDetectInterval=swL2LoopDetectInterval, swL2NotifyPrefix=swL2NotifyPrefix, swL2PortInfoErrorDisabled=swL2PortInfoErrorDisabled, swL2VlanPortInfoVid=swL2VlanPortInfoVid, swL2PortSecurityEntryClearCtrl=swL2PortSecurityEntryClearCtrl, swL2TrunkMember=swL2TrunkMember, swL2IGMPHostTimeout=swL2IGMPHostTimeout, swL2IGMPPortMap=swL2IGMPPortMap, swL2DhcpRelayCtrlServer=swL2DhcpRelayCtrlServer, swL2PortSecurityControlTable=swL2PortSecurityControlTable, swL2IGMPMulticastVlanTagMemberPort=swL2IGMPMulticastVlanTagMemberPort, swL2PortSecurityMgmt=swL2PortSecurityMgmt, swL2QOSSchedulingTable=swL2QOSSchedulingTable, swL2IGMPQueryState=swL2IGMPQueryState, swL2LimitedMulticastFilterPortProfileID=swL2LimitedMulticastFilterPortProfileID, swL2PortSecurityAdmState=swL2PortSecurityAdmState, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2DhcpLocalRelayVLANEntry=swL2DhcpLocalRelayVLANEntry, swL2IGMPMulticastVlanSourcePort=swL2IGMPMulticastVlanSourcePort, swL2PortCounterClearCtrl=swL2PortCounterClearCtrl, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2PortInfoUnitID=swL2PortInfoUnitID, swL2PortCtrlLearningState=swL2PortCtrlLearningState, swL2MulticastFilterProfileTable=swL2MulticastFilterProfileTable, swL2IGMPMulticastVlanGroupStatus=swL2IGMPMulticastVlanGroupStatus, swL2MulticastFilterProfileIdIndex=swL2MulticastFilterProfileIdIndex, swL2IGMPRouterPortEntry=swL2IGMPRouterPortEntry, swL2IGMPMulticastVlanid=swL2IGMPMulticastVlanid, swL2IGMPQueryInterval=swL2IGMPQueryInterval, swL2DevCtrlIGMPSnooping=swL2DevCtrlIGMPSnooping, swL2PortErrPortIndex=swL2PortErrPortIndex, swL2VlanPortInfoPortIndex=swL2VlanPortInfoPortIndex, swL2PortSecurityDelMacAddress=swL2PortSecurityDelMacAddress, swL2PortCtrlJumboFrameMaxSize=swL2PortCtrlJumboFrameMaxSize, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2DhcpRelayCtrlState=swL2DhcpRelayCtrlState, swL2IGMPVid=swL2IGMPVid, swL2LoopDetectPortTable=swL2LoopDetectPortTable, swL2PortLoopRestart=swL2PortLoopRestart, swL2MgmtMIB=swL2MgmtMIB, swL2DhcpLocalRelayVLANTable=swL2DhcpLocalRelayVLANTable, swL2DhcpRelayOption82State=swL2DhcpRelayOption82State, swL2IGMPRouterPortTable=swL2IGMPRouterPortTable, swL2DhcpRelayMgmt=swL2DhcpRelayMgmt, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange)
mibBuilder.exportSymbols("DES3552P-L2MGMT-MIB", swL2LoopDetectRecoverTime=swL2LoopDetectRecoverTime, swL2QOSSchedulingMechanism=swL2QOSSchedulingMechanism, swL2IGMPMaxResponseTime=swL2IGMPMaxResponseTime, swL2PVIDAutoAssignmentState=swL2PVIDAutoAssignmentState, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2IGMPLeaveTimer=swL2IGMPLeaveTimer, swL2QOSMgmt=swL2QOSMgmt, swL2QOS8021pDefaultPriorityIndex=swL2QOS8021pDefaultPriorityIndex, swL2PortSecurityMode=swL2PortSecurityMode, swL2PortSecurityDelActivity=swL2PortSecurityDelActivity, swL2PortCableDiagnosisEntry=swL2PortCableDiagnosisEntry, swL2LimitedMulticastMgmt=swL2LimitedMulticastMgmt, swL2MulticastFilterAddressState=swL2MulticastFilterAddressState, swL2IGMPCtrlTable=swL2IGMPCtrlTable, swL2MulticastFilterVid=swL2MulticastFilterVid, swL2DhcpLocalRelayVLANID=swL2DhcpLocalRelayVLANID, PortList=PortList, swL2VlanStaticTable=swL2VlanStaticTable, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2MulticastFilterProfileEntry=swL2MulticastFilterProfileEntry, swL2QOS8021pRadiusPriority=swL2QOS8021pRadiusPriority, swL2IGMPMulticastVlanGroupEntry=swL2IGMPMulticastVlanGroupEntry, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2VlanStaticEntry=swL2VlanStaticEntry, swL2QOS8021pDefaultPriorityTable=swL2QOS8021pDefaultPriorityTable, swL2LoopDetectAdminState=swL2LoopDetectAdminState, swL2MulticastFilterMode=swL2MulticastFilterMode, swL2LoopDetectPortLoopStatus=swL2LoopDetectPortLoopStatus, swL2TrunkVLANEntry=swL2TrunkVLANEntry, swL2PortCtrlMediumType=swL2PortCtrlMediumType, swL2IGMPMgmt=swL2IGMPMgmt, swL2DevInfo=swL2DevInfo, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2IGMPRouterPortDynamicPortList=swL2IGMPRouterPortDynamicPortList, swL2PortInfoEntry=swL2PortInfoEntry, swL2IGMPRouterPortVlanName=swL2IGMPRouterPortVlanName, swL2DevAlarm=swL2DevAlarm, swL2DevCtrlCFMPortIndex=swL2DevCtrlCFMPortIndex, swL2PortErrPortState=swL2PortErrPortState, swL2PortCounterCtrlPortIndex=swL2PortCounterCtrlPortIndex, swL2IGMPMaxIpGroupNumPerVlan=swL2IGMPMaxIpGroupNumPerVlan, swL2macNotifyInfo=swL2macNotifyInfo)
