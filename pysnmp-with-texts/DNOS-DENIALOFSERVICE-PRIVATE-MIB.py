...
# Produced by pysmi-0.3.4 at Wed May  1 12:51:25 2019
...
Unsigned32, Counter32, Integer32, ModuleIdentity, IpAddress, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, MibIdentifier, iso, Counter64, NotificationType, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter32", "Integer32", "ModuleIdentity", "IpAddress", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "MibIdentifier", "iso", "Counter64", "NotificationType", "Gauge32")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: fastPathDenialOfService.setRevisionsDescriptions(('Postal address updated.', 'Dell branding related changes.',))
...
if mibBuilder.loadTexts: fastPathDenialOfService.setDescription('The Broadcom Private MIB for DNOS Denial of Service.')
...
mibBuilder.exportSymbols("DNOS-DENIALOFSERVICE-PRIVATE-MIB", agentSwitchDenialOfServiceTCPFlagSeqMode=agentSwitchDenialOfServiceTCPFlagSeqMode, agentSwitchDenialOfServiceTCPSynFinMode=agentSwitchDenialOfServiceTCPSynFinMode, agentSwitchDenialOfServiceICMPv6Mode=agentSwitchDenialOfServiceICMPv6Mode, agentSwitchDenialOfServiceTCPPortMode=agentSwitchDenialOfServiceTCPPortMode, agentSwitchDenialOfServiceTCPFinUrgPshMode=agentSwitchDenialOfServiceTCPFinUrgPshMode, agentSwitchDenialOfServiceICMPMode=agentSwitchDenialOfServiceICMPMode, agentSwitchDenialOfServiceICMPv6Size=agentSwitchDenialOfServiceICMPv6Size, agentSwitchDenialOfServiceSMACDMACMode=agentSwitchDenialOfServiceSMACDMACMode, fastPathDenialOfService=fastPathDenialOfService, agentSwitchDenialOfServiceTCPSynMode=agentSwitchDenialOfServiceTCPSynMode, agentSwitchDenialOfServiceTCPOffsetMode=agentSwitchDenialOfServiceTCPOffsetMode, agentSwitchDenialOfServiceICMPFragMode=agentSwitchDenialOfServiceICMPFragMode, agentSwitchDenialOfServiceSIPDIPMode=agentSwitchDenialOfServiceSIPDIPMode, agentSwitchDenialOfServiceTCPFragMode=agentSwitchDenialOfServiceTCPFragMode, PYSNMP_MODULE_ID=fastPathDenialOfService, agentSwitchDenialOfServiceGroup=agentSwitchDenialOfServiceGroup, agentSwitchDenialOfServiceTCPHdrSize=agentSwitchDenialOfServiceTCPHdrSize, agentSwitchDenialOfServiceFirstFragMode=agentSwitchDenialOfServiceFirstFragMode, agentSwitchDenialOfServiceTCPFlagMode=agentSwitchDenialOfServiceTCPFlagMode, agentSwitchDenialOfServiceUDPPortMode=agentSwitchDenialOfServiceUDPPortMode, agentSwitchDenialOfServiceL4PortMode=agentSwitchDenialOfServiceL4PortMode, agentSwitchDenialOfServiceICMPSize=agentSwitchDenialOfServiceICMPSize)
