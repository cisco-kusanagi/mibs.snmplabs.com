...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/SNMPv2-MIB
...
Gauge32, IpAddress, Counter32, mib_2, Unsigned32, NotificationType, ModuleIdentity, iso, Counter64, ObjectIdentity, MibIdentifier, snmpModules, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "IpAddress", "Counter32", "mib-2", "Unsigned32", "NotificationType", "ModuleIdentity", "iso", "Counter64", "ObjectIdentity", "MibIdentifier", "snmpModules", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
mibBuilder.exportSymbols("SNMPv2-MIB", snmpTrapOID=snmpTrapOID, snmpProxyDrops=snmpProxyDrops, snmpInGenErrs=snmpInGenErrs, sysLocation=sysLocation, system=system, snmpTrapEnterprise=snmpTrapEnterprise, sysORID=sysORID, authenticationFailure=authenticationFailure, snmpInTotalSetVars=snmpInTotalSetVars, snmpGroup=snmpGroup, sysServices=sysServices, snmpInGetRequests=snmpInGetRequests, snmpOutNoSuchNames=snmpOutNoSuchNames, snmpObsoleteGroup=snmpObsoleteGroup, snmpSetSerialNo=snmpSetSerialNo, snmpTrap=snmpTrap, snmpBasicCompliance=snmpBasicCompliance, snmpInNoSuchNames=snmpInNoSuchNames, snmp=snmp, snmpSilentDrops=snmpSilentDrops, snmpWarmStartNotificationGroup=snmpWarmStartNotificationGroup, sysUpTime=sysUpTime, snmpTraps=snmpTraps, snmpInTraps=snmpInTraps, snmpInTotalReqVars=snmpInTotalReqVars, snmpOutSetRequests=snmpOutSetRequests, snmpCommunityGroup=snmpCommunityGroup, snmpInReadOnlys=snmpInReadOnlys, snmpBasicNotificationsGroup=snmpBasicNotificationsGroup, snmpInGetNexts=snmpInGetNexts, snmpInSetRequests=snmpInSetRequests, sysORUpTime=sysORUpTime, snmpMIBConformance=snmpMIBConformance, snmpNotificationGroup=snmpNotificationGroup, snmpOutGetRequests=snmpOutGetRequests, sysORLastChange=sysORLastChange, snmpEnableAuthenTraps=snmpEnableAuthenTraps, snmpSetGroup=snmpSetGroup, warmStart=warmStart, snmpMIBCompliances=snmpMIBCompliances, snmpMIBObjects=snmpMIBObjects, snmpMIBGroups=snmpMIBGroups, PYSNMP_MODULE_ID=snmpMIB, sysORDescr=sysORDescr, snmpOutPkts=snmpOutPkts, coldStart=coldStart, sysOREntry=sysOREntry, snmpOutGenErrs=snmpOutGenErrs, snmpInBadVersions=snmpInBadVersions, snmpOutGetNexts=snmpOutGetNexts, snmpInBadCommunityUses=snmpInBadCommunityUses, sysContact=sysContact, snmpInTooBigs=snmpInTooBigs, sysObjectID=sysObjectID, snmpBasicComplianceRev2=snmpBasicComplianceRev2, sysName=sysName, snmpOutBadValues=snmpOutBadValues, sysORTable=sysORTable, sysDescr=sysDescr, snmpInBadCommunityNames=snmpInBadCommunityNames, snmpOutTooBigs=snmpOutTooBigs, sysORIndex=sysORIndex, snmpOutGetResponses=snmpOutGetResponses, snmpSet=snmpSet, snmpInGetResponses=snmpInGetResponses, systemGroup=systemGroup, snmpMIB=snmpMIB, snmpInASNParseErrs=snmpInASNParseErrs, snmpInPkts=snmpInPkts, snmpOutTraps=snmpOutTraps, snmpInBadValues=snmpInBadValues)
