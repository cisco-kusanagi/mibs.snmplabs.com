...
# Produced by pysmi-0.3.4 at Wed May  1 12:51:38 2019
...
NotificationType, ObjectIdentity, Integer32, Unsigned32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, Counter32, iso, Counter64, MibIdentifier, Bits, Gauge32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "Integer32", "Unsigned32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "Counter32", "iso", "Counter64", "MibIdentifier", "Bits", "Gauge32", "IpAddress")
...
if mibBuilder.loadTexts: fastPathIsdp.setDescription('The Dell Networking Private MIB for ISDP')
...
mibBuilder.exportSymbols("DNOS-ISDP-MIB", agentIsdpCacheAddress=agentIsdpCacheAddress, agentIsdpStatisticsV2PduReceived=agentIsdpStatisticsV2PduReceived, agentIsdpStatisticsV2PduTransmit=agentIsdpStatisticsV2PduTransmit, agentIsdpGlobalRun=agentIsdpGlobalRun, agentIsdpInterfaceEnable=agentIsdpInterfaceEnable, agentIsdpGlobalAdvertiseV2=agentIsdpGlobalAdvertiseV2, agentIsdpCacheLocalIntf=agentIsdpCacheLocalIntf, PYSNMP_MODULE_ID=fastPathIsdp, agentIsdpStatisticsPduReceived=agentIsdpStatisticsPduReceived, agentIsdpMIBObjects=agentIsdpMIBObjects, agentIsdpStatisticsBadHeaderPduReceived=agentIsdpStatisticsBadHeaderPduReceived, agentIsdpStatistics=agentIsdpStatistics, agentIsdpStatisticsV1PduTransmit=agentIsdpStatisticsV1PduTransmit, agentIsdpStatisticsV1PduReceived=agentIsdpStatisticsV1PduReceived, agentIsdpStatisticsTableFull=agentIsdpStatisticsTableFull, agentIsdpStatisticsIpAddressTableFull=agentIsdpStatisticsIpAddressTableFull, agentIsdpCacheVersion=agentIsdpCacheVersion, agentIsdpStatisticsPduTransmit=agentIsdpStatisticsPduTransmit, agentIsdpInterfaceTable=agentIsdpInterfaceTable, agentIsdpCacheCapabilities=agentIsdpCacheCapabilities, agentIsdpGlobal=agentIsdpGlobal, agentIsdpCacheTable=agentIsdpCacheTable, agentIsdpCacheDevicePort=agentIsdpCacheDevicePort, agentIsdpGlobalDeviceIdFormat=agentIsdpGlobalDeviceIdFormat, agentIsdpCacheHoldtime=agentIsdpCacheHoldtime, agentIsdpCacheIfIndex=agentIsdpCacheIfIndex, agentIsdpInterfaceIfIndex=agentIsdpInterfaceIfIndex, agentIsdpClearEntries=agentIsdpClearEntries, fastPathIsdp=fastPathIsdp, agentIsdpCacheDeviceId=agentIsdpCacheDeviceId, agentIsdpCache=agentIsdpCache, agentIsdpCacheIndex=agentIsdpCacheIndex, agentIsdpStatisticsFailurePduTransmit=agentIsdpStatisticsFailurePduTransmit, agentIsdpCacheEntry=agentIsdpCacheEntry, agentIsdpCacheProtocolVersion=agentIsdpCacheProtocolVersion, agentIsdpStatisticsInvalidFormatPduReceived=agentIsdpStatisticsInvalidFormatPduReceived, agentIsdpGlobalHoldTime=agentIsdpGlobalHoldTime, agentIsdpClearStats=agentIsdpClearStats, agentIsdpGlobalMessageInterval=agentIsdpGlobalMessageInterval, agentIsdpGlobalDeviceId=agentIsdpGlobalDeviceId, agentIsdpInterface=agentIsdpInterface, agentIsdpCacheLastChange=agentIsdpCacheLastChange, agentIsdpClear=agentIsdpClear, agentIsdpStatisticsChkSumErrorPduReceived=agentIsdpStatisticsChkSumErrorPduReceived, agentIsdpGlobalDeviceIdFormatCpb=agentIsdpGlobalDeviceIdFormatCpb, agentIsdpInterfaceEntry=agentIsdpInterfaceEntry, agentIsdpCachePlatform=agentIsdpCachePlatform)
