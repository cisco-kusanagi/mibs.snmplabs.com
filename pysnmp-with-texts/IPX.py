...
# Produced by pysmi-0.3.4 at Wed May  1 13:56:56 2019
...
Counter32, Gauge32, MibIdentifier, enterprises, Unsigned32, NotificationType, Bits, NotificationType, Integer32, ModuleIdentity, ObjectIdentity, TimeTicks, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Gauge32", "MibIdentifier", "enterprises", "Unsigned32", "NotificationType", "Bits", "NotificationType", "Integer32", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "IpAddress")
...
mibBuilder.exportSymbols("IPX", ipxCircStaticStatus=ipxCircStaticStatus, ipxDestServTable=ipxDestServTable, ipxStaticServExistState=ipxStaticServExistState, ipxStaticRouteEntry=ipxStaticRouteEntry, ipxAdvSysForwPackets=ipxAdvSysForwPackets, ipxCircNeighInternalNetNum=ipxCircNeighInternalNetNum, ipxDestServEntry=ipxDestServEntry, ipxBasicSysEntry=ipxBasicSysEntry, ipxCircEntry=ipxCircEntry, ipxStaticServName=ipxStaticServName, ipxCircDialName=ipxCircDialName, ipxBasicSysOpenSocketFails=ipxBasicSysOpenSocketFails, ipxServSysInstance=ipxServSysInstance, ipxCircIndex=ipxCircIndex, ipxCircCompressedReceived=ipxCircCompressedReceived, ipxAdvSysCircCount=ipxAdvSysCircCount, ipxCircNeighRouterName=ipxCircNeighRouterName, ipxDestTable=ipxDestTable, ipxDestServName=ipxDestServName, ipxCircSysInstance=ipxCircSysInstance, ipxServSocket=ipxServSocket, ipxTrapCircuitUp=ipxTrapCircuitUp, ipxAdvSysEntry=ipxAdvSysEntry, ipxStaticServType=ipxStaticServType, ipxCircOperState=ipxCircOperState, ipxBasicSysName=ipxBasicSysName, ipxDestNextHopNICAddress=ipxDestNextHopNICAddress, ipxDestHopCount=ipxDestHopCount, ipxStaticServEntry=ipxStaticServEntry, ipxBasicSysOutPackets=ipxBasicSysOutPackets, ipxAdvSysInFiltered=ipxAdvSysInFiltered, ipxCircExistState=ipxCircExistState, ipxBasicSysNetNumber=ipxBasicSysNetNumber, ipxDestSysInstance=ipxDestSysInstance, ipxServTable=ipxServTable, ipxServName=ipxServName, ipxAdvSysInCompressDiscards=ipxAdvSysInCompressDiscards, ipxDestServProtocol=ipxDestServProtocol, ipxStaticServCircIndex=ipxStaticServCircIndex, ipxStaticServTable=ipxStaticServTable, ipxDestServSysInstance=ipxDestServSysInstance, ipxTrapCircuitDown=ipxTrapCircuitDown, ipxCircCompressState=ipxCircCompressState, ipxCircLocalMaxPacketSize=ipxCircLocalMaxPacketSize, ipxBasicSysInDelivers=ipxBasicSysInDelivers, ipxCircIfIndex=ipxCircIfIndex, ipxDestNetNum=ipxDestNetNum, ipxBasicSysOutMalformedRequests=ipxBasicSysOutMalformedRequests, ipxStaticServSocket=ipxStaticServSocket, ipxCircInitFails=ipxCircInitFails, ipxCircType=ipxCircType, ipxStaticRouteExistState=ipxStaticRouteExistState, ipxAdvSysOutFiltered=ipxAdvSysOutFiltered, ipxCircCompressedInitReceived=ipxCircCompressedInitReceived, ipx=ipx, ipxAdvSysInstance=ipxAdvSysInstance, ipxServType=ipxServType, ipxCircDelay=ipxCircDelay, ipxDestNextHopCircIndex=ipxDestNextHopCircIndex, ipxStaticRouteSysInstance=ipxStaticRouteSysInstance, ipxStaticServNetNum=ipxStaticServNetNum, ipxStaticServHopCount=ipxStaticServHopCount, ipxCircCompressedInitSent=ipxCircCompressedInitSent, ipxStaticServNode=ipxStaticServNode, ipxAdvSysDestCount=ipxAdvSysDestCount, ipxStaticRouteTicks=ipxStaticRouteTicks, ipxCircUncompressedReceived=ipxCircUncompressedReceived, ipxStaticRouteTable=ipxStaticRouteTable, ipxAdvSysInTooManyHops=ipxAdvSysInTooManyHops, ipxDestTicks=ipxDestTicks, novell=novell, ipxAdvSysTable=ipxAdvSysTable, ipxServices=ipxServices, ipxStaticRouteNetNum=ipxStaticRouteNetNum, ipxBasicSysInHdrErrors=ipxBasicSysInHdrErrors, ipxBasicSysInReceives=ipxBasicSysInReceives, ipxDestServType=ipxDestServType, ipxServNetNum=ipxServNetNum, ipxAdvSysOutCompressDiscards=ipxAdvSysOutCompressDiscards, ipxBasicSysConfigSockets=ipxBasicSysConfigSockets, ipxDestServSocket=ipxDestServSocket, ipxStaticRouteHopCount=ipxStaticRouteHopCount, ipxDestNextHopNetNum=ipxDestNextHopNetNum, ipxCircTable=ipxCircTable, ipxCircCompressedSent=ipxCircCompressedSent, ipxCircName=ipxCircName, ipxCircThroughput=ipxCircThroughput, ipxDestServNode=ipxDestServNode, ipxStaticServSysInstance=ipxStaticServSysInstance, ipxBasicSysOutRequests=ipxBasicSysOutRequests, ipxStaticRouteCircIndex=ipxStaticRouteCircIndex, NetNumber=NetNumber, ipxCircuit=ipxCircuit, ipxCircStateChanges=ipxCircStateChanges, ipxCircCompressedRejectsReceived=ipxCircCompressedRejectsReceived, ipxCircUncompressedSent=ipxCircUncompressedSent, ipxCircCompressSlots=ipxCircCompressSlots, ipxCircCompressedRejectsSent=ipxCircCompressedRejectsSent, ipxBasicSysInDiscards=ipxBasicSysInDiscards, ipxCircMediaType=ipxCircMediaType, ipxBasicSysOutDiscards=ipxBasicSysOutDiscards, ipxBasicSysInBadChecksums=ipxBasicSysInBadChecksums, ipxServHopCount=ipxServHopCount, ipxBasicSysNoRoutes=ipxBasicSysNoRoutes, ipxAdvSysServCount=ipxAdvSysServCount, ipxServProtocol=ipxServProtocol, ipxTraps=ipxTraps, ipxBasicSysTable=ipxBasicSysTable, ipxSystem=ipxSystem, ipxDestEntry=ipxDestEntry, ipxCircNetNumber=ipxCircNetNumber, ipxDestProtocol=ipxDestProtocol, ipxServEntry=ipxServEntry, ipxAdvSysMaxHops=ipxAdvSysMaxHops, ipxDestServHopCount=ipxDestServHopCount, mibDoc=mibDoc, ipxBasicSysInstance=ipxBasicSysInstance, ipxBasicSysInUnknownSockets=ipxBasicSysInUnknownSockets, ipxAdvSysMaxPathSplits=ipxAdvSysMaxPathSplits, ipxServNode=ipxServNode, ipxForwarding=ipxForwarding, ipxDestServNetNum=ipxDestServNetNum, ipxBasicSysNode=ipxBasicSysNode, ipxBasicSysExistState=ipxBasicSysExistState, ipxAdvSysNETBIOSPackets=ipxAdvSysNETBIOSPackets)
