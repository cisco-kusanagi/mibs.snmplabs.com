...
Hh3cDot11RadioElementIndex, hh3cDot11APElementIndex, hh3cDot11 = mibBuilder.importSymbols("HH3C-DOT11-REF-MIB", "Hh3cDot11RadioElementIndex", "hh3cDot11APElementIndex", "hh3cDot11")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ObjectIdentity, IpAddress, Counter64, TimeTicks, NotificationType, MibIdentifier, ModuleIdentity, Counter32, Unsigned32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ObjectIdentity", "IpAddress", "Counter64", "TimeTicks", "NotificationType", "MibIdentifier", "ModuleIdentity", "Counter32", "Unsigned32", "iso", "Integer32")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: hh3cDot11sMesh.setRevisionsDescriptions(('Add new nodes.', 'Modified to add new nodes and a new table.', 'The initial revision of this MIB module.',))
...
if mibBuilder.loadTexts: hh3cDot11sMeshMkdID.setDescription("This object represents the mesh key distributor identifier (MKD-ID). If the MKD-ID is not configured, the value is '00:00:00:00:00:00'.")
...
if mibBuilder.loadTexts: hh3cDot11sMeshPflTable.setDescription('This table is used to configure mesh profile. A mesh profile is created and mapped to a MP so that it can provide mesh services to other MPs which have the same mesh ID. When the mesh profile is enabled, all of the object in this table can not be modified except hh3cDot11sMeshPflEnable. The mesh profile can not be deleted when it is bound with the radio.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshPflEntry.setDescription('Each entry contains information of a mesh profile.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshPflIndex.setDescription('This object represents the index of the mesh profile.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshPflMeshID.setDescription("This object represents the mesh ID of the mesh profile. The string length of this object is zero when the mesh ID is not configured. If the mesh ID is not configured, hh3cDot11sMeshPflEnable can not be set to 'true'.")
...
if mibBuilder.loadTexts: hh3cDot11sMeshPflBindIntNum.setDescription("This object represents the specified mesh interface number binding to the mesh profile. If the value is set to -1, the binding will be removed. If the mesh interface is not specified, the value of hh3cDot11sMeshPflEnable can not be set to 'true'.")
...
if mibBuilder.loadTexts: hh3cDot11sMeshPflKeepAlive.setDescription('This object represents the mesh link keep-alive interval.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshPflBackhaulRate.setDescription('This object represents the link backhaul rate.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshMkdServEnable.setDescription("This object indicates whether the mesh key distributor (MKD) service for the mesh profile is enabled. 'true': The MKD service for the mesh profile is enabled. 'false': The MKD service for the mesh profile is disabled.")
...
if mibBuilder.loadTexts: hh3cDot11sMeshPflEnable.setDescription("This object indicates whether the mesh profile is enabled. 'true': The mesh profile is enabled. 'false': The mesh profile is disabled.")
...
if mibBuilder.loadTexts: hh3cDot11sMeshPflRowStatus.setDescription('The status of this table entry.')
...
if mibBuilder.loadTexts: hh3cDot11sMpPlcyTable.setDescription("This table is used to configure MP policy. There is 'default_mp_plcy' on system by default and its index is 1. The 'default_mp_plcy' can not be deleted or modified. The MP policy can not be deleted when it is applied to a radio. It can not be modified when it is applied to an enabled radio.")
...
if mibBuilder.loadTexts: hh3cDot11sMpPlcyEntry.setDescription('Each entry contains information of a MP policy.')
...
if mibBuilder.loadTexts: hh3cDot11sMpPlcyIndex.setDescription('This object represents the MP policy index.')
...
if mibBuilder.loadTexts: hh3cDot11sMpPlcyName.setDescription("This object represents the MP policy name. MP policy can not be created with name 'a', 'al', 'all' or 'default_mp_plcy'. Modification is not supported.")
...
if mibBuilder.loadTexts: hh3cDot11sMpPlcyInitEnable.setDescription("This object indicates whether the link initiation for the MP policy is enabled. 'true': The link initiation for the MP policy is enabled. 'false': The link initiation for the MP policy is disabled.")
...
if mibBuilder.loadTexts: hh3cDot11sMlspEnable.setDescription("This object indicates whether the mesh link switch protocol (MLSP) is enabled. 'true': MLSP is enabled. 'false': MLSP is disabled.")
...
if mibBuilder.loadTexts: hh3cDot11sProbReqInterval.setDescription('This object represents the probe request interval.')
...
if mibBuilder.loadTexts: hh3cDot11sRoleAuthEnable.setDescription('This object indicates whether the device can play as the role of an authenticator.')
...
if mibBuilder.loadTexts: hh3cDot11sLinkHoldRSSI.setDescription('This object represents the link-hold receive signal strength indicator (RSSI).')
...
if mibBuilder.loadTexts: hh3cDot11sLinkHoldTime.setDescription('This object represents the link-hold time.')
...
if mibBuilder.loadTexts: hh3cDot11sSwitchMargin.setDescription('This object represents the link-switch margin.')
...
if mibBuilder.loadTexts: hh3cDot11sLinkSaturationRSSI.setDescription('This object represents the link saturation receive signal strength indicator (RSSI).')
...
if mibBuilder.loadTexts: hh3cDot11sLinkRateMode.setDescription('This object represents the rate mode of the mesh link.')
...
if mibBuilder.loadTexts: hh3cDot11sMaxLinkNum.setDescription('This object represents the maximum number of the mesh link.')
...
if mibBuilder.loadTexts: hh3cDot11sMpPlcyRowStatus.setDescription('The status of this table entry.')
...
if mibBuilder.loadTexts: hh3cDot11sMlspCfgTable.setDescription('This table is used to configure MLSP proxy MAC address. Only if the specified MP policy is modifiable and the MLSP is enabled, the row of this table can be created and deleted. The row of this table can not be modified.')
...
if mibBuilder.loadTexts: hh3cDot11sMlspCfgEntry.setDescription('Each entry contains information of MLSP proxy MAC address.')
...
if mibBuilder.loadTexts: hh3cDot11sMlspProxyIndex.setDescription('This object represents the MLSP proxy MAC address index.')
...
if mibBuilder.loadTexts: hh3cDot11sMlspProxyMac.setDescription('This object represents the MLSP proxy MAC address.')
...
if mibBuilder.loadTexts: hh3cDot11sMlspRowStatus.setDescription('The status of this table entry.')
...
if mibBuilder.loadTexts: hh3cDot11sRadioCfgTable.setDescription('This table is used to configure mesh to the specified radio.')
...
if mibBuilder.loadTexts: hh3cDot11sRadioCfgEntry.setDescription('Each entry contains mesh configure information of the specified radio.')
...
if mibBuilder.loadTexts: hh3cDot11sCfgRadioIndex.setDescription('Represents index of the radio.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshPflMap.setDescription('This object represents the number of the mesh profile mapped to the specified radio. The value is zero when the radio is not binding mesh profile.')
...
if mibBuilder.loadTexts: hh3cDot11sMpPlcyMap.setDescription("This object represents the index of the MP policy mapped to the specified radio. The MP policy is 'default_mp_plcy' when the radio is not binding user-defined MP policy. The index of 'default_mp_plcy' is 1. This object can not be modified when the radio is enabled.")
...
if mibBuilder.loadTexts: hh3cDot11sAPCfgTable.setDescription('This table is used to configure mesh to the specified AP.')
...
if mibBuilder.loadTexts: hh3cDot11sAPCfgEntry.setDescription('Each entry contains mesh configure information of the specified AP.')
...
if mibBuilder.loadTexts: hh3cDot11sPortalEnable.setDescription("This object indicates whether the portal service is enabled. 'true': The portal service is enabled. 'false': The portal service is disabled.")
...
if mibBuilder.loadTexts: hh3cDot11sWDSPeerMacTable.setDescription('This table is used to configure wireless distribution system (WDS). The row of this table can not be modified.')
...
if mibBuilder.loadTexts: hh3cDot11sWDSPeerMacEntry.setDescription('Each entry contains information of WDS.')
...
if mibBuilder.loadTexts: hh3cDot11sWDSPeerMacIndex.setDescription('This object represents the peer MAC address index.')
...
if mibBuilder.loadTexts: hh3cDot11sWDSPeerMacAddrss.setDescription('This object represents the peer MAC address.')
...
if mibBuilder.loadTexts: hh3cDot11sWDSPeerMacRowStatus.setDescription('The status of this table entry.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkStatusTable.setDescription('This table is used to represent the status of mesh link.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkStatusEntry.setDescription('Each entry contains status information of mesh link.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkIfIndex.setDescription('This object represents the interface index of the mesh link.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkName.setDescription('This object represents the name of the mesh link.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkBSSID.setDescription('This object represents the BSS ID of the mesh link.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkPeerMac.setDescription('This object represents the peer MAC address of the mesh link.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkExistDuration.setDescription('This object represents the time for which the link has been up.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkStatisTable.setDescription('This table is used to represent the statistical information of mesh link.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkStatisEntry.setDescription('Each entry contains statistical information of mesh link.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkStatIfIndex.setDescription('This object represents the interface index of the mesh link.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkNbrIndex.setDescription('Represents the neighbor index of the mesh link.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkRxTotByte.setDescription('Represents the amount of bytes that the mesh link received.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkRxTotPkt.setDescription('Represents the amount of packets that the mesh link received.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkRxUniPkt.setDescription('Represents the amount of unicast packets that the mesh link received.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkRxBrocPkt.setDescription('Represents the amount of broadcast packets that the mesh link received.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkRxMuticPkt.setDescription('Represents the amount of multicast packets that the mesh link received.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkRxDiscPkt.setDescription('Represents the amount of packets that the mesh link discarded.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkTxTotByte.setDescription('Represents the total amount of bytes that the mesh link transmitted.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkTxTotPkt.setDescription('Represents the total amount of packets that the mesh link transmitted.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkTxUniPkt.setDescription('Represents the amount of unicast packets that the mesh link transmitted.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkTxBrocPkt.setDescription('Represents the amount of broadcast packets that the mesh link transmitted.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkTxMuticPkt.setDescription('Represents the amount of multicast packets that the mesh link transmitted.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkTxDiscPkt.setDescription('Represents the amount of discarded packets that the mesh link transmitted.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkIFName.setDescription('Represents the name of mesh link interface.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshNbrStatusTable.setDescription('This table represents the status information for the neighbors of MP.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshNbrStatusEntry.setDescription('Each entry of the table will provide status information for the neighbors of MP.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshNbrIndex.setDescription('Represents the index for the neighbor.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshNbrRadioID.setDescription('Represents the radio ID of the neighbor.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLocalMeshID.setDescription('Represents the local mesh ID.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshNbrMeshID.setDescription('Represents the mesh ID of the neighbor.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshNbrBSSID.setDescription('Represents the BSS ID of the neighbor.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshNbrPeerMac.setDescription('Represents the MAC address of the peer neighbor.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshLinkInMp.setDescription('Represents the interface index of mesh link that used to connect with this neighbor.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshMPLinkStatus.setDescription('Represents the status of mesh link that used to connect with this neighbor.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshNbrChannel.setDescription('Represents the channel number used by this neighbor.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshNbrLinkDuration.setDescription('Represents the duration of mesh link that used to connect with this neighbor.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshNbrRSSI.setDescription('Represents the RSSI of mesh link that used to connect with this neighbor.')
...
if mibBuilder.loadTexts: hh3cDot11sMeshNbrSNR.setDescription('Represents the SNR of mesh link that used to connect with this neighbor.')
mibBuilder.exportSymbols("HH3C-DOT11S-MESH-MIB", hh3cDot11sMeshLinkStatusTable=hh3cDot11sMeshLinkStatusTable, hh3cDot11sMpPlcyIndex=hh3cDot11sMpPlcyIndex, hh3cDot11sMeshNbrRadioID=hh3cDot11sMeshNbrRadioID, hh3cDot11sMlspProxyMac=hh3cDot11sMlspProxyMac, hh3cDot11sMeshPflRowStatus=hh3cDot11sMeshPflRowStatus, hh3cDot11sMeshLinkRxUniPkt=hh3cDot11sMeshLinkRxUniPkt, hh3cDot11sRadioCfgTable=hh3cDot11sRadioCfgTable, hh3cDot11sWDSPeerMacIndex=hh3cDot11sWDSPeerMacIndex, hh3cDot11sMeshGlobalPara=hh3cDot11sMeshGlobalPara, hh3cDot11sMpPlcyRowStatus=hh3cDot11sMpPlcyRowStatus, hh3cDot11sMeshLinkTxDi