...
mibBuilder.exportSymbols("Nortel-MsCarrier-MscPassport-StandardTextualConventionsMIB", DisplayString=DisplayString, DesignatedRouterPriority=DesignatedRouterPriority, FddiSMTStationIdType=FddiSMTStationIdType, AutonomousType=AutonomousType, standardTextualConventionsCapabilities=standardTextualConventionsCapabilities, Gauge32=Gauge32, Validation=Validation, standardTextualConventionsGroupCA=standardTextualConventionsGroupCA, Timeout=Timeout, HelloRange=HelloRange, RowStatus=RowStatus, InterfaceIndex=InterfaceIndex, standardTextualConventionsCapabilitiesCA01=standardTextualConventionsCapabilitiesCA01, BigMetric=BigMetric, BridgeId=BridgeId, Unsigned32=Unsigned32, DLCI=DLCI, AreaID=AreaID, standardTextualConventionsCapabilitiesCA01A=standardTextualConventionsCapabilitiesCA01A, Status=Status, TAddress=TAddress, UpToMaxAge=UpToMaxAge, TruthValue=TruthValue, FddiResourceId=FddiResourceId, Metric=Metric, X121Address=X121Address, RouterID=RouterID, FddiMACLongAddressType=FddiMACLongAddressType, Integer32=Integer32, VariablePointer=VariablePointer, RowPointer=RowPointer, PhysAddress=PhysAddress, IANAifType=IANAifType, FddiTimeNano=FddiTimeNano, standardTextualConventionsMIB=standardTextualConventionsMIB, TOSType=TOSType, standardTextualConventionsGroupCA01A=standardTextualConventionsGroupCA01A, standardTextualConventionsGroup=standardTextualConventionsGroup, standardTextualConventionsGroupCA01=standardTextualConventionsGroupCA01, PositiveInteger=PositiveInteger, Counter32=Counter32, DateAndTime=DateAndTime, TimeStamp=TimeStamp, TimeInterval=TimeInterval, MacAddress=MacAddress, NsapAddress=NsapAddress, StorageType=StorageType, standardTextualConventionsCapabilitiesCA=standardTextualConventionsCapabilitiesCA, TestAndIncr=TestAndIncr, FddiTimeMilli=FddiTimeMilli)
