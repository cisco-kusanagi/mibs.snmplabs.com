...
# Produced by pysmi-0.3.4 at Wed May  1 11:20:37 2019
...
SNPAAddress, isisISAdjEntry, isisSysInstance, isisISAdjState, SystemID, isisSysL2State, isisSysL1State, isisManAreaAddrExistState = mibBuilder.importSymbols("ISIS-MIB", "SNPAAddress", "isisISAdjEntry", "isisSysInstance", "isisISAdjState", "SystemID", "isisSysL2State", "isisSysL1State", "isisManAreaAddrExistState")
ModuleCompliance, ObjectGroup, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "ObjectGroup", "NotificationGroup")
IpAddress, ObjectIdentity, Counter64, TimeTicks, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, MibIdentifier, ModuleIdentity, Bits, Integer32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ObjectIdentity", "Counter64", "TimeTicks", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "MibIdentifier", "ModuleIdentity", "Bits", "Integer32", "iso", "Unsigned32")
RowStatus, TimeInterval, TruthValue, TimeStamp, DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeInterval", "TruthValue", "TimeStamp", "DisplayString", "TextualConvention")
...
if mibBuilder.loadTexts: vRtrIsisSpfWait.setDescription('The value of vRtrIsisSpfWait defines the Maximum interval between two consecutive spf calculations in seconds.')
...
mibBuilder.exportSymbols("ALCATEL-ISIS-MIB", vRtrIsisInetSummPrefix=vRtrIsisInetSummPrefix, vRtrIsisOperState=vRtrIsisOperState, vRtrIsisOwnLSPPurge=vRtrIsisOwnLSPPurge, vRtrIsisOverloadOnBootTimeout=vRtrIsisOverloadOnBootTimeout, vRtrIsisPDUFragment=vRtrIsisPDUFragment, vRtrIsisAdjV3v0Group=vRtrIsisAdjV3v0Group, vRtrIsisAdjV4v0Group=vRtrIsisAdjV4v0Group, vRtrIsisLSPBuff=vRtrIsisLSPBuff, vRtrIsisISAdjExpiresIn=vRtrIsisISAdjExpiresIn, vRtrIsisLSPRecd=vRtrIsisLSPRecd, vRtrIsisManualAddressDrops=vRtrIsisManualAddressDrops, vRtrIsisIfLevelHelloTimer=vRtrIsisIfLevelHelloTimer, vRtrIsisIfLspPacingInterval=vRtrIsisIfLspPacingInterval, vRtrIsisIfLevelNumAdjacencies=vRtrIsisIfLevelNumAdjacencies, vRtrIsisISAdjNeighborIPv6Type=vRtrIsisISAdjNeighborIPv6Type, vRtrIsisOrigLSPBufSizeMismatch=vRtrIsisOrigLSPBufSizeMismatch, vRtrIsisSpfWait=vRtrIsisSpfWait, vRtrIsisInetRoutePrefixLength=vRtrIsisInetRoutePrefixLength, vRtrIsisMIBConformance=vRtrIsisMIBConformance, vRtrIsisPSNPSent=vRtrIsisPSNPSent, vRtrIsisRouteType=vRtrIsisRouteType, vRtrIsisInetSummaryTable=vRtrIsisInetSummaryTable, vRtrIsisRouteMask=vRtrIsisRouteMask, vRtrIsisIfObjs=vRtrIsisIfObjs, vRtrIsisSpfTriggerReason=vRtrIsisSpfTriggerReason, vRtrIsisProtocolsSupported=vRtrIsisProtocolsSupported, vRtrIsisCSPFRequests=vRtrIsisCSPFRequests, vRtrIsisPathIfIndex=vRtrIsisPathIfIndex, vRtrIsisSpfHoldTime=vRtrIsisSpfHoldTime, vRtrIsisDatabaseClearObjs=vRtrIsisDatabaseClearObjs, vRtrIsisScalarObjs=vRtrIsisScalarObjs, vRtrIsisISAdjNeighborIP=vRtrIsisISAdjNeighborIP, vRtrIsisRouteDest=vRtrIsisRouteDest, vRtrIsisAreaMismatch=vRtrIsisAreaMismatch, vRtrIsisSpfInitialWait=vRtrIsisSpfInitialWait, vRtrIsisNotificationTable=vRtrIsisNotificationTable, vRtrIsisInetRouteSpfRunNumber=vRtrIsisInetRouteSpfRunNumber, vRtrIsisLSPDrop=vRtrIsisLSPDrop, vRtrIsisStatisticsClear=vRtrIsisStatisticsClear, vRtrIsisTable=vRtrIsisTable, vRtrIsisShortCuts=vRtrIsisShortCuts, vRtrIsisUnknownRecd=vRtrIsisUnknownRecd, vRtrIsisLSPMaxArea=vRtrIsisLSPMaxArea, vRtrIsisUnknownRetrans=vRtrIsisUnknownRetrans, vRtrIsisSummaryEntry=vRtrIsisSummaryEntry, vRtrIsisSummRowStatus=vRtrIsisSummRowStatus, vRtrIsisOriginatingBufferSize=vRtrIsisOriginatingBufferSize, vRtrIsisLSPDatabaseClear=vRtrIsisLSPDatabaseClear, vRtrIsisRouteNexthopIP=vRtrIsisRouteNexthopIP, vRtrIsisPathNHopSysID=vRtrIsisPathNHopSysID, vRtrIsisLSPClear=vRtrIsisLSPClear, vRtrIsisLSPSent=vRtrIsisLSPSent, vRtrIsisPsnpAuthentication=vRtrIsisPsnpAuthentication, vRtrIsisLevelOverloadStatus=vRtrIsisLevelOverloadStatus, vRtrIsisCSNPDrop=vRtrIsisCSNPDrop, vRtrIsisNotificationObjGroup=vRtrIsisNotificationObjGroup, vRtrIsisDBClearObjsGroup=vRtrIsisDBClearObjsGroup, vRtrIsisIfLastChangeTime=vRtrIsisIfLastChangeTime, vRtrIsisIfTable=vRtrIsisIfTable, vRtrIsisInetRouteDestType=vRtrIsisInetRouteDestType, vRtrIsisAdjDatabaseClear=vRtrIsisAdjDatabaseClear, vRtrIsisSpfLastTriggerLSPId=vRtrIsisSpfLastTriggerLSPId, vRtrIsisLastSpfRun=vRtrIsisLastSpfRun, vRtrIsisIfLevelTable=vRtrIsisIfLevelTable, vRtrIsisIfLevelPassive=vRtrIsisIfLevelPassive, vRtrIsisLspInitialWait=vRtrIsisLspInitialWait, vRtrIsisRouteLevel=vRtrIsisRouteLevel, vRtrIsisRouteTable=vRtrIsisRouteTable, vRtrIsisGracefulRestart=vRtrIsisGracefulRestart, vRtrIsisInetRouteLevel=vRtrIsisInetRouteLevel, vRtrIsisStatsEntry=vRtrIsisStatsEntry, vRtrIsisIfEntry=vRtrIsisIfEntry, vRtrIsisIfLevelOperMetric=vRtrIsisIfLevelOperMetric, vRtrIsisLSPAttributes=vRtrIsisLSPAttributes, vRtrIsisCSPFPathsFound=vRtrIsisCSPFPathsFound, vRtrIsisPathMetric=vRtrIsisPathMetric, vRtrIsisStatsTable=vRtrIsisStatsTable, vRtrIsisLSPTooLargeToPropagate=vRtrIsisLSPTooLargeToPropagate, vRtrIsisISAdjRestartSupport=vRtrIsisISAdjRestartSupport, vRtrIsisISAdjNeighborIpv6=vRtrIsisISAdjNeighborIpv6, vRtrIsisSystemObjs=vRtrIsisSystemObjs, vRtrIsisHostname=vRtrIsisHostname, vRtrIsisSummPrefix=vRtrIsisSummPrefix, vRtrIsisSpfEventCount=vRtrIsisSpfEventCount, vRtrIsisSummMask=vRtrIsisSummMask, vRtrIsisLSPAllocLen=vRtrIsisLSPAllocLen, vRtrIsisISAdjNumRestarts=vRtrIsisISAdjNumRestarts, vRtrIsisSpfL1Nodes=vRtrIsisSpfL1Nodes, vRtrIsisIfOperState=vRtrIsisIfOperState, vRtrIsisNotificationV3v0Group=vRtrIsisNotificationV3v0Group, vRtrIsisAuthType=vRtrIsisAuthType, vRtrIsisISAdjCircLevel=vRtrIsisISAdjCircLevel, vRtrIsisSpfGroup=vRtrIsisSpfGroup, vRtrIsisOverloadTimeout=vRtrIsisOverloadTimeout, vRtrIsisIfTypeDefault=vRtrIsisIfTypeDefault, vRtrIsisCSNPSent=vRtrIsisCSNPSent, vRtrIsisLevelHelloAuthentication=vRtrIsisLevelHelloAuthentication, vRtrIsisISAdjTable=vRtrIsisISAdjTable, vRtrIsisInetRouteType=vRtrIsisInetRouteType, vRtrIsisInetSummPrefixLength=vRtrIsisInetSummPrefixLength, vRtrIsisAdjObjs=vRtrIsisAdjObjs, vRtrIsisAutTypeFail=vRtrIsisAutTypeFail, vRtrIsisAdjacencyChange=vRtrIsisAdjacencyChange, vRtrIsisRouteV4v0Group=vRtrIsisRouteV4v0Group, vRtrIsisIfAdminState=vRtrIsisIfAdminState, vRtrIsisLSPVersion=vRtrIsisLSPVersion, vRtrIsisIfLevelLastChangeTime=vRtrIsisIfLevelLastChangeTime, vRtrIsisSystemLevel=vRtrIsisSystemLevel, vRtrIsisMIBConformances=vRtrIsisMIBConformances, vRtrIsisLSPEntry=vRtrIsisLSPEntry, vRtrIsisDatabaseOverload=vRtrIsisDatabaseOverload, vRtrIsisCSPFDroppedRequests=vRtrIsisCSPFDroppedRequests, vRtrIsisStrictAdjacencyCheck=vRtrIsisStrictAdjacencyCheck, vRtrIsisLSPSize=vRtrIsisLSPSize, vRtrIsisPathID=vRtrIsisPathID, vRtrIsisIfRowStatus=vRtrIsisIfRowStatus, vRtrIsisLspLifetime=vRtrIsisLspLifetime, vRtrIsisLSPSysIdLen=vRtrIsisLSPSysIdLen, vRtrIsisIfLevelAdminMetric=vRtrIsisIfLevelAdminMetric, vRtrIsisLSPGroup=vRtrIsisLSPGroup, vRtrIsisLSPSeq=vRtrIsisLSPSeq, vRtrIsisV3v0Group=vRtrIsisV3v0Group, vRtrIsisIfLevelISPriority=vRtrIsisIfLevelISPriority, vRtrIsisIIHRetrans=vRtrIsisIIHRetrans, vRtrIsisCSNPRetrans=vRtrIsisCSNPRetrans, vRtrIsisIfRetransmitInterval=vRtrIsisIfRetransmitInterval, vRtrIsisISAdjRestartSupressed=vRtrIsisISAdjRestartSupressed, vRtrIsisDatabaseClearEntry=vRtrIsisDatabaseClearEntry, vRtrIsisGRHelperMode=vRtrIsisGRHelperMode, vRtrIsisIDLenMismatch=vRtrIsisIDLenMismatch, vRtrIsisPathTable=vRtrIsisPathTable, vRtrIsisSpfLogTable=vRtrIsisSpfLogTable, vRtrIsisFieldLen=vRtrIsisFieldLen, vRtrIsisHostnameEntry=vRtrIsisHostnameEntry, vRtrIsisMIBV3v0Compliance=vRtrIsisMIBV3v0Compliance, vRtrIsisLevelPsnpAuthentication=vRtrIsisLevelPsnpAuthentication, vRtrIsisLevelNumLSPs=vRtrIsisLevelNumLSPs, vRtrIsisLSPUsedLen=vRtrIsisLSPUsedLen, vRtrIsisLSPLifetimeRemain=vRtrIsisLSPLifetimeRemain, vRtrIsisIfHelloAuthKey=vRtrIsisIfHelloAuthKey, vRtrIsisSpfLogEntry=vRtrIsisSpfLogEntry, vRtrIsisInitiatedPurges=vRtrIsisInitiatedPurges, vRtrIsisLevelEntry=vRtrIsisLevelEntry, vRtrIsisIfLevelHelloAuthKey=vRtrIsisIfLevelHelloAuthKey, vRtrIsisLSPRetrans=vRtrIsisLSPRetrans, vRtrIsisScalarObjsGroup=vRtrIsisScalarObjsGroup, vRtrIsisLSPTable=vRtrIsisLSPTable, vRtrIsisAuthKey=vRtrIsisAuthKey, vRtrIsisAuthCheck=vRtrIsisAuthCheck, vRtrIsisRouteSpfVersion=vRtrIsisRouteSpfVersion, vRtrIsisLspSecondWait=vRtrIsisLspSecondWait, vRtrIsisInetSummPrefixType=vRtrIsisInetSummPrefixType, vRtrIsisMaxAreaAddress=vRtrIsisMaxAreaAddress, vRtrIsisMIBCompliance=vRtrIsisMIBCompliance, vRtrIsisPathGroup=vRtrIsisPathGroup, vRtrIsisInetSummaryEntry=vRtrIsisInetSummaryEntry, vRtrIsisPathEntry=vRtrIsisPathEntry, vRtrIsisHostGroup=vRtrIsisHostGroup, vRtrIsisSysID=vRtrIsisSysID, vRtrIsisSummLevel=vRtrIsisSummLevel, vRtrIsisLspMaxWait=vRtrIsisLspMaxWait, vRtrIsisIfIndex=vRtrIsisIfIndex, vRtrIsisR2r1Group=vRtrIsisR2r1Group, vRtrIsisInetRouteDest=vRtrIsisInetRouteDest, vRtrIsisPathSNPA=vRtrIsisPathSNPA, vRtrIsisIfCircIndex=vRtrIsisIfCircIndex, vRtrIsisProtocolVersion=vRtrIsisProtocolVersion, vRtrIsisEntry=vRtrIsisEntry, vRtrIsisIfCsnpInterval=vRtrIsisIfCsnpInterval, vRtrIsisSequenceNumberSkip=vRtrIsisSequenceNumberSkip, timetraIsisMIBModule=timetraIsisMIBModule, vRtrIsisInetRouteNexthopIPType=vRtrIsisInetRouteNexthopIPType, vRtrIsisISAdjLastRestartTime=vRtrIsisISAdjLastRestartTime, vRtrIsisNotifications=vRtrIsisNotifications, vRtrIsisCsnpAuthentication=vRtrIsisCsnpAuthentication, vRtrIsisLevelCsnpAuthentication=vRtrIsisLevelCsnpAuthentication, vRtrIsisSpfRunTime=vRtrIsisSpfRunTime, vRtrIsisIIHDrop=vRtrIsisIIHDrop, vRtrIsisInetRouteNexthopIP=vRtrIsisInetRouteNexthopIP, vRtrIsisLevelAuthKey=vRtrIsisLevelAuthKey, vRtrIsisIfLevelHelloAuthType=vRtrIsisIfLevelHelloAuthType, vRtrIsisLSPId=vRtrIsisLSPId, vRtrIsisProtoSuppMismatch=vRtrIsisProtoSuppMismatch, TmnxOperState=TmnxOperState, vRtrIsisIfV4v0Group=vRtrIsisIfV4v0Group, vRtrIsisIfLevel=vRtrIsisIfLevel, vRtrIsisOverloadOnBoot=vRtrIsisOverloadOnBoot, vRtrIsisIfLevelTeMetric=vRtrIsisIfLevelTeMetric, vRtrIsisLSPPktType=vRtrIsisLSPPktType, vRtrIsisSpfRuns=vRtrIsisSpfRuns, vRtrIsisAdjGroup=vRtrIsisAdjGroup, vRtrIsisMIBV4v0Compliance=vRtrIsisMIBV4v0Compliance, vRtrIsisSpfClear=vRtrIsisSpfClear, vRtrIsisRejectedAdjacency=vRtrIsisRejectedAdjacency, vRtrIsisGroup=vRtrIsisGroup, vRtrIsisLevelAuthType=vRtrIsisLevelAuthType, vRtrIsisMaxSeqExceedAttempt=vRtrIsisMaxSeqExceedAttempt, vRtrIsisVersionSkew=vRtrIsisVersionSkew, vRtrIsisSpfL2Nodes=vRtrIsisSpfL2Nodes, vRtrIsisLevelWideMetricsOnly=vRtrIsisLevelWideMetricsOnly, vRtrIsisCorruptedLSPDetected=vRtrIsisCorruptedLSPDetected, vRtrIsisPSNPRetrans=vRtrIsisPSNPRetrans, vRtrIsisSummaryV4v0Group=vRtrIsisSummaryV4v0Group, vRtrIsisPSNPDrop=vRtrIsisPSNPDrop, vRtrIsisInetRouteEntry=vRtrIsisInetRouteEntry, vRtrIsisAdjRestartStatusChange=vRtrIsisAdjRestartStatusChange, vRtrIsisGRRestartDuration=vRtrIsisGRRestartDuration, vRtrIsisMIBGroups=vRtrIsisMIBGroups, vRtrIsisRouteGroup=vRtrIsisRouteGroup, vRtrIsisNotificationsGroup=vRtrIsisNotificationsGroup, vRtrIsisSummaryTable=vRtrIsisSummaryTable, vRtrIsisTrapLSPID=vRtrIsisTrapLSPID, vRtrIsisLSPZeroRLT=vRtrIsisLSPZeroRLT, vRtrIsisDatabaseClearTable=vRtrIsisDatabaseClearTable, vRtrIsisObjs=vRtrIsisObjs, vRtrIsisLevel=vRtrIsisLevel, vRtrIsisNotificationObjs=vRtrIsisNotificationObjs, vRtrIsisHostnameTable=vRtrIsisHostnameTable, PYSNMP_MODULE_ID=timetraIsisMIBModule, vRtrIsisHelloAuthentication=vRtrIsisHelloAuthentication, vRtrIsisRouteNHopSysID=vRtrIsisRouteNHopSysID, TmnxAdminState=TmnxAdminState, vRtrIsisIfHelloAuthType=vRtrIsisIfHelloAuthType, vRtrIsisIIHRecd=vRtrIsisIIHRecd, vRtrIsisPSNPRecd=vRtrIsisPSNPRecd, vRtrIsisUnknownDrop=vRtrIsisUnknownDrop, vRtrIsisInetRouteMetric=vRtrIsisInetRouteMetric, vRtrIsisRouteEntry=vRtrIsisRouteEntry, vRtrIsisISAdjRestartStatus=vRtrIsisISAdjRestartStatus, vRtrIsisInetRouteNHopSysID=vRtrIsisInetRouteNHopSysID, vRtrIsisInetSummRowStatus=vRtrIsisInetSummRowStatus, vRtrIsisMaxAreaAddrsMismatch=vRtrIsisMaxAreaAddrsMismatch, vRtrIsisSpfTimeStamp=vRtrIsisSpfTimeStamp, vRtrIsisAuthFail=vRtrIsisAuthFail, vRtrIsisISAdjClear=vRtrIsisISAdjClear, vRtrIsisCircIdExhausted=vRtrIsisCircIdExhausted, vRtrIsisLastEnabledTime=vRtrIsisLastEnabledTime, vRtrIsisCSNPRecd=vRtrIsisCSNPRecd, vRtrIsisInetSummLevel=vRtrIsisInetSummLevel, vRtrIsisLevelOverloadTimeLeft=vRtrIsisLevelOverloadTimeLeft, vRtrIsisMIBR2r1Compliance=vRtrIsisMIBR2r1Compliance, vRtrIsisRouteMetric=vRtrIsisRouteMetric, vRtrIsisSpfSecondWait=vRtrIsisSpfSecondWait, vRtrIsisSummaryGroup=vRtrIsisSummaryGroup, vRtrIsisIfLevelEntry=vRtrIsisIfLevelEntry, vRtrIsisUnknownSent=vRtrIsisUnknownSent, vRtrIsisLSPChecksum=vRtrIsisLSPChecksum, vRtrIsisV4v0Group=vRtrIsisV4v0Group, vRtrIsisInetRouteTable=vRtrIsisInetRouteTable, vRtrIsisLSPRegenerations=vRtrIsisLSPRegenerations, vRtrIsisIIHSent=vRtrIsisIIHSent, vRtrIsisIfGroup=vRtrIsisIfGroup, vRtrIsisLevelTable=vRtrIsisLevelTable, vRtrIsisISAdjEntry=vRtrIsisISAdjEntry)
mibBuilder.exportSymbols("ALCATEL-ISIS-MIB", vRtrIsisCSPFPathsNotFound=vRtrIsisCSPFPathsNotFound, vRtrIsisLSPPktVersion=vRtrIsisLSPPktVersion, vRtrIsisNotificationEntry=vRtrIsisNotificationEntry)
