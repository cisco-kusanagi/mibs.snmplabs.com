...
ospfAreaEntry, ospfVirtIfEntry, ospfIfEntry, RouterID = mibBuilder.importSymbols("OSPF-MIB", "ospfAreaEntry", "ospfVirtIfEntry", "ospfIfEntry", "RouterID")
rip2IfConfEntry, = mibBuilder.importSymbols("RIPv2-MIB", "rip2IfConfEntry")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
IpAddress, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, TimeTicks, Integer32, Counter32, ObjectIdentity, MibIdentifier, Bits, iso, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "TimeTicks", "Integer32", "Counter32", "ObjectIdentity", "MibIdentifier", "Bits", "iso", "Gauge32", "Unsigned32")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: fastPathRouting.setRevisionsDescriptions(('Postal address updated.', 'Dell branding related changes.', 'Revisions made for new release.', 'Updated for release',))
...
if mibBuilder.loadTexts: fastPathRouting.setContactInfo('')
if mibBuilder.loadTexts: fastPathRouting.setDescription('The Dell Networking Private MIB for Routing')
...
if mibBuilder.loadTexts: agentSwitchIpDefaultGateway.setDescription('Specifies the Default Gateway manually configured.')
...
if mibBuilder.loadTexts: agentSwitchDhcpOperation.setDescription('Renew or Release the IP Address learned through DHCP. Get on this object always gives none. none means no operation is performed on dhcp.')
...
if mibBuilder.loadTexts: agentSwitchIpInterfaceSuppressed.setDescription(" This mib variable contains the following values, which has the meaning as: 'unsuppressed' - The interface is not suppressed 'suppressed' - The interface is suppressed ")
...
if mibBuilder.loadTexts: agentSwitchIpInterfaceNumberOfFlaps.setDescription('This mib variable displays the number of flaps occurred on the interface')
...
if mibBuilder.loadTexts: agentSwitchIpInterfaceCurrentPenalty.setDescription('This mib variable displays the current penalty of an interface')
...
if mibBuilder.loadTexts: agentSwitchIpInterfaceReUseTime.setDescription('This mib variable displays the number of seconds until the interface is allowed to come up ')
...
if mibBuilder.loadTexts: agentSwitchClearIpDefaultGateway.setDescription('Resets the Global Default Gateway address.')
...
if mibBuilder.loadTexts: agentRouterRipDefaultMetric.setDescription('Default metric of redistributed routes, when RIP redistributes from other protocols. {0} indicates that the parameter is not configured, this value should not be set. Valid range for set is (1..15).')
...
if mibBuilder.loadTexts: agentRouterRipDefaultMetricConfigured.setDescription("Flag to determine whether RIP default-metric is configured or not. Set to 'false' to unconfigure the default route metric. Set to 'true' is not allowed.")
...
if mibBuilder.loadTexts: agentRipRouteRedistMetric.setDescription('Metric used for redistributing a particular source protocol route into RIP. {0} indicates that the parameter is not configured, this value should not be set. Valid range for set is (1..15).')
...
if mibBuilder.loadTexts: agentRipRouteRedistMetricConfigured.setDescription("Flag to determine whether RIP redistribute-metric is configured or not. Set to 'false' to unconfigure redistribute metric. Set to 'true' is not allowed.")
...
if mibBuilder.loadTexts: agentRipRouteRedistDistList.setDescription('Access-list number of the access-list, which filters routes received from a source-protocol. A value of 0 indicates no distribute list is configured.')
...
if mibBuilder.loadTexts: agentOspfDefaultMetric.setDescription('Default metric of redistributed routes, when OSPF redistributes from other protocols. {0} indicates that the parameter is not configured, this value should not be set. Valid range for set is (1..16777214).')
...
if mibBuilder.loadTexts: agentOspfDefaultMetricConfigured.setDescription("Flag to determine whether OSPF default-metric is configured or not. Set to 'false' to unconfigure the OSPF default-metric. Set to 'true' is not allowed.")
...
if mibBuilder.loadTexts: agentOspfDefaultInfoOriginateMetricConfigured.setDescription('Flag to determine whether OSPF default-info originate metric is configured or not. Setting to false unconfigures the default route metric. Setting to true is not allowed.')
...
if mibBuilder.loadTexts: agentBootpDhcpRelayCheckReply.setDescription('The BOOTP/DHCP relay option validity check in BOOTREPLY message. This flag is set to enable/disable the check for Circuit ID sub-options.')
...
if mibBuilder.loadTexts: agentBootpDhcpRelayIntfTable.setDescription('This table contains the per-interface configuration parameters for Dhcp Relay agent.')
...
if mibBuilder.loadTexts: agentBootpDhcpRelayIntfEntry.setDescription('Represents a logical row in the agentBootpDhcpRelayIntfTable')
...
if mibBuilder.loadTexts: agentBootpVlanId.setDescription("The Vlan's Id.")
...
if mibBuilder.loadTexts: agentBootpDhcpRelayIntfCircuitIdOptionMode.setDescription('The BOOTP/DHCP Circuit ID Option Mode. This flag is set to enable/disable the network element to add/remove the DHCP Relay agent Circuit ID sub-options at interface level.')
...
if mibBuilder.loadTexts: agentBootpDhcpRelayIntfCheckReply.setDescription('The BOOTP/DHCP Relay reply check. This flag is set to enable/disable the network element at interface level.')
...
if mibBuilder.loadTexts: agentOspfQueueTable.setDescription('Table lists information about OSPFv2 message queue utilization.')
...
if mibBuilder.loadTexts: agentOspfQueueEntry.setDescription('Information on a specific OSPFv2 message queue.')
...
if mibBuilder.loadTexts: agentOspfQueueIndex.setDescription('Index value for this message queue.')
...
if mibBuilder.loadTexts: agentOspfQueueName.setDescription('Name of an OSPFv2 message queue.')
...
if mibBuilder.loadTexts: agentOspfQueueLength.setDescription('The number of messages currently in the message queue.')
...
if mibBuilder.loadTexts: agentOspfQueueHigh.setDescription('The high water mark of the number of messages in the message queue.')
...
if mibBuilder.loadTexts: agentOspfQueueDrops.setDescription('The number of items dropped because the message queue was full.')
...
if mibBuilder.loadTexts: agentOspfQueueLimit.setDescription('The maximum number of messages this queue can hold.')
...
if mibBuilder.loadTexts: agentOspfCountersCleared.setDescription('The time since OSPFv2 counters were last cleared, in seconds.')
...
if mibBuilder.loadTexts: agentOspfLsaRetxCount.setDescription('The total number of LSAs retransmitted since OSPF counters were last cleared. If the same LSA is retransmitted to multiple neighbors, the count is incremented for each neighbor.')
...
if mibBuilder.loadTexts: agentOspfHellosRx.setDescription('The total number of OSPFv2 Hello packets received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfHellosTx.setDescription('The total number of OSPFv2 Hello packets transmitted since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfDdRx.setDescription('The total number of OSPFv2 Database Description packets received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfDdTx.setDescription('The total number of OSPFv2 Database Description packets transmitted since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfLsReqRx.setDescription('The total number of OSPFv2 LS Request packets received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfLsReqTx.setDescription('The total number of OSPFv2 LS Request packets transmitted since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfLsUpdatesRx.setDescription('The total number of OSPFv2 LS Update packets received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfLsUpdatesTx.setDescription('The total number of OSPFv2 LS Update packets transmitted since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfLsAckRx.setDescription('The total number of OSPFv2 LS Acknowledgement packets received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfLsAckTx.setDescription('The total number of OSPFv2 LS Acknowledgement packets transmitted since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfLsUpdatesTxMax.setDescription('The maximum rate of OSPFv2 LS Update packets transmitted over any 5-second interval since OSPF counters were last cleared. The rate is given in packets per second (that is, the number of packets transmitted during the 5-second interval, divided by 5).')
...
if mibBuilder.loadTexts: agentOspfType1LsasRx.setDescription('The number of type 1 (router) LSAs received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfType2LsasRx.setDescription('The number of type 2 (network) LSAs received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfType3LsasRx.setDescription('The number of type 3 (network summary) LSAs received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfType4LsasRx.setDescription('The number of type 4 (ASBR summary) LSAs received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfType5LsasRx.setDescription('The number of type 5 (external) LSAs received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfType7LsasRx.setDescription('The number of type 7 (NSSA external) LSAs received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfType9LsasRx.setDescription('The number of type 9 (Link Opaque) LSAs received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfType10LsasRx.setDescription('The number of type 10 (Area Opaque) LSAs received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfType11LsasRx.setDescription('The number of type 11 (AS Opaque) LSAs received since OSPF counters were last cleared.')
...
if mibBuilder.loadTexts: agentOspfSpfStatsTable.setDescription('Contains statistics for the twenty most recent SPF runs. Statistics are reported from the oldest SPF first to the most recent.')
...
if mibBuilder.loadTexts: agentOspfSpfStatsEntry.setDescription('Statistics for a single SPF run.')
...
if mibBuilder.loadTexts: agentOspfSpfIndex.setDescription('Integer that uniquely identifies an SPF run. This value is incremented each time OSPF runs a full routing table calculation.')
...
if mibBuilder.loadTexts: agentOspfSpfStatsDeltaT.setDescription('How long since this routing table calculation ran. The time is given in seconds.')
...
if mibBuilder.loadTexts: agentOspfSpfStatsIntra.setDescription('Number of milliseconds to compute intra-area routes.')
...
if mibBuilder.loadTexts: agentOspfSpfStatsSumm.setDescription('Number of milliseconds to compute inter-area routes.')
...
if mibBuilder.loadTexts: agentOspfSpfStatsExt.setDescription('Number of milliseconds to compute external routes.')
...
if mibBuilder.loadTexts: agentOspfSpfStatsSpfTotal.setDescription('Number of milliseconds for entire routing table calculation.')
...
if mibBuilder.loadTexts: agentOspfSpfStatsRibUpdate.setDescription('Number of milliseconds to update the common routing table.')
...
if mibBuilder.loadTexts: agentOspfSpfStatsReason.setDescription('Reasons why a routing table calculation was required. R - new router LSA, N - new Network LSA, SN - new network summary LSA, SA - new ASBR summary LSA, X - new external LSA.')
...
if mibBuilder.loadTexts: agentRoutingHeapSize.setDescription('The size of the routing heap, in bytes. Unicast routing protocols and ARP allocate memory from the routing heap.')
...
if mibBuilder.loadTexts: agentRoutingHeapInUse.setDescription('The number of bytes currently allocated from the routing heap.')
...
if mibBuilder.loadTexts: agentRoutingHeapHigh.setDescription('High water mark for the number of bytes allocated from the routing heap.')
...
if mibBuilder.loadTexts: agentConnectedRoutes.setDescription('The number of connected routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentStaticRoutes.setDescription('The number of static routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentRipRoutes.setDescription('The number of RIP routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentOspfRoutes.setDescription('The number of OSPFv2 routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentOspfIntraRoutes.setDescription('The number of OSPFv2 intra-area routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentOspfInterRoutes.setDescription('The number of OSPFv2 inter-area routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentOspfExt1Routes.setDescription('The number of OSPFv2 external type 1 routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentOspfExt2Routes.setDescription('The number of OSPFv2 external type 2 routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentBgpRoutes.setDescription('The number of BGP routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentEbgpRoutes.setDescription('The number of external BGP routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentIbgpRoutes.setDescription('The number of internal BGP routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentLocalBgpRoutes.setDescription('The number of local BGP routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentRejectRoutes.setDescription('The number of reject routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentTotalRoutes.setDescription('The number of routes in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentBestRoutes.setDescription('The number of IPv4 routes in the forwarding table.')
...
if mibBuilder.loadTexts: agentBestRoutesHigh.setDescription('The highest number of IPv4 routes in the forwarding table.')
...
if mibBuilder.loadTexts: agentAlternateRoutes.setDescription('The number of alternate routes in the IPv4 routing table. An alternate route is less preferred than the best route and is not used for forwarding.')
...
if mibBuilder.loadTexts: agentRouteAdds.setDescription('The number of routes added to the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentRouteModifies.setDescription('The number of routes changed in the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentRouteDeletes.setDescription('The number of routes removed from the IPv4 routing table.')
...
if mibBuilder.loadTexts: agentUnresolvedRouteAdds.setDescription("The number of IPv4 route adds that failed because none of the route's next hops were on a local subnet.")
...
if mibBuilder.loadTexts: agentInvalidRouteAdds.setDescription('The number of IPv4 routes adds that failed because the route was invalid.')
...
if mibBuilder.loadTexts: agentFailedRouteAdds.setDescription('The number of IPv4 routes adds that failed because of a resource limitation in the routing table')
...
if mibBuilder.loadTexts: agentReservedLocals.setDescription('The number of IPv4 routing table entries reserved for a local subnet on a routing interface that is down. ')
...
if mibBuilder.loadTexts: agentUniqueNextHops.setDescription('The number of distinct next hops used among all IPv4 routes currently in the routing table. These include local interfaces for local routes and neighbors for indirect routes.')
...
if mibBuilder.loadTexts: agentUniqueNextHopsHigh.setDescription('The highest count of unique next hops since counters were last cleared.')
...
if mibBuilder.loadTexts: agentNextHopGroups.setDescription('The current number of next hop groups in use by one or more routes. Each next hop group includes one or more next hops.')
...
if mibBuilder.loadTexts: agentNextHopGroupsHigh.setDescription('The highest count of next hop groups since counters were last cleared.')
...
if mibBuilder.loadTexts: agentEcmpGroups.setDescription('The number of next hop groups with multiple next hops.')
...
if mibBuilder.loadTexts: agentEcmpGroupsHigh.setDescription('The high water mark of the number of ECMP groups.')
...
if mibBuilder.loadTexts: agentEcmpRoutes.setDescription('The current number of IPv4 routes with multiple next hops.')
...
if mibBuilder.loadTexts: agentEcmpRetries.setDescription('The number of ECMP routes that have been installed in the forwarding table after initially being installed with a single next hop.')
...
if mibBuilder.loadTexts: agentEcmpCountTable.setDescription('A count of the number of routes with each number of ECMP next hops.')
...
if mibBuilder.loadTexts: agentEcmpCountEntry.setDescription('Number of IPv4 routes with a given number of next hops.')
...
if mibBuilder.loadTexts: agentEcmpNextHopCount.setDescription('The number of next hops in a route. From 0 to the maximum number of next hops in an ECMP route. The maximum varies by platform.')
...
if mibBuilder.loadTexts: agentEcmpRouteCount.setDescription('The number of IPv4 routes with agentEcmpNextHopCount next hops.')
...
if mibBuilder.loadTexts: ospfStubRouterAdvertisement.setDescription('Specifies how the router LSAs are advertised by the router. The value doNotAdvertise indicates the advertisement of a standard router LSA and is the default value. The value advertise indicates the advertisement of a stub router LSA.')
...
if mibBuilder.loadTexts: agentOspfStubRouterReason.setDescription("This indicates the reason because of which the router is in Stub mode. This is valid only if the agentOspfStubRouterMode is 'active'.")
...
if mibBuilder.loadTexts: agentOspfStubRouterStartupTimeRemaining.setDescription("The time remaining (in seconds) for the router to come out of the stub mode. This is valid only if the agentOspfStubRouterReason is 'startup'.")
...
if mibBuilder.loadTexts: agentOspfStubRouterDuration.setDescription("Time elapsed (in seconds) since the router last entered the stub router mode. This is valid only if the agentOspfStubRouterMode is 'active' and agentOspfStubRouterReason is 'resource-limitation'.")
...
if mibBuilder.loadTexts: vrfName.setDescription('A textual string containing the name of a VRF Instance.')
...
if mibBuilder.loadTexts: appName.setDescription('A textual string containing the name of an application.')
...
if mibBuilder.loadTexts: vrfMaxRoutesReachedTrap.setDescription('This trap is sent when an Virtual Router has its Route-Table full.')
...
if mibBuilder.loadTexts: vrfApplicationRestartedTrap.setDescription('This trap is sent when an application belonging to a particular Virtual Router re-started.')
mibBuilder.exportSymbols("DNOS-ROUTING-MIB", agentOspfLocalLsdbSequence=agentOspfLocalLsdbSequence, agentOspfRouteRedistMetric=agentOspfRouteRedistMetric, agentSwitchIPAddressConfigMethod=agentSwitchIPAddressConfigMethod, agentOspfType9LsasRx=agentOspfType9LsasRx, agentOspfIfAdvertiseSecondaries=agentOspfIfAdvertiseSecondaries, agentSwitchIntfIpHelperHitCount=agentSwitchIntfIpHelperHitCount, agentOspfQueueName=agentOspfQueueName, agentRoutingHeapInUse=agentRoutingHeapInUse, agentRouteModifies=agentRouteModifies, agentBootpDhcpRelayMaxHopCount=agentBootpDhcpRelayMaxHopCount, agentSwitchIntfArpIpAddress=agentSwitchIntfArpIpAddress, agentOspfRoutePrefExternal=agentOspfRoutePrefExternal, agentOspfAreaOpaqueLsdbSequence=agentOspfAreaOpaqueLsdbSequence, agentBootpDhcpRelayIntfEntry=agentBootpDhcpRelayIntfEntry, agentEcmpRouteCount=agentEcmpRouteCount, agentBootpDhcpRelayNumOfDiscards=agentBootpDhcpRelayNumOfDiscards, agentOspfRouteRedistMetricConfigured=agentOspfRouteRedistMetricConfigured, agentSwitchSecondaryAddressTable=agentSwitchSecondaryAddressTable, agentOspfAreaOpaqueLsdbLsid=agentOspfAreaOpaqueLsdbLsid, agentSwitchIpRouterDiscoveryEntry=agentSwitchIpRouterDiscoveryEntry, agentEcmpRoutes=agentEcmpRoutes, fastPathRoutingTraps=fastPathRoutingTraps, agentSwitchIpInterfaceIcmpUnreachables=agentSwitchIpInterfaceIcmpUnreachables, agentOspfAsLsdbTable=agentOspfAsLsdbTable, agentSwitchIpHelperAddressTable=agentSwitchIpHelperAddressTable, agentSwitchArpCacheSize=agentSwitchArpCacheSize, agentReservedLocals=agentReservedLocals, agentSwitchIpInterfaceProxyARPMode=agentSwitchIpInterfaceProxyARPMode, agentRouterVrrpAdminState=agentRouterVrrpAdminState, agentOspfRouteRedistTable=agentOspfRouteRedistTable, agentOspfRouteRedistDistList=agentOspfRouteRedistDistList, agentOspfSpfStatsRibUpdate=agentOspfSpfStatsRibUpdate, agentSwitchIpInterfaceSuppressed=agentSwitchIpInterfaceSuppressed, agentSwitchLocalProxyArpTable=agentSwitchLocalProxyArpTable, agentOspfStubRouterReason=agentOspfStubRouterReason, agentRouterRipDefaultInfoOriginate=agentRouterRipDefaultInfoOriginate, agentOspfAsLsdbType=agentOspfAsLsdbType, agentECMPOspfMaxPaths=agentECMPOspfMaxPaths, agentUdpClientMsgsRelayed=agentUdpClientMsgsRelayed, agentOspfLocalLsdbType=agentOspfLocalLsdbType, agentSwitchIntfIpHelperStatus=agentSwitchIntfIpHelperStatus, agentSwitchHelperAddressEntry=agentSwitchHelperAddressEntry, agentSwitchIpInterfaceBandwidth=agentSwitchIpInterfaceBandwidth, agentEcmpGroupsHigh=agentEcmpGroupsHigh, agentOspfRouteRedistSubnets=agentOspfRouteRedistSubnets, agentDhcpClientMsgsReceived=agentDhcpClientMsgsReceived, agentBootpDhcpRelayNumOfRequestsForwarded=agentBootpDhcpRelayNumOfRequestsForwarded, agentSwitchArpTotalEntryCountPeak=agentSwitchArpTotalEntryCountPeak, agentSwitchIpInterfaceIfIndex=agentSwitchIpInterfaceIfIndex, agentSwitchLocalProxyArpEntry=agentSwitchLocalProxyArpEntry, agentOspfAreaOpaqueLsdbAdvertisement=agentOspfAreaOpaqueLsdbAdvertisement, agentSwitchIpInterfaceIpAddress=agentSwitchIpInterfaceIpAddress, agentRouterVrrpOperPriority=agentRouterVrrpOperPriority, agentBootpDhcpRelayForwardMode=agentBootpDhcpRelayForwardMode, agentOspfStubRouterGroup=agentOspfStubRouterGroup, agentRoutingHeapSize=agentRoutingHeapSize, agentSwitchIpRouterDiscoveryIfIndex=agentSwitchIpRouterDiscoveryIfIndex, agentRouterVrrpOperEntry=agentRouterVrrpOperEntry, agentTotalRoutes=agentTotalRoutes, agentOspfRouteRedistTag=agentOspfRouteRedistTag, agentOspfExt1Routes=agentOspfExt1Routes, agentRouterRipRoutePref=agentRouterRipRoutePref, agentRipRouteRedistDistList=agentRipRouteRedistDistList, agentRipRouteRedistTable=agentRipRouteRedistTable, agentOspfLsAckTx=agentOspfLsAckTx, agentSwitchIntfIpHelperUdpPort=agentSwitchIntfIpHelperUdpPort, agentInvalidRouteAdds=agentInvalidRouteAdds, vrfMaxRoutesReachedTrap=vrfMaxRoutesReachedTrap, agentSwitchIpRouterDiscoveryAdvertisementAddress=agentSwitchIpRouterDiscoveryAdvertisementAddress, agentSwitchClearIpDefaultGateway=agentSwitchClearIpDefaultGateway, agentSwitchArpIpAddress=agentSwitchArpIpAddress, agentOspfAreaOpaqueLsdbRouterId=agentOspfAreaOpaqueLsdbRouterId, agentUniqueNextHops=agentUniqueNextHops, agentOspfLocalLsdbEntry=agentOspfLocalLsdbEntry, agentSwitchIpRouterDiscoveryAdvertisementLifetime=agentSwitchIpRouterDiscoveryAdvertisementLifetime, agentSwitchIpDefaultGateway=agentSwitchIpDefaultGateway, agentSwitchIpRouterDiscoveryPreferenceLevel=agentSwitchIpRouterDiscoveryPreferenceLevel, agentOspfVirtIfAuthKeyId=agentOspfVirtIfAuthKeyId, agentOspfSpfStatsIntra=agentOspfSpfStatsIntra, agentOspfDefaultInfoOriginateMetric=agentOspfDefaultInfoOriginateMetric, appName=appName, agentSwitchArpAge=agentSwitchArpAge, agentIbgpRoutes=agentIbgpRoutes, agentRoutingHeapHigh=agentRoutingHeapHigh, agentOspfStubRouterDuration=agentOspfStubRouterDuration, agentNextHopGroupsHigh=agentNextHopGroupsHigh, agentRouteDeletes=agentRouteDeletes, agentOspfRoutePrefIntraArea=agentOspfRoutePrefIntraArea, agentSwitchIpHelperStatus=agentSwitchIpHelperStatus, agentOspfRouteRedistSource=agentOspfRouteRedistSource, agentOspfAsLsdbAdvertisement=agentOspfAsLsdbAdvertisement, agentSwitchIntfIpHelperDiscard=agentSwitchIntfIpHelperDiscard, agentOspfLocalLsdbAdvertisement=agentOspfLocalLsdbAdvertisement, agentDhcpServerMsgsReceived=agentDhcpServerMsgsReceived, agentStaticRoutes=agentStaticRoutes, agentDhcpClientMsgsRelayed=agentDhcpClientMsgsRelayed, agentOspfLsReqTx=agentOspfLsReqTx, agentBootpDhcpRelayCircuitIdOptionMode=agentBootpDhcpRelayCircuitIdOptionMode, agentRouteAdds=agentRouteAdds, agentInternalVlanPolicy=agentInternalVlanPolicy, agentEcmpCountTable=agentEcmpCountTable, agentSwitchIpVlanId=agentSwitchIpVlanId, agentSwitchIpInterfaceIcmpRedirects=agentSwitchIpInterfaceIcmpRedirects, agentSwitchHelperIpAddress=agentSwitchHelperIpAddress, agentRipRouteRedistMatchNSSAExternal2=agentRipRouteRedistMatchNSSAExternal2, agentRouterRipAutoSummaryMode=agentRouterRipAutoSummaryMode, agentOspfType7LsasRx=agentOspfType7LsasRx, agentOspfDdTx=agentOspfDdTx, agentRouterVrrpTrackIntfTable=agentRouterVrrpTrackIntfTable, agentOspfLocalLsdbLsid=agentOspfLocalLsdbLsid, agentOspfQueueDrops=agentOspfQueueDrops, agentFailedRouteAdds=agentFailedRouteAdds, agentRouterVrrpTrackRtPfxLen=agentRouterVrrpTrackRtPfxLen, agentOspfPacketStatsGroup=agentOspfPacketStatsGroup, agentRouterVrrpTrackIfState=agentRouterVrrpTrackIfState, agentOspfLocalLsdbAddressLessIf=agentOspfLocalLsdbAddressLessIf, agentRoutingTableSummaryGroup=agentRoutingTableSummaryGroup, agentOspfAsLsdbSequence=agentOspfAsLsdbSequence, agentOspfHellosTx=agentOspfHellosTx, agentOspfAsLsdbEntry=agentOspfAsLsdbEntry, agentOspfQueueHigh=agentOspfQueueHigh, agentRipRouteRedistMatchExternal1=agentRipRouteRedistMatchExternal1, agentRouterRipAdminState=agentRouterRipAdminState, agentSwitchDhcpOperation=agentSwitchDhcpOperation, agentRipRouteRedistMatchNSSAExternal1=agentRipRouteRedistMatchNSSAExternal1, agentSwitchArpStatus=agentSwitchArpStatus, agentEbgpRoutes=agentEbgpRoutes, agentOspfLsAckRx=agentOspfLsAckRx, agentSwitchIpInterfaceClearIp=agentSwitchIpInterfaceClearIp, agentRipRouteRedistSource=agentRipRouteRedistSource, agentOspfRouteRedistMetricType=agentOspfRouteRedistMetricType, agentSwitchIntfIpHelperIpAddress=agentSwitchIntfIpHelperIpAddress, agentOspfRoutePrefInterArea=agentOspfRoutePrefInterArea, agentUdpClientMsgsReceived=agentUdpClientMsgsReceived, agentSwitchArpAgeoutTime=agentSwitchArpAgeoutTime, agentOspfLsUpdatesRx=agentOspfLsUpdatesRx, agentOspfQueueLimit=agentOspfQueueLimit, agentInternalVlanBase=agentInternalVlanBase, agentRouterVrrpTrackRtReachable=agentRouterVrrpTrackRtReachable, agentSwitchIpIcmpControlGroup=agentSwitchIpIcmpControlGroup, agentOspfIfTable=agentOspfIfTable, agentVrrpOperations=agentVrrpOperations, agentRouterRipConfigGroup=agentRouterRipConfigGroup, agentRouterRipDefaultMetricConfigured=agentRouterRipDefaultMetricConfigured, agentRouterOspfRFC1583CompatibilityMode=agentRouterOspfRFC1583CompatibilityMode, agentRouterRipHostRoutesAcceptMode=agentRouterRipHostRoutesAcceptMode, agentOspfLsReqRx=agentOspfLsReqRx, agentRipRouteRedistMetric=agentRipRouteRedistMetric, agentUdpClientMsgsDiscarded=agentUdpClientMsgsDiscarded, agentOspfType1LsasRx=agentOspfType1LsasRx, agentSwitchIntfArpAge=agentSwitchIntfArpAge, agentRouterVrrpTrackIntfEntry=agentRouterVrrpTrackIntfEntry, agentRipRouteRedistMode=agentRipRouteRedistMode, agentSwitchIpIcmpRateLimitBurstSize=agentSwitchIpIcmpRateLimitBurstSize, agentOspfAsLsdbLsid=agentOspfAsLsdbLsid, fastPathRouting=fastPathRouting, agentOspfIfPassiveMode=agentOspfIfPassiveMode, agentSwitchInternalVlanEntry=agentSwitchInternalVlanEntry, agentOspfSpfStatsReason=agentOspfSpfStatsReason, agentOspfInterRoutes=agentOspfInterRoutes, agentSwitchIntfIpHelperAddressTable=agentSwitchIntfIpHelperAddressTable, agentSwitchIntfArpIfIndex=agentSwitchIntfArpIfIndex, vrfName=vrfName, agentOspfIfAuthKeyId=agentOspfIfAuthKeyId, agentOspfVirtIfEntry=agentOspfVirtIfEntry, agentOspfVirtIfTable=agentOspfVirtIfTable, agentRouterVrrpTrackRtPrioDec=agentRouterVrrpTrackRtPrioDec, agentOspfAreaOpaqueLsdbAreaId=agentOspfAreaOpaqueLsdbAreaId, agentSnmpVRRPNewMasterTrapFlag=agentSnmpVRRPNewMasterTrapFlag, AutoCostRefBw=AutoCostRefBw, agentVrfTrapConfigGroup=agentVrfTrapConfigGroup, agentOspfExt2Routes=agentOspfExt2Routes, agentEcmpGroups=agentEcmpGroups, agentEcmpNextHopCount=agentEcmpNextHopCount, agentOspfLocalLsdbTable=agentOspfLocalLsdbTable, PYSNMP_MODULE_ID=fastPathRouting, agentSwitchIpInterfaceUnnumberedIfIndex=agentSwitchIpInterfaceUnnumberedIfIndex, agentOspfLsUpdatesTx=agentOspfLsUpdatesTx, agentSwitchIntfArpEntry=agentSwitchIntfArpEntry, agentOspfStubRouterStartupTimeRemaining=agentOspfStubRouterStartupTimeRemaining, agentSwitchInternalVlanId=agentSwitchInternalVlanId, agentSwitchIpRouterDiscoveryTable=agentSwitchIpRouterDiscoveryTable, agentSwitchIpHelperUdpPort=agentSwitchIpHelperUdpPort, agentOspfType10LsasRx=agentOspfType10LsasRx, agentSwitchIpVlanTable=agentSwitchIpVlanTable, agentUniqueNextHopsHigh=agentUniqueNextHopsHigh, agentBootpVlanId=agentBootpVlanId, agentSwitchArpType=agentSwitchArpType, agentOspfDefaultMetric=agentOspfDefaultMetric, agentUdpClientMsgsTtlExpired=agentUdpClientMsgsTtlExpired, agentSwitchIpGroup=agentSwitchIpGroup, agentOspfType4LsasRx=agentOspfType4LsasRx, agentRouterVrrpConfiguredPriority=agentRouterVrrpConfiguredPriority, agentSwitchIpInterfaceReUseTime=agentSwitchIpInterfaceReUseTime, agentEcmpRetries=agentEcmpRetries, agentRouterVrrpConfiguredTable=agentRouterVrrpConfiguredTable, agentOspfDefaultInfoOriginateMetricType=agentOspfDefaultInfoOriginateMetricType, agentOspfType3LsasRx=agentOspfType3LsasRx, agentSwitchHelperAddressTable=agentSwitchHelperAddressTable, agentSwitchArpGroup=agentSwitchArpGroup, agentOspfSpfStatsDeltaT=agentOspfSpfStatsDeltaT, agentIpHelperAdminMode=agentIpHelperAdminMode, agentSwitchIpRouterDiscoveryMinAdvertisementInterval=agentSwitchIpRouterDiscoveryMinAdvertisementInterval, vrfApplicationRestartedTrap=vrfApplicationRestartedTrap, agentSwitchIpInterfaceNetMask=agentSwitchIpInterfaceNetMask, agentRejectRoutes=agentRejectRoutes, agentOspfSpfStatsSpfTotal=agentOspfSpfStatsSpfTotal, agentSwitchIpHelperHitCount=agentSwitchIpHelperHitCount, agentOspfDefaultMetricConfigured=agentOspfDefaultMetricConfigured, agentOspfOpaqueLsaSupport=agentOspfOpaqueLsaSupport, agentSwitchIpIcmpRateLimitInterval=agentSwitchIpIcmpRateLimitInterval, agentOspfLocalLsdbAge=agentOspfLocalLsdbAge, agentIpHelperGroup=agentIpHelperGroup, agentOspfIfEntry=agentOspfIfEntry, agentSwitchArpEntry=agentSwitchArpEntry, agentInternalVlanGroup=agentInternalVlanGroup, agentRouterRipDefaultMetric=agentRouterRipDefaultMetric, agentOspfQueueIndex=agentOspfQueueIndex, agentOspfRouteRedistDistListConfigured=agentOspfRouteRedistDistListConfigured, agentOspfDefaultPassiveMode=agentOspfDefaultPassiveMode, agentSwitchIpInterfaceNumberOfFlaps=agentSwitchIpInterfaceNumberOfFlaps, agentOspfQueueTable=agentOspfQueueTable, agentBootpDhcpRelayForwardingIp=agentBootpDhcpRelayForwardingIp, agentTruncEcmpRoutes=agentTruncEcmpRoutes, SpfTimerRange=SpfTimerRange, agentOspfAsLsdbAge=agentOspfAsLsdbAge, agentSwitchIpInterfaceTable=agentSwitchIpInterfaceTable, agentRouterVrrpConfiguredEntry=agentRouterVrrpConfiguredEntry, agentOspfAreaOpaqueLsdbChecksum=agentOspfAreaOpaqueLsdbChecksum, agentRouterVrrpOperTable=agentRouterVrrpOperTable, agentSwitchIpVlanIfIndex=agentSwitchIpVlanIfIndex, agentSwitchArpMacAddress=agentSwitchArpMacAddress, agentSwitchIpRoutingMode=agentSwitchIpRoutingMode, agentRouterVrrpTrackIfPrioDec=agentRouterVrrpTrackIfPrioDec, agentOspfQueueEntry=agentOspfQueueEntry, agentBootpDhcpRelayGroup=agentBootpDhcpRelayGroup, agentSwitchArpStaticEntryCountCurrent=agentSwitchArpStaticEntryCountCurrent, agentSwitchInternalVlanTable=agentSwitchInternalVlanTable, agentSwitchIntfArpStatus=agentSwitchIntfArpStatus, agentOspfDdRx=agentOspfDdRx, agentSnmpTrapFlagsConfigGroupLayer3=agentSnmpTrapFlagsConfigGroupLayer3, agentOspfAreaOpaqueLsdbType=agentOspfAreaOpaqueLsdbType, agentSwitchHelperStatus=agentSwitchHelperStatus, agentOspfIntraRoutes=agentOspfIntraRoutes, agentBootpDhcpRelayMinWaitTime=agentBootpDhcpRelayMinWaitTime, agentBestRoutesHigh=agentBestRoutesHigh, agentBgpRoutes=agentBgpRoutes, agentOspfSpfStatsSumm=agentOspfSpfStatsSumm, agentRouterVrrpTrackRtPfx=agentRouterVrrpTrackRtPfx, agentSwitchIpIcmpRedirectsMode=agentSwitchIpIcmpRedirectsMode, agentRouterVrrpConfigGroup=agentRouterVrrpConfigGroup, agentSnmpVRRPAuthFailureTrapFlag=agentSnmpVRRPAuthFailureTrapFlag, agentOspfSpfIndex=agentOspfSpfIndex, agentOspfLocalLsdbChecksum=agentOspfLocalLsdbChecksum)
mibBuilder.exportSymbols("DNOS-ROUTING-MIB", agentSwitchArpResponseTime=agentSwitchArpResponseTime, agentOspfSpfStatsTable=agentOspfSpfStatsTable, agentAlternateRoutes=agentAlternateRoutes, agentSwitchArpInterface=agentSwitchArpInterface, agentOspfType5LsasRx=agentOspfType5LsasRx, agentRouterVrrpTrackRouteEntry=agentRouterVrrpTrackRouteEntry, agentLocalBgpRoutes=agentLocalBgpRoutes, agentOspfAreaOpaqueLsdbEntry=agentOspfAreaOpaqueLsdbEntry, agentOspfRoutes=agentOspfRoutes, agentSwitchArpTotalEntryCountCurrent=agentSwitchArpTotalEntryCountCurrent, agentOspfSpfHoldTime=agentOspfSpfHoldTime, agentSwitchIntfIpHelperAddressEntry=agentSwitchIntfIpHelperAddressEntry, agentRip2IfConfTable=agentRip2IfConfTable, agentConnectedRoutes=agentConnectedRoutes, agentSwitchArpStaticEntryCountMax=agentSwitchArpStaticEntryCountMax, agentSwitchIpInterfaceMtuValue=agentSwitchIpInterfaceMtuValue, agentRipRouteRedistMatchExternal2=agentRipRouteRedistMatchExternal2, agentRouterOspfConfigGroup=agentRouterOspfConfigGroup, agentSwitchArpMaxRetries=agentSwitchArpMaxRetries, agentRouterVrrpTrackGroup=agentRouterVrrpTrackGroup, agentSwitchIntfArpTable=agentSwitchIntfArpTable, agentRip2IfConfEntry=agentRip2IfConfEntry, agentEcmpCountEntry=agentEcmpCountEntry, agentOspfHellosRx=agentOspfHellosRx, agentOspfQueueLength=agentOspfQueueLength, agentRouterVrrpTrackIntf=agentRouterVrrpTrackIntf, agentRouterRipSplitHorizonMode=agentRouterRipSplitHorizonMode, agentSwitchSecondaryAddressEntry=agentSwitchSecondaryAddressEntry, agentRouterVrrpTrackIfStatus=agentRouterVrrpTrackIfStatus, agentOspfAutoCostRefBw=agentOspfAutoCostRefBw, agentSwitchSecondaryNetMask=agentSwitchSecondaryNetMask, agentBestRoutes=agentBestRoutes, agentOspfCountersCleared=agentOspfCountersCleared, agentRipRouteRedistDistListConfigured=agentRipRouteRedistDistListConfigured, agentBootpDhcpRelayNumOfRequestsReceived=agentBootpDhcpRelayNumOfRequestsReceived, agentRouterVrrpTrackRtStatus=agentRouterVrrpTrackRtStatus, agentOspfLsUpdatesTxMax=agentOspfLsUpdatesTxMax, agentOspfType2LsasRx=agentOspfType2LsasRx, agentOspfLocalLsdbIpAddress=agentOspfLocalLsdbIpAddress, agentSwitchIpRouterDiscoveryAdvertiseMode=agentSwitchIpRouterDiscoveryAdvertiseMode, agentOspfSpfStatsEntry=agentOspfSpfStatsEntry, agentOspfIfIpMtuIgnoreFlag=agentOspfIfIpMtuIgnoreFlag, agentOspfRouteRedistMode=agentOspfRouteRedistMode, agentBootpDhcpRelayIntfCheckReply=agentBootpDhcpRelayIntfCheckReply, agentRipRouteRedistMetricConfigured=agentRipRouteRedistMetricConfigured, agentSwitchIpInterfaceEntry=agentSwitchIpInterfaceEntry, ospfStubRouterAdvertisement=ospfStubRouterAdvertisement, agentDhcpServerMsgsRelayed=agentDhcpServerMsgsRelayed, agentRouterVrrpTrackRouteTable=agentRouterVrrpTrackRouteTable, agentRoutingHeapGroup=agentRoutingHeapGroup, agentSwitchIpInterfaceRoutingMode=agentSwitchIpInterfaceRoutingMode, agentOspfDefaultInfoOriginateAlways=agentOspfDefaultInfoOriginateAlways, agentUnresolvedRouteAdds=agentUnresolvedRouteAdds, agentSwitchArpDynamicRenew=agentSwitchArpDynamicRenew, agentSwitchSecondaryIpAddress=agentSwitchSecondaryIpAddress, agentECMPGroup=agentECMPGroup, agentSwitchIpIcmpEchoReplyMode=agentSwitchIpIcmpEchoReplyMode, agentOspfLocalLsdbRouterId=agentOspfLocalLsdbRouterId, agentSwitchIpInterfaceCurrentPenalty=agentSwitchIpInterfaceCurrentPenalty, agentBootpDhcpRelayIntfCircuitIdOptionMode=agentBootpDhcpRelayIntfCircuitIdOptionMode, agentOspfAreaOpaqueLsdbTable=agentOspfAreaOpaqueLsdbTable, agentOspfDefaultInfoOriginateMetricConfigured=agentOspfDefaultInfoOriginateMetricConfigured, agentNextHopGroups=agentNextHopGroups, agentSwitchInternalVlanIfIndex=agentSwitchInternalVlanIfIndex, agentSwitchIntfArpType=agentSwitchIntfArpType, agentSwitchIpVlanRoutingStatus=agentSwitchIpVlanRoutingStatus, agentOspfAsLsdbRouterId=agentOspfAsLsdbRouterId, agentBootpDhcpRelayCheckReply=agentBootpDhcpRelayCheckReply, agentOspfLsaRetxCount=agentOspfLsaRetxCount, agentOspfQueueGroup=agentOspfQueueGroup, agentRipRouteRedistMatchInternal=agentRipRouteRedistMatchInternal, agentOspfRouteRedistEntry=agentOspfRouteRedistEntry, agentBootpDhcpRelayIntfTable=agentBootpDhcpRelayIntfTable, agentOspfSpfStatsExt=agentOspfSpfStatsExt, agentRipRouteRedistEntry=agentRipRouteRedistEntry, agentSwitchIntfArpMacAddress=agentSwitchIntfArpMacAddress, agentOspfSpfDelayTime=agentOspfSpfDelayTime, agentOspfDefaultInfoOriginate=agentOspfDefaultInfoOriginate, agentSwitchIpRouterDiscoveryMaxAdvertisementInterval=agentSwitchIpRouterDiscoveryMaxAdvertisementInterval, agentSwitchIpHelperAddress=agentSwitchIpHelperAddress, agentSwitchIpVlanEntry=agentSwitchIpVlanEntry, agentSwitchIpHelperAddressEntry=agentSwitchIpHelperAddressEntry, agentOspfAreaOpaqueLsdbAge=agentOspfAreaOpaqueLsdbAge, agentRipRoutes=agentRipRoutes, agentOspfLsUpdatesRxMax=agentOspfLsUpdatesRxMax, agentRip2IfConfAuthKeyId=agentRip2IfConfAuthKeyId, agentSwitchSecondaryStatus=agentSwitchSecondaryStatus, agentOspfType11LsasRx=agentOspfType11LsasRx, agentSwitchLocalProxyArpMode=agentSwitchLocalProxyArpMode, agentSwitchArpTable=agentSwitchArpTable, agentOspfAsLsdbChecksum=agentOspfAsLsdbChecksum)
