...
Counter64, enterprises, ObjectIdentity, MibIdentifier, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, IpAddress, ModuleIdentity, TimeTicks, Bits, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "enterprises", "ObjectIdentity", "MibIdentifier", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "IpAddress", "ModuleIdentity", "TimeTicks", "Bits", "Counter32", "NotificationType")
...
mibBuilder.exportSymbols("XYPLEX-LAT1-MIB", latOfferedServiceQueuing=latOfferedServiceQueuing, latNodeOutSlots=latNodeOutSlots, latNodeStatus=latNodeStatus, latPortIndex=latPortIndex, latOfferedServiceStatus=latOfferedServiceStatus, latNodeInBadSlots=latNodeInBadSlots, latAnnounceServices=latAnnounceServices, latNodeInMessages=latNodeInMessages, latNodeZeroTime=latNodeZeroTime, latNodeInSessionsRejected=latNodeInSessionsRejected, latOfferedServiceTable=latOfferedServiceTable, latMulticastTimer=latMulticastTimer, latOutRetransmits=latOutRetransmits, latLocalServiceGroups=latLocalServiceGroups, latPortCurrentGroups=latPortCurrentGroups, latVisibleServiceRating=latVisibleServiceRating, latNodeInSessionsAccepted=latNodeInSessionsAccepted, latNodeAddressChange=latNodeAddressChange, latNodesRejected=latNodesRejected, latRetransmitLimit=latRetransmitLimit, latInSessionsAccepted=latInSessionsAccepted, latNodeInBadMessages=latNodeInBadMessages, latKeepaliveTimer=latKeepaliveTimer, latPortTable=latPortTable, latPortAuthorizedGroups=latPortAuthorizedGroups, latOfferedServicePassword=latOfferedServicePassword, latVisibleServiceTable=latVisibleServiceTable, latNodeIdentification=latNodeIdentification, latInSessionsRejected=latInSessionsRejected, latNodeDataLinkFrame=latNodeDataLinkFrame, latGroupPurge=latGroupPurge, latNodeInSlots=latNodeInSlots, latInMessages=latInMessages, latPortRemoteModification=latPortRemoteModification, latNodeOutRetransmits=latNodeOutRetransmits, latOfferedServiceName=latOfferedServiceName, latVisibleServiceName=latVisibleServiceName, latNodeTable=latNodeTable, latOfferedServicePortMap=latOfferedServicePortMap, latNodePurge=latNodePurge, latAddressChange=latAddressChange, latInBadMulticasts=latInBadMulticasts, latNodeEntry=latNodeEntry, latNodeAddress=latNodeAddress, latNodeOutMessages=latNodeOutMessages, latNodeOutBytes=latNodeOutBytes, latVisibleServiceNode=latVisibleServiceNode, latNodeZero=latNodeZero, latNodeGroups=latNodeGroups, latNodeConnectedSessions=latNodeConnectedSessions, latNumber=latNumber, latVisibleServiceConnectedSessions=latVisibleServiceConnectedSessions, latNodeServiceNumber=latNodeServiceNumber, latInBadMessages=latInBadMessages, latNodeLimit=latNodeLimit, latOfferedServiceIdentification=latOfferedServiceIdentification, latPortAutoPrompt=latPortAutoPrompt, latVisibleServiceIdentification=latVisibleServiceIdentification, latNodeName=latNodeName, latNodeInDuplicates=latNodeInDuplicates, latPortEntry=latPortEntry, lat=lat, latIdentificationLengthLimit=latIdentificationLengthLimit, xyplex=xyplex, latOutMessages=latOutMessages, latInDuplicates=latInDuplicates, latVisibleServiceEntry=latVisibleServiceEntry, latInBadSlots=latInBadSlots, latOfferedServiceAllowConnections=latOfferedServiceAllowConnections, latCircuitTimer=latCircuitTimer, latNodeInBytes=latNodeInBytes, latVisibleServiceStatus=latVisibleServiceStatus, latOfferedServiceEntry=latOfferedServiceEntry)
