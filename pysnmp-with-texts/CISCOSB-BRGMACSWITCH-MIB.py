...
# Produced by pysmi-0.3.4 at Wed May  1 12:21:53 2019
...
iso, Counter32, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Unsigned32, Counter64, NotificationType, IpAddress, Integer32, Gauge32, MibIdentifier, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter32", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Unsigned32", "Counter64", "NotificationType", "IpAddress", "Integer32", "Gauge32", "MibIdentifier", "TimeTicks")
...
if mibBuilder.loadTexts: rlBrgMacSwitch.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
mibBuilder.exportSymbols("CISCOSB-BRGMACSWITCH-MIB", rlBrgMacSwOldEntryDeleteMode=rlBrgMacSwOldEntryDeleteMode, rlBrgMacSwSpanningTree=rlBrgMacSwSpanningTree, rlBrgMacSwKeyType=rlBrgMacSwKeyType, rlBrgMacSwVersion=rlBrgMacSwVersion, rlBrgMacSwMaxTableNumber=rlBrgMacSwMaxTableNumber, rlBrgMacSwYellowBoundary=rlBrgMacSwYellowBoundary, rlBrgMacSwOperTrapCount=rlBrgMacSwOperTrapCount, rlBrgMacSwDynamicTables=rlBrgMacSwDynamicTables, rlBrgMacSwitch=rlBrgMacSwitch, PYSNMP_MODULE_ID=rlBrgMacSwitch, rlBrgMacSwTrapEnable=rlBrgMacSwTrapEnable, rlBrgMacSwAdminTrapFrequency=rlBrgMacSwAdminTrapFrequency, rlBrgMacSwRedBoundary=rlBrgMacSwRedBoundary)
