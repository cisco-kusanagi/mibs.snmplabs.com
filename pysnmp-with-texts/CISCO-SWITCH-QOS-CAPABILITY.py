...
# Produced by pysmi-0.3.4 at Wed May  1 12:13:35 2019
...
MibIdentifier, Integer32, iso, Unsigned32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ModuleIdentity, Gauge32, TimeTicks, IpAddress, ObjectIdentity, Bits, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "iso", "Unsigned32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ModuleIdentity", "Gauge32", "TimeTicks", "IpAddress", "ObjectIdentity", "Bits", "NotificationType")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: ciscoSwitchQosCapability.setRevisionsDescriptions(('Add ciscoSwitchQosCapNxOSV06R0210PN7K agent capability statement.', 'Add ciscoSwitchQosCapV06R0002U0201PN3K agent capability statement.', 'Add ciscoSwitchQosCapV5R0003U0501gPN3K and ciscoSwitchQosCapV6R0002U0101PN3K agent capability statement.', 'Add ciscoSwitchQosCapV15R0001SYPCat6k agent capability statement.', 'Add ciscoSwitchQosCapV12R0250SYPCat6k agent capability statement.', 'Add ciscoSwitchQosCapV12R0233SXI4PCat6k agent capability statement.', 'Add ciscoSwitchQosCapV12R0233SXIPCat6k agent capability statement.', 'Initial version of this MIB module.',))
...
if mibBuilder.loadTexts: ciscoSwitchQosCapability.setContactInfo('Cisco Systems Customer Service Postal: 170 West Tasman Drive San Jose, CA 95134 USA Tel: +1 800 553-NETS E-mail: cs-lan-switch-snmp@cisco.com')
if mibBuilder.loadTexts: ciscoSwitchQosCapability.setDescription('The capabilities description of CISCO-SWITCH-QOS-MIB.')
...
if mibBuilder.loadTexts: ciscoSwitchQosCapV12R0233SXHPCat6k.setDescription('CISCO-SWITCH-QOS-MIB capabilities.')
...
if mibBuilder.loadTexts: ciscoSwitchQosCapV12R0233SXIPCat6k.setDescription('CISCO-SWITCH-QOS-MIB capabilities.')
...
if mibBuilder.loadTexts: ciscoSwitchQosCapV12R0233SXI4PCat6k.setDescription('CISCO-SWITCH-QOS-MIB capabilities.')
...
if mibBuilder.loadTexts: ciscoSwitchQosCapV12R0250SYPCat6k.setDescription('CISCO-SWITCH-QOS-MIB capabilities.')
...
if mibBuilder.loadTexts: ciscoSwitchQosCapV15R0001SYPCat6k.setDescription('CISCO-SWITCH-QOS-MIB capabilities.')
...
if mibBuilder.loadTexts: ciscoSwitchQosCapV5R0003U0501gPN3K.setDescription('CISCO-SWITCH-QOS-MIB capabilities.')
...
if mibBuilder.loadTexts: ciscoSwitchQosCapV6R0002U0101PN3K.setDescription('CISCO-SWITCH-QOS-MIB capabilities.')
...
if mibBuilder.loadTexts: ciscoSwitchQosCapV06R0002U0201PN3K.setDescription('CISCO-SWITCH-QOS-MIB capabilities.')
...
if mibBuilder.loadTexts: ciscoSwitchQosCapNxOSV06R0210PN7K.setDescription('CISCO-SWITCH-QOS-MIB capabilities.')
mibBuilder.exportSymbols("CISCO-SWITCH-QOS-CAPABILITY", ciscoSwitchQosCapV5R0003U0501gPN3K=ciscoSwitchQosCapV5R0003U0501gPN3K, ciscoSwitchQosCapV12R0233SXI4PCat6k=ciscoSwitchQosCapV12R0233SXI4PCat6k, PYSNMP_MODULE_ID=ciscoSwitchQosCapability, ciscoSwitchQosCapability=ciscoSwitchQosCapability, ciscoSwitchQosCapV12R0250SYPCat6k=ciscoSwitchQosCapV12R0250SYPCat6k, ciscoSwitchQosCapV6R0002U0101PN3K=ciscoSwitchQosCapV6R0002U0101PN3K, ciscoSwitchQosCapNxOSV06R0210PN7K=ciscoSwitchQosCapNxOSV06R0210PN7K, ciscoSwitchQosCapV15R0001SYPCat6k=ciscoSwitchQosCapV15R0001SYPCat6k, ciscoSwitchQosCapV12R0233SXIPCat6k=ciscoSwitchQosCapV12R0233SXIPCat6k, ciscoSwitchQosCapV06R0002U0201PN3K=ciscoSwitchQosCapV06R0002U0201PN3K, ciscoSwitchQosCapV12R0233SXHPCat6k=ciscoSwitchQosCapV12R0233SXHPCat6k)
