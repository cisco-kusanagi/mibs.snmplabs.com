...
TimeTicks, iso, Counter64, NotificationType, Counter32, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, Unsigned32, Bits, Integer32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "Counter64", "NotificationType", "Counter32", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "Unsigned32", "Bits", "Integer32", "ModuleIdentity")
...
if mibBuilder.loadTexts: rlTunnel.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
mibBuilder.exportSymbols("CISCOSB-TUNNEL-MIB", rlTunnelGeneral=rlTunnelGeneral, rlTunnelIsatapRSInterval=rlTunnelIsatapRSInterval, rlTunnelIsatapMinRSInterval=rlTunnelIsatapMinRSInterval, rlTunnelIsatapPrlIsActive=rlTunnelIsatapPrlIsActive, rlTunnelIsatapPrlEntry=rlTunnelIsatapPrlEntry, rlTunnelIsatapPrlIfIndex=rlTunnelIsatapPrlIfIndex, rlTunnelIsatap=rlTunnelIsatap, rlTunnelIfTable=rlTunnelIfTable, rlTunnelIfEntry=rlTunnelIfEntry, rlTunnelIsatapConfDnsName=rlTunnelIsatapConfDnsName, rlTunnelIsatapRobustness=rlTunnelIsatapRobustness, rlTunnelIsatapDnsHostName=rlTunnelIsatapDnsHostName, rlTunnelIsatapRouterAddress=rlTunnelIsatapRouterAddress, rlTunnelIsatapPrlPriority=rlTunnelIsatapPrlPriority, rlTunnelIfLocalIPv4Address=rlTunnelIfLocalIPv4Address, rlTunnelIsatapPrlAddress=rlTunnelIsatapPrlAddress, rlTunnelIsatapConfTable=rlTunnelIsatapConfTable, rlTunnelIsatapConfEntry=rlTunnelIsatapConfEntry, rlTunnel=rlTunnel, rlTunnelIfLocalAddressSource=rlTunnelIfLocalAddressSource, rlTunnelTypeSpecific=rlTunnelTypeSpecific, rlTunnelIsatapConfRowStatus=rlTunnelIsatapConfRowStatus, rlTunnelIsatapPrlTable=rlTunnelIsatapPrlTable, rlTunnelIsatapConfRobustness=rlTunnelIsatapConfRobustness, rlTunnelIfLocalAddressInterfaceId=rlTunnelIfLocalAddressInterfaceId, rlTunnelIsatapMinQueryInterval=rlTunnelIsatapMinQueryInterval, rlTunnelIsatapStatus=rlTunnelIsatapStatus, rlTunnelIsatapConfRSInterval=rlTunnelIsatapConfRSInterval, rlTunnelIfStatus=rlTunnelIfStatus, PYSNMP_MODULE_ID=rlTunnel, rlTunnelIfEncapsMethod=rlTunnelIfEncapsMethod, rlTunnelIsatapQueryInterval=rlTunnelIsatapQueryInterval, rlTunnelIsatapLocalIPv4Address=rlTunnelIsatapLocalIPv4Address)
