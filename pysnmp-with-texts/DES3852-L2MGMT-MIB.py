...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DES3852-L2MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:41:35 2019
...
Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, iso, TimeTicks, IpAddress, Unsigned32, Bits, Integer32, ModuleIdentity, Gauge32, Counter64, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "iso", "TimeTicks", "IpAddress", "Unsigned32", "Bits", "Integer32", "ModuleIdentity", "Gauge32", "Counter64", "MibIdentifier")
...
mibBuilder.exportSymbols("DES3852-L2MGMT-MIB", swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2IGMPCtrlEntry=swL2IGMPCtrlEntry, swL2IGMPMulticastVlanName=swL2IGMPMulticastVlanName, swPowerRecover=swPowerRecover, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2IGMPRouteTimeout=swL2IGMPRouteTimeout, swL2PortSecurityControlEntry=swL2PortSecurityControlEntry, swL2IGMPRouterPortVlanName=swL2IGMPRouterPortVlanName, swL2PortControlLearningState=swL2PortControlLearningState, swL2PortControlMediumType=swL2PortControlMediumType, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2VlanAdvertiseState=swL2VlanAdvertiseState, swl2NotificationBidings=swl2NotificationBidings, swL2QOS8021pUserPriorityClass=swL2QOS8021pUserPriorityClass, swDevInfoPowerEntry=swDevInfoPowerEntry, swL2TrunkMember=swL2TrunkMember, swL2QOSSchedulingClassIndex=swL2QOSSchedulingClassIndex, swL2IGMPQueryState=swL2IGMPQueryState, swL2QOSBandwidthRadiusRxRate=swL2QOSBandwidthRadiusRxRate, swL2QOS8021pDefaultPriorityIndex=swL2QOS8021pDefaultPriorityIndex, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2IGMPHostTimeout=swL2IGMPHostTimeout, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2PortControlTable=swL2PortControlTable, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2QOSSchedulingEntry=swL2QOSSchedulingEntry, swL2IGMPQueryInfoEntry=swL2IGMPQueryInfoEntry, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swDevInfoPowerID=swDevInfoPowerID, swL2DevCtrl=swL2DevCtrl, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swDevInfoFrontPanelLedMode=swDevInfoFrontPanelLedMode, swL2PortInfoUnitIndex=swL2PortInfoUnitIndex, swL2QOS8021pDefaultPriority=swL2QOS8021pDefaultPriority, VlanIndex=VlanIndex, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2PortInformationMediumType=swL2PortInformationMediumType, swL2IGMPQueryInterval=swL2IGMPQueryInterval, swL2MgmtMIB=swL2MgmtMIB, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2IGMPInfoVid=swL2IGMPInfoVid, swL2IGMPCurrentState=swL2IGMPCurrentState, swL2TrunkType=swL2TrunkType, swL2QOS8021pUserPriorityTable=swL2QOS8021pUserPriorityTable, swL2IGMPRouterPortForbiddenPortList=swL2IGMPRouterPortForbiddenPortList, swL2IGMPMaxSupportedVlans=swL2IGMPMaxSupportedVlans, swL2TrunkState=swL2TrunkState, swL2IGMPLeaveTimer=swL2IGMPLeaveTimer, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swDevInfoModuleType=swDevInfoModuleType, swL2IGMPMulticastVlanEntry=swL2IGMPMulticastVlanEntry, swL2PortControlMACNotifyState=swL2PortControlMACNotifyState, swL2IGMPGroupIpAddr=swL2IGMPGroupIpAddr, swL2QOSSchedulingMaxPkts=swL2QOSSchedulingMaxPkts, swL2PortInfoTable=swL2PortInfoTable, swL2BroadcastSegCtrl=swL2BroadcastSegCtrl, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swL2porttypechgNotification=swL2porttypechgNotification, swL2PortInformationLinkStatus=swL2PortInformationLinkStatus, swL2PortInformationErrorDisabled=swL2PortInformationErrorDisabled, swL2PortControlPortIndex=swL2PortControlPortIndex, swL2DevCtrlRmonState=swL2DevCtrlRmonState, swL2PortSecurityMgmt=swL2PortSecurityMgmt, swL2DevInfo=swL2DevInfo, swDevInfoPowerStatus=swDevInfoPowerStatus, swL2PortMgmt=swL2PortMgmt, swL2QOS8021pDefaultPriorityTable=swL2QOS8021pDefaultPriorityTable, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2PortInformationNwayStatus=swL2PortInformationNwayStatus, swPowerStatusChg=swPowerStatusChg, swL2MACNotifyState=swL2MACNotifyState, swL2IGMPPortMap=swL2IGMPPortMap, swL2PortControlEntry=swL2PortControlEntry, swL2PortSecurityControlTable=swL2PortSecurityControlTable, swL2IGMPCtrlState=swL2IGMPCtrlState, swL2PortCtrlLockState=swL2PortCtrlLockState, swL2QOS8021pUserPriorityEntry=swL2QOS8021pUserPriorityEntry, swL2TrafficSegTable=swL2TrafficSegTable, swL2PortSecurityPortIndex=swL2PortSecurityPortIndex, swL2IGMPInfoTable=swL2IGMPInfoTable, swL2PortInformationUnitID=swL2PortInformationUnitID, swL2macNotifyInfo=swL2macNotifyInfo, swDevInfoPowerTable=swDevInfoPowerTable, swL2TrunkMgmt=swL2TrunkMgmt, swL2IGMPRouterPortVlanid=swL2IGMPRouterPortVlanid, swL2QOSMgmt=swL2QOSMgmt, swL2PortControlUnitIndex=swL2PortControlUnitIndex, swL2IGMPCtrlTable=swL2IGMPCtrlTable, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2QOSBandwidthPortIndex=swL2QOSBandwidthPortIndex, PortList=PortList, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2DevAlarm=swL2DevAlarm, swL2VlanMgmt=swL2VlanMgmt, swL2PortSecurityAdmState=swL2PortSecurityAdmState, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2IGMPMulticastVlanid=swL2IGMPMulticastVlanid, swL2DevMgmt=swL2DevMgmt, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2IGMPRouterPortTable=swL2IGMPRouterPortTable, swL2PortInfoErrorDisabled=swL2PortInfoErrorDisabled, swL2QOS8021pUserPriorityIndex=swL2QOS8021pUserPriorityIndex, swL2QOSBandwidthControlTable=swL2QOSBandwidthControlTable, swL2PortControlNwayState=swL2PortControlNwayState, swL2MirrorMgmt=swL2MirrorMgmt, swL2IGMPCtrlVid=swL2IGMPCtrlVid, swL2IGMPMulticastVlanSourcePort=swL2IGMPMulticastVlanSourcePort, swL2IGMPMulticastVlanMemberPort=swL2IGMPMulticastVlanMemberPort, swL2IGMPFastLeaveState=swL2IGMPFastLeaveState, swPowerFailure=swPowerFailure, swDevInfoSystemUpTime=swDevInfoSystemUpTime, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2macNotification=swL2macNotification, swL2IGMPQueryInfoTable=swL2IGMPQueryInfoTable, swL2IGMPRouterPortStaticPortList=swL2IGMPRouterPortStaticPortList, swL2PortControlMulticastfilter=swL2PortControlMulticastfilter, swL2PortSecurityMode=swL2PortSecurityMode, swL2QOSBandwidthTxRate=swL2QOSBandwidthTxRate, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2PortInformationPortIndex=swL2PortInformationPortIndex, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2QOSBandwidthRadiusTxRate=swL2QOSBandwidthRadiusTxRate, swL2IGMPRobustness=swL2IGMPRobustness, swL2PortControlFlowCtrlState=swL2PortControlFlowCtrlState, swL2PortSecurityTrapLogState=swL2PortSecurityTrapLogState, swL2PortInformationModuleType=swL2PortInformationModuleType, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2QOS8021pRadiusPriority=swL2QOS8021pRadiusPriority, swL2IGMPMacAddr=swL2IGMPMacAddr, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swDevInfoConsoleInUse=swDevInfoConsoleInUse, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2IGMPIpGroupReportCount=swL2IGMPIpGroupReportCount, swL2VlanAdvertisementEntry=swL2VlanAdvertisementEntry, swL2PortCtrlTable=swL2PortCtrlTable, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2VlanIndex=swL2VlanIndex, swL2QOSBandwidthRxRate=swL2QOSBandwidthRxRate, swL2PortInformationType=swL2PortInformationType, swL2DevCtrlIGMPSnooping=swL2DevCtrlIGMPSnooping, swL2IGMPRouterPortDynamicPortList=swL2IGMPRouterPortDynamicPortList, swL2IGMPInfoQueryCount=swL2IGMPInfoQueryCount, swL2PortInfoType=swL2PortInfoType, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2IGMPInfoTxQueryCount=swL2IGMPInfoTxQueryCount, swL2IGMPMulticastVlanRowStatus=swL2IGMPMulticastVlanRowStatus, swL2MgmtMIBTrapPrefix=swL2MgmtMIBTrapPrefix, VlanId=VlanId, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swL2IGMPRouterPortEntry=swL2IGMPRouterPortEntry, swL2PortSecurityMaxLernAddr=swL2PortSecurityMaxLernAddr, swL2PortInfoModuleType=swL2PortInfoModuleType, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2PortInformationEntry=swL2PortInformationEntry, swL2IGMPMgmt=swL2IGMPMgmt, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2TrunkName=swL2TrunkName, swl2NotifyPortSecurity=swl2NotifyPortSecurity, swL2QOS8021pDefaultPriorityEntry=swL2QOS8021pDefaultPriorityEntry, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2PortInformationTable=swL2PortInformationTable, swL2PortInfoEntry=swL2PortInfoEntry, swL2VlanName=swL2VlanName, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2IGMPLastMemberQueryInterval=swL2IGMPLastMemberQueryInterval, swL2IGMPVid=swL2IGMPVid, swL2DevCtrlStpState=swL2DevCtrlStpState, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2IGMPMulticastVlanTable=swL2IGMPMulticastVlanTable, swL2MirrorPortState=swL2MirrorPortState, swL2QOSSchedulingTable=swL2QOSSchedulingTable, swL2QOSBandwidthControlEntry=swL2QOSBandwidthControlEntry, swL2IGMPInfoEntry=swL2IGMPInfoEntry, swDevInfoPowerUnitIndex=swDevInfoPowerUnitIndex, swL2BroadcastSegARPForwardPorts=swL2BroadcastSegARPForwardPorts, swL2VlanAdvertisementTable=swL2VlanAdvertisementTable, swL2TrunkIndex=swL2TrunkIndex, swL2PortControlAdminState=swL2PortControlAdminState, swL2BroadcastSegFilterPorts=swL2BroadcastSegFilterPorts, swL2IGMPMaxResponseTime=swL2IGMPMaxResponseTime, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2TrafficSegPort=swL2TrafficSegPort, PYSNMP_MODULE_ID=swL2MgmtMIB)
