...
# Produced by pysmi-0.3.4 at Wed May  1 12:39:08 2019
...
Counter64, iso, Counter32, enterprises, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, MibIdentifier, ObjectIdentity, Integer32, NotificationType, IpAddress, Bits, ModuleIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "iso", "Counter32", "enterprises", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "MibIdentifier", "ObjectIdentity", "Integer32", "NotificationType", "IpAddress", "Bits", "ModuleIdentity", "Gauge32")
...
if mibBuilder.loadTexts: sysJumboFrameEnable.setDescription('Gigabit Web Smart Switches support jumbo frames (frames larger than the Ethernet frame size of 1522 bytes) of up to 9K bytes (tagged). Default jumbo frame is disabled.')
...
if mibBuilder.loadTexts: sysDhcpRetryTimes.setDescription('This time for DHCP retried times.')
...
mibBuilder.exportSymbols("DES-1210-52-CX", igsVlanMulticastGroupVlanId=igsVlanMulticastGroupVlanId, sysSNTPDSTOffset=sysSNTPDSTOffset, voicevlanOUITable=voicevlanOUITable, laSystem=laSystem, dhcpOption12HostName=dhcpOption12HostName, dhcpLocalRelayEntry=dhcpLocalRelayEntry, aclL3v4ExtRuleICMPMessageType=aclL3v4ExtRuleICMPMessageType, stpHelloTime=stpHelloTime, qosDiffServType20=qosDiffServType20, qosDiffServType46=qosDiffServType46, aclL3v6RuleStatus=aclL3v6RuleStatus, dlinklldpTxDelay=dlinklldpTxDelay, impbWhiteListEntry=impbWhiteListEntry, aclHWResourceStatusTable=aclHWResourceStatusTable, qosTOSType04=qosTOSType04, doSCtrlEntry=doSCtrlEntry, stpPortForwardTransitions=stpPortForwardTransitions, aclL3v6RuleAccessID=aclL3v6RuleAccessID, aclProfileNo=aclProfileNo, dlinkGreenSystemHibernationTimeProfile1=dlinkGreenSystemHibernationTimeProfile1, stpTimeSinceTopologyChange=stpTimeSinceTopologyChange, aclL3v4RuleDstIpAddr=aclL3v4RuleDstIpAddr, aclHWResourceStatus=aclHWResourceStatus, aclL3v4ExtRuleTcpUdpDstPortMask=aclL3v4ExtRuleTcpUdpDstPortMask, dot1qVlanEgressPorts=dot1qVlanEgressPorts, swAuthRadiusServerEntry=swAuthRadiusServerEntry, qosDiffServType09=qosDiffServType09, companyStaticMAC=companyStaticMAC, mldsVlanRouterTable=mldsVlanRouterTable, ipifV6AddressTable=ipifV6AddressTable, aclL2RuleReplacePriority=aclL2RuleReplacePriority, swTimeRangeEndHour=swTimeRangeEndHour, companySNMPV3=companySNMPV3, cableDiagPair2TestResult=cableDiagPair2TestResult, aclProfile=aclProfile, companyTrafficMgmt=companyTrafficMgmt, authProtocol=authProtocol, laPortActorActivity=laPortActorActivity, swAuthUser=swAuthUser, rmonStatsStatus=rmonStatsStatus, snmpV3GroupNotifyViewName=snmpV3GroupNotifyViewName, dhcpRelayOption82Policy=dhcpRelayOption82Policy, sysSNTPFirstServer=sysSNTPFirstServer, voicevlanPortManuTagMode=voicevlanPortManuTagMode, dhcpv6RelayInterfaceSettingsTable=dhcpv6RelayInterfaceSettingsTable, sysSNTPPollInterval=sysSNTPPollInterval, doSCtrlState=doSCtrlState, dot3azEntry=dot3azEntry, staticMcastEntry=staticMcastEntry, companyDHCPRelay=companyDHCPRelay, aclL3v6RuleReplacePriority=aclL3v6RuleReplacePriority, qosTOS=qosTOS, snmpV3HostInterfaceName=snmpV3HostInterfaceName, sysDdpProtStatusIndex=sysDdpProtStatusIndex, qosDiffServType04=qosDiffServType04, snmpV3CommunityPolicy=snmpV3CommunityPolicy, swAuthAuthDirection=swAuthAuthDirection, laPortChannelEntry=laPortChannelEntry, sshUserInfoEntry=sshUserInfoEntry, sysDdpGeneralReportTimer=sysDdpGeneralReportTimer, snmpV3GroupEntry=snmpV3GroupEntry, swAuthPortAccessCtrl=swAuthPortAccessCtrl, sysPortCtrlFlowControl=sysPortCtrlFlowControl, sshUserInfoHostName=sshUserInfoHostName, snmpV3CommunityStatus=snmpV3CommunityStatus, stpHoldTime=stpHoldTime, neighborEntry=neighborEntry, tftpCfgTargetGroup=tftpCfgTargetGroup, snmpV3ViewTree=snmpV3ViewTree, neighborType=neighborType, dhcpv6RelayInterface=dhcpv6RelayInterface, snmpV3TrapSNMPAuthentication=snmpV3TrapSNMPAuthentication, trustedHostIPType=trustedHostIPType, des_1210_52_cx=des_1210_52_cx, voicevlanDeviceStatus=voicevlanDeviceStatus, aclL3v6RuleTable=aclL3v6RuleTable, swAuthUserTable=swAuthUserTable, sysSNTPFirstInterfaceName=sysSNTPFirstInterfaceName, aclL2RuleDstMacAddrMask=aclL2RuleDstMacAddrMask, impbBlackListIpAddress=impbBlackListIpAddress, qosTOSType01=qosTOSType01, securityTrafficSeg=securityTrafficSeg, dhcpv6RelayOption37State=dhcpv6RelayOption37State, stpAdminPortPathCost=stpAdminPortPathCost, qosDiffServType54=qosDiffServType54, ipifv6DHCPStatus=ipifv6DHCPStatus, dhcpv6RelayOption37CheckState=dhcpv6RelayOption37CheckState, stpPortAdminPointToPoint=stpPortAdminPointToPoint, snmpV3UserTable=snmpV3UserTable, snmpV3viewTreeType=snmpV3viewTreeType, PortLaMode=PortLaMode, firmwareTransferError=firmwareTransferError, voicevlanOUIMask=voicevlanOUIMask, dlinkGreenLEDShutoff=dlinkGreenLEDShutoff, sysHardwareVersion=sysHardwareVersion, swAuthRadiusServerTimeout=swAuthRadiusServerTimeout, sysRestart=sysRestart, aclL2RuleDstMacAddr=aclL2RuleDstMacAddr, aclL3v6RuleTrafficClass=aclL3v6RuleTrafficClass, ipifv6DefaultGateway=ipifv6DefaultGateway, qosDiffServType16=qosDiffServType16, swTimeRangeSettingEntry=swTimeRangeSettingEntry, mldsRobustnessValue=mldsRobustnessValue, aclL3v6RuleEntry=aclL3v6RuleEntry, snmpV3UserVersion=snmpV3UserVersion, cableDiagPair1TestResult=cableDiagPair1TestResult, snmpV3GroupStatus=snmpV3GroupStatus, qosTOSType00=qosTOSType00, VlanIndex=VlanIndex, sysLBDStateEnable=sysLBDStateEnable, stpBridgeMaxAge=stpBridgeMaxAge, laPortChannelMode=laPortChannelMode, cableDiagPair4TestResult=cableDiagPair4TestResult, securityARPSpoofPrevent=securityARPSpoofPrevent, dot1pPortPriority=dot1pPortPriority, sshAuthenMethodPubKeyAdmin=sshAuthenMethodPubKeyAdmin, firmwareChecksumError=firmwareChecksumError, ipifv6GlobalStatus=ipifv6GlobalStatus, doSCtrlDisplayState=doSCtrlDisplayState, igsQueryInterval=igsQueryInterval, mldsVlanMulticastGroupVlanId=mldsVlanMulticastGroupVlanId, qosDiffServType31=qosDiffServType31, snmpV3CommunityTable=snmpV3CommunityTable, snmpV3User=snmpV3User, sysPortCtrlOperStatus=sysPortCtrlOperStatus, aclResourceEntryCount=aclResourceEntryCount, aclProfileStatus=aclProfileStatus, snmpV3UserGroupName=snmpV3UserGroupName, swAuthRadiusIPType=swAuthRadiusIPType, aclL3v4ExtRuleProtocol=aclL3v4ExtRuleProtocol, sysSNTPSecondType=sysSNTPSecondType, voicevlanPortState=voicevlanPortState, impbBlackListPort=impbBlackListPort, voiceVlanTimeout=voiceVlanTimeout, staticAutoLearningList=staticAutoLearningList, swAuthRadiusServerIndex=swAuthRadiusServerIndex, aclL2Rule=aclL2Rule, qosDiffServType36=qosDiffServType36, aclPortIndex=aclPortIndex, staticMcastMac=staticMcastMac, snmpV3viewTreeName=snmpV3viewTreeName, cableDiagPair1FaultDistance=cableDiagPair1FaultDistance, sysSNTPDSTStartHour=sysSNTPDSTStartHour, RmonStatus=RmonStatus, aclL3v4RuleEntry=aclL3v4RuleEntry, rmonAlarmEntry=rmonAlarmEntry, laPortControlEntry=laPortControlEntry, syslogSrvFacility=syslogSrvFacility, sysDdpProtStatusEntry=sysDdpProtStatusEntry, companyRMON=companyRMON, securityTrustedHost=securityTrustedHost, impbWhiteListPort=impbWhiteListPort, swAuthRadiusServerTable=swAuthRadiusServerTable, securityDhcpServerScreen=securityDhcpServerScreen, ipifV6AddressIpAddr=ipifV6AddressIpAddr, snmpV3viewTreeMask=snmpV3viewTreeMask, qosDiffServ=qosDiffServ, qosDiffServType52=qosDiffServType52, dhcpRelayServerIP=dhcpRelayServerIP, dhcpRelayInterfaceSettingsRowStatus=dhcpRelayInterfaceSettingsRowStatus, mldsVlanQueryInterval=mldsVlanQueryInterval, aclL3v4ExtRuleSrcIpAddr=aclL3v4ExtRuleSrcIpAddr, rmonStatsOwner=rmonStatsOwner, queuingMechanism=queuingMechanism, swTimeRangeStartMinute=swTimeRangeStartMinute, syslogSrvIP=syslogSrvIP, autoSurveillanceVlanMode=autoSurveillanceVlanMode, aclProfileRuleCount=aclProfileRuleCount, rmonAlarmInterval=rmonAlarmInterval, aclL2RuleTable=aclL2RuleTable, laPortChannelMemberList=laPortChannelMemberList, igsVlan=igsVlan, tftpFwTargetServerIpType=tftpFwTargetServerIpType, snmpV3HostStatus=snmpV3HostStatus, trafficSegStatus=trafficSegStatus, staticMac=staticMac, voicevlanDeviceTable=voicevlanDeviceTable, dlinkGreenPortShutoff=dlinkGreenPortShutoff, sysDdpProtStatusControl=sysDdpProtStatusControl, dlink_DES1210SeriesProd=dlink_DES1210SeriesProd, qosDiffServType19=qosDiffServType19, voiceVlanMode=voiceVlanMode, dlinkGreenLEDShutoffTimeProfile1=dlinkGreenLEDShutoffTimeProfile1, sysPortDescriptionEntry=sysPortDescriptionEntry, snmpV3ViewTreeEntry=snmpV3ViewTreeEntry, swTimeRangeEndMinute=swTimeRangeEndMinute, stpTopChanges=stpTopChanges, sshMacSuiteList=sshMacSuiteList, companydot3azEEE=companydot3azEEE, qosMode=qosMode, sysSNTPDSTEndHour=sysSNTPDSTEndHour, swTimeRangeSunday=swTimeRangeSunday, dlinkGreenSystemHibernationState=dlinkGreenSystemHibernationState, dlinkGreenSystemHibernation=dlinkGreenSystemHibernation, mldsVlanMulticastGroupPortList=mldsVlanMulticastGroupPortList, dlink=dlink, swTimeRangeThursday=swTimeRangeThursday, swTimeRangeSettingTable=swTimeRangeSettingTable, aclL3v6RuleDstIpv6Addr=aclL3v6RuleDstIpv6Addr, tftpFwTargetServerIpAddress=tftpFwTargetServerIpAddress, aclL3v4ExtRuleTcpUdpSrcPort=aclL3v4ExtRuleTcpUdpSrcPort, sysSNTPDSTStartMon=sysSNTPDSTStartMon, qosDiffServType00=qosDiffServType00, snmpV3UserEntry=snmpV3UserEntry, aclL3v4RuleSrcIpAddrMask=aclL3v4RuleSrcIpAddrMask, rmonAlarmFallingEventIndex=rmonAlarmFallingEventIndex, rmonAlarmStatus=rmonAlarmStatus, igsVlanMulticastGroupPortList=igsVlanMulticastGroupPortList, aclAccessListNo=aclAccessListNo, aRPSpoofPreventPortList=aRPSpoofPreventPortList, aclL3v6RuleProtocol=aclL3v6RuleProtocol, sysSNTPGMTMinutes=sysSNTPGMTMinutes, tftpFwTargetImageFileName=tftpFwTargetImageFileName, sysDdpGeneralReportOnOff=sysDdpGeneralReportOnOff, voicevlanDeviceEntry=voicevlanDeviceEntry, dhcpServerScreenTrustedServerAddress=dhcpServerScreenTrustedServerAddress, dhcpServerScreenTrustedServerIndex=dhcpServerScreenTrustedServerIndex, dot1qVlanAsyOnOff=dot1qVlanAsyOnOff, laPortControlIndex=laPortControlIndex, aclL3v6RuleTcpUdpDstPort=aclL3v6RuleTcpUdpDstPort, rmonEventDescription=rmonEventDescription, rmonAlarmSampleType=rmonAlarmSampleType, rmonAlarm=rmonAlarm, igsVlanSnoopStatus=igsVlanSnoopStatus, aclL3v6RuleProfileNo=aclL3v6RuleProfileNo, sysLBDVlanLoopPorts=sysLBDVlanLoopPorts, staticMcastTable=staticMcastTable, qosDiffServType12=qosDiffServType12, dot1pPortIndex=dot1pPortIndex, autoSurveillanceVlanOUIComponentType=autoSurveillanceVlanOUIComponentType, neighborTable=neighborTable, aclHWProfileIndex=aclHWProfileIndex, impbSmartIpAddress=impbSmartIpAddress, aclL2RuleAction=aclL2RuleAction, staticMcastEgressPorts=staticMcastEgressPorts, stpPortOperPointToPoint=stpPortOperPointToPoint, companyCableDiagnostic=companyCableDiagnostic, igsVlanMulticastGroupEntry=igsVlanMulticastGroupEntry, LacpKey=LacpKey, sshPublKeyRSAAdmin=sshPublKeyRSAAdmin, staticVlanID=staticVlanID, stpPortDesignatedPort=stpPortDesignatedPort, qosDiffServType14=qosDiffServType14, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, aclL2RuleSrcMacAddr=aclL2RuleSrcMacAddr, stpProtocolSpecification=stpProtocolSpecification, bandwidthCtrlEntry=bandwidthCtrlEntry, autoSurveillanceVlanSystem=autoSurveillanceVlanSystem, impbBlackListEntry=impbBlackListEntry, stpPortOperEdgePort=stpPortOperEdgePort, snmpV3GroupSecurityLevel=snmpV3GroupSecurityLevel, stpGlobal=stpGlobal, sysSNTPSecondInterfaceName=sysSNTPSecondInterfaceName, mldsQueryInterval=mldsQueryInterval)
mibBuilder.exportSymbols("DES-1210-52-CX", syslogInterfaceName=syslogInterfaceName, swAuthAuthConfigPortNumber=swAuthAuthConfigPortNumber, dlinkGreenPortShutoffState=dlinkGreenPortShutoffState, impbSettingEntry=impbSettingEntry, sshUserInfoUserName=sshUserInfoUserName, companyIpifGroup=companyIpifGroup, impbSmartTable=impbSmartTable, stpPortRestrictedTCN=stpPortRestrictedTCN, staticMcastVlanID=staticMcastVlanID, swAuthRadiusServerInterfaceName=swAuthRadiusServerInterfaceName, securityPortSecurity=securityPortSecurity, aclL3v4ExtRuleProtocolId=aclL3v4ExtRuleProtocolId, sysMirrorStatus=sysMirrorStatus, aclL3v6RuleSrcIpv6AddrPrefixLen=aclL3v6RuleSrcIpv6AddrPrefixLen, traps=traps, sysMirrorCtrlEgressMirroring=sysMirrorCtrlEgressMirroring, sysSNTPDSTEndMon=sysSNTPDSTEndMon, trustedHostTable=trustedHostTable, snmpV3GroupWriteViewName=snmpV3GroupWriteViewName, Timeout=Timeout, laPortControlTable=laPortControlTable, qosDiffServType08=qosDiffServType08, syslogTimeStampOption=syslogTimeStampOption, snmpV3GroupReadViewName=snmpV3GroupReadViewName, swAuthUserPassword=swAuthUserPassword, sysPortCtrlFlowControlOper=sysPortCtrlFlowControlOper, dlinkGreenPortShutoffTimeProfile1=dlinkGreenPortShutoffTimeProfile1, impbBlackListTable=impbBlackListTable, qosDiffServType25=qosDiffServType25, mldsVlanQuerier=mldsVlanQuerier, stpPortEnable=stpPortEnable, sysLBDMode=sysLBDMode, mcastFilterPortIndex=mcastFilterPortIndex, stpPortEdge=stpPortEdge, impbSmartPort=impbSmartPort, igsGrpQueryInterval=igsGrpQueryInterval, igsVlanRouterPortList=igsVlanRouterPortList, aclL2RuleVlanId=aclL2RuleVlanId, dhcpServerScreenTrustedServerStatus=dhcpServerScreenTrustedServerStatus, sshAuthenMethodHostKeyAdmin=sshAuthenMethodHostKeyAdmin, aclPortBindGroup=aclPortBindGroup, tftpCfgTargetTftpOperation=tftpCfgTargetTftpOperation, sysSNTPDSTState=sysSNTPDSTState, stpPriority=stpPriority, qosDiffServType58=qosDiffServType58, trafficSegTable=trafficSegTable, qosDiffServType55=qosDiffServType55, qosDiffServType62=qosDiffServType62, igsHostPortPurgeInterval=igsHostPortPurgeInterval, snmpV3UserAuthProtocol=snmpV3UserAuthProtocol, sysMirrorCtrlIngressMirroring=sysMirrorCtrlIngressMirroring, dhcpv6RelayOption37RemoteID=dhcpv6RelayOption37RemoteID, igsQueryMaxResponseTime=igsQueryMaxResponseTime, laPortActorTimeout=laPortActorTimeout, cableDiagPair4FaultDistance=cableDiagPair4FaultDistance, aclPortGroupEntry=aclPortGroupEntry, tftpCfgTargetTftpOperationStatus=tftpCfgTargetTftpOperationStatus, mldsQueryMaxResponseTime=mldsQueryMaxResponseTime, snmpV3CommunityName=snmpV3CommunityName, swTimeRangeStartMonth=swTimeRangeStartMonth, qosDiffServType37=qosDiffServType37, sysMirrorTargetPort=sysMirrorTargetPort, qosTOSGroup=qosTOSGroup, dot1qVlanManagementOnOff=dot1qVlanManagementOnOff, swAuthAuthServerTimeout=swAuthAuthServerTimeout, dlink_products=dlink_products, qosDiffServType50=qosDiffServType50, qosDiffServType11=qosDiffServType11, companyRSTP=companyRSTP, qosDiffServType05=qosDiffServType05, qosDiffServType28=qosDiffServType28, impbWhiteListIpAddress=impbWhiteListIpAddress, swTimeRangeStartYear=swTimeRangeStartYear, qosDiffServType27=qosDiffServType27, companyMiscGroup=companyMiscGroup, dhcpv6RelayInterfaceSettingsEntry=dhcpv6RelayInterfaceSettingsEntry, trustedHostIpAddr=trustedHostIpAddr, snmpV3UserPrivProtocol=snmpV3UserPrivProtocol, igsVlanRtrPortList=igsVlanRtrPortList, aRPSpoofPreventMacAddress=aRPSpoofPreventMacAddress, swTimeRangeEndYear=swTimeRangeEndYear, qosTOSType05=qosTOSType05, companyDoSCtrl=companyDoSCtrl, igsVlanFilterVlanId=igsVlanFilterVlanId, autoSurveillanceVlanOUIMask=autoSurveillanceVlanOUIMask, aclL3v4ExtRuleToS=aclL3v4ExtRuleToS, staticTable=staticTable, trustedHostEntry=trustedHostEntry, mldsVlan=mldsVlan, stpPortEntry=stpPortEntry, sysPortCtrlIndex=sysPortCtrlIndex, laPortControl=laPortControl, swAuthRadiusServerAddress=swAuthRadiusServerAddress, companySecurity=companySecurity, mldsVlanMulticastGroupTable=mldsVlanMulticastGroupTable, aRPSpoofPreventRowStatus=aRPSpoofPreventRowStatus, aclL3v4RuleTable=aclL3v4RuleTable, impbPortState=impbPortState, aclL3v6RuleDstIpv6AddrPrefixLen=aclL3v6RuleDstIpv6AddrPrefixLen, snmpV3HostAddress=snmpV3HostAddress, aclL3v4RulePriority=aclL3v4RulePriority, sysDdp=sysDdp, broadcastStormCtrlLimitType=broadcastStormCtrlLimitType, dhcpServerScreenEnablePortlist=dhcpServerScreenEnablePortlist, snmpV3Host=snmpV3Host, trafficSegIfIndex=trafficSegIfIndex, dhcpServerScreenTrustedServerTable=dhcpServerScreenTrustedServerTable, dot1pPortTable=dot1pPortTable, broadcastStormCtrlSettings=broadcastStormCtrlSettings, neighborCacheState=neighborCacheState, autoSurveillanceVlanId=autoSurveillanceVlanId, stpForwardDelay=stpForwardDelay, sysFirmwareVersion=sysFirmwareVersion, ipifv6AutolinkloStatus=ipifv6AutolinkloStatus, mldsVlanMulticastGroupIpAddress=mldsVlanMulticastGroupIpAddress, rmonStatsIndex=rmonStatsIndex, voicevlanSystem=voicevlanSystem, aclProfileType=aclProfileType, ipifV6AddressIpPrefix=ipifV6AddressIpPrefix, sysSNTPDSTEndMin=sysSNTPDSTEndMin, aclL2RuleSrcMacAddrMask=aclL2RuleSrcMacAddrMask, impbAutoScanStatus=impbAutoScanStatus, companyTftpGroup=companyTftpGroup, dhcpLocalRelaySettingsVLANID=dhcpLocalRelaySettingsVLANID, dot1qVlanPortTable=dot1qVlanPortTable, aclL3v4RuleProfileNo=aclL3v4RuleProfileNo, snmpV3GroupSecurityModel=snmpV3GroupSecurityModel, staticStatus=staticStatus, rmonStatsTable=rmonStatsTable, aclProfileEntry=aclProfileEntry, sysPortCtrlSpeed=sysPortCtrlSpeed, securitySSH=securitySSH, stpPortProtocolMigration=stpPortProtocolMigration, dhcpRelayTimeThreshold=dhcpRelayTimeThreshold, rmonHistoryStatus=rmonHistoryStatus, laStatus=laStatus, voicevlanDeviceTagType=voicevlanDeviceTagType, swTimeRangeName=swTimeRangeName, voicevlanPortControlTable=voicevlanPortControlTable, sysIpAddrCfgMode=sysIpAddrCfgMode, impbBlackListVlanId=impbBlackListVlanId, aclL3v6RuleTcpUdpSrcPort=aclL3v6RuleTcpUdpSrcPort, companyLLDPSetting=companyLLDPSetting, igsVlanMulticastGroupIpAddress=igsVlanMulticastGroupIpAddress, swTimeRangeTuesday=swTimeRangeTuesday, qosDiffServType13=qosDiffServType13, miscReset=miscReset, swTimeRangeFriday=swTimeRangeFriday, qosTOSType02=qosTOSType02, rmonHistoryInterval=rmonHistoryInterval, portD3State=portD3State, syslogSrvEntry=syslogSrvEntry, firmwareIllegalFile=firmwareIllegalFile, sshAuthenMethodPassWordAdmin=sshAuthenMethodPassWordAdmin, sysSNTPDSTStartMin=sysSNTPDSTStartMin, syslogSrvSeverity=syslogSrvSeverity, syslogSrvTable=syslogSrvTable, sysSystemPassword=sysSystemPassword, companyDHCPv6Relay=companyDHCPv6Relay, swAuthPortAccessControlTable=swAuthPortAccessControlTable, aclPortL3v4ProfileNo=aclPortL3v4ProfileNo, rmonHistory=rmonHistory, mldsVlanCfgQuerier=mldsVlanCfgQuerier, syslogSrvPort=syslogSrvPort, dlinkGreenPortShutoffPortList=dlinkGreenPortShutoffPortList, sysIpAddr=sysIpAddr, portSecState=portSecState, qosDiffServType61=qosDiffServType61, qosQ1p=qosQ1p, stpDesignatedRoot=stpDesignatedRoot, portSecTable=portSecTable, igsReportToAllPort=igsReportToAllPort, impbSmartMacAddress=impbSmartMacAddress, stpPortDesignatedBridge=stpPortDesignatedBridge, impbWhiteListRowStatus=impbWhiteListRowStatus, companyGreenSetting=companyGreenSetting, dhcpRelayManagementOption82=dhcpRelayManagementOption82, igsVlanFilterTable=igsVlanFilterTable, qosDiffServType15=qosDiffServType15, dhcpRelayManagement=dhcpRelayManagement, snmpV3TrapLBD=snmpV3TrapLBD, rmonStatsEntry=rmonStatsEntry, qosDiffServType10=qosDiffServType10, impbWhiteListMacAddress=impbWhiteListMacAddress, snmpV3CommunityEntry=snmpV3CommunityEntry, snmpV3Trap=snmpV3Trap, sshMaxAuthFailAttempts=sshMaxAuthFailAttempts, sysSNTPFirstType=sysSNTPFirstType, stpRootCost=stpRootCost, sysLBDPortStatus=sysLBDPortStatus, companyAuthGroup=companyAuthGroup, snmpV3viewTreeSubtree=snmpV3viewTreeSubtree, swTimeRangeDate=swTimeRangeDate, stpTxHoldCount=stpTxHoldCount, qosDiffServType18=qosDiffServType18, voicevlanOUIEntry=voicevlanOUIEntry, snmpV3EngineID=snmpV3EngineID, companyStaticMcast=companyStaticMcast, dot3azTable=dot3azTable, companyMldsGroup=companyMldsGroup, sysLBDCtrlTable=sysLBDCtrlTable, rmonHistoryBucketsRequested=rmonHistoryBucketsRequested, impbSettingTable=impbSettingTable, stpRootPort=stpRootPort, swAuthAuthReAuthPeriod=swAuthAuthReAuthPeriod, dlinkGreenLEDShutoffState=dlinkGreenLEDShutoffState, qosDiffServType48=qosDiffServType48, igsSystem=igsSystem, swAuthAuthSuppTimeout=swAuthAuthSuppTimeout, sysLBDCtrlIndex=sysLBDCtrlIndex, rmonEvent=rmonEvent, tftpCfgTargetServerIpType=tftpCfgTargetServerIpType, snmpV3IPType=snmpV3IPType, aclL3v4Rule=aclL3v4Rule, aclL3v6RuleProtocolId=aclL3v6RuleProtocolId, aclL3v4ExtRulePriority=aclL3v4ExtRulePriority, dlinklldpConfigManAddrEntry=dlinklldpConfigManAddrEntry, companyDot1qVlanGroup=companyDot1qVlanGroup, rstpStatus=rstpStatus, sysSNTPTimeSeconds=sysSNTPTimeSeconds, aclL3v4RuleStatus=aclL3v4RuleStatus, swAuthRadiusServer=swAuthRadiusServer, qosDiffServType42=qosDiffServType42, aclL3v4ExtRuleProfileNo=aclL3v4ExtRuleProfileNo, igsRobustnessValue=igsRobustnessValue, neighborMACAddr=neighborMACAddr, stpVersion=stpVersion, mldsVlanRtrPortList=mldsVlanRtrPortList, impbAutoScanIpAddressTo=impbAutoScanIpAddressTo, aclL3v4RuleAccessID=aclL3v4RuleAccessID, snmpV3Group=snmpV3Group, dlinkGreenLEDShutoffPortList=dlinkGreenLEDShutoffPortList, dhcpRelayOption82CheckState=dhcpRelayOption82CheckState, qosDiffServType22=qosDiffServType22, aclL2RuleEntry=aclL2RuleEntry, stpPortPathCost=stpPortPathCost, impbWhiteListTable=impbWhiteListTable, topologyChange=topologyChange, staticEntry=staticEntry, qosDiffServType40=qosDiffServType40, aclL3v4ExtRuleTable=aclL3v4ExtRuleTable, dot1qVlanName=dot1qVlanName, rmonAlarmIndex=rmonAlarmIndex, aclProfileName=aclProfileName, companyQoSGroup=companyQoSGroup, stpPortState=stpPortState, sshSecurityStatus=sshSecurityStatus, qosDiffServType51=qosDiffServType51, staticMcastStatus=staticMcastStatus, snmpV3ViewTreeTable=snmpV3ViewTreeTable, aclL3v4ExtRuleStatus=aclL3v4ExtRuleStatus, aclL3v4ExtRuleDstIpAddrMask=aclL3v4ExtRuleDstIpAddrMask, aRPSpoofPreventEntry=aRPSpoofPreventEntry, swAuthStatus=swAuthStatus)
mibBuilder.exportSymbols("DES-1210-52-CX", dhcpLocalRelaySettingsState=dhcpLocalRelaySettingsState, neighborRowStatus=neighborRowStatus, tftpCfgTargetInterfaceName=tftpCfgTargetInterfaceName, LldpManAddress=LldpManAddress, dhcpv6RelayState=dhcpv6RelayState, swAuthPortAccessControlEntry=swAuthPortAccessControlEntry, dhcpServerScreenTrustedServerEntry=dhcpServerScreenTrustedServerEntry, stpBridgeForwardDelay=stpBridgeForwardDelay, aclL3v6RuleICMPv6MessageType=aclL3v6RuleICMPv6MessageType, dhcpv6RelayHopCount=dhcpv6RelayHopCount, snmpV3Community=snmpV3Community, cableDiagPair2FaultDistance=cableDiagPair2FaultDistance, rmonAlarmRisingThreshold=rmonAlarmRisingThreshold, dhcpLocalRelayTable=dhcpLocalRelayTable, mldsRouterPortPurgeInterval=mldsRouterPortPurgeInterval, sysDhcpAutoConfiguration=sysDhcpAutoConfiguration, rmonAlarmOwner=rmonAlarmOwner, aclL3v6Rule=aclL3v6Rule, dlinklldpMsgTxInterval=dlinklldpMsgTxInterval, sysLoginTimeoutInterval=sysLoginTimeoutInterval, swAuthAuthMaxReq=swAuthAuthMaxReq, tftpFwTargetTftpOperation=tftpFwTargetTftpOperation, aclL3v6RuleTcpUdpDstPortMask=aclL3v6RuleTcpUdpDstPortMask, aclL3v6RulePriority=aclL3v6RulePriority, dot1qVlanPortEntry=dot1qVlanPortEntry, swAuthAuthCapability=swAuthAuthCapability, snmpV3GroupName=snmpV3GroupName, autoSurveillanceVlanPriority=autoSurveillanceVlanPriority, igsVlanRouterTable=igsVlanRouterTable, mldsVlanFilterVlanId=mldsVlanFilterVlanId, igsVlanCfgQuerier=igsVlanCfgQuerier, swTimeRangeWednesday=swTimeRangeWednesday, rmonHistoryIndex=rmonHistoryIndex, swAuthAuthReAuthentication=swAuthAuthReAuthentication, laPortChannelTable=laPortChannelTable, mldsVlanFilterTable=mldsVlanFilterTable, sysSwitchName=sysSwitchName, companySyslog=companySyslog, companySystem=companySystem, aclPortGroupTable=aclPortGroupTable, dhcpRelayOption82RemoteIDType=dhcpRelayOption82RemoteIDType, sysPortDescriptionTable=sysPortDescriptionTable, impbDHCPPortState=impbDHCPPortState, aclL3v4ExtRule=aclL3v4ExtRule, dlinkGreenPortShutoffTimeProfile2=dlinkGreenPortShutoffTimeProfile2, dot1qVlanUntaggedPorts=dot1qVlanUntaggedPorts, qosDiffServType41=qosDiffServType41, dlinklldpConfigManAddrTable=dlinklldpConfigManAddrTable, swAuthUserEntry=swAuthUserEntry, mcastFilterPortTable=mcastFilterPortTable, miscStatisticsReset=miscStatisticsReset, swAuthenCtrl=swAuthenCtrl, qosTOSType03=qosTOSType03, doSCtrlTable=doSCtrlTable, qosDiffServType17=qosDiffServType17, aclHWResourceStatusEntry=aclHWResourceStatusEntry, swTimeRangeStartHour=swTimeRangeStartHour, doSCtrlType=doSCtrlType, stpPortTable=stpPortTable, dhcpRelayHopCount=dhcpRelayHopCount, qosDiffServType30=qosDiffServType30, aclL3v4ExtRuleReplacePriority=aclL3v4ExtRuleReplacePriority, sysSNTPSecondServer=sysSNTPSecondServer, qosDiffServType53=qosDiffServType53, impbBlackListMacAddress=impbBlackListMacAddress, aRPSpoofPreventIpAddr=aRPSpoofPreventIpAddr, ipifName=ipifName, dhcpLocalRelayGlobalState=dhcpLocalRelayGlobalState, stpPort=stpPort, sysDdpProtStatusTable=sysDdpProtStatusTable, dot3azEEEset=dot3azEEEset, aclL3v6RuleTcpUdpSrcPortMask=aclL3v6RuleTcpUdpSrcPortMask, qosDiffServType57=qosDiffServType57, qosTOSType06=qosTOSType06, dlinklldpLocManAddr=dlinklldpLocManAddr, bandwidthCtrlTable=bandwidthCtrlTable, ipifSupportV4V6Info=ipifSupportV4V6Info, voicevlanDevicePriority=voicevlanDevicePriority, aclL3v6RuleAction=aclL3v6RuleAction, dhcpRelayOption82State=dhcpRelayOption82State, companyACLGroup=companyACLGroup, companyTraps=companyTraps, sysPortCtrlEntry=sysPortCtrlEntry, snmpV3TrapRSTPStateChange=snmpV3TrapRSTPStateChange, dlinklldpState=dlinklldpState, laPortChannelIfIndex=laPortChannelIfIndex, syslogGeneralGroup=syslogGeneralGroup, sysLBDInterval=sysLBDInterval, sysDdpGlobalOnOff=sysDdpGlobalOnOff, voicevlanDevicePort=voicevlanDevicePort, securitySSL=securitySSL, companyTimeRangeMgmt=companyTimeRangeMgmt, aclPortL2ProfileNo=aclPortL2ProfileNo, rmonGlobalState=rmonGlobalState, aclL3v4ExtRuleAction=aclL3v4ExtRuleAction, trafficSegEntry=trafficSegEntry, dhcpRelayInterfaceSettingsTable=dhcpRelayInterfaceSettingsTable, swAuthAuthQuietPeriod=swAuthAuthQuietPeriod, qosDiffServType56=qosDiffServType56, aclL2Rule1pPriority=aclL2Rule1pPriority, dhcpv6RelayServerIP=dhcpv6RelayServerIP, companyDHCPLocalRelay=companyDHCPLocalRelay, igsVlanQueryInterval=igsVlanQueryInterval, qosDiffServType60=qosDiffServType60, qosDiffServType02=qosDiffServType02, aclL3v4ExtRuleAccessID=aclL3v4ExtRuleAccessID, swTimeRangeEndDay=swTimeRangeEndDay, trustedHostStatus=trustedHostStatus, mldsGrpQueryInterval=mldsGrpQueryInterval, voicevlanPortControlEntry=voicevlanPortControlEntry, autoSurveillanceVlanOUIStatus=autoSurveillanceVlanOUIStatus, portSecIndex=portSecIndex, dlinkGreenLEDShutoffTimeProfile2=dlinkGreenLEDShutoffTimeProfile2, mldsVlanRouterPortList=mldsVlanRouterPortList, dot1qVlanTable=dot1qVlanTable, mldsVlanFilterEntry=mldsVlanFilterEntry, aclL3v4ExtRuleEntry=aclL3v4ExtRuleEntry, voiceVlanPriority=voiceVlanPriority, aclL3v6RuleICMPv6MessageCode=aclL3v6RuleICMPv6MessageCode, swTimeRangeIndex=swTimeRangeIndex, qosDiffServType39=qosDiffServType39, sysIpSubnetMask=sysIpSubnetMask, aclL3v4ExtRuleICMPMessageCode=aclL3v4ExtRuleICMPMessageCode, sysGateway=sysGateway, impbPortIndex=impbPortIndex, qosDiffServType32=qosDiffServType32, sysLocationName=sysLocationName, aclL2ProfileID=aclL2ProfileID, rmonAlarmVariable=rmonAlarmVariable, qosDiffServType21=qosDiffServType21, qosDiffServType23=qosDiffServType23, tftpFwTargetTftpOperationStatus=tftpFwTargetTftpOperationStatus, stpPortRestrictedRole=stpPortRestrictedRole, syslogSrvIPType=syslogSrvIPType, voicevlanOUIStatus=voicevlanOUIStatus, sshUserInfoID=sshUserInfoID, companyLBD=companyLBD, dot1pPortEntry=dot1pPortEntry, dhcpv6RelayManagement=dhcpv6RelayManagement, aclProfileTable=aclProfileTable, dhcpRelayState=dhcpRelayState, rmonEventTable=rmonEventTable, cableDiagPair3TestResult=cableDiagPair3TestResult, swAuthAuthTxPeriod=swAuthAuthTxPeriod, voicevlanOUI=voicevlanOUI, qosDiffServType01=qosDiffServType01, qosDiffServType03=qosDiffServType03, rmonHistoryTable=rmonHistoryTable, swTimeRangeStartDay=swTimeRangeStartDay, stpPortDesignatedCost=stpPortDesignatedCost, rmonEventOwner=rmonEventOwner, swAuthRadiusServerRetransmit=swAuthRadiusServerRetransmit, swAuthRadiusServerStatus=swAuthRadiusServerStatus, firmwareUpgradeSuccess=firmwareUpgradeSuccess, rmonAlarmRisingEventIndex=rmonAlarmRisingEventIndex, qosDiffServType38=qosDiffServType38, dlinkGreenSystemHibernationTimeProfile2=dlinkGreenSystemHibernationTimeProfile2, igsVlanRouterVlanId=igsVlanRouterVlanId, cableDiagPair3FaultDistance=cableDiagPair3FaultDistance, dhcpv6RelayOption37=dhcpv6RelayOption37, stpPortDesignatedRoot=stpPortDesignatedRoot, snmpV3UserName=snmpV3UserName, qosDiffServType24=qosDiffServType24, securityIpMacPortBinding=securityIpMacPortBinding, voicevlanDeviceIndexMac=voicevlanDeviceIndexMac, trafficSegMemberList=trafficSegMemberList, BridgeId=BridgeId, ipifv6NSRetransmitTime=ipifv6NSRetransmitTime, qosDiffServType07=qosDiffServType07, mcastFilterPortType=mcastFilterPortType, syslogState=syslogState, qosDiffServType43=qosDiffServType43, aclPortL3v6ProfileNo=aclPortL3v6ProfileNo, sysPortDescIndex=sysPortDescIndex, rmonAlarmFallingThreshold=rmonAlarmFallingThreshold, snmpV3UserStatus=snmpV3UserStatus, impbBlackListStatus=impbBlackListStatus, syslogSrvRowStatus=syslogSrvRowStatus, swAuthRadiusServerAccountingPort=swAuthRadiusServerAccountingPort, dlinklldpConfigManAddrPortsTxEnable=dlinklldpConfigManAddrPortsTxEnable, igsVlanMulticastGroupMacAddress=igsVlanMulticastGroupMacAddress, aclL3v4ExtRuleSrcIpAddrMask=aclL3v4ExtRuleSrcIpAddrMask, sshUserInfoAuth=sshUserInfoAuth, companySNTPSetting=companySNTPSetting, sshUserInfoHostIp=sshUserInfoHostIp, qosTOSEnable=qosTOSEnable, portSecMLA=portSecMLA, autoSurveillanceVlanOUIDescription=autoSurveillanceVlanOUIDescription, Ipv6Address=Ipv6Address, rmonHistoryEntry=rmonHistoryEntry, cableDiagTriggerIndex=cableDiagTriggerIndex, sysLBDVlanLoopEntry=sysLBDVlanLoopEntry, dhcpRelayOption82RemoteID=dhcpRelayOption82RemoteID, des_1210_52=des_1210_52, companyMirror=companyMirror, sysLBDRecoverTime=sysLBDRecoverTime, aclL3v4RuleAction=aclL3v4RuleAction, autoSurveillanceVlanTaggedUplinkDownlinkPort=autoSurveillanceVlanTaggedUplinkDownlinkPort, igsVlanQuerier=igsVlanQuerier, swAuthRadiusServerAuthenticationPort=swAuthRadiusServerAuthenticationPort, sysDhcpRetryTimes=sysDhcpRetryTimes, trustedHostIpMask=trustedHostIpMask, dot1qVlanRowStatus=dot1qVlanRowStatus, impbSmartEntry=impbSmartEntry, qosDiffServType47=qosDiffServType47, snmpV3viewTreeStatus=snmpV3viewTreeStatus, voicevlanPortAutoDetection=voicevlanPortAutoDetection, swTimeRangeRowStatus=swTimeRangeRowStatus, dlinklldpReinitDelay=dlinklldpReinitDelay, rmonAlarmTable=rmonAlarmTable, igsVlanMulticastGroupTable=igsVlanMulticastGroupTable, mldsVlanMulticastGroupEntry=mldsVlanMulticastGroupEntry, portSecEntry=portSecEntry, sysSNTPServerTable=sysSNTPServerTable, aclL3v4ExtRuleTcpUdpSrcPortMask=aclL3v4ExtRuleTcpUdpSrcPortMask, snmpGlobalState=snmpGlobalState, snmpV3TrapPortLinkUpDown=snmpV3TrapPortLinkUpDown, rmonStatistics=rmonStatistics, mldsVlanRouterVlanId=mldsVlanRouterVlanId, qosDiffServType44=qosDiffServType44, stpMaxAge=stpMaxAge, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, sslSecurityHttpStatus=sslSecurityHttpStatus, bandwidthCtrlTxThreshold=bandwidthCtrlTxThreshold, rmonEventEntry=rmonEventEntry, qosDiffServType34=qosDiffServType34, tftpCfgTargetServerIpAddress=tftpCfgTargetServerIpAddress, qosTOSType07=qosTOSType07, cableDiagLengthinRange=cableDiagLengthinRange, qosDiffServType29=qosDiffServType29, snmpV3UserPrivProtocolPassword=snmpV3UserPrivProtocolPassword, autoSurveillanceVlanOUITable=autoSurveillanceVlanOUITable, impbSmartBinding=impbSmartBinding, sshUserInfoTable=sshUserInfoTable, companyNeighbor=companyNeighbor, mldsStatus=mldsStatus, broadcastStormCtrlThreshold=broadcastStormCtrlThreshold, aclL2RuleStatus=aclL2RuleStatus, aclL3v4RuleDstIpAddrMask=aclL3v4RuleDstIpAddrMask, mcastFilterPortEntry=mcastFilterPortEntry, swAuthUserStatus=swAuthUserStatus, ipifV6AddressRowStatus=ipifV6AddressRowStatus, snmpV3HostVersion=snmpV3HostVersion, voicevlanOUIDescription=voicevlanOUIDescription, dhcpRelayInterface=dhcpRelayInterface, mldsSystem=mldsSystem, dhcpv6RelayOption37RemoteIDType=dhcpv6RelayOption37RemoteIDType, staticDisableAutoLearn=staticDisableAutoLearn, dot1qVlanEntry=dot1qVlanEntry, sshUserInfoHostIpv6=sshUserInfoHostIpv6, rmonEventIndex=rmonEventIndex, snmpV3HostTable=snmpV3HostTable, sysLBDPortLoopStatus=sysLBDPortLoopStatus, voicevlanPortCurrentTagMode=voicevlanPortCurrentTagMode)
mibBuilder.exportSymbols("DES-1210-52-CX", rmonEventCommunity=rmonEventCommunity, ipifV6AddressEntry=ipifV6AddressEntry, ipifV6AddressIpType=ipifV6AddressIpType, dhcpv6RelayInterfaceSettingsRowStatus=dhcpv6RelayInterfaceSettingsRowStatus, dot1qVlanPvid=dot1qVlanPvid, sshSessionKeyRekeying=sshSessionKeyRekeying, aclL3v4ExtRuleDscp=aclL3v4ExtRuleDscp, voicevlanOUITelephonyOUI=voicevlanOUITelephonyOUI, qosDiffServType06=qosDiffServType06, sysPortCtrlTable=sysPortCtrlTable, impbAutoScanIpAddressFrom=impbAutoScanIpAddressFrom, swAuthCtrlPktFwdMode=swAuthCtrlPktFwdMode, mldsVlanRouterEntry=mldsVlanRouterEntry, sysLBDCtrlEntry=sysLBDCtrlEntry, aRPSpoofPreventTable=aRPSpoofPreventTable, mldsHostPortPurgeInterval=mldsHostPortPurgeInterval, bandwidthCtrlSettings=bandwidthCtrlSettings, PortList=PortList, sysSafeGuardEnable=sysSafeGuardEnable, trustedHostRowStatus=trustedHostRowStatus, swTimeRangeSaturday=swTimeRangeSaturday, tftpCfgTargetImageFileName=tftpCfgTargetImageFileName, qosDiffServType26=qosDiffServType26, dhcpRelayControl=dhcpRelayControl, tftpFwTargetGroup=tftpFwTargetGroup, snmpV3GroupTable=snmpV3GroupTable, dhcpServerScreenIPType=dhcpServerScreenIPType, autoSurveillanceVlanOUISurveillanceOUI=autoSurveillanceVlanOUISurveillanceOUI, sslCiphers=sslCiphers, aclL3v4RuleReplacePriority=aclL3v4RuleReplacePriority, companyIgsGroup=companyIgsGroup, sysSave=sysSave, voicevlanPortControlIndex=voicevlanPortControlIndex, aclL3v4ExtRuleDstIpAddr=aclL3v4ExtRuleDstIpAddr, sslCipherSuiteList=sslCipherSuiteList, portD3Index=portD3Index, swAuthUserName=swAuthUserName, sysPortCtrlType=sysPortCtrlType, qosDiffServTypeGroup=qosDiffServTypeGroup, aclL3v6RuleSrcIpv6Addr=aclL3v6RuleSrcIpv6Addr, rmonHistoryOwner=rmonHistoryOwner, swLoopDetectEnabledVlanList=swLoopDetectEnabledVlanList, rmonHistoryDataSource=rmonHistoryDataSource, stpBridgeHelloTime=stpBridgeHelloTime, igsVlanFilterEntry=igsVlanFilterEntry, sysLBDVlanLoopTable=sysLBDVlanLoopTable, impbSmartVlanId=impbSmartVlanId, sysPortCtrlMDI=sysPortCtrlMDI, sysSNTPState=sysSNTPState, voiceVlanId=voiceVlanId, swAuthRadiusServerKey=swAuthRadiusServerKey, snmpV3TrapFirmUpgrade=snmpV3TrapFirmUpgrade, dlinklldpMsgHoldMultiplier=dlinklldpMsgHoldMultiplier, bandwidthCtrlIndex=bandwidthCtrlIndex, companyVoiceVlan=companyVoiceVlan, igsVlanFastLeave=igsVlanFastLeave, dlinkPowerSavingGlobalSetting=dlinkPowerSavingGlobalSetting, sysJumboFrameEnable=sysJumboFrameEnable, companyMulticastFilter=companyMulticastFilter, companyAutoSurveillanceVlan=companyAutoSurveillanceVlan, mldsVlanMulticastGroupMacAddress=mldsVlanMulticastGroupMacAddress, qosDiffServType33=qosDiffServType33, qosDiffServType63=qosDiffServType63, voicevlanDevice=voicevlanDevice, neighborIfindex=neighborIfindex, aclL2AccessID=aclL2AccessID, dhcpRelayInterfaceSettingsEntry=dhcpRelayInterfaceSettingsEntry, snmpV3UserAuthProtocolPassword=snmpV3UserAuthProtocolPassword, sysLBDVlanLoopIndex=sysLBDVlanLoopIndex, swTimeRangeMonday=swTimeRangeMonday, dhcpOption12Status=dhcpOption12Status, aclL3v4ExtRuleTcpUdpDstPort=aclL3v4ExtRuleTcpUdpDstPort, ipifV6AddressMainIndex=ipifV6AddressMainIndex, aclL3v4ExtRuleIgmpType=aclL3v4ExtRuleIgmpType, qosDiffServType45=qosDiffServType45, impbInsIpPacPortState=impbInsIpPacPortState, sshConnectionTimeout=sshConnectionTimeout, rmonStatsDataSource=rmonStatsDataSource, sysPortDescString=sysPortDescString, mldsVlanSnoopStatus=mldsVlanSnoopStatus, aclL2RulePriority=aclL2RulePriority, stpPortPriority=stpPortPriority, qosDiffServEnable=qosDiffServEnable, qosDiffServType49=qosDiffServType49, firmwareUpgradeFailure=firmwareUpgradeFailure, sysSNTPDSTStartDay=sysSNTPDSTStartDay, autoSurveillanceVlanOUI=autoSurveillanceVlanOUI, autoSurveillanceVlanOUIEntry=autoSurveillanceVlanOUIEntry, swTimeRangeEndMonth=swTimeRangeEndMonth, qosDiffServType35=qosDiffServType35, companyLA=companyLA, aclL2RuleEtherType=aclL2RuleEtherType, swAuthAuthConfigPortControl=swAuthAuthConfigPortControl, dot1qVlanManagementid=dot1qVlanManagementid, sshCipherSuiteList=sshCipherSuiteList, tftpFwTargetInterfaceName=tftpFwTargetInterfaceName, staticPort=staticPort, snmpV3TrapBootup=snmpV3TrapBootup, igsVlanRouterEntry=igsVlanRouterEntry, aclL3v4RuleSrcIpAddr=aclL3v4RuleSrcIpAddr, mldsVlanFastLeave=mldsVlanFastLeave, bandwidthCtrlRxThreshold=bandwidthCtrlRxThreshold, snmpV3HostCommunityName=snmpV3HostCommunityName, qosDiffServType59=qosDiffServType59, igsStatus=igsStatus, sysSNTPDSTEndDay=sysSNTPDSTEndDay, rmonEventType=rmonEventType, rmonEventStatus=rmonEventStatus, sshMaxSession=sshMaxSession, snmpV3HostEntry=snmpV3HostEntry, dhcpv6RelayControl=dhcpv6RelayControl, neighborIPv6Addr=neighborIPv6Addr, dlinklldpLocManAddrSubtype=dlinklldpLocManAddrSubtype)
