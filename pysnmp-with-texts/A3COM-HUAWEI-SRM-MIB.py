...
# Produced by pysmi-0.3.4 at Wed May  1 11:07:05 2019
...
mibBuilder.exportSymbols("A3COM-HUAWEI-SRM-MIB", hw8060SlotOperStatus=hw8060SlotOperStatus, hw8060PortTable=hw8060PortTable, aR46_E200=aR46_E200, hw8060DevMTemperatureMin=hw8060DevMTemperatureMin, hw8060SubslotAdminStatus=hw8060SubslotAdminStatus, hw8060PortEntry=hw8060PortEntry, hwHSCardConfPathErr=hwHSCardConfPathErr, hwFanUnitNormal=hwFanUnitNormal, hw8060SubslotPortNum=hw8060SubslotPortNum, hwPowerUnitNormal=hwPowerUnitNormal, hwRpuTempOK=hwRpuTempOK, hw8060FrameEntry=hw8060FrameEntry, hwVentTempOK=hwVentTempOK, dev8060MFanNum=dev8060MFanNum, hw8060SlotCpuRatio=hw8060SlotCpuRatio, hwFanUnitFail=hwFanUnitFail, hw8060FrameAdminStatus=hw8060FrameAdminStatus, hw8060SlotSubslotNumber=hw8060SlotSubslotNumber, hwNpuJtagErr=hwNpuJtagErr, hwCardPciHealthyErr=hwCardPciHealthyErr, dev8060MPowerNum=dev8060MPowerNum, hwNpRpuDmuErr=hwNpRpuDmuErr, hw8060PortOperateStatus=hw8060PortOperateStatus, hwFtpLoadFail=hwFtpLoadFail, hwNpTempTooLow=hwNpTempTooLow, hw8060SubslotType=hw8060SubslotType, hw8060FrameSlotNumber=hw8060FrameSlotNumber, hw8060SysTime=hw8060SysTime, hw8060SlotDesc=hw8060SlotDesc, hwNpIntReportErr=hwNpIntReportErr, hwSlotReset=hwSlotReset, hwNpReset=hwNpReset, hw8060DevMRpuTemperature=hw8060DevMRpuTemperature, hw8060SubslotTable=hw8060SubslotTable, hwNpTempTooHigh=hwNpTempTooHigh, hwHSCardHealthyErr=hwHSCardHealthyErr, hwPowerUnitFail=hwPowerUnitFail, hwRpuTempTooLow=hwRpuTempTooLow, dev8060MPowerStatusTable=dev8060MPowerStatusTable, PYSNMP_MODULE_ID=aR46_E200, hw8060SlotType=hw8060SlotType, hwRpuIntReportErr=hwRpuIntReportErr, hw8060SlotPcbVersion=hw8060SlotPcbVersion, hw8060FrameIndex=hw8060FrameIndex, hw8060PortAdminStatus=hw8060PortAdminStatus, hwVentTempTooHigh=hwVentTempTooHigh, hwHSCardJtagErr=hwHSCardJtagErr, hwPciAlarm=hwPciAlarm, hw8060SubslotEntry=hw8060SubslotEntry, hw8060PortType=hw8060PortType, dev8060MFanStatusEntry=dev8060MFanStatusEntry, dev8060MGlobalTable=dev8060MGlobalTable, dev8060MPowerStatusEntry=dev8060MPowerStatusEntry, hw8060FrameDesc=hw8060FrameDesc, hw8060PortDesc=hw8060PortDesc, hw8060FrameType=hw8060FrameType, hw8060PortSpeed=hw8060PortSpeed, hwTftpLoadFail=hwTftpLoadFail, hwRpuReset=hwRpuReset, dev8060MFanStatus=dev8060MFanStatus, hw8060PortIndex=hw8060PortIndex, hw8060SlotIndex=hw8060SlotIndex, hw8060SubslotIndex=hw8060SubslotIndex, hwLSCardHealthyErr=hwLSCardHealthyErr, hwNpConfPathErr=hwNpConfPathErr, hw8060DevObjects=hw8060DevObjects, dev8060MFanStatusTable=dev8060MFanStatusTable, hw8060SlotAdminStatus=hw8060SlotAdminStatus, hwXmodemLoadFail=hwXmodemLoadFail, hw8060DevMTemperatureMax=hw8060DevMTemperatureMax, hw8060DevConformance=hw8060DevConformance, hw8060SlotSoftwareVersion=hw8060SlotSoftwareVersion, hw8060SlotEntry=hw8060SlotEntry, hwNpResetOK=hwNpResetOK, hwNpTempOK=hwNpTempOK, hwRpuResetOK=hwRpuResetOK, hw8060SlotTable=hw8060SlotTable, dev8060MPowerStatus=dev8060MPowerStatus, hw8060FrameTable=hw8060FrameTable, hwWriteFlashErr=hwWriteFlashErr, hwVentTempTooLow=hwVentTempTooLow, hwHSCardPowerErr=hwHSCardPowerErr, hwPciNormal=hwPciNormal, hw8060DevMVentTemperature=hw8060DevMVentTemperature, hwRpuTempTooHigh=hwRpuTempTooHigh, hwSlotResetOK=hwSlotResetOK, hwSlotIntReportErr=hwSlotIntReportErr, hwLSCardJtagErr=hwLSCardJtagErr, hw8060SysVersion=hw8060SysVersion, hw8060DevNotifications=hw8060DevNotifications)
