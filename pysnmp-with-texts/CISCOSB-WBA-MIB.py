...
# Produced by pysmi-0.3.4 at Wed May  1 12:24:06 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Integer32, IpAddress, Gauge32, ModuleIdentity, TimeTicks, ObjectIdentity, Unsigned32, Counter64, Counter32, iso, Bits, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Integer32", "IpAddress", "Gauge32", "ModuleIdentity", "TimeTicks", "ObjectIdentity", "Unsigned32", "Counter64", "Counter32", "iso", "Bits", "MibIdentifier")
...
if mibBuilder.loadTexts: rlWBA.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
mibBuilder.exportSymbols("CISCOSB-WBA-MIB", rlWBAPassword=rlWBAPassword, rlWBAImageIndex=rlWBAImageIndex, rlWBADataTable=rlWBADataTable, RlWBARetryFlagOp=RlWBARetryFlagOp, rlWBAImageNumber=rlWBAImageNumber, rlWBADataNumber=rlWBADataNumber, rlWBADataClear=rlWBADataClear, RlWBAStatusType=RlWBAStatusType, rlWBAImageDownloadFinishStatus=rlWBAImageDownloadFinishStatus, rlWBAImageInfoEntry=rlWBAImageInfoEntry, rlWBAImageInfoSize=rlWBAImageInfoSize, rlAuxFailReason=rlAuxFailReason, rlWBADataEntry=rlWBADataEntry, rlWBAUsername=rlWBAUsername, rlWBAImageEntry=rlWBAImageEntry, rlWBAAuxiliaryEntry=rlWBAAuxiliaryEntry, rlWBAAuxiliaryTable=rlWBAAuxiliaryTable, rlWBAImageClear=rlWBAImageClear, rlIsRetryFlag=rlIsRetryFlag, rlWBAImageText=rlWBAImageText, rlWBAImageTable=rlWBAImageTable, rlWBAImageInfoNumber=rlWBAImageInfoNumber, rlWBAStatus=rlWBAStatus, PYSNMP_MODULE_ID=rlWBA, rlWBAImageInfoTable=rlWBAImageInfoTable, rlWBAIp=rlWBAIp, rlWBADataIndex=rlWBADataIndex, rlWBA=rlWBA, rlWBAImageInfoName=rlWBAImageInfoName, rlWBADataText=rlWBADataText)
