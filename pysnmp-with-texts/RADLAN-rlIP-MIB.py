...
# Produced by pysmi-0.3.4 at Wed May  1 14:51:02 2019
...
ModuleIdentity, mib_2, Gauge32, Unsigned32, Counter32, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, zeroDotZero, Counter64, TimeTicks, iso, IpAddress, MibIdentifier, Integer32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mib-2", "Gauge32", "Unsigned32", "Counter32", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "zeroDotZero", "Counter64", "TimeTicks", "iso", "IpAddress", "MibIdentifier", "Integer32", "NotificationType")
RowStatus, TimeStamp, PhysAddress, TextualConvention, StorageType, TestAndIncr, RowPointer, TruthValue, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TimeStamp", "PhysAddress", "TextualConvention", "StorageType", "TestAndIncr", "RowPointer", "TruthValue", "DisplayString")
...
if mibBuilder.loadTexts: rlIp.setContactInfo('radlan.com')
...
mibBuilder.exportSymbols("RADLAN-rlIP-MIB", RlIpAddressOriginTC=RlIpAddressOriginTC, PYSNMP_MODULE_ID=rlIp, rlIpAddressStatus=rlIpAddressStatus, rlIpAddressCompleteAddr=rlIpAddressCompleteAddr, rlIpAddressExtdPrefixLength=rlIpAddressExtdPrefixLength, rlIpAddressOrigin=rlIpAddressOrigin, rlIpAddressTable=rlIpAddressTable, rlIpAddressCreated=rlIpAddressCreated, rlIpAddressLastChanged=rlIpAddressLastChanged, rlIp=rlIp, rlIpAddressStorageType=rlIpAddressStorageType, rlIpAddressRowStatus=rlIpAddressRowStatus, rlIpAddressAddrType=rlIpAddressAddrType, rlIpAddressIfIndex=rlIpAddressIfIndex, rlIpAddressGeneralPrefixName=rlIpAddressGeneralPrefixName, rlIpAddressEntry=rlIpAddressEntry, rlIpAddressAddr=rlIpAddressAddr, rlIpAddressExtdType=rlIpAddressExtdType, rlIpAddressPrefix=rlIpAddressPrefix)
