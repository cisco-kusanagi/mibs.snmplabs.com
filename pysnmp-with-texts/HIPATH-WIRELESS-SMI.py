...
iso, MibIdentifier, NotificationType, ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, Bits, ObjectIdentity, Gauge32, Integer32, Counter64, enterprises, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "MibIdentifier", "NotificationType", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "Bits", "ObjectIdentity", "Gauge32", "Integer32", "Counter64", "enterprises", "Counter32")
...
if mibBuilder.loadTexts: hiPathWireless.setContactInfo('Behrouz Sultan Chantry Networks, Inc. 1900 Minnesota Court, Suite 125 Mississauga ON, L5N 3C9 Email: behrouz.sultan@siemens.com Phone 1-905-363-6400 Fax 1-905-567-0099')
if mibBuilder.loadTexts: hiPathWireless.setDescription('The root MIB module for High Path Wireless Products. enterprises.siemens(4329).15')
...
if mibBuilder.loadTexts: hiPathWirelessProducts.setDescription('Provides a root OID from which MIB-II sysObjectID values are assigned. Actual product OIDs are defined in HIPATH-WIRELESS-PRODUCTS-MIB.')
...
if mibBuilder.loadTexts: hiPathWirelessDevelopment.setDescription("Subtree for pre-release MIB development. Elements in this subtree are eventually moved to 'hiPathWirelessMgmt'.")
...
if mibBuilder.loadTexts: hiPathWirelessModules.setDescription('Provides a root object identifier from which MODULE-IDENTITY values are assigned.')
