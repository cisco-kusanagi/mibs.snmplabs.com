...
# Produced by pysmi-0.3.4 at Wed May  1 14:10:34 2019
...
TimeTicks, ModuleIdentity, Integer32, Bits, Gauge32, NotificationType, iso, Counter64, ObjectIdentity, Unsigned32, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "ModuleIdentity", "Integer32", "Bits", "Gauge32", "NotificationType", "iso", "Counter64", "ObjectIdentity", "Unsigned32", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
if mibBuilder.loadTexts: rlUdld.setContactInfo('marvell.com')
...
mibBuilder.exportSymbols("MARVELL-UDLD-MIB", rlUdldPortEntry=rlUdldPortEntry, rlUdldNeighborEntry=rlUdldNeighborEntry, UdldString=UdldString, rlUdldNeighborPortID=rlUdldNeighborPortID, rlUdldGlobalUDLDMode=rlUdldGlobalUDLDMode, rlUdldNeighborDeviceID=rlUdldNeighborDeviceID, rlUdldPortOperMode=rlUdldPortOperMode, UdldPortMode=UdldPortMode, rlUdldNeighborDeviceMACAddress=rlUdldNeighborDeviceMACAddress, rlUdldPortTable=rlUdldPortTable, rlUdldBidirectionalState=rlUdldBidirectionalState, rlUdldGlobalMessageTime=rlUdldGlobalMessageTime, rlUdldNeighborPortIfIndex=rlUdldNeighborPortIfIndex, rlUdldPortIfIndex=rlUdldPortIfIndex, UdldGlobalMode=UdldGlobalMode, rlUdldNumberOfDetectedNeighbors=rlUdldNumberOfDetectedNeighbors, rlUdldNeighborTable=rlUdldNeighborTable, UdldPortBidirectionalState=UdldPortBidirectionalState, rlUdld=rlUdld, rlUdldPortDefaultConfiguration=rlUdldPortDefaultConfiguration, rlUdldNeighborLeftLifeTime=rlUdldNeighborLeftLifeTime, rlUdldNeighborDeviceName=rlUdldNeighborDeviceName, rlUdldNeighborCurrentState=rlUdldNeighborCurrentState, PYSNMP_MODULE_ID=rlUdld, rlUdldPortAdminMode=rlUdldPortAdminMode, rlUdldNeighborMessageTime=rlUdldNeighborMessageTime, UdldNeighborCurrentState=UdldNeighborCurrentState)
