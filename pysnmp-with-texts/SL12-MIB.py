...
# Produced by pysmi-0.3.4 at Wed May  1 15:05:59 2019
...
Counter64, Counter32, private, Gauge32, mgmt, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, IpAddress, ModuleIdentity, enterprises, TimeTicks, internet, iso, NotificationType, MibIdentifier, Bits, ObjectIdentity, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Counter32", "private", "Gauge32", "mgmt", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "IpAddress", "ModuleIdentity", "enterprises", "TimeTicks", "internet", "iso", "NotificationType", "MibIdentifier", "Bits", "ObjectIdentity", "Integer32")
...
if mibBuilder.loadTexts: esNumberEventSensors.setDescription('The number of EventSensors recognized by the SL12 Range: 0-4')
...
mibBuilder.exportSymbols("SL12-MIB", relay2PowerupState=relay2PowerupState, analog2HighSeverity=analog2HighSeverity, esPointTable=esPointTable, tempReturnNormalTrap=tempReturnNormalTrap, serialNumber=serialNumber, mibendObject=mibendObject, contact2ReturnNormalTrap=contact2ReturnNormalTrap, ftpUsername=ftpUsername, contact4State=contact4State, contact6Name=contact6Name, contact1NormalTrap=contact1NormalTrap, esID=esID, contact3AlarmEnable=contact3AlarmEnable, voltageESVeryHighTrap=voltageESVeryHighTrap, contact4Threshold=contact4Threshold, ptSayLoginText=ptSayLoginText, contact3=contact3, contact1=contact1, humidityHighSeverity=humidityHighSeverity, netlossTrapsend=netlossTrapsend, ptLfstripFromPort=ptLfstripFromPort, contact1Threshold=contact1Threshold, analog1AlarmThreshold=analog1AlarmThreshold, eventSensorStatus=eventSensorStatus, humidityESVeryLowTrap=humidityESVeryLowTrap, techsupportIPAddress=techsupportIPAddress, tempVeryLowSeverity=tempVeryLowSeverity, contact4ReturnNormalTrap=contact4ReturnNormalTrap, analog2AlarmThreshold=analog2AlarmThreshold, analog2TrapRepeat=analog2TrapRepeat, humidityNormalTrap=humidityNormalTrap, contact6ReturnNormalTrap=contact6ReturnNormalTrap, buildID=buildID, ptLfstripToPort=ptLfstripToPort, tempESHighTrap=tempESHighTrap, contact5Threshold=contact5Threshold, ptUsername=ptUsername, contactESActiveTrap=contactESActiveTrap, contact2Threshold=contact2Threshold, asentria=asentria, voltageESLowTrap=voltageESLowTrap, contact2TrapRepeat=contact2TrapRepeat, esPointInEventState=esPointInEventState, alarmStatus=alarmStatus, tempHighLevel=tempHighLevel, contact4NormalTrap=contact4NormalTrap, techsupportRouter=techsupportRouter, humidityVeryLowTrap=humidityVeryLowTrap, contact1Name=contact1Name, relay1CurrentState=relay1CurrentState, humidityTrapRepeat=humidityTrapRepeat, contact5Severity=contact5Severity, tempMode=tempMode, contact3State=contact3State, contact6TrapRepeat=contact6TrapRepeat, serialTimeout=serialTimeout, ptNeedPassword=ptNeedPassword, contact6State=contact6State, snmpManager3=snmpManager3, esPointValueStr=esPointValueStr, analog2Value=analog2Value, humidityESHighTrap=humidityESHighTrap, voltageESVeryLowTrap=voltageESVeryLowTrap, analog1LowSeverity=analog1LowSeverity, contact4Severity=contact4Severity, analog2VeryLowSeverity=analog2VeryLowSeverity, esEntry=esEntry, analog1VeryHighSeverity=analog1VeryHighSeverity, ptPassword=ptPassword, contact3ActiveTrap=contact3ActiveTrap, contact3ReturnNormalTrap=contact3ReturnNormalTrap, analog2HighLevel=analog2HighLevel, tempTrapRepeat=tempTrapRepeat, analog2AlarmEnable=analog2AlarmEnable, relay2Name=relay2Name, eventSensorConfig=eventSensorConfig, tempVeryLowTrap=tempVeryLowTrap, contact5State=contact5State, contact5ActiveTrap=contact5ActiveTrap, analog1NormalTrap=analog1NormalTrap, contact1AlarmEnable=contact1AlarmEnable, analog1HighSeverity=analog1HighSeverity, humidityHighTrap=humidityHighTrap, techsupport=techsupport, humidityAlarmThreshold=humidityAlarmThreshold, humidityHighLevel=humidityHighLevel, esRelayReportingMode=esRelayReportingMode, thisTrapText=thisTrapText, analog=analog, contact2ActiveTrap=contact2ActiveTrap, humidityLowTrap=humidityLowTrap, contact1ReturnNormalTrap=contact1ReturnNormalTrap, analog2=analog2, contact3Severity=contact3Severity, contact5AlarmEnable=contact5AlarmEnable, humidityVeryLowLevel=humidityVeryLowLevel, contact4ActiveTrap=contact4ActiveTrap, analog1VeryHighLevel=analog1VeryHighLevel, contact6NormalTrap=contact6NormalTrap, analog1Value=analog1Value, ftpPassword=ftpPassword, contact3TrapRepeat=contact3TrapRepeat, tempsensor=tempsensor, humidityReturnNormalTrap=humidityReturnNormalTrap, tempLowTrap=tempLowTrap, humidityAlarmEnable=humidityAlarmEnable, analog1LowTrap=analog1LowTrap, tempHighSeverity=tempHighSeverity, contact4=contact4, ptEscChar=ptEscChar, esPointEntry=esPointEntry, analog2VeryLowTrap=analog2VeryLowTrap, tempESVeryHighTrap=tempESVeryHighTrap, esAnalogReportingMode=esAnalogReportingMode, contact2State=contact2State, tempESNormalTrap=tempESNormalTrap, statusRepeatHours=statusRepeatHours, contact1Severity=contact1Severity, contact2AlarmEnable=contact2AlarmEnable, tempValue=tempValue, esNumberTempSensors=esNumberTempSensors, humidityName=humidityName, esPointValueInt=esPointValueInt, contact5NormalTrap=contact5NormalTrap, forceTraps=forceTraps, relay1=relay1, contact1TrapRepeat=contact1TrapRepeat, snmpManager=snmpManager, contact4ActiveDirection=contact4ActiveDirection, voltageESHighTrap=voltageESHighTrap, tempName=tempName, passthrough=passthrough, esNumberRelayOutputs=esNumberRelayOutputs, contact5ReturnNormalTrap=contact5ReturnNormalTrap, contact1ActiveDirection=contact1ActiveDirection, esIndexPoint=esIndexPoint, tempVeryHighTrap=tempVeryHighTrap, contact5Name=contact5Name, contact5TrapRepeat=contact5TrapRepeat, techsupportRestart=techsupportRestart, tempLowLevel=tempLowLevel, esPointName=esPointName, contactESNormalTrap=contactESNormalTrap, analog1VeryLowLevel=analog1VeryLowLevel, ptSaySiteID=ptSaySiteID, analog2LowLevel=analog2LowLevel, voltageESNormalTrap=voltageESNormalTrap, firmwareVersion=firmwareVersion, contact4Name=contact4Name, tempVeryHighLevel=tempVeryHighLevel, esCCReportingMode=esCCReportingMode, esNumberAnalog=esNumberAnalog, ptLoginText=ptLoginText, analog2VeryLowLevel=analog2VeryLowLevel, contact6ActiveTrap=contact6ActiveTrap, analog2HighTrap=analog2HighTrap, contact2Severity=contact2Severity, esTable=esTable, tempNormalTrap=tempNormalTrap, tempESLowTrap=tempESLowTrap, device=device, relays=relays, contact3ActiveDirection=contact3ActiveDirection, humidityVeryHighLevel=humidityVeryHighLevel, techsupportNetMask=techsupportNetMask, contact2NormalTrap=contact2NormalTrap, contact6=contact6, contact2=contact2, contact3Name=contact3Name, esNumberHumidSensors=esNumberHumidSensors, analog2Name=analog2Name, analog2NormalTrap=analog2NormalTrap, contact4AlarmEnable=contact4AlarmEnable, analog2LowSeverity=analog2LowSeverity, analog1LowLevel=analog1LowLevel, esIndexPC=esIndexPC, esNumberEventSensors=esNumberEventSensors, contacts=contacts, esIndex=esIndex, contact2Name=contact2Name, analog2LowTrap=analog2LowTrap, analog1HighLevel=analog1HighLevel, contact3Threshold=contact3Threshold, tempHighTrap=tempHighTrap, analog1TrapRepeat=analog1TrapRepeat, snmpManager4=snmpManager4, analog1VeryLowTrap=analog1VeryLowTrap, humidityESVeryHighTrap=humidityESVeryHighTrap, sl12=sl12, tempAlarmThreshold=tempAlarmThreshold, contact6Severity=contact6Severity, analog2ReturnNormalTrap=analog2ReturnNormalTrap, analog2VeryHighTrap=analog2VeryHighTrap, ptSerialParity=ptSerialParity, techsupportVersionNumber=techsupportVersionNumber, mibend=mibend, analog1ReturnNormalTrap=analog1ReturnNormalTrap, humidityLowSeverity=humidityLowSeverity, esIndexES=esIndexES, snmpManager1=snmpManager1, contact1State=contact1State, humidityVeryLowSeverity=humidityVeryLowSeverity, testTrap=testTrap, tempAlarmEnable=tempAlarmEnable, contact6ActiveDirection=contact6ActiveDirection, humidityVeryHighSeverity=humidityVeryHighSeverity, ptSerialWordlength=ptSerialWordlength, powerupTrapsend=powerupTrapsend, humidityESLowTrap=humidityESLowTrap, contact6Threshold=contact6Threshold, siteID=siteID, esTempReportingMode=esTempReportingMode, analog1HighTrap=analog1HighTrap, analog2VeryHighLevel=analog2VeryHighLevel, tempVeryHighSeverity=tempVeryHighSeverity, ftp=ftp, humidityESNormalTrap=humidityESNormalTrap, analog1VeryHighTrap=analog1VeryHighTrap, ptSerialBaudrate=ptSerialBaudrate, esNumberCCs=esNumberCCs, relay2=relay2, contact4TrapRepeat=contact4TrapRepeat, contact5=contact5, snmpManager2=snmpManager2, esHumidReportingMode=esHumidReportingMode, tempESVeryLowTrap=tempESVeryLowTrap, contact6AlarmEnable=contact6AlarmEnable, humidityLowLevel=humidityLowLevel, tempVeryLowLevel=tempVeryLowLevel, analog1=analog1, relay1Name=relay1Name, analog1VeryLowSeverity=analog1VeryLowSeverity, ptTimeout=ptTimeout, analog1Name=analog1Name, ptTCPPortnumber=ptTCPPortnumber, contact1ActiveTrap=contact1ActiveTrap, humiditysensor=humiditysensor, analog1AlarmEnable=analog1AlarmEnable, tempLowSeverity=tempLowSeverity, contact3NormalTrap=contact3NormalTrap, humidityVeryHighTrap=humidityVeryHighTrap, relay2CurrentState=relay2CurrentState, humidityValue=humidityValue, contact2ActiveDirection=contact2ActiveDirection, analog2VeryHighSeverity=analog2VeryHighSeverity, relay1PowerupState=relay1PowerupState, contact5ActiveDirection=contact5ActiveDirection)
