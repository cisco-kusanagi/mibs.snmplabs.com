...
Counter32, ObjectIdentity, ModuleIdentity, Counter64, MibIdentifier, Unsigned32, Gauge32, NotificationType, TimeTicks, Integer32, iso, Bits, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, transmission = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "ObjectIdentity", "ModuleIdentity", "Counter64", "MibIdentifier", "Unsigned32", "Gauge32", "NotificationType", "TimeTicks", "Integer32", "iso", "Bits", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "transmission")
...
mibBuilder.exportSymbols("MPLS-TC-MIB", MplsLdpGenAddr=MplsLdpGenAddr, MplsTunnelInstanceIndex=MplsTunnelInstanceIndex, MplsLdpLabelTypes=MplsLdpLabelTypes, MplsPathIndexOrZero=MplsPathIndexOrZero, mplsMIB=mplsMIB, MplsBurstSize=MplsBurstSize, MplsBitRate=MplsBitRate, mplsTCMIB=mplsTCMIB, MplsExtendedTunnelId=MplsExtendedTunnelId, MplsLsrIdentifier=MplsLsrIdentifier, MplsTunnelIndex=MplsTunnelIndex, MplsPortNumber=MplsPortNumber, MplsInitialCreationSource=MplsInitialCreationSource, MplsLSPID=MplsLSPID, MplsLabel=MplsLabel, PYSNMP_MODULE_ID=mplsTCMIB, MplsTunnelAffinity=MplsTunnelAffinity, MplsLdpIdentifier=MplsLdpIdentifier, MplsAtmVcIdentifier=MplsAtmVcIdentifier, MplsPathIndex=MplsPathIndex)
