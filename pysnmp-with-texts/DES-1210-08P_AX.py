...
# Produced by pysmi-0.3.4 at Wed May  1 12:38:27 2019
...
iso, TimeTicks, NotificationType, Counter64, ObjectIdentity, MibIdentifier, enterprises, Counter32, ModuleIdentity, Integer32, IpAddress, Gauge32, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "NotificationType", "Counter64", "ObjectIdentity", "MibIdentifier", "enterprises", "Counter32", "ModuleIdentity", "Integer32", "IpAddress", "Gauge32", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32")
...
if mibBuilder.loadTexts: poeTimeRangeSettingID.setDescription('The Schedule identifier. The maximum number of Schedule entry is the number of ports supported PoE function. The value must be between 1 and 8.')
...
mibBuilder.exportSymbols("DES-1210-08P_AX", aclL3RuleTcpSynBit=aclL3RuleTcpSynBit, poeThermalShutdown=poeThermalShutdown, stpPortForwardTransitions=stpPortForwardTransitions, pethPsePortPowerConsumption=pethPsePortPowerConsumption, voiceVlanMode=voiceVlanMode, aclProfileDstPortMask=aclProfileDstPortMask, companyMiscGroup=companyMiscGroup, autoSurveillanceVlanOUITable=autoSurveillanceVlanOUITable, qosDiffServType16=qosDiffServType16, poeScheduleEndMonth=poeScheduleEndMonth, mcastFilterPortTable=mcastFilterPortTable, qosDiffServType26=qosDiffServType26, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, poeScheduleWednesday=poeScheduleWednesday, qosDiffServType14=qosDiffServType14, aclProfile=aclProfile, sysSafeGuardEnable=sysSafeGuardEnable, stpPortProtocolMigration=stpPortProtocolMigration, qosDiffServType03=qosDiffServType03, companyDot1qVlanGroup=companyDot1qVlanGroup, companyTrapSetting=companyTrapSetting, snmpV3UserGroupName=snmpV3UserGroupName, aRPSpoofPreventIpAddr=aRPSpoofPreventIpAddr, autoSurveillanceVlanOUISurveillanceOUI=autoSurveillanceVlanOUISurveillanceOUI, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, sysTrapOverMaxPowerBudgetEvent=sysTrapOverMaxPowerBudgetEvent, igsVlanMulticastGroupIpAddress=igsVlanMulticastGroupIpAddress, dot1pPortTable=dot1pPortTable, stpRootPort=stpRootPort, aclL2ProfileID=aclL2ProfileID, voiceVlanTimeout=voiceVlanTimeout, miscStatisticsReset=miscStatisticsReset, voicevlanPortState=voicevlanPortState, sysTrapSystemEvent=sysTrapSystemEvent, d_link=d_link, poeTimeRangeSettingID=poeTimeRangeSettingID, laPortChannelEntry=laPortChannelEntry, securityPortSecurity=securityPortSecurity, sslCiphers=sslCiphers, aclProfileDstMacAddrMask=aclProfileDstMacAddrMask, snmpV3UserStatus=snmpV3UserStatus, voicevlanPortControlEntry=voicevlanPortControlEntry, stpPortDesignatedBridge=stpPortDesignatedBridge, stpForwardDelay=stpForwardDelay, qosDiffServType10=qosDiffServType10, tftpConfigTftpOperation=tftpConfigTftpOperation, sysPortCtrlOperStatus=sysPortCtrlOperStatus, qosDiffServType19=qosDiffServType19, firmwareUpgradeFailure=firmwareUpgradeFailure, stpDesignatedRoot=stpDesignatedRoot, snmpV3CommunityStatus=snmpV3CommunityStatus, qosDiffServ=qosDiffServ, sysPortCtrlFlowControl=sysPortCtrlFlowControl, snmpV3HostVersion=snmpV3HostVersion, laPortControlEntry=laPortControlEntry, snmpV3viewTreeType=snmpV3viewTreeType, snmpV3UserName=snmpV3UserName, snmpV3viewTreeMask=snmpV3viewTreeMask, sysTrapTwistedPortEvent=sysTrapTwistedPortEvent, companyTraps=companyTraps, sysLoginTimeoutInterval=sysLoginTimeoutInterval, companyMulticastFilter=companyMulticastFilter, sysSNTPGMTMinutes=sysSNTPGMTMinutes, poePortStatus=poePortStatus, companyPoEGroup=companyPoEGroup, stpPortRestrictedTCN=stpPortRestrictedTCN, stpBridgeMaxAge=stpBridgeMaxAge, snmpV3EngineID=snmpV3EngineID, laPortControlTable=laPortControlTable, aclL3RuleProfileNo=aclL3RuleProfileNo, igsStatus=igsStatus, snmpV3HostEntry=snmpV3HostEntry, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, sysSNTPDSTEndMon=sysSNTPDSTEndMon, dot1qVlanForbiddenPorts=dot1qVlanForbiddenPorts, firmwareIllegalFile=firmwareIllegalFile, aclL3RuleICMPMessageCode=aclL3RuleICMPMessageCode, poeScheduleMonday=poeScheduleMonday, autoSurveillanceVlanOUIStatus=autoSurveillanceVlanOUIStatus, qosDiffServType04=qosDiffServType04, tftpFwImageFileName=tftpFwImageFileName, qosDiffServType37=qosDiffServType37, aclL2RuleAction=aclL2RuleAction, sysLBDCtrlTable=sysLBDCtrlTable, poePortSettingState=poePortSettingState, qosDiffServType00=qosDiffServType00, staticVlanID=staticVlanID, poePortCurrent=poePortCurrent, autoSurveillanceVlanOUIComponentType=autoSurveillanceVlanOUIComponentType, qosDiffServType48=qosDiffServType48, qosDiffServType21=qosDiffServType21, stpTopChanges=stpTopChanges, igsVlanMulticastGroupMacAddress=igsVlanMulticastGroupMacAddress, dot1qVlanTable=dot1qVlanTable, stpBridgeHelloTime=stpBridgeHelloTime, autoSurveillanceVlanSystem=autoSurveillanceVlanSystem, qosDiffServType28=qosDiffServType28, qosDiffServType29=qosDiffServType29, aclL3RuleTcpUdpDstPortMask=aclL3RuleTcpUdpDstPortMask, poeScheduleSunday=poeScheduleSunday, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, qosDiffServType50=qosDiffServType50, poePortSettingPriority=poePortSettingPriority, aclL2RuleSrcMacAddr=aclL2RuleSrcMacAddr, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, dot1xAuthStatus=dot1xAuthStatus, snmpV3UserEntry=snmpV3UserEntry, snmpV3GroupNotifyViewName=snmpV3GroupNotifyViewName, aclL2RuleVlanId=aclL2RuleVlanId, aclL3RuleDstIpAddr=aclL3RuleDstIpAddr, aclL3RuleTcpFinBit=aclL3RuleTcpFinBit, sysSNTPDSTStartHour=sysSNTPDSTStartHour, qosDiffServType20=qosDiffServType20, qosDiffServType02=qosDiffServType02, qosDiffServType30=qosDiffServType30, stpRootCost=stpRootCost, voiceVlanId=voiceVlanId, snmpV3UserPrivProtocolPassword=snmpV3UserPrivProtocolPassword, snmpV3viewTreeStatus=snmpV3viewTreeStatus, qosDiffServType36=qosDiffServType36, dot1pPortPriority=dot1pPortPriority, portSecTable=portSecTable, aclProfileMask=aclProfileMask, qosDiffServType35=qosDiffServType35, snmpV3TrapPoePowerOnOff=snmpV3TrapPoePowerOnOff, stpPortOperEdgePort=stpPortOperEdgePort, aRPSpoofPreventRowStatus=aRPSpoofPreventRowStatus, syslogSeverity=syslogSeverity, qosDiffServType11=qosDiffServType11, qosDiffServType59=qosDiffServType59, aclProfileArpSenderMacAddrMask=aclProfileArpSenderMacAddrMask, stpPortEnable=stpPortEnable, qosDiffServType56=qosDiffServType56, poeOverMaxPowerBudget=poeOverMaxPowerBudget, voicevlanOUIMask=voicevlanOUIMask, qosDiffServType09=qosDiffServType09, securityDhcpServerScreen=securityDhcpServerScreen, stpBridgeForwardDelay=stpBridgeForwardDelay, syslogLogSrvAddr=syslogLogSrvAddr, securitySSL=securitySSL, staticStatus=staticStatus, poeScheduleStartMonth=poeScheduleStartMonth, aclL2Rule1pPriority=aclL2Rule1pPriority, aclL3RuleIgmpType=aclL3RuleIgmpType, companyTimeBasedPoE=companyTimeBasedPoE, dot1qVlanManagementOnOff=dot1qVlanManagementOnOff, tftpFwTftpOperationStatus=tftpFwTftpOperationStatus, sysLBDStateEnable=sysLBDStateEnable, snmpV3TrapOverMaxPowerBudget=snmpV3TrapOverMaxPowerBudget, bandwidthCtrlRxThreshold=bandwidthCtrlRxThreshold, aclProfileEntry=aclProfileEntry, dot1qVlanAsyOnOff=dot1qVlanAsyOnOff, qosDiffServType22=qosDiffServType22, snmpV3User=snmpV3User, snmpV3viewTreeName=snmpV3viewTreeName, snmpV3HostCommunityName=snmpV3HostCommunityName, autoSurveillanceVlanOUIEntry=autoSurveillanceVlanOUIEntry, staticPort=staticPort, sysSwitchName=sysSwitchName, sysPoEPortSettingTable=sysPoEPortSettingTable, voicevlanOUIDescription=voicevlanOUIDescription, snmpV3UserPrivProtocol=snmpV3UserPrivProtocol, radiusServerAddress=radiusServerAddress, laPortActorActivity=laPortActorActivity, poeScheduleEndYear=poeScheduleEndYear, snmpV3Group=snmpV3Group, voicevlanSystem=voicevlanSystem, qosDiffServType45=qosDiffServType45, pethPsePortPowerRatioOfSystemPower=pethPsePortPowerRatioOfSystemPower, voicevlanOUIStatus=voicevlanOUIStatus, dot1qVlanPortEntry=dot1qVlanPortEntry, stpPortAdminPointToPoint=stpPortAdminPointToPoint, qosDiffServType39=qosDiffServType39, qosDiffServType51=qosDiffServType51, aclProfileNo=aclProfileNo, dot1xAuthTxPeriod=dot1xAuthTxPeriod, sysMirrorCtrlEgressMirroring=sysMirrorCtrlEgressMirroring, dot1qVlanRowStatus=dot1qVlanRowStatus, aclL2RuleInPortList=aclL2RuleInPortList, aclL3RuleAction=aclL3RuleAction, snmpV3GroupStatus=snmpV3GroupStatus, igsVlanCfgQuerier=igsVlanCfgQuerier, snmpV3UserAuthProtocol=snmpV3UserAuthProtocol, stpPriority=stpPriority, poeScheduleStartMinute=poeScheduleStartMinute, snmpV3GroupSecurityModel=snmpV3GroupSecurityModel, igsVlanMulticastGroupTable=igsVlanMulticastGroupTable, laSystem=laSystem, aclL3RuleICMPMessageType=aclL3RuleICMPMessageType, qosDiffServType17=qosDiffServType17, snmpV3viewTreeSubtree=snmpV3viewTreeSubtree, dot1qVlanEntry=dot1qVlanEntry, qosDiffServType18=qosDiffServType18, laPortActorTimeout=laPortActorTimeout, aclProfileIPProtocol=aclProfileIPProtocol, traps=traps, stpHoldTime=stpHoldTime, companyTrafficMgmt=companyTrafficMgmt, poeportid=poeportid, aclL3RuleDstIpAddrMask=aclL3RuleDstIpAddrMask, aclL3RuleTcpUdpDstPort=aclL3RuleTcpUdpDstPort, staticAutoLearningList=staticAutoLearningList, qosDiffServType58=qosDiffServType58, sysGateway=sysGateway, bandwidthCtrlTable=bandwidthCtrlTable, snmpV3GroupTable=snmpV3GroupTable, poeScheduleThursday=poeScheduleThursday, autoSurveillanceVlanPriority=autoSurveillanceVlanPriority, tftpCfgServerIpAddress=tftpCfgServerIpAddress, des_1210_08pax=des_1210_08pax, stpPortEdge=stpPortEdge, PortList=PortList, qosQ1p=qosQ1p, sysLBDPortLoopStatus=sysLBDPortLoopStatus, dlinklldpAntiRoguePortControl=dlinklldpAntiRoguePortControl, qosDiffServType27=qosDiffServType27, sysLBDCtrlIndex=sysLBDCtrlIndex, aclL3RuleStatus=aclL3RuleStatus, dot1qVlanEgressPorts=dot1qVlanEgressPorts, companyAutoSurveillanceVlan=companyAutoSurveillanceVlan, sysPortCtrlEntry=sysPortCtrlEntry, aRPSpoofPreventMacAddress=aRPSpoofPreventMacAddress, snmpV3CommunityPolicy=snmpV3CommunityPolicy, igsVlanRouterTable=igsVlanRouterTable, trustedHostEntry=trustedHostEntry, firmwareUpgradeSuccess=firmwareUpgradeSuccess, stpPortRestrictedRole=stpPortRestrictedRole, aRPSpoofPreventPortList=aRPSpoofPreventPortList, sysSave=sysSave, bandwidthCtrlTxThreshold=bandwidthCtrlTxThreshold, stpAdminPortPathCost=stpAdminPortPathCost, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, snmpV3CommunityTable=snmpV3CommunityTable, poeScheduleTuesday=poeScheduleTuesday, aclProfileDstIpAddrMask=aclProfileDstIpAddrMask, aclL2RuleStatus=aclL2RuleStatus, qosDiffServType12=qosDiffServType12, tftpConfigTftpOperationStatus=tftpConfigTftpOperationStatus, laPortChannelMemberList=laPortChannelMemberList, aclL3RuleTcpPshBit=aclL3RuleTcpPshBit, dlinklldpState=dlinklldpState, VlanIndex=VlanIndex, dlinklldpMsgTxInterval=dlinklldpMsgTxInterval, qosDiffServType46=qosDiffServType46, companyIpifGroup=companyIpifGroup, qosDiffServType57=qosDiffServType57, qosDiffServType42=qosDiffServType42, radiusServerSharedSecret=radiusServerSharedSecret, igsVlanRouterVlanId=igsVlanRouterVlanId, dot1qVlanUntaggedPorts=dot1qVlanUntaggedPorts, qosDiffServType05=qosDiffServType05, aclL3RuleProtocol=aclL3RuleProtocol, qosDiffServEnable=qosDiffServEnable, dot1qVlanName=dot1qVlanName)
mibBuilder.exportSymbols("DES-1210-08P_AX", snmpV3Trap=snmpV3Trap, stpPortDesignatedPort=stpPortDesignatedPort, poePowerOff=poePowerOff, dlinklldpRemOrgDefInfoTable=dlinklldpRemOrgDefInfoTable, stpMaxAge=stpMaxAge, igsVlanFilterVlanId=igsVlanFilterVlanId, igsVlanFilterTable=igsVlanFilterTable, aclL2RuleDstMacAddrMask=aclL2RuleDstMacAddrMask, igsQueryInterval=igsQueryInterval, syslogFacility=syslogFacility, poePortClassification=poePortClassification, stpPortPriority=stpPortPriority, stpPortEntry=stpPortEntry, qosDiffServType13=qosDiffServType13, qosDiffServType60=qosDiffServType60, autoSurveillanceVlanMode=autoSurveillanceVlanMode, poeSystemSettingPowerThreshold=poeSystemSettingPowerThreshold, aclProfileTable=aclProfileTable, sysPortCtrlIndex=sysPortCtrlIndex, voicevlanPortControlTable=voicevlanPortControlTable, portSecState=portSecState, sysSNTPPollInterval=sysSNTPPollInterval, dlinklldpTxDelay=dlinklldpTxDelay, stpPortTable=stpPortTable, igsVlanMulticastGroupPortList=igsVlanMulticastGroupPortList, securityTrustedHost=securityTrustedHost, sysSNTPDSTStartDay=sysSNTPDSTStartDay, sysPortCtrlType=sysPortCtrlType, voicevlanOUI=voicevlanOUI, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, companyIgsGroup=companyIgsGroup, qosDiffServType06=qosDiffServType06, sysPortCtrlFlowControlOper=sysPortCtrlFlowControlOper, stpGlobal=stpGlobal, sysTrapPoePowerOnOffEvent=sysTrapPoePowerOnOffEvent, sysTrapStateChangeEvent=sysTrapStateChangeEvent, PortLaMode=PortLaMode, topologyChange=topologyChange, aclProfileArpSenderIpAddrMask=aclProfileArpSenderIpAddrMask, portSecMLA=portSecMLA, voicevlanOUIEntry=voicevlanOUIEntry, aclL3Rule=aclL3Rule, sysSNTPTimeSeconds=sysSNTPTimeSeconds, snmpV3TrapBootup=snmpV3TrapBootup, portSecIndex=portSecIndex, companySystem=companySystem, laPortChannelTable=laPortChannelTable, tftpFwServerIpAddress=tftpFwServerIpAddress, companyTftpGroup=companyTftpGroup, sysIpSubnetMask=sysIpSubnetMask, radius=radius, aclL2Rule=aclL2Rule, snmpV3ViewTreeTable=snmpV3ViewTreeTable, companyVoiceVlan=companyVoiceVlan, snmpV3GroupEntry=snmpV3GroupEntry, igsVlan=igsVlan, sysLBDCtrlEntry=sysLBDCtrlEntry, snmpV3TrapSNMPAuthentication=snmpV3TrapSNMPAuthentication, sysPortCtrlMDI=sysPortCtrlMDI, aclProfileSrcMacAddrMask=aclProfileSrcMacAddrMask, companyACLGroup=companyACLGroup, stpPort=stpPort, bandwidthCtrlEntry=bandwidthCtrlEntry, staticDisableAutoLearn=staticDisableAutoLearn, stpTxHoldCount=stpTxHoldCount, qosDiffServType07=qosDiffServType07, qosDiffServType23=qosDiffServType23, trustedHostStatus=trustedHostStatus, syslogUDPPort=syslogUDPPort, autoSurveillanceVlanOUIDescription=autoSurveillanceVlanOUIDescription, qosDiffServType24=qosDiffServType24, sysSNTPFirstServer=sysSNTPFirstServer, igsVlanRouterPortList=igsVlanRouterPortList, companySNMPV3=companySNMPV3, igsVlanRtrPortList=igsVlanRtrPortList, poePowerDenied=poePowerDenied, snmpV3TrapRSTPStateChange=snmpV3TrapRSTPStateChange, sysTrapPoePowerErrorEvent=sysTrapPoePowerErrorEvent, poePortPower=poePortPower, qosDiffServType62=qosDiffServType62, qosDiffServTypeGroup=qosDiffServTypeGroup, igsVlanMulticastGroupEntry=igsVlanMulticastGroupEntry, qosDiffServType41=qosDiffServType41, aclL3RuleTcpUrgBit=aclL3RuleTcpUrgBit, aRPSpoofPreventTable=aRPSpoofPreventTable, tftpFwTftpOperation=tftpFwTftpOperation, snmpV3GroupWriteViewName=snmpV3GroupWriteViewName, voicevlanOUITable=voicevlanOUITable, poeScheduleSaturday=poeScheduleSaturday, sysSNTPDSTOffset=sysSNTPDSTOffset, sysSNTPDSTStartMin=sysSNTPDSTStartMin, poePortSettingUserDefineState=poePortSettingUserDefineState, aclL3RuleDscp=aclL3RuleDscp, aclL2RuleEtherType=aclL2RuleEtherType, qosDiffServType15=qosDiffServType15, sysTrapStatus=sysTrapStatus, snmpV3ViewTree=snmpV3ViewTree, sysSNTPDSTState=sysSNTPDSTState, dot1qVlanPortTable=dot1qVlanPortTable, LacpKey=LacpKey, broadcastStormCtrlSettings=broadcastStormCtrlSettings, poeportgroup=poeportgroup, dlinklldpAntiRoguePassword=dlinklldpAntiRoguePassword, aclL3RulePortList=aclL3RulePortList, poePortSettingPowerLimit=poePortSettingPowerLimit, firmwareChecksumError=firmwareChecksumError, qosDiffServType52=qosDiffServType52, miscReset=miscReset, securityARPSpoofPrevent=securityARPSpoofPrevent, snmpV3Community=snmpV3Community, aclProfileSrcIpAddrMask=aclProfileSrcIpAddrMask, laPortActorPortPriority=laPortActorPortPriority, aclL3RuleSrcIpAddrMask=aclL3RuleSrcIpAddrMask, sysPortCtrlTable=sysPortCtrlTable, sysPortCtrlSpeed=sysPortCtrlSpeed, dot1xAuthServerTimeout=dot1xAuthServerTimeout, companyStaticMAC=companyStaticMAC, rstpStatus=rstpStatus, snmpV3ViewTreeEntry=snmpV3ViewTreeEntry, sysSNTPDSTEndMin=sysSNTPDSTEndMin, sslCipherSuiteList=sslCipherSuiteList, mcastFilterPortEntry=mcastFilterPortEntry, dlink_DES1210SeriesProd=dlink_DES1210SeriesProd, stpPortOperPointToPoint=stpPortOperPointToPoint, companyMirror=companyMirror, broadcastStormCtrlLimitType=broadcastStormCtrlLimitType, poeSystemSettingDisconnectMethod=poeSystemSettingDisconnectMethod, poeScheduleFriday=poeScheduleFriday, aclL3RuleSrcIpAddr=aclL3RuleSrcIpAddr, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, companySecurity=companySecurity, dot1xAuthMaxReq=dot1xAuthMaxReq, dlinklldpAntiRoguePortIndex=dlinklldpAntiRoguePortIndex, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, aclL3RuleTcpUdpSrcPortMask=aclL3RuleTcpUdpSrcPortMask, poeTimeRangeSettingEntry=poeTimeRangeSettingEntry, stpPortPathCost=stpPortPathCost, sysLBDPortStatus=sysLBDPortStatus, sysLBDRecoverTime=sysLBDRecoverTime, qosDiffServType34=qosDiffServType34, snmpV3UserTable=snmpV3UserTable, stpVersion=stpVersion, broadcastStormCtrlThreshold=broadcastStormCtrlThreshold, aclL3RuleTcpUdpSrcPort=aclL3RuleTcpUdpSrcPort, companySNTPSetting=companySNTPSetting, snmpV3TrapCopperLinkUpDown=snmpV3TrapCopperLinkUpDown, sysMirrorStatus=sysMirrorStatus, sysIpAddrCfgMode=sysIpAddrCfgMode, pethPsePortPowerBudget=pethPsePortPowerBudget, aclL3RuleEntry=aclL3RuleEntry, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, igsQueryMaxResponseTime=igsQueryMaxResponseTime, poeScheduleEndMinute=poeScheduleEndMinute, poeTimeBasedPoERangeName=poeTimeBasedPoERangeName, qosDiffServType47=qosDiffServType47, laStatus=laStatus, sysLocationName=sysLocationName, stpPortDesignatedCost=stpPortDesignatedCost, queuingMechanism=queuingMechanism, voicevlanPortControlIndex=voicevlanPortControlIndex, poeTimeRangeSettingTable=poeTimeRangeSettingTable, aclL2AccessID=aclL2AccessID, stpTimeSinceTopologyChange=stpTimeSinceTopologyChange, companyRSTP=companyRSTP, autoSurveillanceVlanId=autoSurveillanceVlanId, qosMode=qosMode, snmpV3HostStatus=snmpV3HostStatus, dlinklldpConfigManAddrPortsTxEnable=dlinklldpConfigManAddrPortsTxEnable, aclL3RuleTable=aclL3RuleTable, trustedHostRowStatus=trustedHostRowStatus, dot1qVlanPvid=dot1qVlanPvid, companyDot1xGroup=companyDot1xGroup, tftpConfigFileName=tftpConfigFileName, igsVlanFilterEntry=igsVlanFilterEntry, dot1pPortIndex=dot1pPortIndex, poeOverLoad=poeOverLoad, igsSystem=igsSystem, sysTrapIP=sysTrapIP, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, sysMirrorCtrlIngressMirroring=sysMirrorCtrlIngressMirroring, sysIpAddr=sysIpAddr, poeShortCircuit=poeShortCircuit, qosDiffServType08=qosDiffServType08, laPortChannelMode=laPortChannelMode, snmpV3UserVersion=snmpV3UserVersion, aclProfileSrcPortMask=aclProfileSrcPortMask, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, bandwidthCtrlIndex=bandwidthCtrlIndex, staticEntry=staticEntry, syslogGeneralGroup=syslogGeneralGroup, sysTrapFirmUpgradeEvent=sysTrapFirmUpgradeEvent, aclL3RuleTcpRstBit=aclL3RuleTcpRstBit, stpProtocolSpecification=stpProtocolSpecification, staticTable=staticTable, poeTimeRangeDate=poeTimeRangeDate, trustedHostIpMask=trustedHostIpMask, igsVlanMulticastGroupVlanId=igsVlanMulticastGroupVlanId, laPortControl=laPortControl, autoSurveillanceVlanOUIMask=autoSurveillanceVlanOUIMask, igsVlanRouterEntry=igsVlanRouterEntry, qosDiffServType38=qosDiffServType38, sysPoEPortSettingEntry=sysPoEPortSettingEntry, dot1qVlanManagementid=dot1qVlanManagementid, aclL3RuleTcpAckBit=aclL3RuleTcpAckBit, sysGroupInterval=sysGroupInterval, snmpV3HostTable=snmpV3HostTable, companyQoSGroup=companyQoSGroup, qosDiffServType40=qosDiffServType40, qosDiffServType55=qosDiffServType55, portSecEntry=portSecEntry, BridgeId=BridgeId, aclProfileStatus=aclProfileStatus, qosDiffServType43=qosDiffServType43, snmpV3TrapFirmUpgrade=snmpV3TrapFirmUpgrade, aclL3RuleAccessID=aclL3RuleAccessID, pethPsePortPowerRemainder=pethPsePortPowerRemainder, trustedHostTable=trustedHostTable, poeScheduleStartDay=poeScheduleStartDay, voicevlanOUITelephonyOUI=voicevlanOUITelephonyOUI, sysLBDInterval=sysLBDInterval, stpPortState=stpPortState, igsRobustnessValue=igsRobustnessValue, dlinklldpRemOrgDefInfoOUI=dlinklldpRemOrgDefInfoOUI, qosDiffServType53=qosDiffServType53, sysSystemPassword=sysSystemPassword, snmpV3Host=snmpV3Host, igsHostPortPurgeInterval=igsHostPortPurgeInterval, dlinklldpAntiRoguePortStatus=dlinklldpAntiRoguePortStatus, syslogLogging=syslogLogging, aRPSpoofPreventEntry=aRPSpoofPreventEntry, poeScheduleEndHour=poeScheduleEndHour, laPortControlIndex=laPortControlIndex, sysFirmwareVersion=sysFirmwareVersion, snmpV3CommunityEntry=snmpV3CommunityEntry, dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, qosDiffServType33=qosDiffServType33, dot1xAuth=dot1xAuth, snmpV3GroupReadViewName=snmpV3GroupReadViewName, sysSNTPDSTEndHour=sysSNTPDSTEndHour, staticMac=staticMac, companyLBD=companyLBD, aclL2RuleEntry=aclL2RuleEntry, poeScheduleStartHour=poeScheduleStartHour, companyLA=companyLA, laPortChannelIfIndex=laPortChannelIfIndex, companySyslog=companySyslog, qosDiffServType61=qosDiffServType61, sysMirrorTargetPort=sysMirrorTargetPort, firmwareTransferError=firmwareTransferError, snmpV3UserAuthProtocolPassword=snmpV3UserAuthProtocolPassword, trustedHostIpAddr=trustedHostIpAddr, qosDiffServType49=qosDiffServType49, aclL2RuleDstMacAddr=aclL2RuleDstMacAddr, sysDhcpAutoConfiguration=sysDhcpAutoConfiguration)
mibBuilder.exportSymbols("DES-1210-08P_AX", mcastFilterPortIndex=mcastFilterPortIndex, sysRestart=sysRestart, igsGrpQueryInterval=igsGrpQueryInterval, aclL2RuleSrcMacAddrMask=aclL2RuleSrcMacAddrMask, snmpGlobalState=snmpGlobalState, dhcpServerScreenEnablePortlist=dhcpServerScreenEnablePortlist, sysHardwareVersion=sysHardwareVersion, qosDiffServType01=qosDiffServType01, stpHelloTime=stpHelloTime, qosDiffServType25=qosDiffServType25, voiceVlanPriority=voiceVlanPriority, qosDiffServType32=qosDiffServType32, poeScheduleStartYear=poeScheduleStartYear, snmpV3GroupName=snmpV3GroupName, poeTimeRangeRowStatus=poeTimeRangeRowStatus, syslogTimeStamp=syslogTimeStamp, dlinklldpReinitDelay=dlinklldpReinitDelay, igsVlanQuerier=igsVlanQuerier, aclL2RuleTable=aclL2RuleTable, snmpV3GroupSecurityLevel=snmpV3GroupSecurityLevel, snmpV3TrapPoePowerError=snmpV3TrapPoePowerError, igsVlanSnoopStatus=igsVlanSnoopStatus, qosDiffServType31=qosDiffServType31, dot1pPortEntry=dot1pPortEntry, qosDiffServType44=qosDiffServType44, aclProfileRuleCount=aclProfileRuleCount, poePortTimeBaseSchduleID=poePortTimeBaseSchduleID, sysSNTPDSTStartMon=sysSNTPDSTStartMon, voicevlanPortAutoDetection=voicevlanPortAutoDetection, dlink_products=dlink_products, poePowerOn=poePowerOn, sysSNTPSecondServer=sysSNTPSecondServer, bandwidthCtrlSettings=bandwidthCtrlSettings, aclProfileType=aclProfileType, poeScheduleEndDay=poeScheduleEndDay, companyLLDPSetting=companyLLDPSetting, stpPortDesignatedRoot=stpPortDesignatedRoot, dlinklldpMsgHoldMultiplier=dlinklldpMsgHoldMultiplier, qosDiffServType54=qosDiffServType54, sslSecurityHttpStatus=sslSecurityHttpStatus, Timeout=Timeout, sysSNTPState=sysSNTPState, sysSNTPDSTEndDay=sysSNTPDSTEndDay, poePortSettingUserDefine=poePortSettingUserDefine, mcastFilterPortType=mcastFilterPortType, qosDiffServType63=qosDiffServType63, autoSurveillanceVlanOUI=autoSurveillanceVlanOUI, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, snmpV3CommunityName=snmpV3CommunityName, poePortVoltage=poePortVoltage, snmpV3HostAddress=snmpV3HostAddress, igsVlanQueryInterval=igsVlanQueryInterval)
