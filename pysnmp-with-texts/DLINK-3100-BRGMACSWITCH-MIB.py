...
# Produced by pysmi-0.3.4 at Wed May  1 12:47:57 2019
...
ModuleIdentity, TimeTicks, Integer32, ObjectIdentity, Counter32, NotificationType, Bits, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, Unsigned32, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "Integer32", "ObjectIdentity", "Counter32", "NotificationType", "Bits", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "Unsigned32", "MibIdentifier", "IpAddress")
...
if mibBuilder.loadTexts: rlBrgMacSwitch.setContactInfo('www.dlink.com')
...
mibBuilder.exportSymbols("DLINK-3100-BRGMACSWITCH-MIB", rlBrgMacSwMaxTableNumber=rlBrgMacSwMaxTableNumber, rlBrgMacSwAdminTrapFrequency=rlBrgMacSwAdminTrapFrequency, rlBrgMacSwRedBoundary=rlBrgMacSwRedBoundary, rlBrgMacSwYellowBoundary=rlBrgMacSwYellowBoundary, PYSNMP_MODULE_ID=rlBrgMacSwitch, rlBrgMacSwTrapEnable=rlBrgMacSwTrapEnable, rlBrgMacSwVersion=rlBrgMacSwVersion, rlBrgMacSwitch=rlBrgMacSwitch, rlBrgMacSwOldEntryDeleteMode=rlBrgMacSwOldEntryDeleteMode, rlBrgMacSwKeyType=rlBrgMacSwKeyType, rlBrgMacSwOperTrapCount=rlBrgMacSwOperTrapCount, rlBrgMacSwSpanningTree=rlBrgMacSwSpanningTree, rlBrgMacSwDynamicTables=rlBrgMacSwDynamicTables)
