...
# Produced by pysmi-0.3.4 at Wed May  1 13:11:05 2019
...
iso, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, IpAddress, NotificationType, ModuleIdentity, Counter32, MibIdentifier, Bits, Integer32, ObjectIdentity, TimeTicks, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "IpAddress", "NotificationType", "ModuleIdentity", "Counter32", "MibIdentifier", "Bits", "Integer32", "ObjectIdentity", "TimeTicks", "Unsigned32")
...
if mibBuilder.loadTexts: fastPathTimeZonePrivate.setDescription('The Ubiquiti Private MIB for EdgeSwitch for system time, timezone and summer-time settings')
...
mibBuilder.exportSymbols("EdgeSwitch-TIMEZONE-PRIVATE-MIB", agentSystemTimeZoneAcronym=agentSystemTimeZoneAcronym, agentSummerTimeNonRecurringGroup=agentSummerTimeNonRecurringGroup, agentTimeZoneGroup=agentTimeZoneGroup, agentStRecurringZoneOffset=agentStRecurringZoneOffset, agentStNonRecurringEndingYear=agentStNonRecurringEndingYear, agentTimeZoneAcronym=agentTimeZoneAcronym, agentStRecurringStartingDay=agentStRecurringStartingDay, agentSummerTimeRecurringGroup=agentSummerTimeRecurringGroup, agentSystemDate=agentSystemDate, agentSystemTimeSource=agentSystemTimeSource, agentStNonRecurringEndingDay=agentStNonRecurringEndingDay, agentStRecurringEndingWeek=agentStRecurringEndingWeek, PYSNMP_MODULE_ID=fastPathTimeZonePrivate, agentStNonRecurringStartingYear=agentStNonRecurringStartingYear, agentStNonRecurringZoneAcronym=agentStNonRecurringZoneAcronym, agentSystemTimeGroup=agentSystemTimeGroup, agentTimeZoneMinutesOffset=agentTimeZoneMinutesOffset, agentStRecurringStartingMonth=agentStRecurringStartingMonth, agentStRecurringZoneAcronym=agentStRecurringZoneAcronym, agentStRecurringEndingDay=agentStRecurringEndingDay, agentStRecurringEndingMonth=agentStRecurringEndingMonth, agentStNonRecurringEndingMonth=agentStNonRecurringEndingMonth, agentSummerTimeGroup=agentSummerTimeGroup, agentSummerTimeMode=agentSummerTimeMode, fastPathTimeZonePrivate=fastPathTimeZonePrivate, agentStRecurringStartingTime=agentStRecurringStartingTime, agentStRecurringStartingWeek=agentStRecurringStartingWeek, agentSystemTime=agentSystemTime, agentStNonRecurringZoneOffset=agentStNonRecurringZoneOffset, agentStRecurringEndingTime=agentStRecurringEndingTime, agentStNonRecurringStartingMonth=agentStNonRecurringStartingMonth, agentStNonRecurringEndingTime=agentStNonRecurringEndingTime, agentStNonRecurringStartingTime=agentStNonRecurringStartingTime, agentSystemSummerTimeState=agentSystemSummerTimeState, agentTimeZoneHoursOffset=agentTimeZoneHoursOffset, agentStNonRecurringStartingDay=agentStNonRecurringStartingDay)
