...
# Produced by pysmi-0.3.4 at Wed May  1 13:20:14 2019
...
Counter64, NotificationType, TimeTicks, Counter32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, ModuleIdentity, Integer32, Gauge32, Bits, MibIdentifier, Unsigned32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "TimeTicks", "Counter32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "ModuleIdentity", "Integer32", "Gauge32", "Bits", "MibIdentifier", "Unsigned32", "IpAddress")
RowStatus, MacAddress, PhysAddress, TextualConvention, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "MacAddress", "PhysAddress", "TextualConvention", "DisplayString")
gsm7312Switching = ModuleIdentity((1, 3, 6, 1, 4, 1, 4526, 1, 6, 1))
gsm7312Switching.setRevisions(('2003-02-06 18:35',))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: gsm7312Switching.setRevisionsDescriptions(('',))
...
if mibBuilder.loadTexts: gsm7312Switching.setContactInfo('')
if mibBuilder.loadTexts: gsm7312Switching.setDescription('')
...
mibBuilder.exportSymbols("GSM7312-SWITCHING-MIB", agentProtocolGroupPortTable=agentProtocolGroupPortTable, agentTrapLogEntry=agentTrapLogEntry, agentSwitchBroadcastControlMode=agentSwitchBroadcastControlMode, agentSnmpTrapReceiverIPAddress=agentSnmpTrapReceiverIPAddress, agentStpPortEntry=agentStpPortEntry, agentTrapLogSystemTime=agentTrapLogSystemTime, agentSwitchMFDBDescription=agentSwitchMFDBDescription, agentStpMstDesignatedPortId=agentStpMstDesignatedPortId, agentLagDetailedConfigTable=agentLagDetailedConfigTable, agentStpConfigName=agentStpConfigName, agentTransferUploadDataType=agentTransferUploadDataType, agentPortSTPMode=agentPortSTPMode, agentSnmpSpanningTreeTrapFlag=agentSnmpSpanningTreeTrapFlag, agentLagDetailedPortStatus=agentLagDetailedPortStatus, agentStpMstId=agentStpMstId, agentConfigGroup=agentConfigGroup, agentAuthenticationListTable=agentAuthenticationListTable, agentStpMstVlanRowStatus=agentStpMstVlanRowStatus, agentLagConfigGroup=agentLagConfigGroup, agentSwitchIGMPSnoopingPortMask=agentSwitchIGMPSnoopingPortMask, agentTelnetMaxSessions=agentTelnetMaxSessions, agentStpMstTopologyChangeParm=agentStpMstTopologyChangeParm, agentCLIConfigGroup=agentCLIConfigGroup, agentSupportedMibDescription=agentSupportedMibDescription, agentTrapLogTotalSinceLastViewed=agentTrapLogTotalSinceLastViewed, agentMirroredPortIfIndex=agentMirroredPortIfIndex, agentLoginSessionTable=agentLoginSessionTable, agentProtocolGroupProtocolARP=agentProtocolGroupProtocolARP, agentLagSummaryAddPort=agentLagSummaryAddPort, agentServicePortDefaultGateway=agentServicePortDefaultGateway, agentSnmpTrapFlagsConfigGroup=agentSnmpTrapFlagsConfigGroup, agentStpMstPortId=agentStpMstPortId, agentLagDetailedLagIndex=agentLagDetailedLagIndex, agentSwitchAddressAgingTimeoutEntry=agentSwitchAddressAgingTimeoutEntry, agentUserPortConfigTable=agentUserPortConfigTable, agentSwitchConfigGroup=agentSwitchConfigGroup, agentSerialStopBits=agentSerialStopBits, agentSerialParityType=agentSerialParityType, agentPortDVlanTagCustomerId=agentPortDVlanTagCustomerId, agentSwitchMFDBMaxTableEntries=agentSwitchMFDBMaxTableEntries, agentStpPortState=agentStpPortState, agentUserStatus=agentUserStatus, agentPortDot1dBasePort=agentPortDot1dBasePort, agentCableTesterCableStatus=agentCableTesterCableStatus, agentClassOfServiceTable=agentClassOfServiceTable, agentAuthenticationGroup=agentAuthenticationGroup, gsm7312Switching=gsm7312Switching, agentTelnetConfigGroup=agentTelnetConfigGroup, agentTelnetLoginTimeout=agentTelnetLoginTimeout, agentPortDVlanTagEthertype=agentPortDVlanTagEthertype, agentSwitchAddressAgingTimeout=agentSwitchAddressAgingTimeout, agentSwitchMFDBFilteringPortMask=agentSwitchMFDBFilteringPortMask, vlanDefaultCfgFailureTrap=vlanDefaultCfgFailureTrap, agentUserConfigGroup=agentUserConfigGroup, agentSnmpCommunityName=agentSnmpCommunityName, agentStpMstTimeSinceTopologyChange=agentStpMstTimeSinceTopologyChange, agentSaveConfigStatus=agentSaveConfigStatus, agentLagSummaryLagIndex=agentLagSummaryLagIndex, agentSnmpCommunityIPAddress=agentSnmpCommunityIPAddress, agentProtocolGroupPortIfIndex=agentProtocolGroupPortIfIndex, agentSwitchMFDBSummaryForwardingPortMask=agentSwitchMFDBSummaryForwardingPortMask, agentClearTrapLog=agentClearTrapLog, agentProtocolConfigGroup=agentProtocolConfigGroup, agentLagConfigCreate=agentLagConfigCreate, agentSwitchMFDBCurrentEntries=agentSwitchMFDBCurrentEntries, agentCableTesterStatus=agentCableTesterStatus, agentStpMstPortTable=agentStpMstPortTable, broadcastStormEndTrap=broadcastStormEndTrap, agentClassOfServiceGroup=agentClassOfServiceGroup, agentServicePortConfigProtocol=agentServicePortConfigProtocol, agentPortIanaType=agentPortIanaType, powerSupplyStatusChangeTrap=powerSupplyStatusChangeTrap, agentStpCstRegionalRootPathCost=agentStpCstRegionalRootPathCost, agentProtocolGroupStatus=agentProtocolGroupStatus, agentLoginSessionStatus=agentLoginSessionStatus, agentPortMaxFrameSizeLimit=agentPortMaxFrameSizeLimit, agentPortClearStats=agentPortClearStats, agentTrapLogIndex=agentTrapLogIndex, agentSwitchMFDBMostEntriesUsed=agentSwitchMFDBMostEntriesUsed, agentStpMstPortPriority=agentStpMstPortPriority, agentSerialTimeout=agentSerialTimeout, agentProtocolGroupEntry=agentProtocolGroupEntry, agentDot3adAggPortTable=agentDot3adAggPortTable, agentStpCstHelloTime=agentStpCstHelloTime, agentStpMstTopologyChangeCount=agentStpMstTopologyChangeCount, agentSpanningTreeConfigGroup=agentSpanningTreeConfigGroup, agentLagSummaryAdminMode=agentLagSummaryAdminMode, agentStpPortStatsStpBpduTx=agentStpPortStatsStpBpduTx, agentStpCstMaxAge=agentStpCstMaxAge, agentLagConfigStaticCapability=agentLagConfigStaticCapability, agentStpSwitchConfigGroup=agentStpSwitchConfigGroup, agentClearConfig=agentClearConfig, agentClearPortStats=agentClearPortStats, agentClearLags=agentClearLags, agentTransferUploadPath=agentTransferUploadPath, agentSwitchIGMPSnoopingMulticastControlFramesProcessed=agentSwitchIGMPSnoopingMulticastControlFramesProcessed, agentUserPortSecurity=agentUserPortSecurity, agentServicePortSubnetMask=agentServicePortSubnetMask, agentUserName=agentUserName, agentPortIfIndex=agentPortIfIndex, agentStpAdminMode=agentStpAdminMode, agentNetworkWebMode=agentNetworkWebMode, agentSnmpLinkUpDownTrapFlag=agentSnmpLinkUpDownTrapFlag, agentTransferUploadFilename=agentTransferUploadFilename, agentTrapLogTotal=agentTrapLogTotal, agentUserPortConfigEntry=agentUserPortConfigEntry, agentProtocolGroupCreate=agentProtocolGroupCreate, agentUserAuthenticationConfigTable=agentUserAuthenticationConfigTable, agentSwitchIGMPSnoopingGroup=agentSwitchIGMPSnoopingGroup, agentStpCstConfigGroup=agentStpCstConfigGroup, agentServicePortBurnedInMacAddress=agentServicePortBurnedInMacAddress, agentTransferDownloadStart=agentTransferDownloadStart, agentProtocolGroupId=agentProtocolGroupId, agentTransferDownloadGroup=agentTransferDownloadGroup, agentStpForceVersion=agentStpForceVersion, agentTransferDownloadMode=agentTransferDownloadMode, agentSnmpCommunityIPMask=agentSnmpCommunityIPMask, agentLagSummaryLinkTrap=agentLagSummaryLinkTrap, agentPortDVlanTagMode=agentPortDVlanTagMode, agentLoginSessionIdleTime=agentLoginSessionIdleTime, agentNetworkDefaultGateway=agentNetworkDefaultGateway, agentStpCstPortForwardingState=agentStpCstPortForwardingState, vlanRestoreFailureTrap=vlanRestoreFailureTrap, agentLagSummaryName=agentLagSummaryName, agentSupportedMibIndex=agentSupportedMibIndex, agentSaveConfig=agentSaveConfig, agentUserConfigCreate=agentUserConfigCreate, agentSwitchDot3FlowControlMode=agentSwitchDot3FlowControlMode, agentClearPasswords=agentClearPasswords, agentNetworkSubnetMask=agentNetworkSubnetMask, agentStpCstBridgeHoldTime=agentStpCstBridgeHoldTime, agentPortMirroringGroup=agentPortMirroringGroup, agentStpCstBridgeMaxAge=agentStpCstBridgeMaxAge, agentPortMirroringMode=agentPortMirroringMode, agentLoginSessionSessionTime=agentLoginSessionSessionTime, agentStpPortStatsRstpBpduRx=agentStpPortStatsRstpBpduRx, agentNetworkConfigGroup=agentNetworkConfigGroup, agentServicePortConfigGroup=agentServicePortConfigGroup, agentSwitchMFDBMacAddress=agentSwitchMFDBMacAddress, agentNetworkIPAddress=agentNetworkIPAddress, agentStpPortStatsRstpBpduTx=agentStpPortStatsRstpBpduTx, agentProtocolGroupTable=agentProtocolGroupTable, agentStpCstDesignatedBridgeId=agentStpCstDesignatedBridgeId, agentStpPortStatsMstpBpduRx=agentStpPortStatsMstpBpduRx, agentStpMstTable=agentStpMstTable, agentDot3adAggPortEntry=agentDot3adAggPortEntry, agentTransferConfigGroup=agentTransferConfigGroup, vlanRequestFailureTrap=vlanRequestFailureTrap, agentStpMstPortForwardingState=agentStpMstPortForwardingState, agentSwitchMFDBSummaryMacAddress=agentSwitchMFDBSummaryMacAddress, agentTrapLogTable=agentTrapLogTable, agentStpMstBridgePriority=agentStpMstBridgePriority, agentInventoryGroup=agentInventoryGroup, agentProtocolGroupPortEntry=agentProtocolGroupPortEntry, agentClearSwitchStats=agentClearSwitchStats, agentUserIndex=agentUserIndex, agentStpCstPortTable=agentStpCstPortTable, agentStpMstRowStatus=agentStpMstRowStatus, agentAuthenticationListMethod3=agentAuthenticationListMethod3, agentSnmpTrapReceiverIndex=agentSnmpTrapReceiverIndex, stpInstanceTopologyChangeTrap=stpInstanceTopologyChangeTrap, agentClassOfServiceEntry=agentClassOfServiceEntry, agentClearVlan=agentClearVlan, agentLagSummaryStpMode=agentLagSummaryStpMode, agentTransferUploadMode=agentTransferUploadMode, agentSnmpTrapReceiverConfigTable=agentSnmpTrapReceiverConfigTable, agentStpCstPortPriority=agentStpCstPortPriority, agentCableTesterCableFailureLocation=agentCableTesterCableFailureLocation, agentSerialGroup=agentSerialGroup, agentSnmpMultipleUsersTrapFlag=agentSnmpMultipleUsersTrapFlag, agentTransferUploadServerIP=agentTransferUploadServerIP, agentPortPhysicalStatus=agentPortPhysicalStatus, agentStpMstDesignatedRootId=agentStpMstDesignatedRootId, agentStpMstPortPathCost=agentStpMstPortPathCost, agentAuthenticationListIndex=agentAuthenticationListIndex, agentSerialCharacterSize=agentSerialCharacterSize, agentResetSystem=agentResetSystem, agentPortDefaultType=agentPortDefaultType, agentAuthenticationListEntry=agentAuthenticationListEntry, agentSupportedMibTable=agentSupportedMibTable, agentStpMstDesignatedBridgeId=agentStpMstDesignatedBridgeId, agentClassOfServiceClass=agentClassOfServiceClass, agentPortConfigTable=agentPortConfigTable, agentSupportedMibEntry=agentSupportedMibEntry, agentStpCstPortTopologyChangeAck=agentStpCstPortTopologyChangeAck, agentStpMstRootPortId=agentStpMstRootPortId, agentSpanningTreeMode=agentSpanningTreeMode, agentInventoryAdditionalPackages=agentInventoryAdditionalPackages, agentUserAuthenticationType=agentUserAuthenticationType, agentStpCstRootFwdDelay=agentStpCstRootFwdDelay, agentLagDetailedIfIndex=agentLagDetailedIfIndex, agentSwitchMFDBForwardingPortMask=agentSwitchMFDBForwardingPortMask, agentTrapLogGroup=agentTrapLogGroup, agentStpPortUpTime=agentStpPortUpTime, agentNetworkConfigProtocol=agentNetworkConfigProtocol, agentPortLinkTrapMode=agentPortLinkTrapMode, agentSwitchIGMPSnoopingGroupMembershipInterval=agentSwitchIGMPSnoopingGroupMembershipInterval, agentSwitchMFDBSummaryEntry=agentSwitchMFDBSummaryEntry, agentSwitchMFDBTable=agentSwitchMFDBTable, agentLagSummaryType=agentLagSummaryType, agentCableTesterGroup=agentCableTesterGroup, agentSwitchIGMPSnoopingAdminMode=agentSwitchIGMPSnoopingAdminMode, agentStpCstPortOperPointToPoint=agentStpCstPortOperPointToPoint, agentUserConfigTable=agentUserConfigTable, agentStpCstRegionalRootId=agentStpCstRegionalRootId, agentAuthenticationListMethod1=agentAuthenticationListMethod1, multipleUsersTrap=multipleUsersTrap, agentLoginSessionUserName=agentLoginSessionUserName, agentSnmpCommunityAccessMode=agentSnmpCommunityAccessMode, agentProbePortIfIndex=agentProbePortIfIndex, agentSnmpCommunityConfigEntry=agentSnmpCommunityConfigEntry, agentLagSummaryStatus=agentLagSummaryStatus, agentPortMaxFrameSize=agentPortMaxFrameSize, agentInventoryBurnedInMacAddress=agentInventoryBurnedInMacAddress, agentTransferDownloadDataType=agentTransferDownloadDataType, agentUserAccessMode=agentUserAccessMode, agentProtocolGroupPortStatus=agentProtocolGroupPortStatus, agentAuthenticationListStatus=agentAuthenticationListStatus, agentSwitchIGMPSnoopingMaxResponseTime=agentSwitchIGMPSnoopingMaxResponseTime, agentTelnetAllowNewMode=agentTelnetAllowNewMode, agentStpMstPortEntry=agentStpMstPortEntry, agentCableTesterMaximumCableLength=agentCableTesterMaximumCableLength, agentPortDot3FlowControlMode=agentPortDot3FlowControlMode, agentStpPortStatsMstpBpduTx=agentStpPortStatsMstpBpduTx, agentAuthenticationListCreate=agentAuthenticationListCreate, agentStpMstVlanEntry=agentStpMstVlanEntry, agentUserConfigDefaultAuthenticationList=agentUserConfigDefaultAuthenticationList, gsm7312SwitchingTraps=gsm7312SwitchingTraps, agentStpMstEntry=agentStpMstEntry, stpInstanceNewRootTrap=stpInstanceNewRootTrap, agentCableTesterIfIndex=agentCableTesterIfIndex, agentNetworkJavaMode=agentNetworkJavaMode, agentStpCstPortEntry=agentStpCstPortEntry, agentInventoryMachineType=agentInventoryMachineType, agentProtocolGroupProtocolIP=agentProtocolGroupProtocolIP, agentUserConfigEntry=agentUserConfigEntry, agentSwitchAddressAgingTimeoutTable=agentSwitchAddressAgingTimeoutTable, agentServicePortIPAddress=agentServicePortIPAddress, agentProtocolGroupVlanId=agentProtocolGroupVlanId, agentSwitchMFDBSummaryTable=agentSwitchMFDBSummaryTable, agentLagSummaryConfigTable=agentLagSummaryConfigTable, agentStpCstPortOperEdge=agentStpCstPortOperEdge, PYSNMP_MODULE_ID=gsm7312Switching, agentInfoGroup=agentInfoGroup, agentStpCstBridgeHelloTime=agentStpCstBridgeHelloTime, fanFailureTrap=fanFailureTrap, agentLagSummaryConfigEntry=agentLagSummaryConfigEntry, agentLagDetailedConfigEntry=agentLagDetailedConfigEntry, agentSwitchMFDBProtocolType=agentSwitchMFDBProtocolType, agentSwitchMFDBSummaryVlanId=agentSwitchMFDBSummaryVlanId, agentStpMstVlanTable=agentStpMstVlanTable, agentTrapLogTrap=agentTrapLogTrap, agentStpConfigFormatSelector=agentStpConfigFormatSelector, agentSupportedMibName=agentSupportedMibName)
mibBuilder.exportSymbols("GSM7312-SWITCHING-MIB", agentStpPortMigrationCheck=agentStpPortMigrationCheck, agentInventorySoftwareVersion=agentInventorySoftwareVersion, agentStpCstDesignatedPortId=agentStpCstDesignatedPortId, linkFailureTrap=linkFailureTrap, agentCableTesterMinimumCableLength=agentCableTesterMinimumCableLength, agentLagSummaryDeletePort=agentLagSummaryDeletePort, agentPortAutoNegAdminStatus=agentPortAutoNegAdminStatus, agentAuthenticationListName=agentAuthenticationListName, agentSnmpCommunityConfigTable=agentSnmpCommunityConfigTable, agentLoginSessionEntry=agentLoginSessionEntry, agentSystemGroup=agentSystemGroup, agentProtocolGroupName=agentProtocolGroupName, agentLagDetailedPortSpeed=agentLagDetailedPortSpeed, agentTransferUploadGroup=agentTransferUploadGroup, agentClearLoginSessions=agentClearLoginSessions, agentTransferDownloadServerIP=agentTransferDownloadServerIP, agentProtocolGroupProtocolIPX=agentProtocolGroupProtocolIPX, agentPortAdminMode=agentPortAdminMode, agentLagSummaryFlushTimer=agentLagSummaryFlushTimer, agentSnmpCommunityCreate=agentSnmpCommunityCreate, agentStpCstPortPathCost=agentStpCstPortPathCost, agentStpPortTable=agentStpPortTable, agentSnmpBroadcastStormTrapFlag=agentSnmpBroadcastStormTrapFlag, agentSnmpTrapReceiverCommunityName=agentSnmpTrapReceiverCommunityName, agentStpMstRootPathCost=agentStpMstRootPathCost, agentStpConfigDigestKey=agentStpConfigDigestKey, agentStpMstDesignatedCost=agentStpMstDesignatedCost, agentSwitchMFDBVlanId=agentSwitchMFDBVlanId, agentDot3adAggPortLACPMode=agentDot3adAggPortLACPMode, agentSnmpConfigGroup=agentSnmpConfigGroup, agentSwitchMFDBType=agentSwitchMFDBType, agentTransferUploadStatus=agentTransferUploadStatus, agentStpConfigRevision=agentStpConfigRevision, agentStpMstBridgeIdentifier=agentStpMstBridgeIdentifier, agentPortPhysicalMode=agentPortPhysicalMode, agentUserPassword=agentUserPassword, agentSnmpTrapReceiverCreate=agentSnmpTrapReceiverCreate, agentNetworkMgmtVlan=agentNetworkMgmtVlan, agentSnmpCommunityIndex=agentSnmpCommunityIndex, agentStpCstPortId=agentStpCstPortId, agentStpCstPortEdge=agentStpCstPortEdge, agentNetworkBurnedInMacAddress=agentNetworkBurnedInMacAddress, agentSerialBaudrate=agentSerialBaudrate, agentTransferDownloadPath=agentTransferDownloadPath, agentTransferUploadStart=agentTransferUploadStart, agentTransferDownloadStatus=agentTransferDownloadStatus, agentUserEncryptionType=agentUserEncryptionType, agentSnmpTrapReceiverConfigEntry=agentSnmpTrapReceiverConfigEntry, agentUserAuthenticationList=agentUserAuthenticationList, agentInventorySysDescription=agentInventorySysDescription, agentTransferDownloadFilename=agentTransferDownloadFilename, agentLoginSessionConnectionType=agentLoginSessionConnectionType, agentPortType=agentPortType, agentAuthenticationListMethod2=agentAuthenticationListMethod2, agentPortSTPState=agentPortSTPState, agentLoginSessionIPAddress=agentLoginSessionIPAddress, agentSerialHWFlowControlMode=agentSerialHWFlowControlMode, agentStpCstBridgeFwdDelay=agentStpCstBridgeFwdDelay, agentPortConfigEntry=agentPortConfigEntry, agentUserEncryptionPassword=agentUserEncryptionPassword, agentLoginSessionIndex=agentLoginSessionIndex, agentStpCstDesignatedCost=agentStpCstDesignatedCost, agentSnmpCommunityStatus=agentSnmpCommunityStatus, agentDot3adAggPort=agentDot3adAggPort, agentSwitchIGMPSnoopingMRPExpirationTime=agentSwitchIGMPSnoopingMRPExpirationTime, agentSwitchMFDBGroup=agentSwitchMFDBGroup, broadcastStormStartTrap=broadcastStormStartTrap, agentSnmpAuthenticationTrapFlag=agentSnmpAuthenticationTrapFlag, agentSnmpTrapReceiverStatus=agentSnmpTrapReceiverStatus, agentStpPortStatsStpBpduRx=agentStpPortStatsStpBpduRx, agentUserAuthenticationConfigEntry=agentUserAuthenticationConfigEntry, vlanDeleteLastTrap=vlanDeleteLastTrap, agentClassOfServicePriority=agentClassOfServicePriority, agentSwitchMFDBEntry=agentSwitchMFDBEntry)
