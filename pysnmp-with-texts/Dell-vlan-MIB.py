...
# Produced by pysmi-0.3.4 at Wed May  1 12:57:59 2019
...
ModuleIdentity, Unsigned32, iso, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, IpAddress, Gauge32, TimeTicks, Bits, Integer32, ObjectIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Unsigned32", "iso", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "IpAddress", "Gauge32", "TimeTicks", "Bits", "Integer32", "ObjectIdentity", "Counter64")
...
if mibBuilder.loadTexts: vlan.setContactInfo('www.dell.com')
if mibBuilder.loadTexts: vlan.setDescription('The private MIB module definition for IP Multicast support in Dell devices.')
...
if mibBuilder.loadTexts: vlanPrivateTableOld.setDescription('table for PrivateVlan')
...
if mibBuilder.loadTexts: vlanPrivateEntryOld.setDescription(' entry of PrivateVlan')
...
if mibBuilder.loadTexts: vlanPrivateOldIsolatedVlanTag.setDescription('vlan Tag')
...
if mibBuilder.loadTexts: vlanPrivateOldStatus.setDescription('The row status variable, used according to row installation and removal conventions.')
...
if mibBuilder.loadTexts: vlanVoicePortQosMode.setDescription("Port's current QOS mode in Voice VLAN. Possible values: 'src(1)' - Only traffic with OUI prefix in the source MAC received QOS of the Voice Vlan. 'all(2)' - All traffic through that port received QOS of the Voice Vlan.")
...
if mibBuilder.loadTexts: vlanPrivateTable.setDescription('Private vlan table which contains the private vlan entries.')
...
if mibBuilder.loadTexts: vlanPrivateEntry.setDescription('Private vlan entry which contains the private vlan definition.')
vlanPrivateVid = MibTableColumn((1, 3, 6, 1, 4, 1, 89, 48, 59, 1, 1), VlanIndex())
if mibBuilder.loadTexts: vlanPrivateVid.setStatus('current')
if mibBuilder.loadTexts: vlanPrivateVid.setDescription('The static vlan ID which is set to one of the private vlan types.')
...
if mibBuilder.loadTexts: vlanPrivateType.setDescription('private vlan types: primary - Carries traffic from promiscuous ports. promiscuous port can communicate with all ports of the same PVLAN, including the isolated and community ports of the same PVLAN. isolated - Carries traffic from isolated ports. isolated ports can communicate only with the promiscuous ports of the same PVLAN. community - Carries traffic from community ports. community ports of the same community can communicate among themselves and with the promiscuous ports of the same PVLAN.')
...
if mibBuilder.loadTexts: vlanPrivatePrimaryVid.setDescription('The primary vlan ID which has defined in VlanPrivateEntry and which is associated with secondary vlan (in vlanPrivateMapTable). vlanPrivatePrimaryVid is equivalent to vlanPrivateVid when vlanPrivateVid is primary vlan.')
...
if mibBuilder.loadTexts: vlanPrivateMapTable.setDescription('Private vlan mapping table which contains the private vlan mapping entries.')
...
if mibBuilder.loadTexts: vlanPrivateMapEntry.setDescription('Private vlan mapping entry which contains the primary / secondary private vlan association and their ports membership.')
...
if mibBuilder.loadTexts: vlanPrivateMapPrimaryVid.setDescription('The primary private vlan ID which is associated with the secondary (isolated or community) vlan (vlanPrivateMapSecondaryVid).')
...
if mibBuilder.loadTexts: vlanPrivateMapSecondaryVid.setDescription('The secondary private vlan ID which is associated with the primary vlan (vlanPrivateMapPrimaryVid).')
...
if mibBuilder.loadTexts: vlanPrivateMapPrimaryPorts.setDescription('The private vlan promiscuous ports mode which are belongs to the association of vlanPrivateMapPrimaryVid and vlanPrivateMapSecondaryVid.')
...
if mibBuilder.loadTexts: vlanPrivateMapSecondaryPorts.setDescription('The private vlan host ports mode which are belongs to the association of vlanPrivateMapPrimaryVid and vlanPrivateMapSecondaryVid.')
...
if mibBuilder.loadTexts: vlanPrivateMapPrimaryOperPorts.setDescription('The private vlan active promiscuous ports mode which are belongs to the association of vlanPrivateMapPrimaryVid and vlanPrivateMapSecondaryVid.')
...
if mibBuilder.loadTexts: vlanPrivateMapSecondaryOperPorts.setDescription('The private vlan active host ports mode which are belongs to the association of vlanPrivateMapPrimaryVid and vlanPrivateMapSecondaryVid.')
...
if mibBuilder.loadTexts: vlanPrivateMapStatus.setDescription('The row status variable, used according to row installation and removal conventions.')
vlanTrunkPortModeTable = MibTable((1, 3, 6, 1, 4, 1, 89, 48, 61), )
if mibBuilder.loadTexts: vlanTrunkPortModeTable.setStatus('current')
if mibBuilder.loadTexts: vlanTrunkPortModeTable.setDescription('The tables contains trunk mode port entries.')
...
if mibBuilder.loadTexts: vlanTrunkPortModeEntry.setDescription(' The entry contains port ifIndex,native vlan id and vlan list the port has a membership. The vlan list can contain not created vlans.')
...
if mibBuilder.loadTexts: vlanTrunkPortModeNativeVlanId.setDescription('Indicated native vlan index.Default value 0')
...
if mibBuilder.loadTexts: vlanTrunkModeList1to1024.setDescription('vlan trunk mode list 1. Default value is {0}')
...
if mibBuilder.loadTexts: vlanTrunkModeList1025to2048.setDescription('vlan trunk mode list 2. Default value is {0}')
...
if mibBuilder.loadTexts: vlanTrunkModeList2049to3072.setDescription('vlan trunk mode list 3. Default value is {0}')
...
if mibBuilder.loadTexts: vlanTrunkModeList3073to4094.setDescription('vlan trunk mode list 4. Default value is {0}')
vlanAccessPortModeTable = MibTable((1, 3, 6, 1, 4, 1, 89, 48, 62), )
if mibBuilder.loadTexts: vlanAccessPortModeTable.setStatus('current')
if mibBuilder.loadTexts: vlanAccessPortModeTable.setDescription('The tables contains access mode port entries.')
...
if mibBuilder.loadTexts: vlanAccessPortModeEntry.setDescription(' The entry contains port ifIndex,access vlan id and multicast TV vlan id.')
...
if mibBuilder.loadTexts: vlanAccessPortModeVlanId.setDescription('Indicated access vlan id.Default value is 0')
...
if mibBuilder.loadTexts: vlanAccessPortModeMcstTvVlanId.setDescription('Indicated multicast TV vlan id. ')
...
if mibBuilder.loadTexts: vlanCustomerPortModeTable.setDescription('The tables contains customer mode port entries.')
...
if mibBuilder.loadTexts: vlanCustomerPortModeEntry.setDescription(' The entry contains port ifIndex,customer vlan id and customer multicast TV vlan id.')
...
if mibBuilder.loadTexts: vlanCustomerPortModeVlanId.setDescription('Indicated customer vlan id.Default value is 0')
...
if mibBuilder.loadTexts: vlanCustomerPortModeMtvList1to1024.setDescription('vlan customer port mode multicast TV list 1. Default value is {0}')
...
if mibBuilder.loadTexts: vlanCustomerPortModeMtvList1025to2048.setDescription('vlan customer port mode multicast TV list 2. Default value is {0}')
...
if mibBuilder.loadTexts: vlanCustomerPortModeMtvList2049to3072.setDescription('vlan customer port mode multicast TV list 3. Default value is {0}')
...
if mibBuilder.loadTexts: vlanCustomerPortModeMtvList3073to4094.setDescription('vlan customer port mode multicast TV list 4. Default value is {0}')
vlanSwitchPortModeTable = MibTable((1, 3, 6, 1, 4, 1, 89, 48, 64), )
if mibBuilder.loadTexts: vlanSwitchPortModeTable.setStatus('current')
if mibBuilder.loadTexts: vlanSwitchPortModeTable.setDescription('The table defines L3/L2 port context.')
...
if mibBuilder.loadTexts: vlanSwitchPortModeEntry.setDescription('The entry contains port ifIndex and switch port enable value.')
...
if mibBuilder.loadTexts: vlanSwitchPortModeCategory.setDescription('Indicated if a port is switchport (l2 port) or no switchport (l3 port) 1 - switchport 2 - no switchport. Default is 1')
vlanPortModeContextTable = MibTable((1, 3, 6, 1, 4, 1, 89, 48, 65), )
if mibBuilder.loadTexts: vlanPortModeContextTable.setStatus('current')
if mibBuilder.loadTexts: vlanPortModeContextTable.setDescription('The tables contains current port mode context entries.')
...
if mibBuilder.loadTexts: vlanPortModeContextEntry.setDescription('The entry contains current port mode context.')
...
if mibBuilder.loadTexts: vlanPortModeContextValue.setDescription('Indicated port context value: 0. Lag 1. Monitor 2. L3 3. RAVA 4. Dot1x 5. Dot1q 6. Access 7. Trunk 8. Customer 9. PV_promisc 10. PV_host')
...
if mibBuilder.loadTexts: vlanRsvlEnable.setDescription('Enable / Disable Shared Vlans at the device.')
vlanRsvlMapTable = MibTable((1, 3, 6, 1, 4, 1, 89, 48, 67), )
if mibBuilder.loadTexts: vlanRsvlMapTable.setStatus('current')
if mibBuilder.loadTexts: vlanRsvlMapTable.setDescription('Shared vlan learning mapping table which contains the SVL mapping entries.')
...
if mibBuilder.loadTexts: vlanRsvlMapEntry.setDescription('SVL mapping entry which contains the primary / secondary SVL association.')
...
if mibBuilder.loadTexts: vlanRsvlMapPrimaryVid.setDescription('The primary SVL ID which is associated with the secondary shared vlan vlanRsvlMapSecondaryVid.')
...
if mibBuilder.loadTexts: vlanRsvlMapSecondaryVid.setDescription('The secondary SVL ID which is associated with the primary shared vlan vlanRsvlMapPrimaryVid.')
...
if mibBuilder.loadTexts: vlanRsvlMapStatus.setDescription('The row status variable, used according to row installation and removal conventions.')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticTable.setDescription('A table containing static vlan port membership information.')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticEntry.setDescription('Static vlan membership information per port')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticEgressList1to1024.setDescription('The port egress vlan static list.Default value is {0}')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticEgressList1025to2048.setDescription('The port egress vlan static list.Default value is {0}')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticEgressList2049to3072.setDescription('The port egress vlan static list.Default value is {0}')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticEgressList3073to4094.setDescription('The port egress vlan static list.Default value is {0}')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticUntaggedEgressList1to1024.setDescription('The port egress untagged vlan static list.Default value is {0}')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticUntaggedEgressList1025to2048.setDescription('The port egress untagged vlan static list.Default value is {0}')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticUntaggedEgressList2049to3072.setDescription('The port egress untagged vlan static list.Default value is {0}')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticUntaggedEgressList3073to4094.setDescription('The port egress untagged vlan static list.Default value is {0}')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticForbiddenList1to1024.setDescription('The port forbidden vlan static list.Default value is {0}')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticForbiddenList1025to2048.setDescription('The port forbidden vlan static list.Default value is {0}')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticForbiddenList2049to3072.setDescription('The port forbidden vlan static list.Default value is {0}')
...
if mibBuilder.loadTexts: rldot1qPortVlanStaticForbiddenList3073to4094.setDescription('The port forbidden vlan static list.Default value is {0}')
...
if mibBuilder.loadTexts: rldot1qVlanStaticListTable.setDescription('A table contains only one entry of a static vlan list.')
...
if mibBuilder.loadTexts: rldot1qVlanStaticListEntry.setDescription('Staticly created by local or network management vlan list')
...
if mibBuilder.loadTexts: rldot1qVlanStaticListIndex.setDescription("An index is entrie's sequence. This field substitutes a vlan type. If the vlan was created by user configuration then the type is static. If the vlan was created by GVRP/MVRP protocols then the type is dynamicGvrp. If the vlan was created by Radius server attribute assignment mechanism then the type is dynamicRava.")
...
if mibBuilder.loadTexts: rldot1qVlanStaticList1to1024.setDescription('A list of staticaly created vlans from 1 to 1024.')
...
if mibBuilder.loadTexts: rldot1qVlanStaticList1025to2048.setDescription('A list of according to the type field created vlans from 1025 to 2048.')
...
if mibBuilder.loadTexts: rldot1qVlanStaticList2049to3072.setDescription('A list of according to the type field created vlans from 2049 to 3072.')
...
if mibBuilder.loadTexts: rldot1qVlanStaticList3073to4094.setDescription('A list of according to the type field created vlans from 3073 to 4094.')
...
if mibBuilder.loadTexts: rldot1qVlanStaticNameTable.setDescription('A table contains created by user vlans names.')
...
if mibBuilder.loadTexts: rldot1qVlanStaticNameEntry.setDescription('Staticly created by local or network management vlan list')
...
if mibBuilder.loadTexts: rldot1qVlanStaticName.setReference('IEEE 802.1Q/D11 Section 12.10.2.1')
if mibBuilder.loadTexts: rldot1qVlanStaticName.setStatus('current')
if mibBuilder.loadTexts: rldot1qVlanStaticName.setDescription('An administratively assigned string,which may be used to identify the VLAN. The VLAN name must be unique or no name.')
...
if mibBuilder.loadTexts: rlPortVlanTriplePlayMulticastTvTable.setDescription('A table saves a list of vlans per port/lag.')
...
if mibBuilder.loadTexts: rlPortVlanTriplePlayMulticastTvEntry.setDescription('Entry of Triple Play Multicast Tv table.')
...
if mibBuilder.loadTexts: rlPortVlanTriplePlayMulticastTvList1to1024.setDescription('A list of staticaly created Triple Play MTV vlans from 1 to 1024.')
...
if mibBuilder.loadTexts: rlPortVlanTriplePlayMulticastTvList1025to2048.setDescription('A list of staticaly created Triple Play MTV vlans from 1025 to 2048.')
...
if mibBuilder.loadTexts: rlPortVlanTriplePlayMulticastTvList2049to3072.setDescription('A list of staticaly created Triple Play MTV vlans from 2049 to 3072.')
...
if mibBuilder.loadTexts: rlPortVlanTriplePlayMulticastTvList3073to4094.setDescription('A list of staticaly created Triple Play MTV vlans from 3073 to 4094.')
...
if mibBuilder.loadTexts: rldot1qVlanMembershipTypeTable.setDescription('A table contains a bitmap of the VLAN owners(applications) that can create the VLAN and/or add a port to the VLAN.')
...
if mibBuilder.loadTexts: rldot1qVlanMembershipTypeEntry.setDescription('Staticly or dynamicly created VLAN ID owner entry')
...
if mibBuilder.loadTexts: rldot1qVlanMembershipTypeBitmap.setDescription('This field contains a bitmap of owners that can creates and/or add a port to the VLAN. There exist three such type of owners : Default VLAN Manual created VLAN Dynamic(RAVA)created VLAN GVRP(MVRP)created VLAN ')
mibBuilder.exportSymbols("Dell-vlan-MIB", vlanAsymmetricEnabled=vlanAsymmetricEnabled, vlanSubnetPortGroupVid=vlanSubnetPortGroupVid, vlanSpecialTagCurrentTable=vlanSpecialTagCurrentTable, vlanDynamicVlanTable=vlanDynamicVlanTable, rldot1qVlanStaticList2049to3072=rldot1qVlanStaticList2049to3072, vlanPortModeExtEntry=vlanPortModeExtEntry, vlanTrunkModeList1to1024=vlanTrunkModeList1to1024, rldot1qPortVlanStaticUntaggedEgressList1to1024=rldot1qPortVlanStaticUntaggedEgressList1to1024, vlanPrivateEdgeTable=vlanPrivateEdgeTable, vlanMacBaseVlanGroupId=vlanMacBaseVlanGroupId, vlanPrivateOldStatus=vlanPrivateOldStatus, vlanDynamicVlanEntry=vlanDynamicVlanEntry, vlanSubnetRangeTable=vlanSubnetRangeTable, rlPortVlanTriplePlayMulticastTvTable=rlPortVlanTriplePlayMulticastTvTable, vlanSubnetRangeGroupId=vlanSubnetRangeGroupId, vlanDynamicVlanTag=vlanDynamicVlanTag, vlanTrunkPortModeNativeVlanId=vlanTrunkPortModeNativeVlanId, vlanSpecialTagEntry=vlanSpecialTagEntry, vlanSpecialTagStatus=vlanSpecialTagStatus, vlanDot1vSupported=vlanDot1vSupported, vlanPortModeContextEntry=vlanPortModeContextEntry, vlanMulticastTvVID=vlanMulticastTvVID, vlanPrivateOldIsolatedVlanTag=vlanPrivateOldIsolatedVlanTag, vlanTriplePlayMulticastTvVID=vlanTriplePlayMulticastTvVID, vlanPrivateVid=vlanPrivateVid, rldot1qVlanMembershipTypeTable=rldot1qVlanMembershipTypeTable, rldot1qPortVlanStaticEgressList1025to2048=rldot1qPortVlanStaticEgressList1025to2048, rldot1qVlanStaticNameTable=rldot1qVlanStaticNameTable, vlanPortModeExtTable=vlanPortModeExtTable, vlanSpecialTagCurrentActive=vlanSpecialTagCurrentActive, vlan=vlan, vlanPrivateEdgeSupported=vlanPrivateEdgeSupported, vlanPrivateEdgeVersion=vlanPrivateEdgeVersion, vlanMacBaseVlanPortEntry=vlanMacBaseVlanPortEntry, vlanInetTriplePlayEntry=vlanInetTriplePlayEntry, vlanVoicePortSecure=vlanVoicePortSecure, rldot1qPortVlanStaticUntaggedEgressList2049to3072=rldot1qPortVlanStaticUntaggedEgressList2049to3072, vlanVoiceAgingTimeout=vlanVoiceAgingTimeout, vlanPrivateMapSecondaryVid=vlanPrivateMapSecondaryVid, vlanVoiceOUIEntryRowStatus=vlanVoiceOUIEntryRowStatus, vlanNameEntry=vlanNameEntry, vlanRsvlMapTable=vlanRsvlMapTable, vlanCustomerPortModeMtvList2049to3072=vlanCustomerPortModeMtvList2049to3072, vlanPrivateEntryOld=vlanPrivateEntryOld, rldot1qVlanStaticListIndex=rldot1qVlanStaticListIndex, vlanVoiceEntry=vlanVoiceEntry, vlanInetTriplePlayRowStatus=vlanInetTriplePlayRowStatus, vlanAccessPortModeVlanId=vlanAccessPortModeVlanId, rldot1qPortVlanStaticForbiddenList1to1024=rldot1qPortVlanStaticForbiddenList1to1024, vlanVoicePortCurrentMembership=vlanVoicePortCurrentMembership, vlanPrivateMapSecondaryOperPorts=vlanPrivateMapSecondaryOperPorts, vlanPrivateCommunityTable=vlanPrivateCommunityTable, vlanMacBaseVlanPortRowStatus=vlanMacBaseVlanPortRowStatus, vlanPortModeExtStatus=vlanPortModeExtStatus, vlanDefaultEnabledPorts=vlanDefaultEnabledPorts, vlanTriplePlayTable=vlanTriplePlayTable, rldot1qPortVlanStaticEgressList2049to3072=rldot1qPortVlanStaticEgressList2049to3072, vlanRsvlMapStatus=vlanRsvlMapStatus, vlanTrunkModeList2049to3072=vlanTrunkModeList2049to3072, rldot1qVlanStaticList1025to2048=rldot1qVlanStaticList1025to2048, rldot1qPortVlanStaticUntaggedEgressList1025to2048=rldot1qPortVlanStaticUntaggedEgressList1025to2048, vlanSubnetRangeEntry=vlanSubnetRangeEntry, vlanTriplePlayInnerVID=vlanTriplePlayInnerVID, vlanPrivateEdgeGroupTable=vlanPrivateEdgeGroupTable, vlanSubnetPortRowStatus=vlanSubnetPortRowStatus, vlanVoicePriorityRemark=vlanVoicePriorityRemark, vlanPrivateMapStatus=vlanPrivateMapStatus, vlanRsvlEnable=vlanRsvlEnable, rldot1qVlanStaticListTable=rldot1qVlanStaticListTable, vlanTriplePlayMulticastTvTable=vlanTriplePlayMulticastTvTable, vlanPrivateMapEntry=vlanPrivateMapEntry, vlanVoiceTable=vlanVoiceTable, rldot1qPortVlanStaticForbiddenList1025to2048=rldot1qPortVlanStaticForbiddenList1025to2048, vlanMulticastTvEntry=vlanMulticastTvEntry, vlanTriplePlayMulticatTvEntry=vlanTriplePlayMulticatTvEntry, vlanInetTriplePlayMulticastTvMulticastTvVID=vlanInetTriplePlayMulticastTvMulticastTvVID, vlanPrivateSupported=vlanPrivateSupported, vlanDefaultExtManagment=vlanDefaultExtManagment, vlanTrunkModeList1025to2048=vlanTrunkModeList1025to2048, vlanTriplePlayMulticastTvMulticastTvPortList=vlanTriplePlayMulticastTvMulticastTvPortList, vlanSubnetRangeRowStatus=vlanSubnetRangeRowStatus, vlanAccessPortModeMcstTvVlanId=vlanAccessPortModeMcstTvVlanId, rldot1qPortVlanStaticForbiddenList2049to3072=rldot1qPortVlanStaticForbiddenList2049to3072, vlanPrivateEdgeEntry=vlanPrivateEdgeEntry, vlanSpecialTagTable=vlanSpecialTagTable, vlanTriplePlayEntry=vlanTriplePlayEntry, vlanTrunkPortModeEntry=vlanTrunkPortModeEntry, rldot1qVlanStaticList3073to4094=rldot1qVlanStaticList3073to4094, vlanPortModeTable=vlanPortModeTable, vlanAccessPortModeTable=vlanAccessPortModeTable, vlanPrivateTableOld=vlanPrivateTableOld, vlanMacBaseVlanPortTable=vlanMacBaseVlanPortTable, vlanPrivateEdgeGroupIfIndexTable=vlanPrivateEdgeGroupIfIndexTable, vlanVoicePortEnable=vlanVoicePortEnable, vlanSpecialTagCurrentVID=vlanSpecialTagCurrentVID, rldot1qPortVlanStaticUntaggedEgressList3073to4094=rldot1qPortVlanStaticUntaggedEgressList3073to4094, vlanPrivateStatus=vlanPrivateStatus, vlanPortModeExtState=vlanPortModeExtState, rldot1qPortVlanStaticEgressList3073to4094=rldot1qPortVlanStaticEgressList3073to4094, vlanPrivateEdgeGroupIfIndexEntry=vlanPrivateEdgeGroupIfIndexEntry, PYSNMP_MODULE_ID=vlan, vlanDefaultEnabled=vlanDefaultEnabled, rldot1qVlanMembershipTypeEntry=rldot1qVlanMembershipTypeEntry, vlanVoicePriority=vlanVoicePriority, vlanInetTriplePlayMulticatTvEntry=vlanInetTriplePlayMulticatTvEntry, rlPortVlanTriplePlayMulticastTvEntry=rlPortVlanTriplePlayMulticastTvEntry, vlanCustomerPortModeMtvList1to1024=vlanCustomerPortModeMtvList1to1024, vlanCustomerPortModeMtvList1025to2048=vlanCustomerPortModeMtvList1025to2048, vlanSubnetRangeMask=vlanSubnetRangeMask, vlanRsvlMapPrimaryVid=vlanRsvlMapPrimaryVid, vlanRsvlMapSecondaryVid=vlanRsvlMapSecondaryVid, vlanPrivateMapPrimaryVid=vlanPrivateMapPrimaryVid, vlanMulticastTvStatus=vlanMulticastTvStatus, vlanSendUnknownToAllPorts=vlanSendUnknownToAllPorts, vlanPrivateEdgeGroupUplink=vlanPrivateEdgeGroupUplink, vlanPortModeEntry=vlanPortModeEntry, vlanTrunkPortModeTable=vlanTrunkPortModeTable, vlanCustomerPortModeEntry=vlanCustomerPortModeEntry, vlanSpecialTagVID=vlanSpecialTagVID, vlanMacBaseVlanGroupRowStatus=vlanMacBaseVlanGroupRowStatus, vlanSwitchPortModeTable=vlanSwitchPortModeTable, rldot1qPortVlanStaticEntry=rldot1qPortVlanStaticEntry, vlanSubnetRangeAddr=vlanSubnetRangeAddr, vlanPrivateEdgeGroupSource=vlanPrivateEdgeGroupSource, rldot1qPortVlanStaticTable=rldot1qPortVlanStaticTable, vlanDefaultTaggedPorts=vlanDefaultTaggedPorts, vlanSwitchPortModeEntry=vlanSwitchPortModeEntry, vlanVoicePortTable=vlanVoicePortTable, vlanDynamicVlanStatus=vlanDynamicVlanStatus, vlanSubnetPortGroupId=vlanSubnetPortGroupId, rldot1qVlanStaticList1to1024=rldot1qVlanStaticList1to1024, vlanVoiceRowStatus=vlanVoiceRowStatus, rldot1qVlanStaticNameEntry=rldot1qVlanStaticNameEntry, vlanPortModeContextValue=vlanPortModeContextValue, vlanPrivatePrimaryVid=vlanPrivatePrimaryVid, vlanMacBaseVlanPortGroupVid=vlanMacBaseVlanPortGroupVid, vlanVoiceOUIDescription=vlanVoiceOUIDescription, rldot1qVlanStaticName=rldot1qVlanStaticName, vlanSubnetPortEntry=vlanSubnetPortEntry, vlanMaxTableNumber=vlanMaxTableNumber, vlanDefault=vlanDefault, vlanPrivateType=vlanPrivateType, vlanDynamicVlanSupported=vlanDynamicVlanSupported, vlanPrivateEdgeGroupIfIndexDomainID=vlanPrivateEdgeGroupIfIndexDomainID, vlanPrivateTable=vlanPrivateTable, vlanPrivateCommunityEntry=vlanPrivateCommunityEntry, vlanNameTag=vlanNameTag, vlanVoicePortEntry=vlanVoicePortEntry, vlanVoicePortQosMode=vlanVoicePortQosMode, vlanPrivateMapTable=vlanPrivateMapTable, vlanTriplePlayRowStatus=vlanTriplePlayRowStatus, rlPortVlanTriplePlayMulticastTvList1to1024=rlPortVlanTriplePlayMulticastTvList1to1024, vlanNameIfIndex=vlanNameIfIndex, vlanPrivateEdgeGroupStatus=vlanPrivateEdgeGroupStatus, vlanInetTriplePlayInetAddressType=vlanInetTriplePlayInetAddressType, vlanVoicePortVlanIndex=vlanVoicePortVlanIndex, vlanSwitchPortModeCategory=vlanSwitchPortModeCategory, vlanMacBaseVlanMacAddress=vlanMacBaseVlanMacAddress, vlanSubnetPortTable=vlanSubnetPortTable, vlanSpecialTagCurrentReserved=vlanSpecialTagCurrentReserved, vlanMulticastTvTable=vlanMulticastTvTable, vlanPrivateMapSecondaryPorts=vlanPrivateMapSecondaryPorts, vlanPrivateEdgeStatus=vlanPrivateEdgeStatus, vlanPrivateMapPrimaryOperPorts=vlanPrivateMapPrimaryOperPorts, vlanNameName=vlanNameName, vlanPrivateEdgeUplink=vlanPrivateEdgeUplink, vlanTriplePlayMulticastTvMulticastTvVID=vlanTriplePlayMulticastTvMulticastTvVID, vlanVoiceOUIPrefix=vlanVoiceOUIPrefix, vlanInetTriplePlayMulticastTvVID=vlanInetTriplePlayMulticastTvVID, vlanNameTable=vlanNameTable, vlanMacBaseVlanGroupEntry=vlanMacBaseVlanGroupEntry, vlanInetTriplePlayMulticastTvTable=vlanInetTriplePlayMulticastTvTable, vlanTrunkModeList3073to4094=vlanTrunkModeList3073to4094, rldot1qPortVlanStaticForbiddenList3073to4094=rldot1qPortVlanStaticForbiddenList3073to4094, vlanPrivateEntry=vlanPrivateEntry, vlanCustomerPortModeMtvList3073to4094=vlanCustomerPortModeMtvList3073to4094, vlanDefaultSupported=vlanDefaultSupported, rlPortVlanTriplePlayMulticastTvList2049to3072=rlPortVlanTriplePlayMulticastTvList2049to3072, vlanMibVersion=vlanMibVersion, vlanPrivateEdgeGroupIfIndexID=vlanPrivateEdgeGroupIfIndexID, vlanInetTriplePlayTable=vlanInetTriplePlayTable, vlanVoice=vlanVoice, vlanMacBaseVlanPortGroupId=vlanMacBaseVlanPortGroupId, vlanPortModeContextTable=vlanPortModeContextTable, vlanRsvlMapEntry=vlanRsvlMapEntry, vlanPortModeState=vlanPortModeState, vlanVoiceOUIEntry=vlanVoiceOUIEntry, rlPortVlanTriplePlayMulticastTvList1025to2048=rlPortVlanTriplePlayMulticastTvList1025to2048, vlanPrivateEdgeGroupEntry=vlanPrivateEdgeGroupEntry, vlanInetTriplePlayMulticastTvMulticastTvPortList=vlanInetTriplePlayMulticastTvMulticastTvPortList, vlanMacBaseVlanGroupTable=vlanMacBaseVlanGroupTable, vlanCustomerPortModeVlanId=vlanCustomerPortModeVlanId, vlanInetTriplePlayInnerVID=vlanInetTriplePlayInnerVID, rldot1qPortVlanStaticEgressList1to1024=rldot1qPortVlanStaticEgressList1to1024, vlanVoiceOUISetToDefault=vlanVoiceOUISetToDefault, rldot1qVlanMembershipTypeBitmap=rldot1qVlanMembershipTypeBitmap, vlanDynamicVlanMacAddress=vlanDynamicVlanMacAddress, vlanAccessPortModeEntry=vlanAccessPortModeEntry, vlanPrivateMapPrimaryPorts=vlanPrivateMapPrimaryPorts, vlanPrivateCommunityStatus=vlanPrivateCommunityStatus, vlanMacBaseVlanMacMask=vlanMacBaseVlanMacMask, vlanPrivateCommunityVlanTag=vlanPrivateCommunityVlanTag, vlanSpecialTagCurrentEntry=vlanSpecialTagCurrentEntry, rldot1qVlanStaticListEntry=rldot1qVlanStaticListEntry, vlanVoiceOUITable=vlanVoiceOUITable, rlPortVlanTriplePlayMulticastTvList3073to4094=rlPortVlanTriplePlayMulticastTvList3073to4094, vlanCustomerPortModeTable=vlanCustomerPortModeTable)
