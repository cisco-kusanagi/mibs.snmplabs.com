...
# Produced by pysmi-0.3.4 at Wed May  1 12:24:26 2019
...
VlanList4, VlanList2, VlanList1, VlanList3 = mibBuilder.importSymbols("CISCOSB-BRIDGEMIBOBJECTS-MIB", "VlanList4", "VlanList2", "VlanList1", "VlanList3")
...
Counter64, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, NotificationType, ObjectIdentity, ModuleIdentity, IpAddress, TimeTicks, Counter32, Integer32, MibIdentifier, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "IpAddress", "TimeTicks", "Counter32", "Integer32", "MibIdentifier", "iso", "Bits")
...
if mibBuilder.loadTexts: vlan.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
if mibBuilder.loadTexts: vlan.setDescription('The private MIB module definition for IP Multicast support in CISCOSB devices.')
...
mibBuilder.exportSymbols("CISCOSB-vlan-MIB", rldot1qPortVlanStaticEgressList3073to4094=rldot1qPortVlanStaticEgressList3073to4094, vlanPortModeTable=vlanPortModeTable, vlanSendUnknownToAllPorts=vlanSendUnknownToAllPorts, vlanPrivateMapSecondaryVid=vlanPrivateMapSecondaryVid, vlanTriplePlayMulticatTvEntry=vlanTriplePlayMulticatTvEntry, vlanTrunkPortModeNativeVlanId=vlanTrunkPortModeNativeVlanId, vlanPrivateType=vlanPrivateType, vlanSpecialTagCurrentReserved=vlanSpecialTagCurrentReserved, vlanMacBaseVlanPortTable=vlanMacBaseVlanPortTable, vlanMibVersion=vlanMibVersion, vlanVoiceAgingTimeout=vlanVoiceAgingTimeout, rldot1qPortVlanStaticEntry=rldot1qPortVlanStaticEntry, vlanDefault=vlanDefault, vlanPrivateOldStatus=vlanPrivateOldStatus, vlanPrivateTableOld=vlanPrivateTableOld, vlanSubnetRangeTable=vlanSubnetRangeTable, vlanNameTable=vlanNameTable, vlanPrivateMapSecondaryPorts=vlanPrivateMapSecondaryPorts, vlanRsvlMapPrimaryVid=vlanRsvlMapPrimaryVid, rldot1qPortVlanStaticEgressList2049to3072=rldot1qPortVlanStaticEgressList2049to3072, vlanPrivateEdgeGroupIfIndexID=vlanPrivateEdgeGroupIfIndexID, vlanCustomerPortModeMtvList2049to3072=vlanCustomerPortModeMtvList2049to3072, vlanVoicePortQosMode=vlanVoicePortQosMode, vlanSpecialTagTable=vlanSpecialTagTable, vlanRsvlMapEntry=vlanRsvlMapEntry, vlanPrivateEdgeSupported=vlanPrivateEdgeSupported, vlanVoiceOUIDescription=vlanVoiceOUIDescription, vlanPrivateEdgeGroupIfIndexDomainID=vlanPrivateEdgeGroupIfIndexDomainID, vlanSubnetPortGroupVid=vlanSubnetPortGroupVid, vlanInetTriplePlayMulticatTvEntry=vlanInetTriplePlayMulticatTvEntry, vlanSubnetPortRowStatus=vlanSubnetPortRowStatus, vlanTriplePlayEntry=vlanTriplePlayEntry, vlanDynamicVlanTable=vlanDynamicVlanTable, vlanTrunkModeList1to1024=vlanTrunkModeList1to1024, vlanInetTriplePlayMulticastTvTable=vlanInetTriplePlayMulticastTvTable, vlanMacBaseVlanPortGroupId=vlanMacBaseVlanPortGroupId, vlanSpecialTagEntry=vlanSpecialTagEntry, vlanPrivateEdgeEntry=vlanPrivateEdgeEntry, vlanPrivateCommunityTable=vlanPrivateCommunityTable, vlanPortModeContextEntry=vlanPortModeContextEntry, vlanPrivateEdgeGroupEntry=vlanPrivateEdgeGroupEntry, rldot1qPortVlanStaticUntaggedEgressList1to1024=rldot1qPortVlanStaticUntaggedEgressList1to1024, rldot1qVlanStaticListTable=rldot1qVlanStaticListTable, vlanPrivateEdgeGroupUplink=vlanPrivateEdgeGroupUplink, vlanSpecialTagStatus=vlanSpecialTagStatus, vlanPrivateEdgeGroupIfIndexEntry=vlanPrivateEdgeGroupIfIndexEntry, vlanSubnetRangeAddr=vlanSubnetRangeAddr, vlanMulticastTvEntry=vlanMulticastTvEntry, vlanVoiceTable=vlanVoiceTable, vlanCustomerPortModeMtvList1to1024=vlanCustomerPortModeMtvList1to1024, vlanCustomerPortModeMtvList3073to4094=vlanCustomerPortModeMtvList3073to4094, vlanPrivateEdgeGroupSource=vlanPrivateEdgeGroupSource, vlanMacBaseVlanGroupTable=vlanMacBaseVlanGroupTable, vlanMacBaseVlanMacAddress=vlanMacBaseVlanMacAddress, vlanTrunkModeList2049to3072=vlanTrunkModeList2049to3072, vlanVoiceOUIPrefix=vlanVoiceOUIPrefix, vlanVoiceOUIEntryRowStatus=vlanVoiceOUIEntryRowStatus, vlanPrivateMapStatus=vlanPrivateMapStatus, vlanTrunkModeList3073to4094=vlanTrunkModeList3073to4094, vlanPortModeState=vlanPortModeState, vlanMacBaseVlanGroupEntry=vlanMacBaseVlanGroupEntry, vlanInetTriplePlayInnerVID=vlanInetTriplePlayInnerVID, vlanSwitchPortModeTable=vlanSwitchPortModeTable, rldot1qPortVlanStaticForbiddenList1025to2048=rldot1qPortVlanStaticForbiddenList1025to2048, rldot1qPortVlanStaticEgressList1025to2048=rldot1qPortVlanStaticEgressList1025to2048, vlanMulticastTvTable=vlanMulticastTvTable, PYSNMP_MODULE_ID=vlan, vlanSubnetRangeRowStatus=vlanSubnetRangeRowStatus, rlPortVlanTriplePlayMulticastTvList1025to2048=rlPortVlanTriplePlayMulticastTvList1025to2048, vlanSubnetPortEntry=vlanSubnetPortEntry, vlanPrivateEntry=vlanPrivateEntry, vlanPrivatePrimaryVid=vlanPrivatePrimaryVid, vlanRsvlMapSecondaryVid=vlanRsvlMapSecondaryVid, rldot1qVlanMembershipTypeBitmap=rldot1qVlanMembershipTypeBitmap, vlan=vlan, vlanInetTriplePlayMulticastTvMulticastTvPortList=vlanInetTriplePlayMulticastTvMulticastTvPortList, vlanDynamicVlanMacAddress=vlanDynamicVlanMacAddress, vlanSubnetRangeEntry=vlanSubnetRangeEntry, vlanSubnetRangeMask=vlanSubnetRangeMask, vlanPrivateCommunityStatus=vlanPrivateCommunityStatus, rldot1qVlanStaticNameTable=rldot1qVlanStaticNameTable, vlanMaxTableNumber=vlanMaxTableNumber, vlanPrivateStatus=vlanPrivateStatus, rldot1qPortVlanStaticUntaggedEgressList2049to3072=rldot1qPortVlanStaticUntaggedEgressList2049to3072, rldot1qVlanStaticList2049to3072=rldot1qVlanStaticList2049to3072, vlanSpecialTagCurrentActive=vlanSpecialTagCurrentActive, vlanTriplePlayMulticastTvMulticastTvVID=vlanTriplePlayMulticastTvMulticastTvVID, vlanAsymmetricEnabled=vlanAsymmetricEnabled, vlanTrunkPortModeEntry=vlanTrunkPortModeEntry, vlanAccessPortModeMcstTvVlanId=vlanAccessPortModeMcstTvVlanId, rldot1qPortVlanStaticEgressList1to1024=rldot1qPortVlanStaticEgressList1to1024, vlanVoicePriorityRemark=vlanVoicePriorityRemark, vlanPrivateMapEntry=vlanPrivateMapEntry, vlanInetTriplePlayInetAddressType=vlanInetTriplePlayInetAddressType, vlanNameIfIndex=vlanNameIfIndex, vlanSpecialTagVID=vlanSpecialTagVID, vlanPortModeExtState=vlanPortModeExtState, vlanVoicePortTable=vlanVoicePortTable, vlanInetTriplePlayMulticastTvMulticastTvVID=vlanInetTriplePlayMulticastTvMulticastTvVID, vlanTriplePlayMulticastTvVID=vlanTriplePlayMulticastTvVID, rldot1qPortVlanStaticTable=rldot1qPortVlanStaticTable, rldot1qVlanStaticListIndex=rldot1qVlanStaticListIndex, vlanPrivateEdgeGroupTable=vlanPrivateEdgeGroupTable, vlanMacBaseVlanPortEntry=vlanMacBaseVlanPortEntry, vlanTriplePlayRowStatus=vlanTriplePlayRowStatus, vlanDot1vSupported=vlanDot1vSupported, vlanPrivateVid=vlanPrivateVid, vlanAccessPortModeTable=vlanAccessPortModeTable, vlanDynamicVlanSupported=vlanDynamicVlanSupported, vlanDefaultExtManagment=vlanDefaultExtManagment, rlPortVlanTriplePlayMulticastTvList3073to4094=rlPortVlanTriplePlayMulticastTvList3073to4094, rlPortVlanTriplePlayMulticastTvList1to1024=rlPortVlanTriplePlayMulticastTvList1to1024, vlanDynamicVlanTag=vlanDynamicVlanTag, rldot1qVlanMembershipTypeEntry=rldot1qVlanMembershipTypeEntry, vlanMacBaseVlanPortRowStatus=vlanMacBaseVlanPortRowStatus, vlanPrivateMapPrimaryVid=vlanPrivateMapPrimaryVid, vlanAccessPortModeEntry=vlanAccessPortModeEntry, vlanSubnetRangeGroupId=vlanSubnetRangeGroupId, vlanSpecialTagCurrentTable=vlanSpecialTagCurrentTable, vlanPrivateEdgeVersion=vlanPrivateEdgeVersion, rldot1qPortVlanStaticForbiddenList1to1024=rldot1qPortVlanStaticForbiddenList1to1024, vlanTriplePlayInnerVID=vlanTriplePlayInnerVID, vlanRsvlMapStatus=vlanRsvlMapStatus, vlanNameEntry=vlanNameEntry, rldot1qVlanMembershipTypeTable=rldot1qVlanMembershipTypeTable, vlanPortModeEntry=vlanPortModeEntry, vlanMacBaseVlanGroupRowStatus=vlanMacBaseVlanGroupRowStatus, vlanVoicePortCurrentMembership=vlanVoicePortCurrentMembership, vlanSubnetPortTable=vlanSubnetPortTable, vlanMacBaseVlanGroupId=vlanMacBaseVlanGroupId, vlanNameName=vlanNameName, vlanPrivateEdgeTable=vlanPrivateEdgeTable, vlanPrivateMapPrimaryPorts=vlanPrivateMapPrimaryPorts, vlanCustomerPortModeTable=vlanCustomerPortModeTable, rldot1qVlanStaticList3073to4094=rldot1qVlanStaticList3073to4094, vlanVoiceOUITable=vlanVoiceOUITable, vlanDynamicVlanEntry=vlanDynamicVlanEntry, vlanVoiceEntry=vlanVoiceEntry, vlanVoiceRowStatus=vlanVoiceRowStatus, vlanPrivateMapTable=vlanPrivateMapTable, vlanVoicePriority=vlanVoicePriority, vlanPortModeExtStatus=vlanPortModeExtStatus, vlanDefaultTaggedPorts=vlanDefaultTaggedPorts, rldot1qVlanStaticList1025to2048=rldot1qVlanStaticList1025to2048, vlanSpecialTagCurrentEntry=vlanSpecialTagCurrentEntry, vlanMacBaseVlanMacMask=vlanMacBaseVlanMacMask, vlanMulticastTvStatus=vlanMulticastTvStatus, vlanVoicePortEntry=vlanVoicePortEntry, vlanCustomerPortModeMtvList1025to2048=vlanCustomerPortModeMtvList1025to2048, rlPortVlanTriplePlayMulticastTvList2049to3072=rlPortVlanTriplePlayMulticastTvList2049to3072, rldot1qVlanStaticList1to1024=rldot1qVlanStaticList1to1024, vlanPrivateEntryOld=vlanPrivateEntryOld, vlanPortModeContextTable=vlanPortModeContextTable, rldot1qPortVlanStaticUntaggedEgressList1025to2048=rldot1qPortVlanStaticUntaggedEgressList1025to2048, vlanVoiceOUIEntry=vlanVoiceOUIEntry, rldot1qVlanStaticListEntry=rldot1qVlanStaticListEntry, vlanInetTriplePlayEntry=vlanInetTriplePlayEntry, rldot1qPortVlanStaticForbiddenList2049to3072=rldot1qPortVlanStaticForbiddenList2049to3072, rlPortVlanTriplePlayMulticastTvEntry=rlPortVlanTriplePlayMulticastTvEntry, vlanDynamicVlanStatus=vlanDynamicVlanStatus, vlanTrunkModeList1025to2048=vlanTrunkModeList1025to2048, vlanAccessPortModeVlanId=vlanAccessPortModeVlanId, rldot1qPortVlanStaticForbiddenList3073to4094=rldot1qPortVlanStaticForbiddenList3073to4094, vlanMacBaseVlanPortGroupVid=vlanMacBaseVlanPortGroupVid, vlanVoiceOUISetToDefault=vlanVoiceOUISetToDefault, vlanDefaultEnabledPorts=vlanDefaultEnabledPorts, rlPortVlanTriplePlayMulticastTvTable=rlPortVlanTriplePlayMulticastTvTable, vlanCustomerPortModeVlanId=vlanCustomerPortModeVlanId, vlanVoicePortVlanIndex=vlanVoicePortVlanIndex, vlanTriplePlayTable=vlanTriplePlayTable, vlanVoicePortSecure=vlanVoicePortSecure, vlanInetTriplePlayMulticastTvVID=vlanInetTriplePlayMulticastTvVID, vlanNameTag=vlanNameTag, vlanPrivateEdgeGroupStatus=vlanPrivateEdgeGroupStatus, vlanCustomerPortModeEntry=vlanCustomerPortModeEntry, vlanTriplePlayMulticastTvTable=vlanTriplePlayMulticastTvTable, vlanPrivateEdgeUplink=vlanPrivateEdgeUplink, vlanPrivateEdgeStatus=vlanPrivateEdgeStatus, vlanPrivateCommunityVlanTag=vlanPrivateCommunityVlanTag, vlanSpecialTagCurrentVID=vlanSpecialTagCurrentVID, vlanPrivateEdgeGroupIfIndexTable=vlanPrivateEdgeGroupIfIndexTable, vlanVoice=vlanVoice, vlanTrunkPortModeTable=vlanTrunkPortModeTable, vlanPrivateSupported=vlanPrivateSupported, vlanInetTriplePlayTable=vlanInetTriplePlayTable, vlanSwitchPortModeEntry=vlanSwitchPortModeEntry, vlanDefaultSupported=vlanDefaultSupported, vlanPortModeExtTable=vlanPortModeExtTable, vlanMulticastTvVID=vlanMulticastTvVID, vlanPrivateOldIsolatedVlanTag=vlanPrivateOldIsolatedVlanTag, vlanRsvlMapTable=vlanRsvlMapTable, vlanInetTriplePlayRowStatus=vlanInetTriplePlayRowStatus, vlanPrivateCommunityEntry=vlanPrivateCommunityEntry, vlanPrivateTable=vlanPrivateTable, vlanSwitchPortModeCategory=vlanSwitchPortModeCategory, rldot1qVlanStaticNameEntry=rldot1qVlanStaticNameEntry, vlanTriplePlayMulticastTvMulticastTvPortList=vlanTriplePlayMulticastTvMulticastTvPortList, vlanPortModeContextValue=vlanPortModeContextValue, rldot1qPortVlanStaticUntaggedEgressList3073to4094=rldot1qPortVlanStaticUntaggedEgressList3073to4094, vlanPortModeExtEntry=vlanPortModeExtEntry, vlanRsvlEnable=vlanRsvlEnable, vlanSubnetPortGroupId=vlanSubnetPortGroupId, vlanDefaultEnabled=vlanDefaultEnabled, rldot1qVlanStaticName=rldot1qVlanStaticName, vlanVoicePortEnable=vlanVoicePortEnable)
