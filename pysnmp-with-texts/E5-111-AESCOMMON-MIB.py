...
MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, NotificationType, Bits, Unsigned32, Gauge32, Counter32, iso, ModuleIdentity, MibIdentifier, Counter64, ObjectIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "NotificationType", "Bits", "Unsigned32", "Gauge32", "Counter32", "iso", "ModuleIdentity", "MibIdentifier", "Counter64", "ObjectIdentity", "TimeTicks")
...
mibBuilder.exportSymbols("E5-111-AESCOMMON-MIB", aesLineDiagPsCCFLirl1=aesLineDiagPsCCFLirl1, aesAturNumOfSubcarriersPerPort=aesAturNumOfSubcarriersPerPort, aesLineDiagPsCCFLog2=aesLineDiagPsCCFLog2, aesMaxNumOfProfiles=aesMaxNumOfProfiles, aesLineStatusAdslMode=aesLineStatusAdslMode, aesLineConfRateMode=aesLineConfRateMode, aesAturLineDiagLATN=aesAturLineDiagLATN, seltOps=seltOps, aesLineDiagPsCCFLog1=aesLineDiagPsCCFLog1, aesLineDiagPsQLN=aesLineDiagPsQLN, aesAtucLineDiagSATN=aesAtucLineDiagSATN, aesAtucLineDiagSNRM=aesAtucLineDiagSNRM, aesLineDiagPsCCFLirl2=aesLineDiagPsCCFLirl2, aesAtucNumOfSubcarriersPerPort=aesAtucNumOfSubcarriersPerPort, aesMaxNumOfAlarmProfiles=aesMaxNumOfAlarmProfiles, seltCableType=seltCableType, aesBitLoadingAtucNumOfCarriers=aesBitLoadingAtucNumOfCarriers, aesLineConfAdslMode=aesLineConfAdslMode, aesLineDiagOps=aesLineDiagOps, seltStatus=seltStatus, aesAtucLineDiagLATN=aesAtucLineDiagLATN, aesAtucLineDiagACTATP=aesAtucLineDiagACTATP, aesLineDiagPs=aesLineDiagPs, aesAturLineDiagACTATP=aesAturLineDiagACTATP, aesLineConfAnnexM=aesLineConfAnnexM, aesLineDiagTarget=aesLineDiagTarget, aesAtucLineDiagATTNDR=aesAtucLineDiagATTNDR, aesLineDiagPsCCFLiim2=aesLineDiagPsCCFLiim2, aesLineDiagPsSNR=aesLineDiagPsSNR, aesLineConfVpi=aesLineConfVpi, aesLineConfAnnexL=aesLineConfAnnexL, aesLineConfTable=aesLineConfTable, aesAturLineDiagSNRM=aesAturLineDiagSNRM, aesLineConfEncap=aesLineConfEncap, aesBitLoadingTable=aesBitLoadingTable, seltTarget=seltTarget, aesBitLoadingAturNumOfCarriers=aesBitLoadingAturNumOfCarriers, aesAturLineDiagATTNDR=aesAturLineDiagATTNDR, seltLoopEstimateLengthMeter=seltLoopEstimateLengthMeter, aesAturLineDiagSATN=aesAturLineDiagSATN, aesLineDiagFailReason=aesLineDiagFailReason, aesLineStatusTable=aesLineStatusTable, seltLoopEstimateLengthFt=seltLoopEstimateLengthFt, aesLineConfVci=aesLineConfVci, aesLineConfEntry=aesLineConfEntry, aesLineConfPmMode=aesLineConfPmMode, selt=selt, aesBitLoadingEntry=aesBitLoadingEntry, aesLineStatusEntry=aesLineStatusEntry, aesLineDiagnostic=aesLineDiagnostic, aesLineDiagPsCCFLiim1=aesLineDiagPsCCFLiim1, aesBitLoadingBits=aesBitLoadingBits)
