...
# Produced by pysmi-0.3.4 at Wed May  1 13:20:07 2019
...
Unsigned32, Integer32, TimeTicks, Counter32, Counter64, NotificationType, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, ModuleIdentity, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Integer32", "TimeTicks", "Counter32", "Counter64", "NotificationType", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "ModuleIdentity", "IpAddress", "Gauge32")
MacAddress, TruthValue, RowStatus, DisplayString, PhysAddress, StorageType, RowPointer, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "MacAddress", "TruthValue", "RowStatus", "DisplayString", "PhysAddress", "StorageType", "RowPointer", "TextualConvention")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: gsm7312QOSDiffServPrivate.setRevisionsDescriptions(('Initial revision.',))
...
if mibBuilder.loadTexts: gsm7312QOSDiffServPrivate.setContactInfo('')
if mibBuilder.loadTexts: gsm7312QOSDiffServPrivate.setDescription('')
...
mibBuilder.exportSymbols("GSM7312-QOS-DIFFSERV-PRIVATE-MIB", agentDiffServPolicyAttrStmtPoliceTworatePburst=agentDiffServPolicyAttrStmtPoliceTworatePburst, agentDiffServPolicyPerfOutTailDroppedOctets=agentDiffServPolicyPerfOutTailDroppedOctets, agentDiffServPolicyAttrStorageType=agentDiffServPolicyAttrStorageType, agentDiffServClassGroup=agentDiffServClassGroup, agentDiffServPolicyPerfOutEntry=agentDiffServPolicyPerfOutEntry, agentDiffServPolicyPerfOutHCShapeDelayedPackets=agentDiffServPolicyPerfOutHCShapeDelayedPackets, agentDiffServPolicyPerfOutTailDroppedPackets=agentDiffServPolicyPerfOutTailDroppedPackets, agentDiffServPolicyAttrStmtPoliceSimpleCburst=agentDiffServPolicyAttrStmtPoliceSimpleCburst, agentDiffServServicePerfSentPackets=agentDiffServServicePerfSentPackets, agentDiffServPolicyAttrRowStatus=agentDiffServPolicyAttrRowStatus, gsm7312QOSDiffServPrivate=gsm7312QOSDiffServPrivate, agentDiffServPolicyPerfOutShapeDelayedOctets=agentDiffServPolicyPerfOutShapeDelayedOctets, agentDiffServPolicyPerfInEntry=agentDiffServPolicyPerfInEntry, agentDiffServServicePerfHCDiscardedOctets=agentDiffServServicePerfHCDiscardedOctets, agentDiffServGenStatusClassTableMax=agentDiffServGenStatusClassTableMax, agentDiffServPolicyAttrTable=agentDiffServPolicyAttrTable, agentDiffServClassRuleEntry=agentDiffServClassRuleEntry, agentDiffServPolicyPerfInHCOfferedOctets=agentDiffServPolicyPerfInHCOfferedOctets, agentDiffServClassIndex=agentDiffServClassIndex, agentDiffServPolicyPerfInStorageType=agentDiffServPolicyPerfInStorageType, agentDiffServPolicyAttrStmtMarkCosVal=agentDiffServPolicyAttrStmtMarkCosVal, agentDiffServServiceIfIndex=agentDiffServServiceIfIndex, agentDiffServServicePerfEntry=agentDiffServServicePerfEntry, agentDiffServClassRuleMatchEntryType=agentDiffServClassRuleMatchEntryType, agentDiffServServicePerfDiscardedPackets=agentDiffServServicePerfDiscardedPackets, agentDiffServPolicyAttrStmtEntryType=agentDiffServPolicyAttrStmtEntryType, agentDiffServServicePolicyIndex=agentDiffServServicePolicyIndex, agentDiffServClassEntry=agentDiffServClassEntry, agentDiffServPolicyInstEntry=agentDiffServPolicyInstEntry, agentDiffServGenStatusPolicyTableSize=agentDiffServGenStatusPolicyTableSize, agentDiffServGenStatusGroup=agentDiffServGenStatusGroup, agentDiffServPolicyAttrStmtRandomdropMaxDropProb=agentDiffServPolicyAttrStmtRandomdropMaxDropProb, agentDiffServPolicyAttrStmtPoliceTworateCburst=agentDiffServPolicyAttrStmtPoliceTworateCburst, agentDiffServPolicyPerfInRowStatus=agentDiffServPolicyPerfInRowStatus, agentDiffServPolicyInstIndexNextFree=agentDiffServPolicyInstIndexNextFree, agentDiffServPolicyInstRowStatus=agentDiffServPolicyInstRowStatus, agentDiffServPolicyPerfOutHCShapeDelayedOctets=agentDiffServPolicyPerfOutHCShapeDelayedOctets, agentDiffServPolicyPerfOutTable=agentDiffServPolicyPerfOutTable, agentDiffServPolicyInstTable=agentDiffServPolicyInstTable, agentDiffServPolicyPerfOutRowStatus=agentDiffServPolicyPerfOutRowStatus, agentDiffServPolicyIndexNextFree=agentDiffServPolicyIndexNextFree, agentDiffServClassRowStatus=agentDiffServClassRowStatus, agentDiffServPolicyPerfInTable=agentDiffServPolicyPerfInTable, agentDiffServPolicyAttrEntry=agentDiffServPolicyAttrEntry, agentDiffServPolicyAttrStmtPoliceSimpleCrate=agentDiffServPolicyAttrStmtPoliceSimpleCrate, agentDiffServClassTable=agentDiffServClassTable, agentDiffServPolicyPerfOutHCTailDroppedOctets=agentDiffServPolicyPerfOutHCTailDroppedOctets, agentDiffServPolicyAttrStmtPoliceConformAct=agentDiffServPolicyAttrStmtPoliceConformAct, agentDiffServClassStorageType=agentDiffServClassStorageType, agentDiffServClassRuleMatchSrcIpMask=agentDiffServClassRuleMatchSrcIpMask, agentDiffServClassIndexNextFree=agentDiffServClassIndexNextFree, agentDiffServPolicyInstClassIndex=agentDiffServPolicyInstClassIndex, QosBurstSize=QosBurstSize, PYSNMP_MODULE_ID=gsm7312QOSDiffServPrivate, agentDiffServClassRuleMatchIpTosMask=agentDiffServClassRuleMatchIpTosMask, agentDiffServPolicyAttrStmtShapeAverageCrate=agentDiffServPolicyAttrStmtShapeAverageCrate, agentDiffServServicePerfSentOctets=agentDiffServServicePerfSentOctets, agentDiffServServicePerfDiscardedOctets=agentDiffServServicePerfDiscardedOctets, agentDiffServClassRuleIndex=agentDiffServClassRuleIndex, agentDiffServPolicyPerfOutHCTailDroppedPackets=agentDiffServPolicyPerfOutHCTailDroppedPackets, agentDiffServPolicyAttrStmtRandomdropMaxThresh=agentDiffServPolicyAttrStmtRandomdropMaxThresh, agentDiffServServicePerfHCSentOctets=agentDiffServServicePerfHCSentOctets, agentDiffServPolicyInstStorageType=agentDiffServPolicyInstStorageType, agentDiffServClassRuleMatchSrcL4PortStart=agentDiffServClassRuleMatchSrcL4PortStart, agentDiffServClassRuleMatchSrcMacAddr=agentDiffServClassRuleMatchSrcMacAddr, agentDiffServPolicyEntry=agentDiffServPolicyEntry, agentDiffServPolicyAttrStmtPoliceNonconformAct=agentDiffServPolicyAttrStmtPoliceNonconformAct, agentDiffServClassRuleMatchIpDscp=agentDiffServClassRuleMatchIpDscp, agentDiffServPolicyPerfOutRandomDroppedOctets=agentDiffServPolicyPerfOutRandomDroppedOctets, agentDiffServServiceEntry=agentDiffServServiceEntry, agentDiffServServiceGroup=agentDiffServServiceGroup, agentDiffServPolicyPerfOutShapeDelayedPackets=agentDiffServPolicyPerfOutShapeDelayedPackets, agentDiffServGenStatusPolicyAttrTableMax=agentDiffServGenStatusPolicyAttrTableMax, agentDiffServGenStatusPolicyInstTableMax=agentDiffServGenStatusPolicyInstTableMax, agentDiffServClassAclNum=agentDiffServClassAclNum, agentDiffServPolicyStorageType=agentDiffServPolicyStorageType, agentDiffServPolicyPerfInOfferedOctets=agentDiffServPolicyPerfInOfferedOctets, agentDiffServClassRuleMatchDstMacMask=agentDiffServClassRuleMatchDstMacMask, agentDiffServClassRuleMatchSrcIpAddr=agentDiffServClassRuleMatchSrcIpAddr, agentDiffServPolicyAttrStmtPoliceSinglerateCrate=agentDiffServPolicyAttrStmtPoliceSinglerateCrate, agentDiffServClassRuleMatchDstIpMask=agentDiffServClassRuleMatchDstIpMask, agentDiffServPolicyAttrStmtPoliceSinglerateEburst=agentDiffServPolicyAttrStmtPoliceSinglerateEburst, agentDiffServPolicyTable=agentDiffServPolicyTable, agentDiffServClassRuleMatchIpPrecedence=agentDiffServClassRuleMatchIpPrecedence, agentDiffServClassRuleMatchDstL4PortEnd=agentDiffServClassRuleMatchDstL4PortEnd, agentDiffServPolicyAttrStmtExpediteCrate=agentDiffServPolicyAttrStmtExpediteCrate, agentDiffServPolicyIndex=agentDiffServPolicyIndex, agentDiffServClassRuleMatchProtocolNum=agentDiffServClassRuleMatchProtocolNum, agentDiffServPolicyAttrStmtMarkIpPrecedenceVal=agentDiffServPolicyAttrStmtMarkIpPrecedenceVal, agentDiffServServicePerfHCOfferedOctets=agentDiffServServicePerfHCOfferedOctets, agentDiffServServicePerfHCOfferedPackets=agentDiffServServicePerfHCOfferedPackets, agentDiffServPolicyAttrIndex=agentDiffServPolicyAttrIndex, agentDiffServPolicyInstAttrIndexNextFree=agentDiffServPolicyInstAttrIndexNextFree, agentDiffServClassRuleIndexNextFree=agentDiffServClassRuleIndexNextFree, agentDiffServPolicyAttrStmtExpediteCburst=agentDiffServPolicyAttrStmtExpediteCburst, agentDiffServClassRuleMatchRefClassIndex=agentDiffServClassRuleMatchRefClassIndex, agentDiffServServiceTable=agentDiffServServiceTable, agentDiffServPolicyType=agentDiffServPolicyType, agentDiffServGenStatusPolicyAttrTableSize=agentDiffServGenStatusPolicyAttrTableSize, agentDiffServPolicyAttrStmtRandomdropDecayExponent=agentDiffServPolicyAttrStmtRandomdropDecayExponent, agentDiffServPolicyPerfInHCOfferedPackets=agentDiffServPolicyPerfInHCOfferedPackets, agentDiffServPolicyAttrStmtPoliceTworateCrate=agentDiffServPolicyAttrStmtPoliceTworateCrate, IntfDirection=IntfDirection, agentDiffServPolicyAttrStmtExpediteCrateUnits=agentDiffServPolicyAttrStmtExpediteCrateUnits, agentDiffServPolicyAttrStmtPoliceConformVal=agentDiffServPolicyAttrStmtPoliceConformVal, agentDiffServServiceIfOperStatus=agentDiffServServiceIfOperStatus, agentDiffServServicePerfOfferedPackets=agentDiffServServicePerfOfferedPackets, agentDiffServPolicyAttrStmtShapePeakPrate=agentDiffServPolicyAttrStmtShapePeakPrate, agentDiffServPolicyAttrStmtPoliceNonconformVal=agentDiffServPolicyAttrStmtPoliceNonconformVal, agentDiffServClassRuleMatchDstIpAddr=agentDiffServClassRuleMatchDstIpAddr, agentDiffServServicePerfTable=agentDiffServServicePerfTable, agentDiffServClassRuleMatchDstL4PortStart=agentDiffServClassRuleMatchDstL4PortStart, agentDiffServPolicyAttrStmtRandomdropSamplingRate=agentDiffServPolicyAttrStmtRandomdropSamplingRate, agentDiffServGenStatusClassRuleTableMax=agentDiffServGenStatusClassRuleTableMax, agentDiffServGenStatusClassRuleTableSize=agentDiffServGenStatusClassRuleTableSize, agentDiffServPolicyPerfInOfferedPackets=agentDiffServPolicyPerfInOfferedPackets, agentDiffServPolicyRowStatus=agentDiffServPolicyRowStatus, agentDiffServGenStatusServiceTableMax=agentDiffServGenStatusServiceTableMax, agentDiffServGenStatusAdminMode=agentDiffServGenStatusAdminMode, agentDiffServServicePerfOfferedOctets=agentDiffServServicePerfOfferedOctets, agentDiffServClassRuleMatchSrcL4PortEnd=agentDiffServClassRuleMatchSrcL4PortEnd, agentDiffServPolicyPerfInHCDiscardedPackets=agentDiffServPolicyPerfInHCDiscardedPackets, agentDiffServClassRuleMatchIpTosBits=agentDiffServClassRuleMatchIpTosBits, agentDiffServServiceIfDirection=agentDiffServServiceIfDirection, agentDiffServServicePerfHCDiscardedPackets=agentDiffServServicePerfHCDiscardedPackets, agentDiffServPolicyAttrStmtPoliceTworatePrate=agentDiffServPolicyAttrStmtPoliceTworatePrate, agentDiffServClassRuleMatchCos=agentDiffServClassRuleMatchCos, agentDiffServClassRuleStorageType=agentDiffServClassRuleStorageType, agentDiffServPolicyPerfOutHCSentPackets=agentDiffServPolicyPerfOutHCSentPackets, agentDiffServClassRuleMatchSrcMacMask=agentDiffServClassRuleMatchSrcMacMask, agentDiffServGenStatusClassTableSize=agentDiffServGenStatusClassTableSize, agentDiffServPolicyAttrStmtMarkIpDscpVal=agentDiffServPolicyAttrStmtMarkIpDscpVal, agentDiffServPolicyPerfOutHCSentOctets=agentDiffServPolicyPerfOutHCSentOctets, agentDiffServClassRuleMatchVlanId=agentDiffServClassRuleMatchVlanId, agentDiffServPolicyPerfOutRandomDroppedPackets=agentDiffServPolicyPerfOutRandomDroppedPackets, agentDiffServPolicyPerfInDiscardedPackets=agentDiffServPolicyPerfInDiscardedPackets, agentDiffServPolicyInstIndex=agentDiffServPolicyInstIndex, agentDiffServPolicyName=agentDiffServPolicyName, agentDiffServPolicyAttrStmtRandomdropMinThresh=agentDiffServPolicyAttrStmtRandomdropMinThresh, agentDiffServPolicyAttrStmtShapePeakCrate=agentDiffServPolicyAttrStmtShapePeakCrate, agentDiffServPolicyAttrStmtBandwidthCrate=agentDiffServPolicyAttrStmtBandwidthCrate, agentDiffServPolicyPerfOutStorageType=agentDiffServPolicyPerfOutStorageType, agentDiffServServiceStorageType=agentDiffServServiceStorageType, agentDiffServClassName=agentDiffServClassName, agentDiffServClassRuleRowStatus=agentDiffServClassRuleRowStatus, agentDiffServPolicyPerfOutHCRandomDroppedOctets=agentDiffServPolicyPerfOutHCRandomDroppedOctets, agentDiffServClassRuleMatchExcludeFlag=agentDiffServClassRuleMatchExcludeFlag, agentDiffServPolicyPerfInDiscardedOctets=agentDiffServPolicyPerfInDiscardedOctets, agentDiffServPolicyGroup=agentDiffServPolicyGroup, agentDiffServClassRuleTable=agentDiffServClassRuleTable, agentDiffServClassRuleMatchEvery=agentDiffServClassRuleMatchEvery, agentDiffServGenStatusPolicyInstTableSize=agentDiffServGenStatusPolicyInstTableSize, agentDiffServServicePerfHCSentPackets=agentDiffServServicePerfHCSentPackets, agentDiffServPolicyAttrStmtPoliceExceedAct=agentDiffServPolicyAttrStmtPoliceExceedAct, agentDiffServClassType=agentDiffServClassType, agentDiffServPolicyAttrStmtPoliceExceedVal=agentDiffServPolicyAttrStmtPoliceExceedVal, agentDiffServPolicyAttrStmtPoliceSinglerateCburst=agentDiffServPolicyAttrStmtPoliceSinglerateCburst, agentDiffServClassRuleMatchDstMacAddr=agentDiffServClassRuleMatchDstMacAddr, agentDiffServGenStatusServiceTableSize=agentDiffServGenStatusServiceTableSize, agentDiffServPolicyAttrStmtBandwidthCrateUnits=agentDiffServPolicyAttrStmtBandwidthCrateUnits, agentDiffServPolicyPerfOutHCRandomDroppedPackets=agentDiffServPolicyPerfOutHCRandomDroppedPackets, agentDiffServPolicyPerfOutSentPackets=agentDiffServPolicyPerfOutSentPackets, agentDiffServServiceRowStatus=agentDiffServServiceRowStatus, agentDiffServPolicyPerfOutSentOctets=agentDiffServPolicyPerfOutSentOctets, agentDiffServGenStatusPolicyTableMax=agentDiffServGenStatusPolicyTableMax, agentDiffServPolicyPerfInHCDiscardedOctets=agentDiffServPolicyPerfInHCDiscardedOctets)
