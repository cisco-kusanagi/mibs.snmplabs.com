...
# Produced by pysmi-0.3.4 at Wed May  1 14:56:16 2019
...
ObjectIdentity, Unsigned32, ModuleIdentity, MibIdentifier, NotificationType, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, Bits, mgmt, TimeTicks, Counter32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "MibIdentifier", "NotificationType", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "Bits", "mgmt", "TimeTicks", "Counter32", "Integer32")
...
mibBuilder.exportSymbols("RFC1066-MIB", tcpOutSegs=tcpOutSegs, ipAddrEntry=ipAddrEntry, tcpConnRemAddress=tcpConnRemAddress, icmpInTimestampReps=icmpInTimestampReps, ifOutOctets=ifOutOctets, tcpRetransSegs=tcpRetransSegs, icmpOutMsgs=icmpOutMsgs, tcpAttemptFails=tcpAttemptFails, ipInHdrErrors=ipInHdrErrors, ifOutQLen=ifOutQLen, tcpActiveOpens=tcpActiveOpens, mib=mib, ifPhysAddress=ifPhysAddress, ifOperStatus=ifOperStatus, ipForwarding=ipForwarding, icmpOutDestUnreachs=icmpOutDestUnreachs, ifSpeed=ifSpeed, sysUpTime=sysUpTime, icmpInTimestamps=icmpInTimestamps, tcpConnRemPort=tcpConnRemPort, atPhysAddress=atPhysAddress, ipReasmFails=ipReasmFails, ipReasmOKs=ipReasmOKs, ifNumber=ifNumber, egpNeighTable=egpNeighTable, ipRouteDest=ipRouteDest, ipOutRequests=ipOutRequests, ipReasmReqds=ipReasmReqds, ifTable=ifTable, udpNoPorts=udpNoPorts, ipRouteAge=ipRouteAge, ifLastChange=ifLastChange, egpOutErrors=egpOutErrors, egpOutMsgs=egpOutMsgs, atNetAddress=atNetAddress, icmpInAddrMasks=icmpInAddrMasks, ipRouteEntry=ipRouteEntry, atTable=atTable, ipRouteMetric3=ipRouteMetric3, icmpOutTimestamps=icmpOutTimestamps, ifInUcastPkts=ifInUcastPkts, icmpInEchos=icmpInEchos, ipOutNoRoutes=ipOutNoRoutes, icmpInSrcQuenchs=icmpInSrcQuenchs, sysDescr=sysDescr, ipAdEntIfIndex=ipAdEntIfIndex, tcpRtoAlgorithm=tcpRtoAlgorithm, egpInErrors=egpInErrors, icmpOutAddrMaskReps=icmpOutAddrMaskReps, tcpInSegs=tcpInSegs, interfaces=interfaces, tcpPassiveOpens=tcpPassiveOpens, ifInDiscards=ifInDiscards, ifIndex=ifIndex, atEntry=atEntry, ifInErrors=ifInErrors, ipInDiscards=ipInDiscards, icmpOutErrors=icmpOutErrors, tcp=tcp, tcpConnTable=tcpConnTable, icmpOutTimestampReps=icmpOutTimestampReps, atIfIndex=atIfIndex, ipReasmTimeout=ipReasmTimeout, ifInNUcastPkts=ifInNUcastPkts, ipFragFails=ipFragFails, icmpInErrors=icmpInErrors, ipInAddrErrors=ipInAddrErrors, ipFragCreates=ipFragCreates, icmpOutSrcQuenchs=icmpOutSrcQuenchs, ifMtu=ifMtu, icmpOutParmProbs=icmpOutParmProbs, tcpConnState=tcpConnState, ifOutDiscards=ifOutDiscards, ifInOctets=ifInOctets, ipFragOKs=ipFragOKs, ipRouteIfIndex=ipRouteIfIndex, icmpOutTimeExcds=icmpOutTimeExcds, tcpEstabResets=tcpEstabResets, tcpConnLocalPort=tcpConnLocalPort, icmpInMsgs=icmpInMsgs, udpInDatagrams=udpInDatagrams, ipAddrTable=ipAddrTable, ip=ip, icmpInAddrMaskReps=icmpInAddrMaskReps, ifType=ifType, system=system, icmpInRedirects=icmpInRedirects, tcpMaxConn=tcpMaxConn, ipRouteNextHop=ipRouteNextHop, ipInDelivers=ipInDelivers, ipOutDiscards=ipOutDiscards, ifOutErrors=ifOutErrors, ifInUnknownProtos=ifInUnknownProtos, ipDefaultTTL=ipDefaultTTL, ifAdminStatus=ifAdminStatus, icmpInEchoReps=icmpInEchoReps, icmpOutEchos=icmpOutEchos, icmpOutAddrMasks=icmpOutAddrMasks, udpOutDatagrams=udpOutDatagrams, tcpRtoMax=tcpRtoMax, ipRouteMetric1=ipRouteMetric1, icmpOutRedirects=icmpOutRedirects, icmpOutEchoReps=icmpOutEchoReps, tcpConnLocalAddress=tcpConnLocalAddress, ipRouteMetric2=ipRouteMetric2, tcpConnEntry=tcpConnEntry, tcpCurrEstab=tcpCurrEstab, ifOutUcastPkts=ifOutUcastPkts, ipAdEntNetMask=ipAdEntNetMask, ipRouteType=ipRouteType, icmp=icmp, egpNeighAddr=egpNeighAddr, ifDescr=ifDescr, ipRouteMetric4=ipRouteMetric4, tcpRtoMin=tcpRtoMin, udp=udp, ipRoutingTable=ipRoutingTable, ifEntry=ifEntry, ipRouteProto=ipRouteProto, icmpInTimeExcds=icmpInTimeExcds, sysObjectID=sysObjectID, ipAdEntBcastAddr=ipAdEntBcastAddr, ipInUnknownProtos=ipInUnknownProtos, at=at, icmpInParmProbs=icmpInParmProbs, ipInReceives=ipInReceives, icmpInDestUnreachs=icmpInDestUnreachs, ipAdEntAddr=ipAdEntAddr, udpInErrors=udpInErrors, egpInMsgs=egpInMsgs, egpNeighEntry=egpNeighEntry, ipForwDatagrams=ipForwDatagrams, egpNeighState=egpNeighState, ifOutNUcastPkts=ifOutNUcastPkts, egp=egp)
