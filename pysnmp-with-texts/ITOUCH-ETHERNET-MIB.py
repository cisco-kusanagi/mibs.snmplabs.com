...
# Produced by pysmi-0.3.4 at Wed May  1 13:57:50 2019
...
NotificationType, Counter32, Unsigned32, Bits, TimeTicks, ModuleIdentity, MibIdentifier, IpAddress, ObjectIdentity, Gauge32, Integer32, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter32", "Unsigned32", "Bits", "TimeTicks", "ModuleIdentity", "MibIdentifier", "IpAddress", "ObjectIdentity", "Gauge32", "Integer32", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
mibBuilder.exportSymbols("ITOUCH-ETHERNET-MIB", etherXTxEntry=etherXTxEntry, etherFCSErrors=etherFCSErrors, etherMulticastBytesIn=etherMulticastBytesIn, etherMulticastTable=etherMulticastTable, etherXTxExcessiveCollisions=etherXTxExcessiveCollisions, etherTxMultipleCollisionFrames=etherTxMultipleCollisionFrames, etherEntry=etherEntry, etherTxSingleCollisionFrames=etherTxSingleCollisionFrames, etherXTxTable=etherXTxTable, etherTxTable=etherTxTable, etherAlignmentErrors=etherAlignmentErrors, etherTxEntry=etherTxEntry, etherMulticastBytesOut=etherMulticastBytesOut, xEthernet=xEthernet, etherTxIndex=etherTxIndex, etherMulticastIndex=etherMulticastIndex, etherXTxIndex=etherXTxIndex, etherMulticastEntry=etherMulticastEntry, etherTable=etherTable, etherIndex=etherIndex)
