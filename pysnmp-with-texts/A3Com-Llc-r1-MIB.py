...
# Produced by pysmi-0.3.4 at Wed May  1 11:09:13 2019
...
Gauge32, enterprises, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, iso, NotificationType, TimeTicks, Bits, ModuleIdentity, Counter64, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "enterprises", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "iso", "NotificationType", "TimeTicks", "Bits", "ModuleIdentity", "Counter64", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("A3Com-Llc-r1-MIB", llcPortOperLastModifyTime=llcPortOperLastModifyTime, llcPortAdminAckTimer=llcPortAdminAckTimer, llcPortAdminMaxUnackedIPDUsRcv=llcPortAdminMaxUnackedIPDUsRcv, llcCcStatsIOctetsOut=llcCcStatsIOctetsOut, llcCcStatsSFramesIn=llcCcStatsSFramesIn, llcCcOperLastFailTime=llcCcOperLastFailTime, llcCcOperWw=llcCcOperWw, llcCcLSap=llcCcLSap, ccsLlcRouterTunnelTransport=ccsLlcRouterTunnelTransport, ccsLlcRouterTunnelPort=ccsLlcRouterTunnelPort, ccsLlcDestTunnelId=ccsLlcDestTunnelId, ccsLlcTunnelRouterEntry=ccsLlcTunnelRouterEntry, llcCcOperMaxRetransmits=llcCcOperMaxRetransmits, llcCcLMac=llcCcLMac, llcPortAdminMaxCcs=llcPortAdminMaxCcs, ccsLlcTunnelDefaultDestEntry=ccsLlcTunnelDefaultDestEntry, llcCcRMac=llcCcRMac, llcSapStatsConnectFail=llcSapStatsConnectFail, llcSapStatsReset=llcSapStatsReset, llcSapStatsXIDCommandsOut=llcSapStatsXIDCommandsOut, llcCcOperTable=llcCcOperTable, llcCcOperMaxIPDUOctetsRcv=llcCcOperMaxIPDUOctetsRcv, llcSapStatsIFramesOut=llcSapStatsIFramesOut, llcCcOperRejTimer=llcCcOperRejTimer, llcPortAdminName=llcPortAdminName, llcCcOperMaxUnackedIPDUsSend=llcCcOperMaxUnackedIPDUsSend, llcSapStatsTESTResponsesOut=llcSapStatsTESTResponsesOut, ccsLlcTunnelRouterTable=ccsLlcTunnelRouterTable, llcCcOperMaxUnackedIPDUsRcv=llcCcOperMaxUnackedIPDUsRcv, ccsLlcRouterMode=ccsLlcRouterMode, llcSapStatsTable=llcSapStatsTable, llcPortAdminMaxRetransmits=llcPortAdminMaxRetransmits, llcSapOperStatus=llcSapOperStatus, llcSapStatsXIDCommandsIn=llcSapStatsXIDCommandsIn, llcTunnelGroup=llcTunnelGroup, llcCcOperLastWwCause=llcCcOperLastWwCause, pysmiFakeCol1000=pysmiFakeCol1000, llcSapStatsUIFramesIn=llcSapStatsUIFramesIn, llcSapStatsConnectOk=llcSapStatsConnectOk, llcPortAdminEntry=llcPortAdminEntry, llcSapStatsIFramesIn=llcSapStatsIFramesIn, llcCcOperNw=llcCcOperNw, llcSapNumber=llcSapNumber, llcCcOperLastFailFRMRInfo=llcCcOperLastFailFRMRInfo, llcCcOperMaxIPDUOctetsSend=llcCcOperMaxIPDUOctetsSend, llcSapStatsIOctetsOut=llcSapStatsIOctetsOut, llcSapStatsDisconnect=llcSapStatsDisconnect, llcCcOperBusyTimer=llcCcOperBusyTimer, llcPortOperEntry=llcPortOperEntry, llcCcOperPbitTimer=llcCcOperPbitTimer, llcSapOperTable=llcSapOperTable, llcCcStatsWwCount=llcCcStatsWwCount, llcCcStatsIFramesOut=llcCcStatsIFramesOut, llcPortAdminPbitTimer=llcPortAdminPbitTimer, llcSapStatsSFramesIn=llcSapStatsSFramesIn, llcPortAdminRejTimer=llcPortAdminRejTimer, llcCcOperInactTimer=llcCcOperInactTimer, ccsLlcTunnelInfo=ccsLlcTunnelInfo, llcPortAdminDelayAckTimer=llcPortAdminDelayAckTimer, llcSapStatsUIFramesOut=llcSapStatsUIFramesOut, llcPortAdminTable=llcPortAdminTable, llcSapOperNumCcs=llcSapOperNumCcs, llcSapStatsDisconnectTimer=llcSapStatsDisconnectTimer, llcCcGroup=llcCcGroup, llcCcStatsSFramesOut=llcCcStatsSFramesOut, llcSapStatsXIDResponsesIn=llcSapStatsXIDResponsesIn, llcPortGroup=llcPortGroup, llcCcOperLastModifyTime=llcCcOperLastModifyTime, llcSapStatsTESTResponsesIn=llcSapStatsTESTResponsesIn, llcSapStatsUIOctetsIn=llcSapStatsUIOctetsIn, llcSapStatsEntry=llcSapStatsEntry, llcSapStatsUIOctetsOut=llcSapStatsUIOctetsOut, llcCcStatsIOctetsIn=llcCcStatsIOctetsIn, ccsLlcTunnelMode=ccsLlcTunnelMode, a3com=a3com, llcCcOperCreateTime=llcCcOperCreateTime, llcSapStatsTESTCommandsOut=llcSapStatsTESTCommandsOut, ccsLlcRemoteMacAddress=ccsLlcRemoteMacAddress, llcSapStatsREJsIn=llcSapStatsREJsIn, llcSapStatsRetransmitsOut=llcSapStatsRetransmitsOut, ccsLlcRemoteSapHighRange=ccsLlcRemoteSapHighRange, MacAddress=MacAddress, llcCcOperDelayAckCount=llcCcOperDelayAckCount, ccsLlcTunnelDefaultDestTable=ccsLlcTunnelDefaultDestTable, llcPortAdminNw=llcPortAdminNw, llcPortOperSimRim=llcPortOperSimRim, llcSapStatsIOctetsIn=llcSapStatsIOctetsIn, llcCcAdminTable=llcCcAdminTable, llcCcOperLastFailCause=llcCcOperLastFailCause, llcCcOperDelayAckTimer=llcCcOperDelayAckTimer, ccsLlcRouterEnable=ccsLlcRouterEnable, brouterMIB=brouterMIB, llcCcStatsREJsIn=llcCcStatsREJsIn, llcCcStatsRetransmitsOut=llcCcStatsRetransmitsOut, ccsLlcTunnelSNAPriority=ccsLlcTunnelSNAPriority, llcSapStatsTESTCommandsIn=llcSapStatsTESTCommandsIn, llcCcStatsRemoteBusies=llcCcStatsRemoteBusies, llcSapStatsDisconnectFRMRRcv=llcSapStatsDisconnectFRMRRcv, llcCcStatsTable=llcCcStatsTable, llcPortAdminMaxPDUOctets=llcPortAdminMaxPDUOctets, llcCcStatsIFramesIn=llcCcStatsIFramesIn, ccsLlcTunnelId=ccsLlcTunnelId, ccsLlcRouterPeerString=ccsLlcRouterPeerString, llcSapStatsDisconnectFRMRSend=llcSapStatsDisconnectFRMRSend, llcPortAdminBusyTimer=llcPortAdminBusyTimer, ccsLlcRemoteSapLowRange=ccsLlcRemoteSapLowRange, llcPortAdminDelayAckCount=llcPortAdminDelayAckCount, llc=llc, ccsLlcLocalAddress=ccsLlcLocalAddress, llcCcRSap=llcCcRSap, llcSapAdminEntry=llcSapAdminEntry, llcSapGroup=llcSapGroup, llcPortAdminInactTimer=llcPortAdminInactTimer, llcPortAdminMaxSaps=llcPortAdminMaxSaps, llcPortAdminMaxUnackedIPDUsSend=llcPortAdminMaxUnackedIPDUsSend, llcCcOperEntry=llcCcOperEntry, llcCcStatsLocalBusies=llcCcStatsLocalBusies, llcSapStatsRemoteBusies=llcSapStatsRemoteBusies, llcPortOperTable=llcPortOperTable, llcPortOperNumSaps=llcPortOperNumSaps, llcCcStatsREJsOut=llcCcStatsREJsOut, llcCcOperAckTimer=llcCcOperAckTimer, llcCcStatsEntry=llcCcStatsEntry, llcSapStatsREJsOut=llcSapStatsREJsOut, llcSapOperEntry=llcSapOperEntry, ccsLlcRemoteSap=ccsLlcRemoteSap, llcSapOperLlc2Support=llcSapOperLlc2Support, llcSapStatsLocalBusies=llcSapStatsLocalBusies, ccsLlcTunnelVirtualRing=ccsLlcTunnelVirtualRing, llcSapStatsXIDResponsesOut=llcSapStatsXIDResponsesOut, ccsLlcPeerAddress=ccsLlcPeerAddress, llcSapStatsWwCount=llcSapStatsWwCount, llcCcOperState=llcCcOperState, llcSapAdminTable=llcSapAdminTable, llcCcAdminEntry=llcCcAdminEntry, llcSapStatsSFramesOut=llcSapStatsSFramesOut)
