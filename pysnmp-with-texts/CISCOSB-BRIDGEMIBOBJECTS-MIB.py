...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/CISCOSB-BRIDGEMIBOBJECTS-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:21:58 2019
...
dot1dBasePort, BridgeId, dot1dStpPort, Timeout = mibBuilder.importSymbols("BRIDGE-MIB", "dot1dBasePort", "BridgeId", "dot1dStpPort", "Timeout")
switch001, = mibBuilder.importSymbols("CISCOSB-MIB", "switch001")
InterfaceIndex, ifIndex = mibBuilder.importSymbols("IF-MIB", "InterfaceIndex", "ifIndex")
PortList, = mibBuilder.importSymbols("Q-BRIDGE-MIB", "PortList")
SnmpAdminString, = mibBuilder.importSymbols("SNMP-FRAMEWORK-MIB", "SnmpAdminString")
ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup")
Integer32, TimeTicks, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, MibIdentifier, NotificationType, Unsigned32, ModuleIdentity, Gauge32, ObjectIdentity, Counter64, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "MibIdentifier", "NotificationType", "Unsigned32", "ModuleIdentity", "Gauge32", "ObjectIdentity", "Counter64", "iso", "Bits")
...
if mibBuilder.loadTexts: rlpBridgeMIBObjects.setOrganization('Cisco Small Business')
if mibBuilder.loadTexts: rlpBridgeMIBObjects.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
rldot1sMstpInstanceId = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 57, 6, 1, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 64))).setMaxAccess("readonly")
...
rldot1sMstpInstancePortMstiId = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 57, 6, 2, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 64))).setMaxAccess("readonly")
...
rldot1sMstpGroup = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 57, 6, 6, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 64))).setMaxAccess("readonly")
...
rldot1sMstpPendingGroup = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 57, 6, 6, 1, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 64))).setMaxAccess("readwrite")
...
rldot1sMstpInstanceVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 57, 6, 15, 1), ).setIndexNames((0, "CISCOSB-BRIDGEMIBOBJECTS-MIB", "rldot1sMstpInstanceVlanId"))
...
rldot1sMstpInstanceVlanId = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 57, 6, 15, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 64))).setMaxAccess("readonly")
...
rldot1sMstpInstanceVlanId1To1024 = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 57, 6, 15, 1, 2), VlanList1()).setMaxAccess("readonly")
...
rldot1sMstpInstanceVlanId1025To2048 = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 57, 6, 15, 1, 3), VlanList2()).setMaxAccess("readonly")
...
rldot1sMstpInstanceVlanId2049To3072 = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 57, 6, 15, 1, 4), VlanList3()).setMaxAccess("readonly")
...
rldot1sMstpInstanceVlanId3073To4094 = MibTableColumn((1, 3, 6, 1, 4, 1, 9, 6, 1, 101, 57, 6, 15, 1, 5), VlanList4()).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("CISCOSB-BRIDGEMIBOBJECTS-MIB", rldot1dStpPortBpduReceived=rldot1dStpPortBpduReceived, rldot1dStpMaxAge=rldot1dStpMaxAge, rldot1wRStpVlanEdgePortTable=rldot1wRStpVlanEdgePortTable, rldot1dStpVlanTable=rldot1dStpVlanTable, rldot1dStpTrapVrblVID=rldot1dStpTrapVrblVID, rldot1sMstpInstanceRootPort=rldot1sMstpInstanceRootPort, rldot1sMstpExtPortBoundary=rldot1sMstpExtPortBoundary, rldot1dExtBase=rldot1dExtBase, rldot1wRStpForceVersionState=rldot1wRStpForceVersionState, rldot1dStpPortDampEnable=rldot1dStpPortDampEnable, rldot1sMstpInstanceEntry=rldot1sMstpInstanceEntry, rldot1dStpVlanEntry=rldot1dStpVlanEntry, rldot1sMstpExtPortTable=rldot1sMstpExtPortTable, rldot1sMstpRegionalRoot=rldot1sMstpRegionalRoot, rldot1wRStpForceVersionEntry=rldot1wRStpForceVersionEntry, rldot1dStpPortLoopback=rldot1dStpPortLoopback, rldot1dStpMonitorTime=rldot1dStpMonitorTime, rldot1sMstpRemainingHops=rldot1sMstpRemainingHops, rldot1sMstpInstanceVlanEntry=rldot1sMstpInstanceVlanEntry, rldot1sMstpInstanceVlanId1To1024=rldot1sMstpInstanceVlanId1To1024, rldot1dStpPortFilterBpdu=rldot1dStpPortFilterBpdu, rldot1dStpHelloTime=rldot1dStpHelloTime, rldot1dStpDisabledPortStateEntry=rldot1dStpDisabledPortStateEntry, rldot1dStp=rldot1dStp, rldot1dStpLastChanged=rldot1dStpLastChanged, VlanList2=VlanList2, rldot1dStpVlanPortPort=rldot1dStpVlanPortPort, rldot1dStpPortBelongToVlanDefault=rldot1dStpPortBelongToVlanDefault, rldot1wRStpEdgePortStatus=rldot1wRStpEdgePortStatus, rldot1sMstpInstanceEnable=rldot1sMstpInstanceEnable, rldot1dStpVlanPortForwardTransitions=rldot1dStpVlanPortForwardTransitions, rldot1sMstpInstancePortPriority=rldot1sMstpInstancePortPriority, rldot1sMstpExtPortPort=rldot1sMstpExtPortPort, rldot1dStpVlanPortEntry=rldot1dStpVlanPortEntry, VlanList3=VlanList3, rldot1dStpPortTable=rldot1dStpPortTable, rldot1wRStpVlanEdgePortVlan=rldot1wRStpVlanEdgePortVlan, rldot1sMstpPendingRevisionLevel=rldot1sMstpPendingRevisionLevel, rldot1dStpDesignatedRoot=rldot1dStpDesignatedRoot, rldot1sMstpInstanceHelloTime=rldot1sMstpInstanceHelloTime, rldot1pPriorityMapEntry=rldot1pPriorityMapEntry, rldot1dStpVlanPortDesignatedPort=rldot1dStpVlanPortDesignatedPort, rldot1sMstpExtPortEntry=rldot1sMstpExtPortEntry, rldot1dStpPortToDefault=rldot1dStpPortToDefault, rldot1sMstpInstancePriority=rldot1sMstpInstancePriority, rldot1sMstpPendingConfigurationName=rldot1sMstpPendingConfigurationName, rldot1dStpPortRestrictedRole=rldot1dStpPortRestrictedRole, rldot1sMstpInstancePortState=rldot1sMstpInstancePortState, rldot1sMstpInstancePortEnable=rldot1sMstpInstancePortEnable, rldot1dStpVlanPortDesignatedCost=rldot1dStpVlanPortDesignatedCost, rldot1dStpSeparatedBridgesTable=rldot1dStpSeparatedBridgesTable, rldot1dStpEnable=rldot1dStpEnable, rldot1dStpSeparatedBridgesEntry=rldot1dStpSeparatedBridgesEntry, rldot1sMstpExtPortInternalOperPathCost=rldot1sMstpExtPortInternalOperPathCost, rldot1sMstpInstancePortDesignatedRoot=rldot1sMstpInstancePortDesignatedRoot, rldot1dStpVlanPortTable=rldot1dStpVlanPortTable, rldot1dExtBaseMibVersion=rldot1dExtBaseMibVersion, rlpBridgeMIBObjects=rlpBridgeMIBObjects, rldot1sMstpPendingAction=rldot1sMstpPendingAction, rldot1sMstpRevisionLevel=rldot1sMstpRevisionLevel, rldot1dStpPortBpduSent=rldot1dStpPortBpduSent, rldot1pPriorityMap=rldot1pPriorityMap, rldot1dStpVlanPortDesignatedBridge=rldot1dStpVlanPortDesignatedBridge, rldot1dTpAgingTimeMax=rldot1dTpAgingTimeMax, rldot1sMstpInstancePortEntry=rldot1sMstpInstancePortEntry, rldot1dStpPortEntry=rldot1dStpPortEntry, rldot1pPriorityMapName=rldot1pPriorityMapName, rldot1dStpDisabledPortStateTable=rldot1dStpDisabledPortStateTable, rldot1sMstpInstanceRootCost=rldot1sMstpInstanceRootCost, rldot1sMstpInstancePortPathCost=rldot1sMstpInstancePortPathCost, rldot1sMStpInstancePortRole=rldot1sMStpInstancePortRole, rldot1sMstpInstancePortDesignatedCost=rldot1sMstpInstancePortDesignatedCost, rldot1sMstpExtPortDesignatedRegionalCost=rldot1sMstpExtPortDesignatedRegionalCost, rldot1dStpSeparatedBridges=rldot1dStpSeparatedBridges, rldot1dStpBpduType=rldot1dStpBpduType, rldot1dStpFloodBpduMethod=rldot1dStpFloodBpduMethod, rldot1dStpVlanPortEnable=rldot1dStpVlanPortEnable, rldot1dStpPortBpduGuardEntry=rldot1dStpPortBpduGuardEntry, rldot1sMstpInstanceHoldTime=rldot1sMstpInstanceHoldTime, rldot1dStpPortPort=rldot1dStpPortPort, rldot1dStpEdgeportSupportInStp=rldot1dStpEdgeportSupportInStp, rldot1dStpSeparatedBridgesEnable=rldot1dStpSeparatedBridgesEnable, rldot1dStpVlanEnable=rldot1dStpVlanEnable, rldot1dStpTrapVariable=rldot1dStpTrapVariable, rldot1sMstpInstancePortDesignatedPort=rldot1sMstpInstancePortDesignatedPort, rldot1dStpMibVersion=rldot1dStpMibVersion, rldot1sMstpInstancePortMstiId=rldot1sMstpInstancePortMstiId, rldot1dStpVlan=rldot1dStpVlan, rldot1dStpBpduCount=rldot1dStpBpduCount, rldot1dStpExtendedPortNumberFormat=rldot1dStpExtendedPortNumberFormat, VlanList1=VlanList1, rldot1dStpRootPort=rldot1dStpRootPort, rldot1dStpEnableByDefault=rldot1dStpEnableByDefault, rldot1dDeviceCapabilities=rldot1dDeviceCapabilities, rldot1wRStpForceVersionTable=rldot1wRStpForceVersionTable, rldot1sMstpPendingGroup=rldot1sMstpPendingGroup, rldot1sMstpInstanceVlanId=rldot1sMstpInstanceVlanId, rldot1sMstpMaxHopes=rldot1sMstpMaxHopes, rldot1sMstpInstanceVlanTable=rldot1sMstpInstanceVlanTable, rldot1dStpPortMustBelongToVlan=rldot1dStpPortMustBelongToVlan, rldot1dStpDisabledPortState=rldot1dStpDisabledPortState, rldot1sMstpInstanceDesignatedRoot=rldot1sMstpInstanceDesignatedRoot, rldot1dPriority=rldot1dPriority, rldot1dTpAgingTimeMin=rldot1dTpAgingTimeMin, rldot1dStpType=rldot1dStpType, rldot1dStpHoldTime=rldot1dStpHoldTime, rldot1dStpRootCost=rldot1dStpRootCost, rldot1dStpVlanPortPriority=rldot1dStpVlanPortPriority, rldot1dStpVlanPortDesignatedRoot=rldot1dStpVlanPortDesignatedRoot, rldot1dPriorityPortGroupTable=rldot1dPriorityPortGroupTable, rldot1dStpPortRole=rldot1dStpPortRole, rldot1sMstpInstancePortForwardTransitions=rldot1sMstpInstancePortForwardTransitions, PYSNMP_MODULE_ID=rlpBridgeMIBObjects, rldot1dTpAgingTime=rldot1dTpAgingTime, rldot1dStpLoopbackGuardEnable=rldot1dStpLoopbackGuardEnable, rldot1pPriorityMapState=rldot1pPriorityMapState, rldot1sMstpInstanceId=rldot1sMstpInstanceId, rldot1wRStpVlanEdgePortEntry=rldot1wRStpVlanEdgePortEntry, rldot1dStpForwardDelay=rldot1dStpForwardDelay, rldot1sMstpInstanceTopChanges=rldot1sMstpInstanceTopChanges, rldot1dStpFilterBpdu=rldot1dStpFilterBpdu, rldot1dStpVlanPortPathCost=rldot1dStpVlanPortPathCost, rldot1dStpTrapVrblifIndex=rldot1dStpTrapVrblifIndex, rldot1pPriorityMapPortList=rldot1pPriorityMapPortList, rldot1sMstpVlan=rldot1sMstpVlan, rldot1sMstpInstancePortDesignatedBridge=rldot1sMstpInstancePortDesignatedBridge, rldot1dStpVlanPortVlan=rldot1dStpVlanPortVlan, rldot1sMstpExtPortInternalAdminPathCost=rldot1sMstpExtPortInternalAdminPathCost, rldot1dStpPortDampStable=rldot1dStpPortDampStable, rldot1dStpSeparatedBridgesAutoConfig=rldot1dStpSeparatedBridgesAutoConfig, rldot1sMstpConfigurationName=rldot1sMstpConfigurationName, rldot1sMstpVlanEntry=rldot1sMstpVlanEntry, rldot1sMstpInstanceVlanId3073To4094=rldot1sMstpInstanceVlanId3073To4094, rldot1dStpTaggedFlooding=rldot1dStpTaggedFlooding, rldot1sMstpInstanceTimeSinceTopologyChange=rldot1sMstpInstanceTimeSinceTopologyChange, rldot1sMstpExtPortDesignatedRegionalRoot=rldot1sMstpExtPortDesignatedRegionalRoot, rldot1sMstp=rldot1sMstp, rldot1wRStp=rldot1wRStp, rldot1sMstpGroup=rldot1sMstpGroup, rldot1dPriorityPortGroupEntry=rldot1dPriorityPortGroupEntry, rldot1dStpTimeSinceTopologyChange=rldot1dStpTimeSinceTopologyChange, rldot1sMstpInstanceVlanId1025To2048=rldot1sMstpInstanceVlanId1025To2048, rldot1dStpTopChanges=rldot1dStpTopChanges, rldot1sMstpInstanceTable=rldot1sMstpInstanceTable, rldot1sMStpInstancePortAdminPathCost=rldot1sMStpInstancePortAdminPathCost, rldot1dStpVlanPortState=rldot1dStpVlanPortState, rldot1sMstpInstanceVlanId2049To3072=rldot1sMstpInstanceVlanId2049To3072, rldot1sMstpInstanceForwardDelay=rldot1sMstpInstanceForwardDelay, rldot1dStpSupportedType=rldot1dStpSupportedType, rldot1dStpPortBpduGuardTable=rldot1dStpPortBpduGuardTable, VlanList4=VlanList4, rldot1dStpPortsEnable=rldot1dStpPortsEnable, rldot1dPriorityPortGroupNumber=rldot1dPriorityPortGroupNumber, rldot1dStpSeparatedBridgesPortEnable=rldot1dStpSeparatedBridgesPortEnable, rldot1sMstpRegionalRootCost=rldot1sMstpRegionalRootCost, rldot1dStpTypeAfterReset=rldot1dStpTypeAfterReset, rldot1wRStpForceVersionVlan=rldot1wRStpForceVersionVlan, rldot1dStpPortBpduOperStatus=rldot1dStpPortBpduOperStatus, rldot1sMstpDesignatedMaxHopes=rldot1sMstpDesignatedMaxHopes, rldot1sMstpInstanceMaxAge=rldot1sMstpInstanceMaxAge, rldot1sMstpInstanceRemainingHopes=rldot1sMstpInstanceRemainingHopes, rldot1pPriorityMapStatus=rldot1pPriorityMapStatus, rldot1pPriorityMapPriority=rldot1pPriorityMapPriority, rldot1sMstpInstancePortTable=rldot1sMstpInstancePortTable, rldot1sMstpInstancePortPort=rldot1sMstpInstancePortPort, rldot1pPriorityMapPort=rldot1pPriorityMapPort, rldot1wRStpVlanEdgePortPort=rldot1wRStpVlanEdgePortPort, rldot1pPriorityMapTable=rldot1pPriorityMapTable, rldot1dStpPortBpduGuardEnable=rldot1dStpPortBpduGuardEnable, rldot1dStpPortAutoEdgePort=rldot1dStpPortAutoEdgePort, rldot1dPriorityMibVersion=rldot1dPriorityMibVersion, rldot1sMstpVlanTable=rldot1sMstpVlanTable)
