#
# PySNMP MIB module DKSF-201-9-X-X-1 (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DKSF-201-9-X-X-1
# Produced by pysmi-0.3.4 at Wed May  1 12:47:20 2019
...
MibIdentifier, Integer32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, Counter64, Unsigned32, Counter32, ObjectIdentity, ModuleIdentity, Bits, TimeTicks, enterprises, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "Counter64", "Unsigned32", "Counter32", "ObjectIdentity", "ModuleIdentity", "Bits", "TimeTicks", "enterprises", "IpAddress")
...
netPing2PWR220SMSv3 = ModuleIdentity((1, 3, 6, 1, 4, 1, 25728, 201))
netPing2PWR220SMSv3.setRevisions(('2015-08-17 00:00', '2014-11-14 00:00', '2014-04-14 00:00', '2014-02-02 00:00', '2014-01-29 00:00', '2014-01-21 00:00', '2013-04-11 00:00', '2012-05-31 00:00', '2012-04-17 00:00', '2012-03-23 00:00', '2011-09-23 00:00', '2011-03-24 00:00', '2010-10-14 00:00', '2010-09-20 00:00', '2010-05-31 00:00', '2010-04-14 00:00',))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: netPing2PWR220SMSv3.setRevisionsDescriptions(('changed npIoLevelOut value definitions', 'bugfix npRelayN range changed to (1..2) value name npNormRange changed to npSafeRange', 'rewrite for DKSF201.8', 'npRelayMode valid values changed, (3) excluded ', 'npCurLoop, npRelHumidity, npIr branches has added', 'partial rewrite for DKSF 70', 'partial rewrite for DKSF 48', 'npPwrRelayState branch was added', 'npReboot branch was added', 'Minor changes to IR module for IRC-TRv2', '4 IO lines, Identification is changed from DKSF 52.4 to DKSF 52.5', 'npIoPulseCounter, npIoSinglePulseDuration, npIoSinglePulseStart is added Identification is changed from DKSF 52.3 to DKSF 52.4', 'IR module support', 'dksf 52.3 subversion', 'dksf 51.3 subversion', 'SMIv2-style rewrite',))
if mibBuilder.loadTexts: netPing2PWR220SMSv3.setLastUpdated('201508170000Z')
if mibBuilder.loadTexts: netPing2PWR220SMSv3.setOrganization('Alentis Electronics')
if mibBuilder.loadTexts: netPing2PWR220SMSv3.setContactInfo('developers@netping.ru')
if mibBuilder.loadTexts: netPing2PWR220SMSv3.setDescription('Generic MIB for NetPing remote sensing and control')
...
npRelayEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25728, 5500, 5, 1), ).setIndexNames((0, "DKSF-201-9-X-X-1", "npRelayN"))
...
npPwrEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25728, 5800, 3, 1), ).setIndexNames((0, "DKSF-201-9-X-X-1", "npPwrChannelN"))
...
npThermoEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25728, 8800, 1, 1), ).setIndexNames((0, "DKSF-201-9-X-X-1", "npThermoSensorN"))
...
npThermoTrap = NotificationType((1, 3, 6, 1, 4, 1, 25728, 8800, 2, 0, 1)).setObjects(("DKSF-201-9-X-X-1", "npThermoTrapSensorN"), ("DKSF-201-9-X-X-1", "npThermoTrapValue"), ("DKSF-201-9-X-X-1", "npThermoTrapStatus"), ("DKSF-201-9-X-X-1", "npThermoTrapLow"), ("DKSF-201-9-X-X-1", "npThermoTrapHigh"), ("DKSF-201-9-X-X-1", "npThermoTrapMemo"))
...
npIoEntry = MibTableRow((1, 3, 6, 1, 4, 1, 25728, 8900, 1, 1), ).setIndexNames((0, "DKSF-201-9-X-X-1", "npIoLineN"))
...
npIoTrap = NotificationType((1, 3, 6, 1, 4, 1, 25728, 8900, 2, 0, 1)).setObjects(("DKSF-201-9-X-X-1", "npIoTrapLineN"), ("DKSF-201-9-X-X-1", "npIoTrapLevelIn"), ("DKSF-201-9-X-X-1", "npIoTrapMemo"))
...
npRelHumTrap = NotificationType((1, 3, 6, 1, 4, 1, 25728, 8400, 9, 0, 1)).setObjects(("DKSF-201-9-X-X-1", "npRelHumSensorStatusH"), ("DKSF-201-9-X-X-1", "npRelHumSensorValueH"), ("DKSF-201-9-X-X-1", "npRelHumSafeRangeHigh"), ("DKSF-201-9-X-X-1", "npRelHumSafeRangeLow"), ("DKSF-201-9-X-X-1", "npTrapEmailTo"))
...
npGsmTrap = NotificationType((1, 3, 6, 1, 4, 1, 25728, 3800, 2, 0, 1)).setObjects(("DKSF-201-9-X-X-1", "npGsmFailed"), ("DKSF-201-9-X-X-1", "npGsmRegistration"), ("DKSF-201-9-X-X-1", "npGsmStrength"))
...
mibBuilder.exportSymbols("DKSF-201-9-X-X-1", npRelHumTrap=npRelHumTrap, npIoSinglePulseStart=npIoSinglePulseStart, npRelayMode=npRelayMode, npGsmStrength=npGsmStrength, npRelHumidity=npRelHumidity, npThermoTable=npThermoTable, npTrapInfo=npTrapInfo, lightcom=lightcom, npThermoTrapStatus=npThermoTrapStatus, npThermoLow=npThermoLow, npIoLevelOut=npIoLevelOut, npThermoTraps=npThermoTraps, npThermoTrapLow=npThermoTrapLow, npPwrMemo=npPwrMemo, npThermoHigh=npThermoHigh, npIoEntry=npIoEntry, npIoTraps=npIoTraps, npRelayStartReset=npRelayStartReset, npPwrRelayFlip=npPwrRelayFlip, npThermoSensorN=npThermoSensorN, npPwrResetsCounter=npPwrResetsCounter, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npGsmTrap=npGsmTrap, npThermoTrapPrefix=npThermoTrapPrefix, npIoTable=npIoTable, npGsmTraps=npGsmTraps, npTrapEmailTo=npTrapEmailTo, npIoTrap=npIoTrap, npIoLevelIn=npIoLevelIn, npRelHumSensorStatus=npRelHumSensorStatus, npThermoEntry=npThermoEntry, npPwrTable=npPwrTable, npIrPlayCmd=npIrPlayCmd, npPwrManualMode=npPwrManualMode, npRelayMemo=npRelayMemo, npThermoValue=npThermoValue, netPing2PWR220SMSv3=netPing2PWR220SMSv3, npReboot=npReboot, npRelHumSensor=npRelHumSensor, npIrReset=npIrReset, npThermoTrap=npThermoTrap, npIoSinglePulseDuration=npIoSinglePulseDuration, npIoPulseCounter=npIoPulseCounter, npThermoTrapMemo=npThermoTrapMemo, npRelHumTrapPrefix=npRelHumTrapPrefix, npRelHumSensorValueH=npRelHumSensorValueH, npRelayN=npRelayN, npRelHumSensorStatusH=npRelHumSensorStatusH, npGsm=npGsm, npPwrEntry=npPwrEntry, npThermoTrapSensorN=npThermoTrapSensorN, npPwrRelayState=npPwrRelayState, PYSNMP_MODULE_ID=netPing2PWR220SMSv3, npIoTrapMemo=npIoTrapMemo, npIrStatus=npIrStatus, npIr=npIr, npRelayTable=npRelayTable, npIoTrapLevelIn=npIoTrapLevelIn, npIo=npIo, npGsmFailed=npGsmFailed, npIoTrapLineN=npIoTrapLineN, npIoMemo=npIoMemo, npIrCtrl=npIrCtrl, npPwrRepeatingResetsCounter=npPwrRepeatingResetsCounter, npRelayFlip=npRelayFlip, npPwrChannelN=npPwrChannelN, npRelayEntry=npRelayEntry, npRelHumSensorValueT100=npRelHumSensorValueT100, npRelHumTraps=npRelHumTraps, npForcedReboot=npForcedReboot, npIoTrapPrefix=npIoTrapPrefix, npGsmInfo=npGsmInfo, npRelHumSensorValueT=npRelHumSensorValueT, npThermoStatus=npThermoStatus, npThermoTrapValue=npThermoTrapValue, npThermoTrapHigh=npThermoTrapHigh, npGsmTrapPrefix=npGsmTrapPrefix, npRelayState=npRelayState, npResetStack=npResetStack, npRelay=npRelay, npSoftReboot=npSoftReboot, npIoLineN=npIoLineN, npPwr=npPwr, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npGsmRegistration=npGsmRegistration, npThermoMemo=npThermoMemo, npThermo=npThermo, npPwrStartReset=npPwrStartReset)
