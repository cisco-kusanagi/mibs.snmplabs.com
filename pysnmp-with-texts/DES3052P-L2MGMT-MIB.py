...
# Produced by pysmi-0.3.4 at Wed May  1 12:40:16 2019
...
Bits, ModuleIdentity, NotificationType, iso, Unsigned32, ObjectIdentity, Gauge32, IpAddress, Integer32, TimeTicks, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "ModuleIdentity", "NotificationType", "iso", "Unsigned32", "ObjectIdentity", "Gauge32", "IpAddress", "Integer32", "TimeTicks", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Counter32")
...
mibBuilder.exportSymbols("DES3052P-L2MGMT-MIB", swL2PortLoopRestart=swL2PortLoopRestart, swL2DevMgmt=swL2DevMgmt, swL2DhcpLocalRelayVLANState=swL2DhcpLocalRelayVLANState, swL2FloodMACAutoFDBRowStatus=swL2FloodMACAutoFDBRowStatus, swL2PortSecurityAdmState=swL2PortSecurityAdmState, swL2DhcpRelayCtrlEntry=swL2DhcpRelayCtrlEntry, swL2PortErrPortStatus=swL2PortErrPortStatus, swL2FloodMACMgmt=swL2FloodMACMgmt, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2IGMPMulticastVlanEntry=swL2IGMPMulticastVlanEntry, swL2TrafficSegPort=swL2TrafficSegPort, swL2PortErrPortReason=swL2PortErrPortReason, swPortTrunkEntry=swPortTrunkEntry, swL2QOS8021pUserPriorityEntry=swL2QOS8021pUserPriorityEntry, swL2QOS8021pDefaultPriorityTable=swL2QOS8021pDefaultPriorityTable, swL2IGMPAccessAuthEntry=swL2IGMPAccessAuthEntry, swL2DevAlarm=swL2DevAlarm, swPortTrunkFloodingPort=swPortTrunkFloodingPort, swL2PortSecurityMode=swL2PortSecurityMode, swL2FloodMACTrapState=swL2FloodMACTrapState, swPortTrunkType=swPortTrunkType, swL2FloodMACAutoFDBIPAddress=swL2FloodMACAutoFDBIPAddress, swL2CosTosPRIEntry=swL2CosTosPRIEntry, swL2IGMPInfoTxQueryCount=swL2IGMPInfoTxQueryCount, swL2PortInfoMediumType=swL2PortInfoMediumType, swL2DhcpRelayCtrlTable=swL2DhcpRelayCtrlTable, swL2IGMPInfoTable=swL2IGMPInfoTable, swL2QOSSchedulingTable=swL2QOSSchedulingTable, swL2DhcpLocalRelayVLANTable=swL2DhcpLocalRelayVLANTable, swL2DhcpRelayOption82State=swL2DhcpRelayOption82State, swL2IGMPLeaveTimer=swL2IGMPLeaveTimer, swL2CosPortPRIIndex=swL2CosPortPRIIndex, swPortMirrorPackage=swPortMirrorPackage, swL2PortSecurityDelActivity=swL2PortSecurityDelActivity, swL2DhcpRelayCtrlInterfaceName=swL2DhcpRelayCtrlInterfaceName, swL2TrafficSegTable=swL2TrafficSegTable, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2McastFilterPortProfileAddOrDelState=swL2McastFilterPortProfileAddOrDelState, swL2FloodMACLogState=swL2FloodMACLogState, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2DevCtrlSystemReboot=swL2DevCtrlSystemReboot, swL2CosMacBasePRIClass=swL2CosMacBasePRIClass, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2FloodMACAutoFDBPort=swL2FloodMACAutoFDBPort, swL2DhcpRelayMgmt=swL2DhcpRelayMgmt, swL2DhcpRelayOption82Policy=swL2DhcpRelayOption82Policy, swL2IGMPRouterPortStaticPortList=swL2IGMPRouterPortStaticPortList, swL2FloodMacDetectedMacVid=swL2FloodMacDetectedMacVid, swL2QOSBandwidthPortIndex=swL2QOSBandwidthPortIndex, swL2McastFilterPortMaxGroupPortIndex=swL2McastFilterPortMaxGroupPortIndex, swL2PortCtrlTable=swL2PortCtrlTable, swL2DevCtrlVLANTrunkState=swL2DevCtrlVLANTrunkState, swL2McastFilterPortEntry=swL2McastFilterPortEntry, swL2IGMPDynIPMultVlanAge=swL2IGMPDynIPMultVlanAge, swL2PortCtrlPortMediumType=swL2PortCtrlPortMediumType, swL2IGMPMulticastVlanGroupEntry=swL2IGMPMulticastVlanGroupEntry, swL2VlanMultiplyAction=swL2VlanMultiplyAction, swL2DhcpRelayTimeThreshold=swL2DhcpRelayTimeThreshold, swL2QOS8021pUserPriorityTable=swL2QOS8021pUserPriorityTable, swPortTrunkTable=swPortTrunkTable, swL2IGMPMulticastVlanRemapPriority=swL2IGMPMulticastVlanRemapPriority, swL2VlanMultiplyMgmt=swL2VlanMultiplyMgmt, swL2DevCtrlIpAutoConfig=swL2DevCtrlIpAutoConfig, swL2TrunkVLANTable=swL2TrunkVLANTable, swL2DhcpLocalRelayState=swL2DhcpLocalRelayState, swL2LoopDetectRecoverTime=swL2LoopDetectRecoverTime, swPortTrunkActivePort=swPortTrunkActivePort, swL2TrunkMgmt=swL2TrunkMgmt, swL2PortCtrlMDIXState=swL2PortCtrlMDIXState, swL2DhcpRelayCtrlState=swL2DhcpRelayCtrlState, swL2CosTosPRIIndex=swL2CosTosPRIIndex, swL2IGMPRouterPortTable=swL2IGMPRouterPortTable, swL2IGMPHostTimeout=swL2IGMPHostTimeout, swL2McastFilterStatus=swL2McastFilterStatus, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2IGMPPortMap=swL2IGMPPortMap, swL2FloodMACFDBIndex=swL2FloodMACFDBIndex, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swL2CosTosPRITable=swL2CosTosPRITable, swL2PortSecurityControlTable=swL2PortSecurityControlTable, swL2QOSBandwidthControlEntry=swL2QOSBandwidthControlEntry, swL2McastFilterPortMaxGroupTable=swL2McastFilterPortMaxGroupTable, swL2macNotifyInfo=swL2macNotifyInfo, swL2FloodMacDetectedTrap=swL2FloodMacDetectedTrap, swIGMPPackage=swIGMPPackage, swL2FloodMACAutoFDBCtrlEntry=swL2FloodMACAutoFDBCtrlEntry, swL2IGMPInfoEntry=swL2IGMPInfoEntry, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2IGMPMulticastVlanSourcePort=swL2IGMPMulticastVlanSourcePort, swPortTrunkIndex=swPortTrunkIndex, swL2VlanMultiplyVlanList=swL2VlanMultiplyVlanList, swL2FloodMACFDBStatus=swL2FloodMACFDBStatus, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2VlanName=swL2VlanName, swL2IGMPv3SourceIPAddr=swL2IGMPv3SourceIPAddr, swL2McastFilterGroupList=swL2McastFilterGroupList, swL2QOSSchedulingEntry=swL2QOSSchedulingEntry, swL2IGMPAccessAuthPort=swL2IGMPAccessAuthPort, swL2IGMPMulticastVlanGroupTable=swL2IGMPMulticastVlanGroupTable, swL2IGMPSnoopingClearDynIpMult=swL2IGMPSnoopingClearDynIpMult, swL2McastFilterPortInfoPortIndex=swL2McastFilterPortInfoPortIndex, swPortMirrorTxPortList=swPortMirrorTxPortList, swL2CosDscpPRIIndex=swL2CosDscpPRIIndex, swL2DevInfo=swL2DevInfo, swL2FloodMACFDBTimestamp=swL2FloodMACFDBTimestamp, swL2IGMPMulticastVlanGroupFromIp=swL2IGMPMulticastVlanGroupFromIp, swL2McastFilterPortProfileID=swL2McastFilterPortProfileID, swIGMPSnoopingGroupRouterPorts=swIGMPSnoopingGroupRouterPorts, swL2VlanMultiplyPortList=swL2VlanMultiplyPortList, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2McastFilterPortGroupPortIndex=swL2McastFilterPortGroupPortIndex, swL2CosPriorityPortPRI=swL2CosPriorityPortPRI, swL2IGMPRouterPortVlanName=swL2IGMPRouterPortVlanName, swL2LoopDetectCtrl=swL2LoopDetectCtrl, swL2CosDscpPRIEntry=swL2CosDscpPRIEntry, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2PortErrTable=swL2PortErrTable, swL2IGMPQueryInterval=swL2IGMPQueryInterval, swL2IGMPv3Table=swL2IGMPv3Table, swL2QOSSchedulingMechanismCtrl=swL2QOSSchedulingMechanismCtrl, swL2McastFilterTable=swL2McastFilterTable, swL2PortSecurityPortIndex=swL2PortSecurityPortIndex, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2McastFilterPortInfoProfileName=swL2McastFilterPortInfoProfileName, swL2FloodMACFDBMacAddress=swL2FloodMACFDBMacAddress, swL2LoopDetectPortState=swL2LoopDetectPortState, swL2CosDscpPRIClass=swL2CosDscpPRIClass, swL2CosPortPRIClass=swL2CosPortPRIClass, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2DevCtrlDefaultGateway=swL2DevCtrlDefaultGateway, swL2PortSecurityMaxLernAddr=swL2PortSecurityMaxLernAddr, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2IGMPCtrlEntry=swL2IGMPCtrlEntry, swL2VlanAdvertisementTable=swL2VlanAdvertisementTable, swL2IGMPSnoopingMulticastVlanState=swL2IGMPSnoopingMulticastVlanState, swPortTrunkMaxEntries=swPortTrunkMaxEntries, swL2FloodMACAutoFDBTable=swL2FloodMACAutoFDBTable, swL2VlanMultiplyPortListAction=swL2VlanMultiplyPortListAction, swL2LoopDetectPortTable=swL2LoopDetectPortTable, swL2IGMPDynIpMultMgmt=swL2IGMPDynIpMultMgmt, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2CosPriorityEntry=swL2CosPriorityEntry, swL2PortCtrlMulticastfilter=swL2PortCtrlMulticastfilter, swL2VlanAdvertisementEntry=swL2VlanAdvertisementEntry, swL2FloodMACClearFDB=swL2FloodMACClearFDB, swPortTrunkPortList=swPortTrunkPortList, swL2FloodMACAutoFDBMacAddress=swL2FloodMACAutoFDBMacAddress, swL2DhcpRelayState=swL2DhcpRelayState, swL2PortSecurityDelCtrl=swL2PortSecurityDelCtrl, swL2PortCtrlDescription=swL2PortCtrlDescription, swL2IGMPMaxSupportedVlans=swL2IGMPMaxSupportedVlans, swL2IGMPCtrlTable=swL2IGMPCtrlTable, swL2IGMPMulticastVlanRemoveAllMcastAddrListAction=swL2IGMPMulticastVlanRemoveAllMcastAddrListAction, swL2PortCtrlAddressLearning=swL2PortCtrlAddressLearning, swL2LoopDetectMgmt=swL2LoopDetectMgmt, swIGMPSnoopingGroupUpTime=swIGMPSnoopingGroupUpTime, swL2IGMPQueryInfoTable=swL2IGMPQueryInfoTable, swL2PortInfoEntry=swL2PortInfoEntry, swL2IGMPMulticastVlanReplaceSourceIp=swL2IGMPMulticastVlanReplaceSourceIp, swL2FloodMacDetectedMacAddress=swL2FloodMacDetectedMacAddress, swL2IGMPQueryState=swL2IGMPQueryState, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2PortErrEntry=swL2PortErrEntry, swL2FloodMACFDBVID=swL2FloodMACFDBVID, swL2IGMPDynIPMultVlanState=swL2IGMPDynIPMultVlanState, swPortMirrorTargetPort=swPortMirrorTargetPort, swL2CosPriorityEtherPRI=swL2CosPriorityEtherPRI, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2QOSBandwidthRxRate=swL2QOSBandwidthRxRate, swL2IGMPLastMemberQueryInterval=swL2IGMPLastMemberQueryInterval, swL2CosPortPRITable=swL2CosPortPRITable, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2IGMPv3Entry=swL2IGMPv3Entry, swL2PortSecurityDelMacAddress=swL2PortSecurityDelMacAddress, swIGMPSnoopingGroupExcludePortMap=swIGMPSnoopingGroupExcludePortMap, swL2CosMacBasePRIIndex=swL2CosMacBasePRIIndex, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2PortLoopOccurred=swL2PortLoopOccurred, swL2VlanMgmt=swL2VlanMgmt, swL2IGMPMulticastVlanMemberPort=swL2IGMPMulticastVlanMemberPort, swL2IGMPSnoopingClearDynIpMultIP=swL2IGMPSnoopingClearDynIpMultIP, swL2QOS8021pUserPriorityClass=swL2QOS8021pUserPriorityClass, swL2DevCtrlSnmpEnableAuthenTraps=swL2DevCtrlSnmpEnableAuthenTraps, swL2CosMacBasePRIEntry=swL2CosMacBasePRIEntry, swPortMirrorRxPortList=swPortMirrorRxPortList, swL2PortSecurityTrapLogState=swL2PortSecurityTrapLogState, swL2FloodMACInfo=swL2FloodMACInfo, swIGMPSnoopingGroupGroupAddr=swIGMPSnoopingGroupGroupAddr, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2LoopDetectPortLoopStatus=swL2LoopDetectPortLoopStatus, swL2QOS8021pDefaultPriorityEntry=swL2QOS8021pDefaultPriorityEntry, swPortTrunkMaxPortMembers=swPortTrunkMaxPortMembers, swL2IGMPMulticastVlanTagMemberPort=swL2IGMPMulticastVlanTagMemberPort, swL2IGMPMulticastVlanid=swL2IGMPMulticastVlanid, swL2FloodMACGlobalSettings=swL2FloodMACGlobalSettings, swL2LoopDetectInterval=swL2LoopDetectInterval, swL2QOS8021pUserPriorityIndex=swL2QOS8021pUserPriorityIndex, swL2QOSBandwidthControlTable=swL2QOSBandwidthControlTable, swl2PortSecurityBindings=swl2PortSecurityBindings, swL2FloodMAC=swL2FloodMAC, swL2FloodMACAutoFDBCtrlTable=swL2FloodMACAutoFDBCtrlTable, swL2CosTosPRIClass=swL2CosTosPRIClass, PortList=PortList, swL2DhcpRelayCtrlServer=swL2DhcpRelayCtrlServer, swL2IGMPMulticastVlanGroupVid=swL2IGMPMulticastVlanGroupVid, swIGMPSnoopingGroupReportCount=swIGMPSnoopingGroupReportCount, swL2IGMPMacAddr=swL2IGMPMacAddr, swL2VlanMultiplyAdvertisement=swL2VlanMultiplyAdvertisement, swL2IGMPAccessAuthTable=swL2IGMPAccessAuthTable, swL2IGMPGroupIpAddr=swL2IGMPGroupIpAddr, swL2IGMPMaxResponseTime=swL2IGMPMaxResponseTime, swL2PortErrDescription=swL2PortErrDescription, swL2DhcpLocalRelayVLANEntry=swL2DhcpLocalRelayVLANEntry, swL2IGMPv3ExpireTimer=swL2IGMPv3ExpireTimer, swL2IGMPDynIPMultMaxEntry=swL2IGMPDynIPMultMaxEntry, swL2DevCtrlRmonState=swL2DevCtrlRmonState, swL2IGMPQueryInfoEntry=swL2IGMPQueryInfoEntry, swL2IGMPv3Forwarding=swL2IGMPv3Forwarding, swL2IGMPFastLeave=swL2IGMPFastLeave, swL2DhcpLocalRelayVLANID=swL2DhcpLocalRelayVLANID, swL2LoopDetectTrapMode=swL2LoopDetectTrapMode, swL2IGMPRouterPortForbiddenPortList=swL2IGMPRouterPortForbiddenPortList, swL2PortInfoTable=swL2PortInfoTable, swL2CosPriorityPort=swL2CosPriorityPort, swL2PortErrPortState=swL2PortErrPortState, swL2IGMPCurrentState=swL2IGMPCurrentState, swL2LoopDetectPortIndex=swL2LoopDetectPortIndex, swL2CosPriorityTable=swL2CosPriorityTable, swL2FloodMACAutoFDBEntry=swL2FloodMACAutoFDBEntry, swL2DevCtrlAsymVlanState=swL2DevCtrlAsymVlanState, swL2DhcpRelayHopCount=swL2DhcpRelayHopCount, swIGMPSnoopingGroupTable=swIGMPSnoopingGroupTable, swL2MgmtMIBTrapPrefix=swL2MgmtMIBTrapPrefix, swL2DevInfoFrontPanelLedStatus=swL2DevInfoFrontPanelLedStatus, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2LoopDetectAdminState=swL2LoopDetectAdminState, swL2IGMPMulticastVlanGroupToIp=swL2IGMPMulticastVlanGroupToIp, swL2IGMPCtrlState=swL2IGMPCtrlState, swL2CosDscpPRITable=swL2CosDscpPRITable, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swl2NotificationBindings=swl2NotificationBindings, swL2TrunkVLANPort=swL2TrunkVLANPort, swL2IGMPRouteTimeout=swL2IGMPRouteTimeout, swL2PortSecurityControlEntry=swL2PortSecurityControlEntry, swL2McastFilterEntry=swL2McastFilterEntry, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2IGMPMulticastVlanReplacePriority=swL2IGMPMulticastVlanReplacePriority, swL2IGMPSnoopingClearDynIpMultVID=swL2IGMPSnoopingClearDynIpMultVID, swL2QOSSchedulingMaxWeight=swL2QOSSchedulingMaxWeight, swL2LoopDetectPortMgmt=swL2LoopDetectPortMgmt, swL2VlanAdvertiseState=swL2VlanAdvertiseState)
mibBuilder.exportSymbols("DES3052P-L2MGMT-MIB", swL2IGMPMulticastVlanRowStatus=swL2IGMPMulticastVlanRowStatus, swL2VlanIndex=swL2VlanIndex, swL2IGMPAccessAuthState=swL2IGMPAccessAuthState, swL2IGMPIpGroupReportCount=swL2IGMPIpGroupReportCount, swL2IGMPSnoopingClearDynIpMultAction=swL2IGMPSnoopingClearDynIpMultAction, swL2IGMPMulticastVlanTable=swL2IGMPMulticastVlanTable, swL2IGMPMulticastVlanName=swL2IGMPMulticastVlanName, swL2QOSMgmt=swL2QOSMgmt, swL2QOS8021pRadiusPriority=swL2QOS8021pRadiusPriority, swL2IGMPCtrlVid=swL2IGMPCtrlVid, swL2IGMPInfoQueryCount=swL2IGMPInfoQueryCount, swL2DhcpLocalRelayMgmt=swL2DhcpLocalRelayMgmt, swL2DevCtrlSubnetMask=swL2DevCtrlSubnetMask, swL2PortSecurityDelVlanName=swL2PortSecurityDelVlanName, swL2FloodMACAutoFDBTimestamp=swL2FloodMACAutoFDBTimestamp, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swIGMPSnoopingGroupIncludePortMap=swIGMPSnoopingGroupIncludePortMap, swL2McastFilterPortInfoTable=swL2McastFilterPortInfoTable, swL2macNotification=swL2macNotification, swL2CosPriorityCtrl=swL2CosPriorityCtrl, swL2McastFilterPortMaxGroup=swL2McastFilterPortMaxGroup, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swPortTrunkMasterPort=swPortTrunkMasterPort, swL2MgmtMIB=swL2MgmtMIB, swL2QOSBandwidthTxRate=swL2QOSBandwidthTxRate, swL2McastFilterProfileIndex=swL2McastFilterProfileIndex, swL2MACNotifyState=swL2MACNotifyState, swL2QOSBandwidthRadiusTxRate=swL2QOSBandwidthRadiusTxRate, swL2IGMPRouterPortEntry=swL2IGMPRouterPortEntry, swL2CosMgmt=swL2CosMgmt, swL2PortSecurityDelPort=swL2PortSecurityDelPort, swL2McastFilterPortInfoEntry=swL2McastFilterPortInfoEntry, swL2QOSSchedulingMechanism=swL2QOSSchedulingMechanism, swL2QOSBandwidthRadiusRxRate=swL2QOSBandwidthRadiusRxRate, swIGMPSnoopingGroupSourceAddr=swIGMPSnoopingGroupSourceAddr, swL2McastFilterProfileName=swL2McastFilterProfileName, swL2McastFilterPortMaxGroupEntry=swL2McastFilterPortMaxGroupEntry, swL2McastFilterAddOrDelState=swL2McastFilterAddOrDelState, VlanId=VlanId, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2FloodMACFDBTable=swL2FloodMACFDBTable, swL2FloodMACAutoFDBVID=swL2FloodMACAutoFDBVID, swL2MultiFilter=swL2MultiFilter, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2DevCtrlSystemIP=swL2DevCtrlSystemIP, swL2IGMPVid=swL2IGMPVid, swL2IGMPRouterPortVlanid=swL2IGMPRouterPortVlanid, swL2CosMacBasePRITable=swL2CosMacBasePRITable, swIGMPSnoopingGroupExpiryTime=swIGMPSnoopingGroupExpiryTime, swL2QOSSchedulingClassIndex=swL2QOSSchedulingClassIndex, swL2DevCtrlIGMPSnooping=swL2DevCtrlIGMPSnooping, swPortMirrorState=swPortMirrorState, swL2McastFilterPortTable=swL2McastFilterPortTable, swL2CosPriorityNone=swL2CosPriorityNone, swL2IGMPInfoVid=swL2IGMPInfoVid, swPortTrunkState=swPortTrunkState, swL2IGMPMulticastVlanGroupStatus=swL2IGMPMulticastVlanGroupStatus, swL2IGMPRouterPortDynamicPortList=swL2IGMPRouterPortDynamicPortList, swL2PortMgmt=swL2PortMgmt, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2CosPriorityIpPRI=swL2CosPriorityIpPRI, swL2IGMPRobustness=swL2IGMPRobustness, swL2DhcpRelayOption82Check=swL2DhcpRelayOption82Check, swL2IGMPMaxIpGroupNumPerVlan=swL2IGMPMaxIpGroupNumPerVlan, swL2CosPortPRIEntry=swL2CosPortPRIEntry, swL2FloodMACState=swL2FloodMACState, swL2FloodMACFDBEntry=swL2FloodMACFDBEntry, swL2TrunkVLANEntry=swL2TrunkVLANEntry, swL2QOS8021pDefaultPriority=swL2QOS8021pDefaultPriority, swIGMPSnoopingGroupVid=swIGMPSnoopingGroupVid, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2LoopDetectPortEntry=swL2LoopDetectPortEntry, swL2PortErrPortIndex=swL2PortErrPortIndex, swL2QOS8021pDefaultPriorityIndex=swL2QOS8021pDefaultPriorityIndex, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swL2TrunkVLANState=swL2TrunkVLANState, swL2DevCtrl=swL2DevCtrl, swL2IGMPMulticastVlanState=swL2IGMPMulticastVlanState, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swIGMPSnoopingGroupEntry=swIGMPSnoopingGroupEntry, swL2PortSecurityMgmt=swL2PortSecurityMgmt, swL2IGMPMulticastVlanUntagSourcePort=swL2IGMPMulticastVlanUntagSourcePort, MacAddress=MacAddress)
