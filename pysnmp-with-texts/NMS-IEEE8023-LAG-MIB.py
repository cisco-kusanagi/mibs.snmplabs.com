...
# Produced by pysmi-0.3.4 at Wed May  1 14:22:05 2019
...
TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, iso, Counter64, Gauge32, Unsigned32, Counter32, NotificationType, MibIdentifier, IpAddress, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "iso", "Counter64", "Gauge32", "Unsigned32", "Counter32", "NotificationType", "MibIdentifier", "IpAddress", "ObjectIdentity", "ModuleIdentity")
...
if mibBuilder.loadTexts: lagMIB.setContactInfo('')
if mibBuilder.loadTexts: lagMIB.setDescription('The Link Aggregation module for managing IEEE Std 802.3ad.')
...
class LagMode(TextualConvention, Integer32):
    description = 'The link aggregation control mode.'
    status = 'current'
...
if mibBuilder.loadTexts: dot3adAggMaxNum.setDescription('A value indicates the max number of Aggregators supported in the system.')
...
if mibBuilder.loadTexts: dot3adAggPortsMaxNum.setDescription('A value indicates the max number of aggregated ports in one Aggregator.')
...
if mibBuilder.loadTexts: dot3adAggIfIndex.setDescription('The interface index of this Aggregator.')
...
if mibBuilder.loadTexts: dot3adAggAdminMode.setDescription('The default aggregation control mode of this Aggregator.')
...
if mibBuilder.loadTexts: dot3adAggOperMode.setDescription('The running aggregation control mode of this Aggregator.')
...
if mibBuilder.loadTexts: dot3adAggRowStatus.setDescription("This object indicates the status of this entry. Set this value to 'createAndGo' to create a new aggregator.")
...
if mibBuilder.loadTexts: dot3adAggPortListAggregatedPorts.setDescription('The complete set of ports currently aggregated in this Aggregator.')
...
if mibBuilder.loadTexts: dot3adAggPortActorAdminKey.setDescription('The current administrative value of the Key for the Aggregation Port. This is a 16-bit read-only value. The meaning of particular Key values is of local significance.')
...
if mibBuilder.loadTexts: dot3adAggPortPartnerAdminSystemID.setDescription("A 6-octet read-only MACAddress value representing the administrative value of the Aggregation Port's protocol Partner's System ID. The assigned value is used, along with the value of aAggPortPartnerAdminSystemPriority, aAggPortPartnerAdminKey, aAggPortPartnerAdminPort, and aAggPortPartnerAdminPortPriority, in order to achieve manually configured aggregation.")
...
if mibBuilder.loadTexts: dot3adAggPortActorPortPriority.setDescription('The priority value assigned to this Aggregation Port. This 16-bit value is read-only.')
...
if mibBuilder.loadTexts: dot3adAggPortPartnerAdminPort.setDescription('The current administrative value of the port number for the protocol Partner. This is a 16-bit read-only value. The assigned value is used, along with the value of aAggPortPartnerAdminSystemPriority, aAggPortPartnerAdminSystemID, aAggPortPartnerAdminKey, and aAggPortPartnerAdminPortPriority, in order to achieve manually configured aggregation.')
...
if mibBuilder.loadTexts: dot3adAggPortPartnerAdminPortPriority.setDescription('The current administrative value of the port priority for the protocol Partner. This is a 16-bit read-only value. The assigned value is used, along with the value of aAggPortPartnerAdminSystemPriority, aAggPortPartnerAdminSystemID, aAggPortPartnerAdminKey, and aAggPortPartnerAdminPort, in order to achieve manually configured aggregation.')
...
if mibBuilder.loadTexts: dot3adAggPortPartnerAdminState.setDescription('A string of 8 bits, corresponding to the current administrative value of Actor_State for the protocol Partner. The bit allocations are as defined in 30.7.2.1.20. This attribute value is read-only. The assigned value is used in order to achieve manually configured aggregation.')
...
if mibBuilder.loadTexts: dot3adAggPortOperMode.setDescription('The running link aggregation control mode.')
...
if mibBuilder.loadTexts: dot3adAggPortStatsUnknownRx.setDescription('The number of frames received that either: - carry the Slow Protocols Ethernet Type value (43B.4), but contain an unknown PDU, or: - are addressed to the Slow Protocols group MAC Address (43B.3), but do not carry the Slow Protocols Ethernet Type. This value is read-only.')
...
mibBuilder.exportSymbols("NMS-IEEE8023-LAG-MIB", dot3adTablesLastChangedGroup=dot3adTablesLastChangedGroup, dot3adAggCompliance=dot3adAggCompliance, PYSNMP_MODULE_ID=lagMIB, dot3adAggPortActorPort=dot3adAggPortActorPort, dot3adAggPartnerSystemPriority=dot3adAggPartnerSystemPriority, dot3adAggPortStatsLACPDUsRx=dot3adAggPortStatsLACPDUsRx, dot3adAggMaxNum=dot3adAggMaxNum, dot3adAggPortPartnerAdminPort=dot3adAggPortPartnerAdminPort, dot3adAggPortSelectedAggID=dot3adAggPortSelectedAggID, dot3adAggAdminMode=dot3adAggAdminMode, dot3adAgg=dot3adAgg, dot3adAggPortStatsEntry=dot3adAggPortStatsEntry, dot3adAggPortDebugActorChangeCount=dot3adAggPortDebugActorChangeCount, dot3adAggPortIndex=dot3adAggPortIndex, dot3adAggPortStatsUnknownRx=dot3adAggPortStatsUnknownRx, dot3adAggPortActorOperState=dot3adAggPortActorOperState, dot3adAggRowStatus=dot3adAggRowStatus, dot3adAggIndex=dot3adAggIndex, dot3adAggConformance=dot3adAggConformance, dot3adAggPortDebugActorChurnCount=dot3adAggPortDebugActorChurnCount, dot3adAggPortListTable=dot3adAggPortListTable, dot3adAggPortActorSystemID=dot3adAggPortActorSystemID, dot3adAggMACAddress=dot3adAggMACAddress, dot3adAggPortStatsIllegalRx=dot3adAggPortStatsIllegalRx, dot3adAggPortDebugPartnerChurnState=dot3adAggPortDebugPartnerChurnState, dot3adAggPortActorAdminKey=dot3adAggPortActorAdminKey, dot3adAggPortActorSystemPriority=dot3adAggPortActorSystemPriority, dot3adAggPortPartnerOperSystemPriority=dot3adAggPortPartnerOperSystemPriority, dot3adAggEntry=dot3adAggEntry, dot3adAggPortActorPortPriority=dot3adAggPortActorPortPriority, dot3adAggPartnerSystemID=dot3adAggPartnerSystemID, dot3adAggPortStatsLACPDUsTx=dot3adAggPortStatsLACPDUsTx, dot3adAggOperMode=dot3adAggOperMode, lagMIBObjects=lagMIBObjects, dot3adAggPortDebugMuxState=dot3adAggPortDebugMuxState, dot3adAggPortStatsMarkerResponsePDUsTx=dot3adAggPortStatsMarkerResponsePDUsTx, dot3adAggPortDebugPartnerChangeCount=dot3adAggPortDebugPartnerChangeCount, dot3adAggPortDebugActorSyncTransitionCount=dot3adAggPortDebugActorSyncTransitionCount, dot3adAggActorSystemPriority=dot3adAggActorSystemPriority, dot3adAggPortAttachedAggID=dot3adAggPortAttachedAggID, dot3adAggPortPartnerAdminState=dot3adAggPortPartnerAdminState, LacpState=LacpState, dot3adAggPortListPorts=dot3adAggPortListPorts, dot3adAggPortPartnerAdminKey=dot3adAggPortPartnerAdminKey, dot3adAggPortListEntry=dot3adAggPortListEntry, dot3adAggPortListAggregatedPorts=dot3adAggPortListAggregatedPorts, dot3adAggActorSystemID=dot3adAggActorSystemID, dot3adAggPortAggregateOrIndividual=dot3adAggPortAggregateOrIndividual, dot3adAggPortDebugMuxReason=dot3adAggPortDebugMuxReason, dot3adAggPortStatsMarkerPDUsTx=dot3adAggPortStatsMarkerPDUsTx, dot3adTablesLastChanged=dot3adTablesLastChanged, dot3adAggPortPartnerOperKey=dot3adAggPortPartnerOperKey, dot3adAggActorOperKey=dot3adAggActorOperKey, dot3adAggPortEntry=dot3adAggPortEntry, dot3adAggPortPartnerOperPort=dot3adAggPortPartnerOperPort, dot3adAggPortStatsMarkerPDUsRx=dot3adAggPortStatsMarkerPDUsRx, dot3adAggTable=dot3adAggTable, dot3adAggActorAdminKey=dot3adAggActorAdminKey, dot3adAggPortActorOperKey=dot3adAggPortActorOperKey, dot3adAggPortPartnerOperPortPriority=dot3adAggPortPartnerOperPortPriority, dot3adAggPortActorAdminState=dot3adAggPortActorAdminState, dot3adAggPortPartnerAdminPortPriority=dot3adAggPortPartnerAdminPortPriority, ChurnState=ChurnState, dot3adAggPartnerOperKey=dot3adAggPartnerOperKey, dot3adAggPortPartnerAdminSystemPriority=dot3adAggPortPartnerAdminSystemPriority, dot3adAggGroup=dot3adAggGroup, dot3adAggPortDebugTable=dot3adAggPortDebugTable, LacpKey=LacpKey, dot3adAggPortStatsTable=dot3adAggPortStatsTable, dot3adAggPortDebugLastRxTime=dot3adAggPortDebugLastRxTime, dot3adAggPortTable=dot3adAggPortTable, dot3adAggGroups=dot3adAggGroups, dot3adAggIfIndex=dot3adAggIfIndex, dot3adAggPortOperMode=dot3adAggPortOperMode, dot3adAggPortStatsMarkerResponsePDUsRx=dot3adAggPortStatsMarkerResponsePDUsRx, dot3adAggCollectorMaxDelay=dot3adAggCollectorMaxDelay, dot3adAggPortDebugPartnerChurnCount=dot3adAggPortDebugPartnerChurnCount, dot3adAggPortStatsGroup=dot3adAggPortStatsGroup, dot3adAggPortPartnerOperSystemID=dot3adAggPortPartnerOperSystemID, LagMode=LagMode, dot3adAggPortDebugPartnerSyncTransitionCount=dot3adAggPortDebugPartnerSyncTransitionCount, dot3adAggPortPartnerAdminSystemID=dot3adAggPortPartnerAdminSystemID, dot3adAggPortPartnerOperState=dot3adAggPortPartnerOperState, dot3adAggPortGroup=dot3adAggPortGroup, dot3adAggPortListGroup=dot3adAggPortListGroup, dot3adAggPort=dot3adAggPort, dot3adAggPortDebugGroup=dot3adAggPortDebugGroup, dot3adAggPortDebugActorChurnState=dot3adAggPortDebugActorChurnState, dot3adAggPortsMaxNum=dot3adAggPortsMaxNum, dot3adAggPortDebugRxState=dot3adAggPortDebugRxState, dot3adAggPortDebugEntry=dot3adAggPortDebugEntry, dot3adAggAggregateOrIndividual=dot3adAggAggregateOrIndividual, dot3adAggCompliances=dot3adAggCompliances, lagMIB=lagMIB)
