...
NotificationType, ObjectIdentity, MibIdentifier, Bits, Counter64, Unsigned32, iso, IpAddress, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, TimeTicks, ModuleIdentity, Counter32, experimental = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "ObjectIdentity", "MibIdentifier", "Bits", "Counter64", "Unsigned32", "iso", "IpAddress", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "TimeTicks", "ModuleIdentity", "Counter32", "experimental")
...
if mibBuilder.loadTexts: mplsVpnVrfBgpPAtrPeerType.setDescription('Address type of the mplsVpnVrfBgpPAtrPeer object.')
...
if mibBuilder.loadTexts: mplsVpnVrfBgpPAtrIpAddrPfxType.setDescription('Address type of the mplsVpnVrfBgpPAtrIpAddrPrefix object.')
...
if mibBuilder.loadTexts: mplsVpnVrfBgpPAtrNextHopType.setDescription('Address type of the mplsVpnVrfBgpPAtrNextHop object.')
...
if mibBuilder.loadTexts: mplsVpnVrfBgpPAtrAggrAddrType.setDescription('Address type of the mplsVpnVrfBgpPAtrAggrAddr object.')
...
mibBuilder.exportSymbols("MPLS-VPN-MIB-DRAFT-05", mplsVpnVrfRouteMetric5=mplsVpnVrfRouteMetric5, mplsVpnNotifications=mplsVpnNotifications, mplsVpnIfVpnRouteDistProtocol=mplsVpnIfVpnRouteDistProtocol, mplsVpnVrfBgpNbrAddrEntry=mplsVpnVrfBgpNbrAddrEntry, mplsVpnIfGroup=mplsVpnIfGroup, mplsVpnVrfBgpPAtrAtomicAggregate=mplsVpnVrfBgpPAtrAtomicAggregate, mplsVpnVrfRouteTargetEntry=mplsVpnVrfRouteTargetEntry, mplsVpnVrfVpnId=mplsVpnVrfVpnId, mplsVpnVrfRouteMetric2=mplsVpnVrfRouteMetric2, mplsNumVrfRouteMaxThreshExceeded=mplsNumVrfRouteMaxThreshExceeded, mplsVpnVrfConfHighRouteThreshold=mplsVpnVrfConfHighRouteThreshold, mplsVrfIfUp=mplsVrfIfUp, mplsVpnVrfRouteTarget=mplsVpnVrfRouteTarget, mplsVpnVrfCreationTime=mplsVpnVrfCreationTime, mplsVpnVrfRouteTargetGroup=mplsVpnVrfRouteTargetGroup, mplsVpnVrfPerfCurrNumRoutes=mplsVpnVrfPerfCurrNumRoutes, mplsVpnVrfBgpPAtrNextHop=mplsVpnVrfBgpPAtrNextHop, mplsVpnVrfBgpNbrGroup=mplsVpnVrfBgpNbrGroup, mplsVpnVrfRouteTargetRowStatus=mplsVpnVrfRouteTargetRowStatus, mplsVpnNotificationGroup=mplsVpnNotificationGroup, mplsVpnVrfBgpPrefixGroup=mplsVpnVrfBgpPrefixGroup, mplsVpnConformance=mplsVpnConformance, mplsVpnVrfBgpNbrRowStatus=mplsVpnVrfBgpNbrRowStatus, mplsVpnVrfBgpPAtrIpAddrPrefix=mplsVpnVrfBgpPAtrIpAddrPrefix, mplsVpnVrfRouteRowStatus=mplsVpnVrfRouteRowStatus, mplsVpnVrfRouteMetric4=mplsVpnVrfRouteMetric4, mplsVpnVrfConfRouteMaxThreshTime=mplsVpnVrfConfRouteMaxThreshTime, mplsVpnVrfRouteTable=mplsVpnVrfRouteTable, mplsVpnVrfBgpPAtrAggregatorAS=mplsVpnVrfBgpPAtrAggregatorAS, mplsVpnVrfBgpPAtrCalcLocalPref=mplsVpnVrfBgpPAtrCalcLocalPref, mplsVpnVrfRouteNextHop=mplsVpnVrfRouteNextHop, mplsVpnVrfPerfRoutesDeleted=mplsVpnVrfPerfRoutesDeleted, mplsVpnIfConfEntry=mplsVpnIfConfEntry, mplsVpnVrfRouteEntry=mplsVpnVrfRouteEntry, mplsVpnVrfPerfTable=mplsVpnVrfPerfTable, mplsVpnVrfRouteMetric1=mplsVpnVrfRouteMetric1, mplsVpnVrfBgpPAtrLocalPref=mplsVpnVrfBgpPAtrLocalPref, mplsNumVrfRouteMaxThreshCleared=mplsNumVrfRouteMaxThreshCleared, PYSNMP_MODULE_ID=mplsVpnMIB, mplsVpnVrfBgpPAtrIpAddrPrefixLen=mplsVpnVrfBgpPAtrIpAddrPrefixLen, mplsVpnIfConfRowStatus=mplsVpnIfConfRowStatus, mplsVpnScalarGroup=mplsVpnScalarGroup, mplsVpnIfVpnClassification=mplsVpnIfVpnClassification, mplsVpnVrfConfStorageType=mplsVpnVrfConfStorageType, mplsVpnIfLabelEdgeType=mplsVpnIfLabelEdgeType, mplsVpnVrfPerfRoutesAdded=mplsVpnVrfPerfRoutesAdded, mplsVpnVrfConfMaxPossibleRoutes=mplsVpnVrfConfMaxPossibleRoutes, mplsVpnVrfBgpPAtrAggrAddrType=mplsVpnVrfBgpPAtrAggrAddrType, mplsVpnObjects=mplsVpnObjects, mplsVpnVrfRouteMaskAddrType=mplsVpnVrfRouteMaskAddrType, mplsVpnVrfBgpNbrIndex=mplsVpnVrfBgpNbrIndex, mplsVpnVrfRouteTos=mplsVpnVrfRouteTos, mplsVpnVrfSecIllegalLblRcvThrsh=mplsVpnVrfSecIllegalLblRcvThrsh, mplsVpnVrfOperStatus=mplsVpnVrfOperStatus, mplsVpnVrfRouteDestAddrType=mplsVpnVrfRouteDestAddrType, mplsVpnVrfGroup=mplsVpnVrfGroup, mplsVpnIfConfIndex=mplsVpnIfConfIndex, mplsVpnVrfConfLastChanged=mplsVpnVrfConfLastChanged, mplsVpnVrfBgpNbrType=mplsVpnVrfBgpNbrType, mplsVpnVrfBgpNbrPrefixTable=mplsVpnVrfBgpNbrPrefixTable, mplsVpnVrfBgpPAtrASPathSegment=mplsVpnVrfBgpPAtrASPathSegment, mplsVpnSecGroup=mplsVpnSecGroup, mplsVpnVrfRouteTargetIndex=mplsVpnVrfRouteTargetIndex, mplsVpnIfConfTable=mplsVpnIfConfTable, mplsVpnPerf=mplsVpnPerf, mplsVpnVrfConfMaxRoutes=mplsVpnVrfConfMaxRoutes, mplsVpnConfiguredVrfs=mplsVpnConfiguredVrfs, mplsVpnVrfRouteInfo=mplsVpnVrfRouteInfo, mplsVpnVrfRouteTargetTable=mplsVpnVrfRouteTargetTable, mplsVpnVrfRouteDest=mplsVpnVrfRouteDest, mplsVpnVrfRouteNextHopAddrType=mplsVpnVrfRouteNextHopAddrType, mplsVpnVrfBgpPAtrUnknown=mplsVpnVrfBgpPAtrUnknown, mplsVpnVrfBgpPAtrIpAddrPfxType=mplsVpnVrfBgpPAtrIpAddrPfxType, mplsVpnPerfGroup=mplsVpnPerfGroup, mplsVpnVrfRouteGroup=mplsVpnVrfRouteGroup, mplsVpnVrfBgpPAtrPeer=mplsVpnVrfBgpPAtrPeer, mplsVpnVrfBgpPAtrMultiExitDisc=mplsVpnVrfBgpPAtrMultiExitDisc, mplsVpnVrfBgpPAtrBest=mplsVpnVrfBgpPAtrBest, mplsVpnConf=mplsVpnConf, mplsVpnVrfRouteProto=mplsVpnVrfRouteProto, mplsVpnVrfRouteMetric3=mplsVpnVrfRouteMetric3, mplsVpnCompliances=mplsVpnCompliances, mplsVpnVrfRouteType=mplsVpnVrfRouteType, mplsVpnActiveVrfs=mplsVpnActiveVrfs, mplsVpnVrfName=mplsVpnVrfName, mplsVpnModuleCompliance=mplsVpnModuleCompliance, mplsVpnVrfRouteAge=mplsVpnVrfRouteAge, mplsVpnGroups=mplsVpnGroups, mplsVpnVrfBgpNbrAddrTable=mplsVpnVrfBgpNbrAddrTable, mplsVpnVrfBgpPAtrAggregatorAddr=mplsVpnVrfBgpPAtrAggregatorAddr, mplsVpnNotificationEnable=mplsVpnNotificationEnable, mplsVpnVrfRouteIfIndex=mplsVpnVrfRouteIfIndex, mplsNumVrfRouteMidThreshExceeded=mplsNumVrfRouteMidThreshExceeded, mplsVpnRoute=mplsVpnRoute, mplsVpnVrfAssociatedInterfaces=mplsVpnVrfAssociatedInterfaces, mplsVpnVrfEntry=mplsVpnVrfEntry, mplsVpnVrfRouteTargetType=mplsVpnVrfRouteTargetType, mplsVpnVrfConfMidRouteThreshold=mplsVpnVrfConfMidRouteThreshold, mplsVpnVrfBgpNbrAddr=mplsVpnVrfBgpNbrAddr, MplsVpnName=MplsVpnName, mplsVpnVrfBgpNbrRole=mplsVpnVrfBgpNbrRole, mplsVpnVrfRouteTargetDescr=mplsVpnVrfRouteTargetDescr, mplsVpnVrfBgpPAtrPeerType=mplsVpnVrfBgpPAtrPeerType, mplsVpnVrfConfRowStatus=mplsVpnVrfConfRowStatus, mplsVpnVrfSecEntry=mplsVpnVrfSecEntry, mplsVpnMIB=mplsVpnMIB, mplsVpnVrfActiveInterfaces=mplsVpnVrfActiveInterfaces, mplsVpnVrfRouteMask=mplsVpnVrfRouteMask, mplsVpnVrfDescription=mplsVpnVrfDescription, mplsVpnIfConfStorageType=mplsVpnIfConfStorageType, mplsVpnVrfBgpNbrStorageType=mplsVpnVrfBgpNbrStorageType, MplsVpnRouteDistinguisher=MplsVpnRouteDistinguisher, mplsVpnVrfSecTable=mplsVpnVrfSecTable, mplsVpnScalars=mplsVpnScalars, mplsVpnVrfTable=mplsVpnVrfTable, mplsVpnVrfBgpPAtrNextHopType=mplsVpnVrfBgpPAtrNextHopType, mplsVpnVrfRouteDistinguisher=mplsVpnVrfRouteDistinguisher, mplsVpnVrfRouteNextHopAS=mplsVpnVrfRouteNextHopAS, mplsNumVrfSecIllglLblThrshExcd=mplsNumVrfSecIllglLblThrshExcd, mplsVpnVrfRouteStorageType=mplsVpnVrfRouteStorageType, mplsVpnVrfBgpNbrPrefixEntry=mplsVpnVrfBgpNbrPrefixEntry, mplsVpnConnectedInterfaces=mplsVpnConnectedInterfaces, mplsVpnVrfBgpPAtrOrigin=mplsVpnVrfBgpPAtrOrigin, mplsVrfIfDown=mplsVrfIfDown, mplsVpnVrfPerfEntry=mplsVpnVrfPerfEntry, mplsVpnVrfSecIllegalLblVltns=mplsVpnVrfSecIllegalLblVltns)
