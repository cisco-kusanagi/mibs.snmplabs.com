...
# Produced by pysmi-0.3.4 at Wed May  1 15:35:48 2019
...
Unsigned32, TimeTicks, NotificationType, MibIdentifier, Counter32, Counter64, IpAddress, Bits, ModuleIdentity, enterprises, ObjectIdentity, Gauge32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "TimeTicks", "NotificationType", "MibIdentifier", "Counter32", "Counter64", "IpAddress", "Bits", "ModuleIdentity", "enterprises", "ObjectIdentity", "Gauge32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso")
...
if mibBuilder.loadTexts: wag302.setContactInfo('4500 Great America Parkway Santa Clara, California 95054 Phone: (408) 907-8000 Fax: (408) 907-8097 Web Site: http://www.netgear.com')
if mibBuilder.loadTexts: wag302.setDescription('The MIB module for 802.11a/b/g ProSafe Wireless Access Point entities. iso(1).org(3).dod(6).internet(1).private(4). enterprises(1).netgear(4526).wireless(4).wag302(7)')
...
if mibBuilder.loadTexts: apName.setDescription('The field indicates the name of AP. The name is also the NETBIOS name of the AP.')
...
if mibBuilder.loadTexts: sysCountryRegion.setDescription('This attribute shall indicate the region of operation for which which the wireless interface is intended.')
...
if mibBuilder.loadTexts: operatemode.setDescription('This attribute shall indicate the desired wireless operating mode. The option are: auto - Both 802.11g and 802.11b wireless stations can be used. dot11a - Only 802.11a wireless stations can be used. dot11b - All 802.11b wireless stations can be used. 802.11g wireless stations can still be used if they can operate in 802.11b mode. dot11g - Only 802.11g wireless stations can be used.')
...
if mibBuilder.loadTexts: trapServerCommunity.setDescription('The field indicates the community name for traps.')
...
mibBuilder.exportSymbols("WAG302", sndacntipaddr=sndacntipaddr, timeSettings=timeSettings, untaggedVlanID=untaggedVlanID, dtiminterval=dtiminterval, knownapssid=knownapssid, preambletype=preambletype, wlanseparator=wlanseparator, unknownapchannel=unknownapchannel, wlantransmulticastpacket=wlantransmulticastpacket, unknownapband=unknownapband, txpower=txpower, vapSettingEntry=vapSettingEntry, vapIndex=vapIndex, knownapnumBeacons=knownapnumBeacons, unknownapbeaconInterval=unknownapbeaconInterval, knownApTable=knownApTable, wmmSupport=wmmSupport, pxpremotemacaddress2=pxpremotemacaddress2, unknownapprivacy=unknownapprivacy, syslogsrvport=syslogsrvport, wlanrecvbroadcastpacket=wlanrecvbroadcastpacket, vapEnable=vapEnable, vlanEnable=vlanEnable, stationstatus=stationstatus, sndradport=sndradport, resetAP=resetAP, aprate=aprate, trapServerCommunity=trapServerCommunity, logSettings=logSettings, httpRedirectEnable=httpRedirectEnable, apmac=apmac, channel=channel, snddnsipAddr=snddnsipAddr, hidenetworkname=hidenetworkname, knownapbeaconInterval=knownapbeaconInterval, wlanSettingEntry=wlanSettingEntry, unknownapmac=unknownapmac, dhcpsipstart=dhcpsipstart, rtsthreshold=rtsthreshold, syslog=syslog, priradipaddr=priradipaddr, lantransbytes=lantransbytes, dhcpspsndwins=dhcpspsndwins, apband=apband, knownaplastBeacon=knownaplastBeacon, vapSetting=vapSetting, knownapchannel=knownapchannel, accntinfo=accntinfo, aclMAC=aclMAC, unknownApEntry=unknownApEntry, macaddress=macaddress, knownapEntryStatus=knownapEntryStatus, sndacntsharedsecret=sndacntsharedsecret, wirelessStatTable=wirelessStatTable, knownApEntry=knownApEntry, repremotemacaddress4=repremotemacaddress4, pxpremotemacaddress1=pxpremotemacaddress1, adminPasswd=adminPasswd, clientWirelessMode=clientWirelessMode, unknownapssid=unknownapssid, priacntipaddr=priacntipaddr, detectedApEntry=detectedApEntry, unknownaplastBeacon=unknownaplastBeacon, datarate=datarate, sysVersion=sysVersion, detectedApTable=detectedApTable, wlantransbytes=wlantransbytes, priradsharedsecret=priradsharedsecret, apName=apName, wiredethernetstat=wiredethernetstat, wlanWdsEntry=wlanWdsEntry, sysCountryRegion=sysCountryRegion, key1=key1, knownaprate=knownaprate, repremotemacaddress2=repremotemacaddress2, keyno=keyno, wlantransbroadcastpacket=wlantransbroadcastpacket, knownapband=knownapband, wlanAccessControlLocalTable=wlanAccessControlLocalTable, knownapmac=knownapmac, wlanSettingTable=wlanSettingTable, wlanWdsTable=wlanWdsTable, wirelessStatEntry=wirelessStatEntry, managementVlanID=managementVlanID, netmaskAddr=netmaskAddr, wepPassPhrase=wepPassPhrase, vapSettingTable=vapSettingTable, key2=key2, apssid=apssid, aplastBeacon=aplastBeacon, priacntport=priacntport, lanSettings=lanSettings, aclMacStatus=aclMacStatus, vapWepAndGlobalSettingTable=vapWepAndGlobalSettingTable, info802dot1x=info802dot1x, clientIpaddr=clientIpaddr, vlanID=vlanID, unknownaprate=unknownaprate, lanrecvpacket=lanrecvpacket, readOnlyCommunity=readOnlyCommunity, trapServerIP=trapServerIP, daylightsaving=daylightsaving, remoteSettings=remoteSettings, wlanrecvbytes=wlanrecvbytes, sshd=sshd, sndradsharedsecret=sndradsharedsecret, timezone=timezone, currenttime=currenttime, dhcpspsnddns=dhcpspsnddns, apbeaconInterval=apbeaconInterval, repremotemacaddress1=repremotemacaddress1, dhcpsleasetime=dhcpsleasetime, wlanrecvmulticastpacket=wlanrecvmulticastpacket, dhcpspridns=dhcpspridns, ipAddr=ipAddr, spantree=spantree, apchannel=apchannel, wlantranspacket=wlantranspacket, wlanAccessControlLocalEntry=wlanAccessControlLocalEntry, dhcpsSettings=dhcpsSettings, dhcpserver=dhcpserver, priacntsharedsecret=priacntsharedsecret, accessControlMode=accessControlMode, statistic=statistic, pxpremotemacaddress3=pxpremotemacaddress3, superG=superG, syslogsrvip=syslogsrvip, knownapprivacy=knownapprivacy, wireless=wireless, sndacntport=sndacntport, dhcpnetmask=dhcpnetmask, operatemode=operatemode, lanrecvbytes=lanrecvbytes, repremotemacaddress3=repremotemacaddress3, ptpremotemacaddress=ptpremotemacaddress, apmode=apmode, adminName=adminName, sndradipaddr=sndradipaddr, pridnsipAddr=pridnsipAddr, httpRedirectSettings=httpRedirectSettings, snmpenable=snmpenable, beaconinterval=beaconinterval, stationListEntry=stationListEntry, encryption=encryption, userCommand=userCommand, fraglength=fraglength, radioEnable=radioEnable, gatewayAddr=gatewayAddr, netgear=netgear, wlantransunicastpacket=wlantransunicastpacket, apnumBeacons=apnumBeacons, wag302=wag302, vapWepAndGlobalSettingEntry=vapWepAndGlobalSettingEntry, dhcpsipend=dhcpsipend, authenticationtype=authenticationtype, presharekey=presharekey, unknownApTable=unknownApTable, readWriteCommunity=readWriteCommunity, wlanrecvpacket=wlanrecvpacket, unknownapnumBeacons=unknownapnumBeacons, lantranspacket=lantranspacket, httpRedirectURL=httpRedirectURL, priradport=priradport, PYSNMP_MODULE_ID=wag302, dhcpStatus=dhcpStatus, dhcpsgateway=dhcpsgateway, wepKeyType=wepKeyType, sysMacAddress=sysMacAddress, key3=key3, securityProfileName=securityProfileName, pxpremotemacaddress4=pxpremotemacaddress4, dhcpspriwins=dhcpspriwins, stationListTable=stationListTable, localMacAddress=localMacAddress, authinfo=authinfo, key4=key4, ssid=ssid, apprivacy=apprivacy, antenna=antenna, wlanrecvunicastpacket=wlanrecvunicastpacket)
