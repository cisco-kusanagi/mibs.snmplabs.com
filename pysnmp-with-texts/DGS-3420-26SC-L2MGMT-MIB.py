...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS-3420-26SC-L2MGMT-MIB
...
MibScalar, MibTable, MibTableRow, MibTableColumn, iso, NotificationType, MibIdentifier, Counter32, ModuleIdentity, ObjectIdentity, Bits, Counter64, Unsigned32, Gauge32, TimeTicks, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "NotificationType", "MibIdentifier", "Counter32", "ModuleIdentity", "ObjectIdentity", "Bits", "Counter64", "Unsigned32", "Gauge32", "TimeTicks", "Integer32", "IpAddress")
...
swL2PortInfoErrorDisabled = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 6, 2, 3, 1, 1, 8), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3, 4, 5, 6))).clone(namedValues=NamedValues(("none", 0), ("storm", 1), ("stp-lbd", 2), ("ctp-lbd", 3), ("ddm", 4), ("bpdu-protection", 5), ("unknow", 6)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("DGS-3420-26SC-L2MGMT-MIB", swL2macNotificationSeverity=swL2macNotificationSeverity, swL2DevCtrlIpAutoconfig=swL2DevCtrlIpAutoconfig, swL2DevCtrlCFMPortEntry=swL2DevCtrlCFMPortEntry, swL2NotifyMgmt=swL2NotifyMgmt, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2PortJumboFrameCtrlPortState=swL2PortJumboFrameCtrlPortState, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2NotifyPrefix=swL2NotifyPrefix, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2PortCtrlMediumType=swL2PortCtrlMediumType, swL2MulticastFilterVid=swL2MulticastFilterVid, swL2DevCtrlCFMPortIndex=swL2DevCtrlCFMPortIndex, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2MirrorGroupLogicTargetPort=swL2MirrorGroupLogicTargetPort, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2DevCtrlCFMMepEntry=swL2DevCtrlCFMMepEntry, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swL2TrunkVLANTable=swL2TrunkVLANTable, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2VlanPortInfoTable=swL2VlanPortInfoTable, swL2DevAlarm=swL2DevAlarm, swL2MulticastFilterModeVlanEntry=swL2MulticastFilterModeVlanEntry, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2MirrorMgmt=swL2MirrorMgmt, swL2TrunkIndex=swL2TrunkIndex, swL2macNotifyInfo=swL2macNotifyInfo, swL2PVIDAutoAssignmentState=swL2PVIDAutoAssignmentState, swL2DevCtrlSnmpTrapState=swL2DevCtrlSnmpTrapState, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2DevCtrlAsymVlanState=swL2DevCtrlAsymVlanState, swL2DevCtrlCFMState=swL2DevCtrlCFMState, swL2TrunkVLANEntry=swL2TrunkVLANEntry, swL2PortMgmt=swL2PortMgmt, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2VlanStaticTable=swL2VlanStaticTable, swL2PortSecurityViolationSeverity=swL2PortSecurityViolationSeverity, swL2DevCtrlCFMMaTable=swL2DevCtrlCFMMaTable, swL2DevCtrlVLANTrunkState=swL2DevCtrlVLANTrunkState, swL2TrunkMember=swL2TrunkMember, swl2NotificationBidings=swl2NotificationBidings, swL2DevMgmt=swL2DevMgmt, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2DevCtrlCFMPortTable=swL2DevCtrlCFMPortTable, PortList=PortList, swL2DevCtrlCFMMaMode=swL2DevCtrlCFMMaMode, swL2MirrorPortState=swL2MirrorPortState, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2DevCtrlCFMMaEntry=swL2DevCtrlCFMMaEntry, swL2PortCounterCtrlTable=swL2PortCounterCtrlTable, swL2DevCtrlCFMMepTable=swL2DevCtrlCFMMepTable, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, PYSNMP_MODULE_ID=swL2MgmtMIB, VlanId=VlanId, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swL2PortCtrlLearningState=swL2PortCtrlLearningState, swL2DevCtrl=swL2DevCtrl, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2MulticastFilterVlanMode=swL2MulticastFilterVlanMode, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2MirrorGroupRowStatus=swL2MirrorGroupRowStatus, swL2Notify=swL2Notify, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2TrunkMgmt=swL2TrunkMgmt, swL2MulticastFilterMode=swL2MulticastFilterMode, swL2PortInfoErrorDisabled=swL2PortInfoErrorDisabled, swL2TrunkType=swL2TrunkType, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2TrafficSegTable=swL2TrafficSegTable, swL2PortCtrlTable=swL2PortCtrlTable, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2MirrorGroupState=swL2MirrorGroupState, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2VLANAdvertisement=swL2VLANAdvertisement, swL2NniGvrpBpduAddress=swL2NniGvrpBpduAddress, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2PortInfoUnitID=swL2PortInfoUnitID, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2MirrorGroupPortSourceEngress=swL2MirrorGroupPortSourceEngress, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2MirrorGroupPortSourceIngress=swL2MirrorGroupPortSourceIngress, swL2PortCtrlJumboFrameMaxSize=swL2PortCtrlJumboFrameMaxSize, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2MACNotifyState=swL2MACNotifyState, swL2MgmtMIB=swL2MgmtMIB, swL2PortInfoTable=swL2PortInfoTable, swL2PortInfoType=swL2PortInfoType, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2VLANMgmt=swL2VLANMgmt, swL2TrafficSegPort=swL2TrafficSegPort, swL2VlanPortInfoEntry=swL2VlanPortInfoEntry, MacAddress=MacAddress, swL2VlanPortInfoVid=swL2VlanPortInfoVid, swL2PortCounterClearCtrl=swL2PortCounterClearCtrl, swL2DevCtrlCFM=swL2DevCtrlCFM, swL2VlanPortInfoPortRole=swL2VlanPortInfoPortRole, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2MirrorGroupTable=swL2MirrorGroupTable, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2PortCounterCtrlEntry=swL2PortCounterCtrlEntry, swL2PortCounterCtrlPortIndex=swL2PortCounterCtrlPortIndex, swL2DevCtrlCFMMepMode=swL2DevCtrlCFMMepMode, swL2PortJumboFrameCtrlTable=swL2PortJumboFrameCtrlTable, swL2MirrorGroupEntry=swL2MirrorGroupEntry, swL2PortInfoEntry=swL2PortInfoEntry, swL2PortJumboFrameCtrlPortIndex=swL2PortJumboFrameCtrlPortIndex, swL2TrunkState=swL2TrunkState, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swL2PortJumboFrameCtrlEntry=swL2PortJumboFrameCtrlEntry, swL2VlanIndex=swL2VlanIndex, swL2VlanPortInfoPortIndex=swL2VlanPortInfoPortIndex, swL2DevInfo=swL2DevInfo, swL2PortInfoMediumType=swL2PortInfoMediumType, swL2TrunkVLANPort=swL2TrunkVLANPort, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2DevCtrlCFMPortState=swL2DevCtrlCFMPortState, swL2VlanStaticEntry=swL2VlanStaticEntry, swL2MirrorGroupID=swL2MirrorGroupID, swL2NotifFirmware=swL2NotifFirmware, swL2PortCtrlMDIXState=swL2PortCtrlMDIXState, swL2TrunkVLANState=swL2TrunkVLANState, IANAifMauAutoNegCapBits=IANAifMauAutoNegCapBits, swL2macNotification=swL2macNotification, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swL2MulticastFilterModeVlanTable=swL2MulticastFilterModeVlanTable, swL2TrunkFloodingPort=swL2TrunkFloodingPort)
