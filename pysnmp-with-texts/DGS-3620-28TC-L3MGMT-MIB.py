...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS-3620-28TC-L3MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:44:45 2019
...
Status, DesignatedRouterPriority, UpToMaxAge, AreaID, RouterID, HelloRange, Metric, PositiveInteger, TOSType = mibBuilder.importSymbols("OSPF-MIB", "Status", "DesignatedRouterPriority", "UpToMaxAge", "AreaID", "RouterID", "HelloRange", "Metric", "PositiveInteger", "TOSType")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
NotificationType, Counter64, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Integer32, ModuleIdentity, iso, MibIdentifier, ObjectIdentity, Unsigned32, IpAddress, Gauge32, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Integer32", "ModuleIdentity", "iso", "MibIdentifier", "ObjectIdentity", "Unsigned32", "IpAddress", "Gauge32", "Bits", "TimeTicks")
RowStatus, MacAddress, TextualConvention, DisplayString, TruthValue, PhysAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "MacAddress", "TextualConvention", "DisplayString", "TruthValue", "PhysAddress", "TimeStamp")
...
swL3IpCtrlIpDhcpOption12State = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 1, 3, 2, 1, 3, 1, 22), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpDhcpOption12HostName = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 1, 3, 2, 1, 3, 1, 23), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 63))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 1, 3, 2, 1, 3, 1, 28), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigDefault = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 1, 3, 2, 1, 3, 1, 29), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 1, 3, 2, 1, 3, 1, 30), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientPDRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 1, 3, 2, 1, 3, 1, 31), TruthValue()).setMaxAccess("readwrite")
...
swL3ospfIfDistributeListInType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 1, 3, 8, 1, 24), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
swL3ospfIfBfdStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 1, 3, 8, 1, 26), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("disabled", 1), ("enabled", 2)))).setMaxAccess("readwrite")
if mibBuilder.loadTexts: swL3ospfIfBfdStatus.setStatus('current')
if mibBuilder.loadTexts: swL3ospfIfBfdStatus.setDescription('Enable or disable the BFD function status on OSPF interface.')
...
swL3VrrpOperBfdPeerAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 1, 3, 14, 1, 1, 17), IpAddress().clone(hexValue="00000000")).setMaxAccess("readcreate")
if mibBuilder.loadTexts: swL3VrrpOperBfdPeerAddr.setStatus('current')
if mibBuilder.loadTexts: swL3VrrpOperBfdPeerAddr.setDescription("The BFD peer's IP address, when set to 0.0.0.0, the peer will be removed.")
...
swL3RIPInboundRouteFilterType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 1, 3, 19, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS-3620-28TC-L3MGMT-MIB", swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3RoutePreferenceIBGP=swL3RoutePreferenceIBGP, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3ospfIfDistributeListInName=swL3ospfIfDistributeListInName, swL3VrrpOperBfdPeerAddr=swL3VrrpOperBfdPeerAddr, swL3OspfDefInfoOrigMetric=swL3OspfDefInfoOrigMetric, swL3IpCtrlDhcpv6ClientPDPrefixLen=swL3IpCtrlDhcpv6ClientPDPrefixLen, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3DevMgmt=swL3DevMgmt, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3RIPInboundRouteFilterName=swL3RIPInboundRouteFilterName, swL3RouteRedistriType=swL3RouteRedistriType, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3VrrpOperState=swL3VrrpOperState, swL3Route6RedistriType=swL3Route6RedistriType, swL3ospfIfDemand=swL3ospfIfDemand, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3OspfDefInfoOrigMetricType=swL3OspfDefInfoOrigMetricType, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3IpCtrlState=swL3IpCtrlState, swL3ospfIfEntry=swL3ospfIfEntry, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3RoutePreferenceDefault=swL3RoutePreferenceDefault, swL3IpCtrlDhcpv6ClientPDPrefixName=swL3IpCtrlDhcpv6ClientPDPrefixName, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3IpStaticRouteTunnelEntry=swL3IpStaticRouteTunnelEntry, swL3OspfHostMetric=swL3OspfHostMetric, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3Route6RedistriRowStatus=swL3Route6RedistriRowStatus, swL3ospfAreaType=swL3ospfAreaType, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3IpCtrlMode=swL3IpCtrlMode, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3IpCtrlIpv6AutoConfigState=swL3IpCtrlIpv6AutoConfigState, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3Md5Key=swL3Md5Key, swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=swL3Ipv6DHCPv6CPDAddrCtrlPrefixName, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3RelayMgmt=swL3RelayMgmt, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3ospfIfEvents=swL3ospfIfEvents, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3Ipv6DHCPv6CPDAddrCtrlTable=swL3Ipv6DHCPv6CPDAddrCtrlTable, swL3Ipv6Address=swL3Ipv6Address, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3Md5Table=swL3Md5Table, swL3RouteRedistriRouteMapName=swL3RouteRedistriRouteMapName, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3DevCtrl=swL3DevCtrl, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3MgmtMIB=swL3MgmtMIB, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3ospfIfState=swL3ospfIfState, NetAddress=NetAddress, swL3Route6RedistriSrcProtocol=swL3Route6RedistriSrcProtocol, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3Route6RedistriMetric=swL3Route6RedistriMetric, swL3LoopBackIpCtrlIpSubnetMask=swL3LoopBackIpCtrlIpSubnetMask, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3Route6RedistriTable=swL3Route6RedistriTable, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3IpStaticRouteTunnelTable=swL3IpStaticRouteTunnelTable, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3ospfAreaTable=swL3ospfAreaTable, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3RIPTimeOutTime=swL3RIPTimeOutTime, swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3IpCtrlDhcpv6ClientPDPrefix=swL3IpCtrlDhcpv6ClientPDPrefix, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3IpCtrlDhcpv6ClientPDState=swL3IpCtrlDhcpv6ClientPDState, swL3LoopBackIpCtrlIfIndex=swL3LoopBackIpCtrlIfIndex, swL3ospfIfBfdStatus=swL3ospfIfBfdStatus, swL3Md5KeyId=swL3Md5KeyId, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3LoopBackIpCtrlInterfaceName=swL3LoopBackIpCtrlInterfaceName, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3RIPInboundRouteFilterType=swL3RIPInboundRouteFilterType, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3Ipv6DHCPv6CPDAddrCtrlEntry=swL3Ipv6DHCPv6CPDAddrCtrlEntry, swL3LoopBackIpCtrlAdminState=swL3LoopBackIpCtrlAdminState, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName, swL3OspfHostTOS=swL3OspfHostTOS, swL3RoutePreferenceEBGP=swL3RoutePreferenceEBGP, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3OspfECMPState=swL3OspfECMPState, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, VrId=VrId, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, NodeAddress=NodeAddress, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3IpCtrlIpv6AdminState=swL3IpCtrlIpv6AdminState, swL3LoopBackIpCtrlTable=swL3LoopBackIpCtrlTable, swL3IpCtrlTable=swL3IpCtrlTable, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3IpCtrlIpv4AdminState=swL3IpCtrlIpv4AdminState, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3ospfIfTable=swL3ospfIfTable, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3LoopBackIpCtrlEntry=swL3LoopBackIpCtrlEntry, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3RoutePreference=swL3RoutePreference, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3VrrpOperTable=swL3VrrpOperTable, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3RIPInboundRouteFilterEntry=swL3RIPInboundRouteFilterEntry, swL3IpCtrlIpDirectedBroadcastState=swL3IpCtrlIpDirectedBroadcastState, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3RIPTimerMgmt=swL3RIPTimerMgmt, swL3Ipv6DHCPv6CPDAddrCtrlState=swL3Ipv6DHCPv6CPDAddrCtrlState, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3OspfHostEntry=swL3OspfHostEntry, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3ospfIfType=swL3ospfIfType, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3IpCtrlLocalProxyArp=swL3IpCtrlLocalProxyArp, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3IpStaticRouteTunnelRowStatus=swL3IpStaticRouteTunnelRowStatus, swL3OspfHostTable=swL3OspfHostTable, swL3RIPInboundRouteFilterIfIpAddress=swL3RIPInboundRouteFilterIfIpAddress, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3LoopBackIpCtrlIpAddr=swL3LoopBackIpCtrlIpAddr, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3ospfIfMetric=swL3ospfIfMetric, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3OspfDefInfoOriginate=swL3OspfDefInfoOriginate, swL3RIPInboundRouteFilterTable=swL3RIPInboundRouteFilterTable, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3IpStaticRouteTunnelInterfaceName=swL3IpStaticRouteTunnelInterfaceName, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3Route6RedistriDstProtocol=swL3Route6RedistriDstProtocol, swL3Md5Entry=swL3Md5Entry, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3RIPGarbageCollectionTime=swL3RIPGarbageCollectionTime, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3ospfIfDistributeListInType=swL3ospfIfDistributeListInType, swL3IpMgmt=swL3IpMgmt, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3Md5RowStatus=swL3Md5RowStatus, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3IpCtrlDhcpv6ClientPDRapidCommit=swL3IpCtrlDhcpv6ClientPDRapidCommit, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3RIPUpdateTime=swL3RIPUpdateTime, swL3Route6RedistriEntry=swL3Route6RedistriEntry, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu)
mibBuilder.exportSymbols("DGS-3620-28TC-L3MGMT-MIB", swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3OspfDefInfoOrigMgmt=swL3OspfDefInfoOrigMgmt, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3LoopBackIpCtrlRowStatus=swL3LoopBackIpCtrlRowStatus, swL3ospfAreaId=swL3ospfAreaId, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3OspfHostStatus=swL3OspfHostStatus, swL3RelayDnsState=swL3RelayDnsState, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3IpCtrlDhcpv6ClientRapidCommit=swL3IpCtrlDhcpv6ClientRapidCommit, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3IpCtrlIpv6AutoConfigDefault=swL3IpCtrlIpv6AutoConfigDefault, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3VrrpOperVrId=swL3VrrpOperVrId)
