...
# Produced by pysmi-0.3.4 at Wed May  1 15:44:37 2019
...
MibIdentifier, Unsigned32, Gauge32, TimeTicks, Counter32, iso, Counter64, Integer32, ModuleIdentity, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, NotificationType, enterprises, ObjectIdentity, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Unsigned32", "Gauge32", "TimeTicks", "Counter32", "iso", "Counter64", "Integer32", "ModuleIdentity", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "NotificationType", "enterprises", "ObjectIdentity", "IpAddress")
...
if mibBuilder.loadTexts: buckOn.setDescription('WARNING: The UPS has enabled Buck.')
returnFromBuck = NotificationType((1, 3, 6, 1, 4, 1, 935) + (0,69))
if mibBuilder.loadTexts: returnFromBuck.setDescription('WARNING: The UPS has return from Buck.')
returnFromBoost = NotificationType((1, 3, 6, 1, 4, 1, 935) + (0,70))
if mibBuilder.loadTexts: returnFromBoost.setDescription('WARNING: The UPS has return from Boost.')
mibBuilder.exportSymbols("XPPC-MIB", upsThreePhaseBypassGrp=upsThreePhaseBypassGrp, upsThreePhaseBypssSourceVoltageS=upsThreePhaseBypssSourceVoltageS, upsThreePhaseInputGrp=upsThreePhaseInputGrp, returnFromBoost=returnFromBoost, upsSmartInputLineFailCause=upsSmartInputLineFailCause, indexOfDevice=indexOfDevice, upsSmartInput=upsSmartInput, upsThreePhaseOutputLoadPercentageR=upsThreePhaseOutputLoadPercentageR, upsBypassacabnormal=upsBypassacabnormal, upsSmartInputMaxLineVoltage=upsSmartInputMaxLineVoltage, upsThreePhaseRatingOutputFrequency=upsThreePhaseRatingOutputFrequency, envOverTemperature=envOverTemperature, upsCapacityNormal=upsCapacityNormal, deviceAccept=deviceAccept, upsSmartInputMinLineVoltage=upsSmartInputMinLineVoltage, upsThreePhaseDCandRectifierStatusRecRotError=upsThreePhaseDCandRectifierStatusRecRotError, upsSmartIdent=upsSmartIdent, envSecurityAbnormal=envSecurityAbnormal, upsSmartIdentDateOfManufacture=upsSmartIdentDateOfManufacture, upsThreePhaseRatingRectifierVoltage=upsThreePhaseRatingRectifierVoltage, upsThreePhaseOutputVoltageT=upsThreePhaseOutputVoltageT, upsEnvTemperature=upsEnvTemperature, upsHighDCShutdown=upsHighDCShutdown, upsSmartConfigMinReturnCapacity=upsSmartConfigMinReturnCapacity, upsBaseConfigDeviceTable=upsBaseConfigDeviceTable, upsConfigp=upsConfigp, upsBaseBatteryLastReplaceDate=upsBaseBatteryLastReplaceDate, upsThreePhaseFaultStatusInverterOutputFail=upsThreePhaseFaultStatusInverterOutputFail, mconfigTrapsReceiversTable=mconfigTrapsReceiversTable, upsSmartBatteryRunTimeRemaining=upsSmartBatteryRunTimeRemaining, upsBaseConfigNumDevices=upsBaseConfigNumDevices, ppcmgmt=ppcmgmt, upsThreePhaseBatteryVoltage=upsThreePhaseBatteryVoltage, upsCapacityUnderrun=upsCapacityUnderrun, upsSmartTestDiagnosticsResults=upsSmartTestDiagnosticsResults, upsBaseIdentModel=upsBaseIdentModel, upsThreePhaseDCandRectifierStatusLowBattery=upsThreePhaseDCandRectifierStatusLowBattery, upsEnvOverHumidity=upsEnvOverHumidity, upsTemp=upsTemp, buckOn=buckOn, hardware=hardware, upsSmartBatteryTemperature=upsSmartBatteryTemperature, upsSmartBatteryVoltage=upsSmartBatteryVoltage, upsThreePhaseDCandRectifierStatusChargeStatus=upsThreePhaseDCandRectifierStatusChargeStatus, upsSmartOutputFrequency=upsSmartOutputFrequency, lowBattery=lowBattery, envSecurity2=envSecurity2, envSecurity6=envSecurity6, upsEnvironment=upsEnvironment, upsSmartOutputVoltage=upsSmartOutputVoltage, upsRebootStarted=upsRebootStarted, upsThreePhaseOutputFrequency=upsThreePhaseOutputFrequency, upsEnvOverTemperature=upsEnvOverTemperature, upsThreePhaseUPSStaticSwitchMode=upsThreePhaseUPSStaticSwitchMode, communicationEstablished=communicationEstablished, envSecurity5=envSecurity5, upsThreePhaseUPSStatusInverterOperating=upsThreePhaseUPSStatusInverterOperating, upsBaseOutputPhase=upsBaseOutputPhase, powerRestored=powerRestored, envGasAbnormal=envGasAbnormal, upsThreePhaseBypssSourceVoltageT=upsThreePhaseBypssSourceVoltageT, upsSmartConfigShutoffDelay=upsSmartConfigShutoffDelay, upsBaseOutput=upsBaseOutput, upsWokeUp=upsWokeUp, upsSmartIdentAgentFirmwareRevision=upsSmartIdentAgentFirmwareRevision, upsThreePhaseBatteryTimeRemain=upsThreePhaseBatteryTimeRemain, upsThreePhaseRatingBypassFrequency=upsThreePhaseRatingBypassFrequency, upsThreePhaseOutputVoltageS=upsThreePhaseOutputVoltageS, upsSmartBattery=upsSmartBattery, upsThreePhaseRatingRectifierFrequency=upsThreePhaseRatingRectifierFrequency, envSecurity7=envSecurity7, trapsReceiverAddr=trapsReceiverAddr, receiverCommunityString=receiverCommunityString, upsThreePhaseDCandRectifierStatusRecOperating=upsThreePhaseDCandRectifierStatusRecOperating, envSecurity1=envSecurity1, upsThreePhaseOutputGrp=upsThreePhaseOutputGrp, upsSmartBatteryCapacity=upsSmartBatteryCapacity, upsBypassacnormal=upsBypassacnormal, upsThreePhaseFaultStatusOverLoad=upsThreePhaseFaultStatusOverLoad, upsThreePhase=upsThreePhase, mconfigTrapsReceiversNum=mconfigTrapsReceiversNum, upsThreePhaseBypssSourceVoltageR=upsThreePhaseBypssSourceVoltageR, upsTestp=upsTestp, upsSmartTestCalibrationResults=upsSmartTestCalibrationResults, upsSmartConfig=upsSmartConfig, upsThreePhaseUPSStatusBypassFreqFail=upsThreePhaseUPSStatusBypassFreqFail, upsThreePhaseDCandRectifierStatusBatteryStatus=upsThreePhaseDCandRectifierStatusBatteryStatus, vaRatingOfDevice=vaRatingOfDevice, upsOverLoad=upsOverLoad, upsTempNormal=upsTempNormal, upsSmartInputLineVoltage=upsSmartInputLineVoltage, upsThreePhaseBypassSourceFrequency=upsThreePhaseBypassSourceFrequency, upsThreePhaseFaultStatusOverTemperature=upsThreePhaseFaultStatusOverTemperature, upsEnvUnderHumidity=upsEnvUnderHumidity, upsThreePhaseBatteryGrp=upsThreePhaseBatteryGrp, boostOn=boostOn, upsBypassFreFail=upsBypassFreFail, upsTurnedOff=upsTurnedOff, upsThreePhaseUPSStatusManualBypassBreaker=upsThreePhaseUPSStatusManualBypassBreaker, upsOutputp=upsOutputp, upsSmartTestDiagnosticSchedule=upsSmartTestDiagnosticSchedule, returnFromLowBattery=returnFromLowBattery, envSecurity4=envSecurity4, upsThreePhaseRatingBatteryVoltage=upsThreePhaseRatingBatteryVoltage, upsEnvSecurity4=upsEnvSecurity4, upsEnvSmoke=upsEnvSmoke, upsSmartTest=upsSmartTest, upsSmartIdentFirmwareRevision=upsSmartIdentFirmwareRevision, upsThreePhaseRatingGrp=upsThreePhaseRatingGrp, upsSmartInputFrequency=upsSmartInputFrequency, upsLowBatteryShutdown=upsLowBatteryShutdown, upsThreePhaseBatteryCurrent=upsThreePhaseBatteryCurrent, upsThreePhaseFaultStatusHighDCShutdown=upsThreePhaseFaultStatusHighDCShutdown, upsThreePhaseOutputLoadPercentageT=upsThreePhaseOutputLoadPercentageT, upsSmartOutput=upsSmartOutput, upsBaseOutputStatus=upsBaseOutputStatus, upsEnvHumidity=upsEnvHumidity, upsInputp=upsInputp, upsSmartControlTurnOnUpsLoad=upsSmartControlTurnOnUpsLoad, nameOfDevice=nameOfDevice, upsSmartConfigReturnDelay=upsSmartConfigReturnDelay, envWaterNormal=envWaterNormal, upsThreePhaseInputVoltageS=upsThreePhaseInputVoltageS, upsInverterOutputFailShutdown=upsInverterOutputFailShutdown, upsEnvSecurity2=upsEnvSecurity2, upsSmartControl=upsSmartControl, upsBaseControlConserveBattery=upsBaseControlConserveBattery, upsThreePhaseFaultStatusShortCircuit=upsThreePhaseFaultStatusShortCircuit, upsEnvUnderTemperature=upsEnvUnderTemperature, upsBypassReturn=upsBypassReturn, upsBatteryp=upsBatteryp, upsSmartControlRebootUps=upsSmartControlRebootUps, upsOnBattery=upsOnBattery, upsThreePhaseFaultStatusGrp=upsThreePhaseFaultStatusGrp, upsTest=upsTest, upsThreePhaseRatingPower=upsThreePhaseRatingPower, upsSmartConfigHighTransferVolt=upsSmartConfigHighTransferVolt, trapsIndex=trapsIndex, upsShortCircuitShutdown=upsShortCircuitShutdown, upsThreePhaseDCandRectifierStatusGrp=upsThreePhaseDCandRectifierStatusGrp, upsThreePhaseOutputLoadPercentageS=upsThreePhaseOutputLoadPercentageS, envSecurity3=envSecurity3, mconfigTrapsReceiversEntry=mconfigTrapsReceiversEntry, upsSmartTestDiagnostics=upsSmartTestDiagnostics, upsEnvSecurity5=upsEnvSecurity5, envHumidityNormal=envHumidityNormal, upsSmartConfigLowTransferVolt=upsSmartConfigLowTransferVolt, upsThreePhaseOutputVoltageR=upsThreePhaseOutputVoltageR, upsSmartConfigAlarm=upsSmartConfigAlarm, upsSmartTestIndicators=upsSmartTestIndicators, upsBaseTest=upsBaseTest, upsBaseBatteryTimeOnBattery=upsBaseBatteryTimeOnBattery, upsBypass=upsBypass, upsThreePhaseDCandRectifierStatusInAndOut=upsThreePhaseDCandRectifierStatusInAndOut, upsSmartBatteryCurrent=upsSmartBatteryCurrent, upsEnvWater=upsEnvWater, upsSmartConfigUpsSleepTime=upsSmartConfigUpsSleepTime, upsSleeping=upsSleeping, upsThreePhaseInputVoltageR=upsThreePhaseInputVoltageR, upsBaseBattery=upsBaseBattery, envSmokeAbnormal=envSmokeAbnormal, upsSmartControlFlashAndBeep=upsSmartControlFlashAndBeep, upsThreePhaseFaultStatusBypassBreaker=upsThreePhaseFaultStatusBypassBreaker, upsOverLoadShutdown=upsOverLoadShutdown, upsEnvSecurity1=upsEnvSecurity1, upsSmartControlUpsSleep=upsSmartControlUpsSleep, upsControlp=upsControlp, upsIdentp=upsIdentp, upsBaseIdent=upsBaseIdent, upsSmartConfigLowBatteryRunTime=upsSmartConfigLowBatteryRunTime, upsThreePhaseBatteryCapacityPercentage=upsThreePhaseBatteryCapacityPercentage, upsEmergencyStop=upsEmergencyStop, upsLoadNormal=upsLoadNormal, upsEnvSecurity3=upsEnvSecurity3, upsThreePhaseFaultStatusEmergencyStop=upsThreePhaseFaultStatusEmergencyStop, upsSmartBatteryFullChargeVoltage=upsSmartBatteryFullChargeVoltage, upsSmartControlUpsOff=upsSmartControlUpsOff, upsThreePhaseInputVoltageT=upsThreePhaseInputVoltageT, upsBaseInput=upsBaseInput, upsSmartTestRuntimeCalibration=upsSmartTestRuntimeCalibration, upsBaseConfigDeviceEntry=upsBaseConfigDeviceEntry, upsSmartConfigSensitivity=upsSmartConfigSensitivity, upsOverTemperatureShutdown=upsOverTemperatureShutdown, upsBypassMode=upsBypassMode, upsEnvStatus=upsEnvStatus, upsThreePhaseRatingOutputVoltage=upsThreePhaseRatingOutputVoltage, upsScheduleShutdown=upsScheduleShutdown, upsBaseBatteryStatus=upsBaseBatteryStatus, severityLevel=severityLevel, envUnderTemperature=envUnderTemperature, upsRecroterror=upsRecroterror, upsSmartIdentUpsSerialNumber=upsSmartIdentUpsSerialNumber, ups=ups, upsDiagnosticsFailed=upsDiagnosticsFailed, upsBypassBreadkerOnShutdown=upsBypassBreadkerOnShutdown, upsThreePhaseDCandRectifierStatusLowBatteryShutdown=upsThreePhaseDCandRectifierStatusLowBatteryShutdown, envUnderHumidity=envUnderHumidity, upsSmartConfigAlarmTimer=upsSmartConfigAlarmTimer, upsBaseConfig=upsBaseConfig, upsSmartConfigRatedOutputVoltage=upsSmartConfigRatedOutputVoltage, upsSmartConfigSetEEPROMDefaults=upsSmartConfigSetEEPROMDefaults, upsSmartTestCalibrationDate=upsSmartTestCalibrationDate, envTemperatureNormal=envTemperatureNormal, upsDischarged=upsDischarged, returnFromBuck=returnFromBuck, upsSmartBatteryReplaceIndicator=upsSmartBatteryReplaceIndicator, envWaterAbnormal=envWaterAbnormal, upsSmartTestLastDiagnosticsDate=upsSmartTestLastDiagnosticsDate, upsThreePhaseUPSStatusACStatus=upsThreePhaseUPSStatusACStatus, upsEnvSetting=upsEnvSetting, upsEnvSecurity7=upsEnvSecurity7, upsBaseControl=upsBaseControl, receiverAccept=receiverAccept, upsBaseInputPhase=upsBaseInputPhase, ppc=ppc, upsBaseIdentUpsName=upsBaseIdentUpsName, upsSmartControlSimulatePowerFail=upsSmartControlSimulatePowerFail, upsThreePhaseBatteryTemperature=upsThreePhaseBatteryTemperature, upsEnvSecurity6=upsEnvSecurity6, upsThreePhaseInputFrequency=upsThreePhaseInputFrequency, upsSmartOutputLoad=upsSmartOutputLoad, upsDiagnosticsPassed=upsDiagnosticsPassed, communicationLost=communicationLost, upsThreePhaseUPSStatusGrp=upsThreePhaseUPSStatusGrp, envOverHumidity=envOverHumidity, upsInverterMode=upsInverterMode, products=products, mconfig=mconfig, upsThreePhaseRatingBypassVoltage=upsThreePhaseRatingBypassVoltage)
