...
# Produced by pysmi-0.3.4 at Wed May  1 11:26:40 2019
...
if mibBuilder.loadTexts: mibatmSvcRouteProfileTable.setDescription('A list of mibatmSvcRouteProfile profile entries.')
...
if mibBuilder.loadTexts: mibatmSvcRouteProfileEntry.setDescription('A mibatmSvcRouteProfile entry containing objects that maps to the parameters of mibatmSvcRouteProfile profile.')
...
if mibBuilder.loadTexts: atmSvcRouteProfile_Name.setDescription('The name of this atm route.')
...
if mibBuilder.loadTexts: atmSvcRouteProfile_Active.setDescription('TRUE if this is route is active. Inactive routes are ignored and do not affect the routing tables.')
...
if mibBuilder.loadTexts: atmSvcRouteProfile_AddressPrefix.setDescription('The address prefix of the destination network. To indicate a default route, set this field to *.')
...
if mibBuilder.loadTexts: atmSvcRouteProfile_InterfaceAddress_PhysicalAddress_Shelf.setDescription('The number of the shelf that the addressed physical device resides on.')
...
if mibBuilder.loadTexts: atmSvcRouteProfile_InterfaceAddress_PhysicalAddress_Slot.setDescription('The number of the slot that the addressed physical device resides on.')
...
if mibBuilder.loadTexts: atmSvcRouteProfile_InterfaceAddress_PhysicalAddress_ItemNumber.setDescription('A number that specifies an addressable entity within the context of shelf and slot.')
...
if mibBuilder.loadTexts: atmSvcRouteProfile_InterfaceAddress_LogicalItem.setDescription('A number that specifies an addressable logical entity within the context of a physical address.')
...
if mibBuilder.loadTexts: atmSvcRouteProfile_Action_o.setDescription('')
mibBuilder.exportSymbols("ASCEND-MIBATMSVCROUTE-MIB", atmSvcRouteProfile_Action_o=atmSvcRouteProfile_Action_o, atmSvcRouteProfile_Active=atmSvcRouteProfile_Active, atmSvcRouteProfile_AddressPrefix=atmSvcRouteProfile_AddressPrefix, atmSvcRouteProfile_Name=atmSvcRouteProfile_Name, atmSvcRouteProfile_InterfaceAddress_PhysicalAddress_Slot=atmSvcRouteProfile_InterfaceAddress_PhysicalAddress_Slot, DisplayString=DisplayString, atmSvcRouteProfile_InterfaceAddress_PhysicalAddress_ItemNumber=atmSvcRouteProfile_InterfaceAddress_PhysicalAddress_ItemNumber, atmSvcRouteProfile_InterfaceAddress_LogicalItem=atmSvcRouteProfile_InterfaceAddress_LogicalItem, atmSvcRouteProfile_InterfaceAddress_PhysicalAddress_Shelf=atmSvcRouteProfile_InterfaceAddress_PhysicalAddress_Shelf, mibatmSvcRouteProfile=mibatmSvcRouteProfile, mibatmSvcRouteProfileEntry=mibatmSvcRouteProfileEntry, mibatmSvcRouteProfileTable=mibatmSvcRouteProfileTable)
