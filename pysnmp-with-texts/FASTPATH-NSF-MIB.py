...
# Produced by pysmi-0.3.4 at Wed May  1 13:12:18 2019
...
Counter64, Integer32, Counter32, TimeTicks, Bits, IpAddress, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Unsigned32, ObjectIdentity, iso, ModuleIdentity, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Integer32", "Counter32", "TimeTicks", "Bits", "IpAddress", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Unsigned32", "ObjectIdentity", "iso", "ModuleIdentity", "NotificationType")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: fastPathNsf.setRevisionsDescriptions(('Initial version.',))
...
if mibBuilder.loadTexts: fastPathNsf.setContactInfo(' Customer Support Postal: Broadcom Corporation 100 Perimeter Park Dr., Suite H Morrisville, NC 27560 Tel: +1 919 865 2700')
...
if mibBuilder.loadTexts: agentNsfStackRestartComplete.setDescription('Sent when a the stack finishes restarting after a failover.')
mibBuilder.exportSymbols("FASTPATH-NSF-MIB", agentNsfOspfHelperSupportMode=agentNsfOspfHelperSupportMode, agentNsfInitiateFailover=agentNsfInitiateFailover, agentNsfOspfRestartStatus=agentNsfOspfRestartStatus, agentNsfOspfRestartInterval=agentNsfOspfRestartInterval, agentNsfRestartInProgress=agentNsfRestartInProgress, agentNsfOspfSupportMode=agentNsfOspfSupportMode, agentNsfGroup=agentNsfGroup, agentNsfOperStatus=agentNsfOperStatus, agentNsfTraps=agentNsfTraps, agentNsfWarmRestartReady=agentNsfWarmRestartReady, agentNsfUnitTable=agentNsfUnitTable, agentCheckpointMessageRateInterval=agentCheckpointMessageRateInterval, fastPathNsf=fastPathNsf, agentCheckpointTimeSinceCountersCleared=agentCheckpointTimeSinceCountersCleared, agentNsfUnitEntry=agentNsfUnitEntry, agentNsfStackRestartComplete=agentNsfStackRestartComplete, agentCheckpointMessages=agentCheckpointMessages, agentNsfOspfRestartExitReason=agentNsfOspfRestartExitReason, agentNsfLastStartupReason=agentNsfLastStartupReason, agentNsfUnitSupport=agentNsfUnitSupport, agentCheckpointStatsGroup=agentCheckpointStatsGroup, agentCheckpointBytes=agentCheckpointBytes, agentNsfTimeSinceLastRestart=agentNsfTimeSinceLastRestart, agentNsfOspfHelperStrictLSAChecking=agentNsfOspfHelperStrictLSAChecking, agentCheckpointClearStatistics=agentCheckpointClearStatistics, agentNsfOspfGroup=agentNsfOspfGroup, agentCheckpointMessageRate=agentCheckpointMessageRate, agentNsfBackupConfigurationAge=agentNsfBackupConfigurationAge, agentNsfOspfRestartAge=agentNsfOspfRestartAge, agentCheckpointHighestMessageRate=agentCheckpointHighestMessageRate, agentNsfAdminStatus=agentNsfAdminStatus, PYSNMP_MODULE_ID=fastPathNsf)
