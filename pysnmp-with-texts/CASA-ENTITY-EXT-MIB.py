...
IpAddress, Counter64, Counter32, NotificationType, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, MibIdentifier, Integer32, Unsigned32, Gauge32, TimeTicks, ObjectIdentity, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Counter64", "Counter32", "NotificationType", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "MibIdentifier", "Integer32", "Unsigned32", "Gauge32", "TimeTicks", "ObjectIdentity", "ModuleIdentity")
...
if mibBuilder.loadTexts: casaModuleCpuMemMib.setContactInfo('Guangzhou Casa Communications Ltd. No.206 YueHe Bld,Huacui Str. Tianhe Industrial Park Guangzhou TEL:020 85545002/85577786 ext.212 FAX:020 85545002 ext.230 E-mail: huangxiaole@casachina.com.cn')
if mibBuilder.loadTexts: casaModuleCpuMemMib.setDescription('This is the enterprise MIB Module for CASA systems IPQAM. ')
...
if mibBuilder.loadTexts: casaModuleCpuMemTable.setDescription('Description.')
...
if mibBuilder.loadTexts: casaModuleCpuMemEntry.setDescription('Description.')
...
if mibBuilder.loadTexts: casaModuleTotalAllocatableMem.setDescription('TotalAllocatableMem Byte')
...
if mibBuilder.loadTexts: casaModuleTotalMemAllocated.setDescription('TotalMemAllocated Byte')
...
if mibBuilder.loadTexts: casaModuleTotalFreeMem.setDescription('TotalFreeMem Byte')
...
if mibBuilder.loadTexts: casaModuleTotalCpuUtilization.setDescription('TotalCPUUtilization ')
...
if mibBuilder.loadTexts: casaCmtsCpuMemGroup.setDescription('Description.')
...
if mibBuilder.loadTexts: casaCmtsCpuMemCompliance.setDescription('Description.')
mibBuilder.exportSymbols("CASA-ENTITY-EXT-MIB", casaMgmt=casaMgmt, casaModuleCpuMemMib=casaModuleCpuMemMib, casaModuleCpuMemTable=casaModuleCpuMemTable, casaModuleCpuMemObjects=casaModuleCpuMemObjects, casaModuleTotalAllocatableMem=casaModuleTotalAllocatableMem, casaModuleTotalMemAllocated=casaModuleTotalMemAllocated, casaModuleTotalFreeMem=casaModuleTotalFreeMem, casaModuleTotalCpuUtilization=casaModuleTotalCpuUtilization, casaCmtsCpuMemGroups=casaCmtsCpuMemGroups, casaCmtsCpuMemGroup=casaCmtsCpuMemGroup, casaCmtsCpuMemCompliances=casaCmtsCpuMemCompliances, casaModuleCpuMemEntry=casaModuleCpuMemEntry, PYSNMP_MODULE_ID=casaModuleCpuMemMib, casaCmtsCpuMemCompliance=casaCmtsCpuMemCompliance)
