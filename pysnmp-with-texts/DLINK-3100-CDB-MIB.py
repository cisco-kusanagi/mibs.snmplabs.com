...
# Produced by pysmi-0.3.4 at Wed May  1 12:48:05 2019
...
NotificationType, Unsigned32, ModuleIdentity, TimeTicks, Counter32, Counter64, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ObjectIdentity, Gauge32, Bits, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "ModuleIdentity", "TimeTicks", "Counter32", "Counter64", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ObjectIdentity", "Gauge32", "Bits", "IpAddress")
...
if mibBuilder.loadTexts: rlCDB.setContactInfo('www.dlink.com')
...
mibBuilder.exportSymbols("DLINK-3100-CDB-MIB", rlCDB=rlCDB, PYSNMP_MODULE_ID=rlCDB, rlStartupCDBChanged=rlStartupCDBChanged, rlManualReboot=rlManualReboot)
