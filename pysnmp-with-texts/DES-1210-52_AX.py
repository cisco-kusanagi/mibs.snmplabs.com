#
# PySNMP MIB module DES-1210-52_AX (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DES-1210-52_AX
# Produced by pysmi-0.3.4 at Wed May  1 12:39:11 2019
...
Counter32, Counter64, enterprises, Bits, Gauge32, ObjectIdentity, TimeTicks, ModuleIdentity, iso, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, IpAddress, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "enterprises", "Bits", "Gauge32", "ObjectIdentity", "TimeTicks", "ModuleIdentity", "iso", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "IpAddress", "MibIdentifier", "NotificationType")
...
des_1210_52ax = MibIdentifier((1, 3, 6, 1, 4, 1, 171, 10, 75, 7)).setLabel("des-1210-52ax")
...
sysPortCtrlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 1, 13, 1), ).setIndexNames((0, "DES-1210-52_AX", "sysPortCtrlIndex"))
...
sysIpAddrCfgMode = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 2, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("manual", 1), ("dynamic", 2))).clone('manual')).setMaxAccess("readwrite")
...
sysIpAddr = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 2, 2), IpAddress()).setMaxAccess("readwrite")
...
sysIpSubnetMask = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 2, 3), IpAddress()).setMaxAccess("readwrite")
...
sysGateway = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 2, 4), IpAddress()).setMaxAccess("readwrite")
...
tftpConfigTftpOperation = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 3, 7), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("download", 1), ("upload", 2), ("progressing", 3)))).setMaxAccess("readwrite")
...
stpPortEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 6, 2, 1), ).setIndexNames((0, "DES-1210-52_AX", "stpPort"))
...
stpPortPathCost = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 6, 2, 1, 6), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 200000000))).setMaxAccess("readwrite")
...
dot1qVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 7, 6, 1), ).setIndexNames((0, "DES-1210-52_AX", "dot1qVlanName"))
...
dot1qVlanForbiddenPorts = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 7, 6, 1, 3), PortList()).setMaxAccess("readonly")
...
dot1dBasePortEntry.registerAugmentions(("DES-1210-52_AX", "dot1qVlanPortEntry"))
...
dot1qVlanUngisterMCFilterEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 7, 8, 1), ).setIndexNames((0, "DES-1210-52_AX", "dot1qVlanUngisterMCFilterVlanId"))
...
laPortChannelEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 8, 1, 3, 1), ).setIndexNames((0, "DES-1210-52_AX", "laPortChannelIfIndex"))
...
laPortControlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 8, 2, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "laPortControlIndex"))
...
laPortActorPortPriority = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 8, 2, 1, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readwrite")
...
staticEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 9, 3, 1), ).setIndexNames((0, "DES-1210-52_AX", "staticVlanID"), (0, "DES-1210-52_AX", "staticMac"), (0, "DES-1210-52_AX", "staticPort"))
...
igsVlanRouterEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 10, 3, 3, 1), ).setIndexNames((0, "DES-1210-52_AX", "igsVlanRouterVlanId"))
...
igsVlanFilterEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 10, 3, 4, 1), ).setIndexNames((0, "DES-1210-52_AX", "igsVlanFilterVlanId"))
...
igsVlanMulticastGroupEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 10, 3, 5, 1), ).setIndexNames((0, "DES-1210-52_AX", "igsVlanMulticastGroupVlanId"), (0, "DES-1210-52_AX", "igsVlanMulticastGroupIpAddress"))
...
radiusServerAddress = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 11, 1, 1), IpAddress()).setMaxAccess("readwrite")
...
radiusServerSharedSecret = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 11, 1, 2), DisplayString()).setMaxAccess("readwrite")
...
dot1xAuthConfigPortEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 11, 2, 9, 1), ).setIndexNames((0, "DES-1210-52_AX", "dot1xAuthConfigPortNumber"))
...
qosMode = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 12, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("dot1p", 1), ("dscp", 2)))).setMaxAccess("readwrite")
...
dot1pPortEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 12, 3, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "dot1pPortIndex"))
...
bandwidthCtrlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 13, 1, 2, 1), ).setIndexNames((0, "DES-1210-52_AX", "bandwidthCtrlIndex"))
...
trustedHostTable = MibTable((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 14, 1, 2), )
...
trustedHostEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 14, 1, 2, 1), ).setIndexNames((0, "DES-1210-52_AX", "trustedHostIpAddr"), (0, "DES-1210-52_AX", "trustedHostIpMask"))
...
trustedHostIpAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 14, 1, 2, 1, 1), IpAddress()).setMaxAccess("readonly")
...
trustedHostIpMask = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 14, 1, 2, 1, 2), IpAddress()).setMaxAccess("readonly")
...
trustedHostRowStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 14, 1, 2, 1, 3), RowStatus()).setMaxAccess("readcreate")
...
aRPSpoofPreventEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 14, 3, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "aRPSpoofPreventIpAddr"))
...
portSecEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 14, 2, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "portSecIndex"))
...
aclProfileTable = MibTable((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1), )
...
aclProfileEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "aclProfileNo"))
...
aclProfileNo = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 50))).setMaxAccess("readonly")
...
aclProfileType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 4, 5, 6))).clone(namedValues=NamedValues(("l2", 1), ("l3", 2), ("arpSP_permit", 4), ("arpSP_deny", 5), ("voiceVlan", 6)))).setMaxAccess("readwrite")
...
aclProfileRuleCount = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
...
aclProfileMask = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 4), OctetString()).setMaxAccess("readwrite")
...
aclProfileDstMacAddrMask = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 5), MacAddress()).setMaxAccess("readwrite")
...
aclProfileSrcMacAddrMask = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 6), MacAddress()).setMaxAccess("readwrite")
...
aclProfileIPProtocol = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 7), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 6, 17))).clone(namedValues=NamedValues(("none", 0), ("icmp", 1), ("igmp", 2), ("tcp", 6), ("udp", 17)))).setMaxAccess("readwrite")
...
aclProfileDstIpAddrMask = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 8), IpAddress().clone(hexValue="FFFFFFFF")).setMaxAccess("readwrite")
...
aclProfileSrcIpAddrMask = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 9), IpAddress().clone(hexValue="FFFFFFFF")).setMaxAccess("readwrite")
...
aclProfileDstPortMask = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 10), OctetString().clone(hexValue="FFFF")).setMaxAccess("readwrite")
...
aclProfileSrcPortMask = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 11), OctetString().clone(hexValue="FFFF")).setMaxAccess("readwrite")
...
aclProfileArpSenderMacAddrMask = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 12), MacAddress().clone(hexValue="FFFFFFFFFF")).setMaxAccess("readonly")
...
aclProfileArpSenderIpAddrMask = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 13), IpAddress().clone(hexValue="FFFFFFFF")).setMaxAccess("readonly")
...
aclProfileStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 1, 1, 1, 14), RowStatus()).setMaxAccess("readcreate")
...
aclL2RuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 2, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "aclL2AccessID"), (0, "DES-1210-52_AX", "aclL2ProfileID"))
...
aclL3RuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 15, 3, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "aclL3RuleAccessID"), (0, "DES-1210-52_AX", "aclL3RuleProfileNo"))
...
snmpV3UserEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 2, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "snmpV3UserName"), (0, "DES-1210-52_AX", "snmpV3UserVersion"))
...
snmpV3GroupEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 3, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "snmpV3GroupName"), (0, "DES-1210-52_AX", "snmpV3GroupSecurityModel"), (0, "DES-1210-52_AX", "snmpV3GroupSecurityLevel"))
...
snmpV3ViewTreeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 4, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "snmpV3viewTreeName"), (0, "DES-1210-52_AX", "snmpV3viewTreeSubtree"))
...
snmpV3CommunityEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 5, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "snmpV3CommunityName"))
...
snmpV3HostTable = MibTable((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 6, 1), )
if mibBuilder.loadTexts: snmpV3HostTable.setStatus('current')
if mibBuilder.loadTexts: snmpV3HostTable.setDescription('')
snmpV3HostEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 6, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "snmpV3HostAddress"))
if mibBuilder.loadTexts: snmpV3HostEntry.setStatus('current')
if mibBuilder.loadTexts: snmpV3HostEntry.setDescription('')
snmpV3HostAddress = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 6, 1, 1, 1), IpAddress()).setMaxAccess("readonly")
...
snmpV3HostCommunityName = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 6, 1, 1, 2), SnmpAdminString().subtype(subtypeSpec=ValueSizeConstraint(1, 32))).setMaxAccess("readcreate")
...
snmpV3HostVersion = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 6, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))).clone(namedValues=NamedValues(("v1", 1), ("v2c", 2), ("v3NoAuthNoPriv", 3), ("v3AuthNoPriv", 4), ("v3AuthPriv", 5)))).setMaxAccess("readcreate")
...
snmpV3HostStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 6, 1, 1, 4), RowStatus()).setMaxAccess("readcreate")
...
snmpV3TrapFiberLinkUpDown = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 8, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
snmpV3TrapCopperLinkUpDown = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 8, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
snmpV3TrapRSTPStateChange = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 8, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
snmpV3TrapFirmUpgrade = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 25, 8, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
syslogGeneralGroup = MibIdentifier((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 16, 1))
syslogLogSrvAddr = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 16, 1, 1), IpAddress()).setMaxAccess("readwrite")
...
syslogUDPPort = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 16, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 65535))).setMaxAccess("readwrite")
...
syslogTimeStamp = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 16, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enable", 1), ("disable", 2))).clone('enable')).setMaxAccess("readwrite")
...
syslogSeverity = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 16, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(4, 6, 7))).clone(namedValues=NamedValues(("warning", 4), ("info", 6), ("all", 7)))).setMaxAccess("readwrite")
...
syslogFacility = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 16, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(128, 136, 144, 152, 160, 168, 176, 184))).clone(namedValues=NamedValues(("local0", 128), ("local1", 136), ("local2", 144), ("local3", 152), ("local4", 160), ("local5", 168), ("local6", 176), ("local7", 184))).clone('local0')).setMaxAccess("readwrite")
...
syslogLogging = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 16, 1, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enable", 1), ("disable", 2))).clone('disable')).setMaxAccess("readwrite")
...
sysLBDInterval = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 17, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 32767)).clone(2)).setMaxAccess("readwrite")
...
sysLBDRecoverTime = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 17, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(ValueRangeConstraint(0, 0), ValueRangeConstraint(60, 1000000), )).clone(60)).setMaxAccess("readwrite")
...
sysLBDCtrlTable = MibTable((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 17, 4), )
...
sysLBDCtrlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 17, 4, 1), ).setIndexNames((0, "DES-1210-52_AX", "sysLBDCtrlIndex"))
...
sysLBDCtrlIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 17, 4, 1, 1), Integer32()).setMaxAccess("readonly")
...
sysLBDPortStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 17, 4, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2))).clone('disabled')).setMaxAccess("readwrite")
...
sysLBDPortLoopStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 17, 4, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("normal", 1), ("disabled", 2)))).setMaxAccess("readonly")
...
sysTrapFiberPortEvent = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 19, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enable", 1), ("disable", 2))).clone('disable')).setMaxAccess("readwrite")
...
sysTrapTwistedPortEvent = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 19, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enable", 1), ("disable", 2))).clone('disable')).setMaxAccess("readwrite")
...
sysTrapStateChangeEvent = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 19, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enable", 1), ("disable", 2))).clone('disable')).setMaxAccess("readwrite")
...
sysTrapFirmUpgradeEvent = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 19, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enable", 1), ("disable", 2))).clone('disable')).setMaxAccess("readwrite")
...
sysTrapStatus = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 19, 10), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enable", 1), ("disable", 2))).clone('disable')).setMaxAccess("readwrite")
...
sysSNTPTimeSeconds = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 1), Integer32()).setMaxAccess("readwrite")
...
sysSNTPFirstServer = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 2), IpAddress()).setMaxAccess("readwrite")
...
sysSNTPSecondServer = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 3), IpAddress()).setMaxAccess("readwrite")
...
sysSNTPPollInterval = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 4), Integer32()).setMaxAccess("readwrite")
...
sysSNTPState = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("sntp", 1), ("local", 2)))).setMaxAccess("readwrite")
...
sysSNTPDSTOffset = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(30, 60, 90, 120))).clone(namedValues=NamedValues(("offset30min", 30), ("offset60min", 60), ("offset90min", 90), ("offset120min", 120)))).setMaxAccess("readwrite")
...
sysSNTPGMTMinutes = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 7), Integer32()).setMaxAccess("readwrite")
...
sysSNTPDSTStartMon = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 8), Integer32()).setMaxAccess("readwrite")
...
sysSNTPDSTStartDay = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 9), Integer32()).setMaxAccess("readwrite")
...
sysSNTPDSTStartHour = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 10), Integer32()).setMaxAccess("readwrite")
...
sysSNTPDSTStartMin = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 11), Integer32()).setMaxAccess("readwrite")
...
sysSNTPDSTEndMon = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 12), Integer32()).setMaxAccess("readwrite")
...
sysSNTPDSTEndDay = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 13), Integer32()).setMaxAccess("readwrite")
...
sysSNTPDSTEndHour = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 14), Integer32()).setMaxAccess("readwrite")
...
sysSNTPDSTEndMin = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 15), Integer32()).setMaxAccess("readwrite")
...
sysSNTPDSTState = MibScalar((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 20, 16), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("annual", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
voicevlanPortControlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 21, 1, 6, 1), ).setIndexNames((0, "DES-1210-52_AX", "voicevlanPortControlIndex"))
...
voicevlanPortState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 21, 1, 6, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("manual", 1), ("dynamic", 2), ("none", 3)))).setMaxAccess("readonly")
...
voicevlanOUIEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 21, 2, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "voicevlanOUITelephonyOUI"))
...
autoSurveillanceVlanOUIEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 26, 2, 1, 1), ).setIndexNames((0, "DES-1210-52_AX", "autoSurveillanceVlanOUISurveillanceOUI"))
...
autoSurveillanceVlanOUIMask = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 75, 7, 26, 2, 1, 1, 3), MacAddress()).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("DES-1210-52_AX", snmpV3UserGroupName=snmpV3UserGroupName, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, sysSNTPDSTStartMin=sysSNTPDSTStartMin, aclL3RuleAccessID=aclL3RuleAccessID, stpPortState=stpPortState, stpPortEnable=stpPortEnable, dot1pPortIndex=dot1pPortIndex, tftpConfigFileName=tftpConfigFileName, qosDiffServType15=qosDiffServType15, dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, sysSNTPDSTStartMon=sysSNTPDSTStartMon, stpRootPort=stpRootPort, portSecTable=portSecTable, dot1qVlanUngisterMCFilterEntry=dot1qVlanUngisterMCFilterEntry, sysMirrorCtrlEgressMirroring=sysMirrorCtrlEgressMirroring, radius=radius, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, dot1xAuthStatus=dot1xAuthStatus, voicevlanPortState=voicevlanPortState, qosDiffServType23=qosDiffServType23, snmpV3ViewTree=snmpV3ViewTree, autoSurveillanceVlanOUI=autoSurveillanceVlanOUI, snmpV3UserName=snmpV3UserName, snmpV3GroupStatus=snmpV3GroupStatus, snmpV3TrapFirmUpgrade=snmpV3TrapFirmUpgrade, qosDiffServType11=qosDiffServType11, qosDiffServType32=qosDiffServType32, aclProfileArpSenderIpAddrMask=aclProfileArpSenderIpAddrMask, igsQueryMaxResponseTime=igsQueryMaxResponseTime, companySNMPV3=companySNMPV3, dot1qVlanEntry=dot1qVlanEntry, companyVoiceVlan=companyVoiceVlan, voiceVlanPriority=voiceVlanPriority, aclProfileTable=aclProfileTable, stpPriority=stpPriority, voiceVlanMode=voiceVlanMode, qosDiffServType12=qosDiffServType12, aclL3RuleTcpFinBit=aclL3RuleTcpFinBit, companyMirror=companyMirror, snmpV3viewTreeType=snmpV3viewTreeType, companyQoSGroup=companyQoSGroup, aclL2ProfileID=aclL2ProfileID, aclL3RuleTcpUdpSrcPortMask=aclL3RuleTcpUdpSrcPortMask, voicevlanOUI=voicevlanOUI, aclL3RuleTcpUrgBit=aclL3RuleTcpUrgBit, dot1qVlanManagementid=dot1qVlanManagementid, stpHelloTime=stpHelloTime, sysLocationName=sysLocationName, sysPortCtrlSpeed=sysPortCtrlSpeed, stpPortPriority=stpPortPriority, qosDiffServType16=qosDiffServType16, autoSurveillanceVlanOUIDescription=autoSurveillanceVlanOUIDescription, securitySSL=securitySSL, snmpGlobalState=snmpGlobalState, companySyslog=companySyslog, qosDiffServType47=qosDiffServType47, qosDiffServType63=qosDiffServType63, sysTrapSystemEvent=sysTrapSystemEvent, companyIgsGroup=companyIgsGroup, stpBridgeMaxAge=stpBridgeMaxAge, bandwidthCtrlTxThreshold=bandwidthCtrlTxThreshold, dot1qVlanUngisterMCFilterVlanId=dot1qVlanUngisterMCFilterVlanId, traps=traps, aclL3RuleDscp=aclL3RuleDscp, companySNTPSetting=companySNTPSetting, miscReset=miscReset, syslogTimeStamp=syslogTimeStamp, aclL2Rule1pPriority=aclL2Rule1pPriority, radiusServerAddress=radiusServerAddress, qosDiffServType19=qosDiffServType19, aclL3RuleTcpUdpDstPort=aclL3RuleTcpUdpDstPort, sysPortCtrlType=sysPortCtrlType, trustedHostRowStatus=trustedHostRowStatus, stpAdminPortPathCost=stpAdminPortPathCost, dot1qVlanForbiddenPorts=dot1qVlanForbiddenPorts, aclL3Rule=aclL3Rule, dlink_products=dlink_products, aclL3RuleDstIpAddrMask=aclL3RuleDstIpAddrMask, snmpV3EngineID=snmpV3EngineID, trustedHostIpAddr=trustedHostIpAddr, sysPortCtrlTable=sysPortCtrlTable, aRPSpoofPreventEntry=aRPSpoofPreventEntry, sysPortCtrlEntry=sysPortCtrlEntry, aclProfileEntry=aclProfileEntry, laStatus=laStatus, qosDiffServType00=qosDiffServType00, snmpV3Trap=snmpV3Trap, broadcastStormCtrlLimitType=broadcastStormCtrlLimitType, autoSurveillanceVlanOUIMask=autoSurveillanceVlanOUIMask, PortLaMode=PortLaMode, aclL3RuleAction=aclL3RuleAction, dot1pPortPriority=dot1pPortPriority, dhcpServerScreenEnablePortlist=dhcpServerScreenEnablePortlist, VlanIndex=VlanIndex, dot1xAuthServerTimeout=dot1xAuthServerTimeout, dlink_DES1210SeriesProd=dlink_DES1210SeriesProd, sysPortCtrlOperStatus=sysPortCtrlOperStatus, sysSNTPDSTEndMon=sysSNTPDSTEndMon, dot1qVlanManagementOnOff=dot1qVlanManagementOnOff, trustedHostTable=trustedHostTable, sysSNTPFirstServer=sysSNTPFirstServer, autoSurveillanceVlanOUIComponentType=autoSurveillanceVlanOUIComponentType, aclL2RuleVlanId=aclL2RuleVlanId, voicevlanPortControlTable=voicevlanPortControlTable, voicevlanOUITelephonyOUI=voicevlanOUITelephonyOUI, qosDiffServType61=qosDiffServType61, qosDiffServType57=qosDiffServType57, staticMac=staticMac, companyDot1qVlanGroup=companyDot1qVlanGroup, companyTftpGroup=companyTftpGroup, Timeout=Timeout, sysMirrorTargetPort=sysMirrorTargetPort, qosDiffServType03=qosDiffServType03, trustedHostStatus=trustedHostStatus, aclL2RuleDstMacAddrMask=aclL2RuleDstMacAddrMask, tftpFwImageFileName=tftpFwImageFileName, snmpV3CommunityPolicy=snmpV3CommunityPolicy, sysTrapFirmUpgradeEvent=sysTrapFirmUpgradeEvent, rstpStatus=rstpStatus, aclL3RuleDstIpAddr=aclL3RuleDstIpAddr, companyRSTP=companyRSTP, sysSwitchName=sysSwitchName, aRPSpoofPreventMacAddress=aRPSpoofPreventMacAddress, sysIpSubnetMask=sysIpSubnetMask, tftpFwServerIpAddress=tftpFwServerIpAddress, igsVlanRtrPortList=igsVlanRtrPortList, snmpV3HostAddress=snmpV3HostAddress, aRPSpoofPreventPortList=aRPSpoofPreventPortList, snmpV3CommunityTable=snmpV3CommunityTable, qosDiffServType33=qosDiffServType33, aclL2RuleSrcMacAddr=aclL2RuleSrcMacAddr, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, igsHostPortPurgeInterval=igsHostPortPurgeInterval, dot1pPortTable=dot1pPortTable, stpPortOperEdgePort=stpPortOperEdgePort, qosDiffServTypeGroup=qosDiffServTypeGroup, dot1xAuth=dot1xAuth, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, snmpV3GroupTable=snmpV3GroupTable, companyMiscGroup=companyMiscGroup, laPortChannelTable=laPortChannelTable, tftpConfigTftpOperationStatus=tftpConfigTftpOperationStatus, autoSurveillanceVlanOUIEntry=autoSurveillanceVlanOUIEntry, stpPortOperPointToPoint=stpPortOperPointToPoint, stpPortRestrictedRole=stpPortRestrictedRole, qosDiffServType05=qosDiffServType05, qosDiffServType09=qosDiffServType09, sysLoginTimeoutInterval=sysLoginTimeoutInterval, qosDiffServType17=qosDiffServType17, aclProfileRuleCount=aclProfileRuleCount, aclProfileSrcMacAddrMask=aclProfileSrcMacAddrMask, sysHardwareVersion=sysHardwareVersion, aRPSpoofPreventIpAddr=aRPSpoofPreventIpAddr, stpGlobal=stpGlobal, stpPort=stpPort, qosDiffServType43=qosDiffServType43, igsVlanMulticastGroupPortList=igsVlanMulticastGroupPortList, snmpV3UserAuthProtocol=snmpV3UserAuthProtocol, dot1qVlanUntaggedPorts=dot1qVlanUntaggedPorts, sysSafeGuardEnable=sysSafeGuardEnable, sysSNTPDSTStartDay=sysSNTPDSTStartDay, qosDiffServType42=qosDiffServType42, tftpCfgServerIpAddress=tftpCfgServerIpAddress, stpPortEntry=stpPortEntry, aclL2RuleEntry=aclL2RuleEntry, laPortChannelIfIndex=laPortChannelIfIndex, snmpV3GroupName=snmpV3GroupName, qosDiffServType60=qosDiffServType60, aclProfileStatus=aclProfileStatus, aclProfileDstMacAddrMask=aclProfileDstMacAddrMask, stpMaxAge=stpMaxAge, snmpV3TrapRSTPStateChange=snmpV3TrapRSTPStateChange, stpPortForwardTransitions=stpPortForwardTransitions, aclL3RuleTcpUdpDstPortMask=aclL3RuleTcpUdpDstPortMask, qosDiffServType59=qosDiffServType59, snmpV3HostTable=snmpV3HostTable, sysMirrorStatus=sysMirrorStatus, aclL3RuleSrcIpAddr=aclL3RuleSrcIpAddr, laPortChannelEntry=laPortChannelEntry, voicevlanOUIEntry=voicevlanOUIEntry, d_link=d_link, aclL3RuleTcpUdpSrcPort=aclL3RuleTcpUdpSrcPort, autoSurveillanceVlanPriority=autoSurveillanceVlanPriority, sysSNTPDSTEndMin=sysSNTPDSTEndMin, igsVlanMulticastGroupIpAddress=igsVlanMulticastGroupIpAddress, qosDiffServType48=qosDiffServType48, sysPortCtrlFlowControl=sysPortCtrlFlowControl, igsVlanMulticastGroupEntry=igsVlanMulticastGroupEntry, snmpV3UserVersion=snmpV3UserVersion, dot1qVlanAsyOnOff=dot1qVlanAsyOnOff, companySystem=companySystem, igsVlanRouterVlanId=igsVlanRouterVlanId, sysTrapIP=sysTrapIP, snmpV3viewTreeStatus=snmpV3viewTreeStatus, PortList=PortList, voiceVlanId=voiceVlanId, topologyChange=topologyChange, stpPortPathCost=stpPortPathCost, syslogSeverity=syslogSeverity, syslogGeneralGroup=syslogGeneralGroup, stpPortEdge=stpPortEdge, stpTopChanges=stpTopChanges, laPortActorActivity=laPortActorActivity, autoSurveillanceVlanSystem=autoSurveillanceVlanSystem, qosDiffServType40=qosDiffServType40, aclL3RuleICMPMessageCode=aclL3RuleICMPMessageCode, stpBridgeHelloTime=stpBridgeHelloTime, snmpV3Group=snmpV3Group, qosDiffServType04=qosDiffServType04, qosDiffServType29=qosDiffServType29, snmpV3TrapBootup=snmpV3TrapBootup, qosDiffServType56=qosDiffServType56, snmpV3viewTreeSubtree=snmpV3viewTreeSubtree, stpPortAdminPointToPoint=stpPortAdminPointToPoint, BridgeId=BridgeId, igsVlanRouterTable=igsVlanRouterTable, snmpV3HostStatus=snmpV3HostStatus, qosDiffServType26=qosDiffServType26, qosDiffServType06=qosDiffServType06, LacpKey=LacpKey, qosDiffServType31=qosDiffServType31, snmpV3CommunityName=snmpV3CommunityName, voicevlanOUIStatus=voicevlanOUIStatus, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, sysTrapStateChangeEvent=sysTrapStateChangeEvent, stpPortDesignatedRoot=stpPortDesignatedRoot, staticEntry=staticEntry, igsVlanFilterTable=igsVlanFilterTable, sysTrapFiberPortEvent=sysTrapFiberPortEvent, dot1xAuthMaxReq=dot1xAuthMaxReq, snmpV3GroupSecurityModel=snmpV3GroupSecurityModel, stpVersion=stpVersion, sysSNTPState=sysSNTPState, companyACLGroup=companyACLGroup, dot1qVlanUngisterMCFilterTable=dot1qVlanUngisterMCFilterTable, aclProfile=aclProfile, voicevlanOUIDescription=voicevlanOUIDescription, securityARPSpoofPrevent=securityARPSpoofPrevent, qosDiffServType20=qosDiffServType20, snmpV3UserPrivProtocolPassword=snmpV3UserPrivProtocolPassword, aRPSpoofPreventRowStatus=aRPSpoofPreventRowStatus, staticDisableAutoLearn=staticDisableAutoLearn, snmpV3TrapSNMPAuthentication=snmpV3TrapSNMPAuthentication, bandwidthCtrlSettings=bandwidthCtrlSettings, firmwareIllegalFile=firmwareIllegalFile, qosDiffServType30=qosDiffServType30, snmpV3GroupNotifyViewName=snmpV3GroupNotifyViewName, igsVlanMulticastGroupTable=igsVlanMulticastGroupTable, igsVlanFilterEntry=igsVlanFilterEntry, aclL2AccessID=aclL2AccessID, dot1pPortEntry=dot1pPortEntry, laPortControlTable=laPortControlTable, aclL3RuleStatus=aclL3RuleStatus, stpForwardDelay=stpForwardDelay)
mibBuilder.exportSymbols("DES-1210-52_AX", igsVlanRouterEntry=igsVlanRouterEntry, aclL3RuleProfileNo=aclL3RuleProfileNo, autoSurveillanceVlanOUITable=autoSurveillanceVlanOUITable, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, qosDiffServType02=qosDiffServType02, snmpV3GroupReadViewName=snmpV3GroupReadViewName, snmpV3HostEntry=snmpV3HostEntry, laPortChannelMemberList=laPortChannelMemberList, portSecState=portSecState, snmpV3HostCommunityName=snmpV3HostCommunityName, qosDiffServType07=qosDiffServType07, qosDiffServType58=qosDiffServType58, sysLBDCtrlEntry=sysLBDCtrlEntry, snmpV3TrapCopperLinkUpDown=snmpV3TrapCopperLinkUpDown, igsGrpQueryInterval=igsGrpQueryInterval, qosDiffServType34=qosDiffServType34, snmpV3viewTreeName=snmpV3viewTreeName, stpPortDesignatedPort=stpPortDesignatedPort, aclL3RuleSrcIpAddrMask=aclL3RuleSrcIpAddrMask, aclL3RuleTcpRstBit=aclL3RuleTcpRstBit, sysSNTPDSTState=sysSNTPDSTState, sslCipherSuiteList=sslCipherSuiteList, autoSurveillanceVlanOUIStatus=autoSurveillanceVlanOUIStatus, snmpV3CommunityEntry=snmpV3CommunityEntry, dot1qVlanUngisterMCFiltermode=dot1qVlanUngisterMCFiltermode, qosDiffServType10=qosDiffServType10, syslogFacility=syslogFacility, laSystem=laSystem, miscStatisticsReset=miscStatisticsReset, queuingMechanism=queuingMechanism, laPortControlIndex=laPortControlIndex, aclL2RuleTable=aclL2RuleTable, stpPortTable=stpPortTable, laPortControl=laPortControl, broadcastStormCtrlSettings=broadcastStormCtrlSettings, igsVlanMulticastGroupVlanId=igsVlanMulticastGroupVlanId, sysPortCtrlMDI=sysPortCtrlMDI, qosDiffServType28=qosDiffServType28, dot1qVlanEgressPorts=dot1qVlanEgressPorts, aclL3RuleTcpAckBit=aclL3RuleTcpAckBit, portSecEntry=portSecEntry, stpDesignatedRoot=stpDesignatedRoot, aRPSpoofPreventTable=aRPSpoofPreventTable, sysIpAddr=sysIpAddr, qosDiffServType24=qosDiffServType24, snmpV3UserAuthProtocolPassword=snmpV3UserAuthProtocolPassword, stpPortRestrictedTCN=stpPortRestrictedTCN, stpHoldTime=stpHoldTime, aclProfileSrcIpAddrMask=aclProfileSrcIpAddrMask, dot1qVlanTable=dot1qVlanTable, snmpV3UserStatus=snmpV3UserStatus, sysSave=sysSave, snmpV3HostVersion=snmpV3HostVersion, aclL3RulePortList=aclL3RulePortList, igsVlanRouterPortList=igsVlanRouterPortList, qosDiffServEnable=qosDiffServEnable, companyTraps=companyTraps, sysLBDPortLoopStatus=sysLBDPortLoopStatus, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, voicevlanPortAutoDetection=voicevlanPortAutoDetection, tftpFwTftpOperationStatus=tftpFwTftpOperationStatus, companyTrafficMgmt=companyTrafficMgmt, stpRootCost=stpRootCost, firmwareTransferError=firmwareTransferError, aclProfileArpSenderMacAddrMask=aclProfileArpSenderMacAddrMask, firmwareChecksumError=firmwareChecksumError, aclL2RuleAction=aclL2RuleAction, qosDiffServType21=qosDiffServType21, igsVlan=igsVlan, snmpV3CommunityStatus=snmpV3CommunityStatus, qosDiffServType55=qosDiffServType55, companyStaticMAC=companyStaticMAC, sysSNTPDSTOffset=sysSNTPDSTOffset, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, qosDiffServType37=qosDiffServType37, stpBridgeForwardDelay=stpBridgeForwardDelay, stpPortProtocolMigration=stpPortProtocolMigration, snmpV3Community=snmpV3Community, aclProfileIPProtocol=aclProfileIPProtocol, voiceVlanTimeout=voiceVlanTimeout, broadcastStormCtrlThreshold=broadcastStormCtrlThreshold, qosDiffServType22=qosDiffServType22, stpPortDesignatedCost=stpPortDesignatedCost, sysLBDStateEnable=sysLBDStateEnable, snmpV3ViewTreeTable=snmpV3ViewTreeTable, qosDiffServType13=qosDiffServType13, qosDiffServType52=qosDiffServType52, staticStatus=staticStatus, qosDiffServType18=qosDiffServType18, sslSecurityHttpStatus=sslSecurityHttpStatus, qosMode=qosMode, sysDhcpAutoConfiguration=sysDhcpAutoConfiguration, bandwidthCtrlRxThreshold=bandwidthCtrlRxThreshold, companyTrapSetting=companyTrapSetting, sysTrapTwistedPortEvent=sysTrapTwistedPortEvent, qosDiffServType45=qosDiffServType45, igsVlanMulticastGroupMacAddress=igsVlanMulticastGroupMacAddress, sysPortCtrlFlowControlOper=sysPortCtrlFlowControlOper, aclProfileSrcPortMask=aclProfileSrcPortMask, qosDiffServType36=qosDiffServType36, stpPortDesignatedBridge=stpPortDesignatedBridge, sysSNTPDSTStartHour=sysSNTPDSTStartHour, companySecurity=companySecurity, aclL3RuleTable=aclL3RuleTable, sysLBDRecoverTime=sysLBDRecoverTime, dot1qVlanPvid=dot1qVlanPvid, staticTable=staticTable, autoSurveillanceVlanId=autoSurveillanceVlanId, igsQueryInterval=igsQueryInterval, snmpV3User=snmpV3User, snmpV3ViewTreeEntry=snmpV3ViewTreeEntry, aclProfileDstIpAddrMask=aclProfileDstIpAddrMask, companyIpifGroup=companyIpifGroup, aclL2RuleInPortList=aclL2RuleInPortList, stpProtocolSpecification=stpProtocolSpecification, igsSystem=igsSystem, snmpV3Host=snmpV3Host, aclL3RuleEntry=aclL3RuleEntry, igsRobustnessValue=igsRobustnessValue, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, portSecIndex=portSecIndex, sysIpAddrCfgMode=sysIpAddrCfgMode, sysGateway=sysGateway, des_1210_52ax=des_1210_52ax, snmpV3UserPrivProtocol=snmpV3UserPrivProtocol, sysSNTPTimeSeconds=sysSNTPTimeSeconds, aclL3RuleICMPMessageType=aclL3RuleICMPMessageType, trustedHostEntry=trustedHostEntry, autoSurveillanceVlanMode=autoSurveillanceVlanMode, tftpFwTftpOperation=tftpFwTftpOperation, qosDiffServType14=qosDiffServType14, sysLBDCtrlIndex=sysLBDCtrlIndex, autoSurveillanceVlanOUISurveillanceOUI=autoSurveillanceVlanOUISurveillanceOUI, dot1qVlanRowStatus=dot1qVlanRowStatus, sysSNTPPollInterval=sysSNTPPollInterval, aclL2RuleSrcMacAddrMask=aclL2RuleSrcMacAddrMask, radiusServerSharedSecret=radiusServerSharedSecret, aclL3RuleIgmpType=aclL3RuleIgmpType, companyAutoSurveillanceVlan=companyAutoSurveillanceVlan, firmwareUpgradeFailure=firmwareUpgradeFailure, syslogLogging=syslogLogging, snmpV3UserTable=snmpV3UserTable, qosDiffServType38=qosDiffServType38, sysGroupInterval=sysGroupInterval, sysMirrorCtrlIngressMirroring=sysMirrorCtrlIngressMirroring, sysSNTPSecondServer=sysSNTPSecondServer, voicevlanSystem=voicevlanSystem, aclL3RuleTcpSynBit=aclL3RuleTcpSynBit, igsVlanQueryInterval=igsVlanQueryInterval, snmpV3TrapFiberLinkUpDown=snmpV3TrapFiberLinkUpDown, sysLBDCtrlTable=sysLBDCtrlTable, igsStatus=igsStatus, qosDiffServType46=qosDiffServType46, sysLBDInterval=sysLBDInterval, aclL2RuleStatus=aclL2RuleStatus, companyDot1xGroup=companyDot1xGroup, sslCiphers=sslCiphers, tftpConfigTftpOperation=tftpConfigTftpOperation, snmpV3GroupWriteViewName=snmpV3GroupWriteViewName, securityPortSecurity=securityPortSecurity, qosDiffServType35=qosDiffServType35, aclProfileNo=aclProfileNo, staticVlanID=staticVlanID, qosDiffServType49=qosDiffServType49, aclL2RuleDstMacAddr=aclL2RuleDstMacAddr, stpTimeSinceTopologyChange=stpTimeSinceTopologyChange, stpTxHoldCount=stpTxHoldCount, sysSystemPassword=sysSystemPassword, qosDiffServType25=qosDiffServType25, sysSNTPDSTEndDay=sysSNTPDSTEndDay, laPortChannelMode=laPortChannelMode, snmpV3viewTreeMask=snmpV3viewTreeMask, sysSNTPDSTEndHour=sysSNTPDSTEndHour, qosDiffServType50=qosDiffServType50, qosDiffServType62=qosDiffServType62, aclL2Rule=aclL2Rule, firmwareUpgradeSuccess=firmwareUpgradeSuccess, syslogUDPPort=syslogUDPPort, qosDiffServType51=qosDiffServType51, trustedHostIpMask=trustedHostIpMask, sysTrapStatus=sysTrapStatus, companyLA=companyLA, companyLBD=companyLBD, voicevlanPortControlEntry=voicevlanPortControlEntry, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, bandwidthCtrlEntry=bandwidthCtrlEntry, securityTrustedHost=securityTrustedHost, staticAutoLearningList=staticAutoLearningList, sysRestart=sysRestart, sysPortCtrlIndex=sysPortCtrlIndex, aclL2RuleEtherType=aclL2RuleEtherType, laPortActorTimeout=laPortActorTimeout, qosDiffServType41=qosDiffServType41, dot1qVlanPortTable=dot1qVlanPortTable, bandwidthCtrlIndex=bandwidthCtrlIndex, igsVlanCfgQuerier=igsVlanCfgQuerier, voicevlanOUIMask=voicevlanOUIMask, igsVlanQuerier=igsVlanQuerier, voicevlanOUITable=voicevlanOUITable, sysSNTPGMTMinutes=sysSNTPGMTMinutes, bandwidthCtrlTable=bandwidthCtrlTable, qosDiffServ=qosDiffServ, qosDiffServType54=qosDiffServType54, syslogLogSrvAddr=syslogLogSrvAddr, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, qosDiffServType01=qosDiffServType01, qosDiffServType08=qosDiffServType08, laPortActorPortPriority=laPortActorPortPriority, dot1xAuthTxPeriod=dot1xAuthTxPeriod, portSecMLA=portSecMLA, dot1qVlanName=dot1qVlanName, sysLBDPortStatus=sysLBDPortStatus, laPortControlEntry=laPortControlEntry, aclProfileDstPortMask=aclProfileDstPortMask, staticPort=staticPort, qosDiffServType39=qosDiffServType39, dot1qVlanPortEntry=dot1qVlanPortEntry, snmpV3UserEntry=snmpV3UserEntry, igsVlanFilterVlanId=igsVlanFilterVlanId, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, qosDiffServType44=qosDiffServType44, aclL3RuleTcpPshBit=aclL3RuleTcpPshBit, aclProfileType=aclProfileType, snmpV3GroupSecurityLevel=snmpV3GroupSecurityLevel, voicevlanPortControlIndex=voicevlanPortControlIndex, aclL3RuleProtocol=aclL3RuleProtocol, sysFirmwareVersion=sysFirmwareVersion, snmpV3GroupEntry=snmpV3GroupEntry, aclProfileMask=aclProfileMask, igsVlanSnoopStatus=igsVlanSnoopStatus, qosDiffServType53=qosDiffServType53, qosDiffServType27=qosDiffServType27, qosQ1p=qosQ1p, securityDhcpServerScreen=securityDhcpServerScreen)
