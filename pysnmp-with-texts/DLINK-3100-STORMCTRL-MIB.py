...
if mibBuilder.loadTexts: rlStormCtrl.setContactInfo('www.dlink.com')
...
if mibBuilder.loadTexts: rlStormCtrlSWAction.setDescription('indicate the action to perform on storm')
...
if mibBuilder.loadTexts: rlStormCtrlSWInterval.setDescription('indicate the time interval in seconds at which to poll for storming')
...
if mibBuilder.loadTexts: rlStormCtrlSWTrapEnabled.setDescription('determines weather a trap will be issued when port is suspended due to SW storm control')
mibBuilder.exportSymbols("DLINK-3100-STORMCTRL-MIB", rlStormCtrlMulticastRate=rlStormCtrlMulticastRate, rlStormCtrlSWAction=rlStormCtrlSWAction, PYSNMP_MODULE_ID=rlStormCtrl, rlStormCtrlSetDefaultUnknownMulticastRate=rlStormCtrlSetDefaultUnknownMulticastRate, rlStormCtrlEnbaleDependencyBetweenTypes=rlStormCtrlEnbaleDependencyBetweenTypes, rlStormCtrlUnknownUnicastRate=rlStormCtrlUnknownUnicastRate, rlStormCtrlSetDefaultUnknownMulticastEnable=rlStormCtrlSetDefaultUnknownMulticastEnable, rlStormCtrlMulticastEnable=rlStormCtrlMulticastEnable, rlStormCtrlSupport=rlStormCtrlSupport, rlStormCtrl=rlStormCtrl, rlStormCtrlGroupTable=rlStormCtrlGroupTable, rlStormCtrlRateType=rlStormCtrlRateType, rlStormCtrlBroadcastRate=rlStormCtrlBroadcastRate, rlStormCtrlUnknownMulticastRate=rlStormCtrlUnknownMulticastRate, rlStormCtrlRateUnitTypeSupport=rlStormCtrlRateUnitTypeSupport, rlStormCtrlGroupMulticastId=rlStormCtrlGroupMulticastId, rlStormCtrlSetDefaultRateType=rlStormCtrlSetDefaultRateType, rlStormCtrlSetDefaultUnknownUnicastRate=rlStormCtrlSetDefaultUnknownUnicastRate, rlStormCtrlSetDefaultBroadcastEnable=rlStormCtrlSetDefaultBroadcastEnable, rlStormCtrlTable=rlStormCtrlTable, rlStormCtrlMibVersion=rlStormCtrlMibVersion, rlStormCtrlSetDefaultBroadcastRate=rlStormCtrlSetDefaultBroadcastRate, rlStormCtrlUnknownMulticastEnable=rlStormCtrlUnknownMulticastEnable, rlStormCtrlRateSupportPerType=rlStormCtrlRateSupportPerType, rlStormCtrlSetDefaultUnknownUnicastEnable=rlStormCtrlSetDefaultUnknownUnicastEnable, rlStormCtrlSWInterval=rlStormCtrlSWInterval, rlStormCtrlGroupBroadcastId=rlStormCtrlGroupBroadcastId, rlStormCtrlUnknownUnicastEnable=rlStormCtrlUnknownUnicastEnable, rlStormCtrlSetDefaultMulticastEnable=rlStormCtrlSetDefaultMulticastEnable, rlStormCtrlBroadcastEnable=rlStormCtrlBroadcastEnable, rlStormCtrlSetDefaultMulticastRate=rlStormCtrlSetDefaultMulticastRate, rlStormCtrlTypeSupport=rlStormCtrlTypeSupport, rlStormCtrlEntry=rlStormCtrlEntry, rlStormCtrlRateDependencyBetweenTypes=rlStormCtrlRateDependencyBetweenTypes, rlStormCtrlGroupUnknownUnicastId=rlStormCtrlGroupUnknownUnicastId, RlStormCtrlRateUnit=RlStormCtrlRateUnit, RlSormCtrlActionType=RlSormCtrlActionType, rlStormCtrlSWTrapEnabled=rlStormCtrlSWTrapEnabled, rlStormCtrlGroupEntry=rlStormCtrlGroupEntry, rlStormCtrlGroupUnknownMulticastId=rlStormCtrlGroupUnknownMulticastId)
