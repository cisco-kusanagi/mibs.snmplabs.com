...
# Produced by pysmi-0.3.4 at Wed May  1 12:45:24 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, IpAddress, Integer32, ObjectIdentity, Gauge32, Unsigned32, ModuleIdentity, Counter64, MibIdentifier, TimeTicks, Bits, NotificationType, iso = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "IpAddress", "Integer32", "ObjectIdentity", "Gauge32", "Unsigned32", "ModuleIdentity", "Counter64", "MibIdentifier", "TimeTicks", "Bits", "NotificationType", "iso")
...
mibBuilder.exportSymbols("DGS1100-18ME-MGMT-MIB", VlanIndex=VlanIndex, PYSNMP_MODULE_ID=swL2MgmtMIB, PortList=PortList, VlanId=VlanId, swL2MgmtMIB=swL2MgmtMIB)
