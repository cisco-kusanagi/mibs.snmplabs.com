...
# Produced by pysmi-0.3.4 at Wed May  1 13:14:57 2019
...
MibIdentifier, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Integer32, Counter32, iso, Bits, ObjectIdentity, Unsigned32, ModuleIdentity, IpAddress, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Integer32", "Counter32", "iso", "Bits", "ObjectIdentity", "Unsigned32", "ModuleIdentity", "IpAddress", "Gauge32")
...
mibBuilder.exportSymbols("FOUNDRY-IP-SOURCE-GUARD-MIB", BindType=BindType, fdryIpSrcGuardBindMode=fdryIpSrcGuardBindMode, PYSNMP_MODULE_ID=fdryIpSrcGuardMIB, fdryIpSrcGuardPortVlan=fdryIpSrcGuardPortVlan, fdryIpSrcGuardBindTable=fdryIpSrcGuardBindTable, fdryIpSrcGuardBindType=fdryIpSrcGuardBindType, fdryIpSrcGuardIfConfigEntry=fdryIpSrcGuardIfConfigEntry, fdryIpSrcGuardPortVlanVlanId=fdryIpSrcGuardPortVlanVlanId, fdryIpSrcGuardBindRowStatus=fdryIpSrcGuardBindRowStatus, BindMode=BindMode, fdryIpSrcGuardBindVlanId=fdryIpSrcGuardBindVlanId, fdryIpSrcGuardBindEntry=fdryIpSrcGuardBindEntry, fdryIpSrcGuardPortVlanEnable=fdryIpSrcGuardPortVlanEnable, fdryIpSrcGuardBind=fdryIpSrcGuardBind, fdryIpSrcGuardPortVlanConfigTable=fdryIpSrcGuardPortVlanConfigTable, fdryIpSrcGuardPortVlanPortId=fdryIpSrcGuardPortVlanPortId, fdryIpSrcGuardMIB=fdryIpSrcGuardMIB, fdryIpSrcGuardIfConfigTable=fdryIpSrcGuardIfConfigTable, fdryIpSrcGuardBindIpAddr=fdryIpSrcGuardBindIpAddr, fdryIpSrcGuardPortVlanConfigEntry=fdryIpSrcGuardPortVlanConfigEntry, fdryIpSrcGuardIfEnable=fdryIpSrcGuardIfEnable, fdryIpSrcGuardInterface=fdryIpSrcGuardInterface)
