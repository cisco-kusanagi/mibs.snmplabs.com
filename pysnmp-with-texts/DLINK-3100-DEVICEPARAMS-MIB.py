...
ObjectIdentity, iso, Integer32, TimeTicks, NotificationType, Bits, Gauge32, Unsigned32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, ModuleIdentity, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "iso", "Integer32", "TimeTicks", "NotificationType", "Bits", "Gauge32", "Unsigned32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "ModuleIdentity", "Counter64", "IpAddress")
...
if mibBuilder.loadTexts: rndDeviceParams.setContactInfo('www.dlink.com')
...
mibBuilder.exportSymbols("DLINK-3100-DEVICEPARAMS-MIB", genGroup=genGroup, rndImageInfoTable=rndImageInfoTable, RlImageIdType=RlImageIdType, rlComponentsInfoImageId=rlComponentsInfoImageId, rlManagedMrid=rlManagedMrid, rndBrgFeatures=rndBrgFeatures, rndIpHostManagement=rndIpHostManagement, rndImage1Version=rndImage1Version, rndDeviceParams=rndDeviceParams, rndInactiveArpTimeOut=rndInactiveArpTimeOut, rndErrorSeverity=rndErrorSeverity, rndCommunityTrapDestPort=rndCommunityTrapDestPort, rndActiveSoftwareFile=rndActiveSoftwareFile, rlComponentsInfoBaseline=rlComponentsInfoBaseline, rndImageSize=rndImageSize, rndBackupConfigurationEnabled=rndBackupConfigurationEnabled, rndCommunityAccess=rndCommunityAccess, rndImage2Name=rndImage2Name, rndCommunityString=rndCommunityString, rlMridEntry=rlMridEntry, rndBaseBootVersion=rndBaseBootVersion, rndManagedDate=rndManagedDate, rndImageInfo=rndImageInfo, rndActiveSoftwareFileAfterReset=rndActiveSoftwareFileAfterReset, rndActiveSoftwareFileEntry=rndActiveSoftwareFileEntry, rndUnitNumber=rndUnitNumber, rndImageInfoEntry=rndImageInfoEntry, rndImage1Date=rndImage1Date, rndImage2Time=rndImage2Time, rlMridTable=rlMridTable, rlResetStatus=rlResetStatus, rndManagedTime=rndManagedTime, rndStackUnitNumber=rndStackUnitNumber, rndBridgeType=rndBridgeType, rndImage1Name=rndImage1Name, rlComponentsInfoComponent=rlComponentsInfoComponent, rndCommunityTable=rndCommunityTable, rndCommunityOwner=rndCommunityOwner, rndIpHost=rndIpHost, rndErrorDesc=rndErrorDesc, rndCommunityEntry=rndCommunityEntry, rndImage2Date=rndImage2Date, rndCommunityMngStationAddr=rndCommunityMngStationAddr, rndCommunityPortSecurity=rndCommunityPortSecurity, rndIpHostManagementSupported=rndIpHostManagementSupported, PYSNMP_MODULE_ID=rndDeviceParams, rndCommunityStatus=rndCommunityStatus, genGroupHWVersion=genGroupHWVersion, genGroupConfigurationSymbol=genGroupConfigurationSymbol, rlComponentsInfoTable=rlComponentsInfoTable, rndCommunityTrapsEnable=rndCommunityTrapsEnable, rndBridgeAlarm=rndBridgeAlarm, rndBrgLicense=rndBrgLicense, genGroupHWStatus=genGroupHWStatus, rndBasePhysicalAddress=rndBasePhysicalAddress, rndImage2Version=rndImage2Version, rndIpHostManagementIfIndex=rndIpHostManagementIfIndex, rlComponentsInfoStackUnitNumber=rlComponentsInfoStackUnitNumber, rndImage1Time=rndImage1Time, rlComponentsInfoEntry=rlComponentsInfoEntry, rlMridConnection=rlMridConnection, rndSoftwareFile=rndSoftwareFile, rndActiveSoftwareFileTable=rndActiveSoftwareFileTable, rndBrgVersion=rndBrgVersion)
