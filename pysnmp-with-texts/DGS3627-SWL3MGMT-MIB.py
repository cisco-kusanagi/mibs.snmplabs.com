...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS3627-SWL3MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:46:40 2019
...
PositiveInteger, AreaID, Metric, RouterID, DesignatedRouterPriority, TOSType, UpToMaxAge, HelloRange, Status = mibBuilder.importSymbols("OSPF-MIB", "PositiveInteger", "AreaID", "Metric", "RouterID", "DesignatedRouterPriority", "TOSType", "UpToMaxAge", "HelloRange", "Status")
ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup")
iso, Gauge32, Integer32, Bits, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, Unsigned32, TimeTicks, ModuleIdentity, IpAddress, MibIdentifier, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Gauge32", "Integer32", "Bits", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "Unsigned32", "TimeTicks", "ModuleIdentity", "IpAddress", "MibIdentifier", "Counter32")
RowStatus, DisplayString, TruthValue, PhysAddress, MacAddress, TimeStamp, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TruthValue", "PhysAddress", "MacAddress", "TimeStamp", "TextualConvention")
...
swL3ospfIfDistributeListInType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 6, 3, 8, 1, 24), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
swL3RIPInboundRouteFilterType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 6, 3, 19, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS3627-SWL3MGMT-MIB", swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3LoopBackIpCtrlIfIndex=swL3LoopBackIpCtrlIfIndex, swL3LoopBackIpCtrlAdminState=swL3LoopBackIpCtrlAdminState, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3LoopBackIpCtrlIpSubnetMask=swL3LoopBackIpCtrlIpSubnetMask, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3DHCPRelayOption60DefTable=swL3DHCPRelayOption60DefTable, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3OspfHostMetric=swL3OspfHostMetric, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3VrrpOperTable=swL3VrrpOperTable, swL3Md5Table=swL3Md5Table, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3DevCtrlDHCPAutoConfigState=swL3DevCtrlDHCPAutoConfigState, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3RoutePreferenceDefault=swL3RoutePreferenceDefault, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3ospfAreaType=swL3ospfAreaType, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3Md5KeyId=swL3Md5KeyId, swL3IpCtrlState=swL3IpCtrlState, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3RoutePreferenceIBGP=swL3RoutePreferenceIBGP, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3Route6RedistriType=swL3Route6RedistriType, swL3ospfIfMetric=swL3ospfIfMetric, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3DHCPRelayOption61DefMode=swL3DHCPRelayOption61DefMode, swL3RIPInboundRouteFilterTable=swL3RIPInboundRouteFilterTable, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3ospfIfState=swL3ospfIfState, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3DHCPRelayOption61=swL3DHCPRelayOption61, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=swL3Ipv6DHCPv6CPDAddrCtrlPrefixName, swL3Ipv6Address=swL3Ipv6Address, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3DHCPRelayOption61DefRelayIp=swL3DHCPRelayOption61DefRelayIp, swL3OspfHostStatus=swL3OspfHostStatus, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3RelayDhcpOption82Policy=swL3RelayDhcpOption82Policy, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3LoopBackIpCtrlIpAddr=swL3LoopBackIpCtrlIpAddr, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3Route6RedistriSrcProtocol=swL3Route6RedistriSrcProtocol, swL3OspfHostTOS=swL3OspfHostTOS, swL3DHCPRelayOption60RelayIp=swL3DHCPRelayOption60RelayIp, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3IpCtrlDhcpv6ClientPDPrefixLen=swL3IpCtrlDhcpv6ClientPDPrefixLen, swL3LoopBackIpCtrlInterfaceName=swL3LoopBackIpCtrlInterfaceName, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3DHCPRelayOption60Entry=swL3DHCPRelayOption60Entry, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3DHCPRelayOption61ClientID=swL3DHCPRelayOption61ClientID, swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen, swL3LoopBackIpCtrlTable=swL3LoopBackIpCtrlTable, swL3DHCPRelayOption61Table=swL3DHCPRelayOption61Table, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3Md5Entry=swL3Md5Entry, swL3RelayDhcpOption82CheckState=swL3RelayDhcpOption82CheckState, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3RIPInboundRouteFilterEntry=swL3RIPInboundRouteFilterEntry, swL3IpCtrlAdminState=swL3IpCtrlAdminState, NetAddress=NetAddress, swL3RelayDnsState=swL3RelayDnsState, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3ospfIfDistributeListInType=swL3ospfIfDistributeListInType, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3DevCtrlPIMState=swL3DevCtrlPIMState, swL3DHCPRelayOption60String=swL3DHCPRelayOption60String, swL3OspfECMPState=swL3OspfECMPState, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3RelayDhcpCtrlInterfaceName=swL3RelayDhcpCtrlInterfaceName, swL3ospfIfEntry=swL3ospfIfEntry, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3RIPInboundRouteFilterType=swL3RIPInboundRouteFilterType, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3Ipv6DHCPv6CPDAddrCtrlTable=swL3Ipv6DHCPv6CPDAddrCtrlTable, swL3Ipv6DHCPv6CPDAddrCtrlState=swL3Ipv6DHCPv6CPDAddrCtrlState, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3DevCtrl=swL3DevCtrl, swL3IpCtrlDhcpv6ClientPDPrefixName=swL3IpCtrlDhcpv6ClientPDPrefixName, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3RouteRedistriType=swL3RouteRedistriType, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3ospfIfDemand=swL3ospfIfDemand, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3IpCtrlDhcpv6ClientPDPrefix=swL3IpCtrlDhcpv6ClientPDPrefix, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3DHCPRelayOption60DefMode=swL3DHCPRelayOption60DefMode, swL3ospfAreaId=swL3ospfAreaId, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3RelayDhcpState=swL3RelayDhcpState, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3Route6RedistriDstProtocol=swL3Route6RedistriDstProtocol, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3DHCPRelayOption60Table=swL3DHCPRelayOption60Table, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3Route6RedistriRowStatus=swL3Route6RedistriRowStatus, swL3Ipv6DHCPv6CPDAddrCtrlEntry=swL3Ipv6DHCPv6CPDAddrCtrlEntry, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3DHCPRelayOption60DefRelayIp=swL3DHCPRelayOption60DefRelayIp, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3DHCPRelayOption61Mode=swL3DHCPRelayOption61Mode, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3OspfHostEntry=swL3OspfHostEntry, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3DHCPRelayOption60State=swL3DHCPRelayOption60State, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3RelayDhcpTimeThreshold=swL3RelayDhcpTimeThreshold, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3IpCtrlDhcpv6ClientPDState=swL3IpCtrlDhcpv6ClientPDState, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3RelayMgmt=swL3RelayMgmt, swL3DHCPRelayOption60DefEntry=swL3DHCPRelayOption60DefEntry, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3RelayDhcpHopCount=swL3RelayDhcpHopCount, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3VrrpOperEntry=swL3VrrpOperEntry, NodeAddress=NodeAddress, swL3Ipv6AddressCtrlAddressType=swL3Ipv6AddressCtrlAddressType, swL3LoopBackIpCtrlEntry=swL3LoopBackIpCtrlEntry, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3ospfIfDistributeListInName=swL3ospfIfDistributeListInName, swL3ospfIfEvents=swL3ospfIfEvents, swL3RIPInboundRouteFilterIfIpAddress=swL3RIPInboundRouteFilterIfIpAddress, swL3ospfAreaTable=swL3ospfAreaTable, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3Route6RedistriEntry=swL3Route6RedistriEntry, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3DHCPRelayOption61ClientType=swL3DHCPRelayOption61ClientType, swL3RelayDhcpCtrlTable=swL3RelayDhcpCtrlTable, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3RelayDhcpOption82State=swL3RelayDhcpOption82State, swL3DHCPRelayOption60DefRowStatus=swL3DHCPRelayOption60DefRowStatus, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3DHCPRelayOption61Entry=swL3DHCPRelayOption61Entry, swL3VrrpOperState=swL3VrrpOperState, swL3ospfIfType=swL3ospfIfType, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3DevMgmt=swL3DevMgmt, swL3OspfHostTable=swL3OspfHostTable, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3MgmtMIB=swL3MgmtMIB, swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3RelayDhcpCtrlServer=swL3RelayDhcpCtrlServer, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3DHCPRelayOption61RelayIp=swL3DHCPRelayOption61RelayIp, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3Route6RedistriTable=swL3Route6RedistriTable, swL3IpCtrlMode=swL3IpCtrlMode, swL3LoopBackIpCtrlRowStatus=swL3LoopBackIpCtrlRowStatus, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3RoutePreference=swL3RoutePreference, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3DHCPRelayOption61RowStatus=swL3DHCPRelayOption61RowStatus, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3RouteRedistriRouteMapName=swL3RouteRedistriRouteMapName, swL3Route6RedistriMetric=swL3Route6RedistriMetric)
mibBuilder.exportSymbols("DGS3627-SWL3MGMT-MIB", swL3IpMgmt=swL3IpMgmt, swL3RelayDhcpCtrlEntry=swL3RelayDhcpCtrlEntry, swL3RoutePreferenceEBGP=swL3RoutePreferenceEBGP, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3DHCPRelayOption60=swL3DHCPRelayOption60, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName, swL3IpCtrlIpDirectedBroadcastState=swL3IpCtrlIpDirectedBroadcastState, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3ospfIfTable=swL3ospfIfTable, swL3RelayDhcpCtrlState=swL3RelayDhcpCtrlState, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3RIPInboundRouteFilterName=swL3RIPInboundRouteFilterName, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3IpCtrlTable=swL3IpCtrlTable, VrId=VrId, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3DHCPRelayOption60MatchType=swL3DHCPRelayOption60MatchType, swL3DHCPRelayOption60RowStatus=swL3DHCPRelayOption60RowStatus, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3Md5RowStatus=swL3Md5RowStatus, swL3IpCtrlLocalProxyArp=swL3IpCtrlLocalProxyArp, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, Ipv6Address=Ipv6Address, swL3DHCPRelayOption61State=swL3DHCPRelayOption61State, swL3Md5Key=swL3Md5Key, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3RelayDhcpMgmt=swL3RelayDhcpMgmt, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3IpCtrlMgmt=swL3IpCtrlMgmt)
