...
ModuleIdentity, ObjectIdentity, TimeTicks, IpAddress, Gauge32, Counter32, NotificationType, MibIdentifier, Bits, Unsigned32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "ObjectIdentity", "TimeTicks", "IpAddress", "Gauge32", "Counter32", "NotificationType", "MibIdentifier", "Bits", "Unsigned32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "enterprises")
TextualConvention, DisplayString, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "MacAddress")
aerohive = ModuleIdentity((1, 3, 6, 1, 4, 1, 26928))
if mibBuilder.loadTexts: aerohive.setLastUpdated('200612140000Z')
if mibBuilder.loadTexts: aerohive.setOrganization('Aerohive Networks, Inc')
if mibBuilder.loadTexts: aerohive.setContactInfo('info@aerohive.com 330 Gibraltar Drive Sunnyvale CA, 94089')
if mibBuilder.loadTexts: aerohive.setDescription('This is the MIB module for object type definitions that are used throughout the Aerohive Networks enterprise MIBs.')
...
mibBuilder.exportSymbols("AH-SMI-MIB", AhString=AhString, ahAPHiveAP028_ag=ahAPHiveAP028_ag, ahAPIDP=ahAPIDP, ahAPMRP=ahAPMRP, AhInterfaceType=AhInterfaceType, ahAPInterface=ahAPInterface, ahAPHiveAP340_n=ahAPHiveAP340_n, ahAPTrap=ahAPTrap, AhNodeID=AhNodeID, AhMACProtocol=AhMACProtocol, ahAPHiveAP020_ag=ahAPHiveAP020_ag, ahAPCommon=ahAPCommon, PYSNMP_MODULE_ID=aerohive, aerohive=aerohive, ahAP=ahAP, AhInterfaceMode=AhInterfaceMode, ahProduct=ahProduct, ahAPHiveAP320_n=ahAPHiveAP320_n)
