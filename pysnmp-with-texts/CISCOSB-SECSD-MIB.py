...
if mibBuilder.loadTexts: rlSecSd.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
mibBuilder.exportSymbols("CISCOSB-SECSD-MIB", rlSecSdRuleRead=rlSecSdRuleRead, PYSNMP_MODULE_ID=rlSecSd, rlSecSdConfigurationFileDigest=rlSecSdConfigurationFileDigest, rlSecSdCurrentSessionId=rlSecSdCurrentSessionId, RlSecSdPermitAccessType=RlSecSdPermitAccessType, rlSecSdRulePermitRead=rlSecSdRulePermitRead, RlSecSdSessionAccessType=RlSecSdSessionAccessType, rlSecSdRuleIsDefault=rlSecSdRuleIsDefault, rlSecSdSessionControl=rlSecSdSessionControl, rlSecSdRuleChannel=rlSecSdRuleChannel, rlSecSdMngSessionId=rlSecSdMngSessionId, RlSecSdRuleOwnerType=RlSecSdRuleOwnerType, rlSecSdMngSessionsTable=rlSecSdMngSessionsTable, rlSecSdMngSessionUserName=rlSecSdMngSessionUserName, rlSecSdPassPhrase=rlSecSdPassPhrase, rlSecSdRuleOwner=rlSecSdRuleOwner, rlSecSdFileIntegrityControl=rlSecSdFileIntegrityControl, rlSecSdConfigurationFileSsdDigest=rlSecSdConfigurationFileSsdDigest, rlSecSdRuleUserName=rlSecSdRuleUserName, rlSecSd=rlSecSd, rlSecSdFilePassphraseControl=rlSecSdFilePassphraseControl, RlSecSdAccessType=RlSecSdAccessType, rlSecSdRulesTable=rlSecSdRulesTable, rlSecSdFileIndicator=rlSecSdFileIndicator, rlSecSdMngSessionsEntry=rlSecSdMngSessionsEntry, RlSecSdChannelType=RlSecSdChannelType, rlSecSdMngSessionChannel=rlSecSdMngSessionChannel, rlSecSdMngSessionUserLevel=rlSecSdMngSessionUserLevel, RlSecSdRuleUserType=RlSecSdRuleUserType, rlSecSdRuleUser=rlSecSdRuleUser, rlSecSdRuleStatus=rlSecSdRuleStatus, rlSecSdRulesEntry=rlSecSdRulesEntry)
