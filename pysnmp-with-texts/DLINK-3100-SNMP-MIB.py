...
# Produced by pysmi-0.3.4 at Wed May  1 12:49:01 2019
...
MibIdentifier, Integer32, Unsigned32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Gauge32, ObjectIdentity, iso, IpAddress, Counter32, Counter64, Bits, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Integer32", "Unsigned32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Gauge32", "ObjectIdentity", "iso", "IpAddress", "Counter32", "Counter64", "Bits", "TimeTicks")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: rlSNMP.setRevisionsDescriptions(('Added rlEvents MIB.', 'Added rlSNMPenable object.', 'Initial version of this MIB.',))
if mibBuilder.loadTexts: rlSNMP.setLastUpdated('200709100000Z')
if mibBuilder.loadTexts: rlSNMP.setOrganization('Dlink, Inc.')
if mibBuilder.loadTexts: rlSNMP.setContactInfo('www.dlink.com')
if mibBuilder.loadTexts: rlSNMP.setDescription('Private MIB module for SNMP support in DLINK-3100 devices.')
...
mibBuilder.exportSymbols("DLINK-3100-SNMP-MIB", rlMridInetEntry=rlMridInetEntry, rndCommunityInetEntry=rndCommunityInetEntry, rlSnmpUDPMridDomain=rlSnmpUDPMridDomain, RlSnmpUDPIpv6MridAddress=RlSnmpUDPIpv6MridAddress, rlSNMPenable=rlSNMPenable, rlSNMPv3IpAddrToIndexMappedIndex=rlSNMPv3IpAddrToIndexMappedIndex, rlEventIndexInMask=rlEventIndexInMask, rlEventsDeleteEvents=rlEventsDeleteEvents, rlSnmpRequestMridEntry=rlSnmpRequestMridEntry, RlSnmpUDPMridAddress=RlSnmpUDPMridAddress, RlSnmpUDPIpv6zMridAddress=RlSnmpUDPIpv6zMridAddress, rndCommunityInetAccess=rndCommunityInetAccess, rlEventsPollerId=rlEventsPollerId, rndCommunityInetOwner=rndCommunityInetOwner, rlEventsTable=rlEventsTable, rlEventId=rlEventId, rlEventsMaskMask=rlEventsMaskMask, rlEventsMaskPollerId=rlEventsMaskPollerId, rndCommunityInetPortSecurity=rndCommunityInetPortSecurity, rlSNMPv3IpAddrToIndexAddr=rlSNMPv3IpAddrToIndexAddr, rlSNMPv3IpAddrToIndexTable=rlSNMPv3IpAddrToIndexTable, rlEventsPollingControlTable=rlEventsPollingControlTable, rlInetManagedMrid=rlInetManagedMrid, rlSnmpRequestManagedMrid=rlSnmpRequestManagedMrid, rndCommunityInetString=rndCommunityInetString, rlSnmpEngineID=rlSnmpEngineID, rlTargetAddrExtTable=rlTargetAddrExtTable, rlSnmpRequestMridTable=rlSnmpRequestMridTable, rlEvents=rlEvents, rlNotifyFilterTestingLevel=rlNotifyFilterTestingLevel, rndCommunityInetTrapsEnable=rndCommunityInetTrapsEnable, rlTargetAddrMagicUsedInIndex=rlTargetAddrMagicUsedInIndex, rndCommunityInetAltAddrType=rndCommunityInetAltAddrType, rlSnmpUdpIpv6zMridDomain=rlSnmpUdpIpv6zMridDomain, rndCommunityInetStatus=rndCommunityInetStatus, rlEventsMaskEntry=rlEventsMaskEntry, rlEventsPoller=rlEventsPoller, rlEventsStatus=rlEventsStatus, rlEventsPollingControlPollerId=rlEventsPollingControlPollerId, rlSNMP=rlSNMP, rlSNMPv3IpAddrToIndexAddrType=rlSNMPv3IpAddrToIndexAddrType, rlEventsPollingControlPollingInterval=rlEventsPollingControlPollingInterval, rlEventsEntry=rlEventsEntry, rlTargetAddrExtEntry=rlTargetAddrExtEntry, rlSnmpUdpIpv6MridDomain=rlSnmpUdpIpv6MridDomain, rlSNMPDomains=rlSNMPDomains, rlSNMPv3=rlSNMPv3, rlEventsMaskTable=rlEventsMaskTable, rndCommunityInetTrapDestPort=rndCommunityInetTrapDestPort, rlSNMPv3IpAddrToIndexEntry=rlSNMPv3IpAddrToIndexEntry, rlSnmpRequestMridStatus=rlSnmpRequestMridStatus, rlMridInetConnection=rlMridInetConnection, PYSNMP_MODULE_ID=rlSNMP, rlTargetParamsTestingLevel=rlTargetParamsTestingLevel, rndCommunityInetTable=rndCommunityInetTable, rlEventsPollingControlEntry=rlEventsPollingControlEntry, rndCommunityInetMngStationAddr=rndCommunityInetMngStationAddr, rndCommunityInetMngStationAddrType=rndCommunityInetMngStationAddrType, rndCommunityInetAltAddr=rndCommunityInetAltAddr, rlMridInetTable=rlMridInetTable, rlEventsDefaultPollingInterval=rlEventsDefaultPollingInterval)
