...
# Produced by pysmi-0.3.4 at Wed May  1 14:24:12 2019
...
TimeTicks, enterprises, MibIdentifier, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Gauge32, Bits, ModuleIdentity, NotificationType, IpAddress, iso, Integer32, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "enterprises", "MibIdentifier", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Gauge32", "Bits", "ModuleIdentity", "NotificationType", "IpAddress", "iso", "Integer32", "Counter32")
...
mibBuilder.exportSymbols("NOVELL-RIPSAP-MIB", ripCircAgeMultiplier=ripCircAgeMultiplier, ripCircTable=ripCircTable, sapCircAgeMultiplier=sapCircAgeMultiplier, ripSysIncorrectPackets=ripSysIncorrectPackets, sapSysTable=sapSysTable, ripsapSystem=ripsapSystem, sapCircOutPackets=sapCircOutPackets, sapSysIncorrectPackets=sapSysIncorrectPackets, ripSysEntry=ripSysEntry, ripCircPacketSize=ripCircPacketSize, ripCircState=ripCircState, ripSysInstance=ripSysInstance, ripCircPace=ripCircPace, sapCircState=sapCircState, ripSysState=ripSysState, ripCircInPackets=ripCircInPackets, ripCircEntry=ripCircEntry, ripCircIndex=ripCircIndex, sapCircIndex=sapCircIndex, sapCircTable=sapCircTable, ripCircSysInstance=ripCircSysInstance, sapCircUpdate=sapCircUpdate, sapCircEntry=sapCircEntry, sapSysState=sapSysState, sapCircSysInstance=sapCircSysInstance, sapCircGetNearestServerReply=sapCircGetNearestServerReply, sapSysInstance=sapSysInstance, ripCircOutPackets=ripCircOutPackets, sapCircPacketSize=sapCircPacketSize, ripCircUpdate=ripCircUpdate, ripsap=ripsap, sapCircPace=sapCircPace, ripSysTable=ripSysTable, sapCircInPackets=sapCircInPackets, sapSysEntry=sapSysEntry, ripsapCircuit=ripsapCircuit)
