...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS3426P-L2MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:46:25 2019
...
NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, TimeTicks, IpAddress, Bits, Counter64, ModuleIdentity, Gauge32, MibIdentifier, ObjectIdentity, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "TimeTicks", "IpAddress", "Bits", "Counter64", "ModuleIdentity", "Gauge32", "MibIdentifier", "ObjectIdentity", "Counter32")
...
swL2PortInfoErrDisReason = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 7, 2, 3, 1, 1, 7), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("err-none", 1), ("storm-control", 2), ("lbd-control", 3)))).setMaxAccess("readonly")
...
swL2QOSSchedulingEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 70, 7, 2, 6, 2, 1), ).setIndexNames((0, "DGS3426P-L2MGMT-MIB", "swL2QOSSchedulingClassIndex"))
...
swL2QOSSchedulingClassIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 7, 2, 6, 2, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 7))).setMaxAccess("readonly")
...
swL2QOSSchedulingMaxPkts = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 7, 2, 6, 2, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 15))).setMaxAccess("readwrite")
...
swL2QOSSchedulingMechanism = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 7, 2, 6, 2, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("strict", 1), ("roundrobin", 2), ("weightfair", 3)))).setMaxAccess("readonly")
...
swL2PortSecurityMaxLernAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 7, 2, 7, 1, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 16))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS3426P-L2MGMT-MIB", swL2LoopDetectPortIndex=swL2LoopDetectPortIndex, swL2TrunkActivePorts=swL2TrunkActivePorts, swL2IGMPMulticastVlanName=swL2IGMPMulticastVlanName, swL2IGMPMulticastVlanGroupVid=swL2IGMPMulticastVlanGroupVid, swL2LoopDetectInterval=swL2LoopDetectInterval, swL2IGMPMulticastVlanTagMemberPort=swL2IGMPMulticastVlanTagMemberPort, swL2MgmtMIB=swL2MgmtMIB, swL2PortAutoNegInfoCapAdvertisedBits=swL2PortAutoNegInfoCapAdvertisedBits, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swIGMPSnoopingGroupExcludePortMap=swIGMPSnoopingGroupExcludePortMap, swL2IGMPSnoopingStaticGroupRowStatus=swL2IGMPSnoopingStaticGroupRowStatus, swL2QOSBandwidthRxRate=swL2QOSBandwidthRxRate, swL2QOSBandwidthRadiusRxRate=swL2QOSBandwidthRadiusRxRate, swL2IGMPRouterPortsEntry=swL2IGMPRouterPortsEntry, swL2PortInfoUnitID=swL2PortInfoUnitID, swL2IGMPMulticastVlanSourcePort=swL2IGMPMulticastVlanSourcePort, swL2IGMPMulticastVlanGroupFromIp=swL2IGMPMulticastVlanGroupFromIp, swL2LoopDetectedNotify=swL2LoopDetectedNotify, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2PortAutoNegInfoPortIndex=swL2PortAutoNegInfoPortIndex, swL2QOSSchedulingClassIndex=swL2QOSSchedulingClassIndex, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2QOSSchedulingEntry=swL2QOSSchedulingEntry, swL2PortSecurityMgmt=swL2PortSecurityMgmt, swDevInfoFirmwareVersion=swDevInfoFirmwareVersion, swL2QOS8021pDefaultPriorityTable=swL2QOS8021pDefaultPriorityTable, swL2IGMPCtrlTable=swL2IGMPCtrlTable, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2IpLimitedMulticastPortIndex=swL2IpLimitedMulticastPortIndex, swL2PortCounterCtrlPortIndex=swL2PortCounterCtrlPortIndex, swL2IGMPIpGroupReportCount=swL2IGMPIpGroupReportCount, swL2VlanMgmt=swL2VlanMgmt, swL2IGMPMulticastVlanRowStatus=swL2IGMPMulticastVlanRowStatus, swL2MirrorPortState=swL2MirrorPortState, swL2VlanIndex=swL2VlanIndex, swL2LoopDetectMgmt=swL2LoopDetectMgmt, swL2QOS8021pUserPriorityEntry=swL2QOS8021pUserPriorityEntry, swL2IpLimitedMulticastState=swL2IpLimitedMulticastState, swDevModuleInfoEntry=swDevModuleInfoEntry, swL2TrunkMgmt=swL2TrunkMgmt, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2PortVLANIngressDrops=swL2PortVLANIngressDrops, swL2VlanStaticPorts=swL2VlanStaticPorts, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2IGMPHostTimeout=swL2IGMPHostTimeout, swL2macNotifyInfo=swL2macNotifyInfo, swL2PortCounterClearCtrl=swL2PortCounterClearCtrl, VlanId=VlanId, swL2IGMPPortMap=swL2IGMPPortMap, swL2VlanForbiddenPorts=swL2VlanForbiddenPorts, swL2PortAutoNegInfoCapabilityBits=swL2PortAutoNegInfoCapabilityBits, swL2IGMPSnoopingStaticGroupTable=swL2IGMPSnoopingStaticGroupTable, swIGMPSnoopingGroupTable=swIGMPSnoopingGroupTable, swL2IGMPSnoopingStaticGroupEntry=swL2IGMPSnoopingStaticGroupEntry, swL2PortInfoType=swL2PortInfoType, swL2IGMPMulticastVlanTable=swL2IGMPMulticastVlanTable, swL2IGMPRouteTimeout=swL2IGMPRouteTimeout, swL2QOSBandwidthTxRate=swL2QOSBandwidthTxRate, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swDevInfoBootPromVersion=swDevInfoBootPromVersion, swL2VlanTable=swL2VlanTable, swL2IGMPMaxResponseTime=swL2IGMPMaxResponseTime, swL2PortSecurityDelActivity=swL2PortSecurityDelActivity, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2Notify=swL2Notify, swL2IpLimitedMulticastDelState=swL2IpLimitedMulticastDelState, swL2DevMgmt=swL2DevMgmt, swL2PortCtrlJumboFrameMaxSize=swL2PortCtrlJumboFrameMaxSize, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swDevModuleInfoTable=swDevModuleInfoTable, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2IpLimitedMulticastAccess=swL2IpLimitedMulticastAccess, swL2DevCtrlRmonState=swL2DevCtrlRmonState, swL2IGMPInfoQueryCount=swL2IGMPInfoQueryCount, swL2QOS8021pDefaultPriority=swL2QOS8021pDefaultPriority, swL2VlanCurrentUntaggedPorts=swL2VlanCurrentUntaggedPorts, swL2PortSecurityAdmState=swL2PortSecurityAdmState, swL2TrunkMember=swL2TrunkMember, swL2QOS8021pUserPriorityIndex=swL2QOS8021pUserPriorityIndex, swL2IGMPRouterPortsVid=swL2IGMPRouterPortsVid, swL2IGMPMulticastVlanGroupEntry=swL2IGMPMulticastVlanGroupEntry, swL2IGMPQueryVersion=swL2IGMPQueryVersion, swDevModuleInfoUnitID=swDevModuleInfoUnitID, swL2IGMPMulticastVlanGroupToIp=swL2IGMPMulticastVlanGroupToIp, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2QOS8021pUserPriorityClass=swL2QOS8021pUserPriorityClass, swL2LoopDetectPortMgmt=swL2LoopDetectPortMgmt, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swIGMPSnoopingGroupIncludePortMap=swIGMPSnoopingGroupIncludePortMap, swL2QOSSchedulingMechanism=swL2QOSSchedulingMechanism, swL2MultiFilterMode=swL2MultiFilterMode, swL2IpLimitedMulticastTable=swL2IpLimitedMulticastTable, swL2PortLoopOccurred=swL2PortLoopOccurred, IANAifMauAutoNegCapBits=IANAifMauAutoNegCapBits, swDevModuleInfoSerial=swDevModuleInfoSerial, PortList=PortList, swL2TrunkIndex=swL2TrunkIndex, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2QOS8021pRadiusPriority=swL2QOS8021pRadiusPriority, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2DevAlarm=swL2DevAlarm, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2LoopDetectPortLoopVLAN=swL2LoopDetectPortLoopVLAN, swL2IGMPCtrlState=swL2IGMPCtrlState, swL2QOSBandwidthControlEntry=swL2QOSBandwidthControlEntry, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2IpLimitedMulticastHead=swL2IpLimitedMulticastHead, swL2QOSMgmt=swL2QOSMgmt, swL2PortCtrlTable=swL2PortCtrlTable, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2IpLimitedMulticastTail=swL2IpLimitedMulticastTail, swL2NotifFirmware=swL2NotifFirmware, swL2DevCtrlClipagingState=swL2DevCtrlClipagingState, swL2IGMPMgmt=swL2IGMPMgmt, swL2DevInfo=swL2DevInfo, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swDevModuleInfoModuleName=swDevModuleInfoModuleName, swL2QOS8021pDefaultPriorityEntry=swL2QOS8021pDefaultPriorityEntry, swL2TrunkState=swL2TrunkState, swL2TrunkName=swL2TrunkName, swL2IGMPCtrlEntry=swL2IGMPCtrlEntry, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2IpLimitedMulticastEntry=swL2IpLimitedMulticastEntry, swL2LoopDetectPortEntry=swL2LoopDetectPortEntry, swL2QOS8021pUserPriorityTable=swL2QOS8021pUserPriorityTable, swL2QOSBandwidthRadiusTxRate=swL2QOSBandwidthRadiusTxRate, swL2IGMPReportSuppression=swL2IGMPReportSuppression, swL2LoopDetectPortLoopStatus=swL2LoopDetectPortLoopStatus, swL2IGMPGroupIpAddr=swL2IGMPGroupIpAddr, swL2PortLoopRestart=swL2PortLoopRestart, swl2NotificationBidings=swl2NotificationBidings, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2PortCtrlAutoNegCapAdvertisedBits=swL2PortCtrlAutoNegCapAdvertisedBits, swL2PortAutoNegInfoEntry=swL2PortAutoNegInfoEntry, swL2PortSecurityDelVlanName=swL2PortSecurityDelVlanName, swL2IGMPQueryInfoTable=swL2IGMPQueryInfoTable, swL2IGMPInfoEntry=swL2IGMPInfoEntry, swL2MultiFilterVid=swL2MultiFilterVid, swL2NotifyPrefix=swL2NotifyPrefix, swL2IGMPLastMemberQueryInterval=swL2IGMPLastMemberQueryInterval, swL2TrunkType=swL2TrunkType, swL2PortSecurityMaxLernAddr=swL2PortSecurityMaxLernAddr, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2VlanEntry=swL2VlanEntry, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2PortSecurityDelPort=swL2PortSecurityDelPort, swL2VlanLoopDetectVID=swL2VlanLoopDetectVID, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2PortCounterCtrlEntry=swL2PortCounterCtrlEntry, swL2QOSSchedulingTable=swL2QOSSchedulingTable, swL2QOSHolPreventionCtrl=swL2QOSHolPreventionCtrl, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2TrafficSegTable=swL2TrafficSegTable, swL2IGMPMulticastVlanReplaceSourceIp=swL2IGMPMulticastVlanReplaceSourceIp, swDevModuleInfoReversion=swDevModuleInfoReversion, swL2IGMPRouterDynamicPortList=swL2IGMPRouterDynamicPortList, swL2VlanName=swL2VlanName, swL2IGMPFastLeaveState=swL2IGMPFastLeaveState, swL2LoopDetectRecoverTime=swL2LoopDetectRecoverTime, swL2DevCtrl=swL2DevCtrl, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2PortSecurityControlTable=swL2PortSecurityControlTable, swL2PortMgmt=swL2PortMgmt, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2IGMPRouterStaticPortList=swL2IGMPRouterStaticPortList, swL2IGMPMulticastVlanState=swL2IGMPMulticastVlanState, swL2IGMPMulticastVlanRemoveAllMcastAddrListAction=swL2IGMPMulticastVlanRemoveAllMcastAddrListAction, swL2PortInfoErrDisReason=swL2PortInfoErrDisReason, swL2QOSBandwidthPortIndex=swL2QOSBandwidthPortIndex, swL2PortCtrlLockState=swL2PortCtrlLockState, swL2IGMPInfoTable=swL2IGMPInfoTable, swL2VlanStaticTaggedPorts=swL2VlanStaticTaggedPorts, swL2PortCtrlMediumType=swL2PortCtrlMediumType, swL2QOSBandwidthControlTable=swL2QOSBandwidthControlTable, swL2macNotification=swL2macNotification, swL2PortDropCounterPortIndex=swL2PortDropCounterPortIndex, swL2TrafficSegPort=swL2TrafficSegPort, swL2IGMPMulticastVlanEntry=swL2IGMPMulticastVlanEntry, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swL2VlanAdvertisementState=swL2VlanAdvertisementState, swL2IGMPMulticastVlanGroupStatus=swL2IGMPMulticastVlanGroupStatus, swL2PVIDAutoAssignmentState=swL2PVIDAutoAssignmentState, swL2IGMPInfoTxQueryCount=swL2IGMPInfoTxQueryCount, swL2VlanMemberPorts=swL2VlanMemberPorts, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2PortSecurityDelMacAddress=swL2PortSecurityDelMacAddress, swL2IGMPMulticastVlanGroupTable=swL2IGMPMulticastVlanGroupTable, swL2LoopDetectPortState=swL2LoopDetectPortState, swL2MirrorMgmt=swL2MirrorMgmt, swDevModuleInfoDescription=swDevModuleInfoDescription, swL2PortInfoMediumType=swL2PortInfoMediumType, swIGMPSnoopingGroupGroupAddr=swIGMPSnoopingGroupGroupAddr, swL2IGMPMulticastVlanMemberPort=swL2IGMPMulticastVlanMemberPort, swL2IGMPCtrlVid=swL2IGMPCtrlVid, swL2IpLimitedMulticastMgmt=swL2IpLimitedMulticastMgmt, swL2PortDropCounterTable=swL2PortDropCounterTable, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2IGMPQueryInterval=swL2IGMPQueryInterval, MacAddress=MacAddress, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2PortSecurityMode=swL2PortSecurityMode, swL2IGMPMaxIpGroupNumPerVlan=swL2IGMPMaxIpGroupNumPerVlan, swL2LoopDetectAdminState=swL2LoopDetectAdminState, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2DevCtrlIGMPSnoopingMcstRTOnly=swL2DevCtrlIGMPSnoopingMcstRTOnly, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2PortSecurityControlEntry=swL2PortSecurityControlEntry, swIGMPSnoopingGroupSourceAddr=swIGMPSnoopingGroupSourceAddr, swL2QOS8021pDefaultPriorityIndex=swL2QOS8021pDefaultPriorityIndex, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2PortDropCounterEntry=swL2PortDropCounterEntry, swL2VlanType=swL2VlanType, swL2DevCtrlIGMPSnooping=swL2DevCtrlIGMPSnooping, swL2IGMPRobustness=swL2IGMPRobustness, swL2MACNotifyState=swL2MACNotifyState, swIGMPSnoopingGroupVid=swIGMPSnoopingGroupVid, swL2DevCtrlIpAutoconfig=swL2DevCtrlIpAutoconfig, swL2PortACLDrops=swL2PortACLDrops, swL2IGMPMacAddr=swL2IGMPMacAddr, swL2DevCtrlStpState=swL2DevCtrlStpState, swL2LoopDetectPortTable=swL2LoopDetectPortTable, swL2IGMPQueryState=swL2IGMPQueryState, swL2PortAutoNegInfoCapReceivedBits=swL2PortAutoNegInfoCapReceivedBits, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swL2IGMPMaxSupportedVlans=swL2IGMPMaxSupportedVlans, swL2IGMPInfoVid=swL2IGMPInfoVid, swL2MultiFilterTable=swL2MultiFilterTable, swL2IGMPRouterForbiddenPortList=swL2IGMPRouterForbiddenPortList, swL2PortAutoNegInfoAdminStatus=swL2PortAutoNegInfoAdminStatus, swL2LoopDetectMode=swL2LoopDetectMode, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2PortCounterCtrlTable=swL2PortCounterCtrlTable, swL2IGMPSnoopingStaticGroupIPaddress=swL2IGMPSnoopingStaticGroupIPaddress, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2IGMPCurrentState=swL2IGMPCurrentState, swIGMPSnoopingGroupEntry=swIGMPSnoopingGroupEntry, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2PortInfoEntry=swL2PortInfoEntry, swL2QOSSchedulingMechanismCtrl=swL2QOSSchedulingMechanismCtrl, swL2IGMPSnoopingStaticGroupVID=swL2IGMPSnoopingStaticGroupVID, swL2IGMPMulticastVlanid=swL2IGMPMulticastVlanid, swL2IGMPQueryInfoEntry=swL2IGMPQueryInfoEntry, swL2IGMPLeaveTimer=swL2IGMPLeaveTimer, swDevInfoFrontPanelLedStatus=swDevInfoFrontPanelLedStatus, swL2IGMPVid=swL2IGMPVid, swL2IGMPRouterPortsTable=swL2IGMPRouterPortsTable, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries)
mibBuilder.exportSymbols("DGS3426P-L2MGMT-MIB", swL2LoopDetectCtrl=swL2LoopDetectCtrl, swL2LoopDetectTrapMode=swL2LoopDetectTrapMode, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2VlanLoopRestart=swL2VlanLoopRestart, swL2PortBufferFullDrops=swL2PortBufferFullDrops, swL2PortSecurityPortIndex=swL2PortSecurityPortIndex, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2IGMPSnoopingStaticGroupMemberPortList=swL2IGMPSnoopingStaticGroupMemberPortList, swL2VlanLoopOccurred=swL2VlanLoopOccurred, swL2VlanStaticUntaggedPorts=swL2VlanStaticUntaggedPorts, swL2PortInfoTable=swL2PortInfoTable, swL2VlanCurrentTaggedPorts=swL2VlanCurrentTaggedPorts, swL2PortMulticastDrops=swL2PortMulticastDrops, swL2PortAutoNegInfoTable=swL2PortAutoNegInfoTable, swL2QOSSchedulingMaxPkts=swL2QOSSchedulingMaxPkts, swL2MultiFilter=swL2MultiFilter, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2MultiFilterEntry=swL2MultiFilterEntry, swL2PortSecurityDelCtrl=swL2PortSecurityDelCtrl, swL2PortCtrlAutoNegRestart=swL2PortCtrlAutoNegRestart, swDevModuleInfoModuleID=swDevModuleInfoModuleID)
