...
TimeTicks, NotificationType, Bits, Integer32, ObjectIdentity, Gauge32, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Unsigned32, IpAddress, iso, ModuleIdentity, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "NotificationType", "Bits", "Integer32", "ObjectIdentity", "Gauge32", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Unsigned32", "IpAddress", "iso", "ModuleIdentity", "Counter64")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: rlCopy.setRevisionsDescriptions(('Added USB file type.', 'Added objects rlCopyInetDestinationUnitList,rlCopyHistoryInetDestinationUnitList,rlCopyInetUnitStatusList,rlCopyHistoryInetUnitStatusList.', 'Added mirror-config and MIB rlCopyMirrorTimeout.', 'The private MIB module definition for file copy in Radlan devices.', 'Added objects rlCopyMessagesTable and rlCopyMessagesTableRemoveEntries.', 'Initial version of this MIB.',))
...
if mibBuilder.loadTexts: rlCopyHistoryInetTotalFileSize.setDescription('The total length of image/static file')
...
if mibBuilder.loadTexts: rlCopyOptionsCheckFilePermission.setDescription('Controls whether to check file permissions during copy.')
...
if mibBuilder.loadTexts: rlCopyOptionsCheckSystemReservedStorage.setDescription('Controls whether to check system reserved storage during copy.')
...
mibBuilder.exportSymbols("RADLAN-COPY-MIB", rlCopyMessagesMessageIndex=rlCopyMessagesMessageIndex, rlCopyHistoryBytesTransferred=rlCopyHistoryBytesTransferred, rlCopyInetDestinationFileType=rlCopyInetDestinationFileType, rlCopyEntry=rlCopyEntry, rlCopyHistoryInetSourceFileName=rlCopyHistoryInetSourceFileName, rlCopyInetApplicationId=rlCopyInetApplicationId, rlCopyHistoryInetSourceIpAddress=rlCopyHistoryInetSourceIpAddress, rlCopyFinished=rlCopyFinished, rlCopyInetRowStatus=rlCopyInetRowStatus, rlCopyHistoryInetOperationState=rlCopyHistoryInetOperationState, rlCopySourceUnitNumber=rlCopySourceUnitNumber, RlCopyApplicationType=RlCopyApplicationType, rlCopyHistoryEntry=rlCopyHistoryEntry, rlCopyDestinationIpAddress=rlCopyDestinationIpAddress, rlCopyInetUnitStatusList=rlCopyInetUnitStatusList, rlCopyHistoryInetSourceIpAddressType=rlCopyHistoryInetSourceIpAddressType, rlCopyOptionsIndex=rlCopyOptionsIndex, rlCopyInetEntry=rlCopyInetEntry, rlCopyMessagesMessageText=rlCopyMessagesMessageText, rlCopyMirrorEnable=rlCopyMirrorEnable, rlCopyHistorySourceFileType=rlCopyHistorySourceFileType, rlCopySourceFileName=rlCopySourceFileName, rlCopyHistorySourceFileName=rlCopyHistorySourceFileName, rlCopyHistoryInetDestinationIpAddressType=rlCopyHistoryInetDestinationIpAddressType, rlCopyFreeHistoryIndex=rlCopyFreeHistoryIndex, rlCopyInetSourceFileType=rlCopyInetSourceFileType, rlCopyHistoryDestinationFileType=rlCopyHistoryDestinationFileType, rlCopyHistoryIndex=rlCopyHistoryIndex, rlCopyHistoryTable=rlCopyHistoryTable, rlCopyInetDestinationFileName=rlCopyInetDestinationFileName, rlCopyFailed=rlCopyFailed, rlCopyHistoryInetDestinationFileType=rlCopyHistoryInetDestinationFileType, RlCopyLocationType=RlCopyLocationType, rlCopyInetDestinationLocation=rlCopyInetDestinationLocation, rlCopyHistoryUpTime=rlCopyHistoryUpTime, rlCopyInetDestinationIpAddress=rlCopyInetDestinationIpAddress, rlCopyInetSourceIpAddress=rlCopyInetSourceIpAddress, rlCopySourceFileType=rlCopySourceFileType, rlCopyHistoryInetUnitStatusList=rlCopyHistoryInetUnitStatusList, rlCopyOperationState=rlCopyOperationState, rlCopyDestinationLocation=rlCopyDestinationLocation, rlCopyHistoryInetDestinationUnitNumber=rlCopyHistoryInetDestinationUnitNumber, rlCopySourceIpAddress=rlCopySourceIpAddress, rlCopyHistorySourceUnitNumber=rlCopyHistorySourceUnitNumber, rlCopyMirror=rlCopyMirror, rlCopyHistoryInetDestinationIpAddress=rlCopyHistoryInetDestinationIpAddress, rlCopyHistoryInetSourceUnitNumber=rlCopyHistoryInetSourceUnitNumber, rlCopyHistoryRowStatus=rlCopyHistoryRowStatus, rlCopyApplicationId=rlCopyApplicationId, rlCopyHistoryInetHistoryIndex=rlCopyHistoryInetHistoryIndex, rlCopyHistoryInetDestinationFileName=rlCopyHistoryInetDestinationFileName, rlCopyHistoryOperationState=rlCopyHistoryOperationState, rlCopyOptionsCheckFilePermission=rlCopyOptionsCheckFilePermission, rlCopyHistoryInetUpTime=rlCopyHistoryInetUpTime, rlCopyHistoryInetTotalFileSize=rlCopyHistoryInetTotalFileSize, rlCopyInetSourceLocation=rlCopyInetSourceLocation, rlCopyMirrorFileIllegal=rlCopyMirrorFileIllegal, rlCopyMessagesEntry=rlCopyMessagesEntry, rlCopyHistoryInetSourceLocation=rlCopyHistoryInetSourceLocation, rlCopySourceLocation=rlCopySourceLocation, rlCopyDestinationFileType=rlCopyDestinationFileType, rlCopyHistorySourceLocation=rlCopyHistorySourceLocation, rlCopyInetDestinationUnitNumber=rlCopyInetDestinationUnitNumber, rlCopyHistoryInetDestinationUnitList=rlCopyHistoryInetDestinationUnitList, rlCopyHistoryInetBytesTransferred=rlCopyHistoryInetBytesTransferred, rlCopyInetSpecificCopyInfo=rlCopyInetSpecificCopyInfo, rlCopyMibVersion=rlCopyMibVersion, rlCopyHistoryInetApplicationId=rlCopyHistoryInetApplicationId, rlCopyHistoryApplicationId=rlCopyHistoryApplicationId, rlCopyInetSourceIpAddressType=rlCopyInetSourceIpAddressType, rlCopyHistorySourceIpAddress=rlCopyHistorySourceIpAddress, rlCopyInetHistoryIndex=rlCopyInetHistoryIndex, rlCopyHistoryInetTable=rlCopyHistoryInetTable, rlCopyHistoryInetInBackground=rlCopyHistoryInetInBackground, rlCopyHistoryDestinationIpAddress=rlCopyHistoryDestinationIpAddress, RlCopyFileType=RlCopyFileType, rlCopySWFinished=rlCopySWFinished, rlCopyHistoryDestinationUnitNumber=rlCopyHistoryDestinationUnitNumber, rlCopyBytesTransferred=rlCopyBytesTransferred, rlCopyHistoryHistoryIndex=rlCopyHistoryHistoryIndex, rlCopyOptionsTable=rlCopyOptionsTable, rlCopyOptionsRequestedSsdAccess=rlCopyOptionsRequestedSsdAccess, rlCopyAuditingEnable=rlCopyAuditingEnable, rlCopyUpTime=rlCopyUpTime, PYSNMP_MODULE_ID=rlCopy, RlCopySecSdAccessType=RlCopySecSdAccessType, rlCopyInetInBackground=rlCopyInetInBackground, rlCopyIndex=rlCopyIndex, rlCopyHistoryInetRowStatus=rlCopyHistoryInetRowStatus, rlCopyHistoryErrorMessage=rlCopyHistoryErrorMessage, rlCopyDestinationFileName=rlCopyDestinationFileName, rlCopyMessagesStatus=rlCopyMessagesStatus, rlCopyHistoryInetSourceFileType=rlCopyHistoryInetSourceFileType, rlCopyInetUpTime=rlCopyInetUpTime, rlCopyHistoryDestinationFileName=rlCopyHistoryDestinationFileName, rlCopyInetIndex=rlCopyInetIndex, rlCopyTable=rlCopyTable, rlCopyHistoryInetDestinationLocation=rlCopyHistoryInetDestinationLocation, rlCopyRowStatus=rlCopyRowStatus, rlCopyInetDestinationUnitList=rlCopyInetDestinationUnitList, rlCopyUnitsList=rlCopyUnitsList, rlCopyMessagesTableRemoveEntries=rlCopyMessagesTableRemoveEntries, rlCopyInetOperationState=rlCopyInetOperationState, rlCopyInetDestinationIpAddressType=rlCopyInetDestinationIpAddressType, rlCopy=rlCopy, rlCopyMessagesTable=rlCopyMessagesTable, rlCopyMessagesCopyIndex=rlCopyMessagesCopyIndex, rlCopyInBackground=rlCopyInBackground, rlCopyHistoryInetErrorMessage=rlCopyHistoryInetErrorMessage, rlCopyInetBytesTransferred=rlCopyInetBytesTransferred, rlCopySWToUnits=rlCopySWToUnits, rlCopyInetSourceUnitNumber=rlCopyInetSourceUnitNumber, rlCopyHistoryInBackground=rlCopyHistoryInBackground, rlCopyOptionsCheckSystemReservedStorage=rlCopyOptionsCheckSystemReservedStorage, rlCopyDestinationUnitNumber=rlCopyDestinationUnitNumber, rlCopyInetSourceFileName=rlCopyInetSourceFileName, rlCopyStaticDowngradeStatus=rlCopyStaticDowngradeStatus, rlCopyHistoryDestinationLocation=rlCopyHistoryDestinationLocation, rlCopyMirrorTimeout=rlCopyMirrorTimeout, rlCopyOptionsEntry=rlCopyOptionsEntry, rlCopyHistoryInetEntry=rlCopyHistoryInetEntry, rlCopyInetTable=rlCopyInetTable)
