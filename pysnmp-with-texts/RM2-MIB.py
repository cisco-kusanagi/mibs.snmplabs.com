...
# Produced by pysmi-0.3.4 at Wed May  1 14:57:58 2019
...
snmpModules, enterprises, iso, Gauge32, Bits, Counter32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, Unsigned32, ModuleIdentity, IpAddress, MibIdentifier, NotificationType, TimeTicks, Integer32, ObjectName = mibBuilder.importSymbols("SNMPv2-SMI", "snmpModules", "enterprises", "iso", "Gauge32", "Bits", "Counter32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "Unsigned32", "ModuleIdentity", "IpAddress", "MibIdentifier", "NotificationType", "TimeTicks", "Integer32", "ObjectName")
...
if mibBuilder.loadTexts: rm2.setContactInfo('')
if mibBuilder.loadTexts: rm2.setDescription('The MIB module for entities implementing the xxxx protocol.')
...
mibBuilder.exportSymbols("RM2-MIB", cpuLoadWarningThreshold=cpuLoadWarningThreshold, diskUsageAlarmPct=diskUsageAlarmPct, rmControl=rmControl, archiveDir=archiveDir, products=products, cpuLoad=cpuLoad, duIndex=duIndex, rmFileGrp=rmFileGrp, diskUsageWarningPct=diskUsageWarningPct, fmEntry=fmEntry, diskPeriod=diskPeriod, fmIndex=fmIndex, processUpTime=processUpTime, processIndex=processIndex, processNumber=processNumber, processID=processID, duNumber=duNumber, PYSNMP_MODULE_ID=rm2, filePeriod=filePeriod, cpuUtilization=cpuUtilization, rmObjectID=rmObjectID, processCPUUsageAlarmMark=processCPUUsageAlarmMark, rmSystem=rmSystem, rm2=rm2, rmUpTime=rmUpTime, processName=processName, cpuPeriod=cpuPeriod, processTable=processTable, diskUsageEntry=diskUsageEntry, processEntry=processEntry, processMemUsageAlarmMark=processMemUsageAlarmMark, resourceMonitor=resourceMonitor, lucent=lucent, rmProcessGrp=rmProcessGrp, processCPUUsageWarnMark=processCPUUsageWarnMark, duPctUsed=duPctUsed, fmName=fmName, duSize=duSize, rmNetAddress=rmNetAddress, cpuUtilAlarmPct=cpuUtilAlarmPct, softSwitch=softSwitch, rmDescr=rmDescr, duFSName=duFSName, fmThreshold=fmThreshold, processPeriod=processPeriod, rmDiskGrp=rmDiskGrp, processCPUUsageCurrent=processCPUUsageCurrent, fmCurSize=fmCurSize, fmTable=fmTable, rmCpuGrp=rmCpuGrp, processMemUsageCurrent=processMemUsageCurrent, fmNumber=fmNumber, cpuUtilWarningPct=cpuUtilWarningPct, diskUsageTable=diskUsageTable, cpuLoadAlarmThreshold=cpuLoadAlarmThreshold)
