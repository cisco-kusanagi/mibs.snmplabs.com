...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS-3420-28TC-L2MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:44:05 2019
...
Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, IpAddress, ModuleIdentity, TimeTicks, Integer32, Counter64, MibIdentifier, NotificationType, ObjectIdentity, iso, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "IpAddress", "ModuleIdentity", "TimeTicks", "Integer32", "Counter64", "MibIdentifier", "NotificationType", "ObjectIdentity", "iso", "Bits")
...
swL2PortInfoErrorDisabled = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 1, 2, 3, 1, 1, 8), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3, 4, 5, 6))).clone(namedValues=NamedValues(("none", 0), ("storm", 1), ("stp-lbd", 2), ("ctp-lbd", 3), ("ddm", 4), ("bpdu-protection", 5), ("unknow", 6)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("DGS-3420-28TC-L2MGMT-MIB", swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2MirrorGroupPortSourceIngress=swL2MirrorGroupPortSourceIngress, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2TrunkMgmt=swL2TrunkMgmt, VlanId=VlanId, swL2MACNotifyState=swL2MACNotifyState, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2macNotification=swL2macNotification, swL2TrunkState=swL2TrunkState, swL2macNotificationSeverity=swL2macNotificationSeverity, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2PortInfoTable=swL2PortInfoTable, swL2macNotifyInfo=swL2macNotifyInfo, swL2MulticastFilterModeVlanTable=swL2MulticastFilterModeVlanTable, swL2TrunkVLANPort=swL2TrunkVLANPort, swL2VLANMgmt=swL2VLANMgmt, swL2DevCtrlCFMMaEntry=swL2DevCtrlCFMMaEntry, swL2PortCounterCtrlEntry=swL2PortCounterCtrlEntry, swL2PortCtrlLearningState=swL2PortCtrlLearningState, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2VlanPortInfoEntry=swL2VlanPortInfoEntry, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2TrafficSegTable=swL2TrafficSegTable, swL2DevCtrlCFMState=swL2DevCtrlCFMState, swL2TrunkType=swL2TrunkType, swL2PortJumboFrameCtrlPortIndex=swL2PortJumboFrameCtrlPortIndex, swL2DevMgmt=swL2DevMgmt, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2NotifyMgmt=swL2NotifyMgmt, swL2PortInfoErrorDisabled=swL2PortInfoErrorDisabled, swL2MulticastFilterMode=swL2MulticastFilterMode, swL2MirrorMgmt=swL2MirrorMgmt, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swL2TrunkVLANEntry=swL2TrunkVLANEntry, MacAddress=MacAddress, swL2MirrorGroupLogicTargetPort=swL2MirrorGroupLogicTargetPort, swL2DevCtrl=swL2DevCtrl, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2DevCtrlCFMPortIndex=swL2DevCtrlCFMPortIndex, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2PortCounterCtrlTable=swL2PortCounterCtrlTable, swL2PortInfoType=swL2PortInfoType, swL2DevCtrlIpAutoconfig=swL2DevCtrlIpAutoconfig, swL2DevCtrlVLANTrunkState=swL2DevCtrlVLANTrunkState, swL2MirrorGroupRowStatus=swL2MirrorGroupRowStatus, swL2PortCtrlJumboFrameMaxSize=swL2PortCtrlJumboFrameMaxSize, swL2MulticastFilterModeVlanEntry=swL2MulticastFilterModeVlanEntry, swL2DevCtrlCFMMepMode=swL2DevCtrlCFMMepMode, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2DevCtrlCFMMepEntry=swL2DevCtrlCFMMepEntry, swL2DevCtrlAsymVlanState=swL2DevCtrlAsymVlanState, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2PortSecurityViolationSeverity=swL2PortSecurityViolationSeverity, swL2PortMgmt=swL2PortMgmt, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2MulticastFilterVid=swL2MulticastFilterVid, swL2DevCtrlSnmpTrapState=swL2DevCtrlSnmpTrapState, swL2PortJumboFrameCtrlPortState=swL2PortJumboFrameCtrlPortState, swL2PortCtrlMediumType=swL2PortCtrlMediumType, swL2PortJumboFrameCtrlEntry=swL2PortJumboFrameCtrlEntry, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2VlanStaticTable=swL2VlanStaticTable, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2VlanPortInfoVid=swL2VlanPortInfoVid, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2DevCtrlCFMMepTable=swL2DevCtrlCFMMepTable, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2TrunkVLANState=swL2TrunkVLANState, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2DevCtrlCFMPortTable=swL2DevCtrlCFMPortTable, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2PortCounterCtrlPortIndex=swL2PortCounterCtrlPortIndex, swL2VlanPortInfoPortRole=swL2VlanPortInfoPortRole, swL2MirrorGroupEntry=swL2MirrorGroupEntry, swL2TrunkMember=swL2TrunkMember, swL2DevCtrlCFMMaTable=swL2DevCtrlCFMMaTable, swL2PortInfoEntry=swL2PortInfoEntry, swL2VlanPortInfoPortIndex=swL2VlanPortInfoPortIndex, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2DevAlarm=swL2DevAlarm, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2DevCtrlCFMPortEntry=swL2DevCtrlCFMPortEntry, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2TrunkIndex=swL2TrunkIndex, swL2NotifFirmware=swL2NotifFirmware, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2NotifyPrefix=swL2NotifyPrefix, swL2PVIDAutoAssignmentState=swL2PVIDAutoAssignmentState, swL2DevCtrlCFM=swL2DevCtrlCFM, swL2VlanPortInfoTable=swL2VlanPortInfoTable, swL2PortInfoMediumType=swL2PortInfoMediumType, swL2MirrorGroupID=swL2MirrorGroupID, swL2PortInfoUnitID=swL2PortInfoUnitID, swL2TrafficSegPort=swL2TrafficSegPort, swL2MirrorGroupPortSourceEngress=swL2MirrorGroupPortSourceEngress, swL2MulticastFilterVlanMode=swL2MulticastFilterVlanMode, swL2MgmtMIB=swL2MgmtMIB, IANAifMauAutoNegCapBits=IANAifMauAutoNegCapBits, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2VlanIndex=swL2VlanIndex, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2PortCtrlTable=swL2PortCtrlTable, PortList=PortList, swL2PortCtrlMDIXState=swL2PortCtrlMDIXState, swL2Notify=swL2Notify, swL2VLANAdvertisement=swL2VLANAdvertisement, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2MirrorPortState=swL2MirrorPortState, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2PortCounterClearCtrl=swL2PortCounterClearCtrl, swL2DevCtrlCFMPortState=swL2DevCtrlCFMPortState, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swL2MirrorGroupState=swL2MirrorGroupState, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2VlanStaticEntry=swL2VlanStaticEntry, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2NniGvrpBpduAddress=swL2NniGvrpBpduAddress, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2PortJumboFrameCtrlTable=swL2PortJumboFrameCtrlTable, swl2NotificationBidings=swl2NotificationBidings, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2DevCtrlCFMMaMode=swL2DevCtrlCFMMaMode, swL2MirrorGroupTable=swL2MirrorGroupTable, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2DevInfo=swL2DevInfo, swL2TrunkVLANTable=swL2TrunkVLANTable, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swL2PortCtrlEntry=swL2PortCtrlEntry)
