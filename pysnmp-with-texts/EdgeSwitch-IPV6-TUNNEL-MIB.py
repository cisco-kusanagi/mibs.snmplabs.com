...
# Produced by pysmi-0.3.4 at Wed May  1 13:10:23 2019
...
NotificationType, MibIdentifier, Integer32, TimeTicks, IpAddress, iso, ModuleIdentity, Counter32, ObjectIdentity, Counter64, Unsigned32, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "MibIdentifier", "Integer32", "TimeTicks", "IpAddress", "iso", "ModuleIdentity", "Counter32", "ObjectIdentity", "Counter64", "Unsigned32", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: fastPathIpv6Tunnel.setRevisionsDescriptions(('Postal address updated.', 'Ubiquiti branding related changes.',))
...
if mibBuilder.loadTexts: fastPathIpv6Tunnel.setDescription('The Ubiquiti Private MIB for FastPath IPV6 Tunnel')
...
mibBuilder.exportSymbols("EdgeSwitch-IPV6-TUNNEL-MIB", agentTunnelLocalIfIndex=agentTunnelLocalIfIndex, agentTunnelRemoteIP4Addr=agentTunnelRemoteIP4Addr, agentTunnelMode=agentTunnelMode, agentTunnelIfIndex=agentTunnelIfIndex, agentTunnelIPV6PrefixTable=agentTunnelIPV6PrefixTable, agentTunnelIPV6Table=agentTunnelIPV6Table, agentTunnelStatus=agentTunnelStatus, agentTunnelIPV6PrefixEntry=agentTunnelIPV6PrefixEntry, agentTunnelIPV6PrefixPrefix=agentTunnelIPV6PrefixPrefix, agentTunnelIPV6PrefixPrefixLen=agentTunnelIPV6PrefixPrefixLen, agentTunnelIPV6Entry=agentTunnelIPV6Entry, agentTunnelIPV6Group=agentTunnelIPV6Group, agentTunnelIcmpUnreachableMode=agentTunnelIcmpUnreachableMode, agentTunnelID=agentTunnelID, PYSNMP_MODULE_ID=fastPathIpv6Tunnel, fastPathIpv6Tunnel=fastPathIpv6Tunnel, agentTunnelIPV6PrefixStatus=agentTunnelIPV6PrefixStatus, agentTunnelLocalIP4Addr=agentTunnelLocalIP4Addr)
