...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS3426-L2MGMT-MIB
...
ModuleIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter64, IpAddress, Gauge32, Counter32, MibIdentifier, NotificationType, ObjectIdentity, Unsigned32, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter64", "IpAddress", "Gauge32", "Counter32", "MibIdentifier", "NotificationType", "ObjectIdentity", "Unsigned32", "iso", "Integer32")
...
swL2PortInfoErrDisReason = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 1, 2, 3, 1, 1, 7), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("err-none", 1), ("storm-control", 2), ("lbd-control", 3)))).setMaxAccess("readonly")
...
swL2QOSSchedulingEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 70, 1, 2, 6, 2, 1), ).setIndexNames((0, "DGS3426-L2MGMT-MIB", "swL2QOSSchedulingClassIndex"))
...
swL2QOSSchedulingClassIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 1, 2, 6, 2, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 7))).setMaxAccess("readonly")
...
swL2QOSSchedulingMaxPkts = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 1, 2, 6, 2, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 15))).setMaxAccess("readwrite")
...
swL2QOSSchedulingMechanism = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 1, 2, 6, 2, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("strict", 1), ("roundrobin", 2), ("weightfair", 3)))).setMaxAccess("readonly")
...
swL2PortSecurityMaxLernAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 1, 2, 7, 1, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 16))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS3426-L2MGMT-MIB", swDevModuleInfoReversion=swDevModuleInfoReversion, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2IGMPSnoopingStaticGroupRowStatus=swL2IGMPSnoopingStaticGroupRowStatus, swl2NotificationBidings=swl2NotificationBidings, swL2VlanType=swL2VlanType, swL2IGMPMulticastVlanName=swL2IGMPMulticastVlanName, swL2IGMPMulticastVlanGroupTable=swL2IGMPMulticastVlanGroupTable, swL2LoopDetectMode=swL2LoopDetectMode, IANAifMauAutoNegCapBits=IANAifMauAutoNegCapBits, MacAddress=MacAddress, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2MultiFilterMode=swL2MultiFilterMode, swL2PortInfoErrDisReason=swL2PortInfoErrDisReason, swL2IGMPIpGroupReportCount=swL2IGMPIpGroupReportCount, swL2macNotifyInfo=swL2macNotifyInfo, swL2VlanCurrentUntaggedPorts=swL2VlanCurrentUntaggedPorts, swL2MirrorPortState=swL2MirrorPortState, swL2IpLimitedMulticastDelState=swL2IpLimitedMulticastDelState, swL2DevCtrlIGMPSnooping=swL2DevCtrlIGMPSnooping, swL2QOS8021pDefaultPriority=swL2QOS8021pDefaultPriority, swL2IGMPMulticastVlanSourcePort=swL2IGMPMulticastVlanSourcePort, swL2IGMPRouterPortsVid=swL2IGMPRouterPortsVid, swL2IGMPSnoopingStaticGroupMemberPortList=swL2IGMPSnoopingStaticGroupMemberPortList, swL2PortSecurityDelPort=swL2PortSecurityDelPort, swL2PortAutoNegInfoEntry=swL2PortAutoNegInfoEntry, swL2DevCtrlIpAutoconfig=swL2DevCtrlIpAutoconfig, swL2IGMPGroupIpAddr=swL2IGMPGroupIpAddr, swL2TrunkMgmt=swL2TrunkMgmt, swL2IGMPMulticastVlanReplaceSourceIp=swL2IGMPMulticastVlanReplaceSourceIp, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2MultiFilterTable=swL2MultiFilterTable, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2QOSBandwidthControlTable=swL2QOSBandwidthControlTable, swL2QOSHolPreventionCtrl=swL2QOSHolPreventionCtrl, swL2PortCtrlAutoNegRestart=swL2PortCtrlAutoNegRestart, swL2PortAutoNegInfoTable=swL2PortAutoNegInfoTable, swL2PortInfoEntry=swL2PortInfoEntry, swL2LoopDetectMgmt=swL2LoopDetectMgmt, swL2IGMPMulticastVlanGroupStatus=swL2IGMPMulticastVlanGroupStatus, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swL2QOSSchedulingClassIndex=swL2QOSSchedulingClassIndex, swL2PortDropCounterPortIndex=swL2PortDropCounterPortIndex, swL2PortLoopRestart=swL2PortLoopRestart, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2QOSSchedulingMaxPkts=swL2QOSSchedulingMaxPkts, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2VlanMgmt=swL2VlanMgmt, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2MgmtMIB=swL2MgmtMIB, swL2QOS8021pUserPriorityClass=swL2QOS8021pUserPriorityClass, swL2DevCtrlClipagingState=swL2DevCtrlClipagingState, swL2IGMPLastMemberQueryInterval=swL2IGMPLastMemberQueryInterval, swL2DevCtrlStpState=swL2DevCtrlStpState, swL2IGMPQueryVersion=swL2IGMPQueryVersion, swL2TrunkName=swL2TrunkName, swL2VlanLoopDetectVID=swL2VlanLoopDetectVID, swL2QOS8021pDefaultPriorityIndex=swL2QOS8021pDefaultPriorityIndex, swL2DevInfo=swL2DevInfo, swL2PortCtrlTable=swL2PortCtrlTable, swL2QOSMgmt=swL2QOSMgmt, swL2IGMPMaxResponseTime=swL2IGMPMaxResponseTime, swL2IGMPMulticastVlanEntry=swL2IGMPMulticastVlanEntry, swL2QOSSchedulingTable=swL2QOSSchedulingTable, swL2IGMPRouterStaticPortList=swL2IGMPRouterStaticPortList, swL2Notify=swL2Notify, swL2IpLimitedMulticastEntry=swL2IpLimitedMulticastEntry, swL2LoopDetectRecoverTime=swL2LoopDetectRecoverTime, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2IGMPMulticastVlanGroupFromIp=swL2IGMPMulticastVlanGroupFromIp, swL2IGMPMulticastVlanMemberPort=swL2IGMPMulticastVlanMemberPort, swL2QOSBandwidthTxRate=swL2QOSBandwidthTxRate, swL2PortInfoType=swL2PortInfoType, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2QOSSchedulingEntry=swL2QOSSchedulingEntry, swL2IpLimitedMulticastPortIndex=swL2IpLimitedMulticastPortIndex, swDevModuleInfoTable=swDevModuleInfoTable, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2PortCtrlLockState=swL2PortCtrlLockState, swL2PortDropCounterTable=swL2PortDropCounterTable, swL2PortMulticastDrops=swL2PortMulticastDrops, swL2MultiFilterVid=swL2MultiFilterVid, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2VlanStaticTaggedPorts=swL2VlanStaticTaggedPorts, swL2LoopDetectedNotify=swL2LoopDetectedNotify, swL2QOS8021pUserPriorityEntry=swL2QOS8021pUserPriorityEntry, swL2PortCounterCtrlPortIndex=swL2PortCounterCtrlPortIndex, swL2IGMPMulticastVlanTable=swL2IGMPMulticastVlanTable, swIGMPSnoopingGroupSourceAddr=swIGMPSnoopingGroupSourceAddr, swL2DevMgmt=swL2DevMgmt, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swIGMPSnoopingGroupGroupAddr=swIGMPSnoopingGroupGroupAddr, swIGMPSnoopingGroupExcludePortMap=swIGMPSnoopingGroupExcludePortMap, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2PortVLANIngressDrops=swL2PortVLANIngressDrops, swL2PortSecurityMgmt=swL2PortSecurityMgmt, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2PortSecurityPortIndex=swL2PortSecurityPortIndex, swL2TrunkIndex=swL2TrunkIndex, swL2IpLimitedMulticastHead=swL2IpLimitedMulticastHead, swL2MirrorMgmt=swL2MirrorMgmt, swL2MultiFilterEntry=swL2MultiFilterEntry, swL2IGMPInfoTable=swL2IGMPInfoTable, swL2IGMPMaxSupportedVlans=swL2IGMPMaxSupportedVlans, swL2QOSBandwidthRxRate=swL2QOSBandwidthRxRate, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2QOS8021pUserPriorityTable=swL2QOS8021pUserPriorityTable, swL2IGMPMacAddr=swL2IGMPMacAddr, swL2IGMPSnoopingStaticGroupVID=swL2IGMPSnoopingStaticGroupVID, swL2TrunkMember=swL2TrunkMember, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swL2PortCtrlMediumType=swL2PortCtrlMediumType, swL2IGMPVid=swL2IGMPVid, swL2PortACLDrops=swL2PortACLDrops, swL2VlanTable=swL2VlanTable, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2QOSBandwidthRadiusTxRate=swL2QOSBandwidthRadiusTxRate, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swIGMPSnoopingGroupTable=swIGMPSnoopingGroupTable, swL2IGMPMgmt=swL2IGMPMgmt, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2IGMPFastLeaveState=swL2IGMPFastLeaveState, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2IGMPReportSuppression=swL2IGMPReportSuppression, swL2IGMPMulticastVlanGroupToIp=swL2IGMPMulticastVlanGroupToIp, swL2DevCtrlRmonState=swL2DevCtrlRmonState, swL2VlanIndex=swL2VlanIndex, swL2IpLimitedMulticastState=swL2IpLimitedMulticastState, swL2IpLimitedMulticastMgmt=swL2IpLimitedMulticastMgmt, swL2MACNotifyState=swL2MACNotifyState, swL2PortCounterCtrlTable=swL2PortCounterCtrlTable, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2PVIDAutoAssignmentState=swL2PVIDAutoAssignmentState, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2IGMPMulticastVlanGroupEntry=swL2IGMPMulticastVlanGroupEntry, swL2LoopDetectCtrl=swL2LoopDetectCtrl, swL2VlanMemberPorts=swL2VlanMemberPorts, swDevInfoBootPromVersion=swDevInfoBootPromVersion, swL2TrunkType=swL2TrunkType, swL2PortAutoNegInfoCapAdvertisedBits=swL2PortAutoNegInfoCapAdvertisedBits, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2IGMPQueryInfoEntry=swL2IGMPQueryInfoEntry, swL2PortInfoTable=swL2PortInfoTable, swL2IGMPCtrlVid=swL2IGMPCtrlVid, swL2TrunkActivePorts=swL2TrunkActivePorts, swL2PortLoopOccurred=swL2PortLoopOccurred, swL2IGMPMulticastVlanid=swL2IGMPMulticastVlanid, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2PortSecurityDelMacAddress=swL2PortSecurityDelMacAddress, swDevModuleInfoDescription=swDevModuleInfoDescription, swL2PortMgmt=swL2PortMgmt, swL2IGMPMulticastVlanTagMemberPort=swL2IGMPMulticastVlanTagMemberPort, swL2VlanLoopRestart=swL2VlanLoopRestart, swL2PortCtrlJumboFrameMaxSize=swL2PortCtrlJumboFrameMaxSize, swL2IGMPQueryState=swL2IGMPQueryState, swL2IGMPSnoopingStaticGroupIPaddress=swL2IGMPSnoopingStaticGroupIPaddress, swL2IGMPInfoEntry=swL2IGMPInfoEntry, swL2QOSBandwidthRadiusRxRate=swL2QOSBandwidthRadiusRxRate, swL2LoopDetectPortIndex=swL2LoopDetectPortIndex, swL2QOS8021pDefaultPriorityTable=swL2QOS8021pDefaultPriorityTable, swL2TrunkState=swL2TrunkState, swL2PortAutoNegInfoCapabilityBits=swL2PortAutoNegInfoCapabilityBits, swL2IGMPInfoQueryCount=swL2IGMPInfoQueryCount, swL2QOSBandwidthControlEntry=swL2QOSBandwidthControlEntry, swIGMPSnoopingGroupIncludePortMap=swIGMPSnoopingGroupIncludePortMap, swL2IGMPCtrlState=swL2IGMPCtrlState, swL2MultiFilter=swL2MultiFilter, swL2QOSSchedulingMechanism=swL2QOSSchedulingMechanism, PortList=PortList, swL2PortAutoNegInfoPortIndex=swL2PortAutoNegInfoPortIndex, swL2IGMPMaxIpGroupNumPerVlan=swL2IGMPMaxIpGroupNumPerVlan, swL2IGMPQueryInfoTable=swL2IGMPQueryInfoTable, swL2PortSecurityAdmState=swL2PortSecurityAdmState, swL2LoopDetectTrapMode=swL2LoopDetectTrapMode, swL2IGMPRouteTimeout=swL2IGMPRouteTimeout, swIGMPSnoopingGroupVid=swIGMPSnoopingGroupVid, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2IpLimitedMulticastTail=swL2IpLimitedMulticastTail, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2LoopDetectPortMgmt=swL2LoopDetectPortMgmt, swL2QOSBandwidthPortIndex=swL2QOSBandwidthPortIndex, swL2LoopDetectPortTable=swL2LoopDetectPortTable, swL2PortCtrlAutoNegCapAdvertisedBits=swL2PortCtrlAutoNegCapAdvertisedBits, swL2PortSecurityDelCtrl=swL2PortSecurityDelCtrl, swL2PortSecurityDelActivity=swL2PortSecurityDelActivity, swL2VlanAdvertisementState=swL2VlanAdvertisementState, swL2TrafficSegTable=swL2TrafficSegTable, swL2PortInfoUnitID=swL2PortInfoUnitID, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swIGMPSnoopingGroupEntry=swIGMPSnoopingGroupEntry, swL2NotifyPrefix=swL2NotifyPrefix, swL2QOS8021pUserPriorityIndex=swL2QOS8021pUserPriorityIndex, swL2PortInfoMediumType=swL2PortInfoMediumType, swL2IGMPMulticastVlanState=swL2IGMPMulticastVlanState, swL2IGMPMulticastVlanRowStatus=swL2IGMPMulticastVlanRowStatus, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2IGMPRouterDynamicPortList=swL2IGMPRouterDynamicPortList, swL2VlanStaticUntaggedPorts=swL2VlanStaticUntaggedPorts, swL2VlanForbiddenPorts=swL2VlanForbiddenPorts, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2PortCounterClearCtrl=swL2PortCounterClearCtrl, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2QOS8021pRadiusPriority=swL2QOS8021pRadiusPriority, swL2IGMPMulticastVlanGroupVid=swL2IGMPMulticastVlanGroupVid, swL2VlanEntry=swL2VlanEntry, swDevInfoFrontPanelLedStatus=swDevInfoFrontPanelLedStatus, swL2IGMPMulticastVlanRemoveAllMcastAddrListAction=swL2IGMPMulticastVlanRemoveAllMcastAddrListAction, swL2IGMPSnoopingStaticGroupEntry=swL2IGMPSnoopingStaticGroupEntry, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2IGMPLeaveTimer=swL2IGMPLeaveTimer, swL2VlanCurrentTaggedPorts=swL2VlanCurrentTaggedPorts, swL2LoopDetectAdminState=swL2LoopDetectAdminState, swL2LoopDetectPortLoopVLAN=swL2LoopDetectPortLoopVLAN, swL2macNotification=swL2macNotification, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2PortDropCounterEntry=swL2PortDropCounterEntry, swDevModuleInfoEntry=swDevModuleInfoEntry, swL2QOS8021pDefaultPriorityEntry=swL2QOS8021pDefaultPriorityEntry, swL2LoopDetectInterval=swL2LoopDetectInterval, swDevModuleInfoModuleName=swDevModuleInfoModuleName, swL2PortSecurityMaxLernAddr=swL2PortSecurityMaxLernAddr, swL2TrafficSegPort=swL2TrafficSegPort, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2PortCounterCtrlEntry=swL2PortCounterCtrlEntry, swL2IGMPRouterForbiddenPortList=swL2IGMPRouterForbiddenPortList, swL2VlanName=swL2VlanName, swL2PortSecurityControlTable=swL2PortSecurityControlTable, swL2IGMPCtrlEntry=swL2IGMPCtrlEntry, VlanId=VlanId, swL2QOSSchedulingMechanismCtrl=swL2QOSSchedulingMechanismCtrl, swL2IGMPRouterPortsTable=swL2IGMPRouterPortsTable, swL2IGMPInfoTxQueryCount=swL2IGMPInfoTxQueryCount, swL2DevCtrlIGMPSnoopingMcstRTOnly=swL2DevCtrlIGMPSnoopingMcstRTOnly, swL2PortSecurityMode=swL2PortSecurityMode, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2IGMPSnoopingStaticGroupTable=swL2IGMPSnoopingStaticGroupTable, swL2IpLimitedMulticastAccess=swL2IpLimitedMulticastAccess, swL2IGMPCtrlTable=swL2IGMPCtrlTable, swL2IGMPPortMap=swL2IGMPPortMap, swL2IpLimitedMulticastTable=swL2IpLimitedMulticastTable, swL2PortSecurityControlEntry=swL2PortSecurityControlEntry, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2VlanLoopOccurred=swL2VlanLoopOccurred, swDevModuleInfoModuleID=swDevModuleInfoModuleID, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2PortSecurityDelVlanName=swL2PortSecurityDelVlanName, swL2IGMPCurrentState=swL2IGMPCurrentState)
mibBuilder.exportSymbols("DGS3426-L2MGMT-MIB", swL2DevCtrl=swL2DevCtrl, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2IGMPHostTimeout=swL2IGMPHostTimeout, swL2PortBufferFullDrops=swL2PortBufferFullDrops, swL2IGMPQueryInterval=swL2IGMPQueryInterval, swDevModuleInfoSerial=swDevModuleInfoSerial, swL2LoopDetectPortState=swL2LoopDetectPortState, swDevModuleInfoUnitID=swDevModuleInfoUnitID, swL2IGMPRobustness=swL2IGMPRobustness, swL2DevAlarm=swL2DevAlarm, swL2IGMPInfoVid=swL2IGMPInfoVid, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2LoopDetectPortEntry=swL2LoopDetectPortEntry, swL2PortAutoNegInfoAdminStatus=swL2PortAutoNegInfoAdminStatus, swL2LoopDetectPortLoopStatus=swL2LoopDetectPortLoopStatus, swL2NotifFirmware=swL2NotifFirmware, swL2PortAutoNegInfoCapReceivedBits=swL2PortAutoNegInfoCapReceivedBits, swDevInfoFirmwareVersion=swDevInfoFirmwareVersion, swL2IGMPRouterPortsEntry=swL2IGMPRouterPortsEntry, swL2VlanStaticPorts=swL2VlanStaticPorts, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId)
