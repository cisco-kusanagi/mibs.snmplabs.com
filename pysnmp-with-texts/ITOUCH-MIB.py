...
TimeTicks, Integer32, Counter64, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, Unsigned32, Counter32, enterprises, Bits, NotificationType, Gauge32, MibIdentifier, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "Counter64", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "Unsigned32", "Counter32", "enterprises", "Bits", "NotificationType", "Gauge32", "MibIdentifier", "ObjectIdentity", "iso")
...
mibBuilder.exportSymbols("ITOUCH-MIB", ChassisType=ChassisType, ir9504=ir9504, iTouch=iTouch, ir7520=ir7520, tsMxCard1M=tsMxCard1M, ir9040=ir9040, bridgeRouterN9=bridgeRouterN9, nbaseSwitch=nbaseSwitch, agent=agent, DateTime=DateTime, rpN9=rpN9, ir8008=ir8008, tsMxCard=tsMxCard, nbaseSwitchN9=nbaseSwitchN9, ir9020=ir9020, irMgr0Rdc=irMgr0Rdc, tsX25=tsX25, irMgr0=irMgr0, irM700=irM700, ir8020=ir8020, bridgeRouterEB=bridgeRouterEB, nbase=nbase, ir7004=ir7004, ir7020=ir7020, ir7040=ir7040, switch=switch, irM900=irM900, rpMx=rpMx, irMGR0AC_IN=irMGR0AC_IN, tsPrint=tsPrint, TypedAddress=TypedAddress, AddressType=AddressType, tsMxBox1M=tsMxBox1M, ir9004=ir9004, ir9008=ir9008, bridgeRouterMx=bridgeRouterMx, oem=oem, nv8516FF=nv8516FF, irM800=irM800, nv8516TT=nv8516TT, ir8004=ir8004, irMGR0AC=irMGR0AC, ir8040=ir8040, bridgeRouterN3=bridgeRouterN3, tsN9=tsN9, HardwareType=HardwareType, bridgeRouter=bridgeRouter, bridgeRouterRepeater=bridgeRouterRepeater, terminalServer=terminalServer, SoftwareType=SoftwareType, ir7008=ir7008, bridge=bridge, tsMxBox=tsMxBox, em1608=em1608, IOType=IOType, repeater=repeater, bridgeRouterN2=bridgeRouterN2, netVantage=netVantage)
