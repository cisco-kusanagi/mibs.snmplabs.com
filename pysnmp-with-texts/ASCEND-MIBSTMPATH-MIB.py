...
# Produced by pysmi-0.3.4 at Wed May  1 11:28:34 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, ModuleIdentity, NotificationType, IpAddress, Counter32, Counter64, ObjectIdentity, Integer32, Unsigned32, Bits, MibIdentifier, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "ModuleIdentity", "NotificationType", "IpAddress", "Counter32", "Counter64", "ObjectIdentity", "Integer32", "Unsigned32", "Bits", "MibIdentifier", "iso", "TimeTicks")
...
if mibBuilder.loadTexts: mibsTMPathProfileTable.setDescription('A list of mibsTMPathProfile profile entries.')
...
if mibBuilder.loadTexts: mibsTMPathProfileEntry.setDescription('A mibsTMPathProfile entry containing objects that maps to the parameters of mibsTMPathProfile profile.')
...
if mibBuilder.loadTexts: sTMPathProfile_Shelf_o.setDescription('')
...
if mibBuilder.loadTexts: sTMPathProfile_Slot_o.setDescription('')
...
if mibBuilder.loadTexts: sTMPathProfile_Item_o.setDescription('')
...
if mibBuilder.loadTexts: sTMPathProfile_Name.setDescription('Name of Channelized SONET/SDH Path profile')
...
if mibBuilder.loadTexts: sTMPathProfile_PhysicalAddress_Shelf.setDescription('The number of the shelf that the addressed physical device resides on.')
...
if mibBuilder.loadTexts: sTMPathProfile_PhysicalAddress_Slot.setDescription('The number of the slot that the addressed physical device resides on.')
...
if mibBuilder.loadTexts: sTMPathProfile_PhysicalAddress_ItemNumber.setDescription('A number that specifies an addressable entity within the context of shelf and slot.')
...
if mibBuilder.loadTexts: sTMPathProfile_Enabled.setDescription('TRUE if the link is enabled, otherwise FALSE.')
...
if mibBuilder.loadTexts: sTMPathProfile_TributaryMapping.setDescription('The VT/VC mapping to be performed by this link')
...
if mibBuilder.loadTexts: sTMPathProfile_Action_o.setDescription('')
mibBuilder.exportSymbols("ASCEND-MIBSTMPATH-MIB", sTMPathProfile_PhysicalAddress_Slot=sTMPathProfile_PhysicalAddress_Slot, sTMPathProfile_Item_o=sTMPathProfile_Item_o, sTMPathProfile_TributaryMapping=sTMPathProfile_TributaryMapping, sTMPathProfile_PhysicalAddress_ItemNumber=sTMPathProfile_PhysicalAddress_ItemNumber, mibsTMPathProfileEntry=mibsTMPathProfileEntry, sTMPathProfile_PhysicalAddress_Shelf=sTMPathProfile_PhysicalAddress_Shelf, sTMPathProfile_Enabled=sTMPathProfile_Enabled, sTMPathProfile_Action_o=sTMPathProfile_Action_o, sTMPathProfile_Name=sTMPathProfile_Name, DisplayString=DisplayString, sTMPathProfile_Slot_o=sTMPathProfile_Slot_o, mibsTMPathProfile=mibsTMPathProfile, mibsTMPathProfileTable=mibsTMPathProfileTable, sTMPathProfile_Shelf_o=sTMPathProfile_Shelf_o)
