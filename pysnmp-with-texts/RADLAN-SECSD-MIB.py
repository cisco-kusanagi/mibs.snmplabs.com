...
if mibBuilder.loadTexts: rlSecSd.setContactInfo('www.Marvell.com')
...
mibBuilder.exportSymbols("RADLAN-SECSD-MIB", RlSecSdChannelType=RlSecSdChannelType, rlSecSdCurrentSessionId=rlSecSdCurrentSessionId, rlSecSdConfigurationFileSsdDigest=rlSecSdConfigurationFileSsdDigest, rlSecSdRuleIsDefault=rlSecSdRuleIsDefault, rlSecSdMngSessionId=rlSecSdMngSessionId, rlSecSdMngSessionChannel=rlSecSdMngSessionChannel, RlSecSdSessionAccessType=RlSecSdSessionAccessType, rlSecSdRuleRead=rlSecSdRuleRead, rlSecSd=rlSecSd, rlSecSdFilePassphraseControl=rlSecSdFilePassphraseControl, RlSecSdPermitAccessType=RlSecSdPermitAccessType, RlSecSdRuleUserType=RlSecSdRuleUserType, RlSecSdRuleOwnerType=RlSecSdRuleOwnerType, rlSecSdMngSessionsEntry=rlSecSdMngSessionsEntry, rlSecSdRuleOwner=rlSecSdRuleOwner, PYSNMP_MODULE_ID=rlSecSd, RlSecSdAccessType=RlSecSdAccessType, rlSecSdMngSessionsTable=rlSecSdMngSessionsTable, rlSecSdRuleUser=rlSecSdRuleUser, rlSecSdMngSessionUserLevel=rlSecSdMngSessionUserLevel, rlSecSdRuleUserName=rlSecSdRuleUserName, rlSecSdPassPhrase=rlSecSdPassPhrase, rlSecSdConfigurationFileDigest=rlSecSdConfigurationFileDigest, rlSecSdFileIndicator=rlSecSdFileIndicator, rlSecSdRulesTable=rlSecSdRulesTable, rlSecSdSessionControl=rlSecSdSessionControl, rlSecSdRulesEntry=rlSecSdRulesEntry, rlSecSdRuleChannel=rlSecSdRuleChannel, rlSecSdFileIntegrityControl=rlSecSdFileIntegrityControl, rlSecSdRulePermitRead=rlSecSdRulePermitRead, rlSecSdRuleStatus=rlSecSdRuleStatus, rlSecSdMngSessionUserName=rlSecSdMngSessionUserName)
