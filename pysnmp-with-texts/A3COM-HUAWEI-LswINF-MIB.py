...
mibBuilder.exportSymbols("A3COM-HUAWEI-LswINF-MIB", hwBpduTunnelStatus=hwBpduTunnelStatus, hwifPpsMcastControl=hwifPpsMcastControl, hwifEthernetAutoSpeedMask=hwifEthernetAutoSpeedMask, hwifEthernetAutoSpeed=hwifEthernetAutoSpeed, hwMaxMacLearnRange=hwMaxMacLearnRange, InterfaceIndex=InterfaceIndex, hwifXXTable=hwifXXTable, hwifEthernetMTU=hwifEthernetMTU, hwifPpsMulSuppression=hwifPpsMulSuppression, hwifClearStat=hwifClearStat, hwifVLANTrunkStatusEntry=hwifVLANTrunkStatusEntry, hwifBKbpsMulSuppressionMax=hwifBKbpsMulSuppressionMax, hwifMcastControl=hwifMcastControl, hwifAggregateTable=hwifAggregateTable, hwifMacAddressLearn=hwifMacAddressLearn, hwPortIsolateGroupTable=hwPortIsolateGroupTable, hwifXXBasePortIndex=hwifXXBasePortIndex, hwifHybridUnTaggedVlanListHigh=hwifHybridUnTaggedVlanListHigh, hwifVLANTrunkPassListHigh=hwifVLANTrunkPassListHigh, hwethernetTable=hwethernetTable, hwifPpsUniSuppression=hwifPpsUniSuppression, hwifVLANType=hwifVLANType, hwVlanVPNTPIDMode=hwVlanVPNTPIDMode, hwifISPhyPort=hwifISPhyPort, hwifVlanVPNTPID=hwifVlanVPNTPID, hwifHybridTaggedVlanListHigh=hwifHybridTaggedVlanListHigh, hwPortIsolateGroupDescription=hwPortIsolateGroupDescription, hwLswL2InfMibObject=hwLswL2InfMibObject, hwifHybridPortIndex=hwifHybridPortIndex, hwifComboPortIndex=hwifComboPortIndex, hwifIsolateGroupID=hwifIsolateGroupID, hwifInPayloadOctets=hwifInPayloadOctets, hwifBMbpsUniSuppression=hwifBMbpsUniSuppression, hwifAggregatePort=hwifAggregatePort, hwPortIsolateUplinkIfIndex=hwPortIsolateUplinkIfIndex, VlanIndex=VlanIndex, hwifBKbpsUniSuppressionMax=hwifBKbpsUniSuppressionMax, hwifAggregateEntry=hwifAggregateEntry, hwMaxMacLearn=hwMaxMacLearn, hwifBKbpsUniSuppressionStep=hwifBKbpsUniSuppressionStep, hwifBKbpsUniSuppression=hwifBKbpsUniSuppression, hwifHybridPortTable=hwifHybridPortTable, hwifAggregatePortIndex=hwifAggregatePortIndex, hwifBMbpsUniSuppressionMax=hwifBMbpsUniSuppressionMax, hwifVLANTrunkAllowListHigh=hwifVLANTrunkAllowListHigh, hwifEthernetTest=hwifEthernetTest, hwifComboPortCurActive=hwifComboPortCurActive, hwGlobalBroadcastMaxPps=hwGlobalBroadcastMaxPps, hwifSrcMacControl=hwifSrcMacControl, SpeedModeFlag=SpeedModeFlag, hwifVLANTrunkPassListLow=hwifVLANTrunkPassListLow, hwPortIsolateGroupIndex=hwPortIsolateGroupIndex, hwifisUplinkPort=hwifisUplinkPort, hwifEthernetDuplex=hwifEthernetDuplex, hwifBMbpsMulSuppression=hwifBMbpsMulSuppression, hwifPpsMulSuppressionMax=hwifPpsMulSuppressionMax, hwifBKbpsMulSuppression=hwifBKbpsMulSuppression, hwifXXDevPortIndex=hwifXXDevPortIndex, hwifAggregateOperStatus=hwifAggregateOperStatus, hwSlotPortMax=hwSlotPortMax, hwifInNormalPkts=hwifInNormalPkts, hwifUniSuppression=hwifUniSuppression, PortList=PortList, hwethernetEntry=hwethernetEntry, hwifVLANTrunkStatusTable=hwifVLANTrunkStatusTable, hwIsolateGroupMax=hwIsolateGroupMax, hwifEthernetIsolate=hwifEthernetIsolate, hwifVlanVPNUplinkStatus=hwifVlanVPNUplinkStatus, hwifVlanVPNStatus=hwifVlanVPNStatus, hwifVLANTrunkIndex=hwifVLANTrunkIndex, hwifHybridTaggedVlanListLow=hwifHybridTaggedVlanListLow, hwVlanVPNTPID=hwVlanVPNTPID, hwifMirrorPort=hwifMirrorPort, hwifMulSuppressionStep=hwifMulSuppressionStep, hwifHybridPortEntry=hwifHybridPortEntry, hwifBKbpsMulSuppressionStep=hwifBKbpsMulSuppressionStep, DropDirection=DropDirection, hwifOutPayloadOctets=hwifOutPayloadOctets, hwPortIsolateGroupEntry=hwPortIsolateGroupEntry, hwifVLANTrunkGvrpRegistration=hwifVLANTrunkGvrpRegistration, hwifComboActivePort=hwifComboActivePort, PYSNMP_MODULE_ID=hwLswL2InfMib, hwifOutPkts=hwifOutPkts, hwifAggregatePortListPorts=hwifAggregatePortListPorts, hwifHybridUnTaggedVlanListLow=hwifHybridUnTaggedVlanListLow, hwifInPkts=hwifInPkts, hwifMulSuppression=hwifMulSuppression, hwifComboPortEntry=hwifComboPortEntry, hwifUniSuppressionStep=hwifUniSuppressionStep, hwifInErrorPktsRate=hwifInErrorPktsRate, hwifComboPortTable=hwifComboPortTable, hwifAggregatePortName=hwifAggregatePortName, hwifEthernetSpeed=hwifEthernetSpeed, hwifEthernetFlowInterval=hwifEthernetFlowInterval, hwGlobalBroadcastMaxRatio=hwGlobalBroadcastMaxRatio, hwPortIsolateGroupRowStatus=hwPortIsolateGroupRowStatus, hwLswL2InfMib=hwLswL2InfMib, hwifUnknownPacketDropUni=hwifUnknownPacketDropUni, hwifEthernetMdi=hwifEthernetMdi, hwifPpsUniSuppressionMax=hwifPpsUniSuppressionMax, hwifVLANTrunkAllowListLow=hwifVLANTrunkAllowListLow, hwifPpsBcastDisValControl=hwifPpsBcastDisValControl, hwifXXEntry=hwifXXEntry, hwifFlowControl=hwifFlowControl, hwSwitchPortMax=hwSwitchPortMax, hwifBMbpsMulSuppressionMax=hwifBMbpsMulSuppressionMax, hwifUnBoundPort=hwifUnBoundPort, hwifMacAddrLearnMode=hwifMacAddrLearnMode, hwifUnknownPacketDropMul=hwifUnknownPacketDropMul, hwifAggregateModel=hwifAggregateModel, hwLswExtInterface=hwLswExtInterface)
