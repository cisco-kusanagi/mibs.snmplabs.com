...
# Produced by pysmi-0.3.4 at Wed May  1 15:01:06 2019
...
if mibBuilder.loadTexts: serviceTable.setDescription('')
...
if mibBuilder.loadTexts: serviceNumber1.setDescription('')
...
if mibBuilder.loadTexts: serviceName.setDescription('')
...
if mibBuilder.loadTexts: serviceType.setDescription('')
...
if mibBuilder.loadTexts: slot.setDescription('')
...
if mibBuilder.loadTexts: plug.setDescription('')
...
if mibBuilder.loadTexts: serviceState.setDescription('')
...
if mibBuilder.loadTexts: bytesSent.setDescription('')
...
if mibBuilder.loadTexts: bytesReceived.setDescription('')
...
if mibBuilder.loadTexts: packetsSent.setDescription('')
...
if mibBuilder.loadTexts: packetsReceived.setDescription('')
...
if mibBuilder.loadTexts: maxPacketSize.setDescription('')
lanTable = MibTable((1, 3, 6, 1, 4, 1, 208, 24, 2, 1), )
if mibBuilder.loadTexts: lanTable.setStatus('mandatory')
if mibBuilder.loadTexts: lanTable.setDescription('')
...
if mibBuilder.loadTexts: lanEntry.setDescription('')
...
if mibBuilder.loadTexts: serviceNumber2.setDescription('')
...
if mibBuilder.loadTexts: ownSNPAAddress.setDescription('')
...
if mibBuilder.loadTexts: scaNetSubnet.setDescription('')
...
if mibBuilder.loadTexts: incomingAccessMask1.setDescription('')
...
if mibBuilder.loadTexts: outgoingAccessMask1.setDescription('')
wanTable = MibTable((1, 3, 6, 1, 4, 1, 208, 24, 3, 1), )
if mibBuilder.loadTexts: wanTable.setStatus('mandatory')
if mibBuilder.loadTexts: wanTable.setDescription('')
...
if mibBuilder.loadTexts: wanEntry.setDescription('')
...
if mibBuilder.loadTexts: serviceNumber3.setDescription('')
...
if mibBuilder.loadTexts: provider.setDescription('')
...
if mibBuilder.loadTexts: queueActualValue.setDescription('')
...
if mibBuilder.loadTexts: queueHighWaterTideMark.setDescription('')
...
if mibBuilder.loadTexts: queueRejectThreshold1.setDescription('')
...
if mibBuilder.loadTexts: dataCompressionSwitch1.setDescription('')
...
if mibBuilder.loadTexts: dataCompressionState.setDescription('')
...
if mibBuilder.loadTexts: acceptIncomingCalls1.setDescription('')
...
if mibBuilder.loadTexts: permitOutgoingCalls1.setDescription('')
...
if mibBuilder.loadTexts: acceptReverseCharge1.setDescription('')
...
if mibBuilder.loadTexts: proposeReverseCharge1.setDescription('')
...
if mibBuilder.loadTexts: permitTimeCut1.setDescription('')
...
if mibBuilder.loadTexts: backupOnly.setDescription('')
...
if mibBuilder.loadTexts: actualCallState.setDescription('')
...
if mibBuilder.loadTexts: actualCallDirection.setDescription('')
...
if mibBuilder.loadTexts: actualCallDuration.setDescription('')
...
if mibBuilder.loadTexts: minCallDuration1.setDescription('')
...
if mibBuilder.loadTexts: idleTime1.setDescription('')
...
if mibBuilder.loadTexts: actualTimer.setDescription('')
...
if mibBuilder.loadTexts: reserveTime1.setDescription('')
...
if mibBuilder.loadTexts: ownUserDataAddress1.setDescription('')
...
if mibBuilder.loadTexts: remoteSNPAaddress.setDescription('')
...
if mibBuilder.loadTexts: remoteUserDataAddress.setDescription('')
...
if mibBuilder.loadTexts: callsPlaced1.setDescription('')
...
if mibBuilder.loadTexts: callsFailed1.setDescription('')
...
if mibBuilder.loadTexts: actualErrorRetries.setDescription('')
...
if mibBuilder.loadTexts: maxErrorRetries1.setDescription('')
...
if mibBuilder.loadTexts: errorRetryInterval1.setDescription('')
...
if mibBuilder.loadTexts: maxCallSetupTime1.setDescription('')
...
if mibBuilder.loadTexts: mostRecentFailure1.setDescription('')
...
if mibBuilder.loadTexts: backupForLink.setDescription('')
...
if mibBuilder.loadTexts: poolIndex.setDescription('')
...
if mibBuilder.loadTexts: incomingAccessMask2.setDescription('')
...
if mibBuilder.loadTexts: outgoingAccessMask2.setDescription('')
...
if mibBuilder.loadTexts: timecutAccessMask1.setDescription('')
poolTable = MibTable((1, 3, 6, 1, 4, 1, 208, 24, 3, 2), )
if mibBuilder.loadTexts: poolTable.setStatus('mandatory')
if mibBuilder.loadTexts: poolTable.setDescription('')
...
if mibBuilder.loadTexts: poolEntry.setDescription('')
...
if mibBuilder.loadTexts: serviceNumber4.setDescription('')
...
if mibBuilder.loadTexts: poolName.setDescription('')
...
if mibBuilder.loadTexts: queueRejectThreshold2.setDescription('')
...
if mibBuilder.loadTexts: dataCompressionSwitch2.setDescription('')
...
if mibBuilder.loadTexts: acceptIncomingCalls2.setDescription('')
...
if mibBuilder.loadTexts: permitOutgoingCalls2.setDescription('')
...
if mibBuilder.loadTexts: acceptReverseCharge2.setDescription('')
...
if mibBuilder.loadTexts: proposeReverseCharge2.setDescription('')
...
if mibBuilder.loadTexts: permitTimeCut2.setDescription('')
...
if mibBuilder.loadTexts: minCallDuration2.setDescription('')
...
if mibBuilder.loadTexts: idleTime2.setDescription('')
...
if mibBuilder.loadTexts: reserveTime2.setDescription('')
...
if mibBuilder.loadTexts: ownUserDataAddress2.setDescription('')
...
if mibBuilder.loadTexts: callsPlaced2.setDescription('')
...
if mibBuilder.loadTexts: callsFailed2.setDescription('')
...
if mibBuilder.loadTexts: maxErrorRetries2.setDescription('')
...
if mibBuilder.loadTexts: errorRetryInterval2.setDescription('')
...
if mibBuilder.loadTexts: maxCallSetupTime2.setDescription('')
...
if mibBuilder.loadTexts: mostRecentFailure2.setDescription('')
...
if mibBuilder.loadTexts: poolSize.setDescription('')
...
if mibBuilder.loadTexts: freeLinks.setDescription('')
...
if mibBuilder.loadTexts: incomingAccessMask3.setDescription('')
...
if mibBuilder.loadTexts: outgoingAccessMask3.setDescription('')
...
if mibBuilder.loadTexts: timecutAccessMask2.setDescription('')
mibBuilder.exportSymbols("SCA-MPLINK-MIB", serviceNumber1=serviceNumber1, permitTimeCut1=permitTimeCut1, poolName=poolName, serviceNumber3=serviceNumber3, wanSpecific=wanSpecific, serviceType=serviceType, poolTable=poolTable, incomingAccessMask1=incomingAccessMask1, serviceNumber2=serviceNumber2, callsPlaced1=callsPlaced1, OffOn=OffOn, actualErrorRetries=actualErrorRetries, acceptReverseCharge1=acceptReverseCharge1, maxErrorRetries1=maxErrorRetries1, dataCompressionState=dataCompressionState, remoteUserDataAddress=remoteUserDataAddress, maxErrorRetries2=maxErrorRetries2, callsPlaced2=callsPlaced2, serviceEntry=serviceEntry, provider=provider, dataCompressionSwitch2=dataCompressionSwitch2, acceptReverseCharge2=acceptReverseCharge2, ownSNPAAddress=ownSNPAAddress, maxCallSetupTime1=maxCallSetupTime1, wanEntry=wanEntry, permitOutgoingCalls1=permitOutgoingCalls1, poolEntry=poolEntry, freeLinks=freeLinks, slot=slot, mostRecentFailure2=mostRecentFailure2, backupOnly=backupOnly, actualCallState=actualCallState, timecutAccessMask1=timecutAccessMask1, outgoingAccessMask1=outgoingAccessMask1, proposeReverseCharge2=proposeReverseCharge2, permitOutgoingCalls2=permitOutgoingCalls2, mostRecentFailure1=mostRecentFailure1, ownUserDataAddress2=ownUserDataAddress2, minCallDuration2=minCallDuration2, remoteSNPAaddress=remoteSNPAaddress, packetsReceived=packetsReceived, reserveTime1=reserveTime1, maxCallSetupTime2=maxCallSetupTime2, queueRejectThreshold2=queueRejectThreshold2, maxPacketSize=maxPacketSize, lanTable=lanTable, queueActualValue=queueActualValue, queueHighWaterTideMark=queueHighWaterTideMark, bytesSent=bytesSent, minCallDuration1=minCallDuration1, scaNetSubnet=scaNetSubnet, wanTable=wanTable, callsFailed2=callsFailed2, backupForLink=backupForLink, lanSpecific=lanSpecific, actualCallDirection=actualCallDirection, bytesReceived=bytesReceived, packetsSent=packetsSent, service=service, reserveTime2=reserveTime2, permitTimeCut2=permitTimeCut2, idleTime1=idleTime1, serviceNumber4=serviceNumber4, poolIndex=poolIndex, ownUserDataAddress1=ownUserDataAddress1, serviceTable=serviceTable, incomingAccessMask3=incomingAccessMask3, timecutAccessMask2=timecutAccessMask2, incomingAccessMask2=incomingAccessMask2, poolSize=poolSize, plug=plug, actualCallDuration=actualCallDuration, mplk=mplk, serviceState=serviceState, errorRetryInterval1=errorRetryInterval1, outgoingAccessMask2=outgoingAccessMask2, acceptIncomingCalls2=acceptIncomingCalls2, errorRetryInterval2=errorRetryInterval2, queueRejectThreshold1=queueRejectThreshold1, acceptIncomingCalls1=acceptIncomingCalls1, idleTime2=idleTime2, outgoingAccessMask3=outgoingAccessMask3, dataCompressionSwitch1=dataCompressionSwitch1, callsFailed1=callsFailed1, proposeReverseCharge1=proposeReverseCharge1, serviceName=serviceName, lanEntry=lanEntry, actualTimer=actualTimer)
