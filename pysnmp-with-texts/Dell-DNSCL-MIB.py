...
# Produced by pysmi-0.3.4 at Wed May  1 12:55:45 2019
...
dns, DnsOpCode, DnsTime, DnsNameAsIndex, DnsQClass, DnsType, DnsClass, DnsQType, DnsRespCode, DnsName = mibBuilder.importSymbols("DNS-SERVER-MIB", "dns", "DnsOpCode", "DnsTime", "DnsNameAsIndex", "DnsQClass", "DnsType", "DnsClass", "DnsQType", "DnsRespCode", "DnsName")
rnd, = mibBuilder.importSymbols("Dell-MIB", "rnd")
ifIndex, InterfaceIndex = mibBuilder.importSymbols("IF-MIB", "ifIndex", "InterfaceIndex")
InetAddress, InetAddressType = mibBuilder.importSymbols("INET-ADDRESS-MIB", "InetAddress", "InetAddressType")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter32, ObjectIdentity, Unsigned32, iso, Bits, ModuleIdentity, Counter64, Integer32, MibIdentifier, NotificationType, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter32", "ObjectIdentity", "Unsigned32", "iso", "Bits", "ModuleIdentity", "Counter64", "Integer32", "MibIdentifier", "NotificationType", "IpAddress")
...
if mibBuilder.loadTexts: rlDnsCl.setContactInfo('www.dell.com')
if mibBuilder.loadTexts: rlDnsCl.setDescription('The MIB module describes the private MIB for DNS supported by Dell MTS software and products.')
...
mibBuilder.exportSymbols("Dell-DNSCL-MIB", rlDnsClv2UnifiedCachePrettyName=rlDnsClv2UnifiedCachePrettyName, rlDnsClv2FixedTTPolling=rlDnsClv2FixedTTPolling, rlDnsClNamesName=rlDnsClNamesName, rlDnsClNamesInetEntry=rlDnsClNamesInetEntry, rlDnsResNCacheErrInetTable=rlDnsResNCacheErrInetTable, rlDnsResCacheRRInetPrettyName=rlDnsResCacheRRInetPrettyName, rlDnsClv2UnifiedCacheSource=rlDnsClv2UnifiedCacheSource, rlDnsClv2ServersSubTree=rlDnsClv2ServersSubTree, rlDnsClv2ServersPreference=rlDnsClv2ServersPreference, rlDnsClNamesInetAddrType=rlDnsClNamesInetAddrType, rlDnsResConfigSbeltInetAddr=rlDnsResConfigSbeltInetAddr, rlDnsResCacheRRInetData=rlDnsResCacheRRInetData, rlDnsClv2UnifiedCacheTable=rlDnsClv2UnifiedCacheTable, rlDnsResNCacheErrInetQType=rlDnsResNCacheErrInetQType, rlDnsResConfigSbeltInetRecursion=rlDnsResConfigSbeltInetRecursion, rlDnsClNamesAddr=rlDnsClNamesAddr, rlDnsClv2UnifiedCacheIndex=rlDnsClv2UnifiedCacheIndex, rlDnsClNamesOwner=rlDnsClNamesOwner, rlDnsClv2DomainNameEntry=rlDnsClv2DomainNameEntry, rlDnsResCacheRRInetTTL=rlDnsResCacheRRInetTTL, rlDnsResNCacheErrInetSourceAddrType=rlDnsResNCacheErrInetSourceAddrType, rlDnsClNamesInetName=rlDnsClNamesInetName, rlDnsResCacheRRInetName=rlDnsResCacheRRInetName, rlDnsResConfigSbeltInetClass=rlDnsResConfigSbeltInetClass, rlDnsResNCacheErrInetPrettyName=rlDnsResNCacheErrInetPrettyName, rlDnsClNamesEntry=rlDnsClNamesEntry, rlDnsClNamesInetOwner=rlDnsClNamesInetOwner, rlDnsClDomainNameOwner=rlDnsClDomainNameOwner, rlDnsClv2ServersInetAddr=rlDnsClv2ServersInetAddr, rlDnsResCacheRRInetElapsedTTL=rlDnsResCacheRRInetElapsedTTL, rlDnsResCacheRRInetSource=rlDnsResCacheRRInetSource, rlDnsResNCacheErrInetQClass=rlDnsResNCacheErrInetQClass, rlDnsResNCacheErrInetCode=rlDnsResNCacheErrInetCode, rlDnsClv2FixedType=rlDnsClv2FixedType, rlDnsClv2FixedPrettyName=rlDnsClv2FixedPrettyName, rlDnsResConfigSbeltInetName=rlDnsResConfigSbeltInetName, rlDnsClv2UnifiedCacheInetAddrType=rlDnsClv2UnifiedCacheInetAddrType, rlDnsClNamesTable=rlDnsClNamesTable, rlDnsClv2FixedTTL=rlDnsClv2FixedTTL, rlDnsClv2ClearCacheTable=rlDnsClv2ClearCacheTable, rlDnsClv2DomainNameTable=rlDnsClv2DomainNameTable, rlDnsResConfigSbeltInetAddrType=rlDnsResConfigSbeltInetAddrType, rlDnsClv2FixedCounter=rlDnsClv2FixedCounter, rlDnsClv2UnifiedCacheState=rlDnsClv2UnifiedCacheState, rlDnsResCacheRRInetEntry=rlDnsResCacheRRInetEntry, rlDnsResCacheRRInetSourceAddrType=rlDnsResCacheRRInetSourceAddrType, rlDnsClNamesRowStatus=rlDnsClNamesRowStatus, rlDnsResConfigSbeltExtEntry=rlDnsResConfigSbeltExtEntry, rlDnsClNamesInetTable=rlDnsClNamesInetTable, rlDnsClv2DomainNamePreference=rlDnsClv2DomainNamePreference, rlDnsResNCacheErrInetTTL=rlDnsResNCacheErrInetTTL, rlDnsClDomainNameTable=rlDnsClDomainNameTable, rlDnsResConfigSbeltInetOwner=rlDnsResConfigSbeltInetOwner, rlDnsResNCacheErrInetSource=rlDnsResNCacheErrInetSource, rlDnsClv2UnifiedCacheName=rlDnsClv2UnifiedCacheName, rlDnsClDomainNameRowStatus=rlDnsClDomainNameRowStatus, rlDnsClNamesInetRowStatus=rlDnsClNamesInetRowStatus, rlDnsResCacheRRInetTable=rlDnsResCacheRRInetTable, rlDnsClv2ServersClass=rlDnsClv2ServersClass, rlDnsClv2DomainNameName=rlDnsClv2DomainNameName, rlDnsClNamesInetAddr=rlDnsClNamesInetAddr, rlDnsClv2UnifiedCacheRemainingTTL=rlDnsClv2UnifiedCacheRemainingTTL, rlDnsClv2FixedName=rlDnsClv2FixedName, rlDnsClv2FixedTTRefresh=rlDnsClv2FixedTTRefresh, rlDnsResConfigSbeltInetPref=rlDnsResConfigSbeltInetPref, PYSNMP_MODULE_ID=rlDnsCl, rlDnsClEnable=rlDnsClEnable, rlDnsClNamesIndex=rlDnsClNamesIndex, rlDnsResCacheRRInetIndex=rlDnsResCacheRRInetIndex, rlDnsClv2UnifiedCacheTTL=rlDnsClv2UnifiedCacheTTL, rlDnsClNamesInetIndex=rlDnsClNamesInetIndex, rlDnsCl=rlDnsCl, rlDnsClv2DomainNameIfIndex=rlDnsClv2DomainNameIfIndex, rlDnsClv2ServersAddrType=rlDnsClv2ServersAddrType, rlDnsResNCacheErrInetStatus=rlDnsResNCacheErrInetStatus, rlDnsClv2FixedState=rlDnsClv2FixedState, rlDnsClv2ServersEntry=rlDnsClv2ServersEntry, rlDnsClMaxNumOfRetransmissions=rlDnsClMaxNumOfRetransmissions, rlDnsClMibVersion=rlDnsClMibVersion, rlDnsResNCacheErrInetIndex=rlDnsResNCacheErrInetIndex, rlDnsClv2ServersTable=rlDnsClv2ServersTable, rlDnsClv2UnifiedCacheInetAddr=rlDnsClv2UnifiedCacheInetAddr, rlDnsClMinPollingInterval=rlDnsClMinPollingInterval, rlDnsClDomainNameEntry=rlDnsClDomainNameEntry, rlDnsResCacheRRInetType=rlDnsResCacheRRInetType, rlDnsResConfigSbeltExtTable=rlDnsResConfigSbeltExtTable, rlDnsResNCacheErrInetEntry=rlDnsResNCacheErrInetEntry, rlDnsClDomainNameName=rlDnsClDomainNameName, rlDnsClv2UnifiedCacheEntry=rlDnsClv2UnifiedCacheEntry, rlDnsResCacheRRInetStatus=rlDnsResCacheRRInetStatus, rlDnsClv2ServersRowStatus=rlDnsClv2ServersRowStatus, rlDnsResNCacheErrInetElapsedTTL=rlDnsResNCacheErrInetElapsedTTL, rlDnsClv2ServersIfIndex=rlDnsClv2ServersIfIndex, rlDnsClv2DomainNameSource=rlDnsClv2DomainNameSource, rlDnsClv2FixedTable=rlDnsClv2FixedTable, rlDnsResConfigSbeltInetStatus=rlDnsResConfigSbeltInetStatus, rlDnsResConfigSbeltOwner=rlDnsResConfigSbeltOwner, rlDnsClv2ServersSource=rlDnsClv2ServersSource, rlDnsClNamesInetRRType=rlDnsClNamesInetRRType, rlDnsResConfigSbeltInetTable=rlDnsResConfigSbeltInetTable, rlDnsResConfigSbeltInetSubTree=rlDnsResConfigSbeltInetSubTree, rlDnsResConfigSbeltInetEntry=rlDnsResConfigSbeltInetEntry, rlDnsClMinRetransmissionInterval=rlDnsClMinRetransmissionInterval, rlDnsResConfigSbeltExtInetEntry=rlDnsResConfigSbeltExtInetEntry, rlDnsClv2DomainNameRowStatus=rlDnsClv2DomainNameRowStatus, rlDnsResCacheRRInetClass=rlDnsResCacheRRInetClass, rlDnsResConfigSbeltExtInetTable=rlDnsResConfigSbeltExtInetTable, rlDnsResNCacheErrInetQName=rlDnsResNCacheErrInetQName, rlDnsClv2UnifiedCacheType=rlDnsClv2UnifiedCacheType, rlDnsClv2FixedEntry=rlDnsClv2FixedEntry)
