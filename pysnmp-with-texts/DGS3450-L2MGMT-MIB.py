...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS3450-L2MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:46:30 2019
...
Counter64, NotificationType, MibIdentifier, TimeTicks, Gauge32, IpAddress, Unsigned32, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, Counter32, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "MibIdentifier", "TimeTicks", "Gauge32", "IpAddress", "Unsigned32", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "Counter32", "ObjectIdentity")
...
swL2PortInfoErrDisReason = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 3, 2, 3, 1, 1, 7), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("err-none", 1), ("storm-control", 2), ("lbd-control", 3)))).setMaxAccess("readonly")
...
swL2QOSSchedulingEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 70, 3, 2, 6, 2, 1), ).setIndexNames((0, "DGS3450-L2MGMT-MIB", "swL2QOSSchedulingClassIndex"))
...
swL2QOSSchedulingClassIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 3, 2, 6, 2, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 7))).setMaxAccess("readonly")
...
swL2QOSSchedulingMaxPkts = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 3, 2, 6, 2, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 15))).setMaxAccess("readwrite")
...
swL2QOSSchedulingMechanism = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 3, 2, 6, 2, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("strict", 1), ("roundrobin", 2), ("weightfair", 3)))).setMaxAccess("readonly")
...
swL2PortSecurityMaxLernAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 3, 2, 7, 1, 1, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 16))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS3450-L2MGMT-MIB", swL2LoopDetectPortLoopVLAN=swL2LoopDetectPortLoopVLAN, swL2MultiFilterEntry=swL2MultiFilterEntry, swL2QOSSchedulingTable=swL2QOSSchedulingTable, swL2IGMPMulticastVlanEntry=swL2IGMPMulticastVlanEntry, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2PortSecurityDelVlanName=swL2PortSecurityDelVlanName, swL2QOS8021pDefaultPriorityTable=swL2QOS8021pDefaultPriorityTable, swL2DevCtrlIGMPSnooping=swL2DevCtrlIGMPSnooping, swL2IGMPCurrentState=swL2IGMPCurrentState, swL2PortLoopOccurred=swL2PortLoopOccurred, swL2PortInfoType=swL2PortInfoType, swL2QOSSchedulingMaxPkts=swL2QOSSchedulingMaxPkts, swL2IGMPRouterForbiddenPortList=swL2IGMPRouterForbiddenPortList, swIGMPSnoopingGroupEntry=swIGMPSnoopingGroupEntry, swL2IGMPCtrlTable=swL2IGMPCtrlTable, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2PortCtrlMediumType=swL2PortCtrlMediumType, swL2PortInfoUnitID=swL2PortInfoUnitID, swL2NotifFirmware=swL2NotifFirmware, swDevInfoFrontPanelLedStatus=swDevInfoFrontPanelLedStatus, swL2MirrorMgmt=swL2MirrorMgmt, swL2IGMPHostTimeout=swL2IGMPHostTimeout, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2LoopDetectMgmt=swL2LoopDetectMgmt, swL2IGMPInfoVid=swL2IGMPInfoVid, swL2PortLoopRestart=swL2PortLoopRestart, swL2VlanStaticPorts=swL2VlanStaticPorts, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, PortList=PortList, swL2QOS8021pUserPriorityIndex=swL2QOS8021pUserPriorityIndex, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2QOSBandwidthRxRate=swL2QOSBandwidthRxRate, swL2IpLimitedMulticastAccess=swL2IpLimitedMulticastAccess, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2PortSecurityControlEntry=swL2PortSecurityControlEntry, swL2DevCtrl=swL2DevCtrl, swL2PortVLANIngressDrops=swL2PortVLANIngressDrops, swL2MultiFilterTable=swL2MultiFilterTable, swL2IGMPSnoopingStaticGroupRowStatus=swL2IGMPSnoopingStaticGroupRowStatus, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2DevCtrlStpState=swL2DevCtrlStpState, swL2PortInfoTable=swL2PortInfoTable, swL2VlanStaticTaggedPorts=swL2VlanStaticTaggedPorts, swL2PortMgmt=swL2PortMgmt, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2IGMPMulticastVlanRemoveAllMcastAddrListAction=swL2IGMPMulticastVlanRemoveAllMcastAddrListAction, swL2LoopDetectPortLoopStatus=swL2LoopDetectPortLoopStatus, swL2PortDropCounterPortIndex=swL2PortDropCounterPortIndex, swL2TrafficSegTable=swL2TrafficSegTable, swL2LoopDetectPortIndex=swL2LoopDetectPortIndex, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2QOSBandwidthControlTable=swL2QOSBandwidthControlTable, swL2IGMPMulticastVlanTable=swL2IGMPMulticastVlanTable, swL2IGMPSnoopingStaticGroupEntry=swL2IGMPSnoopingStaticGroupEntry, swL2VlanForbiddenPorts=swL2VlanForbiddenPorts, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2PortCounterCtrlTable=swL2PortCounterCtrlTable, swL2IGMPGroupIpAddr=swL2IGMPGroupIpAddr, swL2IGMPMulticastVlanGroupFromIp=swL2IGMPMulticastVlanGroupFromIp, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2IpLimitedMulticastPortIndex=swL2IpLimitedMulticastPortIndex, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2QOS8021pUserPriorityTable=swL2QOS8021pUserPriorityTable, swL2PortCtrlTable=swL2PortCtrlTable, swL2PortSecurityMgmt=swL2PortSecurityMgmt, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2PortDropCounterTable=swL2PortDropCounterTable, swL2QOSBandwidthRadiusRxRate=swL2QOSBandwidthRadiusRxRate, swL2IGMPMulticastVlanMemberPort=swL2IGMPMulticastVlanMemberPort, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2IpLimitedMulticastDelState=swL2IpLimitedMulticastDelState, swL2PVIDAutoAssignmentState=swL2PVIDAutoAssignmentState, swL2PortCounterClearCtrl=swL2PortCounterClearCtrl, swL2DevAlarm=swL2DevAlarm, swDevInfoFirmwareVersion=swDevInfoFirmwareVersion, swL2MACNotifyState=swL2MACNotifyState, swL2IGMPInfoEntry=swL2IGMPInfoEntry, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2IGMPQueryState=swL2IGMPQueryState, swL2PortInfoErrDisReason=swL2PortInfoErrDisReason, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2IGMPMaxSupportedVlans=swL2IGMPMaxSupportedVlans, swL2MgmtMIB=swL2MgmtMIB, swL2QOS8021pUserPriorityClass=swL2QOS8021pUserPriorityClass, swL2LoopDetectPortTable=swL2LoopDetectPortTable, swL2TrunkType=swL2TrunkType, swL2PortAutoNegInfoAdminStatus=swL2PortAutoNegInfoAdminStatus, swL2QOSBandwidthControlEntry=swL2QOSBandwidthControlEntry, swDevModuleInfoDescription=swDevModuleInfoDescription, swL2PortCtrlAutoNegRestart=swL2PortCtrlAutoNegRestart, swL2IGMPQueryInterval=swL2IGMPQueryInterval, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2VlanCurrentTaggedPorts=swL2VlanCurrentTaggedPorts, swL2IGMPSnoopingStaticGroupMemberPortList=swL2IGMPSnoopingStaticGroupMemberPortList, swL2MultiFilterVid=swL2MultiFilterVid, swL2PortCounterCtrlEntry=swL2PortCounterCtrlEntry, swL2DevCtrlRmonState=swL2DevCtrlRmonState, VlanId=VlanId, swL2PortCtrlJumboFrameMaxSize=swL2PortCtrlJumboFrameMaxSize, swL2PortCtrlLockState=swL2PortCtrlLockState, swL2QOS8021pDefaultPriority=swL2QOS8021pDefaultPriority, swL2PortSecurityDelActivity=swL2PortSecurityDelActivity, swL2IGMPMulticastVlanState=swL2IGMPMulticastVlanState, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2LoopDetectAdminState=swL2LoopDetectAdminState, swL2IGMPMgmt=swL2IGMPMgmt, swL2IGMPInfoTable=swL2IGMPInfoTable, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2DevCtrlIpAutoconfig=swL2DevCtrlIpAutoconfig, swL2DevInfo=swL2DevInfo, swL2DevMgmt=swL2DevMgmt, swL2VlanAdvertisementState=swL2VlanAdvertisementState, swDevModuleInfoTable=swDevModuleInfoTable, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2MirrorPortState=swL2MirrorPortState, swL2IGMPQueryVersion=swL2IGMPQueryVersion, swL2QOSBandwidthTxRate=swL2QOSBandwidthTxRate, swL2PortSecurityControlTable=swL2PortSecurityControlTable, swL2LoopDetectCtrl=swL2LoopDetectCtrl, swL2VlanMgmt=swL2VlanMgmt, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2PortAutoNegInfoPortIndex=swL2PortAutoNegInfoPortIndex, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2PortSecurityAdmState=swL2PortSecurityAdmState, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2IGMPRouterDynamicPortList=swL2IGMPRouterDynamicPortList, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swL2LoopDetectedNotify=swL2LoopDetectedNotify, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2TrunkIndex=swL2TrunkIndex, swL2IGMPMaxResponseTime=swL2IGMPMaxResponseTime, swL2VlanMemberPorts=swL2VlanMemberPorts, swL2LoopDetectPortEntry=swL2LoopDetectPortEntry, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2QOSBandwidthPortIndex=swL2QOSBandwidthPortIndex, swL2MultiFilterMode=swL2MultiFilterMode, swL2IGMPMulticastVlanid=swL2IGMPMulticastVlanid, swL2IGMPRouteTimeout=swL2IGMPRouteTimeout, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2PortSecurityMode=swL2PortSecurityMode, swIGMPSnoopingGroupGroupAddr=swIGMPSnoopingGroupGroupAddr, swL2QOSSchedulingEntry=swL2QOSSchedulingEntry, swDevModuleInfoReversion=swDevModuleInfoReversion, swL2macNotification=swL2macNotification, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2VlanType=swL2VlanType, swL2PortSecurityPortIndex=swL2PortSecurityPortIndex, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2IpLimitedMulticastTail=swL2IpLimitedMulticastTail, swL2PortCounterCtrlPortIndex=swL2PortCounterCtrlPortIndex, swL2macNotifyInfo=swL2macNotifyInfo, swIGMPSnoopingGroupSourceAddr=swIGMPSnoopingGroupSourceAddr, swL2IGMPLastMemberQueryInterval=swL2IGMPLastMemberQueryInterval, swL2IpLimitedMulticastHead=swL2IpLimitedMulticastHead, swL2LoopDetectTrapMode=swL2LoopDetectTrapMode, swL2VlanLoopDetectVID=swL2VlanLoopDetectVID, swL2TrunkMember=swL2TrunkMember, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swDevInfoBootPromVersion=swDevInfoBootPromVersion, swL2VlanTable=swL2VlanTable, swL2LoopDetectPortState=swL2LoopDetectPortState, swL2QOSBandwidthRadiusTxRate=swL2QOSBandwidthRadiusTxRate, swL2IGMPMulticastVlanGroupStatus=swL2IGMPMulticastVlanGroupStatus, swIGMPSnoopingGroupExcludePortMap=swIGMPSnoopingGroupExcludePortMap, swL2IpLimitedMulticastTable=swL2IpLimitedMulticastTable, swL2IGMPCtrlEntry=swL2IGMPCtrlEntry, swl2NotificationBidings=swl2NotificationBidings, swL2QOSMgmt=swL2QOSMgmt, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2IGMPQueryInfoTable=swL2IGMPQueryInfoTable, swL2IGMPLeaveTimer=swL2IGMPLeaveTimer, swL2PortACLDrops=swL2PortACLDrops, swL2IGMPIpGroupReportCount=swL2IGMPIpGroupReportCount, swL2IGMPMulticastVlanName=swL2IGMPMulticastVlanName, swL2IGMPReportSuppression=swL2IGMPReportSuppression, swL2IGMPRobustness=swL2IGMPRobustness, swL2PortCtrlAutoNegCapAdvertisedBits=swL2PortCtrlAutoNegCapAdvertisedBits, swL2VlanEntry=swL2VlanEntry, swL2QOS8021pUserPriorityEntry=swL2QOS8021pUserPriorityEntry, swL2NotifyPrefix=swL2NotifyPrefix, swL2VlanIndex=swL2VlanIndex, swL2PortBufferFullDrops=swL2PortBufferFullDrops, swDevModuleInfoSerial=swDevModuleInfoSerial, swL2PortDropCounterEntry=swL2PortDropCounterEntry, swL2QOSSchedulingClassIndex=swL2QOSSchedulingClassIndex, swL2TrunkState=swL2TrunkState, swL2IGMPQueryInfoEntry=swL2IGMPQueryInfoEntry, swL2IGMPMulticastVlanSourcePort=swL2IGMPMulticastVlanSourcePort, swL2IGMPSnoopingStaticGroupIPaddress=swL2IGMPSnoopingStaticGroupIPaddress, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swDevModuleInfoModuleID=swDevModuleInfoModuleID, swL2QOSSchedulingMechanismCtrl=swL2QOSSchedulingMechanismCtrl, swDevModuleInfoUnitID=swDevModuleInfoUnitID, swL2PortSecurityMaxLernAddr=swL2PortSecurityMaxLernAddr, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swL2TrunkName=swL2TrunkName, swL2IGMPSnoopingStaticGroupTable=swL2IGMPSnoopingStaticGroupTable, swL2IGMPMulticastVlanGroupTable=swL2IGMPMulticastVlanGroupTable, swL2PortSecurityDelMacAddress=swL2PortSecurityDelMacAddress, swL2MultiFilter=swL2MultiFilter, swL2TrunkMgmt=swL2TrunkMgmt, swL2PortSecurityDelCtrl=swL2PortSecurityDelCtrl, MacAddress=MacAddress, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2PortAutoNegInfoEntry=swL2PortAutoNegInfoEntry, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2PortAutoNegInfoTable=swL2PortAutoNegInfoTable, swL2IGMPFastLeaveState=swL2IGMPFastLeaveState, swL2IGMPRouterPortsTable=swL2IGMPRouterPortsTable, swL2IGMPMulticastVlanGroupEntry=swL2IGMPMulticastVlanGroupEntry, swL2VlanLoopOccurred=swL2VlanLoopOccurred, swL2PortAutoNegInfoCapabilityBits=swL2PortAutoNegInfoCapabilityBits, swL2DevCtrlIGMPSnoopingMcstRTOnly=swL2DevCtrlIGMPSnoopingMcstRTOnly, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swIGMPSnoopingGroupIncludePortMap=swIGMPSnoopingGroupIncludePortMap, swL2IGMPMaxIpGroupNumPerVlan=swL2IGMPMaxIpGroupNumPerVlan, swL2IGMPCtrlState=swL2IGMPCtrlState, swL2IGMPMulticastVlanGroupToIp=swL2IGMPMulticastVlanGroupToIp, swL2IGMPInfoQueryCount=swL2IGMPInfoQueryCount, swL2VlanLoopRestart=swL2VlanLoopRestart, swIGMPSnoopingGroupVid=swIGMPSnoopingGroupVid, swL2IGMPMulticastVlanRowStatus=swL2IGMPMulticastVlanRowStatus, swDevModuleInfoEntry=swDevModuleInfoEntry, swL2IGMPSnoopingStaticGroupVID=swL2IGMPSnoopingStaticGroupVID, swL2PortInfoEntry=swL2PortInfoEntry, swL2TrafficSegPort=swL2TrafficSegPort, swL2PortAutoNegInfoCapAdvertisedBits=swL2PortAutoNegInfoCapAdvertisedBits, swL2IGMPPortMap=swL2IGMPPortMap, swL2LoopDetectPortMgmt=swL2LoopDetectPortMgmt, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2PortMulticastDrops=swL2PortMulticastDrops, swL2QOS8021pDefaultPriorityIndex=swL2QOS8021pDefaultPriorityIndex, swL2IGMPRouterPortsVid=swL2IGMPRouterPortsVid, swL2IpLimitedMulticastState=swL2IpLimitedMulticastState, swL2VlanStaticUntaggedPorts=swL2VlanStaticUntaggedPorts, swL2IGMPMacAddr=swL2IGMPMacAddr, swL2DevCtrlClipagingState=swL2DevCtrlClipagingState, swL2LoopDetectRecoverTime=swL2LoopDetectRecoverTime, swL2IGMPMulticastVlanTagMemberPort=swL2IGMPMulticastVlanTagMemberPort, swL2VlanName=swL2VlanName, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, IANAifMauAutoNegCapBits=IANAifMauAutoNegCapBits, swL2QOSHolPreventionCtrl=swL2QOSHolPreventionCtrl, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2IGMPRouterStaticPortList=swL2IGMPRouterStaticPortList, swL2PortInfoMediumType=swL2PortInfoMediumType, swL2IpLimitedMulticastMgmt=swL2IpLimitedMulticastMgmt, swL2PortSecurityDelPort=swL2PortSecurityDelPort, swL2IGMPInfoTxQueryCount=swL2IGMPInfoTxQueryCount, swL2IGMPMulticastVlanReplaceSourceIp=swL2IGMPMulticastVlanReplaceSourceIp, swL2IGMPCtrlVid=swL2IGMPCtrlVid)
mibBuilder.exportSymbols("DGS3450-L2MGMT-MIB", swL2QOS8021pRadiusPriority=swL2QOS8021pRadiusPriority, swIGMPSnoopingGroupTable=swIGMPSnoopingGroupTable, swL2IpLimitedMulticastEntry=swL2IpLimitedMulticastEntry, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2PortAutoNegInfoCapReceivedBits=swL2PortAutoNegInfoCapReceivedBits, swL2VlanCurrentUntaggedPorts=swL2VlanCurrentUntaggedPorts, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2Notify=swL2Notify, swL2IGMPMulticastVlanGroupVid=swL2IGMPMulticastVlanGroupVid, swL2QOS8021pDefaultPriorityEntry=swL2QOS8021pDefaultPriorityEntry, swDevModuleInfoModuleName=swDevModuleInfoModuleName, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2IGMPVid=swL2IGMPVid, swL2LoopDetectInterval=swL2LoopDetectInterval, swL2TrunkActivePorts=swL2TrunkActivePorts, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2QOSSchedulingMechanism=swL2QOSSchedulingMechanism, swL2LoopDetectMode=swL2LoopDetectMode, swL2IGMPRouterPortsEntry=swL2IGMPRouterPortsEntry, swL2MACNotifyInterval=swL2MACNotifyInterval)
