...
# Produced by pysmi-0.3.4 at Wed May  1 14:32:59 2019
...
IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, Gauge32, iso, NotificationType, Unsigned32, Counter64, ModuleIdentity, MibIdentifier, Integer32, TimeTicks, ObjectIdentity, enterprises, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "Gauge32", "iso", "NotificationType", "Unsigned32", "Counter64", "ModuleIdentity", "MibIdentifier", "Integer32", "TimeTicks", "ObjectIdentity", "enterprises", "NotificationType")
...
if mibBuilder.loadTexts: trap_lms.setDescription('This alarm has been generated by the LMS environment Refer to the specific Resource Manager documentation for details.')
...
mibBuilder.exportSymbols("OLIVETTI-MIB", uxlms_sdrmEntry=uxlms_sdrmEntry, onetwareCreateFileRequests=onetwareCreateFileRequests, lms_LogString=lms_LogString, uxos_aiohab=uxos_aiohab, uxtp02_tp02SysName=uxtp02_tp02SysName, uxlapb_numOfphystxerrors=uxlapb_numOfphystxerrors, onetwareInstName=onetwareInstName, tnetb_NTWKSubAddr=tnetb_NTWKSubAddr, tp02Entry=tp02Entry, uxos_cpuUser=uxos_cpuUser, pblms_systemrmInstName=pblms_systemrmInstName, uxos_queue72=uxos_queue72, uxos_avenrun3=uxos_avenrun3, onetwareOpenRequests=onetwareOpenRequests, uxlms_systemrmTable=uxlms_systemrmTable, uxos_shlbinfoEntry=uxos_shlbinfoEntry, elcrxoverrun=elcrxoverrun, onetwareClientConnInUse=onetwareClientConnInUse, tnetb_TRSPunsuccessoutconnect=tnetb_TRSPunsuccessoutconnect, uxlmx_wksesstart=uxlmx_wksesstart, uxos_vPgin=uxos_vPgin, uxos_sumvNexfod=uxos_sumvNexfod, uxos_vHbuf=uxos_vHbuf, winlms_system=winlms_system, uxos_ratevFaults=uxos_ratevFaults, uxlapb_numOfrrrece=uxlapb_numOfrrrece, uxos_ipcSysName=uxos_ipcSysName, uxx25_numOfrnrxrece=uxx25_numOfrnrxrece, uxos_varEntry=uxos_varEntry, uxos_vmsumSubAddr=uxos_vmsumSubAddr, onetwareMaxSimultaneousFileLocks=onetwareMaxSimultaneousFileLocks, tnetb_TRSPrxdatagrmTPDU=tnetb_TRSPrxdatagrmTPDU, uxos_wIo=uxos_wIo, uxlmx_wksessfail=uxlmx_wksessfail, uxos_bootTable=uxos_bootTable, uxx25_numOfdatarece=uxx25_numOfdatarece, uxos_namecacheEntry=uxos_namecacheEntry, tnetb_TRSPTable=tnetb_TRSPTable, uxos_msg_rcv_again=uxos_msg_rcv_again, uxos_rtminfoSysName=uxos_rtminfoSysName, tnetb_LLCNrxTESTresponse=tnetb_LLCNrxTESTresponse, uxos_syserrSubAddr=uxos_syserrSubAddr, uxos_lioTable=uxos_lioTable, uxlmx_wkusefail=uxlmx_wkusefail, uxos_smemSubAddr=uxos_smemSubAddr, tnetb_NETBrxPDU=tnetb_NETBrxPDU, uxos_tRmtxt=uxos_tRmtxt, lapb=lapb, onetwareLogicalLockRequests=onetwareLogicalLockRequests, uxos_runocc=uxos_runocc, lmsSystemType=lmsSystemType, uxx25_numOfclearsent=uxx25_numOfclearsent, uxos_kmeminfoSysName=uxos_kmeminfoSysName, uxos_boottime=uxos_boottime, uxx25_numOfrejxrece=uxx25_numOfrejxrece, uxlapb_numOfDMitrece=uxlapb_numOfDMitrece, tnetb_NTWKresourceerror=tnetb_NTWKresourceerror, uxos_vXifrec=uxos_vXifrec, tnetb_TRSPInstName=tnetb_TRSPInstName, uxos_unmodfl=uxos_unmodfl, uxos_queue22=uxos_queue22, netbfreeNCB=netbfreeNCB, uxx25_numOfInformat=uxx25_numOfInformat, uxos_shlblnks=uxos_shlblnks, netbrxnobuffer=netbrxnobuffer, uxos_ratevDfree=uxos_ratevDfree, uxlapb_numOfDISCitsent=uxlapb_numOfDISCitsent, uxlms_systemrmEntry=uxlms_systemrmEntry, ethetxframexceeding=ethetxframexceeding, netbnumbernames=netbnumbernames, onetwareWriteRequests=onetwareWriteRequests, netbmaxNCB=netbmaxNCB, uxos_shlbinfo=uxos_shlbinfo, uxos_vProc=uxos_vProc, uxos_nproc=uxos_nproc, uxos_flckinfoSysName=uxos_flckinfoSysName, etherxalignment=etherxalignment, uxtp02_numOfnumberTPDUSent=uxtp02_numOfnumberTPDUSent, uxos_lwrite=uxos_lwrite, tnetb_LLCN=tnetb_LLCN, ntlms_sdrmTable=ntlms_sdrmTable, uxos_vxSubAddr=uxos_vxSubAddr, netbsoftwarelevel=netbsoftwarelevel, uxos_swapout=uxos_swapout, uxos_ratevNvrfod=uxos_ratevNvrfod, uxlapb_numOfDISCnitsent=uxlapb_numOfDISCnitsent, uxos_aiopoll=uxos_aiopoll, uxos_vxinopage=uxos_vxinopage, uxx25_numOfrejunsucfull=uxx25_numOfrejunsucfull, tnetb_TRSPprotocolerror=tnetb_TRSPprotocolerror, uxlapb_numOfoutsequence=uxlapb_numOfoutsequence, elcrxsuccess=elcrxsuccess, uxos_vXsfrec=uxos_vXsfrec, uxx25_x25SysName=uxx25_x25SysName, uxtp02_numOftExpeditedDataReceived=uxtp02_numOftExpeditedDataReceived, pblms_systemrmTable=pblms_systemrmTable, uxos_vEmap=uxos_vEmap, uxos_ratevPgrec=uxos_ratevPgrec, uxos_diskSysName=uxos_diskSysName, uxos_tRm=uxos_tRm, uxos_lock_rd_intr=uxos_lock_rd_intr, uxos_rectot=uxos_rectot, uxos_vxTable=uxos_vxTable, uxlapb_numOffrmrsent=uxlapb_numOffrmrsent, uxos_unlock=uxos_unlock, uxx25_numOfdatasent=uxx25_numOfdatasent, uxos_buffercache=uxos_buffercache, uxtp02_numOfctTPDUSuccessfullIncoming=uxtp02_numOfctTPDUSuccessfullIncoming, lapbTable=lapbTable, netb_NBEUITable=netb_NBEUITable, tnetb_TRSPEntry=tnetb_TRSPEntry, uxos_numOfTick=uxos_numOfTick, uxos_sumvXsfrec=uxos_sumvXsfrec, onetwareCacheHits=onetwareCacheHits, uxlapb_numOfrnrsent=uxlapb_numOfrnrsent, uxos_lgAlloc=uxos_lgAlloc, uxos_kmeminfoEntry=uxos_kmeminfoEntry, uxos_cntvSeqfree=uxos_cntvSeqfree, netbrxIframeserr=netbrxIframeserr, tnetb_NTWKlifetime=tnetb_NTWKlifetime, ntlms_system=ntlms_system, lsx_unix=lsx_unix, lms_sys_map=lms_sys_map, uxos_cntvSwtch=uxos_cntvSwtch, lms_LogType=lms_LogType, uxos_tMinasmem=uxos_tMinasmem, uxos_readch=uxos_readch, uxos_lock_rd_sleep=uxos_lock_rd_sleep, uxlmx_SRVLMInstName=uxlmx_SRVLMInstName, uxos_evTrap=uxos_evTrap, uxos_tMinarmem=uxos_tMinarmem, uxos_sumvDfree=uxos_sumvDfree, uxos_sumvPgout=uxos_sumvPgout, uxos_shm_atch_fail=uxos_shm_atch_fail, uxos_tPw=uxos_tPw, netbnumbersessions=netbnumbersessions, uxos_cntvPgpgout=uxos_cntvPgpgout, uxos_lock_rd_fail=uxos_lock_rd_fail, lms_SysName=lms_SysName, uxos_vmcntInstName=uxos_vmcntInstName, uxtp02_numOfctTPDUCongestion=uxtp02_numOfctTPDUCongestion, uxos_cntvPgpgin=uxos_cntvPgpgin, tp02=tp02, uxos_aioEntry=uxos_aioEntry, uxos_tAvmtxt=uxos_tAvmtxt, netbANYoustanding=netbANYoustanding, uxos_aioread=uxos_aioread, uxos_spare=uxos_spare, uxos_flockSubAddr=uxos_flockSubAddr, lmssysmapTable=lmssysmapTable, uxlapb_numOfSABMitsent=uxlapb_numOfSABMitsent, uxos_ipcInstName=uxos_ipcInstName, tnetb_TRSPallocerror=tnetb_TRSPallocerror, uxos_rtminfoSubAddr=uxos_rtminfoSubAddr, onetwareNumPhysLocks=onetwareNumPhysLocks, elcrxalignment=elcrxalignment, uxos_bootSubAddr=uxos_bootSubAddr, uxlapb_numOfDMitsent=uxlapb_numOfDMitsent, uxos_lock_read=uxos_lock_read, uxos_vPgrec=uxos_vPgrec, uxos_liowrite=uxos_liowrite, uxos_tAgeinterval=uxos_tAgeinterval, uxx25_numOfoctsent=uxx25_numOfoctsent, uxos_aioInstName=uxos_aioInstName, uxos_vXsdslots=uxos_vXsdslots, uxos_bwrite=uxos_bwrite, uxos_evPost=uxos_evPost, uxos_smInstName=uxos_smInstName, uxos_vCall=uxos_vCall, uxos_vminfoSysName=uxos_vminfoSysName, uxos_enters=uxos_enters, tnetb_LLCNTable=tnetb_LLCNTable, tnetb_LLCNtxUI5rame=tnetb_LLCNtxUI5rame, uxos_psinfail=uxos_psinfail, uxos_driveActive=uxos_driveActive, tnetb_LLCNrxXIDresponse=tnetb_LLCNrxXIDresponse, winlms_systemrmSubAddr=winlms_systemrmSubAddr, uxos_pswitch=uxos_pswitch, ethetxlostCS=ethetxlostCS, uxos_queue51=uxos_queue51, uxos_cntvNzfod=uxos_cntvNzfod, etherxCRC=etherxCRC, onetwareMessageRequests=onetwareMessageRequests, lms_SubAddress=lms_SubAddress, uxos_tFree=uxos_tFree, uxlapb_numOffrmrrece=uxlapb_numOffrmrrece, uxos_shlbatts=uxos_shlbatts, tnetb_TRSPtxTPDU=tnetb_TRSPtxTPDU, uxos_cachemiss=uxos_cachemiss, uxos_rtminfo=uxos_rtminfo, uxos_vClist=uxos_vClist, uxos_tFsflushr=uxos_tFsflushr, netbT1expired=netbT1expired, netbDATAGRAMoutstanding=netbDATAGRAMoutstanding, uxos_ratevPdma=uxos_ratevPdma, uxos_vBuf=uxos_vBuf, uxos_aioSysName=uxos_aioSysName, uxos_cntvTrap=uxos_cntvTrap, uxos_sem_get=uxos_sem_get, uxos_sumvSyscall=uxos_sumvSyscall, uxos_kmemInstName=uxos_kmemInstName, uxos_sema=uxos_sema, uxos_pswapin=uxos_pswapin, winlms_sdrmTable=winlms_sdrmTable, uxos_minfoSubAddr=uxos_minfoSubAddr, uxos_sem_op_again=uxos_sem_op_again, tnetb_NTWKtxforwarded=tnetb_NTWKtxforwarded, uxos_sumvSwpout=uxos_sumvSwpout, uxos_ratevSwpout=uxos_ratevSwpout, uxos_sumvFastpgrec=uxos_sumvFastpgrec, lms_Class=lms_Class, uxos_nprocSubAddr=uxos_nprocSubAddr, uxos_ratevPswpout=uxos_ratevPswpout, uxos_cntvPgin=uxos_cntvPgin, uxos_sysTable=uxos_sysTable, lmsSystemStatus=lmsSystemStatus, uxos_availkmem=uxos_availkmem, uxos_vmtotalEntry=uxos_vmtotalEntry, uxos_flockInstName=uxos_flockInstName, onetware_SRVNWTable=onetware_SRVNWTable, uxlms_system=uxlms_system, uxos_tAvm=uxos_tAvm, uxtp02_numOftDataReceived=uxtp02_numOftDataReceived, uxos_file=uxos_file, uxos_vfpg=uxos_vfpg, uxlmx_svjobsqueued=uxlmx_svjobsqueued, uxx25_numOfoctrece=uxx25_numOfoctrece, uxos_msg_snd_fail=uxos_msg_snd_fail, tnetb_NTWKrxreassembled=tnetb_NTWKrxreassembled, uxos_memTable=uxos_memTable, uxos_shlbinfoTable=uxos_shlbinfoTable, uxos_minQueLen=uxos_minQueLen, uxx25_numOfinterrece=uxx25_numOfinterrece, uxos_lioInstName=uxos_lioInstName, netb_NBEUIEntry=netb_NBEUIEntry, uxos_vmrate=uxos_vmrate, uxx25_numOfrestsent=uxx25_numOfrestsent, uxtp02_numOfctTPDURefusedConfProtError=uxtp02_numOfctTPDURefusedConfProtError, uxos_lock_wr_fail=uxos_lock_wr_fail, uxos_avenrunTable=uxos_avenrunTable, elctxlostCS=elctxlostCS, ntlms_systemrmSysName=ntlms_systemrmSysName, uxos_minfoTable=uxos_minfoTable, uxlms_sdrmSubAddr=uxlms_sdrmSubAddr, uxos_filecnt=uxos_filecnt, uxos_lock_wr_sleep=uxos_lock_wr_sleep, uxos_bootInstName=uxos_bootInstName, tnetb_TRSPSubAddr=tnetb_TRSPSubAddr, uxlapb_numOfrrsent=uxlapb_numOfrrsent, tnetb_LLCNSubAddr=tnetb_LLCNSubAddr, uxos_kmemSubAddr=uxos_kmemSubAddr, lmssysmapEntry=lmssysmapEntry, uxos_swapin=uxos_swapin, uxos_namecacheSysName=uxos_namecacheSysName)
mibBuilder.exportSymbols("OLIVETTI-MIB", winlms_sdrmSubAddr=winlms_sdrmSubAddr, uxlmx_wkuses=uxlmx_wkuses, uxos_lioread=uxos_lioread, uxos_shm_get=uxos_shm_get, tnetb_TRSPsuccessinconnect=tnetb_TRSPsuccessinconnect, elctxattempted=elctxattempted, uxx25_numOfclearretries=uxx25_numOfclearretries, uxos_pagemiss=uxos_pagemiss, uxos_pfault=uxos_pfault, uxlapb_lapbInstName=uxlapb_lapbInstName, ethetxlostCTS=ethetxlostCTS, uxos_sysEntry=uxos_sysEntry, uxtp02_numOfrefusedTPDUProtocolError=uxtp02_numOfrefusedTPDUProtocolError, uxx25_numOfintersent=uxx25_numOfintersent, uxtp02_tp02InstName=uxtp02_tp02InstName, tnetb_TNB=tnetb_TNB, uxx25_numOfrrxrece=uxx25_numOfrrxrece, ntlms_systemrmTable=ntlms_systemrmTable, uxos_ratevNzfod=uxos_ratevNzfod, uxos_unmodsw=uxos_unmodsw, uxos_sumvPswpin=uxos_sumvPswpin, uxos_cntvNvrfod=uxos_cntvNvrfod, uxos_msg_lock_sleep=uxos_msg_lock_sleep, ethetxattempted=ethetxattempted, uxos_psinok=uxos_psinok, netbmaxdatapacket=netbmaxdatapacket, uxlmx_svserrorout=uxlmx_svserrorout, uxos_avenrunSysName=uxos_avenrunSysName, uxos_steal=uxos_steal, uxos_lioEntry=uxos_lioEntry, onetwareDirectoryRequests=onetwareDirectoryRequests, elctxdeferred=elctxdeferred, uxos_kmemTable=uxos_kmemTable, tnetb_TRSPrxinvalidTPDU=tnetb_TRSPrxinvalidTPDU, uxos_aioSubAddr=uxos_aioSubAddr, uxos_ratevIntrans=uxos_ratevIntrans, uxos_sumvIntrans=uxos_sumvIntrans, netbtxnobuffer=netbtxnobuffer, olivetti=olivetti, uxx25_numOfdiagnrece=uxx25_numOfdiagnrece, uxos_canch=uxos_canch, uxos_ratevPswpin=uxos_ratevPswpin, ethe_MAC1=ethe_MAC1, tnetb_NTWKrxbyte=tnetb_NTWKrxbyte, uxos_writech=uxos_writech, uxos_vmrateInstName=uxos_vmrateInstName, netbreserved=netbreserved, uxos_tSw=uxos_tSw, uxlms_systemrmSysName=uxlms_systemrmSysName, uxos_sumvPswpout=uxos_sumvPswpout, uxos_totBlkResp=uxos_totBlkResp, uxos_ufsfreeinodeSubAddr=uxos_ufsfreeinodeSubAddr, uxos_vspg=uxos_vspg, lms_RecLevel=lms_RecLevel, elctxlostCTS=elctxlostCTS, uxos_memSysName=uxos_memSysName, uxos_fileSysName=uxos_fileSysName, uxos_cntvPdma=uxos_cntvPdma, tnetb_TRSPtxdatabyte=tnetb_TRSPtxdatabyte, uxos_cpuEntry=uxos_cpuEntry, uxos_lastInQueue=uxos_lastInQueue, uxos_queue71=uxos_queue71, uxlmx_SRVLMSysName=uxlmx_SRVLMSysName, onetwareMaxSimultaneousLogLocks=onetwareMaxSimultaneousLogLocks, ntlms_systemrmEntry=ntlms_systemrmEntry, uxlapb_numOfrejsent=uxlapb_numOfrejsent, uxos_aiohfbuf=uxos_aiohfbuf, uxos_vPswpout=uxos_vPswpout, uxos_disc=uxos_disc, uxos_sumvRev=uxos_sumvRev, x25=x25, uxos_varTable=uxos_varTable, uxos_inodeovf=uxos_inodeovf, win_nt=win_nt, uxos_vNglobpris=uxos_vNglobpris, uxos_varSysName=uxos_varSysName, uxos_ipcinfo=uxos_ipcinfo, uxos_wPio=uxos_wPio, uxos_fileovf=uxos_fileovf, uxlapb_numOfbusyconent=uxlapb_numOfbusyconent, uxos_sem_op=uxos_sem_op, uxos_avenrunInstName=uxos_avenrunInstName, tnetb_NTWKtxbyte=tnetb_NTWKtxbyte, uxos_varSubAddr=uxos_varSubAddr, uxos_vPswpin=uxos_vPswpin, tnetb_TRSPtxdatagramTPDU=tnetb_TRSPtxdatagramTPDU, uxos_lboltTable=uxos_lboltTable, uxos_tuneSysName=uxos_tuneSysName, uxx25_numOfrestretries=uxx25_numOfrestretries, winlms_systemrmTable=winlms_systemrmTable, uxos_syserrEntry=uxos_syserrEntry, uxlapb_numOfdataoctrece=uxlapb_numOfdataoctrece, uxlms_systemrm=uxlms_systemrm, uxos_lock_write=uxos_lock_write, uxos_mdmint=uxos_mdmint, tnetb_NETBreserved=tnetb_NETBreserved, uxos_smlMem=uxos_smlMem, tnetb_LLCNrxUIframe=tnetb_LLCNrxUIframe, uxos_msg_snd=uxos_msg_snd, tnetb_LLCNtxTESTresponse=tnetb_LLCNtxTESTresponse, tnetb_LLCNEntry=tnetb_LLCNEntry, tnetb_NETBSubAddr=tnetb_NETBSubAddr, uxos_nprocTable=uxos_nprocTable, etherxnobuffer=etherxnobuffer, uxos_memSize=uxos_memSize, uxos_ovszMem=uxos_ovszMem, uxos_tune=uxos_tune, uxos_procovf=uxos_procovf, uxos_varInstName=uxos_varInstName, uxx25_numOfrrxsent=uxx25_numOfrrxsent, uxos_msg_cntl=uxos_msg_cntl, onetware_NW=onetware_NW, tnetb_LLCNtxMACerror=tnetb_LLCNtxMACerror, uxos_lock_rd_again=uxos_lock_rd_again, uxlapb_numOfReserved3=uxlapb_numOfReserved3, ethetxunderrun=ethetxunderrun, uxos_bootEntry=uxos_bootEntry, uxos_cntvIntr=uxos_cntvIntr, onetwareNumFileLocks=onetwareNumFileLocks, uxos_cntvPgout=uxos_cntvPgout, uxos_hits=uxos_hits, uxos_lioSubAddr=uxos_lioSubAddr, uxx25_numOfrejxsent=uxx25_numOfrejxsent, elc_MAC=elc_MAC, tnetb_NETB=tnetb_NETB, uxos_vPgpgin=uxos_vPgpgin, uxos_flckinfoTable=uxos_flckinfoTable, uxos_diskInstName=uxos_diskInstName, uxlmx_wknumNCBs=uxlmx_wknumNCBs, tnetb_NTWKInstName=tnetb_NTWKInstName, uxos_sem_op_intr=uxos_sem_op_intr, uxlmx_svsopens=uxlmx_svsopens, uxx25_x25SubAddr=uxx25_x25SubAddr, onetwareCurrentSharedMemoryUsage=onetwareCurrentSharedMemoryUsage, winlms_systemrmSysName=winlms_systemrmSysName, tnetb_NETBInstName=tnetb_NETBInstName, uxtp02_numOfctTPDUSuccessfullOutgoing=uxtp02_numOfctTPDUSuccessfullOutgoing, uxos_lboltInstName=uxos_lboltInstName, uxos_tMinakmem=uxos_tMinakmem, uxos_queue01=uxos_queue01, tnetb_TRSPoverrunTPDU=tnetb_TRSPoverrunTPDU, tnetb_TRSPreserved3=tnetb_TRSPreserved3, uxos_totBlkTrans=uxos_totBlkTrans, uxos_vxinfo=uxos_vxinfo, uxos_vScrn=uxos_vScrn, elctxcollision=elctxcollision, onetwarePrintRequests=onetwarePrintRequests, tnetb_LLCNInstName=tnetb_LLCNInstName, lms_ResourceName=lms_ResourceName, uxlapb_numOfinfosent=uxlapb_numOfinfosent, elc_ELC=elc_ELC, uxos_ratevSwtch=uxos_ratevSwtch, tnetb_NETBresolutednames=tnetb_NETBresolutednames, uxos_freeswap=uxos_freeswap, uxtp02_numOftDataSent=uxtp02_numOftDataSent, uxos_ipcTable=uxos_ipcTable, uxx25_numOfsyntaxerrors=uxx25_numOfsyntaxerrors, uxos_sumvExfod=uxos_sumvExfod, uxos_sumvFaults=uxos_sumvFaults, uxos_smSubAddr=uxos_smSubAddr, uxos_cntvIntrans=uxos_cntvIntrans, uxos_swpque=uxos_swpque, tnetb_NETBsuccessderegistr=tnetb_NETBsuccessderegistr, ethetxbytesuccess=ethetxbytesuccess, uxos_rel_async=uxos_rel_async, onetwareSharedMemorySize=onetwareSharedMemorySize, uxos_liolock=uxos_liolock, trap_lms=trap_lms, uxos_scsi=uxos_scsi, uxos_rcvint=uxos_rcvint, uxos_rel_free=uxos_rel_free, netbreportingperiod=netbreportingperiod, tnetb_NTWKSysName=tnetb_NTWKSysName, uxos_aioTable=uxos_aioTable, uxos_avenrun1=uxos_avenrun1, uxos_sumvScan=uxos_sumvScan, uxos_sem_op_fail=uxos_sem_op_fail, uxos_avenrun=uxos_avenrun, uxos_sumvIntr=uxos_sumvIntr, uxos_vmtotalTable=uxos_vmtotalTable, uxos_liocall=uxos_liocall, tnetb_TRSPactiveconnection=tnetb_TRSPactiveconnection, uxtp02_numOftExpeditedDataSent=uxtp02_numOftExpeditedDataSent, uxos_ratevFastpgrec=uxos_ratevFastpgrec, uxlapb_numOfUAnitsent=uxlapb_numOfUAnitsent, pblms_systemrm=pblms_systemrm, uxos_ratevSwpin=uxos_ratevSwpin, lms=lms, uxos_availsmem=uxos_availsmem, uxos_smemSysName=uxos_smemSysName, uxos_swap=uxos_swap, uxos_vmrateEntry=uxos_vmrateEntry, uxlapb_numOfDISCnitrece=uxlapb_numOfDISCnitrece, uxos_ratevNexfod=uxos_ratevNexfod, winlms_systemrmInstName=winlms_systemrmInstName, uxos_psoutok=uxos_psoutok, uxos_cntvPswpout=uxos_cntvPswpout, uxos_nprocSysName=uxos_nprocSysName, uxos_syserrSysName=uxos_syserrSysName, uxos_cntvPgfrec=uxos_cntvPgfrec, uxos_avenrunEntry=uxos_avenrunEntry, uxos_tSl=uxos_tSl, uxos_flckinfo=uxos_flckinfo, tnetb_NTWKPDUbadformat=tnetb_NTWKPDUbadformat, uxos_sumvPgrec=uxos_sumvPgrec, uxos_ufsfreeinodeTable=uxos_ufsfreeinodeTable, uxos_sem_cntl=uxos_sem_cntl, uxx25_numOfresetretries=uxx25_numOfresetretries, onetwareTotalPackets=onetwareTotalPackets, uxos_smlFail=uxos_smlFail, ethe_ETH=ethe_ETH, uxos_vXsdsegs=uxos_vXsdsegs, uxos_smemNumOfPages=uxos_smemNumOfPages, uxos_flockinfo=uxos_flockinfo, uxos_evPoll=uxos_evPoll, onetware_SRVNW=onetware_SRVNW, uxos_rel_dontneed=uxos_rel_dontneed, tnetb_TRSPconnectinactivity=tnetb_TRSPconnectinactivity, lmsSystemClass=lmsSystemClass, elctxmaxcollision=elctxmaxcollision, uxlms_nms=uxlms_nms, uxos_cntvXsfrec=uxos_cntvXsfrec, uxos_syserr=uxos_syserr, uxos_vmsumSysName=uxos_vmsumSysName, uxlapb_numOfbusycondet=uxlapb_numOfbusycondet, etheSQEtsterrors=etheSQEtsterrors, tnetb_NTWKPDUunsupportedoption=tnetb_NTWKPDUunsupportedoption, onetwareMaxSimultaneousPhysLocks=onetwareMaxSimultaneousPhysLocks, uxos_vSxt=uxos_vSxt, uxx25_x25InstName=uxx25_x25InstName, uxos_vxInstName=uxos_vxInstName, tnetb_NTWKEntry=tnetb_NTWKEntry, uxos_vSptmap=uxos_vSptmap, elctxsuccess=elctxsuccess, uxos_ratevSyscall=uxos_ratevSyscall, uxos_numOfCpu=uxos_numOfCpu, uxos_vMaxpmem=uxos_vMaxpmem, uxos_vPbuf=uxos_vPbuf, uxos_purges=uxos_purges, uxos_nprocEntry=uxos_nprocEntry, uxos_tFlckrec=uxos_tFlckrec, uxlapb_numOfdataoctsent=uxlapb_numOfdataoctsent, ethetxcollision=ethetxcollision, uxos_queue81=uxos_queue81, uxos_vmcntTable=uxos_vmcntTable, uxos_sumvSwpin=uxos_sumvSwpin, uxos_fileSubAddr=uxos_fileSubAddr, uxos_numOfUfsfreeinode=uxos_numOfUfsfreeinode, uxos_cntvExfod=uxos_cntvExfod, uxos_liopoll=uxos_liopoll, uxos_flckinfoInstName=uxos_flckinfoInstName, uxtp02_tp02SubAddr=uxtp02_tp02SubAddr, uxos_memEntry=uxos_memEntry, uxos_avenrun2=uxos_avenrun2)
mibBuilder.exportSymbols("OLIVETTI-MIB", netbrxsuccesspack=netbrxsuccesspack, uxtp02_numOfzeroingtime=uxtp02_numOfzeroingtime, uxos_cpuSubAddr=uxos_cpuSubAddr, x25Table=x25Table, winlms_sdrmEntry=winlms_sdrmEntry, uxos_vHmask=uxos_vHmask, uxos_longEnter=uxos_longEnter, uxx25_numOfcallunsucfull=uxx25_numOfcallunsucfull, elcrxshframe=elcrxshframe, uxos_shmem=uxos_shmem, uxos_queue31=uxos_queue31, uxos_aiolock=uxos_aiolock, uxos_startOfQueue=uxos_startOfQueue, uxos_smemInstName=uxos_smemInstName, uxx25_numOfregistrece=uxx25_numOfregistrece, netbparamstype=netbparamstype, pblms_systemrmSysName=pblms_systemrmSysName, uxos_numOfProc=uxos_numOfProc, uxos_ovszAlloc=uxos_ovszAlloc, pblms_system=pblms_system, uxos_queue62=uxos_queue62, uxos_ratevPgin=uxos_ratevPgin, uxos_tPadd11=uxos_tPadd11, uxos_vmcntSubAddr=uxos_vmcntSubAddr, uxos_shm_dtch=uxos_shm_dtch, uxos_sumvTrap=uxos_sumvTrap, uxos_ufsfreeinode=uxos_ufsfreeinode, uxos_sumvSeqfree=uxos_sumvSeqfree, uxos_vmtotalInstName=uxos_vmtotalInstName, uxos_queue82=uxos_queue82, uxos_swpocc=uxos_swpocc, uxos_sysSubAddr=uxos_sysSubAddr, tnetb_TRSPtxretranDATATPDU=tnetb_TRSPtxretranDATATPDU, uxos_cntvXifrec=uxos_cntvXifrec, lapbEntry=lapbEntry, ntlms_systemrmSubAddr=ntlms_systemrmSubAddr, uxos_tRq=uxos_tRq, uxos_buffercacheTable=uxos_buffercacheTable, uxos_msg_snd_sleep=uxos_msg_snd_sleep, uxos_vminfoInstName=uxos_vminfoInstName, uxos_rmemTable=uxos_rmemTable, uxos_cpuKernel=uxos_cpuKernel, onetwareMaxVolumes=onetwareMaxVolumes, uxtp02_numOfopenConnection=uxtp02_numOfopenConnection, uxos_cntvVrfod=uxos_cntvVrfod, uxos_phread=uxos_phread, ethetxmaxcollision=ethetxmaxcollision, uxos_rtminfoTable=uxos_rtminfoTable, uxos_buffercacheEntry=uxos_buffercacheEntry, netbmaxpending=netbmaxpending, tnetb_NETBSysName=tnetb_NETBSysName, uxos_tGpgslo=uxos_tGpgslo, tnetb_TRSPopenerror=tnetb_TRSPopenerror, uxos_msg_rcv_sleep=uxos_msg_rcv_sleep, uxos_lruEmpty=uxos_lruEmpty, tnetb_NTWKtxsegmented=tnetb_NTWKtxsegmented, uxos_flckinfoSubAddr=uxos_flckinfoSubAddr, uxos_namei=uxos_namei, uxlapb_numOfrejrece=uxlapb_numOfrejrece, uxos_cpuInstName=uxos_cpuInstName, uxos_cpuTable=uxos_cpuTable, uxos_cpuWait=uxos_cpuWait, uxos_syserrInstName=uxos_syserrInstName, uxos_vFiller=uxos_vFiller, uxos_textovf=uxos_textovf, uxos_getmap=uxos_getmap, uxos_release=uxos_release, uxlmx_svavresponse=uxlmx_svavresponse, uxos_ratevPgfrec=uxos_ratevPgfrec, uxos_smSysName=uxos_smSysName, uxos_tPadd13=uxos_tPadd13, onetwareNumSemaphores=onetwareNumSemaphores, uxos_rmemNumOfPages=uxos_rmemNumOfPages, uxos_shlbovf=uxos_shlbovf, uxos_vminfoEntry=uxos_vminfoEntry, uxos_lgFail=uxos_lgFail, uxlapb_numOfUAnitrece=uxlapb_numOfUAnitrece, uxos_buffercacheSysName=uxos_buffercacheSysName, uxos_sumvZfod=uxos_sumvZfod, uxos_vPfault=uxos_vPfault, uxos_rmemSysName=uxos_rmemSysName, uxlms_systemrmInstName=uxlms_systemrmInstName, uxlmx_svbytessent=uxlmx_svbytessent, uxos_tDw=uxos_tDw, uxos_pfreemiss=uxos_pfreemiss, x25Entry=x25Entry, onetwareBinderyAndMiscRequests=onetwareBinderyAndMiscRequests, uxos_lgMem=uxos_lgMem, onetwareCacheMisses=onetwareCacheMisses, tnetb_TRSPrxTSDU=tnetb_TRSPrxTSDU, tnetb_TRSPunsuccessinconnect=tnetb_TRSPunsuccessinconnect, netb_NBEUI=netb_NBEUI, tnetb_NTWK=tnetb_NTWK, uxx25_numOfresetrece=uxx25_numOfresetrece, uxos_vmtotalSubAddr=uxos_vmtotalSubAddr, uxlapb_numOfInformatype=uxlapb_numOfInformatype, uxos_rmemSubAddr=uxos_rmemSubAddr, uxos_lioinfo=uxos_lioinfo, uxos_shlbs=uxos_shlbs, ntlms_sdrmSubAddr=ntlms_sdrmSubAddr, uxos_tuneTable=uxos_tuneTable, uxos_sysinfo=uxos_sysinfo, uxos_cntvSwpin=uxos_cntvSwpin, uxx25_numOfresetsent=uxx25_numOfresetsent, uxos_lboltSysName=uxos_lboltSysName, uxos_kmemEntry=uxos_kmemEntry, tnetb_TRSPrxdatabyte=tnetb_TRSPrxdatabyte, uxos_msg_get_fail=uxos_msg_get_fail, lms_FilterType=lms_FilterType, netb_NB=netb_NB, uxos_rsin=uxos_rsin, uxlmx_svpwerrors=uxlmx_svpwerrors, uxos_vDfree=uxos_vDfree, uxos_tuneSubAddr=uxos_tuneSubAddr, uxos_freememLeast=uxos_freememLeast, uxos_smemEntry=uxos_smemEntry, uxos_tVm=uxos_tVm, uxos_cntvNexfod=uxos_cntvNexfod, uxlms_sdrm=uxlms_sdrm, uxos_lboltSubAddr=uxos_lboltSubAddr, uxos_var=uxos_var, uxos_shm_atch=uxos_shm_atch, uxos_sumvXifrec=uxos_sumvXifrec, winlms_sdrmSysName=winlms_sdrmSysName, uxos_lock_wr_intr=uxos_lock_wr_intr, uxos_smlAlloc=uxos_smlAlloc, uxos_vmrateSysName=uxos_vmrateSysName, uxos_sspg=uxos_sspg, uxos_cpuSysName=uxos_cpuSysName, uxlmx_svbytesrcvd=uxlmx_svbytesrcvd, uxos_ipcSubAddr=uxos_ipcSubAddr, ethetxdeferred=ethetxdeferred, onetwareNumOpenFiles=onetwareNumOpenFiles, lms_trap=lms_trap, lms_ProductId=lms_ProductId, uxlmx_SRVLMSubAddr=uxlmx_SRVLMSubAddr, uxos_ufsfreeinodeSysName=uxos_ufsfreeinodeSysName, uxos_cpuSxbrk=uxos_cpuSxbrk, uxos_pagecreate=uxos_pagecreate, uxx25_numOfcallrece=uxx25_numOfcallrece, uxx25_numOfregistsent=uxx25_numOfregistsent, onetware_SRVNWEntry=onetware_SRVNWEntry, tnetb_NTWKrxnetworkerror=tnetb_NTWKrxnetworkerror, tnetb_LLCNtxXIDframe=tnetb_LLCNtxXIDframe, uxlmx_wkfcNCBs=uxlmx_wkfcNCBs, uxos_vPhash=uxos_vPhash, uxos_ratevPgout=uxos_ratevPgout, uxos_queue42=uxos_queue42, onetwareNumLogicalLocks=onetwareNumLogicalLocks, onetwareMaxSharedMemoryUsed=onetwareMaxSharedMemoryUsed, uxos_aioinfo=uxos_aioinfo, uxos_sfpg=uxos_sfpg, uxos_cw=uxos_cw, uxos_vmtotalSysName=uxos_vmtotalSysName, uxos_fault=uxos_fault, tnetb_LLCNrxXIDframe=tnetb_LLCNrxXIDframe, uxtp02_numOfctTPDUUnSuccessfullIncoming=uxtp02_numOfctTPDUUnSuccessfullIncoming, uxos_ratevPgpgout=uxos_ratevPgpgout, uxos_vminfoSubAddr=uxos_vminfoSubAddr, elc_ELCTable=elc_ELCTable, elcrxcollision=elcrxcollision, uxos_diskEntry=uxos_diskEntry, uxos_longLook=uxos_longLook, uxos_smemTable=uxos_smemTable, uxlapb_numOfDISCitrece=uxlapb_numOfDISCitrece, uxos_outch=uxos_outch, uxlmx_svpermerrors=uxlmx_svpermerrors, uxos_rawch=uxos_rawch, elcrxCRC=elcrxCRC, onetwareSubAddr=onetwareSubAddr, uxos_queue41=uxos_queue41, uxos_shlbinfoSubAddr=uxos_shlbinfoSubAddr, uxos_vmrateTable=uxos_vmrateTable, uxlapb_numOfinvalidframes=uxlapb_numOfinvalidframes, uxos_kmeminfoSubAddr=uxos_kmeminfoSubAddr, elctxframexceeding=elctxframexceeding, netbmaxdatagram=netbmaxdatagram, uxos_prepfreemiss=uxos_prepfreemiss, uxos_sumvPgfrec=uxos_sumvPgfrec, uxlmx_LM=uxlmx_LM, uxos_smTable=uxos_smTable, tnetb_TRSP=tnetb_TRSP, uxos_freehit=uxos_freehit, uxos_cachehit=uxos_cachehit, tnetb_TRSPreserved4=tnetb_TRSPreserved4, uxos_namecacheTable=uxos_namecacheTable, uxlapb_numOfReserved2=uxlapb_numOfReserved2, tnetb_TRSPnoendpoint=tnetb_TRSPnoendpoint, elctxunderrun=elctxunderrun, onetwareNWProcs=onetwareNWProcs, uxos_segminfo=uxos_segminfo, uxos_ufsfreeinodeEntry=uxos_ufsfreeinodeEntry, uxos_vPgpgout=uxos_vPgpgout, uxos_sumvPgpgin=uxos_sumvPgpgin, ethe_ETHEntry=ethe_ETHEntry, uxos_msg_snd_intr=uxos_msg_snd_intr, uxos_numOfFile=uxos_numOfFile, uxos_freememMost=uxos_freememMost, uxos_freemiss=uxos_freemiss, uxlapb_numOfUAitsent=uxlapb_numOfUAitsent, uxlapb_numOfDMnitrece=uxlapb_numOfDMnitrece, uxos_minfoInstName=uxos_minfoInstName, uxos_rtminfoInstName=uxos_rtminfoInstName, uxx25_numOfdiagnsent=uxx25_numOfdiagnsent, onetwarePeakClientConnUsed=onetwarePeakClientConnUsed, uxx25_numOfdataretrunsucfull=uxx25_numOfdataretrunsucfull, uxos_vSwpin=uxos_vSwpin, uxos_numOtherOp=uxos_numOtherOp, uxos_kmeminfo=uxos_kmeminfo, uxos_cntvSyscall=uxos_cntvSyscall, onetwareLostPacketResends=onetwareLostPacketResends, pb_dos=pb_dos, uxlapb_numOfzerotime=uxlapb_numOfzerotime, uxos_nprocInstName=uxos_nprocInstName, uxlmx_svfopens=uxlmx_svfopens, uxx25_numOfrestunsucfull=uxx25_numOfrestunsucfull, uxlapb_numOfSABMnitrece=uxlapb_numOfSABMnitrece, uxlapb_numOfinforece=uxlapb_numOfinforece, uxos_dirblk=uxos_dirblk, uxos_sysSysName=uxos_sysSysName, uxos_ratevTrap=uxos_ratevTrap, uxos_ratevRev=uxos_ratevRev, uxlapb_numOfrnrrece=uxlapb_numOfrnrrece, uxos_cumulSeekDist=uxos_cumulSeekDist, winlms_sdrm=winlms_sdrm, uxos_rmemInstName=uxos_rmemInstName, uxos_fileInstName=uxos_fileInstName, uxlmx_wkfiNCBs=uxlmx_wkfiNCBs, uxos_major=uxos_major, tnetb_TRSPreserved1=tnetb_TRSPreserved1, uxos_numUnlogErr=uxos_numUnlogErr, uxos_ratevSeqfree=uxos_ratevSeqfree, netbSubAddr=netbSubAddr, tnetb_TRSPreserved6=tnetb_TRSPreserved6, uxlmx_SRVLMEntry=uxlmx_SRVLMEntry, uxos_kmeminfoInstName=uxos_kmeminfoInstName, tnetb_NTWKtxcongested=tnetb_NTWKtxcongested, uxos_pagemissatch=uxos_pagemissatch, elcSysName=elcSysName, uxos_msg_snd_again=uxos_msg_snd_again, uxos_sysread=uxos_sysread, etherxsuccess=etherxsuccess, uxos_tArmtxt=uxos_tArmtxt, uxos_tuneInstName=uxos_tuneInstName, uxos_queue11=uxos_queue11, netbtxFRMR=netbtxFRMR, uxos_sumvPgpgout=uxos_sumvPgpgout, tnetb_LLCNtxXIDresponse=tnetb_LLCNtxXIDresponse, uxlms_systemrmSubAddr=uxlms_systemrmSubAddr, uxos_vmsumInstName=uxos_vmsumInstName, uxx25_numOfzerot=uxx25_numOfzerot, tnetb_NTWKrxPDU=tnetb_NTWKrxPDU, uxos_get_reclaim=uxos_get_reclaim, uxos_msg_rcv_intr=uxos_msg_rcv_intr)
mibBuilder.exportSymbols("OLIVETTI-MIB", uxos_numJobsToDr=uxos_numJobsToDr, uxos_namecacheInstName=uxos_namecacheInstName, uxos_cntvFastpgrec=uxos_cntvFastpgrec, uxos_sumvPgin=uxos_sumvPgin, uxx25_numOflogicalerrors=uxx25_numOflogicalerrors, uxx25_numOfdataretrsucfull=uxx25_numOfdataretrsucfull, tnetb_NTWKtxPDU=tnetb_NTWKtxPDU, uxlmx_svdevopens=uxlmx_svdevopens, uxos_shm_get_fail=uxos_shm_get_fail, uxos_ratevXifrec=uxos_ratevXifrec, uxos_sumvVrfod=uxos_sumvVrfod, etheSubAddr=etheSubAddr, pc_win=pc_win, uxos_cntvZfod=uxos_cntvZfod, uxos_minfoEntry=uxos_minfoEntry, uxos_dblEnters=uxos_dblEnters, uxos_vBufhwm=uxos_vBufhwm, uxx25_numOfrestrece=uxx25_numOfrestrece, uxos_sysInstName=uxos_sysInstName, uxos_maxQueLen=uxos_maxQueLen, uxos_tArm=uxos_tArm, uxos_get_reuse=uxos_get_reuse, netbreleaselevel=netbreleaselevel, uxlapb_numOfSABMnitsent=uxlapb_numOfSABMnitsent, pc_dos=pc_dos, ntlms_nms=ntlms_nms, tnetb_TRSPtxTSDU=tnetb_TRSPtxTSDU, uxos_kmemSysName=uxos_kmemSysName, tnetb_TRSPSysName=tnetb_TRSPSysName, tnetb_NETBtxPDU=tnetb_NETBtxPDU, uxos_phwrite=uxos_phwrite, uxx25_numOfinterunsucfull=uxx25_numOfinterunsucfull, uxos_vxEntry=uxos_vxEntry, onetwarePhysLockRequests=onetwarePhysLockRequests, uxlmx_SRVLMTable=uxlmx_SRVLMTable, uxos_smEntry=uxos_smEntry, uxos_flockEntry=uxos_flockEntry, uxos_ratevZfod=uxos_ratevZfod, uxos_rtminfoEntry=uxos_rtminfoEntry, uxos_ufsfreeinodeInstName=uxos_ufsfreeinodeInstName, uxos_liowait=uxos_liowait, uxos_queue32=uxos_queue32, uxos_ufsinodeovf=uxos_ufsinodeovf, onetwareCreateConnectionRequests=onetwareCreateConnectionRequests, uxos_misses=uxos_misses, tnetb_NETBsuccessregistr=tnetb_NETBsuccessregistr, uxos_tDmalimit=uxos_tDmalimit, uxos_sumvNzfod=uxos_sumvNzfod, netbtxsuccesspack=netbtxsuccesspack, netbconfiguredNCB=netbconfiguredNCB, uxos_vScan=uxos_vScan, tnetb_TRSPsuccessoutconnect=tnetb_TRSPsuccessoutconnect, uxos_cumulUse=uxos_cumulUse, uxos_cpuIdle=uxos_cpuIdle, tnetb_LLCNSysName=tnetb_LLCNSysName, uxos_rel_write=uxos_rel_write, uxos_vmcnt=uxos_vmcnt, tnetb_TRSPreserved2=tnetb_TRSPreserved2, pblms_systemrmEntry=pblms_systemrmEntry, elcrxnobuffer=elcrxnobuffer, uxos_queue52=uxos_queue52, uxos_shlbinfoInstName=uxos_shlbinfoInstName, netbpendingsession=netbpendingsession, uxos_reccnt=uxos_reccnt, uxos_shm_cntl=uxos_shm_cntl, tnetb_NETBunsuccessderegistr=tnetb_NETBunsuccessderegistr, uxos_sem_op_sleep=uxos_sem_op_sleep, uxtp02_numOfctTPDUUnSuccessfullOutgoing=uxtp02_numOfctTPDUUnSuccessfullOutgoing, uxos_numRW=uxos_numRW, uxos_vSftlock=uxos_vSftlock, uxos_ratevPgpgin=uxos_ratevPgpgin, netbconfiguredpending=netbconfiguredpending, tnetb_NETBunresolutednames=tnetb_NETBunresolutednames, winlms_systemrmEntry=winlms_systemrmEntry, uxos_lread=uxos_lread, uxos_minor=uxos_minor, netbSysName=netbSysName, uxos_xmtint=uxos_xmtint, uxos_vmsum=uxos_vmsum, uxos_lioSysName=uxos_lioSysName, uxos_flckinfoEntry=uxos_flckinfoEntry, uxlapb_numOfDMnitsent=uxlapb_numOfDMnitsent, uxos_cache=uxos_cache, uxos_vminfoTable=uxos_vminfoTable, tnetb_NTWKreassemblytimeout=tnetb_NTWKreassemblytimeout, uxos_bread=uxos_bread, uxos_lbolt=uxos_lbolt, uxos_ratevVrfod=uxos_ratevVrfod, uxos_totNumRead=uxos_totNumRead, uxos_ipcEntry=uxos_ipcEntry, ethetxsuccess=ethetxsuccess, uxos_cntvPgrec=uxos_cntvPgrec, uxos_faulta=uxos_faulta, elcSubAddr=elcSubAddr, onetwareSemaphoreRequests=onetwareSemaphoreRequests, uxos_cumulQueLen=uxos_cumulQueLen, uxos_wSwap=uxos_wSwap, uxos_msg_rcv_fail=uxos_msg_rcv_fail, uxos_queue91=uxos_queue91, uxos_sumvPdma=uxos_sumvPdma, tnetb_TRSPreserved5=tnetb_TRSPreserved5, pblms_systemrmSubAddr=pblms_systemrmSubAddr, netbtxaborted=netbtxaborted, uxos_cntvFaults=uxos_cntvFaults, uxos_flockTable=uxos_flockTable, uxos_shlbinfoSysName=uxos_shlbinfoSysName, uxos_physmem=uxos_physmem, tnetb_NTWKtxnetworkerror=tnetb_NTWKtxnetworkerror, uxos_queue92=uxos_queue92, ethe_ETHTable=ethe_ETHTable, uxos_cntvRev=uxos_cntvRev, netbTiexpired=netbTiexpired, onetwareReadRequests=onetwareReadRequests, uxlapb_numOfSABMitrece=uxlapb_numOfSABMitrece, uxos_freedpgs=uxos_freedpgs, wan=wan, uxos_sysexec=uxos_sysexec, tnetb_LLCNtxTESTframe=tnetb_LLCNtxTESTframe, uxos_iget=uxos_iget, uxos_vmsumTable=uxos_vmsumTable, tnetb_TRSPrxTPDU=tnetb_TRSPrxTPDU, uxos_msg=uxos_msg, uxos_rel_abort=uxos_rel_abort, uxos_bootSysName=uxos_bootSysName, uxos_cpu=uxos_cpu, netbtxIframeserr=netbtxIframeserr, uxlapb_numOfReserved4=uxlapb_numOfReserved4, uxos_availrmem=uxos_availrmem, uxos_vSwpout=uxos_vSwpout, uxos_rmemEntry=uxos_rmemEntry, ntlms_sdrm=ntlms_sdrm, uxos_tuneEntry=uxos_tuneEntry, uxtp02_numOfnumberTPDUReceived=uxtp02_numOfnumberTPDUReceived, uxos_cntvPswpin=uxos_cntvPswpin, uxlmx_wkautorec=uxlmx_wkautorec, uxos_sumvNvrfod=uxos_sumvNvrfod, netbrxFRMR=netbrxFRMR, uxos_namecacheSubAddr=uxos_namecacheSubAddr, uxlapb_lapbSubAddr=uxlapb_lapbSubAddr, uxos_fileEntry=uxos_fileEntry, tnetb_TRSPsuppconnection=tnetb_TRSPsuppconnection, uxos_runque=uxos_runque, uxos_queue21=uxos_queue21, uxos_vmcntSysName=uxos_vmcntSysName, uxlms_sdrmTable=uxlms_sdrmTable, uxos_ratevIntr=uxos_ratevIntr, uxos_drivePerf=uxos_drivePerf, uxos_bbusy=uxos_bbusy, uxos_buffercacheInstName=uxos_buffercacheInstName, ntlms_sdrmSysName=ntlms_sdrmSysName, uxx25_numOfclearrece=uxx25_numOfclearrece, uxos_vmcntEntry=uxos_vmcntEntry, uxos_core=uxos_core, uxos_vminfo=uxos_vminfo, uxos_vAutoup=uxos_vAutoup, uxos_memSubAddr=uxos_memSubAddr, uxos_namecache=uxos_namecache, uxos_ovszFail=uxos_ovszFail, uxos_ratevScan=uxos_ratevScan, uxos_bootTime=uxos_bootTime, elctxbytesuccess=elctxbytesuccess, uxos_kmemNumOfPages=uxos_kmemNumOfPages, uxx25_numOfcallsent=uxx25_numOfcallsent, uxos_msg_rcv=uxos_msg_rcv, onetwareMaxClientConnSupported=onetwareMaxClientConnSupported, uxx25_numOfclearunsucfull=uxx25_numOfclearunsucfull, uxos_vxSysName=uxos_vxSysName, winlms_systemrm=winlms_systemrm, uxos_syserrTable=uxos_syserrTable, uxos_vmsumEntry=uxos_vmsumEntry, uxos_vxinodeovf=uxos_vxinodeovf, uxos_vmrateSubAddr=uxos_vmrateSubAddr, uxos_tVmtxt=uxos_tVmtxt, tnetb_NTWKPDUdestinunreach=tnetb_NTWKPDUdestinunreach, uxos_demand=uxos_demand, etheInstName=etheInstName, tnetb_NETBunsuccessregistr=tnetb_NETBunsuccessregistr, tnetb_TRSPtxretranTPDU=tnetb_TRSPtxretranTPDU, tnetb_LLCNrxTESTframe=tnetb_LLCNrxTESTframe, uxos_syswrite=uxos_syswrite, ntlms_systemrmInstName=ntlms_systemrmInstName, tnetb_NETBEntry=tnetb_NETBEntry, netbInstName=netbInstName, uxos_aiowrite=uxos_aiowrite, lms_RecCode=lms_RecCode, uxos_vPgout=uxos_vPgout, onetwareSysName=onetwareSysName, uxos_memInstName=uxos_memInstName, uxx25_numOfresetunsucfull=uxx25_numOfresetunsucfull, uxlms_sdrmSysName=uxlms_sdrmSysName, ntlms_systemrm=ntlms_systemrm, uxos_syscall=uxos_syscall, uxos_tNotused=uxos_tNotused, uxos_minfo=uxos_minfo, uxlapb_lapbSysName=uxlapb_lapbSysName, onetwareUnknownRequests=onetwareUnknownRequests, uxos_kmeminfoTable=uxos_kmeminfoTable, uxos_tGpgshi=uxos_tGpgshi, uxos_cntvDfree=uxos_cntvDfree, uxos_lock_wr_again=uxos_lock_wr_again, uxos_tPadd=uxos_tPadd, tnetb_LLCNrxMACerror=tnetb_LLCNrxMACerror, uxos_pswapout=uxos_pswapout, uxos_vMaxsyspri=uxos_vMaxsyspri, tp02Table=tp02Table, winlms_sdrmInstName=winlms_sdrmInstName, uxos_sumvSwtch=uxos_sumvSwtch, uxx25_numOfrejretries=uxx25_numOfrejretries, uxos_buffercacheSubAddr=uxos_buffercacheSubAddr, uxtp02_numOfdetectedTPDUProtocolError=uxtp02_numOfdetectedTPDUProtocolError, uxos_msg_get=uxos_msg_get, uxos_diskTable=uxos_diskTable, uxos_rsout=uxos_rsout, etherxshframe=etherxshframe, uxos_cntvSwpout=uxos_cntvSwpout, uxos_queue02=uxos_queue02, elc_ELCEntry=elc_ELCEntry, uxlapb_numOfretrframes=uxlapb_numOfretrframes, etherxcollision=etherxcollision, uxos_flockSysName=uxos_flockSysName, winlms_nms=winlms_nms, uxlapb_numOfReserved1=uxlapb_numOfReserved1, uxos_vmtotal=uxos_vmtotal, uxos_avenrunSubAddr=uxos_avenrunSubAddr, uxos_minfoSysName=uxos_minfoSysName, lms_GenerationDate=lms_GenerationDate, uxtp02_numOfctTPDUConfProtErrorDetected=uxtp02_numOfctTPDUConfProtErrorDetected, tnetb_NTWKTable=tnetb_NTWKTable, uxos_queue12=uxos_queue12, uxos_sumvfault=uxos_sumvfault, lmsSystemName=lmsSystemName, uxx25_numOfrnrxsent=uxx25_numOfrnrxsent, uxos_ratevExfod=uxos_ratevExfod, uxlmx_svstimedout=uxlmx_svstimedout, lms_SubClass=lms_SubClass, uxos_totNumWrite=uxos_totNumWrite, elcSQEtsterrors=elcSQEtsterrors, etheSysName=etheSysName, onetwareMaxSimultaneousOpens=onetwareMaxSimultaneousOpens, uxlms_sdrmInstName=uxlms_sdrmInstName, etherxoverrun=etherxoverrun, uxlmx_svsyserrors=uxlmx_svsyserrors, uxos_diskSubAddr=uxos_diskSubAddr, uxos_fileTable=uxos_fileTable, uxos_vxipage=uxos_vxipage, uxos_ratevXsfrec=uxos_ratevXsfrec, netbadaptertype=netbadaptertype, uxlmx_SRVLM=uxlmx_SRVLM, uxos_queue61=uxos_queue61, ntlms_sdrmEntry=ntlms_sdrmEntry, uxos_lboltEntry=uxos_lboltEntry, uxos_cntvScan=uxos_cntvScan, uxos_tPadd12=uxos_tPadd12, uxos_vVfault=uxos_vVfault)
mibBuilder.exportSymbols("OLIVETTI-MIB", uxlapb_numOfUAitrece=uxlapb_numOfUAitrece, uxos_get_use=uxos_get_use, tnetb_NETBTable=tnetb_NETBTable, uxos_aiomsb=uxos_aiomsb, tnetb_NETBrxinvalidPDU=tnetb_NETBrxinvalidPDU, elcInstName=elcInstName, ntlms_sdrmInstName=ntlms_sdrmInstName, uxos_sem_get_fail=uxos_sem_get_fail, onetwareFileLockRequests=onetwareFileLockRequests, uxos_vMaxup=uxos_vMaxup, uxos_sysfork=uxos_sysfork, onetwareMaxSimultaneousSemaphores=onetwareMaxSimultaneousSemaphores)
