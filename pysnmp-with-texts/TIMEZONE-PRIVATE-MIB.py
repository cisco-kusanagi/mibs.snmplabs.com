...
# Produced by pysmi-0.3.4 at Wed May  1 15:23:39 2019
...
Unsigned32, MibIdentifier, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Gauge32, ObjectIdentity, Counter32, ModuleIdentity, NotificationType, IpAddress, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Gauge32", "ObjectIdentity", "Counter32", "ModuleIdentity", "NotificationType", "IpAddress", "Bits")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: timeZonePrivate.setRevisionsDescriptions(('Postal address updated.', 'Initial revision.',))
...
if mibBuilder.loadTexts: timeZonePrivate.setContactInfo(' Customer Support Postal: Quanta Computer Inc. 4, Wen Ming 1 St., Kuei Shan Hsiang, Tao Yuan Shien, Taiwan, R.O.C. Tel: +886 3 328 0050 E-Mail: strong.chen@quantatw.com')
if mibBuilder.loadTexts: timeZonePrivate.setDescription('The QUANTA Private MIB for system time, timezone and summer-time settings')
...
mibBuilder.exportSymbols("TIMEZONE-PRIVATE-MIB", agentSystemSummerTimeState=agentSystemSummerTimeState, agentTimeZoneAcronym=agentTimeZoneAcronym, agentTimeZoneGroup=agentTimeZoneGroup, agentStNonRecurringZoneOffset=agentStNonRecurringZoneOffset, agentStNonRecurringEndingTime=agentStNonRecurringEndingTime, agentStRecurringEndingWeek=agentStRecurringEndingWeek, agentStNonRecurringStartingMonth=agentStNonRecurringStartingMonth, agentStRecurringStartingMonth=agentStRecurringStartingMonth, agentSystemTime=agentSystemTime, agentTimeZoneMinutesOffset=agentTimeZoneMinutesOffset, PYSNMP_MODULE_ID=timeZonePrivate, agentStNonRecurringStartingYear=agentStNonRecurringStartingYear, agentStNonRecurringEndingDay=agentStNonRecurringEndingDay, agentSystemTimeZoneAcronym=agentSystemTimeZoneAcronym, agentStNonRecurringZoneAcronym=agentStNonRecurringZoneAcronym, agentStRecurringEndingTime=agentStRecurringEndingTime, agentStRecurringStartingDay=agentStRecurringStartingDay, agentSummerTimeRecurringGroup=agentSummerTimeRecurringGroup, agentStRecurringEndingMonth=agentStRecurringEndingMonth, agentStRecurringEndingDay=agentStRecurringEndingDay, agentStNonRecurringEndingMonth=agentStNonRecurringEndingMonth, agentStRecurringZoneOffset=agentStRecurringZoneOffset, agentSystemTimeGroup=agentSystemTimeGroup, agentSystemTimeSource=agentSystemTimeSource, agentStRecurringStartingWeek=agentStRecurringStartingWeek, agentStNonRecurringStartingDay=agentStNonRecurringStartingDay, agentTimeZoneHoursOffset=agentTimeZoneHoursOffset, agentSystemDate=agentSystemDate, agentSummerTimeMode=agentSummerTimeMode, agentStRecurringZoneAcronym=agentStRecurringZoneAcronym, agentStNonRecurringEndingYear=agentStNonRecurringEndingYear, timeZonePrivate=timeZonePrivate, agentSummerTimeNonRecurringGroup=agentSummerTimeNonRecurringGroup, agentSummerTimeGroup=agentSummerTimeGroup, agentStNonRecurringStartingTime=agentStNonRecurringStartingTime, agentStRecurringStartingTime=agentStRecurringStartingTime)
