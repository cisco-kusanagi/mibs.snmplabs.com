...
# Produced by pysmi-0.3.4 at Wed May  1 13:51:30 2019
...
Gauge32, Integer32, ModuleIdentity, MibIdentifier, enterprises, ObjectIdentity, TimeTicks, Counter32, Counter64, NotificationType, IpAddress, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Bits, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "ModuleIdentity", "MibIdentifier", "enterprises", "ObjectIdentity", "TimeTicks", "Counter32", "Counter64", "NotificationType", "IpAddress", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Bits", "iso")
...
if mibBuilder.loadTexts: esconPortControlUnitLinkAddress.setDescription('This address identifies the ESCON Director port to which the optical fiber from the ESCON device is attached.')
...
if mibBuilder.loadTexts: esconLinkEntry.setDescription('Table of objects that describe an ESCON channel link. This table is indexed by ifIndex from MIB-II, by host link address, and by (host) partition number.')
...
if mibBuilder.loadTexts: esconStationEntry.setDescription('Table of objects that describe an ESCON channel station. This table is indexed by ifIndex from MIB-II, by host link address, by (host) partition number, and by ESCON device address.')
...
mibBuilder.exportSymbols("IBMESCON-MIB", esconLinkStatus=esconLinkStatus, esconPortControlUnitLinkAddress=esconPortControlUnitLinkAddress, esconStationTotalFramesSent=esconStationTotalFramesSent, esconStationPositiveAckDataPackets=esconStationPositiveAckDataPackets, esconStationUnitSize=esconStationUnitSize, esconMibGroups=esconMibGroups, esconPortGroup=esconPortGroup, esconLinkTable=esconLinkTable, esconStationMaxBfru=esconStationMaxBfru, esconStationHostLinkAddress=esconStationHostLinkAddress, esconConformance=esconConformance, esconLinkHostLinkAddress=esconLinkHostLinkAddress, esconStationMaxMsgSizeSent=esconStationMaxMsgSizeSent, esconMibCompliance=esconMibCompliance, esconStationDataPacketsRetransmitted=esconStationDataPacketsRetransmitted, esconStationPartitionNumber=esconStationPartitionNumber, esconStationTable=esconStationTable, esconPortEntry=esconPortEntry, esconLinkGroup=esconLinkGroup, esconStationGroup=esconStationGroup, esconStationMaxMsgSizeReceived=esconStationMaxMsgSizeReceived, esconStationDataPacketsSent=esconStationDataPacketsSent, ibm=ibm, esconMibCompliances=esconMibCompliances, esconLinkEntry=esconLinkEntry, ibmESCON=ibmESCON, esconStationDataPacketsOkReceived=esconStationDataPacketsOkReceived, esconStationAttentionDelay=esconStationAttentionDelay, esconPortTable=esconPortTable, esconStationSecondChanceAttentions=esconStationSecondChanceAttentions, esconStationCommandsRetried=esconStationCommandsRetried, esconPortData=esconPortData, esconPortInFiberStatus=esconPortInFiberStatus, esconStationDataPacketsKoReceived=esconStationDataPacketsKoReceived, esconStationData=esconStationData, esconLinkPartitionNumber=esconLinkPartitionNumber, esconLinkData=esconLinkData, esconStationEntry=esconStationEntry, esconStationState=esconStationState, esconStationDeviceAddress=esconStationDeviceAddress, ibmArchitecture=ibmArchitecture, esconStationAttentionTimeOut=esconStationAttentionTimeOut, esconPortOutFiberStatus=esconPortOutFiberStatus)
