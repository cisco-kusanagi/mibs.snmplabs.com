...
# Produced by pysmi-0.3.4 at Wed May  1 12:22:56 2019
...
lldpRemTimeMark, lldpRemIndex, lldpRemLocalPortNum, LldpManAddress, LldpPortNumber, LldpPortList = mibBuilder.importSymbols("LLDP-MIB", "lldpRemTimeMark", "lldpRemIndex", "lldpRemLocalPortNum", "LldpManAddress", "LldpPortNumber", "LldpPortList")
PortList, = mibBuilder.importSymbols("Q-BRIDGE-MIB", "PortList")
ObjectGroup, ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ObjectGroup", "ModuleCompliance", "NotificationGroup")
Bits, Counter64, Counter32, IpAddress, ModuleIdentity, NotificationType, iso, MibIdentifier, ObjectIdentity, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Counter32", "IpAddress", "ModuleIdentity", "NotificationType", "iso", "MibIdentifier", "ObjectIdentity", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks")
...
if mibBuilder.loadTexts: rlLldp.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
mibBuilder.exportSymbols("CISCOSB-LLDP-MIB", rlLldpAutoAdvManAddrOwnerIfId=rlLldpAutoAdvManAddrOwnerIfId, rlLldpXMedLocMediaPolicyContainerRowStatus=rlLldpXMedLocMediaPolicyContainerRowStatus, rlLldpEnabled=rlLldpEnabled, rlLldpRemTtl=rlLldpRemTtl, rlLldpAutoAdvPortsStatus=rlLldpAutoAdvPortsStatus, PYSNMP_MODULE_ID=rlLldp, rlLldpClearRx=rlLldpClearRx, rlLldpDuMode=rlLldpDuMode, rlLldpTxOverloadingPortNum=rlLldpTxOverloadingPortNum, rlLldpRemTtlEntry=rlLldpRemTtlEntry, rlLldpXMedLocMediaPolicyContainerTable=rlLldpXMedLocMediaPolicyContainerTable, rlLldpTLVsTxOverloadingSizeEntry=rlLldpTLVsTxOverloadingSizeEntry, rlLldpXMedLocMediaPolicyContainerVlanID=rlLldpXMedLocMediaPolicyContainerVlanID, rlLldpTLVsTxOverloadingStateEnterTrap=rlLldpTLVsTxOverloadingStateEnterTrap, rlLldpXMedLocMediaPolicyContainerIndex=rlLldpXMedLocMediaPolicyContainerIndex, rlLldpXMedConfig=rlLldpXMedConfig, rlLldpTLVsTxOverloadingPorts=rlLldpTLVsTxOverloadingPorts, rlLldp=rlLldp, PolicyNumber=PolicyNumber, rlLldpAutoAdvLocPortManAddrEntry=rlLldpAutoAdvLocPortManAddrEntry, rlLldpAutoAdvManAddrSubtype=rlLldpAutoAdvManAddrSubtype, rlLldpTLVsTxSize=rlLldpTLVsTxSize, PolicyAppVoiceUpdateMode=PolicyAppVoiceUpdateMode, rlLldpConfig=rlLldpConfig, rlLldpTLVsTxOverloadingTable=rlLldpTLVsTxOverloadingTable, rlLldpTLVsTxOverloading=rlLldpTLVsTxOverloading, rlLldpTLVsTxLeftSize=rlLldpTLVsTxLeftSize, rlLldpTotalTLVsTxSize=rlLldpTotalTLVsTxSize, rlLldpLeftTLVsTxSize=rlLldpLeftTLVsTxSize, rlLldpXMedNetPolVoiceUpdateMode=rlLldpXMedNetPolVoiceUpdateMode, rlLldpXMedLocMediaPolicyContainerTagged=rlLldpXMedLocMediaPolicyContainerTagged, rlLldpAutoAdvManAddrNone=rlLldpAutoAdvManAddrNone, PolicyContainerAppType=PolicyContainerAppType, rlLldpXMedLocMediaPolicyContainerUnknown=rlLldpXMedLocMediaPolicyContainerUnknown, rlLldpXMedLocMediaPolicyContainerDscp=rlLldpXMedLocMediaPolicyContainerDscp, rlLldpTLVsTxOverloadingSizeTable=rlLldpTLVsTxOverloadingSizeTable, rlLldpAutoAdvLocPortManAddrTable=rlLldpAutoAdvLocPortManAddrTable, rlLldpXMedLocMediaPolicyContainerAppType=rlLldpXMedLocMediaPolicyContainerAppType, rlLldpXMedLocMediaPolicyContainerPorts=rlLldpXMedLocMediaPolicyContainerPorts, rlLldpTxOverloadingIndex=rlLldpTxOverloadingIndex, rlLldpAutoAdvLocPortNum=rlLldpAutoAdvLocPortNum, rlLldpRemTtlTable=rlLldpRemTtlTable, rlLldpTLVsTxOverloadingEntry=rlLldpTLVsTxOverloadingEntry, rlLldpXMedLocMediaPolicyContainerPriority=rlLldpXMedLocMediaPolicyContainerPriority, rlLldpTxOverloadingGroupId=rlLldpTxOverloadingGroupId, rlLldpObjects=rlLldpObjects, rlLldpXMedLocMediaPolicyContainerEntry=rlLldpXMedLocMediaPolicyContainerEntry, rlLldpTLVsTxGroupOverloading=rlLldpTLVsTxGroupOverloading, rlLldpTLVsTxOverloadingStateExitTrap=rlLldpTLVsTxOverloadingStateExitTrap, rlLldpChassisIdSubtype=rlLldpChassisIdSubtype, rlLldpAutoAdvManAddr=rlLldpAutoAdvManAddr)
