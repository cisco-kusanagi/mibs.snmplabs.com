...
Integer32, MibIdentifier, Unsigned32, Counter32, ModuleIdentity, IpAddress, TimeTicks, Bits, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, ObjectIdentity, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibIdentifier", "Unsigned32", "Counter32", "ModuleIdentity", "IpAddress", "TimeTicks", "Bits", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "ObjectIdentity", "Gauge32")
DisplayString, TextualConvention = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention")
snL4 = ModuleIdentity((1, 3, 6, 1, 4, 1, 1991, 1, 1, 4))
snL4.setRevisions(('2010-06-02 00:00', '2009-09-30 00:00',))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: snL4.setRevisionsDescriptions(('Changed the ORGANIZATION, CONTACT-INFO and DESCRIPTION fields.', 'convert from SMIv1 to SMIv2',))
...
if mibBuilder.loadTexts: snL4.setContactInfo('Technical Support Center 130 Holger Way, San Jose, CA 95134 Email: ipsupport@brocade.com Phone: 1-800-752-8061 URL: www.brocade.com')
if mibBuilder.loadTexts: snL4.setDescription("Copyright 1996-2010 Brocade Communications Systems, Inc. All rights reserved. This Brocade Communications Systems SNMP Management Information Base Specification embodies Brocade Communications Systems' confidential and proprietary intellectual property. Brocade Communications Systems retains all title and ownership in the Specification, including any revisions. This Specification is supplied AS IS, and Brocade Communications Systems makes no warranty, either express or implied, as to the use, operation, condition, or performance of the specification, and any unintended consequence it may on the user environment.")
class L4RowSts(TextualConvention, Integer32):
    description = ' Row Creation/Deletion Values '
    status = 'current'
...
if mibBuilder.loadTexts: snL4TrapLinkName.setDescription('Link name.')
...
if mibBuilder.loadTexts: snL4LinkVirtualInterface.setDescription('Link virtual interface.')
...
mibBuilder.exportSymbols("FOUNDRY-SN-SW-L4-SWITCH-GROUP-MIB", snL4RealServerPortHistoryControlBucketsRequested=snL4RealServerPortHistoryControlBucketsRequested, snL4VirtualServerStatisticReceiveBytes=snL4VirtualServerStatisticReceiveBytes, snL4EnableGslbHealthCheckIpPortDownTrap=snL4EnableGslbHealthCheckIpPortDownTrap, snL4RealServerWeight=snL4RealServerWeight, snL4VirtualServerStatusTotalConnections=snL4VirtualServerStatusTotalConnections, snL4VirtualServerStatusIndex=snL4VirtualServerStatusIndex, snL4VirtualServerHistoryControlTable=snL4VirtualServerHistoryControlTable, snL4BindTable=snL4BindTable, snL4VirtualServerHistoryReceivePkts=snL4VirtualServerHistoryReceivePkts, snL4Active=snL4Active, snL4Backup=snL4Backup, snL4RealServerPortDeleteState=snL4RealServerPortDeleteState, snL4RealServerDeleteState=snL4RealServerDeleteState, snL4VirtualServerStatisticTable=snL4VirtualServerStatisticTable, snL4VirtualServerHistoryControlEntry=snL4VirtualServerHistoryControlEntry, snL4WebCacheEntry=snL4WebCacheEntry, snL4RealServerCfgName=snL4RealServerCfgName, snL4BecomeActive=snL4BecomeActive, snL4WebCachePortAdminStatus=snL4WebCachePortAdminStatus, snL4WebCacheName=snL4WebCacheName, snL4PolicyPortAccess=snL4PolicyPortAccess, snL4RealServerTable=snL4RealServerTable, snL4RealServerCfgTable=snL4RealServerCfgTable, snL4RealServerStatusIndex=snL4RealServerStatusIndex, snL4EnableBecomeActiveTrap=snL4EnableBecomeActiveTrap, snL4slbDangling=snL4slbDangling, snL4RealServerPortHistoryTransmitPkts=snL4RealServerPortHistoryTransmitPkts, snL4WebCacheGroupName=snL4WebCacheGroupName, snL4RealServerStatistic=snL4RealServerStatistic, snL4EnableGslbHealthCheckIpPortUpTrap=snL4EnableGslbHealthCheckIpPortUpTrap, snL4RealServerCfg=snL4RealServerCfg, snL4WebCacheGroupSrcMask=snL4WebCacheGroupSrcMask, snL4VirtualServerStatisticEntry=snL4VirtualServerStatisticEntry, snL4VirtualServerCfgRowStatus=snL4VirtualServerCfgRowStatus, snL4GslbSiteRemoteServerIronPreference=snL4GslbSiteRemoteServerIronPreference, snL4RealServerPortCfg=snL4RealServerPortCfg, snL4VirtualServerPortCfgServerName=snL4VirtualServerPortCfgServerName, snL4RealServerHistoryControlIndex=snL4RealServerHistoryControlIndex, snL4slbDisableCount=snL4slbDisableCount, snL4RealServerPortStatisticFailTime=snL4RealServerPortStatisticFailTime, snL4RealServerPortStatus=snL4RealServerPortStatus, snL4History=snL4History, snL4VirtualServerIndex=snL4VirtualServerIndex, snL4FreeSessionCount=snL4FreeSessionCount, snL4PolicyProtocol=snL4PolicyProtocol, snL4Policy=snL4Policy, snL4RealServerPortHistoryControlInterval=snL4RealServerPortHistoryControlInterval, snL4unsuccessfulConn=snL4unsuccessfulConn, snL4VirtualServerPortHistorySampleIndex=snL4VirtualServerPortHistorySampleIndex, snL4EnableGslbRemoteSiDownTrap=snL4EnableGslbRemoteSiDownTrap, snL4EnableGslbRemoteSiUpTrap=snL4EnableGslbRemoteSiUpTrap, snL4VirtualServerCfgAdminStatus=snL4VirtualServerCfgAdminStatus, snL4RealServerStatusTotalConnections=snL4RealServerStatusTotalConnections, snL4RealServerPortCfgDeleteState=snL4RealServerPortCfgDeleteState, snL4VirtualServerPortHistoryControlInterval=snL4VirtualServerPortHistoryControlInterval, snL4VirtualServerPortCfgDeleteState=snL4VirtualServerPortCfgDeleteState, snL4TrapLinkName=snL4TrapLinkName, snL4VirtualServerHistoryTable=snL4VirtualServerHistoryTable, snL4VirtualServerHistoryControlBucketsRequested=snL4VirtualServerHistoryControlBucketsRequested, snL4EnableGslbHealthCheckIpUpTrap=snL4EnableGslbHealthCheckIpUpTrap, WebCacheState=WebCacheState, snL4Bind=snL4Bind, snL4=snL4, snL4VirtualServerPortStatisticPeakConnection=snL4VirtualServerPortStatisticPeakConnection, snL4WebCachePortTable=snL4WebCachePortTable, snL4VirtualServerStatistic=snL4VirtualServerStatistic, snL4VirtualServerHistoryControlBucketsGranted=snL4VirtualServerHistoryControlBucketsGranted, snL4RealServerStatusTable=snL4RealServerStatusTable, snL4VirtualServerCfgDeleteState=snL4VirtualServerCfgDeleteState, snL4VirtualServerName=snL4VirtualServerName, snL4RealServerHistoryControlInterval=snL4RealServerHistoryControlInterval, snL4RealServerHistoryTotalConnections=snL4RealServerHistoryTotalConnections, snL4RealServerPortCfgPort=snL4RealServerPortCfgPort, snL4VirtualServerRowStatus=snL4VirtualServerRowStatus, snL4RealServerCfgAdminStatus=snL4RealServerCfgAdminStatus, snL4WebCacheDeleteState=snL4WebCacheDeleteState, snL4RealServerPortHistoryTotalConnections=snL4RealServerPortHistoryTotalConnections, snL4RealServerHistorySampleIndex=snL4RealServerHistorySampleIndex, snL4RealServerPortCfgServerName=snL4RealServerPortCfgServerName, snL4WebCacheTrafficStats=snL4WebCacheTrafficStats, snL4MaxSessionLimit=snL4MaxSessionLimit, snL4VirtualServerPortAdminStatus=snL4VirtualServerPortAdminStatus, snL4VirtualServerPortStatisticTable=snL4VirtualServerPortStatisticTable, snL4WebCacheTrafficPort=snL4WebCacheTrafficPort, snL4TcpSynLimit=snL4TcpSynLimit, snL4RealServerPortStatisticRxPkts=snL4RealServerPortStatisticRxPkts, snL4RealServerStatisticTotalConnections=snL4RealServerStatisticTotalConnections, snL4RealServerPortStatisticIP=snL4RealServerPortStatisticIP, snL4WebCacheRxOctets=snL4WebCacheRxOctets, snL4BackupState=snL4BackupState, snL4VirtualServerPortHistoryIntervalStart=snL4VirtualServerPortHistoryIntervalStart, snL4TrapRealServerIP=snL4TrapRealServerIP, snL4WebCachePortDeleteState=snL4WebCachePortDeleteState, snL4RealServerPortStatisticCurrentConnection=snL4RealServerPortStatisticCurrentConnection, snL4WebUncachedTrafficStatsTable=snL4WebUncachedTrafficStatsTable, snL4BindIndex=snL4BindIndex, snL4slbDrops=snL4slbDrops, snL4VirtualServerStatisticSymmetricActivates=snL4VirtualServerStatisticSymmetricActivates, snL4RealServerHistoryControlDataSource=snL4RealServerHistoryControlDataSource, snL4VirtualServerPortStatisticIP=snL4VirtualServerPortStatisticIP, snL4RealServerPortHistoryTable=snL4RealServerPortHistoryTable, snL4VirtualServerPortStatisticCurrentConnection=snL4VirtualServerPortStatisticCurrentConnection, snL4PolicyPortAccessRowStatus=snL4PolicyPortAccessRowStatus, snL4RealServerPortHistorySampleIndex=snL4RealServerPortHistorySampleIndex, snL4WebUncachedRxOctets=snL4WebUncachedRxOctets, snL4RealServerHistoryReceivePkts=snL4RealServerHistoryReceivePkts, snL4WebCacheTrafficStatsEntry=snL4WebCacheTrafficStatsEntry, snL4RealServerPortHistoryPeakConnections=snL4RealServerPortHistoryPeakConnections, snL4RealServerHistoryIndex=snL4RealServerHistoryIndex, snL4VirtualServerPortHistoryCurConnections=snL4VirtualServerPortHistoryCurConnections, snL4RealServerPortHistoryIndex=snL4RealServerPortHistoryIndex, snL4RealServerIP=snL4RealServerIP, snL4RealServerStatusPeakConnections=snL4RealServerStatusPeakConnections, snL4RealServerStatusState=snL4RealServerStatusState, snL4VirtualServerStatisticName=snL4VirtualServerStatisticName, snL4RealServerPortStatusReassignCount=snL4RealServerPortStatusReassignCount, snL4VirtualServerHistoryEntry=snL4VirtualServerHistoryEntry, snL4VirtualServerHistoryControlOwner=snL4VirtualServerHistoryControlOwner, L4DeleteState=L4DeleteState, snL4RealServerStatusName=snL4RealServerStatusName, snL4WebCacheGroupAdminStatus=snL4WebCacheGroupAdminStatus, snL4RealServerStatusAge=snL4RealServerStatusAge, snL4WebServerPortName=snL4WebServerPortName, snL4VirtualServerPortHistoryPeakConnections=snL4VirtualServerPortHistoryPeakConnections, snL4RealServerHistoryPeakConnections=snL4RealServerHistoryPeakConnections, snL4VirtualServerPortHistoryReceivePkts=snL4VirtualServerPortHistoryReceivePkts, snL4PolicyId=snL4PolicyId, snL4VirtualServerPortTable=snL4VirtualServerPortTable, snL4VirtualServerHistoryTotalConnections=snL4VirtualServerHistoryTotalConnections, snL4GslbSiteRemoteServerIronIP=snL4GslbSiteRemoteServerIronIP, snL4VirtualServerHistoryPeakConnections=snL4VirtualServerHistoryPeakConnections, snL4RealServerPortStatisticState=snL4RealServerPortStatisticState, snL4WebCacheGroupId=snL4WebCacheGroupId, snL4VirtualServerPortHistoryEntry=snL4VirtualServerPortHistoryEntry, snL4RealServerStatusReassignments=snL4RealServerStatusReassignments, snL4RealServerPortStatusCurrentConnection=snL4RealServerPortStatusCurrentConnection, snL4RealServerStatusReassignmentLimit=snL4RealServerStatusReassignmentLimit, snL4WebCacheCurrConnections=snL4WebCacheCurrConnections, snL4RealServerStatisticReassignments=snL4RealServerStatisticReassignments, snL4WebServerPort=snL4WebServerPort, snL4RealServerStatisticEntry=snL4RealServerStatisticEntry, snL4RealServerEntry=snL4RealServerEntry, snL4RealServerPortStatusPort=snL4RealServerPortStatusPort, snL4VirtualServerPortStatusPort=snL4VirtualServerPortStatusPort, snL4VirtualServerPortStatusCurrentConnection=snL4VirtualServerPortStatusCurrentConnection, snL4WebCacheGroupDestMask=snL4WebCacheGroupDestMask, snL4VirtualServerStatisticIP=snL4VirtualServerStatisticIP, snL4WebUncachedTrafficStatsEntry=snL4WebUncachedTrafficStatsEntry, snL4RealServerStatusReceivePkts=snL4RealServerStatusReceivePkts, snL4WebCacheIP=snL4WebCacheIP, snL4VirtualServerDeleteState=snL4VirtualServerDeleteState, snL4VirtualServerPortCfgAdminStatus=snL4VirtualServerPortCfgAdminStatus, snL4RealServerCfgEntry=snL4RealServerCfgEntry, snL4VirtualServerCfgVirtualIP=snL4VirtualServerCfgVirtualIP, snL4VirtualServerPortIndex=snL4VirtualServerPortIndex, snL4RealServerPortCfgEntry=snL4RealServerPortCfgEntry, snL4VirtualServerPortHistoryTransmitPkts=snL4VirtualServerPortHistoryTransmitPkts, snL4VirtualServerPortSticky=snL4VirtualServerPortSticky, snL4EnableRealServerPortUpTrap=snL4EnableRealServerPortUpTrap, snL4VirtualServer=snL4VirtualServer, snL4RealServerPortStatusFailTime=snL4RealServerPortStatusFailTime, snL4VirtualServerHistoryControlIndex=snL4VirtualServerHistoryControlIndex, snL4VirtualServerPortStatusServerName=snL4VirtualServerPortStatusServerName, snL4VirtualServerHistoryIntervalStart=snL4VirtualServerHistoryIntervalStart, snL4RealServerRowStatus=snL4RealServerRowStatus, snL4WebCacheGroup=snL4WebCacheGroup, snL4RealServerPortTable=snL4RealServerPortTable, snL4WebCacheTxOctets=snL4WebCacheTxOctets, snL4RealServerIndex=snL4RealServerIndex, snL4VirtualServerStatusTable=snL4VirtualServerStatusTable, snL4WebCachePortEntry=snL4WebCachePortEntry, snL4RealServerHistoryReassignments=snL4RealServerHistoryReassignments, snL4VirtualServerHistorySampleIndex=snL4VirtualServerHistorySampleIndex, snL4VirtualServerPort=snL4VirtualServerPort, snL4RealServerPortHistoryCurConnections=snL4RealServerPortHistoryCurConnections, snL4RealServerStatisticReassignmentLimit=snL4RealServerStatisticReassignmentLimit, snL4PolicyPriority=snL4PolicyPriority, snL4VirtualServerAdminStatus=snL4VirtualServerAdminStatus, snL4slbLimitExceeds=snL4slbLimitExceeds, snL4VirtualServerPortHistoryControlTable=snL4VirtualServerPortHistoryControlTable, snL4WebCacheTable=snL4WebCacheTable, snL4WebCacheMaxConnections=snL4WebCacheMaxConnections, snL4RealServerStatisticName=snL4RealServerStatisticName, snL4WebCacheTrafficIp=snL4WebCacheTrafficIp, snL4Redundancy=snL4Redundancy, snL4RealServerPortEntry=snL4RealServerPortEntry, snL4NoPDUCount=snL4NoPDUCount, snL4WebCacheGroupRowStatus=snL4WebCacheGroupRowStatus, snL4MaxNumWebCachePerGroup=snL4MaxNumWebCachePerGroup, snL4WebCacheTotalConnections=snL4WebCacheTotalConnections, snL4BindVirtualPortNumber=snL4BindVirtualPortNumber, snL4BecomeStandBy=snL4BecomeStandBy, L4Status=L4Status, snL4VirtualServerHistoryTransmitPkts=snL4VirtualServerHistoryTransmitPkts, snL4VirtualServerPortCfgSticky=snL4VirtualServerPortCfgSticky, snL4WebCacheAdminStatus=snL4WebCacheAdminStatus, snL4BindRealServerName=snL4BindRealServerName, snL4VirtualServerStatisticSymmetricBestStandbyMacAddr=snL4VirtualServerStatisticSymmetricBestStandbyMacAddr, snL4PolicyPortAccessTable=snL4PolicyPortAccessTable, snL4RealServerPortStatisticTable=snL4RealServerPortStatisticTable, snL4EnableGslbRemoteGslbSiDownTrap=snL4EnableGslbRemoteGslbSiDownTrap, snL4WebCacheTxPkts=snL4WebCacheTxPkts, snL4WebCachePortRowStatus=snL4WebCachePortRowStatus, snL4RealServerStatisticState=snL4RealServerStatisticState, snL4RealServerPortStatusState=snL4RealServerPortStatusState, snL4RealServerPortStatisticPeakConnection=snL4RealServerPortStatisticPeakConnection, snL4VirtualServerPortStatusEntry=snL4VirtualServerPortStatusEntry, snL4WebCacheRxPkts=snL4WebCacheRxPkts, snL4RealServerHistoryTransmitPkts=snL4RealServerHistoryTransmitPkts, snL4WebCacheGroupEntry=snL4WebCacheGroupEntry, snL4VirtualServerEntry=snL4VirtualServerEntry, snL4RealServerPortStatusPeakConnection=snL4RealServerPortStatusPeakConnection, snL4RealServerCfgWeight=snL4RealServerCfgWeight, snL4WebCacheGroupWebCacheIpList=snL4WebCacheGroupWebCacheIpList, snL4RealServerPortStatisticTotalConnection=snL4RealServerPortStatisticTotalConnection, snL4RealServerPortStatisticEntry=snL4RealServerPortStatisticEntry, snL4PolicyRowStatus=snL4PolicyRowStatus, snL4VirtualServerStatisticTransmitBytes=snL4VirtualServerStatisticTransmitBytes, snL4VirtualServerPortStatusPeakConnection=snL4VirtualServerPortStatusPeakConnection, snL4VirtualServerCfgEntry=snL4VirtualServerCfgEntry, snL4slbForwardTraffic=snL4slbForwardTraffic, snL4RealServerPortPort=snL4RealServerPortPort, snL4RealServerPortHistoryControlEntry=snL4RealServerPortHistoryControlEntry, snL4VirtualServerPortHistoryControlBucketsGranted=snL4VirtualServerPortHistoryControlBucketsGranted, snL4RealServerCfgDeleteState=snL4RealServerCfgDeleteState, snL4VirtualServerPortStatistic=snL4VirtualServerPortStatistic, L4ServerName=L4ServerName, snL4RealServerPortStatusTxBytes=snL4RealServerPortStatusTxBytes, snL4RealServerPortStatisticReassignCount=snL4RealServerPortStatisticReassignCount, snL4RealServerStatusFailTime=snL4RealServerStatusFailTime, snL4RealServerStatisticTable=snL4RealServerStatisticTable, snL4RealServerStatusTransmitPkts=snL4RealServerStatusTransmitPkts, snL4RealServerStatisticRealIP=snL4RealServerStatisticRealIP, snL4VirtualServerCfgTable=snL4VirtualServerCfgTable, snL4VirtualServerHistoryControlStatus=snL4VirtualServerHistoryControlStatus, snL4RealServerPortStatisticServerName=snL4RealServerPortStatisticServerName, snL4EnableRealServerPortDownTrap=snL4EnableRealServerPortDownTrap, snL4VirtualServerCfgSDAType=snL4VirtualServerCfgSDAType, snL4GslbSiteRemoteServerIrons=snL4GslbSiteRemoteServerIrons, snL4WebCacheStateful=snL4WebCacheStateful, snL4RealServerPortHistoryResponseTime=snL4RealServerPortHistoryResponseTime, snL4PolicyTable=snL4PolicyTable, snL4RealServerPortCfgRowStatus=snL4RealServerPortCfgRowStatus, snL4VirtualServerStatusName=snL4VirtualServerStatusName, snL4slbRouterInterfacePortMask=snL4slbRouterInterfacePortMask, snL4EnableRealServerDownTrap=snL4EnableRealServerDownTrap, snL4slbFinished=snL4slbFinished, snL4RealServerPortIndex=snL4RealServerPortIndex, snL4PolicyPortAccessEntry=snL4PolicyPortAccessEntry, snL4slbAged=snL4slbAged, snL4VirtualServerVirtualIP=snL4VirtualServerVirtualIP, snL4RealServerName=snL4RealServerName, snL4WebCacheTrafficStatsTable=snL4WebCacheTrafficStatsTable, snL4RealServerPortStatusTotalConnection=snL4RealServerPortStatusTotalConnection)
mibBuilder.exportSymbols("FOUNDRY-SN-SW-L4-SWITCH-GROUP-MIB", PYSNMP_MODULE_ID=snL4, snL4WebUncachedTxOctets=snL4WebUncachedTxOctets, snL4RealServerPortHistoryControlDataSource=snL4RealServerPortHistoryControlDataSource, snL4RealServerPortCfgIP=snL4RealServerPortCfgIP, snL4WebCachePortPort=snL4WebCachePortPort, snL4RealServerPortStatisticRxBytes=snL4RealServerPortStatisticRxBytes, snL4VirtualServerPortCfgConcurrent=snL4VirtualServerPortCfgConcurrent, snL4VirtualServerStatus=snL4VirtualServerStatus, snL4TcpAge=snL4TcpAge, snL4EnableRealServerMaxConnLimitReachedTrap=snL4EnableRealServerMaxConnLimitReachedTrap, snL4WebClientPortName=snL4WebClientPortName, snL4TrapRealServerCurConnections=snL4TrapRealServerCurConnections, snL4VirtualServerPortHistoryIndex=snL4VirtualServerPortHistoryIndex, snL4VirtualServerHistoryCurConnections=snL4VirtualServerHistoryCurConnections, snL4VirtualServerPortHistoryControlEntry=snL4VirtualServerPortHistoryControlEntry, snL4RealServerPortHistoryReceivePkts=snL4RealServerPortHistoryReceivePkts, snL4VirtualServerStatisticSymmetricInactives=snL4VirtualServerStatisticSymmetricInactives, snL4VirtualServerPortStatisticTotalConnection=snL4VirtualServerPortStatisticTotalConnection, snL4RealServerPortStatistic=snL4RealServerPortStatistic, snL4RealServerHistoryControlTable=snL4RealServerHistoryControlTable, snL4RealServerAdminStatus=snL4RealServerAdminStatus, snL4VirtualServerPortCfgEntry=snL4VirtualServerPortCfgEntry, snL4PolicyPortAccessList=snL4PolicyPortAccessList, snL4RealServerPortStatusRxBytes=snL4RealServerPortStatusRxBytes, snL4RealServerPortAdminStatus=snL4RealServerPortAdminStatus, snL4VirtualServerPortRowStatus=snL4VirtualServerPortRowStatus, snL4MaxNumWebCacheGroup=snL4MaxNumWebCacheGroup, snL4VirtualServerHistoryIndex=snL4VirtualServerHistoryIndex, snL4VirtualServerPortPort=snL4VirtualServerPortPort, snL4LinkVirtualInterface=snL4LinkVirtualInterface, snL4VirtualServerPortStatus=snL4VirtualServerPortStatus, snL4RealServerStatisticTransmitPkts=snL4RealServerStatisticTransmitPkts, snL4VirtualServerPortHistoryTotalConnections=snL4VirtualServerPortHistoryTotalConnections, snL4VirtualServerPortConcurrent=snL4VirtualServerPortConcurrent, snL4RealServerPortCfgTable=snL4RealServerPortCfgTable, snL4RealServerStatusRealIP=snL4RealServerStatusRealIP, snL4RealServerPortStatusTable=snL4RealServerPortStatusTable, snL4RealServerHistoryEntry=snL4RealServerHistoryEntry, snL4EnableTcpSynLimitReachedTrap=snL4EnableTcpSynLimitReachedTrap, snL4PolicyPort=snL4PolicyPort, snL4WebCachePortState=snL4WebCachePortState, snL4VirtualServerHistoryControlInterval=snL4VirtualServerHistoryControlInterval, snL4RealServerPort=snL4RealServerPort, snL4BindRowStatus=snL4BindRowStatus, snL4WebCacheRowStatus=snL4WebCacheRowStatus, snL4VirtualServerStatisticSymmetricState=snL4VirtualServerStatisticSymmetricState, snL4VirtualServerPortCfgIP=snL4VirtualServerPortCfgIP, snL4VirtualServerPortServerName=snL4VirtualServerPortServerName, snL4VirtualServerPortHistoryControlIndex=snL4VirtualServerPortHistoryControlIndex, snL4PingInterval=snL4PingInterval, snL4EnableGslbRemoteGslbSiUpTrap=snL4EnableGslbRemoteGslbSiUpTrap, snL4RealServerPortStatisticPort=snL4RealServerPortStatisticPort, snL4EnableMaxSessionLimitReachedTrap=snL4EnableMaxSessionLimitReachedTrap, snL4VirtualServerTable=snL4VirtualServerTable, snL4RealServerHistoryCurConnections=snL4RealServerHistoryCurConnections, snL4slbGlobalSDAType=snL4slbGlobalSDAType, snL4RealServerPortCfgAdminStatus=snL4RealServerPortCfgAdminStatus, snL4RealServer=snL4RealServer, snL4VirtualServerPortEntry=snL4VirtualServerPortEntry, snL4VirtualServerPortHistoryControlOwner=snL4VirtualServerPortHistoryControlOwner, snL4RealServerStatisticCurConnections=snL4RealServerStatisticCurConnections, snL4RealServerPortHistoryControlStatus=snL4RealServerPortHistoryControlStatus, snL4VirtualServerStatisticSymmetricActiveMacAddr=snL4VirtualServerStatisticSymmetricActiveMacAddr, snL4VirtualServerPortHistoryControlBucketsRequested=snL4VirtualServerPortHistoryControlBucketsRequested, snL4NoPDUSent=snL4NoPDUSent, snL4slbRouterInterfacePortList=snL4slbRouterInterfacePortList, snL4VirtualServerSDAType=snL4VirtualServerSDAType, snL4VirtualServerPortCfgTable=snL4VirtualServerPortCfgTable, snL4BindRealPortNumber=snL4BindRealPortNumber, snL4RealServerStatisticPeakConnections=snL4RealServerStatisticPeakConnections, snL4RealServerPortStatisticTxPkts=snL4RealServerPortStatisticTxPkts, snL4RealServerHistoryControlStatus=snL4RealServerHistoryControlStatus, snL4RealServerPortStatusIndex=snL4RealServerPortStatusIndex, snL4slbTotalConnections=snL4slbTotalConnections, snL4RealServerPortStatisticTxBytes=snL4RealServerPortStatisticTxBytes, snL4RealServerHistoryControlBucketsRequested=snL4RealServerHistoryControlBucketsRequested, snL4RealServerPortHistoryIntervalStart=snL4RealServerPortHistoryIntervalStart, snL4RealServerPortStatusEntry=snL4RealServerPortStatusEntry, L4Flag=L4Flag, snL4WebCachePort=snL4WebCachePort, snL4RealServerCfgRowStatus=snL4RealServerCfgRowStatus, snL4WebUncachedTrafficStats=snL4WebUncachedTrafficStats, snL4VirtualServerPortStatusTable=snL4VirtualServerPortStatusTable, snL4VirtualServerCfgName=snL4VirtualServerCfgName, snL4TrapRealServerPort=snL4TrapRealServerPort, snL4Trap=snL4Trap, snL4VirtualServerStatisticSymmetricPriority=snL4VirtualServerStatisticSymmetricPriority, snL4WebCacheGroupTable=snL4WebCacheGroupTable, L4RowSts=L4RowSts, snL4RealServerHistoryIntervalStart=snL4RealServerHistoryIntervalStart, snL4RealServerStatusFailedPortExists=snL4RealServerStatusFailedPortExists, snL4VirtualServerStatisticReceivePkts=snL4VirtualServerStatisticReceivePkts, snL4WebClientPort=snL4WebClientPort, snL4RealServerStatisticAge=snL4RealServerStatisticAge, snL4EnableRealServerUpTrap=snL4EnableRealServerUpTrap, snL4VirtualServerCfg=snL4VirtualServerCfg, snL4TrapRealServerName=snL4TrapRealServerName, snL4UdpAge=snL4UdpAge, snL4RealServerPortHistoryControlOwner=snL4RealServerPortHistoryControlOwner, snL4VirtualServerPortHistoryControlDataSource=snL4VirtualServerPortHistoryControlDataSource, snL4VirtualServerPortStatisticServerName=snL4VirtualServerPortStatisticServerName, snL4VirtualServerPortStatusIndex=snL4VirtualServerPortStatusIndex, snL4RealServerPortStatusTxPkts=snL4RealServerPortStatusTxPkts, snL4VirtualServerStatusReceivePkts=snL4VirtualServerStatusReceivePkts, snL4WebCachePortServerIp=snL4WebCachePortServerIp, snL4RealServerStatus=snL4RealServerStatus, snL4RealServerPortHistoryControlIndex=snL4RealServerPortHistoryControlIndex, snL4RealServerPortStatusServerName=snL4RealServerPortStatusServerName, snL4VirtualServerPortStatisticEntry=snL4VirtualServerPortStatisticEntry, snL4RealServerHistoryTable=snL4RealServerHistoryTable, snL4VirtualServerPortDeleteState=snL4VirtualServerPortDeleteState, snL4RealServerCfgIP=snL4RealServerCfgIP, snL4RealServerPortHistoryEntry=snL4RealServerPortHistoryEntry, snL4RealServerStatisticFailTime=snL4RealServerStatisticFailTime, snL4RealServerStatisticFailedPortExists=snL4RealServerStatisticFailedPortExists, snL4VirtualServerPortCfg=snL4VirtualServerPortCfg, snL4VirtualServerStatusTransmitPkts=snL4VirtualServerStatusTransmitPkts, snL4VirtualServerStatusEntry=snL4VirtualServerStatusEntry, snL4RealServerStatisticReceivePkts=snL4RealServerStatisticReceivePkts, snL4EnableBecomeStandbyTrap=snL4EnableBecomeStandbyTrap, snL4RealServerHistoryControlOwner=snL4RealServerHistoryControlOwner, snL4VirtualServerStatisticTransmitPkts=snL4VirtualServerStatisticTransmitPkts, snL4VirtualServerPortStatusTotalConnection=snL4VirtualServerPortStatusTotalConnection, snL4RealServerPortHistoryControlBucketsGranted=snL4RealServerPortHistoryControlBucketsGranted, snL4PolicyPortAccessPort=snL4PolicyPortAccessPort, snL4RealServerPortHistoryControlTable=snL4RealServerPortHistoryControlTable, snL4VirtualServerPortCfgPort=snL4VirtualServerPortCfgPort, snL4RealServerMaxConnections=snL4RealServerMaxConnections, snL4RealServerPortStatusRxPkts=snL4RealServerPortStatusRxPkts, snL4VirtualServerStatisticTotalConnections=snL4VirtualServerStatisticTotalConnections, snL4slbReverseTraffic=snL4slbReverseTraffic, snL4RealServerHistoryControlEntry=snL4RealServerHistoryControlEntry, snL4BindEntry=snL4BindEntry, snL4VirtualServerPortHistoryTable=snL4VirtualServerPortHistoryTable, snL4PolicyScope=snL4PolicyScope, snL4WebCacheWeight=snL4WebCacheWeight, snL4VirtualServerPortHistoryControlStatus=snL4VirtualServerPortHistoryControlStatus, snL4EnableGslbHealthCheckIpDownTrap=snL4EnableGslbHealthCheckIpDownTrap, snL4PingRetry=snL4PingRetry, snL4RealServerStatusCurConnections=snL4RealServerStatusCurConnections, snL4BackupInterface=snL4BackupInterface, snL4PolicyEntry=snL4PolicyEntry, snL4VirtualServerPortCfgRowStatus=snL4VirtualServerPortCfgRowStatus, snL4Gen=snL4Gen, snL4WebUncachedTxPkts=snL4WebUncachedTxPkts, snL4BackupMacAddr=snL4BackupMacAddr, snL4WebUncachedRxPkts=snL4WebUncachedRxPkts, snL4WebCache=snL4WebCache, snL4RealServerHistoryControlBucketsGranted=snL4RealServerHistoryControlBucketsGranted, snL4NoPortMap=snL4NoPortMap, snL4RealServerPortRowStatus=snL4RealServerPortRowStatus, snL4GslbSiteRemoteServerIronTable=snL4GslbSiteRemoteServerIronTable, snL4VirtualServerStatisticSymmetricKeep=snL4VirtualServerStatisticSymmetricKeep, snL4RealServerPortServerName=snL4RealServerPortServerName, snL4VirtualServerPortStatisticPort=snL4VirtualServerPortStatisticPort, snL4BindVirtualServerName=snL4BindVirtualServerName, snL4GslbSiteRemoteServerIronEntry=snL4GslbSiteRemoteServerIronEntry, snL4VirtualServerHistoryControlDataSource=snL4VirtualServerHistoryControlDataSource, snL4RealServerCfgMaxConnections=snL4RealServerCfgMaxConnections, snL4RealServerStatusEntry=snL4RealServerStatusEntry)
