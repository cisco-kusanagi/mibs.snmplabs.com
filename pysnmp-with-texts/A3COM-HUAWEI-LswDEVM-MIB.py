...
# Produced by pysmi-0.3.4 at Wed May  1 11:05:44 2019
...
Gauge32, Counter64, TimeTicks, NotificationType, Unsigned32, MibIdentifier, ObjectIdentity, iso, Bits, Integer32, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "TimeTicks", "NotificationType", "Unsigned32", "MibIdentifier", "ObjectIdentity", "iso", "Bits", "Integer32", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress")
...
mibBuilder.exportSymbols("A3COM-HUAWEI-LswDEVM-MIB", hwBufSize=hwBufSize, hwMemRawSliceUsed=hwMemRawSliceUsed, hwCpuCostRate=hwCpuCostRate, hwDevice=hwDevice, hwMemModuleIndex=hwMemModuleIndex, hwDevMFanStatus=hwDevMFanStatus, hwCpuIndex=hwCpuIndex, hwDevMSlotEnvironmentLowerLimit=hwDevMSlotEnvironmentLowerLimit, hwMemLgFree=hwMemLgFree, hwBufTable=hwBufTable, hwFlhLastDelTime=hwFlhLastDelTime, hwdot1qTpFdbLearnStatus=hwdot1qTpFdbLearnStatus, hwCpuTable=hwCpuTable, hwBufEntry=hwBufEntry, PYSNMP_MODULE_ID=hwLswdevMMib, hwMemTable=hwMemTable, hwMemFree=hwMemFree, hwBufCurrentTotal=hwBufCurrentTotal, hwdevMFanStatusTable=hwdevMFanStatusTable, hwdevMSlotEnvironmentType=hwdevMSlotEnvironmentType, hwCpuEntry=hwCpuEntry, hwDevMFirstTrapTime=hwDevMFirstTrapTime, hwFlhTotalSize=hwFlhTotalSize, hwdevMPowerStatusEntry=hwdevMPowerStatusEntry, hwMem=hwMem, hwMemSize=hwMemSize, hwDevMPowerStatus=hwDevMPowerStatus, hwDevMSlotEnvironmentUpperLimit=hwDevMSlotEnvironmentUpperLimit, hwLswdevMMibObject=hwLswdevMMibObject, hwFlhDelState=hwFlhDelState, hwCfmEraseFlash=hwCfmEraseFlash, hwMemEntry=hwMemEntry, hwMemFailNoMem=hwMemFailNoMem, hwFlhTotalFree=hwFlhTotalFree, hwdevMSlotEnvironmentEntry=hwdevMSlotEnvironmentEntry, hwBufModuleIndex=hwBufModuleIndex, hwDevMPowerNum=hwDevMPowerNum, hwdevMPowerStatusTable=hwdevMPowerStatusTable, hwFlhState=hwFlhState, hwLinkUpDownTrapEnable=hwLinkUpDownTrapEnable, hwMemFail=hwMemFail, hwDevMFanNum=hwDevMFanNum, hwCpuCostRatePer1Min=hwCpuCostRatePer1Min, hwCfmWriteFlash=hwCfmWriteFlash, hwdevMSlotEnvironmentTable=hwdevMSlotEnvironmentTable, hwFlh=hwFlh, hwBufCurrentUsed=hwBufCurrentUsed, hwLswdevMMib=hwLswdevMMib, hwDevMSlotEnvironmentValue=hwDevMSlotEnvironmentValue, hwdevMFanStatusEntry=hwdevMFanStatusEntry, hwDevMSlotEnvironmentStatus=hwDevMSlotEnvironmentStatus, hwCpuCostRatePer5Min=hwCpuCostRatePer5Min)
