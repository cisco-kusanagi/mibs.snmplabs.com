...
mibBuilder.exportSymbols("BIANCA-BRICK-OSPF-ERR-MIB", ospfErrLsupdNewerSelfgenLsa=ospfErrLsupdNewerSelfgenLsa, ospfErrOspfBadPacketType=ospfErrOspfBadPacketType, ospfErrIpBadDestination=ospfErrIpBadDestination, biboip=biboip, ospfErrOspfUnknownLsaType=ospfErrOspfUnknownLsaType, ospfErrLsupdLessRecentLsa=ospfErrLsupdLessRecentLsa, ospfErrOspfBadVersion=ospfErrOspfBadVersion, bintec=bintec, ospfErr=ospfErr, ospfErrHelloNetmaskMismatch=ospfErrHelloNetmaskMismatch, ospfErrDdNeighborStateLow=ospfErrDdNeighborStateLow, ospfErrOspfUnknownNeighbor=ospfErrOspfUnknownNeighbor, ospfErrLsackBadAck=ospfErrLsackBadAck, ospfErrLsupdBadLsaChecksum=ospfErrLsupdBadLsaChecksum, ospfErrLsreqBadRequest=ospfErrLsreqBadRequest, bibo=bibo, ospfErrLsreqNeighborStateLow=ospfErrLsreqNeighborStateLow, ospfErrLsupdNeighborStateLow=ospfErrLsupdNeighborStateLow, ospfErrHelloDeadTimerMismatch=ospfErrHelloDeadTimerMismatch, ospfErrLsackDuplicateAck=ospfErrLsackDuplicateAck, ospfErrHelloTimerMismatch=ospfErrHelloTimerMismatch, ospfErrOspfAuthenticationFailed=ospfErrOspfAuthenticationFailed, ospfErrHelloOptionMismatch=ospfErrHelloOptionMismatch, ospfErrOspfBadChecksum=ospfErrOspfBadChecksum, ospfErrDdOptionMismatch=ospfErrDdOptionMismatch, ospfErrOspfBadAreaId=ospfErrOspfBadAreaId, ospfErrOspfRouterIdConfusion=ospfErrOspfRouterIdConfusion)
