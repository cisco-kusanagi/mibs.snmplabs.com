...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS-3620-52P-L3MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:44:51 2019
...
Metric, RouterID, UpToMaxAge, AreaID, DesignatedRouterPriority, HelloRange, Status, PositiveInteger, TOSType = mibBuilder.importSymbols("OSPF-MIB", "Metric", "RouterID", "UpToMaxAge", "AreaID", "DesignatedRouterPriority", "HelloRange", "Status", "PositiveInteger", "TOSType")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
Counter32, NotificationType, Unsigned32, ObjectIdentity, IpAddress, iso, Bits, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, Counter64, TimeTicks, MibIdentifier, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "NotificationType", "Unsigned32", "ObjectIdentity", "IpAddress", "iso", "Bits", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "Counter64", "TimeTicks", "MibIdentifier", "ModuleIdentity")
TextualConvention, DisplayString, MacAddress, PhysAddress, RowStatus, TruthValue, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "DisplayString", "MacAddress", "PhysAddress", "RowStatus", "TruthValue", "TimeStamp")
...
swL3IpCtrlIpDhcpOption12State = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 5, 3, 2, 1, 3, 1, 22), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpDhcpOption12HostName = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 5, 3, 2, 1, 3, 1, 23), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 63))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 5, 3, 2, 1, 3, 1, 28), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigDefault = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 5, 3, 2, 1, 3, 1, 29), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 5, 3, 2, 1, 3, 1, 30), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientPDRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 5, 3, 2, 1, 3, 1, 31), TruthValue()).setMaxAccess("readwrite")
...
swL3ospfIfDistributeListInType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 5, 3, 8, 1, 24), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
swL3ospfIfBfdStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 5, 3, 8, 1, 26), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("disabled", 1), ("enabled", 2)))).setMaxAccess("readwrite")
...
swL3VrrpOperBfdPeerAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 5, 3, 14, 1, 1, 17), IpAddress().clone(hexValue="00000000")).setMaxAccess("readcreate")
...
swL3RIPInboundRouteFilterType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 5, 3, 19, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS-3620-52P-L3MGMT-MIB", swL3ospfAreaMetric=swL3ospfAreaMetric, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3RelayDnsState=swL3RelayDnsState, swL3ospfIfEvents=swL3ospfIfEvents, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, NetAddress=NetAddress, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3VrrpOperTable=swL3VrrpOperTable, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3IpStaticRouteTunnelTable=swL3IpStaticRouteTunnelTable, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3VrrpOperBfdPeerAddr=swL3VrrpOperBfdPeerAddr, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3RIPInboundRouteFilterEntry=swL3RIPInboundRouteFilterEntry, swL3Md5RowStatus=swL3Md5RowStatus, swL3RIPGarbageCollectionTime=swL3RIPGarbageCollectionTime, swL3Ipv6DHCPv6CPDAddrCtrlState=swL3Ipv6DHCPv6CPDAddrCtrlState, swL3RIPTimeOutTime=swL3RIPTimeOutTime, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3IpCtrlTable=swL3IpCtrlTable, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3LoopBackIpCtrlIpAddr=swL3LoopBackIpCtrlIpAddr, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3ospfIfBfdStatus=swL3ospfIfBfdStatus, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3Ipv6Address=swL3Ipv6Address, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3Route6RedistriEntry=swL3Route6RedistriEntry, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3RIPInboundRouteFilterName=swL3RIPInboundRouteFilterName, swL3Md5Key=swL3Md5Key, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3IpMgmt=swL3IpMgmt, swL3Route6RedistriSrcProtocol=swL3Route6RedistriSrcProtocol, swL3ospfIfEntry=swL3ospfIfEntry, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3LoopBackIpCtrlEntry=swL3LoopBackIpCtrlEntry, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3Ipv6DHCPv6CPDAddrCtrlTable=swL3Ipv6DHCPv6CPDAddrCtrlTable, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3ospfIfState=swL3ospfIfState, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3LoopBackIpCtrlIpSubnetMask=swL3LoopBackIpCtrlIpSubnetMask, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3LoopBackIpCtrlAdminState=swL3LoopBackIpCtrlAdminState, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3RouteRedistriType=swL3RouteRedistriType, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3ospfIfTable=swL3ospfIfTable, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3IpCtrlIpv6AutoConfigDefault=swL3IpCtrlIpv6AutoConfigDefault, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3ospfIfDistributeListInType=swL3ospfIfDistributeListInType, swL3LoopBackIpCtrlRowStatus=swL3LoopBackIpCtrlRowStatus, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr, swL3DevCtrl=swL3DevCtrl, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3ospfIfType=swL3ospfIfType, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3RIPInboundRouteFilterIfIpAddress=swL3RIPInboundRouteFilterIfIpAddress, swL3ospfIfDistributeListInName=swL3ospfIfDistributeListInName, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3LoopBackIpCtrlInterfaceName=swL3LoopBackIpCtrlInterfaceName, swL3IpCtrlIpv4AdminState=swL3IpCtrlIpv4AdminState, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3OspfDefInfoOrigMgmt=swL3OspfDefInfoOrigMgmt, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3OspfHostTable=swL3OspfHostTable, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3Route6RedistriType=swL3Route6RedistriType, swL3IpCtrlDhcpv6ClientPDPrefixLen=swL3IpCtrlDhcpv6ClientPDPrefixLen, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3IpCtrlDhcpv6ClientPDPrefix=swL3IpCtrlDhcpv6ClientPDPrefix, swL3OspfECMPState=swL3OspfECMPState, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3Md5Entry=swL3Md5Entry, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3Route6RedistriRowStatus=swL3Route6RedistriRowStatus, swL3RIPInboundRouteFilterType=swL3RIPInboundRouteFilterType, swL3IpCtrlDhcpv6ClientRapidCommit=swL3IpCtrlDhcpv6ClientRapidCommit, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3MgmtMIB=swL3MgmtMIB, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3RouteRedistriRouteMapName=swL3RouteRedistriRouteMapName, swL3IpCtrlState=swL3IpCtrlState, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3RIPInboundRouteFilterTable=swL3RIPInboundRouteFilterTable, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3OspfDefInfoOriginate=swL3OspfDefInfoOriginate, swL3ospfIfDemand=swL3ospfIfDemand, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3OspfHostMetric=swL3OspfHostMetric, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, NodeAddress=NodeAddress, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3RelayMgmt=swL3RelayMgmt, VrId=VrId, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3RoutePreferenceIBGP=swL3RoutePreferenceIBGP, swL3ospfAreaTable=swL3ospfAreaTable, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3IpCtrlDhcpv6ClientPDPrefixName=swL3IpCtrlDhcpv6ClientPDPrefixName, swL3ospfAreaId=swL3ospfAreaId, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3ospfIfMetric=swL3ospfIfMetric, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3Md5Table=swL3Md5Table, swL3IpCtrlLocalProxyArp=swL3IpCtrlLocalProxyArp, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3RoutePreference=swL3RoutePreference, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3IpCtrlIpv6AutoConfigState=swL3IpCtrlIpv6AutoConfigState, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3IpStaticRouteTunnelRowStatus=swL3IpStaticRouteTunnelRowStatus, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3VrrpOperState=swL3VrrpOperState, swL3DevMgmt=swL3DevMgmt, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3OspfHostTOS=swL3OspfHostTOS, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3ospfAreaType=swL3ospfAreaType, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3OspfDefInfoOrigMetric=swL3OspfDefInfoOrigMetric, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3IpCtrlIpDirectedBroadcastState=swL3IpCtrlIpDirectedBroadcastState, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=swL3Ipv6DHCPv6CPDAddrCtrlPrefixName, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3OspfHostStatus=swL3OspfHostStatus, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3RIPTimerMgmt=swL3RIPTimerMgmt, swL3Md5KeyId=swL3Md5KeyId, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3RoutePreferenceEBGP=swL3RoutePreferenceEBGP, swL3IpCtrlDhcpv6ClientPDState=swL3IpCtrlDhcpv6ClientPDState, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3IpStaticRouteTunnelEntry=swL3IpStaticRouteTunnelEntry, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3OspfDefInfoOrigMetricType=swL3OspfDefInfoOrigMetricType, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3Route6RedistriTable=swL3Route6RedistriTable, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3OspfHostEntry=swL3OspfHostEntry, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3IpCtrlDhcpv6ClientPDRapidCommit=swL3IpCtrlDhcpv6ClientPDRapidCommit)
mibBuilder.exportSymbols("DGS-3620-52P-L3MGMT-MIB", swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3RIPUpdateTime=swL3RIPUpdateTime, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3Route6RedistriDstProtocol=swL3Route6RedistriDstProtocol, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3LoopBackIpCtrlIfIndex=swL3LoopBackIpCtrlIfIndex, swL3RoutePreferenceDefault=swL3RoutePreferenceDefault, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3IpStaticRouteTunnelInterfaceName=swL3IpStaticRouteTunnelInterfaceName, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3Route6RedistriMetric=swL3Route6RedistriMetric, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3IpCtrlMode=swL3IpCtrlMode, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3Ipv6DHCPv6CPDAddrCtrlEntry=swL3Ipv6DHCPv6CPDAddrCtrlEntry, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3LoopBackIpCtrlTable=swL3LoopBackIpCtrlTable, swL3IpCtrlIpv6AdminState=swL3IpCtrlIpv6AdminState)
