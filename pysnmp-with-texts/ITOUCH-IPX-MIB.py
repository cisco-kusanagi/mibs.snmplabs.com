...
# Produced by pysmi-0.3.4 at Wed May  1 13:57:56 2019
...
ObjectIdentity, NotificationType, TimeTicks, Gauge32, MibIdentifier, Integer32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Counter64, ModuleIdentity, Bits, IpAddress, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "NotificationType", "TimeTicks", "Gauge32", "MibIdentifier", "Integer32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Counter64", "ModuleIdentity", "Bits", "IpAddress", "Unsigned32")
...
mibBuilder.exportSymbols("ITOUCH-IPX-MIB", ipxPrinterEthernet=ipxPrinterEthernet, ipxRipAge=ipxRipAge, ipxSapIfIndex=ipxSapIfIndex, ipxSapSvInterface=ipxSapSvInterface, ipxSapIfEntry=ipxSapIfEntry, ipxIfRipFilterNetwork=ipxIfRipFilterNetwork, ipxIfSapBcstDiscardTimeout=ipxIfSapBcstDiscardTimeout, ipxIfSapBcstTimer=ipxIfSapBcstTimer, ipxSapSocket=ipxSapSocket, ipxPrinterMac=ipxPrinterMac, ipxIfFilterStatusSourceNodeAll=ipxIfFilterStatusSourceNodeAll, ipxIfFilterSourceNode=ipxIfFilterSourceNode, ipxIfSapFilterEntry=ipxIfSapFilterEntry, ipxIfRipFilterTable=ipxIfRipFilterTable, xIpxPrinter=xIpxPrinter, ipxIfProtocolPriority=ipxIfProtocolPriority, ipxRipRtOrigin=ipxRipRtOrigin, ipxIfSapIn=ipxIfSapIn, ipxIfFramesIn=ipxIfFramesIn, ipxIfRipBcstTimer=ipxIfRipBcstTimer, ipxSapSvNetwork=ipxSapSvNetwork, ipxIfFilterTable=ipxIfFilterTable, ipxRipRtHops=ipxRipRtHops, ipxIfTable=ipxIfTable, ipxIfRipAgedOut=ipxIfRipAgedOut, ipxSapSvTable=ipxSapSvTable, ipxIfNetbiosIn=ipxIfNetbiosIn, ipxSapSvEntry=ipxSapSvEntry, ipxRipTable=ipxRipTable, ipxSapInterface=ipxSapInterface, ipxRipIfTable=ipxRipIfTable, ipxIfFilterStatusPacketTypeAll=ipxIfFilterStatusPacketTypeAll, xIpxRip=xIpxRip, ipxSapIfTable=ipxSapIfTable, ipxIfRipBcst=ipxIfRipBcst, ipxIfFilterPacketType=ipxIfFilterPacketType, ipxSapNetwork=ipxSapNetwork, ipxPrinterPortPrinter=ipxPrinterPortPrinter, ipxIfFilterDestNode=ipxIfFilterDestNode, ipxIfFilterSourceNetwork=ipxIfFilterSourceNetwork, ipxRouting=ipxRouting, ipxIfFilterIndex=ipxIfFilterIndex, ipxNetbiosIfIndex=ipxNetbiosIfIndex, ipxIfRipIn=ipxIfRipIn, ipxRipRtEntry=ipxRipRtEntry, ipxIfSapFilterHost=ipxIfSapFilterHost, ipxRipHops=ipxRipHops, ipxRipRtTable=ipxRipRtTable, ipxSapName=ipxSapName, ipxIfFilterStatusDestNetworkAll=ipxIfFilterStatusDestNetworkAll, ipxSapHost=ipxSapHost, ipxRipNetwork=ipxRipNetwork, ipxIfSapFilterNetworkAll=ipxIfSapFilterNetworkAll, ipxPrinterPortTable=ipxPrinterPortTable, ipxSapSvOrigin=ipxSapSvOrigin, ipxIfSapBcst=ipxIfSapBcst, ipxSapTable=ipxSapTable, xIpxIf=xIpxIf, ipxSapType=ipxSapType, ipxSapSvHost=ipxSapSvHost, ipxIfNetbiosOut=ipxIfNetbiosOut, ipxPrinterPortIndex=ipxPrinterPortIndex, ipxIfSapFilterServiceType=ipxIfSapFilterServiceType, ipxIfTransitDelay=ipxIfTransitDelay, ipxTimeout=ipxTimeout, ipxInternalNetwork=ipxInternalNetwork, ipxIfSapFilterRowStatus=ipxIfSapFilterRowStatus, ipxIfFilterStatusDestNodeAll=ipxIfFilterStatusDestNodeAll, ipxRipIfEntry=ipxRipIfEntry, ipxIfTransitDelayActual=ipxIfTransitDelayActual, ipxIfRipBcstDiscardTimeout=ipxIfRipBcstDiscardTimeout, ipxPrinterPortStatus=ipxPrinterPortStatus, ipxNetbiosHopLimit=ipxNetbiosHopLimit, ipxSapEntry=ipxSapEntry, ipxIfFilterAction=ipxIfFilterAction, ipxPrinterMac802_2_Snap=ipxPrinterMac802_2_Snap, ipxIfState=ipxIfState, xIpxNetbios=xIpxNetbios, ipxIfSapFilterTable=ipxIfSapFilterTable, ipxIfRipFilterType=ipxIfRipFilterType, ipxRipRouter=ipxRipRouter, ipxIfEntry=ipxIfEntry, ipxSapSvRowStatus=ipxSapSvRowStatus, ipxIfFramesOut=ipxIfFramesOut, ipxIfFilterDestNetwork=ipxIfFilterDestNetwork, ipxNetbiosIfEntry=ipxNetbiosIfEntry, xIpxFilter=xIpxFilter, ipxPrinterPortServer=ipxPrinterPortServer, ipxRipRtRowStatus=ipxRipRtRowStatus, ipxIfIndex=ipxIfIndex, ipxIfRipFilterAction=ipxIfRipFilterAction, ipxSapSvAge=ipxSapSvAge, ipxSapSvName=ipxSapSvName, xIpxSap=xIpxSap, ipxIfSapFilterName=ipxIfSapFilterName, ipxSapSvType=ipxSapSvType, ipxIfSapOut=ipxIfSapOut, ipxIfRipOut=ipxIfRipOut, ipxIfSapFilterNetwork=ipxIfSapFilterNetwork, ipxPrinterPortEntry=ipxPrinterPortEntry, ipxIfRipFilterNetworkAll=ipxIfRipFilterNetworkAll, ipxIfFrameStyle=ipxIfFrameStyle, ipxIfFilterStatusSourceNetworkAll=ipxIfFilterStatusSourceNetworkAll, ipxIfErrors=ipxIfErrors, ipxNetbiosIfTable=ipxNetbiosIfTable, ipxIfSapFilterType=ipxIfSapFilterType, ipxRipTransTime=ipxRipTransTime, ipxRipInterface=ipxRipInterface, ipxIfSapAgedOut=ipxIfSapAgedOut, ipxIfFilterRowStatus=ipxIfFilterRowStatus, xIpxSystem=xIpxSystem, ipxRipEntry=ipxRipEntry, ipxIfFilterEntry=ipxIfFilterEntry, ipxIfNetbiosForwarding=ipxIfNetbiosForwarding, ipxIfSapFilterServiceTypeAll=ipxIfSapFilterServiceTypeAll, ipxRipIfIndex=ipxRipIfIndex, ipxIfRipFilterRowStatus=ipxIfRipFilterRowStatus, ipxIfStatusNetwork=ipxIfStatusNetwork, xIpx=xIpx, ipxSapSvHops=ipxSapSvHops, ipxRipRtRouter=ipxRipRtRouter, ipxPrinterMac802_2=ipxPrinterMac802_2, ipxIfSapFilterAction=ipxIfSapFilterAction, ipxRipRtTransTime=ipxRipRtTransTime, ipxRipRtNetwork=ipxRipRtNetwork, ipxIfNetwork=ipxIfNetwork, ipxSapAge=ipxSapAge, ipxIfRipFilterEntry=ipxIfRipFilterEntry, ipxIfWatchdogSpoof=ipxIfWatchdogSpoof, ipxSapSvSocket=ipxSapSvSocket, ipxIfRipFilterHost=ipxIfRipFilterHost, ipxRipRtInterface=ipxRipRtInterface)
