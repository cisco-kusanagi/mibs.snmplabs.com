...
# Produced by pysmi-0.3.4 at Wed May  1 12:38:45 2019
...
Integer32, TimeTicks, IpAddress, Counter32, MibIdentifier, Counter64, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, NotificationType, ModuleIdentity, Unsigned32, ObjectIdentity, enterprises, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "TimeTicks", "IpAddress", "Counter32", "MibIdentifier", "Counter64", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "NotificationType", "ModuleIdentity", "Unsigned32", "ObjectIdentity", "enterprises", "Bits")
...
if mibBuilder.loadTexts: autoSurveillanceVlanTimeout.setDescription('A period of time in hour to remove a port from Auto Surveillance VLAN if the port is an automatic VLAN member. The Timeout range is 1~120 hours. Default aging time is 1 hour.')
...
if mibBuilder.loadTexts: autoSurveillanceVlanPortControlTable.setDescription('A table that contains Auto Surveillance Vlan Port Control configuration information.')
...
if mibBuilder.loadTexts: autoSurveillanceVlanPortControlEntry.setDescription('A list of Auto Surveillance Vlan Control configuration parameters for each Port on this device.')
...
if mibBuilder.loadTexts: autoSurveillanceVlanPortControlIndex.setDescription('The Auto Surveillance vlan port index.')
...
if mibBuilder.loadTexts: autoSurveillanceVlanPortAutoDetection.setDescription('This object is for enabling or disabling Auto Surveillance Vlan Auto Detection in the port. If the auto detection is enable, switch will add this port to the Auto Surveillance VLAN automatically if it detects the device OUI matches the Surveillance OUI. If the port is a static member of Auto Surveillance vlan or a LA member, it can not enable Auto Surveillance vlan auto detection.')
...
if mibBuilder.loadTexts: autoSurveillanceVlanPortState.setDescription('This object indicates Auto Surveillance vlan state to this Port. manual - this port is a static member of Auto Surveillance vlan. dynamic - this port is a dynamic member of Auto Surveillance vlan. none - this port is not a member of Auto Surveillance vlan.')
...
if mibBuilder.loadTexts: autoSurveillanceVlanOUIMask.setDescription('Auto Surveillance vlan OUI Mask. Always be FF:FF:FF:FF:FF:FF.')
...
mibBuilder.exportSymbols("DES-1210-28-AX", qosQ1p=qosQ1p, bandwidthCtrlTxThreshold=bandwidthCtrlTxThreshold, qosDiffServType58=qosDiffServType58, firmwareTransferError=firmwareTransferError, sysPortCtrlOperStatus=sysPortCtrlOperStatus, autoSurveillanceVlanOUISurveillanceOUI=autoSurveillanceVlanOUISurveillanceOUI, sysSNTPDSTStartHour=sysSNTPDSTStartHour, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, bandwidthCtrlIndex=bandwidthCtrlIndex, dot1qVlanPortEntry=dot1qVlanPortEntry, aclProfileIPProtocol=aclProfileIPProtocol, aclL3RuleICMPMessageCode=aclL3RuleICMPMessageCode, rstpStatus=rstpStatus, radiusServerSharedSecret=radiusServerSharedSecret, aclL3RuleSrcIpAddrMask=aclL3RuleSrcIpAddrMask, firmwareChecksumError=firmwareChecksumError, stpTxHoldCount=stpTxHoldCount, snmpV3GroupStatus=snmpV3GroupStatus, sysSNTPDSTEndMon=sysSNTPDSTEndMon, dot1qVlanTable=dot1qVlanTable, qosDiffServType50=qosDiffServType50, qosDiffServType60=qosDiffServType60, sysSNTPTimeSeconds=sysSNTPTimeSeconds, stpRootCost=stpRootCost, snmpV3UserStatus=snmpV3UserStatus, snmpV3ViewTreeTable=snmpV3ViewTreeTable, firmwareIllegalFile=firmwareIllegalFile, sysPortCtrlTable=sysPortCtrlTable, companyTrafficMgmt=companyTrafficMgmt, qosDiffServType45=qosDiffServType45, stpHelloTime=stpHelloTime, laPortChannelEntry=laPortChannelEntry, snmpV3Host=snmpV3Host, stpAdminPortPathCost=stpAdminPortPathCost, qosDiffServType43=qosDiffServType43, stpPortState=stpPortState, igsVlanMulticastGroupVlanId=igsVlanMulticastGroupVlanId, stpPortForwardTransitions=stpPortForwardTransitions, qosDiffServType42=qosDiffServType42, stpPortPathCost=stpPortPathCost, companyACLGroup=companyACLGroup, PortList=PortList, syslogTimeStamp=syslogTimeStamp, igsVlanMulticastGroupPortList=igsVlanMulticastGroupPortList, snmpV3EngineID=snmpV3EngineID, autoSurveillanceVlanOUI=autoSurveillanceVlanOUI, sysPortCtrlMDI=sysPortCtrlMDI, securityPortSecurity=securityPortSecurity, autoSurveillanceVlanId=autoSurveillanceVlanId, stpVersion=stpVersion, qosDiffServType38=qosDiffServType38, sysSafeGuardEnable=sysSafeGuardEnable, voicevlanPortControlEntry=voicevlanPortControlEntry, qosDiffServType01=qosDiffServType01, voiceVlanPriority=voiceVlanPriority, companyDot1qVlanGroup=companyDot1qVlanGroup, dot1qVlanUntaggedPorts=dot1qVlanUntaggedPorts, portSecEntry=portSecEntry, dot1pPortIndex=dot1pPortIndex, snmpV3User=snmpV3User, aclL3RuleICMPMessageType=aclL3RuleICMPMessageType, snmpV3HostEntry=snmpV3HostEntry, laPortActorPortPriority=laPortActorPortPriority, dot1xAuth=dot1xAuth, sysSNTPDSTStartMon=sysSNTPDSTStartMon, sysSNTPDSTOffset=sysSNTPDSTOffset, autoSurveillanceVlanOUIDescription=autoSurveillanceVlanOUIDescription, qosDiffServType56=qosDiffServType56, staticVlanID=staticVlanID, qosDiffServType18=qosDiffServType18, sysHardwareVersion=sysHardwareVersion, qosDiffServ=qosDiffServ, snmpV3TrapFirmUpgrade=snmpV3TrapFirmUpgrade, snmpV3HostStatus=snmpV3HostStatus, sysLBDRecoverTime=sysLBDRecoverTime, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, voicevlanOUI=voicevlanOUI, aclProfileSrcIpAddrMask=aclProfileSrcIpAddrMask, qosDiffServType11=qosDiffServType11, aclL2RuleSrcMacAddrMask=aclL2RuleSrcMacAddrMask, dhcpServerScreenEnablePortlist=dhcpServerScreenEnablePortlist, voicevlanPortState=voicevlanPortState, qosDiffServType07=qosDiffServType07, autoSurveillanceVlanTimeout=autoSurveillanceVlanTimeout, companySystem=companySystem, sysTrapFirmUpgradeEvent=sysTrapFirmUpgradeEvent, companyVoiceVlan=companyVoiceVlan, firmwareUpgradeSuccess=firmwareUpgradeSuccess, sysSNTPDSTEndHour=sysSNTPDSTEndHour, trustedHostTable=trustedHostTable, voicevlanPortAutoDetection=voicevlanPortAutoDetection, qosDiffServType25=qosDiffServType25, dot1qVlanUngisterMCFilterVlanId=dot1qVlanUngisterMCFilterVlanId, snmpV3GroupSecurityLevel=snmpV3GroupSecurityLevel, snmpV3UserEntry=snmpV3UserEntry, stpPortOperEdgePort=stpPortOperEdgePort, aclL3RuleAccessID=aclL3RuleAccessID, laPortControlEntry=laPortControlEntry, radiusServerAddress=radiusServerAddress, igsVlanQueryInterval=igsVlanQueryInterval, portSecMLA=portSecMLA, aclProfileArpSenderMacAddrMask=aclProfileArpSenderMacAddrMask, qosDiffServType22=qosDiffServType22, qosDiffServType05=qosDiffServType05, companyRSTP=companyRSTP, laPortActorTimeout=laPortActorTimeout, snmpV3TrapFiberLinkUpDown=snmpV3TrapFiberLinkUpDown, sysSNTPDSTStartDay=sysSNTPDSTStartDay, laPortChannelTable=laPortChannelTable, sslSecurityHttpStatus=sslSecurityHttpStatus, companyIpifGroup=companyIpifGroup, stpPriority=stpPriority, sslCipherSuiteList=sslCipherSuiteList, qosDiffServType10=qosDiffServType10, syslogGeneralGroup=syslogGeneralGroup, laPortControlTable=laPortControlTable, snmpV3HostCommunityName=snmpV3HostCommunityName, aclProfileDstIpAddrMask=aclProfileDstIpAddrMask, snmpV3CommunityName=snmpV3CommunityName, dot1xAuthStatus=dot1xAuthStatus, aclL3RuleTcpFinBit=aclL3RuleTcpFinBit, igsGrpQueryInterval=igsGrpQueryInterval, miscReset=miscReset, sysFirmwareVersion=sysFirmwareVersion, sysLBDCtrlIndex=sysLBDCtrlIndex, igsVlanMulticastGroupIpAddress=igsVlanMulticastGroupIpAddress, snmpV3HostVersion=snmpV3HostVersion, companyTraps=companyTraps, aclL2RuleSrcMacAddr=aclL2RuleSrcMacAddr, Timeout=Timeout, igsVlanFilterVlanId=igsVlanFilterVlanId, tftpFwTftpOperation=tftpFwTftpOperation, securityTrustedHost=securityTrustedHost, aclL2RuleStatus=aclL2RuleStatus, snmpV3GroupNotifyViewName=snmpV3GroupNotifyViewName, snmpV3TrapRSTPStateChange=snmpV3TrapRSTPStateChange, aclL2Rule1pPriority=aclL2Rule1pPriority, igsVlanMulticastGroupMacAddress=igsVlanMulticastGroupMacAddress, qosDiffServType61=qosDiffServType61, igsHostPortPurgeInterval=igsHostPortPurgeInterval, qosDiffServType35=qosDiffServType35, aclL2RuleInPortList=aclL2RuleInPortList, tftpConfigFileName=tftpConfigFileName, igsVlanFilterEntry=igsVlanFilterEntry, snmpV3viewTreeSubtree=snmpV3viewTreeSubtree, syslogSeverity=syslogSeverity, autoSurveillanceVlanPriority=autoSurveillanceVlanPriority, qosDiffServType63=qosDiffServType63, broadcastStormCtrlLimitType=broadcastStormCtrlLimitType, companyTrapSetting=companyTrapSetting, companyMirror=companyMirror, bandwidthCtrlRxThreshold=bandwidthCtrlRxThreshold, igsStatus=igsStatus, aclProfile=aclProfile, stpGlobal=stpGlobal, tftpFwTftpOperationStatus=tftpFwTftpOperationStatus, autoSurveillanceVlanOUIMask=autoSurveillanceVlanOUIMask, trustedHostIpMask=trustedHostIpMask, dot1pPortTable=dot1pPortTable, stpPortDesignatedPort=stpPortDesignatedPort, dot1qVlanUngisterMCFiltermode=dot1qVlanUngisterMCFiltermode, dot1qVlanUngisterMCFilterEntry=dot1qVlanUngisterMCFilterEntry, aRPSpoofPreventEntry=aRPSpoofPreventEntry, qosDiffServType28=qosDiffServType28, snmpV3UserTable=snmpV3UserTable, qosDiffServType13=qosDiffServType13, qosDiffServType29=qosDiffServType29, radius=radius, igsVlanRouterTable=igsVlanRouterTable, snmpV3ViewTree=snmpV3ViewTree, stpForwardDelay=stpForwardDelay, voicevlanSystem=voicevlanSystem, sysSave=sysSave, aclL2RuleAction=aclL2RuleAction, aclL2RuleTable=aclL2RuleTable, securitySSL=securitySSL, snmpV3UserAuthProtocol=snmpV3UserAuthProtocol, igsQueryInterval=igsQueryInterval, snmpV3HostAddress=snmpV3HostAddress, sysTrapStateChangeEvent=sysTrapStateChangeEvent, dot1xAuthTxPeriod=dot1xAuthTxPeriod, snmpGlobalState=snmpGlobalState, sysLBDPortStatus=sysLBDPortStatus, qosDiffServType37=qosDiffServType37, voiceVlanTimeout=voiceVlanTimeout, bandwidthCtrlTable=bandwidthCtrlTable, securityDhcpServerScreen=securityDhcpServerScreen, dot1qVlanUngisterMCFilterTable=dot1qVlanUngisterMCFilterTable, qosDiffServType02=qosDiffServType02, autoSurveillanceVlanPortAutoDetection=autoSurveillanceVlanPortAutoDetection, sysSNTPDSTStartMin=sysSNTPDSTStartMin, syslogUDPPort=syslogUDPPort, bandwidthCtrlEntry=bandwidthCtrlEntry, igsVlanSnoopStatus=igsVlanSnoopStatus, igsVlanRtrPortList=igsVlanRtrPortList, qosDiffServType12=qosDiffServType12, firmwareUpgradeFailure=firmwareUpgradeFailure, dot1qVlanPvid=dot1qVlanPvid, sysGroupInterval=sysGroupInterval, igsSystem=igsSystem, aclL2RuleEtherType=aclL2RuleEtherType, sysSNTPDSTEndMin=sysSNTPDSTEndMin, qosDiffServType30=qosDiffServType30, bandwidthCtrlSettings=bandwidthCtrlSettings, companyLBD=companyLBD, traps=traps, aclL2AccessID=aclL2AccessID, aclL3RuleTcpUdpSrcPort=aclL3RuleTcpUdpSrcPort, VlanIndex=VlanIndex, dlink_DES1210SeriesProd=dlink_DES1210SeriesProd, qosDiffServType06=qosDiffServType06, sysMirrorStatus=sysMirrorStatus, companySecurity=companySecurity, snmpV3viewTreeName=snmpV3viewTreeName, qosDiffServType54=qosDiffServType54, qosDiffServType36=qosDiffServType36, snmpV3GroupReadViewName=snmpV3GroupReadViewName, autoSurveillanceVlanOUIStatus=autoSurveillanceVlanOUIStatus, sysSNTPGMTMinutes=sysSNTPGMTMinutes, stpPortRestrictedTCN=stpPortRestrictedTCN, companySyslog=companySyslog, aclProfileSrcMacAddrMask=aclProfileSrcMacAddrMask, sysIpSubnetMask=sysIpSubnetMask, qosDiffServType40=qosDiffServType40, sysSwitchName=sysSwitchName, aclProfileMask=aclProfileMask, aclL3RuleProfileNo=aclL3RuleProfileNo, qosDiffServType39=qosDiffServType39, dot1xAuthMaxReq=dot1xAuthMaxReq, companySNMPV3=companySNMPV3, qosDiffServType48=qosDiffServType48, sysSystemPassword=sysSystemPassword, sysPortCtrlIndex=sysPortCtrlIndex, aclL3RuleDscp=aclL3RuleDscp, qosDiffServType27=qosDiffServType27, tftpFwImageFileName=tftpFwImageFileName, stpMaxAge=stpMaxAge, snmpV3Trap=snmpV3Trap, autoSurveillanceVlanOUITable=autoSurveillanceVlanOUITable, aclProfileNo=aclProfileNo, voicevlanPortControlTable=voicevlanPortControlTable, companyIgsGroup=companyIgsGroup, stpPortEntry=stpPortEntry, laPortControl=laPortControl, portSecTable=portSecTable, snmpV3CommunityPolicy=snmpV3CommunityPolicy, aclL3RuleTcpUdpSrcPortMask=aclL3RuleTcpUdpSrcPortMask, sysLocationName=sysLocationName, dlink=dlink, qosDiffServType59=qosDiffServType59, aRPSpoofPreventTable=aRPSpoofPreventTable, BridgeId=BridgeId, snmpV3GroupWriteViewName=snmpV3GroupWriteViewName, qosDiffServType46=qosDiffServType46)
mibBuilder.exportSymbols("DES-1210-28-AX", dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, stpPortPriority=stpPortPriority, dot1qVlanForbiddenPorts=dot1qVlanForbiddenPorts, snmpV3GroupTable=snmpV3GroupTable, aclL3RuleTcpPshBit=aclL3RuleTcpPshBit, dot1qVlanManagementOnOff=dot1qVlanManagementOnOff, snmpV3Community=snmpV3Community, topologyChange=topologyChange, aclL3RuleTable=aclL3RuleTable, dlink_products=dlink_products, igsQueryMaxResponseTime=igsQueryMaxResponseTime, snmpV3TrapCopperLinkUpDown=snmpV3TrapCopperLinkUpDown, aclL3RuleSrcIpAddr=aclL3RuleSrcIpAddr, dot1qVlanEntry=dot1qVlanEntry, aclL3Rule=aclL3Rule, stpPortProtocolMigration=stpPortProtocolMigration, aclProfileDstMacAddrMask=aclProfileDstMacAddrMask, stpHoldTime=stpHoldTime, aclL2RuleDstMacAddrMask=aclL2RuleDstMacAddrMask, snmpV3GroupEntry=snmpV3GroupEntry, sysTrapSystemEvent=sysTrapSystemEvent, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, autoSurveillanceVlanPortControlTable=autoSurveillanceVlanPortControlTable, aRPSpoofPreventMacAddress=aRPSpoofPreventMacAddress, portSecState=portSecState, sysTrapFiberPortEvent=sysTrapFiberPortEvent, tftpConfigTftpOperation=tftpConfigTftpOperation, companyQoSGroup=companyQoSGroup, sysTrapStatus=sysTrapStatus, igsVlan=igsVlan, des_1210_28ax=des_1210_28ax, sysLBDPortLoopStatus=sysLBDPortLoopStatus, aclProfileSrcPortMask=aclProfileSrcPortMask, snmpV3viewTreeType=snmpV3viewTreeType, snmpV3UserName=snmpV3UserName, companyAutoSurveillanceVlan=companyAutoSurveillanceVlan, qosDiffServType41=qosDiffServType41, qosDiffServType03=qosDiffServType03, qosDiffServType16=qosDiffServType16, qosDiffServType09=qosDiffServType09, qosDiffServType08=qosDiffServType08, snmpV3viewTreeStatus=snmpV3viewTreeStatus, qosDiffServType31=qosDiffServType31, qosDiffServType47=qosDiffServType47, snmpV3UserAuthProtocolPassword=snmpV3UserAuthProtocolPassword, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, igsVlanRouterPortList=igsVlanRouterPortList, qosDiffServType44=qosDiffServType44, companyMiscGroup=companyMiscGroup, igsVlanFilterTable=igsVlanFilterTable, aclL3RuleIgmpType=aclL3RuleIgmpType, stpDesignatedRoot=stpDesignatedRoot, aRPSpoofPreventRowStatus=aRPSpoofPreventRowStatus, sysPortCtrlFlowControlOper=sysPortCtrlFlowControlOper, aclL3RulePortList=aclL3RulePortList, igsVlanCfgQuerier=igsVlanCfgQuerier, stpBridgeHelloTime=stpBridgeHelloTime, qosDiffServType04=qosDiffServType04, snmpV3UserGroupName=snmpV3UserGroupName, companyTftpGroup=companyTftpGroup, qosDiffServType14=qosDiffServType14, qosDiffServEnable=qosDiffServEnable, snmpV3UserPrivProtocolPassword=snmpV3UserPrivProtocolPassword, sysGateway=sysGateway, aclL3RuleStatus=aclL3RuleStatus, tftpConfigTftpOperationStatus=tftpConfigTftpOperationStatus, sysSNTPPollInterval=sysSNTPPollInterval, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, sysLoginTimeoutInterval=sysLoginTimeoutInterval, qosDiffServType57=qosDiffServType57, igsVlanRouterVlanId=igsVlanRouterVlanId, snmpV3HostTable=snmpV3HostTable, snmpV3CommunityTable=snmpV3CommunityTable, snmpV3CommunityStatus=snmpV3CommunityStatus, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, snmpV3Group=snmpV3Group, sysTrapTwistedPortEvent=sysTrapTwistedPortEvent, igsRobustnessValue=igsRobustnessValue, snmpV3GroupSecurityModel=snmpV3GroupSecurityModel, snmpV3ViewTreeEntry=snmpV3ViewTreeEntry, voicevlanOUIEntry=voicevlanOUIEntry, qosDiffServType17=qosDiffServType17, sysPortCtrlSpeed=sysPortCtrlSpeed, dot1pPortPriority=dot1pPortPriority, sysSNTPDSTEndDay=sysSNTPDSTEndDay, portSecIndex=portSecIndex, staticAutoLearningList=staticAutoLearningList, aclL3RuleAction=aclL3RuleAction, stpProtocolSpecification=stpProtocolSpecification, stpTimeSinceTopologyChange=stpTimeSinceTopologyChange, broadcastStormCtrlThreshold=broadcastStormCtrlThreshold, stpPortTable=stpPortTable, aclL3RuleTcpUrgBit=aclL3RuleTcpUrgBit, laPortChannelMode=laPortChannelMode, voiceVlanId=voiceVlanId, voicevlanOUIMask=voicevlanOUIMask, voicevlanOUITelephonyOUI=voicevlanOUITelephonyOUI, autoSurveillanceVlanPortState=autoSurveillanceVlanPortState, qosDiffServType62=qosDiffServType62, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, qosDiffServType21=qosDiffServType21, snmpV3CommunityEntry=snmpV3CommunityEntry, staticEntry=staticEntry, tftpFwServerIpAddress=tftpFwServerIpAddress, laPortActorActivity=laPortActorActivity, snmpV3TrapBootup=snmpV3TrapBootup, stpPort=stpPort, aclL3RuleTcpUdpDstPort=aclL3RuleTcpUdpDstPort, aclProfileArpSenderIpAddrMask=aclProfileArpSenderIpAddrMask, dot1qVlanPortTable=dot1qVlanPortTable, qosDiffServType26=qosDiffServType26, dot1xAuthServerTimeout=dot1xAuthServerTimeout, sysSNTPDSTState=sysSNTPDSTState, companyDot1xGroup=companyDot1xGroup, aclL2RuleEntry=aclL2RuleEntry, sysLBDCtrlTable=sysLBDCtrlTable, sysLBDStateEnable=sysLBDStateEnable, qosDiffServType52=qosDiffServType52, autoSurveillanceVlanPortControlEntry=autoSurveillanceVlanPortControlEntry, staticMac=staticMac, qosDiffServType20=qosDiffServType20, stpPortDesignatedRoot=stpPortDesignatedRoot, dot1pPortEntry=dot1pPortEntry, aclProfileStatus=aclProfileStatus, broadcastStormCtrlSettings=broadcastStormCtrlSettings, aclProfileType=aclProfileType, sysSNTPState=sysSNTPState, sysPortCtrlFlowControl=sysPortCtrlFlowControl, securityARPSpoofPrevent=securityARPSpoofPrevent, aclL3RuleDstIpAddr=aclL3RuleDstIpAddr, igsVlanQuerier=igsVlanQuerier, sysLBDCtrlEntry=sysLBDCtrlEntry, aclL2ProfileID=aclL2ProfileID, staticDisableAutoLearn=staticDisableAutoLearn, snmpV3UserVersion=snmpV3UserVersion, LacpKey=LacpKey, igsVlanRouterEntry=igsVlanRouterEntry, sslCiphers=sslCiphers, snmpV3UserPrivProtocol=snmpV3UserPrivProtocol, syslogLogSrvAddr=syslogLogSrvAddr, qosDiffServType49=qosDiffServType49, qosDiffServType55=qosDiffServType55, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, companyLA=companyLA, stpPortDesignatedCost=stpPortDesignatedCost, laPortChannelMemberList=laPortChannelMemberList, aclProfileRuleCount=aclProfileRuleCount, voicevlanOUIStatus=voicevlanOUIStatus, sysDhcpAutoConfiguration=sysDhcpAutoConfiguration, staticTable=staticTable, voiceVlanMode=voiceVlanMode, qosDiffServType33=qosDiffServType33, igsVlanMulticastGroupEntry=igsVlanMulticastGroupEntry, stpPortAdminPointToPoint=stpPortAdminPointToPoint, trustedHostStatus=trustedHostStatus, sysMirrorCtrlEgressMirroring=sysMirrorCtrlEgressMirroring, stpRootPort=stpRootPort, dot1qVlanEgressPorts=dot1qVlanEgressPorts, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, aRPSpoofPreventIpAddr=aRPSpoofPreventIpAddr, sysLBDInterval=sysLBDInterval, aclL3RuleTcpSynBit=aclL3RuleTcpSynBit, sysPortCtrlType=sysPortCtrlType, autoSurveillanceVlanSystem=autoSurveillanceVlanSystem, qosDiffServType15=qosDiffServType15, laPortControlIndex=laPortControlIndex, companySNTPSetting=companySNTPSetting, trustedHostIpAddr=trustedHostIpAddr, sysMirrorTargetPort=sysMirrorTargetPort, stpPortOperPointToPoint=stpPortOperPointToPoint, qosDiffServType34=qosDiffServType34, stpPortEdge=stpPortEdge, trustedHostEntry=trustedHostEntry, queuingMechanism=queuingMechanism, qosDiffServType00=qosDiffServType00, trustedHostRowStatus=trustedHostRowStatus, dot1qVlanAsyOnOff=dot1qVlanAsyOnOff, sysSNTPFirstServer=sysSNTPFirstServer, qosDiffServType32=qosDiffServType32, dot1qVlanRowStatus=dot1qVlanRowStatus, dot1qVlanName=dot1qVlanName, sysTrapIP=sysTrapIP, staticStatus=staticStatus, aclL3RuleDstIpAddrMask=aclL3RuleDstIpAddrMask, stpBridgeForwardDelay=stpBridgeForwardDelay, snmpV3GroupName=snmpV3GroupName, aclL2Rule=aclL2Rule, voicevlanPortControlIndex=voicevlanPortControlIndex, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, qosDiffServType23=qosDiffServType23, aclL2RuleDstMacAddr=aclL2RuleDstMacAddr, qosDiffServTypeGroup=qosDiffServTypeGroup, laStatus=laStatus, aclL3RuleEntry=aclL3RuleEntry, aclL2RuleVlanId=aclL2RuleVlanId, aRPSpoofPreventPortList=aRPSpoofPreventPortList, stpPortDesignatedBridge=stpPortDesignatedBridge, laPortChannelIfIndex=laPortChannelIfIndex, stpPortEnable=stpPortEnable, qosDiffServType24=qosDiffServType24, stpTopChanges=stpTopChanges, aclL3RuleTcpUdpDstPortMask=aclL3RuleTcpUdpDstPortMask, autoSurveillanceVlanMode=autoSurveillanceVlanMode, companyStaticMAC=companyStaticMAC, miscStatisticsReset=miscStatisticsReset, snmpV3TrapSNMPAuthentication=snmpV3TrapSNMPAuthentication, laSystem=laSystem, sysPortCtrlEntry=sysPortCtrlEntry, voicevlanOUIDescription=voicevlanOUIDescription, aclProfileEntry=aclProfileEntry, autoSurveillanceVlanOUIEntry=autoSurveillanceVlanOUIEntry, stpPortRestrictedRole=stpPortRestrictedRole, sysMirrorCtrlIngressMirroring=sysMirrorCtrlIngressMirroring, qosMode=qosMode, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, tftpCfgServerIpAddress=tftpCfgServerIpAddress, voicevlanOUITable=voicevlanOUITable, aclProfileDstPortMask=aclProfileDstPortMask, aclL3RuleProtocol=aclL3RuleProtocol, aclL3RuleTcpRstBit=aclL3RuleTcpRstBit, sysRestart=sysRestart, dot1qVlanManagementid=dot1qVlanManagementid, sysIpAddr=sysIpAddr, qosDiffServType51=qosDiffServType51, stpBridgeMaxAge=stpBridgeMaxAge, autoSurveillanceVlanPortControlIndex=autoSurveillanceVlanPortControlIndex, snmpV3viewTreeMask=snmpV3viewTreeMask, staticPort=staticPort, igsVlanMulticastGroupTable=igsVlanMulticastGroupTable, qosDiffServType19=qosDiffServType19, sysIpAddrCfgMode=sysIpAddrCfgMode, sysSNTPSecondServer=sysSNTPSecondServer, PortLaMode=PortLaMode, aclL3RuleTcpAckBit=aclL3RuleTcpAckBit, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, qosDiffServType53=qosDiffServType53, syslogLogging=syslogLogging, syslogFacility=syslogFacility, aclProfileTable=aclProfileTable)
