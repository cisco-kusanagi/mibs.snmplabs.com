...
# Produced by pysmi-0.3.4 at Wed May  1 11:09:19 2019
...
MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType, ObjectIdentity, ModuleIdentity, Integer32, TimeTicks, enterprises, Unsigned32, Counter64, iso, IpAddress, Bits, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType", "ObjectIdentity", "ModuleIdentity", "Integer32", "TimeTicks", "enterprises", "Unsigned32", "Counter64", "iso", "IpAddress", "Bits", "Gauge32")
