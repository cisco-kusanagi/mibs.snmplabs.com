...
# Produced by pysmi-0.3.4 at Wed May  1 15:27:39 2019
...
IpAddress, Bits, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter64, Gauge32, Integer32, iso, MibIdentifier, ModuleIdentity, ObjectIdentity, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter64", "Gauge32", "Integer32", "iso", "MibIdentifier", "ModuleIdentity", "ObjectIdentity", "Counter32", "NotificationType")
TruthValue, TimeInterval, DisplayString, TextualConvention, RowStatus, VariablePointer, AutonomousType, TimeStamp, DateAndTime = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TimeInterval", "DisplayString", "TextualConvention", "RowStatus", "VariablePointer", "AutonomousType", "TimeStamp", "DateAndTime")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: tlPowerAlert.setRevisionsDescriptions(('Removed obsolete legacy PowerAlert 11 sections', 'Added tlUpsAggregatePowerFactor', 'Added additional tlUpsInputSource... elements', 'Added additional elements to tlUpsOutputCircuitTable', 'Added tlUpsInputSourceSelect', 'Added missing well known alarms', 'Consolidated and Released for PAL v12.06.006x',))
...
if mibBuilder.loadTexts: tlPowerAlert.setContactInfo('Software Engineering Tripp Lite 1111 W. 35th St. Chicago, IL 60609')
if mibBuilder.loadTexts: tlPowerAlert.setDescription('This MIB module defines MIB objects which provide mechanisms for remote management capabilities of Tripplite PowerAlert and related software.')
...
if mibBuilder.loadTexts: tlUpsExternalBatteryAge.setDescription('The age of external battery in years. This is equal to the current date minus tlConfigExternalBattReplDate.')
...
if mibBuilder.loadTexts: tlUpsPhaseImbalance.setDescription('Percentage of imbalance of the 3 phases.')
...
if mibBuilder.loadTexts: tlUpsInputSourceInUse.setDescription('The determination as to which one of two AC input lines is in use.')
...
if mibBuilder.loadTexts: tlUpsInputSourceTransitionCount.setDescription('The number of times the device transitions between primary and secondary sources. Most devices are limied to 65533 transitions, after which the value will not increment.')
...
if mibBuilder.loadTexts: tlUpsOutputCircuitVoltage.setDescription('The magnitude of the present circuit voltage in tenths of an volt.')
...
if mibBuilder.loadTexts: tlUpsOutputCircuitPower.setDescription('The magnitude of the present power in watts. tenths of an amp.')
...
if mibBuilder.loadTexts: tlUpsOutputCircuitPowerFactor.setDescription('The power factor of all receptacles in a given circuit as a %.')
...
if mibBuilder.loadTexts: tlUpsAggregatePowerFactor.setDescription('The aggregrate power factor of all phases.')
...
if mibBuilder.loadTexts: tlUpsAlarmRuntimeBelowWarningLevel.setDescription('The battery seconds remaining is below warning level.')
...
if mibBuilder.loadTexts: tlUpsAlarmBusStartVoltageLow.setDescription('The inverter start up bus voltage is too low.')
...
if mibBuilder.loadTexts: tlUpsAlarmBusOverVoltage.setDescription('The inverter bus voltage is too high.')
...
if mibBuilder.loadTexts: tlUpsAlarmBusUnderVoltage.setDescription('The inverter bus voltage is too low.')
...
if mibBuilder.loadTexts: tlUpsAlarmBusVoltageUnbalanced.setDescription('The inverter bus voltage is not balanced.')
...
if mibBuilder.loadTexts: tlUpsAlarmInverterSoftStartBad.setDescription('The inverter bus voltage cannot reach desired voltage within a specified duration.')
...
if mibBuilder.loadTexts: tlUpsAlarmInverterOverVoltage.setDescription('The inverter voltage is too high.')
...
if mibBuilder.loadTexts: tlUpsAlarmInverterUnderVoltage.setDescription('The inverter voltage is too low.')
...
if mibBuilder.loadTexts: tlUpsAlarmInverterCircuitBad.setDescription('The inverter output is shorted.')
...
if mibBuilder.loadTexts: tlUpsAlarmBatteryOverVoltage.setDescription('The battery voltage is too high.')
...
if mibBuilder.loadTexts: tlUpsAlarmBatteryUnderVoltage.setDescription('The battery voltage is too low.')
...
if mibBuilder.loadTexts: tlUpsAlarmSiteWiringFault.setDescription('The utility input wiring is faulty.')
...
if mibBuilder.loadTexts: tlUpsAlarmOverTemperatureProtection.setDescription('The over temperature protection is activated.')
...
if mibBuilder.loadTexts: tlUpsAlarmOverCharged.setDescription('The UPS is over charged.')
...
if mibBuilder.loadTexts: tlUpsAlarmEPOActive.setDescription('The EPO is currently activate.')
...
if mibBuilder.loadTexts: tlUpsAlarmBypassFrequencyBad.setDescription('The bypass frequency is out of tolerance.')
...
if mibBuilder.loadTexts: tlUpsAlarmExternalSmartBatteryAgeAboveThreshold.setDescription('One or more external smart batteries have been determined to require replacement.')
...
if mibBuilder.loadTexts: tlUpsAlarmExternalNonSmartBatteryAgeAboveThreshold.setDescription('One or more external non-smart batteries have been determined to require replacement.')
...
if mibBuilder.loadTexts: tlUpsAlarmSmartBatteryCommLost.setDescription('Communications with the smart batteries was lost.')
...
if mibBuilder.loadTexts: tlUpsAlarmSourceAOutage.setDescription('Input power source A is not present.')
...
if mibBuilder.loadTexts: tlUpsAlarmSourceBOutage.setDescription('Input power source B is not present.')
...
if mibBuilder.loadTexts: tlUpsAlarmWatchdogReset.setDescription('The internal watchdog triggered a reset of the device.')
...
if mibBuilder.loadTexts: tlUpsConfigDisplayUnits.setDescription('Selects English or Metric display for all readings. This selection may not be available on all devices. Further, some devices may support this selection, but not via a software selector. In this latter case, selections must be performed on the device itself.')
...
if mibBuilder.loadTexts: tlUpsConfigExternalBattReplDate.setDescription('The date on which the external battery was last replaced, in the format YYYYMMDD.')
...
if mibBuilder.loadTexts: tlUpsTemperature.setDescription('The ambient temperature. The measurement returned will either be in units of Celsius (C) or Fahrenheit (F) depending upon whether Metric or English was selected for the reading by tlUpsConfigDisplayUnits.')
...
if mibBuilder.loadTexts: tlCoolingAutoCoolingOn.setDescription('Automatic cooling was activated to lower the temperature below the remote set point.')
...
if mibBuilder.loadTexts: tlCoolingPowerButtonPressed.setDescription('Power button was pressed on the front panel.')
...
if mibBuilder.loadTexts: tlCoolingDisconnectedFromDevice.setDescription('The device communications is disconnected.')
...
if mibBuilder.loadTexts: tlSrCoolNetModel.setDescription('The model name for the device attached to the SRCOOLNET.')
...
if mibBuilder.loadTexts: tlSrCoolNetManufacturer.setDescription('The manufacturer of the AC Unit.')
...
if mibBuilder.loadTexts: tlSrCoolNetSerialNumber.setDescription('The serial number of the SRCOOLNET device.')
...
if mibBuilder.loadTexts: tlSrCoolNetHostSoftwareVersion.setDescription('The software version of the SRCOOLNET device.')
...
if mibBuilder.loadTexts: tlSrCoolNetName.setDescription('The user defined name for the AC Unit.')
...
if mibBuilder.loadTexts: tlSrCoolNetLocation.setDescription('The user defined location of the AC Unit.')
...
if mibBuilder.loadTexts: tlSrCoolNetMode.setDescription('The current mode of SRCOOLNET.')
...
if mibBuilder.loadTexts: tlSrCoolNetFanSpeed.setDescription('The current speed of the fan.')
...
if mibBuilder.loadTexts: tlSrCoolNetReturnAirTemp.setDescription('The return air stream temperature in tenths of degrees in the units Celsius/Fahrenheit as specified in tlSrCoolNetDisplayUnits.')
...
if mibBuilder.loadTexts: tlSrCoolNetWaterFull.setDescription('Indicates the water reservoir is full or not full.')
...
if mibBuilder.loadTexts: tlSrCoolNetCurrentRemoteTemp.setDescription('The EnviroSense temperature in tenths of degrees in Celsius or Fahrenheit depending upon value of tlSrCoolNetDisplayUnits. Only available if EnviroSense is connected to SRCOOLNET.')
...
if mibBuilder.loadTexts: tlSrCoolNetDisplayUnits.setDescription('Selects English or Metric display for all readings. AC unit must be manually configured to match this setting.')
...
if mibBuilder.loadTexts: tlSrCoolNetOnOff.setDescription('Turn the unit off or on.')
...
if mibBuilder.loadTexts: tlSrCoolSetMode.setDescription('Set the operating mode of cooling unit. Unit must be ON to set mode.')
...
if mibBuilder.loadTexts: tlSrCoolNetSetPointTemp.setDescription('The local set point temperature in tenths of degrees in Celsius or Fahrenheit based upon tlSrCoolNetDisplayUnits.')
...
if mibBuilder.loadTexts: tlSrCoolNetRemoteSetPointTemp.setDescription('The remote set point temperature in tenths of degrees in Celsius or Fahrenheit based upon tlSrCoolNetDisplayUnits. Only available when EnviroSense is connected to SRCOOLNET.')
...
if mibBuilder.loadTexts: tlSrCoolNetFanSpeedSetting.setDescription('Set the fan speed of the AC unit.')
...
if mibBuilder.loadTexts: tlSrCoolNetRemoteSetpointEnable.setDescription('Use remote temperature setpoint for control point versus return air temp. Only available when EnviroSense is connected to SRCOOLNET.')
...
if mibBuilder.loadTexts: tlSrCoolNetFanAlwaysOn.setDescription('Leave fans on when not cooling. Only available when EnviroSense is connected to SRCOOLNET.')
...
if mibBuilder.loadTexts: tlSrCoolNetWaterFullAlarm.setDescription('Water reservoir full.')
...
mibBuilder.exportSymbols("TRIPPLITE-12X", tlUpsAlarmBypassFrequencyBad=tlUpsAlarmBypassFrequencyBad, tlUpsInputSourceAvailability=tlUpsInputSourceAvailability, tlEnvContactTable=tlEnvContactTable, tlPASnmpContactsTable=tlPASnmpContactsTable, tlUpsOutletGroupNdx=tlUpsOutletGroupNdx, tlUpsConfigBattReplDate=tlUpsConfigBattReplDate, tlSrCoolNet=tlSrCoolNet, tlSubsetGroups=tlSubsetGroups, tlEnvContactEntry=tlEnvContactEntry, tlUpsAlarmDeviceId=tlUpsAlarmDeviceId, tlUpsOutletCurrent=tlUpsOutletCurrent, tlCoolingMaxReturnAirTemp=tlCoolingMaxReturnAirTemp, tlCoolingCondenserFailure=tlCoolingCondenserFailure, tlPASnmpContactEntry=tlPASnmpContactEntry, tlUpsAlarmDescr=tlUpsAlarmDescr, tlUpsAlarmOutputCurrentChanged=tlUpsAlarmOutputCurrentChanged, tlUpsOutletIndex=tlUpsOutletIndex, tlSrCoolNetWellKnownAlarms=tlSrCoolNetWellKnownAlarms, tlCoolingWellKnownAlarms=tlCoolingWellKnownAlarms, tlUpsAlarmCurrent2AboveThreshold=tlUpsAlarmCurrent2AboveThreshold, tlCoolingControlType=tlCoolingControlType, tlUpsPhaseImbalance=tlUpsPhaseImbalance, tlUpsOutletPower=tlUpsOutletPower, tlCoolingCompressorFailure=tlCoolingCompressorFailure, tlCoolingCompFrequency=tlCoolingCompFrequency, tlUpsControlUpsOn=tlUpsControlUpsOn, tlConformance=tlConformance, tlUpsControlRamp=tlUpsControlRamp, tlCoolingAirFilterClogged=tlCoolingAirFilterClogged, tlUpsAlarmEntry=tlUpsAlarmEntry, tlCoolingCondPumpRunDays=tlCoolingCondPumpRunDays, tlCoolingInputContactType=tlCoolingInputContactType, ultrix=ultrix, tlSrCoolNetReturnAirTemp=tlSrCoolNetReturnAirTemp, tlUpsAlarmGroup=tlUpsAlarmGroup, tlCoolingOutputRelayDefault=tlCoolingOutputRelayDefault, tlCoolingSetPointTemp=tlCoolingSetPointTemp, tlSrCoolNetMode=tlSrCoolNetMode, tlSrCoolNetWaterFull=tlSrCoolNetWaterFull, tlUpsOutputCircuits=tlUpsOutputCircuits, tlUpsAlarmExternalNonSmartBatteryAgeAboveThreshold=tlUpsAlarmExternalNonSmartBatteryAgeAboveThreshold, tlUpsAlarmMac=tlUpsAlarmMac, tlCoolingEvapSurfaceTemp=tlCoolingEvapSurfaceTemp, tlUpsFullConfigGroup=tlUpsFullConfigGroup, PYSNMP_MODULE_ID=tlPowerAlert, tlCoolingCurrentLimit=tlCoolingCurrentLimit, tlEnumerations=tlEnumerations, tlUpsAlarmSecondaryPowerOutage=tlUpsAlarmSecondaryPowerOutage, tlUpsAlarmCircuitBreaker2Open=tlUpsAlarmCircuitBreaker2Open, tlSrCoolNetSetPointTemp=tlSrCoolNetSetPointTemp, tlUpsFullOutletGroup=tlUpsFullOutletGroup, tlCooling=tlCooling, tlCoolingOffOnInputContact=tlCoolingOffOnInputContact, tlUpsMainOutlet=tlUpsMainOutlet, tlCoolingMaxSupplyTemp=tlCoolingMaxSupplyTemp, tlCoolingAutoCoolingOn=tlCoolingAutoCoolingOn, aix=aix, win32=win32, tlUpsSnmpCardSerialNum=tlUpsSnmpCardSerialNum, tlUpsExternalBatteryAge=tlUpsExternalBatteryAge, tlEnvTemperatureHighLimit=tlEnvTemperatureHighLimit, tlEnviroSense=tlEnviroSense, tlUpsInputVoltageTable=tlUpsInputVoltageTable, tlUpsOutletControl=tlUpsOutletControl, tlUpsAlarm=tlUpsAlarm, tlCoolingWaterLeak=tlCoolingWaterLeak, tlPAEmailContacts=tlPAEmailContacts, tlCoolingEvaporatorTemperatureSensorFault=tlCoolingEvaporatorTemperatureSensorFault, tlUpsBattery=tlUpsBattery, tlUpsFullAlarmGroup=tlUpsFullAlarmGroup, tlUpsAlarmSourceAOutage=tlUpsAlarmSourceAOutage, tlCoolingEvapFanRunDays=tlCoolingEvapFanRunDays, tlPASnmpContactSecurityName=tlPASnmpContactSecurityName, tlCoolingDisplayUnits=tlCoolingDisplayUnits, freebsd=freebsd, tlUpsAlarmBusStartVoltageLow=tlUpsAlarmBusStartVoltageLow, tlUpsAlarmFuseFailure=tlUpsAlarmFuseFailure, tlCoolingAirFilterInterval=tlCoolingAirFilterInterval, tlCoolingAutoStart=tlCoolingAutoStart, tlUpsOutput=tlUpsOutput, winnt=winnt, tlUpsAlarmRuntimeBelowWarningLevel=tlUpsAlarmRuntimeBelowWarningLevel, tlSrCoolSetMode=tlSrCoolSetMode, solintel=solintel, tlUpsAlarmOutputOverload=tlUpsAlarmOutputOverload, tlPASystem=tlPASystem, tlCoolingDischargePressurePersistentHigh=tlCoolingDischargePressurePersistentHigh, tlUpsAlarmBatteryUnderVoltage=tlUpsAlarmBatteryUnderVoltage, tlUpsOutletRampDataType=tlUpsOutletRampDataType, tlCoolingFanCurrent=tlCoolingFanCurrent, tlUpsOutletType=tlUpsOutletType, tlUpsOutletGroupName=tlUpsOutletGroupName, tlUpsAlarmOverTemperatureProtection=tlUpsAlarmOverTemperatureProtection, tlEnvHumidityInAlarm=tlEnvHumidityInAlarm, tlCoolingCondOutletTemp=tlCoolingCondOutletTemp, tlCoolingAirFilterRunHoursViolation=tlCoolingAirFilterRunHoursViolation, tlCoolingReturnAirSensorFault=tlCoolingReturnAirSensorFault, irix=irix, tlCoolingReturnAirTempHigh=tlCoolingReturnAirTempHigh, tlCoolingFanUnderCurrent=tlCoolingFanUnderCurrent, tlCoolingCompressorRunDays=tlCoolingCompressorRunDays, tlUpsConfig=tlUpsConfig, tlUpsTest=tlUpsTest, tlEnvContactConfig=tlEnvContactConfig, tlCoolingFanOverCurrent=tlCoolingFanOverCurrent, tlCoolingUnitCurrent=tlCoolingUnitCurrent, tlPAEmailContactName=tlPAEmailContactName, tlUpsOutputPowerTotal=tlUpsOutputPowerTotal, tlUpsAlarmsPresent=tlUpsAlarmsPresent, tlUpsAlarmCurrent1AboveThreshold=tlUpsAlarmCurrent1AboveThreshold, tlEnvContactIndex=tlEnvContactIndex, tlUpsIdentID=tlUpsIdentID, tlUpsLocation=tlUpsLocation, tlCoolingCondInletTemp=tlCoolingCondInletTemp, tlPowerAlert=tlPowerAlert, tlUpsAlarmBatteryOverVoltage=tlUpsAlarmBatteryOverVoltage, tlSrCoolNetWaterFullAlarm=tlSrCoolNetWaterFullAlarm, tlCoolingDischargePressure=tlCoolingDischargePressure, tlCoolingSupplyAirSensorFault=tlCoolingSupplyAirSensorFault, tlUpsConfigExternalBattReplDate=tlUpsConfigExternalBattReplDate, tlUpsTrapSystemShutdown=tlUpsTrapSystemShutdown, tlUpsAlarmOnBattery=tlUpsAlarmOnBattery, tlUpsAlarmTestInProgress=tlUpsAlarmTestInProgress, tlCoolingCompCurrent=tlCoolingCompCurrent, tlUpsAlarmAwaitingPower=tlUpsAlarmAwaitingPower, tlCoolingMaxAirFilterRunHours=tlCoolingMaxAirFilterRunHours, tlCoolingSuctionPressurePersistentLow=tlCoolingSuctionPressurePersistentLow, tlCoolingInverterCommunicationsFault=tlCoolingInverterCommunicationsFault, tlUpsAlarmBusUnderVoltage=tlUpsAlarmBusUnderVoltage, tlPAEmailContactRowStatus=tlPAEmailContactRowStatus, tlUpsAlarmDetail=tlUpsAlarmDetail, tlCoolingEvapFanSpeed=tlCoolingEvapFanSpeed, tlUpsInputNumVoltages=tlUpsInputNumVoltages, tlUpsAggregatePowerFactor=tlUpsAggregatePowerFactor, tlUpsAlarmLoadOff=tlUpsAlarmLoadOff, openbsd=openbsd, tlUpsWatchdogSupported=tlUpsWatchdogSupported, tlUpsAlarmPrimaryPowerOutage=tlUpsAlarmPrimaryPowerOutage, tlCoolingCondFanSpeed=tlCoolingCondFanSpeed, tlCoolingDischargePressureSensorFault=tlCoolingDischargePressureSensorFault, tlSrCoolNetName=tlSrCoolNetName, tlEnvHumidityData=tlEnvHumidityData, tlUpsAlarmFanFailure=tlUpsAlarmFanFailure, tlUpsOutlet=tlUpsOutlet, tlCoolingHostSoftwareVersion=tlCoolingHostSoftwareVersion, tlPAContacts=tlPAContacts, tlEnvHumidity=tlEnvHumidity, tlSrCoolNetOnOff=tlSrCoolNetOnOff, tlCoolingModel=tlCoolingModel, tlUpsInputSourceSelect=tlUpsInputSourceSelect, tlUpsOutletGroupState=tlUpsOutletGroupState, tlSrCoolNetRemoteSetpointEnable=tlSrCoolNetRemoteSetpointEnable, tlPASnmpContactRowStatus=tlPASnmpContactRowStatus, tlPASnmpContactAuthPassword=tlPASnmpContactAuthPassword, tlUpsAlarmCategory=tlUpsAlarmCategory, tlUpsMainOutletState=tlUpsMainOutletState, tlCoolingSupplyAirTemp=tlCoolingSupplyAirTemp, tlPASnmpContactName=tlPASnmpContactName, tlCoolingCondenserInletAirSensorFault=tlCoolingCondenserInletAirSensorFault, tlUpsAlarmCommunicationsLost=tlUpsAlarmCommunicationsLost, tlUpsAlarmCircuitBreaker8Open=tlUpsAlarmCircuitBreaker8Open, tlCoolingSuctionPressure=tlCoolingSuctionPressure, tlCoolingDisconnectedFromDevice=tlCoolingDisconnectedFromDevice, osx=osx, tlUpsWatchdogSecsBeforeReboot=tlUpsWatchdogSecsBeforeReboot, tlUpsMainOutletControl=tlUpsMainOutletControl, tlUpsWellKnownAlarms=tlUpsWellKnownAlarms, unknown=unknown, tlSrCoolNetModel=tlSrCoolNetModel, tlUpsInputVoltage=tlUpsInputVoltage, tlUpsAlarmInverterCircuitBad=tlUpsAlarmInverterCircuitBad, tlUpsAlarmInverterUnderVoltage=tlUpsAlarmInverterUnderVoltage, hpux9=hpux9, hpux11=hpux11, tlCoolingMinSupplyTemp=tlCoolingMinSupplyTemp, tlUpsInputVoltageType=tlUpsInputVoltageType, tlUpsInputSourceInUse=tlUpsInputSourceInUse, tlUpsOutletGroupDesc=tlUpsOutletGroupDesc, tlUpsAlarmOutputOffAsRequested=tlUpsAlarmOutputOffAsRequested, tlUpsControlShed=tlUpsControlShed, tlUpsAlarmCircuitBreaker4Open=tlUpsAlarmCircuitBreaker4Open, tlSrCoolNetFanAlwaysOn=tlSrCoolNetFanAlwaysOn, tlUpsBatteryAge=tlUpsBatteryAge, tlUpsAlarmBusOverVoltage=tlUpsAlarmBusOverVoltage, tlUpsAlarmUpsOutputOff=tlUpsAlarmUpsOutputOff, tlUpsAlarmUpsOffAsRequested=tlUpsAlarmUpsOffAsRequested, tlUpsWellKnownControls=tlUpsWellKnownControls, tlEnvTemperatureC=tlEnvTemperatureC, tlUpsOutletRampAction=tlUpsOutletRampAction, tlUpsOutletTable=tlUpsOutletTable, tlCoolingLocation=tlCoolingLocation, tlCoolingCurrentRemoteTemp=tlCoolingCurrentRemoteTemp, tlUpsFullControlGroup=tlUpsFullControlGroup, tlUpsAlarmShutdownImminent=tlUpsAlarmShutdownImminent, tlUpsOutputCircuitTable=tlUpsOutputCircuitTable, tlCoolingSuctionTemp=tlCoolingSuctionTemp, tlUpsIdent=tlUpsIdent, tlSrCoolNetFanSpeedSetting=tlSrCoolNetFanSpeedSetting, tlUpsAlarmCircuitBreaker1Open=tlUpsAlarmCircuitBreaker1Open, bsdi=bsdi, tlUpsAlarmSiteWiringFault=tlUpsAlarmSiteWiringFault, tlUpsAlarmEPOActive=tlUpsAlarmEPOActive, tlPAEmailContactsTable=tlPAEmailContactsTable, tlUpsAlarmTempBad=tlUpsAlarmTempBad, solspark=solspark, tlSrCoolNetManufacturer=tlSrCoolNetManufacturer, tlUpsAlarmInverterOverVoltage=tlUpsAlarmInverterOverVoltage, tlUpsAlarmCircuitBreaker6Open=tlUpsAlarmCircuitBreaker6Open, tlEnvEnvironment=tlEnvEnvironment, tlUpsInputVoltageEntry=tlUpsInputVoltageEntry, tlSrCoolNetAlarm=tlSrCoolNetAlarm, tlUpsSelectedDeviceID=tlUpsSelectedDeviceID, tlUpsOutletEntry=tlUpsOutletEntry, tlEnvTemperatureF=tlEnvTemperatureF, tlUpsTrapAlarmEntryRemovedV1=tlUpsTrapAlarmEntryRemovedV1, solaris=solaris, tlSrCoolNetSerialNumber=tlSrCoolNetSerialNumber, tlUpsAlarmUpsSystemOff=tlUpsAlarmUpsSystemOff, tlCoolingBeepOnKey=tlCoolingBeepOnKey, tlEnvHumidityHighLimit=tlEnvHumidityHighLimit, tlUpsOutletGroupIndex=tlUpsOutletGroupIndex, tlUpsAlarmCircuitBreaker3Open=tlUpsAlarmCircuitBreaker3Open, tlEnvTemperatureData=tlEnvTemperatureData, tlUpsOutletGroupRowStatus=tlUpsOutletGroupRowStatus, tlUpsAlarmLowBattery=tlUpsAlarmLowBattery, tlCoolingOffOnLeak=tlCoolingOffOnLeak, tlUpsAlarmInputBad=tlUpsAlarmInputBad, tlUpsTestDate=tlUpsTestDate, tlCoolingCondensatePumpFault=tlCoolingCondensatePumpFault, win9x=win9x, tlUpsAlarmDevLocation=tlUpsAlarmDevLocation, tlCoolingEvaporatorCoolingFailure=tlCoolingEvaporatorCoolingFailure, tlUpsFullAlarmObjsGroup=tlUpsFullAlarmObjsGroup, netbsd1=netbsd1, tlUpsOutputCircuitLoadCurrent=tlUpsOutputCircuitLoadCurrent, tlEnvContactStatus=tlEnvContactStatus, tlUpsFullTestGroup=tlUpsFullTestGroup, tlUpsAlarmBatteryBad=tlUpsAlarmBatteryBad, tlCoolingStatus=tlCoolingStatus, tlUpsAlarmSourceBOutage=tlUpsAlarmSourceBOutage, tlUpsTestResultsDetail=tlUpsTestResultsDetail, tlCoolingSuctionPressureLow=tlCoolingSuctionPressureLow, tlPASnmpContactIpAddress=tlPASnmpContactIpAddress, tlUpsOutputCircuitEntry=tlUpsOutputCircuitEntry, tlCoolingWaterFull=tlCoolingWaterFull, tlSrCoolNetConfig=tlSrCoolNetConfig, tlUpsOutletGroup=tlUpsOutletGroup, tlUpsAlarmLoadLevelAboveThreshold=tlUpsAlarmLoadLevelAboveThreshold, tlUpsTemperatureF=tlUpsTemperatureF, tlCoolingTempDiffAlarm=tlCoolingTempDiffAlarm, tlUpsAlarmCircuitBreaker5Open=tlUpsAlarmCircuitBreaker5Open, tlCoolingReturnAirTemp=tlCoolingReturnAirTemp, tlUpsOutletShedAction=tlUpsOutletShedAction, tlCoolingPressureGaugeFailure=tlCoolingPressureGaugeFailure)
mibBuilder.exportSymbols("TRIPPLITE-12X", tlUpsAlarmCurrent3AboveThreshold=tlUpsAlarmCurrent3AboveThreshold, sunos4=sunos4, tlCoolingEnvironment=tlCoolingEnvironment, tlUpsTrapSystemStartup=tlUpsTrapSystemStartup, tlUpsMainOutletControllable=tlUpsMainOutletControllable, tlCoolingAirFilterRunHours=tlCoolingAirFilterRunHours, tlPAEmailContactAddress=tlPAEmailContactAddress, tlUpsControl=tlUpsControl, tlUpsOutputCircuitPower=tlUpsOutputCircuitPower, tlCoolingRunTimes=tlCoolingRunTimes, tlBasicGroups=tlBasicGroups, tlCoolingRefrigerantTemp=tlCoolingRefrigerantTemp, tlCoolingSuctionTemperatureSensorFault=tlCoolingSuctionTemperatureSensorFault, tlUpsOutletName=tlUpsOutletName, sco=sco, tlSrCoolNetHostSoftwareVersion=tlSrCoolNetHostSoftwareVersion, tlUpsControlSelfTest=tlUpsControlSelfTest, tlSrCoolNetRemoteSetPointTemp=tlSrCoolNetRemoteSetPointTemp, tlUpsIdentUpsSoftwareChecksum=tlUpsIdentUpsSoftwareChecksum, tlUpsAlarmExternalSmartBatteryAgeAboveThreshold=tlUpsAlarmExternalSmartBatteryAgeAboveThreshold, tlPASnmpContactIndex=tlPASnmpContactIndex, tlUpsAlarmLocation=tlUpsAlarmLocation, tlCoolingConfig=tlCoolingConfig, tlUpsOutletGroupTable=tlUpsOutletGroupTable, tlCoolingSerialNumber=tlCoolingSerialNumber, tlUpsAlarmInverterSoftStartBad=tlUpsAlarmInverterSoftStartBad, tlCoolingEnableAirFilterAlarm=tlCoolingEnableAirFilterAlarm, tlUpsAlarmShutdownPending=tlUpsAlarmShutdownPending, tlUpsOutletNumOutlets=tlUpsOutletNumOutlets, tlUpsAlarmOnBypass=tlUpsAlarmOnBypass, tlUpsAlarmDeviceName=tlUpsAlarmDeviceName, tlCoolingCondenserFanFault=tlCoolingCondenserFanFault, tlCoolingAlarm=tlCoolingAlarm, tlCoolingOutputRelaySource=tlCoolingOutputRelaySource, tlCoolingCondFanRunDays=tlCoolingCondFanRunDays, tlCoolingOnOff=tlCoolingOnOff, tlUpsAlarmBusVoltageUnbalanced=tlUpsAlarmBusVoltageUnbalanced, tlCoolingSuctionPressureSensorFault=tlCoolingSuctionPressureSensorFault, tlCoolingName=tlCoolingName, tlPANumberOfSnmpContacts=tlPANumberOfSnmpContacts, tlCoolingEvaporatorFreezeUp=tlCoolingEvaporatorFreezeUp, tlOperatingSystems=tlOperatingSystems, tlEnvHumidityLowLimit=tlEnvHumidityLowLimit, tlCoolingCondenserOutletAirSensorFault=tlCoolingCondenserOutletAirSensorFault, tlUpsInput=tlUpsInput, tlSrCoolNetCurrentRemoteTemp=tlSrCoolNetCurrentRemoteTemp, tlUpsOutputCircuitPowerFactor=tlUpsOutputCircuitPowerFactor, tlCoolingStartupLinePressureImbalance=tlCoolingStartupLinePressureImbalance, tlPASnmpContacts=tlPASnmpContacts, tlUpsFullBatteryGroup=tlUpsFullBatteryGroup, tlUpsTraps=tlUpsTraps, tlUpsAlarmId=tlUpsAlarmId, tlSrCoolNetLocation=tlSrCoolNetLocation, tlUpsFullGroups=tlUpsFullGroups, tlEnvContactName=tlEnvContactName, tlCoolingThresholds=tlCoolingThresholds, tlCoolingEEVPercentage=tlCoolingEEVPercentage, tlFullGroups=tlFullGroups, tlCoolingSupplyAirTempHigh=tlCoolingSupplyAirTempHigh, hpux10=hpux10, tlCoolingDischargePressureHigh=tlCoolingDischargePressureHigh, tlUpsAlarmGeneralFault=tlUpsAlarmGeneralFault, tlSrCoolNetDisplayUnits=tlSrCoolNetDisplayUnits, tlUpsAlarmBatteryAgeAboveThreshold=tlUpsAlarmBatteryAgeAboveThreshold, osf=osf, tlUpsAlarmSmartBatteryCommLost=tlUpsAlarmSmartBatteryCommLost, tlEnvContacts=tlEnvContacts, tlUpsOutputCircuitVoltage=tlUpsOutputCircuitVoltage, tlUpsInputVoltageIndex=tlUpsInputVoltageIndex, tlUpsAlarmDiagnosticTestFailed=tlUpsAlarmDiagnosticTestFailed, tlUpsOutletGroupControl=tlUpsOutletGroupControl, tlUpsTemperature=tlUpsTemperature, linux=linux, tlUpsAlarmUserDefined=tlUpsAlarmUserDefined, tlPASnmpContactPort=tlPASnmpContactPort, tlUpsInputSourceTransitionCount=tlUpsInputSourceTransitionCount, tlCoolingManufacturer=tlCoolingManufacturer, tlUpsEnvironment=tlUpsEnvironment, tlPASnmpContactSnmpVersion=tlPASnmpContactSnmpVersion, tlUpsControlUpsOff=tlUpsControlUpsOff, tlUPS=tlUPS, tlUpsTrapAlarmEntryRemoved=tlUpsTrapAlarmEntryRemoved, tlUpsAlarmBypassBad=tlUpsAlarmBypassBad, tlCoolingRemoteShutdownViaInputContact=tlCoolingRemoteShutdownViaInputContact, tlUpsOutletShedDataType=tlUpsOutletShedDataType, tlUpsOutputCircuitStatus=tlUpsOutputCircuitStatus, tlUpsObjects=tlUpsObjects, tlUpsAlarmCircuitBreaker7Open=tlUpsAlarmCircuitBreaker7Open, tlUpsTrapAlarmEntryAddedV1=tlUpsTrapAlarmEntryAddedV1, tlUpsAlarmChargerFailed=tlUpsAlarmChargerFailed, tlUpsOutletNumOutletGroups=tlUpsOutletNumOutletGroups, tlCoolingAtomizerRunDays=tlCoolingAtomizerRunDays, tlUpsAlarmWatchdogReset=tlUpsAlarmWatchdogReset, tlGroups=tlGroups, tlUpsConfigDisplayUnits=tlUpsConfigDisplayUnits, tlCoolingLowRefrigerantStartupFault=tlCoolingLowRefrigerantStartupFault, tlUpsOutletGroupEntry=tlUpsOutletGroupEntry, tlUpsAlarmTime=tlUpsAlarmTime, tlEnvTemperatureLowLimit=tlEnvTemperatureLowLimit, tlUpsAlarmOutputBad=tlUpsAlarmOutputBad, tlCompliances=tlCompliances, tlUpsOutletState=tlUpsOutletState, tlCoolingFanSpeedOverride=tlCoolingFanSpeedOverride, tlCoolingIdent=tlCoolingIdent, tlCoolingFirmwareVersion=tlCoolingFirmwareVersion, tlUpsAlarmIp=tlUpsAlarmIp, tlSrCoolNetIdent=tlSrCoolNetIdent, tlSrCoolNetFanSpeed=tlSrCoolNetFanSpeed, tlUpsFullIdentGroup=tlUpsFullIdentGroup, tlSrCoolNetData=tlSrCoolNetData, tlPASnmpContactPrivPassword=tlPASnmpContactPrivPassword, tlUpsOutletRampData=tlUpsOutletRampData, tlCoolingPowerButtonPressed=tlCoolingPowerButtonPressed, tlEnvTemperatureInAlarm=tlEnvTemperatureInAlarm, tlPAEmailContactIndex=tlPAEmailContactIndex, tlUpsIdentSerialNum=tlUpsIdentSerialNum, tlSrCoolNetStatus=tlSrCoolNetStatus, tlUpsTrapAlarmEntryAdded=tlUpsTrapAlarmEntryAdded, tlUpsAlarmDevName=tlUpsAlarmDevName, tlUpsOutputCircuitIndex=tlUpsOutputCircuitIndex, tlPAEmailContactEntry=tlPAEmailContactEntry, tlPANumberOfEmailContacts=tlPANumberOfEmailContacts, tlCoolingSuctionPressureLowStartFailure=tlCoolingSuctionPressureLowStartFailure, tlCoolingWaterLeakContactType=tlCoolingWaterLeakContactType, tlUpsAlarmTable=tlUpsAlarmTable, tlCoolingEvaporatorFailure=tlCoolingEvaporatorFailure, tlUpsOutletShedData=tlUpsOutletShedData, tlUpsAlarmDepletedBattery=tlUpsAlarmDepletedBattery, tlUpsAlarmOverCharged=tlUpsAlarmOverCharged)
