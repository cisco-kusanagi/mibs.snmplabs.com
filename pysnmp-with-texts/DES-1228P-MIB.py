...
# Produced by pysmi-0.3.4 at Fri Jan 31 21:33:33 2020
...
mibBuilder.exportSymbols("DES-1228P-MIB", commTrapSNMPTPLinkUpDown=commTrapSNMPTPLinkUpDown, broadcastStormGlobalThreshold=broadcastStormGlobalThreshold, poeportid=poeportid, lldpAntiRogueKey=lldpAntiRogueKey, igsSystem=igsSystem, configIpAddress=configIpAddress, trustedHostIpMask=trustedHostIpMask, trustedHostIpAddress=trustedHostIpAddress, configGateway=configGateway, des_1228pa1=des_1228pa1, MacAddress=MacAddress, dot1pPortIndex=dot1pPortIndex, configTftpOperation=configTftpOperation, poeportpowerlimit=poeportpowerlimit, igsVlanRouterPortListVlanId=igsVlanRouterPortListVlanId, dscpEntry=dscpEntry, igsVlanRouterPortListEntry=igsVlanRouterPortListEntry, configPortEntry=configPortEntry, igsVlanMcastFwdTable=igsVlanMcastFwdTable, igsReportForwardInterval=igsReportForwardInterval, commGetIndex=commGetIndex, configVLANMode=configVLANMode, companyPoEGroup=companyPoEGroup, igsVlanRouterPortList=igsVlanRouterPortList, companySecurity=companySecurity, broadcastStormCtrlSettings=broadcastStormCtrlSettings, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, swFiberInsert=swFiberInsert, companyStaticGroup=companyStaticGroup, commTrapTrapAbnormalTPTXError=commTrapTrapAbnormalTPTXError, commTrapSNMPFiberLinkUpDown=commTrapSNMPFiberLinkUpDown, commSetIndex=commSetIndex, radiusServerPort=radiusServerPort, configRestoreDefaults=configRestoreDefaults, swFiberRemove=swFiberRemove, portTrunkTable=portTrunkTable, staticOnOff=staticOnOff, igsSharedSegmentAggregationInterval=igsSharedSegmentAggregationInterval, companyIgsGroup=companyIgsGroup, commTrapTrapPOEPortOvercurrent=commTrapTrapPOEPortOvercurrent, igsVlanRouterPortListTable=igsVlanRouterPortListTable, configSNMPEnable=configSNMPEnable, staticAutoLearning=staticAutoLearning, igsGblReportFwdOnAllPorts=igsGblReportFwdOnAllPorts, configPortTable=configPortTable, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, commTrapTable=commTrapTable, configMirrorTable=configMirrorTable, configSafeguardEnable=configSafeguardEnable, poeportgroup=poeportgroup, configIpAssignmentMode=configIpAssignmentMode, tvlanTable=tvlanTable, configBootTftpServerIp=configBootTftpServerIp, igsVlanMcastFwdPortListMac=igsVlanMcastFwdPortListMac, lldpRemOrgDefInfoTable=lldpRemOrgDefInfoTable, dlink_DES12XXSeriesProd=dlink_DES12XXSeriesProd, tvlanPortVlanId=tvlanPortVlanId, dot1pPortTable=dot1pPortTable, dscpIndex=dscpIndex, commTrapTrapPOEPowerFail=commTrapTrapPOEPowerFail, commSetEntry=commSetEntry, d_link=d_link, staticTable=staticTable, igsVlanMcastFwdVlanIdMac=igsVlanMcastFwdVlanIdMac, companyMiscGroup=companyMiscGroup, commTrapSNMPBootup=commTrapSNMPBootup, configPort=configPort, tvlanManagementOnOff=tvlanManagementOnOff, staticEntry=staticEntry, dot1xAuthMaxReq=dot1xAuthMaxReq, configMirrorTXSrc=configMirrorTXSrc, igsStatus=igsStatus, trustedHostSettings=trustedHostSettings, tvlanPortTable=tvlanPortTable, radiusServerAddress=radiusServerAddress, companyPortTrunkGroup=companyPortTrunkGroup, commTrapEntry=commTrapEntry, trustedHostID=trustedHostID, commSetTable=commSetTable, commGetName=commGetName, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, trustedHostOnOff=trustedHostOnOff, radiusServerSharedSecret=radiusServerSharedSecret, qosMode=qosMode, igsQueryInterval=igsQueryInterval, configMirrorStatus=configMirrorStatus, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, configMirrorRXSrc=configMirrorRXSrc, configTftpServerIpAddress=configTftpServerIpAddress, commGetEntry=commGetEntry, commTrapTrapAbnormalFiberTXError=commTrapTrapAbnormalFiberTXError, dscpPriority=dscpPriority, miscStatisticsReset=miscStatisticsReset, lldpRemOrgDefInfoEntry=lldpRemOrgDefInfoEntry, commSetStatus=commSetStatus, commTrapStatus=commTrapStatus, commGetTable=commGetTable, radius=radius, tvlanUntaggedPorts=tvlanUntaggedPorts, trustedHostTable=trustedHostTable, lldpAntiRoguePortControl=lldpAntiRoguePortControl, dscpTable=dscpTable, dot1pPortEntry=dot1pPortEntry, companyLLDPExtnGroup=companyLLDPExtnGroup, poePortTable=poePortTable, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, commTrapTrapAbnormalFiberRXError=commTrapTrapAbnormalFiberRXError, swFiberAbnormalRXError=swFiberAbnormalRXError, igsLeaveProcessInterval=igsLeaveProcessInterval, igsLastMembQueryInterval=igsLastMembQueryInterval, igsQuerierStateOnOff=igsQuerierStateOnOff, miscReset=miscReset, tvlanStatus=tvlanStatus, portTrunkId=portTrunkId, poePortEntry=poePortEntry, staticStatus=staticStatus, tvlanPortEntry=tvlanPortEntry, configNetMask=configNetMask, commTrapName=commTrapName, companySpanGroup=companySpanGroup, igsVlanFilterEntry=igsVlanFilterEntry, companyTVlanGroup=companyTVlanGroup, igsVlanFilterTable=igsVlanFilterTable, configPhysAddress=configPhysAddress, configBootImageFileName=configBootImageFileName, tvlanMember=tvlanMember, dot1xAuthSystemControl=dot1xAuthSystemControl, dot1pPortPriority=dot1pPortPriority, igsNextMcastFwdMode=igsNextMcastFwdMode, PortList=PortList, dot1xAuthServerTimeout=dot1xAuthServerTimeout, configMirrorEntry=configMirrorEntry, configSave=configSave, commSetName=commSetName, spanOnOff=spanOnOff, configPasswordAdmin=configPasswordAdmin, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, trustedHostStatus=trustedHostStatus, commTrapTrapPOEPortShort=commTrapTrapPOEPortShort, commGetStatus=commGetStatus, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, lldpGalobalEnable=lldpGalobalEnable, commTrapIpAddress=commTrapIpAddress, OwnerString=OwnerString, igsVlanMcastFwdGroupAddress=igsVlanMcastFwdGroupAddress, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, configMirrorId=configMirrorId, commTrapTrapAbnormalTPRXError=commTrapTrapAbnormalTPRXError, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, igsHostPortPurgeInterval=igsHostPortPurgeInterval, dot1xAuth=dot1xAuth, commTrapIndex=commTrapIndex, RowStatus=RowStatus, companyConfigGroup=companyConfigGroup, configVerHwChipSet=configVerHwChipSet, staticVlanID=staticVlanID, swTPAbnormalTXError=swTPAbnormalTXError, igsVlanId=igsVlanId, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, companyCommGroup=companyCommGroup, igsQueryMaxResponseTime=igsQueryMaxResponseTime, trustedHostEntry=trustedHostEntry, configPortSpeed=configPortSpeed, tvlanEntry=tvlanEntry, portTrunkMember=portTrunkMember, queuingMechanism=queuingMechanism, configTftpServerFileName=configTftpServerFileName, lldpSysConfigChecksum=lldpSysConfigChecksum, lldpSysMACDigest=lldpSysMACDigest, tvlanId=tvlanId, igsMcastEntryAgeingInterval=igsMcastEntryAgeingInterval, companyTrafficMgmt=companyTrafficMgmt, configVerSwPrimary=configVerSwPrimary, portTrunkEntry=portTrunkEntry, igsVlanMcastFwdEntry=igsVlanMcastFwdEntry, tvlanName=tvlanName, tvlanPortPortId=tvlanPortPortId, swTPAbnormalRXError=swTPAbnormalRXError, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, tvlanAsyOnOff=tvlanAsyOnOff, staticPort=staticPort, igsVlan=igsVlan, dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, igsVlanFilterStatus=igsVlanFilterStatus, igsRobustnessValue=igsRobustnessValue, staticMac=staticMac, lldpAntiRoguePortIndex=lldpAntiRoguePortIndex, lldpAntiRoguePortStatus=lldpAntiRoguePortStatus, configMirrorMon=configMirrorMon, igsv3Processing=igsv3Processing, staticId=staticId, tvlanManagementid=tvlanManagementid, dot1xAuthTxPeriod=dot1xAuthTxPeriod, dlink_products=dlink_products, configBootTftpOperation=configBootTftpOperation, companyDot1xGroup=companyDot1xGroup, swFiberAbnormalTXError=swFiberAbnormalTXError, configPortOperStatus=configPortOperStatus, portTrunkName=portTrunkName, companyQoSGroup=companyQoSGroup, lldpRemOrgDefInfoOUI=lldpRemOrgDefInfoOUI)
