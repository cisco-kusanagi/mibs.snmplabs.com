...
# Produced by pysmi-0.3.4 at Wed May  1 13:29:30 2019
...
Counter32, Counter64, Unsigned32, MibIdentifier, ModuleIdentity, IpAddress, NotificationType, iso, Integer32, Bits, TimeTicks, Gauge32, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter32", "Counter64", "Unsigned32", "MibIdentifier", "ModuleIdentity", "IpAddress", "NotificationType", "iso", "Integer32", "Bits", "TimeTicks", "Gauge32", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
if mibBuilder.loadTexts: hh3cRS485.setContactInfo('Platform Team H3C Technologies Co., Ltd. Hai-Dian District Beijing P.R. China http://www.h3c.com Zip: 100085')
if mibBuilder.loadTexts: hh3cRS485.setDescription('The objects in this MIB module are used to manage RS485 interfaces, and manage sessions on them.')
...
if mibBuilder.loadTexts: hh3cRS485PropertiesTable.setDescription('Propertie table.')
...
if mibBuilder.loadTexts: hh3cRS485PropertiesEntry.setDescription('Propertie entry.')
...
if mibBuilder.loadTexts: hh3cRS485RawSessionNextIndex.setDescription('The next valid index of raw sessions, from 1 to 64, which session has been created. When there is no valid index left, it will return 0.')
...
if mibBuilder.loadTexts: hh3cRS485BaudRate.setDescription("The port's baud rate.")
...
if mibBuilder.loadTexts: hh3cRS485DataBits.setDescription("The port's number of data bits in a character.")
...
if mibBuilder.loadTexts: hh3cRS485Parity.setDescription("The port's sense of a character parity bit.")
...
if mibBuilder.loadTexts: hh3cRS485StopBits.setDescription("The port's number of stop bits.")
...
if mibBuilder.loadTexts: hh3cRS485FlowControl.setDescription("The port's type of input flow control. 'none' indicates no flow control at this level. 'hardware' indicates use of hardware signals. 'xonOrxoff' indicates use of software function.")
...
if mibBuilder.loadTexts: hh3cRS485TXCharacters.setDescription('The number of output characters for the port.')
...
if mibBuilder.loadTexts: hh3cRS485RXCharacters.setDescription('The number of input characters for the port.')
...
if mibBuilder.loadTexts: hh3cRS485TXErrCharacters.setDescription('The number of output error characters for the port.')
...
if mibBuilder.loadTexts: hh3cRS485RXErrCharacters.setDescription('The number of input error characters for the port.')
...
if mibBuilder.loadTexts: hh3cRS485ResetCharacters.setDescription('Reset the counters to zero, inlucding hh3cRS485TXCharacters, hh3cRS485RXCharacters, hh3cRS485TXErrCharacters and hh3cRS485RXErrCharacters.')
...
if mibBuilder.loadTexts: hh3cRS485RawSessionMaxNum.setDescription('The max number of raw sessions what we can support.')
...
if mibBuilder.loadTexts: hh3cRS485RawSessionTable.setDescription('RS485 raw session table. Data recieved from rs485 will be sent to the destination by raw sockets.')
...
if mibBuilder.loadTexts: hh3cRS485RawSessionEntry.setDescription('Parameters of a session, including remote IP address, remote port, local port, and so on.')
...
if mibBuilder.loadTexts: hh3cRS485SessionIndex.setDescription('Raw session index.')
...
if mibBuilder.loadTexts: hh3cRS485SessionType.setDescription('The type of a session. A session can use UDP socket, TCP socket as a client, or TCP socket as a server.')
...
if mibBuilder.loadTexts: hh3cRS485SessionAddType.setDescription('This object indicates the transport type of the address contained in hh3cRS485SessionRemoteIP object.')
...
if mibBuilder.loadTexts: hh3cRS485SessionRemoteIP.setDescription("The IP of remote entry. When session type is 'udp', this is the IP of the peer. When session type is 'tcpClient', this is the IP of the server . When session type is 'tcpServer', this is invalid, it will return 0. ")
...
if mibBuilder.loadTexts: hh3cRS485SessionRemotePort.setDescription("The port of remote entry. When session type is 'udp', this is port of the peer. When session type is 'tcpClient', this is the port of the server. When session type is 'tcpServer', this is invalid, it will return 0. ")
...
if mibBuilder.loadTexts: hh3cRS485SessionLocalPort.setDescription("Local socket port. When session type is 'udp', this is local UDP socket port. When session type is 'tcpClient', this is invalid, it will return 0. When session type is 'tcpServer', this is the local port which will be listened. ")
...
if mibBuilder.loadTexts: hh3cRS485SessionStatus.setDescription('The status column used for creating, modifying, and deleting instances of the columnar objects in raw session table.')
...
if mibBuilder.loadTexts: hh3cRS485RawSessionErrInfoTable.setDescription('Error infomation table. It is fail to create a session, management station can get infomation from this table.')
...
if mibBuilder.loadTexts: hh3cRS485RawSessionErrInfoEntry.setDescription('Error infomaition.')
...
if mibBuilder.loadTexts: hh3cRS485RawSessionErrInfo.setDescription("Error infomation string. When a response with 'noCreeation' for row creation in table hh3cRS485RawSessionTable, the management station should display this string to users, thus users can konw the reason.")
mibBuilder.exportSymbols("HH3C-RS485-MIB", hh3cRS485RawSessions=hh3cRS485RawSessions, hh3cRS485RawSessionNextIndex=hh3cRS485RawSessionNextIndex, hh3cRS485RawSessionMaxNum=hh3cRS485RawSessionMaxNum, hh3cRS485RawSessionEntry=hh3cRS485RawSessionEntry, PYSNMP_MODULE_ID=hh3cRS485, hh3cRS485SessionStatus=hh3cRS485SessionStatus, hh3cRS485PropertiesTable=hh3cRS485PropertiesTable, hh3cRS485SessionAddType=hh3cRS485SessionAddType, hh3cRS485TXCharacters=hh3cRS485TXCharacters, hh3cRS485RawSessionSummary=hh3cRS485RawSessionSummary, hh3cRS485RawSessionErrInfo=hh3cRS485RawSessionErrInfo, hh3cRS485SessionType=hh3cRS485SessionType, hh3cRS485DataBits=hh3cRS485DataBits, hh3cRS485SessionLocalPort=hh3cRS485SessionLocalPort, hh3cRS485BaudRate=hh3cRS485BaudRate, hh3cRS485RawSessionErrInfoTable=hh3cRS485RawSessionErrInfoTable, hh3cRS485ResetCharacters=hh3cRS485ResetCharacters, hh3cRS485=hh3cRS485, hh3cRS485TXErrCharacters=hh3cRS485TXErrCharacters, hh3cRS485Properties=hh3cRS485Properties, hh3cRS485RawSessionErrInfoEntry=hh3cRS485RawSessionErrInfoEntry, hh3cRS485PropertiesEntry=hh3cRS485PropertiesEntry, hh3cRS485SessionRemotePort=hh3cRS485SessionRemotePort, hh3cRS485FlowControl=hh3cRS485FlowControl, hh3cRS485RawSessionTable=hh3cRS485RawSessionTable, hh3cRS485SessionIndex=hh3cRS485SessionIndex, hh3cRS485RXErrCharacters=hh3cRS485RXErrCharacters, hh3cRS485RXCharacters=hh3cRS485RXCharacters, hh3cRS485StopBits=hh3cRS485StopBits, hh3cRS485SessionRemoteIP=hh3cRS485SessionRemoteIP, hh3cRS485Parity=hh3cRS485Parity)
