...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS-3620-52T-L3MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:44:56 2019
...
TOSType, HelloRange, UpToMaxAge, AreaID, DesignatedRouterPriority, PositiveInteger, RouterID, Status, Metric = mibBuilder.importSymbols("OSPF-MIB", "TOSType", "HelloRange", "UpToMaxAge", "AreaID", "DesignatedRouterPriority", "PositiveInteger", "RouterID", "Status", "Metric")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, MibIdentifier, TimeTicks, Bits, ModuleIdentity, Unsigned32, NotificationType, Counter64, iso, ObjectIdentity, Counter32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "MibIdentifier", "TimeTicks", "Bits", "ModuleIdentity", "Unsigned32", "NotificationType", "Counter64", "iso", "ObjectIdentity", "Counter32", "IpAddress")
DisplayString, TimeStamp, MacAddress, TruthValue, PhysAddress, TextualConvention, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TimeStamp", "MacAddress", "TruthValue", "PhysAddress", "TextualConvention", "RowStatus")
...
swL3IpCtrlIpDhcpOption12State = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 4, 3, 2, 1, 3, 1, 22), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpDhcpOption12HostName = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 4, 3, 2, 1, 3, 1, 23), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 63))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 4, 3, 2, 1, 3, 1, 28), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigDefault = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 4, 3, 2, 1, 3, 1, 29), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 4, 3, 2, 1, 3, 1, 30), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientPDRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 4, 3, 2, 1, 3, 1, 31), TruthValue()).setMaxAccess("readwrite")
...
swL3ospfIfDistributeListInType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 4, 3, 8, 1, 24), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
swL3ospfIfBfdStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 4, 3, 8, 1, 26), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("disabled", 1), ("enabled", 2)))).setMaxAccess("readwrite")
...
swL3VrrpOperBfdPeerAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 4, 3, 14, 1, 1, 17), IpAddress().clone(hexValue="00000000")).setMaxAccess("readcreate")
...
swL3RIPInboundRouteFilterType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 4, 3, 19, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS-3620-52T-L3MGMT-MIB", swL3IpCtrlDhcpv6ClientPDState=swL3IpCtrlDhcpv6ClientPDState, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3OspfECMPState=swL3OspfECMPState, swL3Ipv6Address=swL3Ipv6Address, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3RIPTimerMgmt=swL3RIPTimerMgmt, swL3LoopBackIpCtrlRowStatus=swL3LoopBackIpCtrlRowStatus, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3DevMgmt=swL3DevMgmt, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3OspfHostTOS=swL3OspfHostTOS, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3Md5RowStatus=swL3Md5RowStatus, swL3IpCtrlDhcpv6ClientPDRapidCommit=swL3IpCtrlDhcpv6ClientPDRapidCommit, swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3IpCtrlIpv4AdminState=swL3IpCtrlIpv4AdminState, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3RIPUpdateTime=swL3RIPUpdateTime, swL3RoutePreferenceEBGP=swL3RoutePreferenceEBGP, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3LoopBackIpCtrlIpAddr=swL3LoopBackIpCtrlIpAddr, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3Route6RedistriTable=swL3Route6RedistriTable, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3Ipv6DHCPv6CPDAddrCtrlState=swL3Ipv6DHCPv6CPDAddrCtrlState, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3VrrpOperBfdPeerAddr=swL3VrrpOperBfdPeerAddr, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3IpCtrlIpv6AutoConfigDefault=swL3IpCtrlIpv6AutoConfigDefault, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3OspfHostEntry=swL3OspfHostEntry, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3ospfIfType=swL3ospfIfType, swL3IpCtrlState=swL3IpCtrlState, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3Route6RedistriType=swL3Route6RedistriType, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3DevCtrl=swL3DevCtrl, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3Route6RedistriDstProtocol=swL3Route6RedistriDstProtocol, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3LoopBackIpCtrlIfIndex=swL3LoopBackIpCtrlIfIndex, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3LoopBackIpCtrlIpSubnetMask=swL3LoopBackIpCtrlIpSubnetMask, swL3IpCtrlMode=swL3IpCtrlMode, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3ospfIfMetric=swL3ospfIfMetric, swL3Ipv6DHCPv6CPDAddrCtrlEntry=swL3Ipv6DHCPv6CPDAddrCtrlEntry, swL3ospfAreaType=swL3ospfAreaType, swL3LoopBackIpCtrlEntry=swL3LoopBackIpCtrlEntry, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3OspfHostStatus=swL3OspfHostStatus, swL3ospfIfState=swL3ospfIfState, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3RIPInboundRouteFilterType=swL3RIPInboundRouteFilterType, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3RouteRedistriRouteMapName=swL3RouteRedistriRouteMapName, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3RoutePreferenceIBGP=swL3RoutePreferenceIBGP, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3RelayDnsState=swL3RelayDnsState, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3LoopBackIpCtrlAdminState=swL3LoopBackIpCtrlAdminState, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3IpCtrlTable=swL3IpCtrlTable, swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=swL3Ipv6DHCPv6CPDAddrCtrlPrefixName, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3ospfIfEvents=swL3ospfIfEvents, swL3ospfIfDistributeListInType=swL3ospfIfDistributeListInType, NetAddress=NetAddress, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3IpMgmt=swL3IpMgmt, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3ospfIfDemand=swL3ospfIfDemand, swL3ospfIfBfdStatus=swL3ospfIfBfdStatus, NodeAddress=NodeAddress, swL3OspfHostTable=swL3OspfHostTable, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3IpCtrlDhcpv6ClientPDPrefix=swL3IpCtrlDhcpv6ClientPDPrefix, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3RIPInboundRouteFilterName=swL3RIPInboundRouteFilterName, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3ospfAreaId=swL3ospfAreaId, swL3RouteRedistriType=swL3RouteRedistriType, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3IpStaticRouteTunnelInterfaceName=swL3IpStaticRouteTunnelInterfaceName, swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName, swL3MgmtMIB=swL3MgmtMIB, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3Route6RedistriRowStatus=swL3Route6RedistriRowStatus, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3IpCtrlIpDirectedBroadcastState=swL3IpCtrlIpDirectedBroadcastState, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3VrrpOperState=swL3VrrpOperState, swL3IpStaticRouteTunnelEntry=swL3IpStaticRouteTunnelEntry, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, VrId=VrId, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3Route6RedistriSrcProtocol=swL3Route6RedistriSrcProtocol, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3Ipv6DHCPv6CPDAddrCtrlTable=swL3Ipv6DHCPv6CPDAddrCtrlTable, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3VrrpOperTable=swL3VrrpOperTable, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3IpCtrlDhcpv6ClientPDPrefixLen=swL3IpCtrlDhcpv6ClientPDPrefixLen, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3ospfIfDistributeListInName=swL3ospfIfDistributeListInName, swL3RIPInboundRouteFilterEntry=swL3RIPInboundRouteFilterEntry, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3IpStaticRouteTunnelRowStatus=swL3IpStaticRouteTunnelRowStatus, swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3OspfDefInfoOrigMetric=swL3OspfDefInfoOrigMetric, swL3IpCtrlLocalProxyArp=swL3IpCtrlLocalProxyArp, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3IpCtrlIpv6AdminState=swL3IpCtrlIpv6AdminState, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3IpCtrlDhcpv6ClientPDPrefixName=swL3IpCtrlDhcpv6ClientPDPrefixName, swL3LoopBackIpCtrlTable=swL3LoopBackIpCtrlTable, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3OspfDefInfoOrigMetricType=swL3OspfDefInfoOrigMetricType, swL3RIPInboundRouteFilterIfIpAddress=swL3RIPInboundRouteFilterIfIpAddress, swL3IpCtrlIpv6AutoConfigState=swL3IpCtrlIpv6AutoConfigState, swL3Route6RedistriEntry=swL3Route6RedistriEntry, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3Route6RedistriMetric=swL3Route6RedistriMetric, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3IpCtrlDhcpv6ClientRapidCommit=swL3IpCtrlDhcpv6ClientRapidCommit, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3RoutePreferenceDefault=swL3RoutePreferenceDefault, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3OspfDefInfoOriginate=swL3OspfDefInfoOriginate, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3ospfIfTable=swL3ospfIfTable, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3RIPGarbageCollectionTime=swL3RIPGarbageCollectionTime, swL3OspfDefInfoOrigMgmt=swL3OspfDefInfoOrigMgmt, swL3LoopBackIpCtrlInterfaceName=swL3LoopBackIpCtrlInterfaceName, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3RelayMgmt=swL3RelayMgmt, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag)
mibBuilder.exportSymbols("DGS-3620-52T-L3MGMT-MIB", swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3ospfAreaTable=swL3ospfAreaTable, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3Md5Key=swL3Md5Key, swL3Md5KeyId=swL3Md5KeyId, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3RIPInboundRouteFilterTable=swL3RIPInboundRouteFilterTable, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3Md5Entry=swL3Md5Entry, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3IpStaticRouteTunnelTable=swL3IpStaticRouteTunnelTable, swL3RoutePreference=swL3RoutePreference, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3Md5Table=swL3Md5Table, swL3OspfHostMetric=swL3OspfHostMetric, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3ospfIfEntry=swL3ospfIfEntry, swL3RIPTimeOutTime=swL3RIPTimeOutTime, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask)
