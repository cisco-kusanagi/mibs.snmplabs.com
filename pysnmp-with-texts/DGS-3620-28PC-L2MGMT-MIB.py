...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS-3620-28PC-L2MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:44:21 2019
...
MibIdentifier, Bits, Unsigned32, NotificationType, TimeTicks, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, ObjectIdentity, iso, Gauge32, Counter64, Integer32, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "Unsigned32", "NotificationType", "TimeTicks", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "ObjectIdentity", "iso", "Gauge32", "Counter64", "Integer32", "IpAddress")
...
swL2PortInfoErrorDisabled = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 3, 2, 3, 1, 1, 8), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3, 4, 5, 6))).clone(namedValues=NamedValues(("none", 0), ("storm", 1), ("stp-lbd", 2), ("ctp-lbd", 3), ("ddm", 4), ("bpdu-protection", 5), ("unknow", 6)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("DGS-3620-28PC-L2MGMT-MIB", swL2DevCtrlWeb=swL2DevCtrlWeb, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2TrunkVLANState=swL2TrunkVLANState, swL2VlanPortInfoEntry=swL2VlanPortInfoEntry, swL2TrafficSegPort=swL2TrafficSegPort, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swL2VlanPortInfoVid=swL2VlanPortInfoVid, swL2MirrorGroupTable=swL2MirrorGroupTable, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2DevCtrl=swL2DevCtrl, swL2MirrorGroupRowStatus=swL2MirrorGroupRowStatus, swl2NotificationBidings=swl2NotificationBidings, swL2macNotifyInfo=swL2macNotifyInfo, swL2VlanStaticEntry=swL2VlanStaticEntry, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swL2PVIDAutoAssignmentState=swL2PVIDAutoAssignmentState, swL2MACNotifyState=swL2MACNotifyState, swL2TrunkMgmt=swL2TrunkMgmt, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2VlanPortInfoPortRole=swL2VlanPortInfoPortRole, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2PortCtrlTable=swL2PortCtrlTable, swL2MirrorGroupEntry=swL2MirrorGroupEntry, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2MulticastFilterVlanMode=swL2MulticastFilterVlanMode, swL2DevMgmt=swL2DevMgmt, swL2VlanPortInfoPortIndex=swL2VlanPortInfoPortIndex, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2MirrorGroupLogicTargetPort=swL2MirrorGroupLogicTargetPort, swL2DevCtrlCFMPortTable=swL2DevCtrlCFMPortTable, swL2PortJumboFrameCtrlPortState=swL2PortJumboFrameCtrlPortState, swL2PortCtrlJumboFrameMaxSize=swL2PortCtrlJumboFrameMaxSize, swL2TrunkVLANEntry=swL2TrunkVLANEntry, PortList=PortList, swL2PortCounterCtrlPortIndex=swL2PortCounterCtrlPortIndex, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2PortInfoTable=swL2PortInfoTable, swL2MirrorPortState=swL2MirrorPortState, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swL2DevCtrlCFMPortIndex=swL2DevCtrlCFMPortIndex, swL2macNotificationSeverity=swL2macNotificationSeverity, swL2DevCtrlCFMMepMode=swL2DevCtrlCFMMepMode, swL2Notify=swL2Notify, swL2DevCtrlCFMMaTable=swL2DevCtrlCFMMaTable, swL2TrunkMember=swL2TrunkMember, swL2MirrorMgmt=swL2MirrorMgmt, VlanId=VlanId, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2PortInfoType=swL2PortInfoType, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, IANAifMauAutoNegCapBits=IANAifMauAutoNegCapBits, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2VlanIndex=swL2VlanIndex, swL2DevCtrlIpAutoconfig=swL2DevCtrlIpAutoconfig, swL2PortInfoUnitID=swL2PortInfoUnitID, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2VLANAdvertisement=swL2VLANAdvertisement, swL2MulticastFilterMode=swL2MulticastFilterMode, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2MulticastFilterModeVlanEntry=swL2MulticastFilterModeVlanEntry, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2PortInfoErrorDisabled=swL2PortInfoErrorDisabled, swL2PortCtrlLearningState=swL2PortCtrlLearningState, swL2TrunkState=swL2TrunkState, swL2DevCtrlVLANTrunkState=swL2DevCtrlVLANTrunkState, swL2DevCtrlCFMMepEntry=swL2DevCtrlCFMMepEntry, swL2TrunkType=swL2TrunkType, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2DevCtrlCFMState=swL2DevCtrlCFMState, swL2PortInfoMediumType=swL2PortInfoMediumType, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2MulticastFilterModeVlanTable=swL2MulticastFilterModeVlanTable, swL2NotifyMgmt=swL2NotifyMgmt, swL2DevCtrlAsymVlanState=swL2DevCtrlAsymVlanState, swL2TrafficSegTable=swL2TrafficSegTable, swL2DevCtrlCFMPortState=swL2DevCtrlCFMPortState, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2NotifyPrefix=swL2NotifyPrefix, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2PortCounterCtrlEntry=swL2PortCounterCtrlEntry, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2DevCtrlCFMMepTable=swL2DevCtrlCFMMepTable, swL2PortCounterCtrlTable=swL2PortCounterCtrlTable, swL2PortJumboFrameCtrlTable=swL2PortJumboFrameCtrlTable, swL2MirrorGroupID=swL2MirrorGroupID, swL2macNotification=swL2macNotification, swL2MgmtMIB=swL2MgmtMIB, swL2NniGvrpBpduAddress=swL2NniGvrpBpduAddress, swL2DevCtrlCFMPortEntry=swL2DevCtrlCFMPortEntry, swL2DevCtrlCFMMaMode=swL2DevCtrlCFMMaMode, swL2PortCtrlMDIXState=swL2PortCtrlMDIXState, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2PortCtrlMediumType=swL2PortCtrlMediumType, swL2DevCtrlSnmpTrapState=swL2DevCtrlSnmpTrapState, swL2VLANMgmt=swL2VLANMgmt, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2TrunkVLANPort=swL2TrunkVLANPort, swL2MulticastFilterVid=swL2MulticastFilterVid, swL2VlanPortInfoTable=swL2VlanPortInfoTable, swL2DevCtrlCFM=swL2DevCtrlCFM, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2TrunkIndex=swL2TrunkIndex, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2VlanStaticTable=swL2VlanStaticTable, swL2MirrorGroupState=swL2MirrorGroupState, swL2MirrorGroupPortSourceIngress=swL2MirrorGroupPortSourceIngress, swL2PortMgmt=swL2PortMgmt, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2PortJumboFrameCtrlEntry=swL2PortJumboFrameCtrlEntry, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2DevInfo=swL2DevInfo, swL2DevCtrlCFMMaEntry=swL2DevCtrlCFMMaEntry, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2MgmtMIBTraps=swL2MgmtMIBTraps, MacAddress=MacAddress, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2TrunkVLANTable=swL2TrunkVLANTable, swL2MirrorGroupPortSourceEngress=swL2MirrorGroupPortSourceEngress, swL2PortInfoEntry=swL2PortInfoEntry, swL2PortSecurityViolationSeverity=swL2PortSecurityViolationSeverity, swL2DevAlarm=swL2DevAlarm, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2PortCounterClearCtrl=swL2PortCounterClearCtrl, swL2NotifFirmware=swL2NotifFirmware, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2PortJumboFrameCtrlPortIndex=swL2PortJumboFrameCtrlPortIndex, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort)
