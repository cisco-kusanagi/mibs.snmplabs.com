...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS-3620-28SC-L3MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:44:34 2019
...
PositiveInteger, TOSType, RouterID, HelloRange, UpToMaxAge, AreaID, DesignatedRouterPriority, Metric, Status = mibBuilder.importSymbols("OSPF-MIB", "PositiveInteger", "TOSType", "RouterID", "HelloRange", "UpToMaxAge", "AreaID", "DesignatedRouterPriority", "Metric", "Status")
ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup")
Unsigned32, iso, Counter64, Counter32, IpAddress, Integer32, MibIdentifier, NotificationType, TimeTicks, ObjectIdentity, Bits, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "iso", "Counter64", "Counter32", "IpAddress", "Integer32", "MibIdentifier", "NotificationType", "TimeTicks", "ObjectIdentity", "Bits", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity")
DisplayString, TextualConvention, TruthValue, PhysAddress, RowStatus, MacAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TextualConvention", "TruthValue", "PhysAddress", "RowStatus", "MacAddress", "TimeStamp")
...
swL3IpCtrlIpDhcpOption12State = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 2, 3, 2, 1, 3, 1, 22), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpDhcpOption12HostName = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 2, 3, 2, 1, 3, 1, 23), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 63))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 2, 3, 2, 1, 3, 1, 28), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigDefault = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 2, 3, 2, 1, 3, 1, 29), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 2, 3, 2, 1, 3, 1, 30), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientPDRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 2, 3, 2, 1, 3, 1, 31), TruthValue()).setMaxAccess("readwrite")
...
swL3ospfIfDistributeListInType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 2, 3, 8, 1, 24), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
swL3ospfIfBfdStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 2, 3, 8, 1, 26), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("disabled", 1), ("enabled", 2)))).setMaxAccess("readwrite")
...
swL3VrrpOperBfdPeerAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 2, 3, 14, 1, 1, 17), IpAddress().clone(hexValue="00000000")).setMaxAccess("readcreate")
...
swL3RIPInboundRouteFilterType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 118, 2, 3, 19, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS-3620-28SC-L3MGMT-MIB", swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3Md5KeyId=swL3Md5KeyId, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3ospfIfMetric=swL3ospfIfMetric, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3OspfHostStatus=swL3OspfHostStatus, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3Route6RedistriMetric=swL3Route6RedistriMetric, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, NetAddress=NetAddress, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3RIPTimeOutTime=swL3RIPTimeOutTime, swL3Ipv6DHCPv6CPDAddrCtrlTable=swL3Ipv6DHCPv6CPDAddrCtrlTable, swL3ospfIfBfdStatus=swL3ospfIfBfdStatus, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3RIPInboundRouteFilterEntry=swL3RIPInboundRouteFilterEntry, swL3OspfDefInfoOrigMetricType=swL3OspfDefInfoOrigMetricType, swL3Route6RedistriType=swL3Route6RedistriType, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3Ipv6DHCPv6CPDAddrCtrlEntry=swL3Ipv6DHCPv6CPDAddrCtrlEntry, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3Route6RedistriTable=swL3Route6RedistriTable, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3RouteRedistriRouteMapName=swL3RouteRedistriRouteMapName, swL3RIPTimerMgmt=swL3RIPTimerMgmt, swL3VrrpOperTable=swL3VrrpOperTable, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3OspfHostTOS=swL3OspfHostTOS, swL3VrrpOperState=swL3VrrpOperState, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3Md5Key=swL3Md5Key, swL3LoopBackIpCtrlIfIndex=swL3LoopBackIpCtrlIfIndex, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3RIPInboundRouteFilterName=swL3RIPInboundRouteFilterName, swL3IpCtrlIpv6AutoConfigDefault=swL3IpCtrlIpv6AutoConfigDefault, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3IpStaticRouteTunnelTable=swL3IpStaticRouteTunnelTable, swL3ospfIfEvents=swL3ospfIfEvents, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3RelayDnsState=swL3RelayDnsState, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3Route6RedistriSrcProtocol=swL3Route6RedistriSrcProtocol, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, NodeAddress=NodeAddress, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3RoutePreference=swL3RoutePreference, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3OspfHostMetric=swL3OspfHostMetric, swL3IpCtrlIpDirectedBroadcastState=swL3IpCtrlIpDirectedBroadcastState, swL3IpStaticRouteTunnelRowStatus=swL3IpStaticRouteTunnelRowStatus, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3ospfIfDistributeListInName=swL3ospfIfDistributeListInName, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3IpCtrlDhcpv6ClientPDPrefixLen=swL3IpCtrlDhcpv6ClientPDPrefixLen, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3ospfIfState=swL3ospfIfState, swL3Ipv6Address=swL3Ipv6Address, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3DevMgmt=swL3DevMgmt, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3IpCtrlDhcpv6ClientRapidCommit=swL3IpCtrlDhcpv6ClientRapidCommit, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3RIPGarbageCollectionTime=swL3RIPGarbageCollectionTime, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3OspfHostEntry=swL3OspfHostEntry, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3IpMgmt=swL3IpMgmt, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3OspfECMPState=swL3OspfECMPState, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3Route6RedistriRowStatus=swL3Route6RedistriRowStatus, swL3DevCtrl=swL3DevCtrl, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3MgmtMIB=swL3MgmtMIB, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3ospfAreaType=swL3ospfAreaType, swL3LoopBackIpCtrlTable=swL3LoopBackIpCtrlTable, swL3LoopBackIpCtrlRowStatus=swL3LoopBackIpCtrlRowStatus, swL3LoopBackIpCtrlEntry=swL3LoopBackIpCtrlEntry, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=swL3Ipv6DHCPv6CPDAddrCtrlPrefixName, swL3OspfHostTable=swL3OspfHostTable, swL3ospfIfEntry=swL3ospfIfEntry, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3Md5RowStatus=swL3Md5RowStatus, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3RelayMgmt=swL3RelayMgmt, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3RoutePreferenceIBGP=swL3RoutePreferenceIBGP, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3IpStaticRouteTunnelEntry=swL3IpStaticRouteTunnelEntry, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3LoopBackIpCtrlIpAddr=swL3LoopBackIpCtrlIpAddr, swL3IpCtrlTable=swL3IpCtrlTable, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3Ipv6DHCPv6CPDAddrCtrlState=swL3Ipv6DHCPv6CPDAddrCtrlState, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3LoopBackIpCtrlAdminState=swL3LoopBackIpCtrlAdminState, VrId=VrId, swL3Md5Table=swL3Md5Table, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3RIPInboundRouteFilterIfIpAddress=swL3RIPInboundRouteFilterIfIpAddress, swL3Md5Entry=swL3Md5Entry, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3RIPInboundRouteFilterTable=swL3RIPInboundRouteFilterTable, swL3VrrpOperBfdPeerAddr=swL3VrrpOperBfdPeerAddr, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3IpCtrlMode=swL3IpCtrlMode, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3IpCtrlIpv6AutoConfigState=swL3IpCtrlIpv6AutoConfigState, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3IpCtrlDhcpv6ClientPDRapidCommit=swL3IpCtrlDhcpv6ClientPDRapidCommit, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3ospfIfDistributeListInType=swL3ospfIfDistributeListInType, swL3Route6RedistriEntry=swL3Route6RedistriEntry, swL3IpCtrlIpv4AdminState=swL3IpCtrlIpv4AdminState, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3RoutePreferenceDefault=swL3RoutePreferenceDefault, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3RoutePreferenceEBGP=swL3RoutePreferenceEBGP, swL3RIPInboundRouteFilterType=swL3RIPInboundRouteFilterType, swL3IpCtrlDhcpv6ClientPDPrefix=swL3IpCtrlDhcpv6ClientPDPrefix, swL3ospfAreaTable=swL3ospfAreaTable, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3ospfAreaId=swL3ospfAreaId, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName, swL3ospfIfTable=swL3ospfIfTable, swL3LoopBackIpCtrlInterfaceName=swL3LoopBackIpCtrlInterfaceName, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3OspfDefInfoOrigMgmt=swL3OspfDefInfoOrigMgmt, swL3IpCtrlLocalProxyArp=swL3IpCtrlLocalProxyArp, swL3IpCtrlDhcpv6ClientPDState=swL3IpCtrlDhcpv6ClientPDState, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3IpStaticRouteTunnelInterfaceName=swL3IpStaticRouteTunnelInterfaceName, swL3IpFdbInfoType=swL3IpFdbInfoType)
mibBuilder.exportSymbols("DGS-3620-28SC-L3MGMT-MIB", swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3ospfIfDemand=swL3ospfIfDemand, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3OspfDefInfoOriginate=swL3OspfDefInfoOriginate, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3IpCtrlDhcpv6ClientPDPrefixName=swL3IpCtrlDhcpv6ClientPDPrefixName, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3RIPUpdateTime=swL3RIPUpdateTime, swL3IpCtrlState=swL3IpCtrlState, swL3OspfDefInfoOrigMetric=swL3OspfDefInfoOrigMetric, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3Route6RedistriDstProtocol=swL3Route6RedistriDstProtocol, swL3IpCtrlIpv6AdminState=swL3IpCtrlIpv6AdminState, swL3LoopBackIpCtrlIpSubnetMask=swL3LoopBackIpCtrlIpSubnetMask, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3ospfIfType=swL3ospfIfType, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3RouteRedistriType=swL3RouteRedistriType)
