...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: cyanTCModule.setRevisionsDescriptions(('Release 6.0 build 1416362081',))
...
if mibBuilder.loadTexts: cyanTCModule.setContactInfo(' E-mail: support@cyaninc.com Postal: Cyan, Inc. 1390 N. McDowell Blvd., # G-327 Petaluma, CA 94954 USA Tel: +1-707-735-2300')
if mibBuilder.loadTexts: cyanTCModule.setDescription('MIB module for Textual Conventions')
class CyanActvStdbyTc(TextualConvention, Integer32):
    description = 'CyanActvStdbyTc'
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(0, 1))
    namedValues = NamedValues(("stdby", 0), ("active", 1))

class CyanAdminStateTc(TextualConvention, Integer32):
    description = 'CyanAdminStateTc'
    status = 'current'
...
class CyanAugStructureTc(TextualConvention, Integer32):
    description = 'CyanAugStructureTc'
    status = 'current'
...
class CyanLoopbackControlTc(TextualConvention, Integer32):
    description = 'CyanLoopbackControlTc'
    status = 'current'
...
class CyanSecServiceStateTc(TextualConvention, Bits):
    description = 'CyanSecServiceStateTc'
    status = 'current'
...
class CyanTPConnectionStateTc(TextualConvention, Integer32):
    description = 'CyanTPConnectionStateTc'
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4))
...
class CyanXGOSignalTypeTc(TextualConvention, Integer32):
    description = 'CyanXGOSignalTypeTc'
    status = 'current'
...
class CyanXcvrConnectorCodeTc(TextualConvention, Integer32):
    description = 'CyanXcvrConnectorCodeTc'
    status = 'current'
...
class CyanXcvrIdentifierTc(TextualConvention, Integer32):
    description = 'CyanXcvrIdentifierTc'
    status = 'current'
...
mibBuilder.exportSymbols("CYAN-TC-MIB", CyanOpStateQualTc=CyanOpStateQualTc, CyanFecModeTc=CyanFecModeTc, CyanLayerRateTc=CyanLayerRateTc, CyanFppSubTypeTc=CyanFppSubTypeTc, CyanXcvrIdentifierTc=CyanXcvrIdentifierTc, CyanLEDTc=CyanLEDTc, CyanNimTc=CyanNimTc, CyanPowerClassTc=CyanPowerClassTc, CyanXcvrConnectorCodeTc=CyanXcvrConnectorCodeTc, CyanTPConnectionStateTc=CyanTPConnectionStateTc, CyanGfpUpiTc=CyanGfpUpiTc, CyanOpStateTc=CyanOpStateTc, CyanActvStdbyTc=CyanActvStdbyTc, CyanTimezoneTc=CyanTimezoneTc, CyanChannelIdTc=CyanChannelIdTc, CyanRelayTc=CyanRelayTc, CyanNoYesTc=CyanNoYesTc, CyanAdminStateTc=CyanAdminStateTc, CyanOffOnTc=CyanOffOnTc, CyanEnDisabledTc=CyanEnDisabledTc, CyanSecServiceStateTc=CyanSecServiceStateTc, CyanSsBitsTc=CyanSsBitsTc, CyanOpuPayloadTypeTc=CyanOpuPayloadTypeTc, CyanWdmTypeTc=CyanWdmTypeTc, CyanFppTypeTc=CyanFppTypeTc, CyanAugStructureTc=CyanAugStructureTc, CyanXGOSignalTypeTc=CyanXGOSignalTypeTc, CyanSdhSnSignalLabelTc=CyanSdhSnSignalLabelTc, CyanTxControlTc=CyanTxControlTc, CyanNationalizationTc=CyanNationalizationTc, cyanTCModule=cyanTCModule, CyanLoopbackControlTc=CyanLoopbackControlTc, PYSNMP_MODULE_ID=cyanTCModule)
