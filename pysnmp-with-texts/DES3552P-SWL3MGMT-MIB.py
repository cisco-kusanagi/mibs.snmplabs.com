...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DES3552P-SWL3MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:41:19 2019
...
Metric, TOSType, UpToMaxAge, DesignatedRouterPriority, PositiveInteger, HelloRange, RouterID, Status, AreaID = mibBuilder.importSymbols("OSPF-MIB", "Metric", "TOSType", "UpToMaxAge", "DesignatedRouterPriority", "PositiveInteger", "HelloRange", "RouterID", "Status", "AreaID")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
Unsigned32, Counter64, ObjectIdentity, Counter32, Bits, NotificationType, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, Gauge32, ModuleIdentity, TimeTicks, MibIdentifier, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Counter64", "ObjectIdentity", "Counter32", "Bits", "NotificationType", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "Gauge32", "ModuleIdentity", "TimeTicks", "MibIdentifier", "IpAddress")
TruthValue, TextualConvention, PhysAddress, MacAddress, TimeStamp, RowStatus, DisplayString = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "TextualConvention", "PhysAddress", "MacAddress", "TimeStamp", "RowStatus", "DisplayString")
...
mibBuilder.exportSymbols("DES3552P-SWL3MGMT-MIB", swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3ospfIfState=swL3ospfIfState, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3OspfHostTable=swL3OspfHostTable, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3RelayDhcpCtrlEntry=swL3RelayDhcpCtrlEntry, swL3ospfIfTable=swL3ospfIfTable, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, NetAddress=NetAddress, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3RelayDnsState=swL3RelayDnsState, swL3Md5Key=swL3Md5Key, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3ospfAreaType=swL3ospfAreaType, swL3Md5KeyId=swL3Md5KeyId, swL3DHCPv6RelayMgmt=swL3DHCPv6RelayMgmt, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3Dhcpv6RelayInfoInterfaceName=swL3Dhcpv6RelayInfoInterfaceName, swL3DevMgmt=swL3DevMgmt, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3LocalRouteIPv6GlobalState=swL3LocalRouteIPv6GlobalState, swL3RelayDhcpHopCount=swL3RelayDhcpHopCount, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3ospfIfEvents=swL3ospfIfEvents, swL3RoutePreference=swL3RoutePreference, swL3Dhcpv6RelayInfoRowStatus=swL3Dhcpv6RelayInfoRowStatus, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3IpStaticRouteCost=swL3IpStaticRouteCost, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3RelayDhcpOption82Policy=swL3RelayDhcpOption82Policy, swL3IpCtrlProxyArpLocalState=swL3IpCtrlProxyArpLocalState, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3Ipv6Address=swL3Ipv6Address, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3ospfAreaId=swL3ospfAreaId, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3RelayDhcpState=swL3RelayDhcpState, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3IpMgmt=swL3IpMgmt, swL3RelayDhcpOption82CheckState=swL3RelayDhcpOption82CheckState, swL3Dhcpv6RelayInfoServerInterfaceName=swL3Dhcpv6RelayInfoServerInterfaceName, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3LocalRouteIPv4GlobalState=swL3LocalRouteIPv4GlobalState, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3Dhcpv6RelayCtrlInterfaceName=swL3Dhcpv6RelayCtrlInterfaceName, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3Md5Entry=swL3Md5Entry, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3OspfHostEntry=swL3OspfHostEntry, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3RelayDhcpMgmt=swL3RelayDhcpMgmt, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3OspfHostTOS=swL3OspfHostTOS, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3RelayDhcpCtrlInterfaceName=swL3RelayDhcpCtrlInterfaceName, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, VrId=VrId, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3MgmtMIB=swL3MgmtMIB, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3Md5RowStatus=swL3Md5RowStatus, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, NodeAddress=NodeAddress, swL3Dhcpv6RelayHopCount=swL3Dhcpv6RelayHopCount, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3RelayDhcpCtrlTable=swL3RelayDhcpCtrlTable, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3IpCtrlIpv6AdminState=swL3IpCtrlIpv6AdminState, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3Md5Table=swL3Md5Table, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3VrrpOperTable=swL3VrrpOperTable, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3Ipv6AddressCtrlAddressType=swL3Ipv6AddressCtrlAddressType, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3ospfIfEntry=swL3ospfIfEntry, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3DevCtrl=swL3DevCtrl, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3RouteRedistriType=swL3RouteRedistriType, swL3Dhcpv6RelayCtrlState=swL3Dhcpv6RelayCtrlState, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3ospfIfMetric=swL3ospfIfMetric, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3IpCtrlMgmt=swL3IpCtrlMgmt, Ipv6Address=Ipv6Address, swL3Dhcpv6RelayCtrlTable=swL3Dhcpv6RelayCtrlTable, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3ospfIfDemand=swL3ospfIfDemand, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3DevCtrlDHCPAutoConfigState=swL3DevCtrlDHCPAutoConfigState, swL3OspfECMPState=swL3OspfECMPState, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3Dhcpv6RelayInfoTable=swL3Dhcpv6RelayInfoTable, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3IpCtrlState=swL3IpCtrlState, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3RelayDhcpTimeThreshold=swL3RelayDhcpTimeThreshold, swL3VrrpOperState=swL3VrrpOperState, swL3Dhcpv6RelayInfoEntry=swL3Dhcpv6RelayInfoEntry, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3OspfHostStatus=swL3OspfHostStatus, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3RelayDhcpCtrlState=swL3RelayDhcpCtrlState, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3OspfHostMetric=swL3OspfHostMetric, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3RelayDhcpOption82State=swL3RelayDhcpOption82State, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3LocalRouteMgmt=swL3LocalRouteMgmt, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3IpCtrlIpv4AdminState=swL3IpCtrlIpv4AdminState, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3ospfAreaTable=swL3ospfAreaTable, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3RelayMgmt=swL3RelayMgmt, swL3RelayDhcpCtrlServer=swL3RelayDhcpCtrlServer, swL3IpCtrlTable=swL3IpCtrlTable, swL3Dhcpv6RelayInfoServerAddress=swL3Dhcpv6RelayInfoServerAddress, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3ospfIfType=swL3ospfIfType, swL3Dhcpv6RelayCtrlEntry=swL3Dhcpv6RelayCtrlEntry, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3IpCtrlMode=swL3IpCtrlMode, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr)
mibBuilder.exportSymbols("DES3552P-SWL3MGMT-MIB", swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit)
