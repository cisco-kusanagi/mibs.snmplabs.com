...
# Produced by pysmi-0.3.4 at Wed May  1 12:56:03 2019
...
ModuleIdentity, Bits, Counter64, NotificationType, IpAddress, Gauge32, ObjectIdentity, Integer32, TimeTicks, Unsigned32, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Bits", "Counter64", "NotificationType", "IpAddress", "Gauge32", "ObjectIdentity", "Integer32", "TimeTicks", "Unsigned32", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32")
...
mibBuilder.exportSymbols("Dell-JUMBOFRAMES-MIB", PYSNMP_MODULE_ID=rlJumboFrames, rlJumboFramesCurrentStatus=rlJumboFramesCurrentStatus, rlJumboFrames=rlJumboFrames, rlJumboFramesStatusAfterReset=rlJumboFramesStatusAfterReset)
