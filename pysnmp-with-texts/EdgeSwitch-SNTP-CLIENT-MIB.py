...
# Produced by pysmi-0.3.4 at Wed May  1 13:10:59 2019
...
Counter64, NotificationType, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, ModuleIdentity, TimeTicks, Unsigned32, ObjectIdentity, MibIdentifier, Counter32, IpAddress, Gauge32, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "NotificationType", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "ModuleIdentity", "TimeTicks", "Unsigned32", "ObjectIdentity", "MibIdentifier", "Counter32", "IpAddress", "Gauge32", "Integer32")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: agentSntpClientMIB.setRevisionsDescriptions(('sntp source interface object added.', 'Postal address updated.', 'Ubiquiti branding related changes.', 'Initial version of this MIB module.',))
...
if mibBuilder.loadTexts: agentSntpClientMIB.setDescription('This MIB module defines a portion of the SNMP MIB under the Broadcom Inc enterprise OID pertaining to SNTP client configuration and statistical collection.')
...
if mibBuilder.loadTexts: agentSntpClientDeviceGroup.setDescription('A collection of objects providing device level control of an SNTP client on EdgeSwitch enabled devices.')
...
mibBuilder.exportSymbols("EdgeSwitch-SNTP-CLIENT-MIB", agentSntpClientConformance=agentSntpClientConformance, agentSntpClientVersion=agentSntpClientVersion, agentSntpClientBroadcastGroup=agentSntpClientBroadcastGroup, agentSntpClientUnicastPollTimeout=agentSntpClientUnicastPollTimeout, agentSntpClientMode=agentSntpClientMode, PYSNMP_MODULE_ID=agentSntpClientMIB, agentSntpClientDeviceGroup=agentSntpClientDeviceGroup, agentSntpClientCompliance=agentSntpClientCompliance, agentSntpClientUcastServerAddress=agentSntpClientUcastServerAddress, agentSntpClient=agentSntpClient, agentSntpClientUcastServerEntry=agentSntpClientUcastServerEntry, agentSntpClientServerAddressType=agentSntpClientServerAddressType, agentSntpClientMIB=agentSntpClientMIB, agentSntpClientLastAttemptTime=agentSntpClientLastAttemptTime, agentSntpClientServerRefClkId=agentSntpClientServerRefClkId, agentSntpClientUcastServerVersion=agentSntpClientUcastServerVersion, agentSntpClientUcastServerAddressType=agentSntpClientUcastServerAddressType, agentSntpClientUcastServerNumRequests=agentSntpClientUcastServerNumRequests, agentSntpClientUnicastGroup=agentSntpClientUnicastGroup, agentSntpClientCompliances=agentSntpClientCompliances, agentSntpClientUcastServerMaxEntries=agentSntpClientUcastServerMaxEntries, agentSntpClientUnicastPollRetry=agentSntpClientUnicastPollRetry, agentSntpClientUcastServerTable=agentSntpClientUcastServerTable, agentSntpClientUnicast=agentSntpClientUnicast, agentSntpClientUcastServerPrecedence=agentSntpClientUcastServerPrecedence, agentSntpClientUcastServerPort=agentSntpClientUcastServerPort, agentSntpClientServerAddress=agentSntpClientServerAddress, agentSntpClientUcastServerCurrEntries=agentSntpClientUcastServerCurrEntries, agentSntpClientUcastServerIndex=agentSntpClientUcastServerIndex, agentSntpClientGroups=agentSntpClientGroups, agentSntpClientUcastServerLastAttemptTime=agentSntpClientUcastServerLastAttemptTime, SntpClientUpdateStatus=SntpClientUpdateStatus, agentSntpClientPort=agentSntpClientPort, SntpClientAdminMode=SntpClientAdminMode, agentSntpClientSourceInterface=agentSntpClientSourceInterface, agentSntpClientUnicastPollInterval=agentSntpClientUnicastPollInterval, agentSntpClientLastAttemptStatus=agentSntpClientLastAttemptStatus, agentSntpClientServerMode=agentSntpClientServerMode, agentSntpClientSupportedMode=agentSntpClientSupportedMode, agentSntpClientPollInterval=agentSntpClientPollInterval, agentSntpClientUcastServerRowStatus=agentSntpClientUcastServerRowStatus, agentSntpClientLastUpdateTime=agentSntpClientLastUpdateTime, agentSntpClientObjects=agentSntpClientObjects, agentSntpClientUcastServerNumFailedRequests=agentSntpClientUcastServerNumFailedRequests, agentSntpClientServerStratum=agentSntpClientServerStratum, agentSntpClientBroadcastCount=agentSntpClientBroadcastCount, agentSntpClientBroadcast=agentSntpClientBroadcast, agentSntpClientUcastServerLastAttemptStatus=agentSntpClientUcastServerLastAttemptStatus, agentSntpClientUcastServerLastUpdateTime=agentSntpClientUcastServerLastUpdateTime, agentSntpClientBroadcastInterval=agentSntpClientBroadcastInterval)
