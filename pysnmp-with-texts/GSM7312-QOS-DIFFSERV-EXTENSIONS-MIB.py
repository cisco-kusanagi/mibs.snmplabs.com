...
# Produced by pysmi-0.3.4 at Wed May  1 13:20:06 2019
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, NotificationType, MibIdentifier, Bits, TimeTicks, Gauge32, Integer32, IpAddress, ObjectIdentity, iso, Counter32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "NotificationType", "MibIdentifier", "Bits", "TimeTicks", "Gauge32", "Integer32", "IpAddress", "ObjectIdentity", "iso", "Counter32", "Unsigned32")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: gsm7312QOSDiffServExtensions.setRevisionsDescriptions(('Initial revision.',))
...
if mibBuilder.loadTexts: gsm7312QOSDiffServExtensions.setContactInfo('')
if mibBuilder.loadTexts: gsm7312QOSDiffServExtensions.setDescription('')
...
mibBuilder.exportSymbols("GSM7312-QOS-DIFFSERV-EXTENSIONS-MIB", agentDiffServCosMarkActEntry=agentDiffServCosMarkActEntry, agentDiffServAuxMfClfrTosMask=agentDiffServAuxMfClfrTosMask, gsm7312QOSDiffServExtensions=gsm7312QOSDiffServExtensions, agentDiffServAuxMfClfrStatus=agentDiffServAuxMfClfrStatus, VlanIdOrAny=VlanIdOrAny, agentDiffServAuxMfClfrEntry=agentDiffServAuxMfClfrEntry, agentDiffServAuxMfClfrTable=agentDiffServAuxMfClfrTable, agentDiffServAuxMfClfrSrcMask=agentDiffServAuxMfClfrSrcMask, agentDiffServAuxMfClfrSrcL4PortMin=agentDiffServAuxMfClfrSrcL4PortMin, agentDiffServCosMarkActCos=agentDiffServCosMarkActCos, agentDiffServAuxMfClfrNextFree=agentDiffServAuxMfClfrNextFree, agentDiffServMIBObjects=agentDiffServMIBObjects, agentDiffServAuxMfClfrDstMac=agentDiffServAuxMfClfrDstMac, agentDiffServAuxMfClfrDstAddr=agentDiffServAuxMfClfrDstAddr, agentDiffServAuxMfClfrDstL4PortMax=agentDiffServAuxMfClfrDstL4PortMax, PYSNMP_MODULE_ID=gsm7312QOSDiffServExtensions, agentDiffServAuxMfClfrSrcMacMask=agentDiffServAuxMfClfrSrcMacMask, agentDiffServAuxMfClfrTos=agentDiffServAuxMfClfrTos, agentDiffServIpPrecMarkActPrecedence=agentDiffServIpPrecMarkActPrecedence, agentDiffServIpPrecMarkActEntry=agentDiffServIpPrecMarkActEntry, agentDiffServIpPrecMarkActTable=agentDiffServIpPrecMarkActTable, agentDiffServAuxMfClfrStorage=agentDiffServAuxMfClfrStorage, agentDiffServAuxMfClfrSrcMac=agentDiffServAuxMfClfrSrcMac, agentDiffServAuxMfClfrCos=agentDiffServAuxMfClfrCos, IpPrecedence=IpPrecedence, agentDiffServAuxMfClfrDstMask=agentDiffServAuxMfClfrDstMask, agentDiffServAuxMfClfrId=agentDiffServAuxMfClfrId, agentDiffServCosMarkActTable=agentDiffServCosMarkActTable, agentDiffServAuxMfClfrProtocol=agentDiffServAuxMfClfrProtocol, agentDiffServClassifier=agentDiffServClassifier, agentDiffServAction=agentDiffServAction, agentDiffServAuxMfClfrVlanId=agentDiffServAuxMfClfrVlanId, agentDiffServAuxMfClfrSrcL4PortMax=agentDiffServAuxMfClfrSrcL4PortMax, agentDiffServAuxMfClfrDstMacMask=agentDiffServAuxMfClfrDstMacMask, agentDiffServAuxMfClfrDstL4PortMin=agentDiffServAuxMfClfrDstL4PortMin, CosOrAny=CosOrAny, agentDiffServAuxMfClfrSrcAddr=agentDiffServAuxMfClfrSrcAddr, Cos=Cos)
