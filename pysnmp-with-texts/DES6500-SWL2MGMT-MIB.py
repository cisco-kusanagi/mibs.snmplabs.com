...
# Produced by pysmi-0.3.4 at Wed May  1 12:41:43 2019
...
iso, Bits, Counter32, ObjectIdentity, Counter64, Unsigned32, Integer32, Gauge32, MibIdentifier, IpAddress, ModuleIdentity, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "Bits", "Counter32", "ObjectIdentity", "Counter64", "Unsigned32", "Integer32", "Gauge32", "MibIdentifier", "IpAddress", "ModuleIdentity", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DES6500-SWL2MGMT-MIB", swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2QOSMgmt=swL2QOSMgmt, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swDevInfoBootPromVersion=swDevInfoBootPromVersion, swL2QOSBandwidthRxRate=swL2QOSBandwidthRxRate, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2PortSecurityControlTable=swL2PortSecurityControlTable, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2TrunkType=swL2TrunkType, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2IGMPSnoopingCurrentState=swL2IGMPSnoopingCurrentState, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2QOSBandwidthTxRate=swL2QOSBandwidthTxRate, swL2QOSSchedulingTable=swL2QOSSchedulingTable, swL2QOS8021pDefaultPriorityEntry=swL2QOS8021pDefaultPriorityEntry, swL2PortCtrlTable=swL2PortCtrlTable, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2PortInfoType=swL2PortInfoType, swL2QOSSchedulingMaxPkts=swL2QOSSchedulingMaxPkts, swL2PortSecurityDelCtrl=swL2PortSecurityDelCtrl, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2PortSecurityControlEntry=swL2PortSecurityControlEntry, swL2DevCtrlIGMPSnooping=swL2DevCtrlIGMPSnooping, swL2IGMPSnoopingQueryInterval=swL2IGMPSnoopingQueryInterval, swL2DevCtrlStpState=swL2DevCtrlStpState, swL2IGMPSnoopingMaxResponseTime=swL2IGMPSnoopingMaxResponseTime, swL2IGMPSnoopingPortMap=swL2IGMPSnoopingPortMap, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2IGMPSnoopingInfoTable=swL2IGMPSnoopingInfoTable, swL2IGMPSnoopingCtrlVid=swL2IGMPSnoopingCtrlVid, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2IGMPSnoopingGroupIpAddr=swL2IGMPSnoopingGroupIpAddr, swL2DevCtrlWebState=swL2DevCtrlWebState, MacAddress=MacAddress, swL2QOSBandwidthControlEntry=swL2QOSBandwidthControlEntry, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2PortSecurityAdmState=swL2PortSecurityAdmState, swL2IGMPSnoopingQueryInfoEntry=swL2IGMPSnoopingQueryInfoEntry, swL2QOS8021pUserPriorityIndex=swL2QOS8021pUserPriorityIndex, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2IGMPSnoopingQueryInfoTable=swL2IGMPSnoopingQueryInfoTable, swL2QOSBandwidthPortIndex=swL2QOSBandwidthPortIndex, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2DevCtrlRmonState=swL2DevCtrlRmonState, swL2PortInfoTable=swL2PortInfoTable, swL2DevCtrl=swL2DevCtrl, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2IGMPSnoopingLeaveTimer=swL2IGMPSnoopingLeaveTimer, swL2TrunkIndex=swL2TrunkIndex, swL2TrafficMgmt=swL2TrafficMgmt, swL2IGMPSnoopingRouteTimeout=swL2IGMPSnoopingRouteTimeout, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2PortSecurityDelActivity=swL2PortSecurityDelActivity, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2QOS8021pUserPriorityTable=swL2QOS8021pUserPriorityTable, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2QOS8021pDefaultPriorityTable=swL2QOS8021pDefaultPriorityTable, swL2IGMPSnoopingHostTimeout=swL2IGMPSnoopingHostTimeout, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2TrafficSegPort=swL2TrafficSegPort, swL2PortInfoEntry=swL2PortInfoEntry, swL2QOSSchedulingEntry=swL2QOSSchedulingEntry, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2IGMPSnoopingCtrlEntry=swL2IGMPSnoopingCtrlEntry, swL2IGMPSnoopingInfoQueryCount=swL2IGMPSnoopingInfoQueryCount, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2IGMPSnoopingInfoEntry=swL2IGMPSnoopingInfoEntry, swL2NotifyPrefix=swL2NotifyPrefix, swL2IGMPSnoopingVid=swL2IGMPSnoopingVid, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2PortSecurityMaxLernAddr=swL2PortSecurityMaxLernAddr, swL2NotifFirmware=swL2NotifFirmware, swL2DevAlarm=swL2DevAlarm, swL2IGMPSnoopingInfoTxQueryCount=swL2IGMPSnoopingInfoTxQueryCount, swL2PortSecurityMgmt=swL2PortSecurityMgmt, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2QOS8021pDefaultPriority=swL2QOS8021pDefaultPriority, swL2QOS8021pDefaultPriorityIndex=swL2QOS8021pDefaultPriorityIndex, swL2PortInfoUnitID=swL2PortInfoUnitID, swL2PortMgmt=swL2PortMgmt, swL2IGMPSnoopingQueryState=swL2IGMPSnoopingQueryState, swL2IGMPSnoopingIpGroupReportCount=swL2IGMPSnoopingIpGroupReportCount, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2QOSSchedulingMechanism=swL2QOSSchedulingMechanism, swL2TrunkName=swL2TrunkName, swL2Notify=swL2Notify, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2IGMPSnoopingCtrlState=swL2IGMPSnoopingCtrlState, swL2DevInfo=swL2DevInfo, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2PortSecurityDelMacAddress=swL2PortSecurityDelMacAddress, swL2PortInfoPortNumber=swL2PortInfoPortNumber, swL2DevCtrlTelnet=swL2DevCtrlTelnet, PortList=PortList, swDevInfoHardwareVersion=swDevInfoHardwareVersion, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2PortSecurityDelPort=swL2PortSecurityDelPort, swL2PortSecurityMode=swL2PortSecurityMode, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2QOSBandwidthControlTable=swL2QOSBandwidthControlTable, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2IGMPSnoopingMgmt=swL2IGMPSnoopingMgmt, swL2QOSSchedulingClassIndex=swL2QOSSchedulingClassIndex, swL2TrunkState=swL2TrunkState, VlanId=VlanId, swL2TrafficSegTable=swL2TrafficSegTable, swL2QOSHolPreventionCtrl=swL2QOSHolPreventionCtrl, swL2MirrorMgmt=swL2MirrorMgmt, swL2IGMPSnoopingLastMemberQueryInterval=swL2IGMPSnoopingLastMemberQueryInterval, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2PortSecurityDelVlanName=swL2PortSecurityDelVlanName, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2IGMPSnoopingMacAddr=swL2IGMPSnoopingMacAddr, swL2PortCtrlLockState=swL2PortCtrlLockState, swL2IGMPSnoopingMaxIpGroupNumPerVlan=swL2IGMPSnoopingMaxIpGroupNumPerVlan, swL2DevCtrlIGMPSnoopingMcstRTOnly=swL2DevCtrlIGMPSnoopingMcstRTOnly, swL2QOS8021pUserPriorityClass=swL2QOS8021pUserPriorityClass, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2TrunkMember=swL2TrunkMember, swL2IGMPSnoopingMaxSupportedVlans=swL2IGMPSnoopingMaxSupportedVlans, swL2MgmtMIB=swL2MgmtMIB, swL2TrunkMgmt=swL2TrunkMgmt, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2IGMPSnoopingRobustness=swL2IGMPSnoopingRobustness, swDevInfoFirmwareVersion=swDevInfoFirmwareVersion, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2QOSSchedulingMechanismCtrl=swL2QOSSchedulingMechanismCtrl, swL2QOS8021pUserPriorityEntry=swL2QOS8021pUserPriorityEntry, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2IGMPSnoopingCtrlTable=swL2IGMPSnoopingCtrlTable, swL2IGMPSnoopingInfoVid=swL2IGMPSnoopingInfoVid, swL2RstpMgmt=swL2RstpMgmt, swL2DevMgmt=swL2DevMgmt, swL2PortSecurityPortIndex=swL2PortSecurityPortIndex, swL2MirrorPortState=swL2MirrorPortState)
