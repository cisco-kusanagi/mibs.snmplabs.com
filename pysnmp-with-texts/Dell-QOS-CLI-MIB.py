...
# Produced by pysmi-0.3.4 at Wed May  1 12:56:30 2019
...
ObjectIdentity, Integer32, IpAddress, Bits, NotificationType, Counter32, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, Counter64, Gauge32, MibIdentifier, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Integer32", "IpAddress", "Bits", "NotificationType", "Counter32", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "Counter64", "Gauge32", "MibIdentifier", "iso")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: rlQosCliMib.setRevisionsDescriptions(('The private MIB module definition for Quality Of Service CLI in Dell devices.', 'Editorial changes to support new MIB compilers.', 'Add rlQosPortRateLimitStatus,rlQosCirPortRateLimit, rlQosCbsPortRateLimit to rlQosIfPolicyTable', 'Add vpt,ether-type,tcp-flags,icmp-type,icmp-code,igmp-type to ClassTupleType Add mac-Offset,ip-ICMP,ip-IGMP To AceObjectType Add vpt,ethertype To ClassOffsetType', 'Add new advanced action : trustCosDscp', 'Add DSCP to Queue Default map table.', 'Add textual convention to QosObjectMode (service).', 'Added this MODULE-IDENTITY clause, changed IMPORT, removed ranges in SEQUENCE elements, changed access of rlQosCliQosMode, rlQosCliBasicModeCfg and rlQosMaxNumOfAce.', 'Added rlQosDscpToDpTable',))
if mibBuilder.loadTexts: rlQosCliMib.setLastUpdated('200604040000Z')
if mibBuilder.loadTexts: rlQosCliMib.setOrganization('Dell')
if mibBuilder.loadTexts: rlQosCliMib.setContactInfo('www.dell.com')
...
mibBuilder.exportSymbols("Dell-QOS-CLI-MIB", rlQosEfState=rlQosEfState, rlQosGlobalStatisticsCntrsEntry=rlQosGlobalStatisticsCntrsEntry, rlQosRedMaxDp1=rlQosRedMaxDp1, rlQosSinglePolicerStatisticsOutProfileCntrNumOfBits=rlQosSinglePolicerStatisticsOutProfileCntrNumOfBits, rlQosClassifierMaxRulesNumberUtilizationSystem=rlQosClassifierMaxRulesNumberUtilizationSystem, rlQoSPortTrustAdvancedMode=rlQoSPortTrustAdvancedMode, rlQosLogInputInterfacesAceMatchedVlanList2049to3072=rlQosLogInputInterfacesAceMatchedVlanList2049to3072, rlQosDscpMutationEnable=rlQosDscpMutationEnable, rlQosPortPolicyStatisticsCntrType=rlQosPortPolicyStatisticsCntrType, rlQosIfTrustActive=rlQosIfTrustActive, rlQosAceTidxType=rlQosAceTidxType, rlQosAceTidxTuple1=rlQosAceTidxTuple1, rlQosAclStatus=rlQosAclStatus, rlQosAceTuple3=rlQosAceTuple3, rlIfIndex=rlIfIndex, rlQosAceTidxTimeRange=rlQosAceTidxTimeRange, BinaryStatus=BinaryStatus, rlQosAclAceRefStatus=rlQosAclAceRefStatus, rlQosCosQueueDefaultMapTable=rlQosCosQueueDefaultMapTable, rlQosPolicyClassPriorityRefEntry=rlQosPolicyClassPriorityRefEntry, rlQosAclAceRefTable=rlQosAclAceRefTable, rlQosAggregatePolicerStatisticsInProfileCounterValue=rlQosAggregatePolicerStatisticsInProfileCounterValue, rlQosOutQueueStatisticsTable=rlQosOutQueueStatisticsTable, rlQosClassMapTunnelIdx=rlQosClassMapTunnelIdx, rlQosAceTidxAclIndex=rlQosAceTidxAclIndex, rlQosClassMapEntry=rlQosClassMapEntry, rlQosPolicyClassPriorityRefPriority=rlQosPolicyClassPriorityRefPriority, rlQosOffsetEntry=rlQosOffsetEntry, rlQosUdpPortQueueStatus=rlQosUdpPortQueueStatus, rlQosLogInputInterfacesAceMatchedPorts=rlQosLogInputInterfacesAceMatchedPorts, rlQosNamesToIndexesName=rlQosNamesToIndexesName, rlQosAceTidxTuple4=rlQosAceTidxTuple4, rlQosCliBasicModeCfg=rlQosCliBasicModeCfg, rlQosSinglePolicerStatisticsInProfileCntrNumOfBits=rlQosSinglePolicerStatisticsInProfileCntrNumOfBits, rlQosTypeQueue1=rlQosTypeQueue1, rlQosAceEntry=rlQosAceEntry, rlQosLogInputInterfacesAceMatchedTable=rlQosLogInputInterfacesAceMatchedTable, rlQosPolicerCbs=rlQosPolicerCbs, rlQosAceTuple6=rlQosAceTuple6, rlQosIfPolicyTable=rlQosIfPolicyTable, rlQosClassMapTrapId=rlQosClassMapTrapId, rlQosDenyAceStatisticsIfCounter=rlQosDenyAceStatisticsIfCounter, rlQosAceTidxTuple11=rlQosAceTidxTuple11, rlQosIfIpv6AclOut=rlQosIfIpv6AclOut, rlQosFreeIndexesValue=rlQosFreeIndexesValue, rlQosAclEntry=rlQosAclEntry, rlQosAdvcGlobalTrustMode=rlQosAdvcGlobalTrustMode, rlQosClassMapIndex=rlQosClassMapIndex, AclObjectType=AclObjectType, rlQosOutQueueStatisticsQueue=rlQosOutQueueStatisticsQueue, rlQosPortPolicyStatisticsCntrNumOfBits=rlQosPortPolicyStatisticsCntrNumOfBits, rlQosAggregatePolicerStatisticsStatus=rlQosAggregatePolicerStatisticsStatus, rlQosPolicerCasPointerRemVal=rlQosPolicerCasPointerRemVal, rlQueueProfileName=rlQueueProfileName, rlQosDenyAceStatisticsClearIfCounters=rlQosDenyAceStatisticsClearIfCounters, rlQosOffsetStatus=rlQosOffsetStatus, rlQosValueQueue2=rlQosValueQueue2, rlQosTypeQueue8=rlQosTypeQueue8, rlQosDscpToDpTable=rlQosDscpToDpTable, rlQosClassMapStatus=rlQosClassMapStatus, rlQosDscpIndex=rlQosDscpIndex, rlQosAceTidxTimeRangeIsActive=rlQosAceTidxTimeRangeIsActive, rlQosStackControlQueue=rlQosStackControlQueue, rlQosDscpQueueDefaultMapDscp=rlQosDscpQueueDefaultMapDscp, rlQosUdpPortQueueTable=rlQosUdpPortQueueTable, rlQosPredefBlockAclIfIndex=rlQosPredefBlockAclIfIndex, rlQosTypeQueue4=rlQosTypeQueue4, rlQosTcpQueueValue=rlQosTcpQueueValue, rlQosLogInputInterfacesAceMatchedVlanList3073to4094=rlQosLogInputInterfacesAceMatchedVlanList3073to4094, rlQosPolicyClassPriorityRefStatus=rlQosPolicyClassPriorityRefStatus, rlQosCbsQueue3=rlQosCbsQueue3, rlQosQueueProfilePointer=rlQosQueueProfilePointer, rlQosPolicyClassRefStatus=rlQosPolicyClassRefStatus, rlQosAggregatePolicerStatisticsInProfileCntrNumOfBits=rlQosAggregatePolicerStatisticsInProfileCntrNumOfBits, rlQosIfprofileStatus=rlQosIfprofileStatus, rlQosAclCounterEntry=rlQosAclCounterEntry, rlQosPolicerEntry=rlQosPolicerEntry, rlQosDenyAceStatisticsClearOtherFlowCounter=rlQosDenyAceStatisticsClearOtherFlowCounter, rlQosRedProbDp1=rlQosRedProbDp1, rlQosDscpQueueEntry=rlQosDscpQueueEntry, rlQosRedProbDp2=rlQosRedProbDp2, rlQosIfPolicyMapPointerOut=rlQosIfPolicyMapPointerOut, rlQosNamesToIndexesValue=rlQosNamesToIndexesValue, rlQosPortPolicyStatisticsEnableCounting=rlQosPortPolicyStatisticsEnableCounting, rlQosTcpPortQueueEntry=rlQosTcpPortQueueEntry, rlQosDscpRemarkTable=rlQosDscpRemarkTable, rlQosOutQueueStatisticsEntry=rlQosOutQueueStatisticsEntry, rlQosPredefBlockAclIfType=rlQosPredefBlockAclIfType, rlQosClassifierRulesNumberUtilizationSystem=rlQosClassifierRulesNumberUtilizationSystem, rlQosOffsetType=rlQosOffsetType, rlQosAceTidxIndex=rlQosAceTidxIndex, rlQosAceStatus=rlQosAceStatus, rlQosTypeQueue6=rlQosTypeQueue6, rlQosNamesToIndexesTableId=rlQosNamesToIndexesTableId, rlQosCosQueueEntry=rlQosCosQueueEntry, rlQosCirQueue7=rlQosCirQueue7, rlQosDenyAceStatisticsEntry=rlQosDenyAceStatisticsEntry, rlQosEfQueueId=rlQosEfQueueId, rlQosCosQueueId=rlQosCosQueueId, rlQosPortToProfileMappingEntry=rlQosPortToProfileMappingEntry, RlQosTimeBasedAclWeekPeriodicList=RlQosTimeBasedAclWeekPeriodicList, rlQosPolicyMapStatus=rlQosPolicyMapStatus, rlQosAggregatePolicerStatisticsOutProfileCounterValue=rlQosAggregatePolicerStatisticsOutProfileCounterValue, rlQosAceAccount=rlQosAceAccount, rlQosCbsQueue7=rlQosCbsQueue7, rlQosSinglePolicerStatisticsStatus=rlQosSinglePolicerStatisticsStatus, rlQosClassMapTable=rlQosClassMapTable, rlQosSinglePolicerStatisticsOutProfileCounterValue=rlQosSinglePolicerStatisticsOutProfileCounterValue, rlQosAceIndex=rlQosAceIndex, rlQosPolicerAction=rlQosPolicerAction, rlQosAceTidxActionDropType=rlQosAceTidxActionDropType, rlQosAceTidxAction=rlQosAceTidxAction, QueueType=QueueType, rlQosAceTidxTable=rlQosAceTidxTable, rlQosClassifierUtilizationSystem=rlQosClassifierUtilizationSystem, rlQosLogInputInterfacesAceMatchedIndex=rlQosLogInputInterfacesAceMatchedIndex, rlQosTypeQueue7=rlQosTypeQueue7, rlQosPolicerIndex=rlQosPolicerIndex, rlQosOutQueueStatisticsCountrID=rlQosOutQueueStatisticsCountrID, rlQosCliMib=rlQosCliMib, rlQosNewDscp=rlQosNewDscp, rlQosTypeQueue2=rlQosTypeQueue2, rlQosIfIpv6AclIn=rlQosIfIpv6AclIn, rlQosMaxNumOfAce=rlQosMaxNumOfAce, rlQosClassMapAction=rlQosClassMapAction, QosGlobalMode=QosGlobalMode, rlQosCirQueue6=rlQosCirQueue6, rlQosTupleStatus=rlQosTupleStatus, rlQosTcpPort=rlQosTcpPort, rlQosDscpQueueDefaultMapTable=rlQosDscpQueueDefaultMapTable, rlQosClassMapCounterTable=rlQosClassMapCounterTable, rlQosValueQueue7=rlQosValueQueue7, rlQosAclTable=rlQosAclTable, rlQosPolicerName=rlQosPolicerName, rlQosEfManageTable=rlQosEfManageTable, rlQosAclCounterTable=rlQosAclCounterTable, rlQosQueueShapeProfileTable=rlQosQueueShapeProfileTable, AceActionType=AceActionType, rlQosClassMapPolicer=rlQosClassMapPolicer, rlQosIfPolicyMapPointerIn=rlQosIfPolicyMapPointerIn, rlQosCbsQueue6=rlQosCbsQueue6, MarkVlanAction=MarkVlanAction, rlQosAclAceRefAcePointer=rlQosAclAceRefAcePointer, rlQosSinglePolicerStatisticsInProfileCounterValue=rlQosSinglePolicerStatisticsInProfileCounterValue, ClassTupleType=ClassTupleType, rlIfProfileName=rlIfProfileName, rlQosQueueShapeProfilePointer=rlQosQueueShapeProfilePointer, rlQosGlobalStatisticsCntrsType=rlQosGlobalStatisticsCntrsType, rlQosValueQueue1=rlQosValueQueue1, rlQosQueueNum=rlQosQueueNum, rlQosTupleType=rlQosTupleType, rlQosNamesToIndexesTable=rlQosNamesToIndexesTable, rlQosGlobalIndex=rlQosGlobalIndex, rlQosPolicyClassPriorityRefTable=rlQosPolicyClassPriorityRefTable, rlQosAceTidxTuple8=rlQosAceTidxTuple8, InterfaceType=InterfaceType, rlQosAceType=rlQosAceType, rlQosGlobalStatisticsCntrsTable=rlQosGlobalStatisticsCntrsTable, rlQosLogInputInterfacesAceMatchedVlanList1to1024=rlQosLogInputInterfacesAceMatchedVlanList1to1024, rlQosUdpPortQueueEntry=rlQosUdpPortQueueEntry, rlQosClassMapMarkVlan=rlQosClassMapMarkVlan, rlQosOldDscp=rlQosOldDscp, rlQosAceTidxTuple6=rlQosAceTidxTuple6, rlQosPortPolicyStatisticsEntry=rlQosPortPolicyStatisticsEntry, rlQosOutQueueStatisticsQueueAll=rlQosOutQueueStatisticsQueueAll, rlQosAclAceRefEntry=rlQosAclAceRefEntry, rlQosCosIndex=rlQosCosIndex, rlQosClassMapCounterEnable=rlQosClassMapCounterEnable, rlQosTupleEntry=rlQosTupleEntry, rlQosPortRateLimitStatus=rlQosPortRateLimitStatus, rlQosAceTidxStatus=rlQosAceTidxStatus, rlQosFreeIndexesEntry=rlQosFreeIndexesEntry, rlQosPolicyMapTable=rlQosPolicyMapTable, rlQosFreeIndexesTable=rlQosFreeIndexesTable, rlQosUdpPort=rlQosUdpPort, rlQosDscpRemarkEntry=rlQosDscpRemarkEntry, rlQosCirQueue5=rlQosCirQueue5, rlQosOffsetIndex=rlQosOffsetIndex, rlQosApplicationTrapIdTable=rlQosApplicationTrapIdTable, rlQosDscpMutationTable=rlQosDscpMutationTable, rlQosClassMapNewVlan=rlQosClassMapNewVlan, rlQosGlobalStatisticsCntrsCounterValue=rlQosGlobalStatisticsCntrsCounterValue, rlQosAceTidxAccount=rlQosAceTidxAccount, rlQosDenyAceStatisticsTable=rlQosDenyAceStatisticsTable, rlQosAceTidxTuple10=rlQosAceTidxTuple10, rlQosCbsPortShaper=rlQosCbsPortShaper, rlQosTypeQueue5=rlQosTypeQueue5, rlQosDscp=rlQosDscp, rlQosAclDefaultAction=rlQosAclDefaultAction, rlQosApplicationName=rlQosApplicationName, StatisticsCntrType=StatisticsCntrType, rlQosCosQueueTable=rlQosCosQueueTable, rlQosCirQueue8=rlQosCirQueue8, rlQosRedMaxDp0=rlQosRedMaxDp0, rlQosAceTidxTuple3=rlQosAceTidxTuple3, rlQosAclNumOfAces=rlQosAclNumOfAces, rlQosGlobalStatisticsStatus=rlQosGlobalStatisticsStatus, RedirectAction=RedirectAction, rlQosPolicerCir=rlQosPolicerCir, rlQosRmNewDscp=rlQosRmNewDscp, rlQosCosQueueDefaultMapVpt=rlQosCosQueueDefaultMapVpt, rlQosAceTuple7=rlQosAceTuple7, rlQosCosQueueDefaultMapQueueId=rlQosCosQueueDefaultMapQueueId, rlQosPolicyClassPriorityRefPolicyPointer=rlQosPolicyClassPriorityRefPolicyPointer, rlQosCbsQueue4=rlQosCbsQueue4, rlQosClassifierFreeRulesNumUtilizationSystem=rlQosClassifierFreeRulesNumUtilizationSystem, rlQosPolicyClassPriorityRefClassPointer=rlQosPolicyClassPriorityRefClassPointer, rlQosValueQueue6=rlQosValueQueue6, rlQosIfPolicerIn=rlQosIfPolicerIn, rlQosTypeQueue3=rlQosTypeQueue3, rlQosDenyAceStatisticsIfIndex=rlQosDenyAceStatisticsIfIndex, rlQosCosQueueDefaultMapEntry=rlQosCosQueueDefaultMapEntry, rlQoSApplicationDefaultAction=rlQoSApplicationDefaultAction, rlQosPolicyClassRefClassPointer=rlQosPolicyClassRefClassPointer, rlQosLogInputInterfacesAceMatchedEntry=rlQosLogInputInterfacesAceMatchedEntry, rlQosRedMinDp0=rlQosRedMinDp0, rlQosOutQueueStatisticsDP=rlQosOutQueueStatisticsDP, rlQosAggregatePolicerStatisticsTable=rlQosAggregatePolicerStatisticsTable, rlQosOffsetPattern=rlQosOffsetPattern, rlQosAclCounterValue=rlQosAclCounterValue, rlQosAceTuple4=rlQosAceTuple4, rlQosCirQueue1=rlQosCirQueue1, rlQosClassMapDestInterface=rlQosClassMapDestInterface, StatisticsCntrNumOfBitsType=StatisticsCntrNumOfBitsType, rlQosCirQueue4=rlQosCirQueue4, RlQosAceTidxActionDropType=RlQosAceTidxActionDropType, rlQosPredefBlockAclStatus=rlQosPredefBlockAclStatus, rlQosOutQueueStatisticsVlanAll=rlQosOutQueueStatisticsVlanAll, rlQosTupleIndex=rlQosTupleIndex, rlQosClassMapType=rlQosClassMapType, rlQosClassifierUtilizationRulesNumber=rlQosClassifierUtilizationRulesNumber, rlQosCirQueue2=rlQosCirQueue2, ClassMapAction=ClassMapAction, rlQosCirQueue3=rlQosCirQueue3, rlQosDscpMutationEntry=rlQosDscpMutationEntry, rlQosAggregatePolicerStatisticsEntry=rlQosAggregatePolicerStatisticsEntry, rlQosProfileName=rlQosProfileName, rlQosRedMinDp2=rlQosRedMinDp2, ClassOffsetType=ClassOffsetType, rlQosQueueShapeProfileEntry=rlQosQueueShapeProfileEntry, rlQosModeGlobalCfgEntry=rlQosModeGlobalCfgEntry, rlQosTdThersholdDp0=rlQosTdThersholdDp0, rlQosTupleTable=rlQosTupleTable, rlQosAclAceRefAclPointer=rlQosAclAceRefAclPointer, rlQosPredefBlockAclTable=rlQosPredefBlockAclTable, rlQosClassifierUtilization=rlQosClassifierUtilization, rlQosRmOldDscp=rlQosRmOldDscp, rlQosTcpPortQueueTable=rlQosTcpPortQueueTable, rlQosOutQueueStatisticsStatus=rlQosOutQueueStatisticsStatus, rlQosPolicyMapIndex=rlQosPolicyMapIndex, rlQosDscpQueueTable=rlQosDscpQueueTable, rlQosIfProfileCfgTable=rlQosIfProfileCfgTable, rlQosPolicyMapName=rlQosPolicyMapName, rlQosQueueId=rlQosQueueId)
mibBuilder.exportSymbols("Dell-QOS-CLI-MIB", rlQosOffsetMask=rlQosOffsetMask, rlQosDscpQueueDefaultMapQueueId=rlQosDscpQueueDefaultMapQueueId, rlQosClassifierUtilizationEntry=rlQosClassifierUtilizationEntry, rlQosAceTidxTuple9=rlQosAceTidxTuple9, rlQosClassMapRedirectAction=rlQosClassMapRedirectAction, rlQosAceTidxEntry=rlQosAceTidxEntry, rlQosIfProfileCfgEntry=rlQosIfProfileCfgEntry, rlQosNumOfIfConnections=rlQosNumOfIfConnections, rlQosCliQosMode=rlQosCliQosMode, rlQosOffsetValue=rlQosOffsetValue, rlQosNamesToIndexesEntry=rlQosNamesToIndexesEntry, rlQosTdThersholdDp2=rlQosTdThersholdDp2, rlQosRedProbDp0=rlQosRedProbDp0, rlQosOffsetTable=rlQosOffsetTable, rlQosOutQueueStatisticsDPAll=rlQosOutQueueStatisticsDPAll, rlQosRedQweight=rlQosRedQweight, rlQosDp=rlQosDp, rlQosCbsQueue5=rlQosCbsQueue5, rlQosQueueShapeIndex=rlQosQueueShapeIndex, rlQosModeGlobalCfgStatus=rlQosModeGlobalCfgStatus, rlQosIfAclIn=rlQosIfAclIn, rlQosCbsQueue8=rlQosCbsQueue8, rlQosSinglePolicerStatisticsTable=rlQosSinglePolicerStatisticsTable, rlQosOutQueueStatisticsIfIndexList=rlQosOutQueueStatisticsIfIndexList, rlQosClassMapMatch1=rlQosClassMapMatch1, rlQosApplicationTrapIdEntry=rlQosApplicationTrapIdEntry, rlQosAceTuple2=rlQosAceTuple2, rlQosStackControlCos=rlQosStackControlCos, rlQosDenyAceStatisticsOtherFlowCounter=rlQosDenyAceStatisticsOtherFlowCounter, rlQosClassMapName=rlQosClassMapName, rlQosEfPriority=rlQosEfPriority, rlQosAclCounterAceIndex=rlQosAclCounterAceIndex, rlQosValueQueue5=rlQosValueQueue5, rlQosOffsetTuplePointer=rlQosOffsetTuplePointer, rlQosClassifierUtilizationPercent=rlQosClassifierUtilizationPercent, rlQosPortPolicyStatisticsTable=rlQosPortPolicyStatisticsTable, rlQosRedMinDp1=rlQosRedMinDp1, rlQosClassMapMarkValue=rlQosClassMapMarkValue, QosTrustMode=QosTrustMode, rlQosAclName=rlQosAclName, rlQosTupleValue1=rlQosTupleValue1, rlQosOutQueueStatisticsCounterTailDropValue=rlQosOutQueueStatisticsCounterTailDropValue, rlQosPredefBlockAclMask=rlQosPredefBlockAclMask, rlQosUdpQueueValue=rlQosUdpQueueValue, rlQosStatistics=rlQosStatistics, rlQosValueQueue8=rlQosValueQueue8, rlQosAggregatePolicerStatisticsOutProfileCntrNumOfBits=rlQosAggregatePolicerStatisticsOutProfileCntrNumOfBits, rlQosIfAclOut=rlQosIfAclOut, rlQosOutQueueStatisticsPortAll=rlQosOutQueueStatisticsPortAll, rlQosClassifierUtilizationTable=rlQosClassifierUtilizationTable, rlQosClassifierUtilizationUnitId=rlQosClassifierUtilizationUnitId, rlQosDscpQueueDefaultMapEntry=rlQosDscpQueueDefaultMapEntry, rlQosCirPortShaper=rlQosCirPortShaper, PolicerAction=PolicerAction, rlQosPredefBlockAclEntry=rlQosPredefBlockAclEntry, rlQosAceTuple5=rlQosAceTuple5, rlQosOutQueueStatisticsVlan=rlQosOutQueueStatisticsVlan, rlQosOutQueueStatisticsCounterAllValue=rlQosOutQueueStatisticsCounterAllValue, rlQosPolicyClassRefEntry=rlQosPolicyClassRefEntry, rlQosClassMapCounterEntry=rlQosClassMapCounterEntry, rlQosAceTable=rlQosAceTable, RlQosApplicationDefaultActionType=RlQosApplicationDefaultActionType, rlQosQueueProfileStatus=rlQosQueueProfileStatus, rlIfType=rlIfType, rlQosBasicGlobalTrustMode=rlQosBasicGlobalTrustMode, rlQosValueQueue3=rlQosValueQueue3, rlQosClassMapMatch2=rlQosClassMapMatch2, rlQosPortToProfileMappingTable=rlQosPortToProfileMappingTable, rlQosAceTuple1=rlQosAceTuple1, rlQosCbsPortRateLimit=rlQosCbsPortRateLimit, rlQosAceTuple8=rlQosAceTuple8, rlQosAclIndex=rlQosAclIndex, rlQosClearCounters=rlQosClearCounters, rlQosClassMapCounterValue=rlQosClassMapCounterValue, rlQosPolicerStatus=rlQosPolicerStatus, rlQosPolicyClassRefTable=rlQosPolicyClassRefTable, ClassMapType=ClassMapType, rlQosApplicationTrapId=rlQosApplicationTrapId, rlQosPortPolicyStatisticsCounterValue=rlQosPortPolicyStatisticsCounterValue, rlQosIfPolicyEntry=rlQosIfPolicyEntry, rlQosPolicyMapEntry=rlQosPolicyMapEntry, rlQosCbsQueue2=rlQosCbsQueue2, rlQosPort=rlQosPort, rlQosQueueProfileTable=rlQosQueueProfileTable, rlQosValueQueue4=rlQosValueQueue4, PolicerType=PolicerType, rlQosGlobalStatisticsCntrsNumOfBits=rlQosGlobalStatisticsCntrsNumOfBits, PYSNMP_MODULE_ID=rlQosCliMib, rlQosSinglePolicerStatisticsEntry=rlQosSinglePolicerStatisticsEntry, rlQosModeGlobalCfgTable=rlQosModeGlobalCfgTable, rlQosTcpPortQueueStatus=rlQosTcpPortQueueStatus, rlQosAceTidxTuple2=rlQosAceTidxTuple2, rlQosDscpToDpEntry=rlQosDscpToDpEntry, rlQosCirPortRateLimit=rlQosCirPortRateLimit, rlQosClassMapMatch3=rlQosClassMapMatch3, rlQosAclCounterInterface=rlQosAclCounterInterface, rlQosFreeIndexesTableId=rlQosFreeIndexesTableId, rlQosAceTidxTuple5=rlQosAceTidxTuple5, rlQosOutQueueStatisticsCntrNumOfBits=rlQosOutQueueStatisticsCntrNumOfBits, rlQosPolicerType=rlQosPolicerType, rlQosAclType=rlQosAclType, rlQosAceAction=rlQosAceAction, rlQosTdThersholdDp1=rlQosTdThersholdDp1, rlQosClassifierUtilizationFreeRulesNumber=rlQosClassifierUtilizationFreeRulesNumber, rlQosMibVersion=rlQosMibVersion, rlQosGlobalQoSMode=rlQosGlobalQoSMode, rlQosAclCounterAclIndex=rlQosAclCounterAclIndex, rlQosIfPolicyMapStatus=rlQosIfPolicyMapStatus, rlQosLogInputInterfacesAceMatchedVlanList1025to2048=rlQosLogInputInterfacesAceMatchedVlanList1025to2048, rlQosQueueProfileEntry=rlQosQueueProfileEntry, rlQosQueueShapeProfileStatus=rlQosQueueShapeProfileStatus, rlQosPolicerTable=rlQosPolicerTable, rlQosEfManageEntry=rlQosEfManageEntry, rlQosPolicyClassRefPolicyPointer=rlQosPolicyClassRefPolicyPointer, rlQosCPUSafeGuardEnable=rlQosCPUSafeGuardEnable, rlQosAceTidxTuple7=rlQosAceTidxTuple7, rlQosTupleValue2=rlQosTupleValue2, rlQosRedMaxDp2=rlQosRedMaxDp2, rlQosIfProfilePointer=rlQosIfProfilePointer, rlQosPortShaperStatus=rlQosPortShaperStatus, rlQosCbsQueue1=rlQosCbsQueue1, AceObjectType=AceObjectType, AclDefaultAction=AclDefaultAction)
