...
# Produced by pysmi-0.3.4 at Wed May  1 11:06:16 2019
...
IpAddress, ModuleIdentity, Gauge32, Integer32, Counter64, Unsigned32, iso, ObjectIdentity, MibIdentifier, Bits, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "ModuleIdentity", "Gauge32", "Integer32", "Counter64", "Unsigned32", "iso", "ObjectIdentity", "MibIdentifier", "Bits", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "NotificationType")
StorageType, TextualConvention, TimeStamp, DisplayString, TruthValue, RowPointer, RowStatus = mibBuilder.importSymbols("SNMPv2-TC", "StorageType", "TextualConvention", "TimeStamp", "DisplayString", "TruthValue", "RowPointer", "RowStatus")
...
mibBuilder.exportSymbols("A3COM-HUAWEI-MPLS-LSR-MIB", mplsLabelStackTable=mplsLabelStackTable, mplsInterfaceTotalBandwidth=mplsInterfaceTotalBandwidth, mplsInSegmentPerfDiscontinuityTime=mplsInSegmentPerfDiscontinuityTime, MplsLSPID=MplsLSPID, mplsLsrCompliances=mplsLsrCompliances, mplsInterfaceConfIndex=mplsInterfaceConfIndex, mplsOutSegmentRowStatus=mplsOutSegmentRowStatus, mplsOutSegmentPushTopLabel=mplsOutSegmentPushTopLabel, mplsOutSegmentPackets=mplsOutSegmentPackets, mplsInterfaceLabelMinOut=mplsInterfaceLabelMinOut, mplsOutSegmentIfIndex=mplsOutSegmentIfIndex, mplsInSegmentLabel=mplsInSegmentLabel, mplsInterfaceOutFragments=mplsInterfaceOutFragments, mplsOutSegmentErrors=mplsOutSegmentErrors, mplsInterfaceFailedLabelLookup=mplsInterfaceFailedLabelLookup, mplsOutSegmentDiscards=mplsOutSegmentDiscards, MplsBitRate=MplsBitRate, mplsInSegmentDiscards=mplsInSegmentDiscards, mplsInSegmentPerfEntry=mplsInSegmentPerfEntry, mplsOutSegmentPerfTable=mplsOutSegmentPerfTable, mplsXCOptionalGroup=mplsXCOptionalGroup, mplsPerfGroup=mplsPerfGroup, mplsOutSegmentHCOctets=mplsOutSegmentHCOctets, mplsHCOutSegmentPerfGroup=mplsHCOutSegmentPerfGroup, mplsXCTrapEnable=mplsXCTrapEnable, mplsLabelStackLabelIndex=mplsLabelStackLabelIndex, mplsTrafficParamIndex=mplsTrafficParamIndex, mplsLabelStackEntry=mplsLabelStackEntry, mplsLabelStackStorageType=mplsLabelStackStorageType, mplsXCOwner=mplsXCOwner, mplsInterfaceOutLabelsUsed=mplsInterfaceOutLabelsUsed, mplsXCEntry=mplsXCEntry, mplsXCDown=mplsXCDown, mplsInSegmentEntry=mplsInSegmentEntry, mplsInSegmentHCOctets=mplsInSegmentHCOctets, mplsOutSegmentStorageType=mplsOutSegmentStorageType, mplsXCAdminStatus=mplsXCAdminStatus, mplsXCIsNotPersistentGroup=mplsXCIsNotPersistentGroup, mplsXCIndex=mplsXCIndex, PYSNMP_MODULE_ID=hwMplsLsr, mplsOutSegmentTable=mplsOutSegmentTable, mplsLabelStackIndexNext=mplsLabelStackIndexNext, mplsXCLspId=mplsXCLspId, MplsBurstSize=MplsBurstSize, mplsInSegmentAddrFamily=mplsInSegmentAddrFamily, mplsInSegmentXCIndex=mplsInSegmentXCIndex, mplsTrafficParamIndexNext=mplsTrafficParamIndexNext, mplsInSegmentGroup=mplsInSegmentGroup, mplsInterfaceAvailableBandwidth=mplsInterfaceAvailableBandwidth, mplsXCTable=mplsXCTable, mplsInterfaceConfEntry=mplsInterfaceConfEntry, mplsOutSegmentTopLabel=mplsOutSegmentTopLabel, mplsLsrNotifications=mplsLsrNotifications, mplsOutSegmentIndexNext=mplsOutSegmentIndexNext, mplsInSegmentNPop=mplsInSegmentNPop, mplsXCLabelStackIndex=mplsXCLabelStackIndex, mplsOutSegmentEntry=mplsOutSegmentEntry, mplsInterfaceLabelMinIn=mplsInterfaceLabelMinIn, mplsOutSegmentIndex=mplsOutSegmentIndex, mplsOutSegmentXCIndex=mplsOutSegmentXCIndex, mplsTrafficParamMaxBurstSize=mplsTrafficParamMaxBurstSize, MplsLabel=MplsLabel, hwMplsLsr=hwMplsLsr, mplsTrafficParamRowStatus=mplsTrafficParamRowStatus, mplsInSegmentStorageType=mplsInSegmentStorageType, mplsInSegmentPerfTable=mplsInSegmentPerfTable, mplsInterfacePerfEntry=mplsInterfacePerfEntry, mplsInSegmentOctets=mplsInSegmentOctets, mplsLabelStackGroup=mplsLabelStackGroup, mplsInSegmentErrors=mplsInSegmentErrors, mplsLabelStackLabel=mplsLabelStackLabel, MplsObjectOwner=MplsObjectOwner, mplsXCGroup=mplsXCGroup, mplsOutSegmentOctets=mplsOutSegmentOctets, mplsLsrModuleCompliance=mplsLsrModuleCompliance, mplsOutSegmentNextHopIpAddrType=mplsOutSegmentNextHopIpAddrType, mplsXCIsPersistent=mplsXCIsPersistent, mplsInSegmentTable=mplsInSegmentTable, mplsInterfaceLabelParticipationType=mplsInterfaceLabelParticipationType, mplsLsrNotifyPrefix=mplsLsrNotifyPrefix, mplsTrafficParamEntry=mplsTrafficParamEntry, mplsInterfacePerfTable=mplsInterfacePerfTable, mplsOutSegmentOwner=mplsOutSegmentOwner, mplsXCIsPersistentGroup=mplsXCIsPersistentGroup, mplsOutSegmentPerfDiscontinuityTime=mplsOutSegmentPerfDiscontinuityTime, mplsTrafficParamMeanRate=mplsTrafficParamMeanRate, mplsXCUp=mplsXCUp, mplsXCStorageType=mplsXCStorageType, mplsLsrNotificationGroup=mplsLsrNotificationGroup, mplsInterfaceLabelMaxIn=mplsInterfaceLabelMaxIn, mplsLabelStackIndex=mplsLabelStackIndex, mplsTrafficParamTable=mplsTrafficParamTable, mplsInterfaceInLabelsUsed=mplsInterfaceInLabelsUsed, mplsMaxLabelStackDepth=mplsMaxLabelStackDepth, mplsInSegmentIfIndex=mplsInSegmentIfIndex, mplsInSegmentPackets=mplsInSegmentPackets, mplsLsrObjects=mplsLsrObjects, mplsXCRowStatus=mplsXCRowStatus, mplsLabelStackRowStatus=mplsLabelStackRowStatus, mplsInSegmentRowStatus=mplsInSegmentRowStatus, mplsTrafficParamStorageType=mplsTrafficParamStorageType, mplsLsrConformance=mplsLsrConformance, mplsOutSegmentNextHopIpv4Addr=mplsOutSegmentNextHopIpv4Addr, mplsLsrGroups=mplsLsrGroups, mplsInterfaceLabelMaxOut=mplsInterfaceLabelMaxOut, mplsTrafficParamMaxRate=mplsTrafficParamMaxRate, mplsInSegmentTrafficParamPtr=mplsInSegmentTrafficParamPtr, mplsXCOperStatus=mplsXCOperStatus, mplsOutSegmentPerfEntry=mplsOutSegmentPerfEntry, mplsOutSegmentNextHopIpv6Addr=mplsOutSegmentNextHopIpv6Addr, mplsSegmentDiscontinuityGroup=mplsSegmentDiscontinuityGroup, mplsInterfaceConfStorageType=mplsInterfaceConfStorageType, mplsInterfaceConfTable=mplsInterfaceConfTable, mplsTrafficParamGroup=mplsTrafficParamGroup, mplsInterfaceGroup=mplsInterfaceGroup, mplsOutSegmentGroup=mplsOutSegmentGroup, mplsOutSegmentTrafficParamPtr=mplsOutSegmentTrafficParamPtr, mplsXCIndexNext=mplsXCIndexNext, mplsHCInSegmentPerfGroup=mplsHCInSegmentPerfGroup, mplsInSegmentOwner=mplsInSegmentOwner)
