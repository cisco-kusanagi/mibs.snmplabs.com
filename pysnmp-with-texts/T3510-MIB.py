...
# Produced by pysmi-0.3.4 at Wed May  1 15:15:20 2019
...
NotificationType, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, TimeTicks, ObjectIdentity, ModuleIdentity, IpAddress, enterprises, Counter64, MibIdentifier, Integer32, Gauge32, iso, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "IpAddress", "enterprises", "Counter64", "MibIdentifier", "Integer32", "Gauge32", "iso", "Counter32")
...
mibBuilder.exportSymbols("T3510-MIB", readingsint=readingsint, cvlowi=cvlowi, humidityhigh=humidityhigh, temptime=temptime, humiditylow=humiditylow, temperaturei=temperaturei, cvHysti=cvHysti, products=products, alarmhumidity=alarmhumidity, temptimei=temptimei, historyTable=historyTable, histcomputedValue=histcomputedValue, historyEntry=historyEntry, tempHysti=tempHysti, settingsint=settingsint, settings=settings, tables=tables, cvi=cvi, humidityhighi=humidityhighi, temperature=temperature, cvTimei=cvTimei, histhumidity=histhumidity, humidityHysti=humidityHysti, templow=templow, messageString=messageString, humidityi=humidityi, readings=readings, templowi=templowi, humiditylowi=humiditylowi, humidity=humidity, cvlow=cvlow, humidityHyst=humidityHyst, cvHyst=cvHyst, comet=comet, DisplayString=DisplayString, humidityTime=humidityTime, humidityTimei=humidityTimei, tempHyst=tempHyst, cvhigh=cvhigh, cvTime=cvTime, t3510=t3510, alarmTemperature=alarmTemperature, traps=traps, cvhighi=cvhighi, alarmCv=alarmCv, temphigh=temphigh, computedValue=computedValue, histtemperature=histtemperature, temphighi=temphighi)
