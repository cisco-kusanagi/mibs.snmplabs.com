...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS3650-SWL3MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:46:46 2019
...
PositiveInteger, TOSType, Status, HelloRange, UpToMaxAge, AreaID, DesignatedRouterPriority, Metric, RouterID = mibBuilder.importSymbols("OSPF-MIB", "PositiveInteger", "TOSType", "Status", "HelloRange", "UpToMaxAge", "AreaID", "DesignatedRouterPriority", "Metric", "RouterID")
...
TextualConvention, MacAddress, TruthValue, RowStatus, TimeStamp, DisplayString, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "TextualConvention", "MacAddress", "TruthValue", "RowStatus", "TimeStamp", "DisplayString", "PhysAddress")
...
swL3IpCtrlSecondary = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 5, 3, 2, 1, 3, 1, 7), TruthValue()).setMaxAccess("readwrite")
...
swL3IpStaticRouteNextHop = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 5, 3, 2, 5, 1, 4), IpAddress()).setMaxAccess("readonly")
...
swL3RouteRedistriSrcProtocol = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 5, 3, 5, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5))).clone(namedValues=NamedValues(("other", 1), ("rip", 2), ("ospf", 3), ("static", 4), ("local", 5)))).setMaxAccess("readonly")
...
swL3RouteRedistriDstProtocol = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 5, 3, 5, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("other", 1), ("rip", 2), ("ospf", 3)))).setMaxAccess("readonly")
...
swL3RouteRedistriMetric = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 5, 3, 5, 1, 4), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 16777214))).setMaxAccess("readcreate")
...
mibBuilder.exportSymbols("DGS3650-SWL3MGMT-MIB", swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3Md5Entry=swL3Md5Entry, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3RelayDhcpState=swL3RelayDhcpState, swL3RelayDhcpCtrlServer=swL3RelayDhcpCtrlServer, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3RelayDnsState=swL3RelayDnsState, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3RelayDhcpCtrlEntry=swL3RelayDhcpCtrlEntry, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3ospfAreaId=swL3ospfAreaId, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3RouteRedistriType=swL3RouteRedistriType, swL3Md5Table=swL3Md5Table, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3RoutePreference=swL3RoutePreference, swL3ospfIfEntry=swL3ospfIfEntry, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3RelayDhcpTimeThreshold=swL3RelayDhcpTimeThreshold, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3IpMgmt=swL3IpMgmt, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3OspfHostEntry=swL3OspfHostEntry, swL3ospfIfDemand=swL3ospfIfDemand, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3IpCtrlMode=swL3IpCtrlMode, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3Ipv6Address=swL3Ipv6Address, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3DevCtrlDHCPAutoConfigState=swL3DevCtrlDHCPAutoConfigState, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3RelayDhcpCtrlInterfaceName=swL3RelayDhcpCtrlInterfaceName, swL3DevMgmt=swL3DevMgmt, swL3ospfAreaType=swL3ospfAreaType, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3ospfIfMetric=swL3ospfIfMetric, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3IpCtrlState=swL3IpCtrlState, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, Ipv6Address=Ipv6Address, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3VrrpOperTable=swL3VrrpOperTable, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3ospfAreaTable=swL3ospfAreaTable, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3RelayDhcpCtrlState=swL3RelayDhcpCtrlState, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3RelayDhcpOption82State=swL3RelayDhcpOption82State, swL3Md5KeyId=swL3Md5KeyId, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3RelayDhcpOption82CheckState=swL3RelayDhcpOption82CheckState, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3RelayDhcpHopCount=swL3RelayDhcpHopCount, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3Md5Key=swL3Md5Key, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, NetAddress=NetAddress, swL3RelayDhcpMgmt=swL3RelayDhcpMgmt, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3DevCtrl=swL3DevCtrl, swL3ospfIfTable=swL3ospfIfTable, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3IpCtrlTable=swL3IpCtrlTable, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3MgmtMIB=swL3MgmtMIB, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3OspfHostMetric=swL3OspfHostMetric, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3VrrpOperState=swL3VrrpOperState, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3OspfHostStatus=swL3OspfHostStatus, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, NodeAddress=NodeAddress, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3OspfHostTOS=swL3OspfHostTOS, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3OspfHostTable=swL3OspfHostTable, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3RelayDhcpOption82Policy=swL3RelayDhcpOption82Policy, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, VrId=VrId, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3RelayMgmt=swL3RelayMgmt, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3ospfIfState=swL3ospfIfState, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3RelayDhcpCtrlTable=swL3RelayDhcpCtrlTable, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3ospfIfType=swL3ospfIfType, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3Md5RowStatus=swL3Md5RowStatus, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3ospfIfEvents=swL3ospfIfEvents, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState)
