...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS-3420-52T-L3MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:44:18 2019
...
Status, UpToMaxAge, RouterID, HelloRange, PositiveInteger, DesignatedRouterPriority, AreaID, Metric, TOSType = mibBuilder.importSymbols("OSPF-MIB", "Status", "UpToMaxAge", "RouterID", "HelloRange", "PositiveInteger", "DesignatedRouterPriority", "AreaID", "Metric", "TOSType")
ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup")
MibIdentifier, Bits, NotificationType, IpAddress, Integer32, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, Gauge32, ObjectIdentity, Counter64, Counter32, ModuleIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Bits", "NotificationType", "IpAddress", "Integer32", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "Gauge32", "ObjectIdentity", "Counter64", "Counter32", "ModuleIdentity", "Unsigned32")
RowStatus, TextualConvention, MacAddress, TruthValue, DisplayString, PhysAddress, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "TextualConvention", "MacAddress", "TruthValue", "DisplayString", "PhysAddress", "TimeStamp")
...
swL3OspfECMPMgmt = MibIdentifier((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 15))
swL3RIPTimerMgmt = MibIdentifier((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 17))
swL3OspfDefInfoOrigMgmt = MibIdentifier((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 18))
...
swL3DevCtrlOSPFState = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 1, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("other", 1), ("disabled", 2), ("enabled", 3)))).setMaxAccess("readwrite")
...
swL3DevCtrlDVMRPState = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 1, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("other", 1), ("disabled", 2), ("enabled", 3)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 1, 3, 1, 28), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3IpCtrlIpv6AutoConfigDefault = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 1, 3, 1, 29), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 1, 3, 1, 30), TruthValue()).setMaxAccess("readwrite")
...
swL3IpCtrlDhcpv6ClientPdRapidCommit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 1, 3, 1, 31), TruthValue()).setMaxAccess("readwrite")
...
swL3Ipv6CtrlDadRetransNum = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 1, 4, 1, 14), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 255))).setMaxAccess("readwrite")
...
swL3Ipv6CtrlOptimisticDadState = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 1, 4, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3LoopBackIpv6CtrlTable = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 1, 9), )
...
swL3LoopBackIpv6CtrlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 1, 9, 1), ).setIndexNames((0, "DGS-3420-52T-L3MGMT-MIB", "swL3LoopBackIpv6CtrlInterfaceName"), (0, "DGS-3420-52T-L3MGMT-MIB", "swL3LoopBackIpv6CtrlIpv6Address"), (0, "DGS-3420-52T-L3MGMT-MIB", "swL3LoopBackIpv6CtrlIpv6PrefixLen"))
...
swL3LoopBackIpv6CtrlInterfaceName = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 1, 9, 1, 1), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 12)))
...
swL3LoopBackIpv6CtrlIpv6Address = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 1, 9, 1, 2), Ipv6Address())
...
swL3LoopBackIpv6CtrlIpv6PrefixLen = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 1, 9, 1, 3), Integer32())
...
swL3LoopBackIpv6CtrlRowStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 1, 9, 1, 99), RowStatus()).setMaxAccess("readcreate")
...
swL3IpMcastStaticRouteTable = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 6, 1), )
...
swL3IpMcastStaticRouteEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 6, 1, 1), ).setIndexNames((0, "DGS-3420-52T-L3MGMT-MIB", "swL3IpMcastStaticRouteIpmrouteAddr"), (0, "DGS-3420-52T-L3MGMT-MIB", "swL3IpMcastStaticRouteIpmrouteMask"))
...
swL3IpMcastStaticRouteIpmrouteAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 6, 1, 1, 1), IpAddress())
...
swL3IpMcastStaticRouteIpmrouteMask = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 6, 1, 1, 2), IpAddress())
...
swL3IpMcastStaticRouteRpfAddr = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 6, 1, 1, 3), IpAddress()).setMaxAccess("readcreate")
...
swL3IpMcastStaticRouteRowStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 2, 6, 1, 1, 4), RowStatus()).setMaxAccess("readcreate")
...
swL3Md5Table = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 4), )
...
swL3Md5Entry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 4, 1), ).setIndexNames((0, "DGS-3420-52T-L3MGMT-MIB", "swL3Md5KeyId"))
...
swL3Md5KeyId = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 4, 1, 1), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 255))).setMaxAccess("readonly")
if mibBuilder.loadTexts: swL3Md5KeyId.setStatus('current')
if mibBuilder.loadTexts: swL3Md5KeyId.setDescription('The MD5 key ID.')
swL3Md5Key = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 4, 1, 2), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(1, 16))).setMaxAccess("readcreate")
...
swL3Md5RowStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 4, 1, 3), RowStatus()).setMaxAccess("readcreate")
...
swL3RouteRedistriRouteMapName = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 5, 1, 6), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 16))).setMaxAccess("readcreate")
...
swL3OspfHostTable = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 6), )
...
swL3OspfHostEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 6, 1), ).setIndexNames((0, "DGS-3420-52T-L3MGMT-MIB", "swL3OspfHostIpAddress"), (0, "DGS-3420-52T-L3MGMT-MIB", "swL3OspfHostTOS"))
...
swL3OspfHostIpAddress = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 6, 1, 1), IpAddress()).setMaxAccess("readonly")
...
swL3OspfHostTOS = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 6, 1, 2), TOSType()).setMaxAccess("readonly")
...
swL3OspfHostMetric = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 6, 1, 3), Metric()).setMaxAccess("readcreate")
...
swL3OspfHostAreaID = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 6, 1, 4), AreaID()).setMaxAccess("readcreate")
...
swL3OspfHostStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 6, 1, 5), RowStatus()).setMaxAccess("readcreate")
...
swL3ospfVirtIfTable = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7), )
...
swL3ospfVirtIfEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1), ).setIndexNames((0, "DGS-3420-52T-L3MGMT-MIB", "swL3ospfVirtIfAreaId"), (0, "DGS-3420-52T-L3MGMT-MIB", "swL3ospfVirtIfNeighbor"))
...
swL3ospfVirtIfAreaId = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1, 1), AreaID()).setMaxAccess("readonly")
...
swL3ospfVirtIfNeighbor = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1, 2), RouterID()).setMaxAccess("readonly")
...
swL3ospfVirtIfTransitDelay = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1, 3), UpToMaxAge().clone(1)).setMaxAccess("readonly")
...
swL3ospfVirtIfRetransInterval = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1, 4), UpToMaxAge().clone(5)).setMaxAccess("readonly")
...
swL3ospfVirtIfHelloInterval = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1, 5), HelloRange().clone(10)).setMaxAccess("readcreate")
...
swL3ospfVirtIfRtrDeadInterval = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1, 6), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 65535)).clone(60)).setMaxAccess("readcreate")
...
swL3ospfVirtIfState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1, 7), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 4))).clone(namedValues=NamedValues(("down", 1), ("pointToPoint", 4))).clone('down')).setMaxAccess("readonly")
...
swL3ospfVirtIfEvents = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1, 8), Counter32()).setMaxAccess("readonly")
...
swL3ospfVirtIfAuthType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1, 9), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 255))).setMaxAccess("readcreate")
...
swL3ospfVirtIfAuthKey = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1, 10), OctetString().subtype(subtypeSpec=ValueSizeConstraint(0, 256)).clone(hexValue="0000000000000000")).setMaxAccess("readcreate")
...
swL3ospfVirtIfAuthKeyID = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1, 11), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 255))).setMaxAccess("readcreate")
...
swL3ospfVirtIfStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 7, 1, 12), RowStatus()).setMaxAccess("readcreate")
...
swL3ospfIfTable = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8), )
...
swL3ospfIfEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1), ).setIndexNames((0, "DGS-3420-52T-L3MGMT-MIB", "swL3ospfIfIpAddress"), (0, "DGS-3420-52T-L3MGMT-MIB", "swL3ospfAddressLessIf"))
...
swL3ospfIfIpAddress = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 1), IpAddress()).setMaxAccess("readonly")
...
swL3ospfAddressLessIf = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 2), Integer32()).setMaxAccess("readonly")
...
swL3ospfIfAreaId = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 3), AreaID().clone(hexValue="00000000")).setMaxAccess("readwrite")
...
swL3ospfIfType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 5))).clone(namedValues=NamedValues(("broadcast", 1), ("nbma", 2), ("pointToPoint", 3), ("pointToMultipoint", 5)))).setMaxAccess("readwrite")
...
swL3ospfIfAdminStat = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 5), Status().clone('enabled')).setMaxAccess("readwrite")
...
swL3ospfIfRtrPriority = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 6), DesignatedRouterPriority().clone(1)).setMaxAccess("readwrite")
...
swL3ospfIfTransitDelay = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 7), UpToMaxAge().clone(1)).setMaxAccess("readonly")
...
swL3ospfIfRetransInterval = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 8), UpToMaxAge().clone(5)).setMaxAccess("readonly")
...
swL3ospfIfHelloInterval = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 9), HelloRange().clone(10)).setMaxAccess("readwrite")
...
swL3ospfIfRtrDeadInterval = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 10), PositiveInteger().clone(40)).setMaxAccess("readwrite")
...
swL3ospfIfPollInterval = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 11), PositiveInteger().clone(120)).setMaxAccess("readonly")
...
swL3ospfIfState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 12), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7))).clone(namedValues=NamedValues(("down", 1), ("loopback", 2), ("waiting", 3), ("pointToPoint", 4), ("designatedRouter", 5), ("backupDesignatedRouter", 6), ("otherDesignatedRouter", 7))).clone('down')).setMaxAccess("readonly")
...
swL3ospfIfDesignatedRouter = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 13), IpAddress().clone(hexValue="00000000")).setMaxAccess("readonly")
...
swL3ospfIfBackupDesignatedRouter = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 14), IpAddress().clone(hexValue="00000000")).setMaxAccess("readonly")
...
swL3ospfIfEvents = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 15), Counter32()).setMaxAccess("readonly")
...
swL3ospfIfMulticastForwarding = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 16), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("blocked", 1), ("multicast", 2), ("unicast", 3))).clone('blocked')).setMaxAccess("readonly")
...
swL3ospfIfDemand = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 17), TruthValue().clone('false')).setMaxAccess("readonly")
...
swL3ospfIfAuthType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 18), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 255))).setMaxAccess("readwrite")
...
swL3ospfIfAuthKey = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 19), OctetString().subtype(subtypeSpec=ValueSizeConstraint(0, 256)).clone(hexValue="0000000000000000")).setMaxAccess("readwrite")
...
swL3ospfIfAuthKeyID = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 20), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 255))).setMaxAccess("readwrite")
...
swL3ospfIfPassiveMode = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 21), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("other", 1), ("disabled", 2), ("enabled", 3)))).setMaxAccess("readwrite")
...
swL3ospfIfMetric = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 23), Metric()).setMaxAccess("readwrite")
...
swL3ospfIfDistributeListInType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 24), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
swL3ospfIfDistributeListInName = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 8, 1, 25), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 16))).setMaxAccess("readwrite")
...
swL3RoutePreferenceOSPFIntra = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 9, 2), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 999))).setMaxAccess("readwrite")
...
swL3RoutePreferenceOSPFInter = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 9, 5), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 999))).setMaxAccess("readwrite")
...
swL3RoutePreferenceOSPFExtT1 = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 9, 6), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 999))).setMaxAccess("readwrite")
...
swL3RoutePreferenceOSPFExtT2 = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 9, 7), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 999))).setMaxAccess("readwrite")
...
swL3ospfAreaTable = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 10), )
...
swL3ospfAreaEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 10, 1), ).setIndexNames((0, "DGS-3420-52T-L3MGMT-MIB", "swL3ospfAreaId"))
...
swL3ospfAreaId = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 10, 1, 1), AreaID()).setMaxAccess("readonly")
...
swL3ospfAreaType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 10, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("normal", 1), ("stub", 2), ("nssa", 3)))).setMaxAccess("readcreate")
...
swL3ospfAreaSummaryState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 10, 1, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("none", 1), ("disabled", 2), ("enabled", 3)))).setMaxAccess("readcreate")
...
swL3ospfAreaMetric = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 10, 1, 4), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readwrite")
...
swL3ospfAreaTranslateState = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 10, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("none", 1), ("disabled", 2), ("enabled", 3)))).setMaxAccess("readcreate")
...
swL3ospfAreaStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 10, 1, 6), RowStatus()).setMaxAccess("readcreate")
...
swL3dvmrpInterfaceTable = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 12), )
...
swL3dvmrpInterfaceEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 12, 1), ).setIndexNames((0, "DGS-3420-52T-L3MGMT-MIB", "swL3dvmrpInterfaceIfIndex"))
...
swL3dvmrpInterfaceIfIndex = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 12, 1, 1), Integer32())
...
swL3dvmrpInterfaceLocalAddress = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 12, 1, 2), IpAddress()).setMaxAccess("readcreate")
...
swL3dvmrpInterfaceMetric = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 12, 1, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 31)).clone(1)).setMaxAccess("readcreate")
...
swL3dvmrpInterfaceProbe = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 12, 1, 4), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 65535)).clone(10)).setMaxAccess("readcreate")
...
swL3dvmrpInterfaceNbrTimeout = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 12, 1, 5), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 65535)).clone(35)).setMaxAccess("readcreate")
...
swL3dvmrpInterfaceStatus = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 12, 1, 6), RowStatus()).setMaxAccess("readcreate")
...
swL3dvmrpInterfaceRcvBadPkts = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 12, 1, 7), Counter32()).setMaxAccess("readonly")
...
swL3dvmrpInterfaceRcvBadRoutes = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 12, 1, 8), Counter32()).setMaxAccess("readonly")
...
swL3OspfInternalLsdbTable = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 1), )
...
swL3OspfInternalLsdbEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 1, 1), ).setIndexNames((0, "DGS-3420-52T-L3MGMT-MIB", "swL3OspfInternalLsdbAreaId"), (0, "DGS-3420-52T-L3MGMT-MIB", "swL3OspfInternalLsdbType"), (0, "DGS-3420-52T-L3MGMT-MIB", "swL3OspfInternalLsdbLsid"), (0, "DGS-3420-52T-L3MGMT-MIB", "swL3OspfInternalLsdbRouterId"))
...
swL3OspfInternalLsdbAreaId = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 1, 1, 1), AreaID()).setMaxAccess("readonly")
...
swL3OspfInternalLsdbType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 1, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 7))).clone(namedValues=NamedValues(("routerLink", 1), ("networkLink", 2), ("summaryLink", 3), ("asSummaryLink", 4), ("asExternalLink", 5), ("multicastLink", 6), ("nssaExternalLink", 7)))).setMaxAccess("readonly")
...
swL3OspfInternalLsdbLsid = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 1, 1, 3), IpAddress()).setMaxAccess("readonly")
...
swL3OspfInternalLsdbRouterId = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 1, 1, 4), RouterID()).setMaxAccess("readonly")
...
swL3OspfInternalLsdbMetric = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 1, 1, 5), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
...
swL3OspfInternalLsdbSequenceNo = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 1, 1, 6), OctetString().subtype(subtypeSpec=ValueSizeConstraint(4, 4)).setFixedLength(4)).setMaxAccess("readonly")
...
swL3OspfInternalLsdbAge = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 1, 1, 7), Unsigned32()).setMaxAccess("readonly")
...
swL3OspfInternalLsdbChecksum = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 1, 1, 8), Integer32()).setMaxAccess("readonly")
...
swL3OspfExternalLsdbTable = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 2), )
...
swL3OspfExternalLsdbEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 2, 1), ).setIndexNames((0, "DGS-3420-52T-L3MGMT-MIB", "swL3OspfExternalLsdbType"), (0, "DGS-3420-52T-L3MGMT-MIB", "swL3OspfExternalLsdbLsid"), (0, "DGS-3420-52T-L3MGMT-MIB", "swL3OspfExternalLsdbRouterId"))
...
swL3OspfExternalLsdbType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 2, 1, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(5, 7))).clone(namedValues=NamedValues(("asExternalLink", 5), ("nssaExternalLink", 7)))).setMaxAccess("readonly")
...
swL3OspfExternalLsdbLsid = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 2, 1, 2), IpAddress()).setMaxAccess("readonly")
...
swL3OspfExternalLsdbRouterId = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 2, 1, 3), RouterID()).setMaxAccess("readonly")
...
swL3OspfExternalLsdbMetric = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 2, 1, 4), Integer32().subtype(subtypeSpec=ValueRangeConstraint(0, 65535))).setMaxAccess("readonly")
...
swL3OspfExternalLsdbMetricType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 2, 1, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2))).clone(namedValues=NamedValues(("unrecognized", 0), ("type-1", 1), ("type-2", 2)))).setMaxAccess("readonly")
...
swL3OspfExternalLsdbSequenceNo = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 2, 1, 6), OctetString().subtype(subtypeSpec=ValueSizeConstraint(4, 4)).setFixedLength(4)).setMaxAccess("readonly")
...
swL3OspfExternalLsdbAge = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 2, 1, 7), Unsigned32()).setMaxAccess("readonly")
...
swL3OspfExternalLsdbChecksum = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 2, 1, 8), Integer32()).setMaxAccess("readonly")
...
swL3OspfExternalLsdbForwardingAddress = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 2, 1, 9), IpAddress()).setMaxAccess("readonly")
...
swL3OspfExternalLsdbRouteTag = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 13, 2, 1, 10), OctetString()).setMaxAccess("readonly")
...
swL3OspfECMPIpDestination = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 15, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2))).clone('enabled')).setMaxAccess("readwrite")
...
swL3OspfECMPIpSource = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 15, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2))).clone('disabled')).setMaxAccess("readwrite")
...
swL3OspfECMPCrcLow = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 15, 3), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2))).clone('enabled')).setMaxAccess("readwrite")
...
swL3OspfECMPCrcHigh = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 15, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2))).clone('disabled')).setMaxAccess("readwrite")
...
swL3OspfECMPTCPorUDPport = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 15, 5), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2))).clone('disabled')).setMaxAccess("readwrite")
...
swL3OspfECMPState = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 15, 6), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("enabled", 1), ("disabled", 2)))).setMaxAccess("readwrite")
...
swL3OspfDefInfoOriginate = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 18, 1), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 3))).clone(namedValues=NamedValues(("always", 1), ("default", 2), ("none", 3))).clone('none')).setMaxAccess("readwrite")
...
swL3OspfDefInfoOrigMetricType = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 18, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("type-1", 1), ("type-2", 2))).clone('type-2')).setMaxAccess("readwrite")
...
swL3OspfDefInfoOrigMetric = MibScalar((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 18, 3), Integer32().subtype(subtypeSpec=ValueRangeConstraint(1, 65535)).clone(10)).setMaxAccess("readwrite")
...
swL3RIPInboundRouteFilterTable = MibTable((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 19), )
...
swL3RIPInboundRouteFilterEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 19, 1), ).setIndexNames((0, "DGS-3420-52T-L3MGMT-MIB", "swL3RIPInboundRouteFilterIfIpAddress"))
...
swL3RIPInboundRouteFilterIfIpAddress = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 19, 1, 1), IpAddress()).setMaxAccess("readonly")
...
swL3RIPInboundRouteFilterType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 19, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
swL3RIPInboundRouteFilterName = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 119, 4, 3, 19, 1, 3), DisplayString().subtype(subtypeSpec=ValueSizeConstraint(0, 16))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS-3420-52T-L3MGMT-MIB", swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3OspfHostTOS=swL3OspfHostTOS, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3IpCtrlDhcpv6ClientRapidCommit=swL3IpCtrlDhcpv6ClientRapidCommit, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3IpMgmt=swL3IpMgmt, swL3IpCtrlLocalProxyArp=swL3IpCtrlLocalProxyArp, swL3OspfDefInfoOrigMetricType=swL3OspfDefInfoOrigMetricType, swL3RIPInboundRouteFilterType=swL3RIPInboundRouteFilterType, swL3RIPTimerMgmt=swL3RIPTimerMgmt, swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=swL3Ipv6DHCPv6CPDAddrCtrlPrefixName, swL3ospfIfMetric=swL3ospfIfMetric, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName, swL3Route6RedistriSrcProtocol=swL3Route6RedistriSrcProtocol, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3LoopBackIpCtrlIpSubnetMask=swL3LoopBackIpCtrlIpSubnetMask, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3ospfIfTable=swL3ospfIfTable, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3LoopBackIpCtrlEntry=swL3LoopBackIpCtrlEntry, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3LoopBackIpv6CtrlEntry=swL3LoopBackIpv6CtrlEntry, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3ospfIfState=swL3ospfIfState, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3Ipv6DHCPv6CPDAddrCtrlEntry=swL3Ipv6DHCPv6CPDAddrCtrlEntry, swL3OspfDefInfoOrigMetric=swL3OspfDefInfoOrigMetric, swL3ospfIfDemand=swL3ospfIfDemand, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3Md5Key=swL3Md5Key, swL3Ipv6CtrlOptimisticDadState=swL3Ipv6CtrlOptimisticDadState, swL3Route6RedistriDstProtocol=swL3Route6RedistriDstProtocol, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3Md5RowStatus=swL3Md5RowStatus, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3IpCtrlDhcpv6ClientPDState=swL3IpCtrlDhcpv6ClientPDState, swL3VrrpOperTable=swL3VrrpOperTable, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3IpCtrlState=swL3IpCtrlState, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen, swL3ospfIfDistributeListInType=swL3ospfIfDistributeListInType, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3IpCtrlTable=swL3IpCtrlTable, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3Md5Entry=swL3Md5Entry, swL3ospfIfType=swL3ospfIfType, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3LoopBackIpCtrlInterfaceName=swL3LoopBackIpCtrlInterfaceName, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3IpStaticRouteTunnelRowStatus=swL3IpStaticRouteTunnelRowStatus, swL3DevMgmt=swL3DevMgmt, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3MgmtMIB=swL3MgmtMIB, swL3IpStaticRouteTunnelInterfaceName=swL3IpStaticRouteTunnelInterfaceName, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3RelayMgmt=swL3RelayMgmt, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3Ipv6DHCPv6CPDAddrCtrlTable=swL3Ipv6DHCPv6CPDAddrCtrlTable, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3IpCtrlIpv4AdminState=swL3IpCtrlIpv4AdminState, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3RIPInboundRouteFilterIfIpAddress=swL3RIPInboundRouteFilterIfIpAddress, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3IpCtrlIpv6AdminState=swL3IpCtrlIpv6AdminState, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3RelayDnsState=swL3RelayDnsState, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3RIPInboundRouteFilterName=swL3RIPInboundRouteFilterName, swL3Route6RedistriEntry=swL3Route6RedistriEntry, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3ospfAreaType=swL3ospfAreaType, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3IpStaticRouteTunnelTable=swL3IpStaticRouteTunnelTable, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3Md5Table=swL3Md5Table, swL3IpCtrlIpDirectedBroadcastState=swL3IpCtrlIpDirectedBroadcastState, NodeAddress=NodeAddress, swL3OspfHostMetric=swL3OspfHostMetric, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3RIPGarbageCollectionTime=swL3RIPGarbageCollectionTime, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3IpCtrlMode=swL3IpCtrlMode, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3ospfIfEntry=swL3ospfIfEntry, swL3OspfHostStatus=swL3OspfHostStatus, swL3IpStaticRouteTunnelEntry=swL3IpStaticRouteTunnelEntry, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3RIPUpdateTime=swL3RIPUpdateTime, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3RouteRedistriType=swL3RouteRedistriType, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3Md5KeyId=swL3Md5KeyId, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3Route6RedistriRowStatus=swL3Route6RedistriRowStatus, swL3ospfIfDistributeListInName=swL3ospfIfDistributeListInName, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3LoopBackIpCtrlTable=swL3LoopBackIpCtrlTable, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3IpCtrlDhcpv6ClientPDPrefix=swL3IpCtrlDhcpv6ClientPDPrefix, swL3DevCtrl=swL3DevCtrl, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3Route6RedistriType=swL3Route6RedistriType, swL3ospfIfEvents=swL3ospfIfEvents, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3ospfAreaTable=swL3ospfAreaTable, swL3RIPInboundRouteFilterEntry=swL3RIPInboundRouteFilterEntry, swL3LoopBackIpv6CtrlInterfaceName=swL3LoopBackIpv6CtrlInterfaceName, swL3Ipv6Address=swL3Ipv6Address, swL3OspfECMPState=swL3OspfECMPState, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3RIPTimeOutTime=swL3RIPTimeOutTime, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, NetAddress=NetAddress, swL3OspfHostTable=swL3OspfHostTable, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3LoopBackIpCtrlIfIndex=swL3LoopBackIpCtrlIfIndex, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr, swL3LoopBackIpv6CtrlIpv6PrefixLen=swL3LoopBackIpv6CtrlIpv6PrefixLen, swL3LoopBackIpCtrlIpAddr=swL3LoopBackIpCtrlIpAddr, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3Route6RedistriTable=swL3Route6RedistriTable, swL3Route6RedistriMetric=swL3Route6RedistriMetric, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3IpCtrlIpv6AutoConfigDefault=swL3IpCtrlIpv6AutoConfigDefault, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3Ipv6AddressCtrlAddressType=swL3Ipv6AddressCtrlAddressType, swL3RoutePreferenceDefault=swL3RoutePreferenceDefault, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3OspfDefInfoOrigMgmt=swL3OspfDefInfoOrigMgmt, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3IpCtrlIpv6AutoConfigState=swL3IpCtrlIpv6AutoConfigState, swL3IpCtrlDhcpv6ClientPDPrefixName=swL3IpCtrlDhcpv6ClientPDPrefixName, swL3LoopBackIpCtrlAdminState=swL3LoopBackIpCtrlAdminState, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3LoopBackIpv6CtrlRowStatus=swL3LoopBackIpv6CtrlRowStatus, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3LoopBackIpv6CtrlIpv6Address=swL3LoopBackIpv6CtrlIpv6Address)
mibBuilder.exportSymbols("DGS-3420-52T-L3MGMT-MIB", swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3VrrpOperState=swL3VrrpOperState, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3IpCtrlDhcpv6ClientPDPrefixLen=swL3IpCtrlDhcpv6ClientPDPrefixLen, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3IpCtrlDhcpv6ClientPdRapidCommit=swL3IpCtrlDhcpv6ClientPdRapidCommit, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3OspfHostEntry=swL3OspfHostEntry, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3VrrpOperPriority=swL3VrrpOperPriority, VrId=VrId, swL3RouteRedistriRouteMapName=swL3RouteRedistriRouteMapName, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3RoutePreference=swL3RoutePreference, swL3LoopBackIpv6CtrlTable=swL3LoopBackIpv6CtrlTable, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3ospfAreaId=swL3ospfAreaId, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3LoopBackIpCtrlRowStatus=swL3LoopBackIpCtrlRowStatus, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3Ipv6CtrlDadRetransNum=swL3Ipv6CtrlDadRetransNum, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3OspfDefInfoOriginate=swL3OspfDefInfoOriginate, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3RIPInboundRouteFilterTable=swL3RIPInboundRouteFilterTable, swL3Ipv6DHCPv6CPDAddrCtrlState=swL3Ipv6DHCPv6CPDAddrCtrlState)
