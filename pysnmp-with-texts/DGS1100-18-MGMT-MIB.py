...
# Produced by pysmi-0.3.4 at Wed May  1 12:45:22 2019
...
iso, ObjectIdentity, Unsigned32, Integer32, Gauge32, MibIdentifier, ModuleIdentity, TimeTicks, Counter64, Bits, IpAddress, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ObjectIdentity", "Unsigned32", "Integer32", "Gauge32", "MibIdentifier", "ModuleIdentity", "TimeTicks", "Counter64", "Bits", "IpAddress", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
mibBuilder.exportSymbols("DGS1100-18-MGMT-MIB", VlanId=VlanId, VlanIndex=VlanIndex, PYSNMP_MODULE_ID=swL2MgmtMIB, PortList=PortList, swL2MgmtMIB=swL2MgmtMIB)
