...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS3612G-SWL3MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:46:37 2019
...
Status, AreaID, DesignatedRouterPriority, HelloRange, TOSType, PositiveInteger, UpToMaxAge, Metric, RouterID = mibBuilder.importSymbols("OSPF-MIB", "Status", "AreaID", "DesignatedRouterPriority", "HelloRange", "TOSType", "PositiveInteger", "UpToMaxAge", "Metric", "RouterID")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
Unsigned32, Bits, ObjectIdentity, NotificationType, IpAddress, Counter32, MibIdentifier, TimeTicks, iso, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Counter64, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Bits", "ObjectIdentity", "NotificationType", "IpAddress", "Counter32", "MibIdentifier", "TimeTicks", "iso", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Counter64", "ModuleIdentity")
TruthValue, PhysAddress, TextualConvention, DisplayString, MacAddress, RowStatus, TimeStamp = mibBuilder.importSymbols("SNMPv2-TC", "TruthValue", "PhysAddress", "TextualConvention", "DisplayString", "MacAddress", "RowStatus", "TimeStamp")
...
swL3ospfIfDistributeListInType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 9, 3, 8, 1, 24), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
swL3RIPInboundRouteFilterType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 70, 9, 3, 19, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2))).clone(namedValues=NamedValues(("none", 1), ("access-list", 2)))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS3612G-SWL3MGMT-MIB", swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3RouteRedistriType=swL3RouteRedistriType, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3RelayDhcpCtrlServer=swL3RelayDhcpCtrlServer, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3RelayDhcpCtrlState=swL3RelayDhcpCtrlState, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3Md5Key=swL3Md5Key, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3IpCtrlIpDirectedBroadcastState=swL3IpCtrlIpDirectedBroadcastState, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3Route6RedistriType=swL3Route6RedistriType, swL3RIPInboundRouteFilterTable=swL3RIPInboundRouteFilterTable, swL3IpCtrlDhcpv6ClientPDPrefixName=swL3IpCtrlDhcpv6ClientPDPrefixName, swL3RIPInboundRouteFilterIfIpAddress=swL3RIPInboundRouteFilterIfIpAddress, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3RelayDnsState=swL3RelayDnsState, swL3IpCtrlTable=swL3IpCtrlTable, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3DHCPRelayOption60Table=swL3DHCPRelayOption60Table, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3IpCtrlLocalProxyArp=swL3IpCtrlLocalProxyArp, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3DHCPRelayOption60DefMode=swL3DHCPRelayOption60DefMode, swL3Route6RedistriDstProtocol=swL3Route6RedistriDstProtocol, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3RelayDhcpState=swL3RelayDhcpState, swL3DevCtrlDHCPAutoConfigState=swL3DevCtrlDHCPAutoConfigState, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3Route6RedistriRowStatus=swL3Route6RedistriRowStatus, swL3ospfIfMetric=swL3ospfIfMetric, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName, swL3OspfHostTOS=swL3OspfHostTOS, swL3ospfIfPollInterval=swL3ospfIfPollInterval, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3Md5Table=swL3Md5Table, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3RIPInboundRouteFilterEntry=swL3RIPInboundRouteFilterEntry, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3DHCPRelayOption60RowStatus=swL3DHCPRelayOption60RowStatus, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3OspfHostTable=swL3OspfHostTable, swL3IpCtrlDhcpv6ClientPDPrefixLen=swL3IpCtrlDhcpv6ClientPDPrefixLen, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3DHCPRelayOption60DefTable=swL3DHCPRelayOption60DefTable, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3LoopBackIpCtrlTable=swL3LoopBackIpCtrlTable, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3Md5RowStatus=swL3Md5RowStatus, NodeAddress=NodeAddress, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3RelayDhcpMgmt=swL3RelayDhcpMgmt, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3ospfIfEntry=swL3ospfIfEntry, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3DevMgmt=swL3DevMgmt, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3Md5Entry=swL3Md5Entry, swL3LoopBackIpCtrlAdminState=swL3LoopBackIpCtrlAdminState, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3RIPInboundRouteFilterName=swL3RIPInboundRouteFilterName, swL3ospfIfDemand=swL3ospfIfDemand, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3RelayDhcpOption82CheckState=swL3RelayDhcpOption82CheckState, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3OspfHostStatus=swL3OspfHostStatus, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3ospfIfState=swL3ospfIfState, swL3IpCtrlMode=swL3IpCtrlMode, swL3RelayDhcpTimeThreshold=swL3RelayDhcpTimeThreshold, swL3DHCPRelayOption61Entry=swL3DHCPRelayOption61Entry, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3DHCPRelayOption61ClientID=swL3DHCPRelayOption61ClientID, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3ospfIfTable=swL3ospfIfTable, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3ospfAreaType=swL3ospfAreaType, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3DevCtrl=swL3DevCtrl, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3IpCtrlState=swL3IpCtrlState, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3Ipv6Address=swL3Ipv6Address, swL3IpCtrlDhcpv6ClientPDState=swL3IpCtrlDhcpv6ClientPDState, swL3RelayDhcpOption82State=swL3RelayDhcpOption82State, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3Route6RedistriEntry=swL3Route6RedistriEntry, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3DHCPRelayOption61DefRelayIp=swL3DHCPRelayOption61DefRelayIp, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3DHCPRelayOption61RelayIp=swL3DHCPRelayOption61RelayIp, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3OspfECMPState=swL3OspfECMPState, swL3RelayDhcpCtrlInterfaceName=swL3RelayDhcpCtrlInterfaceName, swL3DevCtrlPIMState=swL3DevCtrlPIMState, swL3DHCPRelayOption61Mode=swL3DHCPRelayOption61Mode, swL3DHCPRelayOption60RelayIp=swL3DHCPRelayOption60RelayIp, swL3Ipv6DHCPv6CPDAddrCtrlState=swL3Ipv6DHCPv6CPDAddrCtrlState, swL3DHCPRelayOption60Entry=swL3DHCPRelayOption60Entry, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3Route6RedistriMetric=swL3Route6RedistriMetric, swL3IpMgmt=swL3IpMgmt, swL3DHCPRelayOption60MatchType=swL3DHCPRelayOption60MatchType, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3ospfAreaId=swL3ospfAreaId, swL3RIPInboundRouteFilterType=swL3RIPInboundRouteFilterType, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3MgmtMIB=swL3MgmtMIB, swL3ospfIfDistributeListInName=swL3ospfIfDistributeListInName, swL3DHCPRelayOption61Table=swL3DHCPRelayOption61Table, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3OspfHostMetric=swL3OspfHostMetric, swL3DHCPRelayOption60=swL3DHCPRelayOption60, swL3LoopBackIpCtrlEntry=swL3LoopBackIpCtrlEntry, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3LoopBackIpCtrlIfIndex=swL3LoopBackIpCtrlIfIndex, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3ospfIfEvents=swL3ospfIfEvents, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3LoopBackIpCtrlInterfaceName=swL3LoopBackIpCtrlInterfaceName, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3IpCtrlDhcpv6ClientPDPrefix=swL3IpCtrlDhcpv6ClientPDPrefix, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3RoutePreference=swL3RoutePreference, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3DHCPRelayOption60DefRowStatus=swL3DHCPRelayOption60DefRowStatus, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, NetAddress=NetAddress, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3DHCPRelayOption61=swL3DHCPRelayOption61, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3ospfIfType=swL3ospfIfType, swL3ospfIfDistributeListInType=swL3ospfIfDistributeListInType, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3VrrpOperTable=swL3VrrpOperTable, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3RoutePreferenceEBGP=swL3RoutePreferenceEBGP, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, Ipv6Address=Ipv6Address, swL3LoopBackIpCtrlIpAddr=swL3LoopBackIpCtrlIpAddr, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3RelayDhcpOption82Policy=swL3RelayDhcpOption82Policy, swL3RelayMgmt=swL3RelayMgmt, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3DHCPRelayOption60DefEntry=swL3DHCPRelayOption60DefEntry, swL3DHCPRelayOption60String=swL3DHCPRelayOption60String, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3LoopBackIpCtrlRowStatus=swL3LoopBackIpCtrlRowStatus, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3Ipv6DHCPv6CPDAddrCtrlTable=swL3Ipv6DHCPv6CPDAddrCtrlTable, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3Ipv6DHCPv6CPDAddrCtrlEntry=swL3Ipv6DHCPv6CPDAddrCtrlEntry, swL3DHCPRelayOption61ClientType=swL3DHCPRelayOption61ClientType)
mibBuilder.exportSymbols("DGS3612G-SWL3MGMT-MIB", swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3Md5KeyId=swL3Md5KeyId, swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=swL3Ipv6DHCPv6CPDAddrCtrlPrefixName, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3Route6RedistriSrcProtocol=swL3Route6RedistriSrcProtocol, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3VrrpOperState=swL3VrrpOperState, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3DHCPRelayOption61State=swL3DHCPRelayOption61State, VrId=VrId, swL3RouteRedistriRouteMapName=swL3RouteRedistriRouteMapName, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3DHCPRelayOption61RowStatus=swL3DHCPRelayOption61RowStatus, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3RelayDhcpCtrlTable=swL3RelayDhcpCtrlTable, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3DHCPRelayOption60DefRelayIp=swL3DHCPRelayOption60DefRelayIp, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3LoopBackIpCtrlIpSubnetMask=swL3LoopBackIpCtrlIpSubnetMask, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3OspfHostEntry=swL3OspfHostEntry, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3DHCPRelayOption60State=swL3DHCPRelayOption60State, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3ospfAreaTable=swL3ospfAreaTable, swL3RoutePreferenceDefault=swL3RoutePreferenceDefault, swL3Route6RedistriTable=swL3Route6RedistriTable, swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen, swL3RoutePreferenceIBGP=swL3RoutePreferenceIBGP, swL3DHCPRelayOption61DefMode=swL3DHCPRelayOption61DefMode, swL3RelayDhcpCtrlEntry=swL3RelayDhcpCtrlEntry, swL3Ipv6AddressCtrlAddressType=swL3Ipv6AddressCtrlAddressType, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3RelayDhcpHopCount=swL3RelayDhcpHopCount, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry)
