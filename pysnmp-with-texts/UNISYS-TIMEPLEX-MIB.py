...
# Produced by pysmi-0.3.4 at Wed May  1 15:28:45 2019
...
iso, ModuleIdentity, mgmt, Counter32, Bits, MibIdentifier, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, ObjectIdentity, Gauge32, Counter64, Unsigned32, IpAddress, Integer32, NotificationType, enterprises = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "ModuleIdentity", "mgmt", "Counter32", "Bits", "MibIdentifier", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ObjectIdentity", "Gauge32", "Counter64", "Unsigned32", "IpAddress", "Integer32", "NotificationType", "enterprises")
...
mibBuilder.exportSymbols("UNISYS-TIMEPLEX-MIB", tl1breInEFs=tl1breInEFs, tl1fddiSMTMACCount=tl1fddiSMTMACCount, tl1idpErrOutSocket=tl1idpErrOutSocket, uegpNumberNeighbors=uegpNumberNeighbors, tl1srtbDupLanIdOrTreeError=tl1srtbDupLanIdOrTreeError, tl1pppCrCount=tl1pppCrCount, ufddiSMTStationIdGrp=ufddiSMTStationIdGrp, tl1x25IfEntry=tl1x25IfEntry, tl1fddiSMTByPassSwitchPresent=tl1fddiSMTByPassSwitchPresent, tl1ospfAreaNetTable=tl1ospfAreaNetTable, tl1idpErrInSizetoobig=tl1idpErrInSizetoobig, tl1srtbMaskAcfEntry=tl1srtbMaskAcfEntry, tl1stapCMaxBridgeTransDelay=tl1stapCMaxBridgeTransDelay, tl1tcpFlowAck=tl1tcpFlowAck, tl1stapBridgeForwardDelay=tl1stapBridgeForwardDelay, tl1idpOutNoRoutes=tl1idpOutNoRoutes, tl1srtbPortCounterEntry=tl1srtbPortCounterEntry, tl1x25FacParam=tl1x25FacParam, usnmpCommunity=usnmpCommunity, uat=uat, tl1stapMaxAge=tl1stapMaxAge, tl1breOutSRFs=tl1breOutSRFs, ufddiMACRingOpCt=ufddiMACRingOpCt, tl1ifEntry=tl1ifEntry, ux25Service=ux25Service, tl1stapPTopologyChangeAck=tl1stapPTopologyChangeAck, tl1fddiMACDuplicateAddr=tl1fddiMACDuplicateAddr, tl1idpOutEchoReps=tl1idpOutEchoReps, tlipNetMaxPktEntry=tlipNetMaxPktEntry, tl1x25OutPkts=tl1x25OutPkts, tl1pppStatTable=tl1pppStatTable, ufddiPHYTable=ufddiPHYTable, uegpMinHelloInterval=uegpMinHelloInterval, tl1x25CalledAddr=tl1x25CalledAddr, tl1fddiMACOutOfBuf=tl1fddiMACOutOfBuf, tl1ripBadFamily=tl1ripBadFamily, tl1ipFilterSrcMask=tl1ipFilterSrcMask, uipStaticRouteCost=uipStaticRouteCost, tl1ipFilterNbrExceptions=tl1ipFilterNbrExceptions, tl1x25PinvP6=tl1x25PinvP6, tl1fddiMACRcvOverflow=tl1fddiMACRcvOverflow, tl1srtbOutAccessPriority=tl1srtbOutAccessPriority, tl1pppNumCrSent=tl1pppNumCrSent, tl1srtbStaticFilterDbParams=tl1srtbStaticFilterDbParams, tl1stapPortStateEntry=tl1stapPortStateEntry, tl1ospfAuthKey=tl1ospfAuthKey, tl1x25PktShort=tl1x25PktShort, tl1stapDesignatedRoot=tl1stapDesignatedRoot, tl1system=tl1system, ufddiMACLateCt=ufddiMACLateCt, tl1idpErrInResources=tl1idpErrInResources, tl1x25IfTable=tl1x25IfTable, tl1idpErrOutErrors=tl1idpErrOutErrors, tl1idpBroadcastInterval=tl1idpBroadcastInterval, tl1fddiMACHighClmRcvd=tl1fddiMACHighClmRcvd, tl1srtbNumStaticEntries=tl1srtbNumStaticEntries, tl1srtbMacAddrAcfTable=tl1srtbMacAddrAcfTable, tl1x25GFI=tl1x25GFI, tl1ospfIfTOSCost=tl1ospfIfTOSCost, tlipStaticRouteOverride=tlipStaticRouteOverride, tl1idpWellKnownGatewayHost=tl1idpWellKnownGatewayHost, uifHdlcAckTo=uifHdlcAckTo, tl1ospfIntfAuthKey=tl1ospfIntfAuthKey, tl1breFtMacAddress=tl1breFtMacAddress, tl1at=tl1at, tlip=tlip, tl1mib=tl1mib, tl1ripOwnAddr=tl1ripOwnAddr, tl1stapTopologyChangeCount=tl1stapTopologyChangeCount, tl1fddiSMTAttachCount=tl1fddiSMTAttachCount, tl1idpForwarding=tl1idpForwarding, tl1fddiSMTOperationalEntry=tl1fddiSMTOperationalEntry, tl1ospfIntfPollIntvl=tl1ospfIntfPollIntvl, tl1ospfIntfPtopIntAddr=tl1ospfIntfPtopIntAddr, tl1ospfAuthType=tl1ospfAuthType, tl1idpStaticRouteGatewayNet=tl1idpStaticRouteGatewayNet, tl1tokEarlyTokenRelease=tl1tokEarlyTokenRelease, tl1srtbDiscardOnError=tl1srtbDiscardOnError, uifFddiArpWait=uifFddiArpWait, tl1srtbValidSRFramesReceived=tl1srtbValidSRFramesReceived, ufddiPHYConnectedResId=ufddiPHYConnectedResId, tl1x25CallBad=tl1x25CallBad, tl1fddiPHYOperationalEntry=tl1fddiPHYOperationalEntry, tl1breForwardTable=tl1breForwardTable, tl1bre=tl1bre, uegpNumberTrustedNeighbors=uegpNumberTrustedNeighbors, tl1ipStaticRouteOverride=tl1ipStaticRouteOverride, tl1stapPDesignatedRoot=tl1stapPDesignatedRoot, tl1idpStaticRouteTable=tl1idpStaticRouteTable, tl1idpFilterExceptionSrcHost=tl1idpFilterExceptionSrcHost, tl1idpErrOutUnspecified=tl1idpErrOutUnspecified, tl1idpFilterExceptionSrcNet=tl1idpFilterExceptionSrcNet, uddnIfReset=uddnIfReset, tl1idpNumStatic=tl1idpNumStatic, utcpFlowAck=utcpFlowAck, tlipLoopback=tlipLoopback, tl1x25InPkts=tl1x25InPkts, tl1pppTrCount=tl1pppTrCount, tl1fddiMACLowClmRcvd=tl1fddiMACLowClmRcvd, tl1fddiMACTransmitCt=tl1fddiMACTransmitCt, tl1fddiMACTxBufEmpty=tl1fddiMACTxBufEmpty, tl1ipRoutePidsTable=tl1ipRoutePidsTable, tl1ipStaticRouteMask=tl1ipStaticRouteMask, tl1ipConfigIntfTable=tl1ipConfigIntfTable, uddnHdhUp=uddnHdhUp, tl1egpNumberNbrs=tl1egpNumberNbrs, tl1tcpThruput=tl1tcpThruput, tl1fddiSMTLinkErrorRateCutoff=tl1fddiSMTLinkErrorRateCutoff, tl1egpRequestCeaseInterval=tl1egpRequestCeaseInterval, tlipNetMaxPktTable=tlipNetMaxPktTable, tl1x25CallTimer=tl1x25CallTimer, tl1ipFilterExceptionEntry=tl1ipFilterExceptionEntry, tl1ospfCumLogEntry=tl1ospfCumLogEntry, tl1egpMinPollInterval=tl1egpMinPollInterval, tl1x25PktSize=tl1x25PktSize, uipNet1MaxPkt=uipNet1MaxPkt, tl1idpStaticRouteOverride=tl1idpStaticRouteOverride, tl1egpDeclareDownInterval=tl1egpDeclareDownInterval, tl1srtbMaskAcfParamsEntry=tl1srtbMaskAcfParamsEntry, tl1srtbFilterDbParams=tl1srtbFilterDbParams, tl1tokConfigTable=tl1tokConfigTable, tl1stapCPathCost=tl1stapCPathCost, tl1ripAdverIntf=tl1ripAdverIntf, uifSubnetMask=uifSubnetMask, tl1pppBadAddress=tl1pppBadAddress, tl1icmp=tl1icmp, tl1pppIpxcpAO=tl1pppIpxcpAO, uddnHdhWentDown=uddnHdhWentDown, tl1x25Window=tl1x25Window, tl1pppInfoTable=tl1pppInfoTable, tl1ipFilterDstNet=tl1ipFilterDstNet, tl1idpFilterNbrExceptions=tl1idpFilterNbrExceptions, tl1srtbMaskAcfPermit=tl1srtbMaskAcfPermit, tl1breFtIpAddress=tl1breFtIpAddress, tl1fddiMACTxAsyncFrm=tl1fddiMACTxAsyncFrm, ux25Window=ux25Window, uhfp=uhfp, utcpRetransTo=utcpRetransTo, tl1fddiMACReceiveCt=tl1fddiMACReceiveCt, tl1idpStaticRouteNetwork=tl1idpStaticRouteNetwork, tl1srtbAcfDestMacAddr=tl1srtbAcfDestMacAddr, ufddiMACSMTLongAddr=ufddiMACSMTLongAddr, uggpNeighborTable=uggpNeighborTable, tlipStaticRouteTable=tlipStaticRouteTable, tl1x25PinvP5=tl1x25PinvP5, tl1stapForwardDelay=tl1stapForwardDelay, uifTable=uifTable, tl1tcpAckTime=tl1tcpAckTime, tl1ospfCumlogTable=tl1ospfCumlogTable, tl1srtbInvalidRi=tl1srtbInvalidRi, tl1ipMasker=tl1ipMasker, tl1idpBadSize=tl1idpBadSize, tl1pppLcpAO=tl1pppLcpAO, tl1idpNetworkAddress=tl1idpNetworkAddress, tl1ipStaticRouteGateway=tl1ipStaticRouteGateway, tl1idpFilterTable=tl1idpFilterTable, tl1x25PinvP4=tl1x25PinvP4, tl1fddiMACTMin=tl1fddiMACTMin, uipStaticRouteTable=uipStaticRouteTable, tl1ripInPkts=tl1ripInPkts, tl1idpBadAddr=tl1idpBadAddr, tlipLogicalDisconnect=tlipLogicalDisconnect, uegp=uegp, tl1fddiMACOperationalEntry=tl1fddiMACOperationalEntry, tl1fddiPHYStateEntry=tl1fddiPHYStateEntry, tl1stapPortConfigTable=tl1stapPortConfigTable, tl1idpErrOutResources=tl1idpErrOutResources, tl1srtbNumMaskAcfEntries=tl1srtbNumMaskAcfEntries, uifHdlcAckCount=uifHdlcAckCount, tlipStaticRouteEntry=tlipStaticRouteEntry, tl1fddiMACTxSyncDone=tl1fddiMACTxSyncDone, tl1fddiSMTNeighborEntry=tl1fddiSMTNeighborEntry, tl1stapPortConfigEntry=tl1stapPortConfigEntry, tl1ospfNBMAEntry=tl1ospfNBMAEntry, tl1snmpNMSAddress=tl1snmpNMSAddress, tl1idpErrInSocket=tl1idpErrInSocket, uddnHipUp=uddnHipUp, tl1ripConfigEntry=tl1ripConfigEntry, tl1ospfIntfRxmtIntvl=tl1ospfIntfRxmtIntvl, tl1fddiMACLateCt=tl1fddiMACLateCt, tl1ip=tl1ip, tl1fddiSMTStnStateTable=tl1fddiSMTStnStateTable, ufddiMACEntry=ufddiMACEntry, tl1idpFilterDestinationHost=tl1idpFilterDestinationHost, tl1idpErrInNohost=tl1idpErrInNohost, uegpMinPollInterval=uegpMinPollInterval, tl1snmpTrapEntry=tl1snmpTrapEntry, tl1x25LcRestr=tl1x25LcRestr, uipRedirectTo=uipRedirectTo, uipNbrStaticRoutes=uipNbrStaticRoutes, tl1breBridgeListTable=tl1breBridgeListTable, uipStaticRouteGateway=uipStaticRouteGateway, tlipStaticRouteGateway=tlipStaticRouteGateway, tl1ipStaticRouteTable=tl1ipStaticRouteTable, tl1srtbIsVLan=tl1srtbIsVLan, ufddiSMTDasScmState=ufddiSMTDasScmState, tl1idpInEchoReply=tl1idpInEchoReply, tl1fddiMACRcvAbort=tl1fddiMACRcvAbort, tl1fddiMACPktsDetected=tl1fddiMACPktsDetected, tl1fddiMACTneg=tl1fddiMACTneg, tl1fddiSMTOperationalTable=tl1fddiSMTOperationalTable, uinterfaces=uinterfaces, uegpErrorTreatment=uegpErrorTreatment, tl1idpInNoRoutes=tl1idpInNoRoutes, tl1snmp=tl1snmp, tl1ospfVirtualIfEntry=tl1ospfVirtualIfEntry, tl1srtbPortParamsTable=tl1srtbPortParamsTable, tl1srtbBridgeNumber=tl1srtbBridgeNumber, tl1stap=tl1stap, tl1idpFilterEntry=tl1idpFilterEntry, tl1x25ResetTimer=tl1x25ResetTimer, tl1fddiSMTNeighborTable=tl1fddiSMTNeighborTable, ufddiMACConnectedResId=ufddiMACConnectedResId, tl1srtbFilterDbSize=tl1srtbFilterDbSize, tlipRoutePidsTable=tlipRoutePidsTable, tl1fddiPHYResourceIndex=tl1fddiPHYResourceIndex, tl1idpFilterDestinationMask=tl1idpFilterDestinationMask, tl1ospfRtrDeadIntvl=tl1ospfRtrDeadIntvl, tl1breStatTable=tl1breStatTable, tl1tcpRetransTo=tl1tcpRetransTo, tl1fddiMACRbcCollision=tl1fddiMACRbcCollision, tlipStaticRouteNetwork=tlipStaticRouteNetwork, utcpThruput=utcpThruput, tl1ipRemoteg=tl1ipRemoteg, tl1fddiMACTMax=tl1fddiMACTMax, uipRoutePid=uipRoutePid, tl1idpFilterSourceNet=tl1idpFilterSourceNet, tl1pppInfoEntry=tl1pppInfoEntry, tl1fddiMACFrameCt=tl1fddiMACFrameCt, tl1fddiMACBadSyncPtr=tl1fddiMACBadSyncPtr, utcpAckTime=utcpAckTime, tl1pppPhaseTable=tl1pppPhaseTable, tl1ripMode=tl1ripMode, tl1ospfIntfEntry=tl1ospfIntfEntry, tl1stapHelloTime=tl1stapHelloTime, tl1breOutTSFs=tl1breOutTSFs, ufddiMACNotCopiedCt=ufddiMACNotCopiedCt, tl1idpInReceives=tl1idpInReceives, tl1srtbMaskAcfParamsTable=tl1srtbMaskAcfParamsTable, tlipRoutePid=tlipRoutePid, tl1fddiMACDpcCollision=tl1fddiMACDpcCollision, tl1fddiSMTStnId=tl1fddiSMTStnId, tl1ospfVirtualIfTable=tl1ospfVirtualIfTable, tl1fddiMACRxSmallGap=tl1fddiMACRxSmallGap, uifHdlcClockType=uifHdlcClockType, tl1fddiMACEnterClaimCt=tl1fddiMACEnterClaimCt, uicmp=uicmp, tl1srtbDynamicFilterDbTable=tl1srtbDynamicFilterDbTable, uhfpSwap=uhfpSwap, tl1stapBridgeState=tl1stapBridgeState, uddnLeaderErrs=uddnLeaderErrs, tl1stapCBridgeHelloTime=tl1stapCBridgeHelloTime, ufddiMACTransmitCt=ufddiMACTransmitCt, tl1ospfIntfPriority=tl1ospfIntfPriority)
mibBuilder.exportSymbols("UNISYS-TIMEPLEX-MIB", tl1ipRedirectTo=tl1ipRedirectTo, tl1x25PktLong=tl1x25PktLong, tl1tcp=tl1tcp, usnmpVersion=usnmpVersion, tlipRemotegTable=tlipRemotegTable, tl1breBlSrBridgeNumber=tl1breBlSrBridgeNumber, tl1snmpForwardTraps=tl1snmpForwardTraps, tl1pppPhaseEntry=tl1pppPhaseEntry, tl1srtbExplorerFramesFrwd=tl1srtbExplorerFramesFrwd, tl1idpErrOutNohost=tl1idpErrOutNohost, uifEntry=uifEntry, tl1x25PinvP2=tl1x25PinvP2, tl1ipFilterExceptionDstNet=tl1ipFilterExceptionDstNet, tl1fddiMACStatEntry=tl1fddiMACStatEntry, tl1fddiMACTxAsyncChain=tl1fddiMACTxAsyncChain, uipStaticRouteEntry=uipStaticRouteEntry, tl1srtbAcfOffset=tl1srtbAcfOffset, usnmpTraps=usnmpTraps, uggp=uggp, tl1ospfIntfRtrDeadIntvl=tl1ospfIntfRtrDeadIntvl, tl1pppNumTrRecd=tl1pppNumTrRecd, tl1breBlIpAddress=tl1breBlIpAddress, tl1fddiMACErrorCt=tl1fddiMACErrorCt, tl1srtbDynamicPortNumber=tl1srtbDynamicPortNumber, usystem=usystem, uegpNeighborTable=uegpNeighborTable, tl1egpNumberTrustedNbrs=tl1egpNumberTrustedNbrs, tl1fddiPHYAction=tl1fddiPHYAction, tl1ripBadMetric=tl1ripBadMetric, ufddiSMTStationType=ufddiSMTStationType, tl1idpFilterExceptionTable=tl1idpFilterExceptionTable, tl1srtbStatEntMacAddrTable=tl1srtbStatEntMacAddrTable, tl1fddiPHYRemotePHYType=tl1fddiPHYRemotePHYType, utcp=utcp, tl1breBlBridgeNumber=tl1breBlBridgeNumber, ufddiMACCfgGrp=ufddiMACCfgGrp, tl1breNumConfigBrdgLstEntries=tl1breNumConfigBrdgLstEntries, tl1idpErrInUnspecified=tl1idpErrInUnspecified, tl1ospfIntfHelloIntvl=tl1ospfIntfHelloIntvl, tl1ospfTransArea=tl1ospfTransArea, ufddiMACDownstreamNeighbor=ufddiMACDownstreamNeighbor, tlipNbrStaticRoutes=tlipNbrStaticRoutes, tl1breCBridgeListEntry=tl1breCBridgeListEntry, tl1ripConfigTable=tl1ripConfigTable, tl1x25PinvP3=tl1x25PinvP3, tl1fddiMACBadAsyncPtr=tl1fddiMACBadAsyncPtr, tl1breBlVLanId=tl1breBlVLanId, tl1idpFilterDestinationNet=tl1idpFilterDestinationNet, tl1ripBadSize=tl1ripBadSize, tl1srtbInternalLanEnabled=tl1srtbInternalLanEnabled, uipStaticRouteNetwork=uipStaticRouteNetwork, tl1fddiPHYConnectedResId=tl1fddiPHYConnectedResId, tl1ospfIntfTOSEntry=tl1ospfIntfTOSEntry, tl1ripOutPkts=tl1ripOutPkts, utcpRtoMax=utcpRtoMax, tl1breOutEFs=tl1breOutEFs, tl1systemAction=tl1systemAction, ufddiMACTMin=ufddiMACTMin, tl1stapSpanningTreeEnabled=tl1stapSpanningTreeEnabled, usnmpRequests=usnmpRequests, tl1ipNetMaxPkt=tl1ipNetMaxPkt, ufddiSMTStationCfgGrp=ufddiSMTStationCfgGrp, ufddiSMTStationId=ufddiSMTStationId, tl1ipFilterExceptionSrcNet=tl1ipFilterExceptionSrcNet, uifHdlcBaudRate=uifHdlcBaudRate, uggpMaxNeighbors=uggpMaxNeighbors, tl1x25RejInv=tl1x25RejInv, uipMaxRoutePids=uipMaxRoutePids, ux25PktSize=ux25PktSize, tl1ifIpAddr=tl1ifIpAddr, tl1srtbValidSRDiscarded=tl1srtbValidSRDiscarded, tl1x25PinvD3=tl1x25PinvD3, tl1systemReboots=tl1systemReboots, tl1egpPurgeInterval=tl1egpPurgeInterval, tl1ipLoopback=tl1ipLoopback, tl1idpErrInEchos=tl1idpErrInEchos, uipLogicalDisconnect=uipLogicalDisconnect, usystemAction=usystemAction, uipStaticRouteOverride=uipStaticRouteOverride, tl1fddiMACStatTable=tl1fddiMACStatTable, uipRoutePidsEntry=uipRoutePidsEntry, ufddiMACCountersGrp=ufddiMACCountersGrp, uegpSharedNetwork=uegpSharedNetwork, ufddiMACReceiveCt=ufddiMACReceiveCt, tl1fddiMACTokenCt=tl1fddiMACTokenCt, tl1srtbDiscardBuffers=tl1srtbDiscardBuffers, tl1idpHashMiss=tl1idpHashMiss, umgmt=umgmt, tl1breCblVLanId=tl1breCblVLanId, ufddiSMTOperationalGrp=ufddiSMTOperationalGrp, tl1fddiPHYRemoteMACIndicated=tl1fddiPHYRemoteMACIndicated, tl1srtbMaskAcfTable=tl1srtbMaskAcfTable, tl1srtbStatEntPortArrayEntry=tl1srtbStatEntPortArrayEntry, tl1ifTable=tl1ifTable, tl1stapRootPort=tl1stapRootPort, usystemErrorCode=usystemErrorCode, tl1srtbNonExplorFramesFrwd=tl1srtbNonExplorFramesFrwd, tl1ospfHelloIntvl=tl1ospfHelloIntvl, tl1idpFilterSourceHost=tl1idpFilterSourceHost, tl1x25=tl1x25, tlipWellKnownGateway=tlipWellKnownGateway, tl1idpGenChecksum=tl1idpGenChecksum, tl1tcpRtoMin=tl1tcpRtoMin, tl1ripBadClass=tl1ripBadClass, tl1srtbDynamicFilterDbEntry=tl1srtbDynamicFilterDbEntry, tl1pppNumCrRecd=tl1pppNumCrRecd, tl1fddiMACLostCt=tl1fddiMACLostCt, tl1srtbMaskAcfInfo=tl1srtbMaskAcfInfo, uegpDeclareDownInterval=uegpDeclareDownInterval, tl1idpErrInChecksum=tl1idpErrInChecksum, tl1ospfStat=tl1ospfStat, tl1ospfNbrId=tl1ospfNbrId, tl1egpErrorTreatment=tl1egpErrorTreatment, tl1interfaces=tl1interfaces, tlipNetMaxPkt=tlipNetMaxPkt, tl1stapPDesignatedPort=tl1stapPDesignatedPort, uegpNeighborEntry=uegpNeighborEntry, tl1idpNetworkIntfTable=tl1idpNetworkIntfTable, ufddiMACTvxValue=ufddiMACTvxValue, ufddiMACTMax=ufddiMACTMax, tl1idpInterfaceTable=tl1idpInterfaceTable, tl1egpEnoughInterval=tl1egpEnoughInterval, tl1srtbInTSFramesReceived=tl1srtbInTSFramesReceived, tl1x25PinvR2=tl1x25PinvR2, tlipRoutePidsEntry=tlipRoutePidsEntry, tl1idpNbrFilters=tl1idpNbrFilters, tl1stapCPortPriority=tl1stapCPortPriority, uifHdlcSabmInterval=uifHdlcSabmInterval, tl1idpHashHit=tl1idpHashHit, tl1x25PinvP1=tl1x25PinvP1, tl1stapCForwardDelay=tl1stapCForwardDelay, uifHdlcRnrInterval=uifHdlcRnrInterval, tl1ipNbrStaticRoutes=tl1ipNbrStaticRoutes, tl1idpStaticRouteEntry=tl1idpStaticRouteEntry, urip=urip, tl1fddiMACRcvUnderflow=tl1fddiMACRcvUnderflow, utcpRtoMin=utcpRtoMin, tl1egpMinHelloInterval=tl1egpMinHelloInterval, tl1ospfNet=tl1ospfNet, uddnLinkWentDown=uddnLinkWentDown, tl1ripSimple=tl1ripSimple, tl1pppBadIpxcp=tl1pppBadIpxcp, tl1idpFilterExceptionDstHost=tl1idpFilterExceptionDstHost, tl1idp=tl1idp, ufddiSMTMACCount=ufddiSMTMACCount, uegpRequestCeaseInterval=uegpRequestCeaseInterval, tl1fddiMACTxSyncChain=tl1fddiMACTxSyncChain, tl1fddiSMTAttachConfiguration=tl1fddiSMTAttachConfiguration, uegpMaxNeighbors=uegpMaxNeighbors, ufddiSMTVersionId=ufddiSMTVersionId, tl1idpInMsgs=tl1idpInMsgs, tl1srtbNumMacAddrAcfEntrs=tl1srtbNumMacAddrAcfEntrs, tl1tcpWakeup=tl1tcpWakeup, tlipRemoteg=tlipRemoteg, tl1egpNbrEntry=tl1egpNbrEntry, tl1idpFilterExceptionEntry=tl1idpFilterExceptionEntry, tl1srtbLanIdMismatch=tl1srtbLanIdMismatch, ufddiMACUpstreamNeighbor=ufddiMACUpstreamNeighbor, tl1fddiSMTStnUpstreamNbr=tl1fddiSMTStnUpstreamNbr, tl1egpNbrTable=tl1egpNbrTable, uegpNeighbor=uegpNeighbor, ufddiPHYType=ufddiPHYType, tl1fddiMACWonClaimBid=tl1fddiMACWonClaimBid, tl1idpBadNbr=tl1idpBadNbr, uddnDeadHostSTATUS=uddnDeadHostSTATUS, uddnPSNGoingDown=uddnPSNGoingDown, tl1idpErrInErrors=tl1idpErrInErrors, tl1ripAdverStatic=tl1ripAdverStatic, tl1fddiSMTDasScmState=tl1fddiSMTDasScmState, tl1srtbStaticEntryPermit=tl1srtbStaticEntryPermit, tl1pppRsTimeout=tl1pppRsTimeout, tl1srtbTotalSRDiscarded=tl1srtbTotalSRDiscarded, tl1x25CallingAddr=tl1x25CallingAddr, tl1tcpTimeToLive=tl1tcpTimeToLive, tl1pppBadProtocol=tl1pppBadProtocol, tl1stapCMaxBpduTransDelay=tl1stapCMaxBpduTransDelay, tl1tcpRtoMax=tl1tcpRtoMax, tl1ripBadCommand=tl1ripBadCommand, tl1ripBadNbr=tl1ripBadNbr, uggpNeighbor=uggpNeighbor, tl1breForwardTableEntry=tl1breForwardTableEntry, utcpWakeup=utcpWakeup, tl1ipNumFilters=tl1ipNumFilters, tl1egp=tl1egp, uipNet2MaxPkt=uipNet2MaxPkt, tl1snmpNMSEntry=tl1snmpNMSEntry, ufddiMACEnteredBeaconCt=ufddiMACEnteredBeaconCt, tl1ipStaticRouteNetwork=tl1ipStaticRouteNetwork, tl1breOutBPDUs=tl1breOutBPDUs, tl1fddiMACInternalErrorCt=tl1fddiMACInternalErrorCt, tl1breBridgeListEntry=tl1breBridgeListEntry, tl1ripBadVersion=tl1ripBadVersion, uipRemoteg2=uipRemoteg2, tl1stapPDesignatedCost=tl1stapPDesignatedCost, tl1pppBadIpcp=tl1pppBadIpcp, uddnConnectionsReused=uddnConnectionsReused, tl1ripBadPort=tl1ripBadPort, uggpEchoInterval=uggpEchoInterval, ufddiMACOperGrp=ufddiMACOperGrp, uifHdlcThrowaway=uifHdlcThrowaway, tl1systemErrorCode=tl1systemErrorCode, tl1breConfigBridgeListTable=tl1breConfigBridgeListTable, tl1srtbMacAddrAcfEntry=tl1srtbMacAddrAcfEntry, tl1idpInOwnAddr=tl1idpInOwnAddr, tl1breInBPDUs=tl1breInBPDUs, uggpNumberNeighbors=uggpNumberNeighbors, tl1ipRoutePidsEntry=tl1ipRoutePidsEntry, tl1idpNetworkMaximumPacket=tl1idpNetworkMaximumPacket, tl1srtbNonExplorOctetsFrwd=tl1srtbNonExplorOctetsFrwd, tl1ospfIntfTransDelay=tl1ospfIntfTransDelay, tl1srtbValidExplorOctetsRcvd=tl1srtbValidExplorOctetsRcvd, tl1ripHolddown=tl1ripHolddown, tl1fddiMACTvxValue=tl1fddiMACTvxValue, uddnTotalQ=uddnTotalQ, tl1ospfIntfType=tl1ospfIntfType, tlipRedirectTo=tlipRedirectTo, ufddiMACTokenCt=ufddiMACTokenCt, tl1breCblSrBridgeNumber=tl1breCblSrBridgeNumber, tl1ospfIntfTable=tl1ospfIntfTable, tl1egpNbr=tl1egpNbr, tl1ipMaxRoutePids=tl1ipMaxRoutePids, tl1srtbStatEntSizeEntry=tl1srtbStatEntSizeEntry, tl1ospfIntfRun=tl1ospfIntfRun, tl1fddiMACOtherBecRcvd=tl1fddiMACOtherBecRcvd, tl1ospfTransDelay=tl1ospfTransDelay, tl1fddiPHYOperationalTable=tl1fddiPHYOperationalTable, tl1tokConfigEntry=tl1tokConfigEntry, tl1fddiMACTReq=tl1fddiMACTReq, utcpTimeToLive=utcpTimeToLive, ufddiPHYCfgGrp=ufddiPHYCfgGrp, tl1ripNonZero=tl1ripNonZero, tl1fddiMACTxAbort=tl1fddiMACTxAbort, tl1ppp=tl1ppp, tl1idpRouteSupplier=tl1idpRouteSupplier, tl1fddiSMTMasterCount=tl1fddiSMTMasterCount, tl1snmpTrapAddress=tl1snmpTrapAddress, tl1ipFilterDstMask=tl1ipFilterDstMask, tl1breCblBridgeNumber=tl1breCblBridgeNumber, tl1ospfRtrId=tl1ospfRtrId, umib=umib, uddnConnections=uddnConnections, tl1ospfAreaTable=tl1ospfAreaTable, tl1srtbOutTSFramesFrwd=tl1srtbOutTSFramesFrwd, tl1stapPathCost=tl1stapPathCost, tl1fddiPHYConnectState=tl1fddiPHYConnectState, tl1fddiMACOperationalTable=tl1fddiMACOperationalTable, ux25=ux25, tl1breStatEntry=tl1breStatEntry, tl1idpFilterSourceMask=tl1idpFilterSourceMask, tl1idpFilterExceptionDstNet=tl1idpFilterExceptionDstNet, ufddiSMTAttachCount=ufddiSMTAttachCount, tl1stapBridgeHelloTime=tl1stapBridgeHelloTime, tl1ipConfigIntfEntry=tl1ipConfigIntfEntry, tl1idpBadAlloc=tl1idpBadAlloc)
mibBuilder.exportSymbols("UNISYS-TIMEPLEX-MIB", tl1srtbLanId=tl1srtbLanId, tl1srtbFilterDbAgeingTime=tl1srtbFilterDbAgeingTime, tl1ipFilterTable=tl1ipFilterTable, tl1srtbStaticEntryMacAddr=tl1srtbStaticEntryMacAddr, usnmp=usnmp, tlipMaxRoutePids=tlipMaxRoutePids, tl1srtbExplorerOctetsFrwd=tl1srtbExplorerOctetsFrwd, tl1srtbStatEntPortArrayTable=tl1srtbStatEntPortArrayTable, tl1fddiPHYStateTable=tl1fddiPHYStateTable, tl1srtbDynamicMacAddr=tl1srtbDynamicMacAddr, tl1egpAutoSysNumber=tl1egpAutoSysNumber, tl1stapBridgeConfig=tl1stapBridgeConfig, uegpMode=uegpMode, tl1srtbNumDynamicEntries=tl1srtbNumDynamicEntries, tl1ifSubnetMask=tl1ifSubnetMask, tl1idpErrOutChecksum=tl1idpErrOutChecksum, tl1ripBadAddr=tl1ripBadAddr, tl1fddiMACMultiTokens=tl1fddiMACMultiTokens, tl1x25IntrCPkt=tl1x25IntrCPkt, ufddiPHYRemotePHYType=ufddiPHYRemotePHYType, tl1x25PinvR1=tl1x25PinvR1, uegpPurgeInterval=uegpPurgeInterval, uggpNeighborEntry=uggpNeighborEntry, uddnRcvIncomplete=uddnRcvIncomplete, tl1fddiMACNotCopiedCt=tl1fddiMACNotCopiedCt, tl1breInErrors=tl1breInErrors, uifEthernetArpWait=uifEthernetArpWait, tl1ospfIntfAreaID=tl1ospfIntfAreaID, tl1fddiMACTxAsyncDone=tl1fddiMACTxAsyncDone, uifIpAddr=uifIpAddr, tl1ospfAreaID=tl1ospfAreaID, ufddiSMT=ufddiSMT, tl1snmpLastTrapMessage=tl1snmpLastTrapMessage, tl1tok=tl1tok, tl1x25PinvD2=tl1x25PinvD2, ufddiMACSTATUSGrp=ufddiMACSTATUSGrp, tl1breBridgeNumber=tl1breBridgeNumber, tl1stapBridgeMaxAge=tl1stapBridgeMaxAge, uipRoutePidsTable=uipRoutePidsTable, tl1breInTSFs=tl1breInTSFs, tl1egpMaxNbrs=tl1egpMaxNbrs, tl1ipStaticRouteEntry=tl1ipStaticRouteEntry, tl1fddiMACOwnBecRcvd=tl1fddiMACOwnBecRcvd, tlipMasker=tlipMasker, tl1srtb=tl1srtb, ufddiPHYAction=ufddiPHYAction, ufddiMACTable=ufddiMACTable, tl1fddiMACRcvThrot=tl1fddiMACRcvThrot, tl1fddiSMTStnDownstreamNbr=tl1fddiSMTStnDownstreamNbr, tl1srtbPortCounterTable=tl1srtbPortCounterTable, ufddiSMTSpurCount=ufddiSMTSpurCount, tl1stapBridgeIdentifier=tl1stapBridgeIdentifier, tl1x25PktInv=tl1x25PktInv, tl1ifType=tl1ifType, ufddiMACReceiveOverflowCt=ufddiMACReceiveOverflowCt, ufddiPHYResourceIndex=ufddiPHYResourceIndex, tl1snmpVersion=tl1snmpVersion, uudp=uudp, tl1ipFilterSrcNet=tl1ipFilterSrcNet, tl1fddiSMTStnType=tl1fddiSMTStnType, tl1x25PinvD1=tl1x25PinvD1, tl1srtbRoutingType=tl1srtbRoutingType, ufddiPHYConnectState=ufddiPHYConnectState, tl1pppIdpcpAO=tl1pppIdpcpAO, tl1srtbPortParamsEntry=tl1srtbPortParamsEntry, tl1idpErrInMaxhops=tl1idpErrInMaxhops, tl1udp=tl1udp, ufddiMACErrorCntrsGrp=ufddiMACErrorCntrsGrp, tl1idpNetworkIntfEntry=tl1idpNetworkIntfEntry, uhfpPad=uhfpPad, tl1ospfAreaNetEntry=tl1ospfAreaNetEntry, uip=uip, tl1stapCPortState=tl1stapCPortState, tl1pppCtTimeout=tl1pppCtTimeout, tl1breInSRFs=tl1breInSRFs, usnmpForwardTraps=usnmpForwardTraps, tl1x25BadPkt=tl1x25BadPkt, tl1idpStaticRouteCost=tl1idpStaticRouteCost, ufddi=ufddi, uegpAcquireCeaseInterval=uegpAcquireCeaseInterval, uddnLinkDownTo=uddnLinkDownTo, tl1idpInErrors=tl1idpInErrors, tl1pppStatEntry=tl1pppStatEntry, tl1srtbDiscardTransitDelay=tl1srtbDiscardTransitDelay, tl1ospfAttRtrIpAddr=tl1ospfAttRtrIpAddr, tl1egpSharedNetwork=tl1egpSharedNetwork, tl1pppLqdTimeout=tl1pppLqdTimeout, tl1snmpNMSTable=tl1snmpNMSTable, tl1fddiPHYType=tl1fddiPHYType, tl1x25FacCode=tl1x25FacCode, uipMasker=uipMasker, tl1srtbTotalSRFrwd=tl1srtbTotalSRFrwd, tl1fddiMACRxFrmsRcvd=tl1fddiMACRxFrmsRcvd, tl1fddiMACRingOpCt=tl1fddiMACRingOpCt, tl1srtbOutUserPriority=tl1srtbOutUserPriority, ufddiMACResourceIndex=ufddiMACResourceIndex, tl1x25PinvP7=tl1x25PinvP7, uegpAutoSysNumber=uegpAutoSysNumber, tl1srtbAcfMask=tl1srtbAcfMask, ufddiPHYRemoteMACIndicated=ufddiPHYRemoteMACIndicated, tl1ospfNBMATable=tl1ospfNBMATable, tl1egpAcquireCeaseInterval=tl1egpAcquireCeaseInterval, tl1srtbInternalLanId=tl1srtbInternalLanId, tl1srtbRdLimit=tl1srtbRdLimit, unisys_timeplex=unisys_timeplex, ux25IfEntry=ux25IfEntry, tl1pppBadIdpcp=tl1pppBadIdpcp, tl1ipFilterExceptionTable=tl1ipFilterExceptionTable, tl1fddi=tl1fddi, tl1breConfigParams=tl1breConfigParams, uipLoopback=uipLoopback, tl1ospfMask=tl1ospfMask, tl1ospfIntfTOSTable=tl1ospfIntfTOSTable, tl1stapPortIdentifier=tl1stapPortIdentifier, tl1idpInHdrErrors=tl1idpInHdrErrors, ufddiPHYEntry=ufddiPHYEntry, tl1rip=tl1rip, usystemReboots=usystemReboots, uipRemoteg1=uipRemoteg1, tl1srtbStatEntMacAddrEntry=tl1srtbStatEntMacAddrEntry, tl1tokRingSpeed=tl1tokRingSpeed, tl1fddiMACEnterBeacontCt=tl1fddiMACEnterBeacontCt, tl1srtbPermDbSize=tl1srtbPermDbSize, ux25IfTable=ux25IfTable, tl1ospfAreaEntry=tl1ospfAreaEntry, tl1ipLogicalDisconnect=tl1ipLogicalDisconnect, uifHdlcDCE=uifHdlcDCE, tl1stapRootPathCost=tl1stapRootPathCost, tl1idpWellKnownGatewayNet=tl1idpWellKnownGatewayNet, tl1srtbInTSFramesDiscarded=tl1srtbInTSFramesDiscarded, ufddiMACShortGrpAddr=ufddiMACShortGrpAddr, tl1x25Service=tl1x25Service, tl1ifHardwareAddress=tl1ifHardwareAddress, tl1idpErrOutMsgs=tl1idpErrOutMsgs, tl1idpErrOutMaxhops=tl1idpErrOutMaxhops, tl1idpNbrStaticRoutes=tl1idpNbrStaticRoutes, tl1idpForwDatagrams=tl1idpForwDatagrams, tl1srtbDiscardHopCountExcd=tl1srtbDiscardHopCountExcd, tl1idpInterfaceEntry=tl1idpInterfaceEntry, tl1idpFilter=tl1idpFilter, tl1snmpTrapTable=tl1snmpTrapTable, tl1idpStaticRouteGatewayHost=tl1idpStaticRouteGatewayHost, tl1ospfPriority=tl1ospfPriority, tl1srtbAcfSrcMacAddr=tl1srtbAcfSrcMacAddr, tl1stapTopologyChange=tl1stapTopologyChange, uddnTimeout=uddnTimeout, tlipStaticRouteCost=tlipStaticRouteCost, tl1idpErrOutSizetoobig=tl1idpErrOutSizetoobig, tl1srtbStatEntSizeTable=tl1srtbStatEntSizeTable, tl1stapCBridgePriority=tl1stapCBridgePriority, tl1stapPDesignatedBridge=tl1stapPDesignatedBridge, tl1fddiSMTVersionId=tl1fddiSMTVersionId, ufddiMACTvxExpiredCt=ufddiMACTvxExpiredCt, tl1breCblIpAddress=tl1breCblIpAddress, tl1breBridgeIpAddress=tl1breBridgeIpAddress, tl1breForwardTableAgeingTime=tl1breForwardTableAgeingTime, uddnMsgout=uddnMsgout, tl1ospf=tl1ospf, tl1fddiSMTLinkErrorRateAlarm=tl1fddiSMTLinkErrorRateAlarm, tl1idpInEchos=tl1idpInEchos, tl1srtbUpTime=tl1srtbUpTime, uegpEnoughInterval=uegpEnoughInterval, ufddiMACTReq=ufddiMACTReq, tlipRemotegEntry=tlipRemotegEntry, tl1egpMode=tl1egpMode, tl1ospfRxmtIntvl=tl1ospfRxmtIntvl, tl1x25PinvR3=tl1x25PinvR3, tl1stapPortStateTable=tl1stapPortStateTable, tl1pppIpcpAO=tl1pppIpcpAO, tl1ifProxyARP=tl1ifProxyARP, uifHdlcRto=uifHdlcRto, tl1stapHoldTime=tl1stapHoldTime, tl1ospfNetCount=tl1ospfNetCount, uhfpMaxMsg=uhfpMaxMsg, uddn=uddn, tl1stapPConfigPending=tl1stapPConfigPending, tl1srtbAcfValue=tl1srtbAcfValue, tl1fddiMACTxSyncFrm=tl1fddiMACTxSyncFrm, tl1pppBadLcp=tl1pppBadLcp, tl1idpBadMetric=tl1idpBadMetric, tl1fddiMACTvxExpiredCt=tl1fddiMACTvxExpiredCt, tl1fddiSMTStnStateEntry=tl1fddiSMTStnStateEntry, tl1stapPortState=tl1stapPortState, uipWellKnownGateway=uipWellKnownGateway, tl1ipStaticRouteCost=tl1ipStaticRouteCost, tl1stapCBridgeMaxAge=tl1stapCBridgeMaxAge, tl1stapTimeSinceTopChange=tl1stapTimeSinceTopChange, tl1idpRouteTimeout=tl1idpRouteTimeout, uddnLinkUp=uddnLinkUp, tl1idpBadCommand=tl1idpBadCommand, tl1ipFilterEntry=tl1ipFilterEntry, tl1ipRoutePid=tl1ipRoutePid, ufddiMACAddressGrp=ufddiMACAddressGrp)
