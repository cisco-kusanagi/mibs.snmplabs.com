...
# Produced by pysmi-0.3.4 at Wed May  1 13:14:29 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, TimeTicks, iso, ModuleIdentity, Counter32, Unsigned32, Bits, Integer32, Gauge32, Counter64, MibIdentifier, NotificationType, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "TimeTicks", "iso", "ModuleIdentity", "Counter32", "Unsigned32", "Bits", "Integer32", "Gauge32", "Counter64", "MibIdentifier", "NotificationType", "ObjectIdentity")
...
if mibBuilder.loadTexts: f10SysComponentMib.setContactInfo('http://www.force10networks.com/support')
if mibBuilder.loadTexts: f10SysComponentMib.setDescription('Dell Networking OS System component MIB. Dell Networking OS System component allow user to view the SW information of a component in the system. Currently, the available component information that are avaibale are 1) CAM Entries on linecard - Overall system CAM usage table - L2 Ingress or Egress CAM Usage - L3 Ingress or Egress CAM Usage - L3Ext Table CAM Usage (Specific to S-series L3 tables-Broadcom pltforms) ')
...
mibBuilder.exportSymbols("FORCE10-SYSTEM-COMPONENT-MIB", camUsageL2EgrAclUsed=camUsageL2EgrAclUsed, camUsageL3Slot=camUsageL3Slot, camUsageSlot=camUsageSlot, f10SysComponentTrap=f10SysComponentTrap, camUsagePartDesc=camUsagePartDesc, sysCompAlarmVarString=sysCompAlarmVarString, camUsageL3ExtLPMUsed=camUsageL3ExtLPMUsed, camUsageUsed=camUsageUsed, camUsageL3ExtPipeId=camUsageL3ExtPipeId, camUsageL3IngAclUsed=camUsageL3IngAclUsed, camUsageL3IngAclTotal=camUsageL3IngAclTotal, camUsageL3IngSysFlowUsed=camUsageL3IngSysFlowUsed, sysCompAlarmLevel=sysCompAlarmLevel, camUsageL3IngPbrUsed=camUsageL3IngPbrUsed, camUsageL3Entry=camUsageL3Entry, camUsageL3IngQosTotal=camUsageL3IngQosTotal, camUsagePartId=camUsagePartId, camUsageL3ExtTable=camUsageL3ExtTable, camUsageL3ExtSlot=camUsageL3ExtSlot, camUsageL3Table=camUsageL3Table, camUsageL3ExtEntry=camUsageL3ExtEntry, camUsageL2EgrAclTotal=camUsageL2EgrAclTotal, sysCompAlarmMibNotifications=sysCompAlarmMibNotifications, sysCompCamPartId=sysCompCamPartId, camUsageL3IngMcastFibTotal=camUsageL3IngMcastFibTotal, camUsageL2IngFibTotal=camUsageL2IngFibTotal, f10SysComponentMib=f10SysComponentMib, camUsageL2IngAclUsed=camUsageL2IngAclUsed, camUsageL3IngSysFlowTotal=camUsageL3IngSysFlowTotal, camUsageL3IngTrcListTotal=camUsageL3IngTrcListTotal, camUsageL3EgrAclUsed=camUsageL3EgrAclUsed, camUsageL3IngMcastFibUsed=camUsageL3IngMcastFibUsed, camUsageTable=camUsageTable, camUsageL3PipeId=camUsageL3PipeId, camUsageL2IngFibUsed=camUsageL2IngFibUsed, camUsageL3ExtHostUsed=camUsageL3ExtHostUsed, camUsageL3ExtLPMTotal=camUsageL3ExtLPMTotal, f10CamEntries=f10CamEntries, sysCompSlotId=sysCompSlotId, camUsageEntry=camUsageEntry, sysCompPortPipe=sysCompPortPipe, camIsFull=camIsFull, camUsageL3IngFibTotal=camUsageL3IngFibTotal, camUsagePipeNum=camUsagePipeNum, camUsageL3ExtHostTotal=camUsageL3ExtHostTotal, camUsageTotal=camUsageTotal, camUsageL3EgrAclTotal=camUsageL3EgrAclTotal, camUsageL2PipeId=camUsageL2PipeId, sysCompAlarmVariable=sysCompAlarmVariable, PYSNMP_MODULE_ID=f10SysComponentMib, camUsageL2Entry=camUsageL2Entry, camUsageL3IngQosUsed=camUsageL3IngQosUsed, camUsageL3IngFibUsed=camUsageL3IngFibUsed, f10SysComponentObjects=f10SysComponentObjects, camAuditError=camAuditError, camUsageL3IngTrcListUsed=camUsageL3IngTrcListUsed, camUsageL3IngPbrTotal=camUsageL3IngPbrTotal, camUsageL2IngAclTotal=camUsageL2IngAclTotal, camUsageThresholdExceed=camUsageThresholdExceed, camUsageL2Table=camUsageL2Table, camUsageL2Slot=camUsageL2Slot)
