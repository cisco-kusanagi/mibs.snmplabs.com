...
NotificationType, iso, ObjectIdentity, MibIdentifier, ModuleIdentity, Integer32, IpAddress, TimeTicks, Bits, Unsigned32, enterprises, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64 = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "iso", "ObjectIdentity", "MibIdentifier", "ModuleIdentity", "Integer32", "IpAddress", "TimeTicks", "Bits", "Unsigned32", "enterprises", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64")
...
if mibBuilder.loadTexts: switch001.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
if mibBuilder.loadTexts: rndNotifications.setDescription(" All the switch001 notifications will reside under this branch as specified in RFC2578 'Structure of Management Information Version 2 (SMIv2)' 8.5")
...
mibBuilder.exportSymbols("CISCOSB-MIB", rlAAAEap=rlAAAEap, rlAmap=rlAmap, rlIPv6=rlIPv6, rsTunning=rsTunning, rlRCli=rlRCli, rlMngInf=rlMngInf, rlProtectedPorts=rlProtectedPorts, rndEndOfMibGroup=rndEndOfMibGroup, rlMir=rlMir, rlUPnP=rlUPnP, rlEee=rlEee, rlBonjour=rlBonjour, rlAAA=rlAAA, rlSecuritySuiteMib=rlSecuritySuiteMib, rlQosCliMib=rlQosCliMib, rlPhy=rlPhy, rlIpv6Fhs=rlIpv6Fhs, rlCli=rlCli, rlWeightedRandomTailDrop=rlWeightedRandomTailDrop, rlEventsMib=rlEventsMib, rlSmartPorts=rlSmartPorts, rndNotifications=rndNotifications, rlMacMulticast=rlMacMulticast, rlQcnMib=rlQcnMib, rlBgp=rlBgp, rlTraceRoute=rlTraceRoute, rlErrdisableRecovery=rlErrdisableRecovery, rlExperience=rlExperience, VlanPriority=VlanPriority, dlPrivate=dlPrivate, rlBrgMcMngr=rlBrgMcMngr, rlBanner=rlBanner, rlDhcpv6=rlDhcpv6, rlRadius=rlRadius, rlWlanMIB=rlWlanMIB, rlCDB=rlCDB, PYSNMP_MODULE_ID=switch001, rlStormCtrl=rlStormCtrl, rndApplications=rndApplications, rlSNMP=rlSNMP, rlLbd=rlLbd, rlUdld=rlUdld, rlTimeSynchronization=rlTimeSynchronization, rlpBridgeMIBObjects=rlpBridgeMIBObjects, rndBootP=rndBootP, rlIpPrefList=rlIpPrefList, rlBrgMulticast=rlBrgMulticast, rlAutoUpdate=rlAutoUpdate, vlan=vlan, rlSwPackageVersion=rlSwPackageVersion, swInterfaces=swInterfaces, rlIfInterfaces=rlIfInterfaces, rlOib=rlOib, rlDhcpCl=rlDhcpCl, rlMacBasePrio=rlMacBasePrio, rlPfcMib=rlPfcMib, rlOspf=rlOspf, rlRtRedist=rlRtRedist, rlBroadcom=rlBroadcom, rlLocalization=rlLocalization, rlInventoryEnt=rlInventoryEnt, rlCopy=rlCopy, rlTrafficSeg=rlTrafficSeg, rlSsl=rlSsl, rlGvrp=rlGvrp, rlSysmngMib=rlSysmngMib, rlCustom1BonjourService=rlCustom1BonjourService, rlEnv=rlEnv, rlFip=rlFip, rlSocket=rlSocket, rlGalileo=rlGalileo, rlWBA=rlWBA, rlsFlowMib=rlsFlowMib, rndMng=rndMng, rlDigitalKeyManage=rlDigitalKeyManage, rlBrgMacSwitch=rlBrgMacSwitch, rlSyslog=rlSyslog, rl3sw2swTables=rl3sw2swTables, rlTunnel=rlTunnel, rlTelnet=rlTelnet, rlLldp=rlLldp, rndDeviceParams=rndDeviceParams, Percents=Percents, rlNicRedundancy=rlNicRedundancy, rlImpbFeatures=rlImpbFeatures, rlStatistics=rlStatistics, rlSpecialBpdu=rlSpecialBpdu, rlVoipSnoop=rlVoipSnoop, rlDot3adAgg=rlDot3adAgg, rlAgentsCapabilitiesGroups=rlAgentsCapabilitiesGroups, rlIntel=rlIntel, rlBridgeSecurity=rlBridgeSecurity, rlRmonControl=rlRmonControl, rlSsh=rlSsh, rlCiscoSmartMIB=rlCiscoSmartMIB, rlIPmulticast=rlIPmulticast, rlIpStdAcl=rlIpStdAcl, rlPolicy=rlPolicy, rlGmrp=rlGmrp, rlPoe=rlPoe, rlDebugCapabilities=rlDebugCapabilities, rlMultiSessionTerminal=rlMultiSessionTerminal, rlWlanAccessPoint=rlWlanAccessPoint, rlArpSpoofing=rlArpSpoofing, rlTBIMib=rlTBIMib, rsUDP=rsUDP, rlFile=rlFile, rlRs232=rlRs232, rlGlobalIpAddrTable=rlGlobalIpAddrTable, ipSpec=ipSpec, switch001=switch001, rlActionAcl=rlActionAcl, rlEtsMib=rlEtsMib, rlGreenEth=rlGreenEth, rlDeleteImg=rlDeleteImg, rlSafeGuard=rlSafeGuard, rlSctMib=rlSctMib, rlDnsCl=rlDnsCl, rlVlanTrunking=rlVlanTrunking, rlEmbWeb=rlEmbWeb, rldot1x=rldot1x, rlDhcpSpoofing=rlDhcpSpoofing, rlSmon=rlSmon, rlAggregateVlan=rlAggregateVlan, NetNumber=NetNumber, rlDlf=rlDlf, rlCpuCounters=rlCpuCounters, rlPhysicalDescription=rlPhysicalDescription, rlFFT=rlFFT, rlJumboFrames=rlJumboFrames, rlIpMRouteStdMIB=rlIpMRouteStdMIB, rlCdp=rlCdp, rlSecSd=rlSecSd, rlStack=rlStack)
