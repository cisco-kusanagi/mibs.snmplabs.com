...
# Produced by pysmi-0.3.4 at Wed May  1 14:57:57 2019
...
NotificationType, Counter64, Gauge32, ModuleIdentity, IpAddress, snmpModules, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, enterprises, Integer32, ObjectName, iso, Bits, Unsigned32, MibIdentifier, Counter32, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Gauge32", "ModuleIdentity", "IpAddress", "snmpModules", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "enterprises", "Integer32", "ObjectName", "iso", "Bits", "Unsigned32", "MibIdentifier", "Counter32", "TimeTicks")
...
if mibBuilder.loadTexts: rm1.setContactInfo('')
if mibBuilder.loadTexts: rm1.setDescription('The MIB module for entities implementing the xxxx protocol.')
...
mibBuilder.exportSymbols("RM1-MIB", duFSName=duFSName, cpuLoad=cpuLoad, products=products, diskUsageAlarmPct=diskUsageAlarmPct, filePeriod=filePeriod, diskPeriod=diskPeriod, PYSNMP_MODULE_ID=rm1, cpuLoadAlarmThreshold=cpuLoadAlarmThreshold, processName=processName, rmNetAddress=rmNetAddress, rmFileGrp=rmFileGrp, rmUpTime=rmUpTime, processCPUUsageAlarmMark=processCPUUsageAlarmMark, cpuUtilWarningPct=cpuUtilWarningPct, cpuLoadWarningThreshold=cpuLoadWarningThreshold, processNumber=processNumber, lucent=lucent, fmNumber=fmNumber, rmDescr=rmDescr, diskUsageTable=diskUsageTable, processPeriod=processPeriod, fmEntry=fmEntry, rm1=rm1, duNumber=duNumber, cpuUtilAlarmPct=cpuUtilAlarmPct, fmName=fmName, duPctUsed=duPctUsed, diskUsageEntry=diskUsageEntry, fmCurSize=fmCurSize, rmObjectID=rmObjectID, resourceMonitor=resourceMonitor, processCPUUsageCurrent=processCPUUsageCurrent, cpuPeriod=cpuPeriod, rmDiskGrp=rmDiskGrp, processMemUsageAlarmMark=processMemUsageAlarmMark, rmCpuGrp=rmCpuGrp, cpuUtilization=cpuUtilization, processIndex=processIndex, rmProcessGrp=rmProcessGrp, processCPUUsageWarnMark=processCPUUsageWarnMark, fmTable=fmTable, fmIndex=fmIndex, processMemUsageCurrent=processMemUsageCurrent, rmSystem=rmSystem, rmControl=rmControl, fmThreshold=fmThreshold, processTable=processTable, diskUsageWarningPct=diskUsageWarningPct, processID=processID, softSwitch=softSwitch, duSize=duSize, processEntry=processEntry, processUpTime=processUpTime, duIndex=duIndex, archiveDir=archiveDir)
