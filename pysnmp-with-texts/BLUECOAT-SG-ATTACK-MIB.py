...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/BLUECOAT-SG-ATTACK-MIB
# Produced by pysmi-0.3.4 at Wed May  1 11:39:41 2019
...
Counter64, Gauge32, Integer32, Counter32, NotificationType, TimeTicks, MibIdentifier, IpAddress, Unsigned32, ModuleIdentity, Bits, ObjectIdentity, iso, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "Gauge32", "Integer32", "Counter32", "NotificationType", "TimeTicks", "MibIdentifier", "IpAddress", "Unsigned32", "ModuleIdentity", "Bits", "ObjectIdentity", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
if mibBuilder.loadTexts: deviceAttackMIB.setContactInfo('support.services@bluecoat.com http://www.bluecoat.com')
if mibBuilder.loadTexts: deviceAttackMIB.setDescription('The Blue Coat Attack MIB is used to monitor possible protocol attacks by hackers.')
...
if mibBuilder.loadTexts: deviceAttackStatus.setDescription('noAttack(1) not under attack, underAttack(2) attack in progress. The default start-up value is noAttack(1).')
...
if mibBuilder.loadTexts: deviceAttackTrap.setDescription("At the start of an attack a notification is generated with 'deviceAttackStatus = underAttack(2)'. At the end of an attack a notification is generated with 'deviceAttackStatus = noAttack(1)'.")
mibBuilder.exportSymbols("BLUECOAT-SG-ATTACK-MIB", deviceAttackTime=deviceAttackTime, deviceAttackName=deviceAttackName, deviceAttackEntry=deviceAttackEntry, deviceAttackMIBObjects=deviceAttackMIBObjects, deviceAttackMIBNotificationsPrefix=deviceAttackMIBNotificationsPrefix, AttackStatus=AttackStatus, deviceAttackMIB=deviceAttackMIB, PYSNMP_MODULE_ID=deviceAttackMIB, deviceAttackStatus=deviceAttackStatus, deviceAttackMIBNotifications=deviceAttackMIBNotifications, deviceAttackTrap=deviceAttackTrap, deviceAttackValues=deviceAttackValues, deviceAttackIndex=deviceAttackIndex, deviceAttackTable=deviceAttackTable)
