...
# Produced by pysmi-0.3.4 at Wed May  1 15:34:52 2019
...
IpAddress, Bits, NotificationType, Counter64, Gauge32, ModuleIdentity, Counter32, TimeTicks, Unsigned32, iso, MibIdentifier, ObjectIdentity, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "Bits", "NotificationType", "Counter64", "Gauge32", "ModuleIdentity", "Counter32", "TimeTicks", "Unsigned32", "iso", "MibIdentifier", "ObjectIdentity", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
...
if mibBuilder.loadTexts: vmwHBMIB.setContactInfo('VMware, Inc 3401 Hillview Ave Palo Alto, CA 94304 Tel: 1-877-486-9273 or 650-427-5000 Fax: 650-427-5001 Web: http://communities.vmware.com/community/developer/forums/managementapi ')
if mibBuilder.loadTexts: vmwHBMIB.setDescription('This MIB module provides a reverse poll for systems that do not yet support polling. See http://kb.vmware.com/kb/2020271 for details on reverse polling in VMware SNMP agents.')
...
if mibBuilder.loadTexts: vmwHbHeartbeat.setDescription('This notification, if the agent is so configured, will be sent on a periodic basis to indicate cimom indication delivery is functioning.')
...
if mibBuilder.loadTexts: vmwHbMIBBasicCompliance.setDescription('The compliance statement for entities which implement the VMWARE-HEARTBEAT-MIB.')
