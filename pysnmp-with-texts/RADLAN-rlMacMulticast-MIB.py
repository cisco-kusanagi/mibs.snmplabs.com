...
rndNotifications, rlMacMulticast, rnd = mibBuilder.importSymbols("RADLAN-MIB", "rndNotifications", "rlMacMulticast", "rnd")
ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup")
Bits, NotificationType, IpAddress, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, MibIdentifier, Gauge32, ObjectIdentity, iso, TimeTicks, ModuleIdentity, Counter64, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "NotificationType", "IpAddress", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "MibIdentifier", "Gauge32", "ObjectIdentity", "iso", "TimeTicks", "ModuleIdentity", "Counter64", "Counter32")
...
if mibBuilder.loadTexts: rlIgmpSnoopQuerierElectionEnable.setDescription('Whether or not to participate in querier election. When true, the snooping querier participates in querier election. When false, the snooping querier is the elected querier until a general query is heard from another router on the vlan (always lose).')
...
if mibBuilder.loadTexts: rlIgmpMldSnoopVlanAdminLastMemberQueryCount.setDescription('Represents the number of group-specific and group-and-source-specific queries sent by the router before it assumes there are no local members. Value 0 is used to indicate usage of default value. DEFVAL { rlIgmpMldSnoopVlanAdminRobustness }')
...
if mibBuilder.loadTexts: rlMldSnoopQuerierVlanTable.setDescription('A table that contains MLD Snooping Querier information about every vlan. This is indexed by vlan tag.')
...
if mibBuilder.loadTexts: rlMldSnoopQuerierElectionEnable.setDescription('Whether or not to participate in querier election. When true, the snooping querier participates in querier election. When false, the snooping querier is the elected querier until a general query is heard from another router on the vlan (always lose).')
...
if mibBuilder.loadTexts: rlIgmpMldSnoopQuerierGlobalAddressIPVersion.setDescription('The IP version of this PIM interface. A physical interface may be configured in multiple modes concurrently, e.g., IPv4 and IPv6; however, the traffic is considered to be logically separate.')
...
if mibBuilder.loadTexts: rlIgmpMldSnoopQuerierGlobalAddress.setDescription('The desired address to used in IGMP/MLD Snoop Querier messages if such an address is not configured on the vlan.')
...
if mibBuilder.loadTexts: rlbrgIgmpSnoopQrrDuplicateIP.setDescription('Warning trap indicating that duplicate ip\\ipv6 address occured between two queries')
mibBuilder.exportSymbols("RADLAN-rlMacMulticast-MIB", rlIgmpMldSnoopMembershipEntry=rlIgmpMldSnoopMembershipEntry, rlIgmpSnoopQuerierEnable=rlIgmpSnoopQuerierEnable, rlIgmpMldSnoopVlanAdminStartupQueryInterval=rlIgmpMldSnoopVlanAdminStartupQueryInterval, rlMldSnoopQuerierAdminEnable=rlMldSnoopQuerierAdminEnable, rlIgmpMldSnoopMembershipVlanTag=rlIgmpMldSnoopMembershipVlanTag, rlIgmpSnoopVlanHostTimeOut=rlIgmpSnoopVlanHostTimeOut, rlIgmpSnoopVlanTag=rlIgmpSnoopVlanTag, rlMacMulticastMaxEntriesNum=rlMacMulticastMaxEntriesNum, rlIgmpMldSnoopVlanAdminRobustness=rlIgmpMldSnoopVlanAdminRobustness, rlMldSnoop=rlMldSnoop, rlMacMulticastEnable=rlMacMulticastEnable, rlIgmpMldSnoopVlanOperQueryInterval=rlIgmpMldSnoopVlanOperQueryInterval, rlIgmpMldSnoopMembershipCompatibilityMode=rlIgmpMldSnoopMembershipCompatibilityMode, rlIgmpMldSnoopVlanOperRobustness=rlIgmpMldSnoopVlanOperRobustness, IgmpVersion=IgmpVersion, rlIgmpMldSnoopMulticastTvEntry=rlIgmpMldSnoopMulticastTvEntry, rlIgmpSnoopQuerierVlanEntry=rlIgmpSnoopQuerierVlanEntry, rlMldSnoopQuerierOperAddrInetAddressType=rlMldSnoopQuerierOperAddrInetAddressType, rlIgmpMldSnoopQuerierGlobalAddressType=rlIgmpMldSnoopQuerierGlobalAddressType, rlIgmpSnoopEnable=rlIgmpSnoopEnable, rlIgmpSnoopMulticastTvTable=rlIgmpSnoopMulticastTvTable, rlMldSnoopQuerierEnable=rlMldSnoopQuerierEnable, rlIgmpMldSnoopVlanOperLastMemberQueryInterval=rlIgmpMldSnoopVlanOperLastMemberQueryInterval, rlIgmpSnoopMulticastTvVID=rlIgmpSnoopMulticastTvVID, rlIgmpSnoopRouterAgingTime=rlIgmpSnoopRouterAgingTime, rlIgmpMldSnoopVlanQueryOverride=rlIgmpMldSnoopVlanQueryOverride, rlIgmpMldSnoopVlanIsImmediateLeave=rlIgmpMldSnoopVlanIsImmediateLeave, rlIgmpMldSnoopQuerierGlobalAddressIPVersion=rlIgmpMldSnoopQuerierGlobalAddressIPVersion, rlIgmpSnoopMulticastTvStatus=rlIgmpSnoopMulticastTvStatus, rlMldSnoopQuerierAdminAddr=rlMldSnoopQuerierAdminAddr, rlIgmpMldSnoopMembershipSourceIpAddressType=rlIgmpMldSnoopMembershipSourceIpAddressType, rlMldSnoopQuerierAdminVersionNumber=rlMldSnoopQuerierAdminVersionNumber, rlIgmpMldSnoopMulticastTvStatus=rlIgmpMldSnoopMulticastTvStatus, rlIgmpMldSnoopVlanRouterTimeOut=rlIgmpMldSnoopVlanRouterTimeOut, rlIgmpSnoopMembershipVlanTag=rlIgmpSnoopMembershipVlanTag, rlIgmpMldSnoopMulticastTvVID=rlIgmpMldSnoopMulticastTvVID, rlIgmpSnoopVlanQuerierTimeOut=rlIgmpSnoopVlanQuerierTimeOut, rlIgmpSnoop=rlIgmpSnoop, rlIgmpMldSnoopMembershipGroupIpAddress=rlIgmpMldSnoopMembershipGroupIpAddress, rlIgmpMldSnoopVlanAdminLeaveTimeOut=rlIgmpMldSnoopVlanAdminLeaveTimeOut, rlIgmpSnoopVlanRouterPortlist=rlIgmpSnoopVlanRouterPortlist, rlIgmpSnoopMulticastTvEntry=rlIgmpSnoopMulticastTvEntry, rlIgmpMldSnoopQuerierGlobalAddress=rlIgmpMldSnoopQuerierGlobalAddress, rlIgmpSnoopQuerierVlanTable=rlIgmpSnoopQuerierVlanTable, rlMldSnoopQuerierOperAddr=rlMldSnoopQuerierOperAddr, rlIgmpMldSnoopQuerierGlobalAddressEntry=rlIgmpMldSnoopQuerierGlobalAddressEntry, rlIgmpSnoopVlanEnable=rlIgmpSnoopVlanEnable, rlIgmpMldSnoopVlanIgmpVersion=rlIgmpMldSnoopVlanIgmpVersion, rlIgmpMldSnoopMulticastTvGroup=rlIgmpMldSnoopMulticastTvGroup, rlIgmpMldSnoopVlanQuerierTimeOut=rlIgmpMldSnoopVlanQuerierTimeOut, rlIgmpSnoopQuerierAdminAddr=rlIgmpSnoopQuerierAdminAddr, rlIgmpMldSnoopMulticastTvGroupAddressType=rlIgmpMldSnoopMulticastTvGroupAddressType, rlIgmpSnoopMibVersion=rlIgmpSnoopMibVersion, rlIgmpSnoopVlanTable=rlIgmpSnoopVlanTable, rlIgmpMldSnoopVlanAdminLastMemberQueryInterval=rlIgmpMldSnoopVlanAdminLastMemberQueryInterval, rlIgmpSnoopVlanEntry=rlIgmpSnoopVlanEntry, rlIgmpSnoopQuerierElectionEnable=rlIgmpSnoopQuerierElectionEnable, rlMldSnoopQuerierElectionEnable=rlMldSnoopQuerierElectionEnable, rlIgmpSnoopHostAgingTime=rlIgmpSnoopHostAgingTime, rlIgmpMldSnoopVlanInetAddressType=rlIgmpMldSnoopVlanInetAddressType, rlIgmpSnoopVlanRouterTimeOut=rlIgmpSnoopVlanRouterTimeOut, rlIgmpMldSnoopMulticastTvTable=rlIgmpMldSnoopMulticastTvTable, rlIgmpMldSnoopVlanEnable=rlIgmpMldSnoopVlanEnable, rlIgmpMldSnoopMembershipExcPortlist=rlIgmpMldSnoopMembershipExcPortlist, rlMacMulticastFilter=rlMacMulticastFilter, rlIgmpSnoopVlanLeaveTimeOut=rlIgmpSnoopVlanLeaveTimeOut, rlIgmpSnoopQuerierOperEnable=rlIgmpSnoopQuerierOperEnable, rlIgmpMldSnoopVlanRouterForbiddenPortlist=rlIgmpMldSnoopVlanRouterForbiddenPortlist, rlIgmpSnoopMembershipEntry=rlIgmpSnoopMembershipEntry, rlMldSnoopHostAgingTime=rlMldSnoopHostAgingTime, rlIgmpSnoopMembershipExpiryTime=rlIgmpSnoopMembershipExpiryTime, rlIgmpSnoopIGMP224ReportsHandle=rlIgmpSnoopIGMP224ReportsHandle, rlIgmpSnoopMembershipGroupIpAddress=rlIgmpSnoopMembershipGroupIpAddress, rlIgmpMldSnoopMembershipTable=rlIgmpMldSnoopMembershipTable, rlIgmpMldSnoopVlanOperLeaveTimeOut=rlIgmpMldSnoopVlanOperLeaveTimeOut, rlIgmpMldSnoopVlanEntry=rlIgmpMldSnoopVlanEntry, rlIgmpMldSnoopVlanAdminHostTimeOut=rlIgmpMldSnoopVlanAdminHostTimeOut, rlIgmpMldSnoopVlanOperQueryMaxResponseTime=rlIgmpMldSnoopVlanOperQueryMaxResponseTime, rlIgmpSnoopVlanRouterLearn=rlIgmpSnoopVlanRouterLearn, rlMldSnoopQuerierOperEnable=rlMldSnoopQuerierOperEnable, rlIgmpMldSnoopVlanAdminLastMemberQueryCount=rlIgmpMldSnoopVlanAdminLastMemberQueryCount, rlIgmpMldSnoopVlanHostTimeOut=rlIgmpMldSnoopVlanHostTimeOut, rlIgmpMldSnoopVlanAdminQueryInterval=rlIgmpMldSnoopVlanAdminQueryInterval, rlIgmpSnoopVlanIgmpVersion=rlIgmpSnoopVlanIgmpVersion, rlIgmpMldSnoopMembershipSourceIpAddress=rlIgmpMldSnoopMembershipSourceIpAddress, rlIgmpSnoopMulticastTvGroup=rlIgmpSnoopMulticastTvGroup, rlMldSnoopRouterAgingTime=rlMldSnoopRouterAgingTime, rlIgmpSnoopQuerierOperVersionNumber=rlIgmpSnoopQuerierOperVersionNumber, rlIgmpMldSnoopMulticastTvInetAddressType=rlIgmpMldSnoopMulticastTvInetAddressType, rlIgmpMldSnoopVlanLeaveTimeOut=rlIgmpMldSnoopVlanLeaveTimeOut, rlIgmpSnoopQuerierAdminEnable=rlIgmpSnoopQuerierAdminEnable, rlIgmpMldSnoopVlanOperStartupQueryInterval=rlIgmpMldSnoopVlanOperStartupQueryInterval, rlIgmpMldSnoopVlanOperRouterTimeOut=rlIgmpMldSnoopVlanOperRouterTimeOut, rlIgmpSnoopMembershipTable=rlIgmpSnoopMembershipTable, rlIgmpMldSnoopVlanTable=rlIgmpMldSnoopVlanTable, rlIgmpMldSnoopVlanRouterStaticPortlist=rlIgmpMldSnoopVlanRouterStaticPortlist, rlIgmpMldSnoopVlanAdminQueryMaxResponseTime=rlIgmpMldSnoopVlanAdminQueryMaxResponseTime, rlMacMulticastUnregFilterEnable=rlMacMulticastUnregFilterEnable, rlIgmpSnoopQuerierOperAddr=rlIgmpSnoopQuerierOperAddr, rlIgmpSnoopQuerierAdminVersionNumber=rlIgmpSnoopQuerierAdminVersionNumber, rlMldSnoopEnable=rlMldSnoopEnable, rlMldSnoopQuerierVlanTable=rlMldSnoopQuerierVlanTable, rlIgmpMldSnoopMembershipIncPortlist=rlIgmpMldSnoopMembershipIncPortlist, rlIgmpMldSnoopVlanAdminStartupQueryCount=rlIgmpMldSnoopVlanAdminStartupQueryCount, rlIgmpMldSnoopVlanOperHostTimeOut=rlIgmpMldSnoopVlanOperHostTimeOut, rlIgmpMldSnoopVlanOperLastMemberQueryCount=rlIgmpMldSnoopVlanOperLastMemberQueryCount, rlIgmpSnoopMembershipIncPortlist=rlIgmpSnoopMembershipIncPortlist, rlIgmpMldSnoopMembershipExpiryTime=rlIgmpMldSnoopMembershipExpiryTime, rlMldSnoopQuerierVlanEntry=rlMldSnoopQuerierVlanEntry, rlIgmpMldSnoopTriplePlayPort=rlIgmpMldSnoopTriplePlayPort, rlIgmpMldSnoopQuerierGlobalAddressTable=rlIgmpMldSnoopQuerierGlobalAddressTable, rlIgmpMldSnoopVlanAdminRouterTimeOut=rlIgmpMldSnoopVlanAdminRouterTimeOut, rlIgmpSnoopMembershipExcPortlist=rlIgmpSnoopMembershipExcPortlist, rlIgmpSnoopMembershipSourceIpAddress=rlIgmpSnoopMembershipSourceIpAddress, rlIgmpSnoopMembershipCompatibilityMode=rlIgmpSnoopMembershipCompatibilityMode, rlIgmpMldSnoopVlanTag=rlIgmpMldSnoopVlanTag, rlMldSnoopQuerierVlanTag=rlMldSnoopQuerierVlanTag, MldVersion=MldVersion, rlIgmpMldSnoopMembershipGroupIpAddressType=rlIgmpMldSnoopMembershipGroupIpAddressType, rlMldSnoopQuerierOperVersionNumber=rlMldSnoopQuerierOperVersionNumber, rlMldSnoopQuerierAdminAddrInetAddressType=rlMldSnoopQuerierAdminAddrInetAddressType, rlIgmpMldSnoopVlanRouterLearn=rlIgmpMldSnoopVlanRouterLearn, rlMacMulticastUnregFilterFailed=rlMacMulticastUnregFilterFailed, rlbrgIgmpSnoopQrrDuplicateIP=rlbrgIgmpSnoopQrrDuplicateIP, rlIgmpMldSnoopVlanRouterPortlist=rlIgmpMldSnoopVlanRouterPortlist, rlIgmpSnoopQuerierVlanTag=rlIgmpSnoopQuerierVlanTag, rlIgmpMldSnoopVlanOperStartupQueryCount=rlIgmpMldSnoopVlanOperStartupQueryCount)
