...
# Produced by pysmi-0.3.4 at Wed May  1 12:22:13 2019
...
Gauge32, Counter64, Integer32, MibIdentifier, Counter32, TimeTicks, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, IpAddress, Unsigned32, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Counter64", "Integer32", "MibIdentifier", "Counter32", "TimeTicks", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "IpAddress", "Unsigned32", "ModuleIdentity", "iso")
...
if mibBuilder.loadTexts: rlDhcpCl.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
if mibBuilder.loadTexts: rlDhcpClManualAutoConfigDataTable.setDescription(' A table for configuring default values for auto-config process. These values during the process, in case no appropriate data was received from the DHCP server.')
...
mibBuilder.exportSymbols("CISCOSB-DHCPCL-MIB", rlDhcpClOption67Enable=rlDhcpClOption67Enable, rlDhcpClSelectedConfigurationFileNameOrigin=rlDhcpClSelectedConfigurationFileNameOrigin, rlDhcpClInformationTftpServerName=rlDhcpClInformationTftpServerName, rlDhcpClActionIfIndex=rlDhcpClActionIfIndex, rlDhcpApprovalActionMask=rlDhcpApprovalActionMask, rlDhcpClInformationDnsServerListPriority=rlDhcpClInformationDnsServerListPriority, rlDhcpClCommandTable=rlDhcpClCommandTable, rlDhcpApprovalActionEntry=rlDhcpApprovalActionEntry, rlDhcpApprovalActionApprove=rlDhcpApprovalActionApprove, rlDhcpClSelectedTftpServerAddress=rlDhcpClSelectedTftpServerAddress, rlDhcpApprovalEnabled=rlDhcpApprovalEnabled, rlDhcpClManualConfigurationFileName=rlDhcpClManualConfigurationFileName, rlDhcpClInformationHostName=rlDhcpClInformationHostName, rlDhcpClInformationTftpServerListTable=rlDhcpClInformationTftpServerListTable, PYSNMP_MODULE_ID=rlDhcpCl, rlDhcpClManualTftpServerAddress=rlDhcpClManualTftpServerAddress, rlDhcpClAutoConfigAutoSave=rlDhcpClAutoConfigAutoSave, rlDhcpClSelectedConfigurationFileName=rlDhcpClSelectedConfigurationFileName, rlDhcpClManualAutoConfigDataIndex=rlDhcpClManualAutoConfigDataIndex, rlDhcpClAutoConfigStatus=rlDhcpClAutoConfigStatus, rlDhcpApprovalActionIfIndex=rlDhcpApprovalActionIfIndex, rlDhcpClActionStatus=rlDhcpClActionStatus, rlDhcpClAutoUpdateStatus=rlDhcpClAutoUpdateStatus, rlDhcpClInformationDnsServerListIfIndex=rlDhcpClInformationDnsServerListIfIndex, rlDhcpClAutoConfigProtocol=rlDhcpClAutoConfigProtocol, rlDhcpClCommandEntry=rlDhcpClCommandEntry, rlDhcpClAutoUpdateScpFileExtention=rlDhcpClAutoUpdateScpFileExtention, rlDhcpClSelectedTftpServerAddressOrigin=rlDhcpClSelectedTftpServerAddressOrigin, rlDhcpClInformationEntry=rlDhcpClInformationEntry, rlDhcpApprovalWaitingGateway=rlDhcpApprovalWaitingGateway, rlDhcpClInformationT2=rlDhcpClInformationT2, rlDhcpClInformationDnsServerListTable=rlDhcpClInformationDnsServerListTable, rlDhcpClSelectedTftpServerInetAddress=rlDhcpClSelectedTftpServerInetAddress, rlDhcpClInformationIpMask=rlDhcpClInformationIpMask, rlDhcpClInformationDomainName=rlDhcpClInformationDomainName, rlDhcpClInformationTftpServerListEntry=rlDhcpClInformationTftpServerListEntry, rlDhcpClAutoConfigScpFileExtention=rlDhcpClAutoConfigScpFileExtention, rlDhcpApprovalWaitingEntry=rlDhcpApprovalWaitingEntry, rlDhcpClInformationTftpServerListIfIndex=rlDhcpClInformationTftpServerListIfIndex, rlDhcpClConfigurationFileName=rlDhcpClConfigurationFileName, rlDhcpApprovalWaitingMask=rlDhcpApprovalWaitingMask, rlDhcpClEnabledByDefaultRemovedIfindex=rlDhcpClEnabledByDefaultRemovedIfindex, rlDhcpClManualAutoConfigDataEntry=rlDhcpClManualAutoConfigDataEntry, rlDhcpClInformationTimeZone=rlDhcpClInformationTimeZone, rlDhcpClInformationT1=rlDhcpClInformationT1, rlDhcpClAutoUpdateProtocol=rlDhcpClAutoUpdateProtocol, rlDhcpClInformationDnsServerListEntry=rlDhcpClInformationDnsServerListEntry, rlDhcpClInformationDefaultGateway=rlDhcpClInformationDefaultGateway, rlDhcpApprovalActionAddress=rlDhcpApprovalActionAddress, rlDhcpClSelectedTftpServerInetAddressType=rlDhcpClSelectedTftpServerInetAddressType, rlDhcpClManualAutoConfigDataTable=rlDhcpClManualAutoConfigDataTable, rlDhcpClActionEntry=rlDhcpClActionEntry, rlDhcpClAutoConfigForce=rlDhcpClAutoConfigForce, rlDhcpClActionHostName=rlDhcpClActionHostName, rlDhcpClActionTable=rlDhcpClActionTable, rlDhcpApprovalWaitingTable=rlDhcpApprovalWaitingTable, rlDhcpClAutoUpdateEnabled=rlDhcpClAutoUpdateEnabled, rlDhcpApprovalWaitingAddress=rlDhcpApprovalWaitingAddress, rlDhcpApprovalActionTable=rlDhcpApprovalActionTable, rlDhcpClCommandAction=rlDhcpClCommandAction, rlDhcpClInformationTftpFileName=rlDhcpClInformationTftpFileName, rlDhcpClInformationTftpImageName=rlDhcpClInformationTftpImageName, rlDhcpClInformationIfIndex=rlDhcpClInformationIfIndex, rlDhcpClInformationDnsServerListAddress=rlDhcpClInformationDnsServerListAddress, rlDhcpClInformationTftpServerListPriority=rlDhcpClInformationTftpServerListPriority, rlDhcpClInformationTftpServerListAddress=rlDhcpClInformationTftpServerListAddress, rlDhcpClInformationTable=rlDhcpClInformationTable, rlDhcpApprovalWaitingIfIndex=rlDhcpApprovalWaitingIfIndex, rlDhcpClManualServerInetAddressType=rlDhcpClManualServerInetAddressType, rlDhcpClManualServerInetAddress=rlDhcpClManualServerInetAddress, rlDhcpCl=rlDhcpCl, rlDhcpClInformationIpAddress=rlDhcpClInformationIpAddress)
