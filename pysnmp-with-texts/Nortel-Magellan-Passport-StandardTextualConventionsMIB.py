...
mibBuilder.exportSymbols("Nortel-Magellan-Passport-StandardTextualConventionsMIB", standardTextualConventionsGroupBC02=standardTextualConventionsGroupBC02, TruthValue=TruthValue, Unsigned32=Unsigned32, standardTextualConventionsMIB=standardTextualConventionsMIB, Counter32=Counter32, TimeInterval=TimeInterval, InterfaceIndex=InterfaceIndex, PositiveInteger=PositiveInteger, Gauge32=Gauge32, PhysAddress=PhysAddress, X121Address=X121Address, FddiResourceId=FddiResourceId, PassportCounter64=PassportCounter64, TimeStamp=TimeStamp, standardTextualConventionsGroup=standardTextualConventionsGroup, standardTextualConventionsCapabilitiesBC02A=standardTextualConventionsCapabilitiesBC02A, DLCI=DLCI, IANAifType=IANAifType, Timeout=Timeout, UpToMaxAge=UpToMaxAge, VariablePointer=VariablePointer, TAddress=TAddress, AreaID=AreaID, Integer32=Integer32, AutonomousType=AutonomousType, Status=Status, BigMetric=BigMetric, HelloRange=HelloRange, MacAddress=MacAddress, RouterID=RouterID, standardTextualConventionsGroupBC=standardTextualConventionsGroupBC, standardTextualConventionsGroupBC02A=standardTextualConventionsGroupBC02A, StorageType=StorageType, standardTextualConventionsCapabilities=standardTextualConventionsCapabilities, BridgeId=BridgeId, DesignatedRouterPriority=DesignatedRouterPriority, TestAndIncr=TestAndIncr, RowStatus=RowStatus, RowPointer=RowPointer, FddiSMTStationIdType=FddiSMTStationIdType, Metric=Metric, NsapAddress=NsapAddress, DisplayString=DisplayString, standardTextualConventionsCapabilitiesBC=standardTextualConventionsCapabilitiesBC, Validation=Validation, FddiMACLongAddressType=FddiMACLongAddressType, standardTextualConventionsCapabilitiesBC02=standardTextualConventionsCapabilitiesBC02, TOSType=TOSType, FddiTimeNano=FddiTimeNano, FddiTimeMilli=FddiTimeMilli, DateAndTime=DateAndTime)
