...
# Produced by pysmi-0.3.4 at Wed May  1 13:20:19 2019
...
IfDirection, IndexIntegerNextFree, IndexInteger = mibBuilder.importSymbols("DIFFSERV-MIB", "IfDirection", "IndexIntegerNextFree", "IndexInteger")
...
TimeTicks, iso, IpAddress, ModuleIdentity, Counter32, Counter64, Bits, NotificationType, ObjectIdentity, MibIdentifier, Gauge32, Unsigned32, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "IpAddress", "ModuleIdentity", "Counter32", "Counter64", "Bits", "NotificationType", "ObjectIdentity", "MibIdentifier", "Gauge32", "Unsigned32", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
DisplayString, RowStatus, StorageType, TextualConvention, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "StorageType", "TextualConvention", "MacAddress")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: gsm7324QOSDiffServExtensions.setRevisionsDescriptions(('Initial revision.',))
...
if mibBuilder.loadTexts: gsm7324QOSDiffServExtensions.setContactInfo('')
if mibBuilder.loadTexts: gsm7324QOSDiffServExtensions.setDescription('')
...
mibBuilder.exportSymbols("GSM7324-QOS-DIFFSERV-EXTENSIONS-MIB", agentDiffServIpPrecMarkActTable=agentDiffServIpPrecMarkActTable, IpPrecedence=IpPrecedence, VlanIdOrAny=VlanIdOrAny, agentDiffServIpPrecMarkActPrecedence=agentDiffServIpPrecMarkActPrecedence, agentDiffServAuxMfClfrVlanId=agentDiffServAuxMfClfrVlanId, agentDiffServAuxMfClfrDstL4PortMax=agentDiffServAuxMfClfrDstL4PortMax, agentDiffServAuxMfClfrSrcL4PortMin=agentDiffServAuxMfClfrSrcL4PortMin, agentDiffServAuxMfClfrStatus=agentDiffServAuxMfClfrStatus, agentDiffServAuxMfClfrDstAddr=agentDiffServAuxMfClfrDstAddr, PYSNMP_MODULE_ID=gsm7324QOSDiffServExtensions, agentDiffServCosMarkActEntry=agentDiffServCosMarkActEntry, agentDiffServAuxMfClfrDstMask=agentDiffServAuxMfClfrDstMask, agentDiffServAuxMfClfrDstMac=agentDiffServAuxMfClfrDstMac, agentDiffServMIBObjects=agentDiffServMIBObjects, agentDiffServAuxMfClfrCos=agentDiffServAuxMfClfrCos, agentDiffServAction=agentDiffServAction, agentDiffServAuxMfClfrDstMacMask=agentDiffServAuxMfClfrDstMacMask, agentDiffServCosMarkActCos=agentDiffServCosMarkActCos, agentDiffServAuxMfClfrTable=agentDiffServAuxMfClfrTable, agentDiffServAuxMfClfrTos=agentDiffServAuxMfClfrTos, agentDiffServAuxMfClfrId=agentDiffServAuxMfClfrId, agentDiffServClassifier=agentDiffServClassifier, agentDiffServCosMarkActTable=agentDiffServCosMarkActTable, agentDiffServAuxMfClfrSrcMac=agentDiffServAuxMfClfrSrcMac, agentDiffServAuxMfClfrEntry=agentDiffServAuxMfClfrEntry, agentDiffServAuxMfClfrNextFree=agentDiffServAuxMfClfrNextFree, CosOrAny=CosOrAny, agentDiffServIpPrecMarkActEntry=agentDiffServIpPrecMarkActEntry, agentDiffServAuxMfClfrSrcL4PortMax=agentDiffServAuxMfClfrSrcL4PortMax, agentDiffServAuxMfClfrSrcMacMask=agentDiffServAuxMfClfrSrcMacMask, agentDiffServAuxMfClfrProtocol=agentDiffServAuxMfClfrProtocol, agentDiffServAuxMfClfrSrcMask=agentDiffServAuxMfClfrSrcMask, Cos=Cos, agentDiffServAuxMfClfrSrcAddr=agentDiffServAuxMfClfrSrcAddr, gsm7324QOSDiffServExtensions=gsm7324QOSDiffServExtensions, agentDiffServAuxMfClfrStorage=agentDiffServAuxMfClfrStorage, agentDiffServAuxMfClfrDstL4PortMin=agentDiffServAuxMfClfrDstL4PortMin, agentDiffServAuxMfClfrTosMask=agentDiffServAuxMfClfrTosMask)
