...
# Produced by pysmi-0.3.4 at Wed May  1 14:49:54 2019
...
class NTPSignedTimeValue(TextualConvention, OctetString):
    description = 'The time in seconds that could represent signed quantities like time delay with respect to some source. This textual-convention is specific to RADLAN implementation of NTP where 32-bit integers are used for such quantities. The signed integer part is in the first 16 bits and the fraction part is in the last 16 bits.'
    status = 'current'
    displayHint = '2d.2d'
...
mibBuilder.exportSymbols("RADLAN-TIMESYNCHRONIZATION-MIB", rlSntpBroadcastInetOffset=rlSntpBroadcastInetOffset, rlSntpBroadcastIfIndex=rlSntpBroadcastIfIndex, RlSntpNtpSyncType=RlSntpNtpSyncType, rlSntpAuthenticationState=rlSntpAuthenticationState, rlSntpNtpConfigRetryTimeout=rlSntpNtpConfigRetryTimeout, rlSntpBroadcastPolled=rlSntpBroadcastPolled, rlSntpServersDelay=rlSntpServersDelay, rlTimeZoneDataSourceIfIndex=rlTimeZoneDataSourceIfIndex, rlSntpConfigServerTable=rlSntpConfigServerTable, rlTimeSyncMethodMode=rlTimeSyncMethodMode, rlSntpRestoreDefaultServers=rlSntpRestoreDefaultServers, rlDaylightSavingTimeMode=rlDaylightSavingTimeMode, rlTimeZoneName=rlTimeZoneName, rlSntpServerAddress=rlSntpServerAddress, rlSntpBroadcastStratum=rlSntpBroadcastStratum, rlTZDSTOffset=rlTZDSTOffset, rlNtpConfig=rlNtpConfig, rlSntpBroadcastInetDelay=rlSntpBroadcastInetDelay, rlSntpAuthenticationEntry=rlSntpAuthenticationEntry, rlSntpNtpConfigSrvIfIndex=rlSntpNtpConfigSrvIfIndex, rlSntpServerStratum=rlSntpServerStratum, rlSntpAllServerSource=rlSntpAllServerSource, rlTimeValidFlag=rlTimeValidFlag, rlSntpServerInetAddressType=rlSntpServerInetAddressType, rlSntpNtpConfigPrimaryPollSrvMrid=rlSntpNtpConfigPrimaryPollSrvMrid, rlSntpNtpConfigMode=rlSntpNtpConfigMode, rlSntpNtpConfigSrvInetAddress=rlSntpNtpConfigSrvInetAddress, rlSntpServerEntry=rlSntpServerEntry, rlAutomaticClockSetFromPCEnabled=rlAutomaticClockSetFromPCEnabled, rlSntpBroadcastMode=rlSntpBroadcastMode, rlSntpAllServerIfIndex=rlSntpAllServerIfIndex, rlSntpNtpConfigSyncSrvIfIndex=rlSntpNtpConfigSyncSrvIfIndex, rlSntpNtpConfigSyncSrvMrid=rlSntpNtpConfigSyncSrvMrid, rlSntpNtpConfigPollInterval=rlSntpNtpConfigPollInterval, rlDaylightSavingTimeOffset=rlDaylightSavingTimeOffset, rlSntpNtpConfigSyncSrvStratum=rlSntpNtpConfigSyncSrvStratum, NTPSignedTimeValue=NTPSignedTimeValue, rlSntpBroadcastInetAddressType=rlSntpBroadcastInetAddressType, rlTimeSyncMethod=rlTimeSyncMethod, rlSntpAnycastInetAddress=rlSntpAnycastInetAddress, rlSntpAuthenticationRowStatus=rlSntpAuthenticationRowStatus, rlSntpServerLastResp=rlSntpServerLastResp, rlTimeZoneTZDSTOffset=rlTimeZoneTZDSTOffset, RlTimeSyncMethod=RlTimeSyncMethod, rndTimeSyncManagedTime=rndTimeSyncManagedTime, rlSntpAnycastStatus=rlSntpAnycastStatus, rlTimeSyncMibVersion=rlTimeSyncMibVersion, rlSntpConfig=rlSntpConfig, rlSntpAnycastInetLastResp=rlSntpAnycastInetLastResp, rlSntpAnycastAddress=rlSntpAnycastAddress, rlSntpNtpConfigRetryCnt=rlSntpNtpConfigRetryCnt, rlSntpNtpConfigSrvMrid=rlSntpNtpConfigSrvMrid, rlDaylightSavingTimeEnd=rlDaylightSavingTimeEnd, rlSntpConfigAuthenticationTable=rlSntpConfigAuthenticationTable, rlSntpBroadcastInetIfAdminState=rlSntpBroadcastInetIfAdminState, rlSntpConfigServerInetTable=rlSntpConfigServerInetTable, rlSntpBroadcastInetRowStatus=rlSntpBroadcastInetRowStatus, rlSntpAnycastInetStratum=rlSntpAnycastInetStratum, rlSntpBroadcastDelay=rlSntpBroadcastDelay, rlSntpAllServerInetStatus=rlSntpAllServerInetStatus, rlSntpConfigAnycastTable=rlSntpConfigAnycastTable, rlTimeZoneCode=rlTimeZoneCode, rlSntpAnycastInetRowStatus=rlSntpAnycastInetRowStatus, rlSntpServerInetPolled=rlSntpServerInetPolled, rlDaylightSavingTimeCode=rlDaylightSavingTimeCode, rlSntpAllServerInetEntry=rlSntpAllServerInetEntry, rlSntpAllServerInetDelay=rlSntpAllServerInetDelay, rlClockStatus=rlClockStatus, rlSntpAnycastEntry=rlSntpAnycastEntry, rlSntpServerInetEntry=rlSntpServerInetEntry, rlSntpAnycastStratum=rlSntpAnycastStratum, rlSntpServerRowStatus=rlSntpServerRowStatus, rlSntpNtpConfigSysStratum=rlSntpNtpConfigSysStratum, rlSntpAllServerPreference=rlSntpAllServerPreference, rlTimeSynchronization=rlTimeSynchronization, rlSntpNtpConfig=rlSntpNtpConfig, rlSntpServerStatus=rlSntpServerStatus, rlSntpAnycastDelay=rlSntpAnycastDelay, rlSntpBroadcastInetStratum=rlSntpBroadcastInetStratum, rlSntpServerInetKeyIdentifier=rlSntpServerInetKeyIdentifier, rlSntpNtpConfigSrvInetAddressType=rlSntpNtpConfigSrvInetAddressType, rlSntpBroadcastEntry=rlSntpBroadcastEntry, rlSntpBroadcastLastResp=rlSntpBroadcastLastResp, rlTimeZoneDaylightSavingTimeStart=rlTimeZoneDaylightSavingTimeStart, rlSntpBroadcastOffset=rlSntpBroadcastOffset, rlTimeZoneEntry=rlTimeZoneEntry, rlTimeZoneTimeSyncMethod=rlTimeZoneTimeSyncMethod, rlSntpUnicastPollState=rlSntpUnicastPollState, rlSntpAnycastInetAddressType=rlSntpAnycastInetAddressType, rlSntpBroadcastInetIfIndex=rlSntpBroadcastInetIfIndex, rlSntpAuthenticationKeyState=rlSntpAuthenticationKeyState, rlSntpAnycastAdminState=rlSntpAnycastAdminState, rlTimeAndDateHaveBeenSet=rlTimeAndDateHaveBeenSet, rlSntpAnycastLastResp=rlSntpAnycastLastResp, rlSntpNtpConfigSrvStratum=rlSntpNtpConfigSrvStratum, rlSntpAuthenticationKeyID=rlSntpAuthenticationKeyID, rlSntpServerInetAddress=rlSntpServerInetAddress, rlSntpAllServerInetPolled=rlSntpAllServerInetPolled, rlSntpNtpMibVersion=rlSntpNtpMibVersion, rlSntpBroadcastInetAddress=rlSntpBroadcastInetAddress, rlSntpServerInetStratum=rlSntpServerInetStratum, rlTimeZoneDaylightSavingTimeOffset=rlTimeZoneDaylightSavingTimeOffset, rlSntpAnycastInetOffset=rlSntpAnycastInetOffset, rlTimeZoneDataType=rlTimeZoneDataType, rlSntpAnycastRowStatus=rlSntpAnycastRowStatus, rlSntpAnycastInetDelay=rlSntpAnycastInetDelay, rlSntpServerInetStatus=rlSntpServerInetStatus, rlSntpServersKeyIdentifier=rlSntpServersKeyIdentifier, rlSntpAnycastInetIfIndex=rlSntpAnycastInetIfIndex, rlSntpAllServerInetOffset=rlSntpAllServerInetOffset, rlSntpBroadcastStatus=rlSntpBroadcastStatus, rlTimeZoneDataDynamicConfSource=rlTimeZoneDataDynamicConfSource, rlSntpServerInetOffset=rlSntpServerInetOffset, rlSntpNtpConfigPrimaryPollSrvStratum=rlSntpNtpConfigPrimaryPollSrvStratum, RlDaylightSavingTimeMode=RlDaylightSavingTimeMode, rlTimeZoneTimeZoneOffset=rlTimeZoneTimeZoneOffset, rlSntpServersOffset=rlSntpServersOffset, rlSntpBroadcastInetLastResp=rlSntpBroadcastInetLastResp, rlSntpServerInetDelay=rlSntpServerInetDelay, rlSntpNtpConfigPrimaryPollSrvIfIndex=rlSntpNtpConfigPrimaryPollSrvIfIndex, rlSntpAnycastInetEntry=rlSntpAnycastInetEntry, NTPTimeStamp=NTPTimeStamp, NTPStratum=NTPStratum, rlDaylightSavingTimeStart=rlDaylightSavingTimeStart, rlTimeZoneTimeZoneName=rlTimeZoneTimeZoneName, rlSntpAuthenticationKeyValue=rlSntpAuthenticationKeyValue, rlTimeZoneIndex=rlTimeZoneIndex, rlSntpAllServerInetLastResp=rlSntpAllServerInetLastResp, rlSntpBroadcastInetMode=rlSntpBroadcastInetMode, RlSntpNtpSyncEntryType=RlSntpNtpSyncEntryType, rlSntpNtpConfigSrvTable=rlSntpNtpConfigSrvTable, rlTimeZoneDaylightSavingTimeMode=rlTimeZoneDaylightSavingTimeMode, rlSntpBroadcastIfAdminState=rlSntpBroadcastIfAdminState, rlSntpBroadcastPollState=rlSntpBroadcastPollState, rlTimeZoneDaylightSavingTimeCode=rlTimeZoneDaylightSavingTimeCode, rlSntpNtpConfigSrvEntryType=rlSntpNtpConfigSrvEntryType, rlSntpNtpConfigSrvSyncType=rlSntpNtpConfigSrvSyncType, rlSntpNtpConfigSyncSrvAddr=rlSntpNtpConfigSyncSrvAddr, rlSntpNtpConfigSyncSrvType=rlSntpNtpConfigSyncSrvType, rlSntpBroadcastInetEntry=rlSntpBroadcastInetEntry, rlSntpConfigAnycastInetTable=rlSntpConfigAnycastInetTable, rlSntpAllServerInetAddress=rlSntpAllServerInetAddress, rlTimeZoneTimeZoneCode=rlTimeZoneTimeZoneCode, rlSntpAnycastIfIndex=rlSntpAnycastIfIndex, rlSntpNtpConfigPrimaryPollSrvAddr=rlSntpNtpConfigPrimaryPollSrvAddr, rlDhcpTimezoneOptionEnabled=rlDhcpTimezoneOptionEnabled, rlSntpBroadcastRowStatus=rlSntpBroadcastRowStatus, rlSntpAllServerInetKeyIdentifier=rlSntpAllServerInetKeyIdentifier, rlSntpPort=rlSntpPort, rlTimeZoneTable=rlTimeZoneTable, rlSntpBroadcastAddress=rlSntpBroadcastAddress, rlSntpNtpClient=rlSntpNtpClient, rlSntpClientMode=rlSntpClientMode, rlSntpAnycastInetStatus=rlSntpAnycastInetStatus, rndTimeSyncManagedDate=rndTimeSyncManagedDate, rndTimeSyncManagedDateTime=rndTimeSyncManagedDateTime, rlSntpAnycastPollState=rlSntpAnycastPollState, rlSntpAllServerInetTable=rlSntpAllServerInetTable, rlSntpConfigBroadcastInetTable=rlSntpConfigBroadcastInetTable, rlTimeZoneDaylightSavingTimeEnd=rlTimeZoneDaylightSavingTimeEnd, rlSntpBroadcastInetPolled=rlSntpBroadcastInetPolled, rlSntpServerInetRowStatus=rlSntpServerInetRowStatus, rlSntpAllServerInetAddressType=rlSntpAllServerInetAddressType, rlSntpServerPolled=rlSntpServerPolled, rlSntpConfigBroadcastTable=rlSntpConfigBroadcastTable, rlSntpAllServerInetStratum=rlSntpAllServerInetStratum, rlSntpBroadcastInetStatus=rlSntpBroadcastInetStatus, rlTimeZone=rlTimeZone, rlSntpUnicastAdminState=rlSntpUnicastAdminState, PYSNMP_MODULE_ID=rlTimeSynchronization, rlSntpAnycastOffset=rlSntpAnycastOffset, rlSntpBroadcastAdminState=rlSntpBroadcastAdminState, rlSntpServerInetLastResp=rlSntpServerInetLastResp, rlSntpNtpConfigSrvEntry=rlSntpNtpConfigSrvEntry)
