...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/CISCOSB-DOT1X-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:22:23 2019
...
Gauge32, iso, NotificationType, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, ModuleIdentity, Integer32, TimeTicks, MibIdentifier, Bits, Counter32, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "iso", "NotificationType", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "ModuleIdentity", "Integer32", "TimeTicks", "MibIdentifier", "Bits", "Counter32", "Counter64", "IpAddress")
...
if mibBuilder.loadTexts: rldot1x.setOrganization('Cisco Small Business')
if mibBuilder.loadTexts: rldot1x.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
if mibBuilder.loadTexts: rldot1xRadiusAttAclNameEnabled.setDescription('Defines if treat ACL Names that received from Radius attributes in Radius-Accept message.')
...
if mibBuilder.loadTexts: rldot1xRadiusAttrVlanIdentifier.setDescription('In case that value is not 0, This field will define the VLAN ID in case that it is not received from Radius attributes in Radius-Accept message.')
...
if mibBuilder.loadTexts: rldot1xMaxHosts.setDescription('Maximum number of authenticated hosts allowed on the interface. A value of 0 means no limitation.')
...
if mibBuilder.loadTexts: rldot1xMaxLoginAttempts.setDescription('Maximum number of allowedlogin attempts on the interface. A value of 0 means the infinite number of attemtps. The configuration is applied only to Web-Based authentication.')
...
if mibBuilder.loadTexts: rldot1xTimeoutSilencePeriod.setDescription('Set the number of seconds that if an authorized client did not send traffic during this period, then the client is changed to unauthrized. The configuration is applied only to Web-Based authentication.')
...
if mibBuilder.loadTexts: rldot1xSystemAuthControlMonitorVlan.setDescription('VLAN Tag of 802.1x monitoring VLAN in the System. value of 0 means that the monitoring mode is disabled.')
...
if mibBuilder.loadTexts: rldot1xClearPortMibCounters.setDescription('Each bit that is set in this portList represent a port that its mib counters should be reset.')
...
if mibBuilder.loadTexts: rldot1xWebQuietFailureTrapEnabled.setDescription('Specify if sending traps when a client is set in quiet state after the maximum sequential attempts of login.')
...
if mibBuilder.loadTexts: rldot1xMacWebAuthSuccessTrapEnabled.setDescription('Specify if sending traps per authentication method when a session is successfully authenticated.')
...
mibBuilder.exportSymbols("CISCOSB-DOT1X-MIB", rldot1xAuthMultiSessionTime=rldot1xAuthMultiSessionTime, rldot1xBpduFilteringEnabled=rldot1xBpduFilteringEnabled, rldot1xAuthMultiSourceMac=rldot1xAuthMultiSourceMac, rldot1xAuthenticationPortTable=rldot1xAuthenticationPortTable, rldot1xLockedCientsTable=rldot1xLockedCientsTable, rldot1xUnAuthenticatedVlanStatus=rldot1xUnAuthenticatedVlanStatus, rldot1xAuthMultiEapolReqIdFramesTx=rldot1xAuthMultiEapolReqIdFramesTx, rldot1xLockedCientsSourceMac=rldot1xLockedCientsSourceMac, rldot1xUserBasedVlanPorts=rldot1xUserBasedVlanPorts, rldot1xAuthMultiSessionStatsTable=rldot1xAuthMultiSessionStatsTable, rldot1xAuthMultiEapolReqFramesTx=rldot1xAuthMultiEapolReqFramesTx, rldot1xTimeoutSilencePeriod=rldot1xTimeoutSilencePeriod, rldot1xSystemAuthControlMonitorVlan=rldot1xSystemAuthControlMonitorVlan, rldot1xAuthMultiDiagEntry=rldot1xAuthMultiDiagEntry, rldot1xAuthMultiConfigEntry=rldot1xAuthMultiConfigEntry, rldot1xAuthMultiEntersAuthenticating=rldot1xAuthMultiEntersAuthenticating, rldot1xAuthMultiSessionOctetsRx=rldot1xAuthMultiSessionOctetsRx, rldot1xGuestVlanSupported=rldot1xGuestVlanSupported, rldot1xWebQuietFailureTrapEnabled=rldot1xWebQuietFailureTrapEnabled, rldot1xAuthMultiDiagSourceMac=rldot1xAuthMultiDiagSourceMac, rldot1xAuthMultiSessionFramesRx=rldot1xAuthMultiSessionFramesRx, rlDot1xAuthMultiSessionMethodType=rlDot1xAuthMultiSessionMethodType, rldot1xAuthMultiDiagTable=rldot1xAuthMultiDiagTable, rldot1xAuthMultiSessionStatsSourceMac=rldot1xAuthMultiSessionStatsSourceMac, rldot1xAuthMultiAuthEapStartsWhileAuthenticating=rldot1xAuthMultiAuthEapStartsWhileAuthenticating, rldot1xAuthMultiEapolRespIdFramesRx=rldot1xAuthMultiEapolRespIdFramesRx, rlDot1xAuthSessionAuthenticMethod=rlDot1xAuthSessionAuthenticMethod, rldot1xAuthMultiPaeState=rldot1xAuthMultiPaeState, rldot1xRadiusAttAclNameEnabled=rldot1xRadiusAttAclNameEnabled, rldot1xRadiusAttrVlanIdEnabled=rldot1xRadiusAttrVlanIdEnabled, rldot1xAuthMultiBackendOtherRequestsToSupplicant=rldot1xAuthMultiBackendOtherRequestsToSupplicant, rldot1xLegacyPortTable=rldot1xLegacyPortTable, rldot1xAuthMultiSessionRadiusAttrSecondFilterId=rldot1xAuthMultiSessionRadiusAttrSecondFilterId, rldot1xLockedCientsRemainedTime=rldot1xLockedCientsRemainedTime, rldot1xGuestVlanTimeInterval=rldot1xGuestVlanTimeInterval, rldot1xAuthMultiStatsTable=rldot1xAuthMultiStatsTable, rldot1xExtAuthSessionStatsTable=rldot1xExtAuthSessionStatsTable, rldot1xGuestVlanPorts=rldot1xGuestVlanPorts, rldot1xAuthMultiEapolFramesTx=rldot1xAuthMultiEapolFramesTx, rldot1xAuthMultiBackendAuthSuccesses=rldot1xAuthMultiBackendAuthSuccesses, rldot1xAuthMultiEapolStartFramesRx=rldot1xAuthMultiEapolStartFramesRx, rldot1xAuthMultiStatsSourceMac=rldot1xAuthMultiStatsSourceMac, rldot1xTimeBasedActive=rldot1xTimeBasedActive, rldot1xAuthMultiSessionStatsEntry=rldot1xAuthMultiSessionStatsEntry, rldot1xAuthMultiSessionRadiusAttrVlan=rldot1xAuthMultiSessionRadiusAttrVlan, rldot1xLockedCientsPortNumber=rldot1xLockedCientsPortNumber, rldot1xAuthMultiBackendNonNakResponsesFromSupplicant=rldot1xAuthMultiBackendNonNakResponsesFromSupplicant, rldot1xClearPortMibCounters=rldot1xClearPortMibCounters, PYSNMP_MODULE_ID=rldot1x, rldot1xMacWebAuthFailureTrapEnabled=rldot1xMacWebAuthFailureTrapEnabled, rldot1xAuthMultiAuthFailWhileAuthenticating=rldot1xAuthMultiAuthFailWhileAuthenticating, rldot1xAuthMultiStatsPortNumber=rldot1xAuthMultiStatsPortNumber, rldot1xAuthMultiBackendAccessChallenges=rldot1xAuthMultiBackendAccessChallenges, rldot1xAuthMultiAuthSuccessWhileAuthenticating=rldot1xAuthMultiAuthSuccessWhileAuthenticating, rldot1xAuthenticationPortEntry=rldot1xAuthenticationPortEntry, rldot1xAuthMultiEapolLogoffFramesRx=rldot1xAuthMultiEapolLogoffFramesRx, rldot1xUnAuthenticatedVlanEntry=rldot1xUnAuthenticatedVlanEntry, rldot1xAuthMultiSessionUserName=rldot1xAuthMultiSessionUserName, rldot1xAuthMultiAuthEapStartsWhileAuthenticated=rldot1xAuthMultiAuthEapStartsWhileAuthenticated, rldot1xAuthMultiSessionRadiusAttrFilterId=rldot1xAuthMultiSessionRadiusAttrFilterId, rldot1xAuthMultiConfigTable=rldot1xAuthMultiConfigTable, rldot1xAuthMultiStatsEntry=rldot1xAuthMultiStatsEntry, rldot1xAuthMultiAuthReauthsWhileAuthenticated=rldot1xAuthMultiAuthReauthsWhileAuthenticated, rldot1xRadiusAttrVlanIdentifier=rldot1xRadiusAttrVlanIdentifier, rldot1xAuthMultiSessionFramesTx=rldot1xAuthMultiSessionFramesTx, rldot1xAuthMultiSessionId=rldot1xAuthMultiSessionId, rldot1xAuthMultiBackendResponses=rldot1xAuthMultiBackendResponses, rldot1xExtAuthSessionStatsEntry=rldot1xExtAuthSessionStatsEntry, rlDot1xAuthMultiSessionMonitorResultsReason=rlDot1xAuthMultiSessionMonitorResultsReason, rldot1xAuthMultiEapolFramesRx=rldot1xAuthMultiEapolFramesRx, rldot1xGuestVlanVID=rldot1xGuestVlanVID, rldot1xAuthMultiDiagPortNumber=rldot1xAuthMultiDiagPortNumber, rldot1xAuthMultiEntersConnecting=rldot1xAuthMultiEntersConnecting, rldot1xLegacyPortModeEnabled=rldot1xLegacyPortModeEnabled, rldot1xAuthMultiPortNumber=rldot1xAuthMultiPortNumber, rldot1xMaxLoginAttempts=rldot1xMaxLoginAttempts, rldot1xAuthMultiControlledPortStatus=rldot1xAuthMultiControlledPortStatus, rldot1xAuthMultiBackendAuthState=rldot1xAuthMultiBackendAuthState, rldot1xAuthMultiAuthReauthsWhileAuthenticating=rldot1xAuthMultiAuthReauthsWhileAuthenticating, rldot1xUnAuthenticatedVlanSupported=rldot1xUnAuthenticatedVlanSupported, rldot1xLockedCientsEntry=rldot1xLockedCientsEntry, rldot1xMacAuthSuccessTrapEnabled=rldot1xMacAuthSuccessTrapEnabled, rldot1xAuthMultiInvalidEapolFramesRx=rldot1xAuthMultiInvalidEapolFramesRx, rldot1xAuthenticationPortMethod=rldot1xAuthenticationPortMethod, rldot1xAuthMultiEapLengthErrorFramesRx=rldot1xAuthMultiEapLengthErrorFramesRx, rldot1xAuthMultiSessionStatsPortNumber=rldot1xAuthMultiSessionStatsPortNumber, rldot1xMacWebAuthSuccessTrapEnabled=rldot1xMacWebAuthSuccessTrapEnabled, rldot1xTimeBasedName=rldot1xTimeBasedName, rldot1xAuthMultiEapolRespFramesRx=rldot1xAuthMultiEapolRespFramesRx, rldot1x=rldot1x, rldot1xUnAuthenticatedVlanTable=rldot1xUnAuthenticatedVlanTable, rldot1xLockedCientsRowStatus=rldot1xLockedCientsRowStatus, rldot1xNumOfAuthorizedHosts=rldot1xNumOfAuthorizedHosts, rldot1xMibVersion=rldot1xMibVersion, rldot1xUserBasedVlanSupported=rldot1xUserBasedVlanSupported, rldot1xLegacyPortEntry=rldot1xLegacyPortEntry, rldot1xMaxHosts=rldot1xMaxHosts, rldot1xMacAuthFailureTrapEnabled=rldot1xMacAuthFailureTrapEnabled, rldot1xAuthMultiSessionOctetsTx=rldot1xAuthMultiSessionOctetsTx, rldot1xRadiusAttributesErrorsAclReject=rldot1xRadiusAttributesErrorsAclReject)
