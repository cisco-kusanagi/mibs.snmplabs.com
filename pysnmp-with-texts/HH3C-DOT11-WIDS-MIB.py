...
# Produced by pysmi-0.3.4 at Wed May  1 13:26:22 2019
...
Hh3cDot11ChannelScopeType, Hh3cDot11RadioType, Hh3cDot11SSIDStringType, Hh3cDot11RadioScopeType, hh3cDot11, Hh3cDot11ObjectIDType = mibBuilder.importSymbols("HH3C-DOT11-REF-MIB", "Hh3cDot11ChannelScopeType", "Hh3cDot11RadioType", "Hh3cDot11SSIDStringType", "Hh3cDot11RadioScopeType", "hh3cDot11", "Hh3cDot11ObjectIDType")
NotificationGroup, ModuleCompliance = mibBuilder.importSymbols("SNMPv2-CONF", "NotificationGroup", "ModuleCompliance")
NotificationType, Integer32, ModuleIdentity, Gauge32, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, TimeTicks, Bits, IpAddress, Counter64, MibIdentifier, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Integer32", "ModuleIdentity", "Gauge32", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "TimeTicks", "Bits", "IpAddress", "Counter64", "MibIdentifier", "ObjectIdentity", "iso")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: hh3cDot11WIDS.setRevisionsDescriptions(('Modified to add new nodes.', 'Modified to add new nodes.', 'Add new nodes and table to support new featrues of WIDS.', 'Add new nodes to support new featrues of WIDS.', 'To fix bugs in the MIB file.', 'To fix bugs in the MIB file.', 'The initial revision of this MIB module.',))
...
if mibBuilder.loadTexts: hh3cDot11WIDSScanMode.setDescription('Represents the scope of channels to be scanned. The following value are supported all(1) - Do scan on all the channels. auto(2) - Do scan for the channels that automatically selected by WIDS.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSScanChannelList.setDescription('Represents the channel scope to be scanned when hh3cDot11WIDSScanMode is configurated as channelSpec mode. Each channel value will be separated by comma character.')
...
if mibBuilder.loadTexts: hh3cDot11CntMsrMode.setDescription('Represents the countermeasures mode.')
...
if mibBuilder.loadTexts: hh3cDot11DevAgingTime.setDescription('Represents the age time for entries in the detected device table. If an entry is not detected within the interval, it is deleted from the detected device table. If the deleted entry is that of a rogue, it is added into the rogue history table.')
...
if mibBuilder.loadTexts: hh3cDot11DynBlkListEnable.setDescription("Represents whether the dynamic blacklist feature is enabled or not. 'true' : Enable the dynamic blacklist feature to filter out unwanted clients, which will not get associated. 'false' : Disable the dynamic blacklist feature.")
...
if mibBuilder.loadTexts: hh3cDot11DynBlkListLifeTime.setDescription('Represents the lifetime for dynamic blacklist entries. If a dynamic blacklist entry is not detected within the lifetime, the entry will be removed from the dynamic blacklist. The lifetime becomes active only if dynamic blacklist feature is enabled.')
...
if mibBuilder.loadTexts: hh3cDot11FloodAtkDctEnable.setDescription("Represents whether detection of flood attack is enabled or not. 'true' : Enable the detection of flood attack. 'false' : Disable the detection of flood attack.")
...
if mibBuilder.loadTexts: hh3cDot11SpoofAtkDctEnable.setDescription("Represents whether detection of Spoof attack is enabled or not. 'true' : Enable the detection of Spoof attack. 'false' : Disable the detection of Spoof attack.")
...
if mibBuilder.loadTexts: hh3cDot11WeakIVAtkDctEnable.setDescription("Represents whether detection of weak-iv attack is enabled or not. 'true' : Enable the detection of weak-iv attack. 'false' : Disable the detection of weak-iv attack.")
...
if mibBuilder.loadTexts: hh3cDot11ResetWIDSRogueHistory.setDescription('This object is used to clear all entries from the rogue history table. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11ResetWIDSHistroy.setDescription('This object is used to clear the history information of attacks detected in the WLAN system. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11ResetWIDSStatistics.setDescription('This object is used to clear the statistics of attacks detected in the WLAN system. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11ResetAllDynBlkList.setDescription('This object is used to remove all entries from the dynamic blacklist. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11ResetAllStcBlkList.setDescription('This object is used to remove all entries from the static blacklist. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11ResetAllWhtBlkList.setDescription('This object is used to remove all entries from the static whitelist. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11ResetAllDctRogueAP.setDescription('This object is used to clear the information of all detected rogue APs. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11ResetAllDctRogueSta.setDescription('This object is used to clear the information of all detected rogue clients. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11ResetAllDctAdhoc.setDescription('This object is used to clear the information of all detected ad hoc devices. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11ResetAllDctDevice.setDescription('This object is used to clear the information of all detected devices. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11ResetAllDctSSID.setDescription('This object is used to clear the information of all detected SSIDs. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11WidsFloodInterval.setDescription('The interval of WIDS flood detection.')
...
if mibBuilder.loadTexts: hh3cDot11WidsBlackListThreshold.setDescription('When flood attack exceeds the value of this node, the MAC address will be added into black list.')
...
if mibBuilder.loadTexts: hh3cDot11SSIDFilterOnOff.setDescription('Represents whether the SSID permit feature is enabled or not.')
...
if mibBuilder.loadTexts: hh3cDot11BSSIDFilterOnOff.setDescription('Represents whether the BSSID permit feature is enabled or not.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSPermitVendorTable.setDescription('The table provides the permitted vendor list, and each vendor will be identified by OUI. The legal device should be made by the permitted vendors.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSPermitVendorEntry.setDescription('Each entry provides the information of permitted vendor.')
...
if mibBuilder.loadTexts: hh3cDot11VendorOUI.setDescription('Represents the vendor OUI information of the wireless device.')
...
if mibBuilder.loadTexts: hh3cDot11PermitVendorRowStatus.setDescription('The status of this table entry.')
...
if mibBuilder.loadTexts: hh3cDot11VendorName.setDescription('Represents the vendor name of the wireless device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSPermitSSIDTable.setDescription('The table represents the list of SSID could be permitted in the wireless network.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSPermitSSIDEntry.setDescription('Each entry provides the information of permitted SSID.')
...
if mibBuilder.loadTexts: hh3cDot11PermitSSID.setDescription('Represents the permitted SSID in the wireless network.')
...
if mibBuilder.loadTexts: hh3cDot11PermitSSIDRowStatus.setDescription('The status of this table entry.')
...
if mibBuilder.loadTexts: hh3cDot11PermitSSIDDetected.setDescription('Represents whether the permitted SSID is detected or not.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSIgnoreListTable.setDescription('The table provides the MAC address list of stations or APs, and WIDS always take them as legal stations or APs.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSIgnoreListEntry.setDescription('Each entry contains the MAC address of station or AP, and WIDS always take it as legal station or AP.')
...
if mibBuilder.loadTexts: hh3cDot11IgnoreMAC.setDescription('Represents the MAC address of station or AP, and WIDS always take it as legal station or AP.')
...
if mibBuilder.loadTexts: hh3cDot11IgnoreListRowStatus.setDescription('The status of this table entry.')
...
if mibBuilder.loadTexts: hh3cDot11IgnoreMACDetected.setDescription('Represents whether the MAC address detected or not.')
...
if mibBuilder.loadTexts: hh3cDot11IgnoreDevType.setDescription('Represents the type of the MAC address detected. The value of this object always is unknown if the MAC address is not detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAttackListTable.setDescription('The table provides the MAC address list of rogue APs or rogue stations, the WIDS will take countermeasure as per the MAC address list.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAttackListEntry.setDescription('Each entry contains the MAC address of rogue AP or rogue station, and the countermeasure will be taken for it.')
...
if mibBuilder.loadTexts: hh3cDot11AttackDeviceMac.setDescription('Represents the MAC address of rogue AP or rogue station, and the countermeasure will be taken for it.')
...
if mibBuilder.loadTexts: hh3cDot11AttackListRowStatus.setDescription('The status of this table entry.')
...
if mibBuilder.loadTexts: hh3cDot11AttackDevDetected.setDescription('Represents whether the assigned MAC address in attack list is detected or not.')
...
if mibBuilder.loadTexts: hh3cDot11AttackDevType.setDescription('Represents the type of detected MAC address in attack list. If the MAC address is not detected, it will return unknown(5) for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11StaticWhiteListTable.setDescription('The table provides the information of whitelist.')
...
if mibBuilder.loadTexts: hh3cDot11StaticWhiteListEntry.setDescription('Each entry contains the information of whitelist.')
...
if mibBuilder.loadTexts: hh3cDot11StaticWhiteListMAC.setDescription('Represents the MAC addresses in whitelist.')
...
if mibBuilder.loadTexts: hh3cDot11StaticWhiteListRowStatus.setDescription('The status of this table entry.')
...
if mibBuilder.loadTexts: hh3cDot11StaticBlackListTable.setDescription('The table provides the information of static blacklist.')
...
if mibBuilder.loadTexts: hh3cDot11StaticBlackListEntry.setDescription('Each entry contains the information of static blacklist.')
...
if mibBuilder.loadTexts: hh3cDot11StaticBlackListMAC.setDescription('Represents the MAC addresses in static blacklist.')
...
if mibBuilder.loadTexts: hh3cDot11StaticBlackListRowStatus.setDescription('The status of this table entry.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSPermitBSSIDTable.setDescription('The table represents the list of BSSID could be permitted in the wireless network.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSPermitBSSIDEntry.setDescription('Each entry provides the information of permitted BSSID.')
...
if mibBuilder.loadTexts: hh3cDot11PermitBSSID.setDescription('Represents the permitted BSSID in the wireless network.')
...
if mibBuilder.loadTexts: hh3cDot11PermitBSSIDDetected.setDescription('Represents whether the permitted BSSID is detected or not.')
...
if mibBuilder.loadTexts: hh3cDot11PermitBSSIDRowStatus.setDescription('Represents the row status of permit BSSID table.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueAPTable.setDescription('The table represents the list of possible BSS information for rogue APs detected by the WIDS.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueAPEntry.setDescription('Each entry contains possible BSS information of each rogue AP detected by WIDS.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPBSSMAC.setDescription('Represents the BSS MAC address of rogue AP.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPVendorName.setDescription('Represents the vendor name of rogue AP.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPMonitorNum.setDescription('Represents the number of monitor APs which detected the rogue AP.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPFirstDetectTm.setDescription('Represents the time that AP was detected as a rogue AP for the first time.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPLastDetectTm.setDescription('Represents the time that AP was detected as a rogue AP for the last time.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPSSID.setDescription('Represents the SSID broadcasted by rogue AP.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPMaxSigStrength.setDescription('Represents the maximal value of signal strength that WIDS received from the rogue AP.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPChannel.setDescription('Represents on which radio channel of the rogue AP the maximal signal strength was received.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPBeaconInterval.setDescription('Represents the interval for Beacon management frame of rogue AP.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPAttackedStatus.setDescription('Represents whether the countermeasure have taken for the rogue AP.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPEncryptStatus.setDescription('Represents whether the rogue AP encrypt the frame or not.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPReset.setDescription('This object is used to clear information of assigned AP. The information of AP which detect assigned rogue AP will be cleared together. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPFirstDetectTmStr.setDescription('Represents the time that AP was detected as a rogue AP for the first time.')
...
if mibBuilder.loadTexts: hh3cDot11RogueAPLastDetectTmStr.setDescription('Represents the time that AP was detected as a rogue AP for the last time.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueAPExtEntry.setDescription('Each entry contains information of the rogue AP detected by each monitor AP.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAPID.setDescription('To uniquely identify each AP, and relation-ship between hh3cDot11WIDSAPID and AP device will be static.')
...
if mibBuilder.loadTexts: hh3cDot11DetectCurAPSigStrength.setDescription('Represents the current value of signal strength that WIDS monitor AP received from the rogue AP.')
...
if mibBuilder.loadTexts: hh3cDot11DetectAPByChannel.setDescription('Represents on which radio channel that WIDS monitor AP detected the rogue AP.')
...
if mibBuilder.loadTexts: hh3cDot11DetectAPByRadioID.setDescription('Represents on which radio the monitor AP has detected the rogue AP.')
...
if mibBuilder.loadTexts: hh3cDot11AttackAPStatus.setDescription('Represents whether monitor AP have taken countermeasure on the rogue AP.')
...
if mibBuilder.loadTexts: hh3cDot11DetectAPFirstTm.setDescription('Represents the time that monitor AP detected the rogue AP for the first time.')
...
if mibBuilder.loadTexts: hh3cDot11DetectAPLastTm.setDescription('Represents the time that monitor AP detected the rogue AP for the last time.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueStaTable.setDescription('The table represents the list of rogue stations detected by the WIDS.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueStaEntry.setDescription('Each entry contains information of each rogue station.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaMAC.setDescription('Represents the MAC address of rogue station.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaVendorName.setDescription('Represents the vendor name of rogue station.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaMonitorNum.setDescription('Represents the number of monitor APs which detected the rogue station.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaFirstDetectTm.setDescription('Represents the time that station was detected as a rogue station for the first time.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaLastDetectTm.setDescription('Represents the time that station was detected as a rogue station for the last time.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaAccessBSSID.setDescription('Represents BSS MAC address that rogue station try to access.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaMaxSigStrength.setDescription('Represents the maximal value of signal strength that WIDS received from the rogue station.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaChannel.setDescription('Represents on which radio channel the maximal signal strength was received.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaAttackedStatus.setDescription('Represents whether the countermeasure have taken for the rogue station.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaAdHocStatus.setDescription('Represents whether the rogue station work on the Ad Hoc mode or not.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaReset.setDescription('This object is used to clear information of assigned station. The information of AP which detects assigned rogue station will be cleared together. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaFirstDetectTmStr.setDescription('Represents the time that station was detected as a rogue station for the first time.')
...
if mibBuilder.loadTexts: hh3cDot11RogueStaLastDetectTmStr.setDescription('Represents the time that station was detected as a rogue station for the last time.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueStaExtEntry.setDescription('Each entry contains information of rogue station detected by each monitor AP.')
...
if mibBuilder.loadTexts: hh3cDot11DetectCurStaSigStrength.setDescription('Represents the current value of signal strength that WIDS monitor AP received from the rogue station.')
...
if mibBuilder.loadTexts: hh3cDot11DetectStaByChannel.setDescription('Represents on which radio channel the maximal signal strength was received.')
...
if mibBuilder.loadTexts: hh3cDot11DetectStaByRadioID.setDescription('Represents which radio on the monitor AP has detected the rogue station.')
...
if mibBuilder.loadTexts: hh3cDot11AttackStaStatus.setDescription('Represents whether monitor AP have taken countermeasure for the rogue station.')
...
if mibBuilder.loadTexts: hh3cDot11DetectStaFirstTm.setDescription('Represents the time that monitor AP detected the rogue station for the first time.')
...
if mibBuilder.loadTexts: hh3cDot11DetectStaLastTm.setDescription('Represents the time that monitor AP detected the rogue station for the last time.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDetectedDevTable.setDescription('This Table contains information of detected devices.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDetectedDevEntry.setDescription('Each entry contains information of detected devices.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevMAC.setDescription('Represents MAC address of the device detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevType.setDescription('Represents type of the device detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevPermitType.setDescription('Represents whether the device detected is a rogue device or not.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevVendor.setDescription('Represents Vendor of the detected device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevMonitorNum.setDescription('Represents the number of active APs that detect the device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevSSID.setDescription('Represents the service set identifier for the ESS of the device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevBSSID.setDescription('Represents the basic service set identifier of the detected device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevChannel.setDescription('Represents the channel in which the device was last detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevMaxRSSI.setDescription('Represents the maximum detected RSSI of the device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevBeaconIntvl.setDescription('Represents the beacon interval for the detected AP.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevFstDctTime.setDescription('Represents the time at which the device was first detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevLstDctTime.setDescription('Represents the time at which the rogue AP was detected last time.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevReset.setDescription('This object is used to clears the information of the device detected in the WLAN. It will return false for get operation.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDevSnr.setDescription('Represents SNR of the device detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRptAPTable.setDescription('This Table contains information of the AP which detected device in the WLAN.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRptAPEntry.setDescription('Each entry contains information of the AP which detected device in the WLAN.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRptAPMAC.setDescription('Represents the MAC address of the AP that detected the device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRptAPName.setDescription('Represents the name of the AP that detected the device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRptAPRadioID.setDescription('Represents the radio index of the AP that detected the device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRptAPMaxRSSI.setDescription('Represents the maximum detected RSSI of the device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRptAPFstDctTime.setDescription('Represents the time at which the rogue AP was detected first time.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRptAPLstDctTime.setDescription('Represents the time at which the rogue AP was detected last time.')
...
if mibBuilder.loadTexts: hh3cDot11DynBlackListTable.setDescription('This table contains information of dynamic blacklist entries.')
...
if mibBuilder.loadTexts: hh3cDot11DynBlackListEntry.setDescription('Each entry contains information of dynamic blacklist.')
...
if mibBuilder.loadTexts: hh3cDot11DynBlackListMAC.setDescription('Represents the MAC address of the device inserted into the dynamic blacklist.')
...
if mibBuilder.loadTexts: hh3cDot11DynBlackListTime.setDescription('Represents the time elapsed since the entry was last updated.')
...
if mibBuilder.loadTexts: hh3cDot11DynBlackListReason.setDescription('Represents the reason why the entry was added into the dynamic blacklist.')
...
if mibBuilder.loadTexts: hh3cDot11DynBlackListReset.setDescription('This object is used to remove designated entry from the dynamic blacklist. The value which read from this object always is false.')
...
if mibBuilder.loadTexts: hh3cDot11DynBlackListTimeTicks.setDescription('Represents the time elapsed since the entry was last updated in units TimeTicks.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueHistoryTable.setDescription('This table contains information of all expired rogue devices which have been deleted from the list of detected rogue devices because they could not be detected within the device aging duration.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueHistoryEntry.setDescription('Each entry contains information of an expired rogue device which has been deleted from the list of detected rogue devices because they could not be detected within the device aging duration.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueHisIndex.setDescription('Represents index of this entry.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueHisMAC.setDescription('Represents the MAC address of the device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueHisVendor.setDescription('Represents the vendor for the device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueHisType.setDescription('Represents the type of the device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueHisChl.setDescription('Represents the channel in which the device was last detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueHisSSID.setDescription('Represents the service set identifier for the ESS of the device.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueHisLastDctTime.setDescription('Represents the time at which the device was last detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkHistroyTable.setDescription('This table contains information of the history of attacks detected in the WLAN system.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkHistroyEntry.setDescription('Each entry contains information of the history of attacks detected in the WLAN system.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkHisIndex.setDescription('Represents index of this entry.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkHisMAC.setDescription('Represents the Mac address. In case of spoof attacks, this field provides the BSSID which was spoofed. In case of other attacks, this field provides the MAC address of the device which initiated the attack.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkHisType.setDescription('Represents the type of attack.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkHisChl.setDescription('Represents the channel in which the attack was detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkHisRSSI.setDescription('Represents the average RSSI of the designated attack.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkHisDctTime.setDescription('Represents the time at which this attack was detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkHisAPName.setDescription('Represents the name of the AP which detected this attack.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkStasStartTime.setDescription('Represents current attack tracking time. It is started at the system startup and is refreshed each hour subsequently.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkStasTable.setDescription('This table contains information of the counts of attacks detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkStasEntry.setDescription('Each entry contains information of the counts of attacks detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkStasType.setDescription('Represents the type of attack.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkStasCurCnt.setDescription('Represents the count of attacks detected since the time specified by the current attack tracking time. The current attack tracking time is started at the system startup and is refreshed each hour subsequently.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkStasTotalCnt.setDescription('Represents the total count of the attacks detected since the system startup.')
...
if mibBuilder.loadTexts: hh3cDot11BlackListTable.setDescription('This table contains information of blacklist entries, including dynamic and static.')
...
if mibBuilder.loadTexts: hh3cDot11BlackListEntry.setDescription('Each entry contains information of blacklist.')
...
if mibBuilder.loadTexts: hh3cDot11BlackListMAC.setDescription('This object represents the MAC address of the device inserted into the table.')
...
if mibBuilder.loadTexts: hh3cDot11BlackListTime.setDescription('Represents the time elapsed since the entry was last updated. If it is static blacklist, the value is always 0.')
...
if mibBuilder.loadTexts: hh3cDot11BlackListReason.setDescription('Represents the reason why the entry was added into the blacklist.')
...
if mibBuilder.loadTexts: hh3cDot11BlackListRowStatus.setDescription('This object represents the status of this table entry.')
...
if mibBuilder.loadTexts: hh3cDot11BlackListTimeTicks.setDescription('Represents the time elapsed since the entry was last updated in timetick. If it is static blacklist, the value is always 0.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDetectRogueTrap.setDescription('The notification represents that a rogue AP or a station was detected by WIDS. The NMS would refer to MIB table under hh3cDot11WIDSDetectGroup group to get more detailed information.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAdHocTrap.setDescription('The notification represents a rogue Ad hoc station was detected.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSUnauthorSSIDTrap.setDescription('The notification represents which unauthorized SSID are accessed in the network. The notification will be sent to NMS when an unauthorized SSID is detected on the network for the first time.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDisappearRogueTrap.setDescription('The notification represents that a rogue device has aged out and moved to history table or the device type has been changed to friendly. The notification will be sent to NMS whenever a rogue disappears.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDetectAttack.setDescription('This notification occurs when some type of attack is detected. ')
...
if mibBuilder.loadTexts: hh3cDot11WIDSDetectWBridge.setDescription('This notification occurs whenever a detected device is classified as rogue wireless-bridge. ')
...
if mibBuilder.loadTexts: hh3cDot11WIDSFloodTrap.setDescription('This notification occurs when flood attack is detected. ')
...
if mibBuilder.loadTexts: hh3cDot11WIDSSpoofTrap.setDescription('This notification occurs when spoof attack is detected. ')
...
if mibBuilder.loadTexts: hh3cDot11WIDSWeakIVTrap.setDescription('This notification occurs when weak IV attack is detected. ')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueMAC.setDescription('Represents which rogue AP or station.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSRogueType.setDescription('Represents the rogue type. The following value are supported rogueAp(1) - A rogue AP rogueStation(2) - A rogue Station')
...
if mibBuilder.loadTexts: hh3cDot11WIDSMonitorMAC.setDescription('Represents which monitor detected the rogue AP or station.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAdHocMAC.setDescription('Represents the MAC address of Ad hoc station.')
...
if mibBuilder.loadTexts: hh3cDot11UnauthorSSIDName.setDescription('Represents an unauthorized SSID.')
...
if mibBuilder.loadTexts: hh3cDot11MonitorAPID.setDescription("Represents monitor AP's APID.")
...
if mibBuilder.loadTexts: hh3cDot11MonitorApRadioID.setDescription("Represents monitor AP's radio ID")
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkMac.setDescription('Represents mac address of attack source.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkFrameType.setDescription('Represents attack frame type.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkChannel.setDescription('Represents attack channel.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkTime.setDescription('Represents when attacking happened.')
...
if mibBuilder.loadTexts: hh3cDot11WIDSAtkDestMac.setDescription('Represents mac address of attack destination.')
mibBuilder.exportSymbols("HH3C-DOT11-WIDS-MIB", hh3cDot11RogueStaAccessBSSID=hh3cDot11RogueStaAccessBSSID, hh3cDot11WIDSScanChannelList=hh3cDot11WIDSScanChannelList, hh3cDot11DevAgingTime=hh3cDot11DevAgingTime, hh3cDot11WIDSRogueHistoryEntry=hh3cDot11WIDSRogueHistoryEntry, hh3cDot11DynBlackListMAC=hh3cDot11DynBlackListMAC, hh3cDot11BSSIDFilterOnOff=hh3cDot11BSSIDFilterOnOff, hh3cDot11RogueAPSSID=hh3cDot11RogueAPSSID, hh3cDot11RogueStaReset=hh3cDot11RogueStaReset, hh3cDot11DetectCurStaSigStrength=hh3cDot11DetectCurStaSigStrength, hh3cDot11PermitVendorRowStatus=hh3cDot11PermitVendorRowStatus, hh3cDot11WIDSAtkHisAPName=hh3cDot11WIDSAtkHisAPName, hh3cDot11WIDSAtkStasTotalCnt=hh3cDot11WIDSAtkStasTotalCnt, hh3cDot11WIDSAttackListEntry=hh3cDot11WIDSAttackListEntry, hh3cDot11RogueAPFirstDetectTmStr=hh3cDot11RogueAPFirstDetectTmStr, hh3cDot11SSIDFilterOnOff=hh3cDot11SSIDFilterOnOff, hh3cDot11BlackListEntry=hh3cDot11BlackListEntry, hh3cDot11WIDSAtkMac=hh3cDot11WIDSAtkMac, hh3cDot11VendorOUI=hh3cDot11VendorOUI, hh3cDot11StaticWhiteListEntry=hh3cDot11StaticWhiteListEntry, hh3cDot11RogueAPMonitorNum=hh3cDot11RogueAPMonitorNum, hh3cDot11RogueStaLastDetectTm=hh3cDot11RogueStaLastDetectTm, hh3cDot11DynBlackListTable=hh3cDot11DynBlackListTable, hh3cDot11AttackStaStatus=hh3cDot11AttackStaStatus, hh3cDot11IgnoreMAC=hh3cDot11IgnoreMAC, hh3cDot11DetectStaByRadioID=hh3cDot11DetectStaByRadioID, hh3cDot11MonitorApRadioID=hh3cDot11MonitorApRadioID, hh3cDot11RogueAPChannel=hh3cDot11RogueAPChannel, Hh3cDot11WIDSDevPermitType=Hh3cDot11WIDSDevPermitType, hh3cDot11WIDSAtkHisMAC=hh3cDot11WIDSAtkHisMAC, hh3cDot11WIDSPermitVendorTable=hh3cDot11WIDSPermitVendorTable, hh3cDot11WIDSDevReset=hh3cDot11WIDSDevReset, hh3cDot11IgnoreMACDetected=hh3cDot11IgnoreMACDetected, hh3cDot11RogueAPEncryptStatus=hh3cDot11RogueAPEncryptStatus, hh3cDot11RogueStaFirstDetectTm=hh3cDot11RogueStaFirstDetectTm, hh