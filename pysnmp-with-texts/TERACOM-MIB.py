...
# Produced by pysmi-0.3.4 at Wed May  1 15:15:48 2019
...
enterprises, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ObjectIdentity, Bits, Gauge32, TimeTicks, ModuleIdentity, Integer32, snmpModules, IpAddress, Unsigned32, iso, Counter32, MibIdentifier, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "enterprises", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ObjectIdentity", "Bits", "Gauge32", "TimeTicks", "ModuleIdentity", "Integer32", "snmpModules", "IpAddress", "Unsigned32", "iso", "Counter32", "MibIdentifier", "NotificationType")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: snmpMIB.setRevisionsDescriptions(('TCW240bv1.14',))
if mibBuilder.loadTexts: snmpMIB.setLastUpdated('201505270000Z')
if mibBuilder.loadTexts: snmpMIB.setOrganization('TERACOM')
if mibBuilder.loadTexts: snmpMIB.setContactInfo('EMail: info@teracom.cc')
if mibBuilder.loadTexts: snmpMIB.setDescription('The MIB module for TCW240 SNMP entities.')
...
class CONTROLLED(TextualConvention, Integer32):
    description = 'This textual convention enumerates the authentication and privledge protocol for USM configuration. '
    status = 'current'
...
if mibBuilder.loadTexts: name.setDescription('Name of product. e.g. teracom.cc etc.')
...
if mibBuilder.loadTexts: version.setDescription('Version string. e.g. 1.0')
...
if mibBuilder.loadTexts: dateTime.setDescription('Date and time')
...
if mibBuilder.loadTexts: deviceID.setDescription('Device ID is Default MAC Address')
...
if mibBuilder.loadTexts: deviceIP.setDescription('Device IP Address')
...
if mibBuilder.loadTexts: s1description.setDescription('Sensor1 description')
...
if mibBuilder.loadTexts: s11MAXx10Int.setDescription('S11 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s11MINx10Int.setDescription('S11 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s11HYSTx10Int.setDescription('S11 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s12MAXx10Int.setDescription('S12 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s12MINx10Int.setDescription('S12 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s12HYSTx10Int.setDescription('S12 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s2description.setDescription('sensor2 description')
...
if mibBuilder.loadTexts: s21MAXx10Int.setDescription('s21 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s21MINx10Int.setDescription('s21 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s21HYSTx10Int.setDescription('s21 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s22MAXx10Int.setDescription('s22 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s22MINx10Int.setDescription('s22 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s22HYSTx10Int.setDescription('s22 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s3description.setDescription('sensor3 description')
...
if mibBuilder.loadTexts: s31MAXx10Int.setDescription('s31 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s31MINx10Int.setDescription('s31 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s31HYSTx10Int.setDescription('s31 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s32MAXx10Int.setDescription('s32 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s32MINx10Int.setDescription('s32 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s32HYSTx10Int.setDescription('s32 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s4description.setDescription('sensor4 description')
...
if mibBuilder.loadTexts: s41MAXx10Int.setDescription('s41 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s41MINx10Int.setDescription('s41 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s41HYSTx10Int.setDescription('s41 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s42MAXx10Int.setDescription('s42 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s42MINx10Int.setDescription('s42 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s42HYSTx10Int.setDescription('s42 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s5description.setDescription('sensor5 description')
...
if mibBuilder.loadTexts: s51MAXx10Int.setDescription('s51 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s51MINx10Int.setDescription('s51 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s51HYSTx10Int.setDescription('s51 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s52MAXx10Int.setDescription('s52 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s52MINx10Int.setDescription('s52 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s52HYSTx10Int.setDescription('s52 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s6description.setDescription('sensor6 description')
...
if mibBuilder.loadTexts: s61MAXx10Int.setDescription('s61 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s61MINx10Int.setDescription('s61 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s61HYSTx10Int.setDescription('s61 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s62MAXx10Int.setDescription('s62 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s62MINx10Int.setDescription('s62 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s62HYSTx10Int.setDescription('s62 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s7description.setDescription('sensor7 description')
...
if mibBuilder.loadTexts: s71MAXx10Int.setDescription('s71 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s71MINx10Int.setDescription('s71 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s71HYSTx10Int.setDescription('s71 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s72MAXx10Int.setDescription('s72 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s72MINx10Int.setDescription('s72 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s72HYSTx10Int.setDescription('s72 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s8description.setDescription('sensor8 description')
...
if mibBuilder.loadTexts: s81MAXx10Int.setDescription('s81 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s81MINx10Int.setDescription('s81 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s81HYSTx10Int.setDescription('s81 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: s82MAXx10Int.setDescription('s82 maximum value x10 in Integer format')
...
if mibBuilder.loadTexts: s82MINx10Int.setDescription('s82 minimum value x10 in Integer format')
...
if mibBuilder.loadTexts: s82HYSTx10Int.setDescription('s82 hysteresis value x10 in Integer format')
...
if mibBuilder.loadTexts: voltage1description.setDescription('Voltage 1 description')
...
if mibBuilder.loadTexts: voltage1max.setDescription('Voltage 1 maximum')
...
if mibBuilder.loadTexts: voltage1min.setDescription('Voltage 1 minimum')
...
if mibBuilder.loadTexts: voltage1hyst.setDescription('Voltage 1 hysteresis')
...
if mibBuilder.loadTexts: voltage2description.setDescription('Voltage 2 description')
...
if mibBuilder.loadTexts: voltage2max.setDescription('Voltage 2 maximum')
...
if mibBuilder.loadTexts: voltage2min.setDescription('Voltage 2 minimum')
...
if mibBuilder.loadTexts: voltage2hyst.setDescription('Voltage 2 hysteresis')
...
if mibBuilder.loadTexts: voltage3description.setDescription('Voltage 3 description')
...
if mibBuilder.loadTexts: voltage3max.setDescription('Voltage 3 maximum')
...
if mibBuilder.loadTexts: voltage3min.setDescription('Voltage 3 minimum')
...
if mibBuilder.loadTexts: voltage3hyst.setDescription('Voltage 3 hysteresis')
...
if mibBuilder.loadTexts: voltage4description.setDescription('Voltage 4 description')
...
if mibBuilder.loadTexts: voltage4max.setDescription('Voltage 4 maximum')
...
if mibBuilder.loadTexts: voltage4min.setDescription('Voltage 4 minimum')
...
if mibBuilder.loadTexts: voltage4hyst.setDescription('Voltage 4 hysteresis')
...
if mibBuilder.loadTexts: digitalInput1description.setDescription('Digital Input 1 description')
...
if mibBuilder.loadTexts: digitalInput2description.setDescription('Digital Input 2 description')
...
if mibBuilder.loadTexts: digitalInput3description.setDescription('Digital Input 3 description')
...
if mibBuilder.loadTexts: digitalInput4description.setDescription('Digital Input 4 description')
...
if mibBuilder.loadTexts: relay1description.setDescription('Relay 1 description')
...
if mibBuilder.loadTexts: relay1pulseWidth.setDescription('Relay1 Pulse x100ms')
...
if mibBuilder.loadTexts: relay1controlledBy.setDescription('Relay1 control logic')
...
if mibBuilder.loadTexts: relay2description.setDescription('Relay 2 description')
...
if mibBuilder.loadTexts: relay2pulseWidth.setDescription('Relay2 Pulse x100ms')
...
if mibBuilder.loadTexts: relay2controlledBy.setDescription('Relay2 control logic')
...
if mibBuilder.loadTexts: relay3description.setDescription('Relay 3 description')
...
if mibBuilder.loadTexts: relay3pulseWidth.setDescription('Relay3 Pulse x100ms')
...
if mibBuilder.loadTexts: relay3controlledBy.setDescription('Relay3 control logic')
...
if mibBuilder.loadTexts: relay4description.setDescription('Relay 4 description')
...
if mibBuilder.loadTexts: relay4pulseWidth.setDescription('Relay4 Pulse x100ms')
...
if mibBuilder.loadTexts: relay4controlledBy.setDescription('Relay4 control logic')
...
if mibBuilder.loadTexts: s11x10Int.setDescription('S11 value x10 in Integer format')
...
if mibBuilder.loadTexts: s12x10Int.setDescription('S12 value x10 in Integer format')
...
if mibBuilder.loadTexts: s1ID.setDescription('S1 ID value')
...
if mibBuilder.loadTexts: s21x10Int.setDescription('S21 value x10 in Integer format')
...
if mibBuilder.loadTexts: s22x10Int.setDescription('S22 value x10 in Integer format')
...
if mibBuilder.loadTexts: s2ID.setDescription('S2 ID value')
...
if mibBuilder.loadTexts: s31x10Int.setDescription('S31 value x10 in Integer format')
...
if mibBuilder.loadTexts: s32x10Int.setDescription('S32 value x10 in Integer format')
...
if mibBuilder.loadTexts: s3ID.setDescription('S3 ID value')
...
if mibBuilder.loadTexts: s41x10Int.setDescription('S41 value x10 in Integer format')
...
if mibBuilder.loadTexts: s42x10Int.setDescription('S42 value x10 in Integer format')
...
if mibBuilder.loadTexts: s4ID.setDescription('S4 ID value')
...
if mibBuilder.loadTexts: s51x10Int.setDescription('S51 value x10 in Integer format')
...
if mibBuilder.loadTexts: s52x10Int.setDescription('S52 value x10 in Integer format')
...
if mibBuilder.loadTexts: s5ID.setDescription('S5 ID value')
...
if mibBuilder.loadTexts: s61x10Int.setDescription('S61 value x10 in Integer format')
...
if mibBuilder.loadTexts: s62x10Int.setDescription('S62 value x10 in Integer format')
...
if mibBuilder.loadTexts: s6ID.setDescription('S6 ID value')
...
if mibBuilder.loadTexts: s71x10Int.setDescription('S71 value x10 in Integer format')
...
if mibBuilder.loadTexts: s72x10Int.setDescription('S72 value x10 in Integer format')
...
if mibBuilder.loadTexts: s7ID.setDescription('S7 ID value')
...
if mibBuilder.loadTexts: s81x10Int.setDescription('S81 value x10 in Integer format')
...
if mibBuilder.loadTexts: s82x10Int.setDescription('S82 value x10 in Integer format')
...
if mibBuilder.loadTexts: s8ID.setDescription('S8 ID value')
...
if mibBuilder.loadTexts: voltage1x10Int.setDescription('Voltage1 x10 in Integer format')
...
if mibBuilder.loadTexts: voltage2x10Int.setDescription('Voltage2 x10 in Integer format')
...
if mibBuilder.loadTexts: voltage3x10Int.setDescription('Voltage3 x10 in Integer format')
...
if mibBuilder.loadTexts: voltage4x10Int.setDescription('Voltage4 x10 in Integer format')
...
if mibBuilder.loadTexts: voltage1x100Int.setDescription('Voltage1 x100 in Integer format')
...
if mibBuilder.loadTexts: voltage2x100Int.setDescription('Voltage2 x100 in Integer format')
...
if mibBuilder.loadTexts: voltage3x100Int.setDescription('Voltage3 x100 in Integer format')
...
if mibBuilder.loadTexts: voltage4x100Int.setDescription('Voltage4 x100 in Integer format')
...
if mibBuilder.loadTexts: digitalInput1State.setDescription('Digital1 Input State')
...
if mibBuilder.loadTexts: digitalInput2State.setDescription('Digital2 Input State')
...
if mibBuilder.loadTexts: digitalInput3State.setDescription('Digital3 Input State')
...
if mibBuilder.loadTexts: digitalInput4State.setDescription('Digital4 Input State')
...
if mibBuilder.loadTexts: relay1State.setDescription('Relay1 State')
...
if mibBuilder.loadTexts: relay1Pulse.setDescription('Relay1 Pulse')
...
if mibBuilder.loadTexts: relay2State.setDescription('Relay2 State')
...
if mibBuilder.loadTexts: relay2Pulse.setDescription('Relay2 Pulse')
...
if mibBuilder.loadTexts: relay3State.setDescription('Relay3 State')
...
if mibBuilder.loadTexts: relay3Pulse.setDescription('Relay3 Pulse')
...
if mibBuilder.loadTexts: relay4State.setDescription('Relay4 State')
...
if mibBuilder.loadTexts: relay4Pulse.setDescription('Relay4 Pulse')
...
if mibBuilder.loadTexts: configurationSaved.setDescription('Configuration save status SAVED/UNSAVED')
...
if mibBuilder.loadTexts: restartDevice.setDescription('Restart Device')
...
if mibBuilder.loadTexts: temperatureUnit.setDescription('Unit of the all temperature values')
...
if mibBuilder.loadTexts: hardwareErr.setDescription('Hardware Error')
...
if mibBuilder.loadTexts: snmp_trap_notification.setDescription('SMIV2 Trap notification information for the SNMP Manager.')
...
if mibBuilder.loadTexts: tcw240bMIBCompliances1.setDescription('This group is for SNMP applications.')
...
if mibBuilder.loadTexts: tcw240bProductGroup.setDescription('A collection of objects providing basic product info.')
...
if mibBuilder.loadTexts: tcw240bSetupGroup.setDescription('A collection of objects providing basic setup.')
...
if mibBuilder.loadTexts: tcw240bMonitorGroup.setDescription('A collection of objects providing basic monitoring and control of a product.')
...
if mibBuilder.loadTexts: tcw240bTrapGroup.setDescription('SNMP Trap Notification object.')
mibBuilder.exportSymbols("TERACOM-MIB", s52HYSTx10Int=s52HYSTx10Int, s21MAXx10Int=s21MAXx10Int, analog=analog, sensor5setup=sensor5setup, relay2controlledBy=relay2controlledBy, relay2=relay2, s12HYSTx10Int=s12HYSTx10Int, s32MINx10Int=s32MINx10Int, voltage4hyst=voltage4hyst, relay3description=relay3description, s41HYSTx10Int=s41HYSTx10Int, s31x10Int=s31x10Int, s41MAXx10Int=s41MAXx10Int, sensor41setup=sensor41setup, voltage2min=voltage2min, sensor52setup=sensor52setup, CONTROLLED=CONTROLLED, sensor2setup=sensor2setup, analog2setup=analog2setup, voltage4description=voltage4description, s22MAXx10Int=s22MAXx10Int, voltage1min=voltage1min, version=version, s22x10Int=s22x10Int, relay4setup=relay4setup, s82x10Int=s82x10Int, voltage1hyst=voltage1hyst, sensor4=sensor4, sensor1setup=sensor1setup, s82HYSTx10Int=s82HYSTx10Int, tcw240bMIBCompliances=tcw240bMIBCompliances, s51MINx10Int=s51MINx10Int, voltage4x100Int=voltage4x100Int, sensor6=sensor6, setup=setup, relay1=relay1, restartDevice=restartDevice, voltage2x100Int=voltage2x100Int, network=network, snmpMIB=snmpMIB, s8description=s8description, s72HYSTx10Int=s72HYSTx10Int, digitalInput2description=digitalInput2description, relay2description=relay2description, s62MINx10Int=s62MINx10Int, voltage3x10Int=voltage3x10Int, digitalInput4description=digitalInput4description, relay3Pulse=relay3Pulse, tcw240bMIBCompliances1=tcw240bMIBCompliances1, digitalInput3State=digitalInput3State, trapNotifications=trapNotifications, sensor82setup=sensor82setup, relay1pulseWidth=relay1pulseWidth, sensor51setup=sensor51setup, tcw240b=tcw240b, s81MINx10Int=s81MINx10Int, s62MAXx10Int=s62MAXx10Int, s81HYSTx10Int=s81HYSTx10Int, sensor1=sensor1, digitalInput3description=digitalInput3description, s72MINx10Int=s72MINx10Int, digitalInput2State=digitalInput2State, voltage3max=voltage3max, s21x10Int=s21x10Int, sensor4setup=sensor4setup, s21HYSTx10Int=s21HYSTx10Int, s31HYSTx10Int=s31HYSTx10Int, s4description=s4description, s12MAXx10Int=s12MAXx10Int, voltage2hyst=voltage2hyst, voltage3min=voltage3min, s61MINx10Int=s61MINx10Int, s71MAXx10Int=s71MAXx10Int, voltage2x10Int=voltage2x10Int, s12MINx10Int=s12MINx10Int, sensor3setup=sensor3setup, voltage4min=voltage4min, relay1description=relay1description, voltage1x100Int=voltage1x100Int, s52MINx10Int=s52MINx10Int, s71MINx10Int=s71MINx10Int, sensor7setup=sensor7setup, s82MAXx10Int=s82MAXx10Int, sensor31setup=sensor31setup, relay4description=relay4description, s71x10Int=s71x10Int, digitalInput1description=digitalInput1description, sensor71setup=sensor71setup, relay3setup=relay3setup, sensor61setup=sensor61setup, s62x10Int=s62x10Int, deviceIP=deviceIP, analog1setup=analog1setup, sensor7=sensor7, teracom=teracom, relay3State=relay3State, sensor72setup=sensor72setup, s62HYSTx10Int=s62HYSTx10Int, s11MINx10Int=s11MINx10Int, sensor32setup=sensor32setup, s41x10Int=s41x10Int, io=io, name=name, relay2Pulse=relay2Pulse, relay1controlledBy=relay1controlledBy, s7description=s7description, s11HYSTx10Int=s11HYSTx10Int, sensor11setup=sensor11setup, voltage4max=voltage4max, relay1State=relay1State, monitorNcontrol=monitorNcontrol, s5ID=s5ID, s3ID=s3ID, s42HYSTx10Int=s42HYSTx10Int, s71HYSTx10Int=s71HYSTx10Int, s41MINx10Int=s41MINx10Int, s6ID=s6ID, sensor6setup=sensor6setup, sensor81setup=sensor81setup, s42MINx10Int=s42MINx10Int, s51x10Int=s51x10Int, s12x10Int=s12x10Int, relay2setup=relay2setup, s81MAXx10Int=s81MAXx10Int, s52MAXx10Int=s52MAXx10Int, relaysSetup=relaysSetup, voltage1x10Int=voltage1x10Int, relays=relays, relay3controlledBy=relay3controlledBy, s32MAXx10Int=s32MAXx10Int, sensor21setup=sensor21setup, digitalInput4State=digitalInput4State, tcw240bMonitorGroup=tcw240bMonitorGroup, s11x10Int=s11x10Int, s32x10Int=s32x10Int, temperatureUnit=temperatureUnit, analog3setup=analog3setup, configurationSaved=configurationSaved, tcw240bMIBConformance=tcw240bMIBConformance, PYSNMP_MODULE_ID=snmpMIB, s6description=s6description, hardwareErr=hardwareErr, s51HYSTx10Int=s51HYSTx10Int, s5description=s5description, s81x10Int=s81x10Int, s51MAXx10Int=s51MAXx10Int, s8ID=s8ID, s61MAXx10Int=s61MAXx10Int, sensorsSetup=sensorsSetup, s22HYSTx10Int=s22HYSTx10Int, s1description=s1description, snmp_trap_notification=snmp_trap_notification, s61x10Int=s61x10Int, dateTime=dateTime, s42x10Int=s42x10Int, relay3=relay3, relay2pulseWidth=relay2pulseWidth, s61HYSTx10Int=s61HYSTx10Int, s7ID=s7ID, s31MINx10Int=s31MINx10Int, voltage3hyst=voltage3hyst, s4ID=s4ID, tcw240bProductGroup=tcw240bProductGroup, sensor42setup=sensor42setup, s1ID=s1ID, relay4pulseWidth=relay4pulseWidth, relay4Pulse=relay4Pulse, relay4=relay4, voltage3description=voltage3description, sensor3=sensor3, s11MAXx10Int=s11MAXx10Int, voltage1description=voltage1description, product=product, deviceID=deviceID, s22MINx10Int=s22MINx10Int, s3description=s3description, voltage1max=voltage1max, tcw240bSetupGroup=tcw240bSetupGroup, digitalSetup=digitalSetup, s72MAXx10Int=s72MAXx10Int, sensor12setup=sensor12setup, s72x10Int=s72x10Int, s2ID=s2ID, relay2State=relay2State, sensor62setup=sensor62setup, s42MAXx10Int=s42MAXx10Int, sensor8setup=sensor8setup, voltage3x100Int=voltage3x100Int, relay3pulseWidth=relay3pulseWidth, relay1Pulse=relay1Pulse, hostName=hostName, relay4State=relay4State, sensor22setup=sensor22setup, sensor2=sensor2, s52x10Int=s52x10Int, relay1setup=relay1setup, s31MAXx10Int=s31MAXx10Int, analogSetup=analogSetup, s82MINx10Int=s82MINx10Int, tcw240bTrapGroup=tcw240bTrapGroup, sensors=sensors, analog4setup=analog4setup, digitalInput1State=digitalInput1State, tcw240bMIBGroups=tcw240bMIBGroups, sensor5=sensor5, s32HYSTx10Int=s32HYSTx10Int, s2description=s2description, s21MINx10Int=s21MINx10Int, digital=digital, voltage2description=voltage2description, voltage2max=voltage2max, relay4controlledBy=relay4controlledBy, voltage4x10Int=voltage4x10Int, sensor8=sensor8)
