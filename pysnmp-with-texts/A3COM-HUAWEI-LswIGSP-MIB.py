...
# Produced by pysmi-0.3.4 at Wed May  1 11:05:47 2019
...
MibIdentifier, Counter64, ModuleIdentity, Bits, iso, Counter32, ObjectIdentity, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, IpAddress, NotificationType, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibIdentifier", "Counter64", "ModuleIdentity", "Bits", "iso", "Counter32", "ObjectIdentity", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "IpAddress", "NotificationType", "Gauge32", "Unsigned32")
...
mibBuilder.exportSymbols("A3COM-HUAWEI-LswIGSP-MIB", hwIgmpSnoopingGroupLimitNumber=hwIgmpSnoopingGroupLimitNumber, hwIgmpSnoopingFastLeaveIfIndex=hwIgmpSnoopingFastLeaveIfIndex, hwIgmpSnoopingVlanID=hwIgmpSnoopingVlanID, hwRecvErrorIGMPPacketNum=hwRecvErrorIGMPPacketNum, hwRecvIGMPV2ReportNum=hwRecvIGMPV2ReportNum, hwIgmpSnoopingResponseTime=hwIgmpSnoopingResponseTime, hwRecvIGMPV1ReportNum=hwRecvIGMPV1ReportNum, hwIgmpSnoopingNonFloodingStatus=hwIgmpSnoopingNonFloodingStatus, hwIgmpSnoopingRouterPortAge=hwIgmpSnoopingRouterPortAge, hwIgmpSnoopingGroupPolicyStatus=hwIgmpSnoopingGroupPolicyStatus, hwRecvIGMPLeaveNum=hwRecvIGMPLeaveNum, hwIgmpSnoopingGroupPolicyParameter=hwIgmpSnoopingGroupPolicyParameter, hwIgmpSnoopingGroupPolicyTable=hwIgmpSnoopingGroupPolicyTable, hwIgmpSnoopingVlanEnabled=hwIgmpSnoopingVlanEnabled, hwIgmpSnoopingStatsObjects=hwIgmpSnoopingStatsObjects, hwIgmpSnoopingHostTime=hwIgmpSnoopingHostTime, hwIgmpSnoopingFastLeaveTable=hwIgmpSnoopingFastLeaveTable, hwIgmpSnoopingGroupPolicyVlanID=hwIgmpSnoopingGroupPolicyVlanID, hwIgmpSnoopingGroupPolicyEntry=hwIgmpSnoopingGroupPolicyEntry, hwIgmpSnoopingGroupLimitEntry=hwIgmpSnoopingGroupLimitEntry, hwIgmpSnoopingGroupPolicyIfIndex=hwIgmpSnoopingGroupPolicyIfIndex, hwIgmpSnoopingVlanStatusTable=hwIgmpSnoopingVlanStatusTable, hwIgmpSnoopingFastLeaveStatus=hwIgmpSnoopingFastLeaveStatus, hwLswIgmpsnoopingMibObject=hwLswIgmpsnoopingMibObject, EnabledStatus=EnabledStatus, hwIgmpSnoopingFastLeaveEntry=hwIgmpSnoopingFastLeaveEntry, hwSentIGMPSQueryNum=hwSentIGMPSQueryNum, hwRecvIGMPSQueryNum=hwRecvIGMPSQueryNum, hwIgmpSnoopingStatus=hwIgmpSnoopingStatus, PYSNMP_MODULE_ID=hwLswIgmpsnoopingMib, hwLswIgmpsnoopingMib=hwLswIgmpsnoopingMib, hwIgmpSnoopingClearStats=hwIgmpSnoopingClearStats, hwRecvIGMPGQueryNum=hwRecvIGMPGQueryNum, hwIgmpSnoopingGroupLimitTable=hwIgmpSnoopingGroupLimitTable, hwIgmpSnoopingGroupIfIndex=hwIgmpSnoopingGroupIfIndex, hwIgmpSnoopingVlanStatusEntry=hwIgmpSnoopingVlanStatusEntry)
