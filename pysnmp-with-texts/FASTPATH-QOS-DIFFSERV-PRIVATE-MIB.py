...
# Produced by pysmi-0.3.4 at Wed May  1 13:12:33 2019
...
NotificationType, Counter64, Gauge32, TimeTicks, Bits, ObjectIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, IpAddress, ModuleIdentity, Integer32, Counter32, Unsigned32, iso = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Gauge32", "TimeTicks", "Bits", "ObjectIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "IpAddress", "ModuleIdentity", "Integer32", "Counter32", "Unsigned32", "iso")
DisplayString, TruthValue, RowStatus, MacAddress, TextualConvention, RowPointer, PhysAddress, StorageType = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "TruthValue", "RowStatus", "MacAddress", "TextualConvention", "RowPointer", "PhysAddress", "StorageType")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: fastPathQOSDiffServPrivate.setRevisionsDescriptions(('Deprecated outbound policy instance performance counters, added new ones.', 'Netgear branding related changes.', 'Added mirror policy attribute.', 'DiffServ enhancements for Netgear 7.3.0.', 'Revisions made for new release.',))
...
if mibBuilder.loadTexts: fastPathQOSDiffServPrivate.setDescription('The Netgear Private MIB for FASTPATH DiffServ')
...
mibBuilder.exportSymbols("FASTPATH-QOS-DIFFSERV-PRIVATE-MIB", agentDiffServPolicyPerfOutShapeDelayedOctets=agentDiffServPolicyPerfOutShapeDelayedOctets, agentDiffServServiceIfDirection=agentDiffServServiceIfDirection, agentDiffServPolicyPerfOutRandomDroppedOctets=agentDiffServPolicyPerfOutRandomDroppedOctets, agentDiffServPolicyAttrStmtExpediteCrateUnits=agentDiffServPolicyAttrStmtExpediteCrateUnits, agentDiffServPolicyPerfOutHCDiscardedOctets=agentDiffServPolicyPerfOutHCDiscardedOctets, agentDiffServPolicyAttrStmtBandwidthCrateUnits=agentDiffServPolicyAttrStmtBandwidthCrateUnits, agentDiffServClassProtoType=agentDiffServClassProtoType, agentDiffServPolicyAttrStmtPoliceSimpleCburst=agentDiffServPolicyAttrStmtPoliceSimpleCburst, agentDiffServPolicyPerfOutHCSentOctets=agentDiffServPolicyPerfOutHCSentOctets, agentDiffServServicePerfHCSentPackets=agentDiffServServicePerfHCSentPackets, agentDiffServPolicyAttrStmtPoliceColorExceedVal=agentDiffServPolicyAttrStmtPoliceColorExceedVal, agentDiffServPolicyAttrStmtMarkCosAsSecCos=agentDiffServPolicyAttrStmtMarkCosAsSecCos, agentDiffServServicePerfTable=agentDiffServServicePerfTable, agentDiffServServiceIfIndex=agentDiffServServiceIfIndex, agentDiffServPolicyAttrStmtShapePeakCrate=agentDiffServPolicyAttrStmtShapePeakCrate, IntfDirection=IntfDirection, agentDiffServClassRuleMatchFlowLabel=agentDiffServClassRuleMatchFlowLabel, agentDiffServPolicyAttrStmtExpediteCburst=agentDiffServPolicyAttrStmtExpediteCburst, agentDiffServPolicyPerfOutRowStatus=agentDiffServPolicyPerfOutRowStatus, agentDiffServClassRuleMatchSrcMacAddr=agentDiffServClassRuleMatchSrcMacAddr, agentDiffServServicePolicyIndex=agentDiffServServicePolicyIndex, agentDiffServClassRuleMatchCos2=agentDiffServClassRuleMatchCos2, agentDiffServClassRuleMatchDstIpMask=agentDiffServClassRuleMatchDstIpMask, agentDiffServClassRuleMatchEtypeValue=agentDiffServClassRuleMatchEtypeValue, agentDiffServGenStatusPolicyInstTableMax=agentDiffServGenStatusPolicyInstTableMax, agentDiffServPolicyPerfOutOfferedPackets=agentDiffServPolicyPerfOutOfferedPackets, agentDiffServClassRuleMatchDstIpv6Prefix=agentDiffServClassRuleMatchDstIpv6Prefix, agentDiffServPolicyPerfOutHCOfferedOctets=agentDiffServPolicyPerfOutHCOfferedOctets, agentDiffServClassRuleMatchSrcIpv6PrefixLength=agentDiffServClassRuleMatchSrcIpv6PrefixLength, agentDiffServClassIndex=agentDiffServClassIndex, agentDiffServServicePerfHCDiscardedOctets=agentDiffServServicePerfHCDiscardedOctets, agentDiffServGenStatusClassTableSize=agentDiffServGenStatusClassTableSize, agentDiffServPolicyAttrStmtRandomdropMaxDropProb=agentDiffServPolicyAttrStmtRandomdropMaxDropProb, agentDiffServServiceTable=agentDiffServServiceTable, agentDiffServServicePerfHCOfferedPackets=agentDiffServServicePerfHCOfferedPackets, agentDiffServPolicyPerfInDiscardedPackets=agentDiffServPolicyPerfInDiscardedPackets, agentDiffServPolicyAttrStmtRedirectIntf=agentDiffServPolicyAttrStmtRedirectIntf, agentDiffServPolicyAttrStmtPoliceColorConformIndex=agentDiffServPolicyAttrStmtPoliceColorConformIndex, agentDiffServPolicyPerfOutHCRandomDroppedOctets=agentDiffServPolicyPerfOutHCRandomDroppedOctets, agentDiffServGenStatusClassRuleTableSize=agentDiffServGenStatusClassRuleTableSize, agentDiffServPolicyAttrStmtBandwidthCrate=agentDiffServPolicyAttrStmtBandwidthCrate, agentDiffServPolicyInstIndexNextFree=agentDiffServPolicyInstIndexNextFree, agentDiffServServicePerfHCSentOctets=agentDiffServServicePerfHCSentOctets, agentDiffServPolicyAttrStmtMarkIpDscpVal=agentDiffServPolicyAttrStmtMarkIpDscpVal, agentDiffServPolicyAttrEntry=agentDiffServPolicyAttrEntry, agentDiffServPolicyInstTable=agentDiffServPolicyInstTable, agentDiffServPolicyInstEntry=agentDiffServPolicyInstEntry, agentDiffServGenStatusPolicyAttrTableMax=agentDiffServGenStatusPolicyAttrTableMax, agentDiffServPolicyIndexNextFree=agentDiffServPolicyIndexNextFree, agentDiffServPolicyTable=agentDiffServPolicyTable, agentDiffServPolicyEntry=agentDiffServPolicyEntry, agentDiffServPolicyAttrStmtPoliceTworatePburst=agentDiffServPolicyAttrStmtPoliceTworatePburst, agentDiffServServicePerfOfferedOctets=agentDiffServServicePerfOfferedOctets, agentDiffServPolicyPerfInEntry=agentDiffServPolicyPerfInEntry, agentDiffServClassRuleMatchDstMacMask=agentDiffServClassRuleMatchDstMacMask, agentDiffServClassRuleMatchVlanIdEnd=agentDiffServClassRuleMatchVlanIdEnd, agentDiffServPolicyAttrStmtPoliceTworateCburst=agentDiffServPolicyAttrStmtPoliceTworateCburst, agentDiffServClassRuleStorageType=agentDiffServClassRuleStorageType, agentDiffServClassGroup=agentDiffServClassGroup, agentDiffServPolicyInstAttrIndexNextFree=agentDiffServPolicyInstAttrIndexNextFree, EtypeValue=EtypeValue, agentDiffServGenStatusPolicyTableMax=agentDiffServGenStatusPolicyTableMax, agentDiffServClassRuleMatchVlanId=agentDiffServClassRuleMatchVlanId, agentDiffServClassAclNum=agentDiffServClassAclNum, agentDiffServPolicyInstIndex=agentDiffServPolicyInstIndex, agentDiffServPolicyPerfInOfferedOctets=agentDiffServPolicyPerfInOfferedOctets, agentDiffServClassType=agentDiffServClassType, agentDiffServClassRowStatus=agentDiffServClassRowStatus, agentDiffServPolicyAttrStmtAssignQueueId=agentDiffServPolicyAttrStmtAssignQueueId, agentDiffServPolicyPerfInRowStatus=agentDiffServPolicyPerfInRowStatus, agentDiffServClassRuleMatchSrcIpAddr=agentDiffServClassRuleMatchSrcIpAddr, agentDiffServPolicyPerfOutHCTailDroppedPackets=agentDiffServPolicyPerfOutHCTailDroppedPackets, agentDiffServPolicyPerfOutHCShapeDelayedOctets=agentDiffServPolicyPerfOutHCShapeDelayedOctets, agentDiffServPolicyAttrStmtPoliceSinglerateCburst=agentDiffServPolicyAttrStmtPoliceSinglerateCburst, agentDiffServPolicyAttrStmtShapePeakPrate=agentDiffServPolicyAttrStmtShapePeakPrate, agentDiffServPolicyAttrStmtPoliceColorExceedIndex=agentDiffServPolicyAttrStmtPoliceColorExceedIndex, agentDiffServClassRuleMatchDstIpAddr=agentDiffServClassRuleMatchDstIpAddr, agentDiffServClassRuleMatchDstL4PortEnd=agentDiffServClassRuleMatchDstL4PortEnd, agentDiffServPolicyType=agentDiffServPolicyType, agentDiffServClassStorageType=agentDiffServClassStorageType, agentDiffServServiceGroup=agentDiffServServiceGroup, agentDiffServClassRuleMatchSrcIpv6Prefix=agentDiffServClassRuleMatchSrcIpv6Prefix, agentDiffServPolicyAttrStmtRandomdropSamplingRate=agentDiffServPolicyAttrStmtRandomdropSamplingRate, agentDiffServPolicyPerfInTable=agentDiffServPolicyPerfInTable, agentDiffServPolicyPerfOutHCTailDroppedOctets=agentDiffServPolicyPerfOutHCTailDroppedOctets, agentDiffServClassRuleRowStatus=agentDiffServClassRuleRowStatus, agentDiffServClassRuleMatchSrcL4PortStart=agentDiffServClassRuleMatchSrcL4PortStart, agentDiffServPolicyAttrStmtPoliceConformVal=agentDiffServPolicyAttrStmtPoliceConformVal, agentDiffServClassRuleMatchIpDscp=agentDiffServClassRuleMatchIpDscp, agentDiffServPolicyName=agentDiffServPolicyName, agentDiffServClassEntry=agentDiffServClassEntry, agentDiffServPolicyInstRowStatus=agentDiffServPolicyInstRowStatus, agentDiffServPolicyPerfOutDiscardedOctets=agentDiffServPolicyPerfOutDiscardedOctets, agentDiffServGenStatusServiceTableMax=agentDiffServGenStatusServiceTableMax, agentDiffServClassRuleMatchEntryType=agentDiffServClassRuleMatchEntryType, PYSNMP_MODULE_ID=fastPathQOSDiffServPrivate, agentDiffServClassRuleMatchDstMacAddr=agentDiffServClassRuleMatchDstMacAddr, agentDiffServClassRuleMatchExcludeFlag=agentDiffServClassRuleMatchExcludeFlag, agentDiffServPolicyAttrStmtPoliceColorConformMode=agentDiffServPolicyAttrStmtPoliceColorConformMode, agentDiffServPolicyPerfInHCOfferedPackets=agentDiffServPolicyPerfInHCOfferedPackets, agentDiffServPolicyAttrStmtPoliceSimpleCrate=agentDiffServPolicyAttrStmtPoliceSimpleCrate, agentDiffServPolicyPerfOutShapeDelayedPackets=agentDiffServPolicyPerfOutShapeDelayedPackets, agentDiffServServicePerfOfferedPackets=agentDiffServServicePerfOfferedPackets, agentDiffServPolicyAttrStmtPoliceColorExceedMode=agentDiffServPolicyAttrStmtPoliceColorExceedMode, agentDiffServPolicyPerfOutStorageType=agentDiffServPolicyPerfOutStorageType, agentDiffServPolicyAttrStmtRandomdropDecayExponent=agentDiffServPolicyAttrStmtRandomdropDecayExponent, agentDiffServPolicyPerfOutRandomDroppedPackets=agentDiffServPolicyPerfOutRandomDroppedPackets, agentDiffServPolicyInstStorageType=agentDiffServPolicyInstStorageType, agentDiffServClassRuleMatchIpPrecedence=agentDiffServClassRuleMatchIpPrecedence, agentDiffServGenStatusClassTableMax=agentDiffServGenStatusClassTableMax, agentDiffServGenStatusGroup=agentDiffServGenStatusGroup, agentDiffServClassRuleTable=agentDiffServClassRuleTable, agentDiffServServiceEntry=agentDiffServServiceEntry, agentDiffServPolicyPerfInOfferedPackets=agentDiffServPolicyPerfInOfferedPackets, agentDiffServGenStatusAdminMode=agentDiffServGenStatusAdminMode, agentDiffServClassRuleMatchProtocolNum=agentDiffServClassRuleMatchProtocolNum, agentDiffServPolicyAttrStmtPoliceNonconformAct=agentDiffServPolicyAttrStmtPoliceNonconformAct, agentDiffServPolicyPerfInHCDiscardedPackets=agentDiffServPolicyPerfInHCDiscardedPackets, agentDiffServClassRuleIndexNextFree=agentDiffServClassRuleIndexNextFree, fastPathQOSDiffServPrivate=fastPathQOSDiffServPrivate, agentDiffServClassRuleMatchVlanId2Start=agentDiffServClassRuleMatchVlanId2Start, agentDiffServGenStatusServiceTableSize=agentDiffServGenStatusServiceTableSize, agentDiffServPolicyPerfOutHCSentPackets=agentDiffServPolicyPerfOutHCSentPackets, agentDiffServPolicyAttrStorageType=agentDiffServPolicyAttrStorageType, agentDiffServPolicyAttrStmtPoliceExceedVal=agentDiffServPolicyAttrStmtPoliceExceedVal, agentDiffServServicePerfHCDiscardedPackets=agentDiffServServicePerfHCDiscardedPackets, agentDiffServPolicyAttrStmtMarkCosVal=agentDiffServPolicyAttrStmtMarkCosVal, agentDiffServPolicyAttrStmtPoliceConformAct=agentDiffServPolicyAttrStmtPoliceConformAct, agentDiffServClassRuleMatchEvery=agentDiffServClassRuleMatchEvery, agentDiffServPolicyPerfInDiscardedOctets=agentDiffServPolicyPerfInDiscardedOctets, agentDiffServPolicyPerfInHCDiscardedOctets=agentDiffServPolicyPerfInHCDiscardedOctets, agentDiffServClassRuleEntry=agentDiffServClassRuleEntry, agentDiffServPolicyGroup=agentDiffServPolicyGroup, agentDiffServPolicyAttrIndex=agentDiffServPolicyAttrIndex, agentDiffServPolicyPerfOutHCDiscardedPackets=agentDiffServPolicyPerfOutHCDiscardedPackets, agentDiffServServicePerfDiscardedOctets=agentDiffServServicePerfDiscardedOctets, agentDiffServClassName=agentDiffServClassName, agentDiffServPolicyPerfOutTailDroppedOctets=agentDiffServPolicyPerfOutTailDroppedOctets, agentDiffServServicePerfHCOfferedOctets=agentDiffServServicePerfHCOfferedOctets, agentDiffServPolicyAttrStmtPoliceColorConformVal=agentDiffServPolicyAttrStmtPoliceColorConformVal, agentDiffServPolicyAttrRowStatus=agentDiffServPolicyAttrRowStatus, agentDiffServPolicyPerfOutSentOctets=agentDiffServPolicyPerfOutSentOctets, agentDiffServClassIndexNextFree=agentDiffServClassIndexNextFree, agentDiffServPolicyAttrStmtRandomdropMinThresh=agentDiffServPolicyAttrStmtRandomdropMinThresh, agentDiffServGenStatusPolicyTableSize=agentDiffServGenStatusPolicyTableSize, agentDiffServClassAclType=agentDiffServClassAclType, agentDiffServPolicyIndex=agentDiffServPolicyIndex, agentDiffServPolicyAttrStmtDrop=agentDiffServPolicyAttrStmtDrop, agentDiffServClassRuleMatchVlanIdStart=agentDiffServClassRuleMatchVlanIdStart, agentDiffServPolicyStorageType=agentDiffServPolicyStorageType, agentDiffServPolicyAttrStmtPoliceSinglerateEburst=agentDiffServPolicyAttrStmtPoliceSinglerateEburst, agentDiffServPolicyPerfInHCOfferedOctets=agentDiffServPolicyPerfInHCOfferedOctets, agentDiffServPolicyPerfOutEntry=agentDiffServPolicyPerfOutEntry, agentDiffServClassRuleMatchVlanId2End=agentDiffServClassRuleMatchVlanId2End, agentDiffServPolicyInstClassIndex=agentDiffServPolicyInstClassIndex, agentDiffServClassRuleIndex=agentDiffServClassRuleIndex, agentDiffServServiceIfOperStatus=agentDiffServServiceIfOperStatus, agentDiffServClassRuleMatchRefClassIndex=agentDiffServClassRuleMatchRefClassIndex, agentDiffServClassRuleMatchEtypeKey=agentDiffServClassRuleMatchEtypeKey, agentDiffServPolicyAttrStmtPoliceNonconformVal=agentDiffServPolicyAttrStmtPoliceNonconformVal, agentDiffServServiceStorageType=agentDiffServServiceStorageType, agentDiffServServiceRowStatus=agentDiffServServiceRowStatus, agentDiffServServicePerfSentPackets=agentDiffServServicePerfSentPackets, QosBurstSize=QosBurstSize, agentDiffServPolicyPerfInStorageType=agentDiffServPolicyPerfInStorageType, agentDiffServGenStatusPolicyInstTableSize=agentDiffServGenStatusPolicyInstTableSize, agentDiffServGenStatusClassRuleTableMax=agentDiffServGenStatusClassRuleTableMax, Ipv6AddressPrefix=Ipv6AddressPrefix, agentDiffServClassRuleMatchSrcIpMask=agentDiffServClassRuleMatchSrcIpMask, agentDiffServPolicyAttrStmtExpediteCrate=agentDiffServPolicyAttrStmtExpediteCrate, agentDiffServPolicyPerfOutOfferedOctets=agentDiffServPolicyPerfOutOfferedOctets, agentDiffServServicePerfSentOctets=agentDiffServServicePerfSentOctets, agentDiffServPolicyAttrStmtShapeAverageCrate=agentDiffServPolicyAttrStmtShapeAverageCrate, agentDiffServPolicyPerfOutHCShapeDelayedPackets=agentDiffServPolicyPerfOutHCShapeDelayedPackets, agentDiffServServicePerfDiscardedPackets=agentDiffServServicePerfDiscardedPackets, agentDiffServPolicyAttrStmtPoliceTworatePrate=agentDiffServPolicyAttrStmtPoliceTworatePrate, agentDiffServPolicyAttrStmtEntryType=agentDiffServPolicyAttrStmtEntryType, agentDiffServClassTable=agentDiffServClassTable, agentDiffServPolicyAttrStmtMarkCos2Val=agentDiffServPolicyAttrStmtMarkCos2Val, agentDiffServPolicyAttrStmtPoliceTworateCrate=agentDiffServPolicyAttrStmtPoliceTworateCrate, agentDiffServPolicyPerfOutSentPackets=agentDiffServPolicyPerfOutSentPackets, agentDiffServPolicyPerfOutDiscardedPackets=agentDiffServPolicyPerfOutDiscardedPackets, agentDiffServPolicyAttrTable=agentDiffServPolicyAttrTable, agentDiffServPolicyAttrStmtMirrorIntf=agentDiffServPolicyAttrStmtMirrorIntf, agentDiffServPolicyAttrStmtRandomdropMaxThresh=agentDiffServPolicyAttrStmtRandomdropMaxThresh, agentDiffServClassRuleMatchIpTosMask=agentDiffServClassRuleMatchIpTosMask, agentDiffServPolicyRowStatus=agentDiffServPolicyRowStatus, agentDiffServPolicyPerfOutTable=agentDiffServPolicyPerfOutTable, agentDiffServGenStatusPolicyAttrTableSize=agentDiffServGenStatusPolicyAttrTableSize, agentDiffServPolicyPerfOutHCOfferedPackets=agentDiffServPolicyPerfOutHCOfferedPackets, agentDiffServPolicyAttrStmtPoliceSinglerateCrate=agentDiffServPolicyAttrStmtPoliceSinglerateCrate, agentDiffServClassRuleMatchIpTosBits=agentDiffServClassRuleMatchIpTosBits, agentDiffServClassRuleMatchDstL4PortStart=agentDiffServClassRuleMatchDstL4PortStart, agentDiffServClassRuleMatchSrcMacMask=agentDiffServClassRuleMatchSrcMacMask, agentDiffServClassRuleMatchSrcL4PortEnd=agentDiffServClassRuleMatchSrcL4PortEnd, agentDiffServPolicyPerfOutTailDroppedPackets=agentDiffServPolicyPerfOutTailDroppedPackets, agentDiffServServicePerfEntry=agentDiffServServicePerfEntry, agentDiffServClassRuleMatchDstIpv6PrefixLength=agentDiffServClassRuleMatchDstIpv6PrefixLength, agentDiffServPolicyPerfOutHCRandomDroppedPackets=agentDiffServPolicyPerfOutHCRandomDroppedPackets, agentDiffServPolicyAttrStmtMarkIpPrecedenceVal=agentDiffServPolicyAttrStmtMarkIpPrecedenceVal, agentDiffServPolicyAttrStmtPoliceExceedAct=agentDiffServPolicyAttrStmtPoliceExceedAct, agentDiffServClassRuleMatchCos=agentDiffServClassRuleMatchCos)
