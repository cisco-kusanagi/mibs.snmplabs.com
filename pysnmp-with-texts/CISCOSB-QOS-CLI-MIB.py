...
# Produced by pysmi-0.3.4 at Wed May  1 12:23:15 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, ModuleIdentity, IpAddress, Unsigned32, NotificationType, MibIdentifier, Counter64, iso, Gauge32, ObjectIdentity, TimeTicks, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "ModuleIdentity", "IpAddress", "Unsigned32", "NotificationType", "MibIdentifier", "Counter64", "iso", "Gauge32", "ObjectIdentity", "TimeTicks", "Integer32")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: rlQosCliMib.setRevisionsDescriptions(('The private MIB module definition for Quality Of Service CLI in CISCOSB devices.', 'Editorial changes to support new MIB compilers.', 'Add rlQosPortRateLimitStatus,rlQosCirPortRateLimit, rlQosCbsPortRateLimit to rlQosIfPolicyTable', 'Add vpt,ether-type,tcp-flags,icmp-type,icmp-code,igmp-type to ClassTupleType Add mac-Offset,ip-ICMP,ip-IGMP To AceObjectType Add vpt,ethertype To ClassOffsetType', 'Add new advanced action : trustCosDscp', 'Add DSCP to Queue Default map table.', 'Add textual convention to QosObjectMode (service).', 'Added this MODULE-IDENTITY clause, changed IMPORT, removed ranges in SEQUENCE elements, changed access of rlQosCliQosMode, rlQosCliBasicModeCfg and rlQosMaxNumOfAce.', 'Added rlQosDscpToDpTable',))
...
if mibBuilder.loadTexts: rlQosCliMib.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
if mibBuilder.loadTexts: rlQosDenyAceStatisticsClearIfCounters.setDescription('Each bit that is set in this portList represent a port or trunk that its hit counters should be reset.')
...
mibBuilder.exportSymbols("CISCOSB-QOS-CLI-MIB", rlQosEfQueueId=rlQosEfQueueId, rlQosSinglePolicerStatisticsInProfileCounterValue=rlQosSinglePolicerStatisticsInProfileCounterValue, rlQosAceTuple8=rlQosAceTuple8, rlQosOutQueueStatisticsQueue=rlQosOutQueueStatisticsQueue, rlQosPolicyClassPriorityRefTable=rlQosPolicyClassPriorityRefTable, rlQosGlobalQoSMode=rlQosGlobalQoSMode, rlQosCbsPortRateLimit=rlQosCbsPortRateLimit, rlQosCirQueue8=rlQosCirQueue8, rlQosAggregatePolicerStatisticsInProfileCntrNumOfBits=rlQosAggregatePolicerStatisticsInProfileCntrNumOfBits, rlQosStackControlQueue=rlQosStackControlQueue, rlQosClassMapCounterValue=rlQosClassMapCounterValue, rlQosValueQueue1=rlQosValueQueue1, rlQosPredefBlockAclTable=rlQosPredefBlockAclTable, rlQosIfPolicyMapPointerIn=rlQosIfPolicyMapPointerIn, rlQosAceTidxIndex=rlQosAceTidxIndex, rlQosPortToProfileMappingEntry=rlQosPortToProfileMappingEntry, rlQosAceTidxAclIndex=rlQosAceTidxAclIndex, rlQosTcpPortQueueEntry=rlQosTcpPortQueueEntry, rlQosOffsetValue=rlQosOffsetValue, rlQosRedMinDp0=rlQosRedMinDp0, rlQosEfPriority=rlQosEfPriority, rlQosPolicerAction=rlQosPolicerAction, rlQosAceEntry=rlQosAceEntry, rlQosPolicerCasPointerRemVal=rlQosPolicerCasPointerRemVal, rlQosAceTidxTimeRange=rlQosAceTidxTimeRange, rlQosTcpPort=rlQosTcpPort, rlQosPort=rlQosPort, rlQosCirQueue6=rlQosCirQueue6, rlQosCbsPortShaper=rlQosCbsPortShaper, rlQosOffsetStatus=rlQosOffsetStatus, rlQosClassMapStatus=rlQosClassMapStatus, StatisticsCntrNumOfBitsType=StatisticsCntrNumOfBitsType, rlQosCbsQueue2=rlQosCbsQueue2, rlQosOutQueueStatisticsPortAll=rlQosOutQueueStatisticsPortAll, AclObjectType=AclObjectType, RlQosTimeBasedAclWeekPeriodicList=RlQosTimeBasedAclWeekPeriodicList, rlQosCirQueue3=rlQosCirQueue3, rlQosOffsetMask=rlQosOffsetMask, rlQosGlobalIndex=rlQosGlobalIndex, rlQosAclCounterAceIndex=rlQosAclCounterAceIndex, rlQosClassifierUtilizationSystem=rlQosClassifierUtilizationSystem, rlQosAclNumOfAces=rlQosAclNumOfAces, rlQosAceTuple4=rlQosAceTuple4, rlQosPolicyClassRefEntry=rlQosPolicyClassRefEntry, rlQosIfProfileCfgEntry=rlQosIfProfileCfgEntry, rlQosQueueId=rlQosQueueId, rlQosSinglePolicerStatisticsOutProfileCounterValue=rlQosSinglePolicerStatisticsOutProfileCounterValue, rlQosOutQueueStatisticsDPAll=rlQosOutQueueStatisticsDPAll, rlQosAceTuple2=rlQosAceTuple2, rlQosUdpPortQueueStatus=rlQosUdpPortQueueStatus, rlQosRedProbDp2=rlQosRedProbDp2, rlQosFreeIndexesTableId=rlQosFreeIndexesTableId, rlQosDenyAceStatisticsIfIndex=rlQosDenyAceStatisticsIfIndex, rlQosEfState=rlQosEfState, rlQosAceTidxEntry=rlQosAceTidxEntry, RedirectAction=RedirectAction, rlQosCosIndex=rlQosCosIndex, rlQosPolicerName=rlQosPolicerName, rlQosAggregatePolicerStatisticsTable=rlQosAggregatePolicerStatisticsTable, rlQosClassifierUtilizationFreeRulesNumber=rlQosClassifierUtilizationFreeRulesNumber, PolicerType=PolicerType, rlQosPredefBlockAclStatus=rlQosPredefBlockAclStatus, rlQosRedMaxDp2=rlQosRedMaxDp2, rlQosTupleValue2=rlQosTupleValue2, ClassTupleType=ClassTupleType, rlQosValueQueue7=rlQosValueQueue7, rlQosClassifierUtilization=rlQosClassifierUtilization, rlQosAclDefaultAction=rlQosAclDefaultAction, rlQosPolicyClassRefStatus=rlQosPolicyClassRefStatus, rlQosPolicyMapEntry=rlQosPolicyMapEntry, rlQosAggregatePolicerStatisticsOutProfileCntrNumOfBits=rlQosAggregatePolicerStatisticsOutProfileCntrNumOfBits, rlQosOffsetIndex=rlQosOffsetIndex, rlQosIfIpv6AclOut=rlQosIfIpv6AclOut, rlQosValueQueue3=rlQosValueQueue3, rlQosValueQueue5=rlQosValueQueue5, rlQosNamesToIndexesTableId=rlQosNamesToIndexesTableId, ClassMapAction=ClassMapAction, rlQosAceTidxAction=rlQosAceTidxAction, rlQosTypeQueue8=rlQosTypeQueue8, rlQosAceTuple6=rlQosAceTuple6, rlQosIfprofileStatus=rlQosIfprofileStatus, rlQosSinglePolicerStatisticsStatus=rlQosSinglePolicerStatisticsStatus, rlQosMaxNumOfAce=rlQosMaxNumOfAce, rlQosModeGlobalCfgStatus=rlQosModeGlobalCfgStatus, rlQosModeGlobalCfgEntry=rlQosModeGlobalCfgEntry, rlQosAclStatus=rlQosAclStatus, rlQosCliQosMode=rlQosCliQosMode, rlQosQueueProfilePointer=rlQosQueueProfilePointer, rlQosClassMapMarkValue=rlQosClassMapMarkValue, rlQosPredefBlockAclIfType=rlQosPredefBlockAclIfType, rlQosCosQueueTable=rlQosCosQueueTable, rlQosStackControlCos=rlQosStackControlCos, rlQosClassMapEntry=rlQosClassMapEntry, rlQosAceIndex=rlQosAceIndex, rlQosTcpPortQueueStatus=rlQosTcpPortQueueStatus, rlQosCirQueue4=rlQosCirQueue4, AceObjectType=AceObjectType, rlQosUdpPortQueueTable=rlQosUdpPortQueueTable, rlQosPortPolicyStatisticsEnableCounting=rlQosPortPolicyStatisticsEnableCounting, rlQosEfManageEntry=rlQosEfManageEntry, rlQosPolicyClassPriorityRefPolicyPointer=rlQosPolicyClassPriorityRefPolicyPointer, rlQosClassMapMarkVlan=rlQosClassMapMarkVlan, rlQosCirQueue1=rlQosCirQueue1, rlQosDscpQueueDefaultMapTable=rlQosDscpQueueDefaultMapTable, rlQosClassMapTrapId=rlQosClassMapTrapId, rlQosGlobalStatisticsCntrsCounterValue=rlQosGlobalStatisticsCntrsCounterValue, rlQosPolicyMapIndex=rlQosPolicyMapIndex, rlQosPolicyMapStatus=rlQosPolicyMapStatus, rlQoSApplicationDefaultAction=rlQoSApplicationDefaultAction, rlQosAceTidxTuple2=rlQosAceTidxTuple2, rlQosPortRateLimitStatus=rlQosPortRateLimitStatus, rlQosOutQueueStatisticsDP=rlQosOutQueueStatisticsDP, rlQosOutQueueStatisticsCounterTailDropValue=rlQosOutQueueStatisticsCounterTailDropValue, rlQosCirQueue5=rlQosCirQueue5, rlQosCliMib=rlQosCliMib, rlQosDscpMutationTable=rlQosDscpMutationTable, rlQosOffsetType=rlQosOffsetType, rlIfProfileName=rlIfProfileName, rlQosAceTidxAccount=rlQosAceTidxAccount, rlQosTypeQueue5=rlQosTypeQueue5, rlQosPolicyClassPriorityRefClassPointer=rlQosPolicyClassPriorityRefClassPointer, rlQosGlobalStatisticsCntrsEntry=rlQosGlobalStatisticsCntrsEntry, rlQosGlobalStatisticsCntrsNumOfBits=rlQosGlobalStatisticsCntrsNumOfBits, rlQosDenyAceStatisticsEntry=rlQosDenyAceStatisticsEntry, rlQosAclEntry=rlQosAclEntry, QueueType=QueueType, rlQosCbsQueue1=rlQosCbsQueue1, rlQosDscpQueueDefaultMapQueueId=rlQosDscpQueueDefaultMapQueueId, rlQosClassifierUtilizationUnitId=rlQosClassifierUtilizationUnitId, rlQosTupleStatus=rlQosTupleStatus, rlQosAceStatus=rlQosAceStatus, rlQosTdThersholdDp1=rlQosTdThersholdDp1, rlQosCosQueueDefaultMapEntry=rlQosCosQueueDefaultMapEntry, rlQosPolicerCir=rlQosPolicerCir, rlQosAceTuple7=rlQosAceTuple7, rlIfType=rlIfType, MarkVlanAction=MarkVlanAction, rlQosAceTidxTuple10=rlQosAceTidxTuple10, rlQosClassifierUtilizationTable=rlQosClassifierUtilizationTable, rlQosIfAclOut=rlQosIfAclOut, rlQosDscp=rlQosDscp, rlQosRedMaxDp0=rlQosRedMaxDp0, rlQosTypeQueue3=rlQosTypeQueue3, rlQosDscpToDpEntry=rlQosDscpToDpEntry, rlQosClassMapMatch2=rlQosClassMapMatch2, rlQosIfPolicerIn=rlQosIfPolicerIn, InterfaceType=InterfaceType, rlQosDscpRemarkTable=rlQosDscpRemarkTable, rlQosTdThersholdDp0=rlQosTdThersholdDp0, rlQosPolicyMapName=rlQosPolicyMapName, rlQosOutQueueStatisticsVlan=rlQosOutQueueStatisticsVlan, rlQosAceAccount=rlQosAceAccount, rlQosAclAceRefAclPointer=rlQosAclAceRefAclPointer, rlQosRmNewDscp=rlQosRmNewDscp, rlQosDscpQueueDefaultMapEntry=rlQosDscpQueueDefaultMapEntry, RlQosAceTidxActionDropType=RlQosAceTidxActionDropType, rlQosIfPolicyTable=rlQosIfPolicyTable, rlQosOffsetTuplePointer=rlQosOffsetTuplePointer, rlQosAceTidxTable=rlQosAceTidxTable, rlQosCbsQueue3=rlQosCbsQueue3, rlQosNamesToIndexesTable=rlQosNamesToIndexesTable, rlQosTupleType=rlQosTupleType, StatisticsCntrType=StatisticsCntrType, rlQosPolicyClassRefPolicyPointer=rlQosPolicyClassRefPolicyPointer, rlQosCosQueueId=rlQosCosQueueId, rlQosApplicationName=rlQosApplicationName, rlQosDenyAceStatisticsTable=rlQosDenyAceStatisticsTable, rlQosAceTable=rlQosAceTable, rlQosOffsetTable=rlQosOffsetTable, PYSNMP_MODULE_ID=rlQosCliMib, rlQosOutQueueStatisticsVlanAll=rlQosOutQueueStatisticsVlanAll, rlQosOutQueueStatisticsCounterAllValue=rlQosOutQueueStatisticsCounterAllValue, rlQosRedProbDp1=rlQosRedProbDp1, rlQosStatistics=rlQosStatistics, rlQosProfileName=rlQosProfileName, rlQosPolicerStatus=rlQosPolicerStatus, rlQosPortToProfileMappingTable=rlQosPortToProfileMappingTable, rlQueueProfileName=rlQueueProfileName, rlQosOffsetPattern=rlQosOffsetPattern, rlQosIfProfilePointer=rlQosIfProfilePointer, rlQosPortShaperStatus=rlQosPortShaperStatus, rlQosPortPolicyStatisticsEntry=rlQosPortPolicyStatisticsEntry, rlQosValueQueue6=rlQosValueQueue6, rlQosPortPolicyStatisticsCntrNumOfBits=rlQosPortPolicyStatisticsCntrNumOfBits, rlQosDenyAceStatisticsClearIfCounters=rlQosDenyAceStatisticsClearIfCounters, rlQosClassMapIndex=rlQosClassMapIndex, rlQosTdThersholdDp2=rlQosTdThersholdDp2, rlQosPredefBlockAclEntry=rlQosPredefBlockAclEntry, rlQosTypeQueue2=rlQosTypeQueue2, rlQosCbsQueue6=rlQosCbsQueue6, rlQosPortPolicyStatisticsTable=rlQosPortPolicyStatisticsTable, rlQosOutQueueStatisticsEntry=rlQosOutQueueStatisticsEntry, rlQosTupleValue1=rlQosTupleValue1, rlQosQueueProfileEntry=rlQosQueueProfileEntry, rlQosAceTidxTuple7=rlQosAceTidxTuple7, rlQosQueueShapeProfilePointer=rlQosQueueShapeProfilePointer, rlQosPolicyClassPriorityRefStatus=rlQosPolicyClassPriorityRefStatus, rlQosNamesToIndexesName=rlQosNamesToIndexesName, rlQosTcpPortQueueTable=rlQosTcpPortQueueTable, rlQosUdpPort=rlQosUdpPort, rlQosAceTidxTuple11=rlQosAceTidxTuple11, rlQosClassMapType=rlQosClassMapType, rlQosAdvcGlobalTrustMode=rlQosAdvcGlobalTrustMode, rlQosClassMapTable=rlQosClassMapTable, rlQosAclIndex=rlQosAclIndex, rlQosPolicyClassPriorityRefEntry=rlQosPolicyClassPriorityRefEntry, rlQosCbsQueue8=rlQosCbsQueue8, rlQosDscpRemarkEntry=rlQosDscpRemarkEntry, rlQosAclName=rlQosAclName, rlQosClassMapCounterEnable=rlQosClassMapCounterEnable, rlQosAclType=rlQosAclType, rlQosOutQueueStatisticsIfIndexList=rlQosOutQueueStatisticsIfIndexList, rlQosQueueNum=rlQosQueueNum, rlQosAceTidxTuple1=rlQosAceTidxTuple1, rlQosDenyAceStatisticsOtherFlowCounter=rlQosDenyAceStatisticsOtherFlowCounter, rlQosCirPortShaper=rlQosCirPortShaper, rlQosAclAceRefEntry=rlQosAclAceRefEntry, rlQosDscpToDpTable=rlQosDscpToDpTable, rlQosCirPortRateLimit=rlQosCirPortRateLimit, rlQosIfPolicyEntry=rlQosIfPolicyEntry, rlQosAceAction=rlQosAceAction, rlQosValueQueue4=rlQosValueQueue4, rlQosAceTidxTuple9=rlQosAceTidxTuple9, rlQosOutQueueStatisticsCountrID=rlQosOutQueueStatisticsCountrID, rlQosNumOfIfConnections=rlQosNumOfIfConnections, rlQosTupleEntry=rlQosTupleEntry, rlQosDp=rlQosDp, rlQosIfAclIn=rlQosIfAclIn, rlQosTypeQueue7=rlQosTypeQueue7, rlQosSinglePolicerStatisticsInProfileCntrNumOfBits=rlQosSinglePolicerStatisticsInProfileCntrNumOfBits, rlQosUdpPortQueueEntry=rlQosUdpPortQueueEntry, rlQosClearCounters=rlQosClearCounters, AclDefaultAction=AclDefaultAction, AceActionType=AceActionType, rlQosPolicerIndex=rlQosPolicerIndex, rlQosAceTidxStatus=rlQosAceTidxStatus, rlQosOutQueueStatisticsTable=rlQosOutQueueStatisticsTable, rlQosClassifierUtilizationRulesNumber=rlQosClassifierUtilizationRulesNumber, rlQosClassMapTunnelIdx=rlQosClassMapTunnelIdx, rlQosCosQueueEntry=rlQosCosQueueEntry, rlQosClassMapDestInterface=rlQosClassMapDestInterface, rlQosRmOldDscp=rlQosRmOldDscp, rlQosPolicyClassRefClassPointer=rlQosPolicyClassRefClassPointer, rlQosOutQueueStatisticsStatus=rlQosOutQueueStatisticsStatus, rlQosTypeQueue6=rlQosTypeQueue6, rlQosGlobalStatisticsCntrsType=rlQosGlobalStatisticsCntrsType, rlQosPolicerCbs=rlQosPolicerCbs, rlQosUdpQueueValue=rlQosUdpQueueValue, rlQosApplicationTrapId=rlQosApplicationTrapId, rlQosOutQueueStatisticsQueueAll=rlQosOutQueueStatisticsQueueAll, rlQosQueueProfileTable=rlQosQueueProfileTable, rlQosPortPolicyStatisticsCntrType=rlQosPortPolicyStatisticsCntrType, QosTrustMode=QosTrustMode, rlQosAclAceRefStatus=rlQosAclAceRefStatus)
mibBuilder.exportSymbols("CISCOSB-QOS-CLI-MIB", rlQosDscpIndex=rlQosDscpIndex, rlQosPredefBlockAclIfIndex=rlQosPredefBlockAclIfIndex, rlQosAggregatePolicerStatisticsOutProfileCounterValue=rlQosAggregatePolicerStatisticsOutProfileCounterValue, rlQosAclCounterTable=rlQosAclCounterTable, PolicerAction=PolicerAction, rlQosClassifierUtilizationEntry=rlQosClassifierUtilizationEntry, rlQosAceTidxTuple4=rlQosAceTidxTuple4, rlQosPolicerTable=rlQosPolicerTable, rlQosIfPolicyMapStatus=rlQosIfPolicyMapStatus, rlQosPolicerEntry=rlQosPolicerEntry, rlQosClassifierRulesNumberUtilizationSystem=rlQosClassifierRulesNumberUtilizationSystem, rlQosAclTable=rlQosAclTable, rlQosCbsQueue4=rlQosCbsQueue4, rlQosCirQueue7=rlQosCirQueue7, rlQosOffsetEntry=rlQosOffsetEntry, rlQosDscpMutationEnable=rlQosDscpMutationEnable, rlQosApplicationTrapIdTable=rlQosApplicationTrapIdTable, rlQosFreeIndexesEntry=rlQosFreeIndexesEntry, rlQosAceTidxTuple6=rlQosAceTidxTuple6, rlQosAceTuple1=rlQosAceTuple1, rlQosAceTuple3=rlQosAceTuple3, rlQosPolicyMapTable=rlQosPolicyMapTable, rlQosQueueShapeProfileEntry=rlQosQueueShapeProfileEntry, rlQosPortPolicyStatisticsCounterValue=rlQosPortPolicyStatisticsCounterValue, rlQosQueueProfileStatus=rlQosQueueProfileStatus, rlQosAceTidxActionDropType=rlQosAceTidxActionDropType, rlQosNamesToIndexesValue=rlQosNamesToIndexesValue, rlQosCbsQueue7=rlQosCbsQueue7, rlQosNewDscp=rlQosNewDscp, ClassOffsetType=ClassOffsetType, rlQosAceTuple5=rlQosAceTuple5, rlQosQueueShapeIndex=rlQosQueueShapeIndex, rlQosCirQueue2=rlQosCirQueue2, rlQosClassMapPolicer=rlQosClassMapPolicer, rlQosAggregatePolicerStatisticsEntry=rlQosAggregatePolicerStatisticsEntry, rlQosIfTrustActive=rlQosIfTrustActive, rlQosClassMapRedirectAction=rlQosClassMapRedirectAction, rlQosCPUSafeGuardEnable=rlQosCPUSafeGuardEnable, rlQosValueQueue8=rlQosValueQueue8, rlQosCliBasicModeCfg=rlQosCliBasicModeCfg, rlQosPolicerType=rlQosPolicerType, rlQosRedQweight=rlQosRedQweight, rlQosAclCounterEntry=rlQosAclCounterEntry, rlQosOutQueueStatisticsCntrNumOfBits=rlQosOutQueueStatisticsCntrNumOfBits, rlQosIfProfileCfgTable=rlQosIfProfileCfgTable, rlQosCosQueueDefaultMapTable=rlQosCosQueueDefaultMapTable, rlQosDscpQueueEntry=rlQosDscpQueueEntry, rlQosClassMapNewVlan=rlQosClassMapNewVlan, BinaryStatus=BinaryStatus, rlQosSinglePolicerStatisticsTable=rlQosSinglePolicerStatisticsTable, rlQosSinglePolicerStatisticsOutProfileCntrNumOfBits=rlQosSinglePolicerStatisticsOutProfileCntrNumOfBits, rlQosRedMinDp1=rlQosRedMinDp1, rlQosClassMapCounterEntry=rlQosClassMapCounterEntry, rlQosDscpQueueTable=rlQosDscpQueueTable, rlQosAceTidxTimeRangeIsActive=rlQosAceTidxTimeRangeIsActive, rlQosSinglePolicerStatisticsEntry=rlQosSinglePolicerStatisticsEntry, rlQosModeGlobalCfgTable=rlQosModeGlobalCfgTable, rlQosRedMinDp2=rlQosRedMinDp2, rlQosAceTidxTuple5=rlQosAceTidxTuple5, QosGlobalMode=QosGlobalMode, rlQosGlobalStatisticsStatus=rlQosGlobalStatisticsStatus, rlIfIndex=rlIfIndex, rlQosDscpQueueDefaultMapDscp=rlQosDscpQueueDefaultMapDscp, rlQosTupleIndex=rlQosTupleIndex, rlQosIfIpv6AclIn=rlQosIfIpv6AclIn, rlQosDscpMutationEntry=rlQosDscpMutationEntry, rlQosClassifierUtilizationPercent=rlQosClassifierUtilizationPercent, rlQosTypeQueue1=rlQosTypeQueue1, rlQosCbsQueue5=rlQosCbsQueue5, rlQosRedMaxDp1=rlQosRedMaxDp1, rlQosCosQueueDefaultMapVpt=rlQosCosQueueDefaultMapVpt, rlQosClassMapMatch3=rlQosClassMapMatch3, rlQosClassMapMatch1=rlQosClassMapMatch1, rlQosFreeIndexesValue=rlQosFreeIndexesValue, rlQosClassMapName=rlQosClassMapName, rlQosTcpQueueValue=rlQosTcpQueueValue, rlQosAceTidxTuple3=rlQosAceTidxTuple3, rlQosDenyAceStatisticsClearOtherFlowCounter=rlQosDenyAceStatisticsClearOtherFlowCounter, rlQosQueueShapeProfileTable=rlQosQueueShapeProfileTable, rlQosAclCounterInterface=rlQosAclCounterInterface, rlQosPolicyClassRefTable=rlQosPolicyClassRefTable, rlQosEfManageTable=rlQosEfManageTable, rlQosAclCounterValue=rlQosAclCounterValue, rlQosAceTidxTuple8=rlQosAceTidxTuple8, rlQosPolicyClassPriorityRefPriority=rlQosPolicyClassPriorityRefPriority, rlQosIfPolicyMapPointerOut=rlQosIfPolicyMapPointerOut, rlQosOldDscp=rlQosOldDscp, rlQosMibVersion=rlQosMibVersion, ClassMapType=ClassMapType, rlQosFreeIndexesTable=rlQosFreeIndexesTable, rlQosApplicationTrapIdEntry=rlQosApplicationTrapIdEntry, rlQosQueueShapeProfileStatus=rlQosQueueShapeProfileStatus, rlQosAclAceRefTable=rlQosAclAceRefTable, rlQosAggregatePolicerStatisticsInProfileCounterValue=rlQosAggregatePolicerStatisticsInProfileCounterValue, RlQosApplicationDefaultActionType=RlQosApplicationDefaultActionType, rlQosAceTidxType=rlQosAceTidxType, rlQosValueQueue2=rlQosValueQueue2, rlQosTupleTable=rlQosTupleTable, rlQosRedProbDp0=rlQosRedProbDp0, rlQosGlobalStatisticsCntrsTable=rlQosGlobalStatisticsCntrsTable, rlQosDenyAceStatisticsIfCounter=rlQosDenyAceStatisticsIfCounter, rlQosBasicGlobalTrustMode=rlQosBasicGlobalTrustMode, rlQosAclAceRefAcePointer=rlQosAclAceRefAcePointer, rlQosClassMapAction=rlQosClassMapAction, rlQosNamesToIndexesEntry=rlQosNamesToIndexesEntry, rlQosClassMapCounterTable=rlQosClassMapCounterTable, rlQoSPortTrustAdvancedMode=rlQoSPortTrustAdvancedMode, rlQosAceType=rlQosAceType, rlQosAggregatePolicerStatisticsStatus=rlQosAggregatePolicerStatisticsStatus, rlQosAclCounterAclIndex=rlQosAclCounterAclIndex, rlQosPredefBlockAclMask=rlQosPredefBlockAclMask, rlQosCosQueueDefaultMapQueueId=rlQosCosQueueDefaultMapQueueId, rlQosTypeQueue4=rlQosTypeQueue4)
