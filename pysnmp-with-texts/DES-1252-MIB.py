...
# Produced by pysmi-0.3.4 at Wed May  1 12:39:18 2019
...
mib_2, MibIdentifier, ModuleIdentity, Unsigned32, TimeTicks, Counter32, IpAddress, Counter64, NotificationType, Integer32, Bits, iso, enterprises, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32 = mibBuilder.importSymbols("SNMPv2-SMI", "mib-2", "MibIdentifier", "ModuleIdentity", "Unsigned32", "TimeTicks", "Counter32", "IpAddress", "Counter64", "NotificationType", "Integer32", "Bits", "iso", "enterprises", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32")
...
mibBuilder.exportSymbols("DES-1252-MIB", commTrapTable=commTrapTable, radiusServerPort=radiusServerPort, configMirrorRXSrc=configMirrorRXSrc, commTrapSNMPFiberLinkUpDown=commTrapSNMPFiberLinkUpDown, companyConfigGroup=companyConfigGroup, configIpAssignmentMode=configIpAssignmentMode, igsVlan=igsVlan, staticPort=staticPort, companySpanGroup=companySpanGroup, trustedHostTable=trustedHostTable, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, dscpEntry=dscpEntry, dscpPriority=dscpPriority, igsVlanMcastFwdTable=igsVlanMcastFwdTable, portTrunkEntry=portTrunkEntry, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, igsVlanRouterPortListEntry=igsVlanRouterPortListEntry, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, dot1xAuthServerTimeout=dot1xAuthServerTimeout, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, portTrunkName=portTrunkName, igsVlanMcastFwdGroupAddress=igsVlanMcastFwdGroupAddress, configTftpOperation=configTftpOperation, portTrunkTable=portTrunkTable, configVLANMode=configVLANMode, dot1xAuthMaxReq=dot1xAuthMaxReq, commSetStatus=commSetStatus, swFiberAbnormalTXError=swFiberAbnormalTXError, configMirrorMon=configMirrorMon, configIpAddress=configIpAddress, tvlanId=tvlanId, tvlanEntry=tvlanEntry, commTrapIndex=commTrapIndex, configPortTable=configPortTable, configBootTftpOperation=configBootTftpOperation, companyTVlanGroup=companyTVlanGroup, igsSharedSegmentAggregationInterval=igsSharedSegmentAggregationInterval, commTrapTrapAbnormalFiberRXError=commTrapTrapAbnormalFiberRXError, configPortSpeed=configPortSpeed, PortList=PortList, staticOnOff=staticOnOff, companyIgsGroup=companyIgsGroup, companyDot1xGroup=companyDot1xGroup, OwnerString=OwnerString, dot1pPortTable=dot1pPortTable, igsQueryMaxResponseTime=igsQueryMaxResponseTime, tvlanName=tvlanName, tvlanAsyOnOff=tvlanAsyOnOff, dot1xAuth=dot1xAuth, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, staticStatus=staticStatus, configMirrorEntry=configMirrorEntry, configSNMPEnable=configSNMPEnable, igsQueryInterval=igsQueryInterval, radiusServerSharedSecret=radiusServerSharedSecret, commTrapName=commTrapName, spanOnOff=spanOnOff, tvlanMember=tvlanMember, configRestoreDefaults=configRestoreDefaults, igsHostPortPurgeInterval=igsHostPortPurgeInterval, dot1xAuthTxPeriod=dot1xAuthTxPeriod, staticEntry=staticEntry, igsLastMembQueryInterval=igsLastMembQueryInterval, staticAutoLearning=staticAutoLearning, configPasswordAdmin=configPasswordAdmin, igsStatus=igsStatus, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, tvlanPortTable=tvlanPortTable, igsVlanId=igsVlanId, companyStaticGroup=companyStaticGroup, configVerHwChipSet=configVerHwChipSet, configPortPriority=configPortPriority, igsVlanMcastFwdPortListMac=igsVlanMcastFwdPortListMac, trustedHostIpAddress=trustedHostIpAddress, commGetEntry=commGetEntry, portTrunkMember=portTrunkMember, commGetStatus=commGetStatus, radiusServerAddress=radiusServerAddress, dscpTable=dscpTable, companyQoSGroup=companyQoSGroup, swFiberAbnormalRXError=swFiberAbnormalRXError, configMirrorTable=configMirrorTable, igsGblReportFwdOnAllPorts=igsGblReportFwdOnAllPorts, companySecurity=companySecurity, broadcastStormGlobalThreshold=broadcastStormGlobalThreshold, trustedHostOnOff=trustedHostOnOff, trustedHostSettings=trustedHostSettings, configGateway=configGateway, configTftpServerFileName=configTftpServerFileName, commTrapTrapAbnormalFiberTXError=commTrapTrapAbnormalFiberTXError, igsVlanFilterTable=igsVlanFilterTable, commTrapStatus=commTrapStatus, commTrapEntry=commTrapEntry, RowStatus=RowStatus, trustedHostEntry=trustedHostEntry, igsSystem=igsSystem, igsVlanRouterPortList=igsVlanRouterPortList, configSafeguardEnable=configSafeguardEnable, companyMiscGroup=companyMiscGroup, swFiberInsert=swFiberInsert, commSetName=commSetName, igsMcastEntryAgeingInterval=igsMcastEntryAgeingInterval, commGetIndex=commGetIndex, configPortOperStatus=configPortOperStatus, tvlanTable=tvlanTable, dlink_products=dlink_products, trustedHostID=trustedHostID, commTrapSNMPTPLinkUpDown=commTrapSNMPTPLinkUpDown, dot1xAuthSystemControl=dot1xAuthSystemControl, igsVlanRouterPortListVlanId=igsVlanRouterPortListVlanId, configVerSwPrimary=configVerSwPrimary, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, tvlanManagementOnOff=tvlanManagementOnOff, configPhysAddress=configPhysAddress, portTrunkId=portTrunkId, commTrapTrapAbnormalTPRXError=commTrapTrapAbnormalTPRXError, igsVlanFilterEntry=igsVlanFilterEntry, miscStatisticsReset=miscStatisticsReset, commTrapIpAddress=commTrapIpAddress, companyTrafficMgmt=companyTrafficMgmt, igsVlanMcastFwdEntry=igsVlanMcastFwdEntry, staticMac=staticMac, dot1pPortIndex=dot1pPortIndex, configMirrorStatus=configMirrorStatus, miscReset=miscReset, configBootTftpServerIp=configBootTftpServerIp, swTPAbnormalRXError=swTPAbnormalRXError, commSetIndex=commSetIndex, igsRobustnessValue=igsRobustnessValue, configMirrorId=configMirrorId, igsNextMcastFwdMode=igsNextMcastFwdMode, commGetName=commGetName, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, tvlanPortEntry=tvlanPortEntry, staticId=staticId, igsVlanRouterPortListTable=igsVlanRouterPortListTable, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, MacAddress=MacAddress, d_link=d_link, configPort=configPort, dot1pPortPriority=dot1pPortPriority, radius=radius, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, igsVlanMcastFwdVlanIdMac=igsVlanMcastFwdVlanIdMac, igsVlanFilterStatus=igsVlanFilterStatus, igsv3Processing=igsv3Processing, igsReportForwardInterval=igsReportForwardInterval, dscpIndex=dscpIndex, dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, companyCommGroup=companyCommGroup, staticVlanID=staticVlanID, configPortEntry=configPortEntry, swTPAbnormalTXError=swTPAbnormalTXError, commGetTable=commGetTable, configSave=configSave, broadcastStormCtrlSettings=broadcastStormCtrlSettings, tvlanPortPortId=tvlanPortPortId, tvlanPortVlanId=tvlanPortVlanId, configTftpServerIpAddress=configTftpServerIpAddress, staticTable=staticTable, dot1pPortEntry=dot1pPortEntry, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, queuingMechanism=queuingMechanism, dlink_DES12XXSeriesProd=dlink_DES12XXSeriesProd, companyPortTrunkGroup=companyPortTrunkGroup, configMirrorTXSrc=configMirrorTXSrc, tvlanManagementid=tvlanManagementid, configNetMask=configNetMask, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, tvlanStatus=tvlanStatus, qosMode=qosMode, tvlanUntaggedPorts=tvlanUntaggedPorts, trustedHostIpMask=trustedHostIpMask, swFiberRemove=swFiberRemove, commSetTable=commSetTable, trustedHostStatus=trustedHostStatus, des_1252a1=des_1252a1, igsQuerierStateOnOff=igsQuerierStateOnOff, commTrapSNMPBootup=commTrapSNMPBootup, igsLeaveProcessInterval=igsLeaveProcessInterval, commSetEntry=commSetEntry, commTrapTrapAbnormalTPTXError=commTrapTrapAbnormalTPTXError, configBootImageFileName=configBootImageFileName)
