...
# Produced by pysmi-0.3.4 at Wed May  1 12:48:07 2019
...
ObjectIdentity, TimeTicks, NotificationType, iso, Integer32, Unsigned32, Bits, Gauge32, Counter32, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "TimeTicks", "NotificationType", "iso", "Integer32", "Unsigned32", "Bits", "Gauge32", "Counter32", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "IpAddress")
...
if mibBuilder.loadTexts: rlCopy.setContactInfo('www.dlink.com')
if mibBuilder.loadTexts: rlCopy.setDescription('The private MIB module definition for file copy in DLINK-3100 devices.')
...
mibBuilder.exportSymbols("DLINK-3100-COPY-MIB", rlCopyHistoryOperationState=rlCopyHistoryOperationState, rlCopyFinished=rlCopyFinished, rlCopyMessagesTable=rlCopyMessagesTable, rlCopyMessagesTableRemoveEntries=rlCopyMessagesTableRemoveEntries, rlCopyInetDestinationUnitNumber=rlCopyInetDestinationUnitNumber, rlCopyHistoryInetHistoryIndex=rlCopyHistoryInetHistoryIndex, rlCopySourceFileName=rlCopySourceFileName, rlCopyFreeHistoryIndex=rlCopyFreeHistoryIndex, rlCopyHistorySourceIpAddress=rlCopyHistorySourceIpAddress, rlCopyInetSourceIpAddressType=rlCopyInetSourceIpAddressType, rlCopyHistoryInetRowStatus=rlCopyHistoryInetRowStatus, rlCopyInBackground=rlCopyInBackground, RlCopyLocationType=RlCopyLocationType, rlCopySourceIpAddress=rlCopySourceIpAddress, rlCopyHistorySourceLocation=rlCopyHistorySourceLocation, rlCopyHistoryDestinationIpAddress=rlCopyHistoryDestinationIpAddress, rlCopyInetInBackground=rlCopyInetInBackground, rlCopyInetBytesTransferred=rlCopyInetBytesTransferred, rlCopyHistoryErrorMessage=rlCopyHistoryErrorMessage, rlCopyInetDestinationFileName=rlCopyInetDestinationFileName, rlCopyMibVersion=rlCopyMibVersion, rlCopyInetIndex=rlCopyInetIndex, rlCopyInetSourceFileName=rlCopyInetSourceFileName, rlCopyHistoryInetSourceUnitNumber=rlCopyHistoryInetSourceUnitNumber, RlCopyFileType=RlCopyFileType, rlCopyHistoryInetSourceFileType=rlCopyHistoryInetSourceFileType, rlCopySourceLocation=rlCopySourceLocation, rlCopyHistoryInetSourceFileName=rlCopyHistoryInetSourceFileName, rlCopyInetApplicationId=rlCopyInetApplicationId, rlCopyHistoryInetSourceIpAddressType=rlCopyHistoryInetSourceIpAddressType, rlCopyHistoryInetApplicationId=rlCopyHistoryInetApplicationId, rlCopyFailed=rlCopyFailed, rlCopyHistoryInetOperationState=rlCopyHistoryInetOperationState, rlCopyHistoryInetBytesTransferred=rlCopyHistoryInetBytesTransferred, rlCopyHistoryBytesTransferred=rlCopyHistoryBytesTransferred, rlCopyAuditingEnable=rlCopyAuditingEnable, rlCopyHistorySourceFileName=rlCopyHistorySourceFileName, rlCopyInetRowStatus=rlCopyInetRowStatus, rlCopyHistoryApplicationId=rlCopyHistoryApplicationId, rlCopyEntry=rlCopyEntry, rlCopyInetSourceUnitNumber=rlCopyInetSourceUnitNumber, rlCopyInetSourceFileType=rlCopyInetSourceFileType, rlCopyInetOperationState=rlCopyInetOperationState, rlCopyBytesTransferred=rlCopyBytesTransferred, rlCopyHistoryInetTable=rlCopyHistoryInetTable, rlCopyHistoryInetDestinationLocation=rlCopyHistoryInetDestinationLocation, PYSNMP_MODULE_ID=rlCopy, rlCopyUpTime=rlCopyUpTime, rlCopyHistoryDestinationFileName=rlCopyHistoryDestinationFileName, rlCopyHistoryInetDestinationIpAddressType=rlCopyHistoryInetDestinationIpAddressType, rlCopyInetDestinationLocation=rlCopyInetDestinationLocation, rlCopyHistoryTable=rlCopyHistoryTable, rlCopyHistoryInetSourceIpAddress=rlCopyHistoryInetSourceIpAddress, rlCopyApplicationId=rlCopyApplicationId, rlCopyHistoryInetSourceLocation=rlCopyHistoryInetSourceLocation, rlCopyHistoryRowStatus=rlCopyHistoryRowStatus, rlCopyHistoryInetEntry=rlCopyHistoryInetEntry, rlCopySWToUnits=rlCopySWToUnits, rlCopyMessagesEntry=rlCopyMessagesEntry, rlCopyHistoryUpTime=rlCopyHistoryUpTime, rlCopyMessagesCopyIndex=rlCopyMessagesCopyIndex, rlCopyInetSourceIpAddress=rlCopyInetSourceIpAddress, rlCopyHistoryInetUpTime=rlCopyHistoryInetUpTime, rlCopyDestinationFileType=rlCopyDestinationFileType, rlCopyHistoryDestinationLocation=rlCopyHistoryDestinationLocation, rlCopyInetTable=rlCopyInetTable, rlCopyMessagesStatus=rlCopyMessagesStatus, rlCopyHistoryInetDestinationFileName=rlCopyHistoryInetDestinationFileName, rlCopyHistoryInetDestinationUnitNumber=rlCopyHistoryInetDestinationUnitNumber, rlCopyHistorySourceUnitNumber=rlCopyHistorySourceUnitNumber, rlCopyDestinationIpAddress=rlCopyDestinationIpAddress, rlCopyDestinationUnitNumber=rlCopyDestinationUnitNumber, rlCopyOperationState=rlCopyOperationState, rlCopyMessagesMessageIndex=rlCopyMessagesMessageIndex, rlCopyInetEntry=rlCopyInetEntry, rlCopyHistoryInBackground=rlCopyHistoryInBackground, rlCopyRowStatus=rlCopyRowStatus, rlCopyDestinationLocation=rlCopyDestinationLocation, rlCopyInetSourceLocation=rlCopyInetSourceLocation, rlCopy=rlCopy, rlCopyHistoryHistoryIndex=rlCopyHistoryHistoryIndex, rlCopyHistoryInetDestinationFileType=rlCopyHistoryInetDestinationFileType, rlCopySourceUnitNumber=rlCopySourceUnitNumber, rlCopyHistoryDestinationUnitNumber=rlCopyHistoryDestinationUnitNumber, rlCopyDestinationFileName=rlCopyDestinationFileName, rlCopyIndex=rlCopyIndex, rlCopyInetDestinationIpAddress=rlCopyInetDestinationIpAddress, rlCopyHistoryDestinationFileType=rlCopyHistoryDestinationFileType, rlCopyHistoryIndex=rlCopyHistoryIndex, rlCopySWFinished=rlCopySWFinished, rlCopyInetDestinationIpAddressType=rlCopyInetDestinationIpAddressType, rlCopyUnitsList=rlCopyUnitsList, rlCopySourceFileType=rlCopySourceFileType, rlCopyHistoryInetDestinationIpAddress=rlCopyHistoryInetDestinationIpAddress, rlCopyHistoryInetErrorMessage=rlCopyHistoryInetErrorMessage, rlCopyMessagesMessageText=rlCopyMessagesMessageText, RlCopyApplicationType=RlCopyApplicationType, rlCopyHistoryInetInBackground=rlCopyHistoryInetInBackground, rlCopyInetUpTime=rlCopyInetUpTime, rlCopyHistorySourceFileType=rlCopyHistorySourceFileType, rlCopyTable=rlCopyTable, rlCopyInetHistoryIndex=rlCopyInetHistoryIndex, rlCopyInetDestinationFileType=rlCopyInetDestinationFileType, rlCopyHistoryEntry=rlCopyHistoryEntry)
