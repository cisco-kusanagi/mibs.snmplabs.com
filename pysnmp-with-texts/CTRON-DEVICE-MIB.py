...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/CTRON-DEVICE-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:29:46 2019
...
iso, TimeTicks, Counter64, MibIdentifier, ModuleIdentity, IpAddress, Integer32, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Counter32, ObjectIdentity, Gauge32, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "iso", "TimeTicks", "Counter64", "MibIdentifier", "ModuleIdentity", "IpAddress", "Integer32", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Counter32", "ObjectIdentity", "Gauge32", "NotificationType")
...
if mibBuilder.loadTexts: comDeviceIPAddress.setDescription('The Network address, in this case the IP address, of the device. This object is required for use by the Local Management Interface.')
