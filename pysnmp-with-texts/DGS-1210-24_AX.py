#
# PySNMP MIB module DGS-1210-24_AX (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DGS-1210-24_AX
# Produced by pysmi-0.3.4 at Wed May  1 12:42:52 2019
...
ModuleIdentity, Counter32, NotificationType, enterprises, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, ObjectIdentity, Counter64, MibIdentifier, iso, Bits, IpAddress, Gauge32, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "Counter32", "NotificationType", "enterprises", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "ObjectIdentity", "Counter64", "MibIdentifier", "iso", "Bits", "IpAddress", "Gauge32", "Unsigned32")
...
sysPortCtrlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 1, 13, 1), ).setIndexNames((0, "DGS-1210-24_AX", "sysPortCtrlIndex"))
...
stpPortEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 6, 2, 1), ).setIndexNames((0, "DGS-1210-24_AX", "stpPort"))
...
dot1qVlanEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 7, 6, 1), ).setIndexNames((0, "DGS-1210-24_AX", "dot1qVlanName"))
...
dot1dBasePortEntry.registerAugmentions(("DGS-1210-24_AX", "dot1qVlanPortEntry"))
...
dot1qVlanUngisterMCFilterEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 7, 8, 1), ).setIndexNames((0, "DGS-1210-24_AX", "dot1qVlanUngisterMCFilterVlanId"))
...
laPortChannelEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 8, 1, 3, 1), ).setIndexNames((0, "DGS-1210-24_AX", "laPortChannelIfIndex"))
...
laPortControlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 8, 2, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "laPortControlIndex"))
...
staticEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 9, 3, 1), ).setIndexNames((0, "DGS-1210-24_AX", "staticVlanID"), (0, "DGS-1210-24_AX", "staticMac"), (0, "DGS-1210-24_AX", "staticPort"))
...
igsVlanRouterEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 10, 3, 3, 1), ).setIndexNames((0, "DGS-1210-24_AX", "igsVlanRouterVlanId"))
...
igsVlanFilterEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 10, 3, 4, 1), ).setIndexNames((0, "DGS-1210-24_AX", "igsVlanFilterVlanId"))
...
igsVlanMulticastGroupEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 10, 3, 5, 1), ).setIndexNames((0, "DGS-1210-24_AX", "igsVlanMulticastGroupVlanId"), (0, "DGS-1210-24_AX", "igsVlanMulticastGroupIpAddress"))
...
dot1xAuthConfigPortEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 11, 2, 9, 1), ).setIndexNames((0, "DGS-1210-24_AX", "dot1xAuthConfigPortNumber"))
...
dot1pPortEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 12, 3, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "dot1pPortIndex"))
...
bandwidthCtrlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 13, 1, 2, 1), ).setIndexNames((0, "DGS-1210-24_AX", "bandwidthCtrlIndex"))
...
trustedHostEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 14, 1, 2, 1), ).setIndexNames((0, "DGS-1210-24_AX", "trustedHostIpAddr"), (0, "DGS-1210-24_AX", "trustedHostIpMask"))
...
aRPSpoofPreventEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 14, 3, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "aRPSpoofPreventIpAddr"))
...
portSecEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 14, 2, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "portSecIndex"))
...
aclProfileEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 15, 1, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "aclProfileNo"))
...
aclProfileType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 15, 1, 1, 1, 2), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(1, 2, 4, 5, 6))).clone(namedValues=NamedValues(("l2", 1), ("l3", 2), ("arpSP_permit", 4), ("arpSP_deny", 5), ("voiceVlan", 6)))).setMaxAccess("readwrite")
...
aclL2RuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 15, 2, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "aclL2AccessID"), (0, "DGS-1210-24_AX", "aclL2ProfileID"))
...
aclL3RuleEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 15, 3, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "aclL3RuleAccessID"), (0, "DGS-1210-24_AX", "aclL3RuleProfileNo"))
...
aclL3RuleTcpAckBit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 15, 3, 1, 1, 14), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(-1, 1, 2))).clone(namedValues=NamedValues(("dont_care", -1), ("establish", 1), ("notEstablish", 2))).clone('dont_care')).setMaxAccess("readcreate")
...
aclL3RuleTcpRstBit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 15, 3, 1, 1, 15), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(-1, 1, 2))).clone(namedValues=NamedValues(("dont_care", -1), ("establish", 1), ("notEstablish", 2))).clone('dont_care')).setMaxAccess("readcreate")
...
aclL3RuleTcpUrgBit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 15, 3, 1, 1, 16), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(-1, 1, 2))).clone(namedValues=NamedValues(("dont_care", -1), ("establish", 1), ("notEstablish", 2))).clone('dont_care')).setMaxAccess("readcreate")
...
aclL3RuleTcpPshBit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 15, 3, 1, 1, 17), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(-1, 1, 2))).clone(namedValues=NamedValues(("dont_care", -1), ("establish", 1), ("notEstablish", 2))).clone('dont_care')).setMaxAccess("readcreate")
...
aclL3RuleTcpSynBit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 15, 3, 1, 1, 18), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(-1, 1, 2))).clone(namedValues=NamedValues(("dont_care", -1), ("establish", 1), ("notEstablish", 2))).clone('dont_care')).setMaxAccess("readcreate")
...
aclL3RuleTcpFinBit = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 15, 3, 1, 1, 19), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(-1, 1, 2))).clone(namedValues=NamedValues(("dont_care", -1), ("establish", 1), ("notEstablish", 2))).clone('dont_care')).setMaxAccess("readcreate")
...
snmpV3UserEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 25, 2, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "snmpV3UserName"), (0, "DGS-1210-24_AX", "snmpV3UserVersion"))
...
snmpV3GroupEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 25, 3, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "snmpV3GroupName"), (0, "DGS-1210-24_AX", "snmpV3GroupSecurityModel"), (0, "DGS-1210-24_AX", "snmpV3GroupSecurityLevel"))
...
snmpV3ViewTreeEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 25, 4, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "snmpV3viewTreeName"), (0, "DGS-1210-24_AX", "snmpV3viewTreeSubtree"))
...
snmpV3CommunityEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 25, 5, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "snmpV3CommunityName"))
...
snmpV3HostEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 25, 6, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "snmpV3HostAddress"))
...
sysLBDCtrlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 17, 4, 1), ).setIndexNames((0, "DGS-1210-24_AX", "sysLBDCtrlIndex"))
...
voicevlanPortControlEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 21, 1, 6, 1), ).setIndexNames((0, "DGS-1210-24_AX", "voicevlanPortControlIndex"))
...
voicevlanOUIEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 21, 2, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "voicevlanOUITelephonyOUI"))
...
autoSurveillanceVlanOUIEntry = MibTableRow((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 26, 2, 1, 1), ).setIndexNames((0, "DGS-1210-24_AX", "autoSurveillanceVlanOUISurveillanceOUI"))
...
autoSurveillanceVlanOUIComponentType = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 10, 76, 10, 26, 2, 1, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 2, 3, 4, 5))).clone(namedValues=NamedValues(("video_Management_Server", 0), ("vMS_Client", 1), ("video_Encoder", 2), ("network_Storage", 3), ("other_IP_Surveillance_Devices", 4), ("d-Link_Surveillance_Device", 5)))).setMaxAccess("readwrite")
...
mibBuilder.exportSymbols("DGS-1210-24_AX", stpPortEdge=stpPortEdge, portSecState=portSecState, staticTable=staticTable, aclProfileSrcPortMask=aclProfileSrcPortMask, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, aclL2Rule=aclL2Rule, aclL3RuleDstIpAddr=aclL3RuleDstIpAddr, sysDhcpAutoConfiguration=sysDhcpAutoConfiguration, qosDiffServType60=qosDiffServType60, igsVlan=igsVlan, igsVlanRouterPortList=igsVlanRouterPortList, aclL2RuleDstMacAddrMask=aclL2RuleDstMacAddrMask, securitySSL=securitySSL, voicevlanPortAutoDetection=voicevlanPortAutoDetection, companySyslog=companySyslog, sysSNTPFirstServer=sysSNTPFirstServer, qosDiffServType34=qosDiffServType34, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, syslogTimeStamp=syslogTimeStamp, sysGroupInterval=sysGroupInterval, aRPSpoofPreventMacAddress=aRPSpoofPreventMacAddress, aclProfileArpSenderMacAddrMask=aclProfileArpSenderMacAddrMask, snmpV3TrapBootup=snmpV3TrapBootup, sysPortCtrlFlowControlOper=sysPortCtrlFlowControlOper, aclL3RuleTcpUdpSrcPortMask=aclL3RuleTcpUdpSrcPortMask, sysLBDCtrlIndex=sysLBDCtrlIndex, qosDiffServType10=qosDiffServType10, snmpV3CommunityEntry=snmpV3CommunityEntry, aclProfile=aclProfile, PortLaMode=PortLaMode, companyRSTP=companyRSTP, broadcastStormCtrlSettings=broadcastStormCtrlSettings, companyIgsGroup=companyIgsGroup, aclL2RuleDstMacAddr=aclL2RuleDstMacAddr, stpTopChanges=stpTopChanges, radiusServerAddress=radiusServerAddress, stpPortState=stpPortState, snmpV3TrapFiberLinkUpDown=snmpV3TrapFiberLinkUpDown, staticAutoLearningList=staticAutoLearningList, snmpV3CommunityTable=snmpV3CommunityTable, igsHostPortPurgeInterval=igsHostPortPurgeInterval, sysLocationName=sysLocationName, voiceVlanMode=voiceVlanMode, portSecMLA=portSecMLA, dot1qVlanAsyOnOff=dot1qVlanAsyOnOff, qosDiffServType52=qosDiffServType52, sysSNTPDSTEndDay=sysSNTPDSTEndDay, stpHelloTime=stpHelloTime, qosDiffServType35=qosDiffServType35, qosDiffServType12=qosDiffServType12, snmpV3ViewTreeEntry=snmpV3ViewTreeEntry, qosDiffServType03=qosDiffServType03, tftpFwTftpOperation=tftpFwTftpOperation, stpProtocolSpecification=stpProtocolSpecification, aclL3RuleStatus=aclL3RuleStatus, sysSNTPDSTEndMon=sysSNTPDSTEndMon, qosDiffServType18=qosDiffServType18, igsSystem=igsSystem, qosDiffServEnable=qosDiffServEnable, trustedHostIpAddr=trustedHostIpAddr, stpPortPathCost=stpPortPathCost, dot1qVlanUngisterMCFilterTable=dot1qVlanUngisterMCFilterTable, trustedHostIpMask=trustedHostIpMask, snmpV3GroupSecurityLevel=snmpV3GroupSecurityLevel, aclL3RuleTcpUdpDstPortMask=aclL3RuleTcpUdpDstPortMask, companyTftpGroup=companyTftpGroup, aclL3RuleICMPMessageType=aclL3RuleICMPMessageType, dgs_1210_24ax=dgs_1210_24ax, aclProfileArpSenderIpAddrMask=aclProfileArpSenderIpAddrMask, stpBridgeHelloTime=stpBridgeHelloTime, qosDiffServType08=qosDiffServType08, sysJumboFrameEnable=sysJumboFrameEnable, qosDiffServType15=qosDiffServType15, laSystem=laSystem, qosDiffServType39=qosDiffServType39, securityTrustedHost=securityTrustedHost, snmpV3CommunityStatus=snmpV3CommunityStatus, autoSurveillanceVlanOUIDescription=autoSurveillanceVlanOUIDescription, companyAutoSurveillanceVlan=companyAutoSurveillanceVlan, qosDiffServType62=qosDiffServType62, stpGlobal=stpGlobal, sysMirrorCtrlIngressMirroring=sysMirrorCtrlIngressMirroring, stpPortTable=stpPortTable, firmwareIllegalFile=firmwareIllegalFile, sysSNTPState=sysSNTPState, sslCipherSuiteList=sslCipherSuiteList, sysTrapStatus=sysTrapStatus, laPortControlIndex=laPortControlIndex, stpPortOperEdgePort=stpPortOperEdgePort, aclL2RuleTable=aclL2RuleTable, bandwidthCtrlTable=bandwidthCtrlTable, aclProfileStatus=aclProfileStatus, companyQoSGroup=companyQoSGroup, snmpV3HostCommunityName=snmpV3HostCommunityName, snmpV3viewTreeName=snmpV3viewTreeName, qosDiffServType47=qosDiffServType47, aclL3RuleICMPMessageCode=aclL3RuleICMPMessageCode, sysPowerSavingEnable=sysPowerSavingEnable, dot1xAuth=dot1xAuth, igsQueryInterval=igsQueryInterval, tftpConfigTftpOperation=tftpConfigTftpOperation, stpPriority=stpPriority, qosDiffServType25=qosDiffServType25, sysSNTPDSTStartMon=sysSNTPDSTStartMon, queuingMechanism=queuingMechanism, laPortActorActivity=laPortActorActivity, voicevlanOUIEntry=voicevlanOUIEntry, firmwareChecksumError=firmwareChecksumError, bandwidthCtrlTxThreshold=bandwidthCtrlTxThreshold, dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, stpTxHoldCount=stpTxHoldCount, dot1qVlanUngisterMCFilterEntry=dot1qVlanUngisterMCFilterEntry, companyTrafficMgmt=companyTrafficMgmt, qosDiffServType14=qosDiffServType14, igsVlanFilterTable=igsVlanFilterTable, qosDiffServType19=qosDiffServType19, snmpV3EngineID=snmpV3EngineID, qosDiffServType13=qosDiffServType13, dot1pPortPriority=dot1pPortPriority, sysTrapFiberPortEvent=sysTrapFiberPortEvent, snmpV3GroupEntry=snmpV3GroupEntry, qosDiffServType06=qosDiffServType06, snmpV3GroupWriteViewName=snmpV3GroupWriteViewName, companyDot1xGroup=companyDot1xGroup, dot1xAuthTxPeriod=dot1xAuthTxPeriod, dot1xAuthStatus=dot1xAuthStatus, qosDiffServType46=qosDiffServType46, sysMirrorCtrlEgressMirroring=sysMirrorCtrlEgressMirroring, snmpV3UserGroupName=snmpV3UserGroupName, dlink_DGS1210SeriesProd=dlink_DGS1210SeriesProd, stpMaxAge=stpMaxAge, qosDiffServType24=qosDiffServType24, aRPSpoofPreventRowStatus=aRPSpoofPreventRowStatus, autoSurveillanceVlanOUIEntry=autoSurveillanceVlanOUIEntry, qosDiffServType16=qosDiffServType16, aclProfileNo=aclProfileNo, aclProfileMask=aclProfileMask, qosDiffServType59=qosDiffServType59, LacpKey=LacpKey, aclL3RuleSrcIpAddr=aclL3RuleSrcIpAddr, snmpV3UserName=snmpV3UserName, sysTrapFirmUpgradeEvent=sysTrapFirmUpgradeEvent, sysSafeGuardEnable=sysSafeGuardEnable, staticMac=staticMac, aclL2AccessID=aclL2AccessID, dhcpServerScreenEnablePortlist=dhcpServerScreenEnablePortlist, voicevlanOUIMask=voicevlanOUIMask, tftpFwImageFileName=tftpFwImageFileName, voiceVlanId=voiceVlanId, voicevlanOUI=voicevlanOUI, snmpV3UserPrivProtocolPassword=snmpV3UserPrivProtocolPassword, qosDiffServType22=qosDiffServType22, snmpV3HostStatus=snmpV3HostStatus, snmpGlobalState=snmpGlobalState, voicevlanPortControlTable=voicevlanPortControlTable, igsVlanFilterEntry=igsVlanFilterEntry, autoSurveillanceVlanOUITable=autoSurveillanceVlanOUITable, sysSNTPDSTEndHour=sysSNTPDSTEndHour, sysLBDCtrlEntry=sysLBDCtrlEntry, sslSecurityHttpStatus=sslSecurityHttpStatus, qosDiffServ=qosDiffServ, aRPSpoofPreventTable=aRPSpoofPreventTable, stpPortEntry=stpPortEntry, aclL2RuleSrcMacAddr=aclL2RuleSrcMacAddr, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, sysPortCtrlSpeed=sysPortCtrlSpeed, sysMirrorStatus=sysMirrorStatus, laPortControlTable=laPortControlTable, qosDiffServType55=qosDiffServType55, traps=traps, staticDisableAutoLearn=staticDisableAutoLearn, sysRestart=sysRestart, sysSwitchName=sysSwitchName, qosDiffServType33=qosDiffServType33, snmpV3Host=snmpV3Host, snmpV3TrapCopperLinkUpDown=snmpV3TrapCopperLinkUpDown, igsQueryMaxResponseTime=igsQueryMaxResponseTime, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, qosDiffServType58=qosDiffServType58, aclL2RuleStatus=aclL2RuleStatus, qosDiffServType51=qosDiffServType51, snmpV3UserAuthProtocol=snmpV3UserAuthProtocol, aRPSpoofPreventIpAddr=aRPSpoofPreventIpAddr, stpDesignatedRoot=stpDesignatedRoot, dot1qVlanManagementOnOff=dot1qVlanManagementOnOff, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, dot1pPortIndex=dot1pPortIndex, laPortControlEntry=laPortControlEntry, dot1qVlanUngisterMCFilterVlanId=dot1qVlanUngisterMCFilterVlanId, sysHardwareVersion=sysHardwareVersion, stpPortRestrictedRole=stpPortRestrictedRole, igsVlanMulticastGroupVlanId=igsVlanMulticastGroupVlanId, aclProfileDstMacAddrMask=aclProfileDstMacAddrMask, staticPort=staticPort, companyTrapSetting=companyTrapSetting, sysSNTPDSTStartHour=sysSNTPDSTStartHour, igsVlanRouterEntry=igsVlanRouterEntry, tftpCfgServerIpAddress=tftpCfgServerIpAddress, companyIpifGroup=companyIpifGroup, aclL3RuleIgmpType=aclL3RuleIgmpType, companyTraps=companyTraps, tftpFwTftpOperationStatus=tftpFwTftpOperationStatus, snmpV3Community=snmpV3Community, qosDiffServType30=qosDiffServType30, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, companyMiscGroup=companyMiscGroup, staticEntry=staticEntry, laPortActorPortPriority=laPortActorPortPriority, sslCiphers=sslCiphers, stpPortEnable=stpPortEnable, voicevlanSystem=voicevlanSystem, snmpV3viewTreeStatus=snmpV3viewTreeStatus, sysIpSubnetMask=sysIpSubnetMask, laPortChannelEntry=laPortChannelEntry, qosDiffServType01=qosDiffServType01, securityDhcpServerScreen=securityDhcpServerScreen, stpPortDesignatedPort=stpPortDesignatedPort, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, sysSave=sysSave, sysSNTPSecondServer=sysSNTPSecondServer, voiceVlanTimeout=voiceVlanTimeout, trustedHostStatus=trustedHostStatus, autoSurveillanceVlanPriority=autoSurveillanceVlanPriority, snmpV3HostVersion=snmpV3HostVersion, aclL2RuleVlanId=aclL2RuleVlanId, aclL3RuleDstIpAddrMask=aclL3RuleDstIpAddrMask, qosDiffServType61=qosDiffServType61, snmpV3CommunityPolicy=snmpV3CommunityPolicy, qosDiffServTypeGroup=qosDiffServTypeGroup, autoSurveillanceVlanOUIComponentType=autoSurveillanceVlanOUIComponentType, aclL3RuleAction=aclL3RuleAction, snmpV3viewTreeType=snmpV3viewTreeType, voicevlanOUIDescription=voicevlanOUIDescription, qosDiffServType17=qosDiffServType17, companySNMPV3=companySNMPV3, dot1qVlanPvid=dot1qVlanPvid, igsStatus=igsStatus, qosDiffServType48=qosDiffServType48, sysTrapIP=sysTrapIP, snmpV3GroupStatus=snmpV3GroupStatus, trustedHostRowStatus=trustedHostRowStatus, igsVlanFilterVlanId=igsVlanFilterVlanId, aclProfileType=aclProfileType, stpPort=stpPort, VlanIndex=VlanIndex, aclL2RuleInPortList=aclL2RuleInPortList, portSecTable=portSecTable, snmpV3UserPrivProtocol=snmpV3UserPrivProtocol, aclProfileDstPortMask=aclProfileDstPortMask, sysSNTPGMTMinutes=sysSNTPGMTMinutes, companySNTPSetting=companySNTPSetting, qosDiffServType20=qosDiffServType20, stpPortDesignatedRoot=stpPortDesignatedRoot, sysSNTPDSTOffset=sysSNTPDSTOffset)
mibBuilder.exportSymbols("DGS-1210-24_AX", snmpV3TrapSNMPAuthentication=snmpV3TrapSNMPAuthentication, sysFirmwareVersion=sysFirmwareVersion, laPortActorTimeout=laPortActorTimeout, snmpV3UserVersion=snmpV3UserVersion, aclL3RuleProtocol=aclL3RuleProtocol, aclProfileTable=aclProfileTable, aclL2RuleEtherType=aclL2RuleEtherType, miscStatisticsReset=miscStatisticsReset, qosDiffServType31=qosDiffServType31, securityARPSpoofPrevent=securityARPSpoofPrevent, qosDiffServType44=qosDiffServType44, aclL3RuleTcpAckBit=aclL3RuleTcpAckBit, sysPortCtrlEntry=sysPortCtrlEntry, sysLBDInterval=sysLBDInterval, qosDiffServType45=qosDiffServType45, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, companyLBD=companyLBD, companySecurity=companySecurity, sysTrapSystemEvent=sysTrapSystemEvent, aclL3RuleTcpSynBit=aclL3RuleTcpSynBit, snmpV3TrapFirmUpgrade=snmpV3TrapFirmUpgrade, dlink_products=dlink_products, dot1qVlanPortTable=dot1qVlanPortTable, securityPortSecurity=securityPortSecurity, qosDiffServType63=qosDiffServType63, sysPortCtrlMDI=sysPortCtrlMDI, snmpV3UserEntry=snmpV3UserEntry, snmpV3UserStatus=snmpV3UserStatus, stpBridgeForwardDelay=stpBridgeForwardDelay, bandwidthCtrlEntry=bandwidthCtrlEntry, snmpV3Trap=snmpV3Trap, laStatus=laStatus, tftpFwServerIpAddress=tftpFwServerIpAddress, qosDiffServType04=qosDiffServType04, aclL3RuleTcpPshBit=aclL3RuleTcpPshBit, qosDiffServType11=qosDiffServType11, autoSurveillanceVlanSystem=autoSurveillanceVlanSystem, igsVlanSnoopStatus=igsVlanSnoopStatus, igsVlanRouterVlanId=igsVlanRouterVlanId, stpPortPriority=stpPortPriority, companyLA=companyLA, companyVoiceVlan=companyVoiceVlan, autoSurveillanceVlanOUIMask=autoSurveillanceVlanOUIMask, syslogLogging=syslogLogging, aclProfileRuleCount=aclProfileRuleCount, PortList=PortList, dot1qVlanForbiddenPorts=dot1qVlanForbiddenPorts, laPortChannelMemberList=laPortChannelMemberList, qosDiffServType05=qosDiffServType05, sysLBDPortLoopStatus=sysLBDPortLoopStatus, miscReset=miscReset, aclL2RuleAction=aclL2RuleAction, sysSystemPassword=sysSystemPassword, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, staticStatus=staticStatus, portSecEntry=portSecEntry, snmpV3GroupName=snmpV3GroupName, qosDiffServType50=qosDiffServType50, aRPSpoofPreventEntry=aRPSpoofPreventEntry, sysPortCtrlType=sysPortCtrlType, voiceVlanPriority=voiceVlanPriority, aclL3RuleAccessID=aclL3RuleAccessID, aclL2RuleEntry=aclL2RuleEntry, snmpV3UserAuthProtocolPassword=snmpV3UserAuthProtocolPassword, dot1xAuthMaxReq=dot1xAuthMaxReq, igsVlanQueryInterval=igsVlanQueryInterval, qosDiffServType40=qosDiffServType40, sysIpAddrCfgMode=sysIpAddrCfgMode, syslogFacility=syslogFacility, d_link=d_link, qosDiffServType02=qosDiffServType02, igsVlanMulticastGroupPortList=igsVlanMulticastGroupPortList, tftpConfigTftpOperationStatus=tftpConfigTftpOperationStatus, rstpStatus=rstpStatus, stpPortRestrictedTCN=stpPortRestrictedTCN, qosQ1p=qosQ1p, qosDiffServType49=qosDiffServType49, stpPortProtocolMigration=stpPortProtocolMigration, sysTrapStateChangeEvent=sysTrapStateChangeEvent, qosDiffServType28=qosDiffServType28, qosDiffServType56=qosDiffServType56, snmpV3GroupReadViewName=snmpV3GroupReadViewName, qosDiffServType57=qosDiffServType57, qosDiffServType32=qosDiffServType32, syslogUDPPort=syslogUDPPort, snmpV3TrapRSTPStateChange=snmpV3TrapRSTPStateChange, sysPortCtrlFlowControl=sysPortCtrlFlowControl, qosDiffServType41=qosDiffServType41, voicevlanPortControlIndex=voicevlanPortControlIndex, snmpV3User=snmpV3User, igsVlanCfgQuerier=igsVlanCfgQuerier, sysLBDStateEnable=sysLBDStateEnable, stpPortDesignatedBridge=stpPortDesignatedBridge, qosDiffServType27=qosDiffServType27, sysPortCtrlOperStatus=sysPortCtrlOperStatus, syslogSeverity=syslogSeverity, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, aclL2RuleSrcMacAddrMask=aclL2RuleSrcMacAddrMask, tftpConfigFileName=tftpConfigFileName, sysTrapTwistedPortEvent=sysTrapTwistedPortEvent, sysSNTPPollInterval=sysSNTPPollInterval, dot1qVlanName=dot1qVlanName, dot1qVlanRowStatus=dot1qVlanRowStatus, autoSurveillanceVlanMode=autoSurveillanceVlanMode, dot1pPortTable=dot1pPortTable, snmpV3UserTable=snmpV3UserTable, qosMode=qosMode, igsVlanMulticastGroupEntry=igsVlanMulticastGroupEntry, staticVlanID=staticVlanID, BridgeId=BridgeId, portSecIndex=portSecIndex, igsVlanRtrPortList=igsVlanRtrPortList, dot1pPortEntry=dot1pPortEntry, igsVlanQuerier=igsVlanQuerier, qosDiffServType37=qosDiffServType37, broadcastStormCtrlLimitType=broadcastStormCtrlLimitType, radius=radius, laPortChannelTable=laPortChannelTable, autoSurveillanceVlanOUIStatus=autoSurveillanceVlanOUIStatus, stpPortOperPointToPoint=stpPortOperPointToPoint, snmpV3HostEntry=snmpV3HostEntry, stpPortDesignatedCost=stpPortDesignatedCost, broadcastStormCtrlThreshold=broadcastStormCtrlThreshold, aclL3RuleTcpFinBit=aclL3RuleTcpFinBit, Timeout=Timeout, sysLBDCtrlTable=sysLBDCtrlTable, firmwareTransferError=firmwareTransferError, aclL3RuleDscp=aclL3RuleDscp, sysLoginTimeoutInterval=sysLoginTimeoutInterval, qosDiffServType29=qosDiffServType29, igsGrpQueryInterval=igsGrpQueryInterval, dot1qVlanTable=dot1qVlanTable, autoSurveillanceVlanOUI=autoSurveillanceVlanOUI, stpPortForwardTransitions=stpPortForwardTransitions, bandwidthCtrlIndex=bandwidthCtrlIndex, aclL3RuleEntry=aclL3RuleEntry, stpVersion=stpVersion, sysLBDPortStatus=sysLBDPortStatus, igsVlanRouterTable=igsVlanRouterTable, companyDot1qVlanGroup=companyDot1qVlanGroup, dot1xAuthServerTimeout=dot1xAuthServerTimeout, dot1qVlanEgressPorts=dot1qVlanEgressPorts, laPortChannelMode=laPortChannelMode, dot1qVlanManagementid=dot1qVlanManagementid, bandwidthCtrlRxThreshold=bandwidthCtrlRxThreshold, aclL2Rule1pPriority=aclL2Rule1pPriority, dot1qVlanUntaggedPorts=dot1qVlanUntaggedPorts, qosDiffServType42=qosDiffServType42, aclL3RuleTcpUdpDstPort=aclL3RuleTcpUdpDstPort, voicevlanPortControlEntry=voicevlanPortControlEntry, sysSNTPDSTEndMin=sysSNTPDSTEndMin, qosDiffServType26=qosDiffServType26, companyStaticMAC=companyStaticMAC, aclProfileIPProtocol=aclProfileIPProtocol, aclProfileSrcMacAddrMask=aclProfileSrcMacAddrMask, snmpV3ViewTreeTable=snmpV3ViewTreeTable, stpPortAdminPointToPoint=stpPortAdminPointToPoint, aclL3RuleTcpRstBit=aclL3RuleTcpRstBit, aclL3RuleTcpUrgBit=aclL3RuleTcpUrgBit, aclL3RuleTcpUdpSrcPort=aclL3RuleTcpUdpSrcPort, igsVlanMulticastGroupIpAddress=igsVlanMulticastGroupIpAddress, snmpV3HostTable=snmpV3HostTable, aclL2ProfileID=aclL2ProfileID, snmpV3GroupTable=snmpV3GroupTable, dot1qVlanUngisterMCFiltermode=dot1qVlanUngisterMCFiltermode, qosDiffServType09=qosDiffServType09, autoSurveillanceVlanId=autoSurveillanceVlanId, stpForwardDelay=stpForwardDelay, sysSNTPDSTStartDay=sysSNTPDSTStartDay, igsRobustnessValue=igsRobustnessValue, qosDiffServType00=qosDiffServType00, sysLBDRecoverTime=sysLBDRecoverTime, igsVlanMulticastGroupTable=igsVlanMulticastGroupTable, qosDiffServType23=qosDiffServType23, firmwareUpgradeSuccess=firmwareUpgradeSuccess, qosDiffServType36=qosDiffServType36, snmpV3GroupNotifyViewName=snmpV3GroupNotifyViewName, sysPortCtrlTable=sysPortCtrlTable, snmpV3viewTreeSubtree=snmpV3viewTreeSubtree, companyACLGroup=companyACLGroup, dot1qVlanPortEntry=dot1qVlanPortEntry, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, aclL3Rule=aclL3Rule, snmpV3ViewTree=snmpV3ViewTree, bandwidthCtrlSettings=bandwidthCtrlSettings, aclL3RuleProfileNo=aclL3RuleProfileNo, voicevlanPortState=voicevlanPortState, sysSNTPDSTStartMin=sysSNTPDSTStartMin, igsVlanMulticastGroupMacAddress=igsVlanMulticastGroupMacAddress, aclL3RuleTable=aclL3RuleTable, companyMirror=companyMirror, syslogLogSrvAddr=syslogLogSrvAddr, aclProfileDstIpAddrMask=aclProfileDstIpAddrMask, dot1qVlanEntry=dot1qVlanEntry, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, qosDiffServType38=qosDiffServType38, aclL3RuleSrcIpAddrMask=aclL3RuleSrcIpAddrMask, snmpV3CommunityName=snmpV3CommunityName, qosDiffServType53=qosDiffServType53, sysMirrorTargetPort=sysMirrorTargetPort, sysSNTPDSTState=sysSNTPDSTState, sysGateway=sysGateway, voicevlanOUITable=voicevlanOUITable, stpHoldTime=stpHoldTime, sysPortCtrlIndex=sysPortCtrlIndex, snmpV3GroupSecurityModel=snmpV3GroupSecurityModel, qosDiffServType43=qosDiffServType43, aclProfileEntry=aclProfileEntry, snmpV3viewTreeMask=snmpV3viewTreeMask, aRPSpoofPreventPortList=aRPSpoofPreventPortList, sysSNTPTimeSeconds=sysSNTPTimeSeconds, topologyChange=topologyChange, firmwareUpgradeFailure=firmwareUpgradeFailure, voicevlanOUIStatus=voicevlanOUIStatus, laPortChannelIfIndex=laPortChannelIfIndex, trustedHostTable=trustedHostTable, qosDiffServType07=qosDiffServType07, trustedHostEntry=trustedHostEntry, syslogGeneralGroup=syslogGeneralGroup, stpRootPort=stpRootPort, autoSurveillanceVlanOUISurveillanceOUI=autoSurveillanceVlanOUISurveillanceOUI, qosDiffServType21=qosDiffServType21, radiusServerSharedSecret=radiusServerSharedSecret, stpAdminPortPathCost=stpAdminPortPathCost, aclProfileSrcIpAddrMask=aclProfileSrcIpAddrMask, stpBridgeMaxAge=stpBridgeMaxAge, snmpV3Group=snmpV3Group, stpRootCost=stpRootCost, companySystem=companySystem, aclL3RulePortList=aclL3RulePortList, stpTimeSinceTopologyChange=stpTimeSinceTopologyChange, qosDiffServType54=qosDiffServType54, snmpV3HostAddress=snmpV3HostAddress, laPortControl=laPortControl, sysIpAddr=sysIpAddr, voicevlanOUITelephonyOUI=voicevlanOUITelephonyOUI)
