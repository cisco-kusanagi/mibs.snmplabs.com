...
# Produced by pysmi-0.3.4 at Wed May  1 12:42:34 2019
...
Integer32, Unsigned32, Counter64, IpAddress, TimeTicks, Bits, ObjectIdentity, enterprises, Gauge32, Counter32, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, MibIdentifier, iso, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "Integer32", "Unsigned32", "Counter64", "IpAddress", "TimeTicks", "Bits", "ObjectIdentity", "enterprises", "Gauge32", "Counter32", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "MibIdentifier", "iso", "ModuleIdentity")
...
if mibBuilder.loadTexts: poePortLegacyPDDetect.setDescription('Enable/Disable Legacy PD Detect function on this port.')
...
mibBuilder.exportSymbols("DGS-1210-10P_CX", dlinklldpAntiRoguePortStatus=dlinklldpAntiRoguePortStatus, snmpV3HostVersion=snmpV3HostVersion, laPortActorActivity=laPortActorActivity, aRPSpoofPreventPortList=aRPSpoofPreventPortList, companySystem=companySystem, mldsSystem=mldsSystem, companyRMON=companyRMON, neighborEntry=neighborEntry, sshConnectionTimeout=sshConnectionTimeout, sysPortCtrlEntry=sysPortCtrlEntry, dlinklldpTxDelay=dlinklldpTxDelay, poeSystemSettingDisconnectMethod=poeSystemSettingDisconnectMethod, topologyChange=topologyChange, snmpV3UserEntry=snmpV3UserEntry, aclL3v6RuleDstIpv6Addr=aclL3v6RuleDstIpv6Addr, sysSNTPFirstType=sysSNTPFirstType, qosTOSType03=qosTOSType03, laStatus=laStatus, companyDHCPLocalRelay=companyDHCPLocalRelay, staticAutoLearningList=staticAutoLearningList, sysLBDCtrlEntry=sysLBDCtrlEntry, sshAuthenMethodPassWordAdmin=sshAuthenMethodPassWordAdmin, pethPsePortPowerBudget=pethPsePortPowerBudget, swAuthRadiusIPType=swAuthRadiusIPType, rmonAlarmStatus=rmonAlarmStatus, qosDiffServType27=qosDiffServType27, dhcpv6RelayOption37CheckState=dhcpv6RelayOption37CheckState, stpPortRestrictedRole=stpPortRestrictedRole, mldsVlanMulticastGroupPortList=mldsVlanMulticastGroupPortList, igsVlanCfgQuerier=igsVlanCfgQuerier, aclL3v6RuleTable=aclL3v6RuleTable, dhcpLocalRelayTable=dhcpLocalRelayTable, sysSNTPGMTMinutes=sysSNTPGMTMinutes, dot1qVlanEgressPorts=dot1qVlanEgressPorts, sysLBDStateEnable=sysLBDStateEnable, aclL3v4ExtRuleReplacePriority=aclL3v4ExtRuleReplacePriority, dlinklldpMsgHoldMultiplier=dlinklldpMsgHoldMultiplier, impbWhiteListEntry=impbWhiteListEntry, syslogGeneralGroup=syslogGeneralGroup, autoSurveillanceVlanSystem=autoSurveillanceVlanSystem, companyStaticMAC=companyStaticMAC, securityIpMacPortBinding=securityIpMacPortBinding, staticMcastEgressPorts=staticMcastEgressPorts, pethPsePortPowerConsumption=pethPsePortPowerConsumption, rmonAlarmEntry=rmonAlarmEntry, qosDiffServType53=qosDiffServType53, bandwidthCtrlSettings=bandwidthCtrlSettings, rmonEventTable=rmonEventTable, snmpV3HostStatus=snmpV3HostStatus, rmonEventOwner=rmonEventOwner, snmpV3UserAuthProtocolPassword=snmpV3UserAuthProtocolPassword, companyQoSGroup=companyQoSGroup, sysLoginTimeoutInterval=sysLoginTimeoutInterval, aclL3v4ExtRuleTcpUdpSrcPortMask=aclL3v4ExtRuleTcpUdpSrcPortMask, impbSettingTable=impbSettingTable, swAuthRadiusServerAuthenticationPort=swAuthRadiusServerAuthenticationPort, Timeout=Timeout, swAuthPortAccessControlEntry=swAuthPortAccessControlEntry, rmonHistoryOwner=rmonHistoryOwner, stpTimeSinceTopologyChange=stpTimeSinceTopologyChange, snmpV3viewTreeName=snmpV3viewTreeName, sshUserInfoID=sshUserInfoID, neighborIPv6Addr=neighborIPv6Addr, qosDiffServ=qosDiffServ, autoSurveillanceVlanOUIMask=autoSurveillanceVlanOUIMask, aclL3v6RuleICMPv6MessageCode=aclL3v6RuleICMPv6MessageCode, swAuthUserTable=swAuthUserTable, broadcastStormCtrlSettings=broadcastStormCtrlSettings, aclL3v6RuleTcpUdpSrcPortMask=aclL3v6RuleTcpUdpSrcPortMask, dlinkGreenLEDShutoffPortList=dlinkGreenLEDShutoffPortList, dhcpRelayInterfaceSettingsRowStatus=dhcpRelayInterfaceSettingsRowStatus, cableDiagTriggerIndex=cableDiagTriggerIndex, aclL3v6RuleAction=aclL3v6RuleAction, voicevlanOUIMask=voicevlanOUIMask, dhcpRelayServerIP=dhcpRelayServerIP, impbBlackListPort=impbBlackListPort, ipifName=ipifName, sshUserInfoHostIpv6=sshUserInfoHostIpv6, sslCiphers=sslCiphers, companyACLGroup=companyACLGroup, dot1qVlanRowStatus=dot1qVlanRowStatus, aRPSpoofPreventMacAddress=aRPSpoofPreventMacAddress, aclL3v4RuleStatus=aclL3v4RuleStatus, snmpV3GroupReadViewName=snmpV3GroupReadViewName, igsVlanMulticastGroupMacAddress=igsVlanMulticastGroupMacAddress, snmpV3CommunityStatus=snmpV3CommunityStatus, swTimeRangeDate=swTimeRangeDate, snmpV3EngineID=snmpV3EngineID, swTimeRangeEndMonth=swTimeRangeEndMonth, dhcpv6RelayInterfaceSettingsRowStatus=dhcpv6RelayInterfaceSettingsRowStatus, aclL3v4ExtRule=aclL3v4ExtRule, dhcpRelayInterface=dhcpRelayInterface, sshMacSuiteList=sshMacSuiteList, poePowerDenied=poePowerDenied, swAuthRadiusServerKey=swAuthRadiusServerKey, swTimeRangeStartYear=swTimeRangeStartYear, companySNTPSetting=companySNTPSetting, sysMirrorTargetPort=sysMirrorTargetPort, staticMcastMac=staticMcastMac, laSystem=laSystem, autoSurveillanceVlanOUIComponentType=autoSurveillanceVlanOUIComponentType, poePortVoltage=poePortVoltage, dlinkPowerSavingGlobalSetting=dlinkPowerSavingGlobalSetting, lldpMEDPortControlTable=lldpMEDPortControlTable, sysMirrorStatus=sysMirrorStatus, tftpFwTargetServerIpAddress=tftpFwTargetServerIpAddress, laPortControlEntry=laPortControlEntry, qosDiffServType36=qosDiffServType36, impbWhiteListMacAddress=impbWhiteListMacAddress, aclL3v4ExtRuleDstIpAddr=aclL3v4ExtRuleDstIpAddr, sysPortCtrlMDI=sysPortCtrlMDI, companyVoiceVlan=companyVoiceVlan, swAuthAuthQuietPeriod=swAuthAuthQuietPeriod, aclL3v4ExtRuleProfileNo=aclL3v4ExtRuleProfileNo, aclL3v6RuleTrafficClass=aclL3v6RuleTrafficClass, igsVlanMulticastGroupVlanId=igsVlanMulticastGroupVlanId, aclL2ProfileID=aclL2ProfileID, qosDiffServType47=qosDiffServType47, impbWhiteListTable=impbWhiteListTable, ipifV6AddressRowStatus=ipifV6AddressRowStatus, igsVlanMulticastGroupIpAddress=igsVlanMulticastGroupIpAddress, aclL3v4ExtRuleTable=aclL3v4ExtRuleTable, stpForwardDelay=stpForwardDelay, syslogSrvFacility=syslogSrvFacility, sysLBDCtrlIndex=sysLBDCtrlIndex, stpGlobal=stpGlobal, syslogSrvPort=syslogSrvPort, aclL3v4RuleTable=aclL3v4RuleTable, dlinklldpLocManAddrSubtype=dlinklldpLocManAddrSubtype, voiceVlanTimeout=voiceVlanTimeout, firmwareChecksumError=firmwareChecksumError, qosDiffServEnable=qosDiffServEnable, aclL3v6RuleTcpUdpSrcPort=aclL3v6RuleTcpUdpSrcPort, companyMirror=companyMirror, aclPortL3v4ProfileNo=aclPortL3v4ProfileNo, swAuthStatus=swAuthStatus, aclL3v4ExtRuleDscp=aclL3v4ExtRuleDscp, stpPortDesignatedRoot=stpPortDesignatedRoot, sysDhcpAutoConfiguration=sysDhcpAutoConfiguration, voicevlanDevicePriority=voicevlanDevicePriority, rmonEventStatus=rmonEventStatus, neighborTable=neighborTable, tftpFwTargetImageFileName=tftpFwTargetImageFileName, swAuthAuthConfigPortControl=swAuthAuthConfigPortControl, doSCtrlEntry=doSCtrlEntry, aclL3v4RuleDstIpAddrMask=aclL3v4RuleDstIpAddrMask, qosDiffServType61=qosDiffServType61, autoSurveillanceVlanTaggedUplinkDownlinkPort=autoSurveillanceVlanTaggedUplinkDownlinkPort, laPortChannelMemberList=laPortChannelMemberList, dhcpv6RelayHopCount=dhcpv6RelayHopCount, qosDiffServType46=qosDiffServType46, qosDiffServType40=qosDiffServType40, dhcpLocalRelayGlobalState=dhcpLocalRelayGlobalState, dhcpv6RelayOption37RemoteIDType=dhcpv6RelayOption37RemoteIDType, aclL2Rule=aclL2Rule, dhcpOption12HostName=dhcpOption12HostName, aclL2Rule1pPriority=aclL2Rule1pPriority, poeLedMode=poeLedMode, rmonEvent=rmonEvent, sysIpAddr=sysIpAddr, dot1qVlanUngisterMCFilterEntry=dot1qVlanUngisterMCFilterEntry, swAuthRadiusServerTable=swAuthRadiusServerTable, qosDiffServType05=qosDiffServType05, swAuthAuthReAuthentication=swAuthAuthReAuthentication, aclL2RulePriority=aclL2RulePriority, aclL3v6RuleProfileNo=aclL3v6RuleProfileNo, companyLA=companyLA, swAuthRadiusServerEntry=swAuthRadiusServerEntry, qosDiffServType12=qosDiffServType12, aclL3v4ExtRuleAction=aclL3v4ExtRuleAction, sysLBDVlanLoopIndex=sysLBDVlanLoopIndex, neighborRowStatus=neighborRowStatus, swTimeRangeSettingTable=swTimeRangeSettingTable, tftpFwTargetServerIpType=tftpFwTargetServerIpType, trustedHostIPType=trustedHostIPType, aclL3v6RuleTcpUdpDstPortMask=aclL3v6RuleTcpUdpDstPortMask, aclPortBindGroup=aclPortBindGroup, dlinklldpConfigManAddrEntry=dlinklldpConfigManAddrEntry, aclL3v6RuleSrcIpv6Addr=aclL3v6RuleSrcIpv6Addr, voicevlanPortControlTable=voicevlanPortControlTable, staticEntry=staticEntry, sshCipherSuiteList=sshCipherSuiteList, snmpV3GroupSecurityLevel=snmpV3GroupSecurityLevel, dhcpRelayOption82RemoteIDType=dhcpRelayOption82RemoteIDType, qosDiffServType43=qosDiffServType43, trustedHostStatus=trustedHostStatus, swAuthAuthServerTimeout=swAuthAuthServerTimeout, qosDiffServType62=qosDiffServType62, ipifv6DHCPStatus=ipifv6DHCPStatus, bandwidthCtrlTxThreshold=bandwidthCtrlTxThreshold, aclProfileRuleCount=aclProfileRuleCount, pethPsePortPowerRemainder=pethPsePortPowerRemainder, dlinklldpLocManAddr=dlinklldpLocManAddr, companyLLDPSetting=companyLLDPSetting, qosDiffServType42=qosDiffServType42, stpHoldTime=stpHoldTime, qosDiffServType14=qosDiffServType14, swAuthAuthMaxReq=swAuthAuthMaxReq, mldsVlanRouterPortList=mldsVlanRouterPortList, tftpCfgTargetServerIpType=tftpCfgTargetServerIpType, ipifv6AutolinkloStatus=ipifv6AutolinkloStatus, rmonHistoryStatus=rmonHistoryStatus, pethPsePortPowerRatioOfSystemPower=pethPsePortPowerRatioOfSystemPower, aRPSpoofPreventTable=aRPSpoofPreventTable, dlinkGreenPortShutoffPortList=dlinkGreenPortShutoffPortList, companyDHCPv6Relay=companyDHCPv6Relay, impbSmartTable=impbSmartTable, mldsHostPortPurgeInterval=mldsHostPortPurgeInterval, snmpV3GroupWriteViewName=snmpV3GroupWriteViewName, swTimeRangeEndHour=swTimeRangeEndHour, swTimeRangeRowStatus=swTimeRangeRowStatus, igsVlanMulticastGroupPortList=igsVlanMulticastGroupPortList, aclL3v6RuleSrcIpv6AddrPrefixLen=aclL3v6RuleSrcIpv6AddrPrefixLen, qosDiffServType35=qosDiffServType35, impbSettingEntry=impbSettingEntry, voiceVlanId=voiceVlanId, swAuthUserEntry=swAuthUserEntry, aclL3v4ExtRuleStatus=aclL3v4ExtRuleStatus, swAuthAuthDirection=swAuthAuthDirection, stpMaxAge=stpMaxAge, snmpV3HostAddress=snmpV3HostAddress, snmpV3User=snmpV3User, dhcpLocalRelaySettingsVLANID=dhcpLocalRelaySettingsVLANID, voicevlanSystem=voicevlanSystem, autoSurveillanceVlanOUI=autoSurveillanceVlanOUI, Ipv6Address=Ipv6Address, snmpV3IPType=snmpV3IPType, sysPortCtrlFlowControl=sysPortCtrlFlowControl, swAuthUserStatus=swAuthUserStatus, aclL3v4RuleSrcIpAddrMask=aclL3v4RuleSrcIpAddrMask, rmonGlobalState=rmonGlobalState, laPortChannelEntry=laPortChannelEntry, mldsVlanQuerier=mldsVlanQuerier, sysDdpProtStatusTable=sysDdpProtStatusTable, firmwareIllegalFile=firmwareIllegalFile, rmonAlarmOwner=rmonAlarmOwner, igsVlanRtrPortList=igsVlanRtrPortList, securitySSL=securitySSL, stpAdminPortPathCost=stpAdminPortPathCost, cableDiagPair4TestResult=cableDiagPair4TestResult, mldsVlanRouterEntry=mldsVlanRouterEntry, dot1qVlanUngisterMCFiltermode=dot1qVlanUngisterMCFiltermode, poePortSettingState=poePortSettingState, aclL3v4RuleAccessID=aclL3v4RuleAccessID, swAuthAuthCapability=swAuthAuthCapability, impbSmartVlanId=impbSmartVlanId, LacpKey=LacpKey, dhcpv6RelayInterfaceSettingsEntry=dhcpv6RelayInterfaceSettingsEntry, snmpV3GroupName=snmpV3GroupName, companyGreenSetting=companyGreenSetting, rmonAlarmTable=rmonAlarmTable, dot1pPortTable=dot1pPortTable, stpPortForwardTransitions=stpPortForwardTransitions, poePortStatus=poePortStatus)
mibBuilder.exportSymbols("DGS-1210-10P_CX", swTimeRangeTuesday=swTimeRangeTuesday, sysPortDescriptionEntry=sysPortDescriptionEntry, swAuthRadiusServerStatus=swAuthRadiusServerStatus, miscStatisticsReset=miscStatisticsReset, poePortClassification=poePortClassification, sshUserInfoHostIp=sshUserInfoHostIp, snmpV3viewTreeMask=snmpV3viewTreeMask, poeOverLoad=poeOverLoad, portSecIndex=portSecIndex, stpBridgeMaxAge=stpBridgeMaxAge, qosDiffServTypeGroup=qosDiffServTypeGroup, ipifV6AddressIpAddr=ipifV6AddressIpAddr, qosDiffServType41=qosDiffServType41, dot1qVlanManagementid=dot1qVlanManagementid, snmpGlobalState=snmpGlobalState, sysSNTPDSTEndHour=sysSNTPDSTEndHour, firmwareTransferError=firmwareTransferError, autoSurveillanceVlanOUIDescription=autoSurveillanceVlanOUIDescription, dhcpRelayInterfaceSettingsEntry=dhcpRelayInterfaceSettingsEntry, rmonEventType=rmonEventType, sysPortCtrlSpeed=sysPortCtrlSpeed, aclProfileNo=aclProfileNo, sysLBDCtrlTable=sysLBDCtrlTable, swTimeRangeWednesday=swTimeRangeWednesday, dhcpRelayState=dhcpRelayState, aclHWResourceStatusTable=aclHWResourceStatusTable, dhcpRelayOption82RemoteID=dhcpRelayOption82RemoteID, dlink_DGS12XXSeriesProd=dlink_DGS12XXSeriesProd, snmpV3Group=snmpV3Group, qosDiffServType37=qosDiffServType37, qosDiffServType16=qosDiffServType16, sysRestart=sysRestart, syslogSrvSeverity=syslogSrvSeverity, snmpV3viewTreeType=snmpV3viewTreeType, stpHelloTime=stpHelloTime, dlinklldpConfigManAddrPortsTxEnable=dlinklldpConfigManAddrPortsTxEnable, sysPoEPortSettingTable=sysPoEPortSettingTable, swAuthRadiusServerTimeout=swAuthRadiusServerTimeout, rmonAlarmRisingThreshold=rmonAlarmRisingThreshold, companySecurity=companySecurity, qosDiffServType48=qosDiffServType48, sslSecurityHttpStatus=sslSecurityHttpStatus, lldpMEDPortState=lldpMEDPortState, qosDiffServType08=qosDiffServType08, aclL3v4ExtRuleICMPMessageType=aclL3v4ExtRuleICMPMessageType, companyTftpGroup=companyTftpGroup, stpPortTable=stpPortTable, aclL2RuleEtherType=aclL2RuleEtherType, autoSurveillanceVlanOUITable=autoSurveillanceVlanOUITable, companyMldsGroup=companyMldsGroup, dhcpv6RelayControl=dhcpv6RelayControl, qosDiffServType39=qosDiffServType39, sysLBDInterval=sysLBDInterval, impbAutoScanIpAddressTo=impbAutoScanIpAddressTo, doSCtrlState=doSCtrlState, aclL2RuleAction=aclL2RuleAction, trafficSegMemberList=trafficSegMemberList, swAuthRadiusServerRetransmit=swAuthRadiusServerRetransmit, doSCtrlTable=doSCtrlTable, igsVlanFilterVlanId=igsVlanFilterVlanId, companyRSTP=companyRSTP, qosDiffServType13=qosDiffServType13, mldsVlanMulticastGroupEntry=mldsVlanMulticastGroupEntry, poePortPower=poePortPower, stpPortEntry=stpPortEntry, impbBlackListEntry=impbBlackListEntry, neighborMACAddr=neighborMACAddr, snmpV3GroupSecurityModel=snmpV3GroupSecurityModel, aclL2RuleEntry=aclL2RuleEntry, tftpFwTargetTftpOperation=tftpFwTargetTftpOperation, igsHostPortPurgeInterval=igsHostPortPurgeInterval, igsGrpQueryInterval=igsGrpQueryInterval, stpBridgeForwardDelay=stpBridgeForwardDelay, qosDiffServType11=qosDiffServType11, mldsVlanFilterEntry=mldsVlanFilterEntry, autoSurveillanceVlanOUIStatus=autoSurveillanceVlanOUIStatus, laPortControlIndex=laPortControlIndex, mldsGrpQueryInterval=mldsGrpQueryInterval, qosDiffServType57=qosDiffServType57, igsVlanFastLeave=igsVlanFastLeave, securityTrafficSeg=securityTrafficSeg, aclL3v4ExtRuleEntry=aclL3v4ExtRuleEntry, dhcpRelayHopCount=dhcpRelayHopCount, companyIpifGroup=companyIpifGroup, mldsVlanRouterTable=mldsVlanRouterTable, staticDisableAutoLearn=staticDisableAutoLearn, mldsVlanSnoopStatus=mldsVlanSnoopStatus, sysSNTPFirstInterfaceName=sysSNTPFirstInterfaceName, mldsStatus=mldsStatus, poePortDelayPowerDetect=poePortDelayPowerDetect, dlinkGreenPortShutoffState=dlinkGreenPortShutoffState, impbAutoScanIpAddressFrom=impbAutoScanIpAddressFrom, poePowerOn=poePowerOn, aclL3v4ExtRuleIgmpType=aclL3v4ExtRuleIgmpType, stpTopChanges=stpTopChanges, aclProfileTable=aclProfileTable, companyTimeRangeMgmt=companyTimeRangeMgmt, impbSmartEntry=impbSmartEntry, dlinklldpAntiRoguePassword=dlinklldpAntiRoguePassword, trustedHostRowStatus=trustedHostRowStatus, mldsVlanFilterVlanId=mldsVlanFilterVlanId, swTimeRangeStartMonth=swTimeRangeStartMonth, qosTOS=qosTOS, neighborCacheState=neighborCacheState, aclL2RuleTable=aclL2RuleTable, stpPortPriority=stpPortPriority, staticMac=staticMac, swTimeRangeSunday=swTimeRangeSunday, rmonAlarm=rmonAlarm, swAuthCtrlPktFwdMode=swAuthCtrlPktFwdMode, qosTOSType01=qosTOSType01, sysSNTPDSTStartMon=sysSNTPDSTStartMon, rmonAlarmRisingEventIndex=rmonAlarmRisingEventIndex, qosDiffServType04=qosDiffServType04, qosDiffServType21=qosDiffServType21, aclProfileEntry=aclProfileEntry, broadcastStormCtrlThreshold=broadcastStormCtrlThreshold, aclL3v4RuleProfileNo=aclL3v4RuleProfileNo, igsVlanRouterEntry=igsVlanRouterEntry, voicevlanDeviceIndexMac=voicevlanDeviceIndexMac, portD3State=portD3State, dlinklldpRemOrgDefInfoEntry=dlinklldpRemOrgDefInfoEntry, qosDiffServType06=qosDiffServType06, swAuthenCtrl=swAuthenCtrl, rmonStatsIndex=rmonStatsIndex, rmonStatsEntry=rmonStatsEntry, sysSave=sysSave, aclL3v6Rule=aclL3v6Rule, dhcpRelayManagementOption82=dhcpRelayManagementOption82, trustedHostIpAddr=trustedHostIpAddr, companyTraps=companyTraps, dlinkGreenPortShutoff=dlinkGreenPortShutoff, qosDiffServType52=qosDiffServType52, qosDiffServType38=qosDiffServType38, rmonAlarmVariable=rmonAlarmVariable, aclPortGroupTable=aclPortGroupTable, cableDiagPair3FaultDistance=cableDiagPair3FaultDistance, rmonEventDescription=rmonEventDescription, companyStaticMcast=companyStaticMcast, rmonEventEntry=rmonEventEntry, d_link=d_link, dot3azTable=dot3azTable, impbInsIpPacPortState=impbInsIpPacPortState, impbDHCPPortState=impbDHCPPortState, qosDiffServType44=qosDiffServType44, sysLBDPortStatus=sysLBDPortStatus, sysPortCtrlOperStatus=sysPortCtrlOperStatus, rmonHistoryDataSource=rmonHistoryDataSource, laPortActorTimeout=laPortActorTimeout, qosTOSType04=qosTOSType04, igsRobustnessValue=igsRobustnessValue, snmpV3HostEntry=snmpV3HostEntry, aclL3v6RuleTcpUdpDstPort=aclL3v6RuleTcpUdpDstPort, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, companyTrafficMgmt=companyTrafficMgmt, aclHWResourceStatus=aclHWResourceStatus, mldsRobustnessValue=mldsRobustnessValue, qosDiffServType17=qosDiffServType17, sslCipherSuiteList=sslCipherSuiteList, stpPortProtocolMigration=stpPortProtocolMigration, snmpV3CommunityEntry=snmpV3CommunityEntry, voicevlanPortCurrentTagMode=voicevlanPortCurrentTagMode, laPortControl=laPortControl, impbSmartBinding=impbSmartBinding, sysDdpProtStatusEntry=sysDdpProtStatusEntry, aclL3v6RuleProtocolId=aclL3v6RuleProtocolId, poePortSettingPriority=poePortSettingPriority, aclHWResourceStatusEntry=aclHWResourceStatusEntry, tftpCfgTargetInterfaceName=tftpCfgTargetInterfaceName, ipifv6DefaultGateway=ipifv6DefaultGateway, aclL3v4ExtRuleSrcIpAddr=aclL3v4ExtRuleSrcIpAddr, poeportid=poeportid, trustedHostTable=trustedHostTable, dot1qVlanAsyOnOff=dot1qVlanAsyOnOff, aclProfileStatus=aclProfileStatus, ipifV6AddressTable=ipifV6AddressTable, swAuthAuthTxPeriod=swAuthAuthTxPeriod, sysPortCtrlIndex=sysPortCtrlIndex, dot1pPortPriority=dot1pPortPriority, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, snmpV3ViewTreeTable=snmpV3ViewTreeTable, swAuthUser=swAuthUser, impbWhiteListRowStatus=impbWhiteListRowStatus, ipifV6AddressIpPrefix=ipifV6AddressIpPrefix, miscReset=miscReset, aclL3v6RuleDstIpv6AddrPrefixLen=aclL3v6RuleDstIpv6AddrPrefixLen, sshAuthenMethodHostKeyAdmin=sshAuthenMethodHostKeyAdmin, BridgeId=BridgeId, tftpCfgTargetServerIpAddress=tftpCfgTargetServerIpAddress, securityTrustedHost=securityTrustedHost, dlinkGreenSystemHibernation=dlinkGreenSystemHibernation, swTimeRangeThursday=swTimeRangeThursday, sysPortDescIndex=sysPortDescIndex, qosDiffServType56=qosDiffServType56, swTimeRangeSaturday=swTimeRangeSaturday, swAuthAuthSuppTimeout=swAuthAuthSuppTimeout, staticMcastVlanID=staticMcastVlanID, syslogSrvRowStatus=syslogSrvRowStatus, igsSystem=igsSystem, securityARPSpoofPrevent=securityARPSpoofPrevent, dot1pPortEntry=dot1pPortEntry, qosTOSType05=qosTOSType05, stpPort=stpPort, aclL3v6RulePriority=aclL3v6RulePriority, portSecEntry=portSecEntry, aclL3v6RuleEntry=aclL3v6RuleEntry, autoSurveillanceVlanOUISurveillanceOUI=autoSurveillanceVlanOUISurveillanceOUI, dlinkGreenPortShutoffTimeProfile1=dlinkGreenPortShutoffTimeProfile1, sysIpAddrCfgMode=sysIpAddrCfgMode, rmonAlarmInterval=rmonAlarmInterval, rmonAlarmFallingThreshold=rmonAlarmFallingThreshold, dlinkGreenSystemHibernationTimeProfile2=dlinkGreenSystemHibernationTimeProfile2, cableDiagPair3TestResult=cableDiagPair3TestResult, snmpV3TrapFirmUpgrade=snmpV3TrapFirmUpgrade, sshSessionKeyRekeying=sshSessionKeyRekeying, swTimeRangeMonday=swTimeRangeMonday, dot3azEEEset=dot3azEEEset, igsQueryMaxResponseTime=igsQueryMaxResponseTime, aclProfileType=aclProfileType, dlinkGreenLEDShutoffState=dlinkGreenLEDShutoffState, poeShortCircuit=poeShortCircuit, aclProfile=aclProfile, rmonHistoryInterval=rmonHistoryInterval, dot1qVlanEntry=dot1qVlanEntry, companyIgsGroup=companyIgsGroup, dlinkGreenPortShutoffTimeProfile2=dlinkGreenPortShutoffTimeProfile2, swAuthUserPassword=swAuthUserPassword, dhcpServerScreenEnablePortlist=dhcpServerScreenEnablePortlist, impbPortIndex=impbPortIndex, companyNeighbor=companyNeighbor, sysSNTPSecondInterfaceName=sysSNTPSecondInterfaceName, voicevlanOUITable=voicevlanOUITable, impbWhiteListIpAddress=impbWhiteListIpAddress, portSecMLA=portSecMLA, aclL2RuleVlanId=aclL2RuleVlanId, aclL3v4ExtRuleProtocol=aclL3v4ExtRuleProtocol, tftpCfgTargetTftpOperation=tftpCfgTargetTftpOperation, snmpV3CommunityName=snmpV3CommunityName, voicevlanOUIDescription=voicevlanOUIDescription, dot1qVlanPvid=dot1qVlanPvid, sysSNTPDSTStartDay=sysSNTPDSTStartDay, dot1qVlanUngisterMCFilterVlanId=dot1qVlanUngisterMCFilterVlanId, stpProtocolSpecification=stpProtocolSpecification, bandwidthCtrlIndex=bandwidthCtrlIndex, stpPortPathCost=stpPortPathCost, portSecState=portSecState, staticMcastEntry=staticMcastEntry, dhcpv6RelayServerIP=dhcpv6RelayServerIP, aclPortL3v6ProfileNo=aclPortL3v6ProfileNo, aclL2RuleReplacePriority=aclL2RuleReplacePriority, aclL3v4ExtRulePriority=aclL3v4ExtRulePriority, voicevlanPortState=voicevlanPortState, sysPortDescString=sysPortDescString, laPortChannelTable=laPortChannelTable)
mibBuilder.exportSymbols("DGS-1210-10P_CX", portSecTable=portSecTable, dlinklldpRemOrgDefInfoOUI=dlinklldpRemOrgDefInfoOUI, cableDiagPair1TestResult=cableDiagPair1TestResult, syslogSrvIPType=syslogSrvIPType, sysSNTPDSTStartMin=sysSNTPDSTStartMin, sysJumboFrameEnable=sysJumboFrameEnable, staticMcastStatus=staticMcastStatus, dot1qVlanUngisterMCFilterTable=dot1qVlanUngisterMCFilterTable, dot1qVlanPortEntry=dot1qVlanPortEntry, cableDiagPair2TestResult=cableDiagPair2TestResult, staticTable=staticTable, aclL3v4RuleSrcIpAddr=aclL3v4RuleSrcIpAddr, dlinkGreenLEDShutoffTimeProfile2=dlinkGreenLEDShutoffTimeProfile2, bandwidthCtrlRxThreshold=bandwidthCtrlRxThreshold, bandwidthCtrlTable=bandwidthCtrlTable, aclResourceEntryCount=aclResourceEntryCount, sysSNTPDSTState=sysSNTPDSTState, igsVlanRouterPortList=igsVlanRouterPortList, rmonStatsStatus=rmonStatsStatus, snmpV3ViewTreeEntry=snmpV3ViewTreeEntry, qosDiffServType63=qosDiffServType63, companyDHCPRelay=companyDHCPRelay, qosDiffServType58=qosDiffServType58, cableDiagPair4FaultDistance=cableDiagPair4FaultDistance, swAuthAuthReAuthPeriod=swAuthAuthReAuthPeriod, voiceVlanPriority=voiceVlanPriority, trafficSegIfIndex=trafficSegIfIndex, autoSurveillanceVlanPriority=autoSurveillanceVlanPriority, mldsQueryMaxResponseTime=mldsQueryMaxResponseTime, impbBlackListMacAddress=impbBlackListMacAddress, dhcpServerScreenTrustedServerTable=dhcpServerScreenTrustedServerTable, aclL3v6RuleICMPv6MessageType=aclL3v6RuleICMPv6MessageType, dhcpLocalRelaySettingsState=dhcpLocalRelaySettingsState, portD3Index=portD3Index, qosDiffServType49=qosDiffServType49, poePortSettingPowerLimit=poePortSettingPowerLimit, swTimeRangeIndex=swTimeRangeIndex, dhcpRelayOption82Policy=dhcpRelayOption82Policy, igsVlanQueryInterval=igsVlanQueryInterval, aclL3v4RuleEntry=aclL3v4RuleEntry, igsVlanRouterTable=igsVlanRouterTable, qosMode=qosMode, qosTOSGroup=qosTOSGroup, sysMirrorCtrlIngressMirroring=sysMirrorCtrlIngressMirroring, dot1pPortIndex=dot1pPortIndex, snmpV3TrapPortLinkUpDown=snmpV3TrapPortLinkUpDown, sshAuthenMethodPubKeyAdmin=sshAuthenMethodPubKeyAdmin, dlinklldpMsgTxInterval=dlinklldpMsgTxInterval, PortLaMode=PortLaMode, aclL3v4ExtRuleICMPMessageCode=aclL3v4ExtRuleICMPMessageCode, qosDiffServType31=qosDiffServType31, snmpV3GroupEntry=snmpV3GroupEntry, impbBlackListIpAddress=impbBlackListIpAddress, snmpV3TrapPoePowerError=snmpV3TrapPoePowerError, voicevlanDeviceStatus=voicevlanDeviceStatus, staticVlanID=staticVlanID, dhcpServerScreenTrustedServerIndex=dhcpServerScreenTrustedServerIndex, aclL3v4ExtRuleAccessID=aclL3v4ExtRuleAccessID, rstpStatus=rstpStatus, igsStatus=igsStatus, qosDiffServType15=qosDiffServType15, poeportgroup=poeportgroup, staticMcastTable=staticMcastTable, aclL3v4ExtRuleTcpUdpDstPortMask=aclL3v4ExtRuleTcpUdpDstPortMask, poePortTimeBaseSchduleID=poePortTimeBaseSchduleID, poePortSettingUserDefine=poePortSettingUserDefine, doSCtrlType=doSCtrlType, rmonHistory=rmonHistory, staticPort=staticPort, igsVlanFilterEntry=igsVlanFilterEntry, aclL2AccessID=aclL2AccessID, syslogState=syslogState, sysLBDMode=sysLBDMode, companyMiscGroup=companyMiscGroup, staticStatus=staticStatus, aRPSpoofPreventIpAddr=aRPSpoofPreventIpAddr, sysSystemPassword=sysSystemPassword, sysSNTPServerTable=sysSNTPServerTable, sysSNTPFirstServer=sysSNTPFirstServer, voicevlanPortManuTagMode=voicevlanPortManuTagMode, snmpV3Trap=snmpV3Trap, snmpV3UserVersion=snmpV3UserVersion, mldsRouterPortPurgeInterval=mldsRouterPortPurgeInterval, impbPortState=impbPortState, dlinklldpAntiRoguePortIndex=dlinklldpAntiRoguePortIndex, cableDiagLengthinRange=cableDiagLengthinRange, sysSNTPTimeSeconds=sysSNTPTimeSeconds, aclL3v4ExtRuleToS=aclL3v4ExtRuleToS, qosDiffServType29=qosDiffServType29, voicevlanDevicePort=voicevlanDevicePort, snmpV3GroupNotifyViewName=snmpV3GroupNotifyViewName, companySyslog=companySyslog, dhcpv6RelayOption37RemoteID=dhcpv6RelayOption37RemoteID, voicevlanPortAutoDetection=voicevlanPortAutoDetection, broadcastStormCtrlLimitType=broadcastStormCtrlLimitType, qosDiffServType07=qosDiffServType07, dlink_products=dlink_products, aRPSpoofPreventEntry=aRPSpoofPreventEntry, tftpCfgTargetGroup=tftpCfgTargetGroup, sysSNTPPollInterval=sysSNTPPollInterval, dot3azEntry=dot3azEntry, dhcpServerScreenTrustedServerAddress=dhcpServerScreenTrustedServerAddress, stpRootCost=stpRootCost, rmonHistoryBucketsRequested=rmonHistoryBucketsRequested, rmonEventIndex=rmonEventIndex, sshPublKeyRSAAdmin=sshPublKeyRSAAdmin, dhcpLocalRelayEntry=dhcpLocalRelayEntry, impbSmartMacAddress=impbSmartMacAddress, ipifV6AddressMainIndex=ipifV6AddressMainIndex, stpPortEnable=stpPortEnable, qosDiffServType09=qosDiffServType09, ipifv6NSRetransmitTime=ipifv6NSRetransmitTime, swAuthUserName=swAuthUserName, qosDiffServType32=qosDiffServType32, qosDiffServType54=qosDiffServType54, aclL3v4ExtRuleDstIpAddrMask=aclL3v4ExtRuleDstIpAddrMask, stpPortOperEdgePort=stpPortOperEdgePort, companyCableDiagnostic=companyCableDiagnostic, swAuthRadiusServerIndex=swAuthRadiusServerIndex, cableDiagPair2FaultDistance=cableDiagPair2FaultDistance, mldsVlanMulticastGroupTable=mldsVlanMulticastGroupTable, aclL2RuleSrcMacAddrMask=aclL2RuleSrcMacAddrMask, snmpV3UserGroupName=snmpV3UserGroupName, impbSmartIpAddress=impbSmartIpAddress, tftpCfgTargetImageFileName=tftpCfgTargetImageFileName, sysLocationName=sysLocationName, snmpV3TrapPoePowerOnOff=snmpV3TrapPoePowerOnOff, swTimeRangeFriday=swTimeRangeFriday, dot1qVlanManagementOnOff=dot1qVlanManagementOnOff, aclL3v6RuleStatus=aclL3v6RuleStatus, swTimeRangeStartMinute=swTimeRangeStartMinute, qosDiffServType25=qosDiffServType25, aclL2RuleDstMacAddrMask=aclL2RuleDstMacAddrMask, tftpFwTargetTftpOperationStatus=tftpFwTargetTftpOperationStatus, ipifSupportV4V6Info=ipifSupportV4V6Info, swLoopDetectEnabledVlanList=swLoopDetectEnabledVlanList, snmpV3viewTreeStatus=snmpV3viewTreeStatus, ipifv6GlobalStatus=ipifv6GlobalStatus, sysDdp=sysDdp, stpVersion=stpVersion, aclL3v4ExtRuleSrcIpAddrMask=aclL3v4ExtRuleSrcIpAddrMask, qosDiffServType22=qosDiffServType22, rmonStatsOwner=rmonStatsOwner, impbBlackListStatus=impbBlackListStatus, snmpV3UserTable=snmpV3UserTable, stpPortRestrictedTCN=stpPortRestrictedTCN, qosTOSType00=qosTOSType00, sysDdpGlobalOnOff=sysDdpGlobalOnOff, queuingMechanism=queuingMechanism, voicevlanDeviceEntry=voicevlanDeviceEntry, mldsVlanFilterTable=mldsVlanFilterTable, poePortSettingUserDefineState=poePortSettingUserDefineState, rmonAlarmSampleType=rmonAlarmSampleType, dhcpv6RelayState=dhcpv6RelayState, dlinkGreenLEDShutoff=dlinkGreenLEDShutoff, dlinklldpReinitDelay=dlinklldpReinitDelay, dhcpv6RelayOption37State=dhcpv6RelayOption37State, PortList=PortList, sysSNTPDSTEndDay=sysSNTPDSTEndDay, poePortCurrent=poePortCurrent, qosDiffServType19=qosDiffServType19, companySNMPV3=companySNMPV3, stpPortState=stpPortState, dhcpServerScreenTrustedServerEntry=dhcpServerScreenTrustedServerEntry, snmpV3ViewTree=snmpV3ViewTree, aclL3v6RuleProtocol=aclL3v6RuleProtocol, voiceVlanMode=voiceVlanMode, autoSurveillanceVlanMode=autoSurveillanceVlanMode, swAuthRadiusServerAccountingPort=swAuthRadiusServerAccountingPort, companyDot1qVlanGroup=companyDot1qVlanGroup, mldsVlanRouterVlanId=mldsVlanRouterVlanId, qosDiffServType45=qosDiffServType45, syslogInterfaceName=syslogInterfaceName, dlinklldpState=dlinklldpState, dhcpServerScreenTrustedServerStatus=dhcpServerScreenTrustedServerStatus, qosDiffServType55=qosDiffServType55, snmpV3Community=snmpV3Community, sysLBDVlanLoopEntry=sysLBDVlanLoopEntry, voicevlanDevice=voicevlanDevice, securityDhcpServerScreen=securityDhcpServerScreen, rmonHistoryIndex=rmonHistoryIndex, snmpV3TrapSNMPAuthentication=snmpV3TrapSNMPAuthentication, qosDiffServType00=qosDiffServType00, mldsVlan=mldsVlan, aclL2RuleStatus=aclL2RuleStatus, swAuthPortAccessControlTable=swAuthPortAccessControlTable, sysFirmwareVersion=sysFirmwareVersion, sysLBDVlanLoopTable=sysLBDVlanLoopTable, trafficSegStatus=trafficSegStatus, mldsVlanCfgQuerier=mldsVlanCfgQuerier, qosDiffServType23=qosDiffServType23, qosQ1p=qosQ1p, dhcpv6RelayOption37=dhcpv6RelayOption37, qosTOSEnable=qosTOSEnable, impbSmartPort=impbSmartPort, dhcpRelayManagement=dhcpRelayManagement, swTimeRangeSettingEntry=swTimeRangeSettingEntry, qosDiffServType10=qosDiffServType10, bandwidthCtrlEntry=bandwidthCtrlEntry, mldsVlanMulticastGroupMacAddress=mldsVlanMulticastGroupMacAddress, rmonAlarmIndex=rmonAlarmIndex, tftpFwTargetGroup=tftpFwTargetGroup, stpPortEdge=stpPortEdge, autoSurveillanceVlanId=autoSurveillanceVlanId, sshUserInfoHostName=sshUserInfoHostName, swAuthRadiusServer=swAuthRadiusServer, tftpCfgTargetTftpOperationStatus=tftpCfgTargetTftpOperationStatus, aclHWProfileIndex=aclHWProfileIndex, igsReportToAllPort=igsReportToAllPort, dot1qVlanPortTable=dot1qVlanPortTable, snmpV3HostInterfaceName=snmpV3HostInterfaceName, dlinklldpConfigManAddrTable=dlinklldpConfigManAddrTable, snmpV3TrapBootup=snmpV3TrapBootup, igsVlanRouterVlanId=igsVlanRouterVlanId, aclL3v4RulePriority=aclL3v4RulePriority, trafficSegTable=trafficSegTable, syslogTimeStampOption=syslogTimeStampOption, sysSafeGuardEnable=sysSafeGuardEnable, lldpMEDPortControlIndex=lldpMEDPortControlIndex, igsVlanFilterTable=igsVlanFilterTable, sysPortCtrlType=sysPortCtrlType, poePowerOff=poePowerOff, sysMirrorCtrlEgressMirroring=sysMirrorCtrlEgressMirroring, doSCtrlDisplayState=doSCtrlDisplayState, dot1qVlanName=dot1qVlanName, snmpV3UserStatus=snmpV3UserStatus, snmpV3UserPrivProtocol=snmpV3UserPrivProtocol, impbWhiteListPort=impbWhiteListPort, aclL3v4RuleAction=aclL3v4RuleAction, aclL3v6RuleReplacePriority=aclL3v6RuleReplacePriority, companydot3azEEE=companydot3azEEE, sysSNTPDSTStartHour=sysSNTPDSTStartHour, voicevlanOUITelephonyOUI=voicevlanOUITelephonyOUI, securitySSH=securitySSH, sysSNTPDSTEndMin=sysSNTPDSTEndMin, aclL3v4ExtRuleTcpUdpSrcPort=aclL3v4ExtRuleTcpUdpSrcPort, sshUserInfoUserName=sshUserInfoUserName, aclL3v4Rule=aclL3v4Rule, stpPortDesignatedBridge=stpPortDesignatedBridge, rmonStatsDataSource=rmonStatsDataSource, LldpManAddress=LldpManAddress, qosDiffServType50=qosDiffServType50, trafficSegEntry=trafficSegEntry, qosDiffServType18=qosDiffServType18, rmonStatistics=rmonStatistics, aclL3v4ExtRuleProtocolId=aclL3v4ExtRuleProtocolId, dlinkGreenSystemHibernationState=dlinkGreenSystemHibernationState, qosDiffServType59=qosDiffServType59, sysDdpGeneralReportOnOff=sysDdpGeneralReportOnOff, dlinkGreenSystemHibernationTimeProfile1=dlinkGreenSystemHibernationTimeProfile1, dhcpOption12Status=dhcpOption12Status, trustedHostEntry=trustedHostEntry, dhcpRelayOption82State=dhcpRelayOption82State, sshUserInfoEntry=sshUserInfoEntry)
mibBuilder.exportSymbols("DGS-1210-10P_CX", aclProfileName=aclProfileName, sshMaxSession=sshMaxSession, snmpV3HostCommunityName=snmpV3HostCommunityName, snmpV3UserAuthProtocol=snmpV3UserAuthProtocol, sshSecurityStatus=sshSecurityStatus, companyLBD=companyLBD, poeOverMaxPowerBudget=poeOverMaxPowerBudget, snmpV3UserName=snmpV3UserName, sysSNTPState=sysSNTPState, aclL2RuleDstMacAddr=aclL2RuleDstMacAddr, sysSNTPDSTEndMon=sysSNTPDSTEndMon, sysIpSubnetMask=sysIpSubnetMask, ipifV6AddressIpType=ipifV6AddressIpType, sysGateway=sysGateway, mldsVlanFastLeave=mldsVlanFastLeave, trustedHostIpMask=trustedHostIpMask, sshUserInfoTable=sshUserInfoTable, aclPortL2ProfileNo=aclPortL2ProfileNo, voicevlanDeviceTable=voicevlanDeviceTable, qosDiffServType30=qosDiffServType30, qosTOSType02=qosTOSType02, swTimeRangeStartHour=swTimeRangeStartHour, sysDdpGeneralReportTimer=sysDdpGeneralReportTimer, poeThermalShutdown=poeThermalShutdown, sysLBDVlanLoopPorts=sysLBDVlanLoopPorts, voicevlanOUI=voicevlanOUI, swAuthRadiusServerInterfaceName=swAuthRadiusServerInterfaceName, voicevlanOUIStatus=voicevlanOUIStatus, companyPoEGroup=companyPoEGroup, stpPortDesignatedCost=stpPortDesignatedCost, dgs_1210_10pcx=dgs_1210_10pcx, igsVlanSnoopStatus=igsVlanSnoopStatus, swTimeRangeName=swTimeRangeName, sysPortDescriptionTable=sysPortDescriptionTable, traps=traps, companyAuthGroup=companyAuthGroup, rmonHistoryEntry=rmonHistoryEntry, dhcpRelayOption82CheckState=dhcpRelayOption82CheckState, qosDiffServType02=qosDiffServType02, snmpV3TrapRSTPStateChange=snmpV3TrapRSTPStateChange, qosDiffServType26=qosDiffServType26, lldpMEDPortControlEntry=lldpMEDPortControlEntry, sysLBDPortLoopStatus=sysLBDPortLoopStatus, poePortLegacyPDDetect=poePortLegacyPDDetect, sysPoEPortSettingEntry=sysPoEPortSettingEntry, mldsVlanMulticastGroupIpAddress=mldsVlanMulticastGroupIpAddress, snmpV3TrapLBD=snmpV3TrapLBD, ipifV6AddressEntry=ipifV6AddressEntry, swAuthPortAccessCtrl=swAuthPortAccessCtrl, poeSystemSettingPowerThreshold=poeSystemSettingPowerThreshold, qosDiffServType03=qosDiffServType03, dhcpv6RelayInterfaceSettingsTable=dhcpv6RelayInterfaceSettingsTable, laPortControlTable=laPortControlTable, snmpV3GroupTable=snmpV3GroupTable, mldsVlanMulticastGroupVlanId=mldsVlanMulticastGroupVlanId, dlinklldpRemOrgDefInfoTable=dlinklldpRemOrgDefInfoTable, qosDiffServType51=qosDiffServType51, sysPortCtrlTable=sysPortCtrlTable, rmonStatsTable=rmonStatsTable, dhcpv6RelayInterface=dhcpv6RelayInterface, dhcpRelayInterfaceSettingsTable=dhcpRelayInterfaceSettingsTable, swTimeRangeEndMinute=swTimeRangeEndMinute, qosTOSType07=qosTOSType07, aclL3v4ExtRuleTcpUdpDstPort=aclL3v4ExtRuleTcpUdpDstPort, swAuthAuthConfigPortNumber=swAuthAuthConfigPortNumber, qosDiffServType33=qosDiffServType33, authProtocol=authProtocol, aclPortIndex=aclPortIndex, syslogSrvTable=syslogSrvTable, rmonHistoryTable=rmonHistoryTable, RmonStatus=RmonStatus, igsVlan=igsVlan, swAuthRadiusServerAddress=swAuthRadiusServerAddress, qosTOSType06=qosTOSType06, neighborType=neighborType, dhcpv6RelayManagement=dhcpv6RelayManagement, snmpV3viewTreeSubtree=snmpV3viewTreeSubtree, igsQueryInterval=igsQueryInterval, igsVlanQuerier=igsVlanQuerier, sysSNTPDSTOffset=sysSNTPDSTOffset, aRPSpoofPreventRowStatus=aRPSpoofPreventRowStatus, swTimeRangeStartDay=swTimeRangeStartDay, dlinkGreenLEDShutoffTimeProfile1=dlinkGreenLEDShutoffTimeProfile1, dhcpServerScreenIPType=dhcpServerScreenIPType, companyAutoSurveillanceVlan=companyAutoSurveillanceVlan, stpPortDesignatedPort=stpPortDesignatedPort, neighborIfindex=neighborIfindex, stpBridgeHelloTime=stpBridgeHelloTime, stpPortAdminPointToPoint=stpPortAdminPointToPoint, sysDdpProtStatusIndex=sysDdpProtStatusIndex, igsVlanMulticastGroupEntry=igsVlanMulticastGroupEntry, securityPortSecurity=securityPortSecurity, impbBlackListTable=impbBlackListTable, dot1qVlanTable=dot1qVlanTable, qosDiffServType20=qosDiffServType20, aclL3v4RuleReplacePriority=aclL3v4RuleReplacePriority, swTimeRangeEndYear=swTimeRangeEndYear, cableDiagPair1FaultDistance=cableDiagPair1FaultDistance, autoSurveillanceVlanOUIEntry=autoSurveillanceVlanOUIEntry, stpTxHoldCount=stpTxHoldCount, qosDiffServType28=qosDiffServType28, impbAutoScanStatus=impbAutoScanStatus, aclL3v6RuleAccessID=aclL3v6RuleAccessID, aclAccessListNo=aclAccessListNo, mldsVlanQueryInterval=mldsVlanQueryInterval, snmpV3CommunityPolicy=snmpV3CommunityPolicy, rmonEventCommunity=rmonEventCommunity, laPortChannelIfIndex=laPortChannelIfIndex, snmpV3TrapOverMaxPowerBudget=snmpV3TrapOverMaxPowerBudget, sysSwitchName=sysSwitchName, stpDesignatedRoot=stpDesignatedRoot, mldsQueryInterval=mldsQueryInterval, snmpV3UserPrivProtocolPassword=snmpV3UserPrivProtocolPassword, swTimeRangeEndDay=swTimeRangeEndDay, snmpV3GroupStatus=snmpV3GroupStatus, mldsVlanRtrPortList=mldsVlanRtrPortList, dlinklldpAntiRoguePortControl=dlinklldpAntiRoguePortControl, sysPortCtrlFlowControlOper=sysPortCtrlFlowControlOper, dot1qVlanUntaggedPorts=dot1qVlanUntaggedPorts, laPortChannelMode=laPortChannelMode, impbBlackListVlanId=impbBlackListVlanId, snmpV3HostTable=snmpV3HostTable, sysLBDRecoverTime=sysLBDRecoverTime, voicevlanPortControlEntry=voicevlanPortControlEntry, voicevlanDeviceTagType=voicevlanDeviceTagType, sysDdpProtStatusControl=sysDdpProtStatusControl, tftpFwTargetInterfaceName=tftpFwTargetInterfaceName, firmwareUpgradeFailure=firmwareUpgradeFailure, firmwareUpgradeSuccess=firmwareUpgradeSuccess, voicevlanOUIEntry=voicevlanOUIEntry, dhcpRelayTimeThreshold=dhcpRelayTimeThreshold, snmpV3CommunityTable=snmpV3CommunityTable, aclL2RuleSrcMacAddr=aclL2RuleSrcMacAddr, qosDiffServType01=qosDiffServType01, aclPortGroupEntry=aclPortGroupEntry, rmonAlarmFallingEventIndex=rmonAlarmFallingEventIndex, dhcpRelayControl=dhcpRelayControl, syslogSrvEntry=syslogSrvEntry, sshMaxAuthFailAttempts=sshMaxAuthFailAttempts, dgs_1210_10p=dgs_1210_10p, qosDiffServType24=qosDiffServType24, syslogSrvIP=syslogSrvIP, qosDiffServType34=qosDiffServType34, aclL3v4RuleDstIpAddr=aclL3v4RuleDstIpAddr, voicevlanPortControlIndex=voicevlanPortControlIndex, stpRootPort=stpRootPort, sysHardwareVersion=sysHardwareVersion, stpPortOperPointToPoint=stpPortOperPointToPoint, sshUserInfoAuth=sshUserInfoAuth, snmpV3Host=snmpV3Host, sysSNTPSecondServer=sysSNTPSecondServer, companyDoSCtrl=companyDoSCtrl, stpPriority=stpPriority, igsVlanMulticastGroupTable=igsVlanMulticastGroupTable, VlanIndex=VlanIndex, sysSNTPSecondType=sysSNTPSecondType, qosDiffServType60=qosDiffServType60)
