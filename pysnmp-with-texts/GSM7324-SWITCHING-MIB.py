...
# Produced by pysmi-0.3.4 at Wed May  1 13:20:27 2019
...
gsm7324, AgentPortMask = mibBuilder.importSymbols("GSM7324-REF-MIB", "gsm7324", "AgentPortMask")
...
IpAddress, iso, Bits, MibIdentifier, ModuleIdentity, Integer32, TimeTicks, NotificationType, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Gauge32, Counter32, Counter64, ObjectIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "IpAddress", "iso", "Bits", "MibIdentifier", "ModuleIdentity", "Integer32", "TimeTicks", "NotificationType", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Gauge32", "Counter32", "Counter64", "ObjectIdentity")
PhysAddress, RowStatus, DisplayString, TextualConvention, MacAddress = mibBuilder.importSymbols("SNMPv2-TC", "PhysAddress", "RowStatus", "DisplayString", "TextualConvention", "MacAddress")
gsm7324Switching = ModuleIdentity((1, 3, 6, 1, 4, 1, 4526, 1, 7, 1))
gsm7324Switching.setRevisions(('2003-02-06 18:35',))

if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: gsm7324Switching.setRevisionsDescriptions(('',))
...
if mibBuilder.loadTexts: gsm7324Switching.setContactInfo('')
if mibBuilder.loadTexts: gsm7324Switching.setDescription('')
...
mibBuilder.exportSymbols("GSM7324-SWITCHING-MIB", agentSwitchMFDBSummaryForwardingPortMask=agentSwitchMFDBSummaryForwardingPortMask, agentStpPortUpTime=agentStpPortUpTime, agentStpCstPortPriority=agentStpCstPortPriority, agentTelnetAllowNewMode=agentTelnetAllowNewMode, agentSwitchMFDBSummaryMacAddress=agentSwitchMFDBSummaryMacAddress, agentProtocolGroupPortStatus=agentProtocolGroupPortStatus, agentSnmpLinkUpDownTrapFlag=agentSnmpLinkUpDownTrapFlag, agentProtocolGroupProtocolIPX=agentProtocolGroupProtocolIPX, agentSerialStopBits=agentSerialStopBits, agentTrapLogTotal=agentTrapLogTotal, agentSpanningTreeMode=agentSpanningTreeMode, agentStpMstTopologyChangeParm=agentStpMstTopologyChangeParm, agentStpMstVlanEntry=agentStpMstVlanEntry, agentSwitchIGMPSnoopingAdminMode=agentSwitchIGMPSnoopingAdminMode, agentSnmpSpanningTreeTrapFlag=agentSnmpSpanningTreeTrapFlag, agentPortDVlanTagMode=agentPortDVlanTagMode, agentSwitchIGMPSnoopingPortMask=agentSwitchIGMPSnoopingPortMask, agentCableTesterCableStatus=agentCableTesterCableStatus, agentProtocolConfigGroup=agentProtocolConfigGroup, agentSwitchMFDBSummaryVlanId=agentSwitchMFDBSummaryVlanId, agentLoginSessionTable=agentLoginSessionTable, agentLagSummaryLagIndex=agentLagSummaryLagIndex, agentLagSummaryType=agentLagSummaryType, agentStpMstDesignatedCost=agentStpMstDesignatedCost, agentInventoryGroup=agentInventoryGroup, agentUserAuthenticationList=agentUserAuthenticationList, agentCableTesterIfIndex=agentCableTesterIfIndex, agentStpCstBridgeHelloTime=agentStpCstBridgeHelloTime, agentSaveConfigStatus=agentSaveConfigStatus, agentServicePortConfigGroup=agentServicePortConfigGroup, agentServicePortIPAddress=agentServicePortIPAddress, agentSwitchMFDBProtocolType=agentSwitchMFDBProtocolType, agentSwitchMFDBMostEntriesUsed=agentSwitchMFDBMostEntriesUsed, stpInstanceTopologyChangeTrap=stpInstanceTopologyChangeTrap, agentPortSTPState=agentPortSTPState, agentStpPortStatsRstpBpduRx=agentStpPortStatsRstpBpduRx, agentUserStatus=agentUserStatus, agentLagSummaryConfigEntry=agentLagSummaryConfigEntry, agentDot3adAggPortLACPMode=agentDot3adAggPortLACPMode, agentTelnetLoginTimeout=agentTelnetLoginTimeout, agentStpCstHelloTime=agentStpCstHelloTime, agentSwitchConfigGroup=agentSwitchConfigGroup, agentTransferUploadStatus=agentTransferUploadStatus, agentSnmpTrapReceiverIndex=agentSnmpTrapReceiverIndex, agentClassOfServiceTable=agentClassOfServiceTable, agentPortMirroringMode=agentPortMirroringMode, agentPortPhysicalMode=agentPortPhysicalMode, agentPortConfigTable=agentPortConfigTable, agentCableTesterMaximumCableLength=agentCableTesterMaximumCableLength, agentStpCstPortTopologyChangeAck=agentStpCstPortTopologyChangeAck, agentLagDetailedLagIndex=agentLagDetailedLagIndex, agentStpMstVlanRowStatus=agentStpMstVlanRowStatus, agentTransferUploadFilename=agentTransferUploadFilename, agentStpCstMaxAge=agentStpCstMaxAge, agentSwitchMFDBType=agentSwitchMFDBType, agentUserConfigDefaultAuthenticationList=agentUserConfigDefaultAuthenticationList, agentSwitchIGMPSnoopingMulticastControlFramesProcessed=agentSwitchIGMPSnoopingMulticastControlFramesProcessed, agentUserConfigTable=agentUserConfigTable, agentCLIConfigGroup=agentCLIConfigGroup, agentStpMstDesignatedRootId=agentStpMstDesignatedRootId, agentLoginSessionConnectionType=agentLoginSessionConnectionType, agentSnmpCommunityIPAddress=agentSnmpCommunityIPAddress, gsm7324Switching=gsm7324Switching, agentStpConfigFormatSelector=agentStpConfigFormatSelector, agentSnmpTrapReceiverConfigEntry=agentSnmpTrapReceiverConfigEntry, agentSnmpCommunityCreate=agentSnmpCommunityCreate, agentSerialHWFlowControlMode=agentSerialHWFlowControlMode, agentTransferUploadServerIP=agentTransferUploadServerIP, vlanRestoreFailureTrap=vlanRestoreFailureTrap, agentStpCstPortEntry=agentStpCstPortEntry, agentStpAdminMode=agentStpAdminMode, agentLoginSessionIPAddress=agentLoginSessionIPAddress, agentSwitchMFDBEntry=agentSwitchMFDBEntry, agentNetworkSubnetMask=agentNetworkSubnetMask, agentStpPortTable=agentStpPortTable, agentStpMstPortPathCost=agentStpMstPortPathCost, agentTrapLogTrap=agentTrapLogTrap, agentSystemGroup=agentSystemGroup, agentProtocolGroupPortEntry=agentProtocolGroupPortEntry, agentSwitchAddressAgingTimeoutEntry=agentSwitchAddressAgingTimeoutEntry, agentStpMstId=agentStpMstId, PYSNMP_MODULE_ID=gsm7324Switching, agentSwitchIGMPSnoopingMaxResponseTime=agentSwitchIGMPSnoopingMaxResponseTime, agentPortDVlanTagEthertype=agentPortDVlanTagEthertype, agentStpMstPortTable=agentStpMstPortTable, agentClearLoginSessions=agentClearLoginSessions, agentStpMstRootPathCost=agentStpMstRootPathCost, stpInstanceNewRootTrap=stpInstanceNewRootTrap, agentStpMstDesignatedPortId=agentStpMstDesignatedPortId, agentProbePortIfIndex=agentProbePortIfIndex, agentPortConfigEntry=agentPortConfigEntry, agentCableTesterGroup=agentCableTesterGroup, agentPortDot1dBasePort=agentPortDot1dBasePort, agentProtocolGroupTable=agentProtocolGroupTable, agentStpCstPortTable=agentStpCstPortTable, agentTransferDownloadPath=agentTransferDownloadPath, agentTrapLogIndex=agentTrapLogIndex, agentSnmpCommunityConfigEntry=agentSnmpCommunityConfigEntry, agentStpPortStatsMstpBpduTx=agentStpPortStatsMstpBpduTx, agentResetSystem=agentResetSystem, agentNetworkBurnedInMacAddress=agentNetworkBurnedInMacAddress, agentProtocolGroupName=agentProtocolGroupName, agentNetworkConfigProtocol=agentNetworkConfigProtocol, agentTransferUploadStart=agentTransferUploadStart, agentSwitchMFDBSummaryTable=agentSwitchMFDBSummaryTable, agentTransferDownloadGroup=agentTransferDownloadGroup, agentSwitchAddressAgingTimeoutTable=agentSwitchAddressAgingTimeoutTable, agentLoginSessionSessionTime=agentLoginSessionSessionTime, agentTransferDownloadFilename=agentTransferDownloadFilename, agentLagConfigStaticCapability=agentLagConfigStaticCapability, agentStpCstRootFwdDelay=agentStpCstRootFwdDelay, agentNetworkJavaMode=agentNetworkJavaMode, agentStpCstBridgeHoldTime=agentStpCstBridgeHoldTime, agentLoginSessionUserName=agentLoginSessionUserName, agentProtocolGroupPortIfIndex=agentProtocolGroupPortIfIndex, agentNetworkDefaultGateway=agentNetworkDefaultGateway, agentSerialParityType=agentSerialParityType, agentStpPortStatsMstpBpduRx=agentStpPortStatsMstpBpduRx, agentStpMstTable=agentStpMstTable, agentLagDetailedPortSpeed=agentLagDetailedPortSpeed, agentClearVlan=agentClearVlan, agentStpMstTimeSinceTopologyChange=agentStpMstTimeSinceTopologyChange, agentSwitchAddressAgingTimeout=agentSwitchAddressAgingTimeout, agentConfigGroup=agentConfigGroup, agentLagDetailedConfigTable=agentLagDetailedConfigTable, agentPortMaxFrameSizeLimit=agentPortMaxFrameSizeLimit, agentSnmpTrapReceiverCreate=agentSnmpTrapReceiverCreate, agentPortClearStats=agentPortClearStats, broadcastStormStartTrap=broadcastStormStartTrap, powerSupplyStatusChangeTrap=powerSupplyStatusChangeTrap, agentLagSummaryConfigTable=agentLagSummaryConfigTable, agentStpPortStatsStpBpduTx=agentStpPortStatsStpBpduTx, agentSerialCharacterSize=agentSerialCharacterSize, agentLagConfigGroup=agentLagConfigGroup, agentStpCstPortOperPointToPoint=agentStpCstPortOperPointToPoint, agentSwitchMFDBTable=agentSwitchMFDBTable, agentSnmpCommunityIPMask=agentSnmpCommunityIPMask, agentCableTesterCableFailureLocation=agentCableTesterCableFailureLocation, agentPortPhysicalStatus=agentPortPhysicalStatus, agentSaveConfig=agentSaveConfig, agentNetworkIPAddress=agentNetworkIPAddress, agentStpCstRegionalRootPathCost=agentStpCstRegionalRootPathCost, agentAuthenticationListTable=agentAuthenticationListTable, agentPortAdminMode=agentPortAdminMode, agentStpSwitchConfigGroup=agentStpSwitchConfigGroup, agentSupportedMibTable=agentSupportedMibTable, agentPortIanaType=agentPortIanaType, agentTelnetConfigGroup=agentTelnetConfigGroup, vlanRequestFailureTrap=vlanRequestFailureTrap, agentNetworkConfigGroup=agentNetworkConfigGroup, agentProtocolGroupStatus=agentProtocolGroupStatus, agentLagSummaryStpMode=agentLagSummaryStpMode, agentSnmpTrapReceiverConfigTable=agentSnmpTrapReceiverConfigTable, agentSnmpConfigGroup=agentSnmpConfigGroup, agentSnmpTrapReceiverStatus=agentSnmpTrapReceiverStatus, agentSwitchBroadcastControlMode=agentSwitchBroadcastControlMode, agentSnmpCommunityIndex=agentSnmpCommunityIndex, agentPortSTPMode=agentPortSTPMode, agentSnmpAuthenticationTrapFlag=agentSnmpAuthenticationTrapFlag, agentPortLinkTrapMode=agentPortLinkTrapMode, agentUserConfigEntry=agentUserConfigEntry, agentPortMaxFrameSize=agentPortMaxFrameSize, gsm7324SwitchingTraps=gsm7324SwitchingTraps, agentLoginSessionEntry=agentLoginSessionEntry, agentTransferDownloadMode=agentTransferDownloadMode, agentSwitchMFDBSummaryEntry=agentSwitchMFDBSummaryEntry, agentUserPortConfigEntry=agentUserPortConfigEntry, agentPortDefaultType=agentPortDefaultType, agentProtocolGroupPortTable=agentProtocolGroupPortTable, agentStpMstPortId=agentStpMstPortId, agentInventoryAdditionalPackages=agentInventoryAdditionalPackages, vlanDeleteLastTrap=vlanDeleteLastTrap, agentProtocolGroupVlanId=agentProtocolGroupVlanId, agentSupportedMibIndex=agentSupportedMibIndex, agentSwitchMFDBFilteringPortMask=agentSwitchMFDBFilteringPortMask, agentStpMstDesignatedBridgeId=agentStpMstDesignatedBridgeId, multipleUsersTrap=multipleUsersTrap, agentStpCstDesignatedCost=agentStpCstDesignatedCost, agentLagSummaryAdminMode=agentLagSummaryAdminMode, agentLagSummaryName=agentLagSummaryName, agentTrapLogEntry=agentTrapLogEntry, agentCableTesterStatus=agentCableTesterStatus, agentTrapLogSystemTime=agentTrapLogSystemTime, agentServicePortSubnetMask=agentServicePortSubnetMask, agentTransferConfigGroup=agentTransferConfigGroup, agentStpConfigName=agentStpConfigName, agentStpMstTopologyChangeCount=agentStpMstTopologyChangeCount, agentClassOfServiceGroup=agentClassOfServiceGroup, agentTransferDownloadDataType=agentTransferDownloadDataType, agentProtocolGroupProtocolIP=agentProtocolGroupProtocolIP, agentPortDot3FlowControlMode=agentPortDot3FlowControlMode, agentStpCstDesignatedBridgeId=agentStpCstDesignatedBridgeId, agentLagConfigCreate=agentLagConfigCreate, agentClearSwitchStats=agentClearSwitchStats, agentAuthenticationListMethod3=agentAuthenticationListMethod3, agentMirroredPortIfIndex=agentMirroredPortIfIndex, agentUserAuthenticationConfigEntry=agentUserAuthenticationConfigEntry, agentSwitchMFDBMacAddress=agentSwitchMFDBMacAddress, agentSwitchMFDBGroup=agentSwitchMFDBGroup, agentInventoryBurnedInMacAddress=agentInventoryBurnedInMacAddress, agentAuthenticationListCreate=agentAuthenticationListCreate, agentSnmpCommunityAccessMode=agentSnmpCommunityAccessMode, agentStpCstBridgeFwdDelay=agentStpCstBridgeFwdDelay, agentSupportedMibName=agentSupportedMibName, linkFailureTrap=linkFailureTrap, agentSerialTimeout=agentSerialTimeout, agentStpMstRowStatus=agentStpMstRowStatus, agentProtocolGroupProtocolARP=agentProtocolGroupProtocolARP, agentInventoryMachineType=agentInventoryMachineType, agentStpMstEntry=agentStpMstEntry, agentUserAuthenticationType=agentUserAuthenticationType, agentClassOfServiceClass=agentClassOfServiceClass, agentCableTesterMinimumCableLength=agentCableTesterMinimumCableLength, agentUserConfigCreate=agentUserConfigCreate, agentAuthenticationListMethod1=agentAuthenticationListMethod1, agentUserEncryptionType=agentUserEncryptionType, agentStpConfigDigestKey=agentStpConfigDigestKey, agentClearPortStats=agentClearPortStats, agentAuthenticationListIndex=agentAuthenticationListIndex, agentStpPortStatsStpBpduRx=agentStpPortStatsStpBpduRx, agentSerialGroup=agentSerialGroup, agentServicePortDefaultGateway=agentServicePortDefaultGateway, agentStpCstConfigGroup=agentStpCstConfigGroup, agentUserPortConfigTable=agentUserPortConfigTable, broadcastStormEndTrap=broadcastStormEndTrap, agentAuthenticationListMethod2=agentAuthenticationListMethod2, agentStpPortEntry=agentStpPortEntry, agentLagSummaryAddPort=agentLagSummaryAddPort, agentLagSummaryFlushTimer=agentLagSummaryFlushTimer, agentStpCstPortId=agentStpCstPortId, agentPortDVlanTagCustomerId=agentPortDVlanTagCustomerId, agentSupportedMibEntry=agentSupportedMibEntry, agentServicePortBurnedInMacAddress=agentServicePortBurnedInMacAddress, agentClearTrapLog=agentClearTrapLog, agentPortAutoNegAdminStatus=agentPortAutoNegAdminStatus, agentTransferDownloadStart=agentTransferDownloadStart, agentTransferDownloadServerIP=agentTransferDownloadServerIP, agentSwitchIGMPSnoopingMRPExpirationTime=agentSwitchIGMPSnoopingMRPExpirationTime, agentSupportedMibDescription=agentSupportedMibDescription, agentSwitchMFDBCurrentEntries=agentSwitchMFDBCurrentEntries, agentAuthenticationListName=agentAuthenticationListName, agentSwitchIGMPSnoopingGroup=agentSwitchIGMPSnoopingGroup, agentUserIndex=agentUserIndex, agentLagSummaryStatus=agentLagSummaryStatus, agentLagSummaryLinkTrap=agentLagSummaryLinkTrap, agentStpForceVersion=agentStpForceVersion, agentStpMstPortEntry=agentStpMstPortEntry, agentSwitchMFDBForwardingPortMask=agentSwitchMFDBForwardingPortMask, fanFailureTrap=fanFailureTrap, agentSnmpTrapReceiverIPAddress=agentSnmpTrapReceiverIPAddress, agentSerialBaudrate=agentSerialBaudrate, agentStpCstPortEdge=agentStpCstPortEdge, agentClassOfServiceEntry=agentClassOfServiceEntry, agentStpCstDesignatedPortId=agentStpCstDesignatedPortId)
mibBuilder.exportSymbols("GSM7324-SWITCHING-MIB", agentTrapLogGroup=agentTrapLogGroup, agentInventorySysDescription=agentInventorySysDescription, agentLoginSessionIndex=agentLoginSessionIndex, agentUserAccessMode=agentUserAccessMode, agentSnmpCommunityConfigTable=agentSnmpCommunityConfigTable, agentStpCstPortPathCost=agentStpCstPortPathCost, agentSwitchIGMPSnoopingGroupMembershipInterval=agentSwitchIGMPSnoopingGroupMembershipInterval, agentInventorySoftwareVersion=agentInventorySoftwareVersion, agentStpCstPortForwardingState=agentStpCstPortForwardingState, agentLoginSessionStatus=agentLoginSessionStatus, agentSpanningTreeConfigGroup=agentSpanningTreeConfigGroup, agentSnmpTrapReceiverCommunityName=agentSnmpTrapReceiverCommunityName, agentSnmpBroadcastStormTrapFlag=agentSnmpBroadcastStormTrapFlag, agentLagDetailedIfIndex=agentLagDetailedIfIndex, agentTransferUploadMode=agentTransferUploadMode, agentStpMstRootPortId=agentStpMstRootPortId, agentSwitchMFDBMaxTableEntries=agentSwitchMFDBMaxTableEntries, agentStpMstVlanTable=agentStpMstVlanTable, agentInfoGroup=agentInfoGroup, agentNetworkWebMode=agentNetworkWebMode, agentStpMstPortForwardingState=agentStpMstPortForwardingState, agentLagDetailedConfigEntry=agentLagDetailedConfigEntry, agentUserPortSecurity=agentUserPortSecurity, agentTransferUploadDataType=agentTransferUploadDataType, agentStpCstPortOperEdge=agentStpCstPortOperEdge, vlanDefaultCfgFailureTrap=vlanDefaultCfgFailureTrap, agentSnmpCommunityStatus=agentSnmpCommunityStatus, agentTrapLogTable=agentTrapLogTable, agentLoginSessionIdleTime=agentLoginSessionIdleTime, agentTransferUploadPath=agentTransferUploadPath, agentLagDetailedPortStatus=agentLagDetailedPortStatus, agentServicePortConfigProtocol=agentServicePortConfigProtocol, agentSwitchMFDBDescription=agentSwitchMFDBDescription, agentPortIfIndex=agentPortIfIndex, agentLagSummaryDeletePort=agentLagSummaryDeletePort, agentStpMstPortPriority=agentStpMstPortPriority, agentSnmpTrapFlagsConfigGroup=agentSnmpTrapFlagsConfigGroup, agentStpPortState=agentStpPortState, agentUserAuthenticationConfigTable=agentUserAuthenticationConfigTable, agentAuthenticationListStatus=agentAuthenticationListStatus, agentTelnetMaxSessions=agentTelnetMaxSessions, agentTransferUploadGroup=agentTransferUploadGroup, agentUserEncryptionPassword=agentUserEncryptionPassword, agentProtocolGroupEntry=agentProtocolGroupEntry, agentStpMstBridgePriority=agentStpMstBridgePriority, agentStpConfigRevision=agentStpConfigRevision, agentDot3adAggPortEntry=agentDot3adAggPortEntry, agentClearLags=agentClearLags, agentUserConfigGroup=agentUserConfigGroup, agentStpPortMigrationCheck=agentStpPortMigrationCheck, agentSnmpMultipleUsersTrapFlag=agentSnmpMultipleUsersTrapFlag, agentClearConfig=agentClearConfig, agentSwitchDot3FlowControlMode=agentSwitchDot3FlowControlMode, agentStpCstRegionalRootId=agentStpCstRegionalRootId, agentClearPasswords=agentClearPasswords, agentAuthenticationListEntry=agentAuthenticationListEntry, agentStpCstBridgeMaxAge=agentStpCstBridgeMaxAge, agentDot3adAggPortTable=agentDot3adAggPortTable, agentProtocolGroupId=agentProtocolGroupId, agentPortMirroringGroup=agentPortMirroringGroup, agentSnmpCommunityName=agentSnmpCommunityName, agentAuthenticationGroup=agentAuthenticationGroup, agentSwitchMFDBVlanId=agentSwitchMFDBVlanId, agentDot3adAggPort=agentDot3adAggPort, agentPortType=agentPortType, agentProtocolGroupCreate=agentProtocolGroupCreate, agentTrapLogTotalSinceLastViewed=agentTrapLogTotalSinceLastViewed, agentNetworkMgmtVlan=agentNetworkMgmtVlan, agentUserName=agentUserName, agentUserPassword=agentUserPassword, agentClassOfServicePriority=agentClassOfServicePriority, agentTransferDownloadStatus=agentTransferDownloadStatus, agentStpMstBridgeIdentifier=agentStpMstBridgeIdentifier, agentStpPortStatsRstpBpduTx=agentStpPortStatsRstpBpduTx)
