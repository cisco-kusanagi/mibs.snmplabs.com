...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/NET-SNMP-MIB
...
MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, TimeTicks, Integer32, NotificationType, Bits, ObjectIdentity, IpAddress, MibIdentifier, enterprises, ModuleIdentity, Counter64, Counter32, iso, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "TimeTicks", "Integer32", "NotificationType", "Bits", "ObjectIdentity", "IpAddress", "MibIdentifier", "enterprises", "ModuleIdentity", "Counter64", "Counter32", "iso", "Unsigned32")
...
mibBuilder.exportSymbols("NET-SNMP-MIB", netSnmpConformance=netSnmpConformance, netSnmpDomains=netSnmpDomains, netSnmpNotificationPrefix=netSnmpNotificationPrefix, netSnmpModuleIDs=netSnmpModuleIDs, netSnmpExperimental=netSnmpExperimental, netSnmpNotificationObjects=netSnmpNotificationObjects, netSnmpNotifications=netSnmpNotifications, netSnmpObjects=netSnmpObjects, netSnmpEnumerations=netSnmpEnumerations, netSnmpPlaypen=netSnmpPlaypen, netSnmpCompliances=netSnmpCompliances, netSnmpGroups=netSnmpGroups, PYSNMP_MODULE_ID=netSnmp, netSnmp=netSnmp, netSnmpAgentOIDs=netSnmpAgentOIDs)
