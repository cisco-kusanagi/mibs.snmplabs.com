...
NotificationType, Counter64, Gauge32, NotificationType, Bits, TimeTicks, ObjectIdentity, ModuleIdentity, IpAddress, Integer32, Unsigned32, MibIdentifier, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, transmission = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Counter64", "Gauge32", "NotificationType", "Bits", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "IpAddress", "Integer32", "Unsigned32", "MibIdentifier", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "transmission")
...
mibBuilder.exportSymbols("RFC1315-MIB", frDlcmiTable=frDlcmiTable, frCircuitReceivedBECNs=frCircuitReceivedBECNs, frDlcmiState=frDlcmiState, frTrapState=frTrapState, frame_relay=frame_relay, frCircuitEntry=frCircuitEntry, frame_relay_globals=frame_relay_globals, frCircuitSentFrames=frCircuitSentFrames, Index=Index, frCircuitReceivedOctets=frCircuitReceivedOctets, frCircuitCommittedBurst=frCircuitCommittedBurst, frDLCIStatusChange=frDLCIStatusChange, frCircuitThroughput=frCircuitThroughput, frDlcmiAddressLen=frDlcmiAddressLen, frCircuitReceivedFrames=frCircuitReceivedFrames, frErrTime=frErrTime, frDlcmiPollingInterval=frDlcmiPollingInterval, frCircuitExcessBurst=frCircuitExcessBurst, frDlcmiMonitoredEvents=frDlcmiMonitoredEvents, frDlcmiEntry=frDlcmiEntry, frErrEntry=frErrEntry, frCircuitLastTimeChange=frCircuitLastTimeChange, frErrIfIndex=frErrIfIndex, frCircuitDlci=frCircuitDlci, frCircuitCreationTime=frCircuitCreationTime, frErrData=frErrData, frErrTable=frErrTable, frErrType=frErrType, frDlcmiIfIndex=frDlcmiIfIndex, frCircuitState=frCircuitState, frCircuitReceivedFECNs=frCircuitReceivedFECNs, frDlcmiMulticast=frDlcmiMulticast, frDlcmiErrorThreshold=frDlcmiErrorThreshold, frCircuitSentOctets=frCircuitSentOctets, DLCI=DLCI, frCircuitIfIndex=frCircuitIfIndex, frDlcmiAddress=frDlcmiAddress, frDlcmiMaxSupportedVCs=frDlcmiMaxSupportedVCs, frDlcmiFullEnquiryInterval=frDlcmiFullEnquiryInterval, frCircuitTable=frCircuitTable)
