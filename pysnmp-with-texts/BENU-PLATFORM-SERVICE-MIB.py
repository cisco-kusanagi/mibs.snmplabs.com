...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/BENU-PLATFORM-SERVICE-MIB
...
TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Bits, Counter64, MibIdentifier, ModuleIdentity, Counter32, iso, Integer32, IpAddress, Gauge32, ObjectIdentity, Unsigned32 = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Bits", "Counter64", "MibIdentifier", "ModuleIdentity", "Counter32", "iso", "Integer32", "IpAddress", "Gauge32", "ObjectIdentity", "Unsigned32")
...
if mibBuilder.loadTexts: benuPlatSerMIB.setContactInfo('Benu Networks,Inc Corporate Headquarters 300 Concord Road, Suite 110 Billerica, MA 01821 USA Tel: +1 978-223-4700 Fax: +1 978-362-1908 Email: info@benunets.com')
if mibBuilder.loadTexts: benuPlatSerMIB.setDescription('The MIB module defines all platform services mibs that are specific to benu enterprise Copyright (C) 2012 by Benu Networks, Inc. All rights reserved.')
