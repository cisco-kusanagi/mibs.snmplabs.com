...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/Dell-VRTX-TRAPS-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:57:32 2019
...
rldot1dStpTrapVrblVID, rldot1dStpTrapVrblifIndex = mibBuilder.importSymbols("Dell-VRTX-BRIDGEMIBOBJECTS-MIB", "rldot1dStpTrapVrblVID", "rldot1dStpTrapVrblifIndex")
...
Bits, Counter64, Gauge32, TimeTicks, ObjectIdentity, ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Unsigned32, Counter32, IpAddress, MibIdentifier, iso, NotificationType, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "Gauge32", "TimeTicks", "ObjectIdentity", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Unsigned32", "Counter32", "IpAddress", "MibIdentifier", "iso", "NotificationType", "Integer32")
...
mibBuilder.exportSymbols("Dell-VRTX-TRAPS-MIB", rlTrunkPortRemovedTrap=rlTrunkPortRemovedTrap, stpLoopbackDetectionResolved=stpLoopbackDetectionResolved, resetRequired=resetRequired, rsIpZhrConnectionsTableOverflow=rsIpZhrConnectionsTableOverflow, stpLoopbackDetection=stpLoopbackDetection, rsSDclientsTableOverflow=rsSDclientsTableOverflow, rxOverflowHWFault=rxOverflowHWFault, rsIpZhrVirtualIpAsSource=rsIpZhrVirtualIpAsSource, rlIpxFftSubOverflow=rlIpxFftSubOverflow, rlEnvMonTemperatureRisingAlarm=rlEnvMonTemperatureRisingAlarm, rldot1xSupplicantLoggedOutTrap=rldot1xSupplicantLoggedOutTrap, rlIgmpV1MsgReceived=rlIgmpV1MsgReceived, rlEeeLldpSingleNeighbour=rlEeeLldpSingleNeighbour, rsIpZhrNotAllocVirtualIp=rsIpZhrNotAllocVirtualIp, rlIpmFftOverflow=rlIpmFftOverflow, PYSNMP_MODULE_ID=rndNotifications, rlPolicyDropPacketTrap=rlPolicyDropPacketTrap, rlHotSwapTrap=rlHotSwapTrap, rndNotifications=rndNotifications, bpduGuardPortSuspended=bpduGuardPortSuspended, rlPhysicalDescriptionChanged=rlPhysicalDescriptionChanged, rlEnvMonPowerSupplyStateChange=rlEnvMonPowerSupplyStateChange, pseInrushPort=pseInrushPort, swIfTablePortUnLock=swIfTablePortUnLock, rldot1dStpPortStateForwarding=rldot1dStpPortStateForwarding, rldot1dStpPortStateNotForwarding=rldot1dStpPortStateNotForwarding, framRelaySwitchConnectionUp=framRelaySwitchConnectionUp, ipxSapTblOverflow=ipxSapTblOverflow, chapFailedCommunication=chapFailedCommunication, rlIpxFftStnOverflow=rlIpxFftStnOverflow, rlVrrpEntriesDeleted=rlVrrpEntriesDeleted, swIfTablePortLock=swIfTablePortLock, rldot1xSupplicantMacUnauthorizedTrap=rldot1xSupplicantMacUnauthorizedTrap, rlTrunkPortAddedTrap=rlTrunkPortAddedTrap, dstrSysLog=dstrSysLog, rlStormControlMinRateTrap=rlStormControlMinRateTrap, startTftp=startTftp, endTftp=endTftp, pppSecurityViolation=pppSecurityViolation, rlTrunkPortNotCapableTrap=rlTrunkPortNotCapableTrap, vlanDynamicToStatic=vlanDynamicToStatic, rldot1xSupplicantQuietPeriodTrap=rldot1xSupplicantQuietPeriodTrap, vlanDynVlanAdded=vlanDynVlanAdded, rldot1xPortStatusAuthorizedTrap=rldot1xPortStatusAuthorizedTrap, rsIpZhrReqStaticConnNotAccepted=rsIpZhrReqStaticConnNotAccepted, rlStackVersionDowngradeTrap=rlStackVersionDowngradeTrap, vlanDynPortRemoved=vlanDynPortRemoved, rlStackVersionUpgradeTrap=rlStackVersionUpgradeTrap, rlEeeLldpMultipleNeighbours=rlEeeLldpMultipleNeighbours, rsSDinactiveServer=rsSDinactiveServer, rsWSDRedundancySwitch=rsWSDRedundancySwitch, rlAAAUserLocked=rlAAAUserLocked, mainLinkUp=mainLinkUp, framRelaySwitchConnectionDown=framRelaySwitchConnectionDown, vlanStaticToDynamic=vlanStaticToDynamic, errorsDuringInit=errorsDuringInit, rlSpecialBpduDbOverflow=rlSpecialBpduDbOverflow, rsSnmpSetRequestInSpecialCfgState=rsSnmpSetRequestInSpecialCfgState, rlPortSuspended=rlPortSuspended, rlPolicyForwardPacketTrap=rlPolicyForwardPacketTrap, vlanDynVlanRemoved=vlanDynVlanRemoved, facsAccessVoilation=facsAccessVoilation, faultBackUp=faultBackUp, rlLockPortTrap=rlLockPortTrap, txOverflowHWFault=txOverflowHWFault, rsDhcpAllocationFailure=rsDhcpAllocationFailure, rlEnvMonFanStateChange=rlEnvMonFanStateChange, rlBrgMacAddFailedTrap=rlBrgMacAddFailedTrap, abortTftp=abortTftp, pseOverloadPort=pseOverloadPort, rlApBackplanePortResolutionTrap=rlApBackplanePortResolutionTrap, rlStackStateChange=rlStackStateChange, vlanDynPortAdded=vlanDynPortAdded, rsPingCompletion=rsPingCompletion, rldot1xPortStatusUnauthorizedTrap=rldot1xPortStatusUnauthorizedTrap, routeTableOverflow=routeTableOverflow, papFailedCommunication=papFailedCommunication, ipxRipTblOverflow=ipxRipTblOverflow, rlIpFftSubOverflow=rlIpFftSubOverflow, rldot1xPortControlModeNotAutoTrap=rldot1xPortControlModeNotAutoTrap, forwardingTabOverflow=forwardingTabOverflow, rldot1xSupplicantMacAuthorizedTrap=rldot1xSupplicantMacAuthorizedTrap, loopbackDetectionPortSuspended=loopbackDetectionPortSuspended, rlIpFftStnOverflow=rlIpFftStnOverflow, autoConfigurationCompleted=autoConfigurationCompleted, rlIgmpProxyTableOverflow=rlIgmpProxyTableOverflow, frDLCIStatudChange=frDLCIStatudChange)
