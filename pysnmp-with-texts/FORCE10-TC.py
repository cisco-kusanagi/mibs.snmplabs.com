...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: f10TextualConventions.setRevisionsDescriptions(('Added new Nemesis card type.', 'Added ExaScale chassis mode and Nemesis card type.', 'Added F10CardOperStatus.', 'Added F10ChassisType and F10HundredthdB.',))
...
if mibBuilder.loadTexts: f10TextualConventions.setContactInfo('http://www.force10networks.com/support')
if mibBuilder.loadTexts: f10TextualConventions.setDescription('The Textual Convention of Dell Networking OS MIB.')
...
class F10CSeriesPortType(TextualConvention, Integer32):
    description = 'Port type available in Dell Networking OS C-Series products.'
    status = 'current'
...
class F10SSeriesPortType(TextualConvention, Integer32):
    description = 'Port type available in Dell Networking OS S-Series products.'
    status = 'current'
...
class F10MSeriesPortType(TextualConvention, Integer32):
    description = 'Port type available in Dell Networking OS M-Series products.'
    status = 'current'
    subtypeSpec = Integer32.subtypeSpec + ConstraintsUnion(SingleValueConstraint(1, 2, 3, 4, 5, 6, 99))
...
mibBuilder.exportSymbols("FORCE10-TC", F10ChassisType=F10ChassisType, PYSNMP_MODULE_ID=f10TextualConventions, F10QueueID=F10QueueID, F10SlotState=F10SlotState, F10SlotID=F10SlotID, F10SwDate=F10SwDate, PortList=PortList, F10SystemPortType=F10SystemPortType, f10TextualConventions=f10TextualConventions, F10MSeriesPortType=F10MSeriesPortType, F10CycloneVersion=F10CycloneVersion, F10SystemCardType=F10SystemCardType, F10HundredthdB=F10HundredthdB, F10CardOperStatus=F10CardOperStatus, F10MfgDate=F10MfgDate, F10ProcessorModuleType=F10ProcessorModuleType, F10InterfaceType=F10InterfaceType, F10CamPartitionType=F10CamPartitionType, F10CSeriesPortType=F10CSeriesPortType, F10PortPipeID=F10PortPipeID, F10CSeriesCardType=F10CSeriesCardType, F10ChassisMode=F10ChassisMode, F10VlanID=F10VlanID, F10SSeriesPortType=F10SSeriesPortType)
