...
# Produced by pysmi-0.3.4 at Wed May  1 12:47:30 2019
...
Counter64, MibIdentifier, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter32, Gauge32, TimeTicks, enterprises, ModuleIdentity, Bits, iso, NotificationType, IpAddress, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Counter64", "MibIdentifier", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter32", "Gauge32", "TimeTicks", "enterprises", "ModuleIdentity", "Bits", "iso", "NotificationType", "IpAddress", "Integer32")
...
mibBuilder.exportSymbols("DKSF-70-4-X-X-1", npThermoMemo=npThermoMemo, npIoLevelIn=npIoLevelIn, npRelayEntry=npRelayEntry, npCurLoopTrapPower=npCurLoopTrapPower, npGsmFailed=npGsmFailed, npIrStatus=npIrStatus, npGsmTraps=npGsmTraps, npThermoTrapLow=npThermoTrapLow, npReboot=npReboot, npIoTable=npIoTable, npIoLineN=npIoLineN, npRelHumSensorStatusH=npRelHumSensorStatusH, npRelayState=npRelayState, npCurLoopTrapPrefix=npCurLoopTrapPrefix, npIoMemo=npIoMemo, npCurLoopTrapR=npCurLoopTrapR, npRelayMemo=npRelayMemo, npRelayTable=npRelayTable, npThermoHigh=npThermoHigh, npRelHumTrapPrefix=npRelHumTrapPrefix, npThermoStatus=npThermoStatus, npGsmRegistration=npGsmRegistration, npCurLoopTable=npCurLoopTable, npRelay=npRelay, npThermoValue=npThermoValue, npIoTrapLevelLegend=npIoTrapLevelLegend, npForcedReboot=npForcedReboot, npThermoTrapMemo=npThermoTrapMemo, npIoTrapPrefix=npIoTrapPrefix, npCurLoopTrapStatus=npCurLoopTrapStatus, npRelayN=npRelayN, npThermoTable=npThermoTable, npRelayMode=npRelayMode, PYSNMP_MODULE_ID=uniPingServerSolutionV3, npThermoTrapValue=npThermoTrapValue, npRelHumTraps=npRelHumTraps, npRelHumSafeRangeHigh=npRelHumSafeRangeHigh, npIoTrapLevelIn=npIoTrapLevelIn, npCurLoopPower=npCurLoopPower, npIo=npIo, npIoTrap=npIoTrap, npCurLoop=npCurLoop, npIrPlayCmd=npIrPlayCmd, npThermoTrap=npThermoTrap, npIrCtrl=npIrCtrl, npIoTrapMemo=npIoTrapMemo, npRelHumSensor=npRelHumSensor, npGsm=npGsm, npThermoTrapPrefix=npThermoTrapPrefix, npIrReset=npIrReset, npCurLoopI=npCurLoopI, npRelHumidity=npRelHumidity, npThermoSensorN=npThermoSensorN, npGsmTrap=npGsmTrap, npGsmTrapPrefix=npGsmTrapPrefix, npCurLoopEntry=npCurLoopEntry, npRelHumSensorValueT=npRelHumSensorValueT, npCurLoopTraps=npCurLoopTraps, npIoPulseCounter=npIoPulseCounter, npThermo=npThermo, npThermoTrapStatus=npThermoTrapStatus, npGsmInfo=npGsmInfo, npCurLoopN=npCurLoopN, npCurLoopTrapN=npCurLoopTrapN, npGsmSendSms=npGsmSendSms, npIoTraps=npIoTraps, npIoLevelOut=npIoLevelOut, npThermoTraps=npThermoTraps, npRelHumSafeRangeLow=npRelHumSafeRangeLow, npTrapEmailTo=npTrapEmailTo, npResetStack=npResetStack, npRelHumSensorStatus=npRelHumSensorStatus, npIoSinglePulseDuration=npIoSinglePulseDuration, npCurLoopV=npCurLoopV, npRelHumSensorValueT100=npRelHumSensorValueT100, uniPingServerSolutionV3=uniPingServerSolutionV3, npRelHumTrap=npRelHumTrap, npThermoEntry=npThermoEntry, npThermoLow=npThermoLow, npIoEntry=npIoEntry, npRelayStartReset=npRelayStartReset, npCurLoopTrap=npCurLoopTrap, npThermoTrapHigh=npThermoTrapHigh, npIr=npIr, npCurLoopTrapI=npCurLoopTrapI, npCurLoopR=npCurLoopR, npRelHumSensorValueH=npRelHumSensorValueH, npIoSinglePulseStart=npIoSinglePulseStart, lightcom=lightcom, npGsmStrength=npGsmStrength, npSoftReboot=npSoftReboot, npCurLoopTrapV=npCurLoopTrapV, npCurLoopStatus=npCurLoopStatus, npThermoTrapSensorN=npThermoTrapSensorN, npTrapInfo=npTrapInfo, npIoTrapLineN=npIoTrapLineN)
