...
# Produced by pysmi-0.3.4 at Wed May  1 14:15:15 2019
...
ObjectIdentity, Gauge32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, Counter32, MibIdentifier, Bits, Integer32, Counter64, TimeTicks, Unsigned32, IpAddress, ModuleIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ObjectIdentity", "Gauge32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "Counter32", "MibIdentifier", "Bits", "Integer32", "Counter64", "TimeTicks", "Unsigned32", "IpAddress", "ModuleIdentity", "iso")
...
mibBuilder.exportSymbols("MRV-IN-REACH-DECNET-MIB", xPhivCircuitIndex=xPhivCircuitIndex, phivCircuitRoutingTimer=phivCircuitRoutingTimer, phivMaxPaths=phivMaxPaths, phivCircuitExportEntry=phivCircuitExportEntry, xPhivExportArea=xPhivExportArea, phivCircuitExportAreaTable=phivCircuitExportAreaTable, rcpRemoteAddress=rcpRemoteAddress, phivTrafficDst=phivTrafficDst, xRcp=xRcp, phivCircuitImportAddr=phivCircuitImportAddr, phivTrafficIndex=phivTrafficIndex, phivTrafficIf=phivTrafficIf, phivCircuitFilterStatus=phivCircuitFilterStatus, phivCircuitFilterDstAddr=phivCircuitFilterDstAddr, phivCircuitLastErrorTime=phivCircuitLastErrorTime, phivCircuitImportAction=phivCircuitImportAction, xPhivRoute=xPhivRoute, phivCircuitImportMask=phivCircuitImportMask, phivCircuitImportAreaMask=phivCircuitImportAreaMask, phivCircuitExportAction=phivCircuitExportAction, phivCircuitExportAreaMask=phivCircuitExportAreaMask, xPhivCircuit=xPhivCircuit, phivCircuitImportAreaAddr=phivCircuitImportAreaAddr, phivCircuitImportAreaIf=phivCircuitImportAreaIf, phivTrafficEntry=phivTrafficEntry, phivTrafficPercent=phivTrafficPercent, phivCircuitLastErrorData=phivCircuitLastErrorData, phivCircuitExportAddr=phivCircuitExportAddr, phivStatus=phivStatus, phivCircuitLastError=phivCircuitLastError, phivCircuitImportAreaStatus=phivCircuitImportAreaStatus, phivCircuitImportAreaAction=phivCircuitImportAreaAction, xPhivTraffic=xPhivTraffic, phivCircuitExportIf=phivCircuitExportIf, phivCircuitFilterDstMask=phivCircuitFilterDstMask, phivTrafficSrc=phivTrafficSrc, phivPathSelection=phivPathSelection, phivCircuitImportIf=phivCircuitImportIf, phivCircuitExportAreaAction=phivCircuitExportAreaAction, xPhivImportArea=xPhivImportArea, phivCircuitFilterIf=phivCircuitFilterIf, phivCircuitFilterSrcMask=phivCircuitFilterSrcMask, phivCircuitEntry=phivCircuitEntry, phivCircuitExportMask=phivCircuitExportMask, phivCircuitOperCost=phivCircuitOperCost, phivCircuitProtocolPriority=phivCircuitProtocolPriority, phivCircuitImportEntry=phivCircuitImportEntry, phivCircuitExportAreaIf=phivCircuitExportAreaIf, phivCircuitFilterTable=phivCircuitFilterTable, phivCircuitRoutingPriority=phivCircuitRoutingPriority, xPhiv=xPhiv, phivCircuitFilterAction=phivCircuitFilterAction, phivCircuitImportTable=phivCircuitImportTable, phivCircuitFilterEntry=phivCircuitFilterEntry, phivCircuitFilterSrcAddr=phivCircuitFilterSrcAddr, xPhivExport=xPhivExport, phivTrafficSort=phivTrafficSort, phivCircuitImportAreaEntry=phivCircuitImportAreaEntry, phivCircuitErrors=phivCircuitErrors, phivCircuitExportAreaEntry=phivCircuitExportAreaEntry, phivCircuitExportAreaStatus=phivCircuitExportAreaStatus, phivCircuitImportStatus=phivCircuitImportStatus, phivTrafficTable=phivTrafficTable, phivCircuitExportAreaAddr=phivCircuitExportAreaAddr, phivCircuitTable=phivCircuitTable, phivCircuitExportTable=phivCircuitExportTable, phivCircuitImportAreaTable=phivCircuitImportAreaTable, xDecnet=xDecnet, xPhivFilter=xPhivFilter, xPhivImport=xPhivImport, phivCircuitExportStatus=phivCircuitExportStatus)
