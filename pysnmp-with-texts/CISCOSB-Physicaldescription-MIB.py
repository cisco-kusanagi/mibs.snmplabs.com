...
# Produced by pysmi-0.3.4 at Wed May  1 12:23:09 2019
...
Gauge32, ObjectIdentity, Unsigned32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, MibIdentifier, iso, TimeTicks, Bits, ModuleIdentity, IpAddress, Integer32, NotificationType, Counter32 = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "ObjectIdentity", "Unsigned32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "MibIdentifier", "iso", "TimeTicks", "Bits", "ModuleIdentity", "IpAddress", "Integer32", "NotificationType", "Counter32")
...
if mibBuilder.loadTexts: rlPhysicalDescription.setContactInfo('Postal: 170 West Tasman Drive San Jose , CA 95134-1706 USA Website: Cisco Small Business Home http://www.cisco.com/smb>;, Cisco Small Business Support Community <http://www.cisco.com/go/smallbizsupport>')
...
mibBuilder.exportSymbols("CISCOSB-Physicaldescription-MIB", rlPhdUnitGenParamServiceTag=rlPhdUnitGenParamServiceTag, rlPhdStackEntry=rlPhdStackEntry, rlPhdModuleHotSwapAdminStatus=rlPhdModuleHotSwapAdminStatus, rlPhdPortsModuleNumber=rlPhdPortsModuleNumber, rlCascadeAfterResetEntry=rlCascadeAfterResetEntry, rlPhdPortsColumn=rlPhdPortsColumn, rlPhdMibVersion=rlPhdMibVersion, rlPhdModuleHotSwapTable=rlPhdModuleHotSwapTable, rlPhdUnitGenParamMd5ChksumImage1=rlPhdUnitGenParamMd5ChksumImage1, rlPhdStackOrderUnitType=rlPhdStackOrderUnitType, rlCascadeTrunkId=rlCascadeTrunkId, rlPhdUnitEnvParamRedundantPSStatus=rlPhdUnitEnvParamRedundantPSStatus, rlPhdUnitEnvParamFan2Status=rlPhdUnitEnvParamFan2Status, rlPhdModuleHotSwapOperStatus=rlPhdModuleHotSwapOperStatus, rlCascadeNeighborIfIndex=rlCascadeNeighborIfIndex, rlStackBackupUnitRemoved=rlStackBackupUnitRemoved, rlPhdPoeEntry=rlPhdPoeEntry, rlPhdPhyLedStackUnit=rlPhdPhyLedStackUnit, rlPhdUnitGenParamHardwareVersion=rlPhdUnitGenParamHardwareVersion, rlPhdUnitGenParamRegistrationSuppressed=rlPhdUnitGenParamRegistrationSuppressed, rlPhdStackConnect2=rlPhdStackConnect2, rlCascadeTrunkIdAfterReset=rlCascadeTrunkIdAfterReset, rlPhdUnitEnvParamFan4Status=rlPhdUnitEnvParamFan4Status, rlPhdNumberOfUnits=rlPhdNumberOfUnits, rlCascadeRowStatus=rlCascadeRowStatus, rlCascadeAfterResetTable=rlCascadeAfterResetTable, rlPhdUnitGenParamRegistrationDone=rlPhdUnitGenParamRegistrationDone, rlCascadeUnitId=rlCascadeUnitId, rlPhdModuleIndex=rlPhdModuleIndex, rlPhdPortsEntry=rlPhdPortsEntry, rlPhdNumberOfPoeUnits=rlPhdNumberOfPoeUnits, rlStackConfigChangedRingChain=rlStackConfigChangedRingChain, rlPhdUnitEnvParamEntry=rlPhdUnitEnvParamEntry, rlPhdStackOrderUnitIndex=rlPhdStackOrderUnitIndex, rlPhdStackMacAddr=rlPhdStackMacAddr, rlPhdForceMasterUnit=rlPhdForceMasterUnit, rlPhdModuleHotSwapEntry=rlPhdModuleHotSwapEntry, PYSNMP_MODULE_ID=rlPhysicalDescription, rlStackUnitDifferentSwVersion=rlStackUnitDifferentSwVersion, rlPhdPortsIfIndex=rlPhdPortsIfIndex, rlPhdUnitEnvParamMonitorOperStatus=rlPhdUnitEnvParamMonitorOperStatus, rlPhdStackUnit=rlPhdStackUnit, rlPhdUnitGenParamAssetTag=rlPhdUnitGenParamAssetTag, rlPhdUnitEnvParamUpTime=rlPhdUnitEnvParamUpTime, rlPhdUnitEnvParamTempSensorValue=rlPhdUnitEnvParamTempSensorValue, rlPhdStackFixedUnitLocation=rlPhdStackFixedUnitLocation, rlPhdStackReorder=rlPhdStackReorder, rlPhdUnitGenParamTable=rlPhdUnitGenParamTable, rlPhdModuleNumberOfPorts=rlPhdModuleNumberOfPorts, rlPhdUnitGenParamFirmwareVersion=rlPhdUnitGenParamFirmwareVersion, rlPhdStackTable=rlPhdStackTable, rlPhdStackFixedUnit=rlPhdStackFixedUnit, rlPhdPortsRow=rlPhdPortsRow, rlPhdStackOrderDesiredUnitPosition=rlPhdStackOrderDesiredUnitPosition, rlPhdStackOrderTable=rlPhdStackOrderTable, rlPhdPortsIfIndexName=rlPhdPortsIfIndexName, rlPhdModuleStackUnit=rlPhdModuleStackUnit, rlPhdUnitEnvParamFan1Status=rlPhdUnitEnvParamFan1Status, rlPhdStackType=rlPhdStackType, rlCascadeTable=rlCascadeTable, rlCascadeIfIndexAfterReset=rlCascadeIfIndexAfterReset, rlPhdStackOrderBottomUnit=rlPhdStackOrderBottomUnit, rlPhdModuleEntry=rlPhdModuleEntry, rlPhdPoeStackUnit=rlPhdPoeStackUnit, rlPhdUnitGenParamSoftwareVersion=rlPhdUnitGenParamSoftwareVersion, rlPhdModuleColumn=rlPhdModuleColumn, rlPhdPoePresent=rlPhdPoePresent, rlPhdUnitEnvParamTempSensorStatus=rlPhdUnitEnvParamTempSensorStatus, rlPhdPortsMediaType=rlPhdPortsMediaType, rlPhdModuleRow=rlPhdModuleRow, rlPhdStackOrderCurrentUnitPosition=rlPhdStackOrderCurrentUnitPosition, rlPhdStackProductID=rlPhdStackProductID, rlPhdPhyLedTimeout=rlPhdPhyLedTimeout, rlStackDuplicateUnitNotJoin=rlStackDuplicateUnitNotJoin, rlPhdUnitGenParamFirmwareDate=rlPhdUnitGenParamFirmwareDate, rlCascadeEntry=rlCascadeEntry, rlPhysicalDescription=rlPhysicalDescription, rlPhdPoeTable=rlPhdPoeTable, rlPhdStackSofrwareVer=rlPhdStackSofrwareVer, rlPhdPortsStackUnit=rlPhdPortsStackUnit, rlPhdModuleTable=rlPhdModuleTable, rlStackLinkChange=rlStackLinkChange, rlPhdUnitEnvParamMainPSStatus=rlPhdUnitEnvParamMainPSStatus, rlPhdModuleStartingPort=rlPhdModuleStartingPort, rlPhdUnitGenParamManufacturer=rlPhdUnitGenParamManufacturer, rlPhdStackOrderPermutation=rlPhdStackOrderPermutation, rlPhdConnectorType=rlPhdConnectorType, rlPhdUnitEnvParamFan3Status=rlPhdUnitEnvParamFan3Status, rlPhdUnitGenParamMd5ChksumBoot=rlPhdUnitGenParamMd5ChksumBoot, rlPhdStackOrderEntry=rlPhdStackOrderEntry, rlPhdStackOrderTopUnit=rlPhdStackOrderTopUnit, rlPhdUnitGenParamSerialNum=rlPhdUnitGenParamSerialNum, rlPhdStackReloadUnit=rlPhdStackReloadUnit, rlPhdUnitEnvParamMonitorAutoRecoveryEnable=rlPhdUnitEnvParamMonitorAutoRecoveryEnable, rlPhdModuleRole=rlPhdModuleRole, rlPhdUnitEnvParamFan5Status=rlPhdUnitEnvParamFan5Status, rlPhdUnitEnvParamStackUnit=rlPhdUnitEnvParamStackUnit, rlPhdMaxNumberOfUnits=rlPhdMaxNumberOfUnits, rlPhdPortsTable=rlPhdPortsTable, rlPhdUnitGenParamStackUnit=rlPhdUnitGenParamStackUnit, rlPhdStackConnect1=rlPhdStackConnect1, rlPhdUnitGenParamModelName=rlPhdUnitGenParamModelName, rlStackUnitRemoved=rlStackUnitRemoved, rlPhdUnitEnvParamMonitorTemperatureStatus=rlPhdUnitEnvParamMonitorTemperatureStatus, rlPhdPortHaul=rlPhdPortHaul, rlPhdUnitGenParamMd5ChksumImage2=rlPhdUnitGenParamMd5ChksumImage2, rlPhdUnitEnvParamTable=rlPhdUnitEnvParamTable, rlPhdUnitGenParamEntry=rlPhdUnitGenParamEntry, rlPhdModuleType=rlPhdModuleType, rlPhdUnitGenParamSoftwareDate=rlPhdUnitGenParamSoftwareDate, rlCascadeNeighborUnit=rlCascadeNeighborUnit, rlStackMasterSwitchover=rlStackMasterSwitchover)
