...
# Produced by pysmi-0.3.4 at Wed May  1 12:37:21 2019
...
ModuleIdentity, mgmt, internet, Counter32, IpAddress, Gauge32, Counter64, ObjectIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Integer32, Unsigned32, Bits, NotificationType, MibIdentifier, TimeTicks, iso = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "mgmt", "internet", "Counter32", "IpAddress", "Gauge32", "Counter64", "ObjectIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Integer32", "Unsigned32", "Bits", "NotificationType", "MibIdentifier", "TimeTicks", "iso")
...
mibBuilder.exportSymbols("DE1500-MIB", monHubUtilization=monHubUtilization, snmpInTotalSetVars=snmpInTotalSetVars, ifInNUcastPkts=ifInNUcastPkts, basicHubLed=basicHubLed, basicPortEntry=basicPortEntry, monPortDataRateMismatchs=monPortDataRateMismatchs, addPortEntry=addPortEntry, snmpOutNoSuchNames=snmpOutNoSuchNames, udpInErrors=udpInErrors, snmpInPkts=snmpInPkts, addPortSourceAddrChanges=addPortSourceAddrChanges, basicHubMIBVersion=basicHubMIBVersion, snmpInTooBigs=snmpInTooBigs, ipReasmFails=ipReasmFails, sysObjectID=sysObjectID, basicHubHealthData=basicHubHealthData, ipInReceives=ipInReceives, monPortFrameTooShorts=monPortFrameTooShorts, snmpInASNParseErrs=snmpInASNParseErrs, icmpInAddrMasks=icmpInAddrMasks, basicHubVersion=basicHubVersion, icmpInEchoReps=icmpInEchoReps, udp=udp, icmpOutTimestampReps=icmpOutTimestampReps, monPortFcsErrors=monPortFcsErrors, snmpOutSetRequests=snmpOutSetRequests, ifOutDiscards=ifOutDiscards, icmpInTimeExcds=icmpInTimeExcds, ipForwDatagrams=ipForwDatagrams, basicPortID=basicPortID, monPortFrameTooLongs=monPortFrameTooLongs, basucHubIntrusion=basucHubIntrusion, icmpOutTimeExcds=icmpOutTimeExcds, monPortReadableOctets=monPortReadableOctets, ipOutRequests=ipOutRequests, ipReasmTimeout=ipReasmTimeout, icmpOutSrcQuenchs=icmpOutSrcQuenchs, icmpOutAddrMaskReps=icmpOutAddrMaskReps, ifSpecific=ifSpecific, basicPortAdminState=basicPortAdminState, ifLastChange=ifLastChange, snmpOutBadValues=snmpOutBadValues, ifIndex=ifIndex, monPortID=monPortID, snmpInTraps=snmpInTraps, interfaces=interfaces, ifTable=ifTable, system=system, ifOutNUcastPkts=ifOutNUcastPkts, ifPhyAddress=ifPhyAddress, ifOperStatus=ifOperStatus, ifOutOctets=ifOutOctets, d_link=d_link, addrTrackGroup=addrTrackGroup, ifType=ifType, ifMtu=ifMtu, udpTable=udpTable, snmpInGetNexts=snmpInGetNexts, monHubCollisions=monHubCollisions, icmpInAddrMaskReps=icmpInAddrMaskReps, sysContact=sysContact, udpInDatagrams=udpInDatagrams, enterprises=enterprises, basicPortClearStats=basicPortClearStats, basicHubNumofPorts=basicHubNumofPorts, snmpOutGenErrs=snmpOutGenErrs, ipInUnknownProtos=ipInUnknownProtos, snmpInGetResponses=snmpInGetResponses, basicGroup=basicGroup, snmpInBadVersions=snmpInBadVersions, udpEntry=udpEntry, snmpOutTraps=snmpOutTraps, ipFragCreates=ipFragCreates, basicHubReset=basicHubReset, icmpOutDestUnreachs=icmpOutDestUnreachs, monHubLedFlag=monHubLedFlag, ifInErrors=ifInErrors, ipFragFails=ipFragFails, icmpOutEchos=icmpOutEchos, ipInDiscards=ipInDiscards, ifSpeed=ifSpeed, icmpInRedirects=icmpInRedirects, monPortReadableFrames=monPortReadableFrames, sysLocation=sysLocation, ipReasmReqds=ipReasmReqds, icmpInParmProbs=icmpInParmProbs, icmpOutMsgs=icmpOutMsgs, udpNoPorts=udpNoPorts, monPortCollisions=monPortCollisions, icmpOutAddrMasks=icmpOutAddrMasks, sysDescr=sysDescr, snmpInNoSuchNames=snmpInNoSuchNames, sysUpTime=sysUpTime, icmp=icmp, basicHubSelfTest2=basicHubSelfTest2, monHubReadableFrames=monHubReadableFrames, monPortEntry=monPortEntry, ipInAddrErrors=ipInAddrErrors, addPortAuthorized=addPortAuthorized, icmpOutTimestamps=icmpOutTimestamps, icmpOutParmProbs=icmpOutParmProbs, ip=ip, snmpInBadCommunityNames=snmpInBadCommunityNames, ifInDiscards=ifInDiscards, experimental=experimental, icmpInDestUnreachs=icmpInDestUnreachs, monPortLateCollisions=monPortLateCollisions, ipOutDiscards=ipOutDiscards, basicPortLink=basicPortLink, snmpInTotalReqVars=snmpInTotalReqVars, snmpInBadTypes=snmpInBadTypes, basicHubVender=basicHubVender, ipOutNoRoutes=ipOutNoRoutes, ifInUnknownProtos=ifInUnknownProtos, basicPortAutoPartState=basicPortAutoPartState, ifOutQLen=ifOutQLen, directory=directory, hubmib=hubmib, snmpInGenErrs=snmpInGenErrs, snmpOutGetNexts=snmpOutGetNexts, ifEntry=ifEntry, ifOutUcastPkts=ifOutUcastPkts, snmpOutTooBigs=snmpOutTooBigs, icmpOutRedirects=icmpOutRedirects, snmpInReadOnlys=snmpInReadOnlys, basicHubHealthState=basicHubHealthState, monPortAlignmentErrors=monPortAlignmentErrors, ipReasmOKs=ipReasmOKs, icmpInSrcQuenchs=icmpInSrcQuenchs, ifDescr=ifDescr, mib=mib, basicPortTable=basicPortTable, monHubBadFrames=monHubBadFrames, basicHubHealthText=basicHubHealthText, basicPortName=basicPortName, icmpOutErrors=icmpOutErrors, icmpInEchos=icmpInEchos, snmpOutGetResponses=snmpOutGetResponses, udpLocalAddress=udpLocalAddress, ifOutErrors=ifOutErrors, ipInHdrErrors=ipInHdrErrors, ipFragOKs=ipFragOKs, snmpInBadCommunityUses=snmpInBadCommunityUses, ipForwarding=ipForwarding, icmpInTimestampReps=icmpInTimestampReps, snmpOutGetRequests=snmpOutGetRequests, udpOutDatagrams=udpOutDatagrams, basicPortType=basicPortType, sysName=sysName, addPortTable=addPortTable, ipInDelivers=ipInDelivers, snmp=snmp, icmpInMsgs=icmpInMsgs, snmpInSetRequests=snmpInSetRequests, ifNumber=ifNumber, addPortLastSourceAddress=addPortLastSourceAddress, snmpEnableAuthTraps=snmpEnableAuthTraps, icmpInErrors=icmpInErrors, ifInOctets=ifInOctets, basicHubSelfTest1=basicHubSelfTest1, snmpInGetRequests=snmpInGetRequests, snmpOutReadOnlys=snmpOutReadOnlys, basicHubClearStats=basicHubClearStats, ipDefaultTTL=ipDefaultTTL, monPortRunts=monPortRunts, udpLocalPort=udpLocalPort, monitorGroup=monitorGroup, snmpInBadValues=snmpInBadValues, icmpInTimestamps=icmpInTimestamps, monPortBadFrames=monPortBadFrames, icmpOutEchoReps=icmpOutEchoReps, ifInUcastPkts=ifInUcastPkts, basicHubProduct=basicHubProduct, ifAdminStatus=ifAdminStatus, sysServices=sysServices, monPortAutoPartitions=monPortAutoPartitions, monPortTable=monPortTable, monHubReadableOctets=monHubReadableOctets, addPortID=addPortID, private=private, snmpOutPkts=snmpOutPkts)
