...
# Produced by pysmi-0.3.4 at Wed May  1 14:23:07 2019
...
NotificationType, Unsigned32, TimeTicks, IpAddress, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Integer32, ObjectIdentity, Counter32, Counter64, MibIdentifier, Gauge32, ModuleIdentity = mibBuilder.importSymbols("SNMPv2-SMI", "NotificationType", "Unsigned32", "TimeTicks", "IpAddress", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Integer32", "ObjectIdentity", "Counter32", "Counter64", "MibIdentifier", "Gauge32", "ModuleIdentity")
...
if mibBuilder.loadTexts: nncExtPositionMaxPossible.setDescription('The maximum possible number of positions in the unit. Positions are numbered from 1 to the value of this object.')
nncExtPositionTable = MibTable((1, 3, 6, 1, 4, 1, 123, 3, 8, 2), )
if mibBuilder.loadTexts: nncExtPositionTable.setStatus('mandatory')
if mibBuilder.loadTexts: nncExtPositionTable.setDescription('Configuration and status information for positions and their contents.')
...
if mibBuilder.loadTexts: nncExtPositionEntry.setDescription('Configuration and status information for positions and their contents.')
...
mibBuilder.exportSymbols("NNCGNI00X4-MIB", PositionAdminStatus=PositionAdminStatus, nncExtPositionUIName=nncExtPositionUIName, nncExtPositionTable=nncExtPositionTable, PositionVariantId=PositionVariantId, nncExtPositionProgModule=nncExtPositionProgModule, nncExtPositionAdminStatus=nncExtPositionAdminStatus, nncExtPositionVariantId=nncExtPositionVariantId, nncExtPositionCardId=nncExtPositionCardId, nncExtPositionBackplaneIdAndRev=nncExtPositionBackplaneIdAndRev, nncExtPositionOperStatus=nncExtPositionOperStatus, PositionCardId=PositionCardId, PositionCardType=PositionCardType, PositionOperStatus=PositionOperStatus, nncExtPositionCurrentCard=nncExtPositionCurrentCard, nncExtPositionMaxPossible=nncExtPositionMaxPossible, nncExtPositionDisplayIdAndRev=nncExtPositionDisplayIdAndRev, nncExtPositionEntry=nncExtPositionEntry, nncExtPositionFirmwareRevision=nncExtPositionFirmwareRevision, PositionModuleType=PositionModuleType, nncExtPositionCurrentModule=nncExtPositionCurrentModule, nncExtPositionName=nncExtPositionName, PositionIndex=PositionIndex, RevisionNumber=RevisionNumber, nncExtPositionProgCard=nncExtPositionProgCard, nncExtPositionIndex=nncExtPositionIndex, nncExtPositionModuleId=nncExtPositionModuleId, nncExtPositionHardwareRevision=nncExtPositionHardwareRevision, PositionModuleId=PositionModuleId)
