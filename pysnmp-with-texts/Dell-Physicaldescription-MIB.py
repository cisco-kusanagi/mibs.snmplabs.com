...
# Produced by pysmi-0.3.4 at Wed May  1 12:56:23 2019
...
Unsigned32, MibIdentifier, Counter64, ObjectIdentity, Counter32, NotificationType, ModuleIdentity, Integer32, TimeTicks, Bits, MibScalar, MibTable, MibTableRow, MibTableColumn, Gauge32, iso, IpAddress = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "MibIdentifier", "Counter64", "ObjectIdentity", "Counter32", "NotificationType", "ModuleIdentity", "Integer32", "TimeTicks", "Bits", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Gauge32", "iso", "IpAddress")
...
if mibBuilder.loadTexts: rlPhysicalDescription.setContactInfo('www.dell.com')
...
mibBuilder.exportSymbols("Dell-Physicaldescription-MIB", rlPhdUnitGenParamRegistrationDone=rlPhdUnitGenParamRegistrationDone, rlPhdStackOrderDesiredUnitPosition=rlPhdStackOrderDesiredUnitPosition, rlPhdStackUnit=rlPhdStackUnit, rlPhdUnitStackPortName=rlPhdUnitStackPortName, rlPhdPortsColumn=rlPhdPortsColumn, rlPhdUnitEnvParamMonitorOperStatus=rlPhdUnitEnvParamMonitorOperStatus, rlCascadeNeighborUnit=rlCascadeNeighborUnit, rlPhdStackConnect1=rlPhdStackConnect1, rlStackUnitDifferentSwVersion=rlStackUnitDifferentSwVersion, rlPhdStackReloadUnit=rlPhdStackReloadUnit, rlPhdMaxNumberOfUnits=rlPhdMaxNumberOfUnits, rlPhdUnitGenParamStackUnit=rlPhdUnitGenParamStackUnit, rlPhdStackFixedUnit=rlPhdStackFixedUnit, rlPhdModuleType=rlPhdModuleType, rlStackConfigChangedRingChain=rlStackConfigChangedRingChain, PYSNMP_MODULE_ID=rlPhysicalDescription, rlPhysicalDescription=rlPhysicalDescription, rlPhdUnitGenParamAssetTag=rlPhdUnitGenParamAssetTag, rlPhdUnitGenParamSoftwareVersion=rlPhdUnitGenParamSoftwareVersion, rlPhdPortsMediaType=rlPhdPortsMediaType, rlPhdModuleIndex=rlPhdModuleIndex, rlPhdUnitStackPortConnectionType=rlPhdUnitStackPortConnectionType, rlPhdUnitEnvParamFan4Status=rlPhdUnitEnvParamFan4Status, rlCascadeIfIndexAfterReset=rlCascadeIfIndexAfterReset, rlPhdUnitGenParamFirmwareVersion=rlPhdUnitGenParamFirmwareVersion, rlPhdUnitGenParamMd5ChksumImage2=rlPhdUnitGenParamMd5ChksumImage2, rlPhdNumberOfPoeUnits=rlPhdNumberOfPoeUnits, rlCascadeEntry=rlCascadeEntry, rlPhdPortsIfIndexName=rlPhdPortsIfIndexName, rlPhdPhyLedTimeout=rlPhdPhyLedTimeout, rlPhdStackOrderUnitType=rlPhdStackOrderUnitType, rlCascadeNeighborIfIndex=rlCascadeNeighborIfIndex, rlPhdPoeEntry=rlPhdPoeEntry, rlPhdUnitEnvParamUpTime=rlPhdUnitEnvParamUpTime, rlPhdPoeTable=rlPhdPoeTable, rlPhdModuleHotSwapEntry=rlPhdModuleHotSwapEntry, rlCascadePortSpeed=rlCascadePortSpeed, rlPhdPortsModuleNumber=rlPhdPortsModuleNumber, rlPhdUnitEnvParamTable=rlPhdUnitEnvParamTable, rlPhdStackOrderTopUnit=rlPhdStackOrderTopUnit, rlPhdUnitGenParamHardwareVersion=rlPhdUnitGenParamHardwareVersion, rlStackUnitRemoved=rlStackUnitRemoved, rlPhdForceMasterUnit=rlPhdForceMasterUnit, rlPhdModuleHotSwapAdminStatus=rlPhdModuleHotSwapAdminStatus, rlPhdModuleEntry=rlPhdModuleEntry, rlPhdStackOrderCurrentUnitPosition=rlPhdStackOrderCurrentUnitPosition, rlPhdUnitGenParamFirmwareDate=rlPhdUnitGenParamFirmwareDate, rlPhdUnitStackPortRow=rlPhdUnitStackPortRow, CascadePortState=CascadePortState, rlCascadeUnitId=rlCascadeUnitId, rlPhdUnitEnvParamFan2Status=rlPhdUnitEnvParamFan2Status, rlPhdStackOrderPermutation=rlPhdStackOrderPermutation, rlCascadeTable=rlCascadeTable, rlPhdUnitEnvParamTempSensorStatus=rlPhdUnitEnvParamTempSensorStatus, rlPhdPortsIfIndex=rlPhdPortsIfIndex, rlCascadeAfterResetTable=rlCascadeAfterResetTable, rlPhdModuleStackUnit=rlPhdModuleStackUnit, rlPhdUnitGenParamRegistrationSuppressed=rlPhdUnitGenParamRegistrationSuppressed, rlPhdUnitEnvParamMonitorTemperatureStatus=rlPhdUnitEnvParamMonitorTemperatureStatus, rlCascadeAfterResetEntry=rlCascadeAfterResetEntry, rlPhdModuleStartingPort=rlPhdModuleStartingPort, rlPhdUnitStackPortType=rlPhdUnitStackPortType, rlPhdUnitStackPortColumn=rlPhdUnitStackPortColumn, rlCascadeRowStatus=rlCascadeRowStatus, rlCascadeTrunkId=rlCascadeTrunkId, rlPhdUnitStackPortEntry=rlPhdUnitStackPortEntry, rlPhdPortsTable=rlPhdPortsTable, rlPhdModuleRow=rlPhdModuleRow, rlPhdPortHaul=rlPhdPortHaul, rlPhdStackOrderTable=rlPhdStackOrderTable, rlPhdStackProductID=rlPhdStackProductID, rlPhdUnitGenParamServiceTag=rlPhdUnitGenParamServiceTag, rlPhdStackMacAddr=rlPhdStackMacAddr, rlPhdStackTable=rlPhdStackTable, rlPhdPhyLedStackUnit=rlPhdPhyLedStackUnit, rlPhdUnitGenParamMd5ChksumImage1=rlPhdUnitGenParamMd5ChksumImage1, rlStackDuplicateUnitNotJoin=rlStackDuplicateUnitNotJoin, rlPhdPortsEntry=rlPhdPortsEntry, rlPhdUnitGenParamTable=rlPhdUnitGenParamTable, rlPhdNumberOfUnits=rlPhdNumberOfUnits, rlPhdUnitEnvParamFan5Status=rlPhdUnitEnvParamFan5Status, rlPhdStackSofrwareVer=rlPhdStackSofrwareVer, rlPhdUnitEnvParamRedundantPSStatus=rlPhdUnitEnvParamRedundantPSStatus, rlPhdUnitGenParamMd5ChksumBoot=rlPhdUnitGenParamMd5ChksumBoot, rlPhdUnitStackPortTable=rlPhdUnitStackPortTable, rlPhdPoePresent=rlPhdPoePresent, rlPhdUnitGenParamModelName=rlPhdUnitGenParamModelName, StackPortType=StackPortType, rlPhdMibVersion=rlPhdMibVersion, rlStackLinkChange=rlStackLinkChange, rlPhdUnitEnvParamFan3Status=rlPhdUnitEnvParamFan3Status, rlCascadeTrunkIdAfterReset=rlCascadeTrunkIdAfterReset, rlCascadePortState=rlCascadePortState, rlPhdUnitEnvParamStackUnit=rlPhdUnitEnvParamStackUnit, rlPhdModuleHotSwapTable=rlPhdModuleHotSwapTable, rlPhdModuleHotSwapOperStatus=rlPhdModuleHotSwapOperStatus, rlPhdModuleColumn=rlPhdModuleColumn, CascadePortSpeed=CascadePortSpeed, rlPhdUnitEnvParamMainPSStatus=rlPhdUnitEnvParamMainPSStatus, rlPhdStackFixedUnitLocation=rlPhdStackFixedUnitLocation, rlPhdUnitEnvParamEntry=rlPhdUnitEnvParamEntry, ConnectionType=ConnectionType, rlPhdModuleNumberOfPorts=rlPhdModuleNumberOfPorts, rlPhdPortsRow=rlPhdPortsRow, rlPhdUnitEnvParamTempSensorValue=rlPhdUnitEnvParamTempSensorValue, rlStackBackupUnitRemoved=rlStackBackupUnitRemoved, rlPhdStackConnect2=rlPhdStackConnect2, rlPhdModuleRole=rlPhdModuleRole, rlPhdStackEntry=rlPhdStackEntry, rlPhdConnectorType=rlPhdConnectorType, rlPhdUnitGenParamManufacturer=rlPhdUnitGenParamManufacturer, rlPhdStackOrderEntry=rlPhdStackOrderEntry, rlPhdStackOrderUnitIndex=rlPhdStackOrderUnitIndex, rlPhdUnitGenParamSoftwareDate=rlPhdUnitGenParamSoftwareDate, rlPhdUnitEnvParamMonitorAutoRecoveryEnable=rlPhdUnitEnvParamMonitorAutoRecoveryEnable, rlPhdUnitGenParamEntry=rlPhdUnitGenParamEntry, rlPhdModuleTable=rlPhdModuleTable, rlPhdUnitEnvParamFan1Status=rlPhdUnitEnvParamFan1Status, rlPhdStackType=rlPhdStackType, rlPhdPortsStackUnit=rlPhdPortsStackUnit, rlStackMasterSwitchover=rlStackMasterSwitchover, rlPhdPoeStackUnit=rlPhdPoeStackUnit, rlPhdStackReorder=rlPhdStackReorder, rlPhdUnitGenParamSerialNum=rlPhdUnitGenParamSerialNum, rlPhdStackOrderBottomUnit=rlPhdStackOrderBottomUnit)
