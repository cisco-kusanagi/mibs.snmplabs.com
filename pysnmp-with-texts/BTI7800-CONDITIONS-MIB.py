...
MibScalar, MibTable, MibTableRow, MibTableColumn, TimeTicks, enterprises, iso, ModuleIdentity, IpAddress, Unsigned32, Counter64, Counter32, MibIdentifier, ObjectIdentity, Integer32, Gauge32, NotificationType, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "TimeTicks", "enterprises", "iso", "ModuleIdentity", "IpAddress", "Unsigned32", "Counter64", "Counter32", "MibIdentifier", "ObjectIdentity", "Integer32", "Gauge32", "NotificationType", "Bits")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: bTI7800_CONDITIONS_MIB.setRevisionsDescriptions(('@REVISION-DESCRIPTION',))
...
if mibBuilder.loadTexts: bTI7800_CONDITIONS_MIB.setContactInfo('@CONTACT-INFO')
if mibBuilder.loadTexts: bTI7800_CONDITIONS_MIB.setDescription('The atlas-conditions submodule defines the data modeling that supports the retrieval of active alarms and conditions on the Atlas system.')
...
if mibBuilder.loadTexts: conditionsTable.setDescription('Severity and handling of system condition events')
...
if mibBuilder.loadTexts: conditionsEntry.setDescription('')
...
if mibBuilder.loadTexts: conditionsEntityName.setDescription('')
...
if mibBuilder.loadTexts: conditionsCode.setDescription('')
...
if mibBuilder.loadTexts: conditionsReportType.setDescription('')
...
if mibBuilder.loadTexts: conditionsTimeStamp.setDescription('')
...
if mibBuilder.loadTexts: conditionsSeverity.setDescription('')
...
if mibBuilder.loadTexts: conditionsServiceAffecting.setDescription('')
...
if mibBuilder.loadTexts: conditionsDescription.setDescription('')
mibBuilder.exportSymbols("BTI7800-CONDITIONS-MIB", conditionsEntry=conditionsEntry, bTI7800_CONDITIONS_MIB=bTI7800_CONDITIONS_MIB, ConditionCode=ConditionCode, PYSNMP_MODULE_ID=bTI7800_CONDITIONS_MIB, conditionsEntityName=conditionsEntityName, conditionsServiceAffecting=conditionsServiceAffecting, conditionsReportType=conditionsReportType, String=String, conditionsCode=conditionsCode, conditionsTable=conditionsTable, conditionsDescription=conditionsDescription, ConfdString=ConfdString, conditionsTimeStamp=conditionsTimeStamp, Severity=Severity, conditionsSeverity=conditionsSeverity)
