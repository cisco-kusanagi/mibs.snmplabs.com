...
# Produced by pysmi-0.3.4 at Wed May  1 12:29:35 2019
...
if mibBuilder.loadTexts: ctBusDSStatus.setDescription('Reports the current status of the Secure Fast Directory Services connection.')
...
mibBuilder.exportSymbols("CTRON-BUS-MIB", ctBusDSStatus=ctBusDSStatus, CtLaneDebugLevel=CtLaneDebugLevel, ctBusLaneDbgSNMP=ctBusLaneDbgSNMP, ctBusLaneDbgOutputFile=ctBusLaneDbgOutputFile, ctBusConfGroup=ctBusConfGroup, ctBusLaneDbgConnectionServices=ctBusLaneDbgConnectionServices, ctBusLaneDbgBUS=ctBusLaneDbgBUS, ctBus=ctBus, ctBusUNIVersion=ctBusUNIVersion)
