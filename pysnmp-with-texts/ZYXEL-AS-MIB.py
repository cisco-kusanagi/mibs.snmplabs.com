...
# Produced by pysmi-0.3.4 at Wed May  1 15:49:09 2019
...
if mibBuilder.loadTexts: asMacDisplayTarget.setDescription('This managed object is a filter used for identify the target from which the MAC addresses are learned in macTable. The target should be IfIndex which is used for identifying subscriber ports (e.g. 300 means all ports in slot 3 and 301 means port 1 in slot 3).')
asMacTable = MibTable((1, 3, 6, 1, 4, 1, 890, 1, 5, 1, 2, 1, 2), )
if mibBuilder.loadTexts: asMacTable.setStatus('current')
if mibBuilder.loadTexts: asMacTable.setDescription('A table that contains information about unicast entries for which the bridge has forwarding and/or filtering information. This information is used by the transparent bridging function in determining how to propagate a received frame.')
...
if mibBuilder.loadTexts: asMacEntry.setDescription('An entry of asMacTable.')
...
if mibBuilder.loadTexts: asMacAddress.setDescription('A unicast MAC address for which the bridge has forwarding and/or filtering information.')
...
if mibBuilder.loadTexts: asMacPort.setDescription('The port from which the mac address has been learned.')
...
if mibBuilder.loadTexts: asMacStatus.setDescription('The status of this entry.')
...
mibBuilder.exportSymbols("ZYXEL-AS-MIB", asDhcpServerTable=asDhcpServerTable, accessSwitchFanRpmMaxValue=accessSwitchFanRpmMaxValue, asDhcpRelayOption82Info=asDhcpRelayOption82Info, ASSlotNum=ASSlotNum, asMacPort=asMacPort, overheat=overheat, accessSwitchVoltageCurValue=accessSwitchVoltageCurValue, fanRpmNormal=fanRpmNormal, accessSwitchSlotId=accessSwitchSlotId, accessSwitchSysTempTable=accessSwitchSysTempTable, accessSwitchVoltageLowThresh=accessSwitchVoltageLowThresh, accessSwitchVoltageMaxValue=accessSwitchVoltageMaxValue, accessSwitchDSLConfOps=accessSwitchDSLConfOps, accessSwitchVoltageNominalValue=accessSwitchVoltageNominalValue, asMacDisplayTarget=asMacDisplayTarget, accessSwitchCommon=accessSwitchCommon, accessSwitchSysTempEntry=accessSwitchSysTempEntry, accessSwitchStats=accessSwitchStats, asPacketForwardingTable=asPacketForwardingTable, asPacketForwardingEntry=asPacketForwardingEntry, asDot1xPortTable=asDot1xPortTable, accessSwitchFanRpmDescr=accessSwitchFanRpmDescr, voltageOutOfRange=voltageOutOfRange, asDot1xPortControl=asDot1xPortControl, fanRpmLow=fanRpmLow, asDhcpRelayEnable=asDhcpRelayEnable, voltageNormal=voltageNormal, accessSwitchSysTempHighThresh=accessSwitchSysTempHighThresh, asDot1xPortReAuthEnable=asDot1xPortReAuthEnable, overheatOver=overheatOver, accessSwitchSysTempMinValue=accessSwitchSysTempMinValue, accessSwitchMgnt=accessSwitchMgnt, accessSwitchDSLConfProfileName=accessSwitchDSLConfProfileName, asMacAddress=asMacAddress, accessSwitchFanRpmLowThresh=accessSwitchFanRpmLowThresh, errLog=errLog, asRadiusServerIndex=asRadiusServerIndex, accessSwitchMaintenance=accessSwitchMaintenance, accessSwitchFanRpmEntry=accessSwitchFanRpmEntry, ASModuleType=ASModuleType, asRadiusServerRowStatus=asRadiusServerRowStatus, systemMaintenanceFailure=systemMaintenanceFailure, asRadiusSharedSecret=asRadiusSharedSecret, accessSwitchDSLConfMode=accessSwitchDSLConfMode, accessSwitchFWVersion=accessSwitchFWVersion, accessSwitchSysTempCurValue=accessSwitchSysTempCurValue, asDhcpServerIp=asDhcpServerIp, asMaxNumOfDhcpServers=asMaxNumOfDhcpServers, accessSwitchVoltageEntry=accessSwitchVoltageEntry, asMaxNumberOfRadiusServers=asMaxNumberOfRadiusServers, systemShutdown=systemShutdown, accessSwitchVoltageIndex=accessSwitchVoltageIndex, accessSwitchSysTempDescr=accessSwitchSysTempDescr, accessSwitchSystemCurrentStatus=accessSwitchSystemCurrentStatus, asRadiusServerIp=asRadiusServerIp, acccessSwitchChassisId=acccessSwitchChassisId, thermalSensorFailure=thermalSensorFailure, accessSwitchFanRpmTable=accessSwitchFanRpmTable, accessSwitchFanRpmCurValue=accessSwitchFanRpmCurValue, accessSwitchFanRpmIndex=accessSwitchFanRpmIndex, products=products, asDot1xPortEnable=asDot1xPortEnable, accessSwitchMaintenancePort=accessSwitchMaintenancePort, configChange=configChange, zyxel=zyxel, accessSwitchModuleType=accessSwitchModuleType, accessSwitchMaxNumOfStaticVlans=accessSwitchMaxNumOfStaticVlans, asDot1xPortReAuthPeriod=asDot1xPortReAuthPeriod, asMacTable=asMacTable, accessSwitch=accessSwitch, asDhcpRelayOption82Enable=asDhcpRelayOption82Enable, accessSwitchModemCodeVersion=accessSwitchModemCodeVersion, accessSwitchSysTempIndex=accessSwitchSysTempIndex, accessSwitchDriverVersion=accessSwitchDriverVersion, asDhcpServerRowStatus=asDhcpServerRowStatus, accessSwitchDSLConfTarget=accessSwitchDSLConfTarget, asDot1xEnable=asDot1xEnable, asPacketForwardingPortList=asPacketForwardingPortList, asRadiusServerPort=asRadiusServerPort, accessSwitchVoltageDescr=accessSwitchVoltageDescr, asDhcpServerEntry=asDhcpServerEntry, asMacEntry=asMacEntry, asMacStats=asMacStats, accessSwitchSystemTemperature=accessSwitchSystemTemperature, reboot=reboot, accessSwitchFanRpmMinValue=accessSwitchFanRpmMinValue, accessSwitchProblemCause=accessSwitchProblemCause, accessSwitchSysTempMaxValue=accessSwitchSysTempMaxValue, asDot1xPortEntry=asDot1xPortEntry, accessSwitchVoltageMinValue=accessSwitchVoltageMinValue, asMacStatus=asMacStatus, accessSwitchVoltageTable=accessSwitchVoltageTable, asRadiusServerEntry=asRadiusServerEntry, asRadiusServerTable=asRadiusServerTable)
