...
# Produced by pysmi-0.3.4 at Wed May  1 12:43:32 2019
...
TimeTicks, iso, MibScalar, MibTable, MibTableRow, MibTableColumn, Bits, Gauge32, enterprises, ModuleIdentity, Counter64, Unsigned32, Counter32, ObjectIdentity, MibIdentifier, Integer32, mib_2, IpAddress, NotificationType = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "iso", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Bits", "Gauge32", "enterprises", "ModuleIdentity", "Counter64", "Unsigned32", "Counter32", "ObjectIdentity", "MibIdentifier", "Integer32", "mib-2", "IpAddress", "NotificationType")
...
if mibBuilder.loadTexts: configJumboEnable.setDescription('Enable/Disable Jumbo Frame function. Maximum Length of jumbo frame is 9220 bytes.')
...
mibBuilder.exportSymbols("DGS-1248T-BX-MIB", dot1xAuthConfigPortNumber=dot1xAuthConfigPortNumber, configMirrorTable=configMirrorTable, staticMac=staticMac, commSetEntry=commSetEntry, dot1pPortEntry=dot1pPortEntry, portTrunkMember=portTrunkMember, configMirrorStatus=configMirrorStatus, commGetEntry=commGetEntry, commSetName=commSetName, igsVlanRouterPortListVlanId=igsVlanRouterPortListVlanId, radiusServerAddress=radiusServerAddress, configSafeguardEnable=configSafeguardEnable, portTrunkName=portTrunkName, tvlanMember=tvlanMember, dot1xAuthQuietPeriod=dot1xAuthQuietPeriod, miscStatisticsReset=miscStatisticsReset, PortList=PortList, igsVlanMcastFwdTable=igsVlanMcastFwdTable, configPhysAddress=configPhysAddress, igsVlanFilterStatus=igsVlanFilterStatus, dot1xAuthConfigPortStatus=dot1xAuthConfigPortStatus, configPasswordAdmin=configPasswordAdmin, dot1xAuthConfigPortSessionUserName=dot1xAuthConfigPortSessionUserName, commTrapSNMPFiberLinkUpDown=commTrapSNMPFiberLinkUpDown, dot1xAuthSystemControl=dot1xAuthSystemControl, dot1xAuthConfigPortEntry=dot1xAuthConfigPortEntry, commTrapTrapAbnormalTPTXError=commTrapTrapAbnormalTPTXError, igsVlanRouterPortList=igsVlanRouterPortList, companyPortTrunkGroup=companyPortTrunkGroup, companyIgsGroup=companyIgsGroup, companyDot1xGroup=companyDot1xGroup, igsVlanFilterTable=igsVlanFilterTable, dot1pPortIndex=dot1pPortIndex, commTrapTrapAbnormalFiberTXError=commTrapTrapAbnormalFiberTXError, portTrunkId=portTrunkId, configPortEntry=configPortEntry, tvlanPortEntry=tvlanPortEntry, companyQoSGroup=companyQoSGroup, portTrunkTable=portTrunkTable, companyStaticGroup=companyStaticGroup, RowStatus=RowStatus, igsVlanRouterPortListTable=igsVlanRouterPortListTable, igsVlanId=igsVlanId, tvlanPortTable=tvlanPortTable, configPortFlowControlOper=configPortFlowControlOper, companyTVlanGroup=companyTVlanGroup, igsRouterPortPurgeInterval=igsRouterPortPurgeInterval, commGetStatus=commGetStatus, igsNextMcastFwdMode=igsNextMcastFwdMode, commTrapIpAddress=commTrapIpAddress, configPort=configPort, configMirrorTXSrc=configMirrorTXSrc, staticAutoLearning=staticAutoLearning, dot1pPortPriority=dot1pPortPriority, spanOnOff=spanOnOff, dot1xAuthSuppTimeout=dot1xAuthSuppTimeout, igsReportForwardInterval=igsReportForwardInterval, companyCommGroup=companyCommGroup, configBootTftpOperation=configBootTftpOperation, dot1xAuthMaxReq=dot1xAuthMaxReq, commSetStatus=commSetStatus, igsLastMembQueryInterval=igsLastMembQueryInterval, commSetTable=commSetTable, configIpAddress=configIpAddress, igsVlanMcastFwdEntry=igsVlanMcastFwdEntry, configPortSpeed=configPortSpeed, swFiberRemove=swFiberRemove, dscpPriority=dscpPriority, dot1xAuthServerTimeout=dot1xAuthServerTimeout, tvlanStatus=tvlanStatus, tvlanTable=tvlanTable, dot1xAuthReAuthPeriod=dot1xAuthReAuthPeriod, commTrapTable=commTrapTable, OwnerString=OwnerString, configBootImageFileName=configBootImageFileName, staticId=staticId, configMirrorMon=configMirrorMon, commTrapSNMPTPLinkUpDown=commTrapSNMPTPLinkUpDown, igsQuerierStateOnOff=igsQuerierStateOnOff, tvlanName=tvlanName, commTrapSNMPBootup=commTrapSNMPBootup, configVLANMode=configVLANMode, tvlanId=tvlanId, igsSharedSegmentAggregationInterval=igsSharedSegmentAggregationInterval, dot1xAuth=dot1xAuth, companyConfigGroup=companyConfigGroup, broadcastStormCtrlSettings=broadcastStormCtrlSettings, igsVlan=igsVlan, configPowerSavingEnable=configPowerSavingEnable, tvlanManagementid=tvlanManagementid, radiusServerPort=radiusServerPort, companySecurity=companySecurity, tvlanManagementOnOff=tvlanManagementOnOff, configSave=configSave, dot1xAuthConfigPortTable=dot1xAuthConfigPortTable, miscReset=miscReset, configNetMask=configNetMask, trustedHostEntry=trustedHostEntry, configPortFlowControl=configPortFlowControl, igsv3Processing=igsv3Processing, dscpEntry=dscpEntry, configTftpOperation=configTftpOperation, trustedHostIpAddress=trustedHostIpAddress, staticPort=staticPort, tvlanUntaggedPorts=tvlanUntaggedPorts, staticEntry=staticEntry, commTrapName=commTrapName, configPortTable=configPortTable, configMirrorId=configMirrorId, commTrapIndex=commTrapIndex, configTftpServerFileName=configTftpServerFileName, staticVlanID=staticVlanID, configVerHwChipSet=configVerHwChipSet, igsVlanFilterEntry=igsVlanFilterEntry, swFiberInsert=swFiberInsert, swTPAbnormalTXError=swTPAbnormalTXError, dot1xAuthTxPeriod=dot1xAuthTxPeriod, commGetIndex=commGetIndex, igsSystem=igsSystem, commGetTable=commGetTable, configIpAssignmentMode=configIpAssignmentMode, tvlanPortPortId=tvlanPortPortId, igsVlanMcastFwdGroupAddress=igsVlanMcastFwdGroupAddress, radius=radius, MacAddress=MacAddress, igsGblReportFwdOnAllPorts=igsGblReportFwdOnAllPorts, tvlanEntry=tvlanEntry, dscpIndex=dscpIndex, configRestoreDefaults=configRestoreDefaults, tvlanPortVlanId=tvlanPortVlanId, tvlanAsyOnOff=tvlanAsyOnOff, configTftpServerIpAddress=configTftpServerIpAddress, companySpanGroup=companySpanGroup, dot1xAuthConfigPortControl=dot1xAuthConfigPortControl, dlink_DGS12XXTSeriesProd=dlink_DGS12XXTSeriesProd, dot1pPortTable=dot1pPortTable, igsQueryInterval=igsQueryInterval, trustedHostIpMask=trustedHostIpMask, configSNMPEnable=configSNMPEnable, swFiberAbnormalRXError=swFiberAbnormalRXError, igsQueryMaxResponseTime=igsQueryMaxResponseTime, portTrunkEntry=portTrunkEntry, trustedHostTable=trustedHostTable, trustedHostID=trustedHostID, companyMiscGroup=companyMiscGroup, trustedHostOnOff=trustedHostOnOff, swFiberAbnormalTXError=swFiberAbnormalTXError, commGetName=commGetName, dot1xAuthConfigPortSessionTime=dot1xAuthConfigPortSessionTime, dlink_products=dlink_products, igsRobustnessValue=igsRobustnessValue, swTPAbnormalRXError=swTPAbnormalRXError, radiusServerSharedSecret=radiusServerSharedSecret, dscpTable=dscpTable, trustedHostStatus=trustedHostStatus, staticStatus=staticStatus, staticOnOff=staticOnOff, configVerSwPrimary=configVerSwPrimary, commSetIndex=commSetIndex, commTrapTrapAbnormalFiberRXError=commTrapTrapAbnormalFiberRXError, igsMcastEntryAgeingInterval=igsMcastEntryAgeingInterval, qosMode=qosMode, igsVlanMcastFwdPortListMac=igsVlanMcastFwdPortListMac, configBootTftpServerIp=configBootTftpServerIp, configPortOperStatus=configPortOperStatus, dot1xAuthReAuthEnabled=dot1xAuthReAuthEnabled, broadcastStormCtrlGlobalOnOff=broadcastStormCtrlGlobalOnOff, configGateway=configGateway, commTrapTrapAbnormalTPRXError=commTrapTrapAbnormalTPRXError, commTrapStatus=commTrapStatus, igsVlanRouterPortListEntry=igsVlanRouterPortListEntry, d_link=d_link, companyTrafficMgmt=companyTrafficMgmt, trustedHostSettings=trustedHostSettings, configJumboEnable=configJumboEnable, broadcastStormGlobalThreshold=broadcastStormGlobalThreshold, commTrapEntry=commTrapEntry, igsStatus=igsStatus, igsLeaveProcessInterval=igsLeaveProcessInterval, dgs_1248tbx=dgs_1248tbx, igsHostPortPurgeInterval=igsHostPortPurgeInterval, configMirrorRXSrc=configMirrorRXSrc, staticTable=staticTable, queuingMechanism=queuingMechanism, igsVlanMcastFwdVlanIdMac=igsVlanMcastFwdVlanIdMac, configMirrorEntry=configMirrorEntry)
