...
# Produced by pysmi-0.3.4 at Wed May  1 13:36:19 2019
...
Unsigned32, Gauge32, TimeTicks, ObjectIdentity, NotificationType, IpAddress, Counter32, Bits, ModuleIdentity, MibIdentifier, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, iso, Integer32 = mibBuilder.importSymbols("SNMPv2-SMI", "Unsigned32", "Gauge32", "TimeTicks", "ObjectIdentity", "NotificationType", "IpAddress", "Counter32", "Bits", "ModuleIdentity", "MibIdentifier", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "iso", "Integer32")
...
mibBuilder.exportSymbols("HP-SN-IPX-MIB", snIpxIfSapAccessFilterList=snIpxIfSapAccessFilterList, snIpxCachePort=snIpxCachePort, snIpxRcvPktsCnt=snIpxRcvPktsCnt, snIpxPortCountersRcvPktsCnt=snIpxPortCountersRcvPktsCnt, snIpxIfRipAccessEntry=snIpxIfRipAccessEntry, snIpxSapFilter=snIpxSapFilter, snIpxTxPktsCnt=snIpxTxPktsCnt, snIpxServerName=snIpxServerName, snIpxPortCountersTable=snIpxPortCountersTable, snIpxClearRoute=snIpxClearRoute, snIpxServerIndex=snIpxServerIndex, snIpxIfFwdAccessEntry=snIpxIfFwdAccessEntry, snIpxSapFilterTable=snIpxSapFilterTable, snIpxSapFilterName=snIpxSapFilterName, snIpxIfSapAccessPort=snIpxIfSapAccessPort, snIpxRouteEntry=snIpxRouteEntry, snIpxCacheNetNum=snIpxCacheNetNum, ClearStatus=ClearStatus, snIpxRipFilterMask=snIpxRipFilterMask, snIpxIfRipAccessFilterList=snIpxIfRipAccessFilterList, snIpxIfFwdAccessPort=snIpxIfFwdAccessPort, snIpxPortAddr=snIpxPortAddr, snIpxIfFwdAccess=snIpxIfFwdAccess, snIpxFwdPktsCnt=snIpxFwdPktsCnt, snIpxPortAddrNetBiosFilterMode=snIpxPortAddrNetBiosFilterMode, snIpxRipFilterRowStatus=snIpxRipFilterRowStatus, PhysAddress=PhysAddress, snIpxSapFiltOnAllPort=snIpxSapFiltOnAllPort, snIpxFwdFilterAction=snIpxFwdFilterAction, snIpxIfSapAccessRowStatus=snIpxIfSapAccessRowStatus, snIpxServer=snIpxServer, snIpxPortAddrNetNum=snIpxPortAddrNetNum, snIpxRipFilterEntry=snIpxRipFilterEntry, snIpxCacheEncap=snIpxCacheEncap, snIpxRcvDropPktsCnt=snIpxRcvDropPktsCnt, snIpxServerNode=snIpxServerNode, snIpxSapFilterType=snIpxSapFilterType, snIpxServerHopCnts=snIpxServerHopCnts, snIpxFwdFilterDestNet=snIpxFwdFilterDestNet, snIpxDestPort=snIpxDestPort, snIpxServerEntry=snIpxServerEntry, snIpxCacheTable=snIpxCacheTable, snIpxPortCountersEntry=snIpxPortCountersEntry, snIpxTxDropPktsCnt=snIpxTxDropPktsCnt, snIpxFwdFilter=snIpxFwdFilter, snIpxRipFiltOnAllPort=snIpxRipFiltOnAllPort, snIpxPortCountersTxPktsCnt=snIpxPortCountersTxPktsCnt, snIpxServerType=snIpxServerType, snIpxIfSapAccessDir=snIpxIfSapAccessDir, snIpxRouteMetric=snIpxRouteMetric, snIpxSapFilterAction=snIpxSapFilterAction, snIpxFwdFilterEntry=snIpxFwdFilterEntry, snIpxPortCounters=snIpxPortCounters, snIpxFwdFilterTable=snIpxFwdFilterTable, snIpxIfRipAccessPort=snIpxIfRipAccessPort, snIpxPortAddrEntry=snIpxPortAddrEntry, snIpxRipFilterNet=snIpxRipFilterNet, snIpxPortCountersTxDropPktsCnt=snIpxPortCountersTxDropPktsCnt, snIpxPortCountersPort=snIpxPortCountersPort, snIpxRoutingMode=snIpxRoutingMode, snIpxIfFwdAccessFilterList=snIpxIfFwdAccessFilterList, snIpxIfFwdAccessDir=snIpxIfFwdAccessDir, snIpxIfRipAccessRowStatus=snIpxIfRipAccessRowStatus, snIpxIfSapAccessEntry=snIpxIfSapAccessEntry, snIpxGen=snIpxGen, snIpxFwdFilterDestNode=snIpxFwdFilterDestNode, snIpxIfRipAccess=snIpxIfRipAccess, snIpxSapGblFiltList=snIpxSapGblFiltList, snIpxRipFilterAction=snIpxRipFilterAction, snIpxIfRipAccessTable=snIpxIfRipAccessTable, NetNumber=NetNumber, snIpxPortAddrTable=snIpxPortAddrTable, snIpxPortCountersFwdPktsCnt=snIpxPortCountersFwdPktsCnt, snIpxFwdFilterSocket=snIpxFwdFilterSocket, snIpxFwdFilterRowStatus=snIpxFwdFilterRowStatus, snIpxFwdFilterSrcNet=snIpxFwdFilterSrcNet, snIpxIfRipAccessDir=snIpxIfRipAccessDir, snIpxCache=snIpxCache, snIpxFwdFilterId=snIpxFwdFilterId, snIpxDestNetNum=snIpxDestNetNum, snIpxIfFwdAccessTable=snIpxIfFwdAccessTable, snIpxPortCountersRcvDropPktsCnt=snIpxPortCountersRcvDropPktsCnt, snIpxRouteTable=snIpxRouteTable, snIpxIfSapAccessTable=snIpxIfSapAccessTable, RtrStatus=RtrStatus, snIpxSapFilterId=snIpxSapFilterId, snIpxCacheOutFilter=snIpxCacheOutFilter, snIpxRipFilterTable=snIpxRipFilterTable, snIpxIfSapAccess=snIpxIfSapAccess, snIpxCacheNode=snIpxCacheNode, snIpxServerNetNum=snIpxServerNetNum, snIpxDestHopCnts=snIpxDestHopCnts, snIpxPortAddrRowStatus=snIpxPortAddrRowStatus, snIpxRoute=snIpxRoute, snIpxRipGblFiltList=snIpxRipGblFiltList, snIpxPortCountersRcvFiltPktsCnt=snIpxPortCountersRcvFiltPktsCnt, snIpxServerSocket=snIpxServerSocket, snIpxPortCountersTxFiltPktsCnt=snIpxPortCountersTxFiltPktsCnt, snIpxRipFilterId=snIpxRipFilterId, snIpxClearTrafficCnts=snIpxClearTrafficCnts, snIpxPortAddrEncap=snIpxPortAddrEncap, snIpxTxFiltPktsCnt=snIpxTxFiltPktsCnt, snIpxIfFwdAccessRowStatus=snIpxIfFwdAccessRowStatus, snIpxFwdRouterNode=snIpxFwdRouterNode, snIpxSapFilterRowStatus=snIpxSapFilterRowStatus, snIpxClearCache=snIpxClearCache, snIpxNetBiosFilterMode=snIpxNetBiosFilterMode, snIpxServerTable=snIpxServerTable, PortIndex=PortIndex, snIpxFwdFilterSrcNode=snIpxFwdFilterSrcNode, snIpxSapFilterEntry=snIpxSapFilterEntry, snIpxRipFilter=snIpxRipFilter, Action=Action, snIpxCacheEntry=snIpxCacheEntry, snIpxCacheIndex=snIpxCacheIndex, snIpxRcvFiltPktsCnt=snIpxRcvFiltPktsCnt, snIpxRouteIndex=snIpxRouteIndex, snIpxPortAddrPort=snIpxPortAddrPort)
