...
# Produced by pysmi-0.3.4 at Wed May  1 12:44:40 2019
...
RouterID, Status, UpToMaxAge, AreaID, Metric, PositiveInteger, TOSType, HelloRange, DesignatedRouterPriority = mibBuilder.importSymbols("OSPF-MIB", "RouterID", "Status", "UpToMaxAge", "AreaID", "Metric", "PositiveInteger", "TOSType", "HelloRange", "DesignatedRouterPriority")
ModuleCompliance, NotificationGroup = mibBuilder.importSymbols("SNMPv2-CONF", "ModuleCompliance", "NotificationGroup")
Gauge32, MibIdentifier, Unsigned32, iso, ModuleIdentity, Counter32, Counter64, IpAddress, ObjectIdentity, Bits, NotificationType, Integer32, TimeTicks, MibScalar, MibTable, MibTableRow, MibTableColumn = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "MibIdentifier", "Unsigned32", "iso", "ModuleIdentity", "Counter32", "Counter64", "IpAddress", "ObjectIdentity", "Bits", "NotificationType", "Integer32", "TimeTicks", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn")
RowStatus, DisplayString, TimeStamp, MacAddress, TruthValue, TextualConvention, PhysAddress = mibBuilder.importSymbols("SNMPv2-TC", "RowStatus", "DisplayString", "TimeStamp", "MacAddress", "TruthValue", "TextualConvention", "PhysAddress")
...
mibBuilder.exportSymbols("DGS-3620-28TC-DC-L3MGMT-MIB", swL3IpFdbInfoTable=swL3IpFdbInfoTable, swL3OspfExternalLsdbChecksum=swL3OspfExternalLsdbChecksum, swL3VrrpOperIfIndex=swL3VrrpOperIfIndex, swL3IpCtrlDhcpv6ClientPDPrefixLen=swL3IpCtrlDhcpv6ClientPDPrefixLen, swL3OspfInternalLsdbAreaId=swL3OspfInternalLsdbAreaId, swL3ospfVirtIfHelloInterval=swL3ospfVirtIfHelloInterval, swL3Md5KeyId=swL3Md5KeyId, swL3IpCtrlProxyArp=swL3IpCtrlProxyArp, swL3ospfIfDistributeListInName=swL3ospfIfDistributeListInName, swL3ospfAreaTranslateState=swL3ospfAreaTranslateState, swL3OspfExternalLsdbMetric=swL3OspfExternalLsdbMetric, swL3Route6RedistriSrcProtocol=swL3Route6RedistriSrcProtocol, swL3IpCtrlIfIndex=swL3IpCtrlIfIndex, swL3RoutePreferenceDefault=swL3RoutePreferenceDefault, swL3IpCtrlAllIpIfState=swL3IpCtrlAllIpIfState, swL3OspfExternalLsdbRouteTag=swL3OspfExternalLsdbRouteTag, swL3IpFdbMgmt=swL3IpFdbMgmt, swL3Ipv6AddressCtrlState=swL3Ipv6AddressCtrlState, swL3OspfInternalLsdbEntry=swL3OspfInternalLsdbEntry, swL3VrrpOperPriority=swL3VrrpOperPriority, swL3OspfECMPIpDestination=swL3OspfECMPIpDestination, swL3dvmrpInterfaceProbe=swL3dvmrpInterfaceProbe, swL3RIPUpdateTime=swL3RIPUpdateTime, swL3OspfECMPState=swL3OspfECMPState, NetAddress=NetAddress, swL3dvmrpInterfaceTable=swL3dvmrpInterfaceTable, swL3Ipv6DHCPv6CPDAddrCtrlPrefixName=swL3Ipv6DHCPv6CPDAddrCtrlPrefixName, VrId=VrId, swL3ospfVirtIfAuthType=swL3ospfVirtIfAuthType, swL3IpCtrlTable=swL3IpCtrlTable, swL3IpMcastStaticRouteRowStatus=swL3IpMcastStaticRouteRowStatus, swL3RoutePreferenceStatic=swL3RoutePreferenceStatic, swL3IpStaticRouteWeight=swL3IpStaticRouteWeight, swL3ospfIfDesignatedRouter=swL3ospfIfDesignatedRouter, swL3Ipv6DHCPv6CPDAddrCtrlEntry=swL3Ipv6DHCPv6CPDAddrCtrlEntry, swL3Ipv6CtrlRaOtherConfigFlag=swL3Ipv6CtrlRaOtherConfigFlag, swL3OspfExternalLsdbAge=swL3OspfExternalLsdbAge, swL3VrrpOperState=swL3VrrpOperState, swL3Ipv6CtrlRaRetransTime=swL3Ipv6CtrlRaRetransTime, swL3IpCtrlIpAddr=swL3IpCtrlIpAddr, swL3IpCtrlIpv6AdminState=swL3IpCtrlIpv6AdminState, swL3OspfHostStatus=swL3OspfHostStatus, swL3IpMcastStaticRouteTable=swL3IpMcastStaticRouteTable, swL3VrrpOperMgmt=swL3VrrpOperMgmt, swL3RouteRedistriRowStatus=swL3RouteRedistriRowStatus, swL3DevMgmt=swL3DevMgmt, swL3RelayDnsCtrlState=swL3RelayDnsCtrlState, swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName=swL3Ipv6DHCPv6CPDAddrCtrlInterfaceName, swL3IpFdbInfoIpSubnetMask=swL3IpFdbInfoIpSubnetMask, swL3LoopBackIpCtrlIfIndex=swL3LoopBackIpCtrlIfIndex, swL3Route6RedistriType=swL3Route6RedistriType, swL3ospfAreaType=swL3ospfAreaType, swL3ospfIfMulticastForwarding=swL3ospfIfMulticastForwarding, swL3IpCtrlIpDirectedBroadcastState=swL3IpCtrlIpDirectedBroadcastState, swL3ospfIfAdminStat=swL3ospfIfAdminStat, swL3Ipv6CtrlRaManagedFlag=swL3Ipv6CtrlRaManagedFlag, swL3OspfHostTable=swL3OspfHostTable, swL3ospfIfTransitDelay=swL3ospfIfTransitDelay, swL3dvmrpInterfaceEntry=swL3dvmrpInterfaceEntry, swL3RIPInboundRouteFilterEntry=swL3RIPInboundRouteFilterEntry, swL3Md5Entry=swL3Md5Entry, swL3IpMcastStaticRouteRpfAddr=swL3IpMcastStaticRouteRpfAddr, swL3IpStaticRouteStatus=swL3IpStaticRouteStatus, swL3OspfInternalLsdbLsid=swL3OspfInternalLsdbLsid, swL3RelayDnsCacheState=swL3RelayDnsCacheState, swL3RoutePreferenceOSPFInter=swL3RoutePreferenceOSPFInter, swL3RIPInboundRouteFilterName=swL3RIPInboundRouteFilterName, swL3IpCtrlIpMtu=swL3IpCtrlIpMtu, swL3ospfIfBackupDesignatedRouter=swL3ospfIfBackupDesignatedRouter, swL3ospfIfAuthKeyID=swL3ospfIfAuthKeyID, swL3ospfAreaEntry=swL3ospfAreaEntry, swL3IpCtrlIpv6LinkLocalAddress=swL3IpCtrlIpv6LinkLocalAddress, swL3IpMcastStaticRouteIpmrouteMask=swL3IpMcastStaticRouteIpmrouteMask, swL3VrrpOperAuthType=swL3VrrpOperAuthType, swL3VrrpOperMasterIpAddr=swL3VrrpOperMasterIpAddr, swL3dvmrpInterfaceRcvBadRoutes=swL3dvmrpInterfaceRcvBadRoutes, swL3RelayMgmt=swL3RelayMgmt, swL3IpCtrlDhcpv6ClientPDPrefix=swL3IpCtrlDhcpv6ClientPDPrefix, swL3ospfIfRetransInterval=swL3ospfIfRetransInterval, swL3DevCtrlOSPFState=swL3DevCtrlOSPFState, swL3Ipv6CtrlRaState=swL3Ipv6CtrlRaState, swL3ospfIfMetric=swL3ospfIfMetric, swL3RIPInboundRouteFilterTable=swL3RIPInboundRouteFilterTable, swL3IpMcastStaticRouteEntry=swL3IpMcastStaticRouteEntry, swL3ospfVirtIfTransitDelay=swL3ospfVirtIfTransitDelay, swL3Md5Key=swL3Md5Key, swL3ospfIfEvents=swL3ospfIfEvents, swL3dvmrpInterfaceNbrTimeout=swL3dvmrpInterfaceNbrTimeout, swL3RIPInboundRouteFilterIfIpAddress=swL3RIPInboundRouteFilterIfIpAddress, swL3VrrpOperAdminState=swL3VrrpOperAdminState, swL3RouteRedistriType=swL3RouteRedistriType, swL3Ipv6Address=swL3Ipv6Address, swL3IpArpAgingTime=swL3IpArpAgingTime, swL3IpCtrlIpSubnetMask=swL3IpCtrlIpSubnetMask, swL3RIPInboundRouteFilterType=swL3RIPInboundRouteFilterType, swL3OspfDefInfoOrigMetric=swL3OspfDefInfoOrigMetric, swL3IpStaticRouteDest=swL3IpStaticRouteDest, swL3OspfECMPCrcHigh=swL3OspfECMPCrcHigh, swL3Route6RedistriEntry=swL3Route6RedistriEntry, swL3LoopBackIpCtrlTable=swL3LoopBackIpCtrlTable, swL3Md5RowStatus=swL3Md5RowStatus, swL3Ipv6AddressCtrlValidLifeTime=swL3Ipv6AddressCtrlValidLifeTime, swL3VrrpOperVrId=swL3VrrpOperVrId, swL3RouteRedistriDstProtocol=swL3RouteRedistriDstProtocol, swL3OspfInternalLsdbSequenceNo=swL3OspfInternalLsdbSequenceNo, swL3IpCtrlVlanName=swL3IpCtrlVlanName, swL3ospfVirtIfNeighbor=swL3ospfVirtIfNeighbor, swL3ospfIfDistributeListInType=swL3ospfIfDistributeListInType, swL3IpMcastStaticRouteIpmrouteAddr=swL3IpMcastStaticRouteIpmrouteAddr, swL3Route6RedistriMetric=swL3Route6RedistriMetric, swL3RelayDnsStaticTableState=swL3RelayDnsStaticTableState, swL3OspfInternalLsdbRouterId=swL3OspfInternalLsdbRouterId, swL3dvmrpInterfaceLocalAddress=swL3dvmrpInterfaceLocalAddress, swL3Ipv6CtrlRaMinRtrAdvInterval=swL3Ipv6CtrlRaMinRtrAdvInterval, swL3OspfInternalLsdbChecksum=swL3OspfInternalLsdbChecksum, swL3LoopBackIpCtrlEntry=swL3LoopBackIpCtrlEntry, swL3IpFdbInfoType=swL3IpFdbInfoType, swL3Ipv6CtrlNsRetransTimer=swL3Ipv6CtrlNsRetransTimer, swL3Route6RedistriDstProtocol=swL3Route6RedistriDstProtocol, swL3OspfExternalLsdbLsid=swL3OspfExternalLsdbLsid, swL3IpMgmt=swL3IpMgmt, swL3ospfIfRtrPriority=swL3ospfIfRtrPriority, swL3RoutePreferenceEBGP=swL3RoutePreferenceEBGP, swL3Ipv6AddressCtrlInterfaceName=swL3Ipv6AddressCtrlInterfaceName, swL3ospfVirtIfState=swL3ospfVirtIfState, swL3OspfECMPCrcLow=swL3OspfECMPCrcLow, swL3Ipv6AddressCtrlPreferredLifeTime=swL3Ipv6AddressCtrlPreferredLifeTime, swL3ospfIfAreaId=swL3ospfIfAreaId, swL3OspfECMPTCPorUDPport=swL3OspfECMPTCPorUDPport, swL3Ipv6DHCPv6CPDAddrCtrlTable=swL3Ipv6DHCPv6CPDAddrCtrlTable, swL3Ipv6DHCPv6CPDAddrCtrlState=swL3Ipv6DHCPv6CPDAddrCtrlState, swL3OspfInternalLsdbTable=swL3OspfInternalLsdbTable, swL3DevCtrlDVMRPState=swL3DevCtrlDVMRPState, swL3DevCtrlVRRPState=swL3DevCtrlVRRPState, swL3IpCtrlDhcpv6ClientState=swL3IpCtrlDhcpv6ClientState, swL3IpCtrlAdminState=swL3IpCtrlAdminState, swL3IpCtrlSecondary=swL3IpCtrlSecondary, swL3ospfAreaId=swL3ospfAreaId, PYSNMP_MODULE_ID=swL3MgmtMIB, swL3DevCtrlVrrpPingState=swL3DevCtrlVrrpPingState, swL3IpStaticRouteNextHop=swL3IpStaticRouteNextHop, swL3VrrpOperEntry=swL3VrrpOperEntry, swL3ospfVirtIfAreaId=swL3ospfVirtIfAreaId, swL3VrrpOperAdvertisementInterval=swL3VrrpOperAdvertisementInterval, swL3OspfExternalLsdbForwardingAddress=swL3OspfExternalLsdbForwardingAddress, swL3ospfVirtIfAuthKeyID=swL3ospfVirtIfAuthKeyID, swL3IpCtrlEntry=swL3IpCtrlEntry, swL3IpCtrlDhcpv6ClientRapidCommit=swL3IpCtrlDhcpv6ClientRapidCommit, swL3IpStaticRouteTunnelInterfaceName=swL3IpStaticRouteTunnelInterfaceName, swL3VrrpOperVirtualMacAddr=swL3VrrpOperVirtualMacAddr, swL3RoutePreferenceOSPFExtT2=swL3RoutePreferenceOSPFExtT2, swL3ospfVirtIfAuthKey=swL3ospfVirtIfAuthKey, swL3IpStaticRouteTunnelRowStatus=swL3IpStaticRouteTunnelRowStatus, swL3Ipv6CtrlRaMaxRtrAdvInterval=swL3Ipv6CtrlRaMaxRtrAdvInterval, swL3OspfHostIpAddress=swL3OspfHostIpAddress, swL3ospfAreaStatus=swL3ospfAreaStatus, swL3VrrpOperCheckCriticalIpState=swL3VrrpOperCheckCriticalIpState, swL3IpStaticRouteMask=swL3IpStaticRouteMask, swL3IpCtrlLocalProxyArp=swL3IpCtrlLocalProxyArp, swL3ospfIfTable=swL3ospfIfTable, swL3IpCtrlMgmt=swL3IpCtrlMgmt, swL3OspfInternalLsdbAge=swL3OspfInternalLsdbAge, swL3VrrpOperPreemptMode=swL3VrrpOperPreemptMode, swL3VrrpOperVirtualIpAddr=swL3VrrpOperVirtualIpAddr, swL3MgmtMIB=swL3MgmtMIB, swL3LoopBackIpCtrlInterfaceName=swL3LoopBackIpCtrlInterfaceName, swL3IpCtrlDhcpv6ClientPDState=swL3IpCtrlDhcpv6ClientPDState, swL3LoopBackIpCtrlIpSubnetMask=swL3LoopBackIpCtrlIpSubnetMask, swL3RouteRedistriRouteMapName=swL3RouteRedistriRouteMapName, swL3OspfHostEntry=swL3OspfHostEntry, swL3OspfExternalLsdbRouterId=swL3OspfExternalLsdbRouterId, swL3RelayDnsMgmt=swL3RelayDnsMgmt, swL3RelayDnsCtrlEntry=swL3RelayDnsCtrlEntry, swL3RouteRedistriEntry=swL3RouteRedistriEntry, swL3IpStaticRouteEntry=swL3IpStaticRouteEntry, swL3IpCtrlIpv6LinkLocalAutoState=swL3IpCtrlIpv6LinkLocalAutoState, swL3ospfIfDemand=swL3ospfIfDemand, swL3ospfIfIpAddress=swL3ospfIfIpAddress, swL3IpCtrlInterfaceName=swL3IpCtrlInterfaceName, swL3DevCtrlRIPState=swL3DevCtrlRIPState, swL3ospfAreaTable=swL3ospfAreaTable, swL3IpCtrlIpDhcpOption12HostName=swL3IpCtrlIpDhcpOption12HostName, swL3ospfVirtIfStatus=swL3ospfVirtIfStatus, swL3dvmrpInterfaceIfIndex=swL3dvmrpInterfaceIfIndex, swL3Ipv6CtrlRaReachableTime=swL3Ipv6CtrlRaReachableTime, swL3ospfIfAuthKey=swL3ospfIfAuthKey, swL3OspfInternalLsdbMetric=swL3OspfInternalLsdbMetric, swL3ospfIfEntry=swL3ospfIfEntry, swL3RoutePreferenceOSPFExtT1=swL3RoutePreferenceOSPFExtT1, swL3RoutePreference=swL3RoutePreference, swL3LoopBackIpCtrlIpAddr=swL3LoopBackIpCtrlIpAddr, swL3Ipv6CtrlTable=swL3Ipv6CtrlTable, swL3Ipv6AddressCtrlPrefixLen=swL3Ipv6AddressCtrlPrefixLen, swL3IpFdbInfoIpAddr=swL3IpFdbInfoIpAddr, swL3RelayDnsCtrlDomainName=swL3RelayDnsCtrlDomainName, swL3OspfInternalLsdbType=swL3OspfInternalLsdbType, swL3OspfDefInfoOrigMetricType=swL3OspfDefInfoOrigMetricType, swL3Md5Table=swL3Md5Table, swL3OspfHostAreaID=swL3OspfHostAreaID, swL3Route6RedistriTable=swL3Route6RedistriTable, swL3IpStaticRouteInterfaceName=swL3IpStaticRouteInterfaceName, swL3RelayDnsCtrlTable=swL3RelayDnsCtrlTable, swL3Ipv6CtrlRaHopLimit=swL3Ipv6CtrlRaHopLimit, swL3LoopBackIpCtrlRowStatus=swL3LoopBackIpCtrlRowStatus, swL3RelayDnsCtrlIpAddr=swL3RelayDnsCtrlIpAddr, swL3VrrpOperAuthKey=swL3VrrpOperAuthKey, swL3DevCtrl=swL3DevCtrl, swL3VrrpOperVirtualRouterUpTime=swL3VrrpOperVirtualRouterUpTime, swL3RouteRedistriSrcProtocol=swL3RouteRedistriSrcProtocol, swL3OspfDefInfoOriginate=swL3OspfDefInfoOriginate, swL3VrrpOperBfdPeerAddr=swL3VrrpOperBfdPeerAddr, swL3OspfHostMetric=swL3OspfHostMetric, swL3Ipv6CtrlRaLifeTime=swL3Ipv6CtrlRaLifeTime, swL3OspfECMPIpSource=swL3OspfECMPIpSource, swL3dvmrpInterfaceRcvBadPkts=swL3dvmrpInterfaceRcvBadPkts, swL3OspfDefInfoOrigMgmt=swL3OspfDefInfoOrigMgmt, swL3ospfIfHelloInterval=swL3ospfIfHelloInterval, swL3RoutePreferenceOSPFIntra=swL3RoutePreferenceOSPFIntra, swL3ospfVirtIfTable=swL3ospfVirtIfTable, swL3IpFdbInfoPort=swL3IpFdbInfoPort, swL3ospfVirtIfRetransInterval=swL3ospfVirtIfRetransInterval, swL3Ipv6AddressCtrlEntry=swL3Ipv6AddressCtrlEntry, swL3dvmrpInterfaceStatus=swL3dvmrpInterfaceStatus, swL3Ipv6CtrlEntry=swL3Ipv6CtrlEntry, swL3ospfVirtIfEntry=swL3ospfVirtIfEntry, swL3RIPTimerMgmt=swL3RIPTimerMgmt, swL3IpCtrlIpv4AdminState=swL3IpCtrlIpv4AdminState, swL3IpCtrlIpv6AutoConfigState=swL3IpCtrlIpv6AutoConfigState, swL3IpMcastMgmt=swL3IpMcastMgmt, swL3IpStaticRouteTable=swL3IpStaticRouteTable, swL3RouteRedistriMetric=swL3RouteRedistriMetric, swL3ospfVirtIfRtrDeadInterval=swL3ospfVirtIfRtrDeadInterval, swL3ospfAreaMetric=swL3ospfAreaMetric, swL3IpCtrlDhcpv6ClientPDPrefixName=swL3IpCtrlDhcpv6ClientPDPrefixName, swL3RouteRedistriTable=swL3RouteRedistriTable, swL3OspfHostTOS=swL3OspfHostTOS, NodeAddress=NodeAddress, swL3OspfExternalLsdbMetricType=swL3OspfExternalLsdbMetricType, swL3Ipv6CtrlMaxReassmblySize=swL3Ipv6CtrlMaxReassmblySize, swL3IpFdbInfoEntry=swL3IpFdbInfoEntry, swL3OspfExternalLsdbSequenceNo=swL3OspfExternalLsdbSequenceNo, swL3VrrpOperTable=swL3VrrpOperTable, swL3ospfIfRtrDeadInterval=swL3ospfIfRtrDeadInterval, swL3VrrpOperCriticalIpAddr=swL3VrrpOperCriticalIpAddr, swL3ospfIfType=swL3ospfIfType, swL3VrrpOperRowStatus=swL3VrrpOperRowStatus, swL3OspfExternalLsdbEntry=swL3OspfExternalLsdbEntry, swL3ospfIfAuthType=swL3ospfIfAuthType, swL3RoutePreferenceIBGP=swL3RoutePreferenceIBGP, swL3Route6RedistriRowStatus=swL3Route6RedistriRowStatus, swL3Ipv6AddressCtrlAutonomousFlag=swL3Ipv6AddressCtrlAutonomousFlag, swL3ospfIfState=swL3ospfIfState, swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen=swL3Ipv6DHCPv6CPDAddrCtrlPrefixLen, swL3ospfIfPollInterval=swL3ospfIfPollInterval)
mibBuilder.exportSymbols("DGS-3620-28TC-DC-L3MGMT-MIB", swL3IpCtrlDhcpv6ClientPDRapidCommit=swL3IpCtrlDhcpv6ClientPDRapidCommit, swL3LoopBackIpCtrlAdminState=swL3LoopBackIpCtrlAdminState, swL3Ipv6CtrlInterfaceName=swL3Ipv6CtrlInterfaceName, swL3RelayDnsState=swL3RelayDnsState, swL3RoutePreferenceLocal=swL3RoutePreferenceLocal, swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr=swL3Ipv6DHCPv6CPDAddrCtrlIPv6addr, swL3RIPTimeOutTime=swL3RIPTimeOutTime, swL3ospfAddressLessIf=swL3ospfAddressLessIf, swL3RIPGarbageCollectionTime=swL3RIPGarbageCollectionTime, swL3OspfLsdbMgmt=swL3OspfLsdbMgmt, swL3ospfVirtIfEvents=swL3ospfVirtIfEvents, swL3OspfECMPMgmt=swL3OspfECMPMgmt, swL3OspfExternalLsdbType=swL3OspfExternalLsdbType, swL3Ipv6AddressCtrlTable=swL3Ipv6AddressCtrlTable, swL3IpCtrlState=swL3IpCtrlState, swL3IpCtrlIpDhcpOption12State=swL3IpCtrlIpDhcpOption12State, swL3IpCtrlIpv6AutoConfigDefault=swL3IpCtrlIpv6AutoConfigDefault, swL3IpStaticRouteTunnelEntry=swL3IpStaticRouteTunnelEntry, swL3IpCtrlIpv6LinkLocalPrefixLen=swL3IpCtrlIpv6LinkLocalPrefixLen, swL3IpStaticRouteTunnelTable=swL3IpStaticRouteTunnelTable, swL3RelayDnsPrimaryServer=swL3RelayDnsPrimaryServer, swL3ospfIfPassiveMode=swL3ospfIfPassiveMode, swL3OspfExternalLsdbTable=swL3OspfExternalLsdbTable, swL3RelayDnsSecondaryServer=swL3RelayDnsSecondaryServer, swL3IpStaticRouteMetric=swL3IpStaticRouteMetric, swL3RoutePreferenceRIP=swL3RoutePreferenceRIP, swL3IpStaticRouteBkupState=swL3IpStaticRouteBkupState, swL3ospfAreaSummaryState=swL3ospfAreaSummaryState, swL3Ipv6AddressCtrlOnLinkFlag=swL3Ipv6AddressCtrlOnLinkFlag, swL3dvmrpInterfaceMetric=swL3dvmrpInterfaceMetric, swL3IpCtrlMode=swL3IpCtrlMode, swL3ospfIfBfdStatus=swL3ospfIfBfdStatus)
