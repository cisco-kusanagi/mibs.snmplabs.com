...
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/DES3528P-L2MGMT-MIB
# Produced by pysmi-0.3.4 at Wed May  1 12:41:10 2019
...
Gauge32, Integer32, IpAddress, ModuleIdentity, Bits, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, NotificationType, MibIdentifier, ObjectIdentity, Counter64, Unsigned32, iso, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Gauge32", "Integer32", "IpAddress", "ModuleIdentity", "Bits", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "NotificationType", "MibIdentifier", "ObjectIdentity", "Counter64", "Unsigned32", "iso", "TimeTicks")
DisplayString, RowStatus, TextualConvention, TruthValue = mibBuilder.importSymbols("SNMPv2-TC", "DisplayString", "RowStatus", "TextualConvention", "TruthValue")
des3528p, = mibBuilder.importSymbols("SW3528PRIMGMT-MIB", "des3528p")
...
swL2PortInfoErrorDisabled = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 105, 2, 2, 3, 1, 1, 8), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(0, 1, 3, 4))).clone(namedValues=NamedValues(("none", 0), ("storm", 1), ("unknow", 3), ("ctp-lbd", 4)))).setMaxAccess("readonly")
...
swL2PortErrPortReason = MibTableColumn((1, 3, 6, 1, 4, 1, 171, 11, 105, 2, 2, 3, 7, 1, 4), Integer32().subtype(subtypeSpec=ConstraintsUnion(SingleValueConstraint(2, 3))).clone(namedValues=NamedValues(("storm-control", 2), ("ctp-lbd", 3)))).setMaxAccess("readonly")
...
mibBuilder.exportSymbols("DES3528P-L2MGMT-MIB", swL2PortSecurityEntryClearCtrl=swL2PortSecurityEntryClearCtrl, swL2LoopDetectPortLoopStatus=swL2LoopDetectPortLoopStatus, swL2DhcpRelayCtrlInterfaceName=swL2DhcpRelayCtrlInterfaceName, swL2IGMPLastMemberQueryInterval=swL2IGMPLastMemberQueryInterval, swL2IGMPQueryState=swL2IGMPQueryState, swL2MulticastFilterVlanMode=swL2MulticastFilterVlanMode, swL2DhcpLocalRelayState=swL2DhcpLocalRelayState, VlanId=VlanId, swL2IGMPCurrentState=swL2IGMPCurrentState, swL2DevAlarmTopologyChange=swL2DevAlarmTopologyChange, swL2IGMPInfoEntry=swL2IGMPInfoEntry, swL2PortCtrlAdminState=swL2PortCtrlAdminState, swL2DevCtrlWebState=swL2DevCtrlWebState, swL2IGMPMulticastVlanRemoveAllMcastAddrListAction=swL2IGMPMulticastVlanRemoveAllMcastAddrListAction, swL2MirrorPortState=swL2MirrorPortState, swL2DevCtrlIpAutoconfig=swL2DevCtrlIpAutoconfig, swL2TrunkType=swL2TrunkType, swL2IGMPMulticastVlanSourcePort=swL2IGMPMulticastVlanSourcePort, swL2IGMPMulticastVlanName=swL2IGMPMulticastVlanName, swL2PortSecurityViolationSeverity=swL2PortSecurityViolationSeverity, swL2PortCtrlEntry=swL2PortCtrlEntry, swL2PortInfoUnitID=swL2PortInfoUnitID, swL2PortCtrlUnitIndex=swL2PortCtrlUnitIndex, swL2PortErrPortState=swL2PortErrPortState, swL2DevCtrlStpState=swL2DevCtrlStpState, swL2IGMPMulticastVlanTagMemberPort=swL2IGMPMulticastVlanTagMemberPort, swL2MulticastFilterModeVlanTable=swL2MulticastFilterModeVlanTable, swL2PortSecurityViolationTrap=swL2PortSecurityViolationTrap, swL2DevCtrlCleanAllStatisticCounter=swL2DevCtrlCleanAllStatisticCounter, swL2IGMPMulticastVlanGroupToIp=swL2IGMPMulticastVlanGroupToIp, swL2PortCtrlJumboFrameMaxSize=swL2PortCtrlJumboFrameMaxSize, swL2PortSecurityTrapLogState=swL2PortSecurityTrapLogState, swL2IGMPCtrlState=swL2IGMPCtrlState, swL2QOS8021pRadiusPriority=swL2QOS8021pRadiusPriority, swL2DhcpLocalRelayVLANID=swL2DhcpLocalRelayVLANID, swL2PortErrEntry=swL2PortErrEntry, swL2DhcpRelayCtrlEntry=swL2DhcpRelayCtrlEntry, swL2VlanPortInfoVid=swL2VlanPortInfoVid, swL2PortSecurityMaxLernAddr=swL2PortSecurityMaxLernAddr, swL2IGMPMulticastVlanState=swL2IGMPMulticastVlanState, swL2PortSecurityViolationMac=swL2PortSecurityViolationMac, swL2DhcpRelayTimeThreshold=swL2DhcpRelayTimeThreshold, swL2DevCtrlCFM=swL2DevCtrlCFM, swL2DhcpRelayHopCount=swL2DhcpRelayHopCount, swL2IGMPRouterPortStaticPortList=swL2IGMPRouterPortStaticPortList, swL2VLANAdvertisement=swL2VLANAdvertisement, swL2PortCtrlNwayState=swL2PortCtrlNwayState, swL2IGMPInfoTxQueryCount=swL2IGMPInfoTxQueryCount, swL2IGMPMulticastVlanRowStatus=swL2IGMPMulticastVlanRowStatus, swL2DhcpLocalRelayVLANState=swL2DhcpLocalRelayVLANState, swL2MulticastFilterProfileIdIndex=swL2MulticastFilterProfileIdIndex, swL2IGMPFastLeaveState=swL2IGMPFastLeaveState, swL2IGMPMulticastVlanGroupTable=swL2IGMPMulticastVlanGroupTable, swL2PortCtrlPortIndex=swL2PortCtrlPortIndex, swL2DevCtrlCFMState=swL2DevCtrlCFMState, swL2DevCtrl=swL2DevCtrl, swL2MirrorMgmt=swL2MirrorMgmt, swL2MulticastFilterProfileAddressTable=swL2MulticastFilterProfileAddressTable, swL2DevCtrlWeb=swL2DevCtrlWeb, swL2QOSSchedulingTable=swL2QOSSchedulingTable, swL2QOSSchedulingMaxPkts=swL2QOSSchedulingMaxPkts, swL2QOSBandwidthRadiusTxRate=swL2QOSBandwidthRadiusTxRate, swL2DevAlarmNewRoot=swL2DevAlarmNewRoot, swL2MirrorPortSourceIngress=swL2MirrorPortSourceIngress, swL2IGMPRouterPortEntry=swL2IGMPRouterPortEntry, swL2TrunkVLANState=swL2TrunkVLANState, swL2QOS8021pUserPriorityEntry=swL2QOS8021pUserPriorityEntry, swL2IGMPCtrlTable=swL2IGMPCtrlTable, swL2TrafficSegMgmt=swL2TrafficSegMgmt, swL2PortSecurityDelMacAddress=swL2PortSecurityDelMacAddress, swL2VlanStaticTable=swL2VlanStaticTable, swL2PortCtrlTable=swL2PortCtrlTable, swL2PortCableDiagnosisPairLength=swL2PortCableDiagnosisPairLength, swL2IGMPRouteTimeout=swL2IGMPRouteTimeout, swL2IGMPMulticastVlanGroupVid=swL2IGMPMulticastVlanGroupVid, swL2LoopDetectPortMgmt=swL2LoopDetectPortMgmt, swL2PortInfoEntry=swL2PortInfoEntry, swL2LoopDetectPortEntry=swL2LoopDetectPortEntry, swL2IGMPLeaveTimer=swL2IGMPLeaveTimer, swL2VlanPortInfoEntry=swL2VlanPortInfoEntry, swL2PortCtrlMediumType=swL2PortCtrlMediumType, swL2IGMPMulticastVlanGroupEntry=swL2IGMPMulticastVlanGroupEntry, swL2IGMPQueryInfoTable=swL2IGMPQueryInfoTable, swL2DevCtrlTelnet=swL2DevCtrlTelnet, swL2LoopDetectInterval=swL2LoopDetectInterval, swL2MgmtMIB=swL2MgmtMIB, swL2PortCableDiagnosisPairStatus=swL2PortCableDiagnosisPairStatus, swL2PortCounterCtrlTable=swL2PortCounterCtrlTable, swL2QOS8021pUserPriorityIndex=swL2QOS8021pUserPriorityIndex, swL2PortSecurityControlTable=swL2PortSecurityControlTable, swL2TrafficSegPort=swL2TrafficSegPort, swL2DevCtrlVLANTrunkState=swL2DevCtrlVLANTrunkState, swL2IGMPMulticastVlanTable=swL2IGMPMulticastVlanTable, swL2QOSBandwidthControlEntry=swL2QOSBandwidthControlEntry, swL2DevAlarmLinkChange=swL2DevAlarmLinkChange, swL2Notify=swL2Notify, swL2PortLoopRestart=swL2PortLoopRestart, swL2MulticastFilterPortMaxGroupEntry=swL2MulticastFilterPortMaxGroupEntry, swL2PortCableDiagnosisPairLengthInaccuracy=swL2PortCableDiagnosisPairLengthInaccuracy, swL2DevAlarm=swL2DevAlarm, swL2PortErrPortIndex=swL2PortErrPortIndex, swL2PortSecurityDelCtrl=swL2PortSecurityDelCtrl, swL2PortMgmt=swL2PortMgmt, swL2DevCtrlIGMPSnoopingMcstRTOnly=swL2DevCtrlIGMPSnoopingMcstRTOnly, swL2IGMPRouterPortTable=swL2IGMPRouterPortTable, swL2LoopDetectAdminState=swL2LoopDetectAdminState, swL2NotifyPrefix=swL2NotifyPrefix, swL2VlanLoopRestart=swL2VlanLoopRestart, swL2VlanPortInfoPortIndex=swL2VlanPortInfoPortIndex, swL2QOSSchedulingMechanism=swL2QOSSchedulingMechanism, swL2DhcpRelayMgmt=swL2DhcpRelayMgmt, swL2macNotification=swL2macNotification, swL2DhcpRelayCtrlState=swL2DhcpRelayCtrlState, swL2MulticastFilterModeVlanEntry=swL2MulticastFilterModeVlanEntry, swL2IGMPMaxIpGroupNumPerVlan=swL2IGMPMaxIpGroupNumPerVlan, swL2TrunkMaxSupportedEntries=swL2TrunkMaxSupportedEntries, swL2MirrorLogicTargetPort=swL2MirrorLogicTargetPort, swL2DhcpLocalRelayMgmt=swL2DhcpLocalRelayMgmt, swL2PortSecurityPortIndex=swL2PortSecurityPortIndex, swL2PortInfoTable=swL2PortInfoTable, swL2TrunkAlgorithm=swL2TrunkAlgorithm, swL2DhcpRelayOption82State=swL2DhcpRelayOption82State, swL2QOSBandwidthRxRate=swL2QOSBandwidthRxRate, swL2IGMPCtrlVid=swL2IGMPCtrlVid, swL2PortErrPortReason=swL2PortErrPortReason, swL2TrunkMember=swL2TrunkMember, swL2QOSBandwidthControlTable=swL2QOSBandwidthControlTable, swL2QOSSchedulingMechanismCtrl=swL2QOSSchedulingMechanismCtrl, swL2TrunkLACPPortTable=swL2TrunkLACPPortTable, swL2DevCtrlAsymVlanState=swL2DevCtrlAsymVlanState, swL2MulticastFilterFromIp=swL2MulticastFilterFromIp, swL2PortCableDiagnosisPortIndex=swL2PortCableDiagnosisPortIndex, swL2MulticastFilterProfileTable=swL2MulticastFilterProfileTable, swL2MulticastFilterPortMaxGroup=swL2MulticastFilterPortMaxGroup, swL2PortInfoMediumType=swL2PortInfoMediumType, swL2DevCtrlCFMPortTable=swL2DevCtrlCFMPortTable, swL2TrunkIndex=swL2TrunkIndex, swL2IGMPVid=swL2IGMPVid, swL2IGMPMulticastVlanMemberPort=swL2IGMPMulticastVlanMemberPort, swL2DhcpRelayCtrlTable=swL2DhcpRelayCtrlTable, swL2IGMPInfoTable=swL2IGMPInfoTable, swL2IGMPQueryInfoEntry=swL2IGMPQueryInfoEntry, swL2PortInfoType=swL2PortInfoType, swL2LimitedMulticastMgmt=swL2LimitedMulticastMgmt, swL2DevCtrlIGMPSnooping=swL2DevCtrlIGMPSnooping, swL2TrunkFloodingPort=swL2TrunkFloodingPort, swL2QOS8021pDefaultPriorityIndex=swL2QOS8021pDefaultPriorityIndex, swL2TrunkLACPPortEntry=swL2TrunkLACPPortEntry, swL2LoopDetectPortLoopVLAN=swL2LoopDetectPortLoopVLAN, swL2QOSBandwidthPortIndex=swL2QOSBandwidthPortIndex, swL2DevInfo=swL2DevInfo, swL2PortCableDiagnosisTable=swL2PortCableDiagnosisTable, swL2LimitedMulticastFilterPortProfileID=swL2LimitedMulticastFilterPortProfileID, swL2MulticastFilterPortMaxGroupPortIndex=swL2MulticastFilterPortMaxGroupPortIndex, swL2PortCtrlMACNotifyState=swL2PortCtrlMACNotifyState, swL2LimitedMulticastFilterPortProfileStatus=swL2LimitedMulticastFilterPortProfileStatus, swL2NniGvrpBpduAddress=swL2NniGvrpBpduAddress, swL2PortErrPortConnStatus=swL2PortErrPortConnStatus, swL2IGMPRouterPortVlanid=swL2IGMPRouterPortVlanid, swL2PortSecurityMode=swL2PortSecurityMode, swL2IGMPRouterPortForbiddenPortList=swL2IGMPRouterPortForbiddenPortList, swL2IGMPRobustness=swL2IGMPRobustness, swL2TrunkCtrlEntry=swL2TrunkCtrlEntry, swL2DhcpLocalRelayVLANTable=swL2DhcpLocalRelayVLANTable, swL2NotifyMgmt=swL2NotifyMgmt, swL2VLANMgmt=swL2VLANMgmt, swDevInfoNumOfPortInUse=swDevInfoNumOfPortInUse, swL2DevCtrlManagementVlanId=swL2DevCtrlManagementVlanId, swL2VlanStaticEntry=swL2VlanStaticEntry, swL2PPPoECirIDinsertState=swL2PPPoECirIDinsertState, swL2PortInfoPortIndex=swL2PortInfoPortIndex, swL2IGMPQueryInterval=swL2IGMPQueryInterval, swDevInfoTotalNumOfPort=swDevInfoTotalNumOfPort, swL2LoopDetectTrapMode=swL2LoopDetectTrapMode, swL2LimitedMulticastFilterPortTable=swL2LimitedMulticastFilterPortTable, swL2MulticastFilterVid=swL2MulticastFilterVid, swL2PortCounterCtrlEntry=swL2PortCounterCtrlEntry, swl2NotificationBidings=swl2NotificationBidings, swL2PortCounterClearCtrl=swL2PortCounterClearCtrl, swL2QOSSchedulingEntry=swL2QOSSchedulingEntry, swL2IGMPMaxSupportedVlans=swL2IGMPMaxSupportedVlans, MacAddress=MacAddress, swL2IGMPMulticastVlanGroupStatus=swL2IGMPMulticastVlanGroupStatus, swL2QOS8021pDefaultPriorityEntry=swL2QOS8021pDefaultPriorityEntry, swL2macNotificationSeverity=swL2macNotificationSeverity, swL2TrunkMasterPort=swL2TrunkMasterPort, swL2IGMPInfoVid=swL2IGMPInfoVid, swL2DevCtrlTelnetTcpPort=swL2DevCtrlTelnetTcpPort, swL2DevMgmt=swL2DevMgmt, swL2PortCtrlLearningState=swL2PortCtrlLearningState, swL2QOS8021pUserPriorityClass=swL2QOS8021pUserPriorityClass, swL2MirrorPortSourceEgress=swL2MirrorPortSourceEgress, swL2LoopDetectPortState=swL2LoopDetectPortState, PYSNMP_MODULE_ID=swL2MgmtMIB, swL2MulticastFilterPortMaxGroupTable=swL2MulticastFilterPortMaxGroupTable, swL2TrunkMgmt=swL2TrunkMgmt, swL2PortInfoNwayStatus=swL2PortInfoNwayStatus, swL2MulticastFilterProfileAddressEntry=swL2MulticastFilterProfileAddressEntry, swL2IGMPMacAddr=swL2IGMPMacAddr, swDevInfoFrontPanelLedStatus=swDevInfoFrontPanelLedStatus, swL2IGMPMaxResponseTime=swL2IGMPMaxResponseTime, swL2IGMPRouterPortVlanName=swL2IGMPRouterPortVlanName, swL2IGMPMulticastVlanReplaceSourceIp=swL2IGMPMulticastVlanReplaceSourceIp, swL2VlanLoopOccurred=swL2VlanLoopOccurred, swL2PPPoEMgmt=swL2PPPoEMgmt, swL2QOSHolPreventionCtrl=swL2QOSHolPreventionCtrl, swL2TrunkState=swL2TrunkState, swL2PortSecurityAdmState=swL2PortSecurityAdmState, swL2MACNotifyHistorySize=swL2MACNotifyHistorySize, swL2LoopDetectPortIndex=swL2LoopDetectPortIndex, swL2PortCounterCtrlPortIndex=swL2PortCounterCtrlPortIndex, swL2TrunkVLANEntry=swL2TrunkVLANEntry, swL2MulticastFilterProfileName=swL2MulticastFilterProfileName, swL2QOSMgmt=swL2QOSMgmt, swL2QOSBandwidthRadiusRxRate=swL2QOSBandwidthRadiusRxRate, swL2DevCtrlVlanIdOfFDBTbl=swL2DevCtrlVlanIdOfFDBTbl, swL2IGMPHostTimeout=swL2IGMPHostTimeout, swL2PortSecurityDelPort=swL2PortSecurityDelPort, swL2PortSecurityControlEntry=swL2PortSecurityControlEntry, swL2MulticastFilterMode=swL2MulticastFilterMode, swL2PortCtrlFlowCtrlState=swL2PortCtrlFlowCtrlState, swL2MulticastFilterProfileIndex=swL2MulticastFilterProfileIndex, swL2TrunkVLANTable=swL2TrunkVLANTable, swL2DevCtrlSnmpTrapState=swL2DevCtrlSnmpTrapState, swL2IGMPGroupIpAddr=swL2IGMPGroupIpAddr, swL2TrunkCurrentNumEntries=swL2TrunkCurrentNumEntries, swL2IGMPRouterPortDynamicPortList=swL2IGMPRouterPortDynamicPortList, swL2macNotifyInfo=swL2macNotifyInfo, swL2MulticastFilterAddressState=swL2MulticastFilterAddressState, swL2MgmtMIBTraps=swL2MgmtMIBTraps, swL2QOSSchedulingClassIndex=swL2QOSSchedulingClassIndex, swL2VlanLoopDetectVID=swL2VlanLoopDetectVID, swL2IGMPMulticastVlanid=swL2IGMPMulticastVlanid, swL2IGMPIpGroupReportCount=swL2IGMPIpGroupReportCount, swL2IGMPCtrlEntry=swL2IGMPCtrlEntry, swL2QOSSchedulingMaxLatency=swL2QOSSchedulingMaxLatency, swL2PortCableDiagnosisCableStatus=swL2PortCableDiagnosisCableStatus, swL2VlanPortInfoPortRole=swL2VlanPortInfoPortRole, swL2PortInfoLinkStatus=swL2PortInfoLinkStatus, swL2LimitedMulticastFilterPortEntry=swL2LimitedMulticastFilterPortEntry, swL2TrunkLACPPortState=swL2TrunkLACPPortState, swL2IGMPSnoopingMulticastVlanState=swL2IGMPSnoopingMulticastVlanState, swL2PortInfoErrorDisabled=swL2PortInfoErrorDisabled, swL2QOS8021pDefaultPriority=swL2QOS8021pDefaultPriority, swL2DevCtrlLLDPState=swL2DevCtrlLLDPState, swL2PortSecurityDelActivity=swL2PortSecurityDelActivity, swL2MulticastFilterToIp=swL2MulticastFilterToIp, swL2DevCtrlWebTcpPort=swL2DevCtrlWebTcpPort, swL2TrunkLACPPortIndex=swL2TrunkLACPPortIndex, swL2LoopDetectMgmt=swL2LoopDetectMgmt, swL2DevCtrlCFMPortEntry=swL2DevCtrlCFMPortEntry, swL2DevCtrlCFMPortState=swL2DevCtrlCFMPortState, swL2NotifFirmware=swL2NotifFirmware, swL2PVIDAutoAssignmentState=swL2PVIDAutoAssignmentState)
mibBuilder.exportSymbols("DES3528P-L2MGMT-MIB", swL2PortErrTable=swL2PortErrTable, swL2DevCtrlLLDPForwardMessageState=swL2DevCtrlLLDPForwardMessageState, swL2QOS8021pDefaultPriorityTable=swL2QOS8021pDefaultPriorityTable, swL2PortCtrlMDIXState=swL2PortCtrlMDIXState, swL2DhcpRelayCtrlServer=swL2DhcpRelayCtrlServer, swL2IGMPMulticastVlanEntry=swL2IGMPMulticastVlanEntry, swL2VlanIndex=swL2VlanIndex, swL2LoopDetectRecoverTime=swL2LoopDetectRecoverTime, swL2LimitedMulticastFilterPortIndex=swL2LimitedMulticastFilterPortIndex, swL2PortCtrlJumboFrame=swL2PortCtrlJumboFrame, swL2IGMPPortMap=swL2IGMPPortMap, swL2TrunkVLANPort=swL2TrunkVLANPort, swL2VlanPortInfoTable=swL2VlanPortInfoTable, swL2DevCtrlTelnetState=swL2DevCtrlTelnetState, swL2PortSecurityMgmt=swL2PortSecurityMgmt, swL2LoopDetectMode=swL2LoopDetectMode, swL2LoopDetectPortTable=swL2LoopDetectPortTable, swL2DhcpRelayOption82Policy=swL2DhcpRelayOption82Policy, swL2PortCableDiagnosisPairIndex=swL2PortCableDiagnosisPairIndex, swL2DhcpRelayOption82Check=swL2DhcpRelayOption82Check, swL2LoopDetectCtrl=swL2LoopDetectCtrl, PortList=PortList, swL2IGMPMulticastVlanGroupFromIp=swL2IGMPMulticastVlanGroupFromIp, swL2MulticastFilterProfileEntry=swL2MulticastFilterProfileEntry, swL2DhcpRelayState=swL2DhcpRelayState, swL2PortLoopOccurred=swL2PortLoopOccurred, swL2TrafficSegTable=swL2TrafficSegTable, swL2TrunkCtrlTable=swL2TrunkCtrlTable, swL2TrafficSegEntry=swL2TrafficSegEntry, swL2QOS8021pUserPriorityTable=swL2QOS8021pUserPriorityTable, swL2MACNotifyState=swL2MACNotifyState, swL2MulticastFilterStatus=swL2MulticastFilterStatus, swL2DhcpLocalRelayVLANEntry=swL2DhcpLocalRelayVLANEntry, swL2IGMPMgmt=swL2IGMPMgmt, swL2MACNotifyInterval=swL2MACNotifyInterval, swL2LimitedMulticastFilterPortAccess=swL2LimitedMulticastFilterPortAccess, swL2DevCtrlCFMPortIndex=swL2DevCtrlCFMPortIndex, swL2IGMPInfoQueryCount=swL2IGMPInfoQueryCount, swL2PortCableDiagnosisEntry=swL2PortCableDiagnosisEntry, swL2TrafficSegForwardPorts=swL2TrafficSegForwardPorts, swL2QOSBandwidthTxRate=swL2QOSBandwidthTxRate, swL2PortSecurityDelVlanName=swL2PortSecurityDelVlanName)
