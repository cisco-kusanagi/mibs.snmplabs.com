...
# Produced by pysmi-0.3.4 at Wed May  1 12:56:38 2019
...
Bits, Counter64, NotificationType, Counter32, MibScalar, MibTable, MibTableRow, MibTableColumn, iso, ObjectIdentity, Integer32, IpAddress, MibIdentifier, Unsigned32, Gauge32, ModuleIdentity, TimeTicks = mibBuilder.importSymbols("SNMPv2-SMI", "Bits", "Counter64", "NotificationType", "Counter32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "iso", "ObjectIdentity", "Integer32", "IpAddress", "MibIdentifier", "Unsigned32", "Gauge32", "ModuleIdentity", "TimeTicks")
...
if mibBuilder.loadTexts: rlSmartPorts.setContactInfo('www.dell.com')
...
if mibBuilder.loadTexts: rlSmartPortsMacroType.setDescription('This variable identifies the macro type: user defined, Dell provided per interface Dell provided globally')
...
mibBuilder.exportSymbols("Dell-SMARTPORTS-MIB", rlSmartPortsMacroKeywords=rlSmartPortsMacroKeywords, rlSmartPortsMacroContentEntry=rlSmartPortsMacroContentEntry, RlSmartPortsMacroNameOrZero=RlSmartPortsMacroNameOrZero, rlSmartPortsDiagLineNumber=rlSmartPortsDiagLineNumber, MacroType=MacroType, rlSmartPortsDiagMacroName=rlSmartPortsDiagMacroName, rlSmartPortsMacroContentTable=rlSmartPortsMacroContentTable, rlSmartPortsMacroName=rlSmartPortsMacroName, rlSmartPortsMacroStatus=rlSmartPortsMacroStatus, rlSmartPortsMacroOctetIndex=rlSmartPortsMacroOctetIndex, rlSmartPortsMacroDescriptionStatus=rlSmartPortsMacroDescriptionStatus, rlSmartPortsMacroText=rlSmartPortsMacroText, rlSmartPortsMacroDescriptionEntry=rlSmartPortsMacroDescriptionEntry, rlSmartPortsMacroType=rlSmartPortsMacroType, rlSmartPortsMacroIndex=rlSmartPortsMacroIndex, rlSmartPortsDiagCommandLine=rlSmartPortsDiagCommandLine, rlSmartPortsMacroDescriptionTable=rlSmartPortsMacroDescriptionTable, rlSmartPortsMacroDesc2=rlSmartPortsMacroDesc2, rlSmartPorts=rlSmartPorts, rlSmartPortsMacroDesc1=rlSmartPortsMacroDesc1, PYSNMP_MODULE_ID=rlSmartPorts, rlSmartPortsMacroDescriptionText=rlSmartPortsMacroDescriptionText, rlSmartPortsCondenseMode=rlSmartPortsCondenseMode, rlSmartPortsFreeIndexes=rlSmartPortsFreeIndexes, rlSmartPortsMacroManageEntry=rlSmartPortsMacroManageEntry, RlSmartPortsMacroName=RlSmartPortsMacroName, rlSmartPortsMacroManageTable=rlSmartPortsMacroManageTable, rlSmartPortsMacroDescriptionIndex=rlSmartPortsMacroDescriptionIndex)
