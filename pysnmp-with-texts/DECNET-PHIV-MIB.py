...
# Produced by pysmi-0.3.4 at Wed May  1 12:37:42 2019
...
MibScalar, MibTable, MibTableRow, MibTableColumn, ModuleIdentity, TimeTicks, Counter32, Counter64, NotificationType, Unsigned32, Integer32, IpAddress, Gauge32, iso, MibIdentifier, ObjectIdentity, mib_2, Bits = mibBuilder.importSymbols("SNMPv2-SMI", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "ModuleIdentity", "TimeTicks", "Counter32", "Counter64", "NotificationType", "Unsigned32", "Integer32", "IpAddress", "Gauge32", "iso", "MibIdentifier", "ObjectIdentity", "mib-2", "Bits")
...
if mibBuilder.loadTexts: phivRouteRoutingType.setDescription('This read-write parameter indicates the type of the executor node. The node-type is one of the following: routing-III nonrouting-III routing-IV ronrouting-IV area A routing node has full routing capability. A nonrouting node contains a subset of the Routing routing modules. The III and IV indicate the DNA phase of the node. Nonrouting nodes can deliver and receive packets to and from any node, but cannot route packets from other nodes through to other nodes. An area node routes between areas. Refer to the Routing specification for details. For adjacent nodes, this is a read-only parameter that indicates the type of the reachable adjacent node. NOTE: The ROUTING-III and NONROUTING-III values are incremented by one compared to the standard DECnet values in order to maintain compliance with RFC 1155)')
...
if mibBuilder.loadTexts: phivControlCircuitIndex.setDescription('A unique index value for each known multipoint control circuit. This is the same value as phivCircuitIndex.')
...
if mibBuilder.loadTexts: phivAdjNodeCircuitIndex.setDescription('A unique index value for each known circuit. This value is the same as phivCircuitIndex and identifies the circuit over which the adjacency is realized.')
...
if mibBuilder.loadTexts: phivAdjNodeBlockSize.setDescription('This read-only parameter is the block size that was negotiated with the adjacent Routing layer during Routing initialization over a particular circuit. It includes the routing header, but excludes the data link header. This parameter is qualified by ADJACENT NODE.')
...
if mibBuilder.loadTexts: phivAdjNodeListenTimer.setDescription('This value determines the maximum number of seconds allowed to elapse before Routing receives some message (either a Hello message or a user message) from the adjacent node on the circuit. It was agreed during Routing initialization with the adjacent Routing layer. This parameter is qualified by ADJACENT NODE.')
...
if mibBuilder.loadTexts: phivAdjNodeCircuitEtherServPhysAddr.setDescription('This parameter indicates the Ethernet physical address of an adjacent node that is being serviced on this circuit. This parameter is a qualifier for SERVICE SUBSTATE.')
...
if mibBuilder.loadTexts: phivAdjNodeType.setDescription('This parameter indicates the type of adjacency. For adjacent nodes, this is a read-only parameter that indicates the type of the reachable adjacent node. NOTE: The routing-III and nonrouting-III values are incremented by one compared to the standard DECnet values in order to maintain compliance with RFC 1155)')
...
if mibBuilder.loadTexts: phivAdjNodeState.setDescription('This value indicates the state of a router adjacency. On adjacencies over a circuit of type (phivCircuitCommonType) Ethernet, CI, or FDDI, with an adjacent node of type (phivAdjNodeType) ROUTING IV or AREA, this variable is the state of the Ethernet Initialization Layer for this adjacency, and can have values INITIALIZING or UP. (See Section 9.1.1 of DECnet Phase IV Routing Layer Functional Specification.) On adjacencies over a circuit of type (phivCircuitCommonType) Ethernet, CI, or FDDI, with an adjacent node of type (phivAdjNodeType) NONROUTING IV, this variable will always take on the value UP. On adjacencies over a circuit of type (phivCircuitCommonType) DDCMP POINT, DDCMP CONTROL, DDCMP TRIBUTARY, DDCMP DMC, or X.25, this variable is the state of the Routing Layer Initialization Circuit State. (See section 7.3, ibid.) It can have values between RUN and HALT. On adjacencies over a circuit of type (phivCircuitCommonType) OTHER, this variable may be used in a manner consistent with the Initialization Layer used on that circuit.')
...
if mibBuilder.loadTexts: phivAdjNodePriority.setDescription('Priority assigned by the adjacent node for this circuit.')
...
mibBuilder.exportSymbols("DECNET-PHIV-MIB", phivRouteCountAgedPktLoss=phivRouteCountAgedPktLoss, phivEndCountZeroCount=phivEndCountZeroCount, phivLineEntry=phivLineEntry, phivDDCMPCircuitLocalBuffErrors=phivDDCMPCircuitLocalBuffErrors, phivEndRetransmitFactor=phivEndRetransmitFactor, ethernet=ethernet, phivCircuitCountTermCongLoss=phivCircuitCountTermCongLoss, area=area, phivCountersCountTable=phivCountersCountTable, phivDDCMPCircuitParametersTable=phivDDCMPCircuitParametersTable, phivCountersCountSysBuffUnav=phivCountersCountSysBuffUnav, phivAdjBlockSize=phivAdjBlockSize, counters=counters, phivEndRemoteEntry=phivEndRemoteEntry, phivAreaCost=phivAreaCost, phivControlCircuitIndex=phivControlCircuitIndex, phivControlDelayTimer=phivControlDelayTimer, phivLineIndex=phivLineIndex, phivRouteCountOutRngePktLoss=phivRouteCountOutRngePktLoss, phivAdjNodeTable=phivAdjNodeTable, phivAdjState=phivAdjState, phivLineSubstate=phivLineSubstate, phivNonBroadcastTable=phivNonBroadcastTable, phivAdjNodeCircuitEtherServPhysAddr=phivAdjNodeCircuitEtherServPhysAddr, phivDDCMPCircuitAdjNodeAddr=phivDDCMPCircuitAdjNodeAddr, phivEndCountHostNodeID=phivEndCountHostNodeID, phivAdjNodePriority=phivAdjNodePriority, phivRouteMaxBuffs=phivRouteMaxBuffs, phivAreaState=phivAreaState, phivControlBabbleTimer=phivControlBabbleTimer, phivEthLinkIndex=phivEthLinkIndex, phivAdjCircuitIndex=phivAdjCircuitIndex, phivMgmtMgmtVers=phivMgmtMgmtVers, phivSystem=phivSystem, phivDDCMPCircuitCountTable=phivDDCMPCircuitCountTable, phivControlDyingBase=phivControlDyingBase, phivNonBroadcastIndex=phivNonBroadcastIndex, phivCountersCountEthUsrBuffUnav=phivCountersCountEthUsrBuffUnav, phivCircuitCommonName=phivCircuitCommonName, phivDDCMPCircuitLocalReplyTimeouts=phivDDCMPCircuitLocalReplyTimeouts, line=line, end=end, phivEndCountConnectsRecd=phivEndCountConnectsRecd, phivEndNSPVers=phivEndNSPVers, phivRouteSystemAddress=phivRouteSystemAddress, phivEndRemoteHostNodeID=phivEndRemoteHostNodeID, phivEndCountConnectsSent=phivEndCountConnectsSent, phivDDCMPCircuitRmteReplyTimeouts=phivDDCMPCircuitRmteReplyTimeouts, phivControlParametersEntry=phivControlParametersEntry, phivEndCountTotalBytesRec=phivEndCountTotalBytesRec, phivRouteRoutingType=phivRouteRoutingType, phivAdjNodeEntry=phivAdjNodeEntry, phivCircuitCountBytesSent=phivCircuitCountBytesSent, phivCircuitCountBytesRecd=phivCircuitCountBytesRecd, phivDDCMPLineCountLocalStationErrs=phivDDCMPLineCountLocalStationErrs, phivAreaCircuitIndex=phivAreaCircuitIndex, phivCircuitIndex=phivCircuitIndex, phivCircuitCountPeakAdj=phivCircuitCountPeakAdj, phivCircuitCountZeroCount=phivCircuitCountZeroCount, phivNonBroadcastDuplex=phivNonBroadcastDuplex, phivAdjPriority=phivAdjPriority, phivEndRemoteTable=phivEndRemoteTable, phivControlDeadTimer=phivControlDeadTimer, control=control, phivCountersCountBlksSentMultCol=phivCountersCountBlksSentMultCol, phivCircuitParametersTable=phivCircuitParametersTable, phivRouteType=phivRouteType, phivEndCountUsrBytesSent=phivEndCountUsrBytesSent, phivLineMaxBlock=phivLineMaxBlock, phivEndRemoteState=phivEndRemoteState, phivCircuitExecCost=phivCircuitExecCost, phivEthLinkParametersEntry=phivEthLinkParametersEntry, phivAdjAddr=phivAdjAddr, phivEndCircuitIndex=phivEndCircuitIndex, phivCountersCountSendFailure=phivCountersCountSendFailure, phivDDCMPCircuitParametersEntry=phivDDCMPCircuitParametersEntry, phivEndInactivityTimer=phivEndInactivityTimer, phivDDCMPCircuitErrorsInbd=phivDDCMPCircuitErrorsInbd, phivCountersCountUnrecFrameDest=phivCountersCountUnrecFrameDest, phivRouteMaxArea=phivRouteMaxArea, phivRouteSystemAddr=phivRouteSystemAddr, phivAdjCircuitEtherServPhysAddr=phivAdjCircuitEtherServPhysAddr, phivRouteCountVerifReject=phivRouteCountVerifReject, phivCountersCountMcastBytesRecd=phivCountersCountMcastBytesRecd, phivRouteCountZeroCount=phivRouteCountZeroCount, phivDDCMPCircuitIndex=phivDDCMPCircuitIndex, phivSessionOutTimer=phivSessionOutTimer, phivRouteBroadcastRouteTimer=phivRouteBroadcastRouteTimer, phivLineName=phivLineName, circuit=circuit, phivEndCountUsrBytesRec=phivEndCountUsrBytesRec, phivCountersCountBlksSentDef=phivCountersCountBlksSentDef, phivCircuitCommonType=phivCircuitCommonType, phivDDCMPCircuitCountEntry=phivDDCMPCircuitCountEntry, phivAdjExecListenTimer=phivAdjExecListenTimer, phivRouteMaxBdcastRouters=phivRouteMaxBdcastRouters, session=session, phivCircuitCountDataBlocksSent=phivCircuitCountDataBlocksSent, phivControlParametersTable=phivControlParametersTable, phivLineState=phivLineState, phivAdjType=phivAdjType, phivAdjEntry=phivAdjEntry, phivAdjTable=phivAdjTable, phivCountersCountBytesRecd=phivCountersCountBytesRecd, phivEthRouterPri=phivEthRouterPri, phivLineTable=phivLineTable, phivControlInactTreshold=phivControlInactTreshold, phivNonBroadcastRetransmitTimer=phivNonBroadcastRetransmitTimer, phivEndDelay=phivEndDelay, phivCountersCountEntry=phivCountersCountEntry, phivDDCMPCircuitSelectIntervalsElap=phivDDCMPCircuitSelectIntervalsElap, phivCountersCountCollDetectFailure=phivCountersCountCollDetectFailure, phivEndCountSecsLastZeroed=phivEndCountSecsLastZeroed, PhivCounter=PhivCounter, phivEndActiveLinks=phivEndActiveLinks, phivRouteMaxAddr=phivRouteMaxAddr, phivRouteRoutingTimer=phivRouteRoutingTimer, phivAdjNodeListenTimer=phivAdjNodeListenTimer, phiv=phiv, phivEndDelayFact=phivEndDelayFact, phivRouteMaxHops=phivRouteMaxHops, phivControlStreamTimer=phivControlStreamTimer, phivControlSchedTimer=phivControlSchedTimer, phivCountersCountBlksSentSingleCol=phivCountersCountBlksSentSingleCol, phivRouteMaxVisits=phivRouteMaxVisits, phivCircuitExecHelloTimer=phivCircuitExecHelloTimer, phivEthHardwareAddr=phivEthHardwareAddr, phivExecIdent=phivExecIdent, phivEndDelayWeight=phivEndDelayWeight, phivCircuitCountTransitPksRecd=phivCircuitCountTransitPksRecd, InterfaceIndex=InterfaceIndex, phivCircuitLineIndex=phivCircuitLineIndex, phivNonBroadcastEntry=phivNonBroadcastEntry, phivLevel1RouteCost=phivLevel1RouteCost, phivEndMaxLinks=phivEndMaxLinks, phivCircuitCountInitFailure=phivCircuitCountInitFailure, phivRouteCountNodeUnrPktLoss=phivRouteCountNodeUnrPktLoss, phivCircuitCommonState=phivCircuitCommonState, phivControlDyingThreshold=phivControlDyingThreshold, phivControlPollingState=phivControlPollingState, phivEndUCountUsrMessRec=phivEndUCountUsrMessRec, phivDDCMPLineCountDataErrsIn=phivDDCMPLineCountDataErrsIn, phivLevel1RouteEntry=phivLevel1RouteEntry, phivDDCMPLineCountTable=phivDDCMPLineCountTable, phivCircuitCountTransitCongestLoss=phivCircuitCountTransitCongestLoss, phivAdjNodeAddr=phivAdjNodeAddr, phivCountersIndex=phivCountersIndex, phivCircuitCountTermPacketsRecd=phivCircuitCountTermPacketsRecd, phivDDCMPLineCountRmteStationErrs=phivDDCMPLineCountRmteStationErrs, phivCircuitCommonSubState=phivCircuitCommonSubState, phivCircuitParametersEntry=phivCircuitParametersEntry, nonBroadcastLine=nonBroadcastLine, phivCircuitService=phivCircuitService, phivLevel1RouteTable=phivLevel1RouteTable, phivRouteSegBuffSize=phivRouteSegBuffSize, phivCircuitCountTransitPkSent=phivCircuitCountTransitPkSent, phivRouteRoutingVers=phivRouteRoutingVers, phivCircuitCountUsrBuffUnav=phivCircuitCountUsrBuffUnav, phivAdjNodeType=phivAdjNodeType, phivEndCountUsrMessSent=phivEndCountUsrMessSent, phivCountersCountDataBlksRecd=phivCountersCountDataBlksRecd, phivAreaMaxCost=phivAreaMaxCost, phivSystemState=phivSystemState, phivRouteCountOverSzePktLoss=phivRouteCountOverSzePktLoss, phivControlMaxTransmits=phivControlMaxTransmits, phivLineReceiveBuffs=phivLineReceiveBuffs, phivCountersCountDataOver=phivCountersCountDataOver, adjacency=adjacency, phivEndCountTotalBytesSent=phivEndCountTotalBytesSent, phivControlMaxBuffs=phivControlMaxBuffs, phivCountersCountDataBlksSent=phivCountersCountDataBlksSent, phivRouteCountPtlRteUpdtLoss=phivRouteCountPtlRteUpdtLoss, phivDDCMPCircuitErrorsOutbd=phivDDCMPCircuitErrorsOutbd, phivAreaNum=phivAreaNum, phivEndCountTable=phivEndCountTable, phivCircuitCountCircuitDown=phivCircuitCountCircuitDown, phivCircuitCountEntry=phivCircuitCountEntry, phivDDCMPCircuitTributary=phivDDCMPCircuitTributary, phivEthLinkParametersTable=phivEthLinkParametersTable, phivDDCMPCircuitSelectTimeouts=phivDDCMPCircuitSelectTimeouts, phivCountersCountMcastBlksRecd=phivCountersCountMcastBlksRecd, phivLevel1RouteHops=phivLevel1RouteHops, phivLevel1RouteNextNode=phivLevel1RouteNextNode, phivCountersCountReceiveFailure=phivCountersCountReceiveFailure, phivCircuitCountDataBlocksRecd=phivCircuitCountDataBlocksRecd, phivLevel1RouteNodeAddr=phivLevel1RouteNodeAddr, phivEndCountReponseTimeouts=phivEndCountReponseTimeouts, phivSessionInTimer=phivSessionInTimer, phivRouteMaxCircuits=phivRouteMaxCircuits, phivDDCMPCircuitRmteBuffErrors=phivDDCMPCircuitRmteBuffErrors, phivCountersCountDataBlocksSent=phivCountersCountDataBlocksSent, phivCircuitCountOriginPackSent=phivCircuitCountOriginPackSent, phivAdjListenTimer=phivAdjListenTimer, phivAdjNodeCircuitIndex=phivAdjNodeCircuitIndex, phivAdjNodeState=phivAdjNodeState, phivCountersCountDataBlocksRecd=phivCountersCountDataBlocksRecd, phivCircuitExecRecallTimer=phivCircuitExecRecallTimer, phivCircuitCountSecLastZeroed=phivCircuitCountSecLastZeroed, phivCountersCountBytesSent=phivCountersCountBytesSent, phivCircuitCountTable=phivCircuitCountTable, phivAreaEntry=phivAreaEntry, phivRouteMaxBdcastNonRouters=phivRouteMaxBdcastNonRouters, phivEndMaxLinksActive=phivEndMaxLinksActive, phivRouteBuffSize=phivRouteBuffSize, phivControlDyingIncrement=phivControlDyingIncrement, phivLevel1RouteCircuitIndex=phivLevel1RouteCircuitIndex, phivAdjNodeBlockSize=phivAdjNodeBlockSize, phivNonBroadcastController=phivNonBroadcastController, phivSessionSystemName=phivSessionSystemName, phivControlDeadThreshold=phivControlDeadThreshold, phivNonBroadcastClock=phivNonBroadcastClock, phivAreaTable=phivAreaTable, phivEndCountTotalMessSent=phivEndCountTotalMessSent, phivLineServiceTimer=phivLineServiceTimer, phivLineProtocol=phivLineProtocol, phivEthMaxRouters=phivEthMaxRouters, PhivAddr=PhivAddr, phivEndCountEntry=phivEndCountEntry, routing=routing, phivCircuitCountAdjDown=phivCircuitCountAdjDown, phivControlPollingSubState=phivControlPollingSubState, phivManagement=phivManagement, phivCircuitCountCorruptLoss=phivCircuitCountCorruptLoss, phivDDCMPLineCountEntry=phivDDCMPLineCountEntry, phivCircuitOrigQueueLimit=phivCircuitOrigQueueLimit, phivAreaHops=phivAreaHops, phivControlTransTimer=phivControlTransTimer, phivAreaNextNode=phivAreaNextNode, phivEndCountTotalMessRec=phivEndCountTotalMessRec, phivRouteMaxCost=phivRouteMaxCost, phivAreaMaxHops=phivAreaMaxHops, ddcmp=ddcmp, phivCountersCountUsrBuffUnav=phivCountersCountUsrBuffUnav, phivEndCountRecdConnectResErrs=phivEndCountRecdConnectResErrs, phivLineService=phivLineService, phivEthDesigRouterNodeAddr=phivEthDesigRouterNodeAddr, phivDDCMPLineCountIndex=phivDDCMPLineCountIndex, phivRouteCountPacketFmtErr=phivRouteCountPacketFmtErr, phivLineDevice=phivLineDevice)
