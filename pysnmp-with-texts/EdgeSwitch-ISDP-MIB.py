...
# Produced by pysmi-0.3.4 at Wed May  1 13:10:24 2019
...
ModuleIdentity, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, TimeTicks, Counter32, iso, Integer32, IpAddress, ObjectIdentity, Bits, Gauge32, NotificationType, Unsigned32, MibIdentifier = mibBuilder.importSymbols("SNMPv2-SMI", "ModuleIdentity", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "TimeTicks", "Counter32", "iso", "Integer32", "IpAddress", "ObjectIdentity", "Bits", "Gauge32", "NotificationType", "Unsigned32", "MibIdentifier")
...
if getattr(mibBuilder, 'version', (0, 0, 0)) > (4, 4, 0):
    if mibBuilder.loadTexts: fastPathIsdp.setRevisionsDescriptions(('Postal address updated.', "Device ID can be system's host name too.", 'Initial version.',))
...
if mibBuilder.loadTexts: fastPathIsdp.setContactInfo('')
if mibBuilder.loadTexts: fastPathIsdp.setDescription('The Ubiquiti Private MIB for FastPath ISDP')
...
if mibBuilder.loadTexts: agentIsdpClearStats.setDescription('Clear ISDP stats. Will always return 0 when read.')
...
if mibBuilder.loadTexts: agentIsdpClearEntries.setDescription('Clear ISDP entries table. Will always return 0 when read.')
...
mibBuilder.exportSymbols("EdgeSwitch-ISDP-MIB", PYSNMP_MODULE_ID=fastPathIsdp, agentIsdpInterface=agentIsdpInterface, agentIsdpInterfaceTable=agentIsdpInterfaceTable, agentIsdpCacheHoldtime=agentIsdpCacheHoldtime, agentIsdpStatisticsPduTransmit=agentIsdpStatisticsPduTransmit, agentIsdpStatisticsChkSumErrorPduReceived=agentIsdpStatisticsChkSumErrorPduReceived, agentIsdpCache=agentIsdpCache, agentIsdpCacheDeviceId=agentIsdpCacheDeviceId, agentIsdpCacheDevicePort=agentIsdpCacheDevicePort, agentIsdpCachePlatform=agentIsdpCachePlatform, agentIsdpStatisticsV1PduTransmit=agentIsdpStatisticsV1PduTransmit, agentIsdpInterfaceIfIndex=agentIsdpInterfaceIfIndex, agentIsdpGlobalDeviceId=agentIsdpGlobalDeviceId, agentIsdpStatisticsV1PduReceived=agentIsdpStatisticsV1PduReceived, agentIsdpCacheCapabilities=agentIsdpCacheCapabilities, agentIsdpCacheLocalIntf=agentIsdpCacheLocalIntf, agentIsdpInterfaceEnable=agentIsdpInterfaceEnable, agentIsdpStatisticsFailurePduTransmit=agentIsdpStatisticsFailurePduTransmit, agentIsdpClearEntries=agentIsdpClearEntries, agentIsdpGlobalAdvertiseV2=agentIsdpGlobalAdvertiseV2, agentIsdpStatisticsBadHeaderPduReceived=agentIsdpStatisticsBadHeaderPduReceived, fastPathIsdp=fastPathIsdp, agentIsdpCacheLastChange=agentIsdpCacheLastChange, agentIsdpGlobalDeviceIdFormat=agentIsdpGlobalDeviceIdFormat, agentIsdpCacheIndex=agentIsdpCacheIndex, agentIsdpCacheTable=agentIsdpCacheTable, agentIsdpStatisticsTableFull=agentIsdpStatisticsTableFull, agentIsdpStatisticsV2PduTransmit=agentIsdpStatisticsV2PduTransmit, agentIsdpCacheIfIndex=agentIsdpCacheIfIndex, agentIsdpInterfaceEntry=agentIsdpInterfaceEntry, agentIsdpGlobalMessageInterval=agentIsdpGlobalMessageInterval, agentIsdpStatistics=agentIsdpStatistics, agentIsdpMIBObjects=agentIsdpMIBObjects, agentIsdpStatisticsInvalidFormatPduReceived=agentIsdpStatisticsInvalidFormatPduReceived, agentIsdpClear=agentIsdpClear, agentIsdpGlobalRun=agentIsdpGlobalRun, agentIsdpCacheAddress=agentIsdpCacheAddress, agentIsdpStatisticsPduReceived=agentIsdpStatisticsPduReceived, agentIsdpCacheEntry=agentIsdpCacheEntry, agentIsdpCacheVersion=agentIsdpCacheVersion, agentIsdpClearStats=agentIsdpClearStats, agentIsdpGlobal=agentIsdpGlobal, agentIsdpStatisticsIpAddressTableFull=agentIsdpStatisticsIpAddressTableFull, agentIsdpGlobalHoldTime=agentIsdpGlobalHoldTime, agentIsdpStatisticsV2PduReceived=agentIsdpStatisticsV2PduReceived, agentIsdpCacheProtocolVersion=agentIsdpCacheProtocolVersion, agentIsdpGlobalDeviceIdFormatCpb=agentIsdpGlobalDeviceIdFormatCpb)
