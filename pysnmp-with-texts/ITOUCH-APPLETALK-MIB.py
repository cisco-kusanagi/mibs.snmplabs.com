#
# PySNMP MIB module ITOUCH-APPLETALK-MIB (http://snmplabs.com/pysmi)
# ASN.1 source file:///Users/davwang4/Dev/mibs.snmplabs.com/asn1/ITOUCH-APPLETALK-MIB
...
TimeTicks, Integer32, MibScalar, MibTable, MibTableRow, MibTableColumn, Counter64, ModuleIdentity, IpAddress, Unsigned32, Counter32, Bits, NotificationType, Gauge32, MibIdentifier, ObjectIdentity, iso = mibBuilder.importSymbols("SNMPv2-SMI", "TimeTicks", "Integer32", "MibScalar", "MibTable", "MibTableRow", "MibTableColumn", "Counter64", "ModuleIdentity", "IpAddress", "Unsigned32", "Counter32", "Bits", "NotificationType", "Gauge32", "MibIdentifier", "ObjectIdentity", "iso")
...
applePortEntry = MibTableRow((1, 3, 6, 1, 4, 1, 33, 21, 2, 1, 1), ).setIndexNames((0, "ITOUCH-APPLETALK-MIB", "applePortIndex"))
...
applePortZoneEntry = MibTableRow((1, 3, 6, 1, 4, 1, 33, 21, 2, 2, 1), ).setIndexNames((0, "ITOUCH-APPLETALK-MIB", "applePortZoneIndex"), (0, "ITOUCH-APPLETALK-MIB", "applePortZoneName"))
...
applePortExportEntry = MibTableRow((1, 3, 6, 1, 4, 1, 33, 21, 3, 1, 1), ).setIndexNames((0, "ITOUCH-APPLETALK-MIB", "applePortExportIndex"), (0, "ITOUCH-APPLETALK-MIB", "applePortExportZone"), (0, "ITOUCH-APPLETALK-MIB", "applePortExportName"), (0, "ITOUCH-APPLETALK-MIB", "applePortExportType"))
...
applePortImportEntry = MibTableRow((1, 3, 6, 1, 4, 1, 33, 21, 3, 2, 1), ).setIndexNames((0, "ITOUCH-APPLETALK-MIB", "applePortImportIndex"), (0, "ITOUCH-APPLETALK-MIB", "applePortImportZone"), (0, "ITOUCH-APPLETALK-MIB", "applePortImportName"), (0, "ITOUCH-APPLETALK-MIB", "applePortImportType"))
...
appleNbpEntry = MibTableRow((1, 3, 6, 1, 4, 1, 33, 21, 4, 1, 1), ).setIndexNames((0, "ITOUCH-APPLETALK-MIB", "appleNbpZone"), (0, "ITOUCH-APPLETALK-MIB", "appleNbpName"), (0, "ITOUCH-APPLETALK-MIB", "appleNbpType"))
...
appleTrafficEntry = MibTableRow((1, 3, 6, 1, 4, 1, 33, 21, 5, 2, 1), ).setIndexNames((0, "ITOUCH-APPLETALK-MIB", "appleTrafficIndex"))
...
mibBuilder.exportSymbols("ITOUCH-APPLETALK-MIB", arapPassword=arapPassword, applePortNetEnd=applePortNetEnd, applePortZoneName=applePortZoneName, applePortForwardsIn=applePortForwardsIn, applePortBringBackTime=applePortBringBackTime, applePortIndex=applePortIndex, applePortZoneEntry=applePortZoneEntry, appleTrafficIndex=appleTrafficIndex, applePortChecksum=applePortChecksum, arapPortEntry=arapPortEntry, applePortExportZone=applePortExportZone, appleTrafficDst=appleTrafficDst, arapPortEnabled=arapPortEnabled, appleTrafficTable=appleTrafficTable, xApplePolicy=xApplePolicy, arapDefaultZoneName=arapDefaultZoneName, appleNbpEntry=appleNbpEntry, appleNbpType=appleNbpType, applePortTable=applePortTable, arapPortTimeRemaining=arapPortTimeRemaining, arapPortZoneAccess=arapPortZoneAccess, applePortImportStatus=applePortImportStatus, appleTrafficSort=appleTrafficSort, applePortImportAction=applePortImportAction, appleNbpNode=appleNbpNode, appleState=appleState, appleTrafficEntry=appleTrafficEntry, arapPortZoneName=arapPortZoneName, appleNbpTable=appleNbpTable, applePortImportType=applePortImportType, xApple=xApple, applePortExportEntry=applePortExportEntry, appleNbpName=appleNbpName, arapPortTimeConnected=arapPortTimeConnected, applePortForwardsOut=applePortForwardsOut, appleStatus=appleStatus, xAppleNbp=xAppleNbp, applePortExportAction=applePortExportAction, appleNbpSocket=appleNbpSocket, applePortPacketsOut=applePortPacketsOut, applePortExportIndex=applePortExportIndex, applePortEntry=applePortEntry, arapPortTable=arapPortTable, applePortZoneIndex=applePortZoneIndex, appleTrafficSrc=appleTrafficSrc, xAppleTraffic=xAppleTraffic, applePortImportName=applePortImportName, appleTrafficPercent=appleTrafficPercent, appleTrafficMonitoring=appleTrafficMonitoring, applePortUseNeighborNotify=applePortUseNeighborNotify, appleStatusIf=appleStatusIf, applePortImportTable=applePortImportTable, applePortExportTable=applePortExportTable, applePortPacketsIn=applePortPacketsIn, xAppleRemoteAccess=xAppleRemoteAccess, xApplePort=xApplePort, applePortArpInterval=applePortArpInterval, appleNbpZone=appleNbpZone, applePortExportName=applePortExportName, applePortNetAddress=applePortNetAddress, applePortLastError=applePortLastError, applePortImportZone=applePortImportZone, applePortLastErrorTime=applePortLastErrorTime, applePortErrors=applePortErrors, arapPortMaxConnectTime=arapPortMaxConnectTime, applePortImportEntry=applePortImportEntry, arapPortGuestLoginsOk=arapPortGuestLoginsOk, applePortZoneTable=applePortZoneTable, applePortNetStart=applePortNetStart, applePortZoneStatus=applePortZoneStatus, xAppleSystem=xAppleSystem, applePortRouterType=applePortRouterType, applePortExportStatus=applePortExportStatus, applePortImportIndex=applePortImportIndex, applePortExportType=applePortExportType, applePortLastErrorData=applePortLastErrorData, applePortProtocolPriority=applePortProtocolPriority, applePortArpRetransmitCount=applePortArpRetransmitCount, appleTrafficIntf=appleTrafficIntf)
